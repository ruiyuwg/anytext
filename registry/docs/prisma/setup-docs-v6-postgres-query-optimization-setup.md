# Setup (/docs/v6/postgres/query-optimization/setup)
...
2. Log in to your [Prisma Data Platform account](https://console.prisma.io/optimize?utm_source=docs\&utm_medium=ppg_optimize_page).

3. Click the **Optimize** tab on the left navigation.

4. Click the **Generate API key** button.

5. Copy the API key that appears and paste it somewhere safe, like a password manager.

6. Click the copy icons to continue through each setup screen until you see the **Finish & optimize** button. Click that to complete the setup.

7. Once you're done, Optimize will automatically begin a new recording session in the background.

8. Add Optimize to your application \[#2-add-optimize-to-your-application]

2.1. Install the required Prisma Client extension \[#21-install-the-required-prisma-client-extension]
