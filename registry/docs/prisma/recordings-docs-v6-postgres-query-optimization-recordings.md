# Recordings (/docs/v6/postgres/query-optimization/recordings)
...
Managing a recording session \[#managing-a-recording-session]
...
Identifying a recording session \[#identifying-a-recording-session]
...
Data captured in a recording session \[#data-captured-in-a-recording-session]
...
Recommendations from a recording session \[#recommendations-from-a-recording-session]
