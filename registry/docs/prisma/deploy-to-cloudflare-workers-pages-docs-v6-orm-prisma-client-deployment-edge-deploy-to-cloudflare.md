...
Set PRISMA\_CLIENT\_FORCE\_WASM=1 when running locally with node \[#set-prisma\_client\_force\_wasm1-when-running-locally-with-node]
...
3\. Set node\_compat = true in wrangler.toml \[#3-set-node\_compat--true-in-wranglertoml]
...
7\. Set the DATABASE\_URL environment variable and deploy the Worker \[#7-set-the-database\_url-environment-variable-and-deploy-the-worker]
...
7\. Set the DATABASE\_URL environment variable and deploy the Worker \[#7-set-the-database\_url-environment-variable-and-deploy-the-worker-1]
...
7\. Set the DATABASE\_URL environment variable and deploy the Worker \[#7-set-the-database\_url-environment-variable-and-deploy-the-worker-2]
