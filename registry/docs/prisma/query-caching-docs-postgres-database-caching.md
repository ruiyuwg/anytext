# Query caching (/docs/postgres/database/caching)
...
2. Go to the [Platform Console](https://console.prisma.io) and navigate to your project dashboard

3. In the "Connect to your database" section, click **Connect**

4. Toggle **Enable Accelerate caching** to activate the caching layer
...
You can invalidate the cache using the [`$accelerate.invalidate` API](/accelerate/reference/api-reference#accelerateinvalidate):
