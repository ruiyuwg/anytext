...
2. Download [the example code](https://github.com/prisma/prisma-examples/tree/latest/deployment-platforms/render) to your local machine.

3. Create a new Git repository on GitHub, GitLab, or BitBucket.

4. Upload the example code to your new repository.

5. Deploy manually \[#2-deploy-manually]

6. In the Render Dashboard, click **New** > **PostgreSQL**. Provide a database name, and select a plan. (The Free plan works for this demo.)

7. After your database is ready, look up its [internal URL](https://docs.render.com/postgresql-creating-connecting#internal-connections).

8. In the Render Dashboard, click **New** > **Web Service** and connect the Git repository that contains the example code.

9. Provide the following values during service creation:
