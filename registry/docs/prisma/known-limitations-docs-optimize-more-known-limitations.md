# Known limitations (/docs/optimize/more/known-limitations)
...
Scope and constraints for Prisma AI \[#scope-and-constraints-for-prisma-ai]
...
Using Prisma Accelerate with the Optimize extension \[#using-prisma-accelerate-with-the-optimize-extension]
