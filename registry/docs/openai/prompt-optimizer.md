...
For effective results, add annotations containing a Good/Bad rating *and* detailed, specific critiques. Create [graders](https://developers.openai.com/api/docs/guides/evaluation-getting-started#adding-graders) that precisely capture the properties that you desire from your prompt.
...
\<a
href="https://cookbook.openai.com/examples/evaluation/Building\_resilient\_prompts\_using\_an\_evaluation\_flywheel.md"
target="\_blank"
rel="noreferrer"
