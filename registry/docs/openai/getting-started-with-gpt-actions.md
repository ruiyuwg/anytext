...
1. *Context* to explain to the model what the GPT Action(s) is doing
2. *Instructions* on the sequence of steps – this is where you reference the Action name and any parameters the API call needs to pay attention to
3. *Additional Notes* if there’s anything to keep in mind
...
- *Solution:* Try to prompt engineer your instructions in the Custom GPT. See examples in our [prompt engineering guide](https://developers.openai.com/api/docs/guides/prompt-engineering)
