...
Here are some typical queries in GROQ. You can also check out [our introduction to GROQ](https://www.sanity.io/docs/content-lake/how-queries-work) and [the complete reference documentation](https://www.sanity.io/docs/groq). To actually run queries you can:
