...
- ### Get your credentials
  ...
  4. Visit [your dashboard on
     Vercel](/dashboard/integrations)
  5. In the **Integrations** section in the sidebar, select **Manage**
  6. On the integration page, select **Configure**
  7. You should see the item key on the page that opens. Copy it
     To add your Edge Config's connection string to your project:
  8. Visit your project's page in [the dashboard](/dashboard)
  9. Open **Storage** in the sidebar. Select **Connect Store** and select the Edge Config associated with your Split integration. The `EDGE_CONFIG` environment variable will be set automatically.
