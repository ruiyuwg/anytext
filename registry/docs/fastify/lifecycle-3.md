...
- the [reply serialized](/docs/v4.29.x/Reference/Server/.md#setreplyserializer) if set
- or by the [serializer compiler](/docs/v4.29.x/Reference/Server/.md#setserializercompiler) when a JSON schema has been set for the returning HTTP status code
