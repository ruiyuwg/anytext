...
To validate your requests and responses you can use JSON Schema files. If you didn't know already, defining schemas for your Fastify routes can increase their throughput! Check out the [Validation and Serialization](/docs/v5.0.x/Reference/Validation-and-Serialization/.md) documentation for more info.
...
They simplify schema validation setup and you can read more about them in [Type Providers](/docs/v5.0.x/Reference/Type-Providers/.md) page.
