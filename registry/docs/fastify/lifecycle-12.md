...
- The [reply serializer](/docs/v5.8.x/Reference/Server/.md#setreplyserializer) if set
- The [serializer compiler](/docs/v5.8.x/Reference/Server/.md#setserializercompiler) if a JSON schema is set for the HTTP status code
...
When [`fastify.close()`](/docs/v5.8.x/Reference/Server/.md#close) is called, the server goes through a graceful shutdown sequence involving [`preClose`](/docs/v5.8.x/Reference/Hooks/.md#pre-close) hooks, connection draining, and [`onClose`](/docs/v5.8.x/Reference/Hooks/.md#on-close) hooks. See the [`close`](/docs/v5.8.x/Reference/Server/.md#close) method documentation for the full step-by-step lifecycle.
