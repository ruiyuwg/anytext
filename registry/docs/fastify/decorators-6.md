...
This method is used to customize the Fastify [server](/docs/v5.0.x/Reference/Server/.md) instance.
...
The decorated [Fastify server](/docs/v5.0.x/Reference/Server/.md) is bound to `this` in [route](/docs/v5.0.x/Reference/Routes/.md) handlers:
...
To achieve proper encapsulation across requests configure a new value for each incoming request in the [`'onRequest'` hook](/docs/v5.0.x/Reference/Hooks/.md#onrequest). Example:
...
To achieve proper encapsulation across requests configure a new value for each incoming request in the [`'onRequest'` hook](/docs/v5.0.x/Reference/Hooks/.md#onrequest).
