...
- API Gateway does not support streams yet, so you are not able to handle [streams](/docs/v4.29.x/Reference/Reply/.md#streams).
...
## Platformatic Cloud[​](#platformatic-cloud "Direct link to Platformatic Cloud")

[Platformatic](https://platformatic.dev) provides zero-configuration deployment for Node.js applications. To use it now, you should wrap your existing Fastify application inside a [Platformatic Service](https://oss.platformatic.dev/docs/reference/service/introduction), by running the following:
...
Then, head to [Platformatic Cloud](https://platformatic.cloud) and sign in with your GitHub account. Create your first application and a static workspace: be careful to download the API key as an env file, e.g. `yourworkspace.txt`.
...
Check out the [Full Guide](https://blog.platformatic.dev/how-to-migrate-a-fastify-app-to-platformatic-service) on how to wrap Fastify application in Platformatic.
