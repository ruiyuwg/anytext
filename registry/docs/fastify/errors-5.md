...
Most errors are a result of unexpected input data, so we recommend [validating your input data against a JSON schema](/docs/v5.1.x/Reference/Validation-and-Serialization/.md).
...
To customize this behavior you should use [`setErrorHandler`](/docs/v5.1.x/Reference/Server/.md#seterrorhandler).
