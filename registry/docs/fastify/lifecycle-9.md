...
- The [reply serializer](/docs/v5.5.x/Reference/Server/.md#setreplyserializer) if set
- The [serializer compiler](/docs/v5.5.x/Reference/Server/.md#setserializercompiler) if a JSON schema is set for the HTTP status code
