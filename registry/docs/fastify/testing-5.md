...
### How to inspect tap tests[​](#how-to-inspect-tap-tests "Direct link to How to inspect tap tests")
...
A basic example of a Plugin. See [Plugin Guide](/docs/v4.29.x/Guides/Plugins-Guide/.md)
