...
Most errors result from unexpected input data, so it is recommended to [validate input data against a JSON schema](/docs/v5.3.x/Reference/Validation-and-Serialization/.md).
...
To customize this behavior, use [`setErrorHandler`](/docs/v5.3.x/Reference/Server/.md#seterrorhandler).
