...
or, in the specific case of *helmet*, you can use the [*fastify-helmet*](https://github.com/fastify/fastify-helmet) [plugin](/docs/v1.14.x/Documentation/Plugins/.md), which is an optimized helmet integration for fastify:
...
Fastify middlewares also do not expose the `send` method or other methods specific to the Fastify [Reply](/docs/v1.14.x/Documentation/Reply/.md "Reply") instance. This is because Fastify wraps the incoming `req` and `res` Node instances using the [Request](/docs/v1.14.x/Documentation/Request/.md "Request") and [Reply](/docs/v1.14.x/Documentation/Reply/.md "Reply") objects internally, but this is done after the middlewares phase. If you need to create a middleware you have to use the Node `req` and `res` instances. Otherwise, you can use the `preHandler` hook that has the [Request](/docs/v1.14.x/Documentation/Request/.md "Request") and [Reply](/docs/v1.14.x/Documentation/Reply/.md "Reply") Fastify instances. For more information, see [Hooks](/docs/v1.14.x/Documentation/Hooks/.md "Hooks").
