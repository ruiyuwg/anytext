...
Validation will only be attempted if the content type is `application-json`, as described in the documentation for the [content type parser](/docs/v5.0.x/Reference/ContentTypeParser/.md).
...
> ℹ If you need to use the latest version of Ajv (v8) you should read how to do it in the [`schemaController`](/docs/v5.0.x/Reference/Server/.md#schema-controller) section.
...
> Refer to [`ajv options`](/docs/v5.0.x/Reference/Server/.md#ajv) to check plugins format
...
This baseline configuration can be modified by providing [`ajv.customOptions`](/docs/v5.0.x/Reference/Server/.md#factory-ajv) to your Fastify factory.
...
*If you need a custom serializer in a very specific part of your code, you can set one with [`reply.serializer(...)`](/docs/v5.0.x/Reference/Reply/.md#serializerfunc).*
...
You can also use [setErrorHandler](/docs/v5.0.x/Reference/Server/.md#seterrorhandler) to define a custom response for validation errors such as
