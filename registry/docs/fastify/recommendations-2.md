...
There are many reverse proxy solutions available, and your environment may dictate the solution to use, e.g. AWS or GCP. But given the above, we could use [HAProxy](https://www.haproxy.org/) to solve these requirements:
