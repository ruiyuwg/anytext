...
Fastify v5 now supports the [Diagnostic Channel](https://nodejs.org/api/diagnostic_channel.html) API natively and provides a way to trace the lifecycle of a request.
