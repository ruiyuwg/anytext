...
Fastify uses different techniques to optimize its code, many of them are documented in our Guides. We highly recommend you read [the hitchhiker's guide to plugins](/docs/v4.29.x/Guides/Plugins-Guide/.md) to discover all the APIs you can use to build your plugin and learn how to use them.
...
Once you submit a plugin to our [ecosystem list](/docs/v4.29.x/Guides/Ecosystem/.md), we will review your code and help you improve it if necessary.
...
Things to keep in mind when implementing a custom [type provider](/docs/v4.29.x/Reference/Type-Providers/.md):
