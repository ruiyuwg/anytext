...
A fundamental feature of Fastify is the "encapsulation context." It governs which [decorators](/docs/v5.8.x/Reference/Decorators/.md), registered [hooks](/docs/v5.8.x/Reference/Hooks/.md), and [plugins](/docs/v5.8.x/Reference/Plugins/.md) are available to [routes](/docs/v5.8.x/Reference/Routes/.md). A visual representation of the encapsulation context is shown in the following figure:
