...
- The [reply serializer](/docs/latest/Reference/Server/.md#setreplyserializer) if set
- The [serializer compiler](/docs/latest/Reference/Server/.md#setserializercompiler) if a JSON schema is set for the HTTP status code
...
When [`fastify.close()`](/docs/latest/Reference/Server/.md#close) is called, the server goes through a graceful shutdown sequence involving [`preClose`](/docs/latest/Reference/Hooks/.md#pre-close) hooks, connection draining, and [`onClose`](/docs/latest/Reference/Hooks/.md#on-close) hooks. See the [`close`](/docs/latest/Reference/Server/.md#close) method documentation for the full step-by-step lifecycle.
