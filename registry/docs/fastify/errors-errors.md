...
- [Errors](#errors)
  ...
  - [Fastify Error Codes](#fastify-error-codes)
    ...
    - [FST\_ERR\_VERSION\_CONSTRAINT\_NOT\_STR](#fst_err_version_constraint_not_str)
    ...
    - [FST\_ERR\_HTTP2\_INVALID\_VERSION](#fst_err_http2_invalid_version)
    ...
    - [FST\_ERR\_DEFAULT\_ROUTE\_INVALID\_TYPE](#fst_err_default_route_invalid_type)
...
Most errors are a result of unexpected input data, so we recommend [validating your input data against a JSON schema](/docs/v4.29.x/Reference/Validation-and-Serialization/.md).
...
To customize this behavior you should use [`setErrorHandler`](/docs/v4.29.x/Reference/Server/.md#seterrorhandler).
