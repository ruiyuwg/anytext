...
Fastify automatically adds the parsed request payload to the [Fastify request](/docs/v4.29.x/Reference/Request/.md) object which you can access with `request.body`.
...
- `bodyLimit` (number): The maximum payload size, in bytes, that the custom parser will accept. Defaults to the global body limit passed to the [`Fastify factory function`](/docs/v4.29.x/Reference/Server/.md#bodylimit).
