...
The logging [Serializers](/docs/v5.7.x/Reference/Logging/.md) have been updated to now Fastify [`Request`](/docs/v5.7.x/Reference/Request/.md) and [`Reply`](/docs/v5.7.x/Reference/Reply/.md) objects instead of native ones.
...
- Deprecated `request.req` and `reply.res` for [`request.raw`](/docs/v5.7.x/Reference/Request/.md) and [`reply.raw`](/docs/v5.7.x/Reference/Reply/.md) ([#2008](https://github.com/fastify/fastify/pull/2008))
- Removed `modifyCoreObjects` option ([#2015](https://github.com/fastify/fastify/pull/2015))
- Added [`connectionTimeout`](/docs/v5.7.x/Reference/Server/.md#factory-connection-timeout) option ([#2086](https://github.com/fastify/fastify/pull/2086))
- Added [`keepAliveTimeout`](/docs/v5.7.x/Reference/Server/.md#factory-keep-alive-timeout) option ([#2086](https://github.com/fastify/fastify/pull/2086))
- Added async-await support for [plugins](/docs/v5.7.x/Reference/Plugins/.md#async-await) ([#2093](https://github.com/fastify/fastify/pull/2093))
