[Concepts](/concepts "Concepts")Session strategies
...
Both session strategies have advantages and disadvantages, which you have to evaluate based on the requirements of your application.
...
-   Auth.js has no opinion on the type of database you are using; we have a big list of [official database adapters](/getting-started/database), but you can [implement your own](/guides/creating-a-database-adapter) as well
...
[How OAuth works](/concepts/oauth "How OAuth works")[Database models](/concepts/database-models "Database models")
