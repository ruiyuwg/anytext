[Getting Started](/getting-started "Getting Started")[Adapters](/getting-started/adapters/azure-tables "Adapters")TypeORM

![](/img/adapters/typeorm.svg)
...
If mixed snake\_case and camelCase column names are an issue for you and/or your underlying database system, we recommend using TypeORM’s naming strategy feature to change the target field names. There is a package called `typeorm-naming-strategies` which includes a `snake_case` strategy which will translate the fields from how Auth.js expects them, to snake\_case in the actual database.
...
[SurrealDB](/getting-started/adapters/surrealdb "SurrealDB")[Unstorage](/getting-started/adapters/unstorage "Unstorage")
