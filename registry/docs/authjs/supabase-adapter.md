[Getting Started](/getting-started "Getting Started")[Adapters](/getting-started/adapters/azure-tables "Adapters")Supabase

![](/img/adapters/supabase.svg)
...
### Expose the NextAuth schema in Supabase[](#expose-the-nextauth-schema-in-supabase)
...
### Enabling Row Level Security (RLS)[](#enabling-row-level-security-rls)
...
#### Generate the Supabase `access_token` JWT in the session callback[](#generate-the-supabase-access_token-jwt-in-the-session-callback)
...
#### Inject the Supabase `access_token` JWT into the client[](#inject-the-supabase-access_token-jwt-into-the-client)
...
#### Extend the session type with the `supabaseAccessToken`[](#extend-the-session-type-with-the-supabaseaccesstoken)
...
[Sequelize](/getting-started/adapters/sequelize "Sequelize")[SurrealDB](/getting-started/adapters/surrealdb "SurrealDB")
