[Getting Started](/getting-started "Getting Started")[Providers](/getting-started/providers/42-school "Providers")Nodemailer
...
Express not documented yet. Help us by contributing [here](https://github.com/nextauthjs/next-auth/edit/main/docs/pages/getting-started/providers/nodemailer.mdx).
...
Qwik not documented yet. Help us by contributing [here](https://github.com/nextauthjs/next-auth/edit/main/docs/pages/getting-started/providers/nodemailer.mdx).
...
If you want to generate great looking emails with React that are compatible with many email clients, check out [mjml](https://mjml.io) or [react-email](https://react.email)
...
### Normalizing Email Addresses[](#normalizing-email-addresses)
...
[Nextcloud](/getting-started/providers/nextcloud "Nextcloud")[Notion](/getting-started/providers/notion "Notion")
