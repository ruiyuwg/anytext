[Guides](/guides/debugging "Guides")Edge Compatibility
...
As of Next.js 16, `middleware.ts` has been renamed to `proxy.ts` and now runs on the **Node.js runtime** instead of the edge runtime. If you are using Next.js 16+, the edge compatibility workarounds below may no longer be necessary.
...
[Supporting Corporate Proxies](/guides/corporate-proxy "Supporting Corporate Proxies")[Configuring GitHub for OAuth](/guides/configuring-github "Configuring GitHub for OAuth")
