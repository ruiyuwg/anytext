[Guides](/guides/debugging "Guides")Role-Based Access Control
...
Determining the users role is your responsibility, you can either add your own logic or if your provider returns a role you can use that instead.
...
When using Next.js and JWT, you can alternatively also use [Proxy](/getting-started/session-management/protecting#nextjs-proxy) to redirect the user based on their role, even before rendering the page.
