[Getting Started](/getting-started "Getting Started")[Adapters](/getting-started/adapters/azure-tables "Adapters")SurrealDB

![](/img/adapters/surrealdb.svg)
...
```
bun add @auth/surrealdb-adapter surrealdb
```
...
[Supabase](/getting-started/adapters/supabase "Supabase")[TypeORM](/getting-started/adapters/typeorm "TypeORM")
