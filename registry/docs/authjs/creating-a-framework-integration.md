[Guides](/guides/debugging "Guides")Creating a Framework Integration
...
## Official framework guidelines[](#official-framework-guidelines)
...
### Setting up a new integration[](#setting-up-a-new-integration)
...
[Creating a Database Adapter](/guides/creating-a-database-adapter "Creating a Database Adapter")[Refresh Token Rotation](/guides/refresh-token-rotation "Refresh Token Rotation")
