[Getting Started](/getting-started "Getting Started")[Authentication](/getting-started/authentication "Authentication")WebAuthn 🔬
...
```
bun add @simplewebauthn/server@9.0.3 @simplewebauthn/browser@9.0.1
```
...
### Apply the required schema Migrations[](#apply-the-required-schema-migrations)
...
[Credentials](/getting-started/authentication/credentials "Credentials")[Database](/getting-started/database "Database")
