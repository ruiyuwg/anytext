[Guides](/guides/debugging "Guides")Supporting Corporate Proxies
...
## Using a custom fetch function[](#using-a-custom-fetch-function)
...
Qwik not documented yet. Help us by contributing [here](https://github.com/nextauthjs/next-auth/edit/main/docs/pages/guides/corporate-proxy.mdx).

SvelteKit not documented yet. Help us by contributing [here](https://github.com/nextauthjs/next-auth/edit/main/docs/pages/guides/corporate-proxy.mdx).

Express not documented yet. Help us by contributing [here](https://github.com/nextauthjs/next-auth/edit/main/docs/pages/guides/corporate-proxy.mdx).
...
[Role-Based Access Control](/guides/role-based-access-control "Role-Based Access Control")[Edge Compatibility](/guides/edge-compatibility "Edge Compatibility")
