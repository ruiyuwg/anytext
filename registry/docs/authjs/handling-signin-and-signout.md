[Getting Started](/getting-started "Getting Started")Session ManagementSignin and Signout
...
#### Form Action (Server-Side)[](#form-action-server-side)
...
![Default Sign-in Page](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fdefault-signin-page.cc76bb68.webp&w=3840&q=75)
...
[Database](/getting-started/database "Database")[Get Session](/getting-started/session-management/get-session "Get Session")
