[Guides](/guides/debugging "Guides")[Pages](/guides/pages/built-in-pages "Pages")Custom Signout
...
src/routes/signout/+page.svelte
...
Express not documented yet. Help us by contributing [here](https://github.com/nextauthjs/next-auth/edit/main/docs/pages/guides/pages/signout.mdx).

Now if the user navigates to `/signout` they’ll see the following page:

![Custom Sign-out](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fcustom-sign-out.555cf074.webp&w=3840&q=75)

If they click “Sign out”, the session will be deleted and they will be redirected to the homepage.

[Custom Signin](/guides/pages/signin "Custom Signin")[Custom Error](/guides/pages/error "Custom Error")
