[Guides](/guides/debugging "Guides")Restricting users accessing to the app
...
## Restrict the app to company employees[](#restrict-the-app-to-company-employees)
...
[Extending the Session](/guides/extending-the-session "Extending the Session")[Role-Based Access Control](/guides/role-based-access-control "Role-Based Access Control")
