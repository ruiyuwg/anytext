...
Each bulk export is divided into multiple *runs*, where each run processes data for a [specific date partition](#partitioning-scheme) (typically organized by day). Runs are processed independently, which enables:
