...
- **[Tracing](/oss/javascript/deepagents/cli/overview#tracing-with-langsmith)** - trace agent operations, tool calls, and decisions in LangSmith for observability and debugging.
