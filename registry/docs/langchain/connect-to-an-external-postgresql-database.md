...
stringData:
  ...
  connection_url: "<iam-identity-name>@<rds-host>:5432/?sslmode=require"
```
...
stringData:
  ...
  connection_url: "<service-account>@.iam@<cloud-sql-host>:5432/?sslmode=require"
```
...
backend:
  serviceAccount:
    annotations:
      iam.gke.io/gcp-service-account: "<service-account>@.iam.gserviceaccount.com"
...
stringData:
  ...
  connection_url: "<managed-identity-name>@<azure-postgres-host>:5432/?sslmode=require"
```
