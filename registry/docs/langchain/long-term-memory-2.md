...
```typescript A tool the agent can use to look up user information theme={"theme":{"light":"catppuccin-latte","dark":"catppuccin-mocha"}}
...
```typescript Example of a tool that updates user information theme={"theme":{"light":"catppuccin-latte","dark":"catppuccin-mocha"}}
import * as z from "zod";
