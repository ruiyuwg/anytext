...
3. Optionally add additional scripts or other resources to the `test-skill` folder. For more information, see [Examples](/oss/javascript/deepagents/skills#example).
