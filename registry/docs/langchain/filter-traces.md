...
**Recommended reading**: For more details about the concepts mentioned on this page, refer to the [Conceptual guide on tracing](/langsmith/observability-concepts).
...
Different types of negative filtering can be applied to \*\* Metadata\*\*, \*\* Input\*\*, and \*\* Output\*\* fields to exclude specific runs from your results.
