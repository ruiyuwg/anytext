...
You can connect a Google, GitLab, GitHub and email account to your Strapi Cloud account. The *Connected accounts* section lists accounts that are currently connected to your Strapi Cloud account. From there you can also connect a new Google, GitLab, GitHub and email account if one is not already connected.
