...
**Reminder:** These are the *root-level* options for the Admin Panel. You can
...
**Tip:** You can easily add *new* routes to the Admin Panel through [Custom
...
**Note:** If you set Root-level Routes *before* auto-generating the Admin
...
**Note:** You can also swap out entire *views* out for your own, using the
