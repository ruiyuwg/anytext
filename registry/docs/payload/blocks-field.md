...
- An event agenda where each timeslot could be a `Break`, `Presentation`, or `BreakoutSession`. <LightDarkImage
...
| **`blocks`** \*        | Array of [block configs](../fields/blocks#config-options) to be made available to this field.                                                                                                                                                                                     |
