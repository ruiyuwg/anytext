...
To add a *new* view to the [Admin Panel](../admin/overview), simply add your own key to the `views` object. This is true for all view scopes.
...
property, they will match on URLs that simply *start* with the route's path.
This is helpful when creating catch-all routes in your application.
Alternatively, define your nested route *before* your parent route.
...
*For details on how to build Custom Views, including all available props, see [Building Custom Views](#building-custom-views).*
