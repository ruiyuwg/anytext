...
But here's an important consideration—you generally only want to store information about a given relationship in *one*
place.
...
The `join` field can be used in conjunction with *any* collection - and if you wanted to define your own "junction"
