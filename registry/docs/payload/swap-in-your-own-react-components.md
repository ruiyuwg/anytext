...
are rendering your Client Component *from within* a Server Component, ensure
...
The Admin Panel itself is a [Next.js](https://nextjs.org) application. For this reason, it is *also* important to follow Next.js best practices. This includes bundling, when to use layouts vs pages, where to place the server/client boundary, and more.
