...
*For details on how to build Custom Views, including all available props, see [Building Custom Views](./custom-views#building-custom-views).*

### Document Root

The Document Root is mounted on the top-level route for a Document. Setting this property will completely take over the entire Document View layout, including the title, [Document Tabs](#document-tabs), *and all other nested Document Views* including the [Edit View](./edit-view), API View, etc.
