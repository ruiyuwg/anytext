...
Copy`import {   Select,   SelectContent,   SelectGroup,   SelectItem,   SelectTrigger,   SelectValue, } from "@/components/ui/select"`

Copy`<Select>   <SelectTrigger className="w-[180px]">     <SelectValue placeholder="Theme" />   </SelectTrigger>   <SelectContent>     <SelectGroup>       <SelectItem value="light">Light</SelectItem>       <SelectItem value="dark">Dark</SelectItem>       <SelectItem value="system">System</SelectItem>     </SelectGroup>   </SelectContent> </Select>`
...
Copy`<Field data-invalid>   <FieldLabel>Fruit</FieldLabel>   <SelectTrigger aria-invalid>     <SelectValue />   </SelectTrigger> </Field>`
...
[Installation](#installation)[Usage](#usage)[Examples](#examples)[Align Item With Trigger](#align-item-with-trigger)[Groups](#groups)[Scrollable](#scrollable)[Disabled](#disabled)[Invalid](#invalid)[RTL](#rtl)[API Reference](#api-reference)
