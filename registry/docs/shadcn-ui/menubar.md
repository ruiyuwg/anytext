...
[Previous](/docs/components/radix/label)[Next](/docs/components/radix/native-select)

A visually persistent menu common in desktop applications that provides quick access to a consistent set of commands.

[Radix UI](/docs/components/radix/menubar)[Base UI](/docs/components/base/menubar)
...
[Label](/docs/components/radix/label)[Native Select](/docs/components/radix/native-select)

On This Page

[Installation](#installation)[Usage](#usage)[Examples](#examples)[Checkbox](#checkbox)[Radio](#radio)[Submenu](#submenu)[With Icons](#with-icons)[RTL](#rtl)[API Reference](#api-reference)
