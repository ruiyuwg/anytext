...
[Previous](/docs/installation/vite)[Next](/docs/installation/react-router)
...
[Create Project](#create-project)[Run the shadcn/ui CLI](#run-the-shadcnui-cli)[Add Components](#add-components)
