...
### Search variants[​](#search-variants "Direct link to heading")
...
### Search types[​](#search-types "Direct link to heading")
...
### An example[​](#an-example "Direct link to heading")
...
For more information, see [Which query should I use?](/docs/queries/about#priority).

## Async utilities[​](#async-utilities "Direct link to heading")
...
For more information, see [DOM Testing Library Async API](/docs/dom-testing-library/api-async).

> Remember to `await` or `.then()` the result of async functions in your tests!

## Firing events[​](#firing-events "Direct link to heading")
...
For more information, see [Events API](/docs/dom-testing-library/api-events)

> **Difference from DOM Testing Library**
> 
> The events returned from `Vue Testing Library` are all async, so you should `await` or `then()` the result.
> 
> VTL also exposes `fireEvent.update(node, value)` event to deal with `v-model`. See [the API](/docs/vue-testing-library/api#updateelem-value) for more details.
...
For more information, see [Querying Within Elements](/docs/dom-testing-library/api-within) and [Config API](/docs/dom-testing-library/api-configuration).

## Text Match Options[​](#text-match-options "Direct link to heading")
