...
- [ Supabase client ](#tab-panel-7687)
- [ Hyperdrive ](#tab-panel-7688)
...
2. This command outputs a binding for the [Wrangler configuration file](https://developers.cloudflare.com/workers/wrangler/configuration/):
   - [  wrangler.jsonc ](#tab-panel-7675)
   - [  wrangler.toml ](#tab-panel-7676)
...
- [  wrangler.jsonc ](#tab-panel-7685)
- [  wrangler.toml ](#tab-panel-7686)
