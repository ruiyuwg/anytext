...
6. [Create an API token](https://developers.cloudflare.com/fundamentals/api/get-started/create-token/) with the following permissions:\
   | Type    | Item                 | Permission |\
   | ------- | -------------------- | ---------- |\
   | Account | Access: SSH Auditing | Edit       |

7. If you have not yet generated a Cloudflare SSH CA, make a `POST` request to the Cloudflare API:
...
- [ Debian/Ubuntu ](#tab-panel-3875)
- [ CentOS/RHEL ](#tab-panel-3876)
