...
3. **Add a Wrangler configuration file**\
   ...
   - [  wrangler.jsonc ](#tab-panel-8196)
   - [  wrangler.toml ](#tab-panel-8197)
...
Note\
As shown above, you must enable the [nodejs\_compat compatibility flag](https://developers.cloudflare.com/workers/runtime-apis/nodejs/) *and* set your [compatibility date](https://developers.cloudflare.com/workers/configuration/compatibility-dates/) to `2024-09-23` or later for your Next.js app to work with @opennextjs/cloudflare.
