...
- [  New dashboard ](#tab-panel-3104)
- [ Old dashboard ](#tab-panel-3105)
...
5. Log in to the [Cloudflare dashboard ↗](https://dash.cloudflare.com/login), and select your account and domain.

6. Select **Security** > **API Shield**.

7. Add your endpoints [manually](#add-endpoints-manually), from [Schema validation](#add-endpoints-from-schema-validation), or from [API Discovery](#add-endpoints-from-api-discovery).
...
- [  New dashboard ](#tab-panel-3094)
- [ Old dashboard ](#tab-panel-3095)
...
4. From **Endpoint Management**, select **Add endpoints** > **Select from Discovery** tab.

5. Select the discovered endpoints you would like to add.

6. Select **Add endpoints**.

#### Add from the Discovery tab

- [  New dashboard ](#tab-panel-3096)
- [ Old dashboard ](#tab-panel-3097)
...
4. From Endpoint Management, select the **Discovery** tab.

5. Select the discovered endpoints you would like to add.

6. Select **Save selected endpoints**.

### Add endpoints from Schema validation

- [  New dashboard ](#tab-panel-3098)
- [ Old dashboard ](#tab-panel-3099)
...
5. Add a schema by [configuring Schema validation](https://developers.cloudflare.com/api-shield/security/schema-validation/).

6. On **Review schema endpoints**, save new endpoints to endpoint management by checking the box.

7. Select **Save as draft** or **Save and Deploy**. Endpoints will be saved regardless of whether the schema is saved as a draft or published.
...
- [  New dashboard ](#tab-panel-3100)
- [ Old dashboard ](#tab-panel-3101)
...
5. From Endpoint Management, select **Add endpoints** > **Manually add**.

6. Choose the method from the dropdown menu and add the path and hostname for the endpoint.

7. Select **Add endpoints**.
...
- [  New dashboard ](#tab-panel-3102)
- [ Old dashboard ](#tab-panel-3103)
...
4. From Endpoint Management, select the checkboxes for the endpoints that you want to delete.

5. Select **Delete endpoints**.
