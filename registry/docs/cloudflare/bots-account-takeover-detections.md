...
6. Go to **Security** > **WAF**.

7. Under **Custom rules**, select **Create rule**.

8. Fill out the form using **Bot Detection IDs** along with other necessary information.

9. Select **Save as draft** to return to the rule later, or **Deploy** to deploy the rule.
...
7. Under **Rate limiting rules**, select **Create rule**.

8. Fill out the form using the **Custom expression builder** and `cf.bot_management_detection_ids` along with other necessary information.
