...
query--"Yes"-->hostname["Look up location byunique hostname"]
query--"No"-->ipv4{{"Is it over IPv4?"}}

ipv4--"Yes"-->source["Look up location bysource IPv4 address"]
ipv4--"No"-->destination["Look up location bydestination IPv6 address"]
```
