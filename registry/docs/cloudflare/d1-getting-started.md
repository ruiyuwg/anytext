...
2. Add them to the end of your Wrangler file.
   - [  wrangler.jsonc ](#tab-panel-4062)
   - [  wrangler.toml ](#tab-panel-4063)
...
- See supported [Wrangler commands for D1](https://developers.cloudflare.com/workers/wrangler/commands/d1/#d1).
