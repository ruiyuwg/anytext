...
flowchart LR
D{{DNS request}}-->L\["Local DNS proxy  (127.0.2.2 and 127.0.2.3)"]-->R{In local domain fallback?}
...
- [ macOS ](#tab-panel-3637)
- [ Windows ](#tab-panel-3638)
...
S -- Yes --> A\[(Application)]
S -- No --> U\["Virtual interface (172.16.0.2)"] --> G\[Cloudflare Gateway]
...
- [ macOS ](#tab-panel-3640)
- [ Windows ](#tab-panel-3641)
- [ Linux ](#tab-panel-3642)
