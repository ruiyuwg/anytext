...
2. Find the site you want to make changes on > select the three dots next to it > **Edit**.
3. In **Basic information**, make changes to the site's name, description, and geographic coordinates.
4. In **On-ramps**, add new on-ramps to your site. You can also remove existing ones.
