...
- [  JavaScript ](#tab-panel-5994)
- [  TypeScript ](#tab-panel-5995)
- [  Python ](#tab-panel-5996)
...
- `sendBatch(messagesIterable<MessageSendRequest<unknown>>, options?QueueSendBatchOptions)` Promise
