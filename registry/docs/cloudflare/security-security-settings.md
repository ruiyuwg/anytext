...
The client-side abuse security category includes features and settings from [Page Shield](https://developers.cloudflare.com/page-shield/) and [Scrape Shield](https://developers.cloudflare.com/waf/tools/scrape-shield/) in the previous dashboard navigation structure.
