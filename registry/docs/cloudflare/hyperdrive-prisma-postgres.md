...
- [ Dashboard ](#tab-panel-4918)
- [ Wrangler CLI ](#tab-panel-4919)
...
2. This command outputs a binding for the [Wrangler configuration file](https://developers.cloudflare.com/workers/wrangler/configuration/):
   - [  wrangler.jsonc ](#tab-panel-4910)
   - [  wrangler.toml ](#tab-panel-4911)
...
4. Edit your existing Hyperdrive configuration with the `--origin-connection-limit` parameter:\
   Terminal window
