...
2. To restrict the API token to specific IP addresses, use the **Client IP Address Filtering** controls.
...
3. To define how long the token is valid, select the **TTL** (time-to-live) start/end date.
