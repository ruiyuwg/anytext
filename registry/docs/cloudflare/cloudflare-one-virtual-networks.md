...
- [ Terraform (v5) ](#tab-panel-3486)
- [ Locally-managed tunnels ](#tab-panel-3487)
...
- [ Dashboard ](#tab-panel-3481)
- [ Locally-managed tunnels ](#tab-panel-3482)
...
- [ Version 2026.2+ ](#tab-panel-3483)
- [ Version 2026.1 and earlier ](#tab-panel-3484)
...
5. Go to **Settings** > **Traffic and DNS mode** > **Virtual Networks**.

6. Choose the virtual network you want to connect to, for example `staging-vnet`.
