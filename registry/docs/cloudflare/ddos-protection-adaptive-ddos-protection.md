...
5. Go to **Security** > **Events**.

6. Filter by `Service equals HTTP DDoS` and by rule ID.

To view traffic flagged by L3/4 Adaptive DDoS Protection rules:

- [  New dashboard ](#tab-panel-4247)
- [ Old dashboard ](#tab-panel-4248)
...
4. In the Cloudflare dashboard, go to the **Network analytics** page.\
