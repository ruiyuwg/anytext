...
4. Select the **Alert Sensitivity Level** threshold from the drop-down menu. The threshold defaults to *Medium (98.0)*. You can choose from options between *Minimum (95.0)* and *Maximum (99.9)*. For details, refer to [How Cloudflare calculates Tunnel health alerts](https://developers.cloudflare.com/magic-transit/reference/how-cloudflare-calculates-tunnel-health-alerts/).
