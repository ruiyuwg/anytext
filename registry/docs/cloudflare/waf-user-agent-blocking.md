...
- [  New dashboard ](#tab-panel-7377)
- [ Old dashboard ](#tab-panel-7378)
- [ API ](#tab-panel-7379)
...
8. Go to **Security** > **WAF**, and select the **Tools** tab.

9. Under **User Agent Blocking**, select **Create blocking rule**.

10. Enter a descriptive name for the rule in **Name/Description**.

11. In **Action**, select the action to perform: *Block*, *Non-Interactive Challenge*, *Managed Challenge*, or *Interactive Challenge*.

12. Enter a user agent value in **User Agent** (wildcards such as `*` are not supported). For example, to block the Bad Bot web spider, enter `BadBot/1.0.2 (+http://bad.bot)`.

13. Select **Save and Deploy blocking rule**.
