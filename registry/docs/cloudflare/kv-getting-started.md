...
1. In your Wrangler file, add the following with the values generated in your terminal from [step 2](https://developers.cloudflare.com/kv/get-started/#2-create-a-kv-namespace):
   - [  wrangler.jsonc ](#tab-panel-5203)
   - [  wrangler.toml ](#tab-panel-5204)
...
6. In the Cloudflare dashboard, go to the **Workers & Pages** page.\
   [ Go to **Workers & Pages** ](https://dash.cloudflare.com/?to=/:account/workers-and-pages)

7. Go to the `kv-tutorial` Worker you created.

8. Select **Edit Code**.

9. Clear the contents of the `workers.js` file, then paste the following code.
...
4. Select the dropdown arrow next to **Deploy** and select **Save**.
...
3. In the Cloudflare dashboard, go to the **Workers & Pages** page.\
   [ Go to **Workers & Pages** ](https://dash.cloudflare.com/?to=/:account/workers-and-pages)

4. Select your `kv-tutorial` Worker.

5. Select **Deployments**.

6. From the **Version History** table, select **Deploy version**.

7. From the **Deploy version** page, select **Deploy**.\
