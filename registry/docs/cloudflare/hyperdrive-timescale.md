...
- [ Dashboard ](#tab-panel-4942)
- [ Wrangler CLI ](#tab-panel-4943)
...
2. This command outputs a binding for the [Wrangler configuration file](https://developers.cloudflare.com/workers/wrangler/configuration/):
   - [  wrangler.jsonc ](#tab-panel-4934)
   - [  wrangler.toml ](#tab-panel-4935)
...
- [  wrangler.jsonc ](#tab-panel-4944)
- [  wrangler.toml ](#tab-panel-4945)
