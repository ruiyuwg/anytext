...
1. [Download the Cloudflare\_WARP\_.msi installer](https://developers.cloudflare.com/cloudflare-one/team-and-resources/devices/cloudflare-one-client/download/#windows).
...
2. Under **Manage devices**, select **Configuration**.
3. Select **Create** > **New Policy**.
4. For **Profile type**, select *Settings catalog* > select **Create**.
