...
- [  New dashboard ](#tab-panel-3313)
- [ Old dashboard ](#tab-panel-3314)
...
5. Select **Configure Bot Management**.

6. For **JavaScript Detections**, switch the toggle to **On**.
...
- [ WAF rule example ](#tab-panel-3311)
- [ Workers example ](#tab-panel-3312)
