...
5. Run the following command to [allocate a public IP address ↗](https://fly.io/docs/postgres/connecting/connecting-external/#allocate-an-ip-address).
...
- [ Dashboard ](#tab-panel-4832)
- [ Wrangler CLI ](#tab-panel-4833)
...
2. This command outputs a binding for the [Wrangler configuration file](https://developers.cloudflare.com/workers/wrangler/configuration/):
   - [  wrangler.jsonc ](#tab-panel-4824)
   - [  wrangler.toml ](#tab-panel-4825)
