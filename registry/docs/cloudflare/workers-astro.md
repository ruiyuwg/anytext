...
1. **Add a Wrangler configuration file**\
   ...
   - [  wrangler.jsonc ](#tab-panel-8043)
   - [  wrangler.toml ](#tab-panel-8044)
...
3. **Add a Wrangler configuration file**\
   In your project root, create a Wrangler configuration file with the following content:
   - [  wrangler.jsonc ](#tab-panel-8047)
   - [  wrangler.toml ](#tab-panel-8048)
...
- [  wrangler.jsonc ](#tab-panel-8045)
- [  wrangler.toml ](#tab-panel-8046)
