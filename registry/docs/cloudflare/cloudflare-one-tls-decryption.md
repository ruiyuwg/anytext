...
- [ Dashboard ](#tab-panel-3844)
- [ Terraform (v5) ](#tab-panel-3845)
...
4. Configure the `tls_decrypt` argument in [cloudflare\_zero\_trust\_gateway\_settings ↗](https://registry.terraform.io/providers/cloudflare/cloudflare/latest/docs/resources/zero%5Ftrust%5Fgateway%5Fsettings):
...
- [ Pass through policy ](#tab-panel-3841)
- [ Chrome browser flag ](#tab-panel-3842)
- [ Chrome enterprise policy ](#tab-panel-3843)
...
- [ Dashboard ](#tab-panel-3846)
- [ Terraform (v5) ](#tab-panel-3847)
