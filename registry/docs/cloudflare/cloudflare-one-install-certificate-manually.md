...
- [  macOS and Linux ](#tab-panel-3714)
...
- [ Keychain Access ](#tab-panel-3747)
- [ Terminal ](#tab-panel-3748)
...
- [  Debian-based ](#tab-panel-3716)
- [  Red Hat-based ](#tab-panel-3717)
- [  NixOS ](#tab-panel-3718)
...
- [ VPN and apps ](#tab-panel-3749)
- [ CA certificate ](#tab-panel-3750)
...
8. [Download a Cloudflare certificate](#download-the-cloudflare-root-certificate) in `.crt` format.

9. Go to **Settings** > **Apps** > **Google Play Store**.

10. Select **Manage Android preferences**.

11. Go to **Security & location** > **Credentials** > **Install a certificate > CA certificate**.

12. When prompted with a privacy warning, select **Install anyway**.

13. In the file open dialog, choose the `certificate.crt` file you downloaded. Select **Open**.

14. To verify the certificate is installed and trusted, go to **Settings** > **Apps** > **Google Play Store** > **Manage Android Preferences** > **Security** > **Credentials** > **Trusted credentials** > **User**.
...
- [  Windows ](#tab-panel-3719)
- [  macOS and Linux ](#tab-panel-3720)
...
7. [Download a Cloudflare certificate](#download-a-cloudflare-root-certificate) in `.pem` format.

8. In a terminal, install the `certifi` package:\
   Terminal window
...
- [  macOS and Linux ](#tab-panel-3721)
- [  Windows ](#tab-panel-3722)
...
5. Install [OpenSSL for Windows ↗](https://slproweb.com/products/Win32OpenSSL.html).

6. In an administrator PowerShell terminal, format the Cloudflare certificate for Java.\
   PowerShell
...
- [  macOS and Linux ](#tab-panel-3723)
- [  Windows ](#tab-panel-3724)
...
7. Install [OpenSSL for Windows ↗](https://slproweb.com/products/Win32OpenSSL.html).

8. In a PowerShell terminal, format the Cloudflare certificate for Ruby.\
   PowerShell
...
- [  Windows ](#tab-panel-3725)
- [  macOS and Linux ](#tab-panel-3726)
...
- [  Windows ](#tab-panel-3727)
- [  macOS and Linux ](#tab-panel-3728)
...
4. Add the certificate to your Docker image:
   - [ During build process ](#tab-panel-3729)
   - [ During runtime ](#tab-panel-3730)\
...
- [  macOS ](#tab-panel-3731)
- [  Windows ](#tab-panel-3732)
- [  Linux ](#tab-panel-3733)
...
- [  macOS ](#tab-panel-3734)
- [  Windows ](#tab-panel-3735)
- [  Linux ](#tab-panel-3736)
...
- [  macOS and Linux ](#tab-panel-3737)
- [  Windows ](#tab-panel-3738)
...
4. In an administrator PowerShell terminal, add the JRE path you copied as an environment variable.\
   PowerShell
...
2. Add the Cloudflare certificate to Eclipse's JVM:

- [  macOS and Linux ](#tab-panel-3739)
...
4. In a terminal, add the `java.home` value you copied as an environment variable.\
   PowerShell
...
- [  macOS and Linux ](#tab-panel-3741)
- [  Windows ](#tab-panel-3742)
...
- [  macOS and Linux ](#tab-panel-3743)
- [  Windows ](#tab-panel-3744)
