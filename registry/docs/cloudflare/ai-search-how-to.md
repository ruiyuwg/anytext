...
[ Edit page ](https://github.com/cloudflare/cloudflare-docs/edit/production/src/content/docs/ai-search/how-to/index.mdx) [ Report issue ](https://github.com/cloudflare/cloudflare-docs/issues/new/choose)
...
- [ Migrate from AutoRAG Search API ](https://developers.cloudflare.com/ai-search/how-to/migrate-from-autorag-api/)
