...
- [  JavaScript ](#tab-panel-8651)
- [  TypeScript ](#tab-panel-8652)
...
- `generateKey(algorithm, extractable, keyUsages)` : Promise | Promise
...
- `deriveKey(algorithm, baseKey, derivedKeyAlgorithm, extractable, keyUsages)` : Promise
...
- `exportKey(formatstring, keyCryptoKey)` : Promise
...
- `wrapKey(format, key, wrappingKey, wrapAlgo)` : Promise
...
- `unwrapKey(format, key, unwrappingKey, unwrapAlgo,  
   unwrappedKeyAlgo, extractable, keyUsages)` : Promise
