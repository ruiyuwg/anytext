...
![Example expression of a WAF Custom Rule with action block using the cf.tls\_client\_auth.cert\_fingerprint\_sha256 field](https://developers.cloudflare.com/_astro/waf-client-certificates-fingerprint.BqsBG7GT_hgTk0.webp)
