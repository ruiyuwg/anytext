...
cf1\["cloudflared  (Replica for tunnel-01)"]
cf2\["cloudflared  (Replica for tunnel-01)"]
S1\[Application]
cf1-->S1
cf2-->S1
end
C -- "Connections x 4 "--> cf1
C --> cf1
C --> cf1
C --> cf1
...
| [--metrics](https://developers.cloudflare.com/tunnel/advanced/run-parameters/#metrics)   | 127.0.0.1:2024x | Prometheus metrics endpoint address            |
