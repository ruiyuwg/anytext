...
```
%% User traffic
user(["User goes to risky.example.com"])--"Connects to"-->cloud[Third-party SWG cloud]
...
biso--"User's browser goes to customer.cloudflareaccess.com/browser/risky.example.com"-->inline
end
```
