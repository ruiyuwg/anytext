...
- [ Dashboard ](#tab-panel-4954)
- [ Wrangler CLI ](#tab-panel-4955)
...
2. This command outputs a binding for the [Wrangler configuration file](https://developers.cloudflare.com/workers/wrangler/configuration/):
   - [  wrangler.jsonc ](#tab-panel-4946)
   - [  wrangler.toml ](#tab-panel-4947)
...
- [  wrangler.jsonc ](#tab-panel-4956)
- [  wrangler.toml ](#tab-panel-4957)
