...
[ Edit page ](https://github.com/cloudflare/cloudflare-docs/edit/production/src/content/docs/page-shield/how-it-works/malicious-script-detection.mdx) [ Report issue ](https://github.com/cloudflare/cloudflare-docs/issues/new/choose)
...
```json
{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"item":{"@id":"/directory/","name":"Directory"}},{"@type":"ListItem","position":2,"item":{"@id":"/page-shield/","name":"Page Shield"}},{"@type":"ListItem","position":3,"item":{"@id":"/page-shield/how-it-works/","name":"How Page Shield works"}},{"@type":"ListItem","position":4,"item":{"@id":"/page-shield/how-it-works/malicious-script-detection/","name":"Malicious script and connection detection"}}]}
```
