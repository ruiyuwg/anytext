...
| [Email](https://developers.cloudflare.com/email-routing/email-workers/runtime-api/)       |       |
| [Fetch](https://developers.cloudflare.com/workers/runtime-apis/handlers/fetch/)           |           |
| [Queue](https://developers.cloudflare.com/queues/configuration/javascript-apis/#consumer) |            |
...
| [WebSocket](https://developers.cloudflare.com/workers/examples/websockets/)               |  |
...
- [  Module Worker ](#tab-panel-8458)
- [  Service Worker ](#tab-panel-8459)
