...
- [  New dashboard ](#tab-panel-7294)
- [ Old dashboard ](#tab-panel-7295)
- [ API ](#tab-panel-7296)
- [ Terraform ](#tab-panel-7297)
...
6. Under **Incoming traffic detections**, turn on **Malicious uploads**.
...
- [  New dashboard ](#tab-panel-7298)
- [ Old dashboard ](#tab-panel-7299)
- [ API ](#tab-panel-7300)
- [ Terraform ](#tab-panel-7301)
...
8. Go to **Security** > **Settings**.

9. Under **Incoming traffic detections**, select **Malicious uploads**.

10. Select **Add content object location**.

11. In **Content location**, enter your custom scan expression. For example:
