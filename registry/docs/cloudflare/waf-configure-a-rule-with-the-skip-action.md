...
- [  New dashboard ](#tab-panel-7263)
- [ Old dashboard ](#tab-panel-7264)
- [ API ](#tab-panel-7265)
...
8. Go to **Security** > **WAF** > **Custom rules**.

9. [Create a custom rule](https://developers.cloudflare.com/waf/custom-rules/create-dashboard/) by selecting **Create rule**, or edit an existing custom rule.

10. Define the rule name and the rule expression.

11. Under **Choose action**, select *Skip* from the dropdown.\
    ![Available Skip action options when configuring a custom rule](https://developers.cloudflare.com/_astro/skip-action-options.N8Emdhwv_Z1dhCLt.webp)

12. Configure the desired [skip options](https://developers.cloudflare.com/waf/custom-rules/skip/options/).
