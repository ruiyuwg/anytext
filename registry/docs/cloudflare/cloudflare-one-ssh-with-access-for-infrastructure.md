...
2. Edit your Split Tunnel routes depending on the mode:
   - [ Exclude IPs and domains ](#tab-panel-3535)
   - [ Include IPs and domains ](#tab-panel-3536)\
   ...
   5. [Add a route](https://developers.cloudflare.com/cloudflare-one/team-and-resources/devices/cloudflare-one-client/configure/route-traffic/split-tunnels/#add-a-route) to include your SSH server's IP/CIDR range.
...
- [ Dashboard ](#tab-panel-3532)
- [ API ](#tab-panel-3533)
- [ Terraform (v4) ](#tab-panel-3534)
...
- [ Debian/Ubuntu ](#tab-panel-3523)
- [ CentOS/RHEL ](#tab-panel-3524)
...
SSH sessions have a maximum expected duration of 10 hours. For more information, refer to the [Troubleshooting FAQ](https://developers.cloudflare.com/cloudflare-one/faq/troubleshooting/#long-lived-ssh-sessions-frequently-disconnect).
...
7. [Reload](#reload-your-ssh-server) your SSH server.\
   ...
   Once you have modified your `sshd` configuration, reload the SSH service on the remote machine for the changes to take effect.
   - [ Debian/Ubuntu ](#tab-panel-3525)
   - [ CentOS/RHEL ](#tab-panel-3526)\
     For Debian/Ubuntu:\
     Terminal window
