...
4. Enter the required information based on the payment options below:**Credit card**:
   ...
   3. Select the **PayPal**.
   4. Follow the online instructions until PayPal returns you to the Cloudflare **Payment Method** to continue your set-up.
   5. Verify your **PayPal username** now appears next to the PayPal logo.
   6. Add your account contact information as well as **Company** and **VAT/GST Number**, if applicable.
