...
A\[LoadingWidget is processing the challenge. ] --> B\[Interaction\*Visitor needs to check the box. \*Managed mode only.]
B --> C\[SuccessThe Challenge was completed successfully.]
