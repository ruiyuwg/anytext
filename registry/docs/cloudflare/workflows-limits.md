...
| Maximum steps per Workflow [2](#user-content-fn-5)                                                                             | 1,024                                                                                                                             | 10,000 (default) / configurable up to 25,000                                                                                               |
...
Each Workflow instance supports 10,000 steps by default, but this can be increased up to 25,000 steps in your Wrangler configuration. Refer to [Workflow step limits](https://developers.cloudflare.com/workflows/build/workers-api/#workflowsteplimit) for more information.
...
2. `step.sleep` does not count towards the maximum steps limit [↩](#user-content-fnref-5)
