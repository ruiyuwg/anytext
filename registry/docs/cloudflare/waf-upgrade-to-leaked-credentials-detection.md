...
- [  New dashboard ](#tab-panel-7310)
- [ Old dashboard ](#tab-panel-7311)
...
5. Go to **Security** > **WAF** > **Managed rules** tab.

6. Under **Managed rules**, edit the rule that executes the Cloudflare Exposed Credentials Check Ruleset and take note of the current configuration (namely the performed action). Next, delete (or turn off) that rule.
...
- [  New dashboard ](#tab-panel-7312)
- [ Old dashboard ](#tab-panel-7313)
- [ API ](#tab-panel-7314)
- [ Terraform ](#tab-panel-7315)
...
6. Under **Incoming traffic detections**, turn on **Leaked credentials**.
