...
3. Manually install the Cloudflare One Client on the device.\
   ...
   - [ Version 2026.2+ ](#tab-panel-5514)
   - [ Version 2026.1 and earlier ](#tab-panel-5515)
   ...
   16. [Download](https://developers.cloudflare.com/cloudflare-one/team-and-resources/devices/cloudflare-one-client/download/) and install the Cloudflare One Agent app.
   17. Launch the Cloudflare One Agent app.
   18. Select **Next**.
   19. Review the privacy policy and select **Accept**.
   20. Enter your team name.
   21. Complete the authentication steps required by your organization.
   22. After authenticating, select **Install VPN Profile**.
   23. In the **Connection request** popup window, select **OK**.
   24. If you did not enable [auto-connect ↗](https://developers.cloudflare.com/cloudflare-one/team-and-resources/devices/cloudflare-one-client/configure/settings/#auto-connect), manually turn on the switch to **Connected**.
