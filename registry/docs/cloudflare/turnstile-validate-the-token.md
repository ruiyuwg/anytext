...
| idempotency\_key | No       | UUID for retry protection                              |
...
- [ Successful response ](#tab-panel-7197)
- [ Failed response ](#tab-panel-7198)
...
| challenge\_ts          | ISO timestamp when the challenge was solved     |
