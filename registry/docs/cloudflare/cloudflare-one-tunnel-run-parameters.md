...
- [ Linux ](#tab-panel-3450)
- [ macOS ](#tab-panel-3451)
- [ Windows ](#tab-panel-3452)
...
| -------------------------------------------------------------- | --------------------------- |
| cloudflared tunnel --edge-bind-address  run  | TUNNEL\_EDGE\_BIND\_ADDRESS |
...
| ----------------------------------------------------------------- | ------- | ------------------------- |
| cloudflared tunnel --edge-ip-version  run  | 4       | TUNNEL\_EDGE\_IP\_VERSION |
...
| Syntax                                                        | Default | Environment Variable  |
| ------------------------------------------------------------- | ------- | --------------------- |
| cloudflared tunnel --grace-period  run  | 30s     | TUNNEL\_GRACE\_PERIOD |
...
| Syntax                                                 | Environment Variable |
| ------------------------------------------------------ | -------------------- |
| cloudflared tunnel --logfile  run  | TUNNEL\_LOGFILE      |
...
| Syntax                                                   | Default | Environment Variable |
| -------------------------------------------------------- | ------- | -------------------- |
| cloudflared tunnel --loglevel  run  | info    | TUNNEL\_LOGLEVEL     |
...
| Syntax                                                    | Default                                                                                                                                    | Environment Variable |
| --------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------ | -------------------- |
| cloudflared tunnel --metrics <IP:PORT> run  | Refer to [Tunnel metrics](https://developers.cloudflare.com/cloudflare-one/networks/connectors/cloudflare-tunnel/monitor-tunnels/metrics/) | TUNNEL\_METRICS      |
...
| Syntax                                                | Environment Variable |
| ----------------------------------------------------- | -------------------- |
| cloudflared tunnel --no-autoupdate run  | NO\_AUTOUPDATE       |
...
| Syntax                                                    | Default                  | Environment Variable |
| --------------------------------------------------------- | ------------------------ | -------------------- |
| cloudflared tunnel --origincert  run  | ~/.cloudflared/cert.pem | TUNNEL\_ORIGIN\_CERT |
...
| Syntax                                                 | Environment Variable |
| ------------------------------------------------------ | -------------------- |
| cloudflared tunnel --pidfile  run  | TUNNEL\_PIDFILE      |
...
| Syntax                                               | Environment Variable  |
| ---------------------------------------------------- | --------------------- |
| cloudflared tunnel run --post-quantum  | TUNNEL\_POST\_QUANTUM |
...
| Syntax                                                   | Default | Environment Variable        |
| -------------------------------------------------------- | ------- | --------------------------- |
| cloudflared tunnel --protocol  run  | auto    | TUNNEL\_TRANSPORT\_PROTOCOL |
...
| Syntax                                                 | Environment Variable |
| ------------------------------------------------------ | -------------------- |
| cloudflared tunnel --region  run  | TUNNEL\_REGION       |
...
| Syntax                                                  | Default | Environment Variable |
| ------------------------------------------------------- | ------- | -------------------- |
| cloudflared tunnel --retries  run  | 5       | TUNNEL\_RETRIES      |
...
| Syntax                                                | Environment Variable |
| ----------------------------------------------------- | -------------------- |
| cloudflared tunnel --tag \<KEY=VAL> run  | TUNNEL\_TAG          |
...
| Syntax                                     | Environment Variable |
| ------------------------------------------ | -------------------- |
| cloudflared tunnel run --token-file  | TUNNEL\_TOKEN\_FILE  |
