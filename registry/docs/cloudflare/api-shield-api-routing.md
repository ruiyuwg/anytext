...
- [  New dashboard ](#tab-panel-3082)
- [ Old dashboard ](#tab-panel-3083)
...
7. Filter the endpoints to find your **Source Endpoint**.

8. Expand the row for your Source Endpoint and note the **operation ID** field.

9. Select the copy icon to copy the operation ID to your clipboard.
...
- [  New dashboard ](#tab-panel-3084)
- [ Old dashboard ](#tab-panel-3085)
...
8. In **Endpoint Management**, select an existing endpoint and expand its details.

9. Under **Routing**, select **Create route**.

10. Enter the target URL or IP address to route your endpoint to.

11. Select **Deploy route**.
