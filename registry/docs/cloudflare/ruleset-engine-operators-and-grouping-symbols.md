...
| Is in set of values / list3                           | in                | ✅                    | ✅  | ✅      | ip.src **in** { 203.0.113.0 203.0.113.1 }ip.src.asnum **in** $ |                                                             |
...
- *starts with* (corresponding to the [starts\_with()](https://developers.cloudflare.com/ruleset-engine/rules-language/functions/#starts%5Fwith) function): Returns `true` when a string starts with a given substring, and `false` otherwise.
- *ends with* (corresponding to the [ends\_with()](https://developers.cloudflare.com/ruleset-engine/rules-language/functions/#ends%5Fwith) function): Returns `true` when a string ends with a given substring, and `false` otherwise.
