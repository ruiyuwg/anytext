...
7. Depending on what you wish to override, refer to the following sections (you can perform both configurations on the same override):\
   ...
   5. Search for the rules you wish to override using the available filters. You can search for tags.
   6. To override a single rule, select the desired value for a field in the displayed dropdowns next to the rule.\
...
- [  New dashboard ](#tab-panel-4257)
- [ Old dashboard ](#tab-panel-4258)
...
5. Log in to the [Cloudflare dashboard ↗](https://dash.cloudflare.com/), and select your account.

6. Go to **Security** > **DDoS**.

7. Next to the DDoS override you wish to delete, select **Delete**.

8. Select **Delete** to confirm the operation.
