...
- [ Windows ](#tab-panel-3465)
- [ macOS ](#tab-panel-3466)
- [ Debian ](#tab-panel-3467)
- [ Red Hat ](#tab-panel-3468)
- [ Docker ](#tab-panel-3469)
- [ Other ](#tab-panel-3470)
...
\*\*If you created a remotely or locally-managed tunnel using the \[API]\(/cloudflare-one/networks/connectors/cloudflare-tunnel/get-started/create-remote-tunnel-api/), run the following command:\*\*
...
**If you created a locally-managed tunnel using the [CLI](https://developers.cloudflare.com/cloudflare-one/networks/connectors/cloudflare-tunnel/do-more-with-tunnels/local-management/create-local-tunnel/#2-authenticate-cloudflared):**
