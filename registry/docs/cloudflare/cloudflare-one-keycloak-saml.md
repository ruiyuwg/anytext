...
3. Set the built-in protocol mapper for the `email` property.\
...
4. In [Cloudflare One ↗](https://one.dash.cloudflare.com/), go to **Integrations** > **Identity providers**.
5. Under **Your identity providers**, select **Add new identity provider**.
6. Choose **SAML** on the next page.\
