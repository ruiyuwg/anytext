...
- [  New dashboard ](#tab-panel-6972)
- [ Old dashboard ](#tab-panel-6973)
...
4. Log in to the [Cloudflare dashboard ↗](https://dash.cloudflare.com/), select your account and domain.

5. Go to **Security** > **Settings**.

6. Next to **Enable Security.txt**, select **Edit Security.txt**.
