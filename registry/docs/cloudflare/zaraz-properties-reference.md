...
| *Region*       | Returns the [ISO 3166-2 ↗](https://en.wikipedia.org/wiki/ISO%5F3166-2) name for the first level region associated with the IP address of the incoming request. For example, Lisbon. |
| *Region* code  | Returns the [ISO 3166-2 ↗](https://en.wikipedia.org/wiki/ISO%5F3166-2) region code associated with the IP address of the incoming request. For example, 11.                         |
