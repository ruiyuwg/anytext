...
- [  New dashboard ](#tab-panel-7320)
- [ Old dashboard ](#tab-panel-7321)
...
8. Under **Managed Rulesets**, select **Deploy** next to a managed ruleset.\
...
- [  New dashboard ](#tab-panel-7318)
- [ Old dashboard ](#tab-panel-7319)
...
10. Next to the *Execute* rule deploying the managed ruleset you want to configure, select the managed ruleset name.\
    If you have not deployed the managed ruleset yet, select the managed ruleset name under **Managed Rulesets**.

11. (Optional) To execute the managed ruleset for a subset of incoming requests, select **Edit scope** and [configure the expression](https://developers.cloudflare.com/ruleset-engine/rules-language/expressions/edit-expressions/) that will determine the scope of the current rule deploying the managed ruleset.

12. Under **Ruleset configuration**, define settings for all the rules in the ruleset using the drop-down lists.\
    For example, select the action to perform for all the rules in the ruleset.

13. If you have not deployed the managed ruleset yet:
...
12. If you have already deployed the managed ruleset you want to configure, select the ruleset name in the list of deployed managed rulesets. Alternatively, select the three dots > **Edit** next to the *Execute* rule deploying the managed ruleset.\
...
- [  New dashboard ](#tab-panel-7324)
- [ Old dashboard ](#tab-panel-7325)
...
10. If you have already deployed the managed ruleset you want to configure, select the ruleset name in the list of deployed managed rulesets. Alternatively, select the three dots > **Edit** next to the *Execute* rule deploying the managed ruleset.\
    If you have not deployed the managed ruleset, select the ruleset name under **Managed Rulesets**.
...
- [  New dashboard ](#tab-panel-7322)
- [ Old dashboard ](#tab-panel-7323)
...
5. Log in to the [Cloudflare dashboard ↗](https://dash.cloudflare.com/), and select your account and domain.

6. Go to **Security** > **WAF** > **Managed rules** tab.

7. If you have already deployed the managed ruleset you want to configure, select the ruleset name in the list of deployed managed rulesets. Alternatively, select the three dots > **Edit** next to the *Execute* rule deploying the managed ruleset.\
   If you have not deployed the managed ruleset, select the ruleset name under **Managed Rulesets**.

8. Select **Browse rules**.

### Delete a managed ruleset deployment rule or an exception

- [  New dashboard ](#tab-panel-7316)
- [ Old dashboard ](#tab-panel-7317)
...
7. Next to the rule or exception (skip rule) you want to delete, select the three dots > **Delete** and confirm the operation.
