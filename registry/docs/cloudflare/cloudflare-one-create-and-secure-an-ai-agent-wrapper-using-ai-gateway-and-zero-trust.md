...
4. Go to **Access controls** > **Policies**.
5. Select **Add a policy**.
6. Set the **Action** to *Allow*.
7. In **Add rules**, add identity rules to define who the application should be isolated for.
8. In **Additional settings (optional)**, turn on **Isolate application**.
