...
RunWorkerFirst-->|Request matches run\_worker\_first path|WorkerScriptInvoked
RunWorkerFirst-->|Request matches run\_worker\_first negative path|AssetServing
...
subgraph single-page-application
	...
	SPAServed@{ shape: stadium, label: "**200 OK**/index.html page served" }
end
```
