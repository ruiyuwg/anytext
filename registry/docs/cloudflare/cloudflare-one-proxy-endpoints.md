...
5. Configure your PAC file:\
   ...
   5. Choose a browser.
   6. Follow the instructions in Cloudflare One to configure devices.
6. Select **Create**.
...
4. Use the [List proxy endpoints](https://developers.cloudflare.com/api/resources/zero%5Ftrust/subresources/gateway/subresources/proxy%5Fendpoints/methods/list/) operation to get a list of your proxy endpoints and their details. For example:\
...
- [ macOS and Linux ](#tab-panel-3585)
- [ Windows ](#tab-panel-3586)
