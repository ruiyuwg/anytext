...
- [ Linux ](#tab-panel-7143)
- [ macOS ](#tab-panel-7144)
- [ Windows ](#tab-panel-7145)
...
| Syntax                                                    | Default                                                                                 | Environment Variable |
| --------------------------------------------------------- | --------------------------------------------------------------------------------------- | -------------------- |
| cloudflared tunnel --metrics <IP:PORT> run  | Refer to [Tunnel metrics](https://developers.cloudflare.com/tunnel/monitoring/#metrics) | TUNNEL\_METRICS      |
