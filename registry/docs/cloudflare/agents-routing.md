...
- [  wrangler.jsonc ](#tab-panel-2543)
- [  wrangler.toml ](#tab-panel-2544)
...
flowchart TD
A\["HTTP Requestor WebSocket"] --> B\["routeAgentRequestParse URL path"]
B --> C\["Find binding inenv by name"]
C --> D\["Get/create DOby instance ID"]
D --> E\["Agent Instance"]
E --> F{"Protocol?"}
