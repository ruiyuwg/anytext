...
- [ Posture finding ](#tab-panel-3407)
- [ Content finding ](#tab-panel-3408)
...
6. In [Cloudflare One ↗](https://one.dash.cloudflare.com), go to **Cloud & SaaS findings** > **Content Findings**.

7. Choose **SaaS** or **Cloud**.

8. Select the file name of the detected asset.

9. In **Sharing details**, select the linked file instance.
