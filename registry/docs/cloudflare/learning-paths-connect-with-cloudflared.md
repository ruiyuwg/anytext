...
11. Add the following permission to your [cloudflare\_api\_token ↗](https://registry.terraform.io/providers/cloudflare/cloudflare/latest/docs/resources/api%5Ftoken):
    - `Cloudflare Tunnel Write`

12. Create a tunnel using the [cloudflare\_zero\_trust\_tunnel\_cloudflare ↗](https://registry.terraform.io/providers/cloudflare/cloudflare/latest/docs/resources/zero%5Ftrust%5Ftunnel%5Fcloudflared) resource.
...
5. Install `cloudflared` on a host machine in your private network and run the tunnel:
   - [ Linux ](#tab-panel-5365)
   - [ Windows ](#tab-panel-5366)
   - [ macOS ](#tab-panel-5367)
   - [ Docker ](#tab-panel-5368)
