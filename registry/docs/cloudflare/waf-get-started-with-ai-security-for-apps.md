...
- [  New dashboard ](#tab-panel-7276)
- [ Old dashboard ](#tab-panel-7277)
...
4. Log in to the [Cloudflare dashboard ↗](https://dash.cloudflare.com/login), and select your account and domain.

5. Go to **Security** > **API Shield**.

6. Go to the **Discovery** tab.

7. Find the endpoint receiving requests with LLM prompts in the list and select **Save** next to the endpoint.

If you did not find the endpoint in the **Discovery** tab, you can add it manually:

- [  New dashboard ](#tab-panel-7274)
- [ Old dashboard ](#tab-panel-7275)
...
6. Select **Add endpoints** > **Manually add**.

7. Choose the method from the dropdown menu and add the path and hostname for the endpoint.

8. Select **Add endpoints**.
...
- [  New dashboard ](#tab-panel-7280)
- [ Old dashboard ](#tab-panel-7281)
...
10. Add the `cf-llm` label to the endpoint.
