...
4. Go to **Security** > **WAF** > **Managed rules** tab.
...
4. **A) To skip one or more rules in the ruleset:**
   ...
   4. Select all the rules in the current page by selecting the checkbox in the table header, near **Description/Rule ID**. The table header will display `10 rules selected (of <TOTAL> rules)`.\
   ...
   5. Select **Select all  rules** in the table header to select all the rules across all pages.
5. Select **Next**.
...
7. Find the exception you want to edit and select its name. Exceptions are rules listed with **Action** = **Skip**.

8. Once you have finished making changes, select **Save**.
