...
graph LR
A\[Traffic] --> B\[WAF custom rulesAI Crawl Control: Crawler blocks]
B --> C\[CloudflareBot Solutions]
C --> D\[AI Crawl Control:Pay Per Crawl]
...
- [  New dashboard ](#tab-panel-2991)
- [ Old dashboard ](#tab-panel-2992)
...
6. Go to **Security** > **WAF** > **Custom rules** tab.

7. Identify your WAF custom rule and the AI Crawl Control rule.

8. Drag the rule you wish to prioritize to the top, or modify your WAF custom rule to ensure it does not conflict with your AI Crawl Control configurations.
