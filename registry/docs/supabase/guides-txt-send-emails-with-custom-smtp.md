...
To maintain the health and reputation of the default SMTP sending service, the number of messages your project can send is limited and can change without notice. Currently this value is set to auth.rate\_limits.email.inbuilt\_smtp\_per\_hour messages per hour.
