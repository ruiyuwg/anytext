...
- [Disabling the Data API entirely](#disabling-the-data-api). This is recommended if you *never* need to access your database via Supabase client libraries or the REST and GraphQL endpoints.
