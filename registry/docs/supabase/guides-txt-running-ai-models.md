...
\<StepHikeCompact.Details title="Execute the function" fullWidth>
`bash
      curl --get "https://project-ref.supabase.co/functions/v1/ollama-test" \       --data-urlencode "prompt=write a short rap song about Supabase, the Postgres Developer platform, as sung by Nicki Minaj" \
      -H "Authorization: $ANON_KEY"
      `
\</StepHikeCompact.Details>
\</StepHikeCompact.Step>
