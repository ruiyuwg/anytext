...
\<Image
alt="Diagram showing the architecture of Supabase. The Kong API gateway sits in front of 7 services: GoTrue, PostgREST, Realtime, Storage, pg\_meta, Functions, and pg\_graphql. All the services talk to a single Postgres instance."
src={{
