...
> Open invoices can’t have a credit note with a pending [payment\_intent](https://docs.stripe.com/api/invoices/object.md#invoice_object-payment_intent).
...
- [Stripe data](https://docs.stripe.com/stripe-data.md)
