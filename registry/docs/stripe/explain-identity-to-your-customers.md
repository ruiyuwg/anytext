...
Likewise, remind any of your end-users who request deletion to also reach out to Stripe, because we’re also holding verification data as an independent controller. They can also contact us if they want to opt-out of Stripe using their biometric data. They can contact us at <privacy@stripe.com>.
