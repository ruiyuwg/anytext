...
2. If you have an existing integration that manually lists payment methods, remove the [payment\_method\_types](https://docs.stripe.com/api/payment_intents/object.md#payment_intent_object-payment_method_types) parameter from your integration.
