...
Instead of an address, you can provide their IP address:
...
The [tax\[automatic\_tax\]](https://docs.stripe.com/api/customers/object.md#customer_object-tax-automatic_tax) parameter has the following values:
