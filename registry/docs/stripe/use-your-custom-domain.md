...
- \[ ] Verify your CNAME record is setup
  ...
  ```
   	canonical name = hosted-checkout.stripecdn.com.
  ```
...
3. [Create a payment link](https://docs.stripe.com/payment-links/create.md) in test mode.
...
3. Read the popup confirmation, and click **Remove** to confirm the removal.
...
Cloudflare, our domain provider, occasionally blocks some domains from being automatically added to Cloudflare as part of an additional security check. If you’re seeing an error message in the [Dashboard settings](https://dashboard.stripe.com/settings/custom-domains) about Cloudflare blocking your domain, you can email <abusereply@cloudflare.com> to resolve the issue.
