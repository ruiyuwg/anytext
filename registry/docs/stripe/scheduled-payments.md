...
- The scheduled payments feature is supported only when [collection\_method](https://docs.stripe.com/api/invoices/object.md#invoice_object-collection_method) is set to `send_invoice`.
