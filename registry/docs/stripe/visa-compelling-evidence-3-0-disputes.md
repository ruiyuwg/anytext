...
- You must categorize the disputed transaction as either `merchandise` or `services` in the [merchandise\_or\_services](https://docs.stripe.com/api/disputes/object.md#dispute_object-evidence-enhanced_evidence-visa_compelling_evidence_3-disputed_transaction-merchandise_or_services) field.
...
- If the status is `requires_action`, use the [required\_actions](https://docs.stripe.com/api/disputes/object.md#dispute_object-evidence_details-enhanced_eligibility-visa_compelling_evidence_3-required_actions) array to figure out the extra evidence needed.
...
When providing evidence for this dispute, you can submit any two test environment transactions in the [prior\_undisputed\_transactions.charge](https://docs.stripe.com/api/disputes/object.md#dispute_object-evidence-enhanced_evidence-visa_compelling_evidence_3-prior_undisputed_transactions-charge) field.
