...
2. Comply with our [document retention requirements](https://docs.stripe.com/capital/regulatory-compliance.md#recordkeeping), which includes copying <capital-offers@stripe.com> on all email campaigns.
