...
3. [Request a PAN data import](https://docs.stripe.com/get-started/data-migrations/pan-import.md) from your current processor. This step is only required if you’re migrating to Stripe from another processor. If you’re migrating from Stripe to Stripe, you can skip this prerequisite.
...
| `coupon`                    | Stripe Coupon ID               | `50_off`                                 | The identifier of the coupon to apply to this subscription.                                                                                                                                                                                                                                                                                                                                                   |
...
1. In the CSV file, specify the details of the subscriptions you want to export.
...
1. Click **Upload revised file** to re-upload the corrected CSV (the CSV file size limit is 120 mb).

2. Wait for re-validation to see the latest validation status.
