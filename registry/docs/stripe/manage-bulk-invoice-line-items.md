...
You can set invoice metadata in the same request for any of the above endpoints. Here’s an example calling [update\_lines](https://docs.stripe.com/api/invoices.md).
