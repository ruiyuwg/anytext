...
7. Consider your sensitive data access requirements carefully.

8. Create restricted API keys.

9. Make API requests to obtain sensitive verification results.

10. Roll your keys if they’re compromised.

11. Communicate your sensitive verification results and security measures to your users.
...
You can [expand](https://docs.stripe.com/expand.md) the [last\_verification\_report](https://docs.stripe.com/api/identity/verification_sessions/object.md#identity_verification_session_object-last_verification_report) session field to retrieve the associated VerificationReport.
