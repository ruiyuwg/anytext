...
## [Step 2: Define services in a Compose file](#step-2-define-services-in-a-compose-file)
...
## [Step 3: Build and run your app with Compose](#step-3-build-and-run-your-app-with-compose)
...
## [Step 4: Edit the Compose file to use Compose Watch](#step-4-edit-the-compose-file-to-use-compose-watch)
...
## [Step 5: Re-build and run the app with Compose](#step-5-re-build-and-run-the-app-with-compose)
...
## [Step 7: Split up your services](#step-7-split-up-your-services)
