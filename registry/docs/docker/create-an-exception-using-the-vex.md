...
1. Build the image and push it to a registry.
   ...
   ```console
   $ docker build --provenance=true --sbom=true --tag  --push .
   ```
...
[Edit this page](https://github.com/docker/docs/edit/main/content/manuals/scout/how-tos/create-exceptions-vex.md)

[Request changes](https://github.com/docker/docs/issues/new?template=doc_issue.yml\&location=https%3a%2f%2fdocs.docker.com%2fscout%2fhow-tos%2fcreate-exceptions-vex%2f\&labels=status%2Ftriage)
