...
### [Start Docker Desktop when you sign in to your computer](#start-docker-desktop-when-you-sign-in-to-your-computer)
...
- **Configure this setting with:**
  - **General** settings in [Docker Desktop GUI](https://docs.docker.com/desktop/settings-and-maintenance/settings/)

### [Open Docker Dashboard when Docker Desktop starts](#open-docker-dashboard-when-docker-desktop-starts)
...
### [Choose theme for Docker Desktop](#choose-theme-for-docker-desktop)
...
### [Configure shell completions](#configure-shell-completions)
...
### [Choose container terminal](#choose-container-terminal)
...
- **Configure this setting with:**
  - **General** setting in [Docker Desktop GUI](https://docs.docker.com/desktop/settings-and-maintenance/settings/)
  - Settings Management: `desktopTerminalEnabled` setting in the [`admin-settings.json` file](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-json-file/)

> Note
>
> In hardened environments, disable and lock this setting to limit host access.

### [Enable Docker Debug by default](#enable-docker-debug-by-default)
...
### [Include VM in Time Machine backup](#include-vm-in-time-machine-backup)
...
### [Choose Virtual Machine Manager](#choose-virtual-machine-manager)
...
- **Description:** Use Rosetta to emulate `amd64` on Apple Silicon. If value is set to `true`, Docker Desktop turns on Rosetta to accelerate x86\_64/amd64 binary emulation on Apple Silicon.
- **OS:** Mac only 13+
- **Use case:** Run Intel-based containers on Apple Silicon hosts.
- **Configure this setting with:**
  - **General** settings in [Docker Desktop GUI](https://docs.docker.com/desktop/settings-and-maintenance/settings/)
  - Settings Management:`useVirtualizationFrameworkRosetta` setting in the [`admin-settings.json` file](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-json-file/)
  - Settings Management: **Use Rosetta for x86\_64/amd64 emulation on Apple Silicon** setting in the [Admin Console](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-admin-console/)
...
### [Choose file sharing implementation](#choose-file-sharing-implementation)
...
- **Configure this setting with:**
  - **General settings** in [Docker Desktop GUI](https://docs.docker.com/desktop/settings-and-maintenance/settings/)
  - Settings Management: `useVirtualizationFrameworkVirtioFS` setting in the [`admin-settings.json` file](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-json-file/)
  - Settings Management: **Use VirtioFS for file sharing** setting in the [Admin Console](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-admin-console/)
...
- **Configure this setting with:**
  - **General** settings in [Docker Desktop GUI](https://docs.docker.com/desktop/settings-and-maintenance/settings/)
  - Settings Management: `useGrpcfuse` setting in the [`admin-settings.json` file](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-json-file/)
  - Settings Management: **Use gRPC FUSE for file sharing** setting in the [Admin Console](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-admin-console/)
...
- **Configure this setting with:**
  - **General** settings in [Docker Desktop GUI](https://docs.docker.com/desktop/settings-and-maintenance/settings/)
  - Settings Management: `analyticsEnabled` setting in the [`admin-settings.json` file](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-json-file/)
  - Settings Management: **Send usage statistics** setting in the [Admin Console](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-admin-console/)
...
### [Use Enhanced Container Isolation](#use-enhanced-container-isolation)
...
- **Configure this setting with:**
  - **General settings** in [Docker Desktop GUI](https://docs.docker.com/desktop/settings-and-maintenance/settings/)
  - Settings Management: `enhancedContainerIsolation` setting in the [`admin-settings.json` file](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-json-file/)
  - Settings Management: **Enable enhanced container isolation** setting in the [Admin Console](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-admin-console/)

> Note
>
> In hardened environments, disable and lock this setting. This allows you to control all your data flows and collect support logs via secure channels if needed.

### [Show CLI hints](#show-cli-hints)
...
- **Configure this setting with:**
  - **General settings** in [Docker Desktop GUI](https://docs.docker.com/desktop/settings-and-maintenance/settings/)
  - Settings Management: `sbomIndexing` setting in the [`admin-settings.json` file](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-json-file/)
  - Settings Management: **SBOM indexing** settings in the [Admin Console](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-admin-console/)
...
### [Automatically check configuration](#automatically-check-configuration)
...
- **Configure this setting with:**
  - **General** settings in [Docker Desktop GUI](https://docs.docker.com/desktop/settings-and-maintenance/settings/)
  - Settings Management: `configurationFileVersion` setting in the [`admin-settings.json` file](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-json-file/)
...
Number of logical CPU cores available on host
...
- **Configure this setting with:**
  - **Advanced** Resources settings in [Docker Desktop GUI](https://docs.docker.com/desktop/settings-and-maintenance/settings/)
...
### [Disk image location](#disk-image-location)
...
### [Enable Resource Saver](#enable-resource-saver)
...
- **Configure this setting with:**
  - **File sharing** Resources settings in [Docker Desktop GUI](https://docs.docker.com/desktop/settings-and-maintenance/settings/)
  - Settings Management: `filesharingAllowedDirectories` setting in the [`admin-settings.json` file](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-json-file/)
  - Settings Management: **Allowed file sharing directories** setting in the [Admin Console](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-admin-console/)
...
- **Configure this setting with:**
  - **Proxies** Resources settings in [Docker Desktop GUI](https://docs.docker.com/desktop/settings-and-maintenance/settings/)
  - Settings Management: `proxy` setting with `manual` and `exclude` modes in the [`admin-settings.json` file](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-json-file/)
  - Settings Management: **Proxy** section in the [Admin Console](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-admin-console/)
...
- **Configure this setting with:**
  - Settings Management: `vpnkitCIDR` setting in the [`admin-settings.json` file](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-json-file/)
  - Settings Management: **VPN Kit CIDR** setting in the [Admin Console](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-admin-console/)

### [Use kernel networking for UDP](#use-kernel-networking-for-udp)
...
- **Configure this setting with:**
  - **Network** Resources settings in [Docker Desktop GUI](https://docs.docker.com/desktop/settings-and-maintenance/settings/)
...
- **Configure this setting with:**
  - **Network** Resources settings in [Docker Desktop GUI](https://docs.docker.com/desktop/settings-and-maintenance/settings/)
  - Settings Management: `defaultNetworkingMode` setting in the [`admin-settings.json` file](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-json-file/)
  - Settings Management: **Default network IP mode** in the [Admin Console](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-admin-console/)
...
- **Configure this setting with:**
  - **Network** Resources settings in [Docker Desktop GUI](https://docs.docker.com/desktop/settings-and-maintenance/settings/)
  - Settings Management: `dnsInhibition` setting in the [`admin-settings.json` file](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-json-file/)
  - Settings Management: **DNS filtering behavior** in the [Admin Console](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-admin-console/)

For more information, see [Networking](https://docs.docker.com/desktop/features/networking/#networking-mode-and-dns-behaviour-for-mac-and-windows).

### [Enable WSL engine](#enable-wsl-engine)
...
- **Configure this setting with:**
  - **WSL Integration** Resources settings in [Docker Desktop GUI](https://docs.docker.com/desktop/settings-and-maintenance/settings/)
  - Settings Management: `wslEngineEnabled` setting in the [`admin-settings.json` file](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-json-file/)
  - Settings Management: **Windows Subsystem for Linux (WSL) Engine** setting in the [Admin Console](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-admin-console/)

> Note
>
> In hardened environments, enable and lock this setting for improved security and performance.

## [Docker Engine settings](#docker-engine-settings)
...
Enable verbose logging in the Docker daemon
...
Enable experimental Docker CLI and daemon features
...
Allow pulling from HTTP registries without TLS

Array of strings (`host:port`)
...
Define alternative registry endpoints
...
- **Configure this setting with:**
  - **Docker Engine** settings in [Docker Desktop GUI](https://docs.docker.com/desktop/settings-and-maintenance/settings/)
...
## [Builders settings](#builders-settings)
...
Backend used by the builder (`docker`, `docker-container`, `remote`, etc.)
...
Target platforms supported by the builder
...
- **Configure this setting with:**
  - **Builders** settings in [Docker Desktop GUI](https://docs.docker.com/desktop/settings-and-maintenance/settings/)
...
- **Configure this setting with:**
  - **AI** settings in [Docker Desktop GUI](https://docs.docker.com/desktop/settings-and-maintenance/settings/)
  - Settings Management: `enableInference` setting in the [`admin-settings.json` file](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-json-file/)
  - Settings Management: **Enable Docker Model Runner** setting in the [Admin Console](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-admin-console/)
...
- **Configure this setting with:**
  - **AI** settings in [Docker Desktop GUI](https://docs.docker.com/desktop/settings-and-maintenance/settings/)
  - Settings Management: `enableInferenceTCP` setting in the [`admin-settings.json` file](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-json-file/)
  - Settings Management: **Host-side TCP support** setting in the [Admin Console](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-admin-console/)
...
- **Configure this setting with:**
  - **AI** settings in [Docker Desktop GUI](https://docs.docker.com/desktop/settings-and-maintenance/settings/)
  - Settings Management: `enableInferenceTCPPort` setting in the [`admin-settings.json` file](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-json-file/)
  - Settings Management: **Host-side TCP port** setting in the [Admin Console](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-admin-console/)
...
Empty string to deny all,`*` to accept all, or a list of comma-separated values
...
- **Configure this setting with:**
  - **AI** settings in [Docker Desktop GUI](https://docs.docker.com/desktop/settings-and-maintenance/settings/)
  - Settings Management: `enableInferenceCORS` setting in the [`admin-settings.json` file](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-json-file/)
  - Settings Management: **CORS Allowed Origins** setting in the [Admin Console](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-admin-console/)

> Note
>
> This setting requires Docker Model Runner and host-side TCP support settings to be enabled first.

#### [Enable GPU-backed inference](#enable-gpu-backed-inference)
...
- **Configure this setting with:**
  - **AI** settings in [Docker Desktop GUI](https://docs.docker.com/desktop/settings-and-maintenance/settings/)
  - Settings Management: `enableInferenceGPUVariant` setting in the [`admin-settings.json` file](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-json-file/)
  - Settings Management: **Enable GPU-backed inference** setting in the [Admin Console](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-admin-console/)
...
- **Configure this setting with:**
  - **Kubernetes** settings in [Docker Desktop GUI](https://docs.docker.com/desktop/settings-and-maintenance/settings/)
  - Settings Management: `kubernetes` setting in the [`admin-settings.json` file](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-json-file/)
  - Settings Management: **Allow Kubernetes** setting in the [Admin Console](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-admin-console/)
...
### [Choose cluster provisioning method](#choose-cluster-provisioning-method)
...
### [Kubernetes node count (kind provisioning)](#kubernetes-node-count-kind-provisioning)
...
### [Kubernetes node version (kind provisioning)](#kubernetes-node-version-kind-provisioning)
...
## [Software updates settings](#software-updates-settings)
...
- **Configure this setting with:**
  - Settings Management: `disableUpdate` setting in the [`admin-settings.json` file](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-json-file/)
  - Settings Management: **Disable update** setting in the [Admin Console](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-admin-console/)

> Note
>
> In hardened environments, enable this setting and lock. This guarantees that only internally vetted versions are installed.

### [Always download updates](#always-download-updates)
...
- **Configure this setting with:**
  - **Software updates** settings in [Docker Desktop GUI](https://docs.docker.com/desktop/settings-and-maintenance/settings/)
  - Settings Management: **Disable updates** setting in the [Admin Console](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-admin-console/)
...
- **Configure this setting with:**
  - **General settings** in [Docker Desktop GUI](https://docs.docker.com/desktop/settings-and-maintenance/settings/#software-updates)
  - Settings Management: `silentModulesUpdate` setting in the [`admin-settings.json` file](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-json-file/)
  - Settings Management: **Automatically update components** setting in the [Admin Console](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-admin-console/)
...
- **Configure this setting with:**
  - **Extensions** settings in [Docker Desktop GUI](https://docs.docker.com/desktop/settings-and-maintenance/settings/)
  - Settings Management: `extensionsEnabled` setting in the [`admin-settings.json` file](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-json-file/)
  - Settings Management: **Allow Extensions** setting in the [Admin Console](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-admin-console/)
...
- **Configure this setting with:**
  - **Extensions** settings in [Docker Desktop GUI](https://docs.docker.com/desktop/settings-and-maintenance/settings/)
  - Settings Management: `onlyMarketplaceExtensions` setting in the [`admin-settings.json` file](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-json-file/)
  - Settings Management: **Only marketplace extensions** setting in the [Admin Console](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-admin-console/)
...
- **Configure this setting with:**
  - Settings Management: `extensionsPrivateMarketplace` setting in the [`admin-settings.json` file](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-json-file/)
  - Settings Management: **Extensions private marketplace** setting in the [Admin Console](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-admin-console/)

### [Show Docker Extensions system containers](#show-docker-extensions-system-containers)
...
Individual users: `true`, `false`\
Business tier: `"Disabled"`, `"Enabled"`, `"Always Enabled"`
...
- **Description:** Enable [Docker MCP Toolkit](https://docs.docker.com/ai/mcp-catalog-and-toolkit/) in Docker Desktop.
- **OS:** All
- **Use case:** Turn on MCP toolkit features for AI model development workflows.
- **Configure this setting with:**
  - **Beta** settings in [Docker Desktop GUI](https://docs.docker.com/desktop/settings-and-maintenance/settings/)
  - Settings Management: `enableDockerMCPToolkit` setting in the [`admin-settings.json` file](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-json-file/)
...
- **Configure this setting with:**
  - **Docker Offload** settings in [Docker Desktop GUI](https://docs.docker.com/desktop/settings-and-maintenance/settings/)
  - Settings Management: `enableCloud` setting in the [`admin-settings.json` file](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-json-file/)
  - Settings Management: **Enable Docker Offload** setting in the [Admin Console](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-admin-console/)

> Note
>
> This setting is only available when Docker Offload capability is enabled for the organization.

### [Enable Wasm](#enable-wasm)
...
- **Description:** Enable [Wasm](https://docs.docker.com/desktop/features/wasm/) to run Wasm workloads.
- **OS:** All
...
### [Status updates on tasks and processes](#status-updates-on-tasks-and-processes)
...
- **Configure this setting with:**
  - **Notifications** settings in [Docker Desktop GUI](https://docs.docker.com/desktop/settings-and-maintenance/settings/)

### [Recommendations from Docker](#recommendations-from-docker)
...
### [Docker announcements](#docker-announcements)
...
### [Docker Scout notification pop-ups](#docker-scout-notification-pop-ups)
...
### [Docker Scout OS notifications](#docker-scout-os-notifications)
...
### [Configure installation of Docker CLI](#configure-installation-of-docker-cli)
...
- **Configure this setting with:**
  - **Advanced** settings in [Docker Desktop GUI](https://docs.docker.com/desktop/settings-and-maintenance/settings/)

### [Allow the default Docker socket to be used](#allow-the-default-docker-socket-to-be-used)
...
- **Configure this setting with:**
  - **Advanced** settings in [Docker Desktop GUI](https://docs.docker.com/desktop/settings-and-maintenance/settings/)
  - Settings Management: `dockerSocketMount` setting in the [`admin-settings.json` file](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-json-file/)

### [Allow privileged port mapping](#allow-privileged-port-mapping)
...
## [Settings only available with Settings Management](#settings-only-available-with-settings-management)
...
- **Configure this setting with:**
  - Settings Management: `blockDockerLoad` setting in the [`admin-settings.json` file](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-json-file/)
  - Settings Management: **Block Docker Load** setting in the [Admin Console](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-admin-console/)
...
- **OS:** All
- **Configure this setting with:**
  - Settings Management: `displayedOnboarding` setting in the [`admin-settings.json` file](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-json-file/)
  - Settings Management: **Hide onboarding survey** setting in the [Admin Console](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-admin-console/)

### [Expose Docker API on TCP 2375](#expose-docker-api-on-tcp-2375)
...
- **Configure this setting with:**
  - Settings Management: `exposeDockerAPIOnTCP2375` in the [`admin-settings.json` file](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-json-file/)
  - Settings Management: **Expose Docker API** setting in the [Admin Console](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-admin-console/)
...
- **Configure this setting with:**
  - Settings Management: `containersProxy` setting in the [`admin-settings.json` file](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-json-file/)
  - Settings Management: **Containers proxy** section in the [Admin Console](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-admin-console/)
...
- Configure this setting with:
  - Settings Management: `enhancedContainerIsolation` > `dockerSocketMount` in the [`admin-settings.json` file](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-json-file/)
  - Settings Management: **Command list** in the [Admin Console](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-admin-console/)
...
- **Configure this setting with:**
  - Settings Management: `allowBetaFeatures` setting in the [`admin-settings.json` file](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-json-file/)
...
### [Docker daemon options (Linux or Windows)](#docker-daemon-options-linux-or-windows)
...
- **Configure this setting with:**
  - Settings Management: `linuxVM.dockerDaemonOptions` or `windowsContainers.dockerDaemonOptions` in the [`admin-settings.json` file](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-json-file/)

> Note
>
> In hardened environments, provide a vetted JSON config and lock it so no overrides are possible.

### [VPNKit CIDR](#vpnkit-cidr)
...
- **Configure this setting with:**
  - Settings Management: `proxy.enableKerberosNtlm` in the [`admin-settings.json` file](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-json-file/)
  - Settings Management: **Kerberos NTLM** setting in the [Admin Console](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-admin-console/)
...
- **OS:** All
- **Configure this setting with:**
  - Settings Management: `pac` in the [`admin-settings.json` file](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-json-file/)
  - Settings Management: **PAC file** setting in the [Admin Console](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-admin-console/)
...
- **OS:** All
- **Configure this setting with:**
  - Settings Management: `embeddedPac` in the [`admin-settings.json` file](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-json-file/)
  - Settings Management: **Embedded PAC script** setting in the [Admin Console](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-admin-console/)

### [Custom Kubernetes image repository](#custom-kubernetes-image-repository)
...
- **Configure this setting with**:
  - Settings Management: `KubernetesImagesRepository` settings in the [`admin-settings.json` file](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-json-file/)
  - Settings Management: **Kubernetes Images Repository** setting in the [Admin Console](https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-admin-console/)
...
[Edit this page](https://github.com/docker/docs/edit/main/content/manuals/enterprise/security/hardened-desktop/settings-management/settings-reference.md)

[Request changes](https://github.com/docker/docs/issues/new?template=doc_issue.yml\&location=https%3a%2f%2fdocs.docker.com%2fenterprise%2fsecurity%2fhardened-desktop%2fsettings-management%2fsettings-reference%2f\&labels=status%2Ftriage)
