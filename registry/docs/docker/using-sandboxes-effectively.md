...
For teams or repeated setups, use [Custom templates](https://docs.docker.com/ai/sandboxes/templates/) to pre-install tools.

## [Docker inside sandboxes](#docker-inside-sandboxes)

Agents can build images, run containers, and use Docker Compose. Everything runs inside the sandbox's private Docker daemon.

### [Testing containerized apps](#testing-containerized-apps)
...
### [Multi-container stacks](#multi-container-stacks)
...
## [Named sandboxes](#named-sandboxes)
...
### [Sharing workspaces across sandboxes](#sharing-workspaces-across-sandboxes)
...
[Edit this page](https://github.com/docker/docs/edit/main/content/manuals/ai/sandboxes/workflows.md)

[Request changes](https://github.com/docker/docs/issues/new?template=doc_issue.yml\&location=https%3a%2f%2fdocs.docker.com%2fai%2fsandboxes%2fworkflows%2f\&labels=status%2Ftriage)
