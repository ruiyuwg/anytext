...
Search for MCP servers in the catalog by name or description

`mcp-add`

Add a new MCP server to the current session

`mcp-config-set`

Configure settings for an MCP server
...
Execute a tool by name that exists in the current session
...
[Edit this page](https://github.com/docker/docs/edit/main/content/manuals/ai/mcp-catalog-and-toolkit/dynamic-mcp.md)

[Request changes](https://github.com/docker/docs/issues/new?template=doc_issue.yml\&location=https%3a%2f%2fdocs.docker.com%2fai%2fmcp-catalog-and-toolkit%2fdynamic-mcp%2f\&labels=status%2Ftriage)
