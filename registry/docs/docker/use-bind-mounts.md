...
4. Make sure you don't have any `getting-started` containers currently running.
...
6. You can watch the logs using `docker logs <container-id>`. You'll know you're ready to go when you see this:
...
7. Make sure you don't have any `getting-started` containers currently running.

8. Run the following command from the `getting-started-app` directory.
...
9. You can watch the logs using `docker logs <container-id>`. You'll know you're ready to go when you see this:
...
10. Make sure you don't have any `getting-started` containers currently running.

11. Run the following command from the `getting-started-app` directory.
...
12. You can watch the logs using `docker logs <container-id>`. You'll know you're ready to go when you see this:
