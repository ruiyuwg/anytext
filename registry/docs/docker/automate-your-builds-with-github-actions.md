...
4. Add Docker Hub credentials as GitHub repository secrets
   ...
   Your Docker Hub access token (created in Step 1)

   `DOCKERHUB_PROJECT_NAME`

   Your Docker Project Name (created in Step 2)
...
[Edit this page](https://github.com/docker/docs/edit/main/content/guides/vuejs/configure-github-actions.md)

[Request changes](https://github.com/docker/docs/issues/new?template=doc_issue.yml\&location=https%3a%2f%2fdocs.docker.com%2fguides%2fvuejs%2fconfigure-github-actions%2f\&labels=status%2Ftriage)
