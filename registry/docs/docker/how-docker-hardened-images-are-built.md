...
### [Customization changes](#customization-changes) DHI Select and Enterprise
...
5. Testing: Images undergo comprehensive testing for compatibility and functionality.
...
DuC(opaicssfktceranredeaeemmdorensediob)tuuorirclsedssTPDruHibIglgireserhgirtseotbruyildAsSaIcitagtgnneussa\&trcadhgtraeiannoigenlerssateHTuemsatninrgeview

### [Customized image pipeline](#customized-image-pipeline) DHI Select and Enterprise
...
5. Signing and attestations: Docker signs the customized image and generates attestations (SBOMs, VEX documents, build provenance).
6. Publishing: The signed customized image is published to Docker Hub and the attestations are published to the Docker Scout registry.
...
DOPDoCuocIbcklkeaierrsrthmiHoftunaobicttosrsTSaritigtgnegse\&tragtreienobenursialtdeFDAceHputIpsclthiyommbaiagzseaetions

[Edit this page](https://github.com/docker/docs/edit/main/content/manuals/dhi/explore/build-process.md)

[Request changes](https://github.com/docker/docs/issues/new?template=doc_issue.yml\&location=https%3a%2f%2fdocs.docker.com%2fdhi%2fexplore%2fbuild-process%2f\&labels=status%2Ftriage)
