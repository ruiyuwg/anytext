...
[`json-file`](https://docs.docker.com/engine/logging/drivers/json-file/)
...
[`journald`](https://docs.docker.com/engine/logging/drivers/journald/)

Writes log messages to `journald`. The `journald` daemon must be running on the host machine.

[`gelf`](https://docs.docker.com/engine/logging/drivers/gelf/)
...
[`awslogs`](https://docs.docker.com/engine/logging/drivers/awslogs/)
...
[`etwlogs`](https://docs.docker.com/engine/logging/drivers/etwlogs/)

Writes log messages as Event Tracing for Windows (ETW) events. Only available on Windows platforms.

[`gcplogs`](https://docs.docker.com/engine/logging/drivers/gcplogs/)
...
[Edit this page](https://github.com/docker/docs/edit/main/content/manuals/engine/logging/configure.md)

[Request changes](https://github.com/docker/docs/issues/new?template=doc_issue.yml\&location=https%3a%2f%2fdocs.docker.com%2fengine%2flogging%2fconfigure%2f\&labels=status%2Ftriage)
