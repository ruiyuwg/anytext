...
3. Select **Add seats** and follow the on-screen instructions to complete adding seats.
...
1. Sign in to [Docker Home](https://app.docker.com/) and select your organization.
2. Select **Billing**.
3. In the **Seats** row, select the action icon, then **Remove seats**.
...
[Edit this page](https://github.com/docker/docs/edit/main/content/manuals/subscription/manage-seats.md)

[Request changes](https://github.com/docker/docs/issues/new?template=doc_issue.yml\&location=https%3a%2f%2fdocs.docker.com%2fsubscription%2fmanage-seats%2f\&labels=status%2Ftriage)
