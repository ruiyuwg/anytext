...
- Review your [activity logs](https://docs.docker.com/admin/organization/activity-logs/) regularly to maintain security awareness
- Check your [Insights dashboard](https://docs.docker.com/admin/organization/insights/) to identify opportunities for optimization
...
[Edit this page](https://github.com/docker/docs/edit/main/content/guides/admin-user-management/audit-and-monitor.md)

[Request changes](https://github.com/docker/docs/issues/new?template=doc_issue.yml\&location=https%3a%2f%2fdocs.docker.com%2fguides%2fadmin-user-management%2faudit-and-monitor%2f\&labels=status%2Ftriage)
