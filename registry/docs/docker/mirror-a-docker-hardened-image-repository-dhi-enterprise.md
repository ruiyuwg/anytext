...
Mirroring requires a DHI Select or Enterprise subscription. Without a subscription, you can pull Docker Hardened Images directly from `dhi.io` without mirroring. With a DHI Select or Enterprise subscription, you must mirror to get:
...
## [Mirror a DHI repository to Docker Hub](#mirror-a-dhi-repository-to-docker-hub)
...
### [Mirror using the DHI CLI](#mirror-using-the-dhi-cli)

The DHI CLI provides a command-line interface for managing Docker Hardened Images, including mirroring operations. For installation instructions and usage details, see [Use the DHI CLI](https://docs.docker.com/dhi/how-to/cli/#mirror-dhi-images).

### [Stop mirroring with the CLI](#stop-mirroring-with-the-cli)
...
### [Mirror using the Docker Hub web interface](#mirror-using-the-docker-hub-web-interface)
...
[Edit this page](https://github.com/docker/docs/edit/main/content/manuals/dhi/how-to/mirror.md)

[Request changes](https://github.com/docker/docs/issues/new?template=doc_issue.yml\&location=https%3a%2f%2fdocs.docker.com%2fdhi%2fhow-to%2fmirror%2f\&labels=status%2Ftriage)
