...
Print package locations including file paths and layer diff\_id
...
Only show CVEs introduced by the base image

`--only-cisa-kev`

Filter to CVEs listed in the CISA KEV catalog
