...
Digest of manifest to import, see [cache versioning](#cache-versioning).
...
Path of the local directory where cache gets exported to.
...
[Edit this page](https://github.com/docker/docs/edit/main/content/manuals/build/cache/backends/local.md)

[Request changes](https://github.com/docker/docs/issues/new?template=doc_issue.yml\&location=https%3a%2f%2fdocs.docker.com%2fbuild%2fcache%2fbackends%2flocal%2f\&labels=status%2Ftriage)
