...
> Note
>
> If you need to use legacy container-based sandboxes, install [Docker Desktop 4.57](/desktop/release-notes/#4570).
...
### [Option 2: Migrate configuration](#option-2-migrate-configuration)
...
4. Create a new sandbox with your template:
   ...
   > Note
   >
   > The `--pull-template` flag was introduced in Docker Desktop 4.61 (Sandbox version 0.12). On Docker Desktop 4.58–4.60, use `--load-local-template` to use a locally-built template image.
...
If you want to share this template with your team, push it to a registry. See [Custom templates](https://docs.docker.com/ai/sandboxes/templates/) for details.

## [Cleanup old resources](#cleanup-old-resources)
...
> Warning
>
> `docker volume prune` removes ALL unused volumes, not just sandbox volumes. Make sure you don't have other important unused volumes before running this command.
...
[Edit this page](https://github.com/docker/docs/edit/main/content/manuals/ai/sandboxes/migration.md)

[Request changes](https://github.com/docker/docs/issues/new?template=doc_issue.yml\&location=https%3a%2f%2fdocs.docker.com%2fai%2fsandboxes%2fmigration%2f\&labels=status%2Ftriage)
