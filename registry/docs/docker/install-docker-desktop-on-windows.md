...
2. The Docker menu ( ![whale menu](../images/whale-x.svg) ) displays the Docker Subscription Service Agreement.
...
[Edit this page](https://github.com/docker/docs/edit/main/content/manuals/desktop/setup/install/windows-install.md)

[Request changes](https://github.com/docker/docs/issues/new?template=doc_issue.yml\&location=https%3a%2f%2fdocs.docker.com%2fdesktop%2fsetup%2finstall%2fwindows-install%2f\&labels=status%2Ftriage)
