...
- [Removal of rate limiting](#removal-of-rate-limiting): Unrestricted pulls for development teams
...
![DVP flow in Docker Hub](https://docs.docker.com/docker-hub/repos/manage/trusted-content/images/dvp-hub-flow.svg)
...
3. Select the upload logo button, represented by a camera icon ( ![camera icon](../../../../images/upload_logo_sm.png) ) overlaying the current repository logo.
...
Select the **Clear** button ( ![clear button](../../../../images/clear_logo_sm.png) ) to remove a logo.
...
[Edit this page](https://github.com/docker/docs/edit/main/content/manuals/docker-hub/repos/manage/trusted-content/dvp-program.md)

[Request changes](https://github.com/docker/docs/issues/new?template=doc_issue.yml\&location=https%3a%2f%2fdocs.docker.com%2fdocker-hub%2frepos%2fmanage%2ftrusted-content%2fdvp-program%2f\&labels=status%2Ftriage)
