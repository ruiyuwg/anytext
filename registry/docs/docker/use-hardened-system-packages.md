...
### [Add packages through image customization](#add-packages-through-image-customization) DHI Select & DHI Enterprise
...
To use Docker's public hardened package repository in your own images, configure the Alpine package manager in your Dockerfile.
...
#### [Enterprise repository](#enterprise-repository) DHI Enterprise
...
> Note
>
> You must have the Docker Hardened Images CLI installed and configured. For more information, see [Use the DHI CLI](https://docs.docker.com/dhi/how-to/cli/).
...
[Edit this page](https://github.com/docker/docs/edit/main/content/manuals/dhi/how-to/hardened-packages.md)

[Request changes](https://github.com/docker/docs/issues/new?template=doc_issue.yml\&location=https%3a%2f%2fdocs.docker.com%2fdhi%2fhow-to%2fhardened-packages%2f\&labels=status%2Ftriage)
