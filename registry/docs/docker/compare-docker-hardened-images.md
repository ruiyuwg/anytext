...
## [Compare images using Docker Scout](#compare-images-using-docker-scout)
...
## [Interpret comparison results](#interpret-comparison-results)
...
## [When to compare images](#when-to-compare-images)
...
[Edit this page](https://github.com/docker/docs/edit/main/content/manuals/dhi/how-to/compare.md)

[Request changes](https://github.com/docker/docs/issues/new?template=doc_issue.yml\&location=https%3a%2f%2fdocs.docker.com%2fdhi%2fhow-to%2fcompare%2f\&labels=status%2Ftriage)
