...
[`--add-host`](/reference/cli/docker/buildx/build/#add-host)

Add a custom host-to-IP mapping (`host:ip`)

[`--build-arg`](/reference/cli/docker/buildx/build/#build-arg)
...
[`--cgroup-parent`](/reference/cli/docker/buildx/build/#cgroup-parent)
...
[`-f, --file`](/reference/cli/docker/buildx/build/#file)
...
[`--network`](/reference/cli/docker/buildx/build/#network)
...
[`-t, --tag`](/reference/cli/docker/buildx/build/#tag)

Name and optionally a tag in the `name:tag` format

[`--target`](/reference/cli/docker/buildx/build/#target)
