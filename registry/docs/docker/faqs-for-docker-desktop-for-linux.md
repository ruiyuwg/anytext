...
ID of the user running Docker Desktop (e.g. 1000)

1

0 + beginning of ID range specified in `/etc/subuid`/`/etc/subgid` (e.g. 100000)

2

1 + beginning of ID range specified in `/etc/subuid`/`/etc/subgid` (e.g. 100001)
...
##### [How do I move the file to a bigger drive?](#how-do-i-move-the-file-to-a-bigger-drive)
...
[Edit this page](https://github.com/docker/docs/edit/main/content/manuals/desktop/troubleshoot-and-support/faqs/linuxfaqs.md)

[Request changes](https://github.com/docker/docs/issues/new?template=doc_issue.yml\&location=https%3a%2f%2fdocs.docker.com%2fdesktop%2ftroubleshoot-and-support%2ffaqs%2flinuxfaqs%2f\&labels=status%2Ftriage)
