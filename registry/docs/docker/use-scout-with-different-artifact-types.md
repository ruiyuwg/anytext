...
Use a local image, or fall back to a registry lookup

`local://`

Use an image from the local image store (don't do a registry lookup)

`registry://`

Use an image from a registry (don't use a local image)

`oci-dir://`

Use an OCI layout directory

`archive://`

Use a tarball archive, as created by `docker save`
...
[Edit this page](https://github.com/docker/docs/edit/main/content/manuals/scout/how-tos/artifact-types.md)

[Request changes](https://github.com/docker/docs/issues/new?template=doc_issue.yml\&location=https%3a%2f%2fdocs.docker.com%2fscout%2fhow-tos%2fartifact-types%2f\&labels=status%2Ftriage)
