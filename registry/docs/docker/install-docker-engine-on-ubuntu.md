...
2. Install the Docker packages.
   ...
   docker-ce/noble 5:29.2.1-1~ubuntu.24.04~noble 
   docker-ce/noble 5:29.2.0-1~ubuntu.24.04~noble 
   ...
   ```
...
[Edit this page](https://github.com/docker/docs/edit/main/content/manuals/engine/install/ubuntu.md)

[Request changes](https://github.com/docker/docs/issues/new?template=doc_issue.yml\&location=https%3a%2f%2fdocs.docker.com%2fengine%2finstall%2fubuntu%2f\&labels=status%2Ftriage)
