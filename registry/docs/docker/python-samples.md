...
A sample Python/Flask application with Nginx proxy and a Mongo database.

[NGINX / Flask / MySQL](https://github.com/docker/awesome-compose/tree/master/nginx-flask-mysql)

A sample Python/Flask application with an Nginx proxy and a MySQL database.

[NGINX / WSGI / Flask](https://github.com/docker/awesome-compose/tree/master/nginx-wsgi-flask)

A sample Nginx reverse proxy with a Flask backend using WSGI.

[Python / Flask / Redis](https://github.com/docker/awesome-compose/tree/master/flask-redis)

A sample Python/Flask and a Redis database.
...
[Edit this page](https://github.com/docker/docs/edit/main/content/reference/samples/python.md)

[Request changes](https://github.com/docker/docs/issues/new?template=doc_issue.yml\&location=https%3a%2f%2fdocs.docker.com%2freference%2fsamples%2fpython%2f\&labels=status%2Ftriage)
