...
- Docker: Rebuilds and re-releases images with upstream patches applied. Docker monitors for vulnerabilities and publishes updates to affected images. DHI Select and DHI Enterprise include SLA commitments. DHI Community offers a secure baseline but no guaranteed remediation timelines.
...
[Edit this page](https://github.com/docker/docs/edit/main/content/manuals/dhi/explore/responsibility.md)

[Request changes](https://github.com/docker/docs/issues/new?template=doc_issue.yml\&location=https%3a%2f%2fdocs.docker.com%2fdhi%2fexplore%2fresponsibility%2f\&labels=status%2Ftriage)
