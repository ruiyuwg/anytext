...
Uses the model's maximum trained context size
...
Simple queries, short code snippets

Low

4,096

Standard conversations, medium code files

Moderate

8,192

Long conversations, larger code files

Higher

16,384+

Extended documents, multi-file context
...
Temperature for sampling. Lower = more deterministic, higher = more creative
...
Limit sampling to top K tokens. Lower = more focused
...
Set to number of performance cores
...
Prevents swapping, requires sufficient RAM
...
All (if GPU available)

Reduce if running out of VRAM

`--main-gpu`

GPU to use for computation
...
Auto-injected URL of the model endpoint

`LLM_MODEL`

Auto-injected model identifier
...
[Edit this page](https://github.com/docker/docs/edit/main/content/manuals/ai/model-runner/configuration.md)

[Request changes](https://github.com/docker/docs/issues/new?template=doc_issue.yml\&location=https%3a%2f%2fdocs.docker.com%2fai%2fmodel-runner%2fconfiguration%2f\&labels=status%2Ftriage)
