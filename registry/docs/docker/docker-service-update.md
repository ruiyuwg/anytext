...
API 1.32+ Add a Generic resource

`--generic-resource-rm`

API 1.32+ Remove a Generic resource
...
API 1.25+ Add a custom host-to-IP mapping (`host:ip`)
...
API 1.41+ Add or update a ulimit option

`--ulimit-rm`

API 1.41+ Remove a ulimit option
