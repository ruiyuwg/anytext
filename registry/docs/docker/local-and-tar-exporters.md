...
`local` exporter only. Split multi-platform outputs into platform subdirectories.
...
[Edit this page](https://github.com/docker/docs/edit/main/content/manuals/build/exporters/local-tar.md)

[Request changes](https://github.com/docker/docs/issues/new?template=doc_issue.yml\&location=https%3a%2f%2fdocs.docker.com%2fbuild%2fexporters%2flocal-tar%2f\&labels=status%2Ftriage)
