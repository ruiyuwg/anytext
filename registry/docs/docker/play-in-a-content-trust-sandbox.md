...
A container with the latest version of Docker Engine and with some preconfigured certificates. This is your sandbox where you can use the `docker` client to test trust operations.
...
The service that does all the heavy-lifting of managing trust
...
7. List the `trusttest` image.
   ...
   sandboxregistry:5000/test/trusttest                 cc7629d1331a        11 months ago       5.025 MB
   ```
...
[Edit this page](https://github.com/docker/docs/edit/main/content/manuals/engine/security/trust/trust_sandbox.md)

[Request changes](https://github.com/docker/docs/issues/new?template=doc_issue.yml\&location=https%3a%2f%2fdocs.docker.com%2fengine%2fsecurity%2ftrust%2ftrust_sandbox%2f\&labels=status%2Ftriage)
