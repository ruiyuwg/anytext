...
Sets the IPvlan operating mode. Can be one of: `l2`, `l3`, `l3s`

`ipvlan_flag`

`bridge`

Sets the IPvlan mode flag. Can be one of: `bridge`, `private`, `vepa`
...
[Edit this page](https://github.com/docker/docs/edit/main/content/manuals/engine/network/drivers/ipvlan.md)

[Request changes](https://github.com/docker/docs/issues/new?template=doc_issue.yml\&location=https%3a%2f%2fdocs.docker.com%2fengine%2fnetwork%2fdrivers%2fipvlan%2f\&labels=status%2Ftriage)
