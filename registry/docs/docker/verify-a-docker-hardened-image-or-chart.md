...
First, authenticate to both registries. Prepare a [personal access token (PAT)](https://docs.docker.com/security/access-tokens/) for your user with `read only` access:
...
[Edit this page](https://github.com/docker/docs/edit/main/content/manuals/dhi/how-to/verify.md)

[Request changes](https://github.com/docker/docs/issues/new?template=doc_issue.yml\&location=https%3a%2f%2fdocs.docker.com%2fdhi%2fhow-to%2fverify%2f\&labels=status%2Ftriage)
