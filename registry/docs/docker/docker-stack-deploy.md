...
API 1.27+ Prune services that are no longer referenced
...
API 1.30+ Query the registry to resolve image digest and supported platforms (`always`, `changed`, `never`)
