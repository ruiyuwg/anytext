...
7. Create a new directory for your workflow:
...
11. Add your API keys and configuration, replacing the placeholders with your actual credentials:
...
12. Protect your credentials by adding `.env` to `.gitignore`:
...
[Edit this page](https://github.com/docker/docs/edit/main/content/guides/github-sonarqube-sandbox/workflow.md)

[Request changes](https://github.com/docker/docs/issues/new?template=doc_issue.yml\&location=https%3a%2f%2fdocs.docker.com%2fguides%2fgithub-sonarqube-sandbox%2fworkflow%2f\&labels=status%2Ftriage)
