...
![](https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/python/python-original.svg "Python") Python Data science
...
Mac / Linux Windows (Command Prompt) Windows (PowerShell) Windows (Git Bash)
...
[Edit this page](https://github.com/docker/docs/edit/main/content/guides/jupyter.md)

[Request changes](https://github.com/docker/docs/issues/new?template=doc_issue.yml\&location=https%3a%2f%2fdocs.docker.com%2fguides%2fjupyter%2f\&labels=status%2Ftriage)
