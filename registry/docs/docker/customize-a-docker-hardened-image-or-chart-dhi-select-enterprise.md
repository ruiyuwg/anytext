...
# Customize a Docker Hardened Image or chart DHI Select & Enterprise
...
### [Customize using the DHI CLI](#customize-using-the-dhi-cli)

The DHI CLI provides a command-line interface for managing Docker Hardened Image customizations. For installation instructions and usage details, see [Use the DHI CLI](https://docs.docker.com/dhi/how-to/cli/#customize-dhi-images).
...
### [Customize using the Docker Hub web interface](#customize-using-the-docker-hub-web-interface)
...
8. Optional. Add packages.
   ...
   1. In the packages drop-down (labeled **Hardened packages** for Alpine distributions or **Packages** for Debian distributions), select the packages you want to add to the image.

      The packages available in the drop-down are OS system packages for the selected image variant. For Alpine-based images, these are hardened packages that have been built from source by Docker with cryptographic signatures and full supply chain security. For Debian-based images, these are standard Debian system packages.
...
9. Select **Next: Configure** to configure the following image settings:
   ...
   11. Select the platforms you want to build the image for. You must select at least one platform.
...
### [Create an OCI artifact image for image customization](#create-an-oci-artifact-image-for-image-customization)
...
[Edit this page](https://github.com/docker/docs/edit/main/content/manuals/dhi/how-to/customize.md)

[Request changes](https://github.com/docker/docs/issues/new?template=doc_issue.yml\&location=https%3a%2f%2fdocs.docker.com%2fdhi%2fhow-to%2fcustomize%2f\&labels=status%2Ftriage)
