...
2. Build and push the image that you want to analyze.
   ...
   ```console
   $ docker build --push --tag /<image:tag> --provenance=true --sbom=true .
   ```
...
[Edit this page](https://github.com/docker/docs/edit/main/content/manuals/scout/explore/analysis.md)

[Request changes](https://github.com/docker/docs/issues/new?template=doc_issue.yml\&location=https%3a%2f%2fdocs.docker.com%2fscout%2fexplore%2fanalysis%2f\&labels=status%2Ftriage)
