...
The MCP community registry

`file://<path>`

A local YAML or JSON file
...
[Edit this page](https://github.com/docker/docs/edit/main/content/manuals/ai/mcp-catalog-and-toolkit/cli.md)

[Request changes](https://github.com/docker/docs/issues/new?template=doc_issue.yml\&location=https%3a%2f%2fdocs.docker.com%2fai%2fmcp-catalog-and-toolkit%2fcli%2f\&labels=status%2Ftriage)
