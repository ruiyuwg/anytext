...
`myrepo.git?tag=mytag`

`refs/tags/mytag`

`/`

`myrepo.git?branch=mybranch`

`refs/heads/mybranch`

`/`

`myrepo.git?ref=pull/42/head`

`refs/pull/42/head`

`/`

`myrepo.git?subdir=myfolder`

`refs/heads/<default branch>`

`/myfolder`

`myrepo.git?branch=master&subdir=myfolder`

`refs/heads/master`

`/myfolder`

`myrepo.git?tag=mytag&subdir=myfolder`

`refs/tags/mytag`

`/myfolder`

`myrepo.git?branch=mybranch&subdir=myfolder`
...
[Edit this page](https://github.com/docker/docs/edit/main/content/manuals/build/concepts/context.md)

[Request changes](https://github.com/docker/docs/issues/new?template=doc_issue.yml\&location=https%3a%2f%2fdocs.docker.com%2fbuild%2fconcepts%2fcontext%2f\&labels=status%2Ftriage)
