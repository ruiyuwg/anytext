...
2. Run the following PowerShell commands to install and extract the archive to your program files:
   ...
   ```powershell
   PS C:\> Expand-Archive /path/to/.zip -DestinationPath $Env:ProgramFiles
   ```
...
[Edit this page](https://github.com/docker/docs/edit/main/content/manuals/engine/install/binaries.md)

[Request changes](https://github.com/docker/docs/issues/new?template=doc_issue.yml\&location=https%3a%2f%2fdocs.docker.com%2fengine%2finstall%2fbinaries%2f\&labels=status%2Ftriage)
