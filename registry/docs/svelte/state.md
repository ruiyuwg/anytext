...
> \[!NOTE] When you update properties of proxies, the original object is *not* mutated. If you need to use your own proxy handlers in a state proxy, you should wrap the object *after* wrapping it in `$state`.
