...
Instead, you should *authenticate* the user using [`cookies`](load#Cookies) and persist the data to a database.
...
Instead, we need to make the value [*reactive*](/tutorial/svelte/state):
