...
| getRectProps | (input: HeatmapRectData) => Omit\<SVGProps, "ref"> | - | Props passed down to each rect depending on its date and associated value |
...
| tooltipProps | Partial | - | Props passed down to the Tooltip.Floating component |
