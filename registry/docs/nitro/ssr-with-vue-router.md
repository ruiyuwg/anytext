...
::code-tree{expand-all default-value="app/entry-server.ts"}
...
#### Create a server entry that renders your app with router support

#### Create a client entry that hydrates and takes over routing
...
- [Vue Router Documentation](https://router.vuejs.org/){rel=""nofollow""}
- [Unhead Documentation](https://unhead.unjs.io/){rel=""nofollow""}
