...
::code-tree{expand-all default-value="src/main.tsx"}
...
#### Create an HTML template with your app entry

#### Create a main entry that initializes the router
...
- [TanStack Router Documentation](https://tanstack.com/router){rel=""nofollow""}
