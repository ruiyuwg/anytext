...
# Class BatchCreateJobsResponse (2.17.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class BatchCreateJobsResponse extends GeneratedMessageV3 implements BatchCreateJobsResponseOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> BatchCreateJobsResponse

## Implements

[BatchCreateJobsResponseOrBuilder](/java/docs/reference/google-cloud-talent/2.17.0/com.google.cloud.talent.v4.BatchCreateJobsResponseOrBuilder)
...
### JOB\_RESULTS\_FIELD\_NUMBER

```
public static final int JOB_RESULTS_FIELD_NUMBER
```
...
```
public static BatchCreateJobsResponse getDefaultInstance()
```
...
`[BatchCreateJobsResponse](/java/docs/reference/google-cloud-talent/2.17.0/com.google.cloud.talent.v4.BatchCreateJobsResponse)`
...
```
public static BatchCreateJobsResponse.Builder newBuilder()
```
...
`[BatchCreateJobsResponse.Builder](/java/docs/reference/google-cloud-talent/2.17.0/com.google.cloud.talent.v4.BatchCreateJobsResponse.Builder)`

### newBuilder(BatchCreateJobsResponse prototype)

```
public static BatchCreateJobsResponse.Builder newBuilder(BatchCreateJobsResponse prototype)
```
...
```
public static BatchCreateJobsResponse parseDelimitedFrom(InputStream input)
```
...
```
public static BatchCreateJobsResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static BatchCreateJobsResponse parseFrom(byte[] data)
```
...
```
public static BatchCreateJobsResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static BatchCreateJobsResponse parseFrom(ByteString data)
```
...
```
public static BatchCreateJobsResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static BatchCreateJobsResponse parseFrom(CodedInputStream input)
```
...
```
public static BatchCreateJobsResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static BatchCreateJobsResponse parseFrom(InputStream input)
```
...
```
public static BatchCreateJobsResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static BatchCreateJobsResponse parseFrom(ByteBuffer data)
```
...
```
public static BatchCreateJobsResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<BatchCreateJobsResponse> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[BatchCreateJobsResponse](/java/docs/reference/google-cloud-talent/2.17.0/com.google.cloud.talent.v4.BatchCreateJobsResponse)>`
...
```
public BatchCreateJobsResponse getDefaultInstanceForType()
```
...
`[JobResult](/java/docs/reference/google-cloud-talent/2.17.0/com.google.cloud.talent.v4.JobResult)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[JobResult](/java/docs/reference/google-cloud-talent/2.17.0/com.google.cloud.talent.v4.JobResult)>`
...
`[JobResultOrBuilder](/java/docs/reference/google-cloud-talent/2.17.0/com.google.cloud.talent.v4.JobResultOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.talent.v4.JobResultOrBuilder>`

### getParserForType()

```
public Parser<BatchCreateJobsResponse> getParserForType()
```
...
```
public BatchCreateJobsResponse.Builder newBuilderForType()
```
...
```
protected BatchCreateJobsResponse.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public BatchCreateJobsResponse.Builder toBuilder()
```
