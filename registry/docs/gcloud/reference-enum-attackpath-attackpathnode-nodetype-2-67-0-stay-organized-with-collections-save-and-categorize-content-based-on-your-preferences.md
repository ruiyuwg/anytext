...
# Enum AttackPath.AttackPathNode.NodeType (2.67.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-securitycenter/2.67.0/com.google.cloud.securitycenter.v1.AttackPath.AttackPathNode.NodeType#com_google_cloud_securitycenter_v1_AttackPath_AttackPathNode_NodeType_forNumber_int_) instead._
