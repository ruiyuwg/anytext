...
# Class GetGuestAttributesResponse (2.25.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> GetGuestAttributesResponse

## Implements

[GetGuestAttributesResponseOrBuilder](/java/docs/reference/google-cloud-tpu/2.25.0/com.google.cloud.tpu.v2alpha1.GetGuestAttributesResponseOrBuilder)
...
### GUEST\_ATTRIBUTES\_FIELD\_NUMBER
...
`[GetGuestAttributesResponse](/java/docs/reference/google-cloud-tpu/2.25.0/com.google.cloud.tpu.v2alpha1.GetGuestAttributesResponse)`
...
`[GetGuestAttributesResponse.Builder](/java/docs/reference/google-cloud-tpu/2.25.0/com.google.cloud.tpu.v2alpha1.GetGuestAttributesResponse.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[GetGuestAttributesResponse](/java/docs/reference/google-cloud-tpu/2.25.0/com.google.cloud.tpu.v2alpha1.GetGuestAttributesResponse)>`
...
`[GuestAttributes](/java/docs/reference/google-cloud-tpu/2.25.0/com.google.cloud.tpu.v2alpha1.GuestAttributes)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[GuestAttributes](/java/docs/reference/google-cloud-tpu/2.25.0/com.google.cloud.tpu.v2alpha1.GuestAttributes)>`
...
`[GuestAttributesOrBuilder](/java/docs/reference/google-cloud-tpu/2.25.0/com.google.cloud.tpu.v2alpha1.GuestAttributesOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.tpu.v2alpha1.GuestAttributesOrBuilder>`
