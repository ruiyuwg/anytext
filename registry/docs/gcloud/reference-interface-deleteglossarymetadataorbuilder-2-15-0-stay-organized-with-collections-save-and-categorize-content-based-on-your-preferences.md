...
# Interface DeleteGlossaryMetadataOrBuilder (2.15.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[DeleteGlossaryMetadata.State](/java/docs/reference/google-cloud-translate/2.15.0/com.google.cloud.translate.v3beta1.DeleteGlossaryMetadata.State)`
