...
# Cloud AI Platform v1 API - Class ModelGardenService.ModelGardenServiceBase (2.17.0) Stay organized with collections Save and categorize content based on your preferences.
...
[object](https://learn.microsoft.com/dotnet/api/system.object) \> ModelGardenService.ModelGardenServiceBase
...
`[GetPublisherModelRequest](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/2.17.0/Google.Cloud.AIPlatform.V1.GetPublisherModelRequest)`  
...
`[Task](https://learn.microsoft.com/dotnet/api/system.threading.tasks.task-1)[PublisherModel](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/2.17.0/Google.Cloud.AIPlatform.V1.PublisherModel)`
