...
# Interface JobTemplateOrBuilder (1.50.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[JobConfig](/java/docs/reference/google-cloud-video-transcoder/1.50.0/com.google.cloud.video.transcoder.v1.JobConfig)`
...
`[JobConfigOrBuilder](/java/docs/reference/google-cloud-video-transcoder/1.50.0/com.google.cloud.video.transcoder.v1.JobConfigOrBuilder)`
...
Use [#getLabelsMap()](/java/docs/reference/google-cloud-video-transcoder/1.50.0/com.google.cloud.video.transcoder.v1.JobTemplateOrBuilder#com_google_cloud_video_transcoder_v1_JobTemplateOrBuilder_getLabelsMap__) instead.
