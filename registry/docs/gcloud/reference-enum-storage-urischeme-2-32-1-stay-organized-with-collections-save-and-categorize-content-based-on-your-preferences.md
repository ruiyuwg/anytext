...
# Enum Storage.UriScheme (2.32.1) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum Storage.UriScheme extends Enum<Storage.UriScheme>
```
