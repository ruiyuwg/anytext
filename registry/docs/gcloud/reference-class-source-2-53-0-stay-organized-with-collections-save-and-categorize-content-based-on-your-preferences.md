...
# Class Source (2.53.0) Stay organized with collections Save and categorize content based on your preferences.
...
### ADDITIONAL\_CONTEXTS\_FIELD\_NUMBER
...
### ARTIFACT\_STORAGE\_SOURCE\_URI\_FIELD\_NUMBER
...
`[Source](/java/docs/reference/grafeas/2.53.0/io.grafeas.v1.Source)`
...
`[Source.Builder](/java/docs/reference/grafeas/2.53.0/io.grafeas.v1.Source.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[Source](/java/docs/reference/grafeas/2.53.0/io.grafeas.v1.Source)>`
...
`[SourceContext](/java/docs/reference/grafeas/2.53.0/io.grafeas.v1.SourceContext)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[SourceContext](/java/docs/reference/grafeas/2.53.0/io.grafeas.v1.SourceContext)>`
...
`[SourceContextOrBuilder](/java/docs/reference/grafeas/2.53.0/io.grafeas.v1.SourceContextOrBuilder)`
...
Use [#getFileHashesMap()](/java/docs/reference/grafeas/2.53.0/io.grafeas.v1.Source#io_grafeas_v1_Source_getFileHashesMap__) instead.
...
`[Map](https://docs.oracle.com/javase/8/docs/api/java/util/Map.html)<[String](https://docs.oracle.com/javase/8/docs/api/java/lang/String.html),[FileHashes](/java/docs/reference/grafeas/2.53.0/io.grafeas.v1.FileHashes)>`
...
`[FileHashes](/java/docs/reference/grafeas/2.53.0/io.grafeas.v1.FileHashes)`  
