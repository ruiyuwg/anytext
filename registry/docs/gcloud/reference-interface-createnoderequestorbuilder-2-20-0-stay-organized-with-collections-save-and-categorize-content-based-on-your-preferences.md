...
# Interface CreateNodeRequestOrBuilder (2.20.0) Stay organized with collections Save and categorize content based on your preferences.
...
`.google.cloud.tpu.v1.Node node = 3 [(.google.api.field_behavior) = REQUIRED];`
...
`[Node](/java/docs/reference/google-cloud-tpu/2.20.0/com.google.cloud.tpu.v1.Node)`
...
`[NodeOrBuilder](/java/docs/reference/google-cloud-tpu/2.20.0/com.google.cloud.tpu.v1.NodeOrBuilder)`
