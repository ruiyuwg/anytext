...
# Class OrganizationName (1.18.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> OrganizationName
...
```
public static OrganizationName.Builder newBuilder()
```
...
`[OrganizationName.Builder](/java/docs/reference/google-cloud-resourcemanager/1.18.0/com.google.cloud.resourcemanager.v3.OrganizationName.Builder)`
...
`[OrganizationName](/java/docs/reference/google-cloud-resourcemanager/1.18.0/com.google.cloud.resourcemanager.v3.OrganizationName)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[OrganizationName](/java/docs/reference/google-cloud-resourcemanager/1.18.0/com.google.cloud.resourcemanager.v3.OrganizationName)>`

### toStringList(List<OrganizationName> values)
...
```
public OrganizationName.Builder toBuilder()
```
