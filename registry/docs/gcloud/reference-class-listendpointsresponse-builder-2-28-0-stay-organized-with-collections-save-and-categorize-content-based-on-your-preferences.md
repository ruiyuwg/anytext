...
# Class ListEndpointsResponse.Builder (2.28.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> ListEndpointsResponse.Builder

## Implements

[ListEndpointsResponseOrBuilder](/java/docs/reference/google-cloud-servicedirectory/2.28.0/com.google.cloud.servicedirectory.v1.ListEndpointsResponseOrBuilder)
...
`[Iterable](https://docs.oracle.com/javase/8/docs/api/java/lang/Iterable.html)<? extends com.google.cloud.servicedirectory.v1.Endpoint>`  
...
`[ListEndpointsResponse.Builder](/java/docs/reference/google-cloud-servicedirectory/2.28.0/com.google.cloud.servicedirectory.v1.ListEndpointsResponse.Builder)`
...
`[Endpoint](/java/docs/reference/google-cloud-servicedirectory/2.28.0/com.google.cloud.servicedirectory.v1.Endpoint)`  
...
`[Endpoint.Builder](/java/docs/reference/google-cloud-servicedirectory/2.28.0/com.google.cloud.servicedirectory.v1.Endpoint.Builder)`  
...
`[ListEndpointsResponse](/java/docs/reference/google-cloud-servicedirectory/2.28.0/com.google.cloud.servicedirectory.v1.ListEndpointsResponse)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Builder](/java/docs/reference/google-cloud-servicedirectory/2.28.0/com.google.cloud.servicedirectory.v1.Endpoint.Builder)>`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Endpoint](/java/docs/reference/google-cloud-servicedirectory/2.28.0/com.google.cloud.servicedirectory.v1.Endpoint)>`
...
`[EndpointOrBuilder](/java/docs/reference/google-cloud-servicedirectory/2.28.0/com.google.cloud.servicedirectory.v1.EndpointOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.servicedirectory.v1.EndpointOrBuilder>`
