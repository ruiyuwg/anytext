...
# Class SearchRequest.QueryExpansionSpec (2.5.1) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class SearchRequest.QueryExpansionSpec extends GeneratedMessageV3 implements SearchRequest.QueryExpansionSpecOrBuilder
```

Specification to determine under which conditions query expansion should occur.

Protobuf type `google.cloud.retail.v2alpha.SearchRequest.QueryExpansionSpec`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> SearchRequest.QueryExpansionSpec

## Implements

[SearchRequest.QueryExpansionSpecOrBuilder](/java/docs/reference/google-cloud-retail/2.5.1/com.google.cloud.retail.v2alpha.SearchRequest.QueryExpansionSpecOrBuilder)
...
### PIN\_UNEXPANDED\_RESULTS\_FIELD\_NUMBER

```
public static final int PIN_UNEXPANDED_RESULTS_FIELD_NUMBER
```
...
```
public static SearchRequest.QueryExpansionSpec getDefaultInstance()
```
...
[SearchRequest.QueryExpansionSpec](/java/docs/reference/google-cloud-retail/2.5.1/com.google.cloud.retail.v2alpha.SearchRequest.QueryExpansionSpec)
...
```
public static SearchRequest.QueryExpansionSpec.Builder newBuilder()
```
...
[SearchRequest.QueryExpansionSpec.Builder](/java/docs/reference/google-cloud-retail/2.5.1/com.google.cloud.retail.v2alpha.SearchRequest.QueryExpansionSpec.Builder)

### newBuilder(SearchRequest.QueryExpansionSpec prototype)

```
public static SearchRequest.QueryExpansionSpec.Builder newBuilder(SearchRequest.QueryExpansionSpec prototype)
```
...
```
public static SearchRequest.QueryExpansionSpec parseDelimitedFrom(InputStream input)
```
...
```
public static SearchRequest.QueryExpansionSpec parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SearchRequest.QueryExpansionSpec parseFrom(byte[] data)
```
...
```
public static SearchRequest.QueryExpansionSpec parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SearchRequest.QueryExpansionSpec parseFrom(ByteString data)
```
...
```
public static SearchRequest.QueryExpansionSpec parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SearchRequest.QueryExpansionSpec parseFrom(CodedInputStream input)
```
...
```
public static SearchRequest.QueryExpansionSpec parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SearchRequest.QueryExpansionSpec parseFrom(InputStream input)
```
...
```
public static SearchRequest.QueryExpansionSpec parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SearchRequest.QueryExpansionSpec parseFrom(ByteBuffer data)
```
...
```
public static SearchRequest.QueryExpansionSpec parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<SearchRequest.QueryExpansionSpec> parser()
```
...
[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[QueryExpansionSpec](/java/docs/reference/google-cloud-retail/2.5.1/com.google.cloud.retail.v2alpha.SearchRequest.QueryExpansionSpec)\>
...
[SearchRequest.QueryExpansionSpec.Condition](/java/docs/reference/google-cloud-retail/2.5.1/com.google.cloud.retail.v2alpha.SearchRequest.QueryExpansionSpec.Condition)
...
```
public Parser<SearchRequest.QueryExpansionSpec> getParserForType()
```
...
```
public SearchRequest.QueryExpansionSpec.Builder newBuilderForType()
```
...
```
protected SearchRequest.QueryExpansionSpec.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public SearchRequest.QueryExpansionSpec.Builder toBuilder()
```
