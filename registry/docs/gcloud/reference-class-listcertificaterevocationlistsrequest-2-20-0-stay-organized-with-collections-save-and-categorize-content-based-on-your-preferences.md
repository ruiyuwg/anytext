...
# Class ListCertificateRevocationListsRequest (2.20.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListCertificateRevocationListsRequest extends GeneratedMessageV3 implements ListCertificateRevocationListsRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListCertificateRevocationListsRequest

## Implements

[ListCertificateRevocationListsRequestOrBuilder](/java/docs/reference/google-cloud-security-private-ca/2.20.0/com.google.cloud.security.privateca.v1beta1.ListCertificateRevocationListsRequestOrBuilder)
...
```
public static ListCertificateRevocationListsRequest getDefaultInstance()
```
...
`[ListCertificateRevocationListsRequest](/java/docs/reference/google-cloud-security-private-ca/2.20.0/com.google.cloud.security.privateca.v1beta1.ListCertificateRevocationListsRequest)`
...
```
public static ListCertificateRevocationListsRequest.Builder newBuilder()
```
...
`[ListCertificateRevocationListsRequest.Builder](/java/docs/reference/google-cloud-security-private-ca/2.20.0/com.google.cloud.security.privateca.v1beta1.ListCertificateRevocationListsRequest.Builder)`

### newBuilder(ListCertificateRevocationListsRequest prototype)

```
public static ListCertificateRevocationListsRequest.Builder newBuilder(ListCertificateRevocationListsRequest prototype)
```
...
```
public static ListCertificateRevocationListsRequest parseDelimitedFrom(InputStream input)
```
...
```
public static ListCertificateRevocationListsRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListCertificateRevocationListsRequest parseFrom(byte[] data)
```
...
```
public static ListCertificateRevocationListsRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListCertificateRevocationListsRequest parseFrom(ByteString data)
```
...
```
public static ListCertificateRevocationListsRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListCertificateRevocationListsRequest parseFrom(CodedInputStream input)
```
...
```
public static ListCertificateRevocationListsRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListCertificateRevocationListsRequest parseFrom(InputStream input)
```
...
```
public static ListCertificateRevocationListsRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListCertificateRevocationListsRequest parseFrom(ByteBuffer data)
```
...
```
public static ListCertificateRevocationListsRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ListCertificateRevocationListsRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListCertificateRevocationListsRequest](/java/docs/reference/google-cloud-security-private-ca/2.20.0/com.google.cloud.security.privateca.v1beta1.ListCertificateRevocationListsRequest)>`
...
Optional. Limit on the number of CertificateRevocationLists to include in the response. Further CertificateRevocationLists can subsequently be obtained by including the ListCertificateRevocationListsResponse.next\_page\_token in a subsequent request. If unspecified, the server will pick an appropriate default.
...
Optional. Pagination token, returned earlier via ListCertificateRevocationListsResponse.next\_page\_token.
...
```
public Parser<ListCertificateRevocationListsRequest> getParserForType()
```
...
```
public ListCertificateRevocationListsRequest.Builder newBuilderForType()
```
...
```
protected ListCertificateRevocationListsRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ListCertificateRevocationListsRequest.Builder toBuilder()
```
