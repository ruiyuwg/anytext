...
# Class ListSpokesResponse (1.0.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListSpokesResponse extends GeneratedMessageV3 implements ListSpokesResponseOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListSpokesResponse

## Implements

[ListSpokesResponseOrBuilder](/java/docs/reference/google-cloud-networkconnectivity/1.0.0/com.google.cloud.networkconnectivity.v1.ListSpokesResponseOrBuilder)
...
```
public static ListSpokesResponse getDefaultInstance()
```
...
[ListSpokesResponse](/java/docs/reference/google-cloud-networkconnectivity/1.0.0/com.google.cloud.networkconnectivity.v1.ListSpokesResponse)
...
```
public static ListSpokesResponse.Builder newBuilder()
```
...
[ListSpokesResponse.Builder](/java/docs/reference/google-cloud-networkconnectivity/1.0.0/com.google.cloud.networkconnectivity.v1.ListSpokesResponse.Builder)

### newBuilder(ListSpokesResponse prototype)

```
public static ListSpokesResponse.Builder newBuilder(ListSpokesResponse prototype)
```
...
```
public static ListSpokesResponse parseDelimitedFrom(InputStream input)
```
...
```
public static ListSpokesResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListSpokesResponse parseFrom(byte[] data)
```
...
```
public static ListSpokesResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListSpokesResponse parseFrom(ByteString data)
```
...
```
public static ListSpokesResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListSpokesResponse parseFrom(CodedInputStream input)
```
...
```
public static ListSpokesResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListSpokesResponse parseFrom(InputStream input)
```
...
```
public static ListSpokesResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListSpokesResponse parseFrom(ByteBuffer data)
```
...
```
public static ListSpokesResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ListSpokesResponse> parser()
```
...
[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListSpokesResponse](/java/docs/reference/google-cloud-networkconnectivity/1.0.0/com.google.cloud.networkconnectivity.v1.ListSpokesResponse)\>
...
```
public Parser<ListSpokesResponse> getParserForType()
```
...
[Spoke](/java/docs/reference/google-cloud-networkconnectivity/1.0.0/com.google.cloud.networkconnectivity.v1.Spoke)
...
[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Spoke](/java/docs/reference/google-cloud-networkconnectivity/1.0.0/com.google.cloud.networkconnectivity.v1.Spoke)\>
...
[SpokeOrBuilder](/java/docs/reference/google-cloud-networkconnectivity/1.0.0/com.google.cloud.networkconnectivity.v1.SpokeOrBuilder)
...
[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.networkconnectivity.v1.SpokeOrBuilder\>
...
```
public ListSpokesResponse.Builder newBuilderForType()
```
...
```
protected ListSpokesResponse.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ListSpokesResponse.Builder toBuilder()
```
