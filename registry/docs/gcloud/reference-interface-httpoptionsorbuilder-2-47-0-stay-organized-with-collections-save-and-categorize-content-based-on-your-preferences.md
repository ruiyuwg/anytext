...
# Interface HttpOptionsOrBuilder (2.47.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[HttpAuthorizationHeader](/java/docs/reference/google-cloud-gsuite-addons/2.47.0/com.google.apps.script.type.HttpAuthorizationHeader)`
