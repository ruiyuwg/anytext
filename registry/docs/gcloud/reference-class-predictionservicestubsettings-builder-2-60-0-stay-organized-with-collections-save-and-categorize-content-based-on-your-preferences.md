...
# Class PredictionServiceStubSettings.Builder (2.60.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class PredictionServiceStubSettings.Builder extends StubSettings.Builder<PredictionServiceStubSettings,PredictionServiceStubSettings.Builder>
```
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [StubSettings.Builder](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.StubSettings.Builder.html) \> PredictionServiceStubSettings.Builder
...
`[PredictionServiceStubSettings](/java/docs/reference/google-cloud-retail/2.60.0/com.google.cloud.retail.v2alpha.stub.PredictionServiceStubSettings)`  
...
```
public PredictionServiceStubSettings.Builder applyToAllUnaryMethods(ApiFunction<UnaryCallSettings.Builder<?,?>,Void> settingsUpdater)
```
...
`[PredictionServiceStubSettings.Builder](/java/docs/reference/google-cloud-retail/2.60.0/com.google.cloud.retail.v2alpha.stub.PredictionServiceStubSettings.Builder)`

### build()

```
public PredictionServiceStubSettings build()
```
...
`[Builder](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.Builder.html)<[PredictRequest](/java/docs/reference/google-cloud-retail/2.60.0/com.google.cloud.retail.v2alpha.PredictRequest),[PredictResponse](/java/docs/reference/google-cloud-retail/2.60.0/com.google.cloud.retail.v2alpha.PredictResponse)>`
