...
# Interface StreamingVideoIntelligenceServiceGrpc.AsyncService (2.22.0) Stay organized with collections Save and categorize content based on your preferences.
...
`io.grpc.stub.StreamObserver<[StreamingAnnotateVideoResponse](/java/docs/reference/google-cloud-video-intelligence/2.22.0/com.google.cloud.videointelligence.v1p3beta1.StreamingAnnotateVideoResponse)>`  
...
`io.grpc.stub.StreamObserver<[StreamingAnnotateVideoRequest](/java/docs/reference/google-cloud-video-intelligence/2.22.0/com.google.cloud.videointelligence.v1p3beta1.StreamingAnnotateVideoRequest)>`
