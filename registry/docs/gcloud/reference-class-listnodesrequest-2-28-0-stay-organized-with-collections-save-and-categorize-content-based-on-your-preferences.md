...
# Class ListNodesRequest (2.28.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListNodesRequest extends GeneratedMessageV3 implements ListNodesRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListNodesRequest

## Implements

[ListNodesRequestOrBuilder](/java/docs/reference/google-cloud-tpu/2.28.0/com.google.cloud.tpu.v2.ListNodesRequestOrBuilder)
...
```
public static ListNodesRequest getDefaultInstance()
```
...
`[ListNodesRequest](/java/docs/reference/google-cloud-tpu/2.28.0/com.google.cloud.tpu.v2.ListNodesRequest)`
...
```
public static ListNodesRequest.Builder newBuilder()
```
...
`[ListNodesRequest.Builder](/java/docs/reference/google-cloud-tpu/2.28.0/com.google.cloud.tpu.v2.ListNodesRequest.Builder)`

### newBuilder(ListNodesRequest prototype)

```
public static ListNodesRequest.Builder newBuilder(ListNodesRequest prototype)
```
...
```
public static ListNodesRequest parseDelimitedFrom(InputStream input)
```
...
```
public static ListNodesRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListNodesRequest parseFrom(byte[] data)
```
...
```
public static ListNodesRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListNodesRequest parseFrom(ByteString data)
```
...
```
public static ListNodesRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListNodesRequest parseFrom(CodedInputStream input)
```
...
```
public static ListNodesRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListNodesRequest parseFrom(InputStream input)
```
...
```
public static ListNodesRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListNodesRequest parseFrom(ByteBuffer data)
```
...
```
public static ListNodesRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ListNodesRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListNodesRequest](/java/docs/reference/google-cloud-tpu/2.28.0/com.google.cloud.tpu.v2.ListNodesRequest)>`
...
```
public Parser<ListNodesRequest> getParserForType()
```
...
```
public ListNodesRequest.Builder newBuilderForType()
```
...
```
protected ListNodesRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
