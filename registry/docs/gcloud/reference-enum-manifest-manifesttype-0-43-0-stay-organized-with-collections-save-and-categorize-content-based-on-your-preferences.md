...
# Enum Manifest.ManifestType (0.43.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-live-stream/0.43.0/com.google.cloud.video.livestream.v1.Manifest.ManifestType#com_google_cloud_video_livestream_v1_Manifest_ManifestType_forNumber_int_) instead._
