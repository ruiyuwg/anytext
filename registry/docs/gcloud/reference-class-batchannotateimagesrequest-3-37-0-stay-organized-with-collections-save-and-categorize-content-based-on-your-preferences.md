...
# Class BatchAnnotateImagesRequest (3.37.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> BatchAnnotateImagesRequest

## Implements

[BatchAnnotateImagesRequestOrBuilder](/java/docs/reference/google-cloud-vision/3.37.0/com.google.cloud.vision.v1p3beta1.BatchAnnotateImagesRequestOrBuilder)
...
`[BatchAnnotateImagesRequest](/java/docs/reference/google-cloud-vision/3.37.0/com.google.cloud.vision.v1p3beta1.BatchAnnotateImagesRequest)`
...
`[BatchAnnotateImagesRequest.Builder](/java/docs/reference/google-cloud-vision/3.37.0/com.google.cloud.vision.v1p3beta1.BatchAnnotateImagesRequest.Builder)`
...
```
public static BatchAnnotateImagesRequest parseDelimitedFrom(InputStream input)
```
...
```
public static BatchAnnotateImagesRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static BatchAnnotateImagesRequest parseFrom(byte[] data)
```
...
```
public static BatchAnnotateImagesRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static BatchAnnotateImagesRequest parseFrom(ByteString data)
```
...
```
public static BatchAnnotateImagesRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static BatchAnnotateImagesRequest parseFrom(CodedInputStream input)
```
...
```
public static BatchAnnotateImagesRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static BatchAnnotateImagesRequest parseFrom(InputStream input)
```
...
```
public static BatchAnnotateImagesRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static BatchAnnotateImagesRequest parseFrom(ByteBuffer data)
```
...
```
public static BatchAnnotateImagesRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<BatchAnnotateImagesRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[BatchAnnotateImagesRequest](/java/docs/reference/google-cloud-vision/3.37.0/com.google.cloud.vision.v1p3beta1.BatchAnnotateImagesRequest)>`
...
```
public Parser<BatchAnnotateImagesRequest> getParserForType()
```
...
`[AnnotateImageRequest](/java/docs/reference/google-cloud-vision/3.37.0/com.google.cloud.vision.v1p3beta1.AnnotateImageRequest)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[AnnotateImageRequest](/java/docs/reference/google-cloud-vision/3.37.0/com.google.cloud.vision.v1p3beta1.AnnotateImageRequest)>`
...
`[AnnotateImageRequestOrBuilder](/java/docs/reference/google-cloud-vision/3.37.0/com.google.cloud.vision.v1p3beta1.AnnotateImageRequestOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.vision.v1p3beta1.AnnotateImageRequestOrBuilder>`
...
```
public BatchAnnotateImagesRequest.Builder newBuilderForType()
```
...
```
protected BatchAnnotateImagesRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public BatchAnnotateImagesRequest.Builder toBuilder()
```
