...
# Class MigrationCenterClient.ListReportConfigsFixedSizeCollection (0.24.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ListReportConfigsPage](/java/docs/reference/google-cloud-migrationcenter/0.24.0/com.google.cloud.migrationcenter.v1.MigrationCenterClient.ListReportConfigsPage)>`  
...
`[MigrationCenterClient.ListReportConfigsFixedSizeCollection](/java/docs/reference/google-cloud-migrationcenter/0.24.0/com.google.cloud.migrationcenter.v1.MigrationCenterClient.ListReportConfigsFixedSizeCollection)`
