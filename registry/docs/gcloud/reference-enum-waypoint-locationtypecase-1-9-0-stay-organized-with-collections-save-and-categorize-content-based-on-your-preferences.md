...
# Enum Waypoint.LocationTypeCase (1.9.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum Waypoint.LocationTypeCase extends Enum<Waypoint.LocationTypeCase> implements Internal.EnumLite, AbstractMessageLite.InternalOneOfEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-optimization/1.9.0/com.google.cloud.optimization.v1.Waypoint.LocationTypeCase#com_google_cloud_optimization_v1_Waypoint_LocationTypeCase_forNumber_int_) instead._
