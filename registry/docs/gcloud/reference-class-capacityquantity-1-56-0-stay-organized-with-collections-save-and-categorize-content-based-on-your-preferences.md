...
# Class CapacityQuantity (1.56.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class CapacityQuantity extends GeneratedMessageV3 implements CapacityQuantityOrBuilder
```
...
### TYPE\_FIELD\_NUMBER (deprecated)
...
### VALUE\_FIELD\_NUMBER (deprecated)
...
```
public static CapacityQuantity getDefaultInstance()
```
...
```
public static CapacityQuantity.Builder newBuilder()
```
...
```
public static CapacityQuantity.Builder newBuilder(CapacityQuantity prototype)
```
...
```
public static CapacityQuantity parseDelimitedFrom(InputStream input)
```
...
```
public static CapacityQuantity parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CapacityQuantity parseFrom(byte[] data)
```
...
```
public static CapacityQuantity parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CapacityQuantity parseFrom(ByteString data)
```
...
```
public static CapacityQuantity parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CapacityQuantity parseFrom(CodedInputStream input)
```
...
```
public static CapacityQuantity parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CapacityQuantity parseFrom(InputStream input)
```
...
```
public static CapacityQuantity parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CapacityQuantity parseFrom(ByteBuffer data)
```
...
```
public static CapacityQuantity parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<CapacityQuantity> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[CapacityQuantity](/java/docs/reference/google-cloud-optimization/1.56.0/com.google.cloud.optimization.v1.CapacityQuantity)>`
...
```
public CapacityQuantity getDefaultInstanceForType()
```
...
```
public Parser<CapacityQuantity> getParserForType()
```
...
```
public CapacityQuantity.Builder newBuilderForType()
```
...
```
protected CapacityQuantity.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public CapacityQuantity.Builder toBuilder()
```
