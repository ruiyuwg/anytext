...
# Interface TransferProto.DeleteAgentPoolRequestOrBuilder (1.32.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static interface TransferProto.DeleteAgentPoolRequestOrBuilder extends MessageOrBuilder
```
