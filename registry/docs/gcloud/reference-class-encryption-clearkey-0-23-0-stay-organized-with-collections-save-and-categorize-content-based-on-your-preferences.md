...
# Class Encryption.Clearkey (0.23.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class Encryption.Clearkey extends GeneratedMessageV3 implements Encryption.ClearkeyOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> Encryption.Clearkey

## Implements

[Encryption.ClearkeyOrBuilder](/java/docs/reference/google-cloud-live-stream/0.23.0/com.google.cloud.video.livestream.v1.Encryption.ClearkeyOrBuilder)
...
```
public static Encryption.Clearkey getDefaultInstance()
```
...
`[Encryption.Clearkey](/java/docs/reference/google-cloud-live-stream/0.23.0/com.google.cloud.video.livestream.v1.Encryption.Clearkey)`
...
```
public static Encryption.Clearkey.Builder newBuilder()
```
...
`[Encryption.Clearkey.Builder](/java/docs/reference/google-cloud-live-stream/0.23.0/com.google.cloud.video.livestream.v1.Encryption.Clearkey.Builder)`

### newBuilder(Encryption.Clearkey prototype)

```
public static Encryption.Clearkey.Builder newBuilder(Encryption.Clearkey prototype)
```
...
```
public static Encryption.Clearkey parseDelimitedFrom(InputStream input)
```
...
```
public static Encryption.Clearkey parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Encryption.Clearkey parseFrom(byte[] data)
```
...
```
public static Encryption.Clearkey parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Encryption.Clearkey parseFrom(ByteString data)
```
...
```
public static Encryption.Clearkey parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Encryption.Clearkey parseFrom(CodedInputStream input)
```
...
```
public static Encryption.Clearkey parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Encryption.Clearkey parseFrom(InputStream input)
```
...
```
public static Encryption.Clearkey parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Encryption.Clearkey parseFrom(ByteBuffer data)
```
...
```
public static Encryption.Clearkey parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<Encryption.Clearkey> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[Clearkey](/java/docs/reference/google-cloud-live-stream/0.23.0/com.google.cloud.video.livestream.v1.Encryption.Clearkey)>`
...
```
public Encryption.Clearkey getDefaultInstanceForType()
```
...
```
public Parser<Encryption.Clearkey> getParserForType()
```
...
```
public Encryption.Clearkey.Builder newBuilderForType()
```
...
```
protected Encryption.Clearkey.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public Encryption.Clearkey.Builder toBuilder()
```
