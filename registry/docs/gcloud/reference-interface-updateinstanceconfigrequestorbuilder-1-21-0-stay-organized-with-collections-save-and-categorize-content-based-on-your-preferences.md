...
# Interface UpdateInstanceConfigRequestOrBuilder (1.21.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[InstanceConfig](/java/docs/reference/google-cloud-notebooks/1.21.0/com.google.cloud.notebooks.v1.InstanceConfig)`
...
`[InstanceConfigOrBuilder](/java/docs/reference/google-cloud-notebooks/1.21.0/com.google.cloud.notebooks.v1.InstanceConfigOrBuilder)`
