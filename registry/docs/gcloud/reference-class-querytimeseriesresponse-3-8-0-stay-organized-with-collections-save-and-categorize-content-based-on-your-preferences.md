...
# Class QueryTimeSeriesResponse (3.8.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> QueryTimeSeriesResponse

## Implements

[QueryTimeSeriesResponseOrBuilder](/java/docs/reference/google-cloud-monitoring/3.8.0/com.google.monitoring.v3.QueryTimeSeriesResponseOrBuilder)
...
### PARTIAL\_ERRORS\_FIELD\_NUMBER
...
### TIME\_SERIES\_DATA\_FIELD\_NUMBER
...
### TIME\_SERIES\_DESCRIPTOR\_FIELD\_NUMBER

```
public static final int TIME_SERIES_DESCRIPTOR_FIELD_NUMBER
```
...
[QueryTimeSeriesResponse](/java/docs/reference/google-cloud-monitoring/3.8.0/com.google.monitoring.v3.QueryTimeSeriesResponse)
...
```
public static QueryTimeSeriesResponse.Builder newBuilder()
```
...
[QueryTimeSeriesResponse.Builder](/java/docs/reference/google-cloud-monitoring/3.8.0/com.google.monitoring.v3.QueryTimeSeriesResponse.Builder)
...
```
public static QueryTimeSeriesResponse parseDelimitedFrom(InputStream input)
```
...
```
public static QueryTimeSeriesResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static QueryTimeSeriesResponse parseFrom(byte[] data)
```
...
```
public static QueryTimeSeriesResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static QueryTimeSeriesResponse parseFrom(ByteString data)
```
...
```
public static QueryTimeSeriesResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static QueryTimeSeriesResponse parseFrom(CodedInputStream input)
```
...
```
public static QueryTimeSeriesResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static QueryTimeSeriesResponse parseFrom(InputStream input)
```
...
```
public static QueryTimeSeriesResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static QueryTimeSeriesResponse parseFrom(ByteBuffer data)
```
...
```
public static QueryTimeSeriesResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[QueryTimeSeriesResponse](/java/docs/reference/google-cloud-monitoring/3.8.0/com.google.monitoring.v3.QueryTimeSeriesResponse)\>
...
[TimeSeriesData](/java/docs/reference/google-cloud-monitoring/3.8.0/com.google.monitoring.v3.TimeSeriesData)
...
[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[TimeSeriesData](/java/docs/reference/google-cloud-monitoring/3.8.0/com.google.monitoring.v3.TimeSeriesData)\>
...
[TimeSeriesDataOrBuilder](/java/docs/reference/google-cloud-monitoring/3.8.0/com.google.monitoring.v3.TimeSeriesDataOrBuilder)
...
[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.monitoring.v3.TimeSeriesDataOrBuilder\>
...
[TimeSeriesDescriptor](/java/docs/reference/google-cloud-monitoring/3.8.0/com.google.monitoring.v3.TimeSeriesDescriptor)
...
[TimeSeriesDescriptorOrBuilder](/java/docs/reference/google-cloud-monitoring/3.8.0/com.google.monitoring.v3.TimeSeriesDescriptorOrBuilder)
...
```
public QueryTimeSeriesResponse.Builder newBuilderForType()
```
...
```
protected QueryTimeSeriesResponse.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
