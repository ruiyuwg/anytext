...
# Class OSPolicy.Builder (2.14.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> OSPolicy.Builder

## Implements

[OSPolicyOrBuilder](/java/docs/reference/google-cloud-os-config/2.14.0/com.google.cloud.osconfig.v1alpha.OSPolicyOrBuilder)
...
`[Iterable](https://docs.oracle.com/javase/8/docs/api/java/lang/Iterable.html)<? extends com.google.cloud.osconfig.v1alpha.OSPolicy.ResourceGroup>`  
...
`[OSPolicy.Builder](/java/docs/reference/google-cloud-os-config/2.14.0/com.google.cloud.osconfig.v1alpha.OSPolicy.Builder)`
...
`[OSPolicy.ResourceGroup](/java/docs/reference/google-cloud-os-config/2.14.0/com.google.cloud.osconfig.v1alpha.OSPolicy.ResourceGroup)`  
...
`[OSPolicy.ResourceGroup.Builder](/java/docs/reference/google-cloud-os-config/2.14.0/com.google.cloud.osconfig.v1alpha.OSPolicy.ResourceGroup.Builder)`  
...
`[OSPolicy](/java/docs/reference/google-cloud-os-config/2.14.0/com.google.cloud.osconfig.v1alpha.OSPolicy)`
...
`[OSPolicy.Mode](/java/docs/reference/google-cloud-os-config/2.14.0/com.google.cloud.osconfig.v1alpha.OSPolicy.Mode)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Builder](/java/docs/reference/google-cloud-os-config/2.14.0/com.google.cloud.osconfig.v1alpha.OSPolicy.ResourceGroup.Builder)>`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ResourceGroup](/java/docs/reference/google-cloud-os-config/2.14.0/com.google.cloud.osconfig.v1alpha.OSPolicy.ResourceGroup)>`
...
`[OSPolicy.ResourceGroupOrBuilder](/java/docs/reference/google-cloud-os-config/2.14.0/com.google.cloud.osconfig.v1alpha.OSPolicy.ResourceGroupOrBuilder)`
