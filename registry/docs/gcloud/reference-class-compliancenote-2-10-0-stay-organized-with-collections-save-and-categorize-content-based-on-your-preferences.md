...
# Class ComplianceNote (2.10.0) Stay organized with collections Save and categorize content based on your preferences.
...
### SCAN\_INSTRUCTIONS\_FIELD\_NUMBER
...
`[ComplianceNote](/java/docs/reference/grafeas/2.10.0/io.grafeas.v1.ComplianceNote)`
...
`[ComplianceNote.Builder](/java/docs/reference/grafeas/2.10.0/io.grafeas.v1.ComplianceNote.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ComplianceNote](/java/docs/reference/grafeas/2.10.0/io.grafeas.v1.ComplianceNote)>`
...
`[ComplianceNote.CisBenchmark](/java/docs/reference/grafeas/2.10.0/io.grafeas.v1.ComplianceNote.CisBenchmark)`
...
`[ComplianceNote.CisBenchmarkOrBuilder](/java/docs/reference/grafeas/2.10.0/io.grafeas.v1.ComplianceNote.CisBenchmarkOrBuilder)`
...
`[ComplianceNote.ComplianceTypeCase](/java/docs/reference/grafeas/2.10.0/io.grafeas.v1.ComplianceNote.ComplianceTypeCase)`
...
`[ComplianceVersion](/java/docs/reference/grafeas/2.10.0/io.grafeas.v1.ComplianceVersion)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ComplianceVersion](/java/docs/reference/grafeas/2.10.0/io.grafeas.v1.ComplianceVersion)>`
...
`[ComplianceVersionOrBuilder](/java/docs/reference/grafeas/2.10.0/io.grafeas.v1.ComplianceVersionOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends io.grafeas.v1.ComplianceVersionOrBuilder>`
