...
# Class ImportUserEventsResponse (0.66.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ImportUserEventsResponse extends GeneratedMessageV3 implements ImportUserEventsResponseOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ImportUserEventsResponse

## Implements

[ImportUserEventsResponseOrBuilder](/java/docs/reference/google-cloud-recommendations-ai/0.66.0/com.google.cloud.recommendationengine.v1beta1.ImportUserEventsResponseOrBuilder)
...
### IMPORT\_SUMMARY\_FIELD\_NUMBER

```
public static final int IMPORT_SUMMARY_FIELD_NUMBER
```
...
```
public static ImportUserEventsResponse getDefaultInstance()
```
...
`[ImportUserEventsResponse](/java/docs/reference/google-cloud-recommendations-ai/0.66.0/com.google.cloud.recommendationengine.v1beta1.ImportUserEventsResponse)`
...
```
public static ImportUserEventsResponse.Builder newBuilder()
```
...
`[ImportUserEventsResponse.Builder](/java/docs/reference/google-cloud-recommendations-ai/0.66.0/com.google.cloud.recommendationengine.v1beta1.ImportUserEventsResponse.Builder)`

### newBuilder(ImportUserEventsResponse prototype)

```
public static ImportUserEventsResponse.Builder newBuilder(ImportUserEventsResponse prototype)
```
...
```
public static ImportUserEventsResponse parseDelimitedFrom(InputStream input)
```
...
```
public static ImportUserEventsResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ImportUserEventsResponse parseFrom(byte[] data)
```
...
```
public static ImportUserEventsResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ImportUserEventsResponse parseFrom(ByteString data)
```
...
```
public static ImportUserEventsResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ImportUserEventsResponse parseFrom(CodedInputStream input)
```
...
```
public static ImportUserEventsResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ImportUserEventsResponse parseFrom(InputStream input)
```
...
```
public static ImportUserEventsResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ImportUserEventsResponse parseFrom(ByteBuffer data)
```
...
```
public static ImportUserEventsResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ImportUserEventsResponse> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ImportUserEventsResponse](/java/docs/reference/google-cloud-recommendations-ai/0.66.0/com.google.cloud.recommendationengine.v1beta1.ImportUserEventsResponse)>`
...
`[ImportErrorsConfig](/java/docs/reference/google-cloud-recommendations-ai/0.66.0/com.google.cloud.recommendationengine.v1beta1.ImportErrorsConfig)`
...
`[ImportErrorsConfigOrBuilder](/java/docs/reference/google-cloud-recommendations-ai/0.66.0/com.google.cloud.recommendationengine.v1beta1.ImportErrorsConfigOrBuilder)`
...
`[UserEventImportSummary](/java/docs/reference/google-cloud-recommendations-ai/0.66.0/com.google.cloud.recommendationengine.v1beta1.UserEventImportSummary)`
...
`[UserEventImportSummaryOrBuilder](/java/docs/reference/google-cloud-recommendations-ai/0.66.0/com.google.cloud.recommendationengine.v1beta1.UserEventImportSummaryOrBuilder)`

### getParserForType()

```
public Parser<ImportUserEventsResponse> getParserForType()
```
...
```
public ImportUserEventsResponse.Builder newBuilderForType()
```
...
```
protected ImportUserEventsResponse.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ImportUserEventsResponse.Builder toBuilder()
```
