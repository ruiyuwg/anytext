...
# Class CreatePredictionApiKeyRegistrationRequest (0.47.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class CreatePredictionApiKeyRegistrationRequest extends GeneratedMessageV3 implements CreatePredictionApiKeyRegistrationRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> CreatePredictionApiKeyRegistrationRequest

## Implements

[CreatePredictionApiKeyRegistrationRequestOrBuilder](/java/docs/reference/google-cloud-recommendations-ai/0.47.0/com.google.cloud.recommendationengine.v1beta1.CreatePredictionApiKeyRegistrationRequestOrBuilder)
...
### PREDICTION\_API\_KEY\_REGISTRATION\_FIELD\_NUMBER

```
public static final int PREDICTION_API_KEY_REGISTRATION_FIELD_NUMBER
```
...
```
public static CreatePredictionApiKeyRegistrationRequest getDefaultInstance()
```
...
`[CreatePredictionApiKeyRegistrationRequest](/java/docs/reference/google-cloud-recommendations-ai/0.47.0/com.google.cloud.recommendationengine.v1beta1.CreatePredictionApiKeyRegistrationRequest)`
...
```
public static CreatePredictionApiKeyRegistrationRequest.Builder newBuilder()
```
...
`[CreatePredictionApiKeyRegistrationRequest.Builder](/java/docs/reference/google-cloud-recommendations-ai/0.47.0/com.google.cloud.recommendationengine.v1beta1.CreatePredictionApiKeyRegistrationRequest.Builder)`

### newBuilder(CreatePredictionApiKeyRegistrationRequest prototype)

```
public static CreatePredictionApiKeyRegistrationRequest.Builder newBuilder(CreatePredictionApiKeyRegistrationRequest prototype)
```
...
```
public static CreatePredictionApiKeyRegistrationRequest parseDelimitedFrom(InputStream input)
```
...
```
public static CreatePredictionApiKeyRegistrationRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreatePredictionApiKeyRegistrationRequest parseFrom(byte[] data)
```
...
```
public static CreatePredictionApiKeyRegistrationRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreatePredictionApiKeyRegistrationRequest parseFrom(ByteString data)
```
...
```
public static CreatePredictionApiKeyRegistrationRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreatePredictionApiKeyRegistrationRequest parseFrom(CodedInputStream input)
```
...
```
public static CreatePredictionApiKeyRegistrationRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreatePredictionApiKeyRegistrationRequest parseFrom(InputStream input)
```
...
```
public static CreatePredictionApiKeyRegistrationRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreatePredictionApiKeyRegistrationRequest parseFrom(ByteBuffer data)
```
...
```
public static CreatePredictionApiKeyRegistrationRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<CreatePredictionApiKeyRegistrationRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[CreatePredictionApiKeyRegistrationRequest](/java/docs/reference/google-cloud-recommendations-ai/0.47.0/com.google.cloud.recommendationengine.v1beta1.CreatePredictionApiKeyRegistrationRequest)>`
...
```
public Parser<CreatePredictionApiKeyRegistrationRequest> getParserForType()
```
...
`[PredictionApiKeyRegistration](/java/docs/reference/google-cloud-recommendations-ai/0.47.0/com.google.cloud.recommendationengine.v1beta1.PredictionApiKeyRegistration)`
...
`[PredictionApiKeyRegistrationOrBuilder](/java/docs/reference/google-cloud-recommendations-ai/0.47.0/com.google.cloud.recommendationengine.v1beta1.PredictionApiKeyRegistrationOrBuilder)`
...
```
public CreatePredictionApiKeyRegistrationRequest.Builder newBuilderForType()
```
...
```
protected CreatePredictionApiKeyRegistrationRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public CreatePredictionApiKeyRegistrationRequest.Builder toBuilder()
```
