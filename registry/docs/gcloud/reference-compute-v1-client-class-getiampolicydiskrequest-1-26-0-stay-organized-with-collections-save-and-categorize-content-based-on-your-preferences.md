...
# Compute V1 Client - Class GetIamPolicyDiskRequest (1.26.0) Stay organized with collections Save and categorize content based on your preferences.
...
Reference documentation and code samples for the Compute V1 Client class GetIamPolicyDiskRequest.

A request message for Disks.GetIamPolicy. See the method description for details.

Generated from protobuf message `google.cloud.compute.v1.GetIamPolicyDiskRequest`
...
`[GetIamPolicyDiskRequest](/php/docs/reference/cloud-compute/1.26.0/V1.GetIamPolicyDiskRequest)`
