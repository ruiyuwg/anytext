...
# Enum SearchRequest.SpellCorrectionSpec.Mode (2.19.0) Stay organized with collections Save and categorize content based on your preferences.
...
Google Retail Search will try to find a spell suggestion if there is any and put in the SearchResponse.corrected\_query. The spell suggestion will not be used as the search query.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-retail/2.19.0/com.google.cloud.retail.v2beta.SearchRequest.SpellCorrectionSpec.Mode#com_google_cloud_retail_v2beta_SearchRequest_SpellCorrectionSpec_Mode_forNumber_int_) instead._
