...
# Enum ImportErrorsConfig.DestinationCase (2.32.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-retail/2.32.0/com.google.cloud.retail.v2alpha.ImportErrorsConfig.DestinationCase#com_google_cloud_retail_v2alpha_ImportErrorsConfig_DestinationCase_forNumber_int_) instead._
