...
# Interface AwsNodePoolAutoscalingOrBuilder (0.58.0) Stay organized with collections Save and categorize content based on your preferences.
...
Required. Maximum number of nodes in the node pool. Must be greater than or equal to min\_node\_count and less than or equal to 50.
...
Required. Minimum number of nodes in the node pool. Must be greater than or equal to 1 and less than or equal to max\_node\_count.
