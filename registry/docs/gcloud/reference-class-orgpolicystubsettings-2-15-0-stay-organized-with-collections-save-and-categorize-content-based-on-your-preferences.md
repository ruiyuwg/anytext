...
# Class OrgPolicyStubSettings (2.15.0) Stay organized with collections Save and categorize content based on your preferences.
...
Settings class to configure an instance of [OrgPolicyStub](/java/docs/reference/google-cloud-orgpolicy/2.15.0/com.google.cloud.orgpolicy.v2.stub.OrgPolicyStub).
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [StubSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.StubSettings.html) \> OrgPolicyStubSettings
...
```
public static OrgPolicyStubSettings.Builder newBuilder()
```
...
`[OrgPolicyStubSettings.Builder](/java/docs/reference/google-cloud-orgpolicy/2.15.0/com.google.cloud.orgpolicy.v2.stub.OrgPolicyStubSettings.Builder)`

### newBuilder(ClientContext clientContext)

```
public static OrgPolicyStubSettings.Builder newBuilder(ClientContext clientContext)
```
...
```
public static OrgPolicyStubSettings.Builder newHttpJsonBuilder()
```
...
### OrgPolicyStubSettings(OrgPolicyStubSettings.Builder settingsBuilder)

```
protected OrgPolicyStubSettings(OrgPolicyStubSettings.Builder settingsBuilder)
```
...
`[UnaryCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.html)<[CreatePolicyRequest](/java/docs/reference/google-cloud-orgpolicy/2.15.0/com.google.cloud.orgpolicy.v2.CreatePolicyRequest),[Policy](/java/docs/reference/google-cloud-orgpolicy/2.15.0/com.google.cloud.orgpolicy.v2.Policy)>`

### createStub()

```
public OrgPolicyStub createStub()
```
...
`[OrgPolicyStub](/java/docs/reference/google-cloud-orgpolicy/2.15.0/com.google.cloud.orgpolicy.v2.stub.OrgPolicyStub)`
...
`[UnaryCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.html)<[DeletePolicyRequest](/java/docs/reference/google-cloud-orgpolicy/2.15.0/com.google.cloud.orgpolicy.v2.DeletePolicyRequest),[Empty](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Empty.html)>`
...
`[UnaryCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.html)<[GetEffectivePolicyRequest](/java/docs/reference/google-cloud-orgpolicy/2.15.0/com.google.cloud.orgpolicy.v2.GetEffectivePolicyRequest),[Policy](/java/docs/reference/google-cloud-orgpolicy/2.15.0/com.google.cloud.orgpolicy.v2.Policy)>`
...
`[UnaryCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.html)<[GetPolicyRequest](/java/docs/reference/google-cloud-orgpolicy/2.15.0/com.google.cloud.orgpolicy.v2.GetPolicyRequest),[Policy](/java/docs/reference/google-cloud-orgpolicy/2.15.0/com.google.cloud.orgpolicy.v2.Policy)>`
...
`[PagedCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PagedCallSettings.html)<[ListConstraintsRequest](/java/docs/reference/google-cloud-orgpolicy/2.15.0/com.google.cloud.orgpolicy.v2.ListConstraintsRequest),[ListConstraintsResponse](/java/docs/reference/google-cloud-orgpolicy/2.15.0/com.google.cloud.orgpolicy.v2.ListConstraintsResponse),[ListConstraintsPagedResponse](/java/docs/reference/google-cloud-orgpolicy/2.15.0/com.google.cloud.orgpolicy.v2.OrgPolicyClient.ListConstraintsPagedResponse)>`
...
`[PagedCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PagedCallSettings.html)<[ListPoliciesRequest](/java/docs/reference/google-cloud-orgpolicy/2.15.0/com.google.cloud.orgpolicy.v2.ListPoliciesRequest),[ListPoliciesResponse](/java/docs/reference/google-cloud-orgpolicy/2.15.0/com.google.cloud.orgpolicy.v2.ListPoliciesResponse),[ListPoliciesPagedResponse](/java/docs/reference/google-cloud-orgpolicy/2.15.0/com.google.cloud.orgpolicy.v2.OrgPolicyClient.ListPoliciesPagedResponse)>`

### toBuilder()

```
public OrgPolicyStubSettings.Builder toBuilder()
```
...
`[UnaryCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.html)<[UpdatePolicyRequest](/java/docs/reference/google-cloud-orgpolicy/2.15.0/com.google.cloud.orgpolicy.v2.UpdatePolicyRequest),[Policy](/java/docs/reference/google-cloud-orgpolicy/2.15.0/com.google.cloud.orgpolicy.v2.Policy)>`
