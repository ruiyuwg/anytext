...
# Class Member (0.26.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static Member.Builder newBuilder()
```
...
### newBuilder(Member prototype)

```
public static Member.Builder newBuilder(Member prototype)
```
...
```
public static Member parseDelimitedFrom(InputStream input)
```
...
```
public static Member parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Member parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Member parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Member parseFrom(CodedInputStream input)
```
...
```
public static Member parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Member parseFrom(InputStream input)
```
...
```
public static Member parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Member parseFrom(ByteBuffer data)
```
...
```
public static Member parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[Member](/java/docs/reference/google-cloud-meet/0.26.0/com.google.apps.meet.v2beta.Member)>`
...
`[Member.Role](/java/docs/reference/google-cloud-meet/0.26.0/com.google.apps.meet.v2beta.Member.Role)`
...
```
public Member.Builder newBuilderForType()
```
...
```
protected Member.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
