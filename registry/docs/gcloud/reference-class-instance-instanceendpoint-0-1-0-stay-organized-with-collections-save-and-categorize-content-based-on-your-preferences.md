...
# Class Instance.InstanceEndpoint (0.1.0) Stay organized with collections Save and categorize content based on your preferences.

0.33.0 (latest) 0.31.0 0.29.0 0.28.0 0.26.0 0.24.0 0.22.0 0.21.0 0.20.0 0.19.0 0.18.0 0.16.0 0.14.0 0.13.0 0.10.0 0.9.0 0.8.0 0.6.0 0.5.0 0.4.0 0.3.0 0.2.0 0.1.0

```
public static final class Instance.InstanceEndpoint extends GeneratedMessageV3 implements Instance.InstanceEndpointOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> Instance.InstanceEndpoint

## Implements

[Instance.InstanceEndpointOrBuilder](/java/docs/reference/google-cloud-valkey/0.1.0/com.google.cloud.memorystore.v1beta.Instance.InstanceEndpointOrBuilder)
...
```
public static Instance.InstanceEndpoint getDefaultInstance()
```
...
`[Instance.InstanceEndpoint](/java/docs/reference/google-cloud-valkey/0.1.0/com.google.cloud.memorystore.v1beta.Instance.InstanceEndpoint)`
...
```
public static Instance.InstanceEndpoint.Builder newBuilder()
```
...
`[Instance.InstanceEndpoint.Builder](/java/docs/reference/google-cloud-valkey/0.1.0/com.google.cloud.memorystore.v1beta.Instance.InstanceEndpoint.Builder)`

### newBuilder(Instance.InstanceEndpoint prototype)

```
public static Instance.InstanceEndpoint.Builder newBuilder(Instance.InstanceEndpoint prototype)
```
...
```
public static Instance.InstanceEndpoint parseDelimitedFrom(InputStream input)
```
...
```
public static Instance.InstanceEndpoint parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Instance.InstanceEndpoint parseFrom(byte[] data)
```
...
```
public static Instance.InstanceEndpoint parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Instance.InstanceEndpoint parseFrom(ByteString data)
```
...
```
public static Instance.InstanceEndpoint parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Instance.InstanceEndpoint parseFrom(CodedInputStream input)
```
...
```
public static Instance.InstanceEndpoint parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Instance.InstanceEndpoint parseFrom(InputStream input)
```
...
```
public static Instance.InstanceEndpoint parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Instance.InstanceEndpoint parseFrom(ByteBuffer data)
```
...
```
public static Instance.InstanceEndpoint parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<Instance.InstanceEndpoint> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[InstanceEndpoint](/java/docs/reference/google-cloud-valkey/0.1.0/com.google.cloud.memorystore.v1beta.Instance.InstanceEndpoint)>`
...
`[Instance.ConnectionDetail](/java/docs/reference/google-cloud-valkey/0.1.0/com.google.cloud.memorystore.v1beta.Instance.ConnectionDetail)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ConnectionDetail](/java/docs/reference/google-cloud-valkey/0.1.0/com.google.cloud.memorystore.v1beta.Instance.ConnectionDetail)>`
...
`[Instance.ConnectionDetailOrBuilder](/java/docs/reference/google-cloud-valkey/0.1.0/com.google.cloud.memorystore.v1beta.Instance.ConnectionDetailOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.memorystore.v1beta.Instance.ConnectionDetailOrBuilder>`
...
```
public Parser<Instance.InstanceEndpoint> getParserForType()
```
...
```
public Instance.InstanceEndpoint.Builder newBuilderForType()
```
...
```
protected Instance.InstanceEndpoint.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public Instance.InstanceEndpoint.Builder toBuilder()
```
