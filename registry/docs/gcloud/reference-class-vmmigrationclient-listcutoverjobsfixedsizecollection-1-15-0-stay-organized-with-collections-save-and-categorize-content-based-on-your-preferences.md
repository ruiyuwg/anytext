...
# Class VmMigrationClient.ListCutoverJobsFixedSizeCollection (1.15.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class VmMigrationClient.ListCutoverJobsFixedSizeCollection extends AbstractFixedSizeCollection<ListCutoverJobsRequest,ListCutoverJobsResponse,CutoverJob,VmMigrationClient.ListCutoverJobsPage,VmMigrationClient.ListCutoverJobsFixedSizeCollection>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractFixedSizeCollection](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractFixedSizeCollection.html) \> VmMigrationClient.ListCutoverJobsFixedSizeCollection
...
### createCollection(List<VmMigrationClient.ListCutoverJobsPage> pages, int collectionSize)

```
protected VmMigrationClient.ListCutoverJobsFixedSizeCollection createCollection(List<VmMigrationClient.ListCutoverJobsPage> pages, int collectionSize)
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ListCutoverJobsPage](/java/docs/reference/google-cloud-vmmigration/1.15.0/com.google.cloud.vmmigration.v1.VmMigrationClient.ListCutoverJobsPage)>`  
...
`[VmMigrationClient.ListCutoverJobsFixedSizeCollection](/java/docs/reference/google-cloud-vmmigration/1.15.0/com.google.cloud.vmmigration.v1.VmMigrationClient.ListCutoverJobsFixedSizeCollection)`
