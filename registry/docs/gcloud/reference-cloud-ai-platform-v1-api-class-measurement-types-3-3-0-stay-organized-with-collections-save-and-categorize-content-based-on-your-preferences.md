...
# Cloud AI Platform v1 API - Class Measurement.Types (3.3.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class Measurement.Types
```

Reference documentation and code samples for the Cloud AI Platform v1 API class Measurement.Types.

Container for nested types declared in the Measurement message type.

## Inheritance

[object](https://learn.microsoft.com/dotnet/api/system.object) \> Measurement.Types
