...
# Class DeleteCatalogItemRequest (0.34.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class DeleteCatalogItemRequest extends GeneratedMessageV3 implements DeleteCatalogItemRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> DeleteCatalogItemRequest

## Implements

[DeleteCatalogItemRequestOrBuilder](/java/docs/reference/google-cloud-recommendations-ai/0.34.0/com.google.cloud.recommendationengine.v1beta1.DeleteCatalogItemRequestOrBuilder)
...
```
public static DeleteCatalogItemRequest getDefaultInstance()
```
...
`[DeleteCatalogItemRequest](/java/docs/reference/google-cloud-recommendations-ai/0.34.0/com.google.cloud.recommendationengine.v1beta1.DeleteCatalogItemRequest)`
...
```
public static DeleteCatalogItemRequest.Builder newBuilder()
```
...
`[DeleteCatalogItemRequest.Builder](/java/docs/reference/google-cloud-recommendations-ai/0.34.0/com.google.cloud.recommendationengine.v1beta1.DeleteCatalogItemRequest.Builder)`

### newBuilder(DeleteCatalogItemRequest prototype)

```
public static DeleteCatalogItemRequest.Builder newBuilder(DeleteCatalogItemRequest prototype)
```
...
```
public static DeleteCatalogItemRequest parseDelimitedFrom(InputStream input)
```
...
```
public static DeleteCatalogItemRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteCatalogItemRequest parseFrom(byte[] data)
```
...
```
public static DeleteCatalogItemRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteCatalogItemRequest parseFrom(ByteString data)
```
...
```
public static DeleteCatalogItemRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteCatalogItemRequest parseFrom(CodedInputStream input)
```
...
```
public static DeleteCatalogItemRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteCatalogItemRequest parseFrom(InputStream input)
```
...
```
public static DeleteCatalogItemRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteCatalogItemRequest parseFrom(ByteBuffer data)
```
...
```
public static DeleteCatalogItemRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<DeleteCatalogItemRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[DeleteCatalogItemRequest](/java/docs/reference/google-cloud-recommendations-ai/0.34.0/com.google.cloud.recommendationengine.v1beta1.DeleteCatalogItemRequest)>`
...
```
public DeleteCatalogItemRequest getDefaultInstanceForType()
```
...
```
public Parser<DeleteCatalogItemRequest> getParserForType()
```
...
```
public DeleteCatalogItemRequest.Builder newBuilderForType()
```
...
```
protected DeleteCatalogItemRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public DeleteCatalogItemRequest.Builder toBuilder()
```
