...
# Class SecurityPostureClient.ListPosturesPage (0.10.0) Stay organized with collections Save and categorize content based on your preferences.
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractPage](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractPage.html) \> SecurityPostureClient.ListPosturesPage
...
`[PageContext](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PageContext.html)<[ListPosturesRequest](/java/docs/reference/google-cloud-securityposture/0.10.0/com.google.cloud.securityposture.v1.ListPosturesRequest),[ListPosturesResponse](/java/docs/reference/google-cloud-securityposture/0.10.0/com.google.cloud.securityposture.v1.ListPosturesResponse),[Posture](/java/docs/reference/google-cloud-securityposture/0.10.0/com.google.cloud.securityposture.v1.Posture)>`  

`response`

`[ListPosturesResponse](/java/docs/reference/google-cloud-securityposture/0.10.0/com.google.cloud.securityposture.v1.ListPosturesResponse)`  
...
`[SecurityPostureClient.ListPosturesPage](/java/docs/reference/google-cloud-securityposture/0.10.0/com.google.cloud.securityposture.v1.SecurityPostureClient.ListPosturesPage)`
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListPosturesResponse](/java/docs/reference/google-cloud-securityposture/0.10.0/com.google.cloud.securityposture.v1.ListPosturesResponse)>`  
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListPosturesPage](/java/docs/reference/google-cloud-securityposture/0.10.0/com.google.cloud.securityposture.v1.SecurityPostureClient.ListPosturesPage)>`
