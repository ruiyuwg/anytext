...
# Google Cloud Ai Platform V1 Client - Class CreateDatasetVersionRequest (1.15.0) Stay organized with collections Save and categorize content based on your preferences.
...
Request message for [DatasetService.CreateDatasetVersion](/php/docs/reference/cloud-ai-platform/1.15.0/V1.Client.DatasetServiceClient#_Google_Cloud_AIPlatform_V1_Client_DatasetServiceClient__createDatasetVersion__).
...
`[DatasetVersion](/php/docs/reference/cloud-ai-platform/1.15.0/V1.DatasetVersion)`  
...
`[DatasetVersion](/php/docs/reference/cloud-ai-platform/1.15.0/V1.DatasetVersion)|null`
...
`[CreateDatasetVersionRequest](/php/docs/reference/cloud-ai-platform/1.15.0/V1.CreateDatasetVersionRequest)`
