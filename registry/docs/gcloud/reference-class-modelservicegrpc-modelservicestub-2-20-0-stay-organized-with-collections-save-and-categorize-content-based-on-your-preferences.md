...
# Class ModelServiceGrpc.ModelServiceStub (2.20.0) Stay organized with collections Save and categorize content based on your preferences.
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> io.grpc.stub.AbstractStub \> io.grpc.stub.AbstractAsyncStub \> ModelServiceGrpc.ModelServiceStub
...
`[ModelServiceGrpc.ModelServiceStub](/java/docs/reference/google-cloud-retail/2.20.0/com.google.cloud.retail.v2beta.ModelServiceGrpc.ModelServiceStub)`
...
`[CreateModelRequest](/java/docs/reference/google-cloud-retail/2.20.0/com.google.cloud.retail.v2beta.CreateModelRequest)`  
...
`[DeleteModelRequest](/java/docs/reference/google-cloud-retail/2.20.0/com.google.cloud.retail.v2beta.DeleteModelRequest)`  
...
`[GetModelRequest](/java/docs/reference/google-cloud-retail/2.20.0/com.google.cloud.retail.v2beta.GetModelRequest)`  

`responseObserver`

`io.grpc.stub.StreamObserver<[Model](/java/docs/reference/google-cloud-retail/2.20.0/com.google.cloud.retail.v2beta.Model)>`  
...
`[ListModelsRequest](/java/docs/reference/google-cloud-retail/2.20.0/com.google.cloud.retail.v2beta.ListModelsRequest)`  

`responseObserver`

`io.grpc.stub.StreamObserver<[ListModelsResponse](/java/docs/reference/google-cloud-retail/2.20.0/com.google.cloud.retail.v2beta.ListModelsResponse)>`  
...
`[PauseModelRequest](/java/docs/reference/google-cloud-retail/2.20.0/com.google.cloud.retail.v2beta.PauseModelRequest)`  
...
`[ResumeModelRequest](/java/docs/reference/google-cloud-retail/2.20.0/com.google.cloud.retail.v2beta.ResumeModelRequest)`  
...
`[TuneModelRequest](/java/docs/reference/google-cloud-retail/2.20.0/com.google.cloud.retail.v2beta.TuneModelRequest)`  
...
`[UpdateModelRequest](/java/docs/reference/google-cloud-retail/2.20.0/com.google.cloud.retail.v2beta.UpdateModelRequest)`  
