...
# Class SearchRequest (1.15.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessage.html) \> SearchRequest

## Implements

[SearchRequestOrBuilder](/java/docs/reference/google-shopping-merchant-reports/latest/com.google.shopping.merchant.reports.v1.SearchRequestOrBuilder)
...
`[SearchRequest](/java/docs/reference/google-shopping-merchant-reports/latest/com.google.shopping.merchant.reports.v1.SearchRequest)`
...
`[SearchRequest.Builder](/java/docs/reference/google-shopping-merchant-reports/latest/com.google.shopping.merchant.reports.v1.SearchRequest.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[SearchRequest](/java/docs/reference/google-shopping-merchant-reports/latest/com.google.shopping.merchant.reports.v1.SearchRequest)>`
...
For details on how to construct your query, see the [Query Language guide](/merchant/api/guides/reports/query-language). For the full list of available tables and fields, see the [Available fields](/merchant/api/reference/rest/reports_v1/accounts.reports).
...
```
protected SearchRequest.Builder newBuilderForType(AbstractMessage.BuilderParent parent)
```
