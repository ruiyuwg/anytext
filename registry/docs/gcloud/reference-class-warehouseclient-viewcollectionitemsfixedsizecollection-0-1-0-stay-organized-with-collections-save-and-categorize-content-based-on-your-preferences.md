...
# Class WarehouseClient.ViewCollectionItemsFixedSizeCollection (0.1.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class WarehouseClient.ViewCollectionItemsFixedSizeCollection extends AbstractFixedSizeCollection<ViewCollectionItemsRequest,ViewCollectionItemsResponse,CollectionItem,WarehouseClient.ViewCollectionItemsPage,WarehouseClient.ViewCollectionItemsFixedSizeCollection>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractFixedSizeCollection](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractFixedSizeCollection.html) \> WarehouseClient.ViewCollectionItemsFixedSizeCollection
...
### createCollection(List<WarehouseClient.ViewCollectionItemsPage> pages, int collectionSize)

```
protected WarehouseClient.ViewCollectionItemsFixedSizeCollection createCollection(List<WarehouseClient.ViewCollectionItemsPage> pages, int collectionSize)
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ViewCollectionItemsPage](/java/docs/reference/google-cloud-visionai/0.1.0/com.google.cloud.visionai.v1.WarehouseClient.ViewCollectionItemsPage)>`  
...
`[WarehouseClient.ViewCollectionItemsFixedSizeCollection](/java/docs/reference/google-cloud-visionai/0.1.0/com.google.cloud.visionai.v1.WarehouseClient.ViewCollectionItemsFixedSizeCollection)`
