...
# Class QueryTestablePermissionsRequest (3.3.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class QueryTestablePermissionsRequest extends GeneratedMessageV3 implements QueryTestablePermissionsRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> QueryTestablePermissionsRequest

## Implements

[QueryTestablePermissionsRequestOrBuilder](/java/docs/reference/google-iam-admin/3.3.0/com.google.iam.admin.v1.QueryTestablePermissionsRequestOrBuilder)
...
### FULL\_RESOURCE\_NAME\_FIELD\_NUMBER
...
```
public static QueryTestablePermissionsRequest getDefaultInstance()
```
...
[QueryTestablePermissionsRequest](/java/docs/reference/google-iam-admin/3.3.0/com.google.iam.admin.v1.QueryTestablePermissionsRequest)
...
```
public static QueryTestablePermissionsRequest.Builder newBuilder()
```
...
[QueryTestablePermissionsRequest.Builder](/java/docs/reference/google-iam-admin/3.3.0/com.google.iam.admin.v1.QueryTestablePermissionsRequest.Builder)

### newBuilder(QueryTestablePermissionsRequest prototype)

```
public static QueryTestablePermissionsRequest.Builder newBuilder(QueryTestablePermissionsRequest prototype)
```
...
```
public static QueryTestablePermissionsRequest parseDelimitedFrom(InputStream input)
```
...
```
public static QueryTestablePermissionsRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static QueryTestablePermissionsRequest parseFrom(byte[] data)
```
...
```
public static QueryTestablePermissionsRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static QueryTestablePermissionsRequest parseFrom(ByteString data)
```
...
```
public static QueryTestablePermissionsRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static QueryTestablePermissionsRequest parseFrom(CodedInputStream input)
```
...
```
public static QueryTestablePermissionsRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static QueryTestablePermissionsRequest parseFrom(InputStream input)
```
...
```
public static QueryTestablePermissionsRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static QueryTestablePermissionsRequest parseFrom(ByteBuffer data)
```
...
```
public static QueryTestablePermissionsRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<QueryTestablePermissionsRequest> parser()
```
...
[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[QueryTestablePermissionsRequest](/java/docs/reference/google-iam-admin/3.3.0/com.google.iam.admin.v1.QueryTestablePermissionsRequest)\>
...
```
public Parser<QueryTestablePermissionsRequest> getParserForType()
```
...
```
public QueryTestablePermissionsRequest.Builder newBuilderForType()
```
...
```
protected QueryTestablePermissionsRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public QueryTestablePermissionsRequest.Builder toBuilder()
```
