...
# Class VmMigrationClient.ListSourcesFixedSizeCollection (1.14.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class VmMigrationClient.ListSourcesFixedSizeCollection extends AbstractFixedSizeCollection<ListSourcesRequest,ListSourcesResponse,Source,VmMigrationClient.ListSourcesPage,VmMigrationClient.ListSourcesFixedSizeCollection>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractFixedSizeCollection](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractFixedSizeCollection.html) \> VmMigrationClient.ListSourcesFixedSizeCollection
...
### createCollection(List<VmMigrationClient.ListSourcesPage> pages, int collectionSize)

```
protected VmMigrationClient.ListSourcesFixedSizeCollection createCollection(List<VmMigrationClient.ListSourcesPage> pages, int collectionSize)
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ListSourcesPage](/java/docs/reference/google-cloud-vmmigration/1.14.0/com.google.cloud.vmmigration.v1.VmMigrationClient.ListSourcesPage)>`  
...
`[VmMigrationClient.ListSourcesFixedSizeCollection](/java/docs/reference/google-cloud-vmmigration/1.14.0/com.google.cloud.vmmigration.v1.VmMigrationClient.ListSourcesFixedSizeCollection)`
