...
# Class PrivateCatalogClient.SearchVersionsPage (0.51.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class PrivateCatalogClient.SearchVersionsPage extends AbstractPage<SearchVersionsRequest,SearchVersionsResponse,Version,PrivateCatalogClient.SearchVersionsPage>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractPage](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractPage.html) \> PrivateCatalogClient.SearchVersionsPage
...
### createPage(PageContext<SearchVersionsRequest,SearchVersionsResponse,Version> context, SearchVersionsResponse response)

```
protected PrivateCatalogClient.SearchVersionsPage createPage(PageContext<SearchVersionsRequest,SearchVersionsResponse,Version> context, SearchVersionsResponse response)
```
...
`[PageContext](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PageContext.html)<[SearchVersionsRequest](/java/docs/reference/google-cloud-private-catalog/0.51.0/com.google.cloud.privatecatalog.v1beta1.SearchVersionsRequest),[SearchVersionsResponse](/java/docs/reference/google-cloud-private-catalog/0.51.0/com.google.cloud.privatecatalog.v1beta1.SearchVersionsResponse),[Version](/java/docs/reference/google-cloud-private-catalog/0.51.0/com.google.cloud.privatecatalog.v1beta1.Version)>`  

`response`

`[SearchVersionsResponse](/java/docs/reference/google-cloud-private-catalog/0.51.0/com.google.cloud.privatecatalog.v1beta1.SearchVersionsResponse)`  
...
`[PrivateCatalogClient.SearchVersionsPage](/java/docs/reference/google-cloud-private-catalog/0.51.0/com.google.cloud.privatecatalog.v1beta1.PrivateCatalogClient.SearchVersionsPage)`
...
### createPageAsync(PageContext<SearchVersionsRequest,SearchVersionsResponse,Version> context, ApiFuture<SearchVersionsResponse> futureResponse)

```
public ApiFuture<PrivateCatalogClient.SearchVersionsPage> createPageAsync(PageContext<SearchVersionsRequest,SearchVersionsResponse,Version> context, ApiFuture<SearchVersionsResponse> futureResponse)
```
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[SearchVersionsResponse](/java/docs/reference/google-cloud-private-catalog/0.51.0/com.google.cloud.privatecatalog.v1beta1.SearchVersionsResponse)>`  
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[SearchVersionsPage](/java/docs/reference/google-cloud-private-catalog/0.51.0/com.google.cloud.privatecatalog.v1beta1.PrivateCatalogClient.SearchVersionsPage)>`
