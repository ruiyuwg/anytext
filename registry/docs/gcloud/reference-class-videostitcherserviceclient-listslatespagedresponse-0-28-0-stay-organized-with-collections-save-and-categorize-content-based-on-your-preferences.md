...
# Class VideoStitcherServiceClient.ListSlatesPagedResponse (0.28.0) Stay organized with collections Save and categorize content based on your preferences.
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractPagedListResponse](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractPagedListResponse.html) \> VideoStitcherServiceClient.ListSlatesPagedResponse
...
`[PageContext](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PageContext.html)<[ListSlatesRequest](/java/docs/reference/google-cloud-video-stitcher/0.28.0/com.google.cloud.video.stitcher.v1.ListSlatesRequest),[ListSlatesResponse](/java/docs/reference/google-cloud-video-stitcher/0.28.0/com.google.cloud.video.stitcher.v1.ListSlatesResponse),[Slate](/java/docs/reference/google-cloud-video-stitcher/0.28.0/com.google.cloud.video.stitcher.v1.Slate)>`  

`futureResponse`

`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListSlatesResponse](/java/docs/reference/google-cloud-video-stitcher/0.28.0/com.google.cloud.video.stitcher.v1.ListSlatesResponse)>`  
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListSlatesPagedResponse](/java/docs/reference/google-cloud-video-stitcher/0.28.0/com.google.cloud.video.stitcher.v1.VideoStitcherServiceClient.ListSlatesPagedResponse)>`
