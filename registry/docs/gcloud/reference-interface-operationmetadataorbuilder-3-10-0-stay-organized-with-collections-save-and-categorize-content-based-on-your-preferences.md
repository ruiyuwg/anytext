...
# Interface OperationMetadataOrBuilder (3.10.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[OperationMetadata.State](/java/docs/reference/google-cloud-vision/3.10.0/com.google.cloud.vision.v1.OperationMetadata.State)`
