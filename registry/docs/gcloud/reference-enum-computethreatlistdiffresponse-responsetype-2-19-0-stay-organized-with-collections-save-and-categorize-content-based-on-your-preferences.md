...
# Enum ComputeThreatListDiffResponse.ResponseType (2.19.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-webrisk/2.19.0/com.google.webrisk.v1beta1.ComputeThreatListDiffResponse.ResponseType#com_google_webrisk_v1beta1_ComputeThreatListDiffResponse_ResponseType_forNumber_int_) instead._
