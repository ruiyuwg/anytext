...
# Class ExecutionsGrpc.ExecutionsFutureStub (0.28.0) Stay organized with collections Save and categorize content based on your preferences.
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> io.grpc.stub.AbstractStub \> io.grpc.stub.AbstractFutureStub \> ExecutionsGrpc.ExecutionsFutureStub
...
`[ExecutionsGrpc.ExecutionsFutureStub](/java/docs/reference/google-cloud-run/0.28.0/com.google.cloud.run.v2.ExecutionsGrpc.ExecutionsFutureStub)`
...
```
public ListenableFuture<Operation> cancelExecution(CancelExecutionRequest request)
```
...
`[CancelExecutionRequest](/java/docs/reference/google-cloud-run/0.28.0/com.google.cloud.run.v2.CancelExecutionRequest)`  
...
`[DeleteExecutionRequest](/java/docs/reference/google-cloud-run/0.28.0/com.google.cloud.run.v2.DeleteExecutionRequest)`  
...
`[GetExecutionRequest](/java/docs/reference/google-cloud-run/0.28.0/com.google.cloud.run.v2.GetExecutionRequest)`  
...
`com.google.common.util.concurrent.ListenableFuture<[Execution](/java/docs/reference/google-cloud-run/0.28.0/com.google.cloud.run.v2.Execution)>`
...
`[ListExecutionsRequest](/java/docs/reference/google-cloud-run/0.28.0/com.google.cloud.run.v2.ListExecutionsRequest)`  
...
`com.google.common.util.concurrent.ListenableFuture<[ListExecutionsResponse](/java/docs/reference/google-cloud-run/0.28.0/com.google.cloud.run.v2.ListExecutionsResponse)>`
