...
# Class ReportResponse.Builder (1.22.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> ReportResponse.Builder

## Implements

[ReportResponseOrBuilder](/java/docs/reference/google-cloud-service-control/1.22.0/com.google.api.servicecontrol.v1.ReportResponseOrBuilder)
...
`[Iterable](https://docs.oracle.com/javase/8/docs/api/java/lang/Iterable.html)<? extends com.google.api.servicecontrol.v1.ReportResponse.ReportError>`  
...
`[ReportResponse.Builder](/java/docs/reference/google-cloud-service-control/1.22.0/com.google.api.servicecontrol.v1.ReportResponse.Builder)`
...
`[ReportResponse.ReportError](/java/docs/reference/google-cloud-service-control/1.22.0/com.google.api.servicecontrol.v1.ReportResponse.ReportError)`  
...
`[ReportResponse.ReportError.Builder](/java/docs/reference/google-cloud-service-control/1.22.0/com.google.api.servicecontrol.v1.ReportResponse.ReportError.Builder)`  
...
`[ReportResponse](/java/docs/reference/google-cloud-service-control/1.22.0/com.google.api.servicecontrol.v1.ReportResponse)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Builder](/java/docs/reference/google-cloud-service-control/1.22.0/com.google.api.servicecontrol.v1.ReportResponse.ReportError.Builder)>`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ReportError](/java/docs/reference/google-cloud-service-control/1.22.0/com.google.api.servicecontrol.v1.ReportResponse.ReportError)>`
...
`[ReportResponse.ReportErrorOrBuilder](/java/docs/reference/google-cloud-service-control/1.22.0/com.google.api.servicecontrol.v1.ReportResponse.ReportErrorOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.api.servicecontrol.v1.ReportResponse.ReportErrorOrBuilder>`
