...
# Class ListRuntimeVersionsResponse (2.10.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListRuntimeVersionsResponse extends GeneratedMessageV3 implements ListRuntimeVersionsResponseOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListRuntimeVersionsResponse

## Implements

[ListRuntimeVersionsResponseOrBuilder](/java/docs/reference/google-cloud-tpu/2.10.0/com.google.cloud.tpu.v2alpha1.ListRuntimeVersionsResponseOrBuilder)
...
### RUNTIME\_VERSIONS\_FIELD\_NUMBER

```
public static final int RUNTIME_VERSIONS_FIELD_NUMBER
```
...
```
public static ListRuntimeVersionsResponse getDefaultInstance()
```
...
`[ListRuntimeVersionsResponse](/java/docs/reference/google-cloud-tpu/2.10.0/com.google.cloud.tpu.v2alpha1.ListRuntimeVersionsResponse)`
...
```
public static ListRuntimeVersionsResponse.Builder newBuilder()
```
...
`[ListRuntimeVersionsResponse.Builder](/java/docs/reference/google-cloud-tpu/2.10.0/com.google.cloud.tpu.v2alpha1.ListRuntimeVersionsResponse.Builder)`

### newBuilder(ListRuntimeVersionsResponse prototype)

```
public static ListRuntimeVersionsResponse.Builder newBuilder(ListRuntimeVersionsResponse prototype)
```
...
```
public static ListRuntimeVersionsResponse parseDelimitedFrom(InputStream input)
```
...
```
public static ListRuntimeVersionsResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListRuntimeVersionsResponse parseFrom(byte[] data)
```
...
```
public static ListRuntimeVersionsResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListRuntimeVersionsResponse parseFrom(ByteString data)
```
...
```
public static ListRuntimeVersionsResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListRuntimeVersionsResponse parseFrom(CodedInputStream input)
```
...
```
public static ListRuntimeVersionsResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListRuntimeVersionsResponse parseFrom(InputStream input)
```
...
```
public static ListRuntimeVersionsResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListRuntimeVersionsResponse parseFrom(ByteBuffer data)
```
...
```
public static ListRuntimeVersionsResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ListRuntimeVersionsResponse> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListRuntimeVersionsResponse](/java/docs/reference/google-cloud-tpu/2.10.0/com.google.cloud.tpu.v2alpha1.ListRuntimeVersionsResponse)>`
...
```
public ListRuntimeVersionsResponse getDefaultInstanceForType()
```
...
```
public Parser<ListRuntimeVersionsResponse> getParserForType()
```
...
### getRuntimeVersions(int index)

```
public RuntimeVersion getRuntimeVersions(int index)
```

The listed nodes.

`repeated .google.cloud.tpu.v2alpha1.RuntimeVersion runtime_versions = 1;`
...
`[RuntimeVersion](/java/docs/reference/google-cloud-tpu/2.10.0/com.google.cloud.tpu.v2alpha1.RuntimeVersion)`

### getRuntimeVersionsCount()
...
```
public List<RuntimeVersion> getRuntimeVersionsList()
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[RuntimeVersion](/java/docs/reference/google-cloud-tpu/2.10.0/com.google.cloud.tpu.v2alpha1.RuntimeVersion)>`

### getRuntimeVersionsOrBuilder(int index)

```
public RuntimeVersionOrBuilder getRuntimeVersionsOrBuilder(int index)
```
...
`[RuntimeVersionOrBuilder](/java/docs/reference/google-cloud-tpu/2.10.0/com.google.cloud.tpu.v2alpha1.RuntimeVersionOrBuilder)`

### getRuntimeVersionsOrBuilderList()

```
public List<? extends RuntimeVersionOrBuilder> getRuntimeVersionsOrBuilderList()
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.tpu.v2alpha1.RuntimeVersionOrBuilder>`
...
```
public ListRuntimeVersionsResponse.Builder newBuilderForType()
```
...
```
protected ListRuntimeVersionsResponse.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ListRuntimeVersionsResponse.Builder toBuilder()
```
