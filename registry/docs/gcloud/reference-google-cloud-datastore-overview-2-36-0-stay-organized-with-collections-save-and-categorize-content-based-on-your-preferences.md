...
# google-cloud-datastore overview (2.36.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Cloud Datastore Description:** Is a fully managed, schemaless database for\\nstoring non-relational data. Cloud Datastore automatically scales with\\nyour users and supports ACID transactions, high availability of reads and\\nwrites, strong consistency for reads and ancestor queries, and eventual\\nconsistency for all other queries.

[Cloud Datastore Product Reference](https://cloud.google.com/datastore)

[GitHub Repository](https://github.com/googleapis/google-cloud-java/tree/main/java-datastore)

[Maven artifact](https://central.sonatype.com/artifact/com.google.cloud/google-cloud-datastore)
...
The example below demonstrates how you would import the BOM and include the `google-cloud-datastore` artifact.
...
libraryDependencies += "com.google.cloud" % "google-cloud-datastore" % "2.36.0"

## Which version ID should I get started with?

For this library, we recommend using [com.google.cloud.datastore](https://cloud.google.com/java/docs/reference/google-cloud-datastore/2.36.0/com.google.cloud.datastore) for new applications.
