...
# Class ProjectsGrpc.ProjectsStub (1.7.0) Stay organized with collections Save and categorize content based on your preferences.
...
[ProjectsGrpc.ProjectsStub](/java/docs/reference/google-cloud-resourcemanager/1.7.0/com.google.cloud.resourcemanager.v3.ProjectsGrpc.ProjectsStub)
...
`[CreateProjectRequest](/java/docs/reference/google-cloud-resourcemanager/1.7.0/com.google.cloud.resourcemanager.v3.CreateProjectRequest)`  
...
`[DeleteProjectRequest](/java/docs/reference/google-cloud-resourcemanager/1.7.0/com.google.cloud.resourcemanager.v3.DeleteProjectRequest)`  
...
`[GetProjectRequest](/java/docs/reference/google-cloud-resourcemanager/1.7.0/com.google.cloud.resourcemanager.v3.GetProjectRequest)`  

responseObserver

`io.grpc.stub.StreamObserver<[Project](/java/docs/reference/google-cloud-resourcemanager/1.7.0/com.google.cloud.resourcemanager.v3.Project)>`  
...
`[ListProjectsRequest](/java/docs/reference/google-cloud-resourcemanager/1.7.0/com.google.cloud.resourcemanager.v3.ListProjectsRequest)`  

responseObserver

`io.grpc.stub.StreamObserver<[ListProjectsResponse](/java/docs/reference/google-cloud-resourcemanager/1.7.0/com.google.cloud.resourcemanager.v3.ListProjectsResponse)>`  
...
`[MoveProjectRequest](/java/docs/reference/google-cloud-resourcemanager/1.7.0/com.google.cloud.resourcemanager.v3.MoveProjectRequest)`  
...
`[SearchProjectsRequest](/java/docs/reference/google-cloud-resourcemanager/1.7.0/com.google.cloud.resourcemanager.v3.SearchProjectsRequest)`  

responseObserver

`io.grpc.stub.StreamObserver<[SearchProjectsResponse](/java/docs/reference/google-cloud-resourcemanager/1.7.0/com.google.cloud.resourcemanager.v3.SearchProjectsResponse)>`  
...
`[UndeleteProjectRequest](/java/docs/reference/google-cloud-resourcemanager/1.7.0/com.google.cloud.resourcemanager.v3.UndeleteProjectRequest)`  
...
`[UpdateProjectRequest](/java/docs/reference/google-cloud-resourcemanager/1.7.0/com.google.cloud.resourcemanager.v3.UpdateProjectRequest)`  
