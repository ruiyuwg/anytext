...
# Google Cloud Ai Platform V1 Client - Class EvaluatedAnnotationExplanation (1.18.0) Stay organized with collections Save and categorize content based on your preferences.
...
Reference documentation and code samples for the Google Cloud Ai Platform V1 Client class EvaluatedAnnotationExplanation.

Explanation result of the prediction produced by the Model.

Generated from protobuf message `google.cloud.aiplatform.v1.EvaluatedAnnotationExplanation`
...
`[Explanation](/php/docs/reference/cloud-ai-platform/1.18.0/V1.Explanation)`  
...
`[Explanation](/php/docs/reference/cloud-ai-platform/1.18.0/V1.Explanation)|null`
