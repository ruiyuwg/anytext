...
# Interface StorageRetryStrategy (2.19.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[StorageRetryStrategy](/java/docs/reference/google-cloud-storage/2.19.0/com.google.cloud.storage.StorageRetryStrategy)`
...
Factory method to get an instance of [StorageRetryStrategy](/java/docs/reference/google-cloud-storage/2.19.0/com.google.cloud.storage.StorageRetryStrategy) which will uniformly retry all calls as if they were idempotent.
