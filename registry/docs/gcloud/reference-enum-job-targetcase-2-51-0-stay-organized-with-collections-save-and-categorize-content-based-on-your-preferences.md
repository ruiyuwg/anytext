...
# Enum Job.TargetCase (2.51.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum Job.TargetCase extends Enum<Job.TargetCase> implements Internal.EnumLite, AbstractMessageLite.InternalOneOfEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-scheduler/2.51.0/com.google.cloud.scheduler.v1.Job.TargetCase#com_google_cloud_scheduler_v1_Job_TargetCase_forNumber_int_) instead._
