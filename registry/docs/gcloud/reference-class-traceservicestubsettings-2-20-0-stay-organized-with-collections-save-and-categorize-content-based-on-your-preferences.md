...
# Class TraceServiceStubSettings (2.20.0) Stay organized with collections Save and categorize content based on your preferences.
...
Settings class to configure an instance of [TraceServiceStub](/java/docs/reference/google-cloud-trace/2.20.0/com.google.cloud.trace.v1.stub.TraceServiceStub).
...
`[TraceServiceStubSettings.Builder](/java/docs/reference/google-cloud-trace/2.20.0/com.google.cloud.trace.v1.stub.TraceServiceStubSettings.Builder)`
...
`[TraceServiceStub](/java/docs/reference/google-cloud-trace/2.20.0/com.google.cloud.trace.v1.stub.TraceServiceStub)`
...
`[UnaryCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.html)<[GetTraceRequest](/java/docs/reference/google-cloud-trace/2.20.0/com.google.devtools.cloudtrace.v1.GetTraceRequest),[Trace](/java/docs/reference/google-cloud-trace/2.20.0/com.google.devtools.cloudtrace.v1.Trace)>`
...
`[PagedCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PagedCallSettings.html)<[ListTracesRequest](/java/docs/reference/google-cloud-trace/2.20.0/com.google.devtools.cloudtrace.v1.ListTracesRequest),[ListTracesResponse](/java/docs/reference/google-cloud-trace/2.20.0/com.google.devtools.cloudtrace.v1.ListTracesResponse),[ListTracesPagedResponse](/java/docs/reference/google-cloud-trace/2.20.0/com.google.cloud.trace.v1.TraceServiceClient.ListTracesPagedResponse)>`
...
`[UnaryCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.html)<[PatchTracesRequest](/java/docs/reference/google-cloud-trace/2.20.0/com.google.devtools.cloudtrace.v1.PatchTracesRequest),[Empty](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Empty.html)>`
