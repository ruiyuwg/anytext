...
# Class ListAssetsResponse (2.95.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListAssetsResponse extends GeneratedMessage implements ListAssetsResponseOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessage.html) \> ListAssetsResponse

## Implements

[ListAssetsResponseOrBuilder](/java/docs/reference/google-cloud-securitycenter/latest/com.google.cloud.securitycenter.v1p1beta1.ListAssetsResponseOrBuilder)
...
### LIST\_ASSETS\_RESULTS\_FIELD\_NUMBER

```
public static final int LIST_ASSETS_RESULTS_FIELD_NUMBER
```
...
`[ListAssetsResponse](/java/docs/reference/google-cloud-securitycenter/latest/com.google.cloud.securitycenter.v1p1beta1.ListAssetsResponse)`
...
```
public static ListAssetsResponse.Builder newBuilder()
```
...
`[ListAssetsResponse.Builder](/java/docs/reference/google-cloud-securitycenter/latest/com.google.cloud.securitycenter.v1p1beta1.ListAssetsResponse.Builder)`

### newBuilder(ListAssetsResponse prototype)

```
public static ListAssetsResponse.Builder newBuilder(ListAssetsResponse prototype)
```
...
```
public static ListAssetsResponse parseDelimitedFrom(InputStream input)
```
...
```
public static ListAssetsResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListAssetsResponse parseFrom(byte[] data)
```
...
```
public static ListAssetsResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListAssetsResponse parseFrom(ByteString data)
```
...
```
public static ListAssetsResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListAssetsResponse parseFrom(CodedInputStream input)
```
...
```
public static ListAssetsResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListAssetsResponse parseFrom(InputStream input)
```
...
```
public static ListAssetsResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListAssetsResponse parseFrom(ByteBuffer data)
```
...
```
public static ListAssetsResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListAssetsResponse](/java/docs/reference/google-cloud-securitycenter/latest/com.google.cloud.securitycenter.v1p1beta1.ListAssetsResponse)>`
...
```
public ListAssetsResponse.ListAssetsResult getListAssetsResults(int index)
```
...
`[ListAssetsResponse.ListAssetsResult](/java/docs/reference/google-cloud-securitycenter/latest/com.google.cloud.securitycenter.v1p1beta1.ListAssetsResponse.ListAssetsResult)`

### getListAssetsResultsCount()
...
```
public List<ListAssetsResponse.ListAssetsResult> getListAssetsResultsList()
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ListAssetsResult](/java/docs/reference/google-cloud-securitycenter/latest/com.google.cloud.securitycenter.v1p1beta1.ListAssetsResponse.ListAssetsResult)>`

### getListAssetsResultsOrBuilder(int index)

```
public ListAssetsResponse.ListAssetsResultOrBuilder getListAssetsResultsOrBuilder(int index)
```
...
`[ListAssetsResponse.ListAssetsResultOrBuilder](/java/docs/reference/google-cloud-securitycenter/latest/com.google.cloud.securitycenter.v1p1beta1.ListAssetsResponse.ListAssetsResultOrBuilder)`

### getListAssetsResultsOrBuilderList()

```
public List<? extends ListAssetsResponse.ListAssetsResultOrBuilder> getListAssetsResultsOrBuilderList()
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.securitycenter.v1p1beta1.ListAssetsResponse.ListAssetsResultOrBuilder>`
...
```
public ListAssetsResponse.Builder newBuilderForType()
```
...
```
protected ListAssetsResponse.Builder newBuilderForType(AbstractMessage.BuilderParent parent)
```
...
```
public ListAssetsResponse.Builder toBuilder()
```
