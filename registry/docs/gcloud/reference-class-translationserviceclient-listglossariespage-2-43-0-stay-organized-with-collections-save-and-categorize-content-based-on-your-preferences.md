...
# Class TranslationServiceClient.ListGlossariesPage (2.43.0) Stay organized with collections Save and categorize content based on your preferences.
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractPage](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractPage.html) \> TranslationServiceClient.ListGlossariesPage
...
`[PageContext](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PageContext.html)<[ListGlossariesRequest](/java/docs/reference/google-cloud-translate/2.43.0/com.google.cloud.translate.v3beta1.ListGlossariesRequest),[ListGlossariesResponse](/java/docs/reference/google-cloud-translate/2.43.0/com.google.cloud.translate.v3beta1.ListGlossariesResponse),[Glossary](/java/docs/reference/google-cloud-translate/2.43.0/com.google.cloud.translate.v3beta1.Glossary)>`  

`response`

`[ListGlossariesResponse](/java/docs/reference/google-cloud-translate/2.43.0/com.google.cloud.translate.v3beta1.ListGlossariesResponse)`  
...
`[TranslationServiceClient.ListGlossariesPage](/java/docs/reference/google-cloud-translate/2.43.0/com.google.cloud.translate.v3beta1.TranslationServiceClient.ListGlossariesPage)`
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListGlossariesResponse](/java/docs/reference/google-cloud-translate/2.43.0/com.google.cloud.translate.v3beta1.ListGlossariesResponse)>`  
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListGlossariesPage](/java/docs/reference/google-cloud-translate/2.43.0/com.google.cloud.translate.v3beta1.TranslationServiceClient.ListGlossariesPage)>`
