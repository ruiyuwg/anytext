...
# Compute V1 Client - Class NetworksGetEffectiveFirewallsResponseEffectiveFirewallPolicy (1.23.0) Stay organized with collections Save and categorize content based on your preferences.
...
`array<[FirewallPolicyRule](/php/docs/reference/cloud-compute/1.23.0/V1.FirewallPolicyRule)>`  
