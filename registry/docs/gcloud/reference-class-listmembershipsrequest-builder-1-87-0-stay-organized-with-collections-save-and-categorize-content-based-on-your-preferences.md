...
# Class ListMembershipsRequest.Builder (1.87.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class ListMembershipsRequest.Builder extends GeneratedMessage.Builder<ListMembershipsRequest.Builder> implements ListMembershipsRequestOrBuilder
```
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessage.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessage.Builder.html) \> ListMembershipsRequest.Builder

## Implements

[ListMembershipsRequestOrBuilder](/java/docs/reference/google-cloud-gkehub/latest/com.google.cloud.gkehub.v1beta1.ListMembershipsRequestOrBuilder)
...
`[ListMembershipsRequest](/java/docs/reference/google-cloud-gkehub/latest/com.google.cloud.gkehub.v1beta1.ListMembershipsRequest)`
...
`[ListMembershipsRequest.Builder](/java/docs/reference/google-cloud-gkehub/latest/com.google.cloud.gkehub.v1beta1.ListMembershipsRequest.Builder)`
...
Optional. Lists Memberships that match the filter expression, following the syntax outlined in [https://google.aip.dev/160](https://google.aip.dev/160).
...
Optional. One or more fields to compare and use to sort the output. See [https://google.aip.dev/132#ordering](https://google.aip.dev/132#ordering).
...
```
public ListMembershipsRequest.Builder setOrderByBytes(ByteString value)
```
