...
# Enum SpaceConfig.ModerationRestrictions.RestrictionType (0.54.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-meet/latest/com.google.apps.meet.v2beta.SpaceConfig.ModerationRestrictions.RestrictionType#com_google_apps_meet_v2beta_SpaceConfig_ModerationRestrictions_RestrictionType_forNumber_int_) instead._
