...
-   [1.2.1 (latest)](/ruby/docs/reference/google-cloud-bigquery-data_policies-v1/latest)
-   [1.2.0](/ruby/docs/reference/google-cloud-bigquery-data_policies-v1/1.2.0)
-   [1.1.0](/ruby/docs/reference/google-cloud-bigquery-data_policies-v1/1.1.0)
-   [1.0.1](/ruby/docs/reference/google-cloud-bigquery-data_policies-v1/1.0.1)
-   [0.10.0](/ruby/docs/reference/google-cloud-bigquery-data_policies-v1/0.10.0)
-   [0.9.0](/ruby/docs/reference/google-cloud-bigquery-data_policies-v1/0.9.0)
-   [0.8.1](/ruby/docs/reference/google-cloud-bigquery-data_policies-v1/0.8.1)
-   [0.7.2](/ruby/docs/reference/google-cloud-bigquery-data_policies-v1/0.7.2)
-   [0.6.0](/ruby/docs/reference/google-cloud-bigquery-data_policies-v1/0.6.0)
-   [0.5.0](/ruby/docs/reference/google-cloud-bigquery-data_policies-v1/0.5.0)
-   [0.4.0](/ruby/docs/reference/google-cloud-bigquery-data_policies-v1/0.4.0)
-   [0.3.1](/ruby/docs/reference/google-cloud-bigquery-data_policies-v1/0.3.1)
-   [0.2.0](/ruby/docs/reference/google-cloud-bigquery-data_policies-v1/0.2.0)
-   [0.1.0](/ruby/docs/reference/google-cloud-bigquery-data_policies-v1/0.1.0)
...
This gem is a _versioned_ client. It provides basic client classes for a specific version of the BigQuery Data Policy Service V1 API. Most users should consider using the main client gem, [google-cloud-bigquery-data\_policies](https://rubygems.org/gems/google-cloud-bigquery-data_policies). See the section below titled _Which client should I use?_ for more information.
...
3.  [Enable the API.](https://console.cloud.google.com/apis/library/bigquerydatapolicy.googleapis.com)
4.  [Set up authentication.](https://docs.cloud.google.com/ruby/docs/reference/google-cloud-bigquery-data_policies-v1/latest/AUTHENTICATION "Set up authentication.")

## Quick Start

require "google/cloud/bigquery/data\_policies/v1"
...
response \= client.create\_data\_policy request

View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-bigquery-data_policies-v1/latest) for class and method documentation.

See also the [Product Documentation](https://cloud.google.com/bigquery/docs) for general usage information.
