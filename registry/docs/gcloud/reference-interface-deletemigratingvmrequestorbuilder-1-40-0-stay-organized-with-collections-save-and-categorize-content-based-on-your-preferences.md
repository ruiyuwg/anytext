...
# Interface DeleteMigratingVmRequestOrBuilder (1.40.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface DeleteMigratingVmRequestOrBuilder extends MessageOrBuilder
```
