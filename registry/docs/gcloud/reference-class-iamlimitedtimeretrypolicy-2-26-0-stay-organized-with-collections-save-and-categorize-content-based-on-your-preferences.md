...
# Class IAMLimitedTimeRetryPolicy (2.26.0) Stay organized with collections Save and categorize content based on your preferences.
...
A retry policy for [`IAMConnection`](/cpp/docs/reference/iam/2.26.0/classgoogle_1_1cloud_1_1iam__admin__v1_1_1IAMConnection) based on elapsed time.
...
`IAMLimitedTimeRetryPolicy const &`  
...
`std::unique_ptr< IAMRetryPolicy >`

## Type Aliases

### BaseType

**Alias Of**: `IAMRetryPolicy`
