...
# Class SearchCatalogsResponse (0.51.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> SearchCatalogsResponse

## Implements

[SearchCatalogsResponseOrBuilder](/java/docs/reference/google-cloud-private-catalog/0.51.0/com.google.cloud.privatecatalog.v1beta1.SearchCatalogsResponseOrBuilder)
...
`[SearchCatalogsResponse](/java/docs/reference/google-cloud-private-catalog/0.51.0/com.google.cloud.privatecatalog.v1beta1.SearchCatalogsResponse)`
...
`[SearchCatalogsResponse.Builder](/java/docs/reference/google-cloud-private-catalog/0.51.0/com.google.cloud.privatecatalog.v1beta1.SearchCatalogsResponse.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[SearchCatalogsResponse](/java/docs/reference/google-cloud-private-catalog/0.51.0/com.google.cloud.privatecatalog.v1beta1.SearchCatalogsResponse)>`
...
`[Catalog](/java/docs/reference/google-cloud-private-catalog/0.51.0/com.google.cloud.privatecatalog.v1beta1.Catalog)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Catalog](/java/docs/reference/google-cloud-private-catalog/0.51.0/com.google.cloud.privatecatalog.v1beta1.Catalog)>`
...
`[CatalogOrBuilder](/java/docs/reference/google-cloud-private-catalog/0.51.0/com.google.cloud.privatecatalog.v1beta1.CatalogOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.privatecatalog.v1beta1.CatalogOrBuilder>`
