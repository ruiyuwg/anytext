...
# Class WafSettings (3.2.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class WafSettings extends GeneratedMessageV3 implements WafSettingsOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> WafSettings

## Implements

[WafSettingsOrBuilder](/java/docs/reference/google-cloud-recaptchaenterprise/3.2.0/com.google.recaptchaenterprise.v1.WafSettingsOrBuilder)
...
### WAF\_FEATURE\_FIELD\_NUMBER

```
public static final int WAF_FEATURE_FIELD_NUMBER
```
...
### WAF\_SERVICE\_FIELD\_NUMBER

```
public static final int WAF_SERVICE_FIELD_NUMBER
```
...
```
public static WafSettings getDefaultInstance()
```
...
[WafSettings](/java/docs/reference/google-cloud-recaptchaenterprise/3.2.0/com.google.recaptchaenterprise.v1.WafSettings)
...
```
public static WafSettings.Builder newBuilder()
```
...
[WafSettings.Builder](/java/docs/reference/google-cloud-recaptchaenterprise/3.2.0/com.google.recaptchaenterprise.v1.WafSettings.Builder)

### newBuilder(WafSettings prototype)

```
public static WafSettings.Builder newBuilder(WafSettings prototype)
```
...
```
public static WafSettings parseDelimitedFrom(InputStream input)
```
...
```
public static WafSettings parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static WafSettings parseFrom(byte[] data)
```
...
```
public static WafSettings parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static WafSettings parseFrom(ByteString data)
```
...
```
public static WafSettings parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static WafSettings parseFrom(CodedInputStream input)
```
...
```
public static WafSettings parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static WafSettings parseFrom(InputStream input)
```
...
```
public static WafSettings parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static WafSettings parseFrom(ByteBuffer data)
```
...
```
public static WafSettings parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<WafSettings> parser()
```
...
[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[WafSettings](/java/docs/reference/google-cloud-recaptchaenterprise/3.2.0/com.google.recaptchaenterprise.v1.WafSettings)\>
...
```
public Parser<WafSettings> getParserForType()
```
...
[WafSettings.WafFeature](/java/docs/reference/google-cloud-recaptchaenterprise/3.2.0/com.google.recaptchaenterprise.v1.WafSettings.WafFeature)
...
[WafSettings.WafService](/java/docs/reference/google-cloud-recaptchaenterprise/3.2.0/com.google.recaptchaenterprise.v1.WafSettings.WafService)
...
```
public WafSettings.Builder newBuilderForType()
```
...
```
protected WafSettings.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public WafSettings.Builder toBuilder()
```
