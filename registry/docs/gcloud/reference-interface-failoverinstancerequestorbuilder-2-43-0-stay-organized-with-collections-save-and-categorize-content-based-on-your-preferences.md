...
# Interface FailoverInstanceRequestOrBuilder (2.43.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[FailoverInstanceRequest.DataProtectionMode](/java/docs/reference/google-cloud-redis/2.43.0/com.google.cloud.redis.v1.FailoverInstanceRequest.DataProtectionMode)`
