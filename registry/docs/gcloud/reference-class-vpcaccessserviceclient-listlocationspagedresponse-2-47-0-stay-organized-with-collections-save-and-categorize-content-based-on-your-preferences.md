...
# Class VpcAccessServiceClient.ListLocationsPagedResponse (2.47.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class VpcAccessServiceClient.ListLocationsPagedResponse extends AbstractPagedListResponse<ListLocationsRequest,ListLocationsResponse,Location,VpcAccessServiceClient.ListLocationsPage,VpcAccessServiceClient.ListLocationsFixedSizeCollection>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractPagedListResponse](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractPagedListResponse.html) \> VpcAccessServiceClient.ListLocationsPagedResponse
...
```
public static ApiFuture<VpcAccessServiceClient.ListLocationsPagedResponse> createAsync(PageContext<ListLocationsRequest,ListLocationsResponse,Location> context, ApiFuture<ListLocationsResponse> futureResponse)
```
...
`[PageContext](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PageContext.html)<com.google.cloud.location.ListLocationsRequest,com.google.cloud.location.ListLocationsResponse,[Location](https://cloud.google.com/java/docs/reference/proto-google-common-protos/latest/com.google.cloud.location.Location.html)>`  
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListLocationsPagedResponse](/java/docs/reference/google-cloud-vpcaccess/2.47.0/com.google.cloud.vpcaccess.v1.VpcAccessServiceClient.ListLocationsPagedResponse)>`
