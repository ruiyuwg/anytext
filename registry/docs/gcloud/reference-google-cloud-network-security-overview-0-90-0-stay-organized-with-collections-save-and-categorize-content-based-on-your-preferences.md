...
# google-cloud-network-security overview (0.90.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Network Security API Description:** N/a

[Network Security API Product Reference](https://cloud.google.com/traffic-director/docs/reference/network-security/rest)

[GitHub Repository](https://github.com/googleapis/google-cloud-java/tree/main/java-network-security)

[Maven artifact](https://central.sonatype.com/artifact/com.google.cloud/google-cloud-network-security)
...
-   [Enable the API](https://console.cloud.google.com/apis/library/networksecurity.googleapis.com)
-   [Set up authentication](https://cloud.google.com/docs/authentication/client-libraries)

## Use the Network Security API for Java
...
The example below demonstrates how you would import the BOM and include the `google-cloud-network-security` artifact.
...
For this library, we recommend using [com.google.cloud.networksecurity.v1](https://cloud.google.com/java/docs/reference/google-cloud-network-security/0.90.0/com.google.cloud.networksecurity.v1) for new applications.
