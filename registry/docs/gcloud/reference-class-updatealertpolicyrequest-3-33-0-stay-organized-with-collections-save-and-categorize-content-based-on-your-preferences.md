...
# Class UpdateAlertPolicyRequest (3.33.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class UpdateAlertPolicyRequest extends GeneratedMessageV3 implements UpdateAlertPolicyRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> UpdateAlertPolicyRequest

## Implements

[UpdateAlertPolicyRequestOrBuilder](/java/docs/reference/google-cloud-monitoring/3.33.0/com.google.monitoring.v3.UpdateAlertPolicyRequestOrBuilder)
...
```
public static UpdateAlertPolicyRequest getDefaultInstance()
```
...
`[UpdateAlertPolicyRequest](/java/docs/reference/google-cloud-monitoring/3.33.0/com.google.monitoring.v3.UpdateAlertPolicyRequest)`
...
```
public static UpdateAlertPolicyRequest.Builder newBuilder()
```
...
`[UpdateAlertPolicyRequest.Builder](/java/docs/reference/google-cloud-monitoring/3.33.0/com.google.monitoring.v3.UpdateAlertPolicyRequest.Builder)`

### newBuilder(UpdateAlertPolicyRequest prototype)

```
public static UpdateAlertPolicyRequest.Builder newBuilder(UpdateAlertPolicyRequest prototype)
```
...
```
public static UpdateAlertPolicyRequest parseDelimitedFrom(InputStream input)
```
...
```
public static UpdateAlertPolicyRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateAlertPolicyRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateAlertPolicyRequest parseFrom(ByteString data)
```
...
```
public static UpdateAlertPolicyRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateAlertPolicyRequest parseFrom(CodedInputStream input)
```
...
```
public static UpdateAlertPolicyRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateAlertPolicyRequest parseFrom(InputStream input)
```
...
```
public static UpdateAlertPolicyRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateAlertPolicyRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<UpdateAlertPolicyRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[UpdateAlertPolicyRequest](/java/docs/reference/google-cloud-monitoring/3.33.0/com.google.monitoring.v3.UpdateAlertPolicyRequest)>`
...
`[AlertPolicy](/java/docs/reference/google-cloud-monitoring/3.33.0/com.google.monitoring.v3.AlertPolicy)`
...
`[AlertPolicyOrBuilder](/java/docs/reference/google-cloud-monitoring/3.33.0/com.google.monitoring.v3.AlertPolicyOrBuilder)`
...
```
public Parser<UpdateAlertPolicyRequest> getParserForType()
```
...
```
protected UpdateAlertPolicyRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
