...
# Class ReportConfigName (0.31.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> ReportConfigName
...
### format(String project, String location, String reportConfig)
...
`[ReportConfigName.Builder](/java/docs/reference/google-cloud-storageinsights/0.31.0/com.google.cloud.storageinsights.v1.ReportConfigName.Builder)`

### of(String project, String location, String reportConfig)
...
`[ReportConfigName](/java/docs/reference/google-cloud-storageinsights/0.31.0/com.google.cloud.storageinsights.v1.ReportConfigName)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ReportConfigName](/java/docs/reference/google-cloud-storageinsights/0.31.0/com.google.cloud.storageinsights.v1.ReportConfigName)>`
