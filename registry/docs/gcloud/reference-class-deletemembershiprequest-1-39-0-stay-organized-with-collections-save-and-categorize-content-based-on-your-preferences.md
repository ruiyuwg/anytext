...
# Class DeleteMembershipRequest (1.39.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class DeleteMembershipRequest extends GeneratedMessageV3 implements DeleteMembershipRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> DeleteMembershipRequest

## Implements

[DeleteMembershipRequestOrBuilder](/java/docs/reference/google-cloud-gkehub/1.39.0/com.google.cloud.gkehub.v1beta1.DeleteMembershipRequestOrBuilder)
...
```
public static DeleteMembershipRequest getDefaultInstance()
```
...
`[DeleteMembershipRequest](/java/docs/reference/google-cloud-gkehub/1.39.0/com.google.cloud.gkehub.v1beta1.DeleteMembershipRequest)`
...
```
public static DeleteMembershipRequest.Builder newBuilder()
```
...
`[DeleteMembershipRequest.Builder](/java/docs/reference/google-cloud-gkehub/1.39.0/com.google.cloud.gkehub.v1beta1.DeleteMembershipRequest.Builder)`

### newBuilder(DeleteMembershipRequest prototype)

```
public static DeleteMembershipRequest.Builder newBuilder(DeleteMembershipRequest prototype)
```
...
```
public static DeleteMembershipRequest parseDelimitedFrom(InputStream input)
```
...
```
public static DeleteMembershipRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteMembershipRequest parseFrom(byte[] data)
```
...
```
public static DeleteMembershipRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteMembershipRequest parseFrom(ByteString data)
```
...
```
public static DeleteMembershipRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteMembershipRequest parseFrom(CodedInputStream input)
```
...
```
public static DeleteMembershipRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteMembershipRequest parseFrom(InputStream input)
```
...
```
public static DeleteMembershipRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteMembershipRequest parseFrom(ByteBuffer data)
```
...
```
public static DeleteMembershipRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<DeleteMembershipRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[DeleteMembershipRequest](/java/docs/reference/google-cloud-gkehub/1.39.0/com.google.cloud.gkehub.v1beta1.DeleteMembershipRequest)>`
...
```
public Parser<DeleteMembershipRequest> getParserForType()
```
...
```
public DeleteMembershipRequest.Builder newBuilderForType()
```
...
```
protected DeleteMembershipRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public DeleteMembershipRequest.Builder toBuilder()
```
