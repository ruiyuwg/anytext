...
# Class EkmConfigName (2.90.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> EkmConfigName
...
```
public static EkmConfigName.Builder newBuilder()
```
...
`[EkmConfigName.Builder](/java/docs/reference/google-cloud-kms/latest/com.google.cloud.kms.v1.EkmConfigName.Builder)`
...
`[EkmConfigName](/java/docs/reference/google-cloud-kms/latest/com.google.cloud.kms.v1.EkmConfigName)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[EkmConfigName](/java/docs/reference/google-cloud-kms/latest/com.google.cloud.kms.v1.EkmConfigName)>`

### toStringList(List<EkmConfigName> values)
...
```
public EkmConfigName.Builder toBuilder()
```
