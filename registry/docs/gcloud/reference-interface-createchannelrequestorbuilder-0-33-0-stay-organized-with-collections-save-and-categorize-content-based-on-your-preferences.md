...
# Interface CreateChannelRequestOrBuilder (0.33.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[Channel](/java/docs/reference/google-cloud-live-stream/0.33.0/com.google.cloud.video.livestream.v1.Channel)`
...
`[ChannelOrBuilder](/java/docs/reference/google-cloud-live-stream/0.33.0/com.google.cloud.video.livestream.v1.ChannelOrBuilder)`
