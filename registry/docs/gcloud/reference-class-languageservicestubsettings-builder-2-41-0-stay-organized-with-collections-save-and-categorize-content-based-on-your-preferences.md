...
# Class LanguageServiceStubSettings.Builder (2.41.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class LanguageServiceStubSettings.Builder extends StubSettings.Builder<LanguageServiceStubSettings,LanguageServiceStubSettings.Builder>
```
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [StubSettings.Builder](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.StubSettings.Builder.html) \> LanguageServiceStubSettings.Builder
...
`[LanguageServiceStubSettings](/java/docs/reference/google-cloud-language/2.41.0/com.google.cloud.language.v1.stub.LanguageServiceStubSettings)`  
...
`[Builder](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.Builder.html)<[AnalyzeEntitiesRequest](/java/docs/reference/google-cloud-language/2.41.0/com.google.cloud.language.v1.AnalyzeEntitiesRequest),[AnalyzeEntitiesResponse](/java/docs/reference/google-cloud-language/2.41.0/com.google.cloud.language.v1.AnalyzeEntitiesResponse)>`
...
`[Builder](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.Builder.html)<[AnalyzeEntitySentimentRequest](/java/docs/reference/google-cloud-language/2.41.0/com.google.cloud.language.v1.AnalyzeEntitySentimentRequest),[AnalyzeEntitySentimentResponse](/java/docs/reference/google-cloud-language/2.41.0/com.google.cloud.language.v1.AnalyzeEntitySentimentResponse)>`
...
`[Builder](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.Builder.html)<[AnalyzeSentimentRequest](/java/docs/reference/google-cloud-language/2.41.0/com.google.cloud.language.v1.AnalyzeSentimentRequest),[AnalyzeSentimentResponse](/java/docs/reference/google-cloud-language/2.41.0/com.google.cloud.language.v1.AnalyzeSentimentResponse)>`
...
`[Builder](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.Builder.html)<[AnalyzeSyntaxRequest](/java/docs/reference/google-cloud-language/2.41.0/com.google.cloud.language.v1.AnalyzeSyntaxRequest),[AnalyzeSyntaxResponse](/java/docs/reference/google-cloud-language/2.41.0/com.google.cloud.language.v1.AnalyzeSyntaxResponse)>`
...
`[Builder](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.Builder.html)<[AnnotateTextRequest](/java/docs/reference/google-cloud-language/2.41.0/com.google.cloud.language.v1.AnnotateTextRequest),[AnnotateTextResponse](/java/docs/reference/google-cloud-language/2.41.0/com.google.cloud.language.v1.AnnotateTextResponse)>`

### applyToAllUnaryMethods(ApiFunction<UnaryCallSettings.Builder<?,?>,Void> settingsUpdater)

```
public LanguageServiceStubSettings.Builder applyToAllUnaryMethods(ApiFunction<UnaryCallSettings.Builder<?,?>,Void> settingsUpdater)
```
...
`[LanguageServiceStubSettings.Builder](/java/docs/reference/google-cloud-language/2.41.0/com.google.cloud.language.v1.stub.LanguageServiceStubSettings.Builder)`

### build()

```
public LanguageServiceStubSettings build()
```
...
`[Builder](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.Builder.html)<[ClassifyTextRequest](/java/docs/reference/google-cloud-language/2.41.0/com.google.cloud.language.v1.ClassifyTextRequest),[ClassifyTextResponse](/java/docs/reference/google-cloud-language/2.41.0/com.google.cloud.language.v1.ClassifyTextResponse)>`
...
`[Builder](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.Builder.html)<[ModerateTextRequest](/java/docs/reference/google-cloud-language/2.41.0/com.google.cloud.language.v1.ModerateTextRequest),[ModerateTextResponse](/java/docs/reference/google-cloud-language/2.41.0/com.google.cloud.language.v1.ModerateTextResponse)>`
