...
# Class GroupVersionKind (1.55.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class GroupVersionKind extends GeneratedMessageV3 implements GroupVersionKindOrBuilder
```

A Kubernetes object's GVK

Protobuf type `google.cloud.gkehub.configmanagement.v1beta.GroupVersionKind`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> GroupVersionKind

## Implements

[GroupVersionKindOrBuilder](/java/docs/reference/google-cloud-gkehub/1.55.0/com.google.cloud.gkehub.configmanagement.v1beta.GroupVersionKindOrBuilder)
...
```
public static GroupVersionKind getDefaultInstance()
```
...
`[GroupVersionKind](/java/docs/reference/google-cloud-gkehub/1.55.0/com.google.cloud.gkehub.configmanagement.v1beta.GroupVersionKind)`
...
```
public static GroupVersionKind.Builder newBuilder()
```
...
`[GroupVersionKind.Builder](/java/docs/reference/google-cloud-gkehub/1.55.0/com.google.cloud.gkehub.configmanagement.v1beta.GroupVersionKind.Builder)`

### newBuilder(GroupVersionKind prototype)

```
public static GroupVersionKind.Builder newBuilder(GroupVersionKind prototype)
```
...
```
public static GroupVersionKind parseDelimitedFrom(InputStream input)
```
...
```
public static GroupVersionKind parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GroupVersionKind parseFrom(byte[] data)
```
...
```
public static GroupVersionKind parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GroupVersionKind parseFrom(ByteString data)
```
...
```
public static GroupVersionKind parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GroupVersionKind parseFrom(CodedInputStream input)
```
...
```
public static GroupVersionKind parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GroupVersionKind parseFrom(InputStream input)
```
...
```
public static GroupVersionKind parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GroupVersionKind parseFrom(ByteBuffer data)
```
...
```
public static GroupVersionKind parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<GroupVersionKind> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[GroupVersionKind](/java/docs/reference/google-cloud-gkehub/1.55.0/com.google.cloud.gkehub.configmanagement.v1beta.GroupVersionKind)>`
...
```
public Parser<GroupVersionKind> getParserForType()
```
...
```
public GroupVersionKind.Builder newBuilderForType()
```
...
```
protected GroupVersionKind.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public GroupVersionKind.Builder toBuilder()
```
