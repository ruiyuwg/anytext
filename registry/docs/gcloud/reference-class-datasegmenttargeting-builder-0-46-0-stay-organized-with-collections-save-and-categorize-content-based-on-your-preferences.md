...
# Class DataSegmentTargeting.Builder (0.46.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class DataSegmentTargeting.Builder extends GeneratedMessage.Builder<DataSegmentTargeting.Builder> implements DataSegmentTargetingOrBuilder
```

Data Segment Targeting

Protobuf type `google.ads.admanager.v1.DataSegmentTargeting`

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessage.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessage.Builder.html) \> DataSegmentTargeting.Builder
...
```
public DataSegmentTargeting build()
```
...
```
public DataSegmentTargeting buildPartial()
```
...
```
public DataSegmentTargeting.Builder clear()
```
...
### clearHasDataSegmentTargeting()

```
public DataSegmentTargeting.Builder clearHasDataSegmentTargeting()
```

Output only. Whether any data segments are currently targeted.

`bool has_data_segment_targeting = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];`
...
```
public DataSegmentTargeting getDefaultInstanceForType()
```
...
### getHasDataSegmentTargeting()

```
public boolean getHasDataSegmentTargeting()
```
...
### mergeFrom(DataSegmentTargeting other)

```
public DataSegmentTargeting.Builder mergeFrom(DataSegmentTargeting other)
```
...
```
public DataSegmentTargeting.Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public DataSegmentTargeting.Builder mergeFrom(Message other)
```
...
### setHasDataSegmentTargeting(boolean value)

```
public DataSegmentTargeting.Builder setHasDataSegmentTargeting(boolean value)
```
...
The hasDataSegmentTargeting to set.
