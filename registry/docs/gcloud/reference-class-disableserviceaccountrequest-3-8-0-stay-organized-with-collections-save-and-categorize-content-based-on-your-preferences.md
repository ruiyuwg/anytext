...
# Class DisableServiceAccountRequest (3.8.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class DisableServiceAccountRequest extends GeneratedMessageV3 implements DisableServiceAccountRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> DisableServiceAccountRequest

## Implements

[DisableServiceAccountRequestOrBuilder](/java/docs/reference/google-iam-admin/3.8.0/com.google.iam.admin.v1.DisableServiceAccountRequestOrBuilder)
...
```
public static DisableServiceAccountRequest getDefaultInstance()
```
...
`[DisableServiceAccountRequest](/java/docs/reference/google-iam-admin/3.8.0/com.google.iam.admin.v1.DisableServiceAccountRequest)`
...
```
public static DisableServiceAccountRequest.Builder newBuilder()
```
...
`[DisableServiceAccountRequest.Builder](/java/docs/reference/google-iam-admin/3.8.0/com.google.iam.admin.v1.DisableServiceAccountRequest.Builder)`

### newBuilder(DisableServiceAccountRequest prototype)

```
public static DisableServiceAccountRequest.Builder newBuilder(DisableServiceAccountRequest prototype)
```
...
```
public static DisableServiceAccountRequest parseDelimitedFrom(InputStream input)
```
...
```
public static DisableServiceAccountRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DisableServiceAccountRequest parseFrom(byte[] data)
```
...
```
public static DisableServiceAccountRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DisableServiceAccountRequest parseFrom(ByteString data)
```
...
```
public static DisableServiceAccountRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DisableServiceAccountRequest parseFrom(CodedInputStream input)
```
...
```
public static DisableServiceAccountRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DisableServiceAccountRequest parseFrom(InputStream input)
```
...
```
public static DisableServiceAccountRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DisableServiceAccountRequest parseFrom(ByteBuffer data)
```
...
```
public static DisableServiceAccountRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<DisableServiceAccountRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[DisableServiceAccountRequest](/java/docs/reference/google-iam-admin/3.8.0/com.google.iam.admin.v1.DisableServiceAccountRequest)>`
...
```
public Parser<DisableServiceAccountRequest> getParserForType()
```
...
```
public DisableServiceAccountRequest.Builder newBuilderForType()
```
...
```
protected DisableServiceAccountRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public DisableServiceAccountRequest.Builder toBuilder()
```
