...
# Class ComputeThreatListDiffResponse.Checksum (2.41.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class ComputeThreatListDiffResponse.Checksum extends GeneratedMessageV3 implements ComputeThreatListDiffResponse.ChecksumOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ComputeThreatListDiffResponse.Checksum

## Implements

[ComputeThreatListDiffResponse.ChecksumOrBuilder](/java/docs/reference/google-cloud-webrisk/2.41.0/com.google.webrisk.v1.ComputeThreatListDiffResponse.ChecksumOrBuilder)
...
```
public static ComputeThreatListDiffResponse.Checksum getDefaultInstance()
```
...
`[ComputeThreatListDiffResponse.Checksum](/java/docs/reference/google-cloud-webrisk/2.41.0/com.google.webrisk.v1.ComputeThreatListDiffResponse.Checksum)`
...
```
public static ComputeThreatListDiffResponse.Checksum.Builder newBuilder()
```
...
`[ComputeThreatListDiffResponse.Checksum.Builder](/java/docs/reference/google-cloud-webrisk/2.41.0/com.google.webrisk.v1.ComputeThreatListDiffResponse.Checksum.Builder)`

### newBuilder(ComputeThreatListDiffResponse.Checksum prototype)

```
public static ComputeThreatListDiffResponse.Checksum.Builder newBuilder(ComputeThreatListDiffResponse.Checksum prototype)
```
...
```
public static ComputeThreatListDiffResponse.Checksum parseDelimitedFrom(InputStream input)
```
...
```
public static ComputeThreatListDiffResponse.Checksum parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ComputeThreatListDiffResponse.Checksum parseFrom(byte[] data)
```
...
```
public static ComputeThreatListDiffResponse.Checksum parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ComputeThreatListDiffResponse.Checksum parseFrom(ByteString data)
```
...
```
public static ComputeThreatListDiffResponse.Checksum parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ComputeThreatListDiffResponse.Checksum parseFrom(CodedInputStream input)
```
...
```
public static ComputeThreatListDiffResponse.Checksum parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ComputeThreatListDiffResponse.Checksum parseFrom(InputStream input)
```
...
```
public static ComputeThreatListDiffResponse.Checksum parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ComputeThreatListDiffResponse.Checksum parseFrom(ByteBuffer data)
```
...
```
public static ComputeThreatListDiffResponse.Checksum parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ComputeThreatListDiffResponse.Checksum> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[Checksum](/java/docs/reference/google-cloud-webrisk/2.41.0/com.google.webrisk.v1.ComputeThreatListDiffResponse.Checksum)>`
...
```
public ComputeThreatListDiffResponse.Checksum getDefaultInstanceForType()
```
...
```
public Parser<ComputeThreatListDiffResponse.Checksum> getParserForType()
```
...
```
public ComputeThreatListDiffResponse.Checksum.Builder newBuilderForType()
```
...
```
protected ComputeThreatListDiffResponse.Checksum.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ComputeThreatListDiffResponse.Checksum.Builder toBuilder()
```
