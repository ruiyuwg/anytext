...
# Interface DeleteLfpStoreRequestOrBuilder (0.11.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface DeleteLfpStoreRequestOrBuilder extends MessageOrBuilder
```
