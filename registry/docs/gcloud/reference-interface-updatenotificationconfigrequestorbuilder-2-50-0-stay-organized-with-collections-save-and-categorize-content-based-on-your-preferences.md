...
# Interface UpdateNotificationConfigRequestOrBuilder (2.50.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[NotificationConfig](/java/docs/reference/google-cloud-securitycenter/2.50.0/com.google.cloud.securitycenter.v1.NotificationConfig)`
...
`[NotificationConfigOrBuilder](/java/docs/reference/google-cloud-securitycenter/2.50.0/com.google.cloud.securitycenter.v1.NotificationConfigOrBuilder)`
