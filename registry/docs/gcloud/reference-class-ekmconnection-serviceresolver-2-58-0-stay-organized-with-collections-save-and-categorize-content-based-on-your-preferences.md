...
# Class EkmConnection.ServiceResolver (2.58.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> EkmConnection.ServiceResolver

## Implements

[EkmConnection.ServiceResolverOrBuilder](/java/docs/reference/google-cloud-kms/2.58.0/com.google.cloud.kms.v1.EkmConnection.ServiceResolverOrBuilder)
...
### ENDPOINT\_FILTER\_FIELD\_NUMBER
...
### SERVER\_CERTIFICATES\_FIELD\_NUMBER
...
### SERVICE\_DIRECTORY\_SERVICE\_FIELD\_NUMBER
...
`[EkmConnection.ServiceResolver](/java/docs/reference/google-cloud-kms/2.58.0/com.google.cloud.kms.v1.EkmConnection.ServiceResolver)`
...
`[EkmConnection.ServiceResolver.Builder](/java/docs/reference/google-cloud-kms/2.58.0/com.google.cloud.kms.v1.EkmConnection.ServiceResolver.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ServiceResolver](/java/docs/reference/google-cloud-kms/2.58.0/com.google.cloud.kms.v1.EkmConnection.ServiceResolver)>`
...
For endpoint filter syntax and examples, see [https://cloud.google.com/service-directory/docs/reference/rpc/google.cloud.servicedirectory.v1#resolveservicerequest](https://cloud.google.com/service-directory/docs/reference/rpc/google.cloud.servicedirectory.v1#resolveservicerequest).
...
`[Certificate](/java/docs/reference/google-cloud-kms/2.58.0/com.google.cloud.kms.v1.Certificate)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Certificate](/java/docs/reference/google-cloud-kms/2.58.0/com.google.cloud.kms.v1.Certificate)>`
...
`[CertificateOrBuilder](/java/docs/reference/google-cloud-kms/2.58.0/com.google.cloud.kms.v1.CertificateOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.kms.v1.CertificateOrBuilder>`
