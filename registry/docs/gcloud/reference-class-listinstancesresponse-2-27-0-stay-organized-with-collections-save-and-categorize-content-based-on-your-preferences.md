...
# Class ListInstancesResponse (2.27.0) Stay organized with collections Save and categorize content based on your preferences.
...
[ListInstancesResponseOrBuilder](/java/docs/reference/google-cloud-memcache/2.27.0/com.google.cloud.memcache.v1.ListInstancesResponseOrBuilder)
...
`[ListInstancesResponse](/java/docs/reference/google-cloud-memcache/2.27.0/com.google.cloud.memcache.v1.ListInstancesResponse)`
...
`[ListInstancesResponse.Builder](/java/docs/reference/google-cloud-memcache/2.27.0/com.google.cloud.memcache.v1.ListInstancesResponse.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListInstancesResponse](/java/docs/reference/google-cloud-memcache/2.27.0/com.google.cloud.memcache.v1.ListInstancesResponse)>`
...
`[Instance](/java/docs/reference/google-cloud-memcache/2.27.0/com.google.cloud.memcache.v1.Instance)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Instance](/java/docs/reference/google-cloud-memcache/2.27.0/com.google.cloud.memcache.v1.Instance)>`
...
`[InstanceOrBuilder](/java/docs/reference/google-cloud-memcache/2.27.0/com.google.cloud.memcache.v1.InstanceOrBuilder)`
