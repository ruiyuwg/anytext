...
# Class CompletionSettings.Builder (2.30.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class CompletionSettings.Builder extends ClientSettings.Builder<CompletionSettings,CompletionSettings.Builder>
```
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [ClientSettings.Builder](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.ClientSettings.Builder.html) \> CompletionSettings.Builder
...
`[CompletionSettings](/java/docs/reference/google-cloud-talent/2.30.0/com.google.cloud.talent.v4.CompletionSettings)`  

### Builder(CompletionStubSettings.Builder stubSettings)
...
`[CompletionStubSettings.Builder](/java/docs/reference/google-cloud-talent/2.30.0/com.google.cloud.talent.v4.stub.CompletionStubSettings.Builder)`  
...
```
public CompletionSettings.Builder applyToAllUnaryMethods(ApiFunction<UnaryCallSettings.Builder<?,?>,Void> settingsUpdater)
```
...
`[CompletionSettings.Builder](/java/docs/reference/google-cloud-talent/2.30.0/com.google.cloud.talent.v4.CompletionSettings.Builder)`

### build()

```
public CompletionSettings build()
```
...
`[Builder](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.Builder.html)<[CompleteQueryRequest](/java/docs/reference/google-cloud-talent/2.30.0/com.google.cloud.talent.v4.CompleteQueryRequest),[CompleteQueryResponse](/java/docs/reference/google-cloud-talent/2.30.0/com.google.cloud.talent.v4.CompleteQueryResponse)>`
