...
# Class ListEventsResponse.Builder (0.23.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> ListEventsResponse.Builder

## Implements

[ListEventsResponseOrBuilder](/java/docs/reference/google-cloud-servicehealth/0.23.0/com.google.cloud.servicehealth.v1.ListEventsResponseOrBuilder)
...
`[Iterable](https://docs.oracle.com/javase/8/docs/api/java/lang/Iterable.html)<? extends com.google.cloud.servicehealth.v1.Event>`  
...
`[ListEventsResponse.Builder](/java/docs/reference/google-cloud-servicehealth/0.23.0/com.google.cloud.servicehealth.v1.ListEventsResponse.Builder)`
...
`[Event](/java/docs/reference/google-cloud-servicehealth/0.23.0/com.google.cloud.servicehealth.v1.Event)`  
...
`[Event.Builder](/java/docs/reference/google-cloud-servicehealth/0.23.0/com.google.cloud.servicehealth.v1.Event.Builder)`  
...
`[ListEventsResponse](/java/docs/reference/google-cloud-servicehealth/0.23.0/com.google.cloud.servicehealth.v1.ListEventsResponse)`
...
Output only. The continuation token, used to page through large result sets. Provide this value in a subsequent request as page\_token to retrieve the next page.
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Builder](/java/docs/reference/google-cloud-servicehealth/0.23.0/com.google.cloud.servicehealth.v1.Event.Builder)>`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Event](/java/docs/reference/google-cloud-servicehealth/0.23.0/com.google.cloud.servicehealth.v1.Event)>`
...
`[EventOrBuilder](/java/docs/reference/google-cloud-servicehealth/0.23.0/com.google.cloud.servicehealth.v1.EventOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.servicehealth.v1.EventOrBuilder>`
