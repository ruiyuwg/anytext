...
# Interface DestinationVolumeParametersOrBuilder (0.66.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public abstract TieringPolicy getTieringPolicy()
```
...
`[TieringPolicy](/java/docs/reference/google-cloud-netapp/latest/com.google.cloud.netapp.v1.TieringPolicy)`
...
```
public abstract TieringPolicyOrBuilder getTieringPolicyOrBuilder()
```
...
`[TieringPolicyOrBuilder](/java/docs/reference/google-cloud-netapp/latest/com.google.cloud.netapp.v1.TieringPolicyOrBuilder)`
...
```
public abstract boolean hasTieringPolicy()
```
