...
# google-cloud-networkconnectivity overview (1.86.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Network Connectivity Center Description:** Google's suite of products that provide enterprise connectivity from your on-premises network or from another cloud provider to your Virtual Private Cloud (VPC) network

[Network Connectivity Center Product Reference](https://cloud.google.com/network-connectivity/docs)

[GitHub Repository](https://github.com/googleapis/google-cloud-java/tree/main/java-networkconnectivity)

[Maven artifact](https://central.sonatype.com/artifact/com.google.cloud/google-cloud-networkconnectivity)
...
-   [Enable the API](https://console.cloud.google.com/apis/library/networkconnectivity.googleapis.com)
-   [Set up authentication](https://cloud.google.com/docs/authentication/client-libraries)

## Use the Network Connectivity Center for Java
...
The example below demonstrates how you would import the BOM and include the `google-cloud-networkconnectivity` artifact.
...
For this library, we recommend using [com.google.cloud.networkconnectivity.v1](https://cloud.google.com/java/docs/reference/google-cloud-networkconnectivity/1.86.0/com.google.cloud.networkconnectivity.v1) for new applications.
