...
# Google Analytics Admin V1alpha Client - Class CreateConversionEventRequest (0.11.1) Stay organized with collections Save and categorize content based on your preferences.
...
`[Google\Analytics\Admin\V1alpha\ConversionEvent](/php/docs/reference/analytics-admin/0.11.1/V1alpha.ConversionEvent)`  
...
`[Google\Analytics\Admin\V1alpha\ConversionEvent](/php/docs/reference/analytics-admin/0.11.1/V1alpha.ConversionEvent)|null`
