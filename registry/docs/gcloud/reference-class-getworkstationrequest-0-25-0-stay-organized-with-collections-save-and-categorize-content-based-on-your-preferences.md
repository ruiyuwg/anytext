...
# Class GetWorkstationRequest (0.25.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class GetWorkstationRequest extends GeneratedMessageV3 implements GetWorkstationRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> GetWorkstationRequest

## Implements

[GetWorkstationRequestOrBuilder](/java/docs/reference/google-cloud-workstations/0.25.0/com.google.cloud.workstations.v1.GetWorkstationRequestOrBuilder)
...
```
public static GetWorkstationRequest getDefaultInstance()
```
...
`[GetWorkstationRequest](/java/docs/reference/google-cloud-workstations/0.25.0/com.google.cloud.workstations.v1.GetWorkstationRequest)`
...
```
public static GetWorkstationRequest.Builder newBuilder()
```
...
`[GetWorkstationRequest.Builder](/java/docs/reference/google-cloud-workstations/0.25.0/com.google.cloud.workstations.v1.GetWorkstationRequest.Builder)`

### newBuilder(GetWorkstationRequest prototype)

```
public static GetWorkstationRequest.Builder newBuilder(GetWorkstationRequest prototype)
```
...
```
public static GetWorkstationRequest parseDelimitedFrom(InputStream input)
```
...
```
public static GetWorkstationRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetWorkstationRequest parseFrom(byte[] data)
```
...
```
public static GetWorkstationRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetWorkstationRequest parseFrom(ByteString data)
```
...
```
public static GetWorkstationRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetWorkstationRequest parseFrom(CodedInputStream input)
```
...
```
public static GetWorkstationRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetWorkstationRequest parseFrom(InputStream input)
```
...
```
public static GetWorkstationRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetWorkstationRequest parseFrom(ByteBuffer data)
```
...
```
public static GetWorkstationRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<GetWorkstationRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[GetWorkstationRequest](/java/docs/reference/google-cloud-workstations/0.25.0/com.google.cloud.workstations.v1.GetWorkstationRequest)>`
...
```
public GetWorkstationRequest getDefaultInstanceForType()
```
...
```
public Parser<GetWorkstationRequest> getParserForType()
```
...
```
public GetWorkstationRequest.Builder newBuilderForType()
```
...
```
protected GetWorkstationRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public GetWorkstationRequest.Builder toBuilder()
```
