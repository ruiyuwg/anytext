...
# Class Folder.Builder (2.63.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> Folder.Builder

## Implements

[FolderOrBuilder](/java/docs/reference/google-cloud-securitycenter/2.63.0/com.google.cloud.securitycenter.v2.FolderOrBuilder)
...
`[Folder.Builder](/java/docs/reference/google-cloud-securitycenter/2.63.0/com.google.cloud.securitycenter.v2.Folder.Builder)`
...
`[Folder](/java/docs/reference/google-cloud-securitycenter/2.63.0/com.google.cloud.securitycenter.v2.Folder)`
...
```
public Folder.Builder clearResourceFolder()
```

Full resource name of this folder. See: [https://cloud.google.com/apis/design/resource\_names#full\_resource\_name](https://cloud.google.com/apis/design/resource_names#full_resource_name)
...
### clearResourceFolderDisplayName()

```
public Folder.Builder clearResourceFolderDisplayName()
```
...
```
public ByteString getResourceFolderBytes()
```
...
```
public String getResourceFolderDisplayName()
```
...
```
public ByteString getResourceFolderDisplayNameBytes()
```
...
```
public Folder.Builder setResourceFolder(String value)
```
...
### setResourceFolderBytes(ByteString value)

```
public Folder.Builder setResourceFolderBytes(ByteString value)
```
...
The bytes for resourceFolder to set.
...
### setResourceFolderDisplayName(String value)

```
public Folder.Builder setResourceFolderDisplayName(String value)
```
...
The resourceFolderDisplayName to set.
...
### setResourceFolderDisplayNameBytes(ByteString value)

```
public Folder.Builder setResourceFolderDisplayNameBytes(ByteString value)
```
...
The bytes for resourceFolderDisplayName to set.
