...
# Class UpdateInstanceConfigRequest.Builder (1.13.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> UpdateInstanceConfigRequest.Builder

## Implements

[UpdateInstanceConfigRequestOrBuilder](/java/docs/reference/google-cloud-notebooks/1.13.0/com.google.cloud.notebooks.v1.UpdateInstanceConfigRequestOrBuilder)
...
`[UpdateInstanceConfigRequest.Builder](/java/docs/reference/google-cloud-notebooks/1.13.0/com.google.cloud.notebooks.v1.UpdateInstanceConfigRequest.Builder)`
...
`[UpdateInstanceConfigRequest](/java/docs/reference/google-cloud-notebooks/1.13.0/com.google.cloud.notebooks.v1.UpdateInstanceConfigRequest)`
...
```
public UpdateInstanceConfigRequest.Builder clearConfig()
```
...
```
public UpdateInstanceConfigRequest.Builder clearName()
```
...
`[InstanceConfig](/java/docs/reference/google-cloud-notebooks/1.13.0/com.google.cloud.notebooks.v1.InstanceConfig)`
...
```
public InstanceConfig.Builder getConfigBuilder()
```
...
`[InstanceConfig.Builder](/java/docs/reference/google-cloud-notebooks/1.13.0/com.google.cloud.notebooks.v1.InstanceConfig.Builder)`
...
`[InstanceConfigOrBuilder](/java/docs/reference/google-cloud-notebooks/1.13.0/com.google.cloud.notebooks.v1.InstanceConfigOrBuilder)`
...
### mergeConfig(InstanceConfig value)

```
public UpdateInstanceConfigRequest.Builder mergeConfig(InstanceConfig value)
```
...
### setConfig(InstanceConfig value)

```
public UpdateInstanceConfigRequest.Builder setConfig(InstanceConfig value)
```
...
### setConfig(InstanceConfig.Builder builderForValue)

```
public UpdateInstanceConfigRequest.Builder setConfig(InstanceConfig.Builder builderForValue)
```
...
```
public UpdateInstanceConfigRequest.Builder setName(String value)
```
...
```
public UpdateInstanceConfigRequest.Builder setNameBytes(ByteString value)
```
