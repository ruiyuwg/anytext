...
# Class ListRelatedAccountGroupsResponse (3.45.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListRelatedAccountGroupsResponse

## Implements

[ListRelatedAccountGroupsResponseOrBuilder](/java/docs/reference/google-cloud-recaptchaenterprise/3.45.0/com.google.recaptchaenterprise.v1.ListRelatedAccountGroupsResponseOrBuilder)
...
### RELATED\_ACCOUNT\_GROUPS\_FIELD\_NUMBER
...
`[ListRelatedAccountGroupsResponse](/java/docs/reference/google-cloud-recaptchaenterprise/3.45.0/com.google.recaptchaenterprise.v1.ListRelatedAccountGroupsResponse)`
...
`[ListRelatedAccountGroupsResponse.Builder](/java/docs/reference/google-cloud-recaptchaenterprise/3.45.0/com.google.recaptchaenterprise.v1.ListRelatedAccountGroupsResponse.Builder)`

### newBuilder(ListRelatedAccountGroupsResponse prototype)
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListRelatedAccountGroupsResponse](/java/docs/reference/google-cloud-recaptchaenterprise/3.45.0/com.google.recaptchaenterprise.v1.ListRelatedAccountGroupsResponse)>`
...
`[RelatedAccountGroup](/java/docs/reference/google-cloud-recaptchaenterprise/3.45.0/com.google.recaptchaenterprise.v1.RelatedAccountGroup)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[RelatedAccountGroup](/java/docs/reference/google-cloud-recaptchaenterprise/3.45.0/com.google.recaptchaenterprise.v1.RelatedAccountGroup)>`
...
`[RelatedAccountGroupOrBuilder](/java/docs/reference/google-cloud-recaptchaenterprise/3.45.0/com.google.recaptchaenterprise.v1.RelatedAccountGroupOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.recaptchaenterprise.v1.RelatedAccountGroupOrBuilder>`
