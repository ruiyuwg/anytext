...
# Enum Secret.ExpirationCase (2.48.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum Secret.ExpirationCase extends Enum<Secret.ExpirationCase> implements Internal.EnumLite, AbstractMessageLite.InternalOneOfEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-secretmanager/2.48.0/com.google.cloud.secretmanager.v1.Secret.ExpirationCase#com_google_cloud_secretmanager_v1_Secret_ExpirationCase_forNumber_int_) instead._
