...
# Class CloudTasksClient.ListQueuesPage (2.32.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class CloudTasksClient.ListQueuesPage extends AbstractPage<ListQueuesRequest,ListQueuesResponse,Queue,CloudTasksClient.ListQueuesPage>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractPage](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractPage.html) \> CloudTasksClient.ListQueuesPage
...
### createPage(PageContext<ListQueuesRequest,ListQueuesResponse,Queue> context, ListQueuesResponse response)

```
protected CloudTasksClient.ListQueuesPage createPage(PageContext<ListQueuesRequest,ListQueuesResponse,Queue> context, ListQueuesResponse response)
```
...
`[PageContext](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PageContext.html)<[ListQueuesRequest](/java/docs/reference/google-cloud-tasks/2.32.0/com.google.cloud.tasks.v2beta3.ListQueuesRequest),[ListQueuesResponse](/java/docs/reference/google-cloud-tasks/2.32.0/com.google.cloud.tasks.v2beta3.ListQueuesResponse),[Queue](/java/docs/reference/google-cloud-tasks/2.32.0/com.google.cloud.tasks.v2beta3.Queue)>`  

`response`

`[ListQueuesResponse](/java/docs/reference/google-cloud-tasks/2.32.0/com.google.cloud.tasks.v2beta3.ListQueuesResponse)`  
...
`[CloudTasksClient.ListQueuesPage](/java/docs/reference/google-cloud-tasks/2.32.0/com.google.cloud.tasks.v2beta3.CloudTasksClient.ListQueuesPage)`
...
### createPageAsync(PageContext<ListQueuesRequest,ListQueuesResponse,Queue> context, ApiFuture<ListQueuesResponse> futureResponse)

```
public ApiFuture<CloudTasksClient.ListQueuesPage> createPageAsync(PageContext<ListQueuesRequest,ListQueuesResponse,Queue> context, ApiFuture<ListQueuesResponse> futureResponse)
```
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListQueuesResponse](/java/docs/reference/google-cloud-tasks/2.32.0/com.google.cloud.tasks.v2beta3.ListQueuesResponse)>`  
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListQueuesPage](/java/docs/reference/google-cloud-tasks/2.32.0/com.google.cloud.tasks.v2beta3.CloudTasksClient.ListQueuesPage)>`
