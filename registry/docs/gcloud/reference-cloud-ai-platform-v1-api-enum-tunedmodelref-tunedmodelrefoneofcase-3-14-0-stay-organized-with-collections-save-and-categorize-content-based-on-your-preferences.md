...
# Cloud AI Platform v1 API - Enum TunedModelRef.TunedModelRefOneofCase (3.14.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum TunedModelRef.TunedModelRefOneofCase
```

Reference documentation and code samples for the Cloud AI Platform v1 API enum TunedModelRef.TunedModelRefOneofCase.

Enum of possible cases for the "tuned\_model\_ref" oneof.
