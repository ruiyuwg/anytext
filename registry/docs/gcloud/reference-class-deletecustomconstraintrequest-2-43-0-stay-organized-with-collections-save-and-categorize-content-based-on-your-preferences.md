...
# Class DeleteCustomConstraintRequest (2.43.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class DeleteCustomConstraintRequest extends GeneratedMessageV3 implements DeleteCustomConstraintRequestOrBuilder
```

The request sent to the \[DeleteCustomConstraint\] \[google.cloud.orgpolicy.v2.OrgPolicy.DeleteCustomConstraint\] method.

Protobuf type `google.cloud.orgpolicy.v2.DeleteCustomConstraintRequest`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> DeleteCustomConstraintRequest

## Implements

[DeleteCustomConstraintRequestOrBuilder](/java/docs/reference/google-cloud-orgpolicy/2.43.0/com.google.cloud.orgpolicy.v2.DeleteCustomConstraintRequestOrBuilder)
...
```
public static DeleteCustomConstraintRequest getDefaultInstance()
```
...
`[DeleteCustomConstraintRequest](/java/docs/reference/google-cloud-orgpolicy/2.43.0/com.google.cloud.orgpolicy.v2.DeleteCustomConstraintRequest)`
...
```
public static DeleteCustomConstraintRequest.Builder newBuilder()
```
...
`[DeleteCustomConstraintRequest.Builder](/java/docs/reference/google-cloud-orgpolicy/2.43.0/com.google.cloud.orgpolicy.v2.DeleteCustomConstraintRequest.Builder)`

### newBuilder(DeleteCustomConstraintRequest prototype)

```
public static DeleteCustomConstraintRequest.Builder newBuilder(DeleteCustomConstraintRequest prototype)
```
...
```
public static DeleteCustomConstraintRequest parseDelimitedFrom(InputStream input)
```
...
```
public static DeleteCustomConstraintRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteCustomConstraintRequest parseFrom(byte[] data)
```
...
```
public static DeleteCustomConstraintRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteCustomConstraintRequest parseFrom(ByteString data)
```
...
```
public static DeleteCustomConstraintRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteCustomConstraintRequest parseFrom(CodedInputStream input)
```
...
```
public static DeleteCustomConstraintRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteCustomConstraintRequest parseFrom(InputStream input)
```
...
```
public static DeleteCustomConstraintRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteCustomConstraintRequest parseFrom(ByteBuffer data)
```
...
```
public static DeleteCustomConstraintRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<DeleteCustomConstraintRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[DeleteCustomConstraintRequest](/java/docs/reference/google-cloud-orgpolicy/2.43.0/com.google.cloud.orgpolicy.v2.DeleteCustomConstraintRequest)>`
...
```
public DeleteCustomConstraintRequest getDefaultInstanceForType()
```
...
```
public Parser<DeleteCustomConstraintRequest> getParserForType()
```
...
```
public DeleteCustomConstraintRequest.Builder newBuilderForType()
```
...
```
protected DeleteCustomConstraintRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public DeleteCustomConstraintRequest.Builder toBuilder()
```
