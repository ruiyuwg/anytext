...
# Class Inventory (2.48.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> Inventory

## Implements

[InventoryOrBuilder](/java/docs/reference/google-cloud-os-config/2.48.0/com.google.cloud.osconfig.v1.InventoryOrBuilder)
...
`[Inventory](/java/docs/reference/google-cloud-os-config/2.48.0/com.google.cloud.osconfig.v1.Inventory)`
...
`[Inventory.Builder](/java/docs/reference/google-cloud-os-config/2.48.0/com.google.cloud.osconfig.v1.Inventory.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[Inventory](/java/docs/reference/google-cloud-os-config/2.48.0/com.google.cloud.osconfig.v1.Inventory)>`
...
Use [#getItemsMap()](/java/docs/reference/google-cloud-os-config/2.48.0/com.google.cloud.osconfig.v1.Inventory#com_google_cloud_osconfig_v1_Inventory_getItemsMap__) instead.
...
`[Map](https://docs.oracle.com/javase/8/docs/api/java/util/Map.html)<[String](https://docs.oracle.com/javase/8/docs/api/java/lang/String.html),[Item](/java/docs/reference/google-cloud-os-config/2.48.0/com.google.cloud.osconfig.v1.Inventory.Item)>`
...
`[Inventory.Item](/java/docs/reference/google-cloud-os-config/2.48.0/com.google.cloud.osconfig.v1.Inventory.Item)`  
...
`[Inventory.OsInfo](/java/docs/reference/google-cloud-os-config/2.48.0/com.google.cloud.osconfig.v1.Inventory.OsInfo)`
...
`[Inventory.OsInfoOrBuilder](/java/docs/reference/google-cloud-os-config/2.48.0/com.google.cloud.osconfig.v1.Inventory.OsInfoOrBuilder)`
