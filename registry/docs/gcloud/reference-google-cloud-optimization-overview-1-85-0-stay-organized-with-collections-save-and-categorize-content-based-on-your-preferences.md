...
# google-cloud-optimization overview (1.85.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Cloud Fleet Routing Product Reference](https://cloud.google.com/optimization/docs)

[GitHub Repository](https://github.com/googleapis/google-cloud-java/tree/main/java-optimization)

[Maven artifact](https://central.sonatype.com/artifact/com.google.cloud/google-cloud-optimization)
...
-   [Enable the API](https://console.cloud.google.com/apis/library/cloudoptimization.googleapis.com)
...
The example below demonstrates how you would import the BOM and include the `google-cloud-optimization` artifact.
...
implementation("com.google.cloud:google-cloud-optimization")
...
libraryDependencies += "com.google.cloud" % "google-cloud-optimization" % "1.85.0"

## Which version ID should I get started with?

For this library, we recommend using [com.google.cloud.optimization.v1](https://cloud.google.com/java/docs/reference/google-cloud-optimization/1.85.0/com.google.cloud.optimization.v1) for new applications.
