...
# Interface TransferProto.UpdateAgentPoolRequestOrBuilder (1.55.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[TransferTypes.AgentPool](/java/docs/reference/google-cloud-storage-transfer/1.55.0/com.google.storagetransfer.v1.proto.TransferTypes.AgentPool)`
...
`[TransferTypes.AgentPoolOrBuilder](/java/docs/reference/google-cloud-storage-transfer/1.55.0/com.google.storagetransfer.v1.proto.TransferTypes.AgentPoolOrBuilder)`
