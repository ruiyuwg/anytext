...
# Interface OrganizationSettingsOrBuilder (2.56.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[OrganizationSettings.AssetDiscoveryConfig](/java/docs/reference/google-cloud-securitycenter/2.56.0/com.google.cloud.securitycenter.v1p1beta1.OrganizationSettings.AssetDiscoveryConfig)`
...
`[OrganizationSettings.AssetDiscoveryConfigOrBuilder](/java/docs/reference/google-cloud-securitycenter/2.56.0/com.google.cloud.securitycenter.v1p1beta1.OrganizationSettings.AssetDiscoveryConfigOrBuilder)`
...
The relative resource name of the settings. See: [https://cloud.google.com/apis/design/resource\_names#relative\_resource\_name](https://cloud.google.com/apis/design/resource_names#relative_resource_name) Example: "organizations/{organization\_id}/organizationSettings".
