...
# Override sql\_v1::SqlAvailableDatabaseVersionsServiceClient Retry Policies

This shows how to override the retry policies for sql\_v1::SqlAvailableDatabaseVersionsServiceClient:
  ...
  //       google::cloud::sql_v1::SqlAvailableDatabaseVersionsServiceLimitedErrorCountRetryPolicy(10).clone()));
```
