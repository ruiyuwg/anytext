...
# Class HttpHealthChecksLimitedErrorCountRetryPolicy (2.32.0) Stay organized with collections Save and categorize content based on your preferences.
...
A retry policy for [`HttpHealthChecksConnection`](/cpp/docs/reference/compute/2.32.0/classgoogle_1_1cloud_1_1compute__http__health__checks__v1_1_1HttpHealthChecksConnection) based on counting errors.
...
`HttpHealthChecksLimitedErrorCountRetryPolicy const &`  
...
`std::unique_ptr< HttpHealthChecksRetryPolicy >`

## Type Aliases

### BaseType

**Alias Of**: `HttpHealthChecksRetryPolicy`
