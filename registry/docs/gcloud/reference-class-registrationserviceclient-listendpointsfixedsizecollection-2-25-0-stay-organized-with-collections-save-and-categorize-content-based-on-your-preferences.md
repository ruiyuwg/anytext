...
# Class RegistrationServiceClient.ListEndpointsFixedSizeCollection (2.25.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class RegistrationServiceClient.ListEndpointsFixedSizeCollection extends AbstractFixedSizeCollection<ListEndpointsRequest,ListEndpointsResponse,Endpoint,RegistrationServiceClient.ListEndpointsPage,RegistrationServiceClient.ListEndpointsFixedSizeCollection>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractFixedSizeCollection](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractFixedSizeCollection.html) \> RegistrationServiceClient.ListEndpointsFixedSizeCollection
...
### createCollection(List<RegistrationServiceClient.ListEndpointsPage> pages, int collectionSize)

```
protected RegistrationServiceClient.ListEndpointsFixedSizeCollection createCollection(List<RegistrationServiceClient.ListEndpointsPage> pages, int collectionSize)
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ListEndpointsPage](/java/docs/reference/google-cloud-servicedirectory/2.25.0/com.google.cloud.servicedirectory.v1beta1.RegistrationServiceClient.ListEndpointsPage)>`  
...
`[RegistrationServiceClient.ListEndpointsFixedSizeCollection](/java/docs/reference/google-cloud-servicedirectory/2.25.0/com.google.cloud.servicedirectory.v1beta1.RegistrationServiceClient.ListEndpointsFixedSizeCollection)`
