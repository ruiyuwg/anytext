...
# Class TransferTypes.GoogleServiceAccount.Builder (1.34.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class TransferTypes.GoogleServiceAccount.Builder extends GeneratedMessageV3.Builder<TransferTypes.GoogleServiceAccount.Builder> implements TransferTypes.GoogleServiceAccountOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> TransferTypes.GoogleServiceAccount.Builder

## Implements

[TransferTypes.GoogleServiceAccountOrBuilder](/java/docs/reference/google-cloud-storage-transfer/1.34.0/com.google.storagetransfer.v1.proto.TransferTypes.GoogleServiceAccountOrBuilder)
...
```
public TransferTypes.GoogleServiceAccount.Builder addRepeatedField(Descriptors.FieldDescriptor field, Object value)
```
...
`[TransferTypes.GoogleServiceAccount.Builder](/java/docs/reference/google-cloud-storage-transfer/1.34.0/com.google.storagetransfer.v1.proto.TransferTypes.GoogleServiceAccount.Builder)`
...
`[TransferTypes.GoogleServiceAccount](/java/docs/reference/google-cloud-storage-transfer/1.34.0/com.google.storagetransfer.v1.proto.TransferTypes.GoogleServiceAccount)`
...
```
public TransferTypes.GoogleServiceAccount.Builder clearField(Descriptors.FieldDescriptor field)
```
...
```
public TransferTypes.GoogleServiceAccount.Builder clearOneof(Descriptors.OneofDescriptor oneof)
```
...
```
public TransferTypes.GoogleServiceAccount.Builder clone()
```
...
```
public final TransferTypes.GoogleServiceAccount.Builder mergeUnknownFields(UnknownFieldSet unknownFields)
```
...
```
public TransferTypes.GoogleServiceAccount.Builder setField(Descriptors.FieldDescriptor field, Object value)
```
...
```
public TransferTypes.GoogleServiceAccount.Builder setRepeatedField(Descriptors.FieldDescriptor field, int index, Object value)
```
...
```
public final TransferTypes.GoogleServiceAccount.Builder setUnknownFields(UnknownFieldSet unknownFields)
```
