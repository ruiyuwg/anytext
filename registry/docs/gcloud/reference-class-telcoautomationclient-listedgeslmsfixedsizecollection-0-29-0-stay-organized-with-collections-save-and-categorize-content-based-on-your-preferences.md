...
# Class TelcoAutomationClient.ListEdgeSlmsFixedSizeCollection (0.29.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class TelcoAutomationClient.ListEdgeSlmsFixedSizeCollection extends AbstractFixedSizeCollection<ListEdgeSlmsRequest,ListEdgeSlmsResponse,EdgeSlm,TelcoAutomationClient.ListEdgeSlmsPage,TelcoAutomationClient.ListEdgeSlmsFixedSizeCollection>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractFixedSizeCollection](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractFixedSizeCollection.html) \> TelcoAutomationClient.ListEdgeSlmsFixedSizeCollection
...
### createCollection(List<TelcoAutomationClient.ListEdgeSlmsPage> pages, int collectionSize)

```
protected TelcoAutomationClient.ListEdgeSlmsFixedSizeCollection createCollection(List<TelcoAutomationClient.ListEdgeSlmsPage> pages, int collectionSize)
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ListEdgeSlmsPage](/java/docs/reference/google-cloud-telcoautomation/0.29.0/com.google.cloud.telcoautomation.v1alpha1.TelcoAutomationClient.ListEdgeSlmsPage)>`  
...
`[TelcoAutomationClient.ListEdgeSlmsFixedSizeCollection](/java/docs/reference/google-cloud-telcoautomation/0.29.0/com.google.cloud.telcoautomation.v1alpha1.TelcoAutomationClient.ListEdgeSlmsFixedSizeCollection)`
