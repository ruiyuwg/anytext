...
# Class MembershipState.DataPlaneManagement (1.47.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class MembershipState.DataPlaneManagement extends GeneratedMessageV3 implements MembershipState.DataPlaneManagementOrBuilder
```

Status of data plane management. Only reported per-member.

Protobuf type `google.cloud.gkehub.servicemesh.v1beta.MembershipState.DataPlaneManagement`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> MembershipState.DataPlaneManagement

## Implements

[MembershipState.DataPlaneManagementOrBuilder](/java/docs/reference/google-cloud-gkehub/1.47.0/com.google.cloud.gkehub.servicemesh.v1beta.MembershipState.DataPlaneManagementOrBuilder)
...
```
public static MembershipState.DataPlaneManagement getDefaultInstance()
```
...
`[MembershipState.DataPlaneManagement](/java/docs/reference/google-cloud-gkehub/1.47.0/com.google.cloud.gkehub.servicemesh.v1beta.MembershipState.DataPlaneManagement)`
...
```
public static MembershipState.DataPlaneManagement.Builder newBuilder()
```
...
`[MembershipState.DataPlaneManagement.Builder](/java/docs/reference/google-cloud-gkehub/1.47.0/com.google.cloud.gkehub.servicemesh.v1beta.MembershipState.DataPlaneManagement.Builder)`

### newBuilder(MembershipState.DataPlaneManagement prototype)

```
public static MembershipState.DataPlaneManagement.Builder newBuilder(MembershipState.DataPlaneManagement prototype)
```
...
```
public static MembershipState.DataPlaneManagement parseDelimitedFrom(InputStream input)
```
...
```
public static MembershipState.DataPlaneManagement parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static MembershipState.DataPlaneManagement parseFrom(byte[] data)
```
...
```
public static MembershipState.DataPlaneManagement parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static MembershipState.DataPlaneManagement parseFrom(ByteString data)
```
...
```
public static MembershipState.DataPlaneManagement parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static MembershipState.DataPlaneManagement parseFrom(CodedInputStream input)
```
...
```
public static MembershipState.DataPlaneManagement parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static MembershipState.DataPlaneManagement parseFrom(InputStream input)
```
...
```
public static MembershipState.DataPlaneManagement parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static MembershipState.DataPlaneManagement parseFrom(ByteBuffer data)
```
...
```
public static MembershipState.DataPlaneManagement parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<MembershipState.DataPlaneManagement> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[DataPlaneManagement](/java/docs/reference/google-cloud-gkehub/1.47.0/com.google.cloud.gkehub.servicemesh.v1beta.MembershipState.DataPlaneManagement)>`
...
```
public MembershipState.DataPlaneManagement getDefaultInstanceForType()
```
...
```
public StatusDetails getDetails(int index)
```
...
`[StatusDetails](/java/docs/reference/google-cloud-gkehub/1.47.0/com.google.cloud.gkehub.servicemesh.v1beta.StatusDetails)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[StatusDetails](/java/docs/reference/google-cloud-gkehub/1.47.0/com.google.cloud.gkehub.servicemesh.v1beta.StatusDetails)>`

### getDetailsOrBuilder(int index)

```
public StatusDetailsOrBuilder getDetailsOrBuilder(int index)
```
...
`[StatusDetailsOrBuilder](/java/docs/reference/google-cloud-gkehub/1.47.0/com.google.cloud.gkehub.servicemesh.v1beta.StatusDetailsOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.gkehub.servicemesh.v1beta.StatusDetailsOrBuilder>`

### getParserForType()

```
public Parser<MembershipState.DataPlaneManagement> getParserForType()
```
...
`[MembershipState.LifecycleState](/java/docs/reference/google-cloud-gkehub/1.47.0/com.google.cloud.gkehub.servicemesh.v1beta.MembershipState.LifecycleState)`
...
```
public MembershipState.DataPlaneManagement.Builder newBuilderForType()
```
...
```
protected MembershipState.DataPlaneManagement.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public MembershipState.DataPlaneManagement.Builder toBuilder()
```
