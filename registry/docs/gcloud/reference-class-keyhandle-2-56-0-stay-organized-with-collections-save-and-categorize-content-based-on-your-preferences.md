...
# Class KeyHandle (2.56.0) Stay organized with collections Save and categorize content based on your preferences.
...
### RESOURCE\_TYPE\_SELECTOR\_FIELD\_NUMBER
...
`[KeyHandle](/java/docs/reference/google-cloud-kms/2.56.0/com.google.cloud.kms.v1.KeyHandle)`
...
`[KeyHandle.Builder](/java/docs/reference/google-cloud-kms/2.56.0/com.google.cloud.kms.v1.KeyHandle.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[KeyHandle](/java/docs/reference/google-cloud-kms/2.56.0/com.google.cloud.kms.v1.KeyHandle)>`
