...
# Interface ObjectTrackingFrameOrBuilder (2.27.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[NormalizedBoundingBox](/java/docs/reference/google-cloud-video-intelligence/2.27.0/com.google.cloud.videointelligence.v1p3beta1.NormalizedBoundingBox)`
...
`[NormalizedBoundingBoxOrBuilder](/java/docs/reference/google-cloud-video-intelligence/2.27.0/com.google.cloud.videointelligence.v1p3beta1.NormalizedBoundingBoxOrBuilder)`
