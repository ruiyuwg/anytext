...
# Class Job.ProcessingOptions (2.13.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class Job.ProcessingOptions extends GeneratedMessageV3 implements Job.ProcessingOptionsOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> Job.ProcessingOptions

## Implements

[Job.ProcessingOptionsOrBuilder](/java/docs/reference/google-cloud-talent/2.13.0/com.google.cloud.talent.v4beta1.Job.ProcessingOptionsOrBuilder)
...
### DISABLE\_STREET\_ADDRESS\_RESOLUTION\_FIELD\_NUMBER

```
public static final int DISABLE_STREET_ADDRESS_RESOLUTION_FIELD_NUMBER
```
...
### HTML\_SANITIZATION\_FIELD\_NUMBER

```
public static final int HTML_SANITIZATION_FIELD_NUMBER
```
...
```
public static Job.ProcessingOptions getDefaultInstance()
```
...
`[Job.ProcessingOptions](/java/docs/reference/google-cloud-talent/2.13.0/com.google.cloud.talent.v4beta1.Job.ProcessingOptions)`
...
```
public static Job.ProcessingOptions.Builder newBuilder()
```
...
`[Job.ProcessingOptions.Builder](/java/docs/reference/google-cloud-talent/2.13.0/com.google.cloud.talent.v4beta1.Job.ProcessingOptions.Builder)`

### newBuilder(Job.ProcessingOptions prototype)

```
public static Job.ProcessingOptions.Builder newBuilder(Job.ProcessingOptions prototype)
```
...
```
public static Job.ProcessingOptions parseDelimitedFrom(InputStream input)
```
...
```
public static Job.ProcessingOptions parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Job.ProcessingOptions parseFrom(byte[] data)
```
...
```
public static Job.ProcessingOptions parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Job.ProcessingOptions parseFrom(ByteString data)
```
...
```
public static Job.ProcessingOptions parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Job.ProcessingOptions parseFrom(CodedInputStream input)
```
...
```
public static Job.ProcessingOptions parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Job.ProcessingOptions parseFrom(InputStream input)
```
...
```
public static Job.ProcessingOptions parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Job.ProcessingOptions parseFrom(ByteBuffer data)
```
...
```
public static Job.ProcessingOptions parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<Job.ProcessingOptions> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ProcessingOptions](/java/docs/reference/google-cloud-talent/2.13.0/com.google.cloud.talent.v4beta1.Job.ProcessingOptions)>`
...
-   incentives
-   qualifications
-   responsibilities HTML tags in these fields may be stripped if sanitiazation isn't disabled. Defaults to HtmlSanitization.SIMPLE\_FORMATTING\_ONLY.
...
`[HtmlSanitization](/java/docs/reference/google-cloud-talent/2.13.0/com.google.cloud.talent.v4beta1.HtmlSanitization)`
...
```
public Parser<Job.ProcessingOptions> getParserForType()
```
...
```
public Job.ProcessingOptions.Builder newBuilderForType()
```
...
```
protected Job.ProcessingOptions.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public Job.ProcessingOptions.Builder toBuilder()
```
