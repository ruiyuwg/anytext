...
-   [0.14.0 (latest)](/ruby/docs/reference/google-cloud-network_security-v1beta1/latest)
-   [0.13.1](/ruby/docs/reference/google-cloud-network_security-v1beta1/0.13.1)
-   [0.12.0](/ruby/docs/reference/google-cloud-network_security-v1beta1/0.12.0)
-   [0.11.0](/ruby/docs/reference/google-cloud-network_security-v1beta1/0.11.0)
-   [0.10.1](/ruby/docs/reference/google-cloud-network_security-v1beta1/0.10.1)
-   [0.9.0](/ruby/docs/reference/google-cloud-network_security-v1beta1/0.9.0)
-   [0.8.1](/ruby/docs/reference/google-cloud-network_security-v1beta1/0.8.1)
-   [0.7.2](/ruby/docs/reference/google-cloud-network_security-v1beta1/0.7.2)
-   [0.6.0](/ruby/docs/reference/google-cloud-network_security-v1beta1/0.6.0)
-   [0.5.1](/ruby/docs/reference/google-cloud-network_security-v1beta1/0.5.1)
-   [0.4.0](/ruby/docs/reference/google-cloud-network_security-v1beta1/0.4.0)
-   [0.3.0](/ruby/docs/reference/google-cloud-network_security-v1beta1/0.3.0)
-   [0.2.0](/ruby/docs/reference/google-cloud-network_security-v1beta1/0.2.0)
-   [0.1.2](/ruby/docs/reference/google-cloud-network_security-v1beta1/0.1.2)
...
This gem is a _versioned_ client. It provides basic client classes for a specific version of the Network Security V1beta1 API. Most users should consider using the main client gem, [google-cloud-network\_security](https://rubygems.org/gems/google-cloud-network_security). See the section below titled _Which client should I use?_ for more information.
...
3.  [Enable the API.](https://console.cloud.google.com/apis/library/networksecurity.googleapis.com)
4.  [Set up authentication.](https://docs.cloud.google.com/ruby/docs/reference/google-cloud-network_security-v1beta1/latest/AUTHENTICATION "Set up authentication.")

## Quick Start

require "google/cloud/network\_security/v1beta1"
...
response \= client.list\_dns\_threat\_detectors request

View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-network_security-v1beta1/latest) for class and method documentation.

See also the [Product Documentation](https://cloud.google.com/traffic-director/docs/reference/network-security/rest/) for general usage information.
...
Most modern Ruby client libraries for Google APIs come in two flavors: the main client library with a name such as `google-cloud-network_security`, and lower-level _versioned_ client libraries with names such as `google-cloud-network_security-v1beta1`. _In most cases, you should install the main client._
