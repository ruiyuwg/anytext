...
# Class TextDetectionParams (3.26.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class TextDetectionParams extends GeneratedMessageV3 implements TextDetectionParamsOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> TextDetectionParams

## Implements

[TextDetectionParamsOrBuilder](/java/docs/reference/google-cloud-vision/3.26.0/com.google.cloud.vision.v1p2beta1.TextDetectionParamsOrBuilder)
...
### ADVANCED\_OCR\_OPTIONS\_FIELD\_NUMBER
...
### ENABLE\_TEXT\_DETECTION\_CONFIDENCE\_SCORE\_FIELD\_NUMBER
...
`[TextDetectionParams](/java/docs/reference/google-cloud-vision/3.26.0/com.google.cloud.vision.v1p2beta1.TextDetectionParams)`
...
`[TextDetectionParams.Builder](/java/docs/reference/google-cloud-vision/3.26.0/com.google.cloud.vision.v1p2beta1.TextDetectionParams.Builder)`
...
```
public static TextDetectionParams parseDelimitedFrom(InputStream input)
```
...
```
public static TextDetectionParams parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static TextDetectionParams parseFrom(byte[] data)
```
...
```
public static TextDetectionParams parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static TextDetectionParams parseFrom(ByteString data)
```
...
```
public static TextDetectionParams parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static TextDetectionParams parseFrom(CodedInputStream input)
```
...
```
public static TextDetectionParams parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static TextDetectionParams parseFrom(InputStream input)
```
...
```
public static TextDetectionParams parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static TextDetectionParams parseFrom(ByteBuffer data)
```
...
```
public static TextDetectionParams parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<TextDetectionParams> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[TextDetectionParams](/java/docs/reference/google-cloud-vision/3.26.0/com.google.cloud.vision.v1p2beta1.TextDetectionParams)>`
...
By default, Cloud Vision API only includes confidence score for DOCUMENT\_TEXT\_DETECTION result. Set the flag to true to include confidence score for TEXT\_DETECTION as well.
...
```
public Parser<TextDetectionParams> getParserForType()
```
...
```
protected TextDetectionParams.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
