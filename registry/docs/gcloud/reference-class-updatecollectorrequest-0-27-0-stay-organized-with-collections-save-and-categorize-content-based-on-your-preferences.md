...
# Class UpdateCollectorRequest (0.27.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class UpdateCollectorRequest extends GeneratedMessageV3 implements UpdateCollectorRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> UpdateCollectorRequest

## Implements

[UpdateCollectorRequestOrBuilder](/java/docs/reference/google-cloud-rapidmigrationassessment/0.27.0/com.google.cloud.rapidmigrationassessment.v1.UpdateCollectorRequestOrBuilder)
...
```
public static UpdateCollectorRequest getDefaultInstance()
```
...
`[UpdateCollectorRequest](/java/docs/reference/google-cloud-rapidmigrationassessment/0.27.0/com.google.cloud.rapidmigrationassessment.v1.UpdateCollectorRequest)`
...
```
public static UpdateCollectorRequest.Builder newBuilder()
```
...
`[UpdateCollectorRequest.Builder](/java/docs/reference/google-cloud-rapidmigrationassessment/0.27.0/com.google.cloud.rapidmigrationassessment.v1.UpdateCollectorRequest.Builder)`

### newBuilder(UpdateCollectorRequest prototype)

```
public static UpdateCollectorRequest.Builder newBuilder(UpdateCollectorRequest prototype)
```
...
```
public static UpdateCollectorRequest parseDelimitedFrom(InputStream input)
```
...
```
public static UpdateCollectorRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateCollectorRequest parseFrom(byte[] data)
```
...
```
public static UpdateCollectorRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateCollectorRequest parseFrom(ByteString data)
```
...
```
public static UpdateCollectorRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateCollectorRequest parseFrom(CodedInputStream input)
```
...
```
public static UpdateCollectorRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateCollectorRequest parseFrom(InputStream input)
```
...
```
public static UpdateCollectorRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateCollectorRequest parseFrom(ByteBuffer data)
```
...
```
public static UpdateCollectorRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<UpdateCollectorRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[UpdateCollectorRequest](/java/docs/reference/google-cloud-rapidmigrationassessment/0.27.0/com.google.cloud.rapidmigrationassessment.v1.UpdateCollectorRequest)>`
...
`[Collector](/java/docs/reference/google-cloud-rapidmigrationassessment/0.27.0/com.google.cloud.rapidmigrationassessment.v1.Collector)`
...
`[CollectorOrBuilder](/java/docs/reference/google-cloud-rapidmigrationassessment/0.27.0/com.google.cloud.rapidmigrationassessment.v1.CollectorOrBuilder)`
...
```
public Parser<UpdateCollectorRequest> getParserForType()
```
...
```
public UpdateCollectorRequest.Builder newBuilderForType()
```
...
```
protected UpdateCollectorRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public UpdateCollectorRequest.Builder toBuilder()
```
