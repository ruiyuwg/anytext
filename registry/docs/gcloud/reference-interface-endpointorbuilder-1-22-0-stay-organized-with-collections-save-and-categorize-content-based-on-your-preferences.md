...
# Interface EndpointOrBuilder (1.22.0) Stay organized with collections Save and categorize content based on your preferences.
...
Use [#getLabelsMap()](/java/docs/reference/google-cloud-ids/1.22.0/com.google.cloud.ids.v1.EndpointOrBuilder#com_google_cloud_ids_v1_EndpointOrBuilder_getLabelsMap__) instead.
...
`[Endpoint.Severity](/java/docs/reference/google-cloud-ids/1.22.0/com.google.cloud.ids.v1.Endpoint.Severity)`
...
`[Endpoint.State](/java/docs/reference/google-cloud-ids/1.22.0/com.google.cloud.ids.v1.Endpoint.State)`
