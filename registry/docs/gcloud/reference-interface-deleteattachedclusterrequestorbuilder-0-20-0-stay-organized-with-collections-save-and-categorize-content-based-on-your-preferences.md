...
# Interface DeleteAttachedClusterRequestOrBuilder (0.20.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface DeleteAttachedClusterRequestOrBuilder extends MessageOrBuilder
```
...
```
public abstract boolean getIgnoreErrors()
```
