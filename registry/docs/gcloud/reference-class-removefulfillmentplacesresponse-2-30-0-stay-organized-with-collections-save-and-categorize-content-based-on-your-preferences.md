...
# Class RemoveFulfillmentPlacesResponse (2.30.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class RemoveFulfillmentPlacesResponse extends GeneratedMessageV3 implements RemoveFulfillmentPlacesResponseOrBuilder
```
...
Protobuf type `google.cloud.retail.v2alpha.RemoveFulfillmentPlacesResponse`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> RemoveFulfillmentPlacesResponse

## Implements

[RemoveFulfillmentPlacesResponseOrBuilder](/java/docs/reference/google-cloud-retail/2.30.0/com.google.cloud.retail.v2alpha.RemoveFulfillmentPlacesResponseOrBuilder)
...
```
public static RemoveFulfillmentPlacesResponse getDefaultInstance()
```
...
`[RemoveFulfillmentPlacesResponse](/java/docs/reference/google-cloud-retail/2.30.0/com.google.cloud.retail.v2alpha.RemoveFulfillmentPlacesResponse)`
...
```
public static RemoveFulfillmentPlacesResponse.Builder newBuilder()
```
...
`[RemoveFulfillmentPlacesResponse.Builder](/java/docs/reference/google-cloud-retail/2.30.0/com.google.cloud.retail.v2alpha.RemoveFulfillmentPlacesResponse.Builder)`

### newBuilder(RemoveFulfillmentPlacesResponse prototype)

```
public static RemoveFulfillmentPlacesResponse.Builder newBuilder(RemoveFulfillmentPlacesResponse prototype)
```
...
```
public static RemoveFulfillmentPlacesResponse parseDelimitedFrom(InputStream input)
```
...
```
public static RemoveFulfillmentPlacesResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RemoveFulfillmentPlacesResponse parseFrom(byte[] data)
```
...
```
public static RemoveFulfillmentPlacesResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RemoveFulfillmentPlacesResponse parseFrom(ByteString data)
```
...
```
public static RemoveFulfillmentPlacesResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RemoveFulfillmentPlacesResponse parseFrom(CodedInputStream input)
```
...
```
public static RemoveFulfillmentPlacesResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RemoveFulfillmentPlacesResponse parseFrom(InputStream input)
```
...
```
public static RemoveFulfillmentPlacesResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RemoveFulfillmentPlacesResponse parseFrom(ByteBuffer data)
```
...
```
public static RemoveFulfillmentPlacesResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<RemoveFulfillmentPlacesResponse> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[RemoveFulfillmentPlacesResponse](/java/docs/reference/google-cloud-retail/2.30.0/com.google.cloud.retail.v2alpha.RemoveFulfillmentPlacesResponse)>`
...
```
public RemoveFulfillmentPlacesResponse getDefaultInstanceForType()
```
...
```
public Parser<RemoveFulfillmentPlacesResponse> getParserForType()
```
...
```
public RemoveFulfillmentPlacesResponse.Builder newBuilderForType()
```
...
```
protected RemoveFulfillmentPlacesResponse.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public RemoveFulfillmentPlacesResponse.Builder toBuilder()
```
