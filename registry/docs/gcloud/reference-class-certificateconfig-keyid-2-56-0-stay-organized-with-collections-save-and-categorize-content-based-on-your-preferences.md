...
# Class CertificateConfig.KeyId (2.56.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class CertificateConfig.KeyId extends GeneratedMessageV3 implements CertificateConfig.KeyIdOrBuilder
```

A KeyId identifies a specific public key, usually by hashing the public key.

Protobuf type `google.cloud.security.privateca.v1.CertificateConfig.KeyId`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> CertificateConfig.KeyId

## Implements

[CertificateConfig.KeyIdOrBuilder](/java/docs/reference/google-cloud-security-private-ca/2.56.0/com.google.cloud.security.privateca.v1.CertificateConfig.KeyIdOrBuilder)
...
```
public static CertificateConfig.KeyId getDefaultInstance()
```
...
`[CertificateConfig.KeyId](/java/docs/reference/google-cloud-security-private-ca/2.56.0/com.google.cloud.security.privateca.v1.CertificateConfig.KeyId)`
...
```
public static CertificateConfig.KeyId.Builder newBuilder()
```
...
`[CertificateConfig.KeyId.Builder](/java/docs/reference/google-cloud-security-private-ca/2.56.0/com.google.cloud.security.privateca.v1.CertificateConfig.KeyId.Builder)`

### newBuilder(CertificateConfig.KeyId prototype)

```
public static CertificateConfig.KeyId.Builder newBuilder(CertificateConfig.KeyId prototype)
```
...
```
public static CertificateConfig.KeyId parseDelimitedFrom(InputStream input)
```
...
```
public static CertificateConfig.KeyId parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CertificateConfig.KeyId parseFrom(byte[] data)
```
...
```
public static CertificateConfig.KeyId parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CertificateConfig.KeyId parseFrom(ByteString data)
```
...
```
public static CertificateConfig.KeyId parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CertificateConfig.KeyId parseFrom(CodedInputStream input)
```
...
```
public static CertificateConfig.KeyId parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CertificateConfig.KeyId parseFrom(InputStream input)
```
...
```
public static CertificateConfig.KeyId parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CertificateConfig.KeyId parseFrom(ByteBuffer data)
```
...
```
public static CertificateConfig.KeyId parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<CertificateConfig.KeyId> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[KeyId](/java/docs/reference/google-cloud-security-private-ca/2.56.0/com.google.cloud.security.privateca.v1.CertificateConfig.KeyId)>`
...
```
public CertificateConfig.KeyId getDefaultInstanceForType()
```
...
```
public Parser<CertificateConfig.KeyId> getParserForType()
```
...
```
public CertificateConfig.KeyId.Builder newBuilderForType()
```
...
```
protected CertificateConfig.KeyId.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public CertificateConfig.KeyId.Builder toBuilder()
```
