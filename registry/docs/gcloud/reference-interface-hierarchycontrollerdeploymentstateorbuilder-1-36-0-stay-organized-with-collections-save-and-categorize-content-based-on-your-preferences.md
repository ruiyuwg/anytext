...
# Interface HierarchyControllerDeploymentStateOrBuilder (1.36.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[DeploymentState](/java/docs/reference/google-cloud-gkehub/1.36.0/com.google.cloud.gkehub.configmanagement.v1alpha.DeploymentState)`
