...
# Class SecurityPostureClient.ListPostureTemplatesPage (0.23.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class SecurityPostureClient.ListPostureTemplatesPage extends AbstractPage<ListPostureTemplatesRequest,ListPostureTemplatesResponse,PostureTemplate,SecurityPostureClient.ListPostureTemplatesPage>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractPage](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractPage.html) \> SecurityPostureClient.ListPostureTemplatesPage
...
### createPage(PageContext<ListPostureTemplatesRequest,ListPostureTemplatesResponse,PostureTemplate> context, ListPostureTemplatesResponse response)

```
protected SecurityPostureClient.ListPostureTemplatesPage createPage(PageContext<ListPostureTemplatesRequest,ListPostureTemplatesResponse,PostureTemplate> context, ListPostureTemplatesResponse response)
```
...
`[PageContext](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PageContext.html)<[ListPostureTemplatesRequest](/java/docs/reference/google-cloud-securityposture/0.23.0/com.google.cloud.securityposture.v1.ListPostureTemplatesRequest),[ListPostureTemplatesResponse](/java/docs/reference/google-cloud-securityposture/0.23.0/com.google.cloud.securityposture.v1.ListPostureTemplatesResponse),[PostureTemplate](/java/docs/reference/google-cloud-securityposture/0.23.0/com.google.cloud.securityposture.v1.PostureTemplate)>`  

`response`

`[ListPostureTemplatesResponse](/java/docs/reference/google-cloud-securityposture/0.23.0/com.google.cloud.securityposture.v1.ListPostureTemplatesResponse)`  
...
`[SecurityPostureClient.ListPostureTemplatesPage](/java/docs/reference/google-cloud-securityposture/0.23.0/com.google.cloud.securityposture.v1.SecurityPostureClient.ListPostureTemplatesPage)`
...
### createPageAsync(PageContext<ListPostureTemplatesRequest,ListPostureTemplatesResponse,PostureTemplate> context, ApiFuture<ListPostureTemplatesResponse> futureResponse)

```
public ApiFuture<SecurityPostureClient.ListPostureTemplatesPage> createPageAsync(PageContext<ListPostureTemplatesRequest,ListPostureTemplatesResponse,PostureTemplate> context, ApiFuture<ListPostureTemplatesResponse> futureResponse)
```
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListPostureTemplatesResponse](/java/docs/reference/google-cloud-securityposture/0.23.0/com.google.cloud.securityposture.v1.ListPostureTemplatesResponse)>`  
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListPostureTemplatesPage](/java/docs/reference/google-cloud-securityposture/0.23.0/com.google.cloud.securityposture.v1.SecurityPostureClient.ListPostureTemplatesPage)>`
