...
# Class Attempt.Builder (2.56.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class Attempt.Builder extends GeneratedMessageV3.Builder<Attempt.Builder> implements AttemptOrBuilder
```

The status of a task attempt.

Protobuf type `google.cloud.tasks.v2beta3.Attempt`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> Attempt.Builder

## Implements

[AttemptOrBuilder](/java/docs/reference/google-cloud-tasks/2.56.0/com.google.cloud.tasks.v2beta3.AttemptOrBuilder)
...
```
public Attempt.Builder addRepeatedField(Descriptors.FieldDescriptor field, Object value)
```
...
`[Attempt.Builder](/java/docs/reference/google-cloud-tasks/2.56.0/com.google.cloud.tasks.v2beta3.Attempt.Builder)`
...
`[Attempt](/java/docs/reference/google-cloud-tasks/2.56.0/com.google.cloud.tasks.v2beta3.Attempt)`
...
```
public Attempt.Builder clearField(Descriptors.FieldDescriptor field)
```
...
```
public Attempt.Builder clearOneof(Descriptors.OneofDescriptor oneof)
```
...
```
public final Attempt.Builder mergeUnknownFields(UnknownFieldSet unknownFields)
```
...
```
public Attempt.Builder setField(Descriptors.FieldDescriptor field, Object value)
```
...
```
public Attempt.Builder setRepeatedField(Descriptors.FieldDescriptor field, int index, Object value)
```
...
```
public final Attempt.Builder setUnknownFields(UnknownFieldSet unknownFields)
```
