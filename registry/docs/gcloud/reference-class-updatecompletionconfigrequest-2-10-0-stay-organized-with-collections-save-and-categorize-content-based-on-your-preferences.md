...
# Class UpdateCompletionConfigRequest (2.10.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class UpdateCompletionConfigRequest extends GeneratedMessageV3 implements UpdateCompletionConfigRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> UpdateCompletionConfigRequest

## Implements

[UpdateCompletionConfigRequestOrBuilder](/java/docs/reference/google-cloud-retail/2.10.0/com.google.cloud.retail.v2.UpdateCompletionConfigRequestOrBuilder)
...
### COMPLETION\_CONFIG\_FIELD\_NUMBER
...
```
public static UpdateCompletionConfigRequest getDefaultInstance()
```
...
[UpdateCompletionConfigRequest](/java/docs/reference/google-cloud-retail/2.10.0/com.google.cloud.retail.v2.UpdateCompletionConfigRequest)
...
```
public static UpdateCompletionConfigRequest.Builder newBuilder()
```
...
[UpdateCompletionConfigRequest.Builder](/java/docs/reference/google-cloud-retail/2.10.0/com.google.cloud.retail.v2.UpdateCompletionConfigRequest.Builder)

### newBuilder(UpdateCompletionConfigRequest prototype)

```
public static UpdateCompletionConfigRequest.Builder newBuilder(UpdateCompletionConfigRequest prototype)
```
...
```
public static UpdateCompletionConfigRequest parseDelimitedFrom(InputStream input)
```
...
```
public static UpdateCompletionConfigRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateCompletionConfigRequest parseFrom(byte[] data)
```
...
```
public static UpdateCompletionConfigRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateCompletionConfigRequest parseFrom(ByteString data)
```
...
```
public static UpdateCompletionConfigRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateCompletionConfigRequest parseFrom(CodedInputStream input)
```
...
```
public static UpdateCompletionConfigRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateCompletionConfigRequest parseFrom(InputStream input)
```
...
```
public static UpdateCompletionConfigRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateCompletionConfigRequest parseFrom(ByteBuffer data)
```
...
```
public static UpdateCompletionConfigRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<UpdateCompletionConfigRequest> parser()
```
...
[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[UpdateCompletionConfigRequest](/java/docs/reference/google-cloud-retail/2.10.0/com.google.cloud.retail.v2.UpdateCompletionConfigRequest)\>
...
Required. The CompletionConfig to update. If the caller does not have permission to update the CompletionConfig, then a PERMISSION\_DENIED error is returned. If the CompletionConfig to update does not exist, a NOT\_FOUND error is returned.
...
[CompletionConfig](/java/docs/reference/google-cloud-retail/2.10.0/com.google.cloud.retail.v2.CompletionConfig)
...
[CompletionConfigOrBuilder](/java/docs/reference/google-cloud-retail/2.10.0/com.google.cloud.retail.v2.CompletionConfigOrBuilder)
...
```
public Parser<UpdateCompletionConfigRequest> getParserForType()
```
...
-   CompletionConfig.matching\_order
-   CompletionConfig.max\_suggestions
-   CompletionConfig.min\_prefix\_length
-   CompletionConfig.auto\_learning If not set, all supported fields are updated.
...
```
public UpdateCompletionConfigRequest.Builder newBuilderForType()
```
...
```
protected UpdateCompletionConfigRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public UpdateCompletionConfigRequest.Builder toBuilder()
```
