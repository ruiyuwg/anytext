...
# Class EventServiceSettings (2.30.0) Stay organized with collections Save and categorize content based on your preferences.
...
Settings class to configure an instance of [EventServiceClient](/java/docs/reference/google-cloud-talent/2.30.0/com.google.cloud.talent.v4beta1.EventServiceClient).
...
`[EventServiceStubSettings](/java/docs/reference/google-cloud-talent/2.30.0/com.google.cloud.talent.v4beta1.stub.EventServiceStubSettings)`  
...
`[EventServiceSettings](/java/docs/reference/google-cloud-talent/2.30.0/com.google.cloud.talent.v4beta1.EventServiceSettings)`
...
`[EventServiceSettings.Builder](/java/docs/reference/google-cloud-talent/2.30.0/com.google.cloud.talent.v4beta1.EventServiceSettings.Builder)`
...
`[UnaryCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.html)<[CreateClientEventRequest](/java/docs/reference/google-cloud-talent/2.30.0/com.google.cloud.talent.v4beta1.CreateClientEventRequest),[ClientEvent](/java/docs/reference/google-cloud-talent/2.30.0/com.google.cloud.talent.v4beta1.ClientEvent)>`
