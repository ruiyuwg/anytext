...
# Class PatchJobs.WindowsUpdateSettings (2.25.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> PatchJobs.WindowsUpdateSettings

## Implements

[PatchJobs.WindowsUpdateSettingsOrBuilder](/java/docs/reference/google-cloud-os-config/2.25.0/com.google.cloud.osconfig.v1.PatchJobs.WindowsUpdateSettingsOrBuilder)
...
### CLASSIFICATIONS\_FIELD\_NUMBER
...
### EXCLUSIVE\_PATCHES\_FIELD\_NUMBER
...
`[PatchJobs.WindowsUpdateSettings](/java/docs/reference/google-cloud-os-config/2.25.0/com.google.cloud.osconfig.v1.PatchJobs.WindowsUpdateSettings)`
...
`[PatchJobs.WindowsUpdateSettings.Builder](/java/docs/reference/google-cloud-os-config/2.25.0/com.google.cloud.osconfig.v1.PatchJobs.WindowsUpdateSettings.Builder)`
...
```
public static PatchJobs.WindowsUpdateSettings parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PatchJobs.WindowsUpdateSettings parseFrom(ByteString data)
```
...
```
public static PatchJobs.WindowsUpdateSettings parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PatchJobs.WindowsUpdateSettings parseFrom(CodedInputStream input)
```
...
```
public static PatchJobs.WindowsUpdateSettings parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PatchJobs.WindowsUpdateSettings parseFrom(InputStream input)
```
...
```
public static PatchJobs.WindowsUpdateSettings parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PatchJobs.WindowsUpdateSettings parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<PatchJobs.WindowsUpdateSettings> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[WindowsUpdateSettings](/java/docs/reference/google-cloud-os-config/2.25.0/com.google.cloud.osconfig.v1.PatchJobs.WindowsUpdateSettings)>`
...
`[PatchJobs.WindowsUpdateSettings.Classification](/java/docs/reference/google-cloud-os-config/2.25.0/com.google.cloud.osconfig.v1.PatchJobs.WindowsUpdateSettings.Classification)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Classification](/java/docs/reference/google-cloud-os-config/2.25.0/com.google.cloud.osconfig.v1.PatchJobs.WindowsUpdateSettings.Classification)>`
...
```
public Parser<PatchJobs.WindowsUpdateSettings> getParserForType()
```
...
```
protected PatchJobs.WindowsUpdateSettings.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
