...
# Class ListPoliciesResponse (1.44.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListPoliciesResponse

## Implements

[ListPoliciesResponseOrBuilder](/java/docs/reference/google-iam-policy/1.44.0/com.google.iam.v2.ListPoliciesResponseOrBuilder)
...
`[ListPoliciesResponse](/java/docs/reference/google-iam-policy/1.44.0/com.google.iam.v2.ListPoliciesResponse)`
...
`[Builder](/java/docs/reference/google-iam-policy/1.44.0/com.google.iam.v2.ListPoliciesResponse.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListPoliciesResponse](/java/docs/reference/google-iam-policy/1.44.0/com.google.iam.v2.ListPoliciesResponse)>`
...
`[Policy](/java/docs/reference/google-iam-policy/1.44.0/com.google.iam.v2.Policy)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Policy](/java/docs/reference/google-iam-policy/1.44.0/com.google.iam.v2.Policy)>`
...
`[PolicyOrBuilder](/java/docs/reference/google-iam-policy/1.44.0/com.google.iam.v2.PolicyOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.iam.v2.PolicyOrBuilder>`
