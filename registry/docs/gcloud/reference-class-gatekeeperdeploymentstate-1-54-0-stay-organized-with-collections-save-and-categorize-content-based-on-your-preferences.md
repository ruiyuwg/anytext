...
# Class GatekeeperDeploymentState (1.54.0) Stay organized with collections Save and categorize content based on your preferences.
...
[GatekeeperDeploymentStateOrBuilder](/java/docs/reference/google-cloud-gkehub/1.54.0/com.google.cloud.gkehub.configmanagement.v1.GatekeeperDeploymentStateOrBuilder)
...
`[GatekeeperDeploymentState](/java/docs/reference/google-cloud-gkehub/1.54.0/com.google.cloud.gkehub.configmanagement.v1.GatekeeperDeploymentState)`
...
`[GatekeeperDeploymentState.Builder](/java/docs/reference/google-cloud-gkehub/1.54.0/com.google.cloud.gkehub.configmanagement.v1.GatekeeperDeploymentState.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[GatekeeperDeploymentState](/java/docs/reference/google-cloud-gkehub/1.54.0/com.google.cloud.gkehub.configmanagement.v1.GatekeeperDeploymentState)>`
...
`[DeploymentState](/java/docs/reference/google-cloud-gkehub/1.54.0/com.google.cloud.gkehub.configmanagement.v1.DeploymentState)`
