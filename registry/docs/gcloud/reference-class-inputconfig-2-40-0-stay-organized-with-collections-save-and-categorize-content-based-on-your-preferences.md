...
# Class InputConfig (2.40.0) Stay organized with collections Save and categorize content based on your preferences.
...
Protobuf type `google.cloud.redis.v1.InputConfig`
...
[InputConfigOrBuilder](/java/docs/reference/google-cloud-redis/2.40.0/com.google.cloud.redis.v1.InputConfigOrBuilder)
...
`[InputConfig](/java/docs/reference/google-cloud-redis/2.40.0/com.google.cloud.redis.v1.InputConfig)`
...
`[InputConfig.Builder](/java/docs/reference/google-cloud-redis/2.40.0/com.google.cloud.redis.v1.InputConfig.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[InputConfig](/java/docs/reference/google-cloud-redis/2.40.0/com.google.cloud.redis.v1.InputConfig)>`
...
`.google.cloud.redis.v1.GcsSource gcs_source = 1;`
...
`[GcsSource](/java/docs/reference/google-cloud-redis/2.40.0/com.google.cloud.redis.v1.GcsSource)`
...
`[GcsSourceOrBuilder](/java/docs/reference/google-cloud-redis/2.40.0/com.google.cloud.redis.v1.GcsSourceOrBuilder)`
...
`[InputConfig.SourceCase](/java/docs/reference/google-cloud-redis/2.40.0/com.google.cloud.redis.v1.InputConfig.SourceCase)`
