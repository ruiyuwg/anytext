...
# Class ListReportDetailsResponse (0.16.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListReportDetailsResponse extends GeneratedMessageV3 implements ListReportDetailsResponseOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListReportDetailsResponse

## Implements

[ListReportDetailsResponseOrBuilder](/java/docs/reference/google-cloud-storageinsights/0.16.0/com.google.cloud.storageinsights.v1.ListReportDetailsResponseOrBuilder)
...
### REPORT\_DETAILS\_FIELD\_NUMBER

```
public static final int REPORT_DETAILS_FIELD_NUMBER
```
...
```
public static ListReportDetailsResponse getDefaultInstance()
```
...
`[ListReportDetailsResponse](/java/docs/reference/google-cloud-storageinsights/0.16.0/com.google.cloud.storageinsights.v1.ListReportDetailsResponse)`
...
```
public static ListReportDetailsResponse.Builder newBuilder()
```
...
`[ListReportDetailsResponse.Builder](/java/docs/reference/google-cloud-storageinsights/0.16.0/com.google.cloud.storageinsights.v1.ListReportDetailsResponse.Builder)`

### newBuilder(ListReportDetailsResponse prototype)

```
public static ListReportDetailsResponse.Builder newBuilder(ListReportDetailsResponse prototype)
```
...
```
public static ListReportDetailsResponse parseDelimitedFrom(InputStream input)
```
...
```
public static ListReportDetailsResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListReportDetailsResponse parseFrom(byte[] data)
```
...
```
public static ListReportDetailsResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListReportDetailsResponse parseFrom(ByteString data)
```
...
```
public static ListReportDetailsResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListReportDetailsResponse parseFrom(CodedInputStream input)
```
...
```
public static ListReportDetailsResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListReportDetailsResponse parseFrom(InputStream input)
```
...
```
public static ListReportDetailsResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListReportDetailsResponse parseFrom(ByteBuffer data)
```
...
```
public static ListReportDetailsResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ListReportDetailsResponse> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListReportDetailsResponse](/java/docs/reference/google-cloud-storageinsights/0.16.0/com.google.cloud.storageinsights.v1.ListReportDetailsResponse)>`
...
```
public Parser<ListReportDetailsResponse> getParserForType()
```
...
`[ReportDetail](/java/docs/reference/google-cloud-storageinsights/0.16.0/com.google.cloud.storageinsights.v1.ReportDetail)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ReportDetail](/java/docs/reference/google-cloud-storageinsights/0.16.0/com.google.cloud.storageinsights.v1.ReportDetail)>`
...
`[ReportDetailOrBuilder](/java/docs/reference/google-cloud-storageinsights/0.16.0/com.google.cloud.storageinsights.v1.ReportDetailOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.storageinsights.v1.ReportDetailOrBuilder>`
...
```
public ListReportDetailsResponse.Builder newBuilderForType()
```
...
```
protected ListReportDetailsResponse.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ListReportDetailsResponse.Builder toBuilder()
```
