...
# Class Endpoint (1.12.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> Endpoint

## Implements

[EndpointOrBuilder](/java/docs/reference/google-cloud-network-management/1.12.0/com.google.cloud.networkmanagement.v1beta1.EndpointOrBuilder)
...
### GKE\_MASTER\_CLUSTER\_FIELD\_NUMBER
...
`[Endpoint](/java/docs/reference/google-cloud-network-management/1.12.0/com.google.cloud.networkmanagement.v1beta1.Endpoint)`
...
`[Endpoint.Builder](/java/docs/reference/google-cloud-network-management/1.12.0/com.google.cloud.networkmanagement.v1beta1.Endpoint.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[Endpoint](/java/docs/reference/google-cloud-network-management/1.12.0/com.google.cloud.networkmanagement.v1beta1.Endpoint)>`
...
`[Endpoint.CloudFunctionEndpoint](/java/docs/reference/google-cloud-network-management/1.12.0/com.google.cloud.networkmanagement.v1beta1.Endpoint.CloudFunctionEndpoint)`
...
`[Endpoint.CloudFunctionEndpointOrBuilder](/java/docs/reference/google-cloud-network-management/1.12.0/com.google.cloud.networkmanagement.v1beta1.Endpoint.CloudFunctionEndpointOrBuilder)`
...
`[Endpoint.NetworkType](/java/docs/reference/google-cloud-network-management/1.12.0/com.google.cloud.networkmanagement.v1beta1.Endpoint.NetworkType)`
