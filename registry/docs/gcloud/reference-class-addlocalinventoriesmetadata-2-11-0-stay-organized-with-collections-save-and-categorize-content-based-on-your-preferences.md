...
# Class AddLocalInventoriesMetadata (2.11.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class AddLocalInventoriesMetadata extends GeneratedMessageV3 implements AddLocalInventoriesMetadataOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> AddLocalInventoriesMetadata

## Implements

[AddLocalInventoriesMetadataOrBuilder](/java/docs/reference/google-cloud-retail/2.11.0/com.google.cloud.retail.v2beta.AddLocalInventoriesMetadataOrBuilder)
...
```
public static AddLocalInventoriesMetadata getDefaultInstance()
```
...
`[AddLocalInventoriesMetadata](/java/docs/reference/google-cloud-retail/2.11.0/com.google.cloud.retail.v2beta.AddLocalInventoriesMetadata)`
...
```
public static AddLocalInventoriesMetadata.Builder newBuilder()
```
...
`[AddLocalInventoriesMetadata.Builder](/java/docs/reference/google-cloud-retail/2.11.0/com.google.cloud.retail.v2beta.AddLocalInventoriesMetadata.Builder)`

### newBuilder(AddLocalInventoriesMetadata prototype)

```
public static AddLocalInventoriesMetadata.Builder newBuilder(AddLocalInventoriesMetadata prototype)
```
...
```
public static AddLocalInventoriesMetadata parseDelimitedFrom(InputStream input)
```
...
```
public static AddLocalInventoriesMetadata parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AddLocalInventoriesMetadata parseFrom(byte[] data)
```
...
```
public static AddLocalInventoriesMetadata parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AddLocalInventoriesMetadata parseFrom(ByteString data)
```
...
```
public static AddLocalInventoriesMetadata parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AddLocalInventoriesMetadata parseFrom(CodedInputStream input)
```
...
```
public static AddLocalInventoriesMetadata parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AddLocalInventoriesMetadata parseFrom(InputStream input)
```
...
```
public static AddLocalInventoriesMetadata parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AddLocalInventoriesMetadata parseFrom(ByteBuffer data)
```
...
```
public static AddLocalInventoriesMetadata parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<AddLocalInventoriesMetadata> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[AddLocalInventoriesMetadata](/java/docs/reference/google-cloud-retail/2.11.0/com.google.cloud.retail.v2beta.AddLocalInventoriesMetadata)>`
...
```
public AddLocalInventoriesMetadata getDefaultInstanceForType()
```
...
```
public Parser<AddLocalInventoriesMetadata> getParserForType()
```
...
```
public AddLocalInventoriesMetadata.Builder newBuilderForType()
```
...
```
protected AddLocalInventoriesMetadata.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public AddLocalInventoriesMetadata.Builder toBuilder()
```
