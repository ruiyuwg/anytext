...
# Class DeleteSecretRequest (2.45.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class DeleteSecretRequest extends GeneratedMessageV3 implements DeleteSecretRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> DeleteSecretRequest

## Implements

[DeleteSecretRequestOrBuilder](/java/docs/reference/google-cloud-secretmanager/2.45.0/com.google.cloud.secretmanager.v1beta2.DeleteSecretRequestOrBuilder)
...
`[DeleteSecretRequest](/java/docs/reference/google-cloud-secretmanager/2.45.0/com.google.cloud.secretmanager.v1beta2.DeleteSecretRequest)`
...
```
public static DeleteSecretRequest.Builder newBuilder()
```
...
`[DeleteSecretRequest.Builder](/java/docs/reference/google-cloud-secretmanager/2.45.0/com.google.cloud.secretmanager.v1beta2.DeleteSecretRequest.Builder)`

### newBuilder(DeleteSecretRequest prototype)

```
public static DeleteSecretRequest.Builder newBuilder(DeleteSecretRequest prototype)
```
...
```
public static DeleteSecretRequest parseDelimitedFrom(InputStream input)
```
...
```
public static DeleteSecretRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteSecretRequest parseFrom(byte[] data)
```
...
```
public static DeleteSecretRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteSecretRequest parseFrom(ByteString data)
```
...
```
public static DeleteSecretRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteSecretRequest parseFrom(CodedInputStream input)
```
...
```
public static DeleteSecretRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteSecretRequest parseFrom(InputStream input)
```
...
```
public static DeleteSecretRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteSecretRequest parseFrom(ByteBuffer data)
```
...
```
public static DeleteSecretRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[DeleteSecretRequest](/java/docs/reference/google-cloud-secretmanager/2.45.0/com.google.cloud.secretmanager.v1beta2.DeleteSecretRequest)>`
...
```
public DeleteSecretRequest.Builder newBuilderForType()
```
...
```
protected DeleteSecretRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
