...
# Class HttpRequest (1.29.0) Stay organized with collections Save and categorize content based on your preferences.
...
[HttpRequestOrBuilder](/java/docs/reference/google-cloud-service-control/1.29.0/com.google.api.servicecontrol.v1.HttpRequestOrBuilder)
...
### CACHE\_FILL\_BYTES\_FIELD\_NUMBER
...
### CACHE\_VALIDATED\_WITH\_ORIGIN\_SERVER\_FIELD\_NUMBER
...
### REQUEST\_METHOD\_FIELD\_NUMBER
...
`[HttpRequest](/java/docs/reference/google-cloud-service-control/1.29.0/com.google.api.servicecontrol.v1.HttpRequest)`
...
`[HttpRequest.Builder](/java/docs/reference/google-cloud-service-control/1.29.0/com.google.api.servicecontrol.v1.HttpRequest.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[HttpRequest](/java/docs/reference/google-cloud-service-control/1.29.0/com.google.api.servicecontrol.v1.HttpRequest)>`
...
The scheme (http, https), the host name, the path, and the query portion of the URL that was requested. Example: `"[http://example.com/some/info?color=red](http://example.com/some/info?color=red)"`.
