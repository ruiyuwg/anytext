...
# Interface RecognizeResponseOrBuilder (4.14.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[SpeechRecognitionResult](/java/docs/reference/google-cloud-speech/4.14.0/com.google.cloud.speech.v1.SpeechRecognitionResult)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[SpeechRecognitionResult](/java/docs/reference/google-cloud-speech/4.14.0/com.google.cloud.speech.v1.SpeechRecognitionResult)>`
...
`[SpeechRecognitionResultOrBuilder](/java/docs/reference/google-cloud-speech/4.14.0/com.google.cloud.speech.v1.SpeechRecognitionResultOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.speech.v1.SpeechRecognitionResultOrBuilder>`
...
`[SpeechAdaptationInfo](/java/docs/reference/google-cloud-speech/4.14.0/com.google.cloud.speech.v1.SpeechAdaptationInfo)`
...
`[SpeechAdaptationInfoOrBuilder](/java/docs/reference/google-cloud-speech/4.14.0/com.google.cloud.speech.v1.SpeechAdaptationInfoOrBuilder)`
