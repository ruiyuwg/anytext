...
# Class InstanceAuthString (2.21.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class InstanceAuthString extends GeneratedMessageV3 implements InstanceAuthStringOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> InstanceAuthString

## Implements

[InstanceAuthStringOrBuilder](/java/docs/reference/google-cloud-redis/2.21.0/com.google.cloud.redis.v1beta1.InstanceAuthStringOrBuilder)
...
### AUTH\_STRING\_FIELD\_NUMBER

```
public static final int AUTH_STRING_FIELD_NUMBER
```
...
```
public static InstanceAuthString getDefaultInstance()
```
...
`[InstanceAuthString](/java/docs/reference/google-cloud-redis/2.21.0/com.google.cloud.redis.v1beta1.InstanceAuthString)`
...
```
public static InstanceAuthString.Builder newBuilder()
```
...
`[InstanceAuthString.Builder](/java/docs/reference/google-cloud-redis/2.21.0/com.google.cloud.redis.v1beta1.InstanceAuthString.Builder)`

### newBuilder(InstanceAuthString prototype)

```
public static InstanceAuthString.Builder newBuilder(InstanceAuthString prototype)
```
...
```
public static InstanceAuthString parseDelimitedFrom(InputStream input)
```
...
```
public static InstanceAuthString parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static InstanceAuthString parseFrom(byte[] data)
```
...
```
public static InstanceAuthString parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static InstanceAuthString parseFrom(ByteString data)
```
...
```
public static InstanceAuthString parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static InstanceAuthString parseFrom(CodedInputStream input)
```
...
```
public static InstanceAuthString parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static InstanceAuthString parseFrom(InputStream input)
```
...
```
public static InstanceAuthString parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static InstanceAuthString parseFrom(ByteBuffer data)
```
...
```
public static InstanceAuthString parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<InstanceAuthString> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[InstanceAuthString](/java/docs/reference/google-cloud-redis/2.21.0/com.google.cloud.redis.v1beta1.InstanceAuthString)>`
...
```
public ByteString getAuthStringBytes()
```
...
```
public InstanceAuthString getDefaultInstanceForType()
```
...
```
public Parser<InstanceAuthString> getParserForType()
```
...
```
public InstanceAuthString.Builder newBuilderForType()
```
...
```
protected InstanceAuthString.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public InstanceAuthString.Builder toBuilder()
```
