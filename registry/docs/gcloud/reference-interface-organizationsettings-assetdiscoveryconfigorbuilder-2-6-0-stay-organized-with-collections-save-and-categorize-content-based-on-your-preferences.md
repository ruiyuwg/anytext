...
# Interface OrganizationSettings.AssetDiscoveryConfigOrBuilder (2.6.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public abstract String getFolderIds(int index)
```
...
```
public abstract ByteString getFolderIdsBytes(int index)
```
...
```
public abstract int getFolderIdsCount()
```
...
```
public abstract List<String> getFolderIdsList()
```
...
```
public abstract OrganizationSettings.AssetDiscoveryConfig.InclusionMode getInclusionMode()
```
...
[OrganizationSettings.AssetDiscoveryConfig.InclusionMode](/java/docs/reference/google-cloud-securitycenter/2.6.0/com.google.cloud.securitycenter.v1.OrganizationSettings.AssetDiscoveryConfig.InclusionMode)
...
```
public abstract int getInclusionModeValue()
```
