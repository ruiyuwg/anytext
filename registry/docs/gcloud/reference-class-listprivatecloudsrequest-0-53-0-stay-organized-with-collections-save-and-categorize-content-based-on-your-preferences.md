...
# Class ListPrivateCloudsRequest (0.53.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListPrivateCloudsRequest extends GeneratedMessageV3 implements ListPrivateCloudsRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListPrivateCloudsRequest

## Implements

[ListPrivateCloudsRequestOrBuilder](/java/docs/reference/google-cloud-vmwareengine/0.53.0/com.google.cloud.vmwareengine.v1.ListPrivateCloudsRequestOrBuilder)
...
```
public static ListPrivateCloudsRequest getDefaultInstance()
```
...
`[ListPrivateCloudsRequest](/java/docs/reference/google-cloud-vmwareengine/0.53.0/com.google.cloud.vmwareengine.v1.ListPrivateCloudsRequest)`
...
```
public static ListPrivateCloudsRequest.Builder newBuilder()
```
...
`[ListPrivateCloudsRequest.Builder](/java/docs/reference/google-cloud-vmwareengine/0.53.0/com.google.cloud.vmwareengine.v1.ListPrivateCloudsRequest.Builder)`

### newBuilder(ListPrivateCloudsRequest prototype)

```
public static ListPrivateCloudsRequest.Builder newBuilder(ListPrivateCloudsRequest prototype)
```
...
```
public static ListPrivateCloudsRequest parseDelimitedFrom(InputStream input)
```
...
```
public static ListPrivateCloudsRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListPrivateCloudsRequest parseFrom(byte[] data)
```
...
```
public static ListPrivateCloudsRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListPrivateCloudsRequest parseFrom(ByteString data)
```
...
```
public static ListPrivateCloudsRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListPrivateCloudsRequest parseFrom(CodedInputStream input)
```
...
```
public static ListPrivateCloudsRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListPrivateCloudsRequest parseFrom(InputStream input)
```
...
```
public static ListPrivateCloudsRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListPrivateCloudsRequest parseFrom(ByteBuffer data)
```
...
```
public static ListPrivateCloudsRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ListPrivateCloudsRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListPrivateCloudsRequest](/java/docs/reference/google-cloud-vmwareengine/0.53.0/com.google.cloud.vmwareengine.v1.ListPrivateCloudsRequest)>`
...
For example, if you are filtering a list of private clouds, you can exclude the ones named `example-pc` by specifying `name != "example-pc"`.

You can also filter nested fields. For example, you could specify `networkConfig.managementCidr = "192.168.0.0/24"` to include private clouds only if they have a matching address in their network configuration.

To filter on multiple expressions, provide each separate expression within parentheses. For example: \` `` `(name = "example-pc") (createTime > "2021-04-12T08:15:10.40Z")` ``

`By default, each expression is an` AND `expression. However, you can include` AND `and` OR `expressions explicitly. For example:` `` `(name = "private-cloud-1") AND (createTime > "2021-04-12T08:15:10.40Z") OR (name = "private-cloud-2")` `` \`
...
A page token, received from a previous `ListPrivateClouds` call. Provide this to retrieve the subsequent page.

When paginating, all other parameters provided to `ListPrivateClouds` must match the call that provided the page token.
...
Required. The resource name of the private cloud to be queried for clusters. Resource names are schemeless URIs that follow the conventions in [https://cloud.google.com/apis/design/resource\_names](https://cloud.google.com/apis/design/resource_names). For example: `projects/my-project/locations/us-central1-a`
...
```
public Parser<ListPrivateCloudsRequest> getParserForType()
```
...
```
public ListPrivateCloudsRequest.Builder newBuilderForType()
```
...
```
protected ListPrivateCloudsRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ListPrivateCloudsRequest.Builder toBuilder()
```
