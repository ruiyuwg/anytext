...
# Interface HierarchyControllerDeploymentStateOrBuilder (1.37.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface HierarchyControllerDeploymentStateOrBuilder extends MessageOrBuilder
```
...
```
public abstract DeploymentState getExtension()
```
...
`[DeploymentState](/java/docs/reference/google-cloud-gkehub/1.37.0/com.google.cloud.gkehub.configmanagement.v1alpha.DeploymentState)`
...
```
public abstract int getExtensionValue()
```
...
```
public abstract DeploymentState getHnc()
```
...
```
public abstract int getHncValue()
```
