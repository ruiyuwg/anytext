...
# Interface RunTaskRequestOrBuilder (2.33.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface RunTaskRequestOrBuilder extends MessageOrBuilder
```
...
`[Task.View](/java/docs/reference/google-cloud-tasks/2.33.0/com.google.cloud.tasks.v2beta3.Task.View)`
