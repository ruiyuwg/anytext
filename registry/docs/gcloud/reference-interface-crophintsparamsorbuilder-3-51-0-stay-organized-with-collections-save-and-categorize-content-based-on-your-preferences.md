...
# Interface CropHintsParamsOrBuilder (3.51.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface CropHintsParamsOrBuilder extends MessageOrBuilder
```
...
```
public abstract float getAspectRatios(int index)
```
...
```
public abstract int getAspectRatiosCount()
```
...
```
public abstract List<Float> getAspectRatiosList()
```
