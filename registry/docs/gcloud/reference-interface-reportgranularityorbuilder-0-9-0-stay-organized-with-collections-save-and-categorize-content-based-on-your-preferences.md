...
# Interface ReportGranularityOrBuilder (0.9.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface ReportGranularityOrBuilder extends MessageOrBuilder
```
