...
# Interface RomanizeTextResponseOrBuilder (2.87.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[Romanization](/java/docs/reference/google-cloud-translate/latest/com.google.cloud.translate.v3.Romanization)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Romanization](/java/docs/reference/google-cloud-translate/latest/com.google.cloud.translate.v3.Romanization)>`
...
`[RomanizationOrBuilder](/java/docs/reference/google-cloud-translate/latest/com.google.cloud.translate.v3.RomanizationOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.translate.v3.RomanizationOrBuilder>`
