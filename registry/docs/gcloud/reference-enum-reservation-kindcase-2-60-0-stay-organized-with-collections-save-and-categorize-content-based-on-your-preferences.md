...
# Enum Reservation.KindCase (2.60.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum Reservation.KindCase extends Enum<Reservation.KindCase> implements Internal.EnumLite, AbstractMessageLite.InternalOneOfEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-tpu/2.60.0/com.google.cloud.tpu.v2alpha1.Reservation.KindCase#com_google_cloud_tpu_v2alpha1_Reservation_KindCase_forNumber_int_) instead._
