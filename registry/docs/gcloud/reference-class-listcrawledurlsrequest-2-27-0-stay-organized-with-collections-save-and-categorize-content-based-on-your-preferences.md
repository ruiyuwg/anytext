...
# Class ListCrawledUrlsRequest (2.27.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListCrawledUrlsRequest extends GeneratedMessageV3 implements ListCrawledUrlsRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListCrawledUrlsRequest

## Implements

[ListCrawledUrlsRequestOrBuilder](/java/docs/reference/google-cloud-websecurityscanner/2.27.0/com.google.cloud.websecurityscanner.v1beta.ListCrawledUrlsRequestOrBuilder)
...
```
public static ListCrawledUrlsRequest getDefaultInstance()
```
...
`[ListCrawledUrlsRequest](/java/docs/reference/google-cloud-websecurityscanner/2.27.0/com.google.cloud.websecurityscanner.v1beta.ListCrawledUrlsRequest)`
...
```
public static ListCrawledUrlsRequest.Builder newBuilder()
```
...
`[ListCrawledUrlsRequest.Builder](/java/docs/reference/google-cloud-websecurityscanner/2.27.0/com.google.cloud.websecurityscanner.v1beta.ListCrawledUrlsRequest.Builder)`

### newBuilder(ListCrawledUrlsRequest prototype)

```
public static ListCrawledUrlsRequest.Builder newBuilder(ListCrawledUrlsRequest prototype)
```
...
```
public static ListCrawledUrlsRequest parseDelimitedFrom(InputStream input)
```
...
```
public static ListCrawledUrlsRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListCrawledUrlsRequest parseFrom(byte[] data)
```
...
```
public static ListCrawledUrlsRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListCrawledUrlsRequest parseFrom(ByteString data)
```
...
```
public static ListCrawledUrlsRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListCrawledUrlsRequest parseFrom(CodedInputStream input)
```
...
```
public static ListCrawledUrlsRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListCrawledUrlsRequest parseFrom(InputStream input)
```
...
```
public static ListCrawledUrlsRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListCrawledUrlsRequest parseFrom(ByteBuffer data)
```
...
```
public static ListCrawledUrlsRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ListCrawledUrlsRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListCrawledUrlsRequest](/java/docs/reference/google-cloud-websecurityscanner/2.27.0/com.google.cloud.websecurityscanner.v1beta.ListCrawledUrlsRequest)>`
...
```
public Parser<ListCrawledUrlsRequest> getParserForType()
```
...
```
public ListCrawledUrlsRequest.Builder newBuilderForType()
```
...
```
protected ListCrawledUrlsRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ListCrawledUrlsRequest.Builder toBuilder()
```
