...
# Compute V1 Client - Class VmDnsSetting (1.25.0) Stay organized with collections Save and categorize content based on your preferences.
...
VmDnsSetting contains string constants that represent the names of each value in the google.cloud.compute.v1.Project.VmDnsSetting descriptor.

## Namespace

Google \\ Cloud \\ Compute \\ V1 \\ Enums \\ Project

## Constants

### UNDEFINED\_VM\_DNS\_SETTING

```
Value: 'UNDEFINED_VM_DNS_SETTING'
```
