...
# Class TransferProto.ListTransferJobsRequest (1.55.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class TransferProto.ListTransferJobsRequest extends GeneratedMessageV3 implements TransferProto.ListTransferJobsRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> TransferProto.ListTransferJobsRequest

## Implements

[TransferProto.ListTransferJobsRequestOrBuilder](/java/docs/reference/google-cloud-storage-transfer/1.55.0/com.google.storagetransfer.v1.proto.TransferProto.ListTransferJobsRequestOrBuilder)
...
```
public static TransferProto.ListTransferJobsRequest getDefaultInstance()
```
...
`[TransferProto.ListTransferJobsRequest](/java/docs/reference/google-cloud-storage-transfer/1.55.0/com.google.storagetransfer.v1.proto.TransferProto.ListTransferJobsRequest)`
...
```
public static TransferProto.ListTransferJobsRequest.Builder newBuilder()
```
...
`[TransferProto.ListTransferJobsRequest.Builder](/java/docs/reference/google-cloud-storage-transfer/1.55.0/com.google.storagetransfer.v1.proto.TransferProto.ListTransferJobsRequest.Builder)`

### newBuilder(TransferProto.ListTransferJobsRequest prototype)

```
public static TransferProto.ListTransferJobsRequest.Builder newBuilder(TransferProto.ListTransferJobsRequest prototype)
```
...
```
public static TransferProto.ListTransferJobsRequest parseDelimitedFrom(InputStream input)
```
...
```
public static TransferProto.ListTransferJobsRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static TransferProto.ListTransferJobsRequest parseFrom(byte[] data)
```
...
```
public static TransferProto.ListTransferJobsRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static TransferProto.ListTransferJobsRequest parseFrom(ByteString data)
```
...
```
public static TransferProto.ListTransferJobsRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static TransferProto.ListTransferJobsRequest parseFrom(CodedInputStream input)
```
...
```
public static TransferProto.ListTransferJobsRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static TransferProto.ListTransferJobsRequest parseFrom(InputStream input)
```
...
```
public static TransferProto.ListTransferJobsRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static TransferProto.ListTransferJobsRequest parseFrom(ByteBuffer data)
```
...
```
public static TransferProto.ListTransferJobsRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<TransferProto.ListTransferJobsRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListTransferJobsRequest](/java/docs/reference/google-cloud-storage-transfer/1.55.0/com.google.storagetransfer.v1.proto.TransferProto.ListTransferJobsRequest)>`
...
```
public Parser<TransferProto.ListTransferJobsRequest> getParserForType()
```
...
```
public TransferProto.ListTransferJobsRequest.Builder newBuilderForType()
```
...
```
protected TransferProto.ListTransferJobsRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public TransferProto.ListTransferJobsRequest.Builder toBuilder()
```
