...
# Enum CompanySize (2.23.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-talent/2.23.0/com.google.cloud.talent.v4.CompanySize#com_google_cloud_talent_v4_CompanySize_forNumber_int_) instead._
