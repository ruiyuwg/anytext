...
# Interface TroubleshootIamPolicyRequestOrBuilder (1.58.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public abstract Explanations.AccessTuple getAccessTuple()
```
...
`[Explanations.AccessTuple](/java/docs/reference/google-cloud-policy-troubleshooter/1.58.0/google.cloud.policytroubleshooter.v1.Explanations.AccessTuple)`
...
```
public abstract Explanations.AccessTupleOrBuilder getAccessTupleOrBuilder()
```
...
`[Explanations.AccessTupleOrBuilder](/java/docs/reference/google-cloud-policy-troubleshooter/1.58.0/google.cloud.policytroubleshooter.v1.Explanations.AccessTupleOrBuilder)`
