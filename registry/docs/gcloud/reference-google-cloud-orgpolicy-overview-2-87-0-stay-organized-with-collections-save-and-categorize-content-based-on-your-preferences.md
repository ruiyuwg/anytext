...
# google-cloud-orgpolicy overview (2.87.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Cloud Organization Policy Description:** N/a

[Cloud Organization Policy Product Reference](/java/docs/reference/google-cloud-orgpolicy/latest/n/a)

[GitHub Repository](https://github.com/googleapis/google-cloud-java/tree/main/java-orgpolicy)

[Maven artifact](https://central.sonatype.com/artifact/com.google.cloud/google-cloud-orgpolicy)
...
-   [Enable the API](https://console.cloud.google.com/apis/library/orgpolicy.googleapis.com)
-   [Set up authentication](https://cloud.google.com/docs/authentication/client-libraries)

## Use the Cloud Organization Policy for Java
...
The example below demonstrates how you would import the BOM and include the `google-cloud-orgpolicy` artifact.
...
implementation("com.google.cloud:google-cloud-orgpolicy")
...
libraryDependencies += "com.google.cloud" % "google-cloud-orgpolicy" % "2.87.0"

## Which version ID should I get started with?

For this library, we recommend using [com.google.cloud.orgpolicy.v2](https://cloud.google.com/java/docs/reference/google-cloud-orgpolicy/2.87.0/com.google.cloud.orgpolicy.v2) for new applications.
