...
# Class PublicKey.Builder (2.46.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> PublicKey.Builder

## Implements

[PublicKeyOrBuilder](/java/docs/reference/google-cloud-kms/2.46.0/com.google.cloud.kms.v1.PublicKeyOrBuilder)
...
`[PublicKey.Builder](/java/docs/reference/google-cloud-kms/2.46.0/com.google.cloud.kms.v1.PublicKey.Builder)`
...
`[PublicKey](/java/docs/reference/google-cloud-kms/2.46.0/com.google.cloud.kms.v1.PublicKey)`
...
`[CryptoKeyVersion.CryptoKeyVersionAlgorithm](/java/docs/reference/google-cloud-kms/2.46.0/com.google.cloud.kms.v1.CryptoKeyVersion.CryptoKeyVersionAlgorithm)`
...
`[Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Int64Value.Builder.html)`
...
`[ProtectionLevel](/java/docs/reference/google-cloud-kms/2.46.0/com.google.cloud.kms.v1.ProtectionLevel)`
...
### mergePemCrc32C(Int64Value value)

```
public PublicKey.Builder mergePemCrc32C(Int64Value value)
```
...
```
public PublicKey.Builder setNameBytes(ByteString value)
```
...
```
public PublicKey.Builder setPemBytes(ByteString value)
```
...
### setPemCrc32C(Int64Value value)

```
public PublicKey.Builder setPemCrc32C(Int64Value value)
```
...
### setPemCrc32C(Int64Value.Builder builderForValue)

```
public PublicKey.Builder setPemCrc32C(Int64Value.Builder builderForValue)
```
