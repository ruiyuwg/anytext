...
# Class ListUptimeCheckConfigsResponse (3.23.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListUptimeCheckConfigsResponse

## Implements

[ListUptimeCheckConfigsResponseOrBuilder](/java/docs/reference/google-cloud-monitoring/3.23.0/com.google.monitoring.v3.ListUptimeCheckConfigsResponseOrBuilder)
...
### UPTIME\_CHECK\_CONFIGS\_FIELD\_NUMBER
...
`[ListUptimeCheckConfigsResponse](/java/docs/reference/google-cloud-monitoring/3.23.0/com.google.monitoring.v3.ListUptimeCheckConfigsResponse)`
...
`[ListUptimeCheckConfigsResponse.Builder](/java/docs/reference/google-cloud-monitoring/3.23.0/com.google.monitoring.v3.ListUptimeCheckConfigsResponse.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListUptimeCheckConfigsResponse](/java/docs/reference/google-cloud-monitoring/3.23.0/com.google.monitoring.v3.ListUptimeCheckConfigsResponse)>`
...
`[UptimeCheckConfig](/java/docs/reference/google-cloud-monitoring/3.23.0/com.google.monitoring.v3.UptimeCheckConfig)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[UptimeCheckConfig](/java/docs/reference/google-cloud-monitoring/3.23.0/com.google.monitoring.v3.UptimeCheckConfig)>`
...
`[UptimeCheckConfigOrBuilder](/java/docs/reference/google-cloud-monitoring/3.23.0/com.google.monitoring.v3.UptimeCheckConfigOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.monitoring.v3.UptimeCheckConfigOrBuilder>`
