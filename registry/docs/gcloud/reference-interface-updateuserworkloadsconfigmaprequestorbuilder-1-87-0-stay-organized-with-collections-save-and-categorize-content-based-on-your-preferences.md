...
# Interface UpdateUserWorkloadsConfigMapRequestOrBuilder (1.87.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface UpdateUserWorkloadsConfigMapRequestOrBuilder extends MessageOrBuilder
```
...
```
public abstract UserWorkloadsConfigMap getUserWorkloadsConfigMap()
```
...
The userWorkloadsConfigMap.

### getUserWorkloadsConfigMapOrBuilder()

```
public abstract UserWorkloadsConfigMapOrBuilder getUserWorkloadsConfigMapOrBuilder()
```
...
```
public abstract boolean hasUserWorkloadsConfigMap()
```
...
Whether the userWorkloadsConfigMap field is set.
