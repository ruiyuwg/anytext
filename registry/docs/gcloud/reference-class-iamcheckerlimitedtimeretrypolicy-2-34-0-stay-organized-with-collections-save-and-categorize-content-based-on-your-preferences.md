...
# Class IamCheckerLimitedTimeRetryPolicy (2.34.0) Stay organized with collections Save and categorize content based on your preferences.
...
A retry policy for [`IamCheckerConnection`](/cpp/docs/reference/policytroubleshooter/2.34.0/classgoogle_1_1cloud_1_1policytroubleshooter__v1_1_1IamCheckerConnection) based on elapsed time.
...
### IamCheckerLimitedTimeRetryPolicy(std::chrono::duration< DurationRep, DurationPeriod >)
...
### IamCheckerLimitedTimeRetryPolicy(IamCheckerLimitedTimeRetryPolicy &&)
...
### IamCheckerLimitedTimeRetryPolicy(IamCheckerLimitedTimeRetryPolicy const &)
...
`IamCheckerLimitedTimeRetryPolicy const &`  
...
`std::unique_ptr< IamCheckerRetryPolicy >`

## Type Aliases

### BaseType

**Alias Of**: `IamCheckerRetryPolicy`
