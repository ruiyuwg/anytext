...
# google-cloud-phishingprotection overview (0.90.0)

## Key Reference Links

**Phishing Protection Description:** Helps prevent users from accessing phishing sites by identifying various signals associated with malicious content, including the use of your brand assets, classifying malicious content that uses your brand and reporting the unsafe URLs to Google Safe Browsing. Once a site is propagated to Safe Browsing, users will see warnings across more than 4 billion devices.

[Phishing Protection Product Reference](https://cloud.google.com/phishing-protection/docs/)

[GitHub Repository (includes samples)](https://github.com/googleapis/google-cloud-java/tree/main/java-phishingprotection)

[Maven artifact](https://central.sonatype.com/artifact/com.google.cloud/google-cloud-phishingprotection)
...
-   [Enable the API](https://console.cloud.google.com/apis/library/phishingprotection.googleapis.com)
-   [Set up authentication](https://cloud.google.com/docs/authentication/client-libraries)

## Use the Phishing Protection for Java
...
The example below demonstrates how you would import the BOM and include the `google-cloud-phishingprotection` artifact.
...
libraryDependencies += "com.google.cloud" % "google-cloud-phishingprotection" % "0.90.0"

## Which version ID should I get started with?

For this library, we recommend using [com.google.phishingprotection.v1beta1](https://cloud.google.com/java/docs/reference/google-cloud-phishingprotection/0.90.0/com.google.phishingprotection.v1beta1) for new applications.
