...
# Interface ReportDetail.MetricsOrBuilder (0.9.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static interface ReportDetail.MetricsOrBuilder extends MessageOrBuilder
```
