...
# Class ListDeviceStatesRequest (2.21.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListDeviceStatesRequest extends GeneratedMessageV3 implements ListDeviceStatesRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListDeviceStatesRequest

## Implements

[ListDeviceStatesRequestOrBuilder](/java/docs/reference/google-cloud-iot/2.21.0/com.google.cloud.iot.v1.ListDeviceStatesRequestOrBuilder)
...
### NUM\_STATES\_FIELD\_NUMBER

```
public static final int NUM_STATES_FIELD_NUMBER
```
...
```
public static ListDeviceStatesRequest getDefaultInstance()
```
...
`[ListDeviceStatesRequest](/java/docs/reference/google-cloud-iot/2.21.0/com.google.cloud.iot.v1.ListDeviceStatesRequest)`
...
```
public static ListDeviceStatesRequest.Builder newBuilder()
```
...
`[ListDeviceStatesRequest.Builder](/java/docs/reference/google-cloud-iot/2.21.0/com.google.cloud.iot.v1.ListDeviceStatesRequest.Builder)`

### newBuilder(ListDeviceStatesRequest prototype)

```
public static ListDeviceStatesRequest.Builder newBuilder(ListDeviceStatesRequest prototype)
```
...
```
public static ListDeviceStatesRequest parseDelimitedFrom(InputStream input)
```
...
```
public static ListDeviceStatesRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListDeviceStatesRequest parseFrom(byte[] data)
```
...
```
public static ListDeviceStatesRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListDeviceStatesRequest parseFrom(ByteString data)
```
...
```
public static ListDeviceStatesRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListDeviceStatesRequest parseFrom(CodedInputStream input)
```
...
```
public static ListDeviceStatesRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListDeviceStatesRequest parseFrom(InputStream input)
```
...
```
public static ListDeviceStatesRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListDeviceStatesRequest parseFrom(ByteBuffer data)
```
...
```
public static ListDeviceStatesRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ListDeviceStatesRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListDeviceStatesRequest](/java/docs/reference/google-cloud-iot/2.21.0/com.google.cloud.iot.v1.ListDeviceStatesRequest)>`
...
```
public Parser<ListDeviceStatesRequest> getParserForType()
```
...
```
public ListDeviceStatesRequest.Builder newBuilderForType()
```
...
```
protected ListDeviceStatesRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ListDeviceStatesRequest.Builder toBuilder()
```
