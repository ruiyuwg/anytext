...
# Interface TerraformOutputOrBuilder (0.26.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface TerraformOutputOrBuilder extends MessageOrBuilder
```
...
```
public abstract boolean getSensitive()
```
