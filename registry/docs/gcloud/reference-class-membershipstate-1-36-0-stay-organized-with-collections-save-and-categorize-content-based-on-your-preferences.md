...
# Class MembershipState (1.36.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> MembershipState

## Implements

[MembershipStateOrBuilder](/java/docs/reference/google-cloud-gkehub/1.36.0/com.google.cloud.gkehub.metering.v1alpha.MembershipStateOrBuilder)
...
### LAST\_MEASUREMENT\_TIME\_FIELD\_NUMBER

```
public static final int LAST_MEASUREMENT_TIME_FIELD_NUMBER
```
...
### PRECISE\_LAST\_MEASURED\_CLUSTER\_VCPU\_CAPACITY\_FIELD\_NUMBER

```
public static final int PRECISE_LAST_MEASURED_CLUSTER_VCPU_CAPACITY_FIELD_NUMBER
```
...
`[MembershipState](/java/docs/reference/google-cloud-gkehub/1.36.0/com.google.cloud.gkehub.metering.v1alpha.MembershipState)`
...
`[MembershipState.Builder](/java/docs/reference/google-cloud-gkehub/1.36.0/com.google.cloud.gkehub.metering.v1alpha.MembershipState.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[MembershipState](/java/docs/reference/google-cloud-gkehub/1.36.0/com.google.cloud.gkehub.metering.v1alpha.MembershipState)>`
