...
# Class SearchRequest.FacetSpec.FacetKey.Builder (2.48.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> SearchRequest.FacetSpec.FacetKey.Builder

## Implements

[SearchRequest.FacetSpec.FacetKeyOrBuilder](/java/docs/reference/google-cloud-retail/2.48.0/com.google.cloud.retail.v2.SearchRequest.FacetSpec.FacetKeyOrBuilder)
...
`[SearchRequest.FacetSpec.FacetKey.Builder](/java/docs/reference/google-cloud-retail/2.48.0/com.google.cloud.retail.v2.SearchRequest.FacetSpec.FacetKey.Builder)`
...
`[Iterable](https://docs.oracle.com/javase/8/docs/api/java/lang/Iterable.html)<? extends com.google.cloud.retail.v2.Interval>`  
...
`[Interval](/java/docs/reference/google-cloud-retail/2.48.0/com.google.cloud.retail.v2.Interval)`  
...
`[Interval.Builder](/java/docs/reference/google-cloud-retail/2.48.0/com.google.cloud.retail.v2.Interval.Builder)`  
...
`[SearchRequest.FacetSpec.FacetKey](/java/docs/reference/google-cloud-retail/2.48.0/com.google.cloud.retail.v2.SearchRequest.FacetSpec.FacetKey)`
...
For example, you can set a customized facet for "shipToStore", where FacetKey.key is "customizedShipToStore", and FacetKey.query is "availability: ANY(\\"IN\_STOCK\\") AND shipToStore: ANY(\\"123\\")". Then the facet counts the products that are both in stock and ship to store "123".
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Builder](/java/docs/reference/google-cloud-retail/2.48.0/com.google.cloud.retail.v2.Interval.Builder)>`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Interval](/java/docs/reference/google-cloud-retail/2.48.0/com.google.cloud.retail.v2.Interval)>`
...
`[IntervalOrBuilder](/java/docs/reference/google-cloud-retail/2.48.0/com.google.cloud.retail.v2.IntervalOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.retail.v2.IntervalOrBuilder>`
