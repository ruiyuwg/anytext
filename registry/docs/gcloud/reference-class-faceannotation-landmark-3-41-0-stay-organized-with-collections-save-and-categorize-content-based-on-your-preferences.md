...
# Class FaceAnnotation.Landmark (3.41.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> FaceAnnotation.Landmark

## Implements

[FaceAnnotation.LandmarkOrBuilder](/java/docs/reference/google-cloud-vision/3.41.0/com.google.cloud.vision.v1.FaceAnnotation.LandmarkOrBuilder)
...
`[FaceAnnotation.Landmark](/java/docs/reference/google-cloud-vision/3.41.0/com.google.cloud.vision.v1.FaceAnnotation.Landmark)`
...
`[FaceAnnotation.Landmark.Builder](/java/docs/reference/google-cloud-vision/3.41.0/com.google.cloud.vision.v1.FaceAnnotation.Landmark.Builder)`
...
```
public static FaceAnnotation.Landmark parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static FaceAnnotation.Landmark parseFrom(byte[] data)
```
...
```
public static FaceAnnotation.Landmark parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static FaceAnnotation.Landmark parseFrom(ByteString data)
```
...
```
public static FaceAnnotation.Landmark parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static FaceAnnotation.Landmark parseFrom(CodedInputStream input)
```
...
```
public static FaceAnnotation.Landmark parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static FaceAnnotation.Landmark parseFrom(InputStream input)
```
...
```
public static FaceAnnotation.Landmark parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static FaceAnnotation.Landmark parseFrom(ByteBuffer data)
```
...
```
public static FaceAnnotation.Landmark parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<FaceAnnotation.Landmark> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[Landmark](/java/docs/reference/google-cloud-vision/3.41.0/com.google.cloud.vision.v1.FaceAnnotation.Landmark)>`
...
```
public Parser<FaceAnnotation.Landmark> getParserForType()
```
...
`[Position](/java/docs/reference/google-cloud-vision/3.41.0/com.google.cloud.vision.v1.Position)`
...
`[PositionOrBuilder](/java/docs/reference/google-cloud-vision/3.41.0/com.google.cloud.vision.v1.PositionOrBuilder)`
...
`[FaceAnnotation.Landmark.Type](/java/docs/reference/google-cloud-vision/3.41.0/com.google.cloud.vision.v1.FaceAnnotation.Landmark.Type)`
...
```
public FaceAnnotation.Landmark.Builder newBuilderForType()
```
...
```
protected FaceAnnotation.Landmark.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public FaceAnnotation.Landmark.Builder toBuilder()
```
