...
# Class ImportErrorsConfig (2.14.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ImportErrorsConfig extends GeneratedMessageV3 implements ImportErrorsConfigOrBuilder
```

Configuration of destination for Import related errors.

Protobuf type `google.cloud.retail.v2alpha.ImportErrorsConfig`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ImportErrorsConfig

## Implements

[ImportErrorsConfigOrBuilder](/java/docs/reference/google-cloud-retail/2.14.0/com.google.cloud.retail.v2alpha.ImportErrorsConfigOrBuilder)
...
### GCS\_PREFIX\_FIELD\_NUMBER

```
public static final int GCS_PREFIX_FIELD_NUMBER
```
...
```
public static ImportErrorsConfig getDefaultInstance()
```
...
`[ImportErrorsConfig](/java/docs/reference/google-cloud-retail/2.14.0/com.google.cloud.retail.v2alpha.ImportErrorsConfig)`
...
```
public static ImportErrorsConfig.Builder newBuilder()
```
...
`[ImportErrorsConfig.Builder](/java/docs/reference/google-cloud-retail/2.14.0/com.google.cloud.retail.v2alpha.ImportErrorsConfig.Builder)`

### newBuilder(ImportErrorsConfig prototype)

```
public static ImportErrorsConfig.Builder newBuilder(ImportErrorsConfig prototype)
```
...
```
public static ImportErrorsConfig parseDelimitedFrom(InputStream input)
```
...
```
public static ImportErrorsConfig parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ImportErrorsConfig parseFrom(byte[] data)
```
...
```
public static ImportErrorsConfig parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ImportErrorsConfig parseFrom(ByteString data)
```
...
```
public static ImportErrorsConfig parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ImportErrorsConfig parseFrom(CodedInputStream input)
```
...
```
public static ImportErrorsConfig parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ImportErrorsConfig parseFrom(InputStream input)
```
...
```
public static ImportErrorsConfig parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ImportErrorsConfig parseFrom(ByteBuffer data)
```
...
```
public static ImportErrorsConfig parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ImportErrorsConfig> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ImportErrorsConfig](/java/docs/reference/google-cloud-retail/2.14.0/com.google.cloud.retail.v2alpha.ImportErrorsConfig)>`
...
```
public ImportErrorsConfig getDefaultInstanceForType()
```
...
```
public ImportErrorsConfig.DestinationCase getDestinationCase()
```
...
`[ImportErrorsConfig.DestinationCase](/java/docs/reference/google-cloud-retail/2.14.0/com.google.cloud.retail.v2alpha.ImportErrorsConfig.DestinationCase)`
...
```
public Parser<ImportErrorsConfig> getParserForType()
```
...
```
public ImportErrorsConfig.Builder newBuilderForType()
```
...
```
protected ImportErrorsConfig.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ImportErrorsConfig.Builder toBuilder()
```
