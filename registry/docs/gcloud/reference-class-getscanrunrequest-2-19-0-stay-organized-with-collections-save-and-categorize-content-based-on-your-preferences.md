...
# Class GetScanRunRequest (2.19.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class GetScanRunRequest extends GeneratedMessageV3 implements GetScanRunRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> GetScanRunRequest

## Implements

[GetScanRunRequestOrBuilder](/java/docs/reference/google-cloud-websecurityscanner/2.19.0/com.google.cloud.websecurityscanner.v1.GetScanRunRequestOrBuilder)
...
```
public static GetScanRunRequest getDefaultInstance()
```
...
```
public static GetScanRunRequest.Builder newBuilder()
```
...
`[GetScanRunRequest.Builder](/java/docs/reference/google-cloud-websecurityscanner/2.19.0/com.google.cloud.websecurityscanner.v1.GetScanRunRequest.Builder)`

### newBuilder(GetScanRunRequest prototype)

```
public static GetScanRunRequest.Builder newBuilder(GetScanRunRequest prototype)
```
...
```
public static GetScanRunRequest parseDelimitedFrom(InputStream input)
```
...
```
public static GetScanRunRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetScanRunRequest parseFrom(byte[] data)
```
...
```
public static GetScanRunRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetScanRunRequest parseFrom(ByteString data)
```
...
```
public static GetScanRunRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetScanRunRequest parseFrom(CodedInputStream input)
```
...
```
public static GetScanRunRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetScanRunRequest parseFrom(InputStream input)
```
...
```
public static GetScanRunRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetScanRunRequest parseFrom(ByteBuffer data)
```
...
```
public static GetScanRunRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<GetScanRunRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[GetScanRunRequest](/java/docs/reference/google-cloud-websecurityscanner/2.19.0/com.google.cloud.websecurityscanner.v1.GetScanRunRequest)>`
...
```
public Parser<GetScanRunRequest> getParserForType()
```
...
```
public GetScanRunRequest.Builder newBuilderForType()
```
...
```
protected GetScanRunRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public GetScanRunRequest.Builder toBuilder()
```
