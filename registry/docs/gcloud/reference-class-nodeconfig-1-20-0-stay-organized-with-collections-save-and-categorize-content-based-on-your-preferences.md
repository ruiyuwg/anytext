...
# Class NodeConfig (1.20.0) Stay organized with collections Save and categorize content based on your preferences.
...
[NodeConfigOrBuilder](/java/docs/reference/google-cloud-orchestration-airflow/1.20.0/com.google.cloud.orchestration.airflow.service.v1.NodeConfigOrBuilder)
...
`[NodeConfig](/java/docs/reference/google-cloud-orchestration-airflow/1.20.0/com.google.cloud.orchestration.airflow.service.v1.NodeConfig)`
...
`[NodeConfig.Builder](/java/docs/reference/google-cloud-orchestration-airflow/1.20.0/com.google.cloud.orchestration.airflow.service.v1.NodeConfig.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[NodeConfig](/java/docs/reference/google-cloud-orchestration-airflow/1.20.0/com.google.cloud.orchestration.airflow.service.v1.NodeConfig)>`
...
`[IPAllocationPolicy](/java/docs/reference/google-cloud-orchestration-airflow/1.20.0/com.google.cloud.orchestration.airflow.service.v1.IPAllocationPolicy)`
...
`[IPAllocationPolicyOrBuilder](/java/docs/reference/google-cloud-orchestration-airflow/1.20.0/com.google.cloud.orchestration.airflow.service.v1.IPAllocationPolicyOrBuilder)`
