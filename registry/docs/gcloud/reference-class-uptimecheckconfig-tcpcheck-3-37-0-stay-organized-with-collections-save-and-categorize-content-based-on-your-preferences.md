...
# Class UptimeCheckConfig.TcpCheck (3.37.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class UptimeCheckConfig.TcpCheck extends GeneratedMessageV3 implements UptimeCheckConfig.TcpCheckOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> UptimeCheckConfig.TcpCheck

## Implements

[UptimeCheckConfig.TcpCheckOrBuilder](/java/docs/reference/google-cloud-monitoring/3.37.0/com.google.monitoring.v3.UptimeCheckConfig.TcpCheckOrBuilder)
...
```
public static UptimeCheckConfig.TcpCheck getDefaultInstance()
```
...
`[UptimeCheckConfig.TcpCheck](/java/docs/reference/google-cloud-monitoring/3.37.0/com.google.monitoring.v3.UptimeCheckConfig.TcpCheck)`
...
```
public static UptimeCheckConfig.TcpCheck.Builder newBuilder()
```
...
`[UptimeCheckConfig.TcpCheck.Builder](/java/docs/reference/google-cloud-monitoring/3.37.0/com.google.monitoring.v3.UptimeCheckConfig.TcpCheck.Builder)`

### newBuilder(UptimeCheckConfig.TcpCheck prototype)

```
public static UptimeCheckConfig.TcpCheck.Builder newBuilder(UptimeCheckConfig.TcpCheck prototype)
```
...
```
public static UptimeCheckConfig.TcpCheck parseDelimitedFrom(InputStream input)
```
...
```
public static UptimeCheckConfig.TcpCheck parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UptimeCheckConfig.TcpCheck parseFrom(byte[] data)
```
...
```
public static UptimeCheckConfig.TcpCheck parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UptimeCheckConfig.TcpCheck parseFrom(ByteString data)
```
...
```
public static UptimeCheckConfig.TcpCheck parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UptimeCheckConfig.TcpCheck parseFrom(CodedInputStream input)
```
...
```
public static UptimeCheckConfig.TcpCheck parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UptimeCheckConfig.TcpCheck parseFrom(InputStream input)
```
...
```
public static UptimeCheckConfig.TcpCheck parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UptimeCheckConfig.TcpCheck parseFrom(ByteBuffer data)
```
...
```
public static UptimeCheckConfig.TcpCheck parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<UptimeCheckConfig.TcpCheck> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[TcpCheck](/java/docs/reference/google-cloud-monitoring/3.37.0/com.google.monitoring.v3.UptimeCheckConfig.TcpCheck)>`
...
```
public UptimeCheckConfig.TcpCheck getDefaultInstanceForType()
```
...
```
public Parser<UptimeCheckConfig.TcpCheck> getParserForType()
```
...
`[UptimeCheckConfig.PingConfig](/java/docs/reference/google-cloud-monitoring/3.37.0/com.google.monitoring.v3.UptimeCheckConfig.PingConfig)`
...
`[UptimeCheckConfig.PingConfigOrBuilder](/java/docs/reference/google-cloud-monitoring/3.37.0/com.google.monitoring.v3.UptimeCheckConfig.PingConfigOrBuilder)`
...
```
public UptimeCheckConfig.TcpCheck.Builder newBuilderForType()
```
...
```
protected UptimeCheckConfig.TcpCheck.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public UptimeCheckConfig.TcpCheck.Builder toBuilder()
```
