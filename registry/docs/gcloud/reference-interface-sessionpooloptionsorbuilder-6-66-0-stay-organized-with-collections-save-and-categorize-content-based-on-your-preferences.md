...
# Interface SessionPoolOptionsOrBuilder (6.66.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface SessionPoolOptionsOrBuilder extends MessageOrBuilder
```
...
```
public abstract boolean getUseMultiplexed()
```
