...
# Class ListKeyRingsResponse (2.49.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListKeyRingsResponse

## Implements

[ListKeyRingsResponseOrBuilder](/java/docs/reference/google-cloud-kms/2.49.0/com.google.cloud.kms.v1.ListKeyRingsResponseOrBuilder)
...
`[ListKeyRingsResponse](/java/docs/reference/google-cloud-kms/2.49.0/com.google.cloud.kms.v1.ListKeyRingsResponse)`
...
`[ListKeyRingsResponse.Builder](/java/docs/reference/google-cloud-kms/2.49.0/com.google.cloud.kms.v1.ListKeyRingsResponse.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListKeyRingsResponse](/java/docs/reference/google-cloud-kms/2.49.0/com.google.cloud.kms.v1.ListKeyRingsResponse)>`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[KeyRing](/java/docs/reference/google-cloud-kms/2.49.0/com.google.cloud.kms.v1.KeyRing)>`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.kms.v1.KeyRingOrBuilder>`
...
A token to retrieve next page of results. Pass this value in ListKeyRingsRequest.page\_token to retrieve the next page of results.
