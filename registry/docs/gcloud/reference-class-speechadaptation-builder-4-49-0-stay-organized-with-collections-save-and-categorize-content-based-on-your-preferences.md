...
# Class SpeechAdaptation.Builder (4.49.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> SpeechAdaptation.Builder

## Implements

[SpeechAdaptationOrBuilder](/java/docs/reference/google-cloud-speech/4.49.0/com.google.cloud.speech.v1.SpeechAdaptationOrBuilder)
...
`[SpeechAdaptation.Builder](/java/docs/reference/google-cloud-speech/4.49.0/com.google.cloud.speech.v1.SpeechAdaptation.Builder)`
...
`[Iterable](https://docs.oracle.com/javase/8/docs/api/java/lang/Iterable.html)<? extends com.google.cloud.speech.v1.PhraseSet>`  
...
`[CustomClass](/java/docs/reference/google-cloud-speech/4.49.0/com.google.cloud.speech.v1.CustomClass)`  
...
`[CustomClass.Builder](/java/docs/reference/google-cloud-speech/4.49.0/com.google.cloud.speech.v1.CustomClass.Builder)`  
...
`[PhraseSet](/java/docs/reference/google-cloud-speech/4.49.0/com.google.cloud.speech.v1.PhraseSet)`  
...
`[PhraseSet.Builder](/java/docs/reference/google-cloud-speech/4.49.0/com.google.cloud.speech.v1.PhraseSet.Builder)`  
...
`[SpeechAdaptation](/java/docs/reference/google-cloud-speech/4.49.0/com.google.cloud.speech.v1.SpeechAdaptation)`
...
Augmented Backus-Naur form (ABNF) is a standardized grammar notation comprised by a set of derivation rules. See specifications: [https://www.w3.org/TR/speech-grammar](https://www.w3.org/TR/speech-grammar)
...
`[SpeechAdaptation.ABNFGrammar](/java/docs/reference/google-cloud-speech/4.49.0/com.google.cloud.speech.v1.SpeechAdaptation.ABNFGrammar)`
...
`[SpeechAdaptation.ABNFGrammar.Builder](/java/docs/reference/google-cloud-speech/4.49.0/com.google.cloud.speech.v1.SpeechAdaptation.ABNFGrammar.Builder)`
...
`[SpeechAdaptation.ABNFGrammarOrBuilder](/java/docs/reference/google-cloud-speech/4.49.0/com.google.cloud.speech.v1.SpeechAdaptation.ABNFGrammarOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Builder](/java/docs/reference/google-cloud-speech/4.49.0/com.google.cloud.speech.v1.CustomClass.Builder)>`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[CustomClass](/java/docs/reference/google-cloud-speech/4.49.0/com.google.cloud.speech.v1.CustomClass)>`
...
`[CustomClassOrBuilder](/java/docs/reference/google-cloud-speech/4.49.0/com.google.cloud.speech.v1.CustomClassOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Builder](/java/docs/reference/google-cloud-speech/4.49.0/com.google.cloud.speech.v1.PhraseSet.Builder)>`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[PhraseSet](/java/docs/reference/google-cloud-speech/4.49.0/com.google.cloud.speech.v1.PhraseSet)>`
...
`[PhraseSetOrBuilder](/java/docs/reference/google-cloud-speech/4.49.0/com.google.cloud.speech.v1.PhraseSetOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.speech.v1.PhraseSetOrBuilder>`
