...
# Class SpeculativeDecodingSpec.DraftModelSpeculation (1.47.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class SpeculativeDecodingSpec.DraftModelSpeculation extends GeneratedMessage implements SpeculativeDecodingSpec.DraftModelSpeculationOrBuilder
```
...
### DRAFT\_MODEL\_FIELD\_NUMBER

```
public static final int DRAFT_MODEL_FIELD_NUMBER
```
...
```
public static SpeculativeDecodingSpec.DraftModelSpeculation getDefaultInstance()
```
...
```
public static SpeculativeDecodingSpec.DraftModelSpeculation.Builder newBuilder()
```
...
### newBuilder(SpeculativeDecodingSpec.DraftModelSpeculation prototype)

```
public static SpeculativeDecodingSpec.DraftModelSpeculation.Builder newBuilder(SpeculativeDecodingSpec.DraftModelSpeculation prototype)
```
...
```
public static SpeculativeDecodingSpec.DraftModelSpeculation parseDelimitedFrom(InputStream input)
```
...
```
public static SpeculativeDecodingSpec.DraftModelSpeculation parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SpeculativeDecodingSpec.DraftModelSpeculation parseFrom(byte[] data)
```
...
```
public static SpeculativeDecodingSpec.DraftModelSpeculation parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SpeculativeDecodingSpec.DraftModelSpeculation parseFrom(ByteString data)
```
...
```
public static SpeculativeDecodingSpec.DraftModelSpeculation parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SpeculativeDecodingSpec.DraftModelSpeculation parseFrom(CodedInputStream input)
```
...
```
public static SpeculativeDecodingSpec.DraftModelSpeculation parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SpeculativeDecodingSpec.DraftModelSpeculation parseFrom(InputStream input)
```
...
```
public static SpeculativeDecodingSpec.DraftModelSpeculation parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SpeculativeDecodingSpec.DraftModelSpeculation parseFrom(ByteBuffer data)
```
...
```
public static SpeculativeDecodingSpec.DraftModelSpeculation parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<SpeculativeDecodingSpec.DraftModelSpeculation> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[DraftModelSpeculation](/java/docs/reference/google-cloud-vertexai/latest/com.google.cloud.vertexai.api.SpeculativeDecodingSpec.DraftModelSpeculation)>`
...
```
public Parser<SpeculativeDecodingSpec.DraftModelSpeculation> getParserForType()
```
...
```
public SpeculativeDecodingSpec.DraftModelSpeculation.Builder newBuilderForType()
```
...
```
protected SpeculativeDecodingSpec.DraftModelSpeculation.Builder newBuilderForType(AbstractMessage.BuilderParent parent)
```
...
```
public SpeculativeDecodingSpec.DraftModelSpeculation.Builder toBuilder()
```
