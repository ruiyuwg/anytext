...
# Class ListFindingsResponse (2.53.0) Stay organized with collections Save and categorize content based on your preferences.
...
[ListFindingsResponseOrBuilder](/java/docs/reference/google-cloud-securitycenter/2.53.0/com.google.cloud.securitycenter.v1beta1.ListFindingsResponseOrBuilder)
...
`[ListFindingsResponse](/java/docs/reference/google-cloud-securitycenter/2.53.0/com.google.cloud.securitycenter.v1beta1.ListFindingsResponse)`
...
`[ListFindingsResponse.Builder](/java/docs/reference/google-cloud-securitycenter/2.53.0/com.google.cloud.securitycenter.v1beta1.ListFindingsResponse.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListFindingsResponse](/java/docs/reference/google-cloud-securitycenter/2.53.0/com.google.cloud.securitycenter.v1beta1.ListFindingsResponse)>`
...
`[Finding](/java/docs/reference/google-cloud-securitycenter/2.53.0/com.google.cloud.securitycenter.v1beta1.Finding)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Finding](/java/docs/reference/google-cloud-securitycenter/2.53.0/com.google.cloud.securitycenter.v1beta1.Finding)>`
...
`[FindingOrBuilder](/java/docs/reference/google-cloud-securitycenter/2.53.0/com.google.cloud.securitycenter.v1beta1.FindingOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.securitycenter.v1beta1.FindingOrBuilder>`
