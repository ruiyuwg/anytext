...
# Class Policy (0.6.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> Policy

## Implements

[PolicyOrBuilder](/java/docs/reference/google-cloud-securityposture/0.6.0/com.google.cloud.securityposture.v1.PolicyOrBuilder)
...
### COMPLIANCE\_STANDARDS\_FIELD\_NUMBER
...
`[Policy](/java/docs/reference/google-cloud-securityposture/0.6.0/com.google.cloud.securityposture.v1.Policy)`
...
`[Policy.Builder](/java/docs/reference/google-cloud-securityposture/0.6.0/com.google.cloud.securityposture.v1.Policy.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[Policy](/java/docs/reference/google-cloud-securityposture/0.6.0/com.google.cloud.securityposture.v1.Policy)>`
...
`[Policy.ComplianceStandard](/java/docs/reference/google-cloud-securityposture/0.6.0/com.google.cloud.securityposture.v1.Policy.ComplianceStandard)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ComplianceStandard](/java/docs/reference/google-cloud-securityposture/0.6.0/com.google.cloud.securityposture.v1.Policy.ComplianceStandard)>`
...
`[Policy.ComplianceStandardOrBuilder](/java/docs/reference/google-cloud-securityposture/0.6.0/com.google.cloud.securityposture.v1.Policy.ComplianceStandardOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.securityposture.v1.Policy.ComplianceStandardOrBuilder>`
...
`[Constraint](/java/docs/reference/google-cloud-securityposture/0.6.0/com.google.cloud.securityposture.v1.Constraint)`
...
`[ConstraintOrBuilder](/java/docs/reference/google-cloud-securityposture/0.6.0/com.google.cloud.securityposture.v1.ConstraintOrBuilder)`
