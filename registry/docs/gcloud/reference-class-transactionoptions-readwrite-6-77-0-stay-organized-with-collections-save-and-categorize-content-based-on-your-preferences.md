...
# Class TransactionOptions.ReadWrite (6.77.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class TransactionOptions.ReadWrite extends GeneratedMessageV3 implements TransactionOptions.ReadWriteOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> TransactionOptions.ReadWrite

## Implements

[TransactionOptions.ReadWriteOrBuilder](/java/docs/reference/google-cloud-spanner/6.77.0/com.google.spanner.v1.TransactionOptions.ReadWriteOrBuilder)
...
### READ\_LOCK\_MODE\_FIELD\_NUMBER

```
public static final int READ_LOCK_MODE_FIELD_NUMBER
```
...
```
public static TransactionOptions.ReadWrite getDefaultInstance()
```
...
`[TransactionOptions.ReadWrite](/java/docs/reference/google-cloud-spanner/6.77.0/com.google.spanner.v1.TransactionOptions.ReadWrite)`
...
```
public static TransactionOptions.ReadWrite.Builder newBuilder()
```
...
`[TransactionOptions.ReadWrite.Builder](/java/docs/reference/google-cloud-spanner/6.77.0/com.google.spanner.v1.TransactionOptions.ReadWrite.Builder)`

### newBuilder(TransactionOptions.ReadWrite prototype)

```
public static TransactionOptions.ReadWrite.Builder newBuilder(TransactionOptions.ReadWrite prototype)
```
...
```
public static TransactionOptions.ReadWrite parseDelimitedFrom(InputStream input)
```
...
```
public static TransactionOptions.ReadWrite parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static TransactionOptions.ReadWrite parseFrom(byte[] data)
```
...
```
public static TransactionOptions.ReadWrite parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static TransactionOptions.ReadWrite parseFrom(ByteString data)
```
...
```
public static TransactionOptions.ReadWrite parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static TransactionOptions.ReadWrite parseFrom(CodedInputStream input)
```
...
```
public static TransactionOptions.ReadWrite parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static TransactionOptions.ReadWrite parseFrom(InputStream input)
```
...
```
public static TransactionOptions.ReadWrite parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static TransactionOptions.ReadWrite parseFrom(ByteBuffer data)
```
...
```
public static TransactionOptions.ReadWrite parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<TransactionOptions.ReadWrite> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ReadWrite](/java/docs/reference/google-cloud-spanner/6.77.0/com.google.spanner.v1.TransactionOptions.ReadWrite)>`
...
```
public Parser<TransactionOptions.ReadWrite> getParserForType()
```
...
`[TransactionOptions.ReadWrite.ReadLockMode](/java/docs/reference/google-cloud-spanner/6.77.0/com.google.spanner.v1.TransactionOptions.ReadWrite.ReadLockMode)`
...
```
public TransactionOptions.ReadWrite.Builder newBuilderForType()
```
...
```
protected TransactionOptions.ReadWrite.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public TransactionOptions.ReadWrite.Builder toBuilder()
```
