...
# Class ImportJob (0.25.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ImportJob

## Implements

[ImportJobOrBuilder](/java/docs/reference/google-cloud-migrationcenter/0.25.0/com.google.cloud.migrationcenter.v1.ImportJobOrBuilder)
...
### EXECUTION\_REPORT\_FIELD\_NUMBER

```
public static final int EXECUTION_REPORT_FIELD_NUMBER
```
...
### VALIDATION\_REPORT\_FIELD\_NUMBER

```
public static final int VALIDATION_REPORT_FIELD_NUMBER
```
...
`[ImportJob](/java/docs/reference/google-cloud-migrationcenter/0.25.0/com.google.cloud.migrationcenter.v1.ImportJob)`
...
`[ImportJob.Builder](/java/docs/reference/google-cloud-migrationcenter/0.25.0/com.google.cloud.migrationcenter.v1.ImportJob.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ImportJob](/java/docs/reference/google-cloud-migrationcenter/0.25.0/com.google.cloud.migrationcenter.v1.ImportJob)>`
...
`[ExecutionReport](/java/docs/reference/google-cloud-migrationcenter/0.25.0/com.google.cloud.migrationcenter.v1.ExecutionReport)`
...
`[ExecutionReportOrBuilder](/java/docs/reference/google-cloud-migrationcenter/0.25.0/com.google.cloud.migrationcenter.v1.ExecutionReportOrBuilder)`
...
Use [#getLabelsMap()](/java/docs/reference/google-cloud-migrationcenter/0.25.0/com.google.cloud.migrationcenter.v1.ImportJob#com_google_cloud_migrationcenter_v1_ImportJob_getLabelsMap__) instead.
...
`[ImportJob.ReportCase](/java/docs/reference/google-cloud-migrationcenter/0.25.0/com.google.cloud.migrationcenter.v1.ImportJob.ReportCase)`
...
`[ImportJob.ImportJobState](/java/docs/reference/google-cloud-migrationcenter/0.25.0/com.google.cloud.migrationcenter.v1.ImportJob.ImportJobState)`
...
`[ValidationReport](/java/docs/reference/google-cloud-migrationcenter/0.25.0/com.google.cloud.migrationcenter.v1.ValidationReport)`
...
`[ValidationReportOrBuilder](/java/docs/reference/google-cloud-migrationcenter/0.25.0/com.google.cloud.migrationcenter.v1.ValidationReportOrBuilder)`
