...
# Enum OperationMetadata.Type (1.7.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-orchestration-airflow/1.7.0/com.google.cloud.orchestration.airflow.service.v1beta1.OperationMetadata.Type#com_google_cloud_orchestration_airflow_service_v1beta1_OperationMetadata_Type_forNumber_int_) instead._
