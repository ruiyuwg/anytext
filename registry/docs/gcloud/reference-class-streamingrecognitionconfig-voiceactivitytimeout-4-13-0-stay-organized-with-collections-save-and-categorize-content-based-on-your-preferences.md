...
# Class StreamingRecognitionConfig.VoiceActivityTimeout (4.13.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class StreamingRecognitionConfig.VoiceActivityTimeout extends GeneratedMessageV3 implements StreamingRecognitionConfig.VoiceActivityTimeoutOrBuilder
```

Events that a timeout can be set on for voice activity.

Protobuf type `google.cloud.speech.v1p1beta1.StreamingRecognitionConfig.VoiceActivityTimeout`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> StreamingRecognitionConfig.VoiceActivityTimeout

## Implements

[StreamingRecognitionConfig.VoiceActivityTimeoutOrBuilder](/java/docs/reference/google-cloud-speech/4.13.0/com.google.cloud.speech.v1p1beta1.StreamingRecognitionConfig.VoiceActivityTimeoutOrBuilder)
...
### SPEECH\_END\_TIMEOUT\_FIELD\_NUMBER

```
public static final int SPEECH_END_TIMEOUT_FIELD_NUMBER
```
...
### SPEECH\_START\_TIMEOUT\_FIELD\_NUMBER

```
public static final int SPEECH_START_TIMEOUT_FIELD_NUMBER
```
...
```
public static StreamingRecognitionConfig.VoiceActivityTimeout getDefaultInstance()
```
...
`[StreamingRecognitionConfig.VoiceActivityTimeout](/java/docs/reference/google-cloud-speech/4.13.0/com.google.cloud.speech.v1p1beta1.StreamingRecognitionConfig.VoiceActivityTimeout)`
...
```
public static StreamingRecognitionConfig.VoiceActivityTimeout.Builder newBuilder()
```
...
`[StreamingRecognitionConfig.VoiceActivityTimeout.Builder](/java/docs/reference/google-cloud-speech/4.13.0/com.google.cloud.speech.v1p1beta1.StreamingRecognitionConfig.VoiceActivityTimeout.Builder)`

### newBuilder(StreamingRecognitionConfig.VoiceActivityTimeout prototype)

```
public static StreamingRecognitionConfig.VoiceActivityTimeout.Builder newBuilder(StreamingRecognitionConfig.VoiceActivityTimeout prototype)
```
...
```
public static StreamingRecognitionConfig.VoiceActivityTimeout parseDelimitedFrom(InputStream input)
```
...
```
public static StreamingRecognitionConfig.VoiceActivityTimeout parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static StreamingRecognitionConfig.VoiceActivityTimeout parseFrom(byte[] data)
```
...
```
public static StreamingRecognitionConfig.VoiceActivityTimeout parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static StreamingRecognitionConfig.VoiceActivityTimeout parseFrom(ByteString data)
```
...
```
public static StreamingRecognitionConfig.VoiceActivityTimeout parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static StreamingRecognitionConfig.VoiceActivityTimeout parseFrom(CodedInputStream input)
```
...
```
public static StreamingRecognitionConfig.VoiceActivityTimeout parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static StreamingRecognitionConfig.VoiceActivityTimeout parseFrom(InputStream input)
```
...
```
public static StreamingRecognitionConfig.VoiceActivityTimeout parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static StreamingRecognitionConfig.VoiceActivityTimeout parseFrom(ByteBuffer data)
```
...
```
public static StreamingRecognitionConfig.VoiceActivityTimeout parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<StreamingRecognitionConfig.VoiceActivityTimeout> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[VoiceActivityTimeout](/java/docs/reference/google-cloud-speech/4.13.0/com.google.cloud.speech.v1p1beta1.StreamingRecognitionConfig.VoiceActivityTimeout)>`
...
```
public StreamingRecognitionConfig.VoiceActivityTimeout getDefaultInstanceForType()
```
...
```
public Parser<StreamingRecognitionConfig.VoiceActivityTimeout> getParserForType()
```
...
```
public StreamingRecognitionConfig.VoiceActivityTimeout.Builder newBuilderForType()
```
...
```
protected StreamingRecognitionConfig.VoiceActivityTimeout.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public StreamingRecognitionConfig.VoiceActivityTimeout.Builder toBuilder()
```
