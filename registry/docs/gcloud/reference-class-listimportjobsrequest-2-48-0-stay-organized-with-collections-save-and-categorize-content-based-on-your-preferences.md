...
# Class ListImportJobsRequest (2.48.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListImportJobsRequest extends GeneratedMessageV3 implements ListImportJobsRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListImportJobsRequest

## Implements

[ListImportJobsRequestOrBuilder](/java/docs/reference/google-cloud-kms/2.48.0/com.google.cloud.kms.v1.ListImportJobsRequestOrBuilder)
...
```
public static ListImportJobsRequest getDefaultInstance()
```
...
`[ListImportJobsRequest](/java/docs/reference/google-cloud-kms/2.48.0/com.google.cloud.kms.v1.ListImportJobsRequest)`
...
```
public static ListImportJobsRequest.Builder newBuilder()
```
...
`[ListImportJobsRequest.Builder](/java/docs/reference/google-cloud-kms/2.48.0/com.google.cloud.kms.v1.ListImportJobsRequest.Builder)`

### newBuilder(ListImportJobsRequest prototype)

```
public static ListImportJobsRequest.Builder newBuilder(ListImportJobsRequest prototype)
```
...
```
public static ListImportJobsRequest parseDelimitedFrom(InputStream input)
```
...
```
public static ListImportJobsRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListImportJobsRequest parseFrom(byte[] data)
```
...
```
public static ListImportJobsRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListImportJobsRequest parseFrom(ByteString data)
```
...
```
public static ListImportJobsRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListImportJobsRequest parseFrom(CodedInputStream input)
```
...
```
public static ListImportJobsRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListImportJobsRequest parseFrom(InputStream input)
```
...
```
public static ListImportJobsRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListImportJobsRequest parseFrom(ByteBuffer data)
```
...
```
public static ListImportJobsRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ListImportJobsRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListImportJobsRequest](/java/docs/reference/google-cloud-kms/2.48.0/com.google.cloud.kms.v1.ListImportJobsRequest)>`
...
```
public ListImportJobsRequest getDefaultInstanceForType()
```
...
```
public Parser<ListImportJobsRequest> getParserForType()
```
...
```
public ListImportJobsRequest.Builder newBuilderForType()
```
...
```
protected ListImportJobsRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ListImportJobsRequest.Builder toBuilder()
```
