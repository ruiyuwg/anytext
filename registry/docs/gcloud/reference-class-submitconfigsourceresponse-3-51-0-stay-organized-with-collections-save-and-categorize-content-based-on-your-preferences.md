...
# Class SubmitConfigSourceResponse (3.51.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class SubmitConfigSourceResponse extends GeneratedMessageV3 implements SubmitConfigSourceResponseOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> SubmitConfigSourceResponse

## Implements

[SubmitConfigSourceResponseOrBuilder](/java/docs/reference/google-cloud-service-management/3.51.0/com.google.api.servicemanagement.v1.SubmitConfigSourceResponseOrBuilder)
...
### SERVICE\_CONFIG\_FIELD\_NUMBER
...
```
public static SubmitConfigSourceResponse getDefaultInstance()
```
...
`[SubmitConfigSourceResponse](/java/docs/reference/google-cloud-service-management/3.51.0/com.google.api.servicemanagement.v1.SubmitConfigSourceResponse)`
...
```
public static SubmitConfigSourceResponse.Builder newBuilder()
```
...
`[SubmitConfigSourceResponse.Builder](/java/docs/reference/google-cloud-service-management/3.51.0/com.google.api.servicemanagement.v1.SubmitConfigSourceResponse.Builder)`

### newBuilder(SubmitConfigSourceResponse prototype)

```
public static SubmitConfigSourceResponse.Builder newBuilder(SubmitConfigSourceResponse prototype)
```
...
```
public static SubmitConfigSourceResponse parseDelimitedFrom(InputStream input)
```
...
```
public static SubmitConfigSourceResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SubmitConfigSourceResponse parseFrom(byte[] data)
```
...
```
public static SubmitConfigSourceResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SubmitConfigSourceResponse parseFrom(ByteString data)
```
...
```
public static SubmitConfigSourceResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SubmitConfigSourceResponse parseFrom(CodedInputStream input)
```
...
```
public static SubmitConfigSourceResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SubmitConfigSourceResponse parseFrom(InputStream input)
```
...
```
public static SubmitConfigSourceResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SubmitConfigSourceResponse parseFrom(ByteBuffer data)
```
...
```
public static SubmitConfigSourceResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<SubmitConfigSourceResponse> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[SubmitConfigSourceResponse](/java/docs/reference/google-cloud-service-management/3.51.0/com.google.api.servicemanagement.v1.SubmitConfigSourceResponse)>`
...
```
public SubmitConfigSourceResponse getDefaultInstanceForType()
```
...
```
public Parser<SubmitConfigSourceResponse> getParserForType()
```
...
```
public ServiceOrBuilder getServiceConfigOrBuilder()
```
...
```
public SubmitConfigSourceResponse.Builder newBuilderForType()
```
...
```
protected SubmitConfigSourceResponse.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public SubmitConfigSourceResponse.Builder toBuilder()
```
