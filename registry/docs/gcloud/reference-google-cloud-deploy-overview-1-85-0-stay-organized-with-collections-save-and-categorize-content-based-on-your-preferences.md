...
# google-cloud-deploy overview (1.85.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Google Cloud Deploy Description:** Is a service that automates delivery of your applications to a series of target environments in a defined sequence

[Google Cloud Deploy Product Reference](https://cloud.google.com/deploy/docs)

[GitHub Repository](https://github.com/googleapis/google-cloud-java/tree/main/java-deploy)

[Maven artifact](https://central.sonatype.com/artifact/com.google.cloud/google-cloud-deploy)
...
-   [Enable the API](https://console.cloud.google.com/apis/library/clouddeploy.googleapis.com)
-   [Set up authentication](https://cloud.google.com/docs/authentication/client-libraries)

## Use the Google Cloud Deploy for Java
...
The example below demonstrates how you would import the BOM and include the `google-cloud-deploy` artifact.
...
implementation("com.google.cloud:google-cloud-deploy")
...
libraryDependencies += "com.google.cloud" % "google-cloud-deploy" % "1.85.0"

## Which version ID should I get started with?

For this library, we recommend using [com.google.cloud.deploy.v1](https://cloud.google.com/java/docs/reference/google-cloud-deploy/1.85.0/com.google.cloud.deploy.v1) for new applications.
