...
# Enum AwsVmDetails.VmArchitecture (1.49.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum AwsVmDetails.VmArchitecture extends Enum<AwsVmDetails.VmArchitecture> implements ProtocolMessageEnum
```
...
`VM_ARCHITECTURE_UNSPECIFIED_VALUE`
...
The architecture is X86\_64.

`X86_64 = 2;`

`X86_64_MAC`

The architecture is X86\_64\_MAC.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-vmmigration/1.49.0/com.google.cloud.vmmigration.v1.AwsVmDetails.VmArchitecture#com_google_cloud_vmmigration_v1_AwsVmDetails_VmArchitecture_forNumber_int_) instead._
