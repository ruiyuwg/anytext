...
# Interface ResourceRequirementsOrBuilder (0.13.0) Stay organized with collections Save and categorize content based on your preferences.
...
Only memory and CPU are supported. Note: The only supported values for CPU are '1', '2', '4', and '8'. Setting 4 CPU requires at least 2Gi of memory. The values of the map is string form of the 'quantity' k8s type: [https://github.com/kubernetes/kubernetes/blob/master/staging/src/k8s.io/apimachinery/pkg/api/resource/quantity.go](https://github.com/kubernetes/kubernetes/blob/master/staging/src/k8s.io/apimachinery/pkg/api/resource/quantity.go)
...
Use [#getLimitsMap()](/java/docs/reference/google-cloud-run/0.13.0/com.google.cloud.run.v2.ResourceRequirementsOrBuilder#com_google_cloud_run_v2_ResourceRequirementsOrBuilder_getLimitsMap__) instead.
