...
# Class DeleteEndpointRequest (2.17.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class DeleteEndpointRequest extends GeneratedMessageV3 implements DeleteEndpointRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> DeleteEndpointRequest

## Implements

[DeleteEndpointRequestOrBuilder](/java/docs/reference/google-cloud-servicedirectory/2.17.0/com.google.cloud.servicedirectory.v1.DeleteEndpointRequestOrBuilder)
...
```
public static DeleteEndpointRequest getDefaultInstance()
```
...
`[DeleteEndpointRequest](/java/docs/reference/google-cloud-servicedirectory/2.17.0/com.google.cloud.servicedirectory.v1.DeleteEndpointRequest)`
...
```
public static DeleteEndpointRequest.Builder newBuilder()
```
...
`[DeleteEndpointRequest.Builder](/java/docs/reference/google-cloud-servicedirectory/2.17.0/com.google.cloud.servicedirectory.v1.DeleteEndpointRequest.Builder)`

### newBuilder(DeleteEndpointRequest prototype)

```
public static DeleteEndpointRequest.Builder newBuilder(DeleteEndpointRequest prototype)
```
...
```
public static DeleteEndpointRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteEndpointRequest parseFrom(byte[] data)
```
...
```
public static DeleteEndpointRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteEndpointRequest parseFrom(ByteString data)
```
...
```
public static DeleteEndpointRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteEndpointRequest parseFrom(CodedInputStream input)
```
...
```
public static DeleteEndpointRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteEndpointRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteEndpointRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<DeleteEndpointRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[DeleteEndpointRequest](/java/docs/reference/google-cloud-servicedirectory/2.17.0/com.google.cloud.servicedirectory.v1.DeleteEndpointRequest)>`
...
```
public Parser<DeleteEndpointRequest> getParserForType()
```
...
```
public DeleteEndpointRequest.Builder newBuilderForType()
```
...
```
protected DeleteEndpointRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public DeleteEndpointRequest.Builder toBuilder()
```
