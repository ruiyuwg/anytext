...
# Class SearchUrisResponse.ThreatUri (2.5.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class SearchUrisResponse.ThreatUri extends GeneratedMessageV3 implements SearchUrisResponse.ThreatUriOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> SearchUrisResponse.ThreatUri

## Implements

[SearchUrisResponse.ThreatUriOrBuilder](/java/docs/reference/google-cloud-webrisk/2.5.0/com.google.webrisk.v1beta1.SearchUrisResponse.ThreatUriOrBuilder)
...
```
public static SearchUrisResponse.ThreatUri getDefaultInstance()
```
...
[SearchUrisResponse.ThreatUri](/java/docs/reference/google-cloud-webrisk/2.5.0/com.google.webrisk.v1beta1.SearchUrisResponse.ThreatUri)
...
```
public static SearchUrisResponse.ThreatUri.Builder newBuilder()
```
...
[SearchUrisResponse.ThreatUri.Builder](/java/docs/reference/google-cloud-webrisk/2.5.0/com.google.webrisk.v1beta1.SearchUrisResponse.ThreatUri.Builder)

### newBuilder(SearchUrisResponse.ThreatUri prototype)

```
public static SearchUrisResponse.ThreatUri.Builder newBuilder(SearchUrisResponse.ThreatUri prototype)
```
...
```
public static SearchUrisResponse.ThreatUri parseDelimitedFrom(InputStream input)
```
...
```
public static SearchUrisResponse.ThreatUri parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SearchUrisResponse.ThreatUri parseFrom(byte[] data)
```
...
```
public static SearchUrisResponse.ThreatUri parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SearchUrisResponse.ThreatUri parseFrom(ByteString data)
```
...
```
public static SearchUrisResponse.ThreatUri parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SearchUrisResponse.ThreatUri parseFrom(CodedInputStream input)
```
...
```
public static SearchUrisResponse.ThreatUri parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SearchUrisResponse.ThreatUri parseFrom(InputStream input)
```
...
```
public static SearchUrisResponse.ThreatUri parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SearchUrisResponse.ThreatUri parseFrom(ByteBuffer data)
```
...
```
public static SearchUrisResponse.ThreatUri parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<SearchUrisResponse.ThreatUri> parser()
```
...
[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ThreatUri](/java/docs/reference/google-cloud-webrisk/2.5.0/com.google.webrisk.v1beta1.SearchUrisResponse.ThreatUri)\>
...
```
public Parser<SearchUrisResponse.ThreatUri> getParserForType()
```
...
[ThreatType](/java/docs/reference/google-cloud-webrisk/2.5.0/com.google.webrisk.v1beta1.ThreatType)
...
[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ThreatType](/java/docs/reference/google-cloud-webrisk/2.5.0/com.google.webrisk.v1beta1.ThreatType)\>
...
```
public SearchUrisResponse.ThreatUri.Builder newBuilderForType()
```
...
```
protected SearchUrisResponse.ThreatUri.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public SearchUrisResponse.ThreatUri.Builder toBuilder()
```
