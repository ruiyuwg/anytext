...
# Class ListOSPolicyAssignmentRevisionsRequest (2.16.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListOSPolicyAssignmentRevisionsRequest extends GeneratedMessageV3 implements ListOSPolicyAssignmentRevisionsRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListOSPolicyAssignmentRevisionsRequest

## Implements

[ListOSPolicyAssignmentRevisionsRequestOrBuilder](/java/docs/reference/google-cloud-os-config/2.16.0/com.google.cloud.osconfig.v1alpha.ListOSPolicyAssignmentRevisionsRequestOrBuilder)
...
```
public static ListOSPolicyAssignmentRevisionsRequest getDefaultInstance()
```
...
`[ListOSPolicyAssignmentRevisionsRequest](/java/docs/reference/google-cloud-os-config/2.16.0/com.google.cloud.osconfig.v1alpha.ListOSPolicyAssignmentRevisionsRequest)`
...
```
public static ListOSPolicyAssignmentRevisionsRequest.Builder newBuilder()
```
...
`[ListOSPolicyAssignmentRevisionsRequest.Builder](/java/docs/reference/google-cloud-os-config/2.16.0/com.google.cloud.osconfig.v1alpha.ListOSPolicyAssignmentRevisionsRequest.Builder)`

### newBuilder(ListOSPolicyAssignmentRevisionsRequest prototype)

```
public static ListOSPolicyAssignmentRevisionsRequest.Builder newBuilder(ListOSPolicyAssignmentRevisionsRequest prototype)
```
...
```
public static ListOSPolicyAssignmentRevisionsRequest parseDelimitedFrom(InputStream input)
```
...
```
public static ListOSPolicyAssignmentRevisionsRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListOSPolicyAssignmentRevisionsRequest parseFrom(byte[] data)
```
...
```
public static ListOSPolicyAssignmentRevisionsRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListOSPolicyAssignmentRevisionsRequest parseFrom(ByteString data)
```
...
```
public static ListOSPolicyAssignmentRevisionsRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListOSPolicyAssignmentRevisionsRequest parseFrom(CodedInputStream input)
```
...
```
public static ListOSPolicyAssignmentRevisionsRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListOSPolicyAssignmentRevisionsRequest parseFrom(InputStream input)
```
...
```
public static ListOSPolicyAssignmentRevisionsRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListOSPolicyAssignmentRevisionsRequest parseFrom(ByteBuffer data)
```
...
```
public static ListOSPolicyAssignmentRevisionsRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ListOSPolicyAssignmentRevisionsRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListOSPolicyAssignmentRevisionsRequest](/java/docs/reference/google-cloud-os-config/2.16.0/com.google.cloud.osconfig.v1alpha.ListOSPolicyAssignmentRevisionsRequest)>`
...
```
public ListOSPolicyAssignmentRevisionsRequest getDefaultInstanceForType()
```
...
```
public Parser<ListOSPolicyAssignmentRevisionsRequest> getParserForType()
```
...
```
public ListOSPolicyAssignmentRevisionsRequest.Builder newBuilderForType()
```
...
```
protected ListOSPolicyAssignmentRevisionsRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ListOSPolicyAssignmentRevisionsRequest.Builder toBuilder()
```
