...
# Class ExportAnalyticsMetricsResponse (2.50.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ExportAnalyticsMetricsResponse extends GeneratedMessageV3 implements ExportAnalyticsMetricsResponseOrBuilder
```
...
Protobuf type `google.cloud.retail.v2.ExportAnalyticsMetricsResponse`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ExportAnalyticsMetricsResponse

## Implements

[ExportAnalyticsMetricsResponseOrBuilder](/java/docs/reference/google-cloud-retail/2.50.0/com.google.cloud.retail.v2.ExportAnalyticsMetricsResponseOrBuilder)
...
```
public static ExportAnalyticsMetricsResponse getDefaultInstance()
```
...
`[ExportAnalyticsMetricsResponse](/java/docs/reference/google-cloud-retail/2.50.0/com.google.cloud.retail.v2.ExportAnalyticsMetricsResponse)`
...
```
public static ExportAnalyticsMetricsResponse.Builder newBuilder()
```
...
`[ExportAnalyticsMetricsResponse.Builder](/java/docs/reference/google-cloud-retail/2.50.0/com.google.cloud.retail.v2.ExportAnalyticsMetricsResponse.Builder)`

### newBuilder(ExportAnalyticsMetricsResponse prototype)

```
public static ExportAnalyticsMetricsResponse.Builder newBuilder(ExportAnalyticsMetricsResponse prototype)
```
...
```
public static ExportAnalyticsMetricsResponse parseDelimitedFrom(InputStream input)
```
...
```
public static ExportAnalyticsMetricsResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ExportAnalyticsMetricsResponse parseFrom(byte[] data)
```
...
```
public static ExportAnalyticsMetricsResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ExportAnalyticsMetricsResponse parseFrom(ByteString data)
```
...
```
public static ExportAnalyticsMetricsResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ExportAnalyticsMetricsResponse parseFrom(CodedInputStream input)
```
...
```
public static ExportAnalyticsMetricsResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ExportAnalyticsMetricsResponse parseFrom(InputStream input)
```
...
```
public static ExportAnalyticsMetricsResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ExportAnalyticsMetricsResponse parseFrom(ByteBuffer data)
```
...
```
public static ExportAnalyticsMetricsResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ExportAnalyticsMetricsResponse> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ExportAnalyticsMetricsResponse](/java/docs/reference/google-cloud-retail/2.50.0/com.google.cloud.retail.v2.ExportAnalyticsMetricsResponse)>`
...
```
public ExportAnalyticsMetricsResponse getDefaultInstanceForType()
```
...
`.google.cloud.retail.v2.ExportErrorsConfig errors_config = 2;`
...
`[ExportErrorsConfig](/java/docs/reference/google-cloud-retail/2.50.0/com.google.cloud.retail.v2.ExportErrorsConfig)`
...
`[ExportErrorsConfigOrBuilder](/java/docs/reference/google-cloud-retail/2.50.0/com.google.cloud.retail.v2.ExportErrorsConfigOrBuilder)`
...
`.google.cloud.retail.v2.OutputResult output_result = 3;`
...
`[OutputResult](/java/docs/reference/google-cloud-retail/2.50.0/com.google.cloud.retail.v2.OutputResult)`
...
`[OutputResultOrBuilder](/java/docs/reference/google-cloud-retail/2.50.0/com.google.cloud.retail.v2.OutputResultOrBuilder)`

### getParserForType()

```
public Parser<ExportAnalyticsMetricsResponse> getParserForType()
```
...
```
public ExportAnalyticsMetricsResponse.Builder newBuilderForType()
```
...
```
protected ExportAnalyticsMetricsResponse.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ExportAnalyticsMetricsResponse.Builder toBuilder()
```
