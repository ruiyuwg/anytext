...
# Interface Service.CustomOrBuilder (3.58.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static interface Service.CustomOrBuilder extends MessageOrBuilder
```
