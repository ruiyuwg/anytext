...
# Class BatchAnnotateFilesResponse (3.52.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class BatchAnnotateFilesResponse extends GeneratedMessageV3 implements BatchAnnotateFilesResponseOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> BatchAnnotateFilesResponse

## Implements

[BatchAnnotateFilesResponseOrBuilder](/java/docs/reference/google-cloud-vision/3.52.0/com.google.cloud.vision.v1p4beta1.BatchAnnotateFilesResponseOrBuilder)
...
```
public static BatchAnnotateFilesResponse getDefaultInstance()
```
...
`[BatchAnnotateFilesResponse](/java/docs/reference/google-cloud-vision/3.52.0/com.google.cloud.vision.v1p4beta1.BatchAnnotateFilesResponse)`
...
```
public static BatchAnnotateFilesResponse.Builder newBuilder()
```
...
`[BatchAnnotateFilesResponse.Builder](/java/docs/reference/google-cloud-vision/3.52.0/com.google.cloud.vision.v1p4beta1.BatchAnnotateFilesResponse.Builder)`

### newBuilder(BatchAnnotateFilesResponse prototype)

```
public static BatchAnnotateFilesResponse.Builder newBuilder(BatchAnnotateFilesResponse prototype)
```
...
```
public static BatchAnnotateFilesResponse parseDelimitedFrom(InputStream input)
```
...
```
public static BatchAnnotateFilesResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static BatchAnnotateFilesResponse parseFrom(byte[] data)
```
...
```
public static BatchAnnotateFilesResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static BatchAnnotateFilesResponse parseFrom(ByteString data)
```
...
```
public static BatchAnnotateFilesResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static BatchAnnotateFilesResponse parseFrom(CodedInputStream input)
```
...
```
public static BatchAnnotateFilesResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static BatchAnnotateFilesResponse parseFrom(InputStream input)
```
...
```
public static BatchAnnotateFilesResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static BatchAnnotateFilesResponse parseFrom(ByteBuffer data)
```
...
```
public static BatchAnnotateFilesResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<BatchAnnotateFilesResponse> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[BatchAnnotateFilesResponse](/java/docs/reference/google-cloud-vision/3.52.0/com.google.cloud.vision.v1p4beta1.BatchAnnotateFilesResponse)>`
...
```
public Parser<BatchAnnotateFilesResponse> getParserForType()
```
...
`[AnnotateFileResponse](/java/docs/reference/google-cloud-vision/3.52.0/com.google.cloud.vision.v1p4beta1.AnnotateFileResponse)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[AnnotateFileResponse](/java/docs/reference/google-cloud-vision/3.52.0/com.google.cloud.vision.v1p4beta1.AnnotateFileResponse)>`
...
`[AnnotateFileResponseOrBuilder](/java/docs/reference/google-cloud-vision/3.52.0/com.google.cloud.vision.v1p4beta1.AnnotateFileResponseOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.vision.v1p4beta1.AnnotateFileResponseOrBuilder>`
...
```
public BatchAnnotateFilesResponse.Builder newBuilderForType()
```
...
```
protected BatchAnnotateFilesResponse.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public BatchAnnotateFilesResponse.Builder toBuilder()
```
