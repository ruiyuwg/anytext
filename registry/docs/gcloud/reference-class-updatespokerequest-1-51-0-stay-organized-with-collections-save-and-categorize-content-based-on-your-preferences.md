...
# Class UpdateSpokeRequest (1.51.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class UpdateSpokeRequest extends GeneratedMessageV3 implements UpdateSpokeRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> UpdateSpokeRequest

## Implements

[UpdateSpokeRequestOrBuilder](/java/docs/reference/google-cloud-networkconnectivity/1.51.0/com.google.cloud.networkconnectivity.v1.UpdateSpokeRequestOrBuilder)
...
```
public static UpdateSpokeRequest getDefaultInstance()
```
...
`[UpdateSpokeRequest](/java/docs/reference/google-cloud-networkconnectivity/1.51.0/com.google.cloud.networkconnectivity.v1.UpdateSpokeRequest)`
...
```
public static UpdateSpokeRequest.Builder newBuilder()
```
...
`[UpdateSpokeRequest.Builder](/java/docs/reference/google-cloud-networkconnectivity/1.51.0/com.google.cloud.networkconnectivity.v1.UpdateSpokeRequest.Builder)`

### newBuilder(UpdateSpokeRequest prototype)

```
public static UpdateSpokeRequest.Builder newBuilder(UpdateSpokeRequest prototype)
```
...
```
public static UpdateSpokeRequest parseDelimitedFrom(InputStream input)
```
...
```
public static UpdateSpokeRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateSpokeRequest parseFrom(byte[] data)
```
...
```
public static UpdateSpokeRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateSpokeRequest parseFrom(ByteString data)
```
...
```
public static UpdateSpokeRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateSpokeRequest parseFrom(CodedInputStream input)
```
...
```
public static UpdateSpokeRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateSpokeRequest parseFrom(InputStream input)
```
...
```
public static UpdateSpokeRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateSpokeRequest parseFrom(ByteBuffer data)
```
...
```
public static UpdateSpokeRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<UpdateSpokeRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[UpdateSpokeRequest](/java/docs/reference/google-cloud-networkconnectivity/1.51.0/com.google.cloud.networkconnectivity.v1.UpdateSpokeRequest)>`
...
```
public Parser<UpdateSpokeRequest> getParserForType()
```
...
`[Spoke](/java/docs/reference/google-cloud-networkconnectivity/1.51.0/com.google.cloud.networkconnectivity.v1.Spoke)`
...
`[SpokeOrBuilder](/java/docs/reference/google-cloud-networkconnectivity/1.51.0/com.google.cloud.networkconnectivity.v1.SpokeOrBuilder)`
...
```
public UpdateSpokeRequest.Builder newBuilderForType()
```
...
```
protected UpdateSpokeRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public UpdateSpokeRequest.Builder toBuilder()
```
