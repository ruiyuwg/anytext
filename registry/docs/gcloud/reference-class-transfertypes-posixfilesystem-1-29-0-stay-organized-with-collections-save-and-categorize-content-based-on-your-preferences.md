...
# Class TransferTypes.PosixFilesystem (1.29.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class TransferTypes.PosixFilesystem extends GeneratedMessageV3 implements TransferTypes.PosixFilesystemOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> TransferTypes.PosixFilesystem

## Implements

[TransferTypes.PosixFilesystemOrBuilder](/java/docs/reference/google-cloud-storage-transfer/1.29.0/com.google.storagetransfer.v1.proto.TransferTypes.PosixFilesystemOrBuilder)
...
### ROOT\_DIRECTORY\_FIELD\_NUMBER

```
public static final int ROOT_DIRECTORY_FIELD_NUMBER
```
...
```
public static TransferTypes.PosixFilesystem getDefaultInstance()
```
...
`[TransferTypes.PosixFilesystem](/java/docs/reference/google-cloud-storage-transfer/1.29.0/com.google.storagetransfer.v1.proto.TransferTypes.PosixFilesystem)`
...
```
public static TransferTypes.PosixFilesystem.Builder newBuilder()
```
...
`[TransferTypes.PosixFilesystem.Builder](/java/docs/reference/google-cloud-storage-transfer/1.29.0/com.google.storagetransfer.v1.proto.TransferTypes.PosixFilesystem.Builder)`

### newBuilder(TransferTypes.PosixFilesystem prototype)

```
public static TransferTypes.PosixFilesystem.Builder newBuilder(TransferTypes.PosixFilesystem prototype)
```
...
```
public static TransferTypes.PosixFilesystem parseDelimitedFrom(InputStream input)
```
...
```
public static TransferTypes.PosixFilesystem parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static TransferTypes.PosixFilesystem parseFrom(byte[] data)
```
...
```
public static TransferTypes.PosixFilesystem parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static TransferTypes.PosixFilesystem parseFrom(ByteString data)
```
...
```
public static TransferTypes.PosixFilesystem parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static TransferTypes.PosixFilesystem parseFrom(CodedInputStream input)
```
...
```
public static TransferTypes.PosixFilesystem parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static TransferTypes.PosixFilesystem parseFrom(InputStream input)
```
...
```
public static TransferTypes.PosixFilesystem parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static TransferTypes.PosixFilesystem parseFrom(ByteBuffer data)
```
...
```
public static TransferTypes.PosixFilesystem parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<TransferTypes.PosixFilesystem> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[PosixFilesystem](/java/docs/reference/google-cloud-storage-transfer/1.29.0/com.google.storagetransfer.v1.proto.TransferTypes.PosixFilesystem)>`
...
```
public Parser<TransferTypes.PosixFilesystem> getParserForType()
```
...
```
public TransferTypes.PosixFilesystem.Builder newBuilderForType()
```
...
```
protected TransferTypes.PosixFilesystem.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public TransferTypes.PosixFilesystem.Builder toBuilder()
```
