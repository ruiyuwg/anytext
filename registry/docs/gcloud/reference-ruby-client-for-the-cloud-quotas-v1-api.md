...
-   [2.2.2 (latest)](/ruby/docs/reference/google-cloud-cloud_quotas-v1/latest)
-   [2.2.1](/ruby/docs/reference/google-cloud-cloud_quotas-v1/2.2.1)
-   [2.1.0](/ruby/docs/reference/google-cloud-cloud_quotas-v1/2.1.0)
-   [2.0.1](/ruby/docs/reference/google-cloud-cloud_quotas-v1/2.0.1)
-   [1.3.0](/ruby/docs/reference/google-cloud-cloud_quotas-v1/1.3.0)
-   [1.2.0](/ruby/docs/reference/google-cloud-cloud_quotas-v1/1.2.0)
-   [1.1.0](/ruby/docs/reference/google-cloud-cloud_quotas-v1/1.1.0)
-   [1.0.1](/ruby/docs/reference/google-cloud-cloud_quotas-v1/1.0.1)
-   [0.3.3](/ruby/docs/reference/google-cloud-cloud_quotas-v1/0.3.3)
-   [0.2.2](/ruby/docs/reference/google-cloud-cloud_quotas-v1/0.2.2)
-   [0.1.0](/ruby/docs/reference/google-cloud-cloud_quotas-v1/0.1.0)
...
This gem is a _versioned_ client. It provides basic client classes for a specific version of the Cloud Quotas V1 API. Most users should consider using the main client gem, [google-cloud-cloud\_quotas](https://rubygems.org/gems/google-cloud-cloud_quotas). See the section below titled _Which client should I use?_ for more information.
...
3.  [Enable the API.](https://console.cloud.google.com/apis/library/cloudquotas.googleapis.com)
4.  [Set up authentication.](https://docs.cloud.google.com/ruby/docs/reference/google-cloud-cloud_quotas-v1/latest/AUTHENTICATION "Set up authentication.")

## Quick Start

require "google/cloud/cloud\_quotas/v1"
...
response \= client.list\_quota\_infos request

View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-cloud_quotas-v1/latest) for class and method documentation.

See also the [Product Documentation](https://cloud.google.com/docs/quotas/api-overview) for general usage information.
...
Most modern Ruby client libraries for Google APIs come in two flavors: the main client library with a name such as `google-cloud-cloud_quotas`, and lower-level _versioned_ client libraries with names such as `google-cloud-cloud_quotas-v1`. _In most cases, you should install the main client._
...
You can use a versioned client if you are content with a possibly lower-level class interface, you explicitly want to avoid features provided by the main client, or you want to access a specific service version not be covered by the main client. You can identify versioned client gems because the service version is part of the name, e.g. `google-cloud-cloud_quotas-v1`.
