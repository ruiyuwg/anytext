...
# Class ClientConnectorService.Ingress.Config.DestinationRoute (0.16.0) Stay organized with collections Save and categorize content based on your preferences.

Version latestkeyboard\_arrow\_down

-   [0.16.0 (latest)](/java/docs/reference/google-cloudevent-types/latest/com.google.events.cloud.beyondcorp.clientconnectorservices.v1.ClientConnectorService.Ingress.Config.DestinationRoute)
-   [0.15.0](/java/docs/reference/google-cloudevent-types/0.15.0/com.google.events.cloud.beyondcorp.clientconnectorservices.v1.ClientConnectorService.Ingress.Config.DestinationRoute)
-   [0.14.1](/java/docs/reference/google-cloudevent-types/0.14.1/com.google.events.cloud.beyondcorp.clientconnectorservices.v1.ClientConnectorService.Ingress.Config.DestinationRoute)

```
public static final class ClientConnectorService.Ingress.Config.DestinationRoute extends GeneratedMessageV3 implements ClientConnectorService.Ingress.Config.DestinationRouteOrBuilder
```
...
Protobuf type `google.events.cloud.beyondcorp.clientconnectorservices.v1.ClientConnectorService.Ingress.Config.DestinationRoute`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ClientConnectorService.Ingress.Config.DestinationRoute

## Implements

[ClientConnectorService.Ingress.Config.DestinationRouteOrBuilder](/java/docs/reference/google-cloudevent-types/latest/com.google.events.cloud.beyondcorp.clientconnectorservices.v1.ClientConnectorService.Ingress.Config.DestinationRouteOrBuilder)
...
### NETMASK\_FIELD\_NUMBER

```
public static final int NETMASK_FIELD_NUMBER
```
...
```
public static ClientConnectorService.Ingress.Config.DestinationRoute getDefaultInstance()
```
...
`[ClientConnectorService.Ingress.Config.DestinationRoute](/java/docs/reference/google-cloudevent-types/latest/com.google.events.cloud.beyondcorp.clientconnectorservices.v1.ClientConnectorService.Ingress.Config.DestinationRoute)`
...
```
public static ClientConnectorService.Ingress.Config.DestinationRoute.Builder newBuilder()
```
...
`[ClientConnectorService.Ingress.Config.DestinationRoute.Builder](/java/docs/reference/google-cloudevent-types/latest/com.google.events.cloud.beyondcorp.clientconnectorservices.v1.ClientConnectorService.Ingress.Config.DestinationRoute.Builder)`

### newBuilder(ClientConnectorService.Ingress.Config.DestinationRoute prototype)

```
public static ClientConnectorService.Ingress.Config.DestinationRoute.Builder newBuilder(ClientConnectorService.Ingress.Config.DestinationRoute prototype)
```
...
```
public static ClientConnectorService.Ingress.Config.DestinationRoute parseDelimitedFrom(InputStream input)
```
...
```
public static ClientConnectorService.Ingress.Config.DestinationRoute parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ClientConnectorService.Ingress.Config.DestinationRoute parseFrom(byte[] data)
```
...
```
public static ClientConnectorService.Ingress.Config.DestinationRoute parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ClientConnectorService.Ingress.Config.DestinationRoute parseFrom(ByteString data)
```
...
```
public static ClientConnectorService.Ingress.Config.DestinationRoute parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ClientConnectorService.Ingress.Config.DestinationRoute parseFrom(CodedInputStream input)
```
...
```
public static ClientConnectorService.Ingress.Config.DestinationRoute parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ClientConnectorService.Ingress.Config.DestinationRoute parseFrom(InputStream input)
```
...
```
public static ClientConnectorService.Ingress.Config.DestinationRoute parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ClientConnectorService.Ingress.Config.DestinationRoute parseFrom(ByteBuffer data)
```
...
```
public static ClientConnectorService.Ingress.Config.DestinationRoute parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ClientConnectorService.Ingress.Config.DestinationRoute> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[DestinationRoute](/java/docs/reference/google-cloudevent-types/latest/com.google.events.cloud.beyondcorp.clientconnectorservices.v1.ClientConnectorService.Ingress.Config.DestinationRoute)>`
...
```
public Parser<ClientConnectorService.Ingress.Config.DestinationRoute> getParserForType()
```
...
```
public ClientConnectorService.Ingress.Config.DestinationRoute.Builder newBuilderForType()
```
...
```
protected ClientConnectorService.Ingress.Config.DestinationRoute.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ClientConnectorService.Ingress.Config.DestinationRoute.Builder toBuilder()
```
