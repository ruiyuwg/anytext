...
# Class NetworkEndpoint.Builder (2.23.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> NetworkEndpoint.Builder

## Implements

[NetworkEndpointOrBuilder](/java/docs/reference/google-cloud-tpu/2.23.0/com.google.cloud.tpu.v2alpha1.NetworkEndpointOrBuilder)
...
`[NetworkEndpoint.Builder](/java/docs/reference/google-cloud-tpu/2.23.0/com.google.cloud.tpu.v2alpha1.NetworkEndpoint.Builder)`
...
`[NetworkEndpoint](/java/docs/reference/google-cloud-tpu/2.23.0/com.google.cloud.tpu.v2alpha1.NetworkEndpoint)`
...
```
public NetworkEndpoint.Builder clearAccessConfig()
```
...
`[AccessConfig](/java/docs/reference/google-cloud-tpu/2.23.0/com.google.cloud.tpu.v2alpha1.AccessConfig)`
...
`[AccessConfig.Builder](/java/docs/reference/google-cloud-tpu/2.23.0/com.google.cloud.tpu.v2alpha1.AccessConfig.Builder)`
...
`[AccessConfigOrBuilder](/java/docs/reference/google-cloud-tpu/2.23.0/com.google.cloud.tpu.v2alpha1.AccessConfigOrBuilder)`
...
```
public NetworkEndpoint.Builder mergeAccessConfig(AccessConfig value)
```
...
```
public NetworkEndpoint.Builder setAccessConfig(AccessConfig value)
```
...
```
public NetworkEndpoint.Builder setAccessConfig(AccessConfig.Builder builderForValue)
```
