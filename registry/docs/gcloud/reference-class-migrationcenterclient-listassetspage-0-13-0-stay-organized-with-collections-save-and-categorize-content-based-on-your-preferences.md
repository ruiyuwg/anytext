...
# Class MigrationCenterClient.ListAssetsPage (0.13.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class MigrationCenterClient.ListAssetsPage extends AbstractPage<ListAssetsRequest,ListAssetsResponse,Asset,MigrationCenterClient.ListAssetsPage>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractPage](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractPage.html) \> MigrationCenterClient.ListAssetsPage
...
```
protected MigrationCenterClient.ListAssetsPage createPage(PageContext<ListAssetsRequest,ListAssetsResponse,Asset> context, ListAssetsResponse response)
```
...
`[PageContext](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PageContext.html)<[ListAssetsRequest](/java/docs/reference/google-cloud-migrationcenter/0.13.0/com.google.cloud.migrationcenter.v1.ListAssetsRequest),[ListAssetsResponse](/java/docs/reference/google-cloud-migrationcenter/0.13.0/com.google.cloud.migrationcenter.v1.ListAssetsResponse),[Asset](/java/docs/reference/google-cloud-migrationcenter/0.13.0/com.google.cloud.migrationcenter.v1.Asset)>`  

`response`

`[ListAssetsResponse](/java/docs/reference/google-cloud-migrationcenter/0.13.0/com.google.cloud.migrationcenter.v1.ListAssetsResponse)`  
...
`[MigrationCenterClient.ListAssetsPage](/java/docs/reference/google-cloud-migrationcenter/0.13.0/com.google.cloud.migrationcenter.v1.MigrationCenterClient.ListAssetsPage)`
...
```
public ApiFuture<MigrationCenterClient.ListAssetsPage> createPageAsync(PageContext<ListAssetsRequest,ListAssetsResponse,Asset> context, ApiFuture<ListAssetsResponse> futureResponse)
```
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListAssetsResponse](/java/docs/reference/google-cloud-migrationcenter/0.13.0/com.google.cloud.migrationcenter.v1.ListAssetsResponse)>`  
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListAssetsPage](/java/docs/reference/google-cloud-migrationcenter/0.13.0/com.google.cloud.migrationcenter.v1.MigrationCenterClient.ListAssetsPage)>`
