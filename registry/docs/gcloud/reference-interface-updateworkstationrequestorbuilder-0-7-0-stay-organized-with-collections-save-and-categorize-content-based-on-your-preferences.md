...
# Interface UpdateWorkstationRequestOrBuilder (0.7.0) Stay organized with collections Save and categorize content based on your preferences.
...
If set and the workstation configuration is not found, a new workstation configuration is created. In this situation, update\_mask is ignored.
...
`[Workstation](/java/docs/reference/google-cloud-workstations/0.7.0/com.google.cloud.workstations.v1.Workstation)`
...
`[WorkstationOrBuilder](/java/docs/reference/google-cloud-workstations/0.7.0/com.google.cloud.workstations.v1.WorkstationOrBuilder)`
