...
# Class WebRiskServiceLimitedTimeRetryPolicy (2.28.0) Stay organized with collections Save and categorize content based on your preferences.
...
A retry policy for [`WebRiskServiceConnection`](/cpp/docs/reference/webrisk/2.28.0/classgoogle_1_1cloud_1_1webrisk__v1_1_1WebRiskServiceConnection) based on elapsed time.
...
### WebRiskServiceLimitedTimeRetryPolicy(std::chrono::duration< DurationRep, DurationPeriod >)
...
### WebRiskServiceLimitedTimeRetryPolicy(WebRiskServiceLimitedTimeRetryPolicy &&)
...
### WebRiskServiceLimitedTimeRetryPolicy(WebRiskServiceLimitedTimeRetryPolicy const &)
...
`std::unique_ptr< WebRiskServiceRetryPolicy >`

## Type Aliases

### BaseType

**Alias Of**: `WebRiskServiceRetryPolicy`
