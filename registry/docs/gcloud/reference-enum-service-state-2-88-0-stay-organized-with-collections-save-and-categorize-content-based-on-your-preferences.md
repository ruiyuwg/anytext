...
# Enum Service.State (2.88.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-dataproc-metastore/latest/com.google.cloud.metastore.v1.Service.State#com_google_cloud_metastore_v1_Service_State_forNumber_int_) instead._
