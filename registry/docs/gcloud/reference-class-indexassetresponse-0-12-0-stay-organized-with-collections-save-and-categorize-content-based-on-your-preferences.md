...
# Class IndexAssetResponse (0.12.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class IndexAssetResponse extends GeneratedMessageV3 implements IndexAssetResponseOrBuilder
```

Response message for IndexAsset.

Protobuf type `google.cloud.visionai.v1.IndexAssetResponse`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> IndexAssetResponse

## Implements

[IndexAssetResponseOrBuilder](/java/docs/reference/google-cloud-visionai/0.12.0/com.google.cloud.visionai.v1.IndexAssetResponseOrBuilder)
...
```
public static IndexAssetResponse getDefaultInstance()
```
...
`[IndexAssetResponse](/java/docs/reference/google-cloud-visionai/0.12.0/com.google.cloud.visionai.v1.IndexAssetResponse)`
...
```
public static IndexAssetResponse.Builder newBuilder()
```
...
`[IndexAssetResponse.Builder](/java/docs/reference/google-cloud-visionai/0.12.0/com.google.cloud.visionai.v1.IndexAssetResponse.Builder)`

### newBuilder(IndexAssetResponse prototype)

```
public static IndexAssetResponse.Builder newBuilder(IndexAssetResponse prototype)
```
...
```
public static IndexAssetResponse parseDelimitedFrom(InputStream input)
```
...
```
public static IndexAssetResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static IndexAssetResponse parseFrom(byte[] data)
```
...
```
public static IndexAssetResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static IndexAssetResponse parseFrom(ByteString data)
```
...
```
public static IndexAssetResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static IndexAssetResponse parseFrom(CodedInputStream input)
```
...
```
public static IndexAssetResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static IndexAssetResponse parseFrom(InputStream input)
```
...
```
public static IndexAssetResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static IndexAssetResponse parseFrom(ByteBuffer data)
```
...
```
public static IndexAssetResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<IndexAssetResponse> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[IndexAssetResponse](/java/docs/reference/google-cloud-visionai/0.12.0/com.google.cloud.visionai.v1.IndexAssetResponse)>`
...
```
public IndexAssetResponse getDefaultInstanceForType()
```
...
```
public Parser<IndexAssetResponse> getParserForType()
```
...
```
public IndexAssetResponse.Builder newBuilderForType()
```
...
```
protected IndexAssetResponse.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public IndexAssetResponse.Builder toBuilder()
```
