...
# Cloud AI Platform v1 API - Class ExportModelOperationMetadata.Types (3.7.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class ExportModelOperationMetadata.Types
```

Reference documentation and code samples for the Cloud AI Platform v1 API class ExportModelOperationMetadata.Types.

Container for nested types declared in the ExportModelOperationMetadata message type.

## Inheritance

[object](https://learn.microsoft.com/dotnet/api/system.object) \> ExportModelOperationMetadata.Types
