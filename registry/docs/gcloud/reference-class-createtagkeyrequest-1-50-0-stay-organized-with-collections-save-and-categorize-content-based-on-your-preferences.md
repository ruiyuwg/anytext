...
# Class CreateTagKeyRequest (1.50.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class CreateTagKeyRequest extends GeneratedMessageV3 implements CreateTagKeyRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> CreateTagKeyRequest

## Implements

[CreateTagKeyRequestOrBuilder](/java/docs/reference/google-cloud-resourcemanager/1.50.0/com.google.cloud.resourcemanager.v3.CreateTagKeyRequestOrBuilder)
...
```
public static CreateTagKeyRequest getDefaultInstance()
```
...
`[CreateTagKeyRequest](/java/docs/reference/google-cloud-resourcemanager/1.50.0/com.google.cloud.resourcemanager.v3.CreateTagKeyRequest)`
...
```
public static CreateTagKeyRequest.Builder newBuilder()
```
...
`[CreateTagKeyRequest.Builder](/java/docs/reference/google-cloud-resourcemanager/1.50.0/com.google.cloud.resourcemanager.v3.CreateTagKeyRequest.Builder)`

### newBuilder(CreateTagKeyRequest prototype)

```
public static CreateTagKeyRequest.Builder newBuilder(CreateTagKeyRequest prototype)
```
...
```
public static CreateTagKeyRequest parseDelimitedFrom(InputStream input)
```
...
```
public static CreateTagKeyRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateTagKeyRequest parseFrom(byte[] data)
```
...
```
public static CreateTagKeyRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateTagKeyRequest parseFrom(ByteString data)
```
...
```
public static CreateTagKeyRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateTagKeyRequest parseFrom(CodedInputStream input)
```
...
```
public static CreateTagKeyRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateTagKeyRequest parseFrom(InputStream input)
```
...
```
public static CreateTagKeyRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateTagKeyRequest parseFrom(ByteBuffer data)
```
...
```
public static CreateTagKeyRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<CreateTagKeyRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[CreateTagKeyRequest](/java/docs/reference/google-cloud-resourcemanager/1.50.0/com.google.cloud.resourcemanager.v3.CreateTagKeyRequest)>`
...
```
public Parser<CreateTagKeyRequest> getParserForType()
```
...
`[TagKey](/java/docs/reference/google-cloud-resourcemanager/1.50.0/com.google.cloud.resourcemanager.v3.TagKey)`
...
`[TagKeyOrBuilder](/java/docs/reference/google-cloud-resourcemanager/1.50.0/com.google.cloud.resourcemanager.v3.TagKeyOrBuilder)`
...
```
public CreateTagKeyRequest.Builder newBuilderForType()
```
...
```
protected CreateTagKeyRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public CreateTagKeyRequest.Builder toBuilder()
```
