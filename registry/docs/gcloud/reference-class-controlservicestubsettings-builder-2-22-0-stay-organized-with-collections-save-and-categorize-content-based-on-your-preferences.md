...
# Class ControlServiceStubSettings.Builder (2.22.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class ControlServiceStubSettings.Builder extends StubSettings.Builder<ControlServiceStubSettings,ControlServiceStubSettings.Builder>
```
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [StubSettings.Builder](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.StubSettings.Builder.html) \> ControlServiceStubSettings.Builder
...
`[ControlServiceStubSettings](/java/docs/reference/google-cloud-retail/2.22.0/com.google.cloud.retail.v2alpha.stub.ControlServiceStubSettings)`  
...
```
public ControlServiceStubSettings.Builder applyToAllUnaryMethods(ApiFunction<UnaryCallSettings.Builder<?,?>,Void> settingsUpdater)
```
...
`[ControlServiceStubSettings.Builder](/java/docs/reference/google-cloud-retail/2.22.0/com.google.cloud.retail.v2alpha.stub.ControlServiceStubSettings.Builder)`

### build()

```
public ControlServiceStubSettings build()
```
...
`[Builder](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.Builder.html)<[CreateControlRequest](/java/docs/reference/google-cloud-retail/2.22.0/com.google.cloud.retail.v2alpha.CreateControlRequest),[Control](/java/docs/reference/google-cloud-retail/2.22.0/com.google.cloud.retail.v2alpha.Control)>`
...
`[Builder](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.Builder.html)<[DeleteControlRequest](/java/docs/reference/google-cloud-retail/2.22.0/com.google.cloud.retail.v2alpha.DeleteControlRequest),[Empty](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Empty.html)>`
...
`[Builder](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.Builder.html)<[GetControlRequest](/java/docs/reference/google-cloud-retail/2.22.0/com.google.cloud.retail.v2alpha.GetControlRequest),[Control](/java/docs/reference/google-cloud-retail/2.22.0/com.google.cloud.retail.v2alpha.Control)>`
...
`[Builder](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PagedCallSettings.Builder.html)<[ListControlsRequest](/java/docs/reference/google-cloud-retail/2.22.0/com.google.cloud.retail.v2alpha.ListControlsRequest),[ListControlsResponse](/java/docs/reference/google-cloud-retail/2.22.0/com.google.cloud.retail.v2alpha.ListControlsResponse),[ListControlsPagedResponse](/java/docs/reference/google-cloud-retail/2.22.0/com.google.cloud.retail.v2alpha.ControlServiceClient.ListControlsPagedResponse)>`
...
`[Builder](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.Builder.html)<[UpdateControlRequest](/java/docs/reference/google-cloud-retail/2.22.0/com.google.cloud.retail.v2alpha.UpdateControlRequest),[Control](/java/docs/reference/google-cloud-retail/2.22.0/com.google.cloud.retail.v2alpha.Control)>`
