...
# Class ListIndexEndpointsResponse (0.11.0) Stay organized with collections Save and categorize content based on your preferences.
...
Protobuf type `google.cloud.visionai.v1.ListIndexEndpointsResponse`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListIndexEndpointsResponse

## Implements

[ListIndexEndpointsResponseOrBuilder](/java/docs/reference/google-cloud-visionai/0.11.0/com.google.cloud.visionai.v1.ListIndexEndpointsResponseOrBuilder)
...
### INDEX\_ENDPOINTS\_FIELD\_NUMBER
...
`[ListIndexEndpointsResponse](/java/docs/reference/google-cloud-visionai/0.11.0/com.google.cloud.visionai.v1.ListIndexEndpointsResponse)`
...
`[ListIndexEndpointsResponse.Builder](/java/docs/reference/google-cloud-visionai/0.11.0/com.google.cloud.visionai.v1.ListIndexEndpointsResponse.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListIndexEndpointsResponse](/java/docs/reference/google-cloud-visionai/0.11.0/com.google.cloud.visionai.v1.ListIndexEndpointsResponse)>`
...
`[IndexEndpoint](/java/docs/reference/google-cloud-visionai/0.11.0/com.google.cloud.visionai.v1.IndexEndpoint)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[IndexEndpoint](/java/docs/reference/google-cloud-visionai/0.11.0/com.google.cloud.visionai.v1.IndexEndpoint)>`
...
`[IndexEndpointOrBuilder](/java/docs/reference/google-cloud-visionai/0.11.0/com.google.cloud.visionai.v1.IndexEndpointOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.visionai.v1.IndexEndpointOrBuilder>`
