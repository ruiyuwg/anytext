...
# Google Cloud Ai Platform V1 Client - Class NearestNeighbors (1.3.0) Stay organized with collections Save and categorize content based on your preferences.
...
`array<[Google\Cloud\AIPlatform\V1\FindNeighborsResponse\Neighbor](/php/docs/reference/cloud-ai-platform/1.3.0/V1.FindNeighborsResponse.Neighbor)>`  
