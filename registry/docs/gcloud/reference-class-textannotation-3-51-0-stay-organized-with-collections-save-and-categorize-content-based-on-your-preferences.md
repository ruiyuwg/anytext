...
# Class TextAnnotation (3.51.0) Stay organized with collections Save and categorize content based on your preferences.
...
[TextAnnotationOrBuilder](/java/docs/reference/google-cloud-vision/3.51.0/com.google.cloud.vision.v1p4beta1.TextAnnotationOrBuilder)
...
`[TextAnnotation](/java/docs/reference/google-cloud-vision/3.51.0/com.google.cloud.vision.v1p4beta1.TextAnnotation)`
...
`[TextAnnotation.Builder](/java/docs/reference/google-cloud-vision/3.51.0/com.google.cloud.vision.v1p4beta1.TextAnnotation.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[TextAnnotation](/java/docs/reference/google-cloud-vision/3.51.0/com.google.cloud.vision.v1p4beta1.TextAnnotation)>`
...
`[Page](/java/docs/reference/google-cloud-vision/3.51.0/com.google.cloud.vision.v1p4beta1.Page)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Page](/java/docs/reference/google-cloud-vision/3.51.0/com.google.cloud.vision.v1p4beta1.Page)>`
...
`[PageOrBuilder](/java/docs/reference/google-cloud-vision/3.51.0/com.google.cloud.vision.v1p4beta1.PageOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.vision.v1p4beta1.PageOrBuilder>`
