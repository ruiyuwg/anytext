...
# google-cloud-video-stitcher overview (0.87.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Video Stitcher API Description:** Allows you to manipulate video content to dynamically insert ads prior to delivery to client devices.

[Video Stitcher API Product Reference](https://cloud.google.com/video-stitcher/)

[GitHub Repository](https://github.com/googleapis/google-cloud-java/tree/main/java-video-stitcher)

[Maven artifact](https://central.sonatype.com/artifact/com.google.cloud/google-cloud-video-stitcher)
...
-   [Enable the API](https://console.cloud.google.com/apis/library/videostitcher.googleapis.com)
-   [Set up authentication](https://cloud.google.com/docs/authentication/client-libraries)

## Use the Video Stitcher API for Java
...
The example below demonstrates how you would import the BOM and include the `google-cloud-video-stitcher` artifact.
...
implementation("com.google.cloud:google-cloud-video-stitcher")
...
libraryDependencies += "com.google.cloud" % "google-cloud-video-stitcher" % "0.87.0"

## Which version ID should I get started with?

For this library, we recommend using [com.google.cloud.video.stitcher.v1](https://cloud.google.com/java/docs/reference/google-cloud-video-stitcher/0.87.0/com.google.cloud.video.stitcher.v1) for new applications.
