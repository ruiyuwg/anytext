...
# Class AssistantGroundedContent.TextGroundingMetadata.Reference.Builder (0.83.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class AssistantGroundedContent.TextGroundingMetadata.Reference.Builder extends GeneratedMessage.Builder<AssistantGroundedContent.TextGroundingMetadata.Reference.Builder> implements AssistantGroundedContent.TextGroundingMetadata.ReferenceOrBuilder
```

Referenced content and related document metadata.

Protobuf type `google.cloud.discoveryengine.v1.AssistantGroundedContent.TextGroundingMetadata.Reference`

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessage.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessage.Builder.html) \> AssistantGroundedContent.TextGroundingMetadata.Reference.Builder

## Implements

[AssistantGroundedContent.TextGroundingMetadata.ReferenceOrBuilder](/java/docs/reference/google-cloud-discoveryengine/latest/com.google.cloud.discoveryengine.v1.AssistantGroundedContent.TextGroundingMetadata.ReferenceOrBuilder)
...
```
public AssistantGroundedContent.TextGroundingMetadata.Reference build()
```
...
`[AssistantGroundedContent.TextGroundingMetadata.Reference](/java/docs/reference/google-cloud-discoveryengine/latest/com.google.cloud.discoveryengine.v1.AssistantGroundedContent.TextGroundingMetadata.Reference)`

### buildPartial()

```
public AssistantGroundedContent.TextGroundingMetadata.Reference buildPartial()
```
...
```
public AssistantGroundedContent.TextGroundingMetadata.Reference.Builder clear()
```
...
`[AssistantGroundedContent.TextGroundingMetadata.Reference.Builder](/java/docs/reference/google-cloud-discoveryengine/latest/com.google.cloud.discoveryengine.v1.AssistantGroundedContent.TextGroundingMetadata.Reference.Builder)`
...
```
public AssistantGroundedContent.TextGroundingMetadata.Reference.Builder clearContent()
```
...
```
public AssistantGroundedContent.TextGroundingMetadata.Reference.Builder clearDocumentMetadata()
```
...
```
public AssistantGroundedContent.TextGroundingMetadata.Reference getDefaultInstanceForType()
```
...
```
public AssistantGroundedContent.TextGroundingMetadata.Reference.DocumentMetadata getDocumentMetadata()
```
...
`[AssistantGroundedContent.TextGroundingMetadata.Reference.DocumentMetadata](/java/docs/reference/google-cloud-discoveryengine/latest/com.google.cloud.discoveryengine.v1.AssistantGroundedContent.TextGroundingMetadata.Reference.DocumentMetadata)`
...
```
public AssistantGroundedContent.TextGroundingMetadata.Reference.DocumentMetadata.Builder getDocumentMetadataBuilder()
```
...
`[AssistantGroundedContent.TextGroundingMetadata.Reference.DocumentMetadata.Builder](/java/docs/reference/google-cloud-discoveryengine/latest/com.google.cloud.discoveryengine.v1.AssistantGroundedContent.TextGroundingMetadata.Reference.DocumentMetadata.Builder)`

### getDocumentMetadataOrBuilder()

```
public AssistantGroundedContent.TextGroundingMetadata.Reference.DocumentMetadataOrBuilder getDocumentMetadataOrBuilder()
```
...
`[AssistantGroundedContent.TextGroundingMetadata.Reference.DocumentMetadataOrBuilder](/java/docs/reference/google-cloud-discoveryengine/latest/com.google.cloud.discoveryengine.v1.AssistantGroundedContent.TextGroundingMetadata.Reference.DocumentMetadataOrBuilder)`
...
### mergeDocumentMetadata(AssistantGroundedContent.TextGroundingMetadata.Reference.DocumentMetadata value)

```
public AssistantGroundedContent.TextGroundingMetadata.Reference.Builder mergeDocumentMetadata(AssistantGroundedContent.TextGroundingMetadata.Reference.DocumentMetadata value)
```
...
### mergeFrom(AssistantGroundedContent.TextGroundingMetadata.Reference other)

```
public AssistantGroundedContent.TextGroundingMetadata.Reference.Builder mergeFrom(AssistantGroundedContent.TextGroundingMetadata.Reference other)
```
...
```
public AssistantGroundedContent.TextGroundingMetadata.Reference.Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public AssistantGroundedContent.TextGroundingMetadata.Reference.Builder mergeFrom(Message other)
```
...
```
public AssistantGroundedContent.TextGroundingMetadata.Reference.Builder setContent(String value)
```
...
```
public AssistantGroundedContent.TextGroundingMetadata.Reference.Builder setContentBytes(ByteString value)
```
...
### setDocumentMetadata(AssistantGroundedContent.TextGroundingMetadata.Reference.DocumentMetadata value)

```
public AssistantGroundedContent.TextGroundingMetadata.Reference.Builder setDocumentMetadata(AssistantGroundedContent.TextGroundingMetadata.Reference.DocumentMetadata value)
```
...
### setDocumentMetadata(AssistantGroundedContent.TextGroundingMetadata.Reference.DocumentMetadata.Builder builderForValue)

```
public AssistantGroundedContent.TextGroundingMetadata.Reference.Builder setDocumentMetadata(AssistantGroundedContent.TextGroundingMetadata.Reference.DocumentMetadata.Builder builderForValue)
```
