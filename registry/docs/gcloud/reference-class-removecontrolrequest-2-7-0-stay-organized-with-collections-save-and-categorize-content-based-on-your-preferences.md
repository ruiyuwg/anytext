...
# Class RemoveControlRequest (2.7.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class RemoveControlRequest extends GeneratedMessageV3 implements RemoveControlRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> RemoveControlRequest

## Implements

[RemoveControlRequestOrBuilder](/java/docs/reference/google-cloud-retail/2.7.0/com.google.cloud.retail.v2.RemoveControlRequestOrBuilder)
...
```
public static RemoveControlRequest getDefaultInstance()
```
...
[RemoveControlRequest](/java/docs/reference/google-cloud-retail/2.7.0/com.google.cloud.retail.v2.RemoveControlRequest)
...
```
public static RemoveControlRequest.Builder newBuilder()
```
...
[RemoveControlRequest.Builder](/java/docs/reference/google-cloud-retail/2.7.0/com.google.cloud.retail.v2.RemoveControlRequest.Builder)

### newBuilder(RemoveControlRequest prototype)

```
public static RemoveControlRequest.Builder newBuilder(RemoveControlRequest prototype)
```
...
```
public static RemoveControlRequest parseDelimitedFrom(InputStream input)
```
...
```
public static RemoveControlRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RemoveControlRequest parseFrom(byte[] data)
```
...
```
public static RemoveControlRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RemoveControlRequest parseFrom(ByteString data)
```
...
```
public static RemoveControlRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RemoveControlRequest parseFrom(CodedInputStream input)
```
...
```
public static RemoveControlRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RemoveControlRequest parseFrom(InputStream input)
```
...
```
public static RemoveControlRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RemoveControlRequest parseFrom(ByteBuffer data)
```
...
```
public static RemoveControlRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<RemoveControlRequest> parser()
```
...
[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[RemoveControlRequest](/java/docs/reference/google-cloud-retail/2.7.0/com.google.cloud.retail.v2.RemoveControlRequest)\>
...
```
public RemoveControlRequest getDefaultInstanceForType()
```
...
```
public Parser<RemoveControlRequest> getParserForType()
```
...
Required. The source ServingConfig resource name . Format: projects/{project\_number}/locations/{location\_id}/catalogs/{catalog\_id}/servingConfigs/{serving\_config\_id}
...
```
public RemoveControlRequest.Builder newBuilderForType()
```
...
```
protected RemoveControlRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public RemoveControlRequest.Builder toBuilder()
```
