...
# Class Bucket.Billing (2.37.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class Bucket.Billing extends GeneratedMessageV3 implements Bucket.BillingOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> Bucket.Billing

## Implements

[Bucket.BillingOrBuilder](/java/docs/reference/google-cloud-storage/2.37.0/com.google.storage.v2.Bucket.BillingOrBuilder)
...
### REQUESTER\_PAYS\_FIELD\_NUMBER

```
public static final int REQUESTER_PAYS_FIELD_NUMBER
```
...
```
public static Bucket.Billing getDefaultInstance()
```
...
`[Bucket.Billing](/java/docs/reference/google-cloud-storage/2.37.0/com.google.storage.v2.Bucket.Billing)`
...
```
public static Bucket.Billing.Builder newBuilder()
```
...
`[Bucket.Billing.Builder](/java/docs/reference/google-cloud-storage/2.37.0/com.google.storage.v2.Bucket.Billing.Builder)`

### newBuilder(Bucket.Billing prototype)

```
public static Bucket.Billing.Builder newBuilder(Bucket.Billing prototype)
```
...
```
public static Bucket.Billing parseDelimitedFrom(InputStream input)
```
...
```
public static Bucket.Billing parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Bucket.Billing parseFrom(byte[] data)
```
...
```
public static Bucket.Billing parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Bucket.Billing parseFrom(ByteString data)
```
...
```
public static Bucket.Billing parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Bucket.Billing parseFrom(CodedInputStream input)
```
...
```
public static Bucket.Billing parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Bucket.Billing parseFrom(InputStream input)
```
...
```
public static Bucket.Billing parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Bucket.Billing parseFrom(ByteBuffer data)
```
...
```
public static Bucket.Billing parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<Bucket.Billing> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[Billing](/java/docs/reference/google-cloud-storage/2.37.0/com.google.storage.v2.Bucket.Billing)>`
...
```
public Parser<Bucket.Billing> getParserForType()
```
...
```
public Bucket.Billing.Builder newBuilderForType()
```
...
```
protected Bucket.Billing.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public Bucket.Billing.Builder toBuilder()
```
