...
# Struct AdvisoryNotificationsServiceConnectionIdempotencyPolicyOption (2.12.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Alias Of**: `std::shared_ptr< AdvisoryNotificationsServiceConnectionIdempotencyPolicy >`
