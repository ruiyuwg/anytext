...
# Class StartScanRunRequest (2.8.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class StartScanRunRequest extends GeneratedMessageV3 implements StartScanRunRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> StartScanRunRequest

## Implements

[StartScanRunRequestOrBuilder](/java/docs/reference/google-cloud-websecurityscanner/2.8.0/com.google.cloud.websecurityscanner.v1beta.StartScanRunRequestOrBuilder)
...
```
public static StartScanRunRequest getDefaultInstance()
```
...
[StartScanRunRequest](/java/docs/reference/google-cloud-websecurityscanner/2.8.0/com.google.cloud.websecurityscanner.v1beta.StartScanRunRequest)
...
```
public static StartScanRunRequest.Builder newBuilder()
```
...
[StartScanRunRequest.Builder](/java/docs/reference/google-cloud-websecurityscanner/2.8.0/com.google.cloud.websecurityscanner.v1beta.StartScanRunRequest.Builder)

### newBuilder(StartScanRunRequest prototype)

```
public static StartScanRunRequest.Builder newBuilder(StartScanRunRequest prototype)
```
...
```
public static StartScanRunRequest parseDelimitedFrom(InputStream input)
```
...
```
public static StartScanRunRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static StartScanRunRequest parseFrom(byte[] data)
```
...
```
public static StartScanRunRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static StartScanRunRequest parseFrom(ByteString data)
```
...
```
public static StartScanRunRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static StartScanRunRequest parseFrom(CodedInputStream input)
```
...
```
public static StartScanRunRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static StartScanRunRequest parseFrom(InputStream input)
```
...
```
public static StartScanRunRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static StartScanRunRequest parseFrom(ByteBuffer data)
```
...
```
public static StartScanRunRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<StartScanRunRequest> parser()
```
...
[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[StartScanRunRequest](/java/docs/reference/google-cloud-websecurityscanner/2.8.0/com.google.cloud.websecurityscanner.v1beta.StartScanRunRequest)\>
...
```
public Parser<StartScanRunRequest> getParserForType()
```
...
```
public StartScanRunRequest.Builder newBuilderForType()
```
...
```
protected StartScanRunRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public StartScanRunRequest.Builder toBuilder()
```
