...
# Interface DeleteInstanceRequestOrBuilder (6.58.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface DeleteInstanceRequestOrBuilder extends MessageOrBuilder
```
