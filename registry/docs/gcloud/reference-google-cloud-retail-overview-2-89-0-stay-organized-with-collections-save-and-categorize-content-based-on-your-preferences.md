...
# google-cloud-retail overview (2.89.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Cloud Retail Description:** Retail solutions API.

[Cloud Retail Product Reference](https://cloud.google.com/solutions/retail)

[GitHub Repository](https://github.com/googleapis/google-cloud-java/tree/main/java-retail)

[Maven artifact](https://central.sonatype.com/artifact/com.google.cloud/google-cloud-retail)
...
-   [Enable the API](https://console.cloud.google.com/apis/library/retail.googleapis.com)
-   [Set up authentication](https://cloud.google.com/docs/authentication/client-libraries)

## Use the Cloud Retail for Java
...
The example below demonstrates how you would import the BOM and include the `google-cloud-retail` artifact.
...
libraryDependencies += "com.google.cloud" % "google-cloud-retail" % "2.89.0"

## Which version ID should I get started with?

For this library, we recommend using [com.google.cloud.retail.v2](https://cloud.google.com/java/docs/reference/google-cloud-retail/2.89.0/com.google.cloud.retail.v2) for new applications.
