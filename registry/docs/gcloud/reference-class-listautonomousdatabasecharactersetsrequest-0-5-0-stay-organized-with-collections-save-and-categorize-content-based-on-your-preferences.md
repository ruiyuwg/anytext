...
# Class ListAutonomousDatabaseCharacterSetsRequest (0.5.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListAutonomousDatabaseCharacterSetsRequest extends GeneratedMessageV3 implements ListAutonomousDatabaseCharacterSetsRequestOrBuilder
```

The request for `AutonomousDatabaseCharacterSet.List`.

Protobuf type `google.cloud.oracledatabase.v1.ListAutonomousDatabaseCharacterSetsRequest`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListAutonomousDatabaseCharacterSetsRequest

## Implements

[ListAutonomousDatabaseCharacterSetsRequestOrBuilder](/java/docs/reference/google-cloud-oracledatabase/0.5.0/com.google.cloud.oracledatabase.v1.ListAutonomousDatabaseCharacterSetsRequestOrBuilder)
...
```
public static ListAutonomousDatabaseCharacterSetsRequest getDefaultInstance()
```
...
`[ListAutonomousDatabaseCharacterSetsRequest](/java/docs/reference/google-cloud-oracledatabase/0.5.0/com.google.cloud.oracledatabase.v1.ListAutonomousDatabaseCharacterSetsRequest)`
...
```
public static ListAutonomousDatabaseCharacterSetsRequest.Builder newBuilder()
```
...
`[ListAutonomousDatabaseCharacterSetsRequest.Builder](/java/docs/reference/google-cloud-oracledatabase/0.5.0/com.google.cloud.oracledatabase.v1.ListAutonomousDatabaseCharacterSetsRequest.Builder)`

### newBuilder(ListAutonomousDatabaseCharacterSetsRequest prototype)

```
public static ListAutonomousDatabaseCharacterSetsRequest.Builder newBuilder(ListAutonomousDatabaseCharacterSetsRequest prototype)
```
...
```
public static ListAutonomousDatabaseCharacterSetsRequest parseDelimitedFrom(InputStream input)
```
...
```
public static ListAutonomousDatabaseCharacterSetsRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListAutonomousDatabaseCharacterSetsRequest parseFrom(byte[] data)
```
...
```
public static ListAutonomousDatabaseCharacterSetsRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListAutonomousDatabaseCharacterSetsRequest parseFrom(ByteString data)
```
...
```
public static ListAutonomousDatabaseCharacterSetsRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListAutonomousDatabaseCharacterSetsRequest parseFrom(CodedInputStream input)
```
...
```
public static ListAutonomousDatabaseCharacterSetsRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListAutonomousDatabaseCharacterSetsRequest parseFrom(InputStream input)
```
...
```
public static ListAutonomousDatabaseCharacterSetsRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListAutonomousDatabaseCharacterSetsRequest parseFrom(ByteBuffer data)
```
...
```
public static ListAutonomousDatabaseCharacterSetsRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ListAutonomousDatabaseCharacterSetsRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListAutonomousDatabaseCharacterSetsRequest](/java/docs/reference/google-cloud-oracledatabase/0.5.0/com.google.cloud.oracledatabase.v1.ListAutonomousDatabaseCharacterSetsRequest)>`
...
```
public ListAutonomousDatabaseCharacterSetsRequest getDefaultInstanceForType()
```
...
Optional. An expression for filtering the results of the request. Only the **character\_set\_type** field is supported in the following format: `character_set_type="{characterSetType}"`. Accepted values include `DATABASE` and `NATIONAL`.
...
```
public Parser<ListAutonomousDatabaseCharacterSetsRequest> getParserForType()
```
...
```
public ListAutonomousDatabaseCharacterSetsRequest.Builder newBuilderForType()
```
...
```
protected ListAutonomousDatabaseCharacterSetsRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ListAutonomousDatabaseCharacterSetsRequest.Builder toBuilder()
```
