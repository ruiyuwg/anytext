...
# Class ServingConfigServiceSettings (2.18.0) Stay organized with collections Save and categorize content based on your preferences.
...
Settings class to configure an instance of [ServingConfigServiceClient](/java/docs/reference/google-cloud-retail/2.18.0/com.google.cloud.retail.v2beta.ServingConfigServiceClient).
...
`[ServingConfigServiceStubSettings](/java/docs/reference/google-cloud-retail/2.18.0/com.google.cloud.retail.v2.stub.ServingConfigServiceStubSettings)`  
...
`[ServingConfigServiceSettings](/java/docs/reference/google-cloud-retail/2.18.0/com.google.cloud.retail.v2.ServingConfigServiceSettings)`
...
`[ServingConfigServiceSettings.Builder](/java/docs/reference/google-cloud-retail/2.18.0/com.google.cloud.retail.v2.ServingConfigServiceSettings.Builder)`
...
`[UnaryCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.html)<[AddControlRequest](/java/docs/reference/google-cloud-retail/2.18.0/com.google.cloud.retail.v2.AddControlRequest),[ServingConfig](/java/docs/reference/google-cloud-retail/2.18.0/com.google.cloud.retail.v2.ServingConfig)>`
...
`[UnaryCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.html)<[CreateServingConfigRequest](/java/docs/reference/google-cloud-retail/2.18.0/com.google.cloud.retail.v2.CreateServingConfigRequest),[ServingConfig](/java/docs/reference/google-cloud-retail/2.18.0/com.google.cloud.retail.v2.ServingConfig)>`
...
`[UnaryCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.html)<[DeleteServingConfigRequest](/java/docs/reference/google-cloud-retail/2.18.0/com.google.cloud.retail.v2.DeleteServingConfigRequest),[Empty](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Empty.html)>`
...
`[UnaryCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.html)<[GetServingConfigRequest](/java/docs/reference/google-cloud-retail/2.18.0/com.google.cloud.retail.v2.GetServingConfigRequest),[ServingConfig](/java/docs/reference/google-cloud-retail/2.18.0/com.google.cloud.retail.v2.ServingConfig)>`
...
`[PagedCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PagedCallSettings.html)<[ListServingConfigsRequest](/java/docs/reference/google-cloud-retail/2.18.0/com.google.cloud.retail.v2.ListServingConfigsRequest),[ListServingConfigsResponse](/java/docs/reference/google-cloud-retail/2.18.0/com.google.cloud.retail.v2.ListServingConfigsResponse),[ListServingConfigsPagedResponse](/java/docs/reference/google-cloud-retail/2.18.0/com.google.cloud.retail.v2.ServingConfigServiceClient.ListServingConfigsPagedResponse)>`
...
`[UnaryCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.html)<[RemoveControlRequest](/java/docs/reference/google-cloud-retail/2.18.0/com.google.cloud.retail.v2.RemoveControlRequest),[ServingConfig](/java/docs/reference/google-cloud-retail/2.18.0/com.google.cloud.retail.v2.ServingConfig)>`
...
`[UnaryCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.html)<[UpdateServingConfigRequest](/java/docs/reference/google-cloud-retail/2.18.0/com.google.cloud.retail.v2.UpdateServingConfigRequest),[ServingConfig](/java/docs/reference/google-cloud-retail/2.18.0/com.google.cloud.retail.v2.ServingConfig)>`
