...
# Class GrpcProductServiceCallableFactory (2.9.0) Stay organized with collections Save and categorize content based on your preferences.
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> GrpcProductServiceCallableFactory
...
```
public GrpcProductServiceCallableFactory()
```
