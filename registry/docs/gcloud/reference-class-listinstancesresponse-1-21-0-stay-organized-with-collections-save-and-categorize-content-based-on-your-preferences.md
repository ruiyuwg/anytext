...
# Class ListInstancesResponse (1.21.0) Stay organized with collections Save and categorize content based on your preferences.
...
[ListInstancesResponseOrBuilder](/java/docs/reference/google-cloud-notebooks/1.21.0/com.google.cloud.notebooks.v1beta1.ListInstancesResponseOrBuilder)
...
`[ListInstancesResponse](/java/docs/reference/google-cloud-notebooks/1.21.0/com.google.cloud.notebooks.v1beta1.ListInstancesResponse)`
...
`[ListInstancesResponse.Builder](/java/docs/reference/google-cloud-notebooks/1.21.0/com.google.cloud.notebooks.v1beta1.ListInstancesResponse.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListInstancesResponse](/java/docs/reference/google-cloud-notebooks/1.21.0/com.google.cloud.notebooks.v1beta1.ListInstancesResponse)>`
...
`[Instance](/java/docs/reference/google-cloud-notebooks/1.21.0/com.google.cloud.notebooks.v1beta1.Instance)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Instance](/java/docs/reference/google-cloud-notebooks/1.21.0/com.google.cloud.notebooks.v1beta1.Instance)>`
...
`[InstanceOrBuilder](/java/docs/reference/google-cloud-notebooks/1.21.0/com.google.cloud.notebooks.v1beta1.InstanceOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.notebooks.v1beta1.InstanceOrBuilder>`
