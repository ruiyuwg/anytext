...
# Enum CommonFeatureSpec.FeatureSpecCase (1.55.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum CommonFeatureSpec.FeatureSpecCase extends Enum<CommonFeatureSpec.FeatureSpecCase> implements Internal.EnumLite, AbstractMessageLite.InternalOneOfEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-gkehub/1.55.0/com.google.cloud.gkehub.v1.CommonFeatureSpec.FeatureSpecCase#com_google_cloud_gkehub_v1_CommonFeatureSpec_FeatureSpecCase_forNumber_int_) instead._
