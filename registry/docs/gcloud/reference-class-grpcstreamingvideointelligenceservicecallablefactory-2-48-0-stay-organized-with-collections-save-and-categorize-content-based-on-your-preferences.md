...
# Class GrpcStreamingVideoIntelligenceServiceCallableFactory (2.48.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public class GrpcStreamingVideoIntelligenceServiceCallableFactory implements GrpcStubCallableFactory
```
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> GrpcStreamingVideoIntelligenceServiceCallableFactory
...
```
public GrpcStreamingVideoIntelligenceServiceCallableFactory()
```
