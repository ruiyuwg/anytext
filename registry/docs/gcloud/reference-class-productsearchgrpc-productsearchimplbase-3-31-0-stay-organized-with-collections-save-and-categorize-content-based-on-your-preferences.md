...
# Class ProductSearchGrpc.ProductSearchImplBase (3.31.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public abstract static class ProductSearchGrpc.ProductSearchImplBase implements BindableService, ProductSearchGrpc.AsyncService
```
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> ProductSearchGrpc.ProductSearchImplBase

## Implements

io.grpc.BindableService, [ProductSearchGrpc.AsyncService](/java/docs/reference/google-cloud-vision/3.31.0/com.google.cloud.vision.v1p3beta1.ProductSearchGrpc.AsyncService)
