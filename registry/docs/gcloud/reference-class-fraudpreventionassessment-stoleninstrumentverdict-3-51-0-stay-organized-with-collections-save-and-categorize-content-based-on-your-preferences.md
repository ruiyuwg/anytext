...
# Class FraudPreventionAssessment.StolenInstrumentVerdict (3.51.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class FraudPreventionAssessment.StolenInstrumentVerdict extends GeneratedMessageV3 implements FraudPreventionAssessment.StolenInstrumentVerdictOrBuilder
```

Information about stolen instrument fraud, where the user is not the legitimate owner of the instrument being used for the purchase.

Protobuf type `google.cloud.recaptchaenterprise.v1beta1.FraudPreventionAssessment.StolenInstrumentVerdict`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> FraudPreventionAssessment.StolenInstrumentVerdict

## Implements

[FraudPreventionAssessment.StolenInstrumentVerdictOrBuilder](/java/docs/reference/google-cloud-recaptchaenterprise/3.51.0/com.google.recaptchaenterprise.v1beta1.FraudPreventionAssessment.StolenInstrumentVerdictOrBuilder)
...
```
public static FraudPreventionAssessment.StolenInstrumentVerdict getDefaultInstance()
```
...
`[FraudPreventionAssessment.StolenInstrumentVerdict](/java/docs/reference/google-cloud-recaptchaenterprise/3.51.0/com.google.recaptchaenterprise.v1beta1.FraudPreventionAssessment.StolenInstrumentVerdict)`
...
```
public static FraudPreventionAssessment.StolenInstrumentVerdict.Builder newBuilder()
```
...
`[FraudPreventionAssessment.StolenInstrumentVerdict.Builder](/java/docs/reference/google-cloud-recaptchaenterprise/3.51.0/com.google.recaptchaenterprise.v1beta1.FraudPreventionAssessment.StolenInstrumentVerdict.Builder)`

### newBuilder(FraudPreventionAssessment.StolenInstrumentVerdict prototype)

```
public static FraudPreventionAssessment.StolenInstrumentVerdict.Builder newBuilder(FraudPreventionAssessment.StolenInstrumentVerdict prototype)
```
...
```
public static FraudPreventionAssessment.StolenInstrumentVerdict parseDelimitedFrom(InputStream input)
```
...
```
public static FraudPreventionAssessment.StolenInstrumentVerdict parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static FraudPreventionAssessment.StolenInstrumentVerdict parseFrom(byte[] data)
```
...
```
public static FraudPreventionAssessment.StolenInstrumentVerdict parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static FraudPreventionAssessment.StolenInstrumentVerdict parseFrom(ByteString data)
```
...
```
public static FraudPreventionAssessment.StolenInstrumentVerdict parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static FraudPreventionAssessment.StolenInstrumentVerdict parseFrom(CodedInputStream input)
```
...
```
public static FraudPreventionAssessment.StolenInstrumentVerdict parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static FraudPreventionAssessment.StolenInstrumentVerdict parseFrom(InputStream input)
```
...
```
public static FraudPreventionAssessment.StolenInstrumentVerdict parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static FraudPreventionAssessment.StolenInstrumentVerdict parseFrom(ByteBuffer data)
```
...
```
public static FraudPreventionAssessment.StolenInstrumentVerdict parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<FraudPreventionAssessment.StolenInstrumentVerdict> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[StolenInstrumentVerdict](/java/docs/reference/google-cloud-recaptchaenterprise/3.51.0/com.google.recaptchaenterprise.v1beta1.FraudPreventionAssessment.StolenInstrumentVerdict)>`
...
```
public FraudPreventionAssessment.StolenInstrumentVerdict getDefaultInstanceForType()
```
...
```
public Parser<FraudPreventionAssessment.StolenInstrumentVerdict> getParserForType()
```
...
```
public FraudPreventionAssessment.StolenInstrumentVerdict.Builder newBuilderForType()
```
...
```
protected FraudPreventionAssessment.StolenInstrumentVerdict.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public FraudPreventionAssessment.StolenInstrumentVerdict.Builder toBuilder()
```
