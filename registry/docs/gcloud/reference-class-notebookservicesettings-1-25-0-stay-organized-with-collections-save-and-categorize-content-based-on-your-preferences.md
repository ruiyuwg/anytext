...
# Class NotebookServiceSettings (1.25.0) Stay organized with collections Save and categorize content based on your preferences.
...
Settings class to configure an instance of [NotebookServiceClient](/java/docs/reference/google-cloud-notebooks/1.25.0/com.google.cloud.notebooks.v2.NotebookServiceClient).
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [ClientSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.ClientSettings.html) \> NotebookServiceSettings
...
`[NotebookServiceStubSettings](/java/docs/reference/google-cloud-notebooks/1.25.0/com.google.cloud.notebooks.v2.stub.NotebookServiceStubSettings)`  
...
`[NotebookServiceSettings](/java/docs/reference/google-cloud-notebooks/1.25.0/com.google.cloud.notebooks.v2.NotebookServiceSettings)`
...
`[NotebookServiceSettings.Builder](/java/docs/reference/google-cloud-notebooks/1.25.0/com.google.cloud.notebooks.v2.NotebookServiceSettings.Builder)`

### newBuilder(ClientContext clientContext)

```
public static NotebookServiceSettings.Builder newBuilder(ClientContext clientContext)
```
...
```
public static NotebookServiceSettings.Builder newHttpJsonBuilder()
```
...
```
protected NotebookServiceSettings(NotebookServiceSettings.Builder settingsBuilder)
```
