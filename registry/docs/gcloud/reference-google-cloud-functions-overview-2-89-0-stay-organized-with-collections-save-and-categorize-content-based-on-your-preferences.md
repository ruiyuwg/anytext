...
# google-cloud-functions overview (2.89.0) Stay organized with collections Save and categorize content based on your preferences.

2.89.0 (latest) 2.87.0 2.85.0 2.84.0 2.83.0 2.82.0 2.80.0 2.78.0 2.77.0 2.76.0 2.75.0 2.74.0 2.72.0 2.70.0 2.69.0 2.66.0 2.65.0 2.64.0 2.62.0 2.61.0 2.60.0 2.59.0 2.58.0 2.57.0 2.56.0 2.55.0 2.54.0 2.53.0 2.51.0 2.50.0 2.49.0 2.48.0 2.47.0 2.46.0 2.45.0 2.44.0 2.43.0 2.42.0 2.41.0 2.39.0 2.38.0 2.37.0 2.36.0 2.35.0 2.34.0 2.33.0 2.32.0 2.31.0 2.30.0 2.29.0 2.26.0 2.25.0 2.24.0 2.23.0 2.22.0 2.21.0 2.20.0 2.19.0 2.18.0 2.17.0 2.16.0 2.15.0 2.14.0 2.13.0 2.11.0 2.10.0 2.9.0 2.8.0 2.7.0 2.6.0 2.5.4 2.4.3 2.3.6

## Key Reference Links

**Cloud Functions Description:** Is a scalable pay as you go Functions-as-a-Service (FaaS) to run your code with zero server management.

[Cloud Functions Product Reference](https://cloud.google.com/functions)

[GitHub Repository](https://github.com/googleapis/google-cloud-java/tree/main/java-functions)

[Maven artifact](https://central.sonatype.com/artifact/com.google.cloud/google-cloud-functions)
...
-   [Enable the API](https://console.cloud.google.com/apis/library/cloudfunctions.googleapis.com)
-   [Set up authentication](https://cloud.google.com/docs/authentication/client-libraries)

## Use the Cloud Functions for Java
...
The example below demonstrates how you would import the BOM and include the `google-cloud-functions` artifact.
...
libraryDependencies += "com.google.cloud" % "google-cloud-functions" % "2.89.0"

## Which version ID should I get started with?

For this library, we recommend using [com.google.cloud.functions.v2](https://cloud.google.com/java/docs/reference/google-cloud-functions/2.89.0/com.google.cloud.functions.v2) for new applications.
