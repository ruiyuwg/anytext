...
# Class TransferProto.CreateAgentPoolRequest (1.32.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> TransferProto.CreateAgentPoolRequest

## Implements

[TransferProto.CreateAgentPoolRequestOrBuilder](/java/docs/reference/google-cloud-storage-transfer/1.32.0/com.google.storagetransfer.v1.proto.TransferProto.CreateAgentPoolRequestOrBuilder)
...
### AGENT\_POOL\_ID\_FIELD\_NUMBER
...
`[TransferProto.CreateAgentPoolRequest](/java/docs/reference/google-cloud-storage-transfer/1.32.0/com.google.storagetransfer.v1.proto.TransferProto.CreateAgentPoolRequest)`
...
`[TransferProto.CreateAgentPoolRequest.Builder](/java/docs/reference/google-cloud-storage-transfer/1.32.0/com.google.storagetransfer.v1.proto.TransferProto.CreateAgentPoolRequest.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[CreateAgentPoolRequest](/java/docs/reference/google-cloud-storage-transfer/1.32.0/com.google.storagetransfer.v1.proto.TransferProto.CreateAgentPoolRequest)>`
...
`[TransferTypes.AgentPool](/java/docs/reference/google-cloud-storage-transfer/1.32.0/com.google.storagetransfer.v1.proto.TransferTypes.AgentPool)`
...
-   Start with a lowercase ASCII character, followed by:
    ...
    As expressed by the regular expression: `^(?!goog)[a-z](/java/docs/reference/google-cloud-storage-transfer/1.32.0/[a-z0-9-._~]*[a-z0-9])?$`.
...
`[TransferTypes.AgentPoolOrBuilder](/java/docs/reference/google-cloud-storage-transfer/1.32.0/com.google.storagetransfer.v1.proto.TransferTypes.AgentPoolOrBuilder)`
