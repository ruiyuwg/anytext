...
# Class PredictResponse.PredictionResult (2.2.3) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class PredictResponse.PredictionResult extends GeneratedMessageV3 implements PredictResponse.PredictionResultOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> PredictResponse.PredictionResult

## Implements

[PredictResponse.PredictionResultOrBuilder](/java/docs/reference/google-cloud-retail/2.2.3/com.google.cloud.retail.v2alpha.PredictResponse.PredictionResultOrBuilder)
...
```
public static PredictResponse.PredictionResult getDefaultInstance()
```
...
[PredictResponse.PredictionResult](/java/docs/reference/google-cloud-retail/2.2.3/com.google.cloud.retail.v2alpha.PredictResponse.PredictionResult)
...
```
public static PredictResponse.PredictionResult.Builder newBuilder()
```
...
[PredictResponse.PredictionResult.Builder](/java/docs/reference/google-cloud-retail/2.2.3/com.google.cloud.retail.v2alpha.PredictResponse.PredictionResult.Builder)

### newBuilder(PredictResponse.PredictionResult prototype)

```
public static PredictResponse.PredictionResult.Builder newBuilder(PredictResponse.PredictionResult prototype)
```
...
```
public static PredictResponse.PredictionResult parseDelimitedFrom(InputStream input)
```
...
```
public static PredictResponse.PredictionResult parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PredictResponse.PredictionResult parseFrom(byte[] data)
```
...
```
public static PredictResponse.PredictionResult parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PredictResponse.PredictionResult parseFrom(ByteString data)
```
...
```
public static PredictResponse.PredictionResult parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PredictResponse.PredictionResult parseFrom(CodedInputStream input)
```
...
```
public static PredictResponse.PredictionResult parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PredictResponse.PredictionResult parseFrom(InputStream input)
```
...
```
public static PredictResponse.PredictionResult parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PredictResponse.PredictionResult parseFrom(ByteBuffer data)
```
...
```
public static PredictResponse.PredictionResult parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<PredictResponse.PredictionResult> parser()
```
...
[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[PredictionResult](/java/docs/reference/google-cloud-retail/2.2.3/com.google.cloud.retail.v2alpha.PredictResponse.PredictionResult)\>
...
Use [#getMetadataMap()](/java/docs/reference/google-cloud-retail/2.2.3/com.google.cloud.retail.v2alpha.PredictResponse.PredictionResult#com_google_cloud_retail_v2alpha_PredictResponse_PredictionResult_getMetadataMap__) instead.
...
```
public Parser<PredictResponse.PredictionResult> getParserForType()
```
...
```
public PredictResponse.PredictionResult.Builder newBuilderForType()
```
...
```
protected PredictResponse.PredictionResult.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public PredictResponse.PredictionResult.Builder toBuilder()
```
