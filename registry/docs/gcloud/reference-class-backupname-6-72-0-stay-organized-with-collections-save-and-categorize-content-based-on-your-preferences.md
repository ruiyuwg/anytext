...
# Class BackupName (6.72.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> BackupName
...
### format(String project, String instance, String backup)
...
`[BackupName.Builder](/java/docs/reference/google-cloud-spanner/6.72.0/com.google.spanner.admin.database.v1.BackupName.Builder)`
...
`[BackupName](/java/docs/reference/google-cloud-spanner/6.72.0/com.google.spanner.admin.database.v1.BackupName)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[BackupName](/java/docs/reference/google-cloud-spanner/6.72.0/com.google.spanner.admin.database.v1.BackupName)>`
