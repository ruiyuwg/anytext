...
# Class ListNodesResponse (2.52.0) Stay organized with collections Save and categorize content based on your preferences.
...
[ListNodesResponseOrBuilder](/java/docs/reference/google-cloud-tpu/2.52.0/com.google.cloud.tpu.v1.ListNodesResponseOrBuilder)
...
`[ListNodesResponse](/java/docs/reference/google-cloud-tpu/2.52.0/com.google.cloud.tpu.v1.ListNodesResponse)`
...
`[ListNodesResponse.Builder](/java/docs/reference/google-cloud-tpu/2.52.0/com.google.cloud.tpu.v1.ListNodesResponse.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListNodesResponse](/java/docs/reference/google-cloud-tpu/2.52.0/com.google.cloud.tpu.v1.ListNodesResponse)>`
...
`[Node](/java/docs/reference/google-cloud-tpu/2.52.0/com.google.cloud.tpu.v1.Node)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Node](/java/docs/reference/google-cloud-tpu/2.52.0/com.google.cloud.tpu.v1.Node)>`
...
`[NodeOrBuilder](/java/docs/reference/google-cloud-tpu/2.52.0/com.google.cloud.tpu.v1.NodeOrBuilder)`
