...
# Cloud AI Platform v1 API - Enum ExplanationMetadata.Types.InputMetadata.Types.Visualization.Types.Type (2.10.0) Stay organized with collections Save and categorize content based on your preferences.
...
Type of the image visualization. Only applicable to \[Integrated Gradients attribution\]\[google.cloud.aiplatform.v1.ExplanationParameters.integrated\_gradients\_attribution\].

## Namespace

[Google](https://cloud.google.com/dotnet/docs/reference/Google.Apis/latest/Google.html)[Cloud](https://cloud.google.com/dotnet/docs/reference/Google.LongRunning/latest/Google.Cloud.html)Google.Cloud.AIPlatform[V1](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/2.10.0/Google.Cloud.AIPlatform.V1)
