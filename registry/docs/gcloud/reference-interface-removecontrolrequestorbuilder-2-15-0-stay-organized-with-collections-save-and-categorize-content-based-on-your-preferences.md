...
# Interface RemoveControlRequestOrBuilder (2.15.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface RemoveControlRequestOrBuilder extends MessageOrBuilder
```
