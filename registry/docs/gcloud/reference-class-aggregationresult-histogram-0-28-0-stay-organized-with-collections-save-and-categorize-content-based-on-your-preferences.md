...
# Class AggregationResult.Histogram (0.28.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> AggregationResult.Histogram

## Implements

[AggregationResult.HistogramOrBuilder](/java/docs/reference/google-cloud-migrationcenter/0.28.0/com.google.cloud.migrationcenter.v1.AggregationResult.HistogramOrBuilder)
...
`[AggregationResult.Histogram](/java/docs/reference/google-cloud-migrationcenter/0.28.0/com.google.cloud.migrationcenter.v1.AggregationResult.Histogram)`
...
`[AggregationResult.Histogram.Builder](/java/docs/reference/google-cloud-migrationcenter/0.28.0/com.google.cloud.migrationcenter.v1.AggregationResult.Histogram.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[Histogram](/java/docs/reference/google-cloud-migrationcenter/0.28.0/com.google.cloud.migrationcenter.v1.AggregationResult.Histogram)>`
...
`[AggregationResult.Histogram.Bucket](/java/docs/reference/google-cloud-migrationcenter/0.28.0/com.google.cloud.migrationcenter.v1.AggregationResult.Histogram.Bucket)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Bucket](/java/docs/reference/google-cloud-migrationcenter/0.28.0/com.google.cloud.migrationcenter.v1.AggregationResult.Histogram.Bucket)>`
...
`[AggregationResult.Histogram.BucketOrBuilder](/java/docs/reference/google-cloud-migrationcenter/0.28.0/com.google.cloud.migrationcenter.v1.AggregationResult.Histogram.BucketOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.migrationcenter.v1.AggregationResult.Histogram.BucketOrBuilder>`
