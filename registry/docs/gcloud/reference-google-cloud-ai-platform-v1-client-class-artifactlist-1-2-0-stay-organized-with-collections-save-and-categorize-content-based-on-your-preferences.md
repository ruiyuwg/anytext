...
# Google Cloud Ai Platform V1 Client - Class ArtifactList (1.2.0) Stay organized with collections Save and categorize content based on your preferences.
...
`array<[Google\Cloud\AIPlatform\V1\Artifact](/php/docs/reference/cloud-ai-platform/1.2.0/V1.Artifact)>`  
