...
# Class GetTaskRequest.Builder (2.21.0) Stay organized with collections Save and categorize content based on your preferences.
...
[GetTaskRequestOrBuilder](/java/docs/reference/google-cloud-tasks/2.21.0/com.google.cloud.tasks.v2beta2.GetTaskRequestOrBuilder)
...
`[GetTaskRequest.Builder](/java/docs/reference/google-cloud-tasks/2.21.0/com.google.cloud.tasks.v2beta2.GetTaskRequest.Builder)`
...
`[GetTaskRequest](/java/docs/reference/google-cloud-tasks/2.21.0/com.google.cloud.tasks.v2beta2.GetTaskRequest)`
...
`[Task.View](/java/docs/reference/google-cloud-tasks/2.21.0/com.google.cloud.tasks.v2beta2.Task.View)`
