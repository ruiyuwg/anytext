...
# Class UpdateInsightTypeConfigRequest (2.44.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class UpdateInsightTypeConfigRequest extends GeneratedMessageV3 implements UpdateInsightTypeConfigRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> UpdateInsightTypeConfigRequest

## Implements

[UpdateInsightTypeConfigRequestOrBuilder](/java/docs/reference/google-cloud-recommender/2.44.0/com.google.cloud.recommender.v1.UpdateInsightTypeConfigRequestOrBuilder)
...
### INSIGHT\_TYPE\_CONFIG\_FIELD\_NUMBER

```
public static final int INSIGHT_TYPE_CONFIG_FIELD_NUMBER
```
...
```
public static UpdateInsightTypeConfigRequest getDefaultInstance()
```
...
`[UpdateInsightTypeConfigRequest](/java/docs/reference/google-cloud-recommender/2.44.0/com.google.cloud.recommender.v1.UpdateInsightTypeConfigRequest)`
...
```
public static UpdateInsightTypeConfigRequest.Builder newBuilder()
```
...
`[UpdateInsightTypeConfigRequest.Builder](/java/docs/reference/google-cloud-recommender/2.44.0/com.google.cloud.recommender.v1.UpdateInsightTypeConfigRequest.Builder)`

### newBuilder(UpdateInsightTypeConfigRequest prototype)

```
public static UpdateInsightTypeConfigRequest.Builder newBuilder(UpdateInsightTypeConfigRequest prototype)
```
...
```
public static UpdateInsightTypeConfigRequest parseDelimitedFrom(InputStream input)
```
...
```
public static UpdateInsightTypeConfigRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateInsightTypeConfigRequest parseFrom(byte[] data)
```
...
```
public static UpdateInsightTypeConfigRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateInsightTypeConfigRequest parseFrom(ByteString data)
```
...
```
public static UpdateInsightTypeConfigRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateInsightTypeConfigRequest parseFrom(CodedInputStream input)
```
...
```
public static UpdateInsightTypeConfigRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateInsightTypeConfigRequest parseFrom(InputStream input)
```
...
```
public static UpdateInsightTypeConfigRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateInsightTypeConfigRequest parseFrom(ByteBuffer data)
```
...
```
public static UpdateInsightTypeConfigRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<UpdateInsightTypeConfigRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[UpdateInsightTypeConfigRequest](/java/docs/reference/google-cloud-recommender/2.44.0/com.google.cloud.recommender.v1.UpdateInsightTypeConfigRequest)>`
...
```
public InsightTypeConfig getInsightTypeConfig()
```
...
`[InsightTypeConfig](/java/docs/reference/google-cloud-recommender/2.44.0/com.google.cloud.recommender.v1.InsightTypeConfig)`
...
```
public InsightTypeConfigOrBuilder getInsightTypeConfigOrBuilder()
```
...
`[InsightTypeConfigOrBuilder](/java/docs/reference/google-cloud-recommender/2.44.0/com.google.cloud.recommender.v1.InsightTypeConfigOrBuilder)`

### getParserForType()

```
public Parser<UpdateInsightTypeConfigRequest> getParserForType()
```
...
```
public UpdateInsightTypeConfigRequest.Builder newBuilderForType()
```
...
```
protected UpdateInsightTypeConfigRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public UpdateInsightTypeConfigRequest.Builder toBuilder()
```
