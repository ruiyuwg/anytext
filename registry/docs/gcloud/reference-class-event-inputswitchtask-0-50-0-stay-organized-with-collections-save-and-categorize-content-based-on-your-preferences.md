...
# Class Event.InputSwitchTask (0.50.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class Event.InputSwitchTask extends GeneratedMessageV3 implements Event.InputSwitchTaskOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> Event.InputSwitchTask

## Implements

[Event.InputSwitchTaskOrBuilder](/java/docs/reference/google-cloud-live-stream/0.50.0/com.google.cloud.video.livestream.v1.Event.InputSwitchTaskOrBuilder)
...
```
public static Event.InputSwitchTask getDefaultInstance()
```
...
`[Event.InputSwitchTask](/java/docs/reference/google-cloud-live-stream/0.50.0/com.google.cloud.video.livestream.v1.Event.InputSwitchTask)`
...
```
public static Event.InputSwitchTask.Builder newBuilder()
```
...
`[Event.InputSwitchTask.Builder](/java/docs/reference/google-cloud-live-stream/0.50.0/com.google.cloud.video.livestream.v1.Event.InputSwitchTask.Builder)`

### newBuilder(Event.InputSwitchTask prototype)

```
public static Event.InputSwitchTask.Builder newBuilder(Event.InputSwitchTask prototype)
```
...
```
public static Event.InputSwitchTask parseDelimitedFrom(InputStream input)
```
...
```
public static Event.InputSwitchTask parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Event.InputSwitchTask parseFrom(byte[] data)
```
...
```
public static Event.InputSwitchTask parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Event.InputSwitchTask parseFrom(ByteString data)
```
...
```
public static Event.InputSwitchTask parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Event.InputSwitchTask parseFrom(CodedInputStream input)
```
...
```
public static Event.InputSwitchTask parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Event.InputSwitchTask parseFrom(InputStream input)
```
...
```
public static Event.InputSwitchTask parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Event.InputSwitchTask parseFrom(ByteBuffer data)
```
...
```
public static Event.InputSwitchTask parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<Event.InputSwitchTask> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[InputSwitchTask](/java/docs/reference/google-cloud-live-stream/0.50.0/com.google.cloud.video.livestream.v1.Event.InputSwitchTask)>`
...
```
public Parser<Event.InputSwitchTask> getParserForType()
```
...
```
public Event.InputSwitchTask.Builder newBuilderForType()
```
...
```
protected Event.InputSwitchTask.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public Event.InputSwitchTask.Builder toBuilder()
```
