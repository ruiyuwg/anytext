...
# Class GuestPolicies.SoftwareRecipe.Artifact.Gcs.Builder (2.33.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> GuestPolicies.SoftwareRecipe.Artifact.Gcs.Builder

## Implements

[GuestPolicies.SoftwareRecipe.Artifact.GcsOrBuilder](/java/docs/reference/google-cloud-os-config/2.33.0/com.google.cloud.osconfig.v1beta.GuestPolicies.SoftwareRecipe.Artifact.GcsOrBuilder)
...
`[GuestPolicies.SoftwareRecipe.Artifact.Gcs.Builder](/java/docs/reference/google-cloud-os-config/2.33.0/com.google.cloud.osconfig.v1beta.GuestPolicies.SoftwareRecipe.Artifact.Gcs.Builder)`
...
`[GuestPolicies.SoftwareRecipe.Artifact.Gcs](/java/docs/reference/google-cloud-os-config/2.33.0/com.google.cloud.osconfig.v1beta.GuestPolicies.SoftwareRecipe.Artifact.Gcs)`
...
Bucket of the Google Cloud Storage object. Given an example URL: `[https://storage.googleapis.com/my-bucket/foo/bar#1234567](https://storage.googleapis.com/my-bucket/foo/bar#1234567)` this value would be `my-bucket`.
...
Must be provided if allow\_insecure is false. Generation number of the Google Cloud Storage object. `[https://storage.googleapis.com/my-bucket/foo/bar#1234567](https://storage.googleapis.com/my-bucket/foo/bar#1234567)` this value would be `1234567`.
...
Name of the Google Cloud Storage object. As specified [here](https://cloud.google.com/storage/docs/naming#objectnames) Given an example URL: `[https://storage.googleapis.com/my-bucket/foo/bar#1234567](https://storage.googleapis.com/my-bucket/foo/bar#1234567)` this value would be `foo/bar`.
