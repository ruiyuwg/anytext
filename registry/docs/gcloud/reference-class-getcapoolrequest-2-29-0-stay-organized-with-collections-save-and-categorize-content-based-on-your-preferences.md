...
# Class GetCaPoolRequest (2.29.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class GetCaPoolRequest extends GeneratedMessageV3 implements GetCaPoolRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> GetCaPoolRequest

## Implements

[GetCaPoolRequestOrBuilder](/java/docs/reference/google-cloud-security-private-ca/2.29.0/com.google.cloud.security.privateca.v1.GetCaPoolRequestOrBuilder)
...
```
public static GetCaPoolRequest getDefaultInstance()
```
...
`[GetCaPoolRequest](/java/docs/reference/google-cloud-security-private-ca/2.29.0/com.google.cloud.security.privateca.v1.GetCaPoolRequest)`
...
```
public static GetCaPoolRequest.Builder newBuilder()
```
...
`[GetCaPoolRequest.Builder](/java/docs/reference/google-cloud-security-private-ca/2.29.0/com.google.cloud.security.privateca.v1.GetCaPoolRequest.Builder)`

### newBuilder(GetCaPoolRequest prototype)

```
public static GetCaPoolRequest.Builder newBuilder(GetCaPoolRequest prototype)
```
...
```
public static GetCaPoolRequest parseDelimitedFrom(InputStream input)
```
...
```
public static GetCaPoolRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetCaPoolRequest parseFrom(byte[] data)
```
...
```
public static GetCaPoolRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetCaPoolRequest parseFrom(ByteString data)
```
...
```
public static GetCaPoolRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetCaPoolRequest parseFrom(CodedInputStream input)
```
...
```
public static GetCaPoolRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetCaPoolRequest parseFrom(InputStream input)
```
...
```
public static GetCaPoolRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetCaPoolRequest parseFrom(ByteBuffer data)
```
...
```
public static GetCaPoolRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<GetCaPoolRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[GetCaPoolRequest](/java/docs/reference/google-cloud-security-private-ca/2.29.0/com.google.cloud.security.privateca.v1.GetCaPoolRequest)>`
...
```
public GetCaPoolRequest getDefaultInstanceForType()
```
...
```
public Parser<GetCaPoolRequest> getParserForType()
```
...
```
public GetCaPoolRequest.Builder newBuilderForType()
```
...
```
protected GetCaPoolRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public GetCaPoolRequest.Builder toBuilder()
```
