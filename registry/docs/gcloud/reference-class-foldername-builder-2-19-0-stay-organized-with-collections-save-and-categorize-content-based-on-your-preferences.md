...
# Class FolderName.Builder (2.19.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class FolderName.Builder
```
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> FolderName.Builder
...
`[FolderName](/java/docs/reference/google-cloud-securitycenter/2.19.0/com.google.cloud.securitycenter.v1.FolderName)`
...
`[FolderName.Builder](/java/docs/reference/google-cloud-securitycenter/2.19.0/com.google.cloud.securitycenter.v1.FolderName.Builder)`
