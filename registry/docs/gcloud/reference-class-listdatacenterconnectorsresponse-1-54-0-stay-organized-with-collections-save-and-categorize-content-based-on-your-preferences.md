...
# Class ListDatacenterConnectorsResponse (1.54.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListDatacenterConnectorsResponse

## Implements

[ListDatacenterConnectorsResponseOrBuilder](/java/docs/reference/google-cloud-vmmigration/1.54.0/com.google.cloud.vmmigration.v1.ListDatacenterConnectorsResponseOrBuilder)
...
### DATACENTER\_CONNECTORS\_FIELD\_NUMBER

```
public static final int DATACENTER_CONNECTORS_FIELD_NUMBER
```
...
`[ListDatacenterConnectorsResponse](/java/docs/reference/google-cloud-vmmigration/1.54.0/com.google.cloud.vmmigration.v1.ListDatacenterConnectorsResponse)`
...
```
public static ListDatacenterConnectorsResponse.Builder newBuilder()
```
...
`[ListDatacenterConnectorsResponse.Builder](/java/docs/reference/google-cloud-vmmigration/1.54.0/com.google.cloud.vmmigration.v1.ListDatacenterConnectorsResponse.Builder)`

### newBuilder(ListDatacenterConnectorsResponse prototype)

```
public static ListDatacenterConnectorsResponse.Builder newBuilder(ListDatacenterConnectorsResponse prototype)
```
...
```
public static ListDatacenterConnectorsResponse parseDelimitedFrom(InputStream input)
```
...
```
public static ListDatacenterConnectorsResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListDatacenterConnectorsResponse parseFrom(byte[] data)
```
...
```
public static ListDatacenterConnectorsResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListDatacenterConnectorsResponse parseFrom(ByteString data)
```
...
```
public static ListDatacenterConnectorsResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListDatacenterConnectorsResponse parseFrom(CodedInputStream input)
```
...
```
public static ListDatacenterConnectorsResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListDatacenterConnectorsResponse parseFrom(InputStream input)
```
...
```
public static ListDatacenterConnectorsResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListDatacenterConnectorsResponse parseFrom(ByteBuffer data)
```
...
```
public static ListDatacenterConnectorsResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListDatacenterConnectorsResponse](/java/docs/reference/google-cloud-vmmigration/1.54.0/com.google.cloud.vmmigration.v1.ListDatacenterConnectorsResponse)>`
...
### getDatacenterConnectors(int index)

```
public DatacenterConnector getDatacenterConnectors(int index)
```
...
`[DatacenterConnector](/java/docs/reference/google-cloud-vmmigration/1.54.0/com.google.cloud.vmmigration.v1.DatacenterConnector)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[DatacenterConnector](/java/docs/reference/google-cloud-vmmigration/1.54.0/com.google.cloud.vmmigration.v1.DatacenterConnector)>`

### getDatacenterConnectorsOrBuilder(int index)

```
public DatacenterConnectorOrBuilder getDatacenterConnectorsOrBuilder(int index)
```
...
`[DatacenterConnectorOrBuilder](/java/docs/reference/google-cloud-vmmigration/1.54.0/com.google.cloud.vmmigration.v1.DatacenterConnectorOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.vmmigration.v1.DatacenterConnectorOrBuilder>`
...
```
public ListDatacenterConnectorsResponse.Builder newBuilderForType()
```
...
```
protected ListDatacenterConnectorsResponse.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ListDatacenterConnectorsResponse.Builder toBuilder()
```
