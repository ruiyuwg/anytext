...
# Class RecommendationContent (2.33.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> RecommendationContent

## Implements

[RecommendationContentOrBuilder](/java/docs/reference/google-cloud-recommender/2.33.0/com.google.cloud.recommender.v1.RecommendationContentOrBuilder)
...
### OPERATION\_GROUPS\_FIELD\_NUMBER

```
public static final int OPERATION_GROUPS_FIELD_NUMBER
```
...
`[RecommendationContent](/java/docs/reference/google-cloud-recommender/2.33.0/com.google.cloud.recommender.v1.RecommendationContent)`
...
```
public static RecommendationContent.Builder newBuilder()
```
...
`[RecommendationContent.Builder](/java/docs/reference/google-cloud-recommender/2.33.0/com.google.cloud.recommender.v1.RecommendationContent.Builder)`

### newBuilder(RecommendationContent prototype)

```
public static RecommendationContent.Builder newBuilder(RecommendationContent prototype)
```
...
```
public static RecommendationContent parseDelimitedFrom(InputStream input)
```
...
```
public static RecommendationContent parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RecommendationContent parseFrom(byte[] data)
```
...
```
public static RecommendationContent parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RecommendationContent parseFrom(ByteString data)
```
...
```
public static RecommendationContent parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RecommendationContent parseFrom(CodedInputStream input)
```
...
```
public static RecommendationContent parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RecommendationContent parseFrom(InputStream input)
```
...
```
public static RecommendationContent parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RecommendationContent parseFrom(ByteBuffer data)
```
...
```
public static RecommendationContent parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[RecommendationContent](/java/docs/reference/google-cloud-recommender/2.33.0/com.google.cloud.recommender.v1.RecommendationContent)>`
...
`[OperationGroup](/java/docs/reference/google-cloud-recommender/2.33.0/com.google.cloud.recommender.v1.OperationGroup)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[OperationGroup](/java/docs/reference/google-cloud-recommender/2.33.0/com.google.cloud.recommender.v1.OperationGroup)>`
...
`[OperationGroupOrBuilder](/java/docs/reference/google-cloud-recommender/2.33.0/com.google.cloud.recommender.v1.OperationGroupOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.recommender.v1.OperationGroupOrBuilder>`
...
```
public RecommendationContent.Builder newBuilderForType()
```
...
```
protected RecommendationContent.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public RecommendationContent.Builder toBuilder()
```
