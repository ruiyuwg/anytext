...
# Enum CatalogAttribute.DynamicFacetableOption (2.36.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-retail/2.36.0/com.google.cloud.retail.v2.CatalogAttribute.DynamicFacetableOption#com_google_cloud_retail_v2_CatalogAttribute_DynamicFacetableOption_forNumber_int_) instead._
