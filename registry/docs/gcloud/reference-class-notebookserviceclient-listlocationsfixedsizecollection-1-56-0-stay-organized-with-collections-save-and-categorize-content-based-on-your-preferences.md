...
# Class NotebookServiceClient.ListLocationsFixedSizeCollection (1.56.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class NotebookServiceClient.ListLocationsFixedSizeCollection extends AbstractFixedSizeCollection<ListLocationsRequest,ListLocationsResponse,Location,NotebookServiceClient.ListLocationsPage,NotebookServiceClient.ListLocationsFixedSizeCollection>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractFixedSizeCollection](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractFixedSizeCollection.html) \> NotebookServiceClient.ListLocationsFixedSizeCollection
...
### createCollection(List<NotebookServiceClient.ListLocationsPage> pages, int collectionSize)

```
protected NotebookServiceClient.ListLocationsFixedSizeCollection createCollection(List<NotebookServiceClient.ListLocationsPage> pages, int collectionSize)
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ListLocationsPage](/java/docs/reference/google-cloud-notebooks/1.56.0/com.google.cloud.notebooks.v2.NotebookServiceClient.ListLocationsPage)>`  
...
`[NotebookServiceClient.ListLocationsFixedSizeCollection](/java/docs/reference/google-cloud-notebooks/1.56.0/com.google.cloud.notebooks.v2.NotebookServiceClient.ListLocationsFixedSizeCollection)`
