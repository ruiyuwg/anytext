...
# Class ServingConfigServiceGrpc.ServingConfigServiceStub (2.29.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[AddControlRequest](/java/docs/reference/google-cloud-retail/2.29.0/com.google.cloud.retail.v2.AddControlRequest)`  

`responseObserver`

`io.grpc.stub.StreamObserver<[ServingConfig](/java/docs/reference/google-cloud-retail/2.29.0/com.google.cloud.retail.v2.ServingConfig)>`  
...
`[ServingConfigServiceGrpc.ServingConfigServiceStub](/java/docs/reference/google-cloud-retail/2.29.0/com.google.cloud.retail.v2.ServingConfigServiceGrpc.ServingConfigServiceStub)`
...
`[CreateServingConfigRequest](/java/docs/reference/google-cloud-retail/2.29.0/com.google.cloud.retail.v2.CreateServingConfigRequest)`  
...
`[DeleteServingConfigRequest](/java/docs/reference/google-cloud-retail/2.29.0/com.google.cloud.retail.v2.DeleteServingConfigRequest)`  
...
`[GetServingConfigRequest](/java/docs/reference/google-cloud-retail/2.29.0/com.google.cloud.retail.v2.GetServingConfigRequest)`  
...
`[ListServingConfigsRequest](/java/docs/reference/google-cloud-retail/2.29.0/com.google.cloud.retail.v2.ListServingConfigsRequest)`  

`responseObserver`

`io.grpc.stub.StreamObserver<[ListServingConfigsResponse](/java/docs/reference/google-cloud-retail/2.29.0/com.google.cloud.retail.v2.ListServingConfigsResponse)>`  
...
`[RemoveControlRequest](/java/docs/reference/google-cloud-retail/2.29.0/com.google.cloud.retail.v2.RemoveControlRequest)`  
...
`[UpdateServingConfigRequest](/java/docs/reference/google-cloud-retail/2.29.0/com.google.cloud.retail.v2.UpdateServingConfigRequest)`  
