...
# Class AsyncBatchAnnotateFilesRequest.Builder (3.43.0) Stay organized with collections Save and categorize content based on your preferences.
...
[AsyncBatchAnnotateFilesRequestOrBuilder](/java/docs/reference/google-cloud-vision/3.43.0/com.google.cloud.vision.v1.AsyncBatchAnnotateFilesRequestOrBuilder)
...
`[AsyncBatchAnnotateFilesRequest.Builder](/java/docs/reference/google-cloud-vision/3.43.0/com.google.cloud.vision.v1.AsyncBatchAnnotateFilesRequest.Builder)`
...
`[AsyncAnnotateFileRequest](/java/docs/reference/google-cloud-vision/3.43.0/com.google.cloud.vision.v1.AsyncAnnotateFileRequest)`  
...
`[AsyncAnnotateFileRequest.Builder](/java/docs/reference/google-cloud-vision/3.43.0/com.google.cloud.vision.v1.AsyncAnnotateFileRequest.Builder)`  
...
`[AsyncBatchAnnotateFilesRequest](/java/docs/reference/google-cloud-vision/3.43.0/com.google.cloud.vision.v1.AsyncBatchAnnotateFilesRequest)`
...
Use [#getLabelsMap()](/java/docs/reference/google-cloud-vision/3.43.0/com.google.cloud.vision.v1.AsyncBatchAnnotateFilesRequest.Builder#com_google_cloud_vision_v1_AsyncBatchAnnotateFilesRequest_Builder_getLabelsMap__) instead.
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Builder](/java/docs/reference/google-cloud-vision/3.43.0/com.google.cloud.vision.v1.AsyncAnnotateFileRequest.Builder)>`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[AsyncAnnotateFileRequest](/java/docs/reference/google-cloud-vision/3.43.0/com.google.cloud.vision.v1.AsyncAnnotateFileRequest)>`
...
`[AsyncAnnotateFileRequestOrBuilder](/java/docs/reference/google-cloud-vision/3.43.0/com.google.cloud.vision.v1.AsyncAnnotateFileRequestOrBuilder)`
