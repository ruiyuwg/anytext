...
# Class BinauthzVersion (1.37.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class BinauthzVersion extends GeneratedMessageV3 implements BinauthzVersionOrBuilder
```

The version of binauthz.

Protobuf type `google.cloud.gkehub.configmanagement.v1alpha.BinauthzVersion`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> BinauthzVersion

## Implements

[BinauthzVersionOrBuilder](/java/docs/reference/google-cloud-gkehub/1.37.0/com.google.cloud.gkehub.configmanagement.v1alpha.BinauthzVersionOrBuilder)
...
### WEBHOOK\_VERSION\_FIELD\_NUMBER

```
public static final int WEBHOOK_VERSION_FIELD_NUMBER
```
...
```
public static BinauthzVersion getDefaultInstance()
```
...
`[BinauthzVersion](/java/docs/reference/google-cloud-gkehub/1.37.0/com.google.cloud.gkehub.configmanagement.v1alpha.BinauthzVersion)`
...
```
public static BinauthzVersion.Builder newBuilder()
```
...
`[BinauthzVersion.Builder](/java/docs/reference/google-cloud-gkehub/1.37.0/com.google.cloud.gkehub.configmanagement.v1alpha.BinauthzVersion.Builder)`

### newBuilder(BinauthzVersion prototype)

```
public static BinauthzVersion.Builder newBuilder(BinauthzVersion prototype)
```
...
```
public static BinauthzVersion parseDelimitedFrom(InputStream input)
```
...
```
public static BinauthzVersion parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static BinauthzVersion parseFrom(byte[] data)
```
...
```
public static BinauthzVersion parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static BinauthzVersion parseFrom(ByteString data)
```
...
```
public static BinauthzVersion parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static BinauthzVersion parseFrom(CodedInputStream input)
```
...
```
public static BinauthzVersion parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static BinauthzVersion parseFrom(InputStream input)
```
...
```
public static BinauthzVersion parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static BinauthzVersion parseFrom(ByteBuffer data)
```
...
```
public static BinauthzVersion parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<BinauthzVersion> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[BinauthzVersion](/java/docs/reference/google-cloud-gkehub/1.37.0/com.google.cloud.gkehub.configmanagement.v1alpha.BinauthzVersion)>`
...
```
public Parser<BinauthzVersion> getParserForType()
```
...
```
public BinauthzVersion.Builder newBuilderForType()
```
...
```
protected BinauthzVersion.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public BinauthzVersion.Builder toBuilder()
```
