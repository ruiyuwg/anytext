...
# Override bigquery\_migration\_v2::MigrationServiceClient Retry Policies

This shows how to override the retry policies for bigquery\_migration\_v2::MigrationServiceClient:
