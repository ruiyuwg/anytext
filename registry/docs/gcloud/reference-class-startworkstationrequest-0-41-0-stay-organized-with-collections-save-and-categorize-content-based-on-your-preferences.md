...
# Class StartWorkstationRequest (0.41.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class StartWorkstationRequest extends GeneratedMessageV3 implements StartWorkstationRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> StartWorkstationRequest

## Implements

[StartWorkstationRequestOrBuilder](/java/docs/reference/google-cloud-workstations/0.41.0/com.google.cloud.workstations.v1.StartWorkstationRequestOrBuilder)
...
```
public static StartWorkstationRequest getDefaultInstance()
```
...
`[StartWorkstationRequest](/java/docs/reference/google-cloud-workstations/0.41.0/com.google.cloud.workstations.v1.StartWorkstationRequest)`
...
```
public static StartWorkstationRequest.Builder newBuilder()
```
...
`[StartWorkstationRequest.Builder](/java/docs/reference/google-cloud-workstations/0.41.0/com.google.cloud.workstations.v1.StartWorkstationRequest.Builder)`

### newBuilder(StartWorkstationRequest prototype)

```
public static StartWorkstationRequest.Builder newBuilder(StartWorkstationRequest prototype)
```
...
```
public static StartWorkstationRequest parseDelimitedFrom(InputStream input)
```
...
```
public static StartWorkstationRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static StartWorkstationRequest parseFrom(byte[] data)
```
...
```
public static StartWorkstationRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static StartWorkstationRequest parseFrom(ByteString data)
```
...
```
public static StartWorkstationRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static StartWorkstationRequest parseFrom(CodedInputStream input)
```
...
```
public static StartWorkstationRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static StartWorkstationRequest parseFrom(InputStream input)
```
...
```
public static StartWorkstationRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static StartWorkstationRequest parseFrom(ByteBuffer data)
```
...
```
public static StartWorkstationRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<StartWorkstationRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[StartWorkstationRequest](/java/docs/reference/google-cloud-workstations/0.41.0/com.google.cloud.workstations.v1.StartWorkstationRequest)>`
...
```
public Parser<StartWorkstationRequest> getParserForType()
```
...
```
public StartWorkstationRequest.Builder newBuilderForType()
```
...
```
protected StartWorkstationRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public StartWorkstationRequest.Builder toBuilder()
```
