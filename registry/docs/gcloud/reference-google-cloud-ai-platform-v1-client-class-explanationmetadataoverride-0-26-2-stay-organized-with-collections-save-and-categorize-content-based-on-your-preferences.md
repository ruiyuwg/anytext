...
# Google Cloud Ai Platform V1 Client - Class ExplanationMetadataOverride (0.26.2) Stay organized with collections Save and categorize content based on your preferences.
...
The [ExplanationMetadata](/php/docs/reference/cloud-ai-platform/0.26.2/V1.ExplanationMetadata) entries that can be overridden at [online explanation](/php/docs/reference/cloud-ai-platform/0.26.2/V1.PredictionServiceClient#_Google_Cloud_AIPlatform_V1_PredictionServiceClient__explain__) time.
...
Required. Overrides the [input metadata](/php/docs/reference/cloud-ai-platform/0.26.2/V1.ExplanationMetadata#_Google_Cloud_AIPlatform_V1_ExplanationMetadata__getInputs__) of the features. The key is the name of the feature to be overridden. The keys specified here must exist in the input metadata to be overridden. If a feature is not specified here, the corresponding feature's input metadata is not overridden.
