...
# Class StartBatchTransactionAction.Builder (6.56.0) Stay organized with collections Save and categorize content based on your preferences.
...
Starts a batch read-only transaction in executor. Successful outcomes of this action will contain batch\_txn\_id--the identificator that can be used to start the same transaction in other Executors to parallelize partition processing.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> StartBatchTransactionAction.Builder

## Implements

[StartBatchTransactionActionOrBuilder](/java/docs/reference/google-cloud-spanner/6.56.0/com.google.spanner.executor.v1.StartBatchTransactionActionOrBuilder)
...
`[StartBatchTransactionAction.Builder](/java/docs/reference/google-cloud-spanner/6.56.0/com.google.spanner.executor.v1.StartBatchTransactionAction.Builder)`
...
`[StartBatchTransactionAction](/java/docs/reference/google-cloud-spanner/6.56.0/com.google.spanner.executor.v1.StartBatchTransactionAction)`
...
Database role to assume while performing this action. Setting the database\_role will enforce additional role-based access checks on this action.
...
`[StartBatchTransactionAction.ParamCase](/java/docs/reference/google-cloud-spanner/6.56.0/com.google.spanner.executor.v1.StartBatchTransactionAction.ParamCase)`
