...
# Class AwsSourceDetails.Tag (1.32.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class AwsSourceDetails.Tag extends GeneratedMessageV3 implements AwsSourceDetails.TagOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> AwsSourceDetails.Tag

## Implements

[AwsSourceDetails.TagOrBuilder](/java/docs/reference/google-cloud-vmmigration/1.32.0/com.google.cloud.vmmigration.v1.AwsSourceDetails.TagOrBuilder)
...
```
public static AwsSourceDetails.Tag getDefaultInstance()
```
...
`[AwsSourceDetails.Tag](/java/docs/reference/google-cloud-vmmigration/1.32.0/com.google.cloud.vmmigration.v1.AwsSourceDetails.Tag)`
...
```
public static AwsSourceDetails.Tag.Builder newBuilder()
```
...
`[AwsSourceDetails.Tag.Builder](/java/docs/reference/google-cloud-vmmigration/1.32.0/com.google.cloud.vmmigration.v1.AwsSourceDetails.Tag.Builder)`

### newBuilder(AwsSourceDetails.Tag prototype)

```
public static AwsSourceDetails.Tag.Builder newBuilder(AwsSourceDetails.Tag prototype)
```
...
```
public static AwsSourceDetails.Tag parseDelimitedFrom(InputStream input)
```
...
```
public static AwsSourceDetails.Tag parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AwsSourceDetails.Tag parseFrom(byte[] data)
```
...
```
public static AwsSourceDetails.Tag parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AwsSourceDetails.Tag parseFrom(ByteString data)
```
...
```
public static AwsSourceDetails.Tag parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AwsSourceDetails.Tag parseFrom(CodedInputStream input)
```
...
```
public static AwsSourceDetails.Tag parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AwsSourceDetails.Tag parseFrom(InputStream input)
```
...
```
public static AwsSourceDetails.Tag parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AwsSourceDetails.Tag parseFrom(ByteBuffer data)
```
...
```
public static AwsSourceDetails.Tag parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<AwsSourceDetails.Tag> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[Tag](/java/docs/reference/google-cloud-vmmigration/1.32.0/com.google.cloud.vmmigration.v1.AwsSourceDetails.Tag)>`
...
```
public Parser<AwsSourceDetails.Tag> getParserForType()
```
...
```
public AwsSourceDetails.Tag.Builder newBuilderForType()
```
...
```
protected AwsSourceDetails.Tag.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public AwsSourceDetails.Tag.Builder toBuilder()
```
