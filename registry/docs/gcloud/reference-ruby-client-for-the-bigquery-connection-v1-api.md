...
-   [1.4.1 (latest)](/ruby/docs/reference/google-cloud-bigquery-connection-v1/latest)
-   [1.4.0](/ruby/docs/reference/google-cloud-bigquery-connection-v1/1.4.0)
-   [1.3.0](/ruby/docs/reference/google-cloud-bigquery-connection-v1/1.3.0)
-   [1.2.1](/ruby/docs/reference/google-cloud-bigquery-connection-v1/1.2.1)
-   [1.1.0](/ruby/docs/reference/google-cloud-bigquery-connection-v1/1.1.0)
-   [1.0.1](/ruby/docs/reference/google-cloud-bigquery-connection-v1/1.0.1)
-   [0.18.0](/ruby/docs/reference/google-cloud-bigquery-connection-v1/0.18.0)
-   [0.17.2](/ruby/docs/reference/google-cloud-bigquery-connection-v1/0.17.2)
-   [0.16.0](/ruby/docs/reference/google-cloud-bigquery-connection-v1/0.16.0)
-   [0.15.1](/ruby/docs/reference/google-cloud-bigquery-connection-v1/0.15.1)
-   [0.14.0](/ruby/docs/reference/google-cloud-bigquery-connection-v1/0.14.0)
-   [0.13.0](/ruby/docs/reference/google-cloud-bigquery-connection-v1/0.13.0)
-   [0.12.0](/ruby/docs/reference/google-cloud-bigquery-connection-v1/0.12.0)
-   [0.11.0](/ruby/docs/reference/google-cloud-bigquery-connection-v1/0.11.0)
-   [0.10.0](/ruby/docs/reference/google-cloud-bigquery-connection-v1/0.10.0)
-   [0.9.0](/ruby/docs/reference/google-cloud-bigquery-connection-v1/0.9.0)
-   [0.8.0](/ruby/docs/reference/google-cloud-bigquery-connection-v1/0.8.0)
-   [0.7.0](/ruby/docs/reference/google-cloud-bigquery-connection-v1/0.7.0)
-   [0.6.0](/ruby/docs/reference/google-cloud-bigquery-connection-v1/0.6.0)
-   [0.5.3](/ruby/docs/reference/google-cloud-bigquery-connection-v1/0.5.3)
...
This gem is a _versioned_ client. It provides basic client classes for a specific version of the BigQuery Connection V1 API. Most users should consider using the main client gem, [google-cloud-bigquery-connection](https://rubygems.org/gems/google-cloud-bigquery-connection). See the section below titled _Which client should I use?_ for more information.

## Installation

```
$ gem install google-cloud-bigquery-connection-v1
```
...
3.  [Enable the API.](https://console.cloud.google.com/apis/library/bigqueryconnection.googleapis.com)
4.  [Set up authentication.](https://docs.cloud.google.com/ruby/docs/reference/google-cloud-bigquery-connection-v1/latest/AUTHENTICATION "Set up authentication.")
...
response \= client.create\_connection request

View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-bigquery-connection-v1/latest) for class and method documentation.

See also the [Product Documentation](https://cloud.google.com/bigquery/docs/reference/bigqueryconnection) for general usage information.
...
Most modern Ruby client libraries for Google APIs come in two flavors: the main client library with a name such as `google-cloud-bigquery-connection`, and lower-level _versioned_ client libraries with names such as `google-cloud-bigquery-connection-v1`. _In most cases, you should install the main client._
