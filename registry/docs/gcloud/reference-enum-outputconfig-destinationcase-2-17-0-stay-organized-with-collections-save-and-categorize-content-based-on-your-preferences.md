...
# Enum OutputConfig.DestinationCase (2.17.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-redis/2.17.0/com.google.cloud.redis.v1beta1.OutputConfig.DestinationCase#com_google_cloud_redis_v1beta1_OutputConfig_DestinationCase_forNumber_int_) instead._
