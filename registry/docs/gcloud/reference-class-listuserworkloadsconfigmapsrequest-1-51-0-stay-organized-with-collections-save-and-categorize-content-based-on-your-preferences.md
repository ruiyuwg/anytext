...
# Class ListUserWorkloadsConfigMapsRequest (1.51.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListUserWorkloadsConfigMapsRequest extends GeneratedMessageV3 implements ListUserWorkloadsConfigMapsRequestOrBuilder
```

List user workloads ConfigMaps request.

Protobuf type `google.cloud.orchestration.airflow.service.v1.ListUserWorkloadsConfigMapsRequest`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListUserWorkloadsConfigMapsRequest

## Implements

[ListUserWorkloadsConfigMapsRequestOrBuilder](/java/docs/reference/google-cloud-orchestration-airflow/1.51.0/com.google.cloud.orchestration.airflow.service.v1.ListUserWorkloadsConfigMapsRequestOrBuilder)
...
```
public static ListUserWorkloadsConfigMapsRequest getDefaultInstance()
```
...
`[ListUserWorkloadsConfigMapsRequest](/java/docs/reference/google-cloud-orchestration-airflow/1.51.0/com.google.cloud.orchestration.airflow.service.v1.ListUserWorkloadsConfigMapsRequest)`
...
```
public static ListUserWorkloadsConfigMapsRequest.Builder newBuilder()
```
...
`[ListUserWorkloadsConfigMapsRequest.Builder](/java/docs/reference/google-cloud-orchestration-airflow/1.51.0/com.google.cloud.orchestration.airflow.service.v1.ListUserWorkloadsConfigMapsRequest.Builder)`

### newBuilder(ListUserWorkloadsConfigMapsRequest prototype)

```
public static ListUserWorkloadsConfigMapsRequest.Builder newBuilder(ListUserWorkloadsConfigMapsRequest prototype)
```
...
```
public static ListUserWorkloadsConfigMapsRequest parseDelimitedFrom(InputStream input)
```
...
```
public static ListUserWorkloadsConfigMapsRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListUserWorkloadsConfigMapsRequest parseFrom(byte[] data)
```
...
```
public static ListUserWorkloadsConfigMapsRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListUserWorkloadsConfigMapsRequest parseFrom(ByteString data)
```
...
```
public static ListUserWorkloadsConfigMapsRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListUserWorkloadsConfigMapsRequest parseFrom(CodedInputStream input)
```
...
```
public static ListUserWorkloadsConfigMapsRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListUserWorkloadsConfigMapsRequest parseFrom(InputStream input)
```
...
```
public static ListUserWorkloadsConfigMapsRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListUserWorkloadsConfigMapsRequest parseFrom(ByteBuffer data)
```
...
```
public static ListUserWorkloadsConfigMapsRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ListUserWorkloadsConfigMapsRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListUserWorkloadsConfigMapsRequest](/java/docs/reference/google-cloud-orchestration-airflow/1.51.0/com.google.cloud.orchestration.airflow.service.v1.ListUserWorkloadsConfigMapsRequest)>`
...
```
public ListUserWorkloadsConfigMapsRequest getDefaultInstanceForType()
```
...
```
public Parser<ListUserWorkloadsConfigMapsRequest> getParserForType()
```
...
```
public ListUserWorkloadsConfigMapsRequest.Builder newBuilderForType()
```
...
```
protected ListUserWorkloadsConfigMapsRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ListUserWorkloadsConfigMapsRequest.Builder toBuilder()
```
