...
# Enum Runtime.HealthState (1.16.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-notebooks/1.16.0/com.google.cloud.notebooks.v1.Runtime.HealthState#com_google_cloud_notebooks_v1_Runtime_HealthState_forNumber_int_) instead._
