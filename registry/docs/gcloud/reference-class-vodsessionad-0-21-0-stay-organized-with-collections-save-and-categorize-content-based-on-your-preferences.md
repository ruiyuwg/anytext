...
# Class VodSessionAd (0.21.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> VodSessionAd

## Implements

[VodSessionAdOrBuilder](/java/docs/reference/google-cloud-video-stitcher/0.21.0/com.google.cloud.video.stitcher.v1.VodSessionAdOrBuilder)
...
### ACTIVITY\_EVENTS\_FIELD\_NUMBER
...
`[VodSessionAd](/java/docs/reference/google-cloud-video-stitcher/0.21.0/com.google.cloud.video.stitcher.v1.VodSessionAd)`
...
`[VodSessionAd.Builder](/java/docs/reference/google-cloud-video-stitcher/0.21.0/com.google.cloud.video.stitcher.v1.VodSessionAd.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[VodSessionAd](/java/docs/reference/google-cloud-video-stitcher/0.21.0/com.google.cloud.video.stitcher.v1.VodSessionAd)>`
...
`[Event](/java/docs/reference/google-cloud-video-stitcher/0.21.0/com.google.cloud.video.stitcher.v1.Event)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Event](/java/docs/reference/google-cloud-video-stitcher/0.21.0/com.google.cloud.video.stitcher.v1.Event)>`
...
`[EventOrBuilder](/java/docs/reference/google-cloud-video-stitcher/0.21.0/com.google.cloud.video.stitcher.v1.EventOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.video.stitcher.v1.EventOrBuilder>`
...
`[CompanionAds](/java/docs/reference/google-cloud-video-stitcher/0.21.0/com.google.cloud.video.stitcher.v1.CompanionAds)`
...
`[CompanionAdsOrBuilder](/java/docs/reference/google-cloud-video-stitcher/0.21.0/com.google.cloud.video.stitcher.v1.CompanionAdsOrBuilder)`
