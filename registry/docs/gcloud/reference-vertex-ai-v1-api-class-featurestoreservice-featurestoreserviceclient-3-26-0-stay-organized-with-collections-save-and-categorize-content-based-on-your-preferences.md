...
# Vertex AI v1 API - Class FeaturestoreService.FeaturestoreServiceClient (3.26.0) Stay organized with collections Save and categorize content based on your preferences.
...
Reference documentation and code samples for the Vertex AI v1 API class FeaturestoreService.FeaturestoreServiceClient.

Client for FeaturestoreService

## Inheritance

[object](https://learn.microsoft.com/dotnet/api/system.object) \> [ClientBase](https://cloud.google.com/dotnet/docs/reference/Grpc.Core/latest/Grpc.Core.ClientBase.html) \> [ClientBase](https://cloud.google.com/dotnet/docs/reference/Grpc.Core/latest/Grpc.Core.ClientBase-1.html)[FeaturestoreService](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.26.0/Google.Cloud.AIPlatform.V1.FeaturestoreService)[FeaturestoreServiceClient](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.26.0/Google.Cloud.AIPlatform.V1.FeaturestoreService.FeaturestoreServiceClient) \> FeaturestoreService.FeaturestoreServiceClient
...
`[BatchCreateFeaturesRequest](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.26.0/Google.Cloud.AIPlatform.V1.BatchCreateFeaturesRequest)`  
...
`[BatchReadFeatureValuesRequest](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.26.0/Google.Cloud.AIPlatform.V1.BatchReadFeatureValuesRequest)`  
...
`[CreateEntityTypeRequest](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.26.0/Google.Cloud.AIPlatform.V1.CreateEntityTypeRequest)`  
...
`[CreateFeatureRequest](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.26.0/Google.Cloud.AIPlatform.V1.CreateFeatureRequest)`  
...
`[CreateFeaturestoreRequest](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.26.0/Google.Cloud.AIPlatform.V1.CreateFeaturestoreRequest)`  
...
`[DeleteEntityTypeRequest](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.26.0/Google.Cloud.AIPlatform.V1.DeleteEntityTypeRequest)`  
...
`[DeleteFeatureRequest](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.26.0/Google.Cloud.AIPlatform.V1.DeleteFeatureRequest)`  
...
`[DeleteFeatureValuesRequest](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.26.0/Google.Cloud.AIPlatform.V1.DeleteFeatureValuesRequest)`  
...
`[DeleteFeaturestoreRequest](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.26.0/Google.Cloud.AIPlatform.V1.DeleteFeaturestoreRequest)`  
...
`[ExportFeatureValuesRequest](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.26.0/Google.Cloud.AIPlatform.V1.ExportFeatureValuesRequest)`  
...
`[GetEntityTypeRequest](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.26.0/Google.Cloud.AIPlatform.V1.GetEntityTypeRequest)`  
...
`[EntityType](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.26.0/Google.Cloud.AIPlatform.V1.EntityType)`
...
`[AsyncUnaryCall](https://cloud.google.com/dotnet/docs/reference/Grpc.Core/latest/Grpc.Core.AsyncUnaryCall-1.html)[EntityType](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.26.0/Google.Cloud.AIPlatform.V1.EntityType)`
...
`[GetFeatureRequest](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.26.0/Google.Cloud.AIPlatform.V1.GetFeatureRequest)`  
...
`[Feature](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.26.0/Google.Cloud.AIPlatform.V1.Feature)`
...
`[AsyncUnaryCall](https://cloud.google.com/dotnet/docs/reference/Grpc.Core/latest/Grpc.Core.AsyncUnaryCall-1.html)[Feature](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.26.0/Google.Cloud.AIPlatform.V1.Feature)`
...
`[GetFeaturestoreRequest](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.26.0/Google.Cloud.AIPlatform.V1.GetFeaturestoreRequest)`  
...
`[Featurestore](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.26.0/Google.Cloud.AIPlatform.V1.Featurestore)`
...
`[AsyncUnaryCall](https://cloud.google.com/dotnet/docs/reference/Grpc.Core/latest/Grpc.Core.AsyncUnaryCall-1.html)[Featurestore](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.26.0/Google.Cloud.AIPlatform.V1.Featurestore)`
...
`[ImportFeatureValuesRequest](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.26.0/Google.Cloud.AIPlatform.V1.ImportFeatureValuesRequest)`  
...
`[ListEntityTypesRequest](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.26.0/Google.Cloud.AIPlatform.V1.ListEntityTypesRequest)`  
...
`[ListEntityTypesResponse](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.26.0/Google.Cloud.AIPlatform.V1.ListEntityTypesResponse)`
...
`[AsyncUnaryCall](https://cloud.google.com/dotnet/docs/reference/Grpc.Core/latest/Grpc.Core.AsyncUnaryCall-1.html)[ListEntityTypesResponse](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.26.0/Google.Cloud.AIPlatform.V1.ListEntityTypesResponse)`
...
`[ListFeaturesRequest](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.26.0/Google.Cloud.AIPlatform.V1.ListFeaturesRequest)`  
...
`[ListFeaturesResponse](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.26.0/Google.Cloud.AIPlatform.V1.ListFeaturesResponse)`
...
`[AsyncUnaryCall](https://cloud.google.com/dotnet/docs/reference/Grpc.Core/latest/Grpc.Core.AsyncUnaryCall-1.html)[ListFeaturesResponse](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.26.0/Google.Cloud.AIPlatform.V1.ListFeaturesResponse)`
...
`[ListFeaturestoresRequest](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.26.0/Google.Cloud.AIPlatform.V1.ListFeaturestoresRequest)`  
...
`[ListFeaturestoresResponse](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.26.0/Google.Cloud.AIPlatform.V1.ListFeaturestoresResponse)`
...
`[AsyncUnaryCall](https://cloud.google.com/dotnet/docs/reference/Grpc.Core/latest/Grpc.Core.AsyncUnaryCall-1.html)[ListFeaturestoresResponse](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.26.0/Google.Cloud.AIPlatform.V1.ListFeaturestoresResponse)`
...
`[FeaturestoreService](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.26.0/Google.Cloud.AIPlatform.V1.FeaturestoreService)[FeaturestoreServiceClient](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.26.0/Google.Cloud.AIPlatform.V1.FeaturestoreService.FeaturestoreServiceClient)`
...
`[SearchFeaturesRequest](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.26.0/Google.Cloud.AIPlatform.V1.SearchFeaturesRequest)`  
...
`[SearchFeaturesResponse](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.26.0/Google.Cloud.AIPlatform.V1.SearchFeaturesResponse)`
...
`[AsyncUnaryCall](https://cloud.google.com/dotnet/docs/reference/Grpc.Core/latest/Grpc.Core.AsyncUnaryCall-1.html)[SearchFeaturesResponse](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.26.0/Google.Cloud.AIPlatform.V1.SearchFeaturesResponse)`
...
`[UpdateEntityTypeRequest](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.26.0/Google.Cloud.AIPlatform.V1.UpdateEntityTypeRequest)`  
...
`[UpdateFeatureRequest](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.26.0/Google.Cloud.AIPlatform.V1.UpdateFeatureRequest)`  
...
`[UpdateFeaturestoreRequest](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.26.0/Google.Cloud.AIPlatform.V1.UpdateFeaturestoreRequest)`  
