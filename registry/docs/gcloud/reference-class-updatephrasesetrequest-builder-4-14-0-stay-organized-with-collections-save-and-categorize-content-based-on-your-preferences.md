...
# Class UpdatePhraseSetRequest.Builder (4.14.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> UpdatePhraseSetRequest.Builder

## Implements

[UpdatePhraseSetRequestOrBuilder](/java/docs/reference/google-cloud-speech/4.14.0/com.google.cloud.speech.v2.UpdatePhraseSetRequestOrBuilder)
...
`[UpdatePhraseSetRequest.Builder](/java/docs/reference/google-cloud-speech/4.14.0/com.google.cloud.speech.v2.UpdatePhraseSetRequest.Builder)`
...
`[UpdatePhraseSetRequest](/java/docs/reference/google-cloud-speech/4.14.0/com.google.cloud.speech.v2.UpdatePhraseSetRequest)`
...
```
public UpdatePhraseSetRequest.Builder clearValidateOnly()
```
...
`[PhraseSet](/java/docs/reference/google-cloud-speech/4.14.0/com.google.cloud.speech.v2.PhraseSet)`
...
`[PhraseSet.Builder](/java/docs/reference/google-cloud-speech/4.14.0/com.google.cloud.speech.v2.PhraseSet.Builder)`
...
`[PhraseSetOrBuilder](/java/docs/reference/google-cloud-speech/4.14.0/com.google.cloud.speech.v2.PhraseSetOrBuilder)`
...
```
public UpdatePhraseSetRequest.Builder setValidateOnly(boolean value)
```
