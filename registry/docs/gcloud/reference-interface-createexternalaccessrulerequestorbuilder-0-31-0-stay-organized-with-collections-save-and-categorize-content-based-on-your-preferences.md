...
# Interface CreateExternalAccessRuleRequestOrBuilder (0.31.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface CreateExternalAccessRuleRequestOrBuilder extends MessageOrBuilder
```
...
```
public abstract ExternalAccessRule getExternalAccessRule()
```
...
`[ExternalAccessRule](/java/docs/reference/google-cloud-vmwareengine/0.31.0/com.google.cloud.vmwareengine.v1.ExternalAccessRule)`
...
```
public abstract String getExternalAccessRuleId()
```
...
```
public abstract ByteString getExternalAccessRuleIdBytes()
```
...
```
public abstract ExternalAccessRuleOrBuilder getExternalAccessRuleOrBuilder()
```
...
`[ExternalAccessRuleOrBuilder](/java/docs/reference/google-cloud-vmwareengine/0.31.0/com.google.cloud.vmwareengine.v1.ExternalAccessRuleOrBuilder)`
...
Required. The resource name of the network policy to create a new external access firewall rule in. Resource names are schemeless URIs that follow the conventions in [https://cloud.google.com/apis/design/resource\_names](https://cloud.google.com/apis/design/resource_names). For example: `projects/my-project/locations/us-central1/networkPolicies/my-policy`
...
```
public abstract boolean hasExternalAccessRule()
```
