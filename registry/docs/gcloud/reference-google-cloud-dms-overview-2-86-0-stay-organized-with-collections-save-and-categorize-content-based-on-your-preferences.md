...
# google-cloud-dms overview (2.86.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Database Migration Service Description:** Makes it easier for you to migrate your data to Google Cloud. This service helps you lift and shift your MySQL and PostgreSQL workloads into Cloud SQL.

[Database Migration Service Product Reference](https://cloud.google.com/database-migration/docs)

[GitHub Repository](https://github.com/googleapis/google-cloud-java/tree/main/java-dms)

[Maven artifact](https://central.sonatype.com/artifact/com.google.cloud/google-cloud-dms)
...
-   [Enable the API](https://console.cloud.google.com/apis/library/datamigration.googleapis.com)
-   [Set up authentication](https://cloud.google.com/docs/authentication/client-libraries)

## Use the Database Migration Service for Java
...
The example below demonstrates how you would import the BOM and include the `google-cloud-dms` artifact.
...
implementation("com.google.cloud:google-cloud-dms")
...
libraryDependencies += "com.google.cloud" % "google-cloud-dms" % "2.86.0"

## Which version ID should I get started with?

For this library, we recommend using [com.google.cloud.clouddms.v1](https://cloud.google.com/java/docs/reference/google-cloud-dms/2.86.0/com.google.cloud.clouddms.v1) for new applications.
