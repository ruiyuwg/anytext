...
# Class CertificateProvider.Builder (0.43.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> CertificateProvider.Builder

## Implements

[CertificateProviderOrBuilder](/java/docs/reference/google-cloud-network-security/0.43.0/com.google.cloud.networksecurity.v1.CertificateProviderOrBuilder)
...
`[CertificateProvider.Builder](/java/docs/reference/google-cloud-network-security/0.43.0/com.google.cloud.networksecurity.v1.CertificateProvider.Builder)`
...
`[CertificateProvider](/java/docs/reference/google-cloud-network-security/0.43.0/com.google.cloud.networksecurity.v1.CertificateProvider)`
...
`[CertificateProviderInstance](/java/docs/reference/google-cloud-network-security/0.43.0/com.google.cloud.networksecurity.v1.CertificateProviderInstance)`
...
`[CertificateProviderInstance.Builder](/java/docs/reference/google-cloud-network-security/0.43.0/com.google.cloud.networksecurity.v1.CertificateProviderInstance.Builder)`
...
`[CertificateProviderInstanceOrBuilder](/java/docs/reference/google-cloud-network-security/0.43.0/com.google.cloud.networksecurity.v1.CertificateProviderInstanceOrBuilder)`
...
`[GrpcEndpoint](/java/docs/reference/google-cloud-network-security/0.43.0/com.google.cloud.networksecurity.v1.GrpcEndpoint)`
...
`[GrpcEndpoint.Builder](/java/docs/reference/google-cloud-network-security/0.43.0/com.google.cloud.networksecurity.v1.GrpcEndpoint.Builder)`
...
`[GrpcEndpointOrBuilder](/java/docs/reference/google-cloud-network-security/0.43.0/com.google.cloud.networksecurity.v1.GrpcEndpointOrBuilder)`
...
`[CertificateProvider.TypeCase](/java/docs/reference/google-cloud-network-security/0.43.0/com.google.cloud.networksecurity.v1.CertificateProvider.TypeCase)`
