...
# Class TransferOperationMetadata (0.12.0) Stay organized with collections Save and categorize content based on your preferences.

0.50.0 (latest) 0.48.0 0.46.0 0.45.0 0.43.0 0.41.0 0.39.0 0.38.0 0.37.0 0.36.0 0.35.0 0.33.0 0.31.0 0.30.0 0.27.0 0.26.0 0.25.0 0.23.0 0.22.0 0.21.0 0.20.0 0.19.0 0.18.0 0.17.0 0.16.0 0.15.0 0.14.0 0.12.0 0.11.0 0.10.0 0.9.0 0.8.0 0.7.0 0.6.0 0.5.0 0.4.0 0.3.0 0.2.0
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> TransferOperationMetadata

## Implements

[TransferOperationMetadataOrBuilder](/java/docs/reference/google-cloud-parallelstore/0.12.0/com.google.cloud.parallelstore.v1beta.TransferOperationMetadataOrBuilder)
...
### DESTINATION\_GCS\_BUCKET\_FIELD\_NUMBER
...
### DESTINATION\_PARALLELSTORE\_FIELD\_NUMBER
...
### SOURCE\_GCS\_BUCKET\_FIELD\_NUMBER
...
### SOURCE\_PARALLELSTORE\_FIELD\_NUMBER
...
`[TransferOperationMetadata](/java/docs/reference/google-cloud-parallelstore/0.12.0/com.google.cloud.parallelstore.v1beta.TransferOperationMetadata)`
...
`[TransferOperationMetadata.Builder](/java/docs/reference/google-cloud-parallelstore/0.12.0/com.google.cloud.parallelstore.v1beta.TransferOperationMetadata.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[TransferOperationMetadata](/java/docs/reference/google-cloud-parallelstore/0.12.0/com.google.cloud.parallelstore.v1beta.TransferOperationMetadata)>`
...
`[TransferCounters](/java/docs/reference/google-cloud-parallelstore/0.12.0/com.google.cloud.parallelstore.v1beta.TransferCounters)`
...
`[TransferCountersOrBuilder](/java/docs/reference/google-cloud-parallelstore/0.12.0/com.google.cloud.parallelstore.v1beta.TransferCountersOrBuilder)`
...
`[TransferOperationMetadata.DestinationCase](/java/docs/reference/google-cloud-parallelstore/0.12.0/com.google.cloud.parallelstore.v1beta.TransferOperationMetadata.DestinationCase)`
...
`[DestinationGcsBucket](/java/docs/reference/google-cloud-parallelstore/0.12.0/com.google.cloud.parallelstore.v1beta.DestinationGcsBucket)`
...
`[DestinationGcsBucketOrBuilder](/java/docs/reference/google-cloud-parallelstore/0.12.0/com.google.cloud.parallelstore.v1beta.DestinationGcsBucketOrBuilder)`
...
`[DestinationParallelstore](/java/docs/reference/google-cloud-parallelstore/0.12.0/com.google.cloud.parallelstore.v1beta.DestinationParallelstore)`
...
`[DestinationParallelstoreOrBuilder](/java/docs/reference/google-cloud-parallelstore/0.12.0/com.google.cloud.parallelstore.v1beta.DestinationParallelstoreOrBuilder)`
...
`[TransferOperationMetadata.SourceCase](/java/docs/reference/google-cloud-parallelstore/0.12.0/com.google.cloud.parallelstore.v1beta.TransferOperationMetadata.SourceCase)`
...
`[SourceGcsBucket](/java/docs/reference/google-cloud-parallelstore/0.12.0/com.google.cloud.parallelstore.v1beta.SourceGcsBucket)`
...
`[SourceGcsBucketOrBuilder](/java/docs/reference/google-cloud-parallelstore/0.12.0/com.google.cloud.parallelstore.v1beta.SourceGcsBucketOrBuilder)`
...
`[SourceParallelstore](/java/docs/reference/google-cloud-parallelstore/0.12.0/com.google.cloud.parallelstore.v1beta.SourceParallelstore)`
...
`[SourceParallelstoreOrBuilder](/java/docs/reference/google-cloud-parallelstore/0.12.0/com.google.cloud.parallelstore.v1beta.SourceParallelstoreOrBuilder)`
...
`[TransferType](/java/docs/reference/google-cloud-parallelstore/0.12.0/com.google.cloud.parallelstore.v1beta.TransferType)`
