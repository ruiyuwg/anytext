...
# Class TenantServiceClient.ListTenantsFixedSizeCollection (2.2.9) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class TenantServiceClient.ListTenantsFixedSizeCollection extends AbstractFixedSizeCollection<ListTenantsRequest,ListTenantsResponse,Tenant,TenantServiceClient.ListTenantsPage,TenantServiceClient.ListTenantsFixedSizeCollection>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractFixedSizeCollection](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractFixedSizeCollection.html) \> TenantServiceClient.ListTenantsFixedSizeCollection
...
### createCollection(List<TenantServiceClient.ListTenantsPage> pages, int collectionSize)

```
protected TenantServiceClient.ListTenantsFixedSizeCollection createCollection(List<TenantServiceClient.ListTenantsPage> pages, int collectionSize)
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ListTenantsPage](/java/docs/reference/google-cloud-talent/2.2.9/com.google.cloud.talent.v4.TenantServiceClient.ListTenantsPage)>`  
...
[TenantServiceClient.ListTenantsFixedSizeCollection](/java/docs/reference/google-cloud-talent/2.2.9/com.google.cloud.talent.v4.TenantServiceClient.ListTenantsFixedSizeCollection)
