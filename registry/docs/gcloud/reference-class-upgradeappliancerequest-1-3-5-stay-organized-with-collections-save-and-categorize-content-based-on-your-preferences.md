...
# Class UpgradeApplianceRequest (1.3.5) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class UpgradeApplianceRequest extends GeneratedMessageV3 implements UpgradeApplianceRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> UpgradeApplianceRequest

## Implements

[UpgradeApplianceRequestOrBuilder](/java/docs/reference/google-cloud-vmmigration/1.3.5/com.google.cloud.vmmigration.v1.UpgradeApplianceRequestOrBuilder)
...
### DATACENTER\_CONNECTOR\_FIELD\_NUMBER

```
public static final int DATACENTER_CONNECTOR_FIELD_NUMBER
```
...
```
public static UpgradeApplianceRequest getDefaultInstance()
```
...
[UpgradeApplianceRequest](/java/docs/reference/google-cloud-vmmigration/1.3.5/com.google.cloud.vmmigration.v1.UpgradeApplianceRequest)
...
```
public static UpgradeApplianceRequest.Builder newBuilder()
```
...
[UpgradeApplianceRequest.Builder](/java/docs/reference/google-cloud-vmmigration/1.3.5/com.google.cloud.vmmigration.v1.UpgradeApplianceRequest.Builder)

### newBuilder(UpgradeApplianceRequest prototype)

```
public static UpgradeApplianceRequest.Builder newBuilder(UpgradeApplianceRequest prototype)
```
...
```
public static UpgradeApplianceRequest parseDelimitedFrom(InputStream input)
```
...
```
public static UpgradeApplianceRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpgradeApplianceRequest parseFrom(byte[] data)
```
...
```
public static UpgradeApplianceRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpgradeApplianceRequest parseFrom(ByteString data)
```
...
```
public static UpgradeApplianceRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpgradeApplianceRequest parseFrom(CodedInputStream input)
```
...
```
public static UpgradeApplianceRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpgradeApplianceRequest parseFrom(InputStream input)
```
...
```
public static UpgradeApplianceRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpgradeApplianceRequest parseFrom(ByteBuffer data)
```
...
```
public static UpgradeApplianceRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<UpgradeApplianceRequest> parser()
```
...
[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[UpgradeApplianceRequest](/java/docs/reference/google-cloud-vmmigration/1.3.5/com.google.cloud.vmmigration.v1.UpgradeApplianceRequest)\>
...
```
public Parser<UpgradeApplianceRequest> getParserForType()
```
...
```
public UpgradeApplianceRequest.Builder newBuilderForType()
```
...
```
protected UpgradeApplianceRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public UpgradeApplianceRequest.Builder toBuilder()
```
