...
# Compute V1 Client - Class NetworkEndpointGroupsClient (1.9.1) Stay organized with collections Save and categorize content based on your preferences.
...
This service has a new (beta) implementation. See [Google\\Cloud\\Compute\\V1\\Client\\NetworkEndpointGroupsClient](/php/docs/reference/cloud-compute/1.9.1/V1.Client.NetworkEndpointGroupsClient) to use the new surface.
...
`[Google\Cloud\Compute\V1\NetworkEndpointGroupsAttachEndpointsRequest](/php/docs/reference/cloud-compute/1.9.1/V1.NetworkEndpointGroupsAttachEndpointsRequest)`  
...
`[Google\Cloud\Compute\V1\NetworkEndpointGroupsDetachEndpointsRequest](/php/docs/reference/cloud-compute/1.9.1/V1.NetworkEndpointGroupsDetachEndpointsRequest)`  
...
`[Google\Cloud\Compute\V1\NetworkEndpointGroup](/php/docs/reference/cloud-compute/1.9.1/V1.NetworkEndpointGroup)`
...
`[Google\Cloud\Compute\V1\NetworkEndpointGroupsListEndpointsRequest](/php/docs/reference/cloud-compute/1.9.1/V1.NetworkEndpointGroupsListEndpointsRequest)`  
...
`[Google\Cloud\Compute\V1\TestPermissionsRequest](/php/docs/reference/cloud-compute/1.9.1/V1.TestPermissionsRequest)`  
...
`[Google\Cloud\Compute\V1\TestPermissionsResponse](/php/docs/reference/cloud-compute/1.9.1/V1.TestPermissionsResponse)`
...
`[Google\Cloud\Compute\V1\ZoneOperationsClient](/php/docs/reference/cloud-compute/1.9.1/V1.ZoneOperationsClient)`
...
```
Value: 'google.cloud.compute.v1.NetworkEndpointGroups'
```
