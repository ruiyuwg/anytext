...
# Class AnnotateVideoResponse (2.42.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> AnnotateVideoResponse

## Implements

[AnnotateVideoResponseOrBuilder](/java/docs/reference/google-cloud-video-intelligence/2.42.0/com.google.cloud.videointelligence.v1beta2.AnnotateVideoResponseOrBuilder)
...
### ANNOTATION\_RESULTS\_FIELD\_NUMBER
...
`[AnnotateVideoResponse](/java/docs/reference/google-cloud-video-intelligence/2.42.0/com.google.cloud.videointelligence.v1beta2.AnnotateVideoResponse)`
...
```
public static AnnotateVideoResponse.Builder newBuilder()
```
...
`[AnnotateVideoResponse.Builder](/java/docs/reference/google-cloud-video-intelligence/2.42.0/com.google.cloud.videointelligence.v1beta2.AnnotateVideoResponse.Builder)`
...
```
public static AnnotateVideoResponse parseDelimitedFrom(InputStream input)
```
...
```
public static AnnotateVideoResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AnnotateVideoResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AnnotateVideoResponse parseFrom(ByteString data)
```
...
```
public static AnnotateVideoResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AnnotateVideoResponse parseFrom(CodedInputStream input)
```
...
```
public static AnnotateVideoResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AnnotateVideoResponse parseFrom(InputStream input)
```
...
```
public static AnnotateVideoResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AnnotateVideoResponse parseFrom(ByteBuffer data)
```
...
```
public static AnnotateVideoResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[AnnotateVideoResponse](/java/docs/reference/google-cloud-video-intelligence/2.42.0/com.google.cloud.videointelligence.v1beta2.AnnotateVideoResponse)>`
...
`[VideoAnnotationResults](/java/docs/reference/google-cloud-video-intelligence/2.42.0/com.google.cloud.videointelligence.v1beta2.VideoAnnotationResults)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[VideoAnnotationResults](/java/docs/reference/google-cloud-video-intelligence/2.42.0/com.google.cloud.videointelligence.v1beta2.VideoAnnotationResults)>`
...
`[VideoAnnotationResultsOrBuilder](/java/docs/reference/google-cloud-video-intelligence/2.42.0/com.google.cloud.videointelligence.v1beta2.VideoAnnotationResultsOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.videointelligence.v1beta2.VideoAnnotationResultsOrBuilder>`
...
```
protected AnnotateVideoResponse.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
