...
# Class OsConfigServiceClient.ListPatchJobInstanceDetailsPage (2.53.0) Stay organized with collections Save and categorize content based on your preferences.
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractPage](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractPage.html) \> OsConfigServiceClient.ListPatchJobInstanceDetailsPage
...
### createPage(PageContext<PatchJobs.ListPatchJobInstanceDetailsRequest,PatchJobs.ListPatchJobInstanceDetailsResponse,PatchJobs.PatchJobInstanceDetails> context, PatchJobs.ListPatchJobInstanceDetailsResponse response)

```
protected OsConfigServiceClient.ListPatchJobInstanceDetailsPage createPage(PageContext<PatchJobs.ListPatchJobInstanceDetailsRequest,PatchJobs.ListPatchJobInstanceDetailsResponse,PatchJobs.PatchJobInstanceDetails> context, PatchJobs.ListPatchJobInstanceDetailsResponse response)
```
...
`[PageContext](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PageContext.html)<[ListPatchJobInstanceDetailsRequest](/java/docs/reference/google-cloud-os-config/2.53.0/com.google.cloud.osconfig.v1beta.PatchJobs.ListPatchJobInstanceDetailsRequest),[ListPatchJobInstanceDetailsResponse](/java/docs/reference/google-cloud-os-config/2.53.0/com.google.cloud.osconfig.v1beta.PatchJobs.ListPatchJobInstanceDetailsResponse),[PatchJobInstanceDetails](/java/docs/reference/google-cloud-os-config/2.53.0/com.google.cloud.osconfig.v1beta.PatchJobs.PatchJobInstanceDetails)>`  

`response`

`[PatchJobs.ListPatchJobInstanceDetailsResponse](/java/docs/reference/google-cloud-os-config/2.53.0/com.google.cloud.osconfig.v1beta.PatchJobs.ListPatchJobInstanceDetailsResponse)`  
...
`[OsConfigServiceClient.ListPatchJobInstanceDetailsPage](/java/docs/reference/google-cloud-os-config/2.53.0/com.google.cloud.osconfig.v1beta.OsConfigServiceClient.ListPatchJobInstanceDetailsPage)`
...
### createPageAsync(PageContext<PatchJobs.ListPatchJobInstanceDetailsRequest,PatchJobs.ListPatchJobInstanceDetailsResponse,PatchJobs.PatchJobInstanceDetails> context, ApiFuture<PatchJobs.ListPatchJobInstanceDetailsResponse> futureResponse)

```
public ApiFuture<OsConfigServiceClient.ListPatchJobInstanceDetailsPage> createPageAsync(PageContext<PatchJobs.ListPatchJobInstanceDetailsRequest,PatchJobs.ListPatchJobInstanceDetailsResponse,PatchJobs.PatchJobInstanceDetails> context, ApiFuture<PatchJobs.ListPatchJobInstanceDetailsResponse> futureResponse)
```
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListPatchJobInstanceDetailsResponse](/java/docs/reference/google-cloud-os-config/2.53.0/com.google.cloud.osconfig.v1beta.PatchJobs.ListPatchJobInstanceDetailsResponse)>`  
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListPatchJobInstanceDetailsPage](/java/docs/reference/google-cloud-os-config/2.53.0/com.google.cloud.osconfig.v1beta.OsConfigServiceClient.ListPatchJobInstanceDetailsPage)>`
