...
# Class VpcConnectorInfo (1.36.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class VpcConnectorInfo extends GeneratedMessageV3 implements VpcConnectorInfoOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> VpcConnectorInfo

## Implements

[VpcConnectorInfoOrBuilder](/java/docs/reference/google-cloud-network-management/1.36.0/com.google.cloud.networkmanagement.v1beta1.VpcConnectorInfoOrBuilder)
...
```
public static VpcConnectorInfo getDefaultInstance()
```
...
`[VpcConnectorInfo](/java/docs/reference/google-cloud-network-management/1.36.0/com.google.cloud.networkmanagement.v1beta1.VpcConnectorInfo)`
...
```
public static VpcConnectorInfo.Builder newBuilder()
```
...
`[VpcConnectorInfo.Builder](/java/docs/reference/google-cloud-network-management/1.36.0/com.google.cloud.networkmanagement.v1beta1.VpcConnectorInfo.Builder)`

### newBuilder(VpcConnectorInfo prototype)

```
public static VpcConnectorInfo.Builder newBuilder(VpcConnectorInfo prototype)
```
...
```
public static VpcConnectorInfo parseDelimitedFrom(InputStream input)
```
...
```
public static VpcConnectorInfo parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static VpcConnectorInfo parseFrom(byte[] data)
```
...
```
public static VpcConnectorInfo parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static VpcConnectorInfo parseFrom(ByteString data)
```
...
```
public static VpcConnectorInfo parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static VpcConnectorInfo parseFrom(CodedInputStream input)
```
...
```
public static VpcConnectorInfo parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static VpcConnectorInfo parseFrom(InputStream input)
```
...
```
public static VpcConnectorInfo parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static VpcConnectorInfo parseFrom(ByteBuffer data)
```
...
```
public static VpcConnectorInfo parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<VpcConnectorInfo> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[VpcConnectorInfo](/java/docs/reference/google-cloud-network-management/1.36.0/com.google.cloud.networkmanagement.v1beta1.VpcConnectorInfo)>`
...
```
public VpcConnectorInfo getDefaultInstanceForType()
```
...
```
public Parser<VpcConnectorInfo> getParserForType()
```
...
```
public VpcConnectorInfo.Builder newBuilderForType()
```
...
```
protected VpcConnectorInfo.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public VpcConnectorInfo.Builder toBuilder()
```
