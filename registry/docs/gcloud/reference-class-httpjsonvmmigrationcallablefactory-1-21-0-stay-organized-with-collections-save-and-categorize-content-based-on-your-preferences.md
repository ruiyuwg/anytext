...
# Class HttpJsonVmMigrationCallableFactory (1.21.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public class HttpJsonVmMigrationCallableFactory implements HttpJsonStubCallableFactory<Operation,OperationsStub>
```

REST callable factory implementation for the VmMigration service API.

This class is for advanced usage.

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> HttpJsonVmMigrationCallableFactory
...
### HttpJsonVmMigrationCallableFactory()

```
public HttpJsonVmMigrationCallableFactory()
```
