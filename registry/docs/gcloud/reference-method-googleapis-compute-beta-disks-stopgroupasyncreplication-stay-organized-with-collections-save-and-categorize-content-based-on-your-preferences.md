...
# Method: googleapis.compute.beta.disks.stopGroupAsyncReplication Stay organized with collections Save and categorize content based on your preferences.
...
Required. The name of the zone for this request. This must be the zone of the primary or secondary disks in the consistency group.
...
`object ([DisksStopGroupAsyncReplicationResource](/workflows/docs/reference/googleapis/compute/beta/Overview#DisksStopGroupAsyncReplicationResource))`
...
Some fields might be optional or required. To identify required fields, refer to the [API documentation](https://cloud.google.com/compute/docs/reference/rest/beta/disks/stopGroupAsyncReplication).

### YAML

\- stopGroupAsyncReplication:
    call: googleapis.compute.beta.disks.stopGroupAsyncReplication
    args:
        project: ...
        zone: ...
        requestId: ...
        body:
            resourcePolicy: ...
    result: stopGroupAsyncReplicationResult
