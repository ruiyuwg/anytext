...
# Interface Endpoint.CloudFunctionEndpointOrBuilder (1.57.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static interface Endpoint.CloudFunctionEndpointOrBuilder extends MessageOrBuilder
```
