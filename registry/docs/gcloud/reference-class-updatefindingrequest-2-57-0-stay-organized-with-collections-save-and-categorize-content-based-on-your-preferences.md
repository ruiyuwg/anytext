...
# Class UpdateFindingRequest (2.57.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class UpdateFindingRequest extends GeneratedMessageV3 implements UpdateFindingRequestOrBuilder
```

Request message for updating or creating a finding.

Protobuf type `google.cloud.securitycenter.v2.UpdateFindingRequest`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> UpdateFindingRequest

## Implements

[UpdateFindingRequestOrBuilder](/java/docs/reference/google-cloud-securitycenter/2.57.0/com.google.cloud.securitycenter.v2.UpdateFindingRequestOrBuilder)
...
```
public static UpdateFindingRequest getDefaultInstance()
```
...
`[UpdateFindingRequest](/java/docs/reference/google-cloud-securitycenter/2.57.0/com.google.cloud.securitycenter.v2.UpdateFindingRequest)`
...
```
public static UpdateFindingRequest.Builder newBuilder()
```
...
`[UpdateFindingRequest.Builder](/java/docs/reference/google-cloud-securitycenter/2.57.0/com.google.cloud.securitycenter.v2.UpdateFindingRequest.Builder)`

### newBuilder(UpdateFindingRequest prototype)

```
public static UpdateFindingRequest.Builder newBuilder(UpdateFindingRequest prototype)
```
...
```
public static UpdateFindingRequest parseDelimitedFrom(InputStream input)
```
...
```
public static UpdateFindingRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateFindingRequest parseFrom(byte[] data)
```
...
```
public static UpdateFindingRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateFindingRequest parseFrom(ByteString data)
```
...
```
public static UpdateFindingRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateFindingRequest parseFrom(CodedInputStream input)
```
...
```
public static UpdateFindingRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateFindingRequest parseFrom(InputStream input)
```
...
```
public static UpdateFindingRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateFindingRequest parseFrom(ByteBuffer data)
```
...
```
public static UpdateFindingRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<UpdateFindingRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[UpdateFindingRequest](/java/docs/reference/google-cloud-securitycenter/2.57.0/com.google.cloud.securitycenter.v2.UpdateFindingRequest)>`
...
`[Finding](/java/docs/reference/google-cloud-securitycenter/2.57.0/com.google.cloud.securitycenter.v2.Finding)`
...
`[FindingOrBuilder](/java/docs/reference/google-cloud-securitycenter/2.57.0/com.google.cloud.securitycenter.v2.FindingOrBuilder)`

### getParserForType()

```
public Parser<UpdateFindingRequest> getParserForType()
```
...
When updating a finding, an empty mask is treated as updating all mutable fields and replacing source\_properties. Individual source\_properties can be added/updated by using "source\_properties.<property key>" in the field mask.
...
```
public UpdateFindingRequest.Builder newBuilderForType()
```
...
```
protected UpdateFindingRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public UpdateFindingRequest.Builder toBuilder()
```
