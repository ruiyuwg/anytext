...
# Class FetchCertificateAuthorityCsrRequest (2.29.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class FetchCertificateAuthorityCsrRequest extends GeneratedMessageV3 implements FetchCertificateAuthorityCsrRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> FetchCertificateAuthorityCsrRequest

## Implements

[FetchCertificateAuthorityCsrRequestOrBuilder](/java/docs/reference/google-cloud-security-private-ca/2.29.0/com.google.cloud.security.privateca.v1beta1.FetchCertificateAuthorityCsrRequestOrBuilder)
...
```
public static FetchCertificateAuthorityCsrRequest getDefaultInstance()
```
...
`[FetchCertificateAuthorityCsrRequest](/java/docs/reference/google-cloud-security-private-ca/2.29.0/com.google.cloud.security.privateca.v1beta1.FetchCertificateAuthorityCsrRequest)`
...
```
public static FetchCertificateAuthorityCsrRequest.Builder newBuilder()
```
...
`[FetchCertificateAuthorityCsrRequest.Builder](/java/docs/reference/google-cloud-security-private-ca/2.29.0/com.google.cloud.security.privateca.v1beta1.FetchCertificateAuthorityCsrRequest.Builder)`

### newBuilder(FetchCertificateAuthorityCsrRequest prototype)

```
public static FetchCertificateAuthorityCsrRequest.Builder newBuilder(FetchCertificateAuthorityCsrRequest prototype)
```
...
```
public static FetchCertificateAuthorityCsrRequest parseDelimitedFrom(InputStream input)
```
...
```
public static FetchCertificateAuthorityCsrRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static FetchCertificateAuthorityCsrRequest parseFrom(byte[] data)
```
...
```
public static FetchCertificateAuthorityCsrRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static FetchCertificateAuthorityCsrRequest parseFrom(ByteString data)
```
...
```
public static FetchCertificateAuthorityCsrRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static FetchCertificateAuthorityCsrRequest parseFrom(CodedInputStream input)
```
...
```
public static FetchCertificateAuthorityCsrRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static FetchCertificateAuthorityCsrRequest parseFrom(InputStream input)
```
...
```
public static FetchCertificateAuthorityCsrRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static FetchCertificateAuthorityCsrRequest parseFrom(ByteBuffer data)
```
...
```
public static FetchCertificateAuthorityCsrRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<FetchCertificateAuthorityCsrRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[FetchCertificateAuthorityCsrRequest](/java/docs/reference/google-cloud-security-private-ca/2.29.0/com.google.cloud.security.privateca.v1beta1.FetchCertificateAuthorityCsrRequest)>`
...
```
public FetchCertificateAuthorityCsrRequest getDefaultInstanceForType()
```
...
```
public Parser<FetchCertificateAuthorityCsrRequest> getParserForType()
```
...
```
public FetchCertificateAuthorityCsrRequest.Builder newBuilderForType()
```
...
```
protected FetchCertificateAuthorityCsrRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public FetchCertificateAuthorityCsrRequest.Builder toBuilder()
```
