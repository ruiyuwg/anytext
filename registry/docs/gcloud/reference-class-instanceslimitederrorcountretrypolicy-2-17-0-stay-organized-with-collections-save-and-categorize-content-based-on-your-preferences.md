...
# Class InstancesLimitedErrorCountRetryPolicy (2.17.0) Stay organized with collections Save and categorize content based on your preferences.
...
A retry policy for [`InstancesConnection`](/cpp/docs/reference/compute/2.17.0/classgoogle_1_1cloud_1_1compute__instances__v1_1_1InstancesConnection) based on counting errors.
...
`InstancesLimitedErrorCountRetryPolicy const &`  
...
`std::unique_ptr< InstancesRetryPolicy >`

## Type Aliases

### BaseType

**Alias Of**: `InstancesRetryPolicy`
