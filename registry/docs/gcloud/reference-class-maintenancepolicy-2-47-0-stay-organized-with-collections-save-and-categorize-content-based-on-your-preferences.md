...
# Class MaintenancePolicy (2.47.0) Stay organized with collections Save and categorize content based on your preferences.
...
Protobuf type `google.cloud.redis.v1.MaintenancePolicy`
...
[MaintenancePolicyOrBuilder](/java/docs/reference/google-cloud-redis/2.47.0/com.google.cloud.redis.v1.MaintenancePolicyOrBuilder)
...
`[MaintenancePolicy](/java/docs/reference/google-cloud-redis/2.47.0/com.google.cloud.redis.v1.MaintenancePolicy)`
...
`[MaintenancePolicy.Builder](/java/docs/reference/google-cloud-redis/2.47.0/com.google.cloud.redis.v1.MaintenancePolicy.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[MaintenancePolicy](/java/docs/reference/google-cloud-redis/2.47.0/com.google.cloud.redis.v1.MaintenancePolicy)>`
...
`[WeeklyMaintenanceWindow](/java/docs/reference/google-cloud-redis/2.47.0/com.google.cloud.redis.v1.WeeklyMaintenanceWindow)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[WeeklyMaintenanceWindow](/java/docs/reference/google-cloud-redis/2.47.0/com.google.cloud.redis.v1.WeeklyMaintenanceWindow)>`
...
`[WeeklyMaintenanceWindowOrBuilder](/java/docs/reference/google-cloud-redis/2.47.0/com.google.cloud.redis.v1.WeeklyMaintenanceWindowOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.redis.v1.WeeklyMaintenanceWindowOrBuilder>`
