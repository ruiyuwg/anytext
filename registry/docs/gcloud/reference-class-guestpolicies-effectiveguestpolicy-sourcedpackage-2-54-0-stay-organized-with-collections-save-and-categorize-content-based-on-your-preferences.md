...
# Class GuestPolicies.EffectiveGuestPolicy.SourcedPackage (2.54.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class GuestPolicies.EffectiveGuestPolicy.SourcedPackage extends GeneratedMessageV3 implements GuestPolicies.EffectiveGuestPolicy.SourcedPackageOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> GuestPolicies.EffectiveGuestPolicy.SourcedPackage

## Implements

[GuestPolicies.EffectiveGuestPolicy.SourcedPackageOrBuilder](/java/docs/reference/google-cloud-os-config/2.54.0/com.google.cloud.osconfig.v1beta.GuestPolicies.EffectiveGuestPolicy.SourcedPackageOrBuilder)
...
```
public static GuestPolicies.EffectiveGuestPolicy.SourcedPackage getDefaultInstance()
```
...
`[GuestPolicies.EffectiveGuestPolicy.SourcedPackage](/java/docs/reference/google-cloud-os-config/2.54.0/com.google.cloud.osconfig.v1beta.GuestPolicies.EffectiveGuestPolicy.SourcedPackage)`
...
```
public static GuestPolicies.EffectiveGuestPolicy.SourcedPackage.Builder newBuilder()
```
...
`[GuestPolicies.EffectiveGuestPolicy.SourcedPackage.Builder](/java/docs/reference/google-cloud-os-config/2.54.0/com.google.cloud.osconfig.v1beta.GuestPolicies.EffectiveGuestPolicy.SourcedPackage.Builder)`

### newBuilder(GuestPolicies.EffectiveGuestPolicy.SourcedPackage prototype)

```
public static GuestPolicies.EffectiveGuestPolicy.SourcedPackage.Builder newBuilder(GuestPolicies.EffectiveGuestPolicy.SourcedPackage prototype)
```
...
```
public static GuestPolicies.EffectiveGuestPolicy.SourcedPackage parseDelimitedFrom(InputStream input)
```
...
```
public static GuestPolicies.EffectiveGuestPolicy.SourcedPackage parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GuestPolicies.EffectiveGuestPolicy.SourcedPackage parseFrom(byte[] data)
```
...
```
public static GuestPolicies.EffectiveGuestPolicy.SourcedPackage parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GuestPolicies.EffectiveGuestPolicy.SourcedPackage parseFrom(ByteString data)
```
...
```
public static GuestPolicies.EffectiveGuestPolicy.SourcedPackage parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GuestPolicies.EffectiveGuestPolicy.SourcedPackage parseFrom(CodedInputStream input)
```
...
```
public static GuestPolicies.EffectiveGuestPolicy.SourcedPackage parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GuestPolicies.EffectiveGuestPolicy.SourcedPackage parseFrom(InputStream input)
```
...
```
public static GuestPolicies.EffectiveGuestPolicy.SourcedPackage parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GuestPolicies.EffectiveGuestPolicy.SourcedPackage parseFrom(ByteBuffer data)
```
...
```
public static GuestPolicies.EffectiveGuestPolicy.SourcedPackage parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<GuestPolicies.EffectiveGuestPolicy.SourcedPackage> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[SourcedPackage](/java/docs/reference/google-cloud-os-config/2.54.0/com.google.cloud.osconfig.v1beta.GuestPolicies.EffectiveGuestPolicy.SourcedPackage)>`
...
`[GuestPolicies.Package](/java/docs/reference/google-cloud-os-config/2.54.0/com.google.cloud.osconfig.v1beta.GuestPolicies.Package)`
...
`[GuestPolicies.PackageOrBuilder](/java/docs/reference/google-cloud-os-config/2.54.0/com.google.cloud.osconfig.v1beta.GuestPolicies.PackageOrBuilder)`

### getParserForType()

```
public Parser<GuestPolicies.EffectiveGuestPolicy.SourcedPackage> getParserForType()
```
...
```
public GuestPolicies.EffectiveGuestPolicy.SourcedPackage.Builder newBuilderForType()
```
...
```
protected GuestPolicies.EffectiveGuestPolicy.SourcedPackage.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public GuestPolicies.EffectiveGuestPolicy.SourcedPackage.Builder toBuilder()
```
