...
# Class AsyncBatchAnnotateImagesRequest.Builder (3.57.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> AsyncBatchAnnotateImagesRequest.Builder

## Implements

[AsyncBatchAnnotateImagesRequestOrBuilder](/java/docs/reference/google-cloud-vision/3.57.0/com.google.cloud.vision.v1.AsyncBatchAnnotateImagesRequestOrBuilder)
...
`[Iterable](https://docs.oracle.com/javase/8/docs/api/java/lang/Iterable.html)<? extends com.google.cloud.vision.v1.AnnotateImageRequest>`  
...
`[AsyncBatchAnnotateImagesRequest.Builder](/java/docs/reference/google-cloud-vision/3.57.0/com.google.cloud.vision.v1.AsyncBatchAnnotateImagesRequest.Builder)`
...
`[AnnotateImageRequest](/java/docs/reference/google-cloud-vision/3.57.0/com.google.cloud.vision.v1.AnnotateImageRequest)`  
...
`[AnnotateImageRequest.Builder](/java/docs/reference/google-cloud-vision/3.57.0/com.google.cloud.vision.v1.AnnotateImageRequest.Builder)`  
...
`[AsyncBatchAnnotateImagesRequest](/java/docs/reference/google-cloud-vision/3.57.0/com.google.cloud.vision.v1.AsyncBatchAnnotateImagesRequest)`
...
```
public AsyncBatchAnnotateImagesRequest.Builder clearLabels()
```
...
Use [#getLabelsMap()](/java/docs/reference/google-cloud-vision/3.57.0/com.google.cloud.vision.v1.AsyncBatchAnnotateImagesRequest.Builder#com_google_cloud_vision_v1_AsyncBatchAnnotateImagesRequest_Builder_getLabelsMap__) instead.
...
`[OutputConfig](/java/docs/reference/google-cloud-vision/3.57.0/com.google.cloud.vision.v1.OutputConfig)`
...
`[OutputConfig.Builder](/java/docs/reference/google-cloud-vision/3.57.0/com.google.cloud.vision.v1.OutputConfig.Builder)`
...
`[OutputConfigOrBuilder](/java/docs/reference/google-cloud-vision/3.57.0/com.google.cloud.vision.v1.OutputConfigOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Builder](/java/docs/reference/google-cloud-vision/3.57.0/com.google.cloud.vision.v1.AnnotateImageRequest.Builder)>`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[AnnotateImageRequest](/java/docs/reference/google-cloud-vision/3.57.0/com.google.cloud.vision.v1.AnnotateImageRequest)>`
...
`[AnnotateImageRequestOrBuilder](/java/docs/reference/google-cloud-vision/3.57.0/com.google.cloud.vision.v1.AnnotateImageRequestOrBuilder)`
...
```
public AsyncBatchAnnotateImagesRequest.Builder putAllLabels(Map<String,String> values)
```
...
```
public AsyncBatchAnnotateImagesRequest.Builder putLabels(String key, String value)
```
...
```
public AsyncBatchAnnotateImagesRequest.Builder removeLabels(String key)
```
