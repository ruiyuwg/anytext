...
# Class ListCaPoolsResponse (2.34.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListCaPoolsResponse extends GeneratedMessageV3 implements ListCaPoolsResponseOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListCaPoolsResponse

## Implements

[ListCaPoolsResponseOrBuilder](/java/docs/reference/google-cloud-security-private-ca/2.34.0/com.google.cloud.security.privateca.v1.ListCaPoolsResponseOrBuilder)
...
### CA\_POOLS\_FIELD\_NUMBER

```
public static final int CA_POOLS_FIELD_NUMBER
```
...
```
public static ListCaPoolsResponse getDefaultInstance()
```
...
`[ListCaPoolsResponse](/java/docs/reference/google-cloud-security-private-ca/2.34.0/com.google.cloud.security.privateca.v1.ListCaPoolsResponse)`
...
```
public static ListCaPoolsResponse.Builder newBuilder()
```
...
`[ListCaPoolsResponse.Builder](/java/docs/reference/google-cloud-security-private-ca/2.34.0/com.google.cloud.security.privateca.v1.ListCaPoolsResponse.Builder)`

### newBuilder(ListCaPoolsResponse prototype)

```
public static ListCaPoolsResponse.Builder newBuilder(ListCaPoolsResponse prototype)
```
...
```
public static ListCaPoolsResponse parseDelimitedFrom(InputStream input)
```
...
```
public static ListCaPoolsResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListCaPoolsResponse parseFrom(byte[] data)
```
...
```
public static ListCaPoolsResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListCaPoolsResponse parseFrom(ByteString data)
```
...
```
public static ListCaPoolsResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListCaPoolsResponse parseFrom(CodedInputStream input)
```
...
```
public static ListCaPoolsResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListCaPoolsResponse parseFrom(InputStream input)
```
...
```
public static ListCaPoolsResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListCaPoolsResponse parseFrom(ByteBuffer data)
```
...
```
public static ListCaPoolsResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ListCaPoolsResponse> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListCaPoolsResponse](/java/docs/reference/google-cloud-security-private-ca/2.34.0/com.google.cloud.security.privateca.v1.ListCaPoolsResponse)>`
...
```
public CaPool getCaPools(int index)
```
...
`[CaPool](/java/docs/reference/google-cloud-security-private-ca/2.34.0/com.google.cloud.security.privateca.v1.CaPool)`
...
```
public List<CaPool> getCaPoolsList()
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[CaPool](/java/docs/reference/google-cloud-security-private-ca/2.34.0/com.google.cloud.security.privateca.v1.CaPool)>`

### getCaPoolsOrBuilder(int index)

```
public CaPoolOrBuilder getCaPoolsOrBuilder(int index)
```
...
`[CaPoolOrBuilder](/java/docs/reference/google-cloud-security-private-ca/2.34.0/com.google.cloud.security.privateca.v1.CaPoolOrBuilder)`

### getCaPoolsOrBuilderList()

```
public List<? extends CaPoolOrBuilder> getCaPoolsOrBuilderList()
```
...
```
public ListCaPoolsResponse getDefaultInstanceForType()
```
...
```
public Parser<ListCaPoolsResponse> getParserForType()
```
...
```
public ListCaPoolsResponse.Builder newBuilderForType()
```
...
```
protected ListCaPoolsResponse.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ListCaPoolsResponse.Builder toBuilder()
```
