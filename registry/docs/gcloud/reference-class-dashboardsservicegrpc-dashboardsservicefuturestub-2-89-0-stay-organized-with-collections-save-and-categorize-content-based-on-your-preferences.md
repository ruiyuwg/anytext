...
# Class DashboardsServiceGrpc.DashboardsServiceFutureStub (2.89.0) Stay organized with collections Save and categorize content based on your preferences.
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> io.grpc.stub.AbstractStub \> io.grpc.stub.AbstractFutureStub \> DashboardsServiceGrpc.DashboardsServiceFutureStub
...
`[DashboardsServiceGrpc.DashboardsServiceFutureStub](/java/docs/reference/google-cloud-monitoring-dashboard/latest/com.google.monitoring.dashboard.v1.DashboardsServiceGrpc.DashboardsServiceFutureStub)`
...
`[CreateDashboardRequest](/java/docs/reference/google-cloud-monitoring-dashboard/latest/com.google.monitoring.dashboard.v1.CreateDashboardRequest)`  
...
`com.google.common.util.concurrent.ListenableFuture<[Dashboard](/java/docs/reference/google-cloud-monitoring-dashboard/latest/com.google.monitoring.dashboard.v1.Dashboard)>`
...
`[DeleteDashboardRequest](/java/docs/reference/google-cloud-monitoring-dashboard/latest/com.google.monitoring.dashboard.v1.DeleteDashboardRequest)`  
...
`[GetDashboardRequest](/java/docs/reference/google-cloud-monitoring-dashboard/latest/com.google.monitoring.dashboard.v1.GetDashboardRequest)`  
...
`[ListDashboardsRequest](/java/docs/reference/google-cloud-monitoring-dashboard/latest/com.google.monitoring.dashboard.v1.ListDashboardsRequest)`  
...
`com.google.common.util.concurrent.ListenableFuture<[ListDashboardsResponse](/java/docs/reference/google-cloud-monitoring-dashboard/latest/com.google.monitoring.dashboard.v1.ListDashboardsResponse)>`
...
`[UpdateDashboardRequest](/java/docs/reference/google-cloud-monitoring-dashboard/latest/com.google.monitoring.dashboard.v1.UpdateDashboardRequest)`  
