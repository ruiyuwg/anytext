...
# Class StorageTransferServiceClient.ListTransferJobsPage (1.15.0) Stay organized with collections Save and categorize content based on your preferences.
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractPage](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractPage.html) \> StorageTransferServiceClient.ListTransferJobsPage
...
### createPage(PageContext<TransferProto.ListTransferJobsRequest,TransferProto.ListTransferJobsResponse,TransferTypes.TransferJob> context, TransferProto.ListTransferJobsResponse response)

```
protected StorageTransferServiceClient.ListTransferJobsPage createPage(PageContext<TransferProto.ListTransferJobsRequest,TransferProto.ListTransferJobsResponse,TransferTypes.TransferJob> context, TransferProto.ListTransferJobsResponse response)
```
...
`[PageContext](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PageContext.html)<[ListTransferJobsRequest](/java/docs/reference/google-cloud-storage-transfer/1.15.0/com.google.storagetransfer.v1.proto.TransferProto.ListTransferJobsRequest),[ListTransferJobsResponse](/java/docs/reference/google-cloud-storage-transfer/1.15.0/com.google.storagetransfer.v1.proto.TransferProto.ListTransferJobsResponse),[TransferJob](/java/docs/reference/google-cloud-storage-transfer/1.15.0/com.google.storagetransfer.v1.proto.TransferTypes.TransferJob)>`  

`response`

`[TransferProto.ListTransferJobsResponse](/java/docs/reference/google-cloud-storage-transfer/1.15.0/com.google.storagetransfer.v1.proto.TransferProto.ListTransferJobsResponse)`  
...
`[StorageTransferServiceClient.ListTransferJobsPage](/java/docs/reference/google-cloud-storage-transfer/1.15.0/com.google.storagetransfer.v1.proto.StorageTransferServiceClient.ListTransferJobsPage)`
...
### createPageAsync(PageContext<TransferProto.ListTransferJobsRequest,TransferProto.ListTransferJobsResponse,TransferTypes.TransferJob> context, ApiFuture<TransferProto.ListTransferJobsResponse> futureResponse)

```
public ApiFuture<StorageTransferServiceClient.ListTransferJobsPage> createPageAsync(PageContext<TransferProto.ListTransferJobsRequest,TransferProto.ListTransferJobsResponse,TransferTypes.TransferJob> context, ApiFuture<TransferProto.ListTransferJobsResponse> futureResponse)
```
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListTransferJobsResponse](/java/docs/reference/google-cloud-storage-transfer/1.15.0/com.google.storagetransfer.v1.proto.TransferProto.ListTransferJobsResponse)>`  
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListTransferJobsPage](/java/docs/reference/google-cloud-storage-transfer/1.15.0/com.google.storagetransfer.v1.proto.StorageTransferServiceClient.ListTransferJobsPage)>`
