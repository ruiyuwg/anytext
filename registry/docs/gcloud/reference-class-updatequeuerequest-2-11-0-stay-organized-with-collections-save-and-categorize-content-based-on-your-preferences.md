...
# Class UpdateQueueRequest (2.11.0) Stay organized with collections Save and categorize content based on your preferences.
...
[UpdateQueueRequestOrBuilder](/java/docs/reference/google-cloud-tasks/2.11.0/com.google.cloud.tasks.v2.UpdateQueueRequestOrBuilder)
...
`[UpdateQueueRequest](/java/docs/reference/google-cloud-tasks/2.11.0/com.google.cloud.tasks.v2.UpdateQueueRequest)`
...
`[UpdateQueueRequest.Builder](/java/docs/reference/google-cloud-tasks/2.11.0/com.google.cloud.tasks.v2.UpdateQueueRequest.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[UpdateQueueRequest](/java/docs/reference/google-cloud-tasks/2.11.0/com.google.cloud.tasks.v2.UpdateQueueRequest)>`
...
`[Queue](/java/docs/reference/google-cloud-tasks/2.11.0/com.google.cloud.tasks.v2.Queue)`
...
`[QueueOrBuilder](/java/docs/reference/google-cloud-tasks/2.11.0/com.google.cloud.tasks.v2.QueueOrBuilder)`
