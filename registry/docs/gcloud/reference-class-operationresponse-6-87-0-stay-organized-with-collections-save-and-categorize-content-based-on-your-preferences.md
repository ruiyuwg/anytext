...
# Class OperationResponse (6.87.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class OperationResponse extends GeneratedMessageV3 implements OperationResponseOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> OperationResponse

## Implements

[OperationResponseOrBuilder](/java/docs/reference/google-cloud-spanner/6.87.0/com.google.spanner.executor.v1.OperationResponseOrBuilder)
...
### LISTED\_OPERATIONS\_FIELD\_NUMBER

```
public static final int LISTED_OPERATIONS_FIELD_NUMBER
```
...
`[OperationResponse](/java/docs/reference/google-cloud-spanner/6.87.0/com.google.spanner.executor.v1.OperationResponse)`
...
```
public static OperationResponse.Builder newBuilder()
```
...
`[OperationResponse.Builder](/java/docs/reference/google-cloud-spanner/6.87.0/com.google.spanner.executor.v1.OperationResponse.Builder)`

### newBuilder(OperationResponse prototype)

```
public static OperationResponse.Builder newBuilder(OperationResponse prototype)
```
...
```
public static OperationResponse parseDelimitedFrom(InputStream input)
```
...
```
public static OperationResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static OperationResponse parseFrom(byte[] data)
```
...
```
public static OperationResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static OperationResponse parseFrom(ByteString data)
```
...
```
public static OperationResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static OperationResponse parseFrom(CodedInputStream input)
```
...
```
public static OperationResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static OperationResponse parseFrom(InputStream input)
```
...
```
public static OperationResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static OperationResponse parseFrom(ByteBuffer data)
```
...
```
public static OperationResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[OperationResponse](/java/docs/reference/google-cloud-spanner/6.87.0/com.google.spanner.executor.v1.OperationResponse)>`
...
### getListedOperations(int index)

```
public Operation getListedOperations(int index)
```
...
```
public List<Operation> getListedOperationsList()
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Operation](https://cloud.google.com/java/docs/reference/gax/latest/com.google.longrunning.Operation.html)>`

### getListedOperationsOrBuilder(int index)

```
public OperationOrBuilder getListedOperationsOrBuilder(int index)
```
...
`[OperationOrBuilder](https://cloud.google.com/java/docs/reference/gax/latest/com.google.longrunning.OperationOrBuilder.html)`

### getListedOperationsOrBuilderList()

```
public List<? extends OperationOrBuilder> getListedOperationsOrBuilderList()
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.longrunning.OperationOrBuilder>`
...
```
public OperationResponse.Builder newBuilderForType()
```
...
```
protected OperationResponse.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public OperationResponse.Builder toBuilder()
```
