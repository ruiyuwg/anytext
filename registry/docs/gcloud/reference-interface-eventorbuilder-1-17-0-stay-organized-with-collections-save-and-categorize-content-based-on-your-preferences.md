...
# Interface EventOrBuilder (1.17.0) Stay organized with collections Save and categorize content based on your preferences.
...
Use [#getDetailsMap()](/java/docs/reference/google-cloud-notebooks/1.17.0/com.google.cloud.notebooks.v1.EventOrBuilder#com_google_cloud_notebooks_v1_EventOrBuilder_getDetailsMap__) instead.
...
`[Event.EventType](/java/docs/reference/google-cloud-notebooks/1.17.0/com.google.cloud.notebooks.v1.Event.EventType)`
