...
# Enum Replication.ReplicationCase (2.39.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum Replication.ReplicationCase extends Enum<Replication.ReplicationCase> implements Internal.EnumLite, AbstractMessageLite.InternalOneOfEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-secretmanager/2.39.0/com.google.cloud.secretmanager.v1.Replication.ReplicationCase#com_google_cloud_secretmanager_v1_Replication_ReplicationCase_forNumber_int_) instead._
