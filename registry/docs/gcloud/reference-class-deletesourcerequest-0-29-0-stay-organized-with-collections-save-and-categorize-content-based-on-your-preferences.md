...
# Class DeleteSourceRequest (0.29.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class DeleteSourceRequest extends GeneratedMessageV3 implements DeleteSourceRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> DeleteSourceRequest

## Implements

[DeleteSourceRequestOrBuilder](/java/docs/reference/google-cloud-migrationcenter/0.29.0/com.google.cloud.migrationcenter.v1.DeleteSourceRequestOrBuilder)
...
```
public static DeleteSourceRequest getDefaultInstance()
```
...
`[DeleteSourceRequest](/java/docs/reference/google-cloud-migrationcenter/0.29.0/com.google.cloud.migrationcenter.v1.DeleteSourceRequest)`
...
```
public static DeleteSourceRequest.Builder newBuilder()
```
...
`[DeleteSourceRequest.Builder](/java/docs/reference/google-cloud-migrationcenter/0.29.0/com.google.cloud.migrationcenter.v1.DeleteSourceRequest.Builder)`

### newBuilder(DeleteSourceRequest prototype)

```
public static DeleteSourceRequest.Builder newBuilder(DeleteSourceRequest prototype)
```
...
```
public static DeleteSourceRequest parseDelimitedFrom(InputStream input)
```
...
```
public static DeleteSourceRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteSourceRequest parseFrom(byte[] data)
```
...
```
public static DeleteSourceRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteSourceRequest parseFrom(ByteString data)
```
...
```
public static DeleteSourceRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteSourceRequest parseFrom(CodedInputStream input)
```
...
```
public static DeleteSourceRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteSourceRequest parseFrom(InputStream input)
```
...
```
public static DeleteSourceRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteSourceRequest parseFrom(ByteBuffer data)
```
...
```
public static DeleteSourceRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<DeleteSourceRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[DeleteSourceRequest](/java/docs/reference/google-cloud-migrationcenter/0.29.0/com.google.cloud.migrationcenter.v1.DeleteSourceRequest)>`
...
```
public DeleteSourceRequest getDefaultInstanceForType()
```
...
```
public Parser<DeleteSourceRequest> getParserForType()
```
...
```
public DeleteSourceRequest.Builder newBuilderForType()
```
...
```
protected DeleteSourceRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public DeleteSourceRequest.Builder toBuilder()
```
