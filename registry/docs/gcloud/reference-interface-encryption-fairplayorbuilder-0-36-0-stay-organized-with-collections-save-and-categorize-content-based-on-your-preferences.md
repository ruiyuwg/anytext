...
# Interface Encryption.FairplayOrBuilder (0.36.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static interface Encryption.FairplayOrBuilder extends MessageOrBuilder
```
