...
# Interface SetInventoryRequestOrBuilder (2.44.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[Product](/java/docs/reference/google-cloud-retail/2.44.0/com.google.cloud.retail.v2alpha.Product)`
...
`[ProductOrBuilder](/java/docs/reference/google-cloud-retail/2.44.0/com.google.cloud.retail.v2alpha.ProductOrBuilder)`
