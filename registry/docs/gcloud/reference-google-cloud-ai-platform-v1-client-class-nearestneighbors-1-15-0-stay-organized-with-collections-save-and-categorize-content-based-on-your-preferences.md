...
# Google Cloud Ai Platform V1 Client - Class NearestNeighbors (1.15.0) Stay organized with collections Save and categorize content based on your preferences.
...
`array<[NearestNeighbors\Neighbor](/php/docs/reference/cloud-ai-platform/1.15.0/V1.NearestNeighbors.Neighbor)>`  
