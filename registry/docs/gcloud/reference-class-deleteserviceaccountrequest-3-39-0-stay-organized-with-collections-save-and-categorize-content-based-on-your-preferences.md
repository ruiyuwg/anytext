...
# Class DeleteServiceAccountRequest (3.39.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class DeleteServiceAccountRequest extends GeneratedMessageV3 implements DeleteServiceAccountRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> DeleteServiceAccountRequest

## Implements

[DeleteServiceAccountRequestOrBuilder](/java/docs/reference/google-iam-admin/3.39.0/com.google.iam.admin.v1.DeleteServiceAccountRequestOrBuilder)
...
```
public static DeleteServiceAccountRequest getDefaultInstance()
```
...
`[DeleteServiceAccountRequest](/java/docs/reference/google-iam-admin/3.39.0/com.google.iam.admin.v1.DeleteServiceAccountRequest)`
...
```
public static DeleteServiceAccountRequest.Builder newBuilder()
```
...
`[DeleteServiceAccountRequest.Builder](/java/docs/reference/google-iam-admin/3.39.0/com.google.iam.admin.v1.DeleteServiceAccountRequest.Builder)`

### newBuilder(DeleteServiceAccountRequest prototype)

```
public static DeleteServiceAccountRequest.Builder newBuilder(DeleteServiceAccountRequest prototype)
```
...
```
public static DeleteServiceAccountRequest parseDelimitedFrom(InputStream input)
```
...
```
public static DeleteServiceAccountRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteServiceAccountRequest parseFrom(byte[] data)
```
...
```
public static DeleteServiceAccountRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteServiceAccountRequest parseFrom(ByteString data)
```
...
```
public static DeleteServiceAccountRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteServiceAccountRequest parseFrom(CodedInputStream input)
```
...
```
public static DeleteServiceAccountRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteServiceAccountRequest parseFrom(InputStream input)
```
...
```
public static DeleteServiceAccountRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteServiceAccountRequest parseFrom(ByteBuffer data)
```
...
```
public static DeleteServiceAccountRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<DeleteServiceAccountRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[DeleteServiceAccountRequest](/java/docs/reference/google-iam-admin/3.39.0/com.google.iam.admin.v1.DeleteServiceAccountRequest)>`
...
```
public Parser<DeleteServiceAccountRequest> getParserForType()
```
...
```
public DeleteServiceAccountRequest.Builder newBuilderForType()
```
...
```
protected DeleteServiceAccountRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public DeleteServiceAccountRequest.Builder toBuilder()
```
