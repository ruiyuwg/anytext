...
# Class OperationMetadata.Builder (1.36.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> OperationMetadata.Builder

## Implements

[OperationMetadataOrBuilder](/java/docs/reference/google-cloud-network-management/1.36.0/com.google.cloud.networkmanagement.v1.OperationMetadataOrBuilder)
...
`[OperationMetadata.Builder](/java/docs/reference/google-cloud-network-management/1.36.0/com.google.cloud.networkmanagement.v1.OperationMetadata.Builder)`
...
`[OperationMetadata](/java/docs/reference/google-cloud-network-management/1.36.0/com.google.cloud.networkmanagement.v1.OperationMetadata)`
...
```
public OperationMetadata.Builder clearCancelRequested()
```
...
```
public OperationMetadata.Builder setCancelRequested(boolean value)
```
...
```
public OperationMetadata.Builder setStatusDetailBytes(ByteString value)
```
