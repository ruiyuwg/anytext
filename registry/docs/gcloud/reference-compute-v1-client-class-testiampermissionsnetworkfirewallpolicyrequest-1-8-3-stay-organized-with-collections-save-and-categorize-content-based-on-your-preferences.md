...
# Compute V1 Client - Class TestIamPermissionsNetworkFirewallPolicyRequest (1.8.3) Stay organized with collections Save and categorize content based on your preferences.
...
`[Google\Cloud\Compute\V1\TestPermissionsRequest](/php/docs/reference/cloud-compute/1.8.3/V1.TestPermissionsRequest)|null`
