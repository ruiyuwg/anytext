...
# Class UpdateSessionTemplateRequest (4.84.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class UpdateSessionTemplateRequest extends GeneratedMessage implements UpdateSessionTemplateRequestOrBuilder
```

A request to update a session template.

Protobuf type `google.cloud.dataproc.v1.UpdateSessionTemplateRequest`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessage.html) \> UpdateSessionTemplateRequest

## Implements

[UpdateSessionTemplateRequestOrBuilder](/java/docs/reference/google-cloud-dataproc/latest/com.google.cloud.dataproc.v1.UpdateSessionTemplateRequestOrBuilder)
...
### SESSION\_TEMPLATE\_FIELD\_NUMBER
...
```
public static UpdateSessionTemplateRequest getDefaultInstance()
```
...
`[UpdateSessionTemplateRequest](/java/docs/reference/google-cloud-dataproc/latest/com.google.cloud.dataproc.v1.UpdateSessionTemplateRequest)`
...
```
public static UpdateSessionTemplateRequest.Builder newBuilder()
```
...
`[UpdateSessionTemplateRequest.Builder](/java/docs/reference/google-cloud-dataproc/latest/com.google.cloud.dataproc.v1.UpdateSessionTemplateRequest.Builder)`

### newBuilder(UpdateSessionTemplateRequest prototype)

```
public static UpdateSessionTemplateRequest.Builder newBuilder(UpdateSessionTemplateRequest prototype)
```
...
```
public static UpdateSessionTemplateRequest parseDelimitedFrom(InputStream input)
```
...
```
public static UpdateSessionTemplateRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateSessionTemplateRequest parseFrom(byte[] data)
```
...
```
public static UpdateSessionTemplateRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateSessionTemplateRequest parseFrom(ByteString data)
```
...
```
public static UpdateSessionTemplateRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateSessionTemplateRequest parseFrom(CodedInputStream input)
```
...
```
public static UpdateSessionTemplateRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateSessionTemplateRequest parseFrom(InputStream input)
```
...
```
public static UpdateSessionTemplateRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateSessionTemplateRequest parseFrom(ByteBuffer data)
```
...
```
public static UpdateSessionTemplateRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<UpdateSessionTemplateRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[UpdateSessionTemplateRequest](/java/docs/reference/google-cloud-dataproc/latest/com.google.cloud.dataproc.v1.UpdateSessionTemplateRequest)>`
...
```
public UpdateSessionTemplateRequest getDefaultInstanceForType()
```
...
```
public Parser<UpdateSessionTemplateRequest> getParserForType()
```
...
`[SessionTemplate](/java/docs/reference/google-cloud-dataproc/latest/com.google.cloud.dataproc.v1.SessionTemplate)`
...
`[SessionTemplateOrBuilder](/java/docs/reference/google-cloud-dataproc/latest/com.google.cloud.dataproc.v1.SessionTemplateOrBuilder)`
...
```
public UpdateSessionTemplateRequest.Builder newBuilderForType()
```
...
```
protected UpdateSessionTemplateRequest.Builder newBuilderForType(AbstractMessage.BuilderParent parent)
```
...
```
public UpdateSessionTemplateRequest.Builder toBuilder()
```
