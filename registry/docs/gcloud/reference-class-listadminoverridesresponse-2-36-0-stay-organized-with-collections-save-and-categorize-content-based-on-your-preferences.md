...
# Class ListAdminOverridesResponse (2.36.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListAdminOverridesResponse extends GeneratedMessageV3 implements ListAdminOverridesResponseOrBuilder
```

Response message for ListAdminOverrides.

Protobuf type `google.api.serviceusage.v1beta1.ListAdminOverridesResponse`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListAdminOverridesResponse

## Implements

[ListAdminOverridesResponseOrBuilder](/java/docs/reference/google-cloud-service-usage/2.36.0/com.google.api.serviceusage.v1beta1.ListAdminOverridesResponseOrBuilder)
...
```
public static ListAdminOverridesResponse getDefaultInstance()
```
...
`[ListAdminOverridesResponse](/java/docs/reference/google-cloud-service-usage/2.36.0/com.google.api.serviceusage.v1beta1.ListAdminOverridesResponse)`
...
```
public static ListAdminOverridesResponse.Builder newBuilder()
```
...
`[ListAdminOverridesResponse.Builder](/java/docs/reference/google-cloud-service-usage/2.36.0/com.google.api.serviceusage.v1beta1.ListAdminOverridesResponse.Builder)`

### newBuilder(ListAdminOverridesResponse prototype)

```
public static ListAdminOverridesResponse.Builder newBuilder(ListAdminOverridesResponse prototype)
```
...
```
public static ListAdminOverridesResponse parseDelimitedFrom(InputStream input)
```
...
```
public static ListAdminOverridesResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListAdminOverridesResponse parseFrom(byte[] data)
```
...
```
public static ListAdminOverridesResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListAdminOverridesResponse parseFrom(ByteString data)
```
...
```
public static ListAdminOverridesResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListAdminOverridesResponse parseFrom(CodedInputStream input)
```
...
```
public static ListAdminOverridesResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListAdminOverridesResponse parseFrom(InputStream input)
```
...
```
public static ListAdminOverridesResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListAdminOverridesResponse parseFrom(ByteBuffer data)
```
...
```
public static ListAdminOverridesResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ListAdminOverridesResponse> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListAdminOverridesResponse](/java/docs/reference/google-cloud-service-usage/2.36.0/com.google.api.serviceusage.v1beta1.ListAdminOverridesResponse)>`
...
```
public ListAdminOverridesResponse getDefaultInstanceForType()
```
...
`[QuotaOverride](/java/docs/reference/google-cloud-service-usage/2.36.0/com.google.api.serviceusage.v1beta1.QuotaOverride)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[QuotaOverride](/java/docs/reference/google-cloud-service-usage/2.36.0/com.google.api.serviceusage.v1beta1.QuotaOverride)>`
...
`[QuotaOverrideOrBuilder](/java/docs/reference/google-cloud-service-usage/2.36.0/com.google.api.serviceusage.v1beta1.QuotaOverrideOrBuilder)`
...
```
public Parser<ListAdminOverridesResponse> getParserForType()
```
...
```
public ListAdminOverridesResponse.Builder newBuilderForType()
```
...
```
protected ListAdminOverridesResponse.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ListAdminOverridesResponse.Builder toBuilder()
```
