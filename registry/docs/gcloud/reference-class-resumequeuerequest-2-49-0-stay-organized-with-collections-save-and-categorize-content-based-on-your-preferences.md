...
# Class ResumeQueueRequest (2.49.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ResumeQueueRequest extends GeneratedMessageV3 implements ResumeQueueRequestOrBuilder
```

Request message for ResumeQueue.

Protobuf type `google.cloud.tasks.v2beta3.ResumeQueueRequest`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ResumeQueueRequest

## Implements

[ResumeQueueRequestOrBuilder](/java/docs/reference/google-cloud-tasks/2.49.0/com.google.cloud.tasks.v2beta3.ResumeQueueRequestOrBuilder)
...
```
public static ResumeQueueRequest getDefaultInstance()
```
...
`[ResumeQueueRequest](/java/docs/reference/google-cloud-tasks/2.49.0/com.google.cloud.tasks.v2beta3.ResumeQueueRequest)`
...
```
public static ResumeQueueRequest.Builder newBuilder()
```
...
`[ResumeQueueRequest.Builder](/java/docs/reference/google-cloud-tasks/2.49.0/com.google.cloud.tasks.v2beta3.ResumeQueueRequest.Builder)`

### newBuilder(ResumeQueueRequest prototype)

```
public static ResumeQueueRequest.Builder newBuilder(ResumeQueueRequest prototype)
```
...
```
public static ResumeQueueRequest parseDelimitedFrom(InputStream input)
```
...
```
public static ResumeQueueRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ResumeQueueRequest parseFrom(byte[] data)
```
...
```
public static ResumeQueueRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ResumeQueueRequest parseFrom(ByteString data)
```
...
```
public static ResumeQueueRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ResumeQueueRequest parseFrom(CodedInputStream input)
```
...
```
public static ResumeQueueRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ResumeQueueRequest parseFrom(InputStream input)
```
...
```
public static ResumeQueueRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ResumeQueueRequest parseFrom(ByteBuffer data)
```
...
```
public static ResumeQueueRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ResumeQueueRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ResumeQueueRequest](/java/docs/reference/google-cloud-tasks/2.49.0/com.google.cloud.tasks.v2beta3.ResumeQueueRequest)>`
...
```
public ResumeQueueRequest getDefaultInstanceForType()
```
...
```
public Parser<ResumeQueueRequest> getParserForType()
```
...
```
public ResumeQueueRequest.Builder newBuilderForType()
```
...
```
protected ResumeQueueRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ResumeQueueRequest.Builder toBuilder()
```
