...
# Class SearchRequest.SpellCorrectionSpec (2.39.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class SearchRequest.SpellCorrectionSpec extends GeneratedMessageV3 implements SearchRequest.SpellCorrectionSpecOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> SearchRequest.SpellCorrectionSpec

## Implements

[SearchRequest.SpellCorrectionSpecOrBuilder](/java/docs/reference/google-cloud-retail/2.39.0/com.google.cloud.retail.v2beta.SearchRequest.SpellCorrectionSpecOrBuilder)
...
```
public static SearchRequest.SpellCorrectionSpec getDefaultInstance()
```
...
`[SearchRequest.SpellCorrectionSpec](/java/docs/reference/google-cloud-retail/2.39.0/com.google.cloud.retail.v2beta.SearchRequest.SpellCorrectionSpec)`
...
```
public static SearchRequest.SpellCorrectionSpec.Builder newBuilder()
```
...
`[SearchRequest.SpellCorrectionSpec.Builder](/java/docs/reference/google-cloud-retail/2.39.0/com.google.cloud.retail.v2beta.SearchRequest.SpellCorrectionSpec.Builder)`

### newBuilder(SearchRequest.SpellCorrectionSpec prototype)

```
public static SearchRequest.SpellCorrectionSpec.Builder newBuilder(SearchRequest.SpellCorrectionSpec prototype)
```
...
```
public static SearchRequest.SpellCorrectionSpec parseDelimitedFrom(InputStream input)
```
...
```
public static SearchRequest.SpellCorrectionSpec parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SearchRequest.SpellCorrectionSpec parseFrom(byte[] data)
```
...
```
public static SearchRequest.SpellCorrectionSpec parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SearchRequest.SpellCorrectionSpec parseFrom(ByteString data)
```
...
```
public static SearchRequest.SpellCorrectionSpec parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SearchRequest.SpellCorrectionSpec parseFrom(CodedInputStream input)
```
...
```
public static SearchRequest.SpellCorrectionSpec parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SearchRequest.SpellCorrectionSpec parseFrom(InputStream input)
```
...
```
public static SearchRequest.SpellCorrectionSpec parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SearchRequest.SpellCorrectionSpec parseFrom(ByteBuffer data)
```
...
```
public static SearchRequest.SpellCorrectionSpec parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<SearchRequest.SpellCorrectionSpec> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[SpellCorrectionSpec](/java/docs/reference/google-cloud-retail/2.39.0/com.google.cloud.retail.v2beta.SearchRequest.SpellCorrectionSpec)>`
...
```
public SearchRequest.SpellCorrectionSpec getDefaultInstanceForType()
```
...
```
public SearchRequest.SpellCorrectionSpec.Mode getMode()
```

The mode under which spell correction should take effect to replace the original search query. Default to Mode.AUTO.

`.google.cloud.retail.v2beta.SearchRequest.SpellCorrectionSpec.Mode mode = 1;`
...
`[SearchRequest.SpellCorrectionSpec.Mode](/java/docs/reference/google-cloud-retail/2.39.0/com.google.cloud.retail.v2beta.SearchRequest.SpellCorrectionSpec.Mode)`
...
```
public Parser<SearchRequest.SpellCorrectionSpec> getParserForType()
```
...
```
public SearchRequest.SpellCorrectionSpec.Builder newBuilderForType()
```
...
```
protected SearchRequest.SpellCorrectionSpec.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public SearchRequest.SpellCorrectionSpec.Builder toBuilder()
```
