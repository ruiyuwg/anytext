...
# Enum Span.Link.Type (2.46.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-trace/2.46.0/com.google.devtools.cloudtrace.v2.Span.Link.Type#com_google_devtools_cloudtrace_v2_Span_Link_Type_forNumber_int_) instead._
