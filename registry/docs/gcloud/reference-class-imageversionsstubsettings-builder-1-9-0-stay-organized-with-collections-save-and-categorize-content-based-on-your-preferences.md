...
# Class ImageVersionsStubSettings.Builder (1.9.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class ImageVersionsStubSettings.Builder extends StubSettings.Builder<ImageVersionsStubSettings,ImageVersionsStubSettings.Builder>
```
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [StubSettings.Builder](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.StubSettings.Builder.html) \> ImageVersionsStubSettings.Builder
...
### Builder(ImageVersionsStubSettings settings)
...
`[ImageVersionsStubSettings](/java/docs/reference/google-cloud-orchestration-airflow/1.9.0/com.google.cloud.orchestration.airflow.service.v1.stub.ImageVersionsStubSettings)`  
...
```
public ImageVersionsStubSettings.Builder applyToAllUnaryMethods(ApiFunction<UnaryCallSettings.Builder<?,?>,Void> settingsUpdater)
```
...
`[ImageVersionsStubSettings.Builder](/java/docs/reference/google-cloud-orchestration-airflow/1.9.0/com.google.cloud.orchestration.airflow.service.v1.stub.ImageVersionsStubSettings.Builder)`

### build()

```
public ImageVersionsStubSettings build()
```
...
`[Builder](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PagedCallSettings.Builder.html)<[ListImageVersionsRequest](/java/docs/reference/google-cloud-orchestration-airflow/1.9.0/com.google.cloud.orchestration.airflow.service.v1.ListImageVersionsRequest),[ListImageVersionsResponse](/java/docs/reference/google-cloud-orchestration-airflow/1.9.0/com.google.cloud.orchestration.airflow.service.v1.ListImageVersionsResponse),[ListImageVersionsPagedResponse](/java/docs/reference/google-cloud-orchestration-airflow/1.9.0/com.google.cloud.orchestration.airflow.service.v1.ImageVersionsClient.ListImageVersionsPagedResponse)>`
