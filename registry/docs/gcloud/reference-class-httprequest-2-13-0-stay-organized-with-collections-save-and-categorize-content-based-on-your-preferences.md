...
# Class HttpRequest (2.13.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> HttpRequest

## Implements

[HttpRequestOrBuilder](/java/docs/reference/google-cloud-tasks/2.13.0/com.google.cloud.tasks.v2beta3.HttpRequestOrBuilder)
...
`[HttpRequest](/java/docs/reference/google-cloud-tasks/2.13.0/com.google.cloud.tasks.v2beta3.HttpRequest)`
...
`[HttpRequest.Builder](/java/docs/reference/google-cloud-tasks/2.13.0/com.google.cloud.tasks.v2beta3.HttpRequest.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[HttpRequest](/java/docs/reference/google-cloud-tasks/2.13.0/com.google.cloud.tasks.v2beta3.HttpRequest)>`
...
`[HttpRequest.AuthorizationHeaderCase](/java/docs/reference/google-cloud-tasks/2.13.0/com.google.cloud.tasks.v2beta3.HttpRequest.AuthorizationHeaderCase)`
...
Use [#getHeadersMap()](/java/docs/reference/google-cloud-tasks/2.13.0/com.google.cloud.tasks.v2beta3.HttpRequest#com_google_cloud_tasks_v2beta3_HttpRequest_getHeadersMap__) instead.
...
`[HttpMethod](/java/docs/reference/google-cloud-tasks/2.13.0/com.google.cloud.tasks.v2beta3.HttpMethod)`
...
`[OAuthToken](/java/docs/reference/google-cloud-tasks/2.13.0/com.google.cloud.tasks.v2beta3.OAuthToken)`
...
`[OAuthTokenOrBuilder](/java/docs/reference/google-cloud-tasks/2.13.0/com.google.cloud.tasks.v2beta3.OAuthTokenOrBuilder)`
...
`[OidcToken](/java/docs/reference/google-cloud-tasks/2.13.0/com.google.cloud.tasks.v2beta3.OidcToken)`
...
`[OidcTokenOrBuilder](/java/docs/reference/google-cloud-tasks/2.13.0/com.google.cloud.tasks.v2beta3.OidcTokenOrBuilder)`
...
Required. The full url path that the request will be sent to. This string must begin with either "http://" or "https://". Some examples are: `[http://acme.com](http://acme.com)` and `[https://acme.com/sales:8080](https://acme.com/sales:8080)`. Cloud Tasks will encode some characters for safety and compatibility. The maximum allowed URL length is 2083 characters after encoding. The `Location` header response from a redirect response \[`300` - `399`\] may be followed. The redirect is not counted as a separate attempt.
