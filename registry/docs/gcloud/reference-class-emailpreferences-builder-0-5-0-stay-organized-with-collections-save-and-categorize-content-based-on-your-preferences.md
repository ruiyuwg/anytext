...
# Class EmailPreferences.Builder (0.5.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class EmailPreferences.Builder extends GeneratedMessageV3.Builder<EmailPreferences.Builder> implements EmailPreferencesOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> EmailPreferences.Builder

## Implements

[EmailPreferencesOrBuilder](/java/docs/reference/google-shopping-merchant-accounts/0.5.0/com.google.shopping.merchant.accounts.v1beta.EmailPreferencesOrBuilder)
...
```
public EmailPreferences.Builder addRepeatedField(Descriptors.FieldDescriptor field, Object value)
```
...
`[EmailPreferences.Builder](/java/docs/reference/google-shopping-merchant-accounts/0.5.0/com.google.shopping.merchant.accounts.v1beta.EmailPreferences.Builder)`
...
```
public EmailPreferences.Builder clearField(Descriptors.FieldDescriptor field)
```
...
```
public EmailPreferences.Builder clearOneof(Descriptors.OneofDescriptor oneof)
```
...
```
public EmailPreferences.Builder clone()
```
...
`[EmailPreferences.OptInState](/java/docs/reference/google-shopping-merchant-accounts/0.5.0/com.google.shopping.merchant.accounts.v1beta.EmailPreferences.OptInState)`
...
```
public final EmailPreferences.Builder mergeUnknownFields(UnknownFieldSet unknownFields)
```
...
```
public EmailPreferences.Builder setField(Descriptors.FieldDescriptor field, Object value)
```
...
```
public EmailPreferences.Builder setRepeatedField(Descriptors.FieldDescriptor field, int index, Object value)
```
...
```
public final EmailPreferences.Builder setUnknownFields(UnknownFieldSet unknownFields)
```
