...
# Class Instance.NodeConfig (2.46.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class Instance.NodeConfig extends GeneratedMessageV3 implements Instance.NodeConfigOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> Instance.NodeConfig

## Implements

[Instance.NodeConfigOrBuilder](/java/docs/reference/google-cloud-memcache/2.46.0/com.google.cloud.memcache.v1.Instance.NodeConfigOrBuilder)
...
### MEMORY\_SIZE\_MB\_FIELD\_NUMBER

```
public static final int MEMORY_SIZE_MB_FIELD_NUMBER
```
...
```
public static Instance.NodeConfig getDefaultInstance()
```
...
`[Instance.NodeConfig](/java/docs/reference/google-cloud-memcache/2.46.0/com.google.cloud.memcache.v1.Instance.NodeConfig)`
...
```
public static Instance.NodeConfig.Builder newBuilder()
```
...
`[Instance.NodeConfig.Builder](/java/docs/reference/google-cloud-memcache/2.46.0/com.google.cloud.memcache.v1.Instance.NodeConfig.Builder)`

### newBuilder(Instance.NodeConfig prototype)

```
public static Instance.NodeConfig.Builder newBuilder(Instance.NodeConfig prototype)
```
...
```
public static Instance.NodeConfig parseDelimitedFrom(InputStream input)
```
...
```
public static Instance.NodeConfig parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Instance.NodeConfig parseFrom(byte[] data)
```
...
```
public static Instance.NodeConfig parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Instance.NodeConfig parseFrom(ByteString data)
```
...
```
public static Instance.NodeConfig parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Instance.NodeConfig parseFrom(CodedInputStream input)
```
...
```
public static Instance.NodeConfig parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Instance.NodeConfig parseFrom(InputStream input)
```
...
```
public static Instance.NodeConfig parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Instance.NodeConfig parseFrom(ByteBuffer data)
```
...
```
public static Instance.NodeConfig parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<Instance.NodeConfig> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[NodeConfig](/java/docs/reference/google-cloud-memcache/2.46.0/com.google.cloud.memcache.v1.Instance.NodeConfig)>`
...
```
public Instance.NodeConfig getDefaultInstanceForType()
```
...
```
public Parser<Instance.NodeConfig> getParserForType()
```
...
```
public Instance.NodeConfig.Builder newBuilderForType()
```
...
```
protected Instance.NodeConfig.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public Instance.NodeConfig.Builder toBuilder()
```
