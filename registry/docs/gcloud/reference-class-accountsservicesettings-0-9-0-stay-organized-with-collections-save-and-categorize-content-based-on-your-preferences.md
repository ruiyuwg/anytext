...
# Class AccountsServiceSettings (0.9.0) Stay organized with collections Save and categorize content based on your preferences.
...
Settings class to configure an instance of [AccountsServiceClient](/java/docs/reference/google-shopping-css/0.9.0/com.google.shopping.css.v1.AccountsServiceClient).
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [ClientSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.ClientSettings.html) \> AccountsServiceSettings
...
### create(AccountsServiceStubSettings stub)
...
`[AccountsServiceStubSettings](/java/docs/reference/google-shopping-css/0.9.0/com.google.shopping.css.v1.stub.AccountsServiceStubSettings)`  
...
`[AccountsServiceSettings](/java/docs/reference/google-shopping-css/0.9.0/com.google.shopping.css.v1.AccountsServiceSettings)`
...
```
public static AccountsServiceSettings.Builder newBuilder()
```
...
`[AccountsServiceSettings.Builder](/java/docs/reference/google-shopping-css/0.9.0/com.google.shopping.css.v1.AccountsServiceSettings.Builder)`

### newBuilder(ClientContext clientContext)

```
public static AccountsServiceSettings.Builder newBuilder(ClientContext clientContext)
```
...
```
public static AccountsServiceSettings.Builder newHttpJsonBuilder()
```
...
### AccountsServiceSettings(AccountsServiceSettings.Builder settingsBuilder)

```
protected AccountsServiceSettings(AccountsServiceSettings.Builder settingsBuilder)
```
...
`[UnaryCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.html)<[GetAccountRequest](/java/docs/reference/google-shopping-css/0.9.0/com.google.shopping.css.v1.GetAccountRequest),[Account](/java/docs/reference/google-shopping-css/0.9.0/com.google.shopping.css.v1.Account)>`
...
`[PagedCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PagedCallSettings.html)<[ListChildAccountsRequest](/java/docs/reference/google-shopping-css/0.9.0/com.google.shopping.css.v1.ListChildAccountsRequest),[ListChildAccountsResponse](/java/docs/reference/google-shopping-css/0.9.0/com.google.shopping.css.v1.ListChildAccountsResponse),[ListChildAccountsPagedResponse](/java/docs/reference/google-shopping-css/0.9.0/com.google.shopping.css.v1.AccountsServiceClient.ListChildAccountsPagedResponse)>`

### toBuilder()

```
public AccountsServiceSettings.Builder toBuilder()
```
...
`[UnaryCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.html)<[UpdateAccountLabelsRequest](/java/docs/reference/google-shopping-css/0.9.0/com.google.shopping.css.v1.UpdateAccountLabelsRequest),[Account](/java/docs/reference/google-shopping-css/0.9.0/com.google.shopping.css.v1.Account)>`
