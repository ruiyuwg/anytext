...
# Class HttpJsonIDSCallableFactory (1.36.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public class HttpJsonIDSCallableFactory implements HttpJsonStubCallableFactory<Operation,OperationsStub>
```
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> HttpJsonIDSCallableFactory
...
### HttpJsonIDSCallableFactory()

```
public HttpJsonIDSCallableFactory()
```
