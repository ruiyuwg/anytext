...
# Class TcpRoute (0.2.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class TcpRoute extends GeneratedMessageV3 implements TcpRouteOrBuilder
```

TcpRoute is the resource defining how TCP traffic should be routed by a Mesh/Gateway resource.

Protobuf type `google.cloud.networkservices.v1.TcpRoute`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> TcpRoute

## Implements

[TcpRouteOrBuilder](/java/docs/reference/google-cloud-networkservices/0.2.0/com.google.cloud.networkservices.v1.TcpRouteOrBuilder)
...
```
public static TcpRoute getDefaultInstance()
```
...
`[TcpRoute](/java/docs/reference/google-cloud-networkservices/0.2.0/com.google.cloud.networkservices.v1.TcpRoute)`
...
```
public static TcpRoute.Builder newBuilder()
```
...
`[TcpRoute.Builder](/java/docs/reference/google-cloud-networkservices/0.2.0/com.google.cloud.networkservices.v1.TcpRoute.Builder)`

### newBuilder(TcpRoute prototype)

```
public static TcpRoute.Builder newBuilder(TcpRoute prototype)
```
...
```
public static TcpRoute parseDelimitedFrom(InputStream input)
```
...
```
public static TcpRoute parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static TcpRoute parseFrom(byte[] data)
```
...
```
public static TcpRoute parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static TcpRoute parseFrom(ByteString data)
```
...
```
public static TcpRoute parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static TcpRoute parseFrom(CodedInputStream input)
```
...
```
public static TcpRoute parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static TcpRoute parseFrom(InputStream input)
```
...
```
public static TcpRoute parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static TcpRoute parseFrom(ByteBuffer data)
```
...
```
public static TcpRoute parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<TcpRoute> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[TcpRoute](/java/docs/reference/google-cloud-networkservices/0.2.0/com.google.cloud.networkservices.v1.TcpRoute)>`
...
Use [#getLabelsMap()](/java/docs/reference/google-cloud-networkservices/0.2.0/com.google.cloud.networkservices.v1.TcpRoute#com_google_cloud_networkservices_v1_TcpRoute_getLabelsMap__) instead.
...
```
public Parser<TcpRoute> getParserForType()
```
...
`[TcpRoute.RouteRule](/java/docs/reference/google-cloud-networkservices/0.2.0/com.google.cloud.networkservices.v1.TcpRoute.RouteRule)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[RouteRule](/java/docs/reference/google-cloud-networkservices/0.2.0/com.google.cloud.networkservices.v1.TcpRoute.RouteRule)>`
...
`[TcpRoute.RouteRuleOrBuilder](/java/docs/reference/google-cloud-networkservices/0.2.0/com.google.cloud.networkservices.v1.TcpRoute.RouteRuleOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.networkservices.v1.TcpRoute.RouteRuleOrBuilder>`
...
```
public TcpRoute.Builder newBuilderForType()
```
...
```
protected TcpRoute.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
