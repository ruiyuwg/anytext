...
# Interface DeleteSlateRequestOrBuilder (0.45.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface DeleteSlateRequestOrBuilder extends MessageOrBuilder
```
