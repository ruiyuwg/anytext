...
# Cloud AI Platform v1 API - Class PurgeExecutionsResponse (2.28.0) Stay organized with collections Save and categorize content based on your preferences.
...
[object](https://learn.microsoft.com/dotnet/api/system.object) \> PurgeExecutionsResponse

## Implements

[IMessage](https://cloud.google.com/dotnet/docs/reference/Google.Protobuf/latest/Google.Protobuf.IMessage-1.html)[PurgeExecutionsResponse](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/2.28.0/Google.Cloud.AIPlatform.V1.PurgeExecutionsResponse), [IEquatable](https://learn.microsoft.com/dotnet/api/system.iequatable-1)[PurgeExecutionsResponse](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/2.28.0/Google.Cloud.AIPlatform.V1.PurgeExecutionsResponse), [IDeepCloneable](https://cloud.google.com/dotnet/docs/reference/Google.Protobuf/latest/Google.Protobuf.IDeepCloneable-1.html)[PurgeExecutionsResponse](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/2.28.0/Google.Cloud.AIPlatform.V1.PurgeExecutionsResponse), [IBufferMessage](https://cloud.google.com/dotnet/docs/reference/Google.Protobuf/latest/Google.Protobuf.IBufferMessage.html), [IMessage](https://cloud.google.com/dotnet/docs/reference/Google.Protobuf/latest/Google.Protobuf.IMessage.html)
...
`[PurgeExecutionsResponse](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/2.28.0/Google.Cloud.AIPlatform.V1.PurgeExecutionsResponse)`  
...
[ExecutionName](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/2.28.0/Google.Cloud.AIPlatform.V1.ExecutionName)\-typed view over the [PurgeSample](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/2.28.0/Google.Cloud.AIPlatform.V1.PurgeExecutionsResponse#Google_Cloud_AIPlatform_V1_PurgeExecutionsResponse_PurgeSample) resource name property.
...
`[ResourceNameList](https://github.com/googleapis/gax-dotnet/blob/83f42b5edc4529818dbdb34d9ea9ecc3c04f7b6e/Google.Api.Gax/ResourceNameList.cs)[ExecutionName](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/2.28.0/Google.Cloud.AIPlatform.V1.ExecutionName)`
