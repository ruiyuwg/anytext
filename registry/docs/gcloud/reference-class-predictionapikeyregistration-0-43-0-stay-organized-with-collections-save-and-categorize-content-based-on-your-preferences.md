...
# Class PredictionApiKeyRegistration (0.43.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class PredictionApiKeyRegistration extends GeneratedMessageV3 implements PredictionApiKeyRegistrationOrBuilder
```
...
```
public static PredictionApiKeyRegistration getDefaultInstance()
```
...
```
public static PredictionApiKeyRegistration.Builder newBuilder()
```
...
`[PredictionApiKeyRegistration.Builder](/java/docs/reference/google-cloud-recommendations-ai/0.43.0/com.google.cloud.recommendationengine.v1beta1.PredictionApiKeyRegistration.Builder)`

### newBuilder(PredictionApiKeyRegistration prototype)

```
public static PredictionApiKeyRegistration.Builder newBuilder(PredictionApiKeyRegistration prototype)
```
...
```
public static PredictionApiKeyRegistration parseDelimitedFrom(InputStream input)
```
...
```
public static PredictionApiKeyRegistration parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PredictionApiKeyRegistration parseFrom(byte[] data)
```
...
```
public static PredictionApiKeyRegistration parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PredictionApiKeyRegistration parseFrom(ByteString data)
```
...
```
public static PredictionApiKeyRegistration parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PredictionApiKeyRegistration parseFrom(CodedInputStream input)
```
...
```
public static PredictionApiKeyRegistration parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PredictionApiKeyRegistration parseFrom(InputStream input)
```
...
```
public static PredictionApiKeyRegistration parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PredictionApiKeyRegistration parseFrom(ByteBuffer data)
```
...
```
public static PredictionApiKeyRegistration parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<PredictionApiKeyRegistration> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[PredictionApiKeyRegistration](/java/docs/reference/google-cloud-recommendations-ai/0.43.0/com.google.cloud.recommendationengine.v1beta1.PredictionApiKeyRegistration)>`
...
```
public Parser<PredictionApiKeyRegistration> getParserForType()
```
...
```
public PredictionApiKeyRegistration.Builder newBuilderForType()
```
...
```
protected PredictionApiKeyRegistration.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public PredictionApiKeyRegistration.Builder toBuilder()
```
