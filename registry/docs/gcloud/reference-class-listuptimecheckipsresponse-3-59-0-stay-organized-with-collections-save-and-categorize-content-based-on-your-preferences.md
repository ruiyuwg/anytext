...
# Class ListUptimeCheckIpsResponse (3.59.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListUptimeCheckIpsResponse extends GeneratedMessageV3 implements ListUptimeCheckIpsResponseOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListUptimeCheckIpsResponse

## Implements

[ListUptimeCheckIpsResponseOrBuilder](/java/docs/reference/google-cloud-monitoring/3.59.0/com.google.monitoring.v3.ListUptimeCheckIpsResponseOrBuilder)
...
### UPTIME\_CHECK\_IPS\_FIELD\_NUMBER

```
public static final int UPTIME_CHECK_IPS_FIELD_NUMBER
```
...
```
public static ListUptimeCheckIpsResponse getDefaultInstance()
```
...
`[ListUptimeCheckIpsResponse](/java/docs/reference/google-cloud-monitoring/3.59.0/com.google.monitoring.v3.ListUptimeCheckIpsResponse)`
...
```
public static ListUptimeCheckIpsResponse.Builder newBuilder()
```
...
`[ListUptimeCheckIpsResponse.Builder](/java/docs/reference/google-cloud-monitoring/3.59.0/com.google.monitoring.v3.ListUptimeCheckIpsResponse.Builder)`

### newBuilder(ListUptimeCheckIpsResponse prototype)

```
public static ListUptimeCheckIpsResponse.Builder newBuilder(ListUptimeCheckIpsResponse prototype)
```
...
```
public static ListUptimeCheckIpsResponse parseDelimitedFrom(InputStream input)
```
...
```
public static ListUptimeCheckIpsResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListUptimeCheckIpsResponse parseFrom(byte[] data)
```
...
```
public static ListUptimeCheckIpsResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListUptimeCheckIpsResponse parseFrom(ByteString data)
```
...
```
public static ListUptimeCheckIpsResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListUptimeCheckIpsResponse parseFrom(CodedInputStream input)
```
...
```
public static ListUptimeCheckIpsResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListUptimeCheckIpsResponse parseFrom(InputStream input)
```
...
```
public static ListUptimeCheckIpsResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListUptimeCheckIpsResponse parseFrom(ByteBuffer data)
```
...
```
public static ListUptimeCheckIpsResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ListUptimeCheckIpsResponse> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListUptimeCheckIpsResponse](/java/docs/reference/google-cloud-monitoring/3.59.0/com.google.monitoring.v3.ListUptimeCheckIpsResponse)>`
...
```
public Parser<ListUptimeCheckIpsResponse> getParserForType()
```
...
`[UptimeCheckIp](/java/docs/reference/google-cloud-monitoring/3.59.0/com.google.monitoring.v3.UptimeCheckIp)`
...
```
public List<UptimeCheckIp> getUptimeCheckIpsList()
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[UptimeCheckIp](/java/docs/reference/google-cloud-monitoring/3.59.0/com.google.monitoring.v3.UptimeCheckIp)>`
...
`[UptimeCheckIpOrBuilder](/java/docs/reference/google-cloud-monitoring/3.59.0/com.google.monitoring.v3.UptimeCheckIpOrBuilder)`

### getUptimeCheckIpsOrBuilderList()

```
public List<? extends UptimeCheckIpOrBuilder> getUptimeCheckIpsOrBuilderList()
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.monitoring.v3.UptimeCheckIpOrBuilder>`
...
```
public ListUptimeCheckIpsResponse.Builder newBuilderForType()
```
...
```
protected ListUptimeCheckIpsResponse.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ListUptimeCheckIpsResponse.Builder toBuilder()
```
