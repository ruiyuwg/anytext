...
# Enum ReplayResult.ResultCase (0.9.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum ReplayResult.ResultCase extends Enum<ReplayResult.ResultCase> implements Internal.EnumLite, AbstractMessageLite.InternalOneOfEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-policysimulator/0.9.0/com.google.cloud.policysimulator.v1.ReplayResult.ResultCase#com_google_cloud_policysimulator_v1_ReplayResult_ResultCase_forNumber_int_) instead._
