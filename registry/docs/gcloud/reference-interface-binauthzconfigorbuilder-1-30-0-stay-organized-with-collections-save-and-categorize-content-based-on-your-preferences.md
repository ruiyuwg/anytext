...
# Interface BinauthzConfigOrBuilder (1.30.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface BinauthzConfigOrBuilder extends MessageOrBuilder
```
