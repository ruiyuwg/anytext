...
# Class ImageAnnotationContext (3.46.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ImageAnnotationContext extends GeneratedMessageV3 implements ImageAnnotationContextOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ImageAnnotationContext

## Implements

[ImageAnnotationContextOrBuilder](/java/docs/reference/google-cloud-vision/3.46.0/com.google.cloud.vision.v1p2beta1.ImageAnnotationContextOrBuilder)
...
```
public static ImageAnnotationContext getDefaultInstance()
```
...
`[ImageAnnotationContext](/java/docs/reference/google-cloud-vision/3.46.0/com.google.cloud.vision.v1p2beta1.ImageAnnotationContext)`
...
```
public static ImageAnnotationContext.Builder newBuilder()
```
...
`[ImageAnnotationContext.Builder](/java/docs/reference/google-cloud-vision/3.46.0/com.google.cloud.vision.v1p2beta1.ImageAnnotationContext.Builder)`

### newBuilder(ImageAnnotationContext prototype)

```
public static ImageAnnotationContext.Builder newBuilder(ImageAnnotationContext prototype)
```
...
```
public static ImageAnnotationContext parseDelimitedFrom(InputStream input)
```
...
```
public static ImageAnnotationContext parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ImageAnnotationContext parseFrom(byte[] data)
```
...
```
public static ImageAnnotationContext parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ImageAnnotationContext parseFrom(ByteString data)
```
...
```
public static ImageAnnotationContext parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ImageAnnotationContext parseFrom(CodedInputStream input)
```
...
```
public static ImageAnnotationContext parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ImageAnnotationContext parseFrom(InputStream input)
```
...
```
public static ImageAnnotationContext parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ImageAnnotationContext parseFrom(ByteBuffer data)
```
...
```
public static ImageAnnotationContext parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ImageAnnotationContext> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ImageAnnotationContext](/java/docs/reference/google-cloud-vision/3.46.0/com.google.cloud.vision.v1p2beta1.ImageAnnotationContext)>`
...
```
public Parser<ImageAnnotationContext> getParserForType()
```
...
```
public ImageAnnotationContext.Builder newBuilderForType()
```
...
```
protected ImageAnnotationContext.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ImageAnnotationContext.Builder toBuilder()
```
