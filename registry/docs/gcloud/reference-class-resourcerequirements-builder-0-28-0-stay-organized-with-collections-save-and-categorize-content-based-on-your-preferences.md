...
# Class ResourceRequirements.Builder (0.28.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> ResourceRequirements.Builder

## Implements

[ResourceRequirementsOrBuilder](/java/docs/reference/google-cloud-run/0.28.0/com.google.cloud.run.v2.ResourceRequirementsOrBuilder)
...
`[ResourceRequirements.Builder](/java/docs/reference/google-cloud-run/0.28.0/com.google.cloud.run.v2.ResourceRequirements.Builder)`
...
`[ResourceRequirements](/java/docs/reference/google-cloud-run/0.28.0/com.google.cloud.run.v2.ResourceRequirements)`
...
-   The only supported values for CPU are '1', '2', '4', and '8'. Setting 4 CPU requires at least 2Gi of memory. For more information, go to [https://cloud.google.com/run/docs/configuring/cpu](https://cloud.google.com/run/docs/configuring/cpu).
    -   For supported 'memory' values and syntax, go to [https://cloud.google.com/run/docs/configuring/memory-limits](https://cloud.google.com/run/docs/configuring/memory-limits)
...
Use [#getLimitsMap()](/java/docs/reference/google-cloud-run/0.28.0/com.google.cloud.run.v2.ResourceRequirements.Builder#com_google_cloud_run_v2_ResourceRequirements_Builder_getLimitsMap__) instead.
