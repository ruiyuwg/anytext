...
# Class ListReplicationsRequest (0.23.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListReplicationsRequest extends GeneratedMessageV3 implements ListReplicationsRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListReplicationsRequest

## Implements

[ListReplicationsRequestOrBuilder](/java/docs/reference/google-cloud-netapp/0.23.0/com.google.cloud.netapp.v1.ListReplicationsRequestOrBuilder)
...
```
public static ListReplicationsRequest getDefaultInstance()
```
...
`[ListReplicationsRequest](/java/docs/reference/google-cloud-netapp/0.23.0/com.google.cloud.netapp.v1.ListReplicationsRequest)`
...
```
public static ListReplicationsRequest.Builder newBuilder()
```
...
`[ListReplicationsRequest.Builder](/java/docs/reference/google-cloud-netapp/0.23.0/com.google.cloud.netapp.v1.ListReplicationsRequest.Builder)`

### newBuilder(ListReplicationsRequest prototype)

```
public static ListReplicationsRequest.Builder newBuilder(ListReplicationsRequest prototype)
```
...
```
public static ListReplicationsRequest parseDelimitedFrom(InputStream input)
```
...
```
public static ListReplicationsRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListReplicationsRequest parseFrom(byte[] data)
```
...
```
public static ListReplicationsRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListReplicationsRequest parseFrom(ByteString data)
```
...
```
public static ListReplicationsRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListReplicationsRequest parseFrom(CodedInputStream input)
```
...
```
public static ListReplicationsRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListReplicationsRequest parseFrom(InputStream input)
```
...
```
public static ListReplicationsRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListReplicationsRequest parseFrom(ByteBuffer data)
```
...
```
public static ListReplicationsRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ListReplicationsRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListReplicationsRequest](/java/docs/reference/google-cloud-netapp/0.23.0/com.google.cloud.netapp.v1.ListReplicationsRequest)>`
...
```
public ListReplicationsRequest getDefaultInstanceForType()
```
...
The next\_page\_token value to use if there are additional results to retrieve for this list request.
...
```
public Parser<ListReplicationsRequest> getParserForType()
```
...
```
public ListReplicationsRequest.Builder newBuilderForType()
```
...
```
protected ListReplicationsRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ListReplicationsRequest.Builder toBuilder()
```
