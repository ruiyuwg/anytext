...
# Interface FaceSegmentOrBuilder (2.47.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface FaceSegmentOrBuilder extends MessageOrBuilder
```
...
`[VideoSegment](/java/docs/reference/google-cloud-video-intelligence/2.47.0/com.google.cloud.videointelligence.v1beta2.VideoSegment)`
...
`[VideoSegmentOrBuilder](/java/docs/reference/google-cloud-video-intelligence/2.47.0/com.google.cloud.videointelligence.v1beta2.VideoSegmentOrBuilder)`
