...
# Class UpdateTlsRouteRequest.Builder (0.9.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> UpdateTlsRouteRequest.Builder

## Implements

[UpdateTlsRouteRequestOrBuilder](/java/docs/reference/google-cloud-networkservices/0.9.0/com.google.cloud.networkservices.v1.UpdateTlsRouteRequestOrBuilder)
...
`[UpdateTlsRouteRequest.Builder](/java/docs/reference/google-cloud-networkservices/0.9.0/com.google.cloud.networkservices.v1.UpdateTlsRouteRequest.Builder)`
...
`[UpdateTlsRouteRequest](/java/docs/reference/google-cloud-networkservices/0.9.0/com.google.cloud.networkservices.v1.UpdateTlsRouteRequest)`
...
Optional. Field mask is used to specify the fields to be overwritten in the TlsRoute resource by the update. The fields specified in the update\_mask are relative to the resource, not the full request. A field will be overwritten if it is in the mask. If the user does not provide a mask then all fields will be overwritten.
...
`[TlsRoute](/java/docs/reference/google-cloud-networkservices/0.9.0/com.google.cloud.networkservices.v1.TlsRoute)`
...
`[TlsRoute.Builder](/java/docs/reference/google-cloud-networkservices/0.9.0/com.google.cloud.networkservices.v1.TlsRoute.Builder)`
...
`[TlsRouteOrBuilder](/java/docs/reference/google-cloud-networkservices/0.9.0/com.google.cloud.networkservices.v1.TlsRouteOrBuilder)`
