...
# Class DeleteAnalysisRequest (0.13.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class DeleteAnalysisRequest extends GeneratedMessageV3 implements DeleteAnalysisRequestOrBuilder
```

Message for deleting an Analysis.

Protobuf type `google.cloud.visionai.v1.DeleteAnalysisRequest`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> DeleteAnalysisRequest

## Implements

[DeleteAnalysisRequestOrBuilder](/java/docs/reference/google-cloud-visionai/0.13.0/com.google.cloud.visionai.v1.DeleteAnalysisRequestOrBuilder)
...
```
public static DeleteAnalysisRequest getDefaultInstance()
```
...
`[DeleteAnalysisRequest](/java/docs/reference/google-cloud-visionai/0.13.0/com.google.cloud.visionai.v1.DeleteAnalysisRequest)`
...
```
public static DeleteAnalysisRequest.Builder newBuilder()
```
...
`[DeleteAnalysisRequest.Builder](/java/docs/reference/google-cloud-visionai/0.13.0/com.google.cloud.visionai.v1.DeleteAnalysisRequest.Builder)`

### newBuilder(DeleteAnalysisRequest prototype)

```
public static DeleteAnalysisRequest.Builder newBuilder(DeleteAnalysisRequest prototype)
```
...
```
public static DeleteAnalysisRequest parseDelimitedFrom(InputStream input)
```
...
```
public static DeleteAnalysisRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteAnalysisRequest parseFrom(byte[] data)
```
...
```
public static DeleteAnalysisRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteAnalysisRequest parseFrom(ByteString data)
```
...
```
public static DeleteAnalysisRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteAnalysisRequest parseFrom(CodedInputStream input)
```
...
```
public static DeleteAnalysisRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteAnalysisRequest parseFrom(InputStream input)
```
...
```
public static DeleteAnalysisRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteAnalysisRequest parseFrom(ByteBuffer data)
```
...
```
public static DeleteAnalysisRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<DeleteAnalysisRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[DeleteAnalysisRequest](/java/docs/reference/google-cloud-visionai/0.13.0/com.google.cloud.visionai.v1.DeleteAnalysisRequest)>`
...
```
public DeleteAnalysisRequest getDefaultInstanceForType()
```
...
```
public Parser<DeleteAnalysisRequest> getParserForType()
```
...
```
public DeleteAnalysisRequest.Builder newBuilderForType()
```
...
```
protected DeleteAnalysisRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public DeleteAnalysisRequest.Builder toBuilder()
```
