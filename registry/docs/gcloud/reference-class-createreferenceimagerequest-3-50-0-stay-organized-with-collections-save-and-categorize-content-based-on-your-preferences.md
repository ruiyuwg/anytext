...
# Class CreateReferenceImageRequest (3.50.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class CreateReferenceImageRequest extends GeneratedMessageV3 implements CreateReferenceImageRequestOrBuilder
```

Request message for the `CreateReferenceImage` method.

Protobuf type `google.cloud.vision.v1p4beta1.CreateReferenceImageRequest`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> CreateReferenceImageRequest

## Implements

[CreateReferenceImageRequestOrBuilder](/java/docs/reference/google-cloud-vision/3.50.0/com.google.cloud.vision.v1p4beta1.CreateReferenceImageRequestOrBuilder)
...
### REFERENCE\_IMAGE\_FIELD\_NUMBER

```
public static final int REFERENCE_IMAGE_FIELD_NUMBER
```
...
### REFERENCE\_IMAGE\_ID\_FIELD\_NUMBER

```
public static final int REFERENCE_IMAGE_ID_FIELD_NUMBER
```
...
```
public static CreateReferenceImageRequest getDefaultInstance()
```
...
`[CreateReferenceImageRequest](/java/docs/reference/google-cloud-vision/3.50.0/com.google.cloud.vision.v1p4beta1.CreateReferenceImageRequest)`
...
```
public static CreateReferenceImageRequest.Builder newBuilder()
```
...
`[CreateReferenceImageRequest.Builder](/java/docs/reference/google-cloud-vision/3.50.0/com.google.cloud.vision.v1p4beta1.CreateReferenceImageRequest.Builder)`

### newBuilder(CreateReferenceImageRequest prototype)

```
public static CreateReferenceImageRequest.Builder newBuilder(CreateReferenceImageRequest prototype)
```
...
```
public static CreateReferenceImageRequest parseDelimitedFrom(InputStream input)
```
...
```
public static CreateReferenceImageRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateReferenceImageRequest parseFrom(byte[] data)
```
...
```
public static CreateReferenceImageRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateReferenceImageRequest parseFrom(ByteString data)
```
...
```
public static CreateReferenceImageRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateReferenceImageRequest parseFrom(CodedInputStream input)
```
...
```
public static CreateReferenceImageRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateReferenceImageRequest parseFrom(InputStream input)
```
...
```
public static CreateReferenceImageRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateReferenceImageRequest parseFrom(ByteBuffer data)
```
...
```
public static CreateReferenceImageRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<CreateReferenceImageRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[CreateReferenceImageRequest](/java/docs/reference/google-cloud-vision/3.50.0/com.google.cloud.vision.v1p4beta1.CreateReferenceImageRequest)>`
...
```
public Parser<CreateReferenceImageRequest> getParserForType()
```
...
`[ReferenceImage](/java/docs/reference/google-cloud-vision/3.50.0/com.google.cloud.vision.v1p4beta1.ReferenceImage)`
...
`[ReferenceImageOrBuilder](/java/docs/reference/google-cloud-vision/3.50.0/com.google.cloud.vision.v1p4beta1.ReferenceImageOrBuilder)`
...
```
public CreateReferenceImageRequest.Builder newBuilderForType()
```
...
```
protected CreateReferenceImageRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public CreateReferenceImageRequest.Builder toBuilder()
```
