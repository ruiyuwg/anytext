...
# Class ControlServiceClient.ListControlsFixedSizeCollection (2.56.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class ControlServiceClient.ListControlsFixedSizeCollection extends AbstractFixedSizeCollection<ListControlsRequest,ListControlsResponse,Control,ControlServiceClient.ListControlsPage,ControlServiceClient.ListControlsFixedSizeCollection>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractFixedSizeCollection](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractFixedSizeCollection.html) \> ControlServiceClient.ListControlsFixedSizeCollection
...
### createCollection(List<ControlServiceClient.ListControlsPage> pages, int collectionSize)

```
protected ControlServiceClient.ListControlsFixedSizeCollection createCollection(List<ControlServiceClient.ListControlsPage> pages, int collectionSize)
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ListControlsPage](/java/docs/reference/google-cloud-retail/2.56.0/com.google.cloud.retail.v2.ControlServiceClient.ListControlsPage)>`  
...
`[ControlServiceClient.ListControlsFixedSizeCollection](/java/docs/reference/google-cloud-retail/2.56.0/com.google.cloud.retail.v2.ControlServiceClient.ListControlsFixedSizeCollection)`
