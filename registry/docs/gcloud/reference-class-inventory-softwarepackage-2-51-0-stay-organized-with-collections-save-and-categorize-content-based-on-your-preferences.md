...
# Class Inventory.SoftwarePackage (2.51.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> Inventory.SoftwarePackage

## Implements

[Inventory.SoftwarePackageOrBuilder](/java/docs/reference/google-cloud-os-config/2.51.0/com.google.cloud.osconfig.v1.Inventory.SoftwarePackageOrBuilder)
...
### GOOGET\_PACKAGE\_FIELD\_NUMBER
...
### WINDOWS\_APPLICATION\_FIELD\_NUMBER
...
### ZYPPER\_PACKAGE\_FIELD\_NUMBER
...
`[Inventory.SoftwarePackage](/java/docs/reference/google-cloud-os-config/2.51.0/com.google.cloud.osconfig.v1.Inventory.SoftwarePackage)`
...
`[Inventory.SoftwarePackage.Builder](/java/docs/reference/google-cloud-os-config/2.51.0/com.google.cloud.osconfig.v1.Inventory.SoftwarePackage.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[SoftwarePackage](/java/docs/reference/google-cloud-os-config/2.51.0/com.google.cloud.osconfig.v1.Inventory.SoftwarePackage)>`
...
Details of an APT package. For details about the apt package manager, see [https://wiki.debian.org/Apt](https://wiki.debian.org/Apt).
...
`[Inventory.VersionedPackage](/java/docs/reference/google-cloud-os-config/2.51.0/com.google.cloud.osconfig.v1.Inventory.VersionedPackage)`
...
`[Inventory.VersionedPackageOrBuilder](/java/docs/reference/google-cloud-os-config/2.51.0/com.google.cloud.osconfig.v1.Inventory.VersionedPackageOrBuilder)`
...
`[Inventory.SoftwarePackage.DetailsCase](/java/docs/reference/google-cloud-os-config/2.51.0/com.google.cloud.osconfig.v1.Inventory.SoftwarePackage.DetailsCase)`
...
Details of a Googet package. For details about the googet package manager, see [https://github.com/google/googet](https://github.com/google/googet).
...
Details of a Windows Quick Fix engineering package. See [https://docs.microsoft.com/en-us/windows/win32/cimwin32prov/win32-quickfixengineering](https://docs.microsoft.com/en-us/windows/win32/cimwin32prov/win32-quickfixengineering) for info in Windows Quick Fix Engineering.
...
`[Inventory.WindowsQuickFixEngineeringPackage](/java/docs/reference/google-cloud-os-config/2.51.0/com.google.cloud.osconfig.v1.Inventory.WindowsQuickFixEngineeringPackage)`
...
`[Inventory.WindowsQuickFixEngineeringPackageOrBuilder](/java/docs/reference/google-cloud-os-config/2.51.0/com.google.cloud.osconfig.v1.Inventory.WindowsQuickFixEngineeringPackageOrBuilder)`
...
`[Inventory.WindowsApplication](/java/docs/reference/google-cloud-os-config/2.51.0/com.google.cloud.osconfig.v1.Inventory.WindowsApplication)`
...
`[Inventory.WindowsApplicationOrBuilder](/java/docs/reference/google-cloud-os-config/2.51.0/com.google.cloud.osconfig.v1.Inventory.WindowsApplicationOrBuilder)`
...
Details of a Windows Update package. See [https://docs.microsoft.com/en-us/windows/win32/api/\_wua/](https://docs.microsoft.com/en-us/windows/win32/api/_wua/) for information about Windows Update.
...
`[Inventory.WindowsUpdatePackage](/java/docs/reference/google-cloud-os-config/2.51.0/com.google.cloud.osconfig.v1.Inventory.WindowsUpdatePackage)`
...
`[Inventory.WindowsUpdatePackageOrBuilder](/java/docs/reference/google-cloud-os-config/2.51.0/com.google.cloud.osconfig.v1.Inventory.WindowsUpdatePackageOrBuilder)`
...
Yum package info. For details about the yum package manager, see [https://access.redhat.com/documentation/en-us/red\_hat\_enterprise\_linux/6/html/deployment\_guide/ch-yum](https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/6/html/deployment_guide/ch-yum).
...
Details of a Zypper package. For details about the Zypper package manager, see [https://en.opensuse.org/SDB:Zypper\_manual](https://en.opensuse.org/SDB:Zypper_manual).
...
Details of a Zypper patch. For details about the Zypper package manager, see [https://en.opensuse.org/SDB:Zypper\_manual](https://en.opensuse.org/SDB:Zypper_manual).
...
`[Inventory.ZypperPatch](/java/docs/reference/google-cloud-os-config/2.51.0/com.google.cloud.osconfig.v1.Inventory.ZypperPatch)`
...
`[Inventory.ZypperPatchOrBuilder](/java/docs/reference/google-cloud-os-config/2.51.0/com.google.cloud.osconfig.v1.Inventory.ZypperPatchOrBuilder)`
