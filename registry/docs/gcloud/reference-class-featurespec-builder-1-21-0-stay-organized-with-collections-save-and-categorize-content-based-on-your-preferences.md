...
# Class FeatureSpec.Builder (1.21.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> FeatureSpec.Builder

## Implements

[FeatureSpecOrBuilder](/java/docs/reference/google-cloud-gkehub/1.21.0/com.google.cloud.gkehub.multiclusteringress.v1alpha.FeatureSpecOrBuilder)
...
`[FeatureSpec.Builder](/java/docs/reference/google-cloud-gkehub/1.21.0/com.google.cloud.gkehub.multiclusteringress.v1alpha.FeatureSpec.Builder)`
...
`[FeatureSpec](/java/docs/reference/google-cloud-gkehub/1.21.0/com.google.cloud.gkehub.multiclusteringress.v1alpha.FeatureSpec)`
...
```
public FeatureSpec.Builder clearBilling()
```
...
```
public FeatureSpec.Builder clearConfigMembership()
```
...
`[Billing](/java/docs/reference/google-cloud-gkehub/1.21.0/com.google.cloud.gkehub.multiclusteringress.v1alpha.Billing)`
...
```
public ByteString getConfigMembershipBytes()
```
...
```
public FeatureSpec.Builder setBilling(Billing value)
```
...
```
public FeatureSpec.Builder setBillingValue(int value)
```
...
The enum numeric value on the wire for billing to set.
...
```
public FeatureSpec.Builder setConfigMembership(String value)
```
...
```
public FeatureSpec.Builder setConfigMembershipBytes(ByteString value)
```
...
The bytes for configMembership to set.
