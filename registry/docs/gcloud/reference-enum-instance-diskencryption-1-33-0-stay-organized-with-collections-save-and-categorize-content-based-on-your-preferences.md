...
# Enum Instance.DiskEncryption (1.33.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-notebooks/1.33.0/com.google.cloud.notebooks.v1.Instance.DiskEncryption#com_google_cloud_notebooks_v1_Instance_DiskEncryption_forNumber_int_) instead._
