...
# Class Grant.Timeline.Event.Ended (0.10.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class Grant.Timeline.Event.Ended extends GeneratedMessageV3 implements Grant.Timeline.Event.EndedOrBuilder
```

An event representing that the grant has ended.

Protobuf type `google.cloud.privilegedaccessmanager.v1.Grant.Timeline.Event.Ended`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> Grant.Timeline.Event.Ended

## Implements

[Grant.Timeline.Event.EndedOrBuilder](/java/docs/reference/google-cloud-privilegedaccessmanager/0.10.0/com.google.cloud.privilegedaccessmanager.v1.Grant.Timeline.Event.EndedOrBuilder)
...
```
public static Grant.Timeline.Event.Ended getDefaultInstance()
```
...
`[Grant.Timeline.Event.Ended](/java/docs/reference/google-cloud-privilegedaccessmanager/0.10.0/com.google.cloud.privilegedaccessmanager.v1.Grant.Timeline.Event.Ended)`
...
```
public static Grant.Timeline.Event.Ended.Builder newBuilder()
```
...
`[Grant.Timeline.Event.Ended.Builder](/java/docs/reference/google-cloud-privilegedaccessmanager/0.10.0/com.google.cloud.privilegedaccessmanager.v1.Grant.Timeline.Event.Ended.Builder)`

### newBuilder(Grant.Timeline.Event.Ended prototype)

```
public static Grant.Timeline.Event.Ended.Builder newBuilder(Grant.Timeline.Event.Ended prototype)
```
...
```
public static Grant.Timeline.Event.Ended parseDelimitedFrom(InputStream input)
```
...
```
public static Grant.Timeline.Event.Ended parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Grant.Timeline.Event.Ended parseFrom(byte[] data)
```
...
```
public static Grant.Timeline.Event.Ended parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Grant.Timeline.Event.Ended parseFrom(ByteString data)
```
...
```
public static Grant.Timeline.Event.Ended parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Grant.Timeline.Event.Ended parseFrom(CodedInputStream input)
```
...
```
public static Grant.Timeline.Event.Ended parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Grant.Timeline.Event.Ended parseFrom(InputStream input)
```
...
```
public static Grant.Timeline.Event.Ended parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Grant.Timeline.Event.Ended parseFrom(ByteBuffer data)
```
...
```
public static Grant.Timeline.Event.Ended parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<Grant.Timeline.Event.Ended> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[Ended](/java/docs/reference/google-cloud-privilegedaccessmanager/0.10.0/com.google.cloud.privilegedaccessmanager.v1.Grant.Timeline.Event.Ended)>`
...
```
public Grant.Timeline.Event.Ended getDefaultInstanceForType()
```
...
```
public Parser<Grant.Timeline.Event.Ended> getParserForType()
```
...
```
public Grant.Timeline.Event.Ended.Builder newBuilderForType()
```
...
```
protected Grant.Timeline.Event.Ended.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public Grant.Timeline.Event.Ended.Builder toBuilder()
```
