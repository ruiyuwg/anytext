...
# Interface CreateScheduleRequestOrBuilder (1.85.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[Schedule](/java/docs/reference/google-cloud-notebooks/latest/com.google.cloud.notebooks.v1.Schedule)`
...
`[ScheduleOrBuilder](/java/docs/reference/google-cloud-notebooks/latest/com.google.cloud.notebooks.v1.ScheduleOrBuilder)`
