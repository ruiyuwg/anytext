...
# Class SynthesizeSpeechRequest (2.8.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> SynthesizeSpeechRequest

## Implements

[SynthesizeSpeechRequestOrBuilder](/java/docs/reference/google-cloud-texttospeech/2.8.0/com.google.cloud.texttospeech.v1beta1.SynthesizeSpeechRequestOrBuilder)
...
### ENABLE\_TIME\_POINTING\_FIELD\_NUMBER

```
public static final int ENABLE_TIME_POINTING_FIELD_NUMBER
```
...
[SynthesizeSpeechRequest](/java/docs/reference/google-cloud-texttospeech/2.8.0/com.google.cloud.texttospeech.v1beta1.SynthesizeSpeechRequest)
...
```
public static SynthesizeSpeechRequest.Builder newBuilder()
```
...
[SynthesizeSpeechRequest.Builder](/java/docs/reference/google-cloud-texttospeech/2.8.0/com.google.cloud.texttospeech.v1beta1.SynthesizeSpeechRequest.Builder)

### newBuilder(SynthesizeSpeechRequest prototype)
...
```
public static SynthesizeSpeechRequest parseDelimitedFrom(InputStream input)
```
...
```
public static SynthesizeSpeechRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SynthesizeSpeechRequest parseFrom(byte[] data)
```
...
```
public static SynthesizeSpeechRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SynthesizeSpeechRequest parseFrom(ByteString data)
```
...
```
public static SynthesizeSpeechRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SynthesizeSpeechRequest parseFrom(CodedInputStream input)
```
...
```
public static SynthesizeSpeechRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SynthesizeSpeechRequest parseFrom(InputStream input)
```
...
```
public static SynthesizeSpeechRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SynthesizeSpeechRequest parseFrom(ByteBuffer data)
```
...
```
public static SynthesizeSpeechRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[SynthesizeSpeechRequest](/java/docs/reference/google-cloud-texttospeech/2.8.0/com.google.cloud.texttospeech.v1beta1.SynthesizeSpeechRequest)\>
...
[AudioConfig](/java/docs/reference/google-cloud-texttospeech/2.8.0/com.google.cloud.texttospeech.v1beta1.AudioConfig)
...
[AudioConfigOrBuilder](/java/docs/reference/google-cloud-texttospeech/2.8.0/com.google.cloud.texttospeech.v1beta1.AudioConfigOrBuilder)
...
[SynthesizeSpeechRequest.TimepointType](/java/docs/reference/google-cloud-texttospeech/2.8.0/com.google.cloud.texttospeech.v1beta1.SynthesizeSpeechRequest.TimepointType)
...
[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[TimepointType](/java/docs/reference/google-cloud-texttospeech/2.8.0/com.google.cloud.texttospeech.v1beta1.SynthesizeSpeechRequest.TimepointType)\>
...
[SynthesisInput](/java/docs/reference/google-cloud-texttospeech/2.8.0/com.google.cloud.texttospeech.v1beta1.SynthesisInput)
...
[SynthesisInputOrBuilder](/java/docs/reference/google-cloud-texttospeech/2.8.0/com.google.cloud.texttospeech.v1beta1.SynthesisInputOrBuilder)
...
[VoiceSelectionParams](/java/docs/reference/google-cloud-texttospeech/2.8.0/com.google.cloud.texttospeech.v1beta1.VoiceSelectionParams)
...
[VoiceSelectionParamsOrBuilder](/java/docs/reference/google-cloud-texttospeech/2.8.0/com.google.cloud.texttospeech.v1beta1.VoiceSelectionParamsOrBuilder)
...
```
public SynthesizeSpeechRequest.Builder newBuilderForType()
```
...
```
protected SynthesizeSpeechRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
