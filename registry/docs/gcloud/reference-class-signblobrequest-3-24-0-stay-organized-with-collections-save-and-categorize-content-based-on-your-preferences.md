...
# Class SignBlobRequest (3.24.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class SignBlobRequest extends GeneratedMessageV3 implements SignBlobRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> SignBlobRequest

## Implements

[SignBlobRequestOrBuilder](/java/docs/reference/google-iam-admin/3.24.0/com.google.iam.admin.v1.SignBlobRequestOrBuilder)
...
### BYTES\_TO\_SIGN\_FIELD\_NUMBER

```
public static final int BYTES_TO_SIGN_FIELD_NUMBER
```
...
```
public static SignBlobRequest getDefaultInstance()
```
...
`[SignBlobRequest](/java/docs/reference/google-iam-admin/3.24.0/com.google.iam.admin.v1.SignBlobRequest)`
...
```
public static SignBlobRequest.Builder newBuilder()
```
...
`[SignBlobRequest.Builder](/java/docs/reference/google-iam-admin/3.24.0/com.google.iam.admin.v1.SignBlobRequest.Builder)`

### newBuilder(SignBlobRequest prototype)

```
public static SignBlobRequest.Builder newBuilder(SignBlobRequest prototype)
```
...
```
public static SignBlobRequest parseDelimitedFrom(InputStream input)
```
...
```
public static SignBlobRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SignBlobRequest parseFrom(byte[] data)
```
...
```
public static SignBlobRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SignBlobRequest parseFrom(ByteString data)
```
...
```
public static SignBlobRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SignBlobRequest parseFrom(CodedInputStream input)
```
...
```
public static SignBlobRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SignBlobRequest parseFrom(InputStream input)
```
...
```
public static SignBlobRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SignBlobRequest parseFrom(ByteBuffer data)
```
...
```
public static SignBlobRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<SignBlobRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[SignBlobRequest](/java/docs/reference/google-iam-admin/3.24.0/com.google.iam.admin.v1.SignBlobRequest)>`
...
**Deprecated.** _google.iam.admin.v1.SignBlobRequest.bytes\_to\_sign is deprecated. See google/iam/admin/v1/iam.proto;l=986_
...
**Deprecated.** _google.iam.admin.v1.SignBlobRequest.name is deprecated. See google/iam/admin/v1/iam.proto;l=974_
...
```
public Parser<SignBlobRequest> getParserForType()
```
...
```
public SignBlobRequest.Builder newBuilderForType()
```
...
```
protected SignBlobRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public SignBlobRequest.Builder toBuilder()
```
