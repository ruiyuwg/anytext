...
# Class TargetHttpsProxiesLimitedErrorCountRetryPolicy (2.22.1) Stay organized with collections Save and categorize content based on your preferences.
...
A retry policy for [`TargetHttpsProxiesConnection`](/cpp/docs/reference/compute/2.22.1/classgoogle_1_1cloud_1_1compute__target__https__proxies__v1_1_1TargetHttpsProxiesConnection) based on counting errors.
...
`TargetHttpsProxiesLimitedErrorCountRetryPolicy const &`  
...
`std::unique_ptr< TargetHttpsProxiesRetryPolicy >`

## Type Aliases

### BaseType

**Alias Of**: `TargetHttpsProxiesRetryPolicy`
