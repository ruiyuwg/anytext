...
# Class UserEvent (0.94.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class UserEvent extends GeneratedMessage implements UserEventOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessage.html) \> UserEvent

## Implements

[UserEventOrBuilder](/java/docs/reference/google-cloud-recommendations-ai/latest/com.google.cloud.recommendationengine.v1beta1.UserEventOrBuilder)
...
### PRODUCT\_EVENT\_DETAIL\_FIELD\_NUMBER
...
`[UserEvent](/java/docs/reference/google-cloud-recommendations-ai/latest/com.google.cloud.recommendationengine.v1beta1.UserEvent)`
...
`[UserEvent.Builder](/java/docs/reference/google-cloud-recommendations-ai/latest/com.google.cloud.recommendationengine.v1beta1.UserEvent.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[UserEvent](/java/docs/reference/google-cloud-recommendations-ai/latest/com.google.cloud.recommendationengine.v1beta1.UserEvent)>`
...
`[EventDetail](/java/docs/reference/google-cloud-recommendations-ai/latest/com.google.cloud.recommendationengine.v1beta1.EventDetail)`
...
`[EventDetailOrBuilder](/java/docs/reference/google-cloud-recommendations-ai/latest/com.google.cloud.recommendationengine.v1beta1.EventDetailOrBuilder)`
...
Optional. This field should _not_ be set when using JavaScript pixel or the Recommendations AI Tag. Defaults to `EVENT_SOURCE_UNSPECIFIED`.
...
`[UserEvent.EventSource](/java/docs/reference/google-cloud-recommendations-ai/latest/com.google.cloud.recommendationengine.v1beta1.UserEvent.EventSource)`
...
-   `shopping-cart-page-view` - note that 'product\_event\_detail' should be set for this unless the shopping cart is empty.
...
`[ProductEventDetail](/java/docs/reference/google-cloud-recommendations-ai/latest/com.google.cloud.recommendationengine.v1beta1.ProductEventDetail)`
...
`[ProductEventDetailOrBuilder](/java/docs/reference/google-cloud-recommendations-ai/latest/com.google.cloud.recommendationengine.v1beta1.ProductEventDetailOrBuilder)`
...
`[UserInfo](/java/docs/reference/google-cloud-recommendations-ai/latest/com.google.cloud.recommendationengine.v1beta1.UserInfo)`
...
`[UserInfoOrBuilder](/java/docs/reference/google-cloud-recommendations-ai/latest/com.google.cloud.recommendationengine.v1beta1.UserInfoOrBuilder)`
...
```
protected UserEvent.Builder newBuilderForType(AbstractMessage.BuilderParent parent)
```
