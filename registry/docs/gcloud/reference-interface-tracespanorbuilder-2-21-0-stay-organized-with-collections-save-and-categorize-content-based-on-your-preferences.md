...
# Interface TraceSpanOrBuilder (2.21.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[TraceSpan.SpanKind](/java/docs/reference/google-cloud-trace/2.21.0/com.google.devtools.cloudtrace.v1.TraceSpan.SpanKind)`
...
Use [#getLabelsMap()](/java/docs/reference/google-cloud-trace/2.21.0/com.google.devtools.cloudtrace.v1.TraceSpanOrBuilder#com_google_devtools_cloudtrace_v1_TraceSpanOrBuilder_getLabelsMap__) instead.
