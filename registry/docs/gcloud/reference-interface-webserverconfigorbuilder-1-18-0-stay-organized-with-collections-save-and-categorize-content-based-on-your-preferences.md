...
# Interface WebServerConfigOrBuilder (1.18.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface WebServerConfigOrBuilder extends MessageOrBuilder
```
