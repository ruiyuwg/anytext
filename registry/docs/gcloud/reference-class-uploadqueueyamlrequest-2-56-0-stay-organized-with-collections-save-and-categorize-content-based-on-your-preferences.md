...
# Class UploadQueueYamlRequest (2.56.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> UploadQueueYamlRequest

## Implements

[UploadQueueYamlRequestOrBuilder](/java/docs/reference/google-cloud-tasks/2.56.0/com.google.cloud.tasks.v2beta2.UploadQueueYamlRequestOrBuilder)
...
`[UploadQueueYamlRequest](/java/docs/reference/google-cloud-tasks/2.56.0/com.google.cloud.tasks.v2beta2.UploadQueueYamlRequest)`
...
`[UploadQueueYamlRequest.Builder](/java/docs/reference/google-cloud-tasks/2.56.0/com.google.cloud.tasks.v2beta2.UploadQueueYamlRequest.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[UploadQueueYamlRequest](/java/docs/reference/google-cloud-tasks/2.56.0/com.google.cloud.tasks.v2beta2.UploadQueueYamlRequest)>`
