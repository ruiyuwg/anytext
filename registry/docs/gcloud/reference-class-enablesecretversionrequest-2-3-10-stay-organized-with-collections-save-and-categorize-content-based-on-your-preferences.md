...
# Class EnableSecretVersionRequest (2.3.10) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class EnableSecretVersionRequest extends GeneratedMessageV3 implements EnableSecretVersionRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> EnableSecretVersionRequest

## Implements

[EnableSecretVersionRequestOrBuilder](/java/docs/reference/google-cloud-secretmanager/2.3.10/com.google.cloud.secretmanager.v1.EnableSecretVersionRequestOrBuilder)
...
```
public static EnableSecretVersionRequest getDefaultInstance()
```
...
[EnableSecretVersionRequest](/java/docs/reference/google-cloud-secretmanager/2.3.10/com.google.cloud.secretmanager.v1.EnableSecretVersionRequest)
...
```
public static EnableSecretVersionRequest.Builder newBuilder()
```
...
[EnableSecretVersionRequest.Builder](/java/docs/reference/google-cloud-secretmanager/2.3.10/com.google.cloud.secretmanager.v1.EnableSecretVersionRequest.Builder)

### newBuilder(EnableSecretVersionRequest prototype)

```
public static EnableSecretVersionRequest.Builder newBuilder(EnableSecretVersionRequest prototype)
```
...
```
public static EnableSecretVersionRequest parseDelimitedFrom(InputStream input)
```
...
```
public static EnableSecretVersionRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static EnableSecretVersionRequest parseFrom(byte[] data)
```
...
```
public static EnableSecretVersionRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static EnableSecretVersionRequest parseFrom(ByteString data)
```
...
```
public static EnableSecretVersionRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static EnableSecretVersionRequest parseFrom(CodedInputStream input)
```
...
```
public static EnableSecretVersionRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static EnableSecretVersionRequest parseFrom(InputStream input)
```
...
```
public static EnableSecretVersionRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static EnableSecretVersionRequest parseFrom(ByteBuffer data)
```
...
```
public static EnableSecretVersionRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<EnableSecretVersionRequest> parser()
```
...
[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[EnableSecretVersionRequest](/java/docs/reference/google-cloud-secretmanager/2.3.10/com.google.cloud.secretmanager.v1.EnableSecretVersionRequest)\>
...
```
public EnableSecretVersionRequest getDefaultInstanceForType()
```
...
```
public Parser<EnableSecretVersionRequest> getParserForType()
```
...
```
public EnableSecretVersionRequest.Builder newBuilderForType()
```
...
```
protected EnableSecretVersionRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public EnableSecretVersionRequest.Builder toBuilder()
```
