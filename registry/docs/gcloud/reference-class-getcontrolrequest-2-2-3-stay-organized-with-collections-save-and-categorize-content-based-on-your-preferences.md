...
# Class GetControlRequest (2.2.3) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class GetControlRequest extends GeneratedMessageV3 implements GetControlRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> GetControlRequest

## Implements

[GetControlRequestOrBuilder](/java/docs/reference/google-cloud-retail/2.2.3/com.google.cloud.retail.v2beta.GetControlRequestOrBuilder)
...
```
public static GetControlRequest getDefaultInstance()
```
...
[GetControlRequest](/java/docs/reference/google-cloud-retail/2.2.3/com.google.cloud.retail.v2beta.GetControlRequest)
...
```
public static GetControlRequest.Builder newBuilder()
```
...
[GetControlRequest.Builder](/java/docs/reference/google-cloud-retail/2.2.3/com.google.cloud.retail.v2beta.GetControlRequest.Builder)

### newBuilder(GetControlRequest prototype)

```
public static GetControlRequest.Builder newBuilder(GetControlRequest prototype)
```
...
```
public static GetControlRequest parseDelimitedFrom(InputStream input)
```
...
```
public static GetControlRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetControlRequest parseFrom(byte[] data)
```
...
```
public static GetControlRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetControlRequest parseFrom(ByteString data)
```
...
```
public static GetControlRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetControlRequest parseFrom(CodedInputStream input)
```
...
```
public static GetControlRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetControlRequest parseFrom(InputStream input)
```
...
```
public static GetControlRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetControlRequest parseFrom(ByteBuffer data)
```
...
```
public static GetControlRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<GetControlRequest> parser()
```
...
[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[GetControlRequest](/java/docs/reference/google-cloud-retail/2.2.3/com.google.cloud.retail.v2beta.GetControlRequest)\>
...
```
public GetControlRequest getDefaultInstanceForType()
```
...
Required. The resource name of the Control to delete. Format: projects/{project\_number}/locations/{location\_id}/catalogs/{catalog\_id}/controls/{control\_id}
...
```
public Parser<GetControlRequest> getParserForType()
```
...
```
public GetControlRequest.Builder newBuilderForType()
```
...
```
protected GetControlRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public GetControlRequest.Builder toBuilder()
```
