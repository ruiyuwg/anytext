...
# Interface ListServicesResponseOrBuilder (2.28.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[Service](/java/docs/reference/google-cloud-service-usage/2.28.0/com.google.api.serviceusage.v1.Service)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Service](/java/docs/reference/google-cloud-service-usage/2.28.0/com.google.api.serviceusage.v1.Service)>`
...
`[ServiceOrBuilder](/java/docs/reference/google-cloud-service-usage/2.28.0/com.google.api.serviceusage.v1.ServiceOrBuilder)`
