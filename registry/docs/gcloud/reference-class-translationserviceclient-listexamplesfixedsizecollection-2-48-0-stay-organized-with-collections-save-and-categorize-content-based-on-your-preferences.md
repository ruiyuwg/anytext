...
# Class TranslationServiceClient.ListExamplesFixedSizeCollection (2.48.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class TranslationServiceClient.ListExamplesFixedSizeCollection extends AbstractFixedSizeCollection<ListExamplesRequest,ListExamplesResponse,Example,TranslationServiceClient.ListExamplesPage,TranslationServiceClient.ListExamplesFixedSizeCollection>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractFixedSizeCollection](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractFixedSizeCollection.html) \> TranslationServiceClient.ListExamplesFixedSizeCollection
...
### createCollection(List<TranslationServiceClient.ListExamplesPage> pages, int collectionSize)

```
protected TranslationServiceClient.ListExamplesFixedSizeCollection createCollection(List<TranslationServiceClient.ListExamplesPage> pages, int collectionSize)
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ListExamplesPage](/java/docs/reference/google-cloud-translate/2.48.0/com.google.cloud.translate.v3.TranslationServiceClient.ListExamplesPage)>`  
...
`[TranslationServiceClient.ListExamplesFixedSizeCollection](/java/docs/reference/google-cloud-translate/2.48.0/com.google.cloud.translate.v3.TranslationServiceClient.ListExamplesFixedSizeCollection)`
