...
# Enum ExportErrorsConfig.DestinationCase (2.18.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum ExportErrorsConfig.DestinationCase extends Enum<ExportErrorsConfig.DestinationCase> implements Internal.EnumLite, AbstractMessageLite.InternalOneOfEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-retail/2.18.0/com.google.cloud.retail.v2alpha.ExportErrorsConfig.DestinationCase#com_google_cloud_retail_v2alpha_ExportErrorsConfig_DestinationCase_forNumber_int_) instead._
