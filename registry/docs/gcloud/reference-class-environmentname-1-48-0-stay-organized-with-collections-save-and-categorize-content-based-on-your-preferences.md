...
# Class EnvironmentName (1.48.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[EnvironmentName.Builder](/java/docs/reference/google-cloud-orchestration-airflow/1.48.0/com.google.cloud.orchestration.airflow.service.v1.EnvironmentName.Builder)`
...
`[EnvironmentName](/java/docs/reference/google-cloud-orchestration-airflow/1.48.0/com.google.cloud.orchestration.airflow.service.v1.EnvironmentName)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[EnvironmentName](/java/docs/reference/google-cloud-orchestration-airflow/1.48.0/com.google.cloud.orchestration.airflow.service.v1.EnvironmentName)>`
