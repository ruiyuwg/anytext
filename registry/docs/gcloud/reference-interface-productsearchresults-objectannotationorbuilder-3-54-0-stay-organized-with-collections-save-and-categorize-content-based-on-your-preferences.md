...
# Interface ProductSearchResults.ObjectAnnotationOrBuilder (3.54.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static interface ProductSearchResults.ObjectAnnotationOrBuilder extends MessageOrBuilder
```
