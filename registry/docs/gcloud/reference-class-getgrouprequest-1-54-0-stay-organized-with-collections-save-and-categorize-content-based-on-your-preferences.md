...
# Class GetGroupRequest (1.54.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class GetGroupRequest extends GeneratedMessageV3 implements GetGroupRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> GetGroupRequest

## Implements

[GetGroupRequestOrBuilder](/java/docs/reference/google-cloud-networkconnectivity/1.54.0/com.google.cloud.networkconnectivity.v1.GetGroupRequestOrBuilder)
...
`[GetGroupRequest](/java/docs/reference/google-cloud-networkconnectivity/1.54.0/com.google.cloud.networkconnectivity.v1.GetGroupRequest)`
...
```
public static GetGroupRequest.Builder newBuilder()
```
...
`[GetGroupRequest.Builder](/java/docs/reference/google-cloud-networkconnectivity/1.54.0/com.google.cloud.networkconnectivity.v1.GetGroupRequest.Builder)`

### newBuilder(GetGroupRequest prototype)

```
public static GetGroupRequest.Builder newBuilder(GetGroupRequest prototype)
```
...
```
public static GetGroupRequest parseDelimitedFrom(InputStream input)
```
...
```
public static GetGroupRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetGroupRequest parseFrom(byte[] data)
```
...
```
public static GetGroupRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetGroupRequest parseFrom(ByteString data)
```
...
```
public static GetGroupRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetGroupRequest parseFrom(CodedInputStream input)
```
...
```
public static GetGroupRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetGroupRequest parseFrom(InputStream input)
```
...
```
public static GetGroupRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetGroupRequest parseFrom(ByteBuffer data)
```
...
```
public static GetGroupRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<GetGroupRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[GetGroupRequest](/java/docs/reference/google-cloud-networkconnectivity/1.54.0/com.google.cloud.networkconnectivity.v1.GetGroupRequest)>`
...
```
public Parser<GetGroupRequest> getParserForType()
```
...
```
public GetGroupRequest.Builder newBuilderForType()
```
...
```
protected GetGroupRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public GetGroupRequest.Builder toBuilder()
```
