...
# Class SpacesServiceSettings (0.2.0) Stay organized with collections Save and categorize content based on your preferences.
...
Settings class to configure an instance of [SpacesServiceClient](/java/docs/reference/google-cloud-meet/0.2.0/com.google.apps.meet.v2beta.SpacesServiceClient).
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [ClientSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.ClientSettings.html) \> SpacesServiceSettings
...
### create(SpacesServiceStubSettings stub)
...
`[SpacesServiceStubSettings](/java/docs/reference/google-cloud-meet/0.2.0/com.google.apps.meet.v2beta.stub.SpacesServiceStubSettings)`  
...
`[SpacesServiceSettings](/java/docs/reference/google-cloud-meet/0.2.0/com.google.apps.meet.v2beta.SpacesServiceSettings)`
...
```
public static SpacesServiceSettings.Builder newBuilder()
```
...
`[SpacesServiceSettings.Builder](/java/docs/reference/google-cloud-meet/0.2.0/com.google.apps.meet.v2beta.SpacesServiceSettings.Builder)`

### newBuilder(ClientContext clientContext)

```
public static SpacesServiceSettings.Builder newBuilder(ClientContext clientContext)
```
...
```
public static SpacesServiceSettings.Builder newHttpJsonBuilder()
```
...
### SpacesServiceSettings(SpacesServiceSettings.Builder settingsBuilder)

```
protected SpacesServiceSettings(SpacesServiceSettings.Builder settingsBuilder)
```
...
`[UnaryCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.html)<[CreateSpaceRequest](/java/docs/reference/google-cloud-meet/0.2.0/com.google.apps.meet.v2beta.CreateSpaceRequest),[Space](/java/docs/reference/google-cloud-meet/0.2.0/com.google.apps.meet.v2beta.Space)>`
...
`[UnaryCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.html)<[EndActiveConferenceRequest](/java/docs/reference/google-cloud-meet/0.2.0/com.google.apps.meet.v2beta.EndActiveConferenceRequest),[Empty](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Empty.html)>`
...
`[UnaryCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.html)<[GetSpaceRequest](/java/docs/reference/google-cloud-meet/0.2.0/com.google.apps.meet.v2beta.GetSpaceRequest),[Space](/java/docs/reference/google-cloud-meet/0.2.0/com.google.apps.meet.v2beta.Space)>`

### toBuilder()

```
public SpacesServiceSettings.Builder toBuilder()
```
...
`[UnaryCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.html)<[UpdateSpaceRequest](/java/docs/reference/google-cloud-meet/0.2.0/com.google.apps.meet.v2beta.UpdateSpaceRequest),[Space](/java/docs/reference/google-cloud-meet/0.2.0/com.google.apps.meet.v2beta.Space)>`
