...
# Class GuestConfigDetails (0.17.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> GuestConfigDetails

## Implements

[GuestConfigDetailsOrBuilder](/java/docs/reference/google-cloud-migrationcenter/0.17.0/com.google.cloud.migrationcenter.v1.GuestConfigDetailsOrBuilder)
...
`[GuestConfigDetails](/java/docs/reference/google-cloud-migrationcenter/0.17.0/com.google.cloud.migrationcenter.v1.GuestConfigDetails)`
...
`[GuestConfigDetails.Builder](/java/docs/reference/google-cloud-migrationcenter/0.17.0/com.google.cloud.migrationcenter.v1.GuestConfigDetails.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[GuestConfigDetails](/java/docs/reference/google-cloud-migrationcenter/0.17.0/com.google.cloud.migrationcenter.v1.GuestConfigDetails)>`
...
`[FstabEntryList](/java/docs/reference/google-cloud-migrationcenter/0.17.0/com.google.cloud.migrationcenter.v1.FstabEntryList)`
...
`[FstabEntryListOrBuilder](/java/docs/reference/google-cloud-migrationcenter/0.17.0/com.google.cloud.migrationcenter.v1.FstabEntryListOrBuilder)`
...
`[HostsEntryList](/java/docs/reference/google-cloud-migrationcenter/0.17.0/com.google.cloud.migrationcenter.v1.HostsEntryList)`
...
`[HostsEntryListOrBuilder](/java/docs/reference/google-cloud-migrationcenter/0.17.0/com.google.cloud.migrationcenter.v1.HostsEntryListOrBuilder)`
...
`[NfsExportList](/java/docs/reference/google-cloud-migrationcenter/0.17.0/com.google.cloud.migrationcenter.v1.NfsExportList)`
...
`[NfsExportListOrBuilder](/java/docs/reference/google-cloud-migrationcenter/0.17.0/com.google.cloud.migrationcenter.v1.NfsExportListOrBuilder)`
...
`[GuestConfigDetails.SeLinuxMode](/java/docs/reference/google-cloud-migrationcenter/0.17.0/com.google.cloud.migrationcenter.v1.GuestConfigDetails.SeLinuxMode)`
