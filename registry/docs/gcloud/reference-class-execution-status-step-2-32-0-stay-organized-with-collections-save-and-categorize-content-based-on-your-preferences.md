...
# Class Execution.Status.Step (2.32.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Execution.Status.StepOrBuilder](/java/docs/reference/google-cloud-workflow-executions/2.32.0/com.google.cloud.workflows.executions.v1.Execution.Status.StepOrBuilder)
...
`[Execution.Status.Step](/java/docs/reference/google-cloud-workflow-executions/2.32.0/com.google.cloud.workflows.executions.v1.Execution.Status.Step)`
...
`[Execution.Status.Step.Builder](/java/docs/reference/google-cloud-workflow-executions/2.32.0/com.google.cloud.workflows.executions.v1.Execution.Status.Step.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[Step](/java/docs/reference/google-cloud-workflow-executions/2.32.0/com.google.cloud.workflows.executions.v1.Execution.Status.Step)>`
