...
# Enum ServiceLevel (0.21.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum ServiceLevel extends Enum<ServiceLevel> implements ProtocolMessageEnum
```
...
`SERVICE_LEVEL_UNSPECIFIED_VALUE`
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-netapp/0.21.0/com.google.cloud.netapp.v1.ServiceLevel#com_google_cloud_netapp_v1_ServiceLevel_forNumber_int_) instead._
