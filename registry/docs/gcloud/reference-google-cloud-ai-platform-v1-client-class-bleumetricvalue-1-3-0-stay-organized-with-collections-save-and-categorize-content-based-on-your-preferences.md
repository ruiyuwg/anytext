...
# Google Cloud Ai Platform V1 Client - Class BleuMetricValue (1.3.0) Stay organized with collections Save and categorize content based on your preferences.
...
Reference documentation and code samples for the Google Cloud Ai Platform V1 Client class BleuMetricValue.

Bleu metric value for an instance.

Generated from protobuf message `google.cloud.aiplatform.v1.BleuMetricValue`
