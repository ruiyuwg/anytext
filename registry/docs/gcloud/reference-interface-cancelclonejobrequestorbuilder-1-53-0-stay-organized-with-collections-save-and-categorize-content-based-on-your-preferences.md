...
# Interface CancelCloneJobRequestOrBuilder (1.53.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface CancelCloneJobRequestOrBuilder extends MessageOrBuilder
```
