...
# Class MuxStream.Fmp4Config (1.86.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class MuxStream.Fmp4Config extends GeneratedMessage implements MuxStream.Fmp4ConfigOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessage.html) \> MuxStream.Fmp4Config

## Implements

[MuxStream.Fmp4ConfigOrBuilder](/java/docs/reference/google-cloud-video-transcoder/latest/com.google.cloud.video.transcoder.v1.MuxStream.Fmp4ConfigOrBuilder)
...
### CODEC\_TAG\_FIELD\_NUMBER

```
public static final int CODEC_TAG_FIELD_NUMBER
```
...
```
public static MuxStream.Fmp4Config getDefaultInstance()
```
...
`[MuxStream.Fmp4Config](/java/docs/reference/google-cloud-video-transcoder/latest/com.google.cloud.video.transcoder.v1.MuxStream.Fmp4Config)`
...
```
public static MuxStream.Fmp4Config.Builder newBuilder()
```
...
`[MuxStream.Fmp4Config.Builder](/java/docs/reference/google-cloud-video-transcoder/latest/com.google.cloud.video.transcoder.v1.MuxStream.Fmp4Config.Builder)`

### newBuilder(MuxStream.Fmp4Config prototype)

```
public static MuxStream.Fmp4Config.Builder newBuilder(MuxStream.Fmp4Config prototype)
```
...
```
public static MuxStream.Fmp4Config parseDelimitedFrom(InputStream input)
```
...
```
public static MuxStream.Fmp4Config parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static MuxStream.Fmp4Config parseFrom(byte[] data)
```
...
```
public static MuxStream.Fmp4Config parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static MuxStream.Fmp4Config parseFrom(ByteString data)
```
...
```
public static MuxStream.Fmp4Config parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static MuxStream.Fmp4Config parseFrom(CodedInputStream input)
```
...
```
public static MuxStream.Fmp4Config parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static MuxStream.Fmp4Config parseFrom(InputStream input)
```
...
```
public static MuxStream.Fmp4Config parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static MuxStream.Fmp4Config parseFrom(ByteBuffer data)
```
...
```
public static MuxStream.Fmp4Config parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<MuxStream.Fmp4Config> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[Fmp4Config](/java/docs/reference/google-cloud-video-transcoder/latest/com.google.cloud.video.transcoder.v1.MuxStream.Fmp4Config)>`
...
```
public Parser<MuxStream.Fmp4Config> getParserForType()
```
...
```
public MuxStream.Fmp4Config.Builder newBuilderForType()
```
...
```
protected MuxStream.Fmp4Config.Builder newBuilderForType(AbstractMessage.BuilderParent parent)
```
...
```
public MuxStream.Fmp4Config.Builder toBuilder()
```
