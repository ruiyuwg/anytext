...
# Class GlobalNetworkEndpointGroupsLimitedErrorCountRetryPolicy (2.22.1) Stay organized with collections Save and categorize content based on your preferences.
...
A retry policy for [`GlobalNetworkEndpointGroupsConnection`](/cpp/docs/reference/compute/2.22.1/classgoogle_1_1cloud_1_1compute__global__network__endpoint__groups__v1_1_1GlobalNetworkEndpointGroupsConnection) based on counting errors.
...
`std::unique_ptr< GlobalNetworkEndpointGroupsRetryPolicy >`

## Type Aliases

### BaseType

**Alias Of**: `GlobalNetworkEndpointGroupsRetryPolicy`
