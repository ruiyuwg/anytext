...
# Enum LogEntry.PayloadCase (1.4.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-service-control/1.4.0/com.google.api.servicecontrol.v1.LogEntry.PayloadCase#com_google_api_servicecontrol_v1_LogEntry_PayloadCase_forNumber_int_) instead._
