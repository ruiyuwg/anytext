...
# Class IntentsLimitedErrorCountRetryPolicy (2.24.0) Stay organized with collections Save and categorize content based on your preferences.
...
A retry policy for [`IntentsConnection`](/cpp/docs/reference/dialogflow_cx/2.24.0/classgoogle_1_1cloud_1_1dialogflow__cx_1_1IntentsConnection) based on counting errors.
...
`IntentsLimitedErrorCountRetryPolicy const &`  
...
`std::unique_ptr< IntentsRetryPolicy >`

## Type Aliases

### BaseType

**Alias Of**: `IntentsRetryPolicy`
