...
# google-cloud-recommender overview (2.89.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Recommender Description:** Delivers highly personalized product recommendations at scale.

[Recommender Product Reference](https://cloud.google.com/recommendations/)

[GitHub Repository](https://github.com/googleapis/google-cloud-java/tree/main/java-recommender)

[Maven artifact](https://central.sonatype.com/artifact/com.google.cloud/google-cloud-recommender)
...
-   [Enable the API](https://console.cloud.google.com/apis/library/recommender.googleapis.com)
-   [Set up authentication](https://cloud.google.com/docs/authentication/client-libraries)

## Use the Recommender for Java
...
The example below demonstrates how you would import the BOM and include the `google-cloud-recommender` artifact.
...
For this library, we recommend using [com.google.cloud.recommender.v1](https://cloud.google.com/java/docs/reference/google-cloud-recommender/2.89.0/com.google.cloud.recommender.v1) for new applications.
