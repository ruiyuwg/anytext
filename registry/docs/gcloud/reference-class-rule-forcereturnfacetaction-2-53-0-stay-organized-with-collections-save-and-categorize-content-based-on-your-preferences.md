...
# Class Rule.ForceReturnFacetAction (2.53.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class Rule.ForceReturnFacetAction extends GeneratedMessageV3 implements Rule.ForceReturnFacetActionOrBuilder
```

Force returns an attribute/facet in the request around a certain position or above.

-   Rule Condition: Must specify non-empty Condition.query\_terms (for search only) or Condition.page\_categories (for browse only), but can't specify both.
...
-   Action Result: Will force return a facet key around a certain position or above if the condition is satisfied.
    ...
    Example: Suppose the query is "shoes", the Condition.query\_terms is "shoes", the ForceReturnFacetAction.FacetPositionAdjustment.attribute\_name is "size" and the ForceReturnFacetAction.FacetPositionAdjustment.position is 8.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> Rule.ForceReturnFacetAction

## Implements

[Rule.ForceReturnFacetActionOrBuilder](/java/docs/reference/google-cloud-retail/2.53.0/com.google.cloud.retail.v2alpha.Rule.ForceReturnFacetActionOrBuilder)
...
### FACET\_POSITION\_ADJUSTMENTS\_FIELD\_NUMBER

```
public static final int FACET_POSITION_ADJUSTMENTS_FIELD_NUMBER
```
...
```
public static Rule.ForceReturnFacetAction getDefaultInstance()
```
...
`[Rule.ForceReturnFacetAction](/java/docs/reference/google-cloud-retail/2.53.0/com.google.cloud.retail.v2alpha.Rule.ForceReturnFacetAction)`
...
```
public static Rule.ForceReturnFacetAction.Builder newBuilder()
```
...
`[Rule.ForceReturnFacetAction.Builder](/java/docs/reference/google-cloud-retail/2.53.0/com.google.cloud.retail.v2alpha.Rule.ForceReturnFacetAction.Builder)`

### newBuilder(Rule.ForceReturnFacetAction prototype)

```
public static Rule.ForceReturnFacetAction.Builder newBuilder(Rule.ForceReturnFacetAction prototype)
```
...
```
public static Rule.ForceReturnFacetAction parseDelimitedFrom(InputStream input)
```
...
```
public static Rule.ForceReturnFacetAction parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Rule.ForceReturnFacetAction parseFrom(byte[] data)
```
...
```
public static Rule.ForceReturnFacetAction parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Rule.ForceReturnFacetAction parseFrom(ByteString data)
```
...
```
public static Rule.ForceReturnFacetAction parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Rule.ForceReturnFacetAction parseFrom(CodedInputStream input)
```
...
```
public static Rule.ForceReturnFacetAction parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Rule.ForceReturnFacetAction parseFrom(InputStream input)
```
...
```
public static Rule.ForceReturnFacetAction parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Rule.ForceReturnFacetAction parseFrom(ByteBuffer data)
```
...
```
public static Rule.ForceReturnFacetAction parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<Rule.ForceReturnFacetAction> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ForceReturnFacetAction](/java/docs/reference/google-cloud-retail/2.53.0/com.google.cloud.retail.v2alpha.Rule.ForceReturnFacetAction)>`
...
`[Rule.ForceReturnFacetAction.FacetPositionAdjustment](/java/docs/reference/google-cloud-retail/2.53.0/com.google.cloud.retail.v2alpha.Rule.ForceReturnFacetAction.FacetPositionAdjustment)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[FacetPositionAdjustment](/java/docs/reference/google-cloud-retail/2.53.0/com.google.cloud.retail.v2alpha.Rule.ForceReturnFacetAction.FacetPositionAdjustment)>`
...
`[Rule.ForceReturnFacetAction.FacetPositionAdjustmentOrBuilder](/java/docs/reference/google-cloud-retail/2.53.0/com.google.cloud.retail.v2alpha.Rule.ForceReturnFacetAction.FacetPositionAdjustmentOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.retail.v2alpha.Rule.ForceReturnFacetAction.FacetPositionAdjustmentOrBuilder>`

### getParserForType()

```
public Parser<Rule.ForceReturnFacetAction> getParserForType()
```
...
```
public Rule.ForceReturnFacetAction.Builder newBuilderForType()
```
...
```
protected Rule.ForceReturnFacetAction.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public Rule.ForceReturnFacetAction.Builder toBuilder()
```
