...
# Class InstanceSettingsLimitedTimeRetryPolicy (2.28.0) Stay organized with collections Save and categorize content based on your preferences.
...
A retry policy for [`InstanceSettingsConnection`](/cpp/docs/reference/compute/2.28.0/classgoogle_1_1cloud_1_1compute__instance__settings__v1_1_1InstanceSettingsConnection) based on elapsed time.
...
`InstanceSettingsLimitedTimeRetryPolicy const &`  
...
`std::unique_ptr< InstanceSettingsRetryPolicy >`

## Type Aliases

### BaseType

**Alias Of**: `InstanceSettingsRetryPolicy`
