...
# Class UpdateParameterRequest (0.1.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> UpdateParameterRequest

## Implements

[UpdateParameterRequestOrBuilder](/java/docs/reference/google-cloud-parametermanager/0.1.0/com.google.cloud.parametermanager.v1.UpdateParameterRequestOrBuilder)
...
`[UpdateParameterRequest](/java/docs/reference/google-cloud-parametermanager/0.1.0/com.google.cloud.parametermanager.v1.UpdateParameterRequest)`
...
```
public static UpdateParameterRequest.Builder newBuilder()
```
...
`[UpdateParameterRequest.Builder](/java/docs/reference/google-cloud-parametermanager/0.1.0/com.google.cloud.parametermanager.v1.UpdateParameterRequest.Builder)`

### newBuilder(UpdateParameterRequest prototype)

```
public static UpdateParameterRequest.Builder newBuilder(UpdateParameterRequest prototype)
```
...
```
public static UpdateParameterRequest parseDelimitedFrom(InputStream input)
```
...
```
public static UpdateParameterRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateParameterRequest parseFrom(byte[] data)
```
...
```
public static UpdateParameterRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateParameterRequest parseFrom(ByteString data)
```
...
```
public static UpdateParameterRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateParameterRequest parseFrom(CodedInputStream input)
```
...
```
public static UpdateParameterRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateParameterRequest parseFrom(InputStream input)
```
...
```
public static UpdateParameterRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateParameterRequest parseFrom(ByteBuffer data)
```
...
```
public static UpdateParameterRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[UpdateParameterRequest](/java/docs/reference/google-cloud-parametermanager/0.1.0/com.google.cloud.parametermanager.v1.UpdateParameterRequest)>`
...
`[Parameter](/java/docs/reference/google-cloud-parametermanager/0.1.0/com.google.cloud.parametermanager.v1.Parameter)`
...
`[ParameterOrBuilder](/java/docs/reference/google-cloud-parametermanager/0.1.0/com.google.cloud.parametermanager.v1.ParameterOrBuilder)`
...
Optional. Field mask is used to specify the fields to be overwritten in the Parameter resource by the update. The fields specified in the update\_mask are relative to the resource, not the full request. A mutable field will be overwritten if it is in the mask. If the user does not provide a mask then all mutable fields present in the request will be overwritten.
...
```
public UpdateParameterRequest.Builder newBuilderForType()
```
...
```
protected UpdateParameterRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public UpdateParameterRequest.Builder toBuilder()
```
