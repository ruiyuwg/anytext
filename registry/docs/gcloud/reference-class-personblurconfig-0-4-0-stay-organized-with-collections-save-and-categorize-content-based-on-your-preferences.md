...
# Class PersonBlurConfig (0.4.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class PersonBlurConfig extends GeneratedMessageV3 implements PersonBlurConfigOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> PersonBlurConfig

## Implements

[PersonBlurConfigOrBuilder](/java/docs/reference/google-cloud-visionai/0.4.0/com.google.cloud.visionai.v1.PersonBlurConfigOrBuilder)
...
### FACES\_ONLY\_FIELD\_NUMBER

```
public static final int FACES_ONLY_FIELD_NUMBER
```
...
### PERSON\_BLUR\_TYPE\_FIELD\_NUMBER

```
public static final int PERSON_BLUR_TYPE_FIELD_NUMBER
```
...
```
public static PersonBlurConfig getDefaultInstance()
```
...
`[PersonBlurConfig](/java/docs/reference/google-cloud-visionai/0.4.0/com.google.cloud.visionai.v1.PersonBlurConfig)`
...
```
public static PersonBlurConfig.Builder newBuilder()
```
...
`[PersonBlurConfig.Builder](/java/docs/reference/google-cloud-visionai/0.4.0/com.google.cloud.visionai.v1.PersonBlurConfig.Builder)`

### newBuilder(PersonBlurConfig prototype)

```
public static PersonBlurConfig.Builder newBuilder(PersonBlurConfig prototype)
```
...
```
public static PersonBlurConfig parseDelimitedFrom(InputStream input)
```
...
```
public static PersonBlurConfig parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PersonBlurConfig parseFrom(byte[] data)
```
...
```
public static PersonBlurConfig parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PersonBlurConfig parseFrom(ByteString data)
```
...
```
public static PersonBlurConfig parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PersonBlurConfig parseFrom(CodedInputStream input)
```
...
```
public static PersonBlurConfig parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PersonBlurConfig parseFrom(InputStream input)
```
...
```
public static PersonBlurConfig parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PersonBlurConfig parseFrom(ByteBuffer data)
```
...
```
public static PersonBlurConfig parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<PersonBlurConfig> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[PersonBlurConfig](/java/docs/reference/google-cloud-visionai/0.4.0/com.google.cloud.visionai.v1.PersonBlurConfig)>`
...
```
public Parser<PersonBlurConfig> getParserForType()
```
...
`[PersonBlurConfig.PersonBlurType](/java/docs/reference/google-cloud-visionai/0.4.0/com.google.cloud.visionai.v1.PersonBlurConfig.PersonBlurType)`
...
```
public PersonBlurConfig.Builder newBuilderForType()
```
...
```
protected PersonBlurConfig.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public PersonBlurConfig.Builder toBuilder()
```
