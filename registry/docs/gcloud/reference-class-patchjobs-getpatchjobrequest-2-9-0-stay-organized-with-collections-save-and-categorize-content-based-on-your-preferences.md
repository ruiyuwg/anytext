...
# Class PatchJobs.GetPatchJobRequest (2.9.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class PatchJobs.GetPatchJobRequest extends GeneratedMessageV3 implements PatchJobs.GetPatchJobRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> PatchJobs.GetPatchJobRequest

## Implements

[PatchJobs.GetPatchJobRequestOrBuilder](/java/docs/reference/google-cloud-os-config/2.9.0/com.google.cloud.osconfig.v1.PatchJobs.GetPatchJobRequestOrBuilder)
...
```
public static PatchJobs.GetPatchJobRequest getDefaultInstance()
```
...
[PatchJobs.GetPatchJobRequest](/java/docs/reference/google-cloud-os-config/2.9.0/com.google.cloud.osconfig.v1.PatchJobs.GetPatchJobRequest)
...
```
public static PatchJobs.GetPatchJobRequest.Builder newBuilder()
```
...
[PatchJobs.GetPatchJobRequest.Builder](/java/docs/reference/google-cloud-os-config/2.9.0/com.google.cloud.osconfig.v1.PatchJobs.GetPatchJobRequest.Builder)

### newBuilder(PatchJobs.GetPatchJobRequest prototype)

```
public static PatchJobs.GetPatchJobRequest.Builder newBuilder(PatchJobs.GetPatchJobRequest prototype)
```
...
```
public static PatchJobs.GetPatchJobRequest parseDelimitedFrom(InputStream input)
```
...
```
public static PatchJobs.GetPatchJobRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PatchJobs.GetPatchJobRequest parseFrom(byte[] data)
```
...
```
public static PatchJobs.GetPatchJobRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PatchJobs.GetPatchJobRequest parseFrom(ByteString data)
```
...
```
public static PatchJobs.GetPatchJobRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PatchJobs.GetPatchJobRequest parseFrom(CodedInputStream input)
```
...
```
public static PatchJobs.GetPatchJobRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PatchJobs.GetPatchJobRequest parseFrom(InputStream input)
```
...
```
public static PatchJobs.GetPatchJobRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PatchJobs.GetPatchJobRequest parseFrom(ByteBuffer data)
```
...
```
public static PatchJobs.GetPatchJobRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<PatchJobs.GetPatchJobRequest> parser()
```
...
[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[GetPatchJobRequest](/java/docs/reference/google-cloud-os-config/2.9.0/com.google.cloud.osconfig.v1.PatchJobs.GetPatchJobRequest)\>
...
```
public Parser<PatchJobs.GetPatchJobRequest> getParserForType()
```
...
```
public PatchJobs.GetPatchJobRequest.Builder newBuilderForType()
```
...
```
protected PatchJobs.GetPatchJobRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public PatchJobs.GetPatchJobRequest.Builder toBuilder()
```
