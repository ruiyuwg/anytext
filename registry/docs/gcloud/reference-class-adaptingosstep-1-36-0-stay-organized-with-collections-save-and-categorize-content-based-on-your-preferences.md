...
# Class AdaptingOSStep (1.36.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class AdaptingOSStep extends GeneratedMessageV3 implements AdaptingOSStepOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> AdaptingOSStep

## Implements

[AdaptingOSStepOrBuilder](/java/docs/reference/google-cloud-vmmigration/1.36.0/com.google.cloud.vmmigration.v1.AdaptingOSStepOrBuilder)
...
```
public static AdaptingOSStep getDefaultInstance()
```
...
`[AdaptingOSStep](/java/docs/reference/google-cloud-vmmigration/1.36.0/com.google.cloud.vmmigration.v1.AdaptingOSStep)`
...
```
public static AdaptingOSStep.Builder newBuilder()
```
...
`[AdaptingOSStep.Builder](/java/docs/reference/google-cloud-vmmigration/1.36.0/com.google.cloud.vmmigration.v1.AdaptingOSStep.Builder)`

### newBuilder(AdaptingOSStep prototype)

```
public static AdaptingOSStep.Builder newBuilder(AdaptingOSStep prototype)
```
...
```
public static AdaptingOSStep parseDelimitedFrom(InputStream input)
```
...
```
public static AdaptingOSStep parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AdaptingOSStep parseFrom(byte[] data)
```
...
```
public static AdaptingOSStep parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AdaptingOSStep parseFrom(ByteString data)
```
...
```
public static AdaptingOSStep parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AdaptingOSStep parseFrom(CodedInputStream input)
```
...
```
public static AdaptingOSStep parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AdaptingOSStep parseFrom(InputStream input)
```
...
```
public static AdaptingOSStep parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AdaptingOSStep parseFrom(ByteBuffer data)
```
...
```
public static AdaptingOSStep parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<AdaptingOSStep> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[AdaptingOSStep](/java/docs/reference/google-cloud-vmmigration/1.36.0/com.google.cloud.vmmigration.v1.AdaptingOSStep)>`
...
```
public AdaptingOSStep getDefaultInstanceForType()
```
...
```
public Parser<AdaptingOSStep> getParserForType()
```
...
```
public AdaptingOSStep.Builder newBuilderForType()
```
...
```
protected AdaptingOSStep.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public AdaptingOSStep.Builder toBuilder()
```
