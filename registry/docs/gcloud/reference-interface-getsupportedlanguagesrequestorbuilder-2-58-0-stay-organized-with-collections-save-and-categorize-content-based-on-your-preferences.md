...
# Interface GetSupportedLanguagesRequestOrBuilder (2.58.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public abstract String getDisplayLanguageCode()
```
...
```
public abstract ByteString getDisplayLanguageCodeBytes()
```
