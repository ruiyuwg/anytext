...
# Cloud AI Platform v1 API - Class CreateFeatureOnlineStoreRequest (3.13.0) Stay organized with collections Save and categorize content based on your preferences.
...
[object](https://learn.microsoft.com/dotnet/api/system.object) \> CreateFeatureOnlineStoreRequest

## Implements

[IMessage](https://cloud.google.com/dotnet/docs/reference/Google.Protobuf/latest/Google.Protobuf.IMessage-1.html)[CreateFeatureOnlineStoreRequest](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.13.0/Google.Cloud.AIPlatform.V1.CreateFeatureOnlineStoreRequest), [IEquatable](https://learn.microsoft.com/dotnet/api/system.iequatable-1)[CreateFeatureOnlineStoreRequest](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.13.0/Google.Cloud.AIPlatform.V1.CreateFeatureOnlineStoreRequest), [IDeepCloneable](https://cloud.google.com/dotnet/docs/reference/Google.Protobuf/latest/Google.Protobuf.IDeepCloneable-1.html)[CreateFeatureOnlineStoreRequest](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.13.0/Google.Cloud.AIPlatform.V1.CreateFeatureOnlineStoreRequest), [IBufferMessage](https://cloud.google.com/dotnet/docs/reference/Google.Protobuf/latest/Google.Protobuf.IBufferMessage.html), [IMessage](https://cloud.google.com/dotnet/docs/reference/Google.Protobuf/latest/Google.Protobuf.IMessage.html)
...
`[CreateFeatureOnlineStoreRequest](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.13.0/Google.Cloud.AIPlatform.V1.CreateFeatureOnlineStoreRequest)`  
...
`[FeatureOnlineStore](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.13.0/Google.Cloud.AIPlatform.V1.FeatureOnlineStore)`
...
[LocationName](https://cloud.google.com/dotnet/docs/reference/Google.Api.Gax/latest/Google.Api.Gax.ResourceNames.LocationName.html)\-typed view over the [Parent](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.13.0/Google.Cloud.AIPlatform.V1.CreateFeatureOnlineStoreRequest#Google_Cloud_AIPlatform_V1_CreateFeatureOnlineStoreRequest_Parent) resource name property.
