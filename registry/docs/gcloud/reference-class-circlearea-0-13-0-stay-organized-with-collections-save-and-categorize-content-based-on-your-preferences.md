...
# Class CircleArea (0.13.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class CircleArea extends GeneratedMessageV3 implements CircleAreaOrBuilder
```

Representation of a circle area.

Protobuf type `google.cloud.visionai.v1.CircleArea`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> CircleArea

## Implements

[CircleAreaOrBuilder](/java/docs/reference/google-cloud-visionai/0.13.0/com.google.cloud.visionai.v1.CircleAreaOrBuilder)
...
### RADIUS\_METER\_FIELD\_NUMBER

```
public static final int RADIUS_METER_FIELD_NUMBER
```
...
`[CircleArea](/java/docs/reference/google-cloud-visionai/0.13.0/com.google.cloud.visionai.v1.CircleArea)`
...
```
public static CircleArea.Builder newBuilder()
```
...
`[CircleArea.Builder](/java/docs/reference/google-cloud-visionai/0.13.0/com.google.cloud.visionai.v1.CircleArea.Builder)`

### newBuilder(CircleArea prototype)

```
public static CircleArea.Builder newBuilder(CircleArea prototype)
```
...
```
public static CircleArea parseDelimitedFrom(InputStream input)
```
...
```
public static CircleArea parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CircleArea parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CircleArea parseFrom(ByteString data)
```
...
```
public static CircleArea parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CircleArea parseFrom(CodedInputStream input)
```
...
```
public static CircleArea parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CircleArea parseFrom(InputStream input)
```
...
```
public static CircleArea parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CircleArea parseFrom(ByteBuffer data)
```
...
```
public static CircleArea parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<CircleArea> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[CircleArea](/java/docs/reference/google-cloud-visionai/0.13.0/com.google.cloud.visionai.v1.CircleArea)>`
...
```
public Parser<CircleArea> getParserForType()
```
...
```
public CircleArea.Builder newBuilderForType()
```
...
```
protected CircleArea.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public CircleArea.Builder toBuilder()
```
