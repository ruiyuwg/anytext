...
# Class GetAlertPolicyRequest (3.8.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class GetAlertPolicyRequest extends GeneratedMessageV3 implements GetAlertPolicyRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> GetAlertPolicyRequest

## Implements

[GetAlertPolicyRequestOrBuilder](/java/docs/reference/google-cloud-monitoring/3.8.0/com.google.monitoring.v3.GetAlertPolicyRequestOrBuilder)
...
```
public static GetAlertPolicyRequest getDefaultInstance()
```
...
[GetAlertPolicyRequest](/java/docs/reference/google-cloud-monitoring/3.8.0/com.google.monitoring.v3.GetAlertPolicyRequest)
...
```
public static GetAlertPolicyRequest.Builder newBuilder()
```
...
[GetAlertPolicyRequest.Builder](/java/docs/reference/google-cloud-monitoring/3.8.0/com.google.monitoring.v3.GetAlertPolicyRequest.Builder)

### newBuilder(GetAlertPolicyRequest prototype)

```
public static GetAlertPolicyRequest.Builder newBuilder(GetAlertPolicyRequest prototype)
```
...
```
public static GetAlertPolicyRequest parseDelimitedFrom(InputStream input)
```
...
```
public static GetAlertPolicyRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetAlertPolicyRequest parseFrom(byte[] data)
```
...
```
public static GetAlertPolicyRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetAlertPolicyRequest parseFrom(ByteString data)
```
...
```
public static GetAlertPolicyRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetAlertPolicyRequest parseFrom(CodedInputStream input)
```
...
```
public static GetAlertPolicyRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetAlertPolicyRequest parseFrom(InputStream input)
```
...
```
public static GetAlertPolicyRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetAlertPolicyRequest parseFrom(ByteBuffer data)
```
...
```
public static GetAlertPolicyRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<GetAlertPolicyRequest> parser()
```
...
[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[GetAlertPolicyRequest](/java/docs/reference/google-cloud-monitoring/3.8.0/com.google.monitoring.v3.GetAlertPolicyRequest)\>
...
Required. The alerting policy to retrieve. The format is: projects/\[PROJECT\_ID\_OR\_NUMBER\]/alertPolicies/\[ALERT\_POLICY\_ID\]
...
```
public Parser<GetAlertPolicyRequest> getParserForType()
```
...
```
public GetAlertPolicyRequest.Builder newBuilderForType()
```
...
```
protected GetAlertPolicyRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public GetAlertPolicyRequest.Builder toBuilder()
```
