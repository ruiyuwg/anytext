...
# Class VodSession.GamSettings (0.37.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class VodSession.GamSettings extends GeneratedMessageV3 implements VodSession.GamSettingsOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> VodSession.GamSettings

## Implements

[VodSession.GamSettingsOrBuilder](/java/docs/reference/google-cloud-video-stitcher/0.37.0/com.google.cloud.video.stitcher.v1.VodSession.GamSettingsOrBuilder)
...
```
public static VodSession.GamSettings getDefaultInstance()
```
...
`[VodSession.GamSettings](/java/docs/reference/google-cloud-video-stitcher/0.37.0/com.google.cloud.video.stitcher.v1.VodSession.GamSettings)`
...
```
public static VodSession.GamSettings.Builder newBuilder()
```
...
`[VodSession.GamSettings.Builder](/java/docs/reference/google-cloud-video-stitcher/0.37.0/com.google.cloud.video.stitcher.v1.VodSession.GamSettings.Builder)`

### newBuilder(VodSession.GamSettings prototype)

```
public static VodSession.GamSettings.Builder newBuilder(VodSession.GamSettings prototype)
```
...
```
public static VodSession.GamSettings parseDelimitedFrom(InputStream input)
```
...
```
public static VodSession.GamSettings parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static VodSession.GamSettings parseFrom(byte[] data)
```
...
```
public static VodSession.GamSettings parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static VodSession.GamSettings parseFrom(ByteString data)
```
...
```
public static VodSession.GamSettings parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static VodSession.GamSettings parseFrom(CodedInputStream input)
```
...
```
public static VodSession.GamSettings parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static VodSession.GamSettings parseFrom(InputStream input)
```
...
```
public static VodSession.GamSettings parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static VodSession.GamSettings parseFrom(ByteBuffer data)
```
...
```
public static VodSession.GamSettings parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<VodSession.GamSettings> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[GamSettings](/java/docs/reference/google-cloud-video-stitcher/0.37.0/com.google.cloud.video.stitcher.v1.VodSession.GamSettings)>`
...
```
public Parser<VodSession.GamSettings> getParserForType()
```
...
```
public VodSession.GamSettings.Builder newBuilderForType()
```
...
```
protected VodSession.GamSettings.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public VodSession.GamSettings.Builder toBuilder()
```
