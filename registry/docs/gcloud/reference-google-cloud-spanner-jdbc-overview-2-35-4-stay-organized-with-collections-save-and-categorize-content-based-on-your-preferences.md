...
# google-cloud-spanner-jdbc overview (2.35.4) Stay organized with collections Save and categorize content based on your preferences.
...
**Google Cloud Spanner JDBC Description:** null

[Google Cloud Spanner JDBC Product Reference](https://cloud.google.com/spanner/docs/use-oss-jdbc)

[GitHub Repository](https://github.com/googleapis/java-spanner-jdbc/tree/main/)

[Maven artifact](https://central.sonatype.com/artifact/com.google.cloud/google-cloud-spanner-jdbc)
...
-   [Enable the API](https://console.cloud.google.com/apis/library/spanner-jdbc.googleapis.com)
-   [Set up authentication](https://cloud.google.com/docs/authentication/client-libraries)

## Use the Google Cloud Spanner JDBC for Java
...
The example below demonstrates how you would import the BOM and include the `google-cloud-spanner-jdbc` artifact.
...
For this library, we recommend using [com.google.cloud.spanner.jdbc](https://cloud.google.com/java/docs/reference/google-cloud-spanner-jdbc/2.35.4/com.google.cloud.spanner.jdbc) for new applications.
