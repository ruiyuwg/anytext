...
# Enum GatewayType (2.16.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-iot/2.16.0/com.google.cloud.iot.v1.GatewayType#com_google_cloud_iot_v1_GatewayType_forNumber_int_) instead._
