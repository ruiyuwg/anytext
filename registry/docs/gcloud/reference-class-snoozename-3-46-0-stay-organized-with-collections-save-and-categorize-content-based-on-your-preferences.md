...
# Class SnoozeName (3.46.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> SnoozeName
...
`[SnoozeName.Builder](/java/docs/reference/google-cloud-monitoring/3.46.0/com.google.monitoring.v3.SnoozeName.Builder)`
...
`[SnoozeName](/java/docs/reference/google-cloud-monitoring/3.46.0/com.google.monitoring.v3.SnoozeName)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[SnoozeName](/java/docs/reference/google-cloud-monitoring/3.46.0/com.google.monitoring.v3.SnoozeName)>`
