...
# Enum OSPolicyAssignmentReport.OSPolicyCompliance.ComplianceState (2.25.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum OSPolicyAssignmentReport.OSPolicyCompliance.ComplianceState extends Enum<OSPolicyAssignmentReport.OSPolicyCompliance.ComplianceState> implements ProtocolMessageEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-os-config/2.25.0/com.google.cloud.osconfig.v1.OSPolicyAssignmentReport.OSPolicyCompliance.ComplianceState#com_google_cloud_osconfig_v1_OSPolicyAssignmentReport_OSPolicyCompliance_ComplianceState_forNumber_int_) instead._
