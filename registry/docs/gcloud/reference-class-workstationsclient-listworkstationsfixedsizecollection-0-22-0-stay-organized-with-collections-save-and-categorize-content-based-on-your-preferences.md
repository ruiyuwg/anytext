...
# Class WorkstationsClient.ListWorkstationsFixedSizeCollection (0.22.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class WorkstationsClient.ListWorkstationsFixedSizeCollection extends AbstractFixedSizeCollection<ListWorkstationsRequest,ListWorkstationsResponse,Workstation,WorkstationsClient.ListWorkstationsPage,WorkstationsClient.ListWorkstationsFixedSizeCollection>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractFixedSizeCollection](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractFixedSizeCollection.html) \> WorkstationsClient.ListWorkstationsFixedSizeCollection
...
### createCollection(List<WorkstationsClient.ListWorkstationsPage> pages, int collectionSize)

```
protected WorkstationsClient.ListWorkstationsFixedSizeCollection createCollection(List<WorkstationsClient.ListWorkstationsPage> pages, int collectionSize)
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ListWorkstationsPage](/java/docs/reference/google-cloud-workstations/0.22.0/com.google.cloud.workstations.v1.WorkstationsClient.ListWorkstationsPage)>`  
...
`[WorkstationsClient.ListWorkstationsFixedSizeCollection](/java/docs/reference/google-cloud-workstations/0.22.0/com.google.cloud.workstations.v1.WorkstationsClient.ListWorkstationsFixedSizeCollection)`
