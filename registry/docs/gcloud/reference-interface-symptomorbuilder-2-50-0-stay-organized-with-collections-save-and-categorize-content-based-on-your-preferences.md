...
# Interface SymptomOrBuilder (2.50.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface SymptomOrBuilder extends MessageOrBuilder
```
...
```
public abstract Symptom.SymptomType getSymptomType()
```
...
`[Symptom.SymptomType](/java/docs/reference/google-cloud-tpu/2.50.0/com.google.cloud.tpu.v1.Symptom.SymptomType)`
...
```
public abstract int getSymptomTypeValue()
```
