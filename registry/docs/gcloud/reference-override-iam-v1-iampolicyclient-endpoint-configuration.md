...
# Override iam\_v1::IAMPolicyClient Endpoint Configuration
  ...
  auto client = google::cloud::iam_v1::IAMPolicyClient(
      google::cloud::iam_v1::MakeIAMPolicyConnection(options));
```
