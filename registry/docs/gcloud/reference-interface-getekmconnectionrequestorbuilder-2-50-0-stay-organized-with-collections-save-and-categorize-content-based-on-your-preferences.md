...
# Interface GetEkmConnectionRequestOrBuilder (2.50.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface GetEkmConnectionRequestOrBuilder extends MessageOrBuilder
```
