...
# Class OperationMetadata (1.43.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> OperationMetadata

## Implements

[OperationMetadataOrBuilder](/java/docs/reference/google-cloud-orchestration-airflow/1.43.0/com.google.cloud.orchestration.airflow.service.v1.OperationMetadataOrBuilder)
...
### OPERATION\_TYPE\_FIELD\_NUMBER
...
### RESOURCE\_UUID\_FIELD\_NUMBER

```
public static final int RESOURCE_UUID_FIELD_NUMBER
```
...
`[OperationMetadata](/java/docs/reference/google-cloud-orchestration-airflow/1.43.0/com.google.cloud.orchestration.airflow.service.v1.OperationMetadata)`
...
`[OperationMetadata.Builder](/java/docs/reference/google-cloud-orchestration-airflow/1.43.0/com.google.cloud.orchestration.airflow.service.v1.OperationMetadata.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[OperationMetadata](/java/docs/reference/google-cloud-orchestration-airflow/1.43.0/com.google.cloud.orchestration.airflow.service.v1.OperationMetadata)>`
...
```
public OperationMetadata.Type getOperationType()
```
...
`[OperationMetadata.Type](/java/docs/reference/google-cloud-orchestration-airflow/1.43.0/com.google.cloud.orchestration.airflow.service.v1.OperationMetadata.Type)`
...
```
public ByteString getResourceUuidBytes()
```
...
`[OperationMetadata.State](/java/docs/reference/google-cloud-orchestration-airflow/1.43.0/com.google.cloud.orchestration.airflow.service.v1.OperationMetadata.State)`
