...
# Google Analytics Admin V1alpha Client - Class BatchUpdateUserLinksRequest (0.10.0) Stay organized with collections Save and categorize content based on your preferences.
...
`array<[Google\Analytics\Admin\V1alpha\UpdateUserLinkRequest](/php/docs/reference/analytics-admin/0.10.0/V1alpha.UpdateUserLinkRequest)>`  
