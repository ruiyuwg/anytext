...
# Interface FolderOrBuilder (2.59.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public abstract ByteString getResourceFolderBytes()
```
...
```
public abstract String getResourceFolderDisplayName()
```
...
```
public abstract ByteString getResourceFolderDisplayNameBytes()
```
