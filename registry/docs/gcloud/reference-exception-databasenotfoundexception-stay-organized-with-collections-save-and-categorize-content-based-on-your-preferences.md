...
# Exception DatabaseNotFoundException Stay organized with collections Save and categorize content based on your preferences.
...
[SpannerException.ResourceNotFoundException.getResourceName()](/java/docs/reference/google-cloud-spanner/6.20.0/com.google.cloud.spanner.SpannerException.ResourceNotFoundException#com_google_cloud_spanner_SpannerException_ResourceNotFoundException_getResourceName__)

[SpannerException.getErrorCode()](/java/docs/reference/google-cloud-spanner/6.20.0/com.google.cloud.spanner.SpannerException#com_google_cloud_spanner_SpannerException_getErrorCode__)

[SpannerException.getRetryDelayInMillis()](/java/docs/reference/google-cloud-spanner/6.20.0/com.google.cloud.spanner.SpannerException#com_google_cloud_spanner_SpannerException_getRetryDelayInMillis__)
