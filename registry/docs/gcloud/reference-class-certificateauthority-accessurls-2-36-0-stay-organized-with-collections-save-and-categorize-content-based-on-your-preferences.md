...
# Class CertificateAuthority.AccessUrls (2.36.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class CertificateAuthority.AccessUrls extends GeneratedMessageV3 implements CertificateAuthority.AccessUrlsOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> CertificateAuthority.AccessUrls

## Implements

[CertificateAuthority.AccessUrlsOrBuilder](/java/docs/reference/google-cloud-security-private-ca/2.36.0/com.google.cloud.security.privateca.v1beta1.CertificateAuthority.AccessUrlsOrBuilder)
...
### CA\_CERTIFICATE\_ACCESS\_URL\_FIELD\_NUMBER

```
public static final int CA_CERTIFICATE_ACCESS_URL_FIELD_NUMBER
```
...
### CRL\_ACCESS\_URL\_FIELD\_NUMBER

```
public static final int CRL_ACCESS_URL_FIELD_NUMBER
```
...
```
public static CertificateAuthority.AccessUrls getDefaultInstance()
```
...
`[CertificateAuthority.AccessUrls](/java/docs/reference/google-cloud-security-private-ca/2.36.0/com.google.cloud.security.privateca.v1beta1.CertificateAuthority.AccessUrls)`
...
```
public static CertificateAuthority.AccessUrls.Builder newBuilder()
```
...
`[CertificateAuthority.AccessUrls.Builder](/java/docs/reference/google-cloud-security-private-ca/2.36.0/com.google.cloud.security.privateca.v1beta1.CertificateAuthority.AccessUrls.Builder)`

### newBuilder(CertificateAuthority.AccessUrls prototype)

```
public static CertificateAuthority.AccessUrls.Builder newBuilder(CertificateAuthority.AccessUrls prototype)
```
...
```
public static CertificateAuthority.AccessUrls parseDelimitedFrom(InputStream input)
```
...
```
public static CertificateAuthority.AccessUrls parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CertificateAuthority.AccessUrls parseFrom(byte[] data)
```
...
```
public static CertificateAuthority.AccessUrls parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CertificateAuthority.AccessUrls parseFrom(ByteString data)
```
...
```
public static CertificateAuthority.AccessUrls parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CertificateAuthority.AccessUrls parseFrom(CodedInputStream input)
```
...
```
public static CertificateAuthority.AccessUrls parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CertificateAuthority.AccessUrls parseFrom(InputStream input)
```
...
```
public static CertificateAuthority.AccessUrls parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CertificateAuthority.AccessUrls parseFrom(ByteBuffer data)
```
...
```
public static CertificateAuthority.AccessUrls parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<CertificateAuthority.AccessUrls> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[AccessUrls](/java/docs/reference/google-cloud-security-private-ca/2.36.0/com.google.cloud.security.privateca.v1beta1.CertificateAuthority.AccessUrls)>`
...
```
public Parser<CertificateAuthority.AccessUrls> getParserForType()
```
...
```
public CertificateAuthority.AccessUrls.Builder newBuilderForType()
```
...
```
protected CertificateAuthority.AccessUrls.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public CertificateAuthority.AccessUrls.Builder toBuilder()
```
