...
# Enum Product.Type (2.6.0) Stay organized with collections Save and categorize content based on your preferences.
...
Default value. Default to Catalog.product\_level\_config.ingestion\_product\_type if unset.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-retail/2.6.0/com.google.cloud.retail.v2beta.Product.Type#com_google_cloud_retail_v2beta_Product_Type_forNumber_int_) instead._
