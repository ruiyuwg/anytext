...
# Interface ExfiltrationOrBuilder (2.47.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[ExfilResource](/java/docs/reference/google-cloud-securitycenter/2.47.0/com.google.cloud.securitycenter.v1.ExfilResource)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ExfilResource](/java/docs/reference/google-cloud-securitycenter/2.47.0/com.google.cloud.securitycenter.v1.ExfilResource)>`
...
`[ExfilResourceOrBuilder](/java/docs/reference/google-cloud-securitycenter/2.47.0/com.google.cloud.securitycenter.v1.ExfilResourceOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.securitycenter.v1.ExfilResourceOrBuilder>`
