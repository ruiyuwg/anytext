...
# Interface BinaryAuthorizationOrBuilder (0.33.0) Stay organized with collections Save and categorize content based on your preferences.
...
`.google.cloud.gkemulticloud.v1.BinaryAuthorization.EvaluationMode evaluation_mode = 1;`
...
`[BinaryAuthorization.EvaluationMode](/java/docs/reference/google-cloud-gke-multi-cloud/0.33.0/com.google.cloud.gkemulticloud.v1.BinaryAuthorization.EvaluationMode)`
