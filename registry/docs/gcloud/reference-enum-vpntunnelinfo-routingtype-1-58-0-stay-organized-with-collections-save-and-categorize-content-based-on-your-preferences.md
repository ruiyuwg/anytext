...
# Enum VpnTunnelInfo.RoutingType (1.58.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-network-management/1.58.0/com.google.cloud.networkmanagement.v1beta1.VpnTunnelInfo.RoutingType#com_google_cloud_networkmanagement_v1beta1_VpnTunnelInfo_RoutingType_forNumber_int_) instead._
