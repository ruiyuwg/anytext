...
# Class SessionsLimitedTimeRetryPolicy (2.37.0) Stay organized with collections Save and categorize content based on your preferences.
...
A retry policy for [`SessionsConnection`](/cpp/docs/reference/dialogflow_cx/2.37.0/classgoogle_1_1cloud_1_1dialogflow__cx_1_1SessionsConnection) based on elapsed time.
...
`SessionsLimitedTimeRetryPolicy const &`  
...
`std::unique_ptr< SessionsRetryPolicy >`

## Type Aliases

### BaseType

**Alias Of**: `SessionsRetryPolicy`
