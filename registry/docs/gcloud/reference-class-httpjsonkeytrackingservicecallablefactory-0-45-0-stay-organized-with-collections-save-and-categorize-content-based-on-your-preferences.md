...
# Class HttpJsonKeyTrackingServiceCallableFactory (0.45.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public class HttpJsonKeyTrackingServiceCallableFactory implements HttpJsonStubCallableFactory<Operation,OperationsStub>
```
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> HttpJsonKeyTrackingServiceCallableFactory
...
```
public HttpJsonKeyTrackingServiceCallableFactory()
```
