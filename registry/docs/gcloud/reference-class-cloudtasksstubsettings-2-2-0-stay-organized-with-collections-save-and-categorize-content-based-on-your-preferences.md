...
# Class CloudTasksStubSettings (2.2.0) Stay organized with collections Save and categorize content based on your preferences.
...
Settings class to configure an instance of [CloudTasksStub](/java/docs/reference/google-cloud-tasks/2.2.0/com.google.cloud.tasks.v2beta3.stub.CloudTasksStub).
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [StubSettings](https://cloud.google.com/java/docs/reference/gax/2.19.2/com.google.api.gax.rpc.StubSettings.html) \> CloudTasksStubSettings
...
[CloudTasksStubSettings.Builder](/java/docs/reference/google-cloud-tasks/2.2.0/com.google.cloud.tasks.v2beta3.stub.CloudTasksStubSettings.Builder)
...
[UnaryCallSettings](https://cloud.google.com/java/docs/reference/gax/2.19.2/com.google.api.gax.rpc.UnaryCallSettings.html)<[CreateQueueRequest](/java/docs/reference/google-cloud-tasks/2.2.0/com.google.cloud.tasks.v2beta3.CreateQueueRequest),[Queue](/java/docs/reference/google-cloud-tasks/2.2.0/com.google.cloud.tasks.v2beta3.Queue)\>
...
[CloudTasksStub](/java/docs/reference/google-cloud-tasks/2.2.0/com.google.cloud.tasks.v2beta3.stub.CloudTasksStub)
...
[UnaryCallSettings](https://cloud.google.com/java/docs/reference/gax/2.19.2/com.google.api.gax.rpc.UnaryCallSettings.html)<[CreateTaskRequest](/java/docs/reference/google-cloud-tasks/2.2.0/com.google.cloud.tasks.v2beta3.CreateTaskRequest),[Task](/java/docs/reference/google-cloud-tasks/2.2.0/com.google.cloud.tasks.v2beta3.Task)\>
...
[UnaryCallSettings](https://cloud.google.com/java/docs/reference/gax/2.19.2/com.google.api.gax.rpc.UnaryCallSettings.html)<[DeleteQueueRequest](/java/docs/reference/google-cloud-tasks/2.2.0/com.google.cloud.tasks.v2beta3.DeleteQueueRequest),[Empty](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Empty.html)\>
...
[UnaryCallSettings](https://cloud.google.com/java/docs/reference/gax/2.19.2/com.google.api.gax.rpc.UnaryCallSettings.html)<[DeleteTaskRequest](/java/docs/reference/google-cloud-tasks/2.2.0/com.google.cloud.tasks.v2beta3.DeleteTaskRequest),[Empty](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Empty.html)\>
...
[UnaryCallSettings](https://cloud.google.com/java/docs/reference/gax/2.19.2/com.google.api.gax.rpc.UnaryCallSettings.html)<com.google.iam.v1.GetIamPolicyRequest,com.google.iam.v1.Policy\>
...
[UnaryCallSettings](https://cloud.google.com/java/docs/reference/gax/2.19.2/com.google.api.gax.rpc.UnaryCallSettings.html)<[GetQueueRequest](/java/docs/reference/google-cloud-tasks/2.2.0/com.google.cloud.tasks.v2beta3.GetQueueRequest),[Queue](/java/docs/reference/google-cloud-tasks/2.2.0/com.google.cloud.tasks.v2beta3.Queue)\>
...
[UnaryCallSettings](https://cloud.google.com/java/docs/reference/gax/2.19.2/com.google.api.gax.rpc.UnaryCallSettings.html)<[GetTaskRequest](/java/docs/reference/google-cloud-tasks/2.2.0/com.google.cloud.tasks.v2beta3.GetTaskRequest),[Task](/java/docs/reference/google-cloud-tasks/2.2.0/com.google.cloud.tasks.v2beta3.Task)\>
...
[PagedCallSettings](https://cloud.google.com/java/docs/reference/gax/2.19.2/com.google.api.gax.rpc.PagedCallSettings.html)<[ListQueuesRequest](/java/docs/reference/google-cloud-tasks/2.2.0/com.google.cloud.tasks.v2beta3.ListQueuesRequest),[ListQueuesResponse](/java/docs/reference/google-cloud-tasks/2.2.0/com.google.cloud.tasks.v2beta3.ListQueuesResponse),[ListQueuesPagedResponse](/java/docs/reference/google-cloud-tasks/2.2.0/com.google.cloud.tasks.v2beta3.CloudTasksClient.ListQueuesPagedResponse)\>
...
[PagedCallSettings](https://cloud.google.com/java/docs/reference/gax/2.19.2/com.google.api.gax.rpc.PagedCallSettings.html)<[ListTasksRequest](/java/docs/reference/google-cloud-tasks/2.2.0/com.google.cloud.tasks.v2beta3.ListTasksRequest),[ListTasksResponse](/java/docs/reference/google-cloud-tasks/2.2.0/com.google.cloud.tasks.v2beta3.ListTasksResponse),[ListTasksPagedResponse](/java/docs/reference/google-cloud-tasks/2.2.0/com.google.cloud.tasks.v2beta3.CloudTasksClient.ListTasksPagedResponse)\>
...
[UnaryCallSettings](https://cloud.google.com/java/docs/reference/gax/2.19.2/com.google.api.gax.rpc.UnaryCallSettings.html)<[PauseQueueRequest](/java/docs/reference/google-cloud-tasks/2.2.0/com.google.cloud.tasks.v2beta3.PauseQueueRequest),[Queue](/java/docs/reference/google-cloud-tasks/2.2.0/com.google.cloud.tasks.v2beta3.Queue)\>
...
[UnaryCallSettings](https://cloud.google.com/java/docs/reference/gax/2.19.2/com.google.api.gax.rpc.UnaryCallSettings.html)<[PurgeQueueRequest](/java/docs/reference/google-cloud-tasks/2.2.0/com.google.cloud.tasks.v2beta3.PurgeQueueRequest),[Queue](/java/docs/reference/google-cloud-tasks/2.2.0/com.google.cloud.tasks.v2beta3.Queue)\>
...
[UnaryCallSettings](https://cloud.google.com/java/docs/reference/gax/2.19.2/com.google.api.gax.rpc.UnaryCallSettings.html)<[ResumeQueueRequest](/java/docs/reference/google-cloud-tasks/2.2.0/com.google.cloud.tasks.v2beta3.ResumeQueueRequest),[Queue](/java/docs/reference/google-cloud-tasks/2.2.0/com.google.cloud.tasks.v2beta3.Queue)\>
...
[UnaryCallSettings](https://cloud.google.com/java/docs/reference/gax/2.19.2/com.google.api.gax.rpc.UnaryCallSettings.html)<[RunTaskRequest](/java/docs/reference/google-cloud-tasks/2.2.0/com.google.cloud.tasks.v2beta3.RunTaskRequest),[Task](/java/docs/reference/google-cloud-tasks/2.2.0/com.google.cloud.tasks.v2beta3.Task)\>
...
[UnaryCallSettings](https://cloud.google.com/java/docs/reference/gax/2.19.2/com.google.api.gax.rpc.UnaryCallSettings.html)<com.google.iam.v1.SetIamPolicyRequest,com.google.iam.v1.Policy\>
...
[UnaryCallSettings](https://cloud.google.com/java/docs/reference/gax/2.19.2/com.google.api.gax.rpc.UnaryCallSettings.html)<com.google.iam.v1.TestIamPermissionsRequest,com.google.iam.v1.TestIamPermissionsResponse\>
...
[UnaryCallSettings](https://cloud.google.com/java/docs/reference/gax/2.19.2/com.google.api.gax.rpc.UnaryCallSettings.html)<[UpdateQueueRequest](/java/docs/reference/google-cloud-tasks/2.2.0/com.google.cloud.tasks.v2beta3.UpdateQueueRequest),[Queue](/java/docs/reference/google-cloud-tasks/2.2.0/com.google.cloud.tasks.v2beta3.Queue)\>
