...
# Class Owner (2.21.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[Owner](/java/docs/reference/google-cloud-storage/2.21.0/com.google.storage.v2.Owner)`
...
`[Owner.Builder](/java/docs/reference/google-cloud-storage/2.21.0/com.google.storage.v2.Owner.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[Owner](/java/docs/reference/google-cloud-storage/2.21.0/com.google.storage.v2.Owner)>`
...
The entity, in the form `user-`_userId_.
