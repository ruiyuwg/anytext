...
# Class ExecutionsStubSettings.Builder (2.13.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class ExecutionsStubSettings.Builder extends StubSettings.Builder<ExecutionsStubSettings,ExecutionsStubSettings.Builder>
```
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [StubSettings.Builder](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.StubSettings.Builder.html) \> ExecutionsStubSettings.Builder
...
### Builder(ExecutionsStubSettings settings)
...
`[ExecutionsStubSettings](/java/docs/reference/google-cloud-workflow-executions/2.13.0/com.google.cloud.workflows.executions.v1beta.stub.ExecutionsStubSettings)`  
...
```
public ExecutionsStubSettings.Builder applyToAllUnaryMethods(ApiFunction<UnaryCallSettings.Builder<?,?>,Void> settingsUpdater)
```
...
`[ExecutionsStubSettings.Builder](/java/docs/reference/google-cloud-workflow-executions/2.13.0/com.google.cloud.workflows.executions.v1beta.stub.ExecutionsStubSettings.Builder)`

### build()

```
public ExecutionsStubSettings build()
```
...
`[Builder](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.Builder.html)<[CancelExecutionRequest](/java/docs/reference/google-cloud-workflow-executions/2.13.0/com.google.cloud.workflows.executions.v1beta.CancelExecutionRequest),[Execution](/java/docs/reference/google-cloud-workflow-executions/2.13.0/com.google.cloud.workflows.executions.v1beta.Execution)>`
...
`[Builder](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.Builder.html)<[CreateExecutionRequest](/java/docs/reference/google-cloud-workflow-executions/2.13.0/com.google.cloud.workflows.executions.v1beta.CreateExecutionRequest),[Execution](/java/docs/reference/google-cloud-workflow-executions/2.13.0/com.google.cloud.workflows.executions.v1beta.Execution)>`
...
`[Builder](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.Builder.html)<[GetExecutionRequest](/java/docs/reference/google-cloud-workflow-executions/2.13.0/com.google.cloud.workflows.executions.v1beta.GetExecutionRequest),[Execution](/java/docs/reference/google-cloud-workflow-executions/2.13.0/com.google.cloud.workflows.executions.v1beta.Execution)>`
...
`[Builder](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PagedCallSettings.Builder.html)<[ListExecutionsRequest](/java/docs/reference/google-cloud-workflow-executions/2.13.0/com.google.cloud.workflows.executions.v1beta.ListExecutionsRequest),[ListExecutionsResponse](/java/docs/reference/google-cloud-workflow-executions/2.13.0/com.google.cloud.workflows.executions.v1beta.ListExecutionsResponse),[ListExecutionsPagedResponse](/java/docs/reference/google-cloud-workflow-executions/2.13.0/com.google.cloud.workflows.executions.v1beta.ExecutionsClient.ListExecutionsPagedResponse)>`
