...
# Interface CreateModelRequestOrBuilder (2.45.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[Model](/java/docs/reference/google-cloud-retail/2.45.0/com.google.cloud.retail.v2.Model)`
...
`[ModelOrBuilder](/java/docs/reference/google-cloud-retail/2.45.0/com.google.cloud.retail.v2.ModelOrBuilder)`
