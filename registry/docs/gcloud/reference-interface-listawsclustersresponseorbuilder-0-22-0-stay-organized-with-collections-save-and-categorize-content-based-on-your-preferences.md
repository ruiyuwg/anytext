...
# Interface ListAwsClustersResponseOrBuilder (0.22.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[AwsCluster](/java/docs/reference/google-cloud-gke-multi-cloud/0.22.0/com.google.cloud.gkemulticloud.v1.AwsCluster)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[AwsCluster](/java/docs/reference/google-cloud-gke-multi-cloud/0.22.0/com.google.cloud.gkemulticloud.v1.AwsCluster)>`
...
`[AwsClusterOrBuilder](/java/docs/reference/google-cloud-gke-multi-cloud/0.22.0/com.google.cloud.gkemulticloud.v1.AwsClusterOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.gkemulticloud.v1.AwsClusterOrBuilder>`
