...
# Class SecurityCenterClient.ListMuteConfigsFixedSizeCollection (2.62.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class SecurityCenterClient.ListMuteConfigsFixedSizeCollection extends AbstractFixedSizeCollection<ListMuteConfigsRequest,ListMuteConfigsResponse,MuteConfig,SecurityCenterClient.ListMuteConfigsPage,SecurityCenterClient.ListMuteConfigsFixedSizeCollection>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractFixedSizeCollection](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractFixedSizeCollection.html) \> SecurityCenterClient.ListMuteConfigsFixedSizeCollection
...
### createCollection(List<SecurityCenterClient.ListMuteConfigsPage> pages, int collectionSize)

```
protected SecurityCenterClient.ListMuteConfigsFixedSizeCollection createCollection(List<SecurityCenterClient.ListMuteConfigsPage> pages, int collectionSize)
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ListMuteConfigsPage](/java/docs/reference/google-cloud-securitycenter/2.62.0/com.google.cloud.securitycenter.v1.SecurityCenterClient.ListMuteConfigsPage)>`  
...
`[SecurityCenterClient.ListMuteConfigsFixedSizeCollection](/java/docs/reference/google-cloud-securitycenter/2.62.0/com.google.cloud.securitycenter.v1.SecurityCenterClient.ListMuteConfigsFixedSizeCollection)`
