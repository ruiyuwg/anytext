...
# Class FetchCaCertsRequest (2.23.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class FetchCaCertsRequest extends GeneratedMessageV3 implements FetchCaCertsRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> FetchCaCertsRequest

## Implements

[FetchCaCertsRequestOrBuilder](/java/docs/reference/google-cloud-security-private-ca/2.23.0/com.google.cloud.security.privateca.v1.FetchCaCertsRequestOrBuilder)
...
```
public static FetchCaCertsRequest getDefaultInstance()
```
...
`[FetchCaCertsRequest](/java/docs/reference/google-cloud-security-private-ca/2.23.0/com.google.cloud.security.privateca.v1.FetchCaCertsRequest)`
...
```
public static FetchCaCertsRequest.Builder newBuilder()
```
...
`[FetchCaCertsRequest.Builder](/java/docs/reference/google-cloud-security-private-ca/2.23.0/com.google.cloud.security.privateca.v1.FetchCaCertsRequest.Builder)`

### newBuilder(FetchCaCertsRequest prototype)

```
public static FetchCaCertsRequest.Builder newBuilder(FetchCaCertsRequest prototype)
```
...
```
public static FetchCaCertsRequest parseDelimitedFrom(InputStream input)
```
...
```
public static FetchCaCertsRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static FetchCaCertsRequest parseFrom(byte[] data)
```
...
```
public static FetchCaCertsRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static FetchCaCertsRequest parseFrom(ByteString data)
```
...
```
public static FetchCaCertsRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static FetchCaCertsRequest parseFrom(CodedInputStream input)
```
...
```
public static FetchCaCertsRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static FetchCaCertsRequest parseFrom(InputStream input)
```
...
```
public static FetchCaCertsRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static FetchCaCertsRequest parseFrom(ByteBuffer data)
```
...
```
public static FetchCaCertsRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<FetchCaCertsRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[FetchCaCertsRequest](/java/docs/reference/google-cloud-security-private-ca/2.23.0/com.google.cloud.security.privateca.v1.FetchCaCertsRequest)>`
...
```
public Parser<FetchCaCertsRequest> getParserForType()
```
...
```
public FetchCaCertsRequest.Builder newBuilderForType()
```
...
```
protected FetchCaCertsRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public FetchCaCertsRequest.Builder toBuilder()
```
