...
# Class ProjectName (2.18.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[ProjectName.Builder](/java/docs/reference/google-cloud-secretmanager/2.18.0/com.google.cloud.secretmanager.v1.ProjectName.Builder)`
...
`[ProjectName](/java/docs/reference/google-cloud-secretmanager/2.18.0/com.google.cloud.secretmanager.v1.ProjectName)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ProjectName](/java/docs/reference/google-cloud-secretmanager/2.18.0/com.google.cloud.secretmanager.v1.ProjectName)>`
