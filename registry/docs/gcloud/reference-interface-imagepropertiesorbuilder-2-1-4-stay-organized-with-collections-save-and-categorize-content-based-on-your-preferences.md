...
# Interface ImagePropertiesOrBuilder (2.1.4) Stay organized with collections Save and categorize content based on your preferences.
...
```
public abstract DominantColorsAnnotation getDominantColors()
```
...
[DominantColorsAnnotation](/java/docs/reference/google-cloud-vision/2.1.4/com.google.cloud.vision.v1p4beta1.DominantColorsAnnotation)
...
```
public abstract DominantColorsAnnotationOrBuilder getDominantColorsOrBuilder()
```
...
[DominantColorsAnnotationOrBuilder](/java/docs/reference/google-cloud-vision/2.1.4/com.google.cloud.vision.v1p4beta1.DominantColorsAnnotationOrBuilder)

### hasDominantColors()

```
public abstract boolean hasDominantColors()
```
