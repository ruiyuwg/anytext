...
# Compute Engine v1 API - Class NetworkEndpointGroupsListEndpointsRequest (3.26.0) Stay organized with collections Save and categorize content based on your preferences.
...
[object](https://learn.microsoft.com/dotnet/api/system.object) \> NetworkEndpointGroupsListEndpointsRequest

## Implements

[IMessage](https://cloud.google.com/dotnet/docs/reference/Google.Protobuf/latest/Google.Protobuf.IMessage-1.html)[NetworkEndpointGroupsListEndpointsRequest](/dotnet/docs/reference/Google.Cloud.Compute.V1/latest/Google.Cloud.Compute.V1.NetworkEndpointGroupsListEndpointsRequest), [IEquatable](https://learn.microsoft.com/dotnet/api/system.iequatable-1)[NetworkEndpointGroupsListEndpointsRequest](/dotnet/docs/reference/Google.Cloud.Compute.V1/latest/Google.Cloud.Compute.V1.NetworkEndpointGroupsListEndpointsRequest), [IDeepCloneable](https://cloud.google.com/dotnet/docs/reference/Google.Protobuf/latest/Google.Protobuf.IDeepCloneable-1.html)[NetworkEndpointGroupsListEndpointsRequest](/dotnet/docs/reference/Google.Cloud.Compute.V1/latest/Google.Cloud.Compute.V1.NetworkEndpointGroupsListEndpointsRequest), [IBufferMessage](https://cloud.google.com/dotnet/docs/reference/Google.Protobuf/latest/Google.Protobuf.IBufferMessage.html), [IMessage](https://cloud.google.com/dotnet/docs/reference/Google.Protobuf/latest/Google.Protobuf.IMessage.html)
...
`[NetworkEndpointGroupsListEndpointsRequest](/dotnet/docs/reference/Google.Cloud.Compute.V1/latest/Google.Cloud.Compute.V1.NetworkEndpointGroupsListEndpointsRequest)`  
...
Gets whether the "health\_status" field is set
