...
# Class ManagedPrometheusConfig.Builder (2.90.0) Stay organized with collections Save and categorize content based on your preferences.
...
Protobuf type `google.container.v1beta1.ManagedPrometheusConfig`

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessage.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessage.Builder.html) \> ManagedPrometheusConfig.Builder

## Implements

[ManagedPrometheusConfigOrBuilder](/java/docs/reference/google-cloud-container/latest/com.google.container.v1beta1.ManagedPrometheusConfigOrBuilder)
...
`[ManagedPrometheusConfig](/java/docs/reference/google-cloud-container/latest/com.google.container.v1beta1.ManagedPrometheusConfig)`
...
`[ManagedPrometheusConfig.Builder](/java/docs/reference/google-cloud-container/latest/com.google.container.v1beta1.ManagedPrometheusConfig.Builder)`
...
```
public ManagedPrometheusConfig.Builder clearAutoMonitoringConfig()
```

GKE Workload Auto-Monitoring Configuration.

`.google.container.v1beta1.AutoMonitoringConfig auto_monitoring_config = 2;`
...
`[AutoMonitoringConfig](/java/docs/reference/google-cloud-container/latest/com.google.container.v1beta1.AutoMonitoringConfig)`

The autoMonitoringConfig.

### getAutoMonitoringConfigBuilder()

```
public AutoMonitoringConfig.Builder getAutoMonitoringConfigBuilder()
```
...
`[AutoMonitoringConfig.Builder](/java/docs/reference/google-cloud-container/latest/com.google.container.v1beta1.AutoMonitoringConfig.Builder)`

### getAutoMonitoringConfigOrBuilder()

```
public AutoMonitoringConfigOrBuilder getAutoMonitoringConfigOrBuilder()
```
...
`[AutoMonitoringConfigOrBuilder](/java/docs/reference/google-cloud-container/latest/com.google.container.v1beta1.AutoMonitoringConfigOrBuilder)`
...
Whether the autoMonitoringConfig field is set.
...
### mergeAutoMonitoringConfig(AutoMonitoringConfig value)

```
public ManagedPrometheusConfig.Builder mergeAutoMonitoringConfig(AutoMonitoringConfig value)
```
...
### setAutoMonitoringConfig(AutoMonitoringConfig value)

```
public ManagedPrometheusConfig.Builder setAutoMonitoringConfig(AutoMonitoringConfig value)
```
...
### setAutoMonitoringConfig(AutoMonitoringConfig.Builder builderForValue)

```
public ManagedPrometheusConfig.Builder setAutoMonitoringConfig(AutoMonitoringConfig.Builder builderForValue)
```
