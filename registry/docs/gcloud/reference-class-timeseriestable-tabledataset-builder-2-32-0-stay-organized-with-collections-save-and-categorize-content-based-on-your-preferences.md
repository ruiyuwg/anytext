...
# Class TimeSeriesTable.TableDataSet.Builder (2.32.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> TimeSeriesTable.TableDataSet.Builder

## Implements

[TimeSeriesTable.TableDataSetOrBuilder](/java/docs/reference/google-cloud-monitoring-dashboard/2.32.0/com.google.monitoring.dashboard.v1.TimeSeriesTable.TableDataSetOrBuilder)
...
`[TimeSeriesTable.TableDataSet.Builder](/java/docs/reference/google-cloud-monitoring-dashboard/2.32.0/com.google.monitoring.dashboard.v1.TimeSeriesTable.TableDataSet.Builder)`
...
`[TimeSeriesTable.TableDataSet](/java/docs/reference/google-cloud-monitoring-dashboard/2.32.0/com.google.monitoring.dashboard.v1.TimeSeriesTable.TableDataSet)`
...
Optional. A template string for naming `TimeSeries` in the resulting data set. This should be a string with interpolations of the form `${label_name}`, which will resolve to the label's value i.e. "${resource.labels.project\_id}."
...
`[TableDisplayOptions](/java/docs/reference/google-cloud-monitoring-dashboard/2.32.0/com.google.monitoring.dashboard.v1.TableDisplayOptions)`
...
`[TableDisplayOptions.Builder](/java/docs/reference/google-cloud-monitoring-dashboard/2.32.0/com.google.monitoring.dashboard.v1.TableDisplayOptions.Builder)`
...
`[TableDisplayOptionsOrBuilder](/java/docs/reference/google-cloud-monitoring-dashboard/2.32.0/com.google.monitoring.dashboard.v1.TableDisplayOptionsOrBuilder)`
...
`[TimeSeriesQuery](/java/docs/reference/google-cloud-monitoring-dashboard/2.32.0/com.google.monitoring.dashboard.v1.TimeSeriesQuery)`
...
`[TimeSeriesQuery.Builder](/java/docs/reference/google-cloud-monitoring-dashboard/2.32.0/com.google.monitoring.dashboard.v1.TimeSeriesQuery.Builder)`
...
`[TimeSeriesQueryOrBuilder](/java/docs/reference/google-cloud-monitoring-dashboard/2.32.0/com.google.monitoring.dashboard.v1.TimeSeriesQueryOrBuilder)`
