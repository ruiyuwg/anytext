...
# Class Inventory.VersionedPackage (2.89.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class Inventory.VersionedPackage extends GeneratedMessage implements Inventory.VersionedPackageOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessage.html) \> Inventory.VersionedPackage

## Implements

[Inventory.VersionedPackageOrBuilder](/java/docs/reference/google-cloud-os-config/latest/com.google.cloud.osconfig.v1.Inventory.VersionedPackageOrBuilder)
...
```
public static Inventory.VersionedPackage getDefaultInstance()
```
...
`[Inventory.VersionedPackage](/java/docs/reference/google-cloud-os-config/latest/com.google.cloud.osconfig.v1.Inventory.VersionedPackage)`
...
```
public static Inventory.VersionedPackage.Builder newBuilder()
```
...
`[Inventory.VersionedPackage.Builder](/java/docs/reference/google-cloud-os-config/latest/com.google.cloud.osconfig.v1.Inventory.VersionedPackage.Builder)`

### newBuilder(Inventory.VersionedPackage prototype)

```
public static Inventory.VersionedPackage.Builder newBuilder(Inventory.VersionedPackage prototype)
```
...
```
public static Inventory.VersionedPackage parseDelimitedFrom(InputStream input)
```
...
```
public static Inventory.VersionedPackage parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Inventory.VersionedPackage parseFrom(byte[] data)
```
...
```
public static Inventory.VersionedPackage parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Inventory.VersionedPackage parseFrom(ByteString data)
```
...
```
public static Inventory.VersionedPackage parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Inventory.VersionedPackage parseFrom(CodedInputStream input)
```
...
```
public static Inventory.VersionedPackage parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Inventory.VersionedPackage parseFrom(InputStream input)
```
...
```
public static Inventory.VersionedPackage parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Inventory.VersionedPackage parseFrom(ByteBuffer data)
```
...
```
public static Inventory.VersionedPackage parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<Inventory.VersionedPackage> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[VersionedPackage](/java/docs/reference/google-cloud-os-config/latest/com.google.cloud.osconfig.v1.Inventory.VersionedPackage)>`
...
```
public Parser<Inventory.VersionedPackage> getParserForType()
```
...
```
public Inventory.VersionedPackage.Builder newBuilderForType()
```
...
```
protected Inventory.VersionedPackage.Builder newBuilderForType(AbstractMessage.BuilderParent parent)
```
...
```
public Inventory.VersionedPackage.Builder toBuilder()
```
