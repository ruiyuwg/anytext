...
# Interface IamBindingOrBuilder (2.54.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public abstract IamBinding.Action getAction()
```
...
`[IamBinding.Action](/java/docs/reference/google-cloud-securitycenter/2.54.0/com.google.cloud.securitycenter.v1.IamBinding.Action)`
...
```
public abstract ByteString getMemberBytes()
```
