...
# Class ComposeObjectRequest.SourceObject (2.8.1) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class ComposeObjectRequest.SourceObject extends GeneratedMessageV3 implements ComposeObjectRequest.SourceObjectOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ComposeObjectRequest.SourceObject

## Implements

[ComposeObjectRequest.SourceObjectOrBuilder](/java/docs/reference/google-cloud-storage/2.8.1/com.google.storage.v2.ComposeObjectRequest.SourceObjectOrBuilder)
...
### OBJECT\_PRECONDITIONS\_FIELD\_NUMBER

```
public static final int OBJECT_PRECONDITIONS_FIELD_NUMBER
```
...
```
public static ComposeObjectRequest.SourceObject getDefaultInstance()
```
...
[ComposeObjectRequest.SourceObject](/java/docs/reference/google-cloud-storage/2.8.1/com.google.storage.v2.ComposeObjectRequest.SourceObject)
...
```
public static ComposeObjectRequest.SourceObject.Builder newBuilder()
```
...
[ComposeObjectRequest.SourceObject.Builder](/java/docs/reference/google-cloud-storage/2.8.1/com.google.storage.v2.ComposeObjectRequest.SourceObject.Builder)

### newBuilder(ComposeObjectRequest.SourceObject prototype)

```
public static ComposeObjectRequest.SourceObject.Builder newBuilder(ComposeObjectRequest.SourceObject prototype)
```
...
```
public static ComposeObjectRequest.SourceObject parseDelimitedFrom(InputStream input)
```
...
```
public static ComposeObjectRequest.SourceObject parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ComposeObjectRequest.SourceObject parseFrom(byte[] data)
```
...
```
public static ComposeObjectRequest.SourceObject parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ComposeObjectRequest.SourceObject parseFrom(ByteString data)
```
...
```
public static ComposeObjectRequest.SourceObject parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ComposeObjectRequest.SourceObject parseFrom(CodedInputStream input)
```
...
```
public static ComposeObjectRequest.SourceObject parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ComposeObjectRequest.SourceObject parseFrom(InputStream input)
```
...
```
public static ComposeObjectRequest.SourceObject parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ComposeObjectRequest.SourceObject parseFrom(ByteBuffer data)
```
...
```
public static ComposeObjectRequest.SourceObject parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ComposeObjectRequest.SourceObject> parser()
```
...
[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[SourceObject](/java/docs/reference/google-cloud-storage/2.8.1/com.google.storage.v2.ComposeObjectRequest.SourceObject)\>
...
[ComposeObjectRequest.SourceObject.ObjectPreconditions](/java/docs/reference/google-cloud-storage/2.8.1/com.google.storage.v2.ComposeObjectRequest.SourceObject.ObjectPreconditions)
...
[ComposeObjectRequest.SourceObject.ObjectPreconditionsOrBuilder](/java/docs/reference/google-cloud-storage/2.8.1/com.google.storage.v2.ComposeObjectRequest.SourceObject.ObjectPreconditionsOrBuilder)

### getParserForType()

```
public Parser<ComposeObjectRequest.SourceObject> getParserForType()
```
...
```
public ComposeObjectRequest.SourceObject.Builder newBuilderForType()
```
...
```
protected ComposeObjectRequest.SourceObject.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ComposeObjectRequest.SourceObject.Builder toBuilder()
```
