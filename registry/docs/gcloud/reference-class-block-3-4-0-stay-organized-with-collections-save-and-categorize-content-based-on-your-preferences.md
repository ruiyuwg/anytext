...
# Class Block (3.4.0) Stay organized with collections Save and categorize content based on your preferences.
...
### BLOCK\_TYPE\_FIELD\_NUMBER

```
public static final int BLOCK_TYPE_FIELD_NUMBER
```
...
[Block](/java/docs/reference/google-cloud-vision/3.4.0/com.google.cloud.vision.v1p4beta1.Block)
...
```
public static Block.Builder newBuilder()
```
...
[Block.Builder](/java/docs/reference/google-cloud-vision/3.4.0/com.google.cloud.vision.v1p4beta1.Block.Builder)

### newBuilder(Block prototype)

```
public static Block.Builder newBuilder(Block prototype)
```
...
```
public static Block parseDelimitedFrom(InputStream input)
```
...
```
public static Block parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Block parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Block parseFrom(ByteString data)
```
...
```
public static Block parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Block parseFrom(CodedInputStream input)
```
...
```
public static Block parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Block parseFrom(InputStream input)
```
...
```
public static Block parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Block parseFrom(ByteBuffer data)
```
...
```
public static Block parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[Block](/java/docs/reference/google-cloud-vision/3.4.0/com.google.cloud.vision.v1p4beta1.Block)\>
...
[Block.BlockType](/java/docs/reference/google-cloud-vision/3.4.0/com.google.cloud.vision.v1p4beta1.Block.BlockType)
...
[Paragraph](/java/docs/reference/google-cloud-vision/3.4.0/com.google.cloud.vision.v1p4beta1.Paragraph)
...
[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Paragraph](/java/docs/reference/google-cloud-vision/3.4.0/com.google.cloud.vision.v1p4beta1.Paragraph)\>
...
[ParagraphOrBuilder](/java/docs/reference/google-cloud-vision/3.4.0/com.google.cloud.vision.v1p4beta1.ParagraphOrBuilder)
...
[TextAnnotation.TextProperty](/java/docs/reference/google-cloud-vision/3.4.0/com.google.cloud.vision.v1p4beta1.TextAnnotation.TextProperty)
...
[TextAnnotation.TextPropertyOrBuilder](/java/docs/reference/google-cloud-vision/3.4.0/com.google.cloud.vision.v1p4beta1.TextAnnotation.TextPropertyOrBuilder)
...
```
public Block.Builder newBuilderForType()
```
...
```
protected Block.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
