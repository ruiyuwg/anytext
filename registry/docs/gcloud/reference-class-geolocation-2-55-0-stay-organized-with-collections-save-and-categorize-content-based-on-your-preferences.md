...
# Class Geolocation (2.55.0) Stay organized with collections Save and categorize content based on your preferences.
...
Protobuf type `google.cloud.securitycenter.v2.Geolocation`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> Geolocation

## Implements

[GeolocationOrBuilder](/java/docs/reference/google-cloud-securitycenter/2.55.0/com.google.cloud.securitycenter.v2.GeolocationOrBuilder)
...
`[Geolocation](/java/docs/reference/google-cloud-securitycenter/2.55.0/com.google.cloud.securitycenter.v2.Geolocation)`
...
```
public static Geolocation.Builder newBuilder()
```
...
`[Geolocation.Builder](/java/docs/reference/google-cloud-securitycenter/2.55.0/com.google.cloud.securitycenter.v2.Geolocation.Builder)`

### newBuilder(Geolocation prototype)

```
public static Geolocation.Builder newBuilder(Geolocation prototype)
```
...
```
public static Geolocation parseDelimitedFrom(InputStream input)
```
...
```
public static Geolocation parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Geolocation parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Geolocation parseFrom(ByteString data)
```
...
```
public static Geolocation parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Geolocation parseFrom(CodedInputStream input)
```
...
```
public static Geolocation parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Geolocation parseFrom(InputStream input)
```
...
```
public static Geolocation parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Geolocation parseFrom(ByteBuffer data)
```
...
```
public static Geolocation parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[Geolocation](/java/docs/reference/google-cloud-securitycenter/2.55.0/com.google.cloud.securitycenter.v2.Geolocation)>`
...
```
public Geolocation.Builder newBuilderForType()
```
...
```
protected Geolocation.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
