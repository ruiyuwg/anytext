...
# Class PatchDeployments.UpdatePatchDeploymentRequest (2.50.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class PatchDeployments.UpdatePatchDeploymentRequest extends GeneratedMessageV3 implements PatchDeployments.UpdatePatchDeploymentRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> PatchDeployments.UpdatePatchDeploymentRequest

## Implements

[PatchDeployments.UpdatePatchDeploymentRequestOrBuilder](/java/docs/reference/google-cloud-os-config/2.50.0/com.google.cloud.osconfig.v1.PatchDeployments.UpdatePatchDeploymentRequestOrBuilder)
...
### PATCH\_DEPLOYMENT\_FIELD\_NUMBER
...
```
public static PatchDeployments.UpdatePatchDeploymentRequest getDefaultInstance()
```
...
`[PatchDeployments.UpdatePatchDeploymentRequest](/java/docs/reference/google-cloud-os-config/2.50.0/com.google.cloud.osconfig.v1.PatchDeployments.UpdatePatchDeploymentRequest)`
...
```
public static PatchDeployments.UpdatePatchDeploymentRequest.Builder newBuilder()
```
...
`[PatchDeployments.UpdatePatchDeploymentRequest.Builder](/java/docs/reference/google-cloud-os-config/2.50.0/com.google.cloud.osconfig.v1.PatchDeployments.UpdatePatchDeploymentRequest.Builder)`

### newBuilder(PatchDeployments.UpdatePatchDeploymentRequest prototype)

```
public static PatchDeployments.UpdatePatchDeploymentRequest.Builder newBuilder(PatchDeployments.UpdatePatchDeploymentRequest prototype)
```
...
```
public static PatchDeployments.UpdatePatchDeploymentRequest parseDelimitedFrom(InputStream input)
```
...
```
public static PatchDeployments.UpdatePatchDeploymentRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PatchDeployments.UpdatePatchDeploymentRequest parseFrom(byte[] data)
```
...
```
public static PatchDeployments.UpdatePatchDeploymentRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PatchDeployments.UpdatePatchDeploymentRequest parseFrom(ByteString data)
```
...
```
public static PatchDeployments.UpdatePatchDeploymentRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PatchDeployments.UpdatePatchDeploymentRequest parseFrom(CodedInputStream input)
```
...
```
public static PatchDeployments.UpdatePatchDeploymentRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PatchDeployments.UpdatePatchDeploymentRequest parseFrom(InputStream input)
```
...
```
public static PatchDeployments.UpdatePatchDeploymentRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PatchDeployments.UpdatePatchDeploymentRequest parseFrom(ByteBuffer data)
```
...
```
public static PatchDeployments.UpdatePatchDeploymentRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<PatchDeployments.UpdatePatchDeploymentRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[UpdatePatchDeploymentRequest](/java/docs/reference/google-cloud-os-config/2.50.0/com.google.cloud.osconfig.v1.PatchDeployments.UpdatePatchDeploymentRequest)>`
...
```
public PatchDeployments.UpdatePatchDeploymentRequest getDefaultInstanceForType()
```
...
```
public Parser<PatchDeployments.UpdatePatchDeploymentRequest> getParserForType()
```
...
`[PatchDeployments.PatchDeployment](/java/docs/reference/google-cloud-os-config/2.50.0/com.google.cloud.osconfig.v1.PatchDeployments.PatchDeployment)`
...
`[PatchDeployments.PatchDeploymentOrBuilder](/java/docs/reference/google-cloud-os-config/2.50.0/com.google.cloud.osconfig.v1.PatchDeployments.PatchDeploymentOrBuilder)`
...
```
public PatchDeployments.UpdatePatchDeploymentRequest.Builder newBuilderForType()
```
...
```
protected PatchDeployments.UpdatePatchDeploymentRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public PatchDeployments.UpdatePatchDeploymentRequest.Builder toBuilder()
```
