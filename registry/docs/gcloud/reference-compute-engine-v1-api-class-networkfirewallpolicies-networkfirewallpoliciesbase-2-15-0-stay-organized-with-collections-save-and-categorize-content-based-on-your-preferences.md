...
# Compute Engine v1 API - Class NetworkFirewallPolicies.NetworkFirewallPoliciesBase (2.15.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[AddAssociationNetworkFirewallPolicyRequest](/dotnet/docs/reference/Google.Cloud.Compute.V1/2.15.0/Google.Cloud.Compute.V1.AddAssociationNetworkFirewallPolicyRequest)`  
...
`[Task](https://learn.microsoft.com/dotnet/api/system.threading.tasks.task-1)[Operation](/dotnet/docs/reference/Google.Cloud.Compute.V1/2.15.0/Google.Cloud.Compute.V1.Operation)`
...
`[AddRuleNetworkFirewallPolicyRequest](/dotnet/docs/reference/Google.Cloud.Compute.V1/2.15.0/Google.Cloud.Compute.V1.AddRuleNetworkFirewallPolicyRequest)`  
...
`[CloneRulesNetworkFirewallPolicyRequest](/dotnet/docs/reference/Google.Cloud.Compute.V1/2.15.0/Google.Cloud.Compute.V1.CloneRulesNetworkFirewallPolicyRequest)`  
...
`[DeleteNetworkFirewallPolicyRequest](/dotnet/docs/reference/Google.Cloud.Compute.V1/2.15.0/Google.Cloud.Compute.V1.DeleteNetworkFirewallPolicyRequest)`  
...
`[GetNetworkFirewallPolicyRequest](/dotnet/docs/reference/Google.Cloud.Compute.V1/2.15.0/Google.Cloud.Compute.V1.GetNetworkFirewallPolicyRequest)`  
...
`[Task](https://learn.microsoft.com/dotnet/api/system.threading.tasks.task-1)[FirewallPolicy](/dotnet/docs/reference/Google.Cloud.Compute.V1/2.15.0/Google.Cloud.Compute.V1.FirewallPolicy)`
...
`[GetAssociationNetworkFirewallPolicyRequest](/dotnet/docs/reference/Google.Cloud.Compute.V1/2.15.0/Google.Cloud.Compute.V1.GetAssociationNetworkFirewallPolicyRequest)`  
...
`[Task](https://learn.microsoft.com/dotnet/api/system.threading.tasks.task-1)[FirewallPolicyAssociation](/dotnet/docs/reference/Google.Cloud.Compute.V1/2.15.0/Google.Cloud.Compute.V1.FirewallPolicyAssociation)`
...
`[GetIamPolicyNetworkFirewallPolicyRequest](/dotnet/docs/reference/Google.Cloud.Compute.V1/2.15.0/Google.Cloud.Compute.V1.GetIamPolicyNetworkFirewallPolicyRequest)`  
...
`[GetRuleNetworkFirewallPolicyRequest](/dotnet/docs/reference/Google.Cloud.Compute.V1/2.15.0/Google.Cloud.Compute.V1.GetRuleNetworkFirewallPolicyRequest)`  
...
`[Task](https://learn.microsoft.com/dotnet/api/system.threading.tasks.task-1)[FirewallPolicyRule](/dotnet/docs/reference/Google.Cloud.Compute.V1/2.15.0/Google.Cloud.Compute.V1.FirewallPolicyRule)`
...
`[InsertNetworkFirewallPolicyRequest](/dotnet/docs/reference/Google.Cloud.Compute.V1/2.15.0/Google.Cloud.Compute.V1.InsertNetworkFirewallPolicyRequest)`  
...
`[ListNetworkFirewallPoliciesRequest](/dotnet/docs/reference/Google.Cloud.Compute.V1/2.15.0/Google.Cloud.Compute.V1.ListNetworkFirewallPoliciesRequest)`  
...
`[Task](https://learn.microsoft.com/dotnet/api/system.threading.tasks.task-1)[FirewallPolicyList](/dotnet/docs/reference/Google.Cloud.Compute.V1/2.15.0/Google.Cloud.Compute.V1.FirewallPolicyList)`
...
`[PatchNetworkFirewallPolicyRequest](/dotnet/docs/reference/Google.Cloud.Compute.V1/2.15.0/Google.Cloud.Compute.V1.PatchNetworkFirewallPolicyRequest)`  
...
`[PatchRuleNetworkFirewallPolicyRequest](/dotnet/docs/reference/Google.Cloud.Compute.V1/2.15.0/Google.Cloud.Compute.V1.PatchRuleNetworkFirewallPolicyRequest)`  
...
`[RemoveAssociationNetworkFirewallPolicyRequest](/dotnet/docs/reference/Google.Cloud.Compute.V1/2.15.0/Google.Cloud.Compute.V1.RemoveAssociationNetworkFirewallPolicyRequest)`  
...
`[RemoveRuleNetworkFirewallPolicyRequest](/dotnet/docs/reference/Google.Cloud.Compute.V1/2.15.0/Google.Cloud.Compute.V1.RemoveRuleNetworkFirewallPolicyRequest)`  
...
`[SetIamPolicyNetworkFirewallPolicyRequest](/dotnet/docs/reference/Google.Cloud.Compute.V1/2.15.0/Google.Cloud.Compute.V1.SetIamPolicyNetworkFirewallPolicyRequest)`  
...
`[TestIamPermissionsNetworkFirewallPolicyRequest](/dotnet/docs/reference/Google.Cloud.Compute.V1/2.15.0/Google.Cloud.Compute.V1.TestIamPermissionsNetworkFirewallPolicyRequest)`  
