...
# Namespace google::cloud::run (2.12.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated:** This namespace is deprecated, prefer the types defined in [`run_v2`](/cpp/docs/reference/run/2.12.0/namespacegoogle_1_1cloud_1_1run__v2).
