...
# Interface ListReportConfigsRequestOrBuilder (0.8.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface ListReportConfigsRequestOrBuilder extends MessageOrBuilder
```
