...
# Class ListInstancesResponse (1.45.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListInstancesResponse

## Implements

[ListInstancesResponseOrBuilder](/java/docs/reference/google-cloud-notebooks/1.45.0/com.google.cloud.notebooks.v2.ListInstancesResponseOrBuilder)
...
`[ListInstancesResponse](/java/docs/reference/google-cloud-notebooks/1.45.0/com.google.cloud.notebooks.v2.ListInstancesResponse)`
...
`[ListInstancesResponse.Builder](/java/docs/reference/google-cloud-notebooks/1.45.0/com.google.cloud.notebooks.v2.ListInstancesResponse.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListInstancesResponse](/java/docs/reference/google-cloud-notebooks/1.45.0/com.google.cloud.notebooks.v2.ListInstancesResponse)>`
...
`repeated .google.cloud.notebooks.v2.Instance instances = 1;`
...
`[Instance](/java/docs/reference/google-cloud-notebooks/1.45.0/com.google.cloud.notebooks.v2.Instance)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Instance](/java/docs/reference/google-cloud-notebooks/1.45.0/com.google.cloud.notebooks.v2.Instance)>`
...
`[InstanceOrBuilder](/java/docs/reference/google-cloud-notebooks/1.45.0/com.google.cloud.notebooks.v2.InstanceOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.notebooks.v2.InstanceOrBuilder>`
