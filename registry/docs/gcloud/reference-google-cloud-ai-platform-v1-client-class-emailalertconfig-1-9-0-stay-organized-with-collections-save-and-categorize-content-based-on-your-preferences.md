...
# Google Cloud Ai Platform V1 Client - Class EmailAlertConfig (1.9.0) Stay organized with collections Save and categorize content based on your preferences.
...
Reference documentation and code samples for the Google Cloud Ai Platform V1 Client class EmailAlertConfig.

The config for email alert.

Generated from protobuf message `google.cloud.aiplatform.v1.ModelMonitoringAlertConfig.EmailAlertConfig`
