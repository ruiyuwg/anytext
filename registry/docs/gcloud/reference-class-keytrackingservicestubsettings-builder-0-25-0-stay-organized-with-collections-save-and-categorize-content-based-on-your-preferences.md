...
# Class KeyTrackingServiceStubSettings.Builder (0.25.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class KeyTrackingServiceStubSettings.Builder extends StubSettings.Builder<KeyTrackingServiceStubSettings,KeyTrackingServiceStubSettings.Builder>
```

Builder for KeyTrackingServiceStubSettings.

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [StubSettings.Builder](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.StubSettings.Builder.html) \> KeyTrackingServiceStubSettings.Builder
...
### Builder(KeyTrackingServiceStubSettings settings)
...
`[KeyTrackingServiceStubSettings](/java/docs/reference/google-cloud-kmsinventory/0.25.0/com.google.cloud.kms.inventory.v1.stub.KeyTrackingServiceStubSettings)`  
...
```
public KeyTrackingServiceStubSettings.Builder applyToAllUnaryMethods(ApiFunction<UnaryCallSettings.Builder<?,?>,Void> settingsUpdater)
```
...
`[KeyTrackingServiceStubSettings.Builder](/java/docs/reference/google-cloud-kmsinventory/0.25.0/com.google.cloud.kms.inventory.v1.stub.KeyTrackingServiceStubSettings.Builder)`

### build()

```
public KeyTrackingServiceStubSettings build()
```
...
`[Builder](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.Builder.html)<[GetProtectedResourcesSummaryRequest](/java/docs/reference/google-cloud-kmsinventory/0.25.0/com.google.cloud.kms.inventory.v1.GetProtectedResourcesSummaryRequest),[ProtectedResourcesSummary](/java/docs/reference/google-cloud-kmsinventory/0.25.0/com.google.cloud.kms.inventory.v1.ProtectedResourcesSummary)>`
...
`[Builder](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PagedCallSettings.Builder.html)<[SearchProtectedResourcesRequest](/java/docs/reference/google-cloud-kmsinventory/0.25.0/com.google.cloud.kms.inventory.v1.SearchProtectedResourcesRequest),[SearchProtectedResourcesResponse](/java/docs/reference/google-cloud-kmsinventory/0.25.0/com.google.cloud.kms.inventory.v1.SearchProtectedResourcesResponse),[SearchProtectedResourcesPagedResponse](/java/docs/reference/google-cloud-kmsinventory/0.25.0/com.google.cloud.kms.inventory.v1.KeyTrackingServiceClient.SearchProtectedResourcesPagedResponse)>`
