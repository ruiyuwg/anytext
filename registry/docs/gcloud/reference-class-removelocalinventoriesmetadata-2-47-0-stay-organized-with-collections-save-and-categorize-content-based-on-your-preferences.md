...
# Class RemoveLocalInventoriesMetadata (2.47.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class RemoveLocalInventoriesMetadata extends GeneratedMessageV3 implements RemoveLocalInventoriesMetadataOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> RemoveLocalInventoriesMetadata

## Implements

[RemoveLocalInventoriesMetadataOrBuilder](/java/docs/reference/google-cloud-retail/2.47.0/com.google.cloud.retail.v2beta.RemoveLocalInventoriesMetadataOrBuilder)
...
```
public static RemoveLocalInventoriesMetadata getDefaultInstance()
```
...
`[RemoveLocalInventoriesMetadata](/java/docs/reference/google-cloud-retail/2.47.0/com.google.cloud.retail.v2beta.RemoveLocalInventoriesMetadata)`
...
```
public static RemoveLocalInventoriesMetadata.Builder newBuilder()
```
...
`[RemoveLocalInventoriesMetadata.Builder](/java/docs/reference/google-cloud-retail/2.47.0/com.google.cloud.retail.v2beta.RemoveLocalInventoriesMetadata.Builder)`

### newBuilder(RemoveLocalInventoriesMetadata prototype)

```
public static RemoveLocalInventoriesMetadata.Builder newBuilder(RemoveLocalInventoriesMetadata prototype)
```
...
```
public static RemoveLocalInventoriesMetadata parseDelimitedFrom(InputStream input)
```
...
```
public static RemoveLocalInventoriesMetadata parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RemoveLocalInventoriesMetadata parseFrom(byte[] data)
```
...
```
public static RemoveLocalInventoriesMetadata parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RemoveLocalInventoriesMetadata parseFrom(ByteString data)
```
...
```
public static RemoveLocalInventoriesMetadata parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RemoveLocalInventoriesMetadata parseFrom(CodedInputStream input)
```
...
```
public static RemoveLocalInventoriesMetadata parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RemoveLocalInventoriesMetadata parseFrom(InputStream input)
```
...
```
public static RemoveLocalInventoriesMetadata parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RemoveLocalInventoriesMetadata parseFrom(ByteBuffer data)
```
...
```
public static RemoveLocalInventoriesMetadata parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<RemoveLocalInventoriesMetadata> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[RemoveLocalInventoriesMetadata](/java/docs/reference/google-cloud-retail/2.47.0/com.google.cloud.retail.v2beta.RemoveLocalInventoriesMetadata)>`
...
```
public RemoveLocalInventoriesMetadata getDefaultInstanceForType()
```
...
```
public Parser<RemoveLocalInventoriesMetadata> getParserForType()
```
...
```
public RemoveLocalInventoriesMetadata.Builder newBuilderForType()
```
...
```
protected RemoveLocalInventoriesMetadata.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public RemoveLocalInventoriesMetadata.Builder toBuilder()
```
