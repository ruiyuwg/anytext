...
# google-shopping-merchant-reports overview (1.15.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Merchant API Description:** Programmatically manage your Merchant Center accounts.

[Merchant API Product Reference](https://developers.google.com/merchant/api)

[GitHub Repository](https://github.com/googleapis/google-cloud-java/tree/main/java-shopping-merchant-reports)

[Maven artifact](https://central.sonatype.com/artifact/com.google.shopping/google-shopping-merchant-reports)
...
-   [Enable the API](https://console.cloud.google.com/apis/library/merchantapi.googleapis.com)
-   [Set up authentication](https://cloud.google.com/docs/authentication/client-libraries)

## Use the Merchant API for Java
...
The example below demonstrates how you would import the BOM and include the `google-shopping-merchant-reports` artifact.
...
implementation("com.google.shopping:google-shopping-merchant-reports")
...
libraryDependencies += "com.google.cloud" % "google-shopping-merchant-reports" % "1.15.0"

## Which version ID should I get started with?

For this library, we recommend using [com.google.shopping.merchant.reports.v1](https://cloud.google.com/java/docs/reference/google-shopping-merchant-reports/1.15.0/com.google.shopping.merchant.reports.v1) for new applications.
