...
# Google Cloud Ai Platform V1 Client - Class PauseModelDeploymentMonitoringJobRequest (0.37.1) Stay organized with collections Save and categorize content based on your preferences.
...
Reference documentation and code samples for the Google Cloud Ai Platform V1 Client class PauseModelDeploymentMonitoringJobRequest.

Request message for JobService.PauseModelDeploymentMonitoringJob.

Generated from protobuf message `google.cloud.aiplatform.v1.PauseModelDeploymentMonitoringJobRequest`
...
Required. The resource name of the ModelDeploymentMonitoringJob to pause. Format: `projects/{project}/locations/{location}/modelDeploymentMonitoringJobs/{model_deployment_monitoring_job}` Please see Google\\Cloud\\AIPlatform\\V1\\JobServiceClient::modelDeploymentMonitoringJobName() for help formatting this field.
...
`[Google\Cloud\AIPlatform\V1\PauseModelDeploymentMonitoringJobRequest](/php/docs/reference/cloud-ai-platform/0.37.1/V1.PauseModelDeploymentMonitoringJobRequest)`
