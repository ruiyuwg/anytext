...
# Enum Instance.DiskType (1.45.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum Instance.DiskType extends Enum<Instance.DiskType> implements ProtocolMessageEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-notebooks/1.45.0/com.google.cloud.notebooks.v1beta1.Instance.DiskType#com_google_cloud_notebooks_v1beta1_Instance_DiskType_forNumber_int_) instead._
