...
# Class GrpcManagedKafkaCallableFactory (0.8.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public class GrpcManagedKafkaCallableFactory implements GrpcStubCallableFactory
```

gRPC callable factory implementation for the ManagedKafka service API.

This class is for advanced usage.

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> GrpcManagedKafkaCallableFactory
...
### GrpcManagedKafkaCallableFactory()

```
public GrpcManagedKafkaCallableFactory()
```
