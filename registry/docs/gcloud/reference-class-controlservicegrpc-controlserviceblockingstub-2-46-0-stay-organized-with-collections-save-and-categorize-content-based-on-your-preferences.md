...
# Class ControlServiceGrpc.ControlServiceBlockingStub (2.46.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[ControlServiceGrpc.ControlServiceBlockingStub](/java/docs/reference/google-cloud-retail/2.46.0/com.google.cloud.retail.v2alpha.ControlServiceGrpc.ControlServiceBlockingStub)`
...
`[CreateControlRequest](/java/docs/reference/google-cloud-retail/2.46.0/com.google.cloud.retail.v2alpha.CreateControlRequest)`  
...
`[Control](/java/docs/reference/google-cloud-retail/2.46.0/com.google.cloud.retail.v2alpha.Control)`
...
`[DeleteControlRequest](/java/docs/reference/google-cloud-retail/2.46.0/com.google.cloud.retail.v2alpha.DeleteControlRequest)`  
...
`[GetControlRequest](/java/docs/reference/google-cloud-retail/2.46.0/com.google.cloud.retail.v2alpha.GetControlRequest)`  
...
`[ListControlsRequest](/java/docs/reference/google-cloud-retail/2.46.0/com.google.cloud.retail.v2alpha.ListControlsRequest)`  
...
`[ListControlsResponse](/java/docs/reference/google-cloud-retail/2.46.0/com.google.cloud.retail.v2alpha.ListControlsResponse)`
...
`[UpdateControlRequest](/java/docs/reference/google-cloud-retail/2.46.0/com.google.cloud.retail.v2alpha.UpdateControlRequest)`  
