...
# Class SecurityCenterClient.ListEffectiveSecurityHealthAnalyticsCustomModulesFixedSizeCollection (2.28.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class SecurityCenterClient.ListEffectiveSecurityHealthAnalyticsCustomModulesFixedSizeCollection extends AbstractFixedSizeCollection<ListEffectiveSecurityHealthAnalyticsCustomModulesRequest,ListEffectiveSecurityHealthAnalyticsCustomModulesResponse,EffectiveSecurityHealthAnalyticsCustomModule,SecurityCenterClient.ListEffectiveSecurityHealthAnalyticsCustomModulesPage,SecurityCenterClient.ListEffectiveSecurityHealthAnalyticsCustomModulesFixedSizeCollection>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractFixedSizeCollection](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractFixedSizeCollection.html) \> SecurityCenterClient.ListEffectiveSecurityHealthAnalyticsCustomModulesFixedSizeCollection
...
### createCollection(List<SecurityCenterClient.ListEffectiveSecurityHealthAnalyticsCustomModulesPage> pages, int collectionSize)

```
protected SecurityCenterClient.ListEffectiveSecurityHealthAnalyticsCustomModulesFixedSizeCollection createCollection(List<SecurityCenterClient.ListEffectiveSecurityHealthAnalyticsCustomModulesPage> pages, int collectionSize)
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ListEffectiveSecurityHealthAnalyticsCustomModulesPage](/java/docs/reference/google-cloud-securitycenter/2.28.0/com.google.cloud.securitycenter.v1.SecurityCenterClient.ListEffectiveSecurityHealthAnalyticsCustomModulesPage)>`  
...
`[SecurityCenterClient.ListEffectiveSecurityHealthAnalyticsCustomModulesFixedSizeCollection](/java/docs/reference/google-cloud-securitycenter/2.28.0/com.google.cloud.securitycenter.v1.SecurityCenterClient.ListEffectiveSecurityHealthAnalyticsCustomModulesFixedSizeCollection)`
