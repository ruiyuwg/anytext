...
# Vertex AI v1 API - Class StudySpec.Types.ParameterSpec.Types (3.68.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class StudySpec.Types.ParameterSpec.Types
```

Reference documentation and code samples for the Vertex AI v1 API class StudySpec.Types.ParameterSpec.Types.

Container for nested types declared in the ParameterSpec message type.

## Inheritance

[object](https://learn.microsoft.com/dotnet/api/system.object) \> StudySpec.Types.ParameterSpec.Types
