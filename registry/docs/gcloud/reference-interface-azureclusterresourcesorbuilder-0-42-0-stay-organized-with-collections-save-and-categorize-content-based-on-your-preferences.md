...
# Interface AzureClusterResourcesOrBuilder (0.42.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface AzureClusterResourcesOrBuilder extends MessageOrBuilder
```
...
```
public abstract String getControlPlaneApplicationSecurityGroupId()
```
...
```
public abstract ByteString getControlPlaneApplicationSecurityGroupIdBytes()
```
...
```
public abstract String getNetworkSecurityGroupId()
```
...
```
public abstract ByteString getNetworkSecurityGroupIdBytes()
```
