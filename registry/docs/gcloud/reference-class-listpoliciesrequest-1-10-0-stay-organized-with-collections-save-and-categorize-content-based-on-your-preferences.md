...
# Class ListPoliciesRequest (1.10.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListPoliciesRequest extends GeneratedMessageV3 implements ListPoliciesRequestOrBuilder
```

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListPoliciesRequest

## Implements

[ListPoliciesRequestOrBuilder](/java/docs/reference/google-iam-policy/1.10.0/com.google.iam.v2beta.ListPoliciesRequestOrBuilder)
...
`[ListPoliciesRequest](/java/docs/reference/google-iam-policy/1.10.0/com.google.iam.v2beta.ListPoliciesRequest)`
...
```
public static ListPoliciesRequest.Builder newBuilder()
```
...
`[Builder](/java/docs/reference/google-iam-policy/1.10.0/com.google.iam.v2beta.ListPoliciesRequest.Builder)`

### newBuilder(ListPoliciesRequest arg0)

```
public static ListPoliciesRequest.Builder newBuilder(ListPoliciesRequest arg0)
```
...
```
public static ListPoliciesRequest parseDelimitedFrom(InputStream arg0)
```
...
```
public static ListPoliciesRequest parseDelimitedFrom(InputStream arg0, ExtensionRegistryLite arg1)
```
...
```
public static ListPoliciesRequest parseFrom(byte[] arg0)
```
...
```
public static ListPoliciesRequest parseFrom(byte[] arg0, ExtensionRegistryLite arg1)
```
...
```
public static ListPoliciesRequest parseFrom(ByteString arg0)
```
...
```
public static ListPoliciesRequest parseFrom(ByteString arg0, ExtensionRegistryLite arg1)
```
...
```
public static ListPoliciesRequest parseFrom(CodedInputStream arg0)
```
...
```
public static ListPoliciesRequest parseFrom(CodedInputStream arg0, ExtensionRegistryLite arg1)
```
...
```
public static ListPoliciesRequest parseFrom(InputStream arg0)
```
...
```
public static ListPoliciesRequest parseFrom(InputStream arg0, ExtensionRegistryLite arg1)
```
...
```
public static ListPoliciesRequest parseFrom(ByteBuffer arg0)
```
...
```
public static ListPoliciesRequest parseFrom(ByteBuffer arg0, ExtensionRegistryLite arg1)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListPoliciesRequest](/java/docs/reference/google-iam-policy/1.10.0/com.google.iam.v2beta.ListPoliciesRequest)>`
...
```
public ListPoliciesRequest.Builder newBuilderForType()
```
...
```
protected ListPoliciesRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent arg0)
```
