...
# Class GrpcCompletionCallableFactory (2.23.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public class GrpcCompletionCallableFactory implements GrpcStubCallableFactory
```
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> GrpcCompletionCallableFactory
...
```
public GrpcCompletionCallableFactory()
```
