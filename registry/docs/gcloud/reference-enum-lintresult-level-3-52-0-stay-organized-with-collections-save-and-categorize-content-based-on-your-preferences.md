...
# Enum LintResult.Level (3.52.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum LintResult.Level extends Enum<LintResult.Level> implements ProtocolMessageEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-iam-admin/3.52.0/com.google.iam.admin.v1.LintResult.Level#com_google_iam_admin_v1_LintResult_Level_forNumber_int_) instead._
