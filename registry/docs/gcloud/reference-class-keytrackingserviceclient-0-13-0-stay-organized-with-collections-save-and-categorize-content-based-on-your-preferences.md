...
# Class KeyTrackingServiceClient (0.13.0) Stay organized with collections Save and categorize content based on your preferences.
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> KeyTrackingServiceClient
...
`[KeyTrackingServiceClient](/java/docs/reference/google-cloud-kmsinventory/0.13.0/com.google.cloud.kms.inventory.v1.KeyTrackingServiceClient)`
...
`[KeyTrackingServiceSettings](/java/docs/reference/google-cloud-kmsinventory/0.13.0/com.google.cloud.kms.inventory.v1.KeyTrackingServiceSettings)`  
...
`[KeyTrackingServiceStub](/java/docs/reference/google-cloud-kmsinventory/0.13.0/com.google.cloud.kms.inventory.v1.stub.KeyTrackingServiceStub)`  
...
`[GetProtectedResourcesSummaryRequest](/java/docs/reference/google-cloud-kmsinventory/0.13.0/com.google.cloud.kms.inventory.v1.GetProtectedResourcesSummaryRequest)`  
...
`[ProtectedResourcesSummary](/java/docs/reference/google-cloud-kmsinventory/0.13.0/com.google.cloud.kms.inventory.v1.ProtectedResourcesSummary)`
...
`[ProtectedResourcesSummaryName](/java/docs/reference/google-cloud-kmsinventory/0.13.0/com.google.cloud.kms.inventory.v1.ProtectedResourcesSummaryName)`  
...
`[UnaryCallable](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallable.html)<[GetProtectedResourcesSummaryRequest](/java/docs/reference/google-cloud-kmsinventory/0.13.0/com.google.cloud.kms.inventory.v1.GetProtectedResourcesSummaryRequest),[ProtectedResourcesSummary](/java/docs/reference/google-cloud-kmsinventory/0.13.0/com.google.cloud.kms.inventory.v1.ProtectedResourcesSummary)>`
...
`[OrganizationName](/java/docs/reference/google-cloud-kmsinventory/0.13.0/com.google.cloud.kms.inventory.v1.OrganizationName)`  
...
`[KeyTrackingServiceClient.SearchProtectedResourcesPagedResponse](/java/docs/reference/google-cloud-kmsinventory/0.13.0/com.google.cloud.kms.inventory.v1.KeyTrackingServiceClient.SearchProtectedResourcesPagedResponse)`
...
`[SearchProtectedResourcesRequest](/java/docs/reference/google-cloud-kmsinventory/0.13.0/com.google.cloud.kms.inventory.v1.SearchProtectedResourcesRequest)`  
...
`[UnaryCallable](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallable.html)<[SearchProtectedResourcesRequest](/java/docs/reference/google-cloud-kmsinventory/0.13.0/com.google.cloud.kms.inventory.v1.SearchProtectedResourcesRequest),[SearchProtectedResourcesResponse](/java/docs/reference/google-cloud-kmsinventory/0.13.0/com.google.cloud.kms.inventory.v1.SearchProtectedResourcesResponse)>`
...
`[UnaryCallable](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallable.html)<[SearchProtectedResourcesRequest](/java/docs/reference/google-cloud-kmsinventory/0.13.0/com.google.cloud.kms.inventory.v1.SearchProtectedResourcesRequest),[SearchProtectedResourcesPagedResponse](/java/docs/reference/google-cloud-kmsinventory/0.13.0/com.google.cloud.kms.inventory.v1.KeyTrackingServiceClient.SearchProtectedResourcesPagedResponse)>`
