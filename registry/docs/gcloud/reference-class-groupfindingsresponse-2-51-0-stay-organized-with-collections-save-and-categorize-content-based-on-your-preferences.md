...
# Class GroupFindingsResponse (2.51.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class GroupFindingsResponse extends GeneratedMessageV3 implements GroupFindingsResponseOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> GroupFindingsResponse

## Implements

[GroupFindingsResponseOrBuilder](/java/docs/reference/google-cloud-securitycenter/2.51.0/com.google.cloud.securitycenter.v2.GroupFindingsResponseOrBuilder)
...
### GROUP\_BY\_RESULTS\_FIELD\_NUMBER

```
public static final int GROUP_BY_RESULTS_FIELD_NUMBER
```
...
```
public static GroupFindingsResponse getDefaultInstance()
```
...
`[GroupFindingsResponse](/java/docs/reference/google-cloud-securitycenter/2.51.0/com.google.cloud.securitycenter.v2.GroupFindingsResponse)`
...
```
public static GroupFindingsResponse.Builder newBuilder()
```
...
`[GroupFindingsResponse.Builder](/java/docs/reference/google-cloud-securitycenter/2.51.0/com.google.cloud.securitycenter.v2.GroupFindingsResponse.Builder)`

### newBuilder(GroupFindingsResponse prototype)

```
public static GroupFindingsResponse.Builder newBuilder(GroupFindingsResponse prototype)
```
...
```
public static GroupFindingsResponse parseDelimitedFrom(InputStream input)
```
...
```
public static GroupFindingsResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GroupFindingsResponse parseFrom(byte[] data)
```
...
```
public static GroupFindingsResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GroupFindingsResponse parseFrom(ByteString data)
```
...
```
public static GroupFindingsResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GroupFindingsResponse parseFrom(CodedInputStream input)
```
...
```
public static GroupFindingsResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GroupFindingsResponse parseFrom(InputStream input)
```
...
```
public static GroupFindingsResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GroupFindingsResponse parseFrom(ByteBuffer data)
```
...
```
public static GroupFindingsResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<GroupFindingsResponse> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[GroupFindingsResponse](/java/docs/reference/google-cloud-securitycenter/2.51.0/com.google.cloud.securitycenter.v2.GroupFindingsResponse)>`
...
`[GroupResult](/java/docs/reference/google-cloud-securitycenter/2.51.0/com.google.cloud.securitycenter.v2.GroupResult)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[GroupResult](/java/docs/reference/google-cloud-securitycenter/2.51.0/com.google.cloud.securitycenter.v2.GroupResult)>`
...
`[GroupResultOrBuilder](/java/docs/reference/google-cloud-securitycenter/2.51.0/com.google.cloud.securitycenter.v2.GroupResultOrBuilder)`
...
```
public Parser<GroupFindingsResponse> getParserForType()
```
...
```
public GroupFindingsResponse.Builder newBuilderForType()
```
...
```
protected GroupFindingsResponse.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public GroupFindingsResponse.Builder toBuilder()
```
