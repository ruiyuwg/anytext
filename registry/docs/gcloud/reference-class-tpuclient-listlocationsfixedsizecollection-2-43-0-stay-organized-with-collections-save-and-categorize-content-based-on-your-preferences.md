...
# Class TpuClient.ListLocationsFixedSizeCollection (2.43.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class TpuClient.ListLocationsFixedSizeCollection extends AbstractFixedSizeCollection<ListLocationsRequest,ListLocationsResponse,Location,TpuClient.ListLocationsPage,TpuClient.ListLocationsFixedSizeCollection>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractFixedSizeCollection](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractFixedSizeCollection.html) \> TpuClient.ListLocationsFixedSizeCollection
...
### createCollection(List<TpuClient.ListLocationsPage> pages, int collectionSize)

```
protected TpuClient.ListLocationsFixedSizeCollection createCollection(List<TpuClient.ListLocationsPage> pages, int collectionSize)
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ListLocationsPage](/java/docs/reference/google-cloud-tpu/2.43.0/com.google.cloud.tpu.v2alpha1.TpuClient.ListLocationsPage)>`  
...
`[TpuClient.ListLocationsFixedSizeCollection](/java/docs/reference/google-cloud-tpu/2.43.0/com.google.cloud.tpu.v2alpha1.TpuClient.ListLocationsFixedSizeCollection)`
