...
# Interface ReferenceOrBuilder (2.36.0) Stay organized with collections Save and categorize content based on your preferences.
...
Uri for the mentioned source e.g. [https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2021-34527](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2021-34527).
