...
# Interface BasicSli.AvailabilityCriteriaOrBuilder (3.5.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static interface BasicSli.AvailabilityCriteriaOrBuilder extends MessageOrBuilder
```
