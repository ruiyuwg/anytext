...
# Interface MembershipFeatureStateOrBuilder (1.29.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[MembershipState](/java/docs/reference/google-cloud-gkehub/1.29.0/com.google.cloud.gkehub.configmanagement.v1alpha.MembershipState)`
...
`[MembershipStateOrBuilder](/java/docs/reference/google-cloud-gkehub/1.29.0/com.google.cloud.gkehub.configmanagement.v1alpha.MembershipStateOrBuilder)`
...
`[MembershipFeatureState.FeatureStateCase](/java/docs/reference/google-cloud-gkehub/1.29.0/com.google.cloud.gkehub.v1alpha.MembershipFeatureState.FeatureStateCase)`
...
`[MembershipState](/java/docs/reference/google-cloud-gkehub/1.29.0/com.google.cloud.gkehub.metering.v1alpha.MembershipState)`
...
`[MembershipStateOrBuilder](/java/docs/reference/google-cloud-gkehub/1.29.0/com.google.cloud.gkehub.metering.v1alpha.MembershipStateOrBuilder)`
...
`[MembershipState](/java/docs/reference/google-cloud-gkehub/1.29.0/com.google.cloud.gkehub.servicemesh.v1alpha.MembershipState)`
...
`[MembershipStateOrBuilder](/java/docs/reference/google-cloud-gkehub/1.29.0/com.google.cloud.gkehub.servicemesh.v1alpha.MembershipStateOrBuilder)`
...
`[FeatureState](/java/docs/reference/google-cloud-gkehub/1.29.0/com.google.cloud.gkehub.v1alpha.FeatureState)`
...
`[FeatureStateOrBuilder](/java/docs/reference/google-cloud-gkehub/1.29.0/com.google.cloud.gkehub.v1alpha.FeatureStateOrBuilder)`
