...
# Class SpokeSummary.SpokeStateReasonCount (1.47.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class SpokeSummary.SpokeStateReasonCount extends GeneratedMessageV3 implements SpokeSummary.SpokeStateReasonCountOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> SpokeSummary.SpokeStateReasonCount

## Implements

[SpokeSummary.SpokeStateReasonCountOrBuilder](/java/docs/reference/google-cloud-networkconnectivity/1.47.0/com.google.cloud.networkconnectivity.v1.SpokeSummary.SpokeStateReasonCountOrBuilder)
...
### STATE\_REASON\_CODE\_FIELD\_NUMBER

```
public static final int STATE_REASON_CODE_FIELD_NUMBER
```
...
```
public static SpokeSummary.SpokeStateReasonCount getDefaultInstance()
```
...
`[SpokeSummary.SpokeStateReasonCount](/java/docs/reference/google-cloud-networkconnectivity/1.47.0/com.google.cloud.networkconnectivity.v1.SpokeSummary.SpokeStateReasonCount)`
...
```
public static SpokeSummary.SpokeStateReasonCount.Builder newBuilder()
```
...
`[SpokeSummary.SpokeStateReasonCount.Builder](/java/docs/reference/google-cloud-networkconnectivity/1.47.0/com.google.cloud.networkconnectivity.v1.SpokeSummary.SpokeStateReasonCount.Builder)`

### newBuilder(SpokeSummary.SpokeStateReasonCount prototype)

```
public static SpokeSummary.SpokeStateReasonCount.Builder newBuilder(SpokeSummary.SpokeStateReasonCount prototype)
```
...
```
public static SpokeSummary.SpokeStateReasonCount parseDelimitedFrom(InputStream input)
```
...
```
public static SpokeSummary.SpokeStateReasonCount parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SpokeSummary.SpokeStateReasonCount parseFrom(byte[] data)
```
...
```
public static SpokeSummary.SpokeStateReasonCount parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SpokeSummary.SpokeStateReasonCount parseFrom(ByteString data)
```
...
```
public static SpokeSummary.SpokeStateReasonCount parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SpokeSummary.SpokeStateReasonCount parseFrom(CodedInputStream input)
```
...
```
public static SpokeSummary.SpokeStateReasonCount parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SpokeSummary.SpokeStateReasonCount parseFrom(InputStream input)
```
...
```
public static SpokeSummary.SpokeStateReasonCount parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SpokeSummary.SpokeStateReasonCount parseFrom(ByteBuffer data)
```
...
```
public static SpokeSummary.SpokeStateReasonCount parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<SpokeSummary.SpokeStateReasonCount> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[SpokeStateReasonCount](/java/docs/reference/google-cloud-networkconnectivity/1.47.0/com.google.cloud.networkconnectivity.v1.SpokeSummary.SpokeStateReasonCount)>`
...
```
public Parser<SpokeSummary.SpokeStateReasonCount> getParserForType()
```
...
`[Spoke.StateReason.Code](/java/docs/reference/google-cloud-networkconnectivity/1.47.0/com.google.cloud.networkconnectivity.v1.Spoke.StateReason.Code)`
...
```
public SpokeSummary.SpokeStateReasonCount.Builder newBuilderForType()
```
...
```
protected SpokeSummary.SpokeStateReasonCount.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public SpokeSummary.SpokeStateReasonCount.Builder toBuilder()
```
