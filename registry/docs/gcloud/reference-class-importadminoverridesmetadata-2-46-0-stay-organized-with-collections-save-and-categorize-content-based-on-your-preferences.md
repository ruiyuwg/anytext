...
# Class ImportAdminOverridesMetadata (2.46.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ImportAdminOverridesMetadata extends GeneratedMessageV3 implements ImportAdminOverridesMetadataOrBuilder
```
...
Protobuf type `google.api.serviceusage.v1beta1.ImportAdminOverridesMetadata`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ImportAdminOverridesMetadata

## Implements

[ImportAdminOverridesMetadataOrBuilder](/java/docs/reference/google-cloud-service-usage/2.46.0/com.google.api.serviceusage.v1beta1.ImportAdminOverridesMetadataOrBuilder)
...
```
public static ImportAdminOverridesMetadata getDefaultInstance()
```
...
`[ImportAdminOverridesMetadata](/java/docs/reference/google-cloud-service-usage/2.46.0/com.google.api.serviceusage.v1beta1.ImportAdminOverridesMetadata)`
...
```
public static ImportAdminOverridesMetadata.Builder newBuilder()
```
...
`[ImportAdminOverridesMetadata.Builder](/java/docs/reference/google-cloud-service-usage/2.46.0/com.google.api.serviceusage.v1beta1.ImportAdminOverridesMetadata.Builder)`

### newBuilder(ImportAdminOverridesMetadata prototype)

```
public static ImportAdminOverridesMetadata.Builder newBuilder(ImportAdminOverridesMetadata prototype)
```
...
```
public static ImportAdminOverridesMetadata parseDelimitedFrom(InputStream input)
```
...
```
public static ImportAdminOverridesMetadata parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ImportAdminOverridesMetadata parseFrom(byte[] data)
```
...
```
public static ImportAdminOverridesMetadata parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ImportAdminOverridesMetadata parseFrom(ByteString data)
```
...
```
public static ImportAdminOverridesMetadata parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ImportAdminOverridesMetadata parseFrom(CodedInputStream input)
```
...
```
public static ImportAdminOverridesMetadata parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ImportAdminOverridesMetadata parseFrom(InputStream input)
```
...
```
public static ImportAdminOverridesMetadata parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ImportAdminOverridesMetadata parseFrom(ByteBuffer data)
```
...
```
public static ImportAdminOverridesMetadata parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ImportAdminOverridesMetadata> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ImportAdminOverridesMetadata](/java/docs/reference/google-cloud-service-usage/2.46.0/com.google.api.serviceusage.v1beta1.ImportAdminOverridesMetadata)>`
...
```
public ImportAdminOverridesMetadata getDefaultInstanceForType()
```
...
```
public Parser<ImportAdminOverridesMetadata> getParserForType()
```
...
```
public ImportAdminOverridesMetadata.Builder newBuilderForType()
```
...
```
protected ImportAdminOverridesMetadata.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ImportAdminOverridesMetadata.Builder toBuilder()
```
