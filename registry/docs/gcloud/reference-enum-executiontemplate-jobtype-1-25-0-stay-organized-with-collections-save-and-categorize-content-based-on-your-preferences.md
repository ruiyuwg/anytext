...
# Enum ExecutionTemplate.JobType (1.25.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum ExecutionTemplate.JobType extends Enum<ExecutionTemplate.JobType> implements ProtocolMessageEnum
```
...
Run execution on a cluster with Dataproc as a job. [https://cloud.google.com/dataproc/docs/reference/rest/v1/projects.regions.jobs](https://cloud.google.com/dataproc/docs/reference/rest/v1/projects.regions.jobs)
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-notebooks/1.25.0/com.google.cloud.notebooks.v1.ExecutionTemplate.JobType#com_google_cloud_notebooks_v1_ExecutionTemplate_JobType_forNumber_int_) instead._
