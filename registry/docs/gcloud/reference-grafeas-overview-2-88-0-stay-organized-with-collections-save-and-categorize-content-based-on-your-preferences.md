...
# grafeas overview (2.88.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Grafeas Description:** N/a

[Grafeas Product Reference](https://grafeas.io)

[GitHub Repository](https://github.com/googleapis/google-cloud-java/tree/main/java-grafeas)

[Maven artifact](https://central.sonatype.com/artifact/io.grafeas/grafeas)
...
The example below demonstrates how you would import the BOM and include the `grafeas` artifact.
...
implementation("io.grafeas:grafeas")
...
libraryDependencies += "com.google.cloud" % "grafeas" % "2.88.0"

## Which version ID should I get started with?

For this library, we recommend using [io.grafeas.v1](https://cloud.google.com/java/docs/reference/grafeas/2.88.0/io.grafeas.v1) for new applications.
