...
# Interface BatchAnnotateFilesResponseOrBuilder (3.41.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[AnnotateFileResponse](/java/docs/reference/google-cloud-vision/3.41.0/com.google.cloud.vision.v1p4beta1.AnnotateFileResponse)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[AnnotateFileResponse](/java/docs/reference/google-cloud-vision/3.41.0/com.google.cloud.vision.v1p4beta1.AnnotateFileResponse)>`
...
`[AnnotateFileResponseOrBuilder](/java/docs/reference/google-cloud-vision/3.41.0/com.google.cloud.vision.v1p4beta1.AnnotateFileResponseOrBuilder)`
