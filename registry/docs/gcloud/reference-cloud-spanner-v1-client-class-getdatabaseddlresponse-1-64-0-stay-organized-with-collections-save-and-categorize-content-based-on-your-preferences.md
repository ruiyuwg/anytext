...
# Cloud Spanner V1 Client - Class GetDatabaseDdlResponse (1.64.0) Stay organized with collections Save and categorize content based on your preferences.
...
The response for [GetDatabaseDdl](/php/docs/reference/cloud-spanner/1.64.0/Admin.Database.V1.DatabaseAdminClient#_Google_Cloud_Spanner_Admin_Database_V1_DatabaseAdminClient__getDatabaseDdl__).
