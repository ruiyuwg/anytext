...
# Class DroppedLabels.Builder (3.53.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class DroppedLabels.Builder extends GeneratedMessageV3.Builder<DroppedLabels.Builder> implements DroppedLabelsOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> DroppedLabels.Builder

## Implements

[DroppedLabelsOrBuilder](/java/docs/reference/google-cloud-monitoring/3.53.0/com.google.monitoring.v3.DroppedLabelsOrBuilder)
...
```
public DroppedLabels.Builder addRepeatedField(Descriptors.FieldDescriptor field, Object value)
```
...
`[DroppedLabels.Builder](/java/docs/reference/google-cloud-monitoring/3.53.0/com.google.monitoring.v3.DroppedLabels.Builder)`
...
`[DroppedLabels](/java/docs/reference/google-cloud-monitoring/3.53.0/com.google.monitoring.v3.DroppedLabels)`
...
```
public DroppedLabels.Builder clearField(Descriptors.FieldDescriptor field)
```
...
```
public DroppedLabels.Builder clearOneof(Descriptors.OneofDescriptor oneof)
```
...
Use [#getLabelMap()](/java/docs/reference/google-cloud-monitoring/3.53.0/com.google.monitoring.v3.DroppedLabels.Builder#com_google_monitoring_v3_DroppedLabels_Builder_getLabelMap__) instead.
...
```
public DroppedLabels.Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public DroppedLabels.Builder mergeFrom(Message other)
```
...
```
public final DroppedLabels.Builder mergeUnknownFields(UnknownFieldSet unknownFields)
```
...
```
public DroppedLabels.Builder setField(Descriptors.FieldDescriptor field, Object value)
```
...
```
public DroppedLabels.Builder setRepeatedField(Descriptors.FieldDescriptor field, int index, Object value)
```
...
```
public final DroppedLabels.Builder setUnknownFields(UnknownFieldSet unknownFields)
```
