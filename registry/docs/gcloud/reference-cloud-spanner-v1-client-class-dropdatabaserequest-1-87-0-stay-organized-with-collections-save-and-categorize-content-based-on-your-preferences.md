...
# Cloud Spanner V1 Client - Class DropDatabaseRequest (1.87.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[Google\Cloud\Spanner\Admin\Database\V1\DropDatabaseRequest](/php/docs/reference/cloud-spanner/1.87.0/Admin.Database.V1.DropDatabaseRequest)`
