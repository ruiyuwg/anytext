...
# Struct SpeechRetryPolicyOption (3.4.0-rc) Stay organized with collections Save and categorize content based on your preferences.
...
**Alias Of**: `std::shared_ptr< SpeechRetryPolicy >`
