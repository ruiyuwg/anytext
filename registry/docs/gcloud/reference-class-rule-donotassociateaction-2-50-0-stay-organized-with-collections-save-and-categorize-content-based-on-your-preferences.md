...
# Class Rule.DoNotAssociateAction (2.50.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class Rule.DoNotAssociateAction extends GeneratedMessageV3 implements Rule.DoNotAssociateActionOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> Rule.DoNotAssociateAction

## Implements

[Rule.DoNotAssociateActionOrBuilder](/java/docs/reference/google-cloud-retail/2.50.0/com.google.cloud.retail.v2.Rule.DoNotAssociateActionOrBuilder)
...
### DO\_NOT\_ASSOCIATE\_TERMS\_FIELD\_NUMBER

```
public static final int DO_NOT_ASSOCIATE_TERMS_FIELD_NUMBER
```
...
```
public static Rule.DoNotAssociateAction getDefaultInstance()
```
...
`[Rule.DoNotAssociateAction](/java/docs/reference/google-cloud-retail/2.50.0/com.google.cloud.retail.v2.Rule.DoNotAssociateAction)`
...
```
public static Rule.DoNotAssociateAction.Builder newBuilder()
```
...
`[Rule.DoNotAssociateAction.Builder](/java/docs/reference/google-cloud-retail/2.50.0/com.google.cloud.retail.v2.Rule.DoNotAssociateAction.Builder)`

### newBuilder(Rule.DoNotAssociateAction prototype)

```
public static Rule.DoNotAssociateAction.Builder newBuilder(Rule.DoNotAssociateAction prototype)
```
...
```
public static Rule.DoNotAssociateAction parseDelimitedFrom(InputStream input)
```
...
```
public static Rule.DoNotAssociateAction parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Rule.DoNotAssociateAction parseFrom(byte[] data)
```
...
```
public static Rule.DoNotAssociateAction parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Rule.DoNotAssociateAction parseFrom(ByteString data)
```
...
```
public static Rule.DoNotAssociateAction parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Rule.DoNotAssociateAction parseFrom(CodedInputStream input)
```
...
```
public static Rule.DoNotAssociateAction parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Rule.DoNotAssociateAction parseFrom(InputStream input)
```
...
```
public static Rule.DoNotAssociateAction parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Rule.DoNotAssociateAction parseFrom(ByteBuffer data)
```
...
```
public static Rule.DoNotAssociateAction parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<Rule.DoNotAssociateAction> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[DoNotAssociateAction](/java/docs/reference/google-cloud-retail/2.50.0/com.google.cloud.retail.v2.Rule.DoNotAssociateAction)>`
...
```
public Parser<Rule.DoNotAssociateAction> getParserForType()
```
...
```
public Rule.DoNotAssociateAction.Builder newBuilderForType()
```
...
```
protected Rule.DoNotAssociateAction.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public Rule.DoNotAssociateAction.Builder toBuilder()
```
