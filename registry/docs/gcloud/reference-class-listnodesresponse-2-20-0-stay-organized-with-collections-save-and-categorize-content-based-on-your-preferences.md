...
# Class ListNodesResponse (2.20.0) Stay organized with collections Save and categorize content based on your preferences.
...
[ListNodesResponseOrBuilder](/java/docs/reference/google-cloud-tpu/2.20.0/com.google.cloud.tpu.v2.ListNodesResponseOrBuilder)
...
`[ListNodesResponse](/java/docs/reference/google-cloud-tpu/2.20.0/com.google.cloud.tpu.v2.ListNodesResponse)`
...
`[ListNodesResponse.Builder](/java/docs/reference/google-cloud-tpu/2.20.0/com.google.cloud.tpu.v2.ListNodesResponse.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListNodesResponse](/java/docs/reference/google-cloud-tpu/2.20.0/com.google.cloud.tpu.v2.ListNodesResponse)>`
...
`repeated .google.cloud.tpu.v2.Node nodes = 1;`
...
`[Node](/java/docs/reference/google-cloud-tpu/2.20.0/com.google.cloud.tpu.v2.Node)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Node](/java/docs/reference/google-cloud-tpu/2.20.0/com.google.cloud.tpu.v2.Node)>`
...
`[NodeOrBuilder](/java/docs/reference/google-cloud-tpu/2.20.0/com.google.cloud.tpu.v2.NodeOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.tpu.v2.NodeOrBuilder>`
