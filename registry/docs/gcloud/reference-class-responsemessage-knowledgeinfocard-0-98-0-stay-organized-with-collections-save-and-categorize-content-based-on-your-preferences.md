...
# Class ResponseMessage.KnowledgeInfoCard (0.98.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class ResponseMessage.KnowledgeInfoCard extends GeneratedMessage implements ResponseMessage.KnowledgeInfoCardOrBuilder
```
...
Protobuf type `google.cloud.dialogflow.cx.v3.ResponseMessage.KnowledgeInfoCard`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessage.html) \> ResponseMessage.KnowledgeInfoCard

## Implements

[ResponseMessage.KnowledgeInfoCardOrBuilder](/java/docs/reference/google-cloud-dialogflow-cx/latest/com.google.cloud.dialogflow.cx.v3.ResponseMessage.KnowledgeInfoCardOrBuilder)
...
```
public static ResponseMessage.KnowledgeInfoCard getDefaultInstance()
```
...
`[ResponseMessage.KnowledgeInfoCard](/java/docs/reference/google-cloud-dialogflow-cx/latest/com.google.cloud.dialogflow.cx.v3.ResponseMessage.KnowledgeInfoCard)`
...
```
public static ResponseMessage.KnowledgeInfoCard.Builder newBuilder()
```
...
`[ResponseMessage.KnowledgeInfoCard.Builder](/java/docs/reference/google-cloud-dialogflow-cx/latest/com.google.cloud.dialogflow.cx.v3.ResponseMessage.KnowledgeInfoCard.Builder)`

### newBuilder(ResponseMessage.KnowledgeInfoCard prototype)

```
public static ResponseMessage.KnowledgeInfoCard.Builder newBuilder(ResponseMessage.KnowledgeInfoCard prototype)
```
...
```
public static ResponseMessage.KnowledgeInfoCard parseDelimitedFrom(InputStream input)
```
...
```
public static ResponseMessage.KnowledgeInfoCard parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ResponseMessage.KnowledgeInfoCard parseFrom(byte[] data)
```
...
```
public static ResponseMessage.KnowledgeInfoCard parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ResponseMessage.KnowledgeInfoCard parseFrom(ByteString data)
```
...
```
public static ResponseMessage.KnowledgeInfoCard parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ResponseMessage.KnowledgeInfoCard parseFrom(CodedInputStream input)
```
...
```
public static ResponseMessage.KnowledgeInfoCard parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ResponseMessage.KnowledgeInfoCard parseFrom(InputStream input)
```
...
```
public static ResponseMessage.KnowledgeInfoCard parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ResponseMessage.KnowledgeInfoCard parseFrom(ByteBuffer data)
```
...
```
public static ResponseMessage.KnowledgeInfoCard parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ResponseMessage.KnowledgeInfoCard> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[KnowledgeInfoCard](/java/docs/reference/google-cloud-dialogflow-cx/latest/com.google.cloud.dialogflow.cx.v3.ResponseMessage.KnowledgeInfoCard)>`
...
```
public ResponseMessage.KnowledgeInfoCard getDefaultInstanceForType()
```
...
```
public Parser<ResponseMessage.KnowledgeInfoCard> getParserForType()
```
...
```
public ResponseMessage.KnowledgeInfoCard.Builder newBuilderForType()
```
...
```
protected ResponseMessage.KnowledgeInfoCard.Builder newBuilderForType(AbstractMessage.BuilderParent parent)
```
...
```
public ResponseMessage.KnowledgeInfoCard.Builder toBuilder()
```
