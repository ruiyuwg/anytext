...
# Class CreateKeyHandleRequest (2.52.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> CreateKeyHandleRequest

## Implements

[CreateKeyHandleRequestOrBuilder](/java/docs/reference/google-cloud-kms/2.52.0/com.google.cloud.kms.v1.CreateKeyHandleRequestOrBuilder)
...
### KEY\_HANDLE\_ID\_FIELD\_NUMBER
...
`[CreateKeyHandleRequest](/java/docs/reference/google-cloud-kms/2.52.0/com.google.cloud.kms.v1.CreateKeyHandleRequest)`
...
`[CreateKeyHandleRequest.Builder](/java/docs/reference/google-cloud-kms/2.52.0/com.google.cloud.kms.v1.CreateKeyHandleRequest.Builder)`

### newBuilder(CreateKeyHandleRequest prototype)

```
public static CreateKeyHandleRequest.Builder newBuilder(CreateKeyHandleRequest prototype)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[CreateKeyHandleRequest](/java/docs/reference/google-cloud-kms/2.52.0/com.google.cloud.kms.v1.CreateKeyHandleRequest)>`
...
`[KeyHandle](/java/docs/reference/google-cloud-kms/2.52.0/com.google.cloud.kms.v1.KeyHandle)`
...
`[KeyHandleOrBuilder](/java/docs/reference/google-cloud-kms/2.52.0/com.google.cloud.kms.v1.KeyHandleOrBuilder)`
