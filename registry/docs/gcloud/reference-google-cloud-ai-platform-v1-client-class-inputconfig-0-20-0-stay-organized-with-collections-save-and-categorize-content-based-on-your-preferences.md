...
# Google Cloud Ai Platform V1 Client - Class InputConfig (0.20.0) Stay organized with collections Save and categorize content based on your preferences.
...
Configures the input to [BatchPredictionJob](/php/docs/reference/cloud-ai-platform/0.20.0/V1.BatchPredictionJob). See [Model.supported\_input\_storage\_formats](/php/docs/reference/cloud-ai-platform/0.20.0/V1.Model#_Google_Cloud_AIPlatform_V1_Model__getSupportedInputStorageFormats__) for Model's supported input formats, and how instances should be expressed via any of them.
...
`[Google\Cloud\AIPlatform\V1\GcsSource](/php/docs/reference/cloud-ai-platform/0.20.0/V1.GcsSource)`  

The Cloud Storage location for the input instances.

`↳ bigquery_source`

`[Google\Cloud\AIPlatform\V1\BigQuerySource](/php/docs/reference/cloud-ai-platform/0.20.0/V1.BigQuerySource)`  
...
Required. The format in which instances are given, must be one of the [Model's](/php/docs/reference/cloud-ai-platform/0.20.0/V1.BatchPredictionJob#_Google_Cloud_AIPlatform_V1_BatchPredictionJob__getModel__) [supported\_input\_storage\_formats](/php/docs/reference/cloud-ai-platform/0.20.0/V1.Model#_Google_Cloud_AIPlatform_V1_Model__getSupportedInputStorageFormats__).
...
`[Google\Cloud\AIPlatform\V1\GcsSource](/php/docs/reference/cloud-ai-platform/0.20.0/V1.GcsSource)|null`
...
`[Google\Cloud\AIPlatform\V1\BigQuerySource](/php/docs/reference/cloud-ai-platform/0.20.0/V1.BigQuerySource)|null`
