...
# Enum NetworkConnection.State (0.5.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-migrationcenter/0.5.0/com.google.cloud.migrationcenter.v1.NetworkConnection.State#com_google_cloud_migrationcenter_v1_NetworkConnection_State_forNumber_int_) instead._
