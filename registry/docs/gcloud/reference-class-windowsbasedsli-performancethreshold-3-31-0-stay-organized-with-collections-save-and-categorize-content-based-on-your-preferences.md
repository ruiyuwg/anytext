...
# Class WindowsBasedSli.PerformanceThreshold (3.31.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> WindowsBasedSli.PerformanceThreshold

## Implements

[WindowsBasedSli.PerformanceThresholdOrBuilder](/java/docs/reference/google-cloud-monitoring/3.31.0/com.google.monitoring.v3.WindowsBasedSli.PerformanceThresholdOrBuilder)
...
### BASIC\_SLI\_PERFORMANCE\_FIELD\_NUMBER
...
`[WindowsBasedSli.PerformanceThreshold](/java/docs/reference/google-cloud-monitoring/3.31.0/com.google.monitoring.v3.WindowsBasedSli.PerformanceThreshold)`
...
`[WindowsBasedSli.PerformanceThreshold.Builder](/java/docs/reference/google-cloud-monitoring/3.31.0/com.google.monitoring.v3.WindowsBasedSli.PerformanceThreshold.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[PerformanceThreshold](/java/docs/reference/google-cloud-monitoring/3.31.0/com.google.monitoring.v3.WindowsBasedSli.PerformanceThreshold)>`
...
`[BasicSli](/java/docs/reference/google-cloud-monitoring/3.31.0/com.google.monitoring.v3.BasicSli)`
...
`[BasicSliOrBuilder](/java/docs/reference/google-cloud-monitoring/3.31.0/com.google.monitoring.v3.BasicSliOrBuilder)`
...
`[RequestBasedSli](/java/docs/reference/google-cloud-monitoring/3.31.0/com.google.monitoring.v3.RequestBasedSli)`
...
`[RequestBasedSliOrBuilder](/java/docs/reference/google-cloud-monitoring/3.31.0/com.google.monitoring.v3.RequestBasedSliOrBuilder)`
...
`[WindowsBasedSli.PerformanceThreshold.TypeCase](/java/docs/reference/google-cloud-monitoring/3.31.0/com.google.monitoring.v3.WindowsBasedSli.PerformanceThreshold.TypeCase)`
