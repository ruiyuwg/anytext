...
# Cloud AI Platform v1 API - Enum UserActionReference.ReferenceOneofCase (2.15.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum UserActionReference.ReferenceOneofCase
```

Reference documentation and code samples for the Cloud AI Platform v1 API enum UserActionReference.ReferenceOneofCase.
