...
# Interface ListControlsRequestOrBuilder (2.19.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface ListControlsRequestOrBuilder extends MessageOrBuilder
```
