...
# Class TerraformVersion (0.17.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> TerraformVersion

## Implements

[TerraformVersionOrBuilder](/java/docs/reference/google-cloud-infra-manager/0.17.0/com.google.cloud.config.v1.TerraformVersionOrBuilder)
...
### DEPRECATE\_TIME\_FIELD\_NUMBER
...
`[TerraformVersion](/java/docs/reference/google-cloud-infra-manager/0.17.0/com.google.cloud.config.v1.TerraformVersion)`
...
`[TerraformVersion.Builder](/java/docs/reference/google-cloud-infra-manager/0.17.0/com.google.cloud.config.v1.TerraformVersion.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[TerraformVersion](/java/docs/reference/google-cloud-infra-manager/0.17.0/com.google.cloud.config.v1.TerraformVersion)>`
...
Identifier. The version name is in the format: 'projects/{project\_id}/locations/{location}/terraformVersions/{terraform\_version}'.
...
`[TerraformVersion.State](/java/docs/reference/google-cloud-infra-manager/0.17.0/com.google.cloud.config.v1.TerraformVersion.State)`
