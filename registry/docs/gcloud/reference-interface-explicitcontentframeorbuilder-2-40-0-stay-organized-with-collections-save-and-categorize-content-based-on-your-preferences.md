...
# Interface ExplicitContentFrameOrBuilder (2.40.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[Likelihood](/java/docs/reference/google-cloud-video-intelligence/2.40.0/com.google.cloud.videointelligence.v1p2beta1.Likelihood)`
