...
# Enum CertificateAuthority.Tier (2.46.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum CertificateAuthority.Tier extends Enum<CertificateAuthority.Tier> implements ProtocolMessageEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-security-private-ca/2.46.0/com.google.cloud.security.privateca.v1beta1.CertificateAuthority.Tier#com_google_cloud_security_privateca_v1beta1_CertificateAuthority_Tier_forNumber_int_) instead._
