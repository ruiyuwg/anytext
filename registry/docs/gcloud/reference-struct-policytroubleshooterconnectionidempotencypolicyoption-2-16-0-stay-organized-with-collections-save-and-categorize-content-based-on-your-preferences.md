...
# Struct PolicyTroubleshooterConnectionIdempotencyPolicyOption (2.16.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Alias Of**: `std::shared_ptr< PolicyTroubleshooterConnectionIdempotencyPolicy >`
