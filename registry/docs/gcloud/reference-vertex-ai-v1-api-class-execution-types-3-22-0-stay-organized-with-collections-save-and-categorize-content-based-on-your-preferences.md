...
# Vertex AI v1 API - Class Execution.Types (3.22.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class Execution.Types
```

Reference documentation and code samples for the Vertex AI v1 API class Execution.Types.

Container for nested types declared in the Execution message type.

## Inheritance

[object](https://learn.microsoft.com/dotnet/api/system.object) \> Execution.Types
