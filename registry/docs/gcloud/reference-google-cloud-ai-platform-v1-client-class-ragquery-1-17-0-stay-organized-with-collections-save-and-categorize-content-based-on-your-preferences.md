...
# Google Cloud Ai Platform V1 Client - Class RagQuery (1.17.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[RagRetrievalConfig](/php/docs/reference/cloud-ai-platform/1.17.0/V1.RagRetrievalConfig)`  
...
`[RagRetrievalConfig](/php/docs/reference/cloud-ai-platform/1.17.0/V1.RagRetrievalConfig)|null`
