...
# Class TelcoAutomationClient.ListHydratedDeploymentsFixedSizeCollection (0.19.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class TelcoAutomationClient.ListHydratedDeploymentsFixedSizeCollection extends AbstractFixedSizeCollection<ListHydratedDeploymentsRequest,ListHydratedDeploymentsResponse,HydratedDeployment,TelcoAutomationClient.ListHydratedDeploymentsPage,TelcoAutomationClient.ListHydratedDeploymentsFixedSizeCollection>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractFixedSizeCollection](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractFixedSizeCollection.html) \> TelcoAutomationClient.ListHydratedDeploymentsFixedSizeCollection
...
### createCollection(List<TelcoAutomationClient.ListHydratedDeploymentsPage> pages, int collectionSize)

```
protected TelcoAutomationClient.ListHydratedDeploymentsFixedSizeCollection createCollection(List<TelcoAutomationClient.ListHydratedDeploymentsPage> pages, int collectionSize)
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ListHydratedDeploymentsPage](/java/docs/reference/google-cloud-telcoautomation/0.19.0/com.google.cloud.telcoautomation.v1alpha1.TelcoAutomationClient.ListHydratedDeploymentsPage)>`  
...
`[TelcoAutomationClient.ListHydratedDeploymentsFixedSizeCollection](/java/docs/reference/google-cloud-telcoautomation/0.19.0/com.google.cloud.telcoautomation.v1alpha1.TelcoAutomationClient.ListHydratedDeploymentsFixedSizeCollection)`
