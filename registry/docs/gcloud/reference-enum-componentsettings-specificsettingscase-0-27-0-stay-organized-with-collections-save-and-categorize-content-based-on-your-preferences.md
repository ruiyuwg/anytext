...
# Enum ComponentSettings.SpecificSettingsCase (0.27.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum ComponentSettings.SpecificSettingsCase extends Enum<ComponentSettings.SpecificSettingsCase> implements Internal.EnumLite, AbstractMessageLite.InternalOneOfEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-securitycenter-settings/0.27.0/com.google.cloud.securitycenter.settings.v1beta1.ComponentSettings.SpecificSettingsCase#com_google_cloud_securitycenter_settings_v1beta1_ComponentSettings_SpecificSettingsCase_forNumber_int_) instead._
