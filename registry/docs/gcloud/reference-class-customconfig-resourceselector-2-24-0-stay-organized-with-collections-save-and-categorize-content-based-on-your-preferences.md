...
# Class CustomConfig.ResourceSelector (2.24.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class CustomConfig.ResourceSelector extends GeneratedMessageV3 implements CustomConfig.ResourceSelectorOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> CustomConfig.ResourceSelector

## Implements

[CustomConfig.ResourceSelectorOrBuilder](/java/docs/reference/google-cloud-securitycenter/2.24.0/com.google.cloud.securitycenter.v1.CustomConfig.ResourceSelectorOrBuilder)
...
### RESOURCE\_TYPES\_FIELD\_NUMBER
...
```
public static CustomConfig.ResourceSelector getDefaultInstance()
```
...
`[CustomConfig.ResourceSelector](/java/docs/reference/google-cloud-securitycenter/2.24.0/com.google.cloud.securitycenter.v1.CustomConfig.ResourceSelector)`
...
```
public static CustomConfig.ResourceSelector.Builder newBuilder()
```
...
`[CustomConfig.ResourceSelector.Builder](/java/docs/reference/google-cloud-securitycenter/2.24.0/com.google.cloud.securitycenter.v1.CustomConfig.ResourceSelector.Builder)`

### newBuilder(CustomConfig.ResourceSelector prototype)

```
public static CustomConfig.ResourceSelector.Builder newBuilder(CustomConfig.ResourceSelector prototype)
```
...
```
public static CustomConfig.ResourceSelector parseDelimitedFrom(InputStream input)
```
...
```
public static CustomConfig.ResourceSelector parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CustomConfig.ResourceSelector parseFrom(byte[] data)
```
...
```
public static CustomConfig.ResourceSelector parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CustomConfig.ResourceSelector parseFrom(ByteString data)
```
...
```
public static CustomConfig.ResourceSelector parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CustomConfig.ResourceSelector parseFrom(CodedInputStream input)
```
...
```
public static CustomConfig.ResourceSelector parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CustomConfig.ResourceSelector parseFrom(InputStream input)
```
...
```
public static CustomConfig.ResourceSelector parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CustomConfig.ResourceSelector parseFrom(ByteBuffer data)
```
...
```
public static CustomConfig.ResourceSelector parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<CustomConfig.ResourceSelector> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ResourceSelector](/java/docs/reference/google-cloud-securitycenter/2.24.0/com.google.cloud.securitycenter.v1.CustomConfig.ResourceSelector)>`
...
```
public Parser<CustomConfig.ResourceSelector> getParserForType()
```
...
```
public CustomConfig.ResourceSelector.Builder newBuilderForType()
```
...
```
protected CustomConfig.ResourceSelector.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public CustomConfig.ResourceSelector.Builder toBuilder()
```
