...
# Class MockAutoscalingPolicyServiceConnection (2.12.0) Stay organized with collections Save and categorize content based on your preferences.
...
Application developers may want to test their code with simulated responses, including errors, from an object of type `AutoscalingPolicyServiceClient`. To do so, construct an object of type `AutoscalingPolicyServiceClient` with an instance of this class. Then use the Google Test framework functions to program the behavior of this mock.
