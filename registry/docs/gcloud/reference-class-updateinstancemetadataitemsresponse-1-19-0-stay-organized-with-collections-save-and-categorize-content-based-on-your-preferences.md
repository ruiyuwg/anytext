...
# Class UpdateInstanceMetadataItemsResponse (1.19.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class UpdateInstanceMetadataItemsResponse extends GeneratedMessageV3 implements UpdateInstanceMetadataItemsResponseOrBuilder
```

Response for adding/changing metadata items for an instance.

Protobuf type `google.cloud.notebooks.v1.UpdateInstanceMetadataItemsResponse`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> UpdateInstanceMetadataItemsResponse

## Implements

[UpdateInstanceMetadataItemsResponseOrBuilder](/java/docs/reference/google-cloud-notebooks/1.19.0/com.google.cloud.notebooks.v1.UpdateInstanceMetadataItemsResponseOrBuilder)
...
```
public static UpdateInstanceMetadataItemsResponse getDefaultInstance()
```
...
`[UpdateInstanceMetadataItemsResponse](/java/docs/reference/google-cloud-notebooks/1.19.0/com.google.cloud.notebooks.v1.UpdateInstanceMetadataItemsResponse)`
...
```
public static UpdateInstanceMetadataItemsResponse.Builder newBuilder()
```
...
`[UpdateInstanceMetadataItemsResponse.Builder](/java/docs/reference/google-cloud-notebooks/1.19.0/com.google.cloud.notebooks.v1.UpdateInstanceMetadataItemsResponse.Builder)`

### newBuilder(UpdateInstanceMetadataItemsResponse prototype)

```
public static UpdateInstanceMetadataItemsResponse.Builder newBuilder(UpdateInstanceMetadataItemsResponse prototype)
```
...
```
public static UpdateInstanceMetadataItemsResponse parseDelimitedFrom(InputStream input)
```
...
```
public static UpdateInstanceMetadataItemsResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateInstanceMetadataItemsResponse parseFrom(byte[] data)
```
...
```
public static UpdateInstanceMetadataItemsResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateInstanceMetadataItemsResponse parseFrom(ByteString data)
```
...
```
public static UpdateInstanceMetadataItemsResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateInstanceMetadataItemsResponse parseFrom(CodedInputStream input)
```
...
```
public static UpdateInstanceMetadataItemsResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateInstanceMetadataItemsResponse parseFrom(InputStream input)
```
...
```
public static UpdateInstanceMetadataItemsResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateInstanceMetadataItemsResponse parseFrom(ByteBuffer data)
```
...
```
public static UpdateInstanceMetadataItemsResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<UpdateInstanceMetadataItemsResponse> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[UpdateInstanceMetadataItemsResponse](/java/docs/reference/google-cloud-notebooks/1.19.0/com.google.cloud.notebooks.v1.UpdateInstanceMetadataItemsResponse)>`
...
```
public UpdateInstanceMetadataItemsResponse getDefaultInstanceForType()
```
...
Use [#getItemsMap()](/java/docs/reference/google-cloud-notebooks/1.19.0/com.google.cloud.notebooks.v1.UpdateInstanceMetadataItemsResponse#com_google_cloud_notebooks_v1_UpdateInstanceMetadataItemsResponse_getItemsMap__) instead.
...
```
public Parser<UpdateInstanceMetadataItemsResponse> getParserForType()
```
...
```
public UpdateInstanceMetadataItemsResponse.Builder newBuilderForType()
```
...
```
protected UpdateInstanceMetadataItemsResponse.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public UpdateInstanceMetadataItemsResponse.Builder toBuilder()
```
