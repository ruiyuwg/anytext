...
# Enum CloudRepoSourceContext.RevisionCase (2.22.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum CloudRepoSourceContext.RevisionCase extends Enum<CloudRepoSourceContext.RevisionCase> implements Internal.EnumLite, AbstractMessageLite.InternalOneOfEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/grafeas/2.22.0/io.grafeas.v1.CloudRepoSourceContext.RevisionCase#io_grafeas_v1_CloudRepoSourceContext_RevisionCase_forNumber_int_) instead._
