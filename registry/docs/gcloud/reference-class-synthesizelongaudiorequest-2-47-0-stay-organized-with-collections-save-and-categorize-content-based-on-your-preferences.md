...
# Class SynthesizeLongAudioRequest (2.47.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> SynthesizeLongAudioRequest

## Implements

[SynthesizeLongAudioRequestOrBuilder](/java/docs/reference/google-cloud-texttospeech/2.47.0/com.google.cloud.texttospeech.v1beta1.SynthesizeLongAudioRequestOrBuilder)
...
### OUTPUT\_GCS\_URI\_FIELD\_NUMBER
...
`[SynthesizeLongAudioRequest](/java/docs/reference/google-cloud-texttospeech/2.47.0/com.google.cloud.texttospeech.v1beta1.SynthesizeLongAudioRequest)`
...
`[SynthesizeLongAudioRequest.Builder](/java/docs/reference/google-cloud-texttospeech/2.47.0/com.google.cloud.texttospeech.v1beta1.SynthesizeLongAudioRequest.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[SynthesizeLongAudioRequest](/java/docs/reference/google-cloud-texttospeech/2.47.0/com.google.cloud.texttospeech.v1beta1.SynthesizeLongAudioRequest)>`
...
`[AudioConfig](/java/docs/reference/google-cloud-texttospeech/2.47.0/com.google.cloud.texttospeech.v1beta1.AudioConfig)`
...
`[AudioConfigOrBuilder](/java/docs/reference/google-cloud-texttospeech/2.47.0/com.google.cloud.texttospeech.v1beta1.AudioConfigOrBuilder)`
...
`[SynthesisInput](/java/docs/reference/google-cloud-texttospeech/2.47.0/com.google.cloud.texttospeech.v1beta1.SynthesisInput)`
...
`[SynthesisInputOrBuilder](/java/docs/reference/google-cloud-texttospeech/2.47.0/com.google.cloud.texttospeech.v1beta1.SynthesisInputOrBuilder)`
...
`[VoiceSelectionParams](/java/docs/reference/google-cloud-texttospeech/2.47.0/com.google.cloud.texttospeech.v1beta1.VoiceSelectionParams)`
...
`[VoiceSelectionParamsOrBuilder](/java/docs/reference/google-cloud-texttospeech/2.47.0/com.google.cloud.texttospeech.v1beta1.VoiceSelectionParamsOrBuilder)`
