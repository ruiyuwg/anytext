...
# Class ResumeMigrationRequest (1.29.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ResumeMigrationRequest extends GeneratedMessageV3 implements ResumeMigrationRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ResumeMigrationRequest

## Implements

[ResumeMigrationRequestOrBuilder](/java/docs/reference/google-cloud-vmmigration/1.29.0/com.google.cloud.vmmigration.v1.ResumeMigrationRequestOrBuilder)
...
```
public static ResumeMigrationRequest getDefaultInstance()
```
...
`[ResumeMigrationRequest](/java/docs/reference/google-cloud-vmmigration/1.29.0/com.google.cloud.vmmigration.v1.ResumeMigrationRequest)`
...
```
public static ResumeMigrationRequest.Builder newBuilder()
```
...
`[ResumeMigrationRequest.Builder](/java/docs/reference/google-cloud-vmmigration/1.29.0/com.google.cloud.vmmigration.v1.ResumeMigrationRequest.Builder)`

### newBuilder(ResumeMigrationRequest prototype)

```
public static ResumeMigrationRequest.Builder newBuilder(ResumeMigrationRequest prototype)
```
...
```
public static ResumeMigrationRequest parseDelimitedFrom(InputStream input)
```
...
```
public static ResumeMigrationRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ResumeMigrationRequest parseFrom(byte[] data)
```
...
```
public static ResumeMigrationRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ResumeMigrationRequest parseFrom(ByteString data)
```
...
```
public static ResumeMigrationRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ResumeMigrationRequest parseFrom(CodedInputStream input)
```
...
```
public static ResumeMigrationRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ResumeMigrationRequest parseFrom(InputStream input)
```
...
```
public static ResumeMigrationRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ResumeMigrationRequest parseFrom(ByteBuffer data)
```
...
```
public static ResumeMigrationRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ResumeMigrationRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ResumeMigrationRequest](/java/docs/reference/google-cloud-vmmigration/1.29.0/com.google.cloud.vmmigration.v1.ResumeMigrationRequest)>`
...
```
public ResumeMigrationRequest getDefaultInstanceForType()
```
...
```
public Parser<ResumeMigrationRequest> getParserForType()
```
...
```
public ResumeMigrationRequest.Builder newBuilderForType()
```
...
```
protected ResumeMigrationRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ResumeMigrationRequest.Builder toBuilder()
```
