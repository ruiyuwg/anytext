...
# Google Cloud AlloyDB for PostgreSQL V1alpha Client - Class ListClustersResponse (0.8.0) Stay organized with collections Save and categorize content based on your preferences.
...
`array<[Google\Cloud\AlloyDb\V1alpha\Cluster](/php/docs/reference/cloud-alloydb/0.8.0/V1alpha.Cluster)>`  
