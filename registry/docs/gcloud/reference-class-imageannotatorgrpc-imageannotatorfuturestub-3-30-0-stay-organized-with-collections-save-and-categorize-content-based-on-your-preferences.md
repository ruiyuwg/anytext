...
# Class ImageAnnotatorGrpc.ImageAnnotatorFutureStub (3.30.0) Stay organized with collections Save and categorize content based on your preferences.
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> io.grpc.stub.AbstractStub \> io.grpc.stub.AbstractFutureStub \> ImageAnnotatorGrpc.ImageAnnotatorFutureStub
...
```
public ListenableFuture<Operation> asyncBatchAnnotateFiles(AsyncBatchAnnotateFilesRequest request)
```
...
`[AsyncBatchAnnotateFilesRequest](/java/docs/reference/google-cloud-vision/3.30.0/com.google.cloud.vision.v1p2beta1.AsyncBatchAnnotateFilesRequest)`  
...
`[BatchAnnotateImagesRequest](/java/docs/reference/google-cloud-vision/3.30.0/com.google.cloud.vision.v1p2beta1.BatchAnnotateImagesRequest)`  
...
`com.google.common.util.concurrent.ListenableFuture<[BatchAnnotateImagesResponse](/java/docs/reference/google-cloud-vision/3.30.0/com.google.cloud.vision.v1p2beta1.BatchAnnotateImagesResponse)>`
...
`[ImageAnnotatorGrpc.ImageAnnotatorFutureStub](/java/docs/reference/google-cloud-vision/3.30.0/com.google.cloud.vision.v1p2beta1.ImageAnnotatorGrpc.ImageAnnotatorFutureStub)`
