...
# Override run\_v2::ExecutionsClient Authentication Defaults
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::run_v2::ExecutionsClient(
        google::cloud::run_v2::MakeExecutionsConnection(options));
  }
```
