...
# Interface HierarchyControllerConfigOrBuilder (1.12.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface HierarchyControllerConfigOrBuilder extends MessageOrBuilder
```
...
```
public abstract boolean getEnableHierarchicalResourceQuota()
```
...
```
public abstract boolean getEnablePodTreeLabels()
```
