...
# Class FailoverInstanceRequest.Builder (2.19.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> FailoverInstanceRequest.Builder

## Implements

[FailoverInstanceRequestOrBuilder](/java/docs/reference/google-cloud-redis/2.19.0/com.google.cloud.redis.v1.FailoverInstanceRequestOrBuilder)
...
`[FailoverInstanceRequest.Builder](/java/docs/reference/google-cloud-redis/2.19.0/com.google.cloud.redis.v1.FailoverInstanceRequest.Builder)`
...
`[FailoverInstanceRequest](/java/docs/reference/google-cloud-redis/2.19.0/com.google.cloud.redis.v1.FailoverInstanceRequest)`
...
```
public FailoverInstanceRequest.Builder clearDataProtectionMode()
```
...
```
public FailoverInstanceRequest.DataProtectionMode getDataProtectionMode()
```
...
`[FailoverInstanceRequest.DataProtectionMode](/java/docs/reference/google-cloud-redis/2.19.0/com.google.cloud.redis.v1.FailoverInstanceRequest.DataProtectionMode)`
...
```
public FailoverInstanceRequest.Builder setDataProtectionMode(FailoverInstanceRequest.DataProtectionMode value)
```
...
```
public FailoverInstanceRequest.Builder setDataProtectionModeValue(int value)
```
...
The enum numeric value on the wire for dataProtectionMode to set.
