...
# Class DeleteDashboardRequest (2.59.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class DeleteDashboardRequest extends GeneratedMessageV3 implements DeleteDashboardRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> DeleteDashboardRequest

## Implements

[DeleteDashboardRequestOrBuilder](/java/docs/reference/google-cloud-monitoring-dashboard/2.59.0/com.google.monitoring.dashboard.v1.DeleteDashboardRequestOrBuilder)
...
`[DeleteDashboardRequest](/java/docs/reference/google-cloud-monitoring-dashboard/2.59.0/com.google.monitoring.dashboard.v1.DeleteDashboardRequest)`
...
```
public static DeleteDashboardRequest.Builder newBuilder()
```
...
`[DeleteDashboardRequest.Builder](/java/docs/reference/google-cloud-monitoring-dashboard/2.59.0/com.google.monitoring.dashboard.v1.DeleteDashboardRequest.Builder)`

### newBuilder(DeleteDashboardRequest prototype)

```
public static DeleteDashboardRequest.Builder newBuilder(DeleteDashboardRequest prototype)
```
...
```
public static DeleteDashboardRequest parseDelimitedFrom(InputStream input)
```
...
```
public static DeleteDashboardRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteDashboardRequest parseFrom(byte[] data)
```
...
```
public static DeleteDashboardRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteDashboardRequest parseFrom(ByteString data)
```
...
```
public static DeleteDashboardRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteDashboardRequest parseFrom(CodedInputStream input)
```
...
```
public static DeleteDashboardRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteDashboardRequest parseFrom(InputStream input)
```
...
```
public static DeleteDashboardRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteDashboardRequest parseFrom(ByteBuffer data)
```
...
```
public static DeleteDashboardRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[DeleteDashboardRequest](/java/docs/reference/google-cloud-monitoring-dashboard/2.59.0/com.google.monitoring.dashboard.v1.DeleteDashboardRequest)>`
...
```
public DeleteDashboardRequest.Builder newBuilderForType()
```
...
```
protected DeleteDashboardRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public DeleteDashboardRequest.Builder toBuilder()
```
