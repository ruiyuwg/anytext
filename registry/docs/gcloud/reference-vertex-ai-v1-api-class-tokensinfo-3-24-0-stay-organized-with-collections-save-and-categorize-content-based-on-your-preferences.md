...
# Vertex AI v1 API - Class TokensInfo (3.24.0) Stay organized with collections Save and categorize content based on your preferences.
...
Reference documentation and code samples for the Vertex AI v1 API class TokensInfo.

Tokens info with a list of tokens and the corresponding list of token ids.

## Inheritance

[object](https://learn.microsoft.com/dotnet/api/system.object) \> TokensInfo

## Implements

[IMessage](https://cloud.google.com/dotnet/docs/reference/Google.Protobuf/latest/Google.Protobuf.IMessage-1.html)[TokensInfo](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.24.0/Google.Cloud.AIPlatform.V1.TokensInfo), [IEquatable](https://learn.microsoft.com/dotnet/api/system.iequatable-1)[TokensInfo](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.24.0/Google.Cloud.AIPlatform.V1.TokensInfo), [IDeepCloneable](https://cloud.google.com/dotnet/docs/reference/Google.Protobuf/latest/Google.Protobuf.IDeepCloneable-1.html)[TokensInfo](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.24.0/Google.Cloud.AIPlatform.V1.TokensInfo), [IBufferMessage](https://cloud.google.com/dotnet/docs/reference/Google.Protobuf/latest/Google.Protobuf.IBufferMessage.html), [IMessage](https://cloud.google.com/dotnet/docs/reference/Google.Protobuf/latest/Google.Protobuf.IMessage.html)
...
`[TokensInfo](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.24.0/Google.Cloud.AIPlatform.V1.TokensInfo)`  
