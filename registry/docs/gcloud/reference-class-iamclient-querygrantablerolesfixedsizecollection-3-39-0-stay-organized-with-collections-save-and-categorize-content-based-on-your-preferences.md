...
# Class IAMClient.QueryGrantableRolesFixedSizeCollection (3.39.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class IAMClient.QueryGrantableRolesFixedSizeCollection extends AbstractFixedSizeCollection<QueryGrantableRolesRequest,QueryGrantableRolesResponse,Role,IAMClient.QueryGrantableRolesPage,IAMClient.QueryGrantableRolesFixedSizeCollection>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractFixedSizeCollection](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractFixedSizeCollection.html) \> IAMClient.QueryGrantableRolesFixedSizeCollection
...
### createCollection(List<IAMClient.QueryGrantableRolesPage> pages, int collectionSize)

```
protected IAMClient.QueryGrantableRolesFixedSizeCollection createCollection(List<IAMClient.QueryGrantableRolesPage> pages, int collectionSize)
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[QueryGrantableRolesPage](/java/docs/reference/google-iam-admin/3.39.0/com.google.cloud.iam.admin.v1.IAMClient.QueryGrantableRolesPage)>`  
...
`[IAMClient.QueryGrantableRolesFixedSizeCollection](/java/docs/reference/google-iam-admin/3.39.0/com.google.cloud.iam.admin.v1.IAMClient.QueryGrantableRolesFixedSizeCollection)`
