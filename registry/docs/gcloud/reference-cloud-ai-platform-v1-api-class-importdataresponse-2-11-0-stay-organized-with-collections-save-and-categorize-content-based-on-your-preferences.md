...
# Cloud AI Platform v1 API - Class ImportDataResponse (2.11.0) Stay organized with collections Save and categorize content based on your preferences.
...
[object](https://learn.microsoft.com/dotnet/api/system.object) \> ImportDataResponse

## Implements

[IMessage](https://cloud.google.com/dotnet/docs/reference/Google.Protobuf/latest/Google.Protobuf.IMessage-1.html)[ImportDataResponse](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/2.11.0/Google.Cloud.AIPlatform.V1.ImportDataResponse), [IEquatable](https://learn.microsoft.com/dotnet/api/system.iequatable-1)[ImportDataResponse](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/2.11.0/Google.Cloud.AIPlatform.V1.ImportDataResponse), [IDeepCloneable](https://cloud.google.com/dotnet/docs/reference/Google.Protobuf/latest/Google.Protobuf.IDeepCloneable-1.html)[ImportDataResponse](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/2.11.0/Google.Cloud.AIPlatform.V1.ImportDataResponse), [IBufferMessage](https://cloud.google.com/dotnet/docs/reference/Google.Protobuf/latest/Google.Protobuf.IBufferMessage.html), [IMessage](https://cloud.google.com/dotnet/docs/reference/Google.Protobuf/latest/Google.Protobuf.IMessage.html)
...
`[ImportDataResponse](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/2.11.0/Google.Cloud.AIPlatform.V1.ImportDataResponse)`  
