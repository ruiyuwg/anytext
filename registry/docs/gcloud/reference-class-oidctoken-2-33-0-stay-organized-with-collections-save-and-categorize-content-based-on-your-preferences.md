...
# Class OidcToken (2.33.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class OidcToken extends GeneratedMessageV3 implements OidcTokenOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> OidcToken

## Implements

[OidcTokenOrBuilder](/java/docs/reference/google-cloud-scheduler/2.33.0/com.google.cloud.scheduler.v1.OidcTokenOrBuilder)
...
`[OidcToken](/java/docs/reference/google-cloud-scheduler/2.33.0/com.google.cloud.scheduler.v1.OidcToken)`
...
```
public static OidcToken.Builder newBuilder()
```
...
`[OidcToken.Builder](/java/docs/reference/google-cloud-scheduler/2.33.0/com.google.cloud.scheduler.v1.OidcToken.Builder)`

### newBuilder(OidcToken prototype)

```
public static OidcToken.Builder newBuilder(OidcToken prototype)
```
...
```
public static OidcToken parseDelimitedFrom(InputStream input)
```
...
```
public static OidcToken parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static OidcToken parseFrom(byte[] data)
```
...
```
public static OidcToken parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static OidcToken parseFrom(ByteString data)
```
...
```
public static OidcToken parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static OidcToken parseFrom(CodedInputStream input)
```
...
```
public static OidcToken parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static OidcToken parseFrom(InputStream input)
```
...
```
public static OidcToken parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static OidcToken parseFrom(ByteBuffer data)
```
...
```
public static OidcToken parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[OidcToken](/java/docs/reference/google-cloud-scheduler/2.33.0/com.google.cloud.scheduler.v1.OidcToken)>`
...
```
public OidcToken.Builder newBuilderForType()
```
...
```
protected OidcToken.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public OidcToken.Builder toBuilder()
```
