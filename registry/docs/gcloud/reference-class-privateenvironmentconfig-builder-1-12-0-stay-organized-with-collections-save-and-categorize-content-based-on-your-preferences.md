...
# Class PrivateEnvironmentConfig.Builder (1.12.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> PrivateEnvironmentConfig.Builder

## Implements

[PrivateEnvironmentConfigOrBuilder](/java/docs/reference/google-cloud-orchestration-airflow/1.12.0/com.google.cloud.orchestration.airflow.service.v1.PrivateEnvironmentConfigOrBuilder)
...
`[PrivateEnvironmentConfig.Builder](/java/docs/reference/google-cloud-orchestration-airflow/1.12.0/com.google.cloud.orchestration.airflow.service.v1.PrivateEnvironmentConfig.Builder)`
...
`[PrivateEnvironmentConfig](/java/docs/reference/google-cloud-orchestration-airflow/1.12.0/com.google.cloud.orchestration.airflow.service.v1.PrivateEnvironmentConfig)`
...
Optional. The CIDR block from which IP range for Cloud Composer Network in tenant project will be reserved. Needs to be disjoint from private\_cluster\_config.master\_ipv4\_cidr\_block and cloud\_sql\_ipv4\_cidr\_block. This field is supported for Cloud Composer environments in versions composer-2._._\-airflow-_._.\* and newer.
...
Output only. The IP range reserved for the tenant project's Cloud Composer network. This field is supported for Cloud Composer environments in versions composer-2._._\-airflow-_._.\* and newer.
...
Optional. If `true`, a Private IP Cloud Composer environment is created. If this field is set to true, `IPAllocationPolicy.use_ip_aliases` must be set to true for Cloud Composer environments in versions composer-1._._\-airflow-_._.\*.
...
Optional. The CIDR block from which IP range for web server will be reserved. Needs to be disjoint from `private_cluster_config.master_ipv4_cidr_block` and `cloud_sql_ipv4_cidr_block`. This field is supported for Cloud Composer environments in versions composer-1._._\-airflow-_._.\*.
...
Output only. The IP range reserved for the tenant project's App Engine VMs. This field is supported for Cloud Composer environments in versions composer-1._._\-airflow-_._.\*.
...
`[NetworkingConfig](/java/docs/reference/google-cloud-orchestration-airflow/1.12.0/com.google.cloud.orchestration.airflow.service.v1.NetworkingConfig)`
...
`[NetworkingConfig.Builder](/java/docs/reference/google-cloud-orchestration-airflow/1.12.0/com.google.cloud.orchestration.airflow.service.v1.NetworkingConfig.Builder)`
...
`[NetworkingConfigOrBuilder](/java/docs/reference/google-cloud-orchestration-airflow/1.12.0/com.google.cloud.orchestration.airflow.service.v1.NetworkingConfigOrBuilder)`
...
`[PrivateClusterConfig](/java/docs/reference/google-cloud-orchestration-airflow/1.12.0/com.google.cloud.orchestration.airflow.service.v1.PrivateClusterConfig)`
...
`[PrivateClusterConfig.Builder](/java/docs/reference/google-cloud-orchestration-airflow/1.12.0/com.google.cloud.orchestration.airflow.service.v1.PrivateClusterConfig.Builder)`
...
`[PrivateClusterConfigOrBuilder](/java/docs/reference/google-cloud-orchestration-airflow/1.12.0/com.google.cloud.orchestration.airflow.service.v1.PrivateClusterConfigOrBuilder)`
