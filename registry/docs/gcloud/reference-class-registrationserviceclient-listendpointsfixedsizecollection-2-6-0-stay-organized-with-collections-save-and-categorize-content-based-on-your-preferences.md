...
# Class RegistrationServiceClient.ListEndpointsFixedSizeCollection (2.6.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ListEndpointsPage](/java/docs/reference/google-cloud-servicedirectory/2.6.0/com.google.cloud.servicedirectory.v1beta1.RegistrationServiceClient.ListEndpointsPage)>`  
...
[RegistrationServiceClient.ListEndpointsFixedSizeCollection](/java/docs/reference/google-cloud-servicedirectory/2.6.0/com.google.cloud.servicedirectory.v1beta1.RegistrationServiceClient.ListEndpointsFixedSizeCollection)
