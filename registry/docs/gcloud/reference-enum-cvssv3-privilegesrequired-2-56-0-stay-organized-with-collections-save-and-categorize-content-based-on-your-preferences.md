...
# Enum Cvssv3.PrivilegesRequired (2.56.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-securitycenter/2.56.0/com.google.cloud.securitycenter.v1.Cvssv3.PrivilegesRequired#com_google_cloud_securitycenter_v1_Cvssv3_PrivilegesRequired_forNumber_int_) instead._
