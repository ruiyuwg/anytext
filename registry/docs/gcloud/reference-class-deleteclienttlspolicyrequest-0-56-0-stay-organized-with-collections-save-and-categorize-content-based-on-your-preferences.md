...
# Class DeleteClientTlsPolicyRequest (0.56.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class DeleteClientTlsPolicyRequest extends GeneratedMessageV3 implements DeleteClientTlsPolicyRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> DeleteClientTlsPolicyRequest

## Implements

[DeleteClientTlsPolicyRequestOrBuilder](/java/docs/reference/google-cloud-network-security/0.56.0/com.google.cloud.networksecurity.v1beta1.DeleteClientTlsPolicyRequestOrBuilder)
...
```
public static DeleteClientTlsPolicyRequest getDefaultInstance()
```
...
`[DeleteClientTlsPolicyRequest](/java/docs/reference/google-cloud-network-security/0.56.0/com.google.cloud.networksecurity.v1beta1.DeleteClientTlsPolicyRequest)`
...
```
public static DeleteClientTlsPolicyRequest.Builder newBuilder()
```
...
`[DeleteClientTlsPolicyRequest.Builder](/java/docs/reference/google-cloud-network-security/0.56.0/com.google.cloud.networksecurity.v1beta1.DeleteClientTlsPolicyRequest.Builder)`

### newBuilder(DeleteClientTlsPolicyRequest prototype)

```
public static DeleteClientTlsPolicyRequest.Builder newBuilder(DeleteClientTlsPolicyRequest prototype)
```
...
```
public static DeleteClientTlsPolicyRequest parseDelimitedFrom(InputStream input)
```
...
```
public static DeleteClientTlsPolicyRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteClientTlsPolicyRequest parseFrom(byte[] data)
```
...
```
public static DeleteClientTlsPolicyRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteClientTlsPolicyRequest parseFrom(ByteString data)
```
...
```
public static DeleteClientTlsPolicyRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteClientTlsPolicyRequest parseFrom(CodedInputStream input)
```
...
```
public static DeleteClientTlsPolicyRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteClientTlsPolicyRequest parseFrom(InputStream input)
```
...
```
public static DeleteClientTlsPolicyRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteClientTlsPolicyRequest parseFrom(ByteBuffer data)
```
...
```
public static DeleteClientTlsPolicyRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<DeleteClientTlsPolicyRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[DeleteClientTlsPolicyRequest](/java/docs/reference/google-cloud-network-security/0.56.0/com.google.cloud.networksecurity.v1beta1.DeleteClientTlsPolicyRequest)>`
...
```
public Parser<DeleteClientTlsPolicyRequest> getParserForType()
```
...
```
public DeleteClientTlsPolicyRequest.Builder newBuilderForType()
```
...
```
protected DeleteClientTlsPolicyRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public DeleteClientTlsPolicyRequest.Builder toBuilder()
```
