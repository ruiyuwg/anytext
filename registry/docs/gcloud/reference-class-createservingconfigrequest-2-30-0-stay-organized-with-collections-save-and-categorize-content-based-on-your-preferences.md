...
# Class CreateServingConfigRequest (2.30.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class CreateServingConfigRequest extends GeneratedMessageV3 implements CreateServingConfigRequestOrBuilder
```

Request for CreateServingConfig method.

Protobuf type `google.cloud.retail.v2alpha.CreateServingConfigRequest`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> CreateServingConfigRequest

## Implements

[CreateServingConfigRequestOrBuilder](/java/docs/reference/google-cloud-retail/2.30.0/com.google.cloud.retail.v2alpha.CreateServingConfigRequestOrBuilder)
...
### SERVING\_CONFIG\_FIELD\_NUMBER
...
### SERVING\_CONFIG\_ID\_FIELD\_NUMBER
...
```
public static CreateServingConfigRequest getDefaultInstance()
```
...
`[CreateServingConfigRequest](/java/docs/reference/google-cloud-retail/2.30.0/com.google.cloud.retail.v2alpha.CreateServingConfigRequest)`
...
```
public static CreateServingConfigRequest.Builder newBuilder()
```
...
`[CreateServingConfigRequest.Builder](/java/docs/reference/google-cloud-retail/2.30.0/com.google.cloud.retail.v2alpha.CreateServingConfigRequest.Builder)`

### newBuilder(CreateServingConfigRequest prototype)

```
public static CreateServingConfigRequest.Builder newBuilder(CreateServingConfigRequest prototype)
```
...
```
public static CreateServingConfigRequest parseDelimitedFrom(InputStream input)
```
...
```
public static CreateServingConfigRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateServingConfigRequest parseFrom(byte[] data)
```
...
```
public static CreateServingConfigRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateServingConfigRequest parseFrom(ByteString data)
```
...
```
public static CreateServingConfigRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateServingConfigRequest parseFrom(CodedInputStream input)
```
...
```
public static CreateServingConfigRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateServingConfigRequest parseFrom(InputStream input)
```
...
```
public static CreateServingConfigRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateServingConfigRequest parseFrom(ByteBuffer data)
```
...
```
public static CreateServingConfigRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<CreateServingConfigRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[CreateServingConfigRequest](/java/docs/reference/google-cloud-retail/2.30.0/com.google.cloud.retail.v2alpha.CreateServingConfigRequest)>`
...
```
public Parser<CreateServingConfigRequest> getParserForType()
```
...
`[ServingConfig](/java/docs/reference/google-cloud-retail/2.30.0/com.google.cloud.retail.v2alpha.ServingConfig)`
...
`[ServingConfigOrBuilder](/java/docs/reference/google-cloud-retail/2.30.0/com.google.cloud.retail.v2alpha.ServingConfigOrBuilder)`
...
```
public CreateServingConfigRequest.Builder newBuilderForType()
```
...
```
protected CreateServingConfigRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public CreateServingConfigRequest.Builder toBuilder()
```
