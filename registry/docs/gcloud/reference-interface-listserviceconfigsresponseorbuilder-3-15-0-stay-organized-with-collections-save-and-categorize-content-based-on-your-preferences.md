...
# Interface ListServiceConfigsResponseOrBuilder (3.15.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public abstract Service getServiceConfigs(int index)
```
...
```
public abstract int getServiceConfigsCount()
```
...
```
public abstract List<Service> getServiceConfigsList()
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<com.google.api.Service>`

### getServiceConfigsOrBuilder(int index)

```
public abstract ServiceOrBuilder getServiceConfigsOrBuilder(int index)
```
...
```
public abstract List<? extends ServiceOrBuilder> getServiceConfigsOrBuilderList()
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.api.ServiceOrBuilder>`
