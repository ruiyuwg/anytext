...
# Interface ReferenceImageOrBuilder (3.26.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public abstract BoundingPoly getBoundingPolys(int index)
```
...
`[BoundingPoly](/java/docs/reference/google-cloud-vision/3.26.0/com.google.cloud.vision.v1p4beta1.BoundingPoly)`

### getBoundingPolysCount()

```
public abstract int getBoundingPolysCount()
```
...
```
public abstract List<BoundingPoly> getBoundingPolysList()
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[BoundingPoly](/java/docs/reference/google-cloud-vision/3.26.0/com.google.cloud.vision.v1p4beta1.BoundingPoly)>`

### getBoundingPolysOrBuilder(int index)

```
public abstract BoundingPolyOrBuilder getBoundingPolysOrBuilder(int index)
```
...
`[BoundingPolyOrBuilder](/java/docs/reference/google-cloud-vision/3.26.0/com.google.cloud.vision.v1p4beta1.BoundingPolyOrBuilder)`

### getBoundingPolysOrBuilderList()

```
public abstract List<? extends BoundingPolyOrBuilder> getBoundingPolysOrBuilderList()
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.vision.v1p4beta1.BoundingPolyOrBuilder>`
