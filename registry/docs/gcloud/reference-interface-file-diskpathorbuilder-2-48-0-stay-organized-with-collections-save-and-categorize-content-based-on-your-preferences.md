...
# Interface File.DiskPathOrBuilder (2.48.0) Stay organized with collections Save and categorize content based on your preferences.
...
UUID of the partition (format [https://wiki.archlinux.org/title/persistent\_block\_device\_naming#by-uuid](https://wiki.archlinux.org/title/persistent_block_device_naming#by-uuid))
...
Relative path of the file in the partition as a JSON encoded string. Example: /home/user1/executable\_file.sh
