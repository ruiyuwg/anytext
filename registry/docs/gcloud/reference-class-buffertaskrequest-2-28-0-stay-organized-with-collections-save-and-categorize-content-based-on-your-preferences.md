...
# Class BufferTaskRequest (2.28.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class BufferTaskRequest extends GeneratedMessageV3 implements BufferTaskRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> BufferTaskRequest

## Implements

[BufferTaskRequestOrBuilder](/java/docs/reference/google-cloud-tasks/2.28.0/com.google.cloud.tasks.v2beta2.BufferTaskRequestOrBuilder)
...
`[BufferTaskRequest](/java/docs/reference/google-cloud-tasks/2.28.0/com.google.cloud.tasks.v2beta2.BufferTaskRequest)`
...
`[BufferTaskRequest.Builder](/java/docs/reference/google-cloud-tasks/2.28.0/com.google.cloud.tasks.v2beta2.BufferTaskRequest.Builder)`
...
```
public static BufferTaskRequest parseDelimitedFrom(InputStream input)
```
...
```
public static BufferTaskRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static BufferTaskRequest parseFrom(byte[] data)
```
...
```
public static BufferTaskRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static BufferTaskRequest parseFrom(ByteString data)
```
...
```
public static BufferTaskRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static BufferTaskRequest parseFrom(CodedInputStream input)
```
...
```
public static BufferTaskRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static BufferTaskRequest parseFrom(InputStream input)
```
...
```
public static BufferTaskRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static BufferTaskRequest parseFrom(ByteBuffer data)
```
...
```
public static BufferTaskRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<BufferTaskRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[BufferTaskRequest](/java/docs/reference/google-cloud-tasks/2.28.0/com.google.cloud.tasks.v2beta2.BufferTaskRequest)>`
...
```
public Parser<BufferTaskRequest> getParserForType()
```
...
Required. The parent queue name. For example: projects/PROJECT\_ID/locations/LOCATION\_ID/queues/QUEUE\_ID\`
...
```
protected BufferTaskRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
