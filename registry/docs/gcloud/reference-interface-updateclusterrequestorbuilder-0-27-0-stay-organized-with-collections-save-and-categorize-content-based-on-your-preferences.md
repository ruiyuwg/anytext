...
# Interface UpdateClusterRequestOrBuilder (0.27.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[Cluster](/java/docs/reference/google-cloud-redis-cluster/0.27.0/com.google.cloud.redis.cluster.v1beta1.Cluster)`
...
`[ClusterOrBuilder](/java/docs/reference/google-cloud-redis-cluster/0.27.0/com.google.cloud.redis.cluster.v1beta1.ClusterOrBuilder)`
