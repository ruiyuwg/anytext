...
# Class LocationName (0.1.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[LocationName.Builder](/java/docs/reference/google-cloud-migrationcenter/0.1.0/com.google.cloud.migrationcenter.v1.LocationName.Builder)`
...
`[LocationName](/java/docs/reference/google-cloud-migrationcenter/0.1.0/com.google.cloud.migrationcenter.v1.LocationName)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[LocationName](/java/docs/reference/google-cloud-migrationcenter/0.1.0/com.google.cloud.migrationcenter.v1.LocationName)>`
