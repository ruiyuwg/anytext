...
# Enum TransferTypes.MetadataOptions.UID (1.53.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum TransferTypes.MetadataOptions.UID extends Enum<TransferTypes.MetadataOptions.UID> implements ProtocolMessageEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-storage-transfer/1.53.0/com.google.storagetransfer.v1.proto.TransferTypes.MetadataOptions.UID#com_google_storagetransfer_v1_proto_TransferTypes_MetadataOptions_UID_forNumber_int_) instead._
