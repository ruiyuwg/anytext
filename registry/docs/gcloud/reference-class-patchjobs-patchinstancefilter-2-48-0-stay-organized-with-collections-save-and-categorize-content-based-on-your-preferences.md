...
# Class PatchJobs.PatchInstanceFilter (2.48.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> PatchJobs.PatchInstanceFilter

## Implements

[PatchJobs.PatchInstanceFilterOrBuilder](/java/docs/reference/google-cloud-os-config/2.48.0/com.google.cloud.osconfig.v1.PatchJobs.PatchInstanceFilterOrBuilder)
...
### INSTANCE\_NAME\_PREFIXES\_FIELD\_NUMBER
...
`[PatchJobs.PatchInstanceFilter](/java/docs/reference/google-cloud-os-config/2.48.0/com.google.cloud.osconfig.v1.PatchJobs.PatchInstanceFilter)`
...
`[PatchJobs.PatchInstanceFilter.Builder](/java/docs/reference/google-cloud-os-config/2.48.0/com.google.cloud.osconfig.v1.PatchJobs.PatchInstanceFilter.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[PatchInstanceFilter](/java/docs/reference/google-cloud-os-config/2.48.0/com.google.cloud.osconfig.v1.PatchJobs.PatchInstanceFilter)>`
...
`[PatchJobs.PatchInstanceFilter.GroupLabel](/java/docs/reference/google-cloud-os-config/2.48.0/com.google.cloud.osconfig.v1.PatchJobs.PatchInstanceFilter.GroupLabel)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[GroupLabel](/java/docs/reference/google-cloud-os-config/2.48.0/com.google.cloud.osconfig.v1.PatchJobs.PatchInstanceFilter.GroupLabel)>`
...
`[PatchJobs.PatchInstanceFilter.GroupLabelOrBuilder](/java/docs/reference/google-cloud-os-config/2.48.0/com.google.cloud.osconfig.v1.PatchJobs.PatchInstanceFilter.GroupLabelOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.osconfig.v1.PatchJobs.PatchInstanceFilter.GroupLabelOrBuilder>`
