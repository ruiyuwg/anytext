...
# Class CloudRedisClusterClient.ListClustersPage (0.30.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class CloudRedisClusterClient.ListClustersPage extends AbstractPage<ListClustersRequest,ListClustersResponse,Cluster,CloudRedisClusterClient.ListClustersPage>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractPage](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractPage.html) \> CloudRedisClusterClient.ListClustersPage
...
### createPage(PageContext<ListClustersRequest,ListClustersResponse,Cluster> context, ListClustersResponse response)

```
protected CloudRedisClusterClient.ListClustersPage createPage(PageContext<ListClustersRequest,ListClustersResponse,Cluster> context, ListClustersResponse response)
```
...
`[PageContext](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PageContext.html)<[ListClustersRequest](/java/docs/reference/google-cloud-redis-cluster/0.30.0/com.google.cloud.redis.cluster.v1.ListClustersRequest),[ListClustersResponse](/java/docs/reference/google-cloud-redis-cluster/0.30.0/com.google.cloud.redis.cluster.v1.ListClustersResponse),[Cluster](/java/docs/reference/google-cloud-redis-cluster/0.30.0/com.google.cloud.redis.cluster.v1.Cluster)>`  

`response`

`[ListClustersResponse](/java/docs/reference/google-cloud-redis-cluster/0.30.0/com.google.cloud.redis.cluster.v1.ListClustersResponse)`  
...
`[CloudRedisClusterClient.ListClustersPage](/java/docs/reference/google-cloud-redis-cluster/0.30.0/com.google.cloud.redis.cluster.v1.CloudRedisClusterClient.ListClustersPage)`
...
### createPageAsync(PageContext<ListClustersRequest,ListClustersResponse,Cluster> context, ApiFuture<ListClustersResponse> futureResponse)

```
public ApiFuture<CloudRedisClusterClient.ListClustersPage> createPageAsync(PageContext<ListClustersRequest,ListClustersResponse,Cluster> context, ApiFuture<ListClustersResponse> futureResponse)
```
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListClustersResponse](/java/docs/reference/google-cloud-redis-cluster/0.30.0/com.google.cloud.redis.cluster.v1.ListClustersResponse)>`  
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListClustersPage](/java/docs/reference/google-cloud-redis-cluster/0.30.0/com.google.cloud.redis.cluster.v1.CloudRedisClusterClient.ListClustersPage)>`
