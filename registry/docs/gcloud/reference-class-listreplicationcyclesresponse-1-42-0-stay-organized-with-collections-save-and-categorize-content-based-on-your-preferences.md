...
# Class ListReplicationCyclesResponse (1.42.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListReplicationCyclesResponse extends GeneratedMessageV3 implements ListReplicationCyclesResponseOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListReplicationCyclesResponse

## Implements

[ListReplicationCyclesResponseOrBuilder](/java/docs/reference/google-cloud-vmmigration/1.42.0/com.google.cloud.vmmigration.v1.ListReplicationCyclesResponseOrBuilder)
...
### REPLICATION\_CYCLES\_FIELD\_NUMBER

```
public static final int REPLICATION_CYCLES_FIELD_NUMBER
```
...
```
public static ListReplicationCyclesResponse getDefaultInstance()
```
...
`[ListReplicationCyclesResponse](/java/docs/reference/google-cloud-vmmigration/1.42.0/com.google.cloud.vmmigration.v1.ListReplicationCyclesResponse)`
...
```
public static ListReplicationCyclesResponse.Builder newBuilder()
```
...
`[ListReplicationCyclesResponse.Builder](/java/docs/reference/google-cloud-vmmigration/1.42.0/com.google.cloud.vmmigration.v1.ListReplicationCyclesResponse.Builder)`

### newBuilder(ListReplicationCyclesResponse prototype)

```
public static ListReplicationCyclesResponse.Builder newBuilder(ListReplicationCyclesResponse prototype)
```
...
```
public static ListReplicationCyclesResponse parseDelimitedFrom(InputStream input)
```
...
```
public static ListReplicationCyclesResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListReplicationCyclesResponse parseFrom(byte[] data)
```
...
```
public static ListReplicationCyclesResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListReplicationCyclesResponse parseFrom(ByteString data)
```
...
```
public static ListReplicationCyclesResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListReplicationCyclesResponse parseFrom(CodedInputStream input)
```
...
```
public static ListReplicationCyclesResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListReplicationCyclesResponse parseFrom(InputStream input)
```
...
```
public static ListReplicationCyclesResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListReplicationCyclesResponse parseFrom(ByteBuffer data)
```
...
```
public static ListReplicationCyclesResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ListReplicationCyclesResponse> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListReplicationCyclesResponse](/java/docs/reference/google-cloud-vmmigration/1.42.0/com.google.cloud.vmmigration.v1.ListReplicationCyclesResponse)>`
...
```
public Parser<ListReplicationCyclesResponse> getParserForType()
```
...
```
public ReplicationCycle getReplicationCycles(int index)
```
...
`[ReplicationCycle](/java/docs/reference/google-cloud-vmmigration/1.42.0/com.google.cloud.vmmigration.v1.ReplicationCycle)`
...
```
public List<ReplicationCycle> getReplicationCyclesList()
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ReplicationCycle](/java/docs/reference/google-cloud-vmmigration/1.42.0/com.google.cloud.vmmigration.v1.ReplicationCycle)>`

### getReplicationCyclesOrBuilder(int index)

```
public ReplicationCycleOrBuilder getReplicationCyclesOrBuilder(int index)
```
...
`[ReplicationCycleOrBuilder](/java/docs/reference/google-cloud-vmmigration/1.42.0/com.google.cloud.vmmigration.v1.ReplicationCycleOrBuilder)`

### getReplicationCyclesOrBuilderList()

```
public List<? extends ReplicationCycleOrBuilder> getReplicationCyclesOrBuilderList()
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.vmmigration.v1.ReplicationCycleOrBuilder>`
...
```
public ListReplicationCyclesResponse.Builder newBuilderForType()
```
...
```
protected ListReplicationCyclesResponse.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ListReplicationCyclesResponse.Builder toBuilder()
```
