...
# Interface VideoIntelligenceServiceGrpc.AsyncService (2.58.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[AnnotateVideoRequest](/java/docs/reference/google-cloud-video-intelligence/2.58.0/com.google.cloud.videointelligence.v1p2beta1.AnnotateVideoRequest)`  
