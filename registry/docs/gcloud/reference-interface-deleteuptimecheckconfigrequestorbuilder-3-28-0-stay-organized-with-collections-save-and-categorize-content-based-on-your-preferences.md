...
# Interface DeleteUptimeCheckConfigRequestOrBuilder (3.28.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface DeleteUptimeCheckConfigRequestOrBuilder extends MessageOrBuilder
```
