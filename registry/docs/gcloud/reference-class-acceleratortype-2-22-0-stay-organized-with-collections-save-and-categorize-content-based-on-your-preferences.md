...
# Class AcceleratorType (2.22.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> AcceleratorType

## Implements

[AcceleratorTypeOrBuilder](/java/docs/reference/google-cloud-tpu/2.22.0/com.google.cloud.tpu.v2alpha1.AcceleratorTypeOrBuilder)
...
### ACCELERATOR\_CONFIGS\_FIELD\_NUMBER
...
`[AcceleratorType](/java/docs/reference/google-cloud-tpu/2.22.0/com.google.cloud.tpu.v2alpha1.AcceleratorType)`
...
```
public static AcceleratorType.Builder newBuilder()
```
...
`[AcceleratorType.Builder](/java/docs/reference/google-cloud-tpu/2.22.0/com.google.cloud.tpu.v2alpha1.AcceleratorType.Builder)`

### newBuilder(AcceleratorType prototype)

```
public static AcceleratorType.Builder newBuilder(AcceleratorType prototype)
```
...
```
public static AcceleratorType parseDelimitedFrom(InputStream input)
```
...
```
public static AcceleratorType parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AcceleratorType parseFrom(byte[] data)
```
...
```
public static AcceleratorType parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AcceleratorType parseFrom(ByteString data)
```
...
```
public static AcceleratorType parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AcceleratorType parseFrom(CodedInputStream input)
```
...
```
public static AcceleratorType parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AcceleratorType parseFrom(InputStream input)
```
...
```
public static AcceleratorType parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AcceleratorType parseFrom(ByteBuffer data)
```
...
```
public static AcceleratorType parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[AcceleratorType](/java/docs/reference/google-cloud-tpu/2.22.0/com.google.cloud.tpu.v2alpha1.AcceleratorType)>`
...
`[AcceleratorConfig](/java/docs/reference/google-cloud-tpu/2.22.0/com.google.cloud.tpu.v2alpha1.AcceleratorConfig)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[AcceleratorConfig](/java/docs/reference/google-cloud-tpu/2.22.0/com.google.cloud.tpu.v2alpha1.AcceleratorConfig)>`
...
`[AcceleratorConfigOrBuilder](/java/docs/reference/google-cloud-tpu/2.22.0/com.google.cloud.tpu.v2alpha1.AcceleratorConfigOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.tpu.v2alpha1.AcceleratorConfigOrBuilder>`
...
```
public AcceleratorType.Builder newBuilderForType()
```
...
```
protected AcceleratorType.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public AcceleratorType.Builder toBuilder()
```
