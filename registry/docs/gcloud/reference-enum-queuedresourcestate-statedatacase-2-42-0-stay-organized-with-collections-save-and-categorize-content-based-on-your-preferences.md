...
# Enum QueuedResourceState.StateDataCase (2.42.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum QueuedResourceState.StateDataCase extends Enum<QueuedResourceState.StateDataCase> implements Internal.EnumLite, AbstractMessageLite.InternalOneOfEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-tpu/2.42.0/com.google.cloud.tpu.v2alpha1.QueuedResourceState.StateDataCase#com_google_cloud_tpu_v2alpha1_QueuedResourceState_StateDataCase_forNumber_int_) instead._
