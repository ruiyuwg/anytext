...
# Class RecommendationStateInfo (2.44.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class RecommendationStateInfo extends GeneratedMessageV3 implements RecommendationStateInfoOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> RecommendationStateInfo

## Implements

[RecommendationStateInfoOrBuilder](/java/docs/reference/google-cloud-recommender/2.44.0/com.google.cloud.recommender.v1beta1.RecommendationStateInfoOrBuilder)
...
```
public static RecommendationStateInfo getDefaultInstance()
```
...
`[RecommendationStateInfo](/java/docs/reference/google-cloud-recommender/2.44.0/com.google.cloud.recommender.v1beta1.RecommendationStateInfo)`
...
```
public static RecommendationStateInfo.Builder newBuilder()
```
...
`[RecommendationStateInfo.Builder](/java/docs/reference/google-cloud-recommender/2.44.0/com.google.cloud.recommender.v1beta1.RecommendationStateInfo.Builder)`
...
```
public static RecommendationStateInfo parseDelimitedFrom(InputStream input)
```
...
```
public static RecommendationStateInfo parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RecommendationStateInfo parseFrom(byte[] data)
```
...
```
public static RecommendationStateInfo parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RecommendationStateInfo parseFrom(ByteString data)
```
...
```
public static RecommendationStateInfo parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RecommendationStateInfo parseFrom(CodedInputStream input)
```
...
```
public static RecommendationStateInfo parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RecommendationStateInfo parseFrom(InputStream input)
```
...
```
public static RecommendationStateInfo parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RecommendationStateInfo parseFrom(ByteBuffer data)
```
...
```
public static RecommendationStateInfo parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<RecommendationStateInfo> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[RecommendationStateInfo](/java/docs/reference/google-cloud-recommender/2.44.0/com.google.cloud.recommender.v1beta1.RecommendationStateInfo)>`
...
```
public Parser<RecommendationStateInfo> getParserForType()
```
...
`[RecommendationStateInfo.State](/java/docs/reference/google-cloud-recommender/2.44.0/com.google.cloud.recommender.v1beta1.RecommendationStateInfo.State)`
...
Use [#getStateMetadataMap()](/java/docs/reference/google-cloud-recommender/2.44.0/com.google.cloud.recommender.v1beta1.RecommendationStateInfo#com_google_cloud_recommender_v1beta1_RecommendationStateInfo_getStateMetadataMap__) instead.
...
```
public RecommendationStateInfo.Builder newBuilderForType()
```
...
```
protected RecommendationStateInfo.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
