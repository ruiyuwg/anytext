...
# Enum HttpMethod (2.42.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-scheduler/2.42.0/com.google.cloud.scheduler.v1.HttpMethod#com_google_cloud_scheduler_v1_HttpMethod_forNumber_int_) instead._
