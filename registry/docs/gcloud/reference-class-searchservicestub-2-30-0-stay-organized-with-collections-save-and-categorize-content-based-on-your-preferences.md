...
# Class SearchServiceStub (2.30.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[UnaryCallable](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallable.html)<[SearchRequest](/java/docs/reference/google-cloud-retail/2.30.0/com.google.cloud.retail.v2.SearchRequest),[SearchResponse](/java/docs/reference/google-cloud-retail/2.30.0/com.google.cloud.retail.v2.SearchResponse)>`
...
`[UnaryCallable](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallable.html)<[SearchRequest](/java/docs/reference/google-cloud-retail/2.30.0/com.google.cloud.retail.v2.SearchRequest),[SearchPagedResponse](/java/docs/reference/google-cloud-retail/2.30.0/com.google.cloud.retail.v2.SearchServiceClient.SearchPagedResponse)>`
