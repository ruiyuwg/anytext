...
# Class DisableServiceRequest (2.56.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> DisableServiceRequest

## Implements

[DisableServiceRequestOrBuilder](/java/docs/reference/google-cloud-service-usage/2.56.0/com.google.api.serviceusage.v1.DisableServiceRequestOrBuilder)
...
### CHECK\_IF\_SERVICE\_HAS\_USAGE\_FIELD\_NUMBER

```
public static final int CHECK_IF_SERVICE_HAS_USAGE_FIELD_NUMBER
```
...
### DISABLE\_DEPENDENT\_SERVICES\_FIELD\_NUMBER

```
public static final int DISABLE_DEPENDENT_SERVICES_FIELD_NUMBER
```
...
`[DisableServiceRequest](/java/docs/reference/google-cloud-service-usage/2.56.0/com.google.api.serviceusage.v1.DisableServiceRequest)`
...
`[DisableServiceRequest.Builder](/java/docs/reference/google-cloud-service-usage/2.56.0/com.google.api.serviceusage.v1.DisableServiceRequest.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[DisableServiceRequest](/java/docs/reference/google-cloud-service-usage/2.56.0/com.google.api.serviceusage.v1.DisableServiceRequest)>`
...
```
public DisableServiceRequest.CheckIfServiceHasUsage getCheckIfServiceHasUsage()
```
...
`[DisableServiceRequest.CheckIfServiceHasUsage](/java/docs/reference/google-cloud-service-usage/2.56.0/com.google.api.serviceusage.v1.DisableServiceRequest.CheckIfServiceHasUsage)`
