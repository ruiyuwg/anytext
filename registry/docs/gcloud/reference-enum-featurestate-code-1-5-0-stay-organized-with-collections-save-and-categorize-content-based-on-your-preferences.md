...
# Enum FeatureState.Code (1.5.0) Stay organized with collections Save and categorize content based on your preferences.
...
Protobuf enum `google.cloud.gkehub.v1alpha.FeatureState.Code`
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-gkehub/1.5.0/com.google.cloud.gkehub.v1alpha.FeatureState.Code#com_google_cloud_gkehub_v1alpha_FeatureState_Code_forNumber_int_) instead._
