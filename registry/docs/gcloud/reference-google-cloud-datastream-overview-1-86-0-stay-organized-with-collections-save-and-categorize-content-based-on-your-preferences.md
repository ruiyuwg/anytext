...
# google-cloud-datastream overview (1.86.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Datastream Description:** Is a serverless and easy-to-use change data capture (CDC) and replication service. It allows you to synchronize data across heterogeneous databases and applications reliably, and with minimal latency and downtime.

[Datastream Product Reference](https://cloud.google.com/datastream/docs)

[GitHub Repository](https://github.com/googleapis/google-cloud-java/tree/main/java-datastream)

[Maven artifact](https://central.sonatype.com/artifact/com.google.cloud/google-cloud-datastream)
...
-   [Enable the API](https://console.cloud.google.com/apis/library/datastream.googleapis.com)
-   [Set up authentication](https://cloud.google.com/docs/authentication/client-libraries)

## Use the Datastream for Java
...
The example below demonstrates how you would import the BOM and include the `google-cloud-datastream` artifact.
...
libraryDependencies += "com.google.cloud" % "google-cloud-datastream" % "1.86.0"

## Which version ID should I get started with?

For this library, we recommend using [com.google.cloud.datastream.v1](https://cloud.google.com/java/docs/reference/google-cloud-datastream/1.86.0/com.google.cloud.datastream.v1) for new applications.
