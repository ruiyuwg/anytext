...
# Interface GetAttachedServerConfigRequestOrBuilder (0.50.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface GetAttachedServerConfigRequestOrBuilder extends MessageOrBuilder
```
