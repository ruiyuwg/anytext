...
# Class OrganizationSettingsName (2.38.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> OrganizationSettingsName
...
```
public static OrganizationSettingsName.Builder newBuilder()
```
...
`[OrganizationSettingsName.Builder](/java/docs/reference/google-cloud-securitycenter/2.38.0/com.google.cloud.securitycenter.v1.OrganizationSettingsName.Builder)`
...
`[OrganizationSettingsName](/java/docs/reference/google-cloud-securitycenter/2.38.0/com.google.cloud.securitycenter.v1.OrganizationSettingsName)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[OrganizationSettingsName](/java/docs/reference/google-cloud-securitycenter/2.38.0/com.google.cloud.securitycenter.v1.OrganizationSettingsName)>`

### toStringList(List<OrganizationSettingsName> values)
...
```
public OrganizationSettingsName.Builder toBuilder()
```
