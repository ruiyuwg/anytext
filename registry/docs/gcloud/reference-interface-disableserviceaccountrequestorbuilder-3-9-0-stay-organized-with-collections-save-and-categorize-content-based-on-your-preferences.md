...
# Interface DisableServiceAccountRequestOrBuilder (3.9.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface DisableServiceAccountRequestOrBuilder extends MessageOrBuilder
```
