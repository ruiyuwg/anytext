...
# Class LocationInfo (3.51.0) Stay organized with collections Save and categorize content based on your preferences.
...
Protobuf type `google.cloud.vision.v1p3beta1.LocationInfo`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> LocationInfo

## Implements

[LocationInfoOrBuilder](/java/docs/reference/google-cloud-vision/3.51.0/com.google.cloud.vision.v1p3beta1.LocationInfoOrBuilder)
...
`[LocationInfo](/java/docs/reference/google-cloud-vision/3.51.0/com.google.cloud.vision.v1p3beta1.LocationInfo)`
...
```
public static LocationInfo.Builder newBuilder()
```
...
`[LocationInfo.Builder](/java/docs/reference/google-cloud-vision/3.51.0/com.google.cloud.vision.v1p3beta1.LocationInfo.Builder)`

### newBuilder(LocationInfo prototype)

```
public static LocationInfo.Builder newBuilder(LocationInfo prototype)
```
...
```
public static LocationInfo parseDelimitedFrom(InputStream input)
```
...
```
public static LocationInfo parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static LocationInfo parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static LocationInfo parseFrom(ByteString data)
```
...
```
public static LocationInfo parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static LocationInfo parseFrom(CodedInputStream input)
```
...
```
public static LocationInfo parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static LocationInfo parseFrom(InputStream input)
```
...
```
public static LocationInfo parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static LocationInfo parseFrom(ByteBuffer data)
```
...
```
public static LocationInfo parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[LocationInfo](/java/docs/reference/google-cloud-vision/3.51.0/com.google.cloud.vision.v1p3beta1.LocationInfo)>`
...
```
public LocationInfo.Builder newBuilderForType()
```
...
```
protected LocationInfo.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
