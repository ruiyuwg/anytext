...
# Enum Instance.ReadReplicasMode (2.9.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum Instance.ReadReplicasMode extends Enum<Instance.ReadReplicasMode> implements ProtocolMessageEnum
```
...
READ\_REPLICAS\_ENABLED\_VALUE

If enabled, read endpoint will be provided and the instance can scale up and down the number of replicas. Not valid for basic tier.

`READ_REPLICAS_ENABLED = 2;`

READ\_REPLICAS\_MODE\_UNSPECIFIED

If not set, Memorystore Redis backend will default to READ\_REPLICAS\_DISABLED.

`READ_REPLICAS_MODE_UNSPECIFIED = 0;`

READ\_REPLICAS\_MODE\_UNSPECIFIED\_VALUE
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-redis/2.9.0/com.google.cloud.redis.v1beta1.Instance.ReadReplicasMode#com_google_cloud_redis_v1beta1_Instance_ReadReplicasMode_forNumber_int_) instead._
