...
# Enum ReportConfig.ReportFormatCase (0.12.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum ReportConfig.ReportFormatCase extends Enum<ReportConfig.ReportFormatCase> implements Internal.EnumLite, AbstractMessageLite.InternalOneOfEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-storageinsights/0.12.0/com.google.cloud.storageinsights.v1.ReportConfig.ReportFormatCase#com_google_cloud_storageinsights_v1_ReportConfig_ReportFormatCase_forNumber_int_) instead._
