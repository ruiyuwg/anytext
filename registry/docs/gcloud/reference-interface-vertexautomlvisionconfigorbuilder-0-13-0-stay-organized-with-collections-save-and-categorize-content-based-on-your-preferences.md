...
# Interface VertexAutoMLVisionConfigOrBuilder (0.13.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface VertexAutoMLVisionConfigOrBuilder extends MessageOrBuilder
```
