...
# Class ListFoldersResponse (1.41.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListFoldersResponse

## Implements

[ListFoldersResponseOrBuilder](/java/docs/reference/google-cloud-resourcemanager/1.41.0/com.google.cloud.resourcemanager.v3.ListFoldersResponseOrBuilder)
...
`[ListFoldersResponse](/java/docs/reference/google-cloud-resourcemanager/1.41.0/com.google.cloud.resourcemanager.v3.ListFoldersResponse)`
...
`[ListFoldersResponse.Builder](/java/docs/reference/google-cloud-resourcemanager/1.41.0/com.google.cloud.resourcemanager.v3.ListFoldersResponse.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListFoldersResponse](/java/docs/reference/google-cloud-resourcemanager/1.41.0/com.google.cloud.resourcemanager.v3.ListFoldersResponse)>`
...
`[Folder](/java/docs/reference/google-cloud-resourcemanager/1.41.0/com.google.cloud.resourcemanager.v3.Folder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Folder](/java/docs/reference/google-cloud-resourcemanager/1.41.0/com.google.cloud.resourcemanager.v3.Folder)>`
...
`[FolderOrBuilder](/java/docs/reference/google-cloud-resourcemanager/1.41.0/com.google.cloud.resourcemanager.v3.FolderOrBuilder)`
