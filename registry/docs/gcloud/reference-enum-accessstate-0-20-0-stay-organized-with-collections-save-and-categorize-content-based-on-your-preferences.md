...
# Enum AccessState (0.20.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-policysimulator/0.20.0/com.google.cloud.policysimulator.v1.AccessState#com_google_cloud_policysimulator_v1_AccessState_forNumber_int_) instead._
