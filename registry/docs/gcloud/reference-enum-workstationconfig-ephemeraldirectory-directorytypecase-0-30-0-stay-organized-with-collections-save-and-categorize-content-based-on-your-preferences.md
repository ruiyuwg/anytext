...
# Enum WorkstationConfig.EphemeralDirectory.DirectoryTypeCase (0.30.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum WorkstationConfig.EphemeralDirectory.DirectoryTypeCase extends Enum<WorkstationConfig.EphemeralDirectory.DirectoryTypeCase> implements Internal.EnumLite, AbstractMessageLite.InternalOneOfEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-workstations/0.30.0/com.google.cloud.workstations.v1beta.WorkstationConfig.EphemeralDirectory.DirectoryTypeCase#com_google_cloud_workstations_v1beta_WorkstationConfig_EphemeralDirectory_DirectoryTypeCase_forNumber_int_) instead._
