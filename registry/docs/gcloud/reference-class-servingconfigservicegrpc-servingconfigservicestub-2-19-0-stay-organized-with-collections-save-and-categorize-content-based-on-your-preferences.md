...
# Class ServingConfigServiceGrpc.ServingConfigServiceStub (2.19.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[AddControlRequest](/java/docs/reference/google-cloud-retail/2.19.0/com.google.cloud.retail.v2beta.AddControlRequest)`  

`responseObserver`

`io.grpc.stub.StreamObserver<[ServingConfig](/java/docs/reference/google-cloud-retail/2.19.0/com.google.cloud.retail.v2beta.ServingConfig)>`  
...
`[ServingConfigServiceGrpc.ServingConfigServiceStub](/java/docs/reference/google-cloud-retail/2.19.0/com.google.cloud.retail.v2beta.ServingConfigServiceGrpc.ServingConfigServiceStub)`
...
`[CreateServingConfigRequest](/java/docs/reference/google-cloud-retail/2.19.0/com.google.cloud.retail.v2beta.CreateServingConfigRequest)`  
...
`[DeleteServingConfigRequest](/java/docs/reference/google-cloud-retail/2.19.0/com.google.cloud.retail.v2beta.DeleteServingConfigRequest)`  
...
`[GetServingConfigRequest](/java/docs/reference/google-cloud-retail/2.19.0/com.google.cloud.retail.v2beta.GetServingConfigRequest)`  
...
`[ListServingConfigsRequest](/java/docs/reference/google-cloud-retail/2.19.0/com.google.cloud.retail.v2beta.ListServingConfigsRequest)`  

`responseObserver`

`io.grpc.stub.StreamObserver<[ListServingConfigsResponse](/java/docs/reference/google-cloud-retail/2.19.0/com.google.cloud.retail.v2beta.ListServingConfigsResponse)>`  
...
`[RemoveControlRequest](/java/docs/reference/google-cloud-retail/2.19.0/com.google.cloud.retail.v2beta.RemoveControlRequest)`  
...
`[UpdateServingConfigRequest](/java/docs/reference/google-cloud-retail/2.19.0/com.google.cloud.retail.v2beta.UpdateServingConfigRequest)`  
