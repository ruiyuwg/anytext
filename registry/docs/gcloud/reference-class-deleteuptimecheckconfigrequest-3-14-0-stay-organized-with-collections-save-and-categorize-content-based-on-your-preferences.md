...
# Class DeleteUptimeCheckConfigRequest (3.14.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class DeleteUptimeCheckConfigRequest extends GeneratedMessageV3 implements DeleteUptimeCheckConfigRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> DeleteUptimeCheckConfigRequest

## Implements

[DeleteUptimeCheckConfigRequestOrBuilder](/java/docs/reference/google-cloud-monitoring/3.14.0/com.google.monitoring.v3.DeleteUptimeCheckConfigRequestOrBuilder)
...
```
public static DeleteUptimeCheckConfigRequest getDefaultInstance()
```
...
`[DeleteUptimeCheckConfigRequest](/java/docs/reference/google-cloud-monitoring/3.14.0/com.google.monitoring.v3.DeleteUptimeCheckConfigRequest)`
...
```
public static DeleteUptimeCheckConfigRequest.Builder newBuilder()
```
...
`[DeleteUptimeCheckConfigRequest.Builder](/java/docs/reference/google-cloud-monitoring/3.14.0/com.google.monitoring.v3.DeleteUptimeCheckConfigRequest.Builder)`

### newBuilder(DeleteUptimeCheckConfigRequest prototype)

```
public static DeleteUptimeCheckConfigRequest.Builder newBuilder(DeleteUptimeCheckConfigRequest prototype)
```
...
```
public static DeleteUptimeCheckConfigRequest parseDelimitedFrom(InputStream input)
```
...
```
public static DeleteUptimeCheckConfigRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteUptimeCheckConfigRequest parseFrom(byte[] data)
```
...
```
public static DeleteUptimeCheckConfigRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteUptimeCheckConfigRequest parseFrom(ByteString data)
```
...
```
public static DeleteUptimeCheckConfigRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteUptimeCheckConfigRequest parseFrom(CodedInputStream input)
```
...
```
public static DeleteUptimeCheckConfigRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteUptimeCheckConfigRequest parseFrom(InputStream input)
```
...
```
public static DeleteUptimeCheckConfigRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteUptimeCheckConfigRequest parseFrom(ByteBuffer data)
```
...
```
public static DeleteUptimeCheckConfigRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<DeleteUptimeCheckConfigRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[DeleteUptimeCheckConfigRequest](/java/docs/reference/google-cloud-monitoring/3.14.0/com.google.monitoring.v3.DeleteUptimeCheckConfigRequest)>`
...
```
public DeleteUptimeCheckConfigRequest getDefaultInstanceForType()
```
...
Required. The Uptime check configuration to delete. The format is: projects/\[PROJECT\_ID\_OR\_NUMBER\]/uptimeCheckConfigs/\[UPTIME\_CHECK\_ID\]
...
```
public Parser<DeleteUptimeCheckConfigRequest> getParserForType()
```
...
```
public DeleteUptimeCheckConfigRequest.Builder newBuilderForType()
```
...
```
protected DeleteUptimeCheckConfigRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public DeleteUptimeCheckConfigRequest.Builder toBuilder()
```
