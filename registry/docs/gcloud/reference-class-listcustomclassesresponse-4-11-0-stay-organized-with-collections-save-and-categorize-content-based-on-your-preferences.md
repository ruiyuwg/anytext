...
# Class ListCustomClassesResponse (4.11.0) Stay organized with collections Save and categorize content based on your preferences.
...
[ListCustomClassesResponseOrBuilder](/java/docs/reference/google-cloud-speech/4.11.0/com.google.cloud.speech.v1p1beta1.ListCustomClassesResponseOrBuilder)
...
`[ListCustomClassesResponse](/java/docs/reference/google-cloud-speech/4.11.0/com.google.cloud.speech.v1p1beta1.ListCustomClassesResponse)`
...
`[ListCustomClassesResponse.Builder](/java/docs/reference/google-cloud-speech/4.11.0/com.google.cloud.speech.v1p1beta1.ListCustomClassesResponse.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListCustomClassesResponse](/java/docs/reference/google-cloud-speech/4.11.0/com.google.cloud.speech.v1p1beta1.ListCustomClassesResponse)>`
...
`[CustomClass](/java/docs/reference/google-cloud-speech/4.11.0/com.google.cloud.speech.v1p1beta1.CustomClass)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[CustomClass](/java/docs/reference/google-cloud-speech/4.11.0/com.google.cloud.speech.v1p1beta1.CustomClass)>`
...
`[CustomClassOrBuilder](/java/docs/reference/google-cloud-speech/4.11.0/com.google.cloud.speech.v1p1beta1.CustomClassOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.speech.v1p1beta1.CustomClassOrBuilder>`
