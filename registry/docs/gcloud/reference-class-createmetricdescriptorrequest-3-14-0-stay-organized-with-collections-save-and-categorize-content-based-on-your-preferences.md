...
# Class CreateMetricDescriptorRequest (3.14.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class CreateMetricDescriptorRequest extends GeneratedMessageV3 implements CreateMetricDescriptorRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> CreateMetricDescriptorRequest

## Implements

[CreateMetricDescriptorRequestOrBuilder](/java/docs/reference/google-cloud-monitoring/3.14.0/com.google.monitoring.v3.CreateMetricDescriptorRequestOrBuilder)
...
### METRIC\_DESCRIPTOR\_FIELD\_NUMBER
...
```
public static CreateMetricDescriptorRequest getDefaultInstance()
```
...
`[CreateMetricDescriptorRequest](/java/docs/reference/google-cloud-monitoring/3.14.0/com.google.monitoring.v3.CreateMetricDescriptorRequest)`
...
```
public static CreateMetricDescriptorRequest.Builder newBuilder()
```
...
`[CreateMetricDescriptorRequest.Builder](/java/docs/reference/google-cloud-monitoring/3.14.0/com.google.monitoring.v3.CreateMetricDescriptorRequest.Builder)`

### newBuilder(CreateMetricDescriptorRequest prototype)

```
public static CreateMetricDescriptorRequest.Builder newBuilder(CreateMetricDescriptorRequest prototype)
```
...
```
public static CreateMetricDescriptorRequest parseDelimitedFrom(InputStream input)
```
...
```
public static CreateMetricDescriptorRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateMetricDescriptorRequest parseFrom(byte[] data)
```
...
```
public static CreateMetricDescriptorRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateMetricDescriptorRequest parseFrom(ByteString data)
```
...
```
public static CreateMetricDescriptorRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateMetricDescriptorRequest parseFrom(CodedInputStream input)
```
...
```
public static CreateMetricDescriptorRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateMetricDescriptorRequest parseFrom(InputStream input)
```
...
```
public static CreateMetricDescriptorRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateMetricDescriptorRequest parseFrom(ByteBuffer data)
```
...
```
public static CreateMetricDescriptorRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<CreateMetricDescriptorRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[CreateMetricDescriptorRequest](/java/docs/reference/google-cloud-monitoring/3.14.0/com.google.monitoring.v3.CreateMetricDescriptorRequest)>`
...
Required. The [project](https://cloud.google.com/monitoring/api/v3#project_name) on which to execute the request. The format is: 4 projects/\[PROJECT\_ID\_OR\_NUMBER\]
...
```
public Parser<CreateMetricDescriptorRequest> getParserForType()
```
...
```
public CreateMetricDescriptorRequest.Builder newBuilderForType()
```
...
```
protected CreateMetricDescriptorRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public CreateMetricDescriptorRequest.Builder toBuilder()
```
