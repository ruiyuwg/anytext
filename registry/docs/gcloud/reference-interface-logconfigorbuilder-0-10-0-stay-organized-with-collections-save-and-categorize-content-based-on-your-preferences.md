...
# Interface LogConfigOrBuilder (0.10.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public abstract LogConfig.LogSeverity getLogSeverity()
```
...
[LogConfig.LogSeverity](/java/docs/reference/google-cloud-live-stream/0.10.0/com.google.cloud.video.livestream.v1.LogConfig.LogSeverity)
