...
# Class ConferenceRecordsServiceClient.ListConferenceRecordsFixedSizeCollection (0.7.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class ConferenceRecordsServiceClient.ListConferenceRecordsFixedSizeCollection extends AbstractFixedSizeCollection<ListConferenceRecordsRequest,ListConferenceRecordsResponse,ConferenceRecord,ConferenceRecordsServiceClient.ListConferenceRecordsPage,ConferenceRecordsServiceClient.ListConferenceRecordsFixedSizeCollection>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractFixedSizeCollection](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractFixedSizeCollection.html) \> ConferenceRecordsServiceClient.ListConferenceRecordsFixedSizeCollection
...
### createCollection(List<ConferenceRecordsServiceClient.ListConferenceRecordsPage> pages, int collectionSize)

```
protected ConferenceRecordsServiceClient.ListConferenceRecordsFixedSizeCollection createCollection(List<ConferenceRecordsServiceClient.ListConferenceRecordsPage> pages, int collectionSize)
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ListConferenceRecordsPage](/java/docs/reference/google-cloud-meet/0.7.0/com.google.apps.meet.v2.ConferenceRecordsServiceClient.ListConferenceRecordsPage)>`  
...
`[ConferenceRecordsServiceClient.ListConferenceRecordsFixedSizeCollection](/java/docs/reference/google-cloud-meet/0.7.0/com.google.apps.meet.v2.ConferenceRecordsServiceClient.ListConferenceRecordsFixedSizeCollection)`
