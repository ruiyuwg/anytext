...
# Class ListPostureTemplatesRequest (0.24.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListPostureTemplatesRequest extends GeneratedMessageV3 implements ListPostureTemplatesRequestOrBuilder
```

Message for requesting list of Posture Templates.

Protobuf type `google.cloud.securityposture.v1.ListPostureTemplatesRequest`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListPostureTemplatesRequest

## Implements

[ListPostureTemplatesRequestOrBuilder](/java/docs/reference/google-cloud-securityposture/0.24.0/com.google.cloud.securityposture.v1.ListPostureTemplatesRequestOrBuilder)
...
```
public static ListPostureTemplatesRequest getDefaultInstance()
```
...
`[ListPostureTemplatesRequest](/java/docs/reference/google-cloud-securityposture/0.24.0/com.google.cloud.securityposture.v1.ListPostureTemplatesRequest)`
...
```
public static ListPostureTemplatesRequest.Builder newBuilder()
```
...
`[ListPostureTemplatesRequest.Builder](/java/docs/reference/google-cloud-securityposture/0.24.0/com.google.cloud.securityposture.v1.ListPostureTemplatesRequest.Builder)`

### newBuilder(ListPostureTemplatesRequest prototype)

```
public static ListPostureTemplatesRequest.Builder newBuilder(ListPostureTemplatesRequest prototype)
```
...
```
public static ListPostureTemplatesRequest parseDelimitedFrom(InputStream input)
```
...
```
public static ListPostureTemplatesRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListPostureTemplatesRequest parseFrom(byte[] data)
```
...
```
public static ListPostureTemplatesRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListPostureTemplatesRequest parseFrom(ByteString data)
```
...
```
public static ListPostureTemplatesRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListPostureTemplatesRequest parseFrom(CodedInputStream input)
```
...
```
public static ListPostureTemplatesRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListPostureTemplatesRequest parseFrom(InputStream input)
```
...
```
public static ListPostureTemplatesRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListPostureTemplatesRequest parseFrom(ByteBuffer data)
```
...
```
public static ListPostureTemplatesRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ListPostureTemplatesRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListPostureTemplatesRequest](/java/docs/reference/google-cloud-securityposture/0.24.0/com.google.cloud.securityposture.v1.ListPostureTemplatesRequest)>`
...
```
public ListPostureTemplatesRequest getDefaultInstanceForType()
```
...
Optional. Filter to be applied on the resource, defined by EBNF grammar [https://google.aip.dev/assets/misc/ebnf-filtering.txt](https://google.aip.dev/assets/misc/ebnf-filtering.txt).
...
```
public Parser<ListPostureTemplatesRequest> getParserForType()
```
...
```
public ListPostureTemplatesRequest.Builder newBuilderForType()
```
...
```
protected ListPostureTemplatesRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ListPostureTemplatesRequest.Builder toBuilder()
```
