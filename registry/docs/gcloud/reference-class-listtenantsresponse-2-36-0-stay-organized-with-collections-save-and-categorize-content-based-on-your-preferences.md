...
# Class ListTenantsResponse (2.36.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListTenantsResponse

## Implements

[ListTenantsResponseOrBuilder](/java/docs/reference/google-cloud-talent/2.36.0/com.google.cloud.talent.v4beta1.ListTenantsResponseOrBuilder)
...
`[ListTenantsResponse](/java/docs/reference/google-cloud-talent/2.36.0/com.google.cloud.talent.v4beta1.ListTenantsResponse)`
...
`[ListTenantsResponse.Builder](/java/docs/reference/google-cloud-talent/2.36.0/com.google.cloud.talent.v4beta1.ListTenantsResponse.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListTenantsResponse](/java/docs/reference/google-cloud-talent/2.36.0/com.google.cloud.talent.v4beta1.ListTenantsResponse)>`
...
`[ResponseMetadata](/java/docs/reference/google-cloud-talent/2.36.0/com.google.cloud.talent.v4beta1.ResponseMetadata)`
...
`[ResponseMetadataOrBuilder](/java/docs/reference/google-cloud-talent/2.36.0/com.google.cloud.talent.v4beta1.ResponseMetadataOrBuilder)`
...
`[Tenant](/java/docs/reference/google-cloud-talent/2.36.0/com.google.cloud.talent.v4beta1.Tenant)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Tenant](/java/docs/reference/google-cloud-talent/2.36.0/com.google.cloud.talent.v4beta1.Tenant)>`
...
`[TenantOrBuilder](/java/docs/reference/google-cloud-talent/2.36.0/com.google.cloud.talent.v4beta1.TenantOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.talent.v4beta1.TenantOrBuilder>`
