...
# Class ListCollectionsResponse (0.4.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListCollectionsResponse

## Implements

[ListCollectionsResponseOrBuilder](/java/docs/reference/google-cloud-visionai/0.4.0/com.google.cloud.visionai.v1.ListCollectionsResponseOrBuilder)
...
### COLLECTIONS\_FIELD\_NUMBER

```
public static final int COLLECTIONS_FIELD_NUMBER
```
...
`[ListCollectionsResponse](/java/docs/reference/google-cloud-visionai/0.4.0/com.google.cloud.visionai.v1.ListCollectionsResponse)`
...
```
public static ListCollectionsResponse.Builder newBuilder()
```
...
`[ListCollectionsResponse.Builder](/java/docs/reference/google-cloud-visionai/0.4.0/com.google.cloud.visionai.v1.ListCollectionsResponse.Builder)`

### newBuilder(ListCollectionsResponse prototype)

```
public static ListCollectionsResponse.Builder newBuilder(ListCollectionsResponse prototype)
```
...
```
public static ListCollectionsResponse parseDelimitedFrom(InputStream input)
```
...
```
public static ListCollectionsResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListCollectionsResponse parseFrom(byte[] data)
```
...
```
public static ListCollectionsResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListCollectionsResponse parseFrom(ByteString data)
```
...
```
public static ListCollectionsResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListCollectionsResponse parseFrom(CodedInputStream input)
```
...
```
public static ListCollectionsResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListCollectionsResponse parseFrom(InputStream input)
```
...
```
public static ListCollectionsResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListCollectionsResponse parseFrom(ByteBuffer data)
```
...
```
public static ListCollectionsResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListCollectionsResponse](/java/docs/reference/google-cloud-visionai/0.4.0/com.google.cloud.visionai.v1.ListCollectionsResponse)>`
...
`[Collection](/java/docs/reference/google-cloud-visionai/0.4.0/com.google.cloud.visionai.v1.Collection)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Collection](/java/docs/reference/google-cloud-visionai/0.4.0/com.google.cloud.visionai.v1.Collection)>`
...
`[CollectionOrBuilder](/java/docs/reference/google-cloud-visionai/0.4.0/com.google.cloud.visionai.v1.CollectionOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.visionai.v1.CollectionOrBuilder>`
...
```
public ListCollectionsResponse.Builder newBuilderForType()
```
...
```
protected ListCollectionsResponse.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ListCollectionsResponse.Builder toBuilder()
```
