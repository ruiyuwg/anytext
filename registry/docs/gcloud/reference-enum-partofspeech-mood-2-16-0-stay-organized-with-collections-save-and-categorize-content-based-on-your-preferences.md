...
# Enum PartOfSpeech.Mood (2.16.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum PartOfSpeech.Mood extends Enum<PartOfSpeech.Mood> implements ProtocolMessageEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-language/2.16.0/com.google.cloud.language.v1beta2.PartOfSpeech.Mood#com_google_cloud_language_v1beta2_PartOfSpeech_Mood_forNumber_int_) instead._
