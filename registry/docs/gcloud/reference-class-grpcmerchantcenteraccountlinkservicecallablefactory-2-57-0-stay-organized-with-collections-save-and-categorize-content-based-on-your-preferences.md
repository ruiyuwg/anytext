...
# Class GrpcMerchantCenterAccountLinkServiceCallableFactory (2.57.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public class GrpcMerchantCenterAccountLinkServiceCallableFactory implements GrpcStubCallableFactory
```
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> GrpcMerchantCenterAccountLinkServiceCallableFactory
...
```
public GrpcMerchantCenterAccountLinkServiceCallableFactory()
```
