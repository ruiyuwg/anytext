...
# Class UpdateBackupPolicyRequest (0.33.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class UpdateBackupPolicyRequest extends GeneratedMessageV3 implements UpdateBackupPolicyRequestOrBuilder
```

UpdateBackupPolicyRequest for updating a backup policy.

Protobuf type `google.cloud.netapp.v1.UpdateBackupPolicyRequest`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> UpdateBackupPolicyRequest

## Implements

[UpdateBackupPolicyRequestOrBuilder](/java/docs/reference/google-cloud-netapp/0.33.0/com.google.cloud.netapp.v1.UpdateBackupPolicyRequestOrBuilder)
...
### BACKUP\_POLICY\_FIELD\_NUMBER

```
public static final int BACKUP_POLICY_FIELD_NUMBER
```
...
```
public static UpdateBackupPolicyRequest getDefaultInstance()
```
...
`[UpdateBackupPolicyRequest](/java/docs/reference/google-cloud-netapp/0.33.0/com.google.cloud.netapp.v1.UpdateBackupPolicyRequest)`
...
```
public static UpdateBackupPolicyRequest.Builder newBuilder()
```
...
`[UpdateBackupPolicyRequest.Builder](/java/docs/reference/google-cloud-netapp/0.33.0/com.google.cloud.netapp.v1.UpdateBackupPolicyRequest.Builder)`

### newBuilder(UpdateBackupPolicyRequest prototype)

```
public static UpdateBackupPolicyRequest.Builder newBuilder(UpdateBackupPolicyRequest prototype)
```
...
```
public static UpdateBackupPolicyRequest parseDelimitedFrom(InputStream input)
```
...
```
public static UpdateBackupPolicyRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateBackupPolicyRequest parseFrom(byte[] data)
```
...
```
public static UpdateBackupPolicyRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateBackupPolicyRequest parseFrom(ByteString data)
```
...
```
public static UpdateBackupPolicyRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateBackupPolicyRequest parseFrom(CodedInputStream input)
```
...
```
public static UpdateBackupPolicyRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateBackupPolicyRequest parseFrom(InputStream input)
```
...
```
public static UpdateBackupPolicyRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateBackupPolicyRequest parseFrom(ByteBuffer data)
```
...
```
public static UpdateBackupPolicyRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<UpdateBackupPolicyRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[UpdateBackupPolicyRequest](/java/docs/reference/google-cloud-netapp/0.33.0/com.google.cloud.netapp.v1.UpdateBackupPolicyRequest)>`
...
`[BackupPolicy](/java/docs/reference/google-cloud-netapp/0.33.0/com.google.cloud.netapp.v1.BackupPolicy)`
...
`[BackupPolicyOrBuilder](/java/docs/reference/google-cloud-netapp/0.33.0/com.google.cloud.netapp.v1.BackupPolicyOrBuilder)`

### getDefaultInstanceForType()

```
public UpdateBackupPolicyRequest getDefaultInstanceForType()
```
...
```
public Parser<UpdateBackupPolicyRequest> getParserForType()
```
...
Required. Field mask is used to specify the fields to be overwritten in the Backup Policy resource by the update. The fields specified in the update\_mask are relative to the resource, not the full request. A field will be overwritten if it is in the mask. If the user does not provide a mask then all fields will be overwritten.
...
```
public UpdateBackupPolicyRequest.Builder newBuilderForType()
```
...
```
protected UpdateBackupPolicyRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public UpdateBackupPolicyRequest.Builder toBuilder()
```
