...
# Interface ParagraphOrBuilder (3.25.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[BoundingPoly](/java/docs/reference/google-cloud-vision/3.25.0/com.google.cloud.vision.v1p2beta1.BoundingPoly)`
...
`[BoundingPolyOrBuilder](/java/docs/reference/google-cloud-vision/3.25.0/com.google.cloud.vision.v1p2beta1.BoundingPolyOrBuilder)`
...
`[TextAnnotation.TextProperty](/java/docs/reference/google-cloud-vision/3.25.0/com.google.cloud.vision.v1p2beta1.TextAnnotation.TextProperty)`
...
`[TextAnnotation.TextPropertyOrBuilder](/java/docs/reference/google-cloud-vision/3.25.0/com.google.cloud.vision.v1p2beta1.TextAnnotation.TextPropertyOrBuilder)`
...
`[Word](/java/docs/reference/google-cloud-vision/3.25.0/com.google.cloud.vision.v1p2beta1.Word)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Word](/java/docs/reference/google-cloud-vision/3.25.0/com.google.cloud.vision.v1p2beta1.Word)>`
...
`[WordOrBuilder](/java/docs/reference/google-cloud-vision/3.25.0/com.google.cloud.vision.v1p2beta1.WordOrBuilder)`
