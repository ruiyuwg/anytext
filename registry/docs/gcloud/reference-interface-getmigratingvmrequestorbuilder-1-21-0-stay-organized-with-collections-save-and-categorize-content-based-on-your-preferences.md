...
# Interface GetMigratingVmRequestOrBuilder (1.21.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface GetMigratingVmRequestOrBuilder extends MessageOrBuilder
```
...
```
public abstract MigratingVmView getView()
```
...
`[MigratingVmView](/java/docs/reference/google-cloud-vmmigration/1.21.0/com.google.cloud.vmmigration.v1.MigratingVmView)`
