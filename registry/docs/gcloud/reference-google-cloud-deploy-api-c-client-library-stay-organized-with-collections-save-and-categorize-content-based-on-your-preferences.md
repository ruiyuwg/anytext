...
# Google Cloud Deploy API C++ Client Library Stay organized with collections Save and categorize content based on your preferences.
...
The main class in this library is [`deploy_v1::CloudDeployClient`](/cpp/docs/reference/deploy/latest/classgoogle_1_1cloud_1_1deploy__v1_1_1CloudDeployClient). All RPCs are exposed as member functions of this class. Other classes provide helpers, configuration parameters, and infrastructure to mock [`deploy_v1::CloudDeployClient`](/cpp/docs/reference/deploy/latest/classgoogle_1_1cloud_1_1deploy__v1_1_1CloudDeployClient) when testing your application.
...
-   [How to Override the Default Endpoint](/cpp/docs/reference/deploy/latest/deploy-override-endpoint) - describes how to override the default endpoint.
-   [How to Override the Authentication Credentials](/cpp/docs/reference/deploy/latest/deploy-override-authentication) - describes how to change the authentication credentials used by the library.
-   [Override Retry, Backoff, and Idempotency Policies](/cpp/docs/reference/deploy/latest/deploy-override-retry) - describes how to change the default retry policies.
-   [Environment Variables](/cpp/docs/reference/deploy/latest/deploy-env) - describes environment variables that can configure the behavior of the library.
-   [How to Override the Default Universe Domain](/cpp/docs/reference/deploy/latest/deploy-override-universe-domain) - describes how to override the default universe domain.
