...
# Cloud AI Platform v1 API - Class VizierService (2.15.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class VizierService
```

Reference documentation and code samples for the Cloud AI Platform v1 API class VizierService.
...
[object](https://learn.microsoft.com/dotnet/api/system.object) \> VizierService
...
### BindService(VizierServiceBase)

```
public static ServerServiceDefinition BindService(VizierService.VizierServiceBase serviceImpl)
```
...
`[VizierService](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/2.15.0/Google.Cloud.AIPlatform.V1.VizierService)[VizierServiceBase](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/2.15.0/Google.Cloud.AIPlatform.V1.VizierService.VizierServiceBase)`  
...
### BindService(ServiceBinderBase, VizierServiceBase)

```
public static void BindService(ServiceBinderBase serviceBinder, VizierService.VizierServiceBase serviceImpl)
```
