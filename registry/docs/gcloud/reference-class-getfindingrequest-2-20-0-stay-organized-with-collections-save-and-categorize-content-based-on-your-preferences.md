...
# Class GetFindingRequest (2.20.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class GetFindingRequest extends GeneratedMessageV3 implements GetFindingRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> GetFindingRequest

## Implements

[GetFindingRequestOrBuilder](/java/docs/reference/google-cloud-websecurityscanner/2.20.0/com.google.cloud.websecurityscanner.v1beta.GetFindingRequestOrBuilder)
...
```
public static GetFindingRequest getDefaultInstance()
```
...
`[GetFindingRequest](/java/docs/reference/google-cloud-websecurityscanner/2.20.0/com.google.cloud.websecurityscanner.v1beta.GetFindingRequest)`
...
```
public static GetFindingRequest.Builder newBuilder()
```
...
`[GetFindingRequest.Builder](/java/docs/reference/google-cloud-websecurityscanner/2.20.0/com.google.cloud.websecurityscanner.v1beta.GetFindingRequest.Builder)`

### newBuilder(GetFindingRequest prototype)

```
public static GetFindingRequest.Builder newBuilder(GetFindingRequest prototype)
```
...
```
public static GetFindingRequest parseDelimitedFrom(InputStream input)
```
...
```
public static GetFindingRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetFindingRequest parseFrom(byte[] data)
```
...
```
public static GetFindingRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetFindingRequest parseFrom(ByteString data)
```
...
```
public static GetFindingRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetFindingRequest parseFrom(CodedInputStream input)
```
...
```
public static GetFindingRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetFindingRequest parseFrom(InputStream input)
```
...
```
public static GetFindingRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetFindingRequest parseFrom(ByteBuffer data)
```
...
```
public static GetFindingRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<GetFindingRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[GetFindingRequest](/java/docs/reference/google-cloud-websecurityscanner/2.20.0/com.google.cloud.websecurityscanner.v1beta.GetFindingRequest)>`
...
```
public GetFindingRequest getDefaultInstanceForType()
```
...
```
public Parser<GetFindingRequest> getParserForType()
```
...
```
public GetFindingRequest.Builder newBuilderForType()
```
...
```
protected GetFindingRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public GetFindingRequest.Builder toBuilder()
```
