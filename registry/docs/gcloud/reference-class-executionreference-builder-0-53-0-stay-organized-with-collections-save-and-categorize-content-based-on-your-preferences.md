...
# Class ExecutionReference.Builder (0.53.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> ExecutionReference.Builder

## Implements

[ExecutionReferenceOrBuilder](/java/docs/reference/google-cloud-run/0.53.0/com.google.cloud.run.v2.ExecutionReferenceOrBuilder)
...
`[ExecutionReference.Builder](/java/docs/reference/google-cloud-run/0.53.0/com.google.cloud.run.v2.ExecutionReference.Builder)`
...
`[ExecutionReference](/java/docs/reference/google-cloud-run/0.53.0/com.google.cloud.run.v2.ExecutionReference)`
...
`[ExecutionReference.CompletionStatus](/java/docs/reference/google-cloud-run/0.53.0/com.google.cloud.run.v2.ExecutionReference.CompletionStatus)`
...
The enum numeric value on the wire for completionStatus to set.
