...
# Class MembershipEndpoint (1.44.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> MembershipEndpoint

## Implements

[MembershipEndpointOrBuilder](/java/docs/reference/google-cloud-gkehub/1.44.0/com.google.cloud.gkehub.v1.MembershipEndpointOrBuilder)
...
### GOOGLE\_MANAGED\_FIELD\_NUMBER
...
### KUBERNETES\_METADATA\_FIELD\_NUMBER
...
### KUBERNETES\_RESOURCE\_FIELD\_NUMBER
...
`[MembershipEndpoint](/java/docs/reference/google-cloud-gkehub/1.44.0/com.google.cloud.gkehub.v1.MembershipEndpoint)`
...
`[MembershipEndpoint.Builder](/java/docs/reference/google-cloud-gkehub/1.44.0/com.google.cloud.gkehub.v1.MembershipEndpoint.Builder)`

### newBuilder(MembershipEndpoint prototype)
...
```
public static MembershipEndpoint parseDelimitedFrom(InputStream input)
```
...
```
public static MembershipEndpoint parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static MembershipEndpoint parseFrom(byte[] data)
```
...
```
public static MembershipEndpoint parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static MembershipEndpoint parseFrom(ByteString data)
```
...
```
public static MembershipEndpoint parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static MembershipEndpoint parseFrom(CodedInputStream input)
```
...
```
public static MembershipEndpoint parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static MembershipEndpoint parseFrom(InputStream input)
```
...
```
public static MembershipEndpoint parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static MembershipEndpoint parseFrom(ByteBuffer data)
```
...
```
public static MembershipEndpoint parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[MembershipEndpoint](/java/docs/reference/google-cloud-gkehub/1.44.0/com.google.cloud.gkehub.v1.MembershipEndpoint)>`
...
`[GkeCluster](/java/docs/reference/google-cloud-gkehub/1.44.0/com.google.cloud.gkehub.v1.GkeCluster)`
...
`[GkeClusterOrBuilder](/java/docs/reference/google-cloud-gkehub/1.44.0/com.google.cloud.gkehub.v1.GkeClusterOrBuilder)`
...
`[KubernetesMetadata](/java/docs/reference/google-cloud-gkehub/1.44.0/com.google.cloud.gkehub.v1.KubernetesMetadata)`
...
`[KubernetesMetadataOrBuilder](/java/docs/reference/google-cloud-gkehub/1.44.0/com.google.cloud.gkehub.v1.KubernetesMetadataOrBuilder)`
...
`[KubernetesResource](/java/docs/reference/google-cloud-gkehub/1.44.0/com.google.cloud.gkehub.v1.KubernetesResource)`
...
`[KubernetesResourceOrBuilder](/java/docs/reference/google-cloud-gkehub/1.44.0/com.google.cloud.gkehub.v1.KubernetesResourceOrBuilder)`
...
```
protected MembershipEndpoint.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
