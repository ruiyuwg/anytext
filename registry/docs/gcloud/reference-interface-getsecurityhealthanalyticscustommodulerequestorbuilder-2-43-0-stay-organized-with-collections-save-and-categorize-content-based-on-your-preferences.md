...
# Interface GetSecurityHealthAnalyticsCustomModuleRequestOrBuilder (2.43.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface GetSecurityHealthAnalyticsCustomModuleRequestOrBuilder extends MessageOrBuilder
```
