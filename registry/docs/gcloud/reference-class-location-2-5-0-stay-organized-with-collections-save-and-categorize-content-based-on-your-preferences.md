...
# Class Location (2.5.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Location](/java/docs/reference/google-cloud-translate/2.5.0/com.google.cloud.location.Location)
...
[Builder](/java/docs/reference/google-cloud-translate/2.5.0/com.google.cloud.location.Location.Builder)

### newBuilder(Location arg0)

```
public static Location.Builder newBuilder(Location arg0)
```
...
```
public static Location parseDelimitedFrom(InputStream arg0)
```
...
```
public static Location parseDelimitedFrom(InputStream arg0, ExtensionRegistryLite arg1)
```
...
```
public static Location parseFrom(byte[] arg0)
```
...
```
public static Location parseFrom(byte[] arg0, ExtensionRegistryLite arg1)
```
...
```
public static Location parseFrom(ByteString arg0)
```
...
```
public static Location parseFrom(ByteString arg0, ExtensionRegistryLite arg1)
```
...
```
public static Location parseFrom(CodedInputStream arg0)
```
...
```
public static Location parseFrom(CodedInputStream arg0, ExtensionRegistryLite arg1)
```
...
```
public static Location parseFrom(InputStream arg0)
```
...
```
public static Location parseFrom(InputStream arg0, ExtensionRegistryLite arg1)
```
...
```
public static Location parseFrom(ByteBuffer arg0)
```
...
```
public static Location parseFrom(ByteBuffer arg0, ExtensionRegistryLite arg1)
```
...
[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[Location](/java/docs/reference/google-cloud-translate/2.5.0/com.google.cloud.location.Location)\>
...
```
protected Location.Builder newBuilderForType(GeneratedMessageV3.BuilderParent arg0)
```
