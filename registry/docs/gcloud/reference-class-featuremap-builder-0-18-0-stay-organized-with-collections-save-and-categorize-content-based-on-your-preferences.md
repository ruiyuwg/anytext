...
# Class FeatureMap.Builder (0.18.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> FeatureMap.Builder

## Implements

[FeatureMapOrBuilder](/java/docs/reference/google-cloud-recommendations-ai/0.18.0/com.google.cloud.recommendationengine.v1beta1.FeatureMapOrBuilder)
...
`[FeatureMap.Builder](/java/docs/reference/google-cloud-recommendations-ai/0.18.0/com.google.cloud.recommendationengine.v1beta1.FeatureMap.Builder)`
...
`[FeatureMap](/java/docs/reference/google-cloud-recommendations-ai/0.18.0/com.google.cloud.recommendationengine.v1beta1.FeatureMap)`
...
Use [#getCategoricalFeaturesMap()](/java/docs/reference/google-cloud-recommendations-ai/0.18.0/com.google.cloud.recommendationengine.v1beta1.FeatureMap.Builder#com_google_cloud_recommendationengine_v1beta1_FeatureMap_Builder_getCategoricalFeaturesMap__) instead.
...
`[Map](https://docs.oracle.com/javase/8/docs/api/java/util/Map.html)<[String](https://docs.oracle.com/javase/8/docs/api/java/lang/String.html),[StringList](/java/docs/reference/google-cloud-recommendations-ai/0.18.0/com.google.cloud.recommendationengine.v1beta1.FeatureMap.StringList)>`
...
`[FeatureMap.StringList](/java/docs/reference/google-cloud-recommendations-ai/0.18.0/com.google.cloud.recommendationengine.v1beta1.FeatureMap.StringList)`  
...
`[Map](https://docs.oracle.com/javase/8/docs/api/java/util/Map.html)<[String](https://docs.oracle.com/javase/8/docs/api/java/lang/String.html),[FloatList](/java/docs/reference/google-cloud-recommendations-ai/0.18.0/com.google.cloud.recommendationengine.v1beta1.FeatureMap.FloatList)>`
...
Use [#getNumericalFeaturesMap()](/java/docs/reference/google-cloud-recommendations-ai/0.18.0/com.google.cloud.recommendationengine.v1beta1.FeatureMap.Builder#com_google_cloud_recommendationengine_v1beta1_FeatureMap_Builder_getNumericalFeaturesMap__) instead.
...
`[FeatureMap.FloatList](/java/docs/reference/google-cloud-recommendations-ai/0.18.0/com.google.cloud.recommendationengine.v1beta1.FeatureMap.FloatList)`  
