...
# Class CreateCryptoKeyVersionRequest (2.23.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> CreateCryptoKeyVersionRequest

## Implements

[CreateCryptoKeyVersionRequestOrBuilder](/java/docs/reference/google-cloud-kms/2.23.0/com.google.cloud.kms.v1.CreateCryptoKeyVersionRequestOrBuilder)
...
### CRYPTO\_KEY\_VERSION\_FIELD\_NUMBER
...
`[CreateCryptoKeyVersionRequest](/java/docs/reference/google-cloud-kms/2.23.0/com.google.cloud.kms.v1.CreateCryptoKeyVersionRequest)`
...
`[CreateCryptoKeyVersionRequest.Builder](/java/docs/reference/google-cloud-kms/2.23.0/com.google.cloud.kms.v1.CreateCryptoKeyVersionRequest.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[CreateCryptoKeyVersionRequest](/java/docs/reference/google-cloud-kms/2.23.0/com.google.cloud.kms.v1.CreateCryptoKeyVersionRequest)>`
...
`[CryptoKeyVersion](/java/docs/reference/google-cloud-kms/2.23.0/com.google.cloud.kms.v1.CryptoKeyVersion)`
...
`[CryptoKeyVersionOrBuilder](/java/docs/reference/google-cloud-kms/2.23.0/com.google.cloud.kms.v1.CryptoKeyVersionOrBuilder)`
