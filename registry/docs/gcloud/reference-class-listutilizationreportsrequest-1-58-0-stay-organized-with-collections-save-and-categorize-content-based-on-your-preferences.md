...
# Class ListUtilizationReportsRequest (1.58.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListUtilizationReportsRequest extends GeneratedMessageV3 implements ListUtilizationReportsRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListUtilizationReportsRequest

## Implements

[ListUtilizationReportsRequestOrBuilder](/java/docs/reference/google-cloud-vmmigration/1.58.0/com.google.cloud.vmmigration.v1.ListUtilizationReportsRequestOrBuilder)
...
```
public static ListUtilizationReportsRequest getDefaultInstance()
```
...
`[ListUtilizationReportsRequest](/java/docs/reference/google-cloud-vmmigration/1.58.0/com.google.cloud.vmmigration.v1.ListUtilizationReportsRequest)`
...
```
public static ListUtilizationReportsRequest.Builder newBuilder()
```
...
`[ListUtilizationReportsRequest.Builder](/java/docs/reference/google-cloud-vmmigration/1.58.0/com.google.cloud.vmmigration.v1.ListUtilizationReportsRequest.Builder)`

### newBuilder(ListUtilizationReportsRequest prototype)

```
public static ListUtilizationReportsRequest.Builder newBuilder(ListUtilizationReportsRequest prototype)
```
...
```
public static ListUtilizationReportsRequest parseDelimitedFrom(InputStream input)
```
...
```
public static ListUtilizationReportsRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListUtilizationReportsRequest parseFrom(byte[] data)
```
...
```
public static ListUtilizationReportsRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListUtilizationReportsRequest parseFrom(ByteString data)
```
...
```
public static ListUtilizationReportsRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListUtilizationReportsRequest parseFrom(CodedInputStream input)
```
...
```
public static ListUtilizationReportsRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListUtilizationReportsRequest parseFrom(InputStream input)
```
...
```
public static ListUtilizationReportsRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListUtilizationReportsRequest parseFrom(ByteBuffer data)
```
...
```
public static ListUtilizationReportsRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ListUtilizationReportsRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListUtilizationReportsRequest](/java/docs/reference/google-cloud-vmmigration/1.58.0/com.google.cloud.vmmigration.v1.ListUtilizationReportsRequest)>`
...
```
public Parser<ListUtilizationReportsRequest> getParserForType()
```
...
`[UtilizationReportView](/java/docs/reference/google-cloud-vmmigration/1.58.0/com.google.cloud.vmmigration.v1.UtilizationReportView)`
...
```
public ListUtilizationReportsRequest.Builder newBuilderForType()
```
...
```
protected ListUtilizationReportsRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ListUtilizationReportsRequest.Builder toBuilder()
```
