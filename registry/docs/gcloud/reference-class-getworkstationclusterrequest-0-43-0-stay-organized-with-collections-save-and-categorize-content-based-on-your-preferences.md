...
# Class GetWorkstationClusterRequest (0.43.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class GetWorkstationClusterRequest extends GeneratedMessageV3 implements GetWorkstationClusterRequestOrBuilder
```

Request message for GetWorkstationCluster.

Protobuf type `google.cloud.workstations.v1beta.GetWorkstationClusterRequest`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> GetWorkstationClusterRequest

## Implements

[GetWorkstationClusterRequestOrBuilder](/java/docs/reference/google-cloud-workstations/0.43.0/com.google.cloud.workstations.v1beta.GetWorkstationClusterRequestOrBuilder)
...
```
public static GetWorkstationClusterRequest getDefaultInstance()
```
...
`[GetWorkstationClusterRequest](/java/docs/reference/google-cloud-workstations/0.43.0/com.google.cloud.workstations.v1beta.GetWorkstationClusterRequest)`
...
```
public static GetWorkstationClusterRequest.Builder newBuilder()
```
...
`[GetWorkstationClusterRequest.Builder](/java/docs/reference/google-cloud-workstations/0.43.0/com.google.cloud.workstations.v1beta.GetWorkstationClusterRequest.Builder)`

### newBuilder(GetWorkstationClusterRequest prototype)

```
public static GetWorkstationClusterRequest.Builder newBuilder(GetWorkstationClusterRequest prototype)
```
...
```
public static GetWorkstationClusterRequest parseDelimitedFrom(InputStream input)
```
...
```
public static GetWorkstationClusterRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetWorkstationClusterRequest parseFrom(byte[] data)
```
...
```
public static GetWorkstationClusterRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetWorkstationClusterRequest parseFrom(ByteString data)
```
...
```
public static GetWorkstationClusterRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetWorkstationClusterRequest parseFrom(CodedInputStream input)
```
...
```
public static GetWorkstationClusterRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetWorkstationClusterRequest parseFrom(InputStream input)
```
...
```
public static GetWorkstationClusterRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetWorkstationClusterRequest parseFrom(ByteBuffer data)
```
...
```
public static GetWorkstationClusterRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<GetWorkstationClusterRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[GetWorkstationClusterRequest](/java/docs/reference/google-cloud-workstations/0.43.0/com.google.cloud.workstations.v1beta.GetWorkstationClusterRequest)>`
...
```
public GetWorkstationClusterRequest getDefaultInstanceForType()
```
...
```
public Parser<GetWorkstationClusterRequest> getParserForType()
```
...
```
public GetWorkstationClusterRequest.Builder newBuilderForType()
```
...
```
protected GetWorkstationClusterRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public GetWorkstationClusterRequest.Builder toBuilder()
```
