...
# Class GetSourceRequest (2.52.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class GetSourceRequest extends GeneratedMessageV3 implements GetSourceRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> GetSourceRequest

## Implements

[GetSourceRequestOrBuilder](/java/docs/reference/google-cloud-securitycenter/2.52.0/com.google.cloud.securitycenter.v1beta1.GetSourceRequestOrBuilder)
...
```
public static GetSourceRequest getDefaultInstance()
```
...
`[GetSourceRequest](/java/docs/reference/google-cloud-securitycenter/2.52.0/com.google.cloud.securitycenter.v1beta1.GetSourceRequest)`
...
```
public static GetSourceRequest.Builder newBuilder()
```
...
`[GetSourceRequest.Builder](/java/docs/reference/google-cloud-securitycenter/2.52.0/com.google.cloud.securitycenter.v1beta1.GetSourceRequest.Builder)`

### newBuilder(GetSourceRequest prototype)

```
public static GetSourceRequest.Builder newBuilder(GetSourceRequest prototype)
```
...
```
public static GetSourceRequest parseDelimitedFrom(InputStream input)
```
...
```
public static GetSourceRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetSourceRequest parseFrom(byte[] data)
```
...
```
public static GetSourceRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetSourceRequest parseFrom(ByteString data)
```
...
```
public static GetSourceRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetSourceRequest parseFrom(CodedInputStream input)
```
...
```
public static GetSourceRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetSourceRequest parseFrom(InputStream input)
```
...
```
public static GetSourceRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetSourceRequest parseFrom(ByteBuffer data)
```
...
```
public static GetSourceRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<GetSourceRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[GetSourceRequest](/java/docs/reference/google-cloud-securitycenter/2.52.0/com.google.cloud.securitycenter.v1beta1.GetSourceRequest)>`
...
```
public GetSourceRequest getDefaultInstanceForType()
```
...
```
public Parser<GetSourceRequest> getParserForType()
```
...
```
public GetSourceRequest.Builder newBuilderForType()
```
...
```
protected GetSourceRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public GetSourceRequest.Builder toBuilder()
```
