...
# Class SpeechClient.ListCustomClassesPage (4.25.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class SpeechClient.ListCustomClassesPage extends AbstractPage<ListCustomClassesRequest,ListCustomClassesResponse,CustomClass,SpeechClient.ListCustomClassesPage>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractPage](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractPage.html) \> SpeechClient.ListCustomClassesPage
...
### createPage(PageContext<ListCustomClassesRequest,ListCustomClassesResponse,CustomClass> context, ListCustomClassesResponse response)

```
protected SpeechClient.ListCustomClassesPage createPage(PageContext<ListCustomClassesRequest,ListCustomClassesResponse,CustomClass> context, ListCustomClassesResponse response)
```
...
`[PageContext](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PageContext.html)<[ListCustomClassesRequest](/java/docs/reference/google-cloud-speech/4.25.0/com.google.cloud.speech.v2.ListCustomClassesRequest),[ListCustomClassesResponse](/java/docs/reference/google-cloud-speech/4.25.0/com.google.cloud.speech.v2.ListCustomClassesResponse),[CustomClass](/java/docs/reference/google-cloud-speech/4.25.0/com.google.cloud.speech.v2.CustomClass)>`  

`response`

`[ListCustomClassesResponse](/java/docs/reference/google-cloud-speech/4.25.0/com.google.cloud.speech.v2.ListCustomClassesResponse)`  
...
`[SpeechClient.ListCustomClassesPage](/java/docs/reference/google-cloud-speech/4.25.0/com.google.cloud.speech.v2.SpeechClient.ListCustomClassesPage)`
...
### createPageAsync(PageContext<ListCustomClassesRequest,ListCustomClassesResponse,CustomClass> context, ApiFuture<ListCustomClassesResponse> futureResponse)

```
public ApiFuture<SpeechClient.ListCustomClassesPage> createPageAsync(PageContext<ListCustomClassesRequest,ListCustomClassesResponse,CustomClass> context, ApiFuture<ListCustomClassesResponse> futureResponse)
```
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListCustomClassesResponse](/java/docs/reference/google-cloud-speech/4.25.0/com.google.cloud.speech.v2.ListCustomClassesResponse)>`  
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListCustomClassesPage](/java/docs/reference/google-cloud-speech/4.25.0/com.google.cloud.speech.v2.SpeechClient.ListCustomClassesPage)>`
