...
# Interface Finding.MuteInfo.StaticMuteOrBuilder (2.60.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static interface Finding.MuteInfo.StaticMuteOrBuilder extends MessageOrBuilder
```
...
```
public abstract Timestamp getApplyTime()
```
...
```
public abstract TimestampOrBuilder getApplyTimeOrBuilder()
```
...
```
public abstract Finding.Mute getState()
```
...
`[Finding.Mute](/java/docs/reference/google-cloud-securitycenter/2.60.0/com.google.cloud.securitycenter.v1.Finding.Mute)`
...
```
public abstract boolean hasApplyTime()
```
