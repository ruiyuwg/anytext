...
# Class UserEventImportSummary (2.16.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class UserEventImportSummary extends GeneratedMessageV3 implements UserEventImportSummaryOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> UserEventImportSummary

## Implements

[UserEventImportSummaryOrBuilder](/java/docs/reference/google-cloud-retail/2.16.0/com.google.cloud.retail.v2.UserEventImportSummaryOrBuilder)
...
### JOINED\_EVENTS\_COUNT\_FIELD\_NUMBER

```
public static final int JOINED_EVENTS_COUNT_FIELD_NUMBER
```
...
### UNJOINED\_EVENTS\_COUNT\_FIELD\_NUMBER

```
public static final int UNJOINED_EVENTS_COUNT_FIELD_NUMBER
```
...
```
public static UserEventImportSummary getDefaultInstance()
```
...
`[UserEventImportSummary](/java/docs/reference/google-cloud-retail/2.16.0/com.google.cloud.retail.v2.UserEventImportSummary)`
...
```
public static UserEventImportSummary.Builder newBuilder()
```
...
`[UserEventImportSummary.Builder](/java/docs/reference/google-cloud-retail/2.16.0/com.google.cloud.retail.v2.UserEventImportSummary.Builder)`

### newBuilder(UserEventImportSummary prototype)

```
public static UserEventImportSummary.Builder newBuilder(UserEventImportSummary prototype)
```
...
```
public static UserEventImportSummary parseDelimitedFrom(InputStream input)
```
...
```
public static UserEventImportSummary parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UserEventImportSummary parseFrom(byte[] data)
```
...
```
public static UserEventImportSummary parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UserEventImportSummary parseFrom(ByteString data)
```
...
```
public static UserEventImportSummary parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UserEventImportSummary parseFrom(CodedInputStream input)
```
...
```
public static UserEventImportSummary parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UserEventImportSummary parseFrom(InputStream input)
```
...
```
public static UserEventImportSummary parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UserEventImportSummary parseFrom(ByteBuffer data)
```
...
```
public static UserEventImportSummary parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<UserEventImportSummary> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[UserEventImportSummary](/java/docs/reference/google-cloud-retail/2.16.0/com.google.cloud.retail.v2.UserEventImportSummary)>`
...
```
public UserEventImportSummary getDefaultInstanceForType()
```
...
```
public Parser<UserEventImportSummary> getParserForType()
```
...
```
public UserEventImportSummary.Builder newBuilderForType()
```
...
```
protected UserEventImportSummary.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public UserEventImportSummary.Builder toBuilder()
```
