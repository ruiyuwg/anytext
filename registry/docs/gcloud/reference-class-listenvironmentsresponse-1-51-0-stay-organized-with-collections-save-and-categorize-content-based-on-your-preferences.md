...
# Class ListEnvironmentsResponse (1.51.0) Stay organized with collections Save and categorize content based on your preferences.
...
[ListEnvironmentsResponseOrBuilder](/java/docs/reference/google-cloud-notebooks/1.51.0/com.google.cloud.notebooks.v1.ListEnvironmentsResponseOrBuilder)
...
`[ListEnvironmentsResponse](/java/docs/reference/google-cloud-notebooks/1.51.0/com.google.cloud.notebooks.v1.ListEnvironmentsResponse)`
...
`[ListEnvironmentsResponse.Builder](/java/docs/reference/google-cloud-notebooks/1.51.0/com.google.cloud.notebooks.v1.ListEnvironmentsResponse.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListEnvironmentsResponse](/java/docs/reference/google-cloud-notebooks/1.51.0/com.google.cloud.notebooks.v1.ListEnvironmentsResponse)>`
...
`[Environment](/java/docs/reference/google-cloud-notebooks/1.51.0/com.google.cloud.notebooks.v1.Environment)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Environment](/java/docs/reference/google-cloud-notebooks/1.51.0/com.google.cloud.notebooks.v1.Environment)>`
...
`[EnvironmentOrBuilder](/java/docs/reference/google-cloud-notebooks/1.51.0/com.google.cloud.notebooks.v1.EnvironmentOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.notebooks.v1.EnvironmentOrBuilder>`
