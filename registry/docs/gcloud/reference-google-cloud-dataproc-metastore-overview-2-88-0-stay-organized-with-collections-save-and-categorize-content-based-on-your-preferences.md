...
# google-cloud-dataproc-metastore overview (2.88.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Dataproc Metastore Description:** Is a fully managed, highly available, autoscaled, autohealing, OSS-native metastore service that greatly simplifies technical metadata management. Dataproc Metastore service is based on Apache Hive metastore and serves as a critical component towards enterprise data lakes.

[Dataproc Metastore Product Reference](https://cloud.google.com/dataproc-metastore/docs)

[GitHub Repository](https://github.com/googleapis/google-cloud-java/tree/main/java-dataproc-metastore)

[Maven artifact](https://central.sonatype.com/artifact/com.google.cloud/google-cloud-dataproc-metastore)
...
-   [Enable the API](https://console.cloud.google.com/apis/library/metastore.googleapis.com)
-   [Set up authentication](https://cloud.google.com/docs/authentication/client-libraries)

## Use the Dataproc Metastore for Java
...
The example below demonstrates how you would import the BOM and include the `google-cloud-dataproc-metastore` artifact.
...
implementation("com.google.cloud:google-cloud-dataproc-metastore")
...
libraryDependencies += "com.google.cloud" % "google-cloud-dataproc-metastore" % "2.88.0"

## Which version ID should I get started with?

For this library, we recommend using [com.google.cloud.metastore.v1](https://cloud.google.com/java/docs/reference/google-cloud-dataproc-metastore/2.88.0/com.google.cloud.metastore.v1) for new applications.
