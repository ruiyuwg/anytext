...
# Enum ImageImportJob.State (1.87.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-vmmigration/latest/com.google.cloud.vmmigration.v1.ImageImportJob.State#com_google_cloud_vmmigration_v1_ImageImportJob_State_forNumber_int_) instead._
