...
# Class LabelAnnotation (2.38.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> LabelAnnotation

## Implements

[LabelAnnotationOrBuilder](/java/docs/reference/google-cloud-video-intelligence/2.38.0/com.google.cloud.videointelligence.v1p3beta1.LabelAnnotationOrBuilder)
...
### CATEGORY\_ENTITIES\_FIELD\_NUMBER
...
`[LabelAnnotation](/java/docs/reference/google-cloud-video-intelligence/2.38.0/com.google.cloud.videointelligence.v1p3beta1.LabelAnnotation)`
...
`[LabelAnnotation.Builder](/java/docs/reference/google-cloud-video-intelligence/2.38.0/com.google.cloud.videointelligence.v1p3beta1.LabelAnnotation.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[LabelAnnotation](/java/docs/reference/google-cloud-video-intelligence/2.38.0/com.google.cloud.videointelligence.v1p3beta1.LabelAnnotation)>`
...
`[Entity](/java/docs/reference/google-cloud-video-intelligence/2.38.0/com.google.cloud.videointelligence.v1p3beta1.Entity)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Entity](/java/docs/reference/google-cloud-video-intelligence/2.38.0/com.google.cloud.videointelligence.v1p3beta1.Entity)>`
...
`[EntityOrBuilder](/java/docs/reference/google-cloud-video-intelligence/2.38.0/com.google.cloud.videointelligence.v1p3beta1.EntityOrBuilder)`
...
`[LabelFrame](/java/docs/reference/google-cloud-video-intelligence/2.38.0/com.google.cloud.videointelligence.v1p3beta1.LabelFrame)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[LabelFrame](/java/docs/reference/google-cloud-video-intelligence/2.38.0/com.google.cloud.videointelligence.v1p3beta1.LabelFrame)>`
...
`[LabelFrameOrBuilder](/java/docs/reference/google-cloud-video-intelligence/2.38.0/com.google.cloud.videointelligence.v1p3beta1.LabelFrameOrBuilder)`
...
`[LabelSegment](/java/docs/reference/google-cloud-video-intelligence/2.38.0/com.google.cloud.videointelligence.v1p3beta1.LabelSegment)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[LabelSegment](/java/docs/reference/google-cloud-video-intelligence/2.38.0/com.google.cloud.videointelligence.v1p3beta1.LabelSegment)>`
...
`[LabelSegmentOrBuilder](/java/docs/reference/google-cloud-video-intelligence/2.38.0/com.google.cloud.videointelligence.v1p3beta1.LabelSegmentOrBuilder)`
