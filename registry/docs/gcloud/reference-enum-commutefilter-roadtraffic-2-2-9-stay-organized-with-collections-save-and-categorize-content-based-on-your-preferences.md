...
# Enum CommuteFilter.RoadTraffic (2.2.9) Stay organized with collections Save and categorize content based on your preferences.
...
ROAD\_TRAFFIC\_UNSPECIFIED

Road traffic situation isn't specified.

`ROAD_TRAFFIC_UNSPECIFIED = 0;`

ROAD\_TRAFFIC\_UNSPECIFIED\_VALUE
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-talent/2.2.9/com.google.cloud.talent.v4.CommuteFilter.RoadTraffic#com_google_cloud_talent_v4_CommuteFilter_RoadTraffic_forNumber_int_) instead._
