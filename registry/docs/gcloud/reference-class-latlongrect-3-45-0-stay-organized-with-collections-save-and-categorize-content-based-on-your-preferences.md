...
# Class LatLongRect (3.45.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> LatLongRect

## Implements

[LatLongRectOrBuilder](/java/docs/reference/google-cloud-vision/3.45.0/com.google.cloud.vision.v1p3beta1.LatLongRectOrBuilder)
...
`[LatLongRect](/java/docs/reference/google-cloud-vision/3.45.0/com.google.cloud.vision.v1p3beta1.LatLongRect)`
...
`[LatLongRect.Builder](/java/docs/reference/google-cloud-vision/3.45.0/com.google.cloud.vision.v1p3beta1.LatLongRect.Builder)`
...
```
public static LatLongRect parseDelimitedFrom(InputStream input)
```
...
```
public static LatLongRect parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static LatLongRect parseFrom(byte[] data)
```
...
```
public static LatLongRect parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static LatLongRect parseFrom(ByteString data)
```
...
```
public static LatLongRect parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static LatLongRect parseFrom(CodedInputStream input)
```
...
```
public static LatLongRect parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static LatLongRect parseFrom(InputStream input)
```
...
```
public static LatLongRect parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static LatLongRect parseFrom(ByteBuffer data)
```
...
```
public static LatLongRect parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[LatLongRect](/java/docs/reference/google-cloud-vision/3.45.0/com.google.cloud.vision.v1p3beta1.LatLongRect)>`
...
```
public LatLongRect.Builder newBuilderForType()
```
...
```
protected LatLongRect.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public LatLongRect.Builder toBuilder()
```
