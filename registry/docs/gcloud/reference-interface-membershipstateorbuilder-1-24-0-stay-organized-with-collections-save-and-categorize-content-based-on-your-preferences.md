...
# Interface MembershipStateOrBuilder (1.24.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[MembershipState.Code](/java/docs/reference/google-cloud-gkehub/1.24.0/com.google.cloud.gkehub.v1alpha2.MembershipState.Code)`
