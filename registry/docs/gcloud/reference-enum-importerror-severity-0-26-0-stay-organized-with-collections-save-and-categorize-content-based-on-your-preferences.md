...
# Enum ImportError.Severity (0.26.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum ImportError.Severity extends Enum<ImportError.Severity> implements ProtocolMessageEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-migrationcenter/0.26.0/com.google.cloud.migrationcenter.v1.ImportError.Severity#com_google_cloud_migrationcenter_v1_ImportError_Severity_forNumber_int_) instead._
