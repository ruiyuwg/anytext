...
# Class InstanceGroupManagersLimitedErrorCountRetryPolicy (2.32.0) Stay organized with collections Save and categorize content based on your preferences.
...
A retry policy for [`InstanceGroupManagersConnection`](/cpp/docs/reference/compute/2.32.0/classgoogle_1_1cloud_1_1compute__instance__group__managers__v1_1_1InstanceGroupManagersConnection) based on counting errors.
...
`InstanceGroupManagersLimitedErrorCountRetryPolicy const &`  
...
`std::unique_ptr< InstanceGroupManagersRetryPolicy >`

## Type Aliases

### BaseType

**Alias Of**: `InstanceGroupManagersRetryPolicy`
