...
# Interface OSPolicy.Resource.PackageResource.DebOrBuilder (2.13.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[OSPolicy.Resource.File](/java/docs/reference/google-cloud-os-config/2.13.0/com.google.cloud.osconfig.v1alpha.OSPolicy.Resource.File)`
...
`[OSPolicy.Resource.FileOrBuilder](/java/docs/reference/google-cloud-os-config/2.13.0/com.google.cloud.osconfig.v1alpha.OSPolicy.Resource.FileOrBuilder)`
