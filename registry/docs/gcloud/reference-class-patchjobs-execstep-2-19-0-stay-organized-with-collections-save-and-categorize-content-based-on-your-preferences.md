...
# Class PatchJobs.ExecStep (2.19.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> PatchJobs.ExecStep

## Implements

[PatchJobs.ExecStepOrBuilder](/java/docs/reference/google-cloud-os-config/2.19.0/com.google.cloud.osconfig.v1beta.PatchJobs.ExecStepOrBuilder)
...
### LINUX\_EXEC\_STEP\_CONFIG\_FIELD\_NUMBER
...
### WINDOWS\_EXEC\_STEP\_CONFIG\_FIELD\_NUMBER
...
`[PatchJobs.ExecStep](/java/docs/reference/google-cloud-os-config/2.19.0/com.google.cloud.osconfig.v1beta.PatchJobs.ExecStep)`
...
`[PatchJobs.ExecStep.Builder](/java/docs/reference/google-cloud-os-config/2.19.0/com.google.cloud.osconfig.v1beta.PatchJobs.ExecStep.Builder)`
...
```
public static PatchJobs.ExecStep parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PatchJobs.ExecStep parseFrom(ByteString data)
```
...
```
public static PatchJobs.ExecStep parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PatchJobs.ExecStep parseFrom(CodedInputStream input)
```
...
```
public static PatchJobs.ExecStep parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PatchJobs.ExecStep parseFrom(InputStream input)
```
...
```
public static PatchJobs.ExecStep parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PatchJobs.ExecStep parseFrom(ByteBuffer data)
```
...
```
public static PatchJobs.ExecStep parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<PatchJobs.ExecStep> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ExecStep](/java/docs/reference/google-cloud-os-config/2.19.0/com.google.cloud.osconfig.v1beta.PatchJobs.ExecStep)>`
...
`[PatchJobs.ExecStepConfig](/java/docs/reference/google-cloud-os-config/2.19.0/com.google.cloud.osconfig.v1beta.PatchJobs.ExecStepConfig)`
...
`[PatchJobs.ExecStepConfigOrBuilder](/java/docs/reference/google-cloud-os-config/2.19.0/com.google.cloud.osconfig.v1beta.PatchJobs.ExecStepConfigOrBuilder)`

### getParserForType()

```
public Parser<PatchJobs.ExecStep> getParserForType()
```
...
```
public PatchJobs.ExecStep.Builder newBuilderForType()
```
...
```
protected PatchJobs.ExecStep.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public PatchJobs.ExecStep.Builder toBuilder()
```
