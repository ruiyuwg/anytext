...
# google-cloud-service-usage overview (2.87.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Service Usage Description:** Is an infrastructure service of Google Cloud that lets you list and manage other APIs and services in your Cloud projects.

[Service Usage Product Reference](https://cloud.google.com/service-usage/docs/overview)

[GitHub Repository](https://github.com/googleapis/google-cloud-java/tree/main/java-service-usage)

[Maven artifact](https://central.sonatype.com/artifact/com.google.cloud/google-cloud-service-usage)
...
-   [Enable the API](https://console.cloud.google.com/apis/library/serviceusage.googleapis.com)
-   [Set up authentication](https://cloud.google.com/docs/authentication/client-libraries)

## Use the Service Usage for Java
...
The example below demonstrates how you would import the BOM and include the `google-cloud-service-usage` artifact.
...
For this library, we recommend using [com.google.api.serviceusage.v1](https://cloud.google.com/java/docs/reference/google-cloud-service-usage/2.87.0/com.google.api.serviceusage.v1) for new applications.
