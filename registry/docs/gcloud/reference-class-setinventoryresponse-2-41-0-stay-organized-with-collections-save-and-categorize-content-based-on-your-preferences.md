...
# Class SetInventoryResponse (2.41.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class SetInventoryResponse extends GeneratedMessageV3 implements SetInventoryResponseOrBuilder
```
...
Protobuf type `google.cloud.retail.v2alpha.SetInventoryResponse`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> SetInventoryResponse

## Implements

[SetInventoryResponseOrBuilder](/java/docs/reference/google-cloud-retail/2.41.0/com.google.cloud.retail.v2alpha.SetInventoryResponseOrBuilder)
...
```
public static SetInventoryResponse getDefaultInstance()
```
...
`[SetInventoryResponse](/java/docs/reference/google-cloud-retail/2.41.0/com.google.cloud.retail.v2alpha.SetInventoryResponse)`
...
```
public static SetInventoryResponse.Builder newBuilder()
```
...
`[SetInventoryResponse.Builder](/java/docs/reference/google-cloud-retail/2.41.0/com.google.cloud.retail.v2alpha.SetInventoryResponse.Builder)`

### newBuilder(SetInventoryResponse prototype)

```
public static SetInventoryResponse.Builder newBuilder(SetInventoryResponse prototype)
```
...
```
public static SetInventoryResponse parseDelimitedFrom(InputStream input)
```
...
```
public static SetInventoryResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SetInventoryResponse parseFrom(byte[] data)
```
...
```
public static SetInventoryResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SetInventoryResponse parseFrom(ByteString data)
```
...
```
public static SetInventoryResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SetInventoryResponse parseFrom(CodedInputStream input)
```
...
```
public static SetInventoryResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SetInventoryResponse parseFrom(InputStream input)
```
...
```
public static SetInventoryResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SetInventoryResponse parseFrom(ByteBuffer data)
```
...
```
public static SetInventoryResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<SetInventoryResponse> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[SetInventoryResponse](/java/docs/reference/google-cloud-retail/2.41.0/com.google.cloud.retail.v2alpha.SetInventoryResponse)>`
...
```
public Parser<SetInventoryResponse> getParserForType()
```
...
```
public SetInventoryResponse.Builder newBuilderForType()
```
...
```
protected SetInventoryResponse.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public SetInventoryResponse.Builder toBuilder()
```
