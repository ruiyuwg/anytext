...
# Class Retry (0.16.0) Stay organized with collections Save and categorize content based on your preferences.

Version latestkeyboard\_arrow\_down

-   [0.16.0 (latest)](/java/docs/reference/google-cloudevent-types/latest/com.google.events.cloud.deploy.v1.Retry)
-   [0.15.0](/java/docs/reference/google-cloudevent-types/0.15.0/com.google.events.cloud.deploy.v1.Retry)
-   [0.14.1](/java/docs/reference/google-cloudevent-types/0.14.1/com.google.events.cloud.deploy.v1.Retry)
...
`[Retry](/java/docs/reference/google-cloudevent-types/latest/com.google.events.cloud.deploy.v1.Retry)`
...
`[Retry.Builder](/java/docs/reference/google-cloudevent-types/latest/com.google.events.cloud.deploy.v1.Retry.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[Retry](/java/docs/reference/google-cloudevent-types/latest/com.google.events.cloud.deploy.v1.Retry)>`
...
`[BackoffMode](/java/docs/reference/google-cloudevent-types/latest/com.google.events.cloud.deploy.v1.BackoffMode)`
