...
# Class VmMigrationClient.ListSourcesPage (1.6.0) Stay organized with collections Save and categorize content based on your preferences.
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractPage](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractPage.html) \> VmMigrationClient.ListSourcesPage
...
```
protected VmMigrationClient.ListSourcesPage createPage(PageContext<ListSourcesRequest,ListSourcesResponse,Source> context, ListSourcesResponse response)
```
...
`[PageContext](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PageContext.html)<[ListSourcesRequest](/java/docs/reference/google-cloud-vmmigration/1.6.0/com.google.cloud.vmmigration.v1.ListSourcesRequest),[ListSourcesResponse](/java/docs/reference/google-cloud-vmmigration/1.6.0/com.google.cloud.vmmigration.v1.ListSourcesResponse),[Source](/java/docs/reference/google-cloud-vmmigration/1.6.0/com.google.cloud.vmmigration.v1.Source)>`  

response

`[ListSourcesResponse](/java/docs/reference/google-cloud-vmmigration/1.6.0/com.google.cloud.vmmigration.v1.ListSourcesResponse)`  
...
[VmMigrationClient.ListSourcesPage](/java/docs/reference/google-cloud-vmmigration/1.6.0/com.google.cloud.vmmigration.v1.VmMigrationClient.ListSourcesPage)
...
```
public ApiFuture<VmMigrationClient.ListSourcesPage> createPageAsync(PageContext<ListSourcesRequest,ListSourcesResponse,Source> context, ApiFuture<ListSourcesResponse> futureResponse)
```
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListSourcesResponse](/java/docs/reference/google-cloud-vmmigration/1.6.0/com.google.cloud.vmmigration.v1.ListSourcesResponse)>`  
...
[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListSourcesPage](/java/docs/reference/google-cloud-vmmigration/1.6.0/com.google.cloud.vmmigration.v1.VmMigrationClient.ListSourcesPage)\>
