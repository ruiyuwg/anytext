...
# Interface Options.UpdateAdminApiOption (6.82.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static interface Options.UpdateAdminApiOption extends Options.AdminApiOption
```
...
[Options.AdminApiOption](/java/docs/reference/google-cloud-spanner/6.82.0/com.google.cloud.spanner.Options.AdminApiOption)
