...
# Class AddSecretVersionRequest (2.17.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class AddSecretVersionRequest extends GeneratedMessageV3 implements AddSecretVersionRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> AddSecretVersionRequest

## Implements

[AddSecretVersionRequestOrBuilder](/java/docs/reference/google-cloud-secretmanager/2.17.0/com.google.cloud.secretmanager.v1.AddSecretVersionRequestOrBuilder)
...
```
public static AddSecretVersionRequest getDefaultInstance()
```
...
`[AddSecretVersionRequest](/java/docs/reference/google-cloud-secretmanager/2.17.0/com.google.cloud.secretmanager.v1.AddSecretVersionRequest)`
...
```
public static AddSecretVersionRequest.Builder newBuilder()
```
...
`[AddSecretVersionRequest.Builder](/java/docs/reference/google-cloud-secretmanager/2.17.0/com.google.cloud.secretmanager.v1.AddSecretVersionRequest.Builder)`

### newBuilder(AddSecretVersionRequest prototype)

```
public static AddSecretVersionRequest.Builder newBuilder(AddSecretVersionRequest prototype)
```
...
```
public static AddSecretVersionRequest parseDelimitedFrom(InputStream input)
```
...
```
public static AddSecretVersionRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AddSecretVersionRequest parseFrom(byte[] data)
```
...
```
public static AddSecretVersionRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AddSecretVersionRequest parseFrom(ByteString data)
```
...
```
public static AddSecretVersionRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AddSecretVersionRequest parseFrom(CodedInputStream input)
```
...
```
public static AddSecretVersionRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AddSecretVersionRequest parseFrom(InputStream input)
```
...
```
public static AddSecretVersionRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AddSecretVersionRequest parseFrom(ByteBuffer data)
```
...
```
public static AddSecretVersionRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<AddSecretVersionRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[AddSecretVersionRequest](/java/docs/reference/google-cloud-secretmanager/2.17.0/com.google.cloud.secretmanager.v1.AddSecretVersionRequest)>`
...
```
public Parser<AddSecretVersionRequest> getParserForType()
```
...
`[SecretPayload](/java/docs/reference/google-cloud-secretmanager/2.17.0/com.google.cloud.secretmanager.v1.SecretPayload)`
...
`[SecretPayloadOrBuilder](/java/docs/reference/google-cloud-secretmanager/2.17.0/com.google.cloud.secretmanager.v1.SecretPayloadOrBuilder)`
...
```
public AddSecretVersionRequest.Builder newBuilderForType()
```
...
```
protected AddSecretVersionRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public AddSecretVersionRequest.Builder toBuilder()
```
