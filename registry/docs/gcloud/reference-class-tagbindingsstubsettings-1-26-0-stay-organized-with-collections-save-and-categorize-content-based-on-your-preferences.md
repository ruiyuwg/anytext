...
# Class TagBindingsStubSettings (1.26.0) Stay organized with collections Save and categorize content based on your preferences.
...
Settings class to configure an instance of [TagBindingsStub](/java/docs/reference/google-cloud-resourcemanager/1.26.0/com.google.cloud.resourcemanager.v3.stub.TagBindingsStub).
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [StubSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.StubSettings.html) \> TagBindingsStubSettings
...
```
public static TagBindingsStubSettings.Builder newBuilder()
```
...
`[TagBindingsStubSettings.Builder](/java/docs/reference/google-cloud-resourcemanager/1.26.0/com.google.cloud.resourcemanager.v3.stub.TagBindingsStubSettings.Builder)`

### newBuilder(ClientContext clientContext)

```
public static TagBindingsStubSettings.Builder newBuilder(ClientContext clientContext)
```
...
```
public static TagBindingsStubSettings.Builder newHttpJsonBuilder()
```
...
### TagBindingsStubSettings(TagBindingsStubSettings.Builder settingsBuilder)

```
protected TagBindingsStubSettings(TagBindingsStubSettings.Builder settingsBuilder)
```
...
```
public TagBindingsStub createStub()
```
...
`[TagBindingsStub](/java/docs/reference/google-cloud-resourcemanager/1.26.0/com.google.cloud.resourcemanager.v3.stub.TagBindingsStub)`
...
`[OperationCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.OperationCallSettings.html)<[CreateTagBindingRequest](/java/docs/reference/google-cloud-resourcemanager/1.26.0/com.google.cloud.resourcemanager.v3.CreateTagBindingRequest),[TagBinding](/java/docs/reference/google-cloud-resourcemanager/1.26.0/com.google.cloud.resourcemanager.v3.TagBinding),[CreateTagBindingMetadata](/java/docs/reference/google-cloud-resourcemanager/1.26.0/com.google.cloud.resourcemanager.v3.CreateTagBindingMetadata)>`
...
`[UnaryCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.html)<[CreateTagBindingRequest](/java/docs/reference/google-cloud-resourcemanager/1.26.0/com.google.cloud.resourcemanager.v3.CreateTagBindingRequest),[Operation](https://cloud.google.com/java/docs/reference/gax/latest/com.google.longrunning.Operation.html)>`
...
`[OperationCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.OperationCallSettings.html)<[DeleteTagBindingRequest](/java/docs/reference/google-cloud-resourcemanager/1.26.0/com.google.cloud.resourcemanager.v3.DeleteTagBindingRequest),[Empty](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Empty.html),[DeleteTagBindingMetadata](/java/docs/reference/google-cloud-resourcemanager/1.26.0/com.google.cloud.resourcemanager.v3.DeleteTagBindingMetadata)>`
...
`[UnaryCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.html)<[DeleteTagBindingRequest](/java/docs/reference/google-cloud-resourcemanager/1.26.0/com.google.cloud.resourcemanager.v3.DeleteTagBindingRequest),[Operation](https://cloud.google.com/java/docs/reference/gax/latest/com.google.longrunning.Operation.html)>`
...
`[PagedCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PagedCallSettings.html)<[ListEffectiveTagsRequest](/java/docs/reference/google-cloud-resourcemanager/1.26.0/com.google.cloud.resourcemanager.v3.ListEffectiveTagsRequest),[ListEffectiveTagsResponse](/java/docs/reference/google-cloud-resourcemanager/1.26.0/com.google.cloud.resourcemanager.v3.ListEffectiveTagsResponse),[ListEffectiveTagsPagedResponse](/java/docs/reference/google-cloud-resourcemanager/1.26.0/com.google.cloud.resourcemanager.v3.TagBindingsClient.ListEffectiveTagsPagedResponse)>`
...
`[PagedCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PagedCallSettings.html)<[ListTagBindingsRequest](/java/docs/reference/google-cloud-resourcemanager/1.26.0/com.google.cloud.resourcemanager.v3.ListTagBindingsRequest),[ListTagBindingsResponse](/java/docs/reference/google-cloud-resourcemanager/1.26.0/com.google.cloud.resourcemanager.v3.ListTagBindingsResponse),[ListTagBindingsPagedResponse](/java/docs/reference/google-cloud-resourcemanager/1.26.0/com.google.cloud.resourcemanager.v3.TagBindingsClient.ListTagBindingsPagedResponse)>`

### toBuilder()

```
public TagBindingsStubSettings.Builder toBuilder()
```
