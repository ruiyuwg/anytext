...
# Class ImageAnnotatorGrpc.ImageAnnotatorStub (3.30.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[AsyncBatchAnnotateFilesRequest](/java/docs/reference/google-cloud-vision/3.30.0/com.google.cloud.vision.v1p3beta1.AsyncBatchAnnotateFilesRequest)`  
...
`[BatchAnnotateImagesRequest](/java/docs/reference/google-cloud-vision/3.30.0/com.google.cloud.vision.v1p3beta1.BatchAnnotateImagesRequest)`  

`responseObserver`

`io.grpc.stub.StreamObserver<[BatchAnnotateImagesResponse](/java/docs/reference/google-cloud-vision/3.30.0/com.google.cloud.vision.v1p3beta1.BatchAnnotateImagesResponse)>`  
...
`[ImageAnnotatorGrpc.ImageAnnotatorStub](/java/docs/reference/google-cloud-vision/3.30.0/com.google.cloud.vision.v1p3beta1.ImageAnnotatorGrpc.ImageAnnotatorStub)`
