...
# Class CompletionServiceGrpc.CompletionServiceStub (2.57.0) Stay organized with collections Save and categorize content based on your preferences.
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> io.grpc.stub.AbstractStub \> io.grpc.stub.AbstractAsyncStub \> CompletionServiceGrpc.CompletionServiceStub
...
`[CompletionServiceGrpc.CompletionServiceStub](/java/docs/reference/google-cloud-retail/2.57.0/com.google.cloud.retail.v2beta.CompletionServiceGrpc.CompletionServiceStub)`
...
`[CompleteQueryRequest](/java/docs/reference/google-cloud-retail/2.57.0/com.google.cloud.retail.v2beta.CompleteQueryRequest)`  

`responseObserver`

`io.grpc.stub.StreamObserver<[CompleteQueryResponse](/java/docs/reference/google-cloud-retail/2.57.0/com.google.cloud.retail.v2beta.CompleteQueryResponse)>`  
...
`[ImportCompletionDataRequest](/java/docs/reference/google-cloud-retail/2.57.0/com.google.cloud.retail.v2beta.ImportCompletionDataRequest)`  
