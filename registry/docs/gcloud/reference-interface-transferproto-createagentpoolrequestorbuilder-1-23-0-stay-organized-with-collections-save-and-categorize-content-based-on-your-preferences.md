...
# Interface TransferProto.CreateAgentPoolRequestOrBuilder (1.23.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[TransferTypes.AgentPool](/java/docs/reference/google-cloud-storage-transfer/1.23.0/com.google.storagetransfer.v1.proto.TransferTypes.AgentPool)`
...
-   Start with a lowercase ASCII character, followed by:
    ...
    As expressed by the regular expression: `^(?!goog)[a-z](/java/docs/reference/google-cloud-storage-transfer/1.23.0/[a-z0-9-._~]*[a-z0-9])?$`.
...
`[TransferTypes.AgentPoolOrBuilder](/java/docs/reference/google-cloud-storage-transfer/1.23.0/com.google.storagetransfer.v1.proto.TransferTypes.AgentPoolOrBuilder)`
