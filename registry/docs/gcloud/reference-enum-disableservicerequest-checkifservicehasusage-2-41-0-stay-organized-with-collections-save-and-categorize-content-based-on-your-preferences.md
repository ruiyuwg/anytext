...
# Enum DisableServiceRequest.CheckIfServiceHasUsage (2.41.0) Stay organized with collections Save and categorize content based on your preferences.
...
If set, service usage is checked when disabling the service. If a service, or its dependents, has usage in the last 30 days, the request returns a FAILED\_PRECONDITION error.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-service-usage/2.41.0/com.google.api.serviceusage.v1.DisableServiceRequest.CheckIfServiceHasUsage#com_google_api_serviceusage_v1_DisableServiceRequest_CheckIfServiceHasUsage_forNumber_int_) instead._
