...
# Class AcquireLeaseRequest (0.10.0) Stay organized with collections Save and categorize content based on your preferences.
...
Protobuf type `google.cloud.visionai.v1.AcquireLeaseRequest`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> AcquireLeaseRequest

## Implements

[AcquireLeaseRequestOrBuilder](/java/docs/reference/google-cloud-visionai/0.10.0/com.google.cloud.visionai.v1.AcquireLeaseRequestOrBuilder)
...
### LEASE\_TYPE\_FIELD\_NUMBER

```
public static final int LEASE_TYPE_FIELD_NUMBER
```
...
```
public static AcquireLeaseRequest getDefaultInstance()
```
...
`[AcquireLeaseRequest](/java/docs/reference/google-cloud-visionai/0.10.0/com.google.cloud.visionai.v1.AcquireLeaseRequest)`
...
```
public static AcquireLeaseRequest.Builder newBuilder()
```
...
`[AcquireLeaseRequest.Builder](/java/docs/reference/google-cloud-visionai/0.10.0/com.google.cloud.visionai.v1.AcquireLeaseRequest.Builder)`

### newBuilder(AcquireLeaseRequest prototype)

```
public static AcquireLeaseRequest.Builder newBuilder(AcquireLeaseRequest prototype)
```
...
```
public static AcquireLeaseRequest parseDelimitedFrom(InputStream input)
```
...
```
public static AcquireLeaseRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AcquireLeaseRequest parseFrom(byte[] data)
```
...
```
public static AcquireLeaseRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AcquireLeaseRequest parseFrom(ByteString data)
```
...
```
public static AcquireLeaseRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AcquireLeaseRequest parseFrom(CodedInputStream input)
```
...
```
public static AcquireLeaseRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AcquireLeaseRequest parseFrom(InputStream input)
```
...
```
public static AcquireLeaseRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AcquireLeaseRequest parseFrom(ByteBuffer data)
```
...
```
public static AcquireLeaseRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<AcquireLeaseRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[AcquireLeaseRequest](/java/docs/reference/google-cloud-visionai/0.10.0/com.google.cloud.visionai.v1.AcquireLeaseRequest)>`
...
```
public AcquireLeaseRequest getDefaultInstanceForType()
```
...
`[LeaseType](/java/docs/reference/google-cloud-visionai/0.10.0/com.google.cloud.visionai.v1.LeaseType)`
...
```
public Parser<AcquireLeaseRequest> getParserForType()
```
...
```
public DurationOrBuilder getTermOrBuilder()
```
...
```
public AcquireLeaseRequest.Builder newBuilderForType()
```
...
```
protected AcquireLeaseRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public AcquireLeaseRequest.Builder toBuilder()
```
