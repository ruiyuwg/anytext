...
# Class GlossaryInputConfig (2.37.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> GlossaryInputConfig

## Implements

[GlossaryInputConfigOrBuilder](/java/docs/reference/google-cloud-translate/2.37.0/com.google.cloud.translate.v3.GlossaryInputConfigOrBuilder)
...
`[GlossaryInputConfig](/java/docs/reference/google-cloud-translate/2.37.0/com.google.cloud.translate.v3.GlossaryInputConfig)`
...
`[GlossaryInputConfig.Builder](/java/docs/reference/google-cloud-translate/2.37.0/com.google.cloud.translate.v3.GlossaryInputConfig.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[GlossaryInputConfig](/java/docs/reference/google-cloud-translate/2.37.0/com.google.cloud.translate.v3.GlossaryInputConfig)>`
...
Required. Google Cloud Storage location of glossary data. File format is determined based on the filename extension. API returns \[google.rpc.Code.INVALID\_ARGUMENT\] for unsupported URI-s and file formats. Wildcards are not allowed. This must be a single file in one of the following formats:
...
`[GcsSource](/java/docs/reference/google-cloud-translate/2.37.0/com.google.cloud.translate.v3.GcsSource)`
...
`[GcsSourceOrBuilder](/java/docs/reference/google-cloud-translate/2.37.0/com.google.cloud.translate.v3.GcsSourceOrBuilder)`
...
`[GlossaryInputConfig.SourceCase](/java/docs/reference/google-cloud-translate/2.37.0/com.google.cloud.translate.v3.GlossaryInputConfig.SourceCase)`
