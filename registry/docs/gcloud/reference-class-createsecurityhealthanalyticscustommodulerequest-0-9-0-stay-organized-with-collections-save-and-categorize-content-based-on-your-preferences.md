...
# Class CreateSecurityHealthAnalyticsCustomModuleRequest (0.9.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class CreateSecurityHealthAnalyticsCustomModuleRequest extends GeneratedMessageV3 implements CreateSecurityHealthAnalyticsCustomModuleRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> CreateSecurityHealthAnalyticsCustomModuleRequest

## Implements

[CreateSecurityHealthAnalyticsCustomModuleRequestOrBuilder](/java/docs/reference/google-cloud-securitycentermanagement/0.9.0/com.google.cloud.securitycentermanagement.v1.CreateSecurityHealthAnalyticsCustomModuleRequestOrBuilder)
...
### SECURITY\_HEALTH\_ANALYTICS\_CUSTOM\_MODULE\_FIELD\_NUMBER

```
public static final int SECURITY_HEALTH_ANALYTICS_CUSTOM_MODULE_FIELD_NUMBER
```
...
```
public static CreateSecurityHealthAnalyticsCustomModuleRequest getDefaultInstance()
```
...
`[CreateSecurityHealthAnalyticsCustomModuleRequest](/java/docs/reference/google-cloud-securitycentermanagement/0.9.0/com.google.cloud.securitycentermanagement.v1.CreateSecurityHealthAnalyticsCustomModuleRequest)`
...
```
public static CreateSecurityHealthAnalyticsCustomModuleRequest.Builder newBuilder()
```
...
`[CreateSecurityHealthAnalyticsCustomModuleRequest.Builder](/java/docs/reference/google-cloud-securitycentermanagement/0.9.0/com.google.cloud.securitycentermanagement.v1.CreateSecurityHealthAnalyticsCustomModuleRequest.Builder)`

### newBuilder(CreateSecurityHealthAnalyticsCustomModuleRequest prototype)

```
public static CreateSecurityHealthAnalyticsCustomModuleRequest.Builder newBuilder(CreateSecurityHealthAnalyticsCustomModuleRequest prototype)
```
...
```
public static CreateSecurityHealthAnalyticsCustomModuleRequest parseDelimitedFrom(InputStream input)
```
...
```
public static CreateSecurityHealthAnalyticsCustomModuleRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateSecurityHealthAnalyticsCustomModuleRequest parseFrom(byte[] data)
```
...
```
public static CreateSecurityHealthAnalyticsCustomModuleRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateSecurityHealthAnalyticsCustomModuleRequest parseFrom(ByteString data)
```
...
```
public static CreateSecurityHealthAnalyticsCustomModuleRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateSecurityHealthAnalyticsCustomModuleRequest parseFrom(CodedInputStream input)
```
...
```
public static CreateSecurityHealthAnalyticsCustomModuleRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateSecurityHealthAnalyticsCustomModuleRequest parseFrom(InputStream input)
```
...
```
public static CreateSecurityHealthAnalyticsCustomModuleRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateSecurityHealthAnalyticsCustomModuleRequest parseFrom(ByteBuffer data)
```
...
```
public static CreateSecurityHealthAnalyticsCustomModuleRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<CreateSecurityHealthAnalyticsCustomModuleRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[CreateSecurityHealthAnalyticsCustomModuleRequest](/java/docs/reference/google-cloud-securitycentermanagement/0.9.0/com.google.cloud.securitycentermanagement.v1.CreateSecurityHealthAnalyticsCustomModuleRequest)>`
...
```
public Parser<CreateSecurityHealthAnalyticsCustomModuleRequest> getParserForType()
```
...
`[SecurityHealthAnalyticsCustomModule](/java/docs/reference/google-cloud-securitycentermanagement/0.9.0/com.google.cloud.securitycentermanagement.v1.SecurityHealthAnalyticsCustomModule)`
...
`[SecurityHealthAnalyticsCustomModuleOrBuilder](/java/docs/reference/google-cloud-securitycentermanagement/0.9.0/com.google.cloud.securitycentermanagement.v1.SecurityHealthAnalyticsCustomModuleOrBuilder)`
...
```
public CreateSecurityHealthAnalyticsCustomModuleRequest.Builder newBuilderForType()
```
...
```
protected CreateSecurityHealthAnalyticsCustomModuleRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public CreateSecurityHealthAnalyticsCustomModuleRequest.Builder toBuilder()
```
