...
# Class DetectLanguageResponse (2.22.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> DetectLanguageResponse

## Implements

[DetectLanguageResponseOrBuilder](/java/docs/reference/google-cloud-translate/2.22.0/com.google.cloud.translate.v3beta1.DetectLanguageResponseOrBuilder)
...
`[DetectLanguageResponse](/java/docs/reference/google-cloud-translate/2.22.0/com.google.cloud.translate.v3beta1.DetectLanguageResponse)`
...
`[DetectLanguageResponse.Builder](/java/docs/reference/google-cloud-translate/2.22.0/com.google.cloud.translate.v3beta1.DetectLanguageResponse.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[DetectLanguageResponse](/java/docs/reference/google-cloud-translate/2.22.0/com.google.cloud.translate.v3beta1.DetectLanguageResponse)>`
...
`[DetectedLanguage](/java/docs/reference/google-cloud-translate/2.22.0/com.google.cloud.translate.v3beta1.DetectedLanguage)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[DetectedLanguage](/java/docs/reference/google-cloud-translate/2.22.0/com.google.cloud.translate.v3beta1.DetectedLanguage)>`
...
`[DetectedLanguageOrBuilder](/java/docs/reference/google-cloud-translate/2.22.0/com.google.cloud.translate.v3beta1.DetectedLanguageOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.translate.v3beta1.DetectedLanguageOrBuilder>`
