...
# Class ControlServiceClient.ListControlsPagedResponse (2.43.0) Stay organized with collections Save and categorize content based on your preferences.
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractPagedListResponse](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractPagedListResponse.html) \> ControlServiceClient.ListControlsPagedResponse
...
`[PageContext](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PageContext.html)<[ListControlsRequest](/java/docs/reference/google-cloud-retail/2.43.0/com.google.cloud.retail.v2alpha.ListControlsRequest),[ListControlsResponse](/java/docs/reference/google-cloud-retail/2.43.0/com.google.cloud.retail.v2alpha.ListControlsResponse),[Control](/java/docs/reference/google-cloud-retail/2.43.0/com.google.cloud.retail.v2alpha.Control)>`  

`futureResponse`

`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListControlsResponse](/java/docs/reference/google-cloud-retail/2.43.0/com.google.cloud.retail.v2alpha.ListControlsResponse)>`  
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListControlsPagedResponse](/java/docs/reference/google-cloud-retail/2.43.0/com.google.cloud.retail.v2alpha.ControlServiceClient.ListControlsPagedResponse)>`
