...
-   [0.18.0 (latest)](/ruby/docs/reference/google-cloud-gke_multi_cloud-v1/latest)
-   [0.17.1](/ruby/docs/reference/google-cloud-gke_multi_cloud-v1/0.17.1)
-   [0.16.0](/ruby/docs/reference/google-cloud-gke_multi_cloud-v1/0.16.0)
-   [0.15.0](/ruby/docs/reference/google-cloud-gke_multi_cloud-v1/0.15.0)
-   [0.14.1](/ruby/docs/reference/google-cloud-gke_multi_cloud-v1/0.14.1)
-   [0.13.0](/ruby/docs/reference/google-cloud-gke_multi_cloud-v1/0.13.0)
-   [0.12.0](/ruby/docs/reference/google-cloud-gke_multi_cloud-v1/0.12.0)
-   [0.11.0](/ruby/docs/reference/google-cloud-gke_multi_cloud-v1/0.11.0)
-   [0.10.1](/ruby/docs/reference/google-cloud-gke_multi_cloud-v1/0.10.1)
-   [0.9.0](/ruby/docs/reference/google-cloud-gke_multi_cloud-v1/0.9.0)
-   [0.8.2](/ruby/docs/reference/google-cloud-gke_multi_cloud-v1/0.8.2)
-   [0.7.0](/ruby/docs/reference/google-cloud-gke_multi_cloud-v1/0.7.0)
-   [0.6.0](/ruby/docs/reference/google-cloud-gke_multi_cloud-v1/0.6.0)
-   [0.5.0](/ruby/docs/reference/google-cloud-gke_multi_cloud-v1/0.5.0)
-   [0.4.0](/ruby/docs/reference/google-cloud-gke_multi_cloud-v1/0.4.0)
-   [0.3.0](/ruby/docs/reference/google-cloud-gke_multi_cloud-v1/0.3.0)
-   [0.2.0](/ruby/docs/reference/google-cloud-gke_multi_cloud-v1/0.2.0)
-   [0.1.0](/ruby/docs/reference/google-cloud-gke_multi_cloud-v1/0.1.0)
...
This gem is a _versioned_ client. It provides basic client classes for a specific version of the Anthos Multi-Cloud V1 API. Most users should consider using the main client gem, [google-cloud-gke\_multi\_cloud](https://rubygems.org/gems/google-cloud-gke_multi_cloud). See the section below titled _Which client should I use?_ for more information.
...
3.  [Enable the API.](https://console.cloud.google.com/apis/library/gkemulticloud.googleapis.com)
4.  [Set up authentication.](https://docs.cloud.google.com/ruby/docs/reference/google-cloud-gke_multi_cloud-v1/latest/AUTHENTICATION "Set up authentication.")

## Quick Start

require "google/cloud/gke\_multi\_cloud/v1"
...
response \= client.create\_attached\_cluster request

View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-gke_multi_cloud-v1/latest) for class and method documentation.

See also the [Product Documentation](https://cloud.google.com/anthos/clusters/docs/multi-cloud) for general usage information.
...
Most modern Ruby client libraries for Google APIs come in two flavors: the main client library with a name such as `google-cloud-gke_multi_cloud`, and lower-level _versioned_ client libraries with names such as `google-cloud-gke_multi_cloud-v1`. _In most cases, you should install the main client._
