...
# Class VerifyNotificationChannelRequest.Builder (3.42.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> VerifyNotificationChannelRequest.Builder

## Implements

[VerifyNotificationChannelRequestOrBuilder](/java/docs/reference/google-cloud-monitoring/3.42.0/com.google.monitoring.v3.VerifyNotificationChannelRequestOrBuilder)
...
```
public VerifyNotificationChannelRequest.Builder addRepeatedField(Descriptors.FieldDescriptor field, Object value)
```
...
`[VerifyNotificationChannelRequest.Builder](/java/docs/reference/google-cloud-monitoring/3.42.0/com.google.monitoring.v3.VerifyNotificationChannelRequest.Builder)`
...
`[VerifyNotificationChannelRequest](/java/docs/reference/google-cloud-monitoring/3.42.0/com.google.monitoring.v3.VerifyNotificationChannelRequest)`
...
```
public VerifyNotificationChannelRequest.Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public VerifyNotificationChannelRequest.Builder setField(Descriptors.FieldDescriptor field, Object value)
```
...
```
public VerifyNotificationChannelRequest.Builder setRepeatedField(Descriptors.FieldDescriptor field, int index, Object value)
```
