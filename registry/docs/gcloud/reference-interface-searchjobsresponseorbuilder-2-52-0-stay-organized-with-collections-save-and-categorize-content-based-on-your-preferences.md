...
# Interface SearchJobsResponseOrBuilder (2.52.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public abstract int getEstimatedTotalSize()
```

An estimation of the number of jobs that match the specified query.

This number isn't guaranteed to be accurate. For accurate results, see SearchJobsResponse.total\_size.
...
`[HistogramQueryResult](/java/docs/reference/google-cloud-talent/2.52.0/com.google.cloud.talent.v4beta1.HistogramQueryResult)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[HistogramQueryResult](/java/docs/reference/google-cloud-talent/2.52.0/com.google.cloud.talent.v4beta1.HistogramQueryResult)>`
...
`[HistogramQueryResultOrBuilder](/java/docs/reference/google-cloud-talent/2.52.0/com.google.cloud.talent.v4beta1.HistogramQueryResultOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.talent.v4beta1.HistogramQueryResultOrBuilder>`
...
`[Location](/java/docs/reference/google-cloud-talent/2.52.0/com.google.cloud.talent.v4beta1.Location)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Location](/java/docs/reference/google-cloud-talent/2.52.0/com.google.cloud.talent.v4beta1.Location)>`
...
`[LocationOrBuilder](/java/docs/reference/google-cloud-talent/2.52.0/com.google.cloud.talent.v4beta1.LocationOrBuilder)`
...
`[SearchJobsResponse.MatchingJob](/java/docs/reference/google-cloud-talent/2.52.0/com.google.cloud.talent.v4beta1.SearchJobsResponse.MatchingJob)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[MatchingJob](/java/docs/reference/google-cloud-talent/2.52.0/com.google.cloud.talent.v4beta1.SearchJobsResponse.MatchingJob)>`
...
`[SearchJobsResponse.MatchingJobOrBuilder](/java/docs/reference/google-cloud-talent/2.52.0/com.google.cloud.talent.v4beta1.SearchJobsResponse.MatchingJobOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.talent.v4beta1.SearchJobsResponse.MatchingJobOrBuilder>`
...
`[ResponseMetadata](/java/docs/reference/google-cloud-talent/2.52.0/com.google.cloud.talent.v4beta1.ResponseMetadata)`
...
`[ResponseMetadataOrBuilder](/java/docs/reference/google-cloud-talent/2.52.0/com.google.cloud.talent.v4beta1.ResponseMetadataOrBuilder)`
...
`[SpellingCorrection](/java/docs/reference/google-cloud-talent/2.52.0/com.google.cloud.talent.v4beta1.SpellingCorrection)`
...
`[SpellingCorrectionOrBuilder](/java/docs/reference/google-cloud-talent/2.52.0/com.google.cloud.talent.v4beta1.SpellingCorrectionOrBuilder)`
