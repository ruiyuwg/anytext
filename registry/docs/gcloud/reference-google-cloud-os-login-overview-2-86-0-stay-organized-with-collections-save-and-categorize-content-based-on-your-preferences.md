...
# google-cloud-os-login overview (2.86.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Cloud OS Login Description:** Manages OS login configuration for Directory API users.

[Cloud OS Login Product Reference](https://cloud.google.com/compute/docs/oslogin/)

[GitHub Repository](https://github.com/googleapis/google-cloud-java/tree/main/java-os-login)

[Maven artifact](https://central.sonatype.com/artifact/com.google.cloud/google-cloud-os-login)
...
-   [Enable the API](https://console.cloud.google.com/apis/library/oslogin.googleapis.com)
-   [Set up authentication](https://cloud.google.com/docs/authentication/client-libraries)

## Use the Cloud OS Login for Java
...
The example below demonstrates how you would import the BOM and include the `google-cloud-os-login` artifact.
...
libraryDependencies += "com.google.cloud" % "google-cloud-os-login" % "2.86.0"

## Which version ID should I get started with?

For this library, we recommend using [com.google.cloud.oslogin.v1](https://cloud.google.com/java/docs/reference/google-cloud-os-login/2.86.0/com.google.cloud.oslogin.v1) for new applications.
