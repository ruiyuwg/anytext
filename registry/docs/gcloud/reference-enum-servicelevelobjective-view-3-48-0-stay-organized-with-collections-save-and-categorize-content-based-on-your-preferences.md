...
# Enum ServiceLevelObjective.View (3.48.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum ServiceLevelObjective.View extends Enum<ServiceLevelObjective.View> implements ProtocolMessageEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-monitoring/3.48.0/com.google.monitoring.v3.ServiceLevelObjective.View#com_google_monitoring_v3_ServiceLevelObjective_View_forNumber_int_) instead._
