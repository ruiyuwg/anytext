...
# Interface AcceleratorConfigOrBuilder (2.16.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[AcceleratorConfig.Type](/java/docs/reference/google-cloud-tpu/2.16.0/com.google.cloud.tpu.v2.AcceleratorConfig.Type)`
