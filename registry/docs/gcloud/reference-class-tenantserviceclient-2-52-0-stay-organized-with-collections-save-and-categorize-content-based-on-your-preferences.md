...
# Class TenantServiceClient (2.52.0) Stay organized with collections Save and categorize content based on your preferences.
...
[GitHub Repository](https://github.com/googleapis/google-cloud-java/tree/main/java-talent/google-cloud-talent/src/main/java/com/google/cloud/talent/v4/TenantServiceClient.java)
...
`[TenantServiceClient](/java/docs/reference/google-cloud-talent/2.52.0/com.google.cloud.talent.v4.TenantServiceClient)`
...
`[TenantServiceSettings](/java/docs/reference/google-cloud-talent/2.52.0/com.google.cloud.talent.v4.TenantServiceSettings)`  
...
`[TenantServiceStub](/java/docs/reference/google-cloud-talent/2.52.0/com.google.cloud.talent.v4.stub.TenantServiceStub)`  
...
`[CreateTenantRequest](/java/docs/reference/google-cloud-talent/2.52.0/com.google.cloud.talent.v4.CreateTenantRequest)`  
...
`[Tenant](/java/docs/reference/google-cloud-talent/2.52.0/com.google.cloud.talent.v4.Tenant)`
...
`[ProjectName](/java/docs/reference/google-cloud-talent/2.52.0/com.google.cloud.talent.v4.ProjectName)`  
...
`[UnaryCallable](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallable.html)<[CreateTenantRequest](/java/docs/reference/google-cloud-talent/2.52.0/com.google.cloud.talent.v4.CreateTenantRequest),[Tenant](/java/docs/reference/google-cloud-talent/2.52.0/com.google.cloud.talent.v4.Tenant)>`
...
`[DeleteTenantRequest](/java/docs/reference/google-cloud-talent/2.52.0/com.google.cloud.talent.v4.DeleteTenantRequest)`  
...
`[TenantName](/java/docs/reference/google-cloud-talent/2.52.0/com.google.cloud.talent.v4.TenantName)`  
...
`[GetTenantRequest](/java/docs/reference/google-cloud-talent/2.52.0/com.google.cloud.talent.v4.GetTenantRequest)`  
...
`[UnaryCallable](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallable.html)<[GetTenantRequest](/java/docs/reference/google-cloud-talent/2.52.0/com.google.cloud.talent.v4.GetTenantRequest),[Tenant](/java/docs/reference/google-cloud-talent/2.52.0/com.google.cloud.talent.v4.Tenant)>`
...
`[ListTenantsRequest](/java/docs/reference/google-cloud-talent/2.52.0/com.google.cloud.talent.v4.ListTenantsRequest)`  
...
`[TenantServiceClient.ListTenantsPagedResponse](/java/docs/reference/google-cloud-talent/2.52.0/com.google.cloud.talent.v4.TenantServiceClient.ListTenantsPagedResponse)`
...
`[UnaryCallable](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallable.html)<[ListTenantsRequest](/java/docs/reference/google-cloud-talent/2.52.0/com.google.cloud.talent.v4.ListTenantsRequest),[ListTenantsResponse](/java/docs/reference/google-cloud-talent/2.52.0/com.google.cloud.talent.v4.ListTenantsResponse)>`
...
`[UnaryCallable](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallable.html)<[ListTenantsRequest](/java/docs/reference/google-cloud-talent/2.52.0/com.google.cloud.talent.v4.ListTenantsRequest),[ListTenantsPagedResponse](/java/docs/reference/google-cloud-talent/2.52.0/com.google.cloud.talent.v4.TenantServiceClient.ListTenantsPagedResponse)>`
...
`[UpdateTenantRequest](/java/docs/reference/google-cloud-talent/2.52.0/com.google.cloud.talent.v4.UpdateTenantRequest)`  
...
`[UnaryCallable](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallable.html)<[UpdateTenantRequest](/java/docs/reference/google-cloud-talent/2.52.0/com.google.cloud.talent.v4.UpdateTenantRequest),[Tenant](/java/docs/reference/google-cloud-talent/2.52.0/com.google.cloud.talent.v4.Tenant)>`
