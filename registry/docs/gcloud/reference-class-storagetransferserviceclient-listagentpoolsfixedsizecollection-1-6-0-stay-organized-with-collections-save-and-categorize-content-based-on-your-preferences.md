...
# Class StorageTransferServiceClient.ListAgentPoolsFixedSizeCollection (1.6.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ListAgentPoolsPage](/java/docs/reference/google-cloud-storage-transfer/1.6.0/com.google.storagetransfer.v1.proto.StorageTransferServiceClient.ListAgentPoolsPage)>`  
...
[StorageTransferServiceClient.ListAgentPoolsFixedSizeCollection](/java/docs/reference/google-cloud-storage-transfer/1.6.0/com.google.storagetransfer.v1.proto.StorageTransferServiceClient.ListAgentPoolsFixedSizeCollection)
