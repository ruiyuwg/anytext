...
# Class CloudShellServiceGrpc.CloudShellServiceImplBase (2.18.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public abstract static class CloudShellServiceGrpc.CloudShellServiceImplBase implements BindableService, CloudShellServiceGrpc.AsyncService
```
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> CloudShellServiceGrpc.CloudShellServiceImplBase

## Implements

io.grpc.BindableService, [CloudShellServiceGrpc.AsyncService](/java/docs/reference/google-cloud-shell/2.18.0/com.google.cloud.shell.v1.CloudShellServiceGrpc.AsyncService)
