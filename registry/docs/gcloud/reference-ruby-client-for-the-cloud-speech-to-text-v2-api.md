...
-   [1.5.0 (latest)](/ruby/docs/reference/google-cloud-speech-v2/latest)
-   [1.4.1](/ruby/docs/reference/google-cloud-speech-v2/1.4.1)
-   [1.3.0](/ruby/docs/reference/google-cloud-speech-v2/1.3.0)
-   [1.2.1](/ruby/docs/reference/google-cloud-speech-v2/1.2.1)
-   [1.1.0](/ruby/docs/reference/google-cloud-speech-v2/1.1.0)
-   [1.0.1](/ruby/docs/reference/google-cloud-speech-v2/1.0.1)
-   [0.16.0](/ruby/docs/reference/google-cloud-speech-v2/0.16.0)
-   [0.15.0](/ruby/docs/reference/google-cloud-speech-v2/0.15.0)
-   [0.14.0](/ruby/docs/reference/google-cloud-speech-v2/0.14.0)
-   [0.13.1](/ruby/docs/reference/google-cloud-speech-v2/0.13.1)
-   [0.12.0](/ruby/docs/reference/google-cloud-speech-v2/0.12.0)
-   [0.11.0](/ruby/docs/reference/google-cloud-speech-v2/0.11.0)
-   [0.10.0](/ruby/docs/reference/google-cloud-speech-v2/0.10.0)
-   [0.9.2](/ruby/docs/reference/google-cloud-speech-v2/0.9.2)
-   [0.8.0](/ruby/docs/reference/google-cloud-speech-v2/0.8.0)
-   [0.7.0](/ruby/docs/reference/google-cloud-speech-v2/0.7.0)
-   [0.6.0](/ruby/docs/reference/google-cloud-speech-v2/0.6.0)
-   [0.5.1](/ruby/docs/reference/google-cloud-speech-v2/0.5.1)
-   [0.4.0](/ruby/docs/reference/google-cloud-speech-v2/0.4.0)
-   [0.3.0](/ruby/docs/reference/google-cloud-speech-v2/0.3.0)
-   [0.2.0](/ruby/docs/reference/google-cloud-speech-v2/0.2.0)
-   [0.1.0](/ruby/docs/reference/google-cloud-speech-v2/0.1.0)
...
This gem is a _versioned_ client. It provides basic client classes for a specific version of the Cloud Speech-to-Text V2 API. Most users should consider using the main client gem, [google-cloud-speech](https://rubygems.org/gems/google-cloud-speech). See the section below titled _Which client should I use?_ for more information.
...
3.  [Enable the API.](https://console.cloud.google.com/apis/library/speech.googleapis.com)
4.  [Set up authentication.](https://docs.cloud.google.com/ruby/docs/reference/google-cloud-speech-v2/latest/AUTHENTICATION "Set up authentication.")
...
response \= client.create\_recognizer request

View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-speech-v2/latest) for class and method documentation.

See also the [Product Documentation](https://cloud.google.com/speech-to-text) for general usage information.
...
Most modern Ruby client libraries for Google APIs come in two flavors: the main client library with a name such as `google-cloud-speech`, and lower-level _versioned_ client libraries with names such as `google-cloud-speech-v2`. _In most cases, you should install the main client._
...
You can use a versioned client if you are content with a possibly lower-level class interface, you explicitly want to avoid features provided by the main client, or you want to access a specific service version not be covered by the main client. You can identify versioned client gems because the service version is part of the name, e.g. `google-cloud-speech-v2`.
