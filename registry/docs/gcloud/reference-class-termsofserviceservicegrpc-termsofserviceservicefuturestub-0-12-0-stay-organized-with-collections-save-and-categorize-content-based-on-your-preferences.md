...
# Class TermsOfServiceServiceGrpc.TermsOfServiceServiceFutureStub (0.12.0) Stay organized with collections Save and categorize content based on your preferences.
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> io.grpc.stub.AbstractStub \> io.grpc.stub.AbstractFutureStub \> TermsOfServiceServiceGrpc.TermsOfServiceServiceFutureStub
...
`[AcceptTermsOfServiceRequest](/java/docs/reference/google-shopping-merchant-accounts/0.12.0/com.google.shopping.merchant.accounts.v1beta.AcceptTermsOfServiceRequest)`  
...
`[TermsOfServiceServiceGrpc.TermsOfServiceServiceFutureStub](/java/docs/reference/google-shopping-merchant-accounts/0.12.0/com.google.shopping.merchant.accounts.v1beta.TermsOfServiceServiceGrpc.TermsOfServiceServiceFutureStub)`
...
`[GetTermsOfServiceRequest](/java/docs/reference/google-shopping-merchant-accounts/0.12.0/com.google.shopping.merchant.accounts.v1beta.GetTermsOfServiceRequest)`  
...
`com.google.common.util.concurrent.ListenableFuture<[TermsOfService](/java/docs/reference/google-shopping-merchant-accounts/0.12.0/com.google.shopping.merchant.accounts.v1beta.TermsOfService)>`
...
`[RetrieveLatestTermsOfServiceRequest](/java/docs/reference/google-shopping-merchant-accounts/0.12.0/com.google.shopping.merchant.accounts.v1beta.RetrieveLatestTermsOfServiceRequest)`  
