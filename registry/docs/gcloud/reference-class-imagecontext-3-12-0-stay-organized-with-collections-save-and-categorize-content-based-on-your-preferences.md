...
# Class ImageContext (3.12.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ImageContext

## Implements

[ImageContextOrBuilder](/java/docs/reference/google-cloud-vision/3.12.0/com.google.cloud.vision.v1p4beta1.ImageContextOrBuilder)
...
### CROP\_HINTS\_PARAMS\_FIELD\_NUMBER
...
### FACE\_RECOGNITION\_PARAMS\_FIELD\_NUMBER
...
### LAT\_LONG\_RECT\_FIELD\_NUMBER
...
### PRODUCT\_SEARCH\_PARAMS\_FIELD\_NUMBER
...
### TEXT\_DETECTION\_PARAMS\_FIELD\_NUMBER
...
### WEB\_DETECTION\_PARAMS\_FIELD\_NUMBER
...
`[ImageContext](/java/docs/reference/google-cloud-vision/3.12.0/com.google.cloud.vision.v1p4beta1.ImageContext)`
...
`[ImageContext.Builder](/java/docs/reference/google-cloud-vision/3.12.0/com.google.cloud.vision.v1p4beta1.ImageContext.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ImageContext](/java/docs/reference/google-cloud-vision/3.12.0/com.google.cloud.vision.v1p4beta1.ImageContext)>`
...
`[CropHintsParams](/java/docs/reference/google-cloud-vision/3.12.0/com.google.cloud.vision.v1p4beta1.CropHintsParams)`
...
`[CropHintsParamsOrBuilder](/java/docs/reference/google-cloud-vision/3.12.0/com.google.cloud.vision.v1p4beta1.CropHintsParamsOrBuilder)`
...
`[FaceRecognitionParams](/java/docs/reference/google-cloud-vision/3.12.0/com.google.cloud.vision.v1p4beta1.FaceRecognitionParams)`
...
`[FaceRecognitionParamsOrBuilder](/java/docs/reference/google-cloud-vision/3.12.0/com.google.cloud.vision.v1p4beta1.FaceRecognitionParamsOrBuilder)`
...
`[LatLongRect](/java/docs/reference/google-cloud-vision/3.12.0/com.google.cloud.vision.v1p4beta1.LatLongRect)`
...
`[LatLongRectOrBuilder](/java/docs/reference/google-cloud-vision/3.12.0/com.google.cloud.vision.v1p4beta1.LatLongRectOrBuilder)`
...
`[ProductSearchParams](/java/docs/reference/google-cloud-vision/3.12.0/com.google.cloud.vision.v1p4beta1.ProductSearchParams)`
...
`[ProductSearchParamsOrBuilder](/java/docs/reference/google-cloud-vision/3.12.0/com.google.cloud.vision.v1p4beta1.ProductSearchParamsOrBuilder)`
...
`[TextDetectionParams](/java/docs/reference/google-cloud-vision/3.12.0/com.google.cloud.vision.v1p4beta1.TextDetectionParams)`
...
`[TextDetectionParamsOrBuilder](/java/docs/reference/google-cloud-vision/3.12.0/com.google.cloud.vision.v1p4beta1.TextDetectionParamsOrBuilder)`
...
`[WebDetectionParams](/java/docs/reference/google-cloud-vision/3.12.0/com.google.cloud.vision.v1p4beta1.WebDetectionParams)`
...
`[WebDetectionParamsOrBuilder](/java/docs/reference/google-cloud-vision/3.12.0/com.google.cloud.vision.v1p4beta1.WebDetectionParamsOrBuilder)`
