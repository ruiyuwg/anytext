...
# Class Experiment.Result.VersionMetrics (0.98.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class Experiment.Result.VersionMetrics extends GeneratedMessage implements Experiment.Result.VersionMetricsOrBuilder
```

Version variant and associated metrics.

Protobuf type `google.cloud.dialogflow.cx.v3beta1.Experiment.Result.VersionMetrics`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessage.html) \> Experiment.Result.VersionMetrics

## Implements

[Experiment.Result.VersionMetricsOrBuilder](/java/docs/reference/google-cloud-dialogflow-cx/latest/com.google.cloud.dialogflow.cx.v3beta1.Experiment.Result.VersionMetricsOrBuilder)
...
```
public static Experiment.Result.VersionMetrics getDefaultInstance()
```
...
`[Experiment.Result.VersionMetrics](/java/docs/reference/google-cloud-dialogflow-cx/latest/com.google.cloud.dialogflow.cx.v3beta1.Experiment.Result.VersionMetrics)`
...
```
public static Experiment.Result.VersionMetrics.Builder newBuilder()
```
...
`[Experiment.Result.VersionMetrics.Builder](/java/docs/reference/google-cloud-dialogflow-cx/latest/com.google.cloud.dialogflow.cx.v3beta1.Experiment.Result.VersionMetrics.Builder)`

### newBuilder(Experiment.Result.VersionMetrics prototype)

```
public static Experiment.Result.VersionMetrics.Builder newBuilder(Experiment.Result.VersionMetrics prototype)
```
...
```
public static Experiment.Result.VersionMetrics parseDelimitedFrom(InputStream input)
```
...
```
public static Experiment.Result.VersionMetrics parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Experiment.Result.VersionMetrics parseFrom(byte[] data)
```
...
```
public static Experiment.Result.VersionMetrics parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Experiment.Result.VersionMetrics parseFrom(ByteString data)
```
...
```
public static Experiment.Result.VersionMetrics parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Experiment.Result.VersionMetrics parseFrom(CodedInputStream input)
```
...
```
public static Experiment.Result.VersionMetrics parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Experiment.Result.VersionMetrics parseFrom(InputStream input)
```
...
```
public static Experiment.Result.VersionMetrics parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Experiment.Result.VersionMetrics parseFrom(ByteBuffer data)
```
...
```
public static Experiment.Result.VersionMetrics parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<Experiment.Result.VersionMetrics> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[VersionMetrics](/java/docs/reference/google-cloud-dialogflow-cx/latest/com.google.cloud.dialogflow.cx.v3beta1.Experiment.Result.VersionMetrics)>`
...
`[Experiment.Result.Metric](/java/docs/reference/google-cloud-dialogflow-cx/latest/com.google.cloud.dialogflow.cx.v3beta1.Experiment.Result.Metric)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Metric](/java/docs/reference/google-cloud-dialogflow-cx/latest/com.google.cloud.dialogflow.cx.v3beta1.Experiment.Result.Metric)>`
...
`[Experiment.Result.MetricOrBuilder](/java/docs/reference/google-cloud-dialogflow-cx/latest/com.google.cloud.dialogflow.cx.v3beta1.Experiment.Result.MetricOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.dialogflow.cx.v3beta1.Experiment.Result.MetricOrBuilder>`

### getParserForType()

```
public Parser<Experiment.Result.VersionMetrics> getParserForType()
```
...
```
public Experiment.Result.VersionMetrics.Builder newBuilderForType()
```
...
```
protected Experiment.Result.VersionMetrics.Builder newBuilderForType(AbstractMessage.BuilderParent parent)
```
...
```
public Experiment.Result.VersionMetrics.Builder toBuilder()
```
