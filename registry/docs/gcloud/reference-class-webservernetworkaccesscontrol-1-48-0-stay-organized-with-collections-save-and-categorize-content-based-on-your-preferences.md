...
# Class WebServerNetworkAccessControl (1.48.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class WebServerNetworkAccessControl extends GeneratedMessageV3 implements WebServerNetworkAccessControlOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> WebServerNetworkAccessControl

## Implements

[WebServerNetworkAccessControlOrBuilder](/java/docs/reference/google-cloud-orchestration-airflow/1.48.0/com.google.cloud.orchestration.airflow.service.v1.WebServerNetworkAccessControlOrBuilder)
...
### ALLOWED\_IP\_RANGES\_FIELD\_NUMBER

```
public static final int ALLOWED_IP_RANGES_FIELD_NUMBER
```
...
```
public static WebServerNetworkAccessControl getDefaultInstance()
```
...
`[WebServerNetworkAccessControl](/java/docs/reference/google-cloud-orchestration-airflow/1.48.0/com.google.cloud.orchestration.airflow.service.v1.WebServerNetworkAccessControl)`
...
```
public static WebServerNetworkAccessControl.Builder newBuilder()
```
...
`[WebServerNetworkAccessControl.Builder](/java/docs/reference/google-cloud-orchestration-airflow/1.48.0/com.google.cloud.orchestration.airflow.service.v1.WebServerNetworkAccessControl.Builder)`

### newBuilder(WebServerNetworkAccessControl prototype)

```
public static WebServerNetworkAccessControl.Builder newBuilder(WebServerNetworkAccessControl prototype)
```
...
```
public static WebServerNetworkAccessControl parseDelimitedFrom(InputStream input)
```
...
```
public static WebServerNetworkAccessControl parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static WebServerNetworkAccessControl parseFrom(byte[] data)
```
...
```
public static WebServerNetworkAccessControl parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static WebServerNetworkAccessControl parseFrom(ByteString data)
```
...
```
public static WebServerNetworkAccessControl parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static WebServerNetworkAccessControl parseFrom(CodedInputStream input)
```
...
```
public static WebServerNetworkAccessControl parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static WebServerNetworkAccessControl parseFrom(InputStream input)
```
...
```
public static WebServerNetworkAccessControl parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static WebServerNetworkAccessControl parseFrom(ByteBuffer data)
```
...
```
public static WebServerNetworkAccessControl parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<WebServerNetworkAccessControl> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[WebServerNetworkAccessControl](/java/docs/reference/google-cloud-orchestration-airflow/1.48.0/com.google.cloud.orchestration.airflow.service.v1.WebServerNetworkAccessControl)>`
...
```
public WebServerNetworkAccessControl.AllowedIpRange getAllowedIpRanges(int index)
```
...
`[WebServerNetworkAccessControl.AllowedIpRange](/java/docs/reference/google-cloud-orchestration-airflow/1.48.0/com.google.cloud.orchestration.airflow.service.v1.WebServerNetworkAccessControl.AllowedIpRange)`

### getAllowedIpRangesCount()
...
```
public List<WebServerNetworkAccessControl.AllowedIpRange> getAllowedIpRangesList()
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[AllowedIpRange](/java/docs/reference/google-cloud-orchestration-airflow/1.48.0/com.google.cloud.orchestration.airflow.service.v1.WebServerNetworkAccessControl.AllowedIpRange)>`

### getAllowedIpRangesOrBuilder(int index)

```
public WebServerNetworkAccessControl.AllowedIpRangeOrBuilder getAllowedIpRangesOrBuilder(int index)
```
...
`[WebServerNetworkAccessControl.AllowedIpRangeOrBuilder](/java/docs/reference/google-cloud-orchestration-airflow/1.48.0/com.google.cloud.orchestration.airflow.service.v1.WebServerNetworkAccessControl.AllowedIpRangeOrBuilder)`

### getAllowedIpRangesOrBuilderList()

```
public List<? extends WebServerNetworkAccessControl.AllowedIpRangeOrBuilder> getAllowedIpRangesOrBuilderList()
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.orchestration.airflow.service.v1.WebServerNetworkAccessControl.AllowedIpRangeOrBuilder>`

### getDefaultInstanceForType()

```
public WebServerNetworkAccessControl getDefaultInstanceForType()
```
...
```
public Parser<WebServerNetworkAccessControl> getParserForType()
```
...
```
public WebServerNetworkAccessControl.Builder newBuilderForType()
```
...
```
protected WebServerNetworkAccessControl.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public WebServerNetworkAccessControl.Builder toBuilder()
```
