...
# Class QueuedResourceState.FailedData (2.53.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class QueuedResourceState.FailedData extends GeneratedMessageV3 implements QueuedResourceState.FailedDataOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> QueuedResourceState.FailedData

## Implements

[QueuedResourceState.FailedDataOrBuilder](/java/docs/reference/google-cloud-tpu/2.53.0/com.google.cloud.tpu.v2alpha1.QueuedResourceState.FailedDataOrBuilder)
...
```
public static QueuedResourceState.FailedData getDefaultInstance()
```
...
`[QueuedResourceState.FailedData](/java/docs/reference/google-cloud-tpu/2.53.0/com.google.cloud.tpu.v2alpha1.QueuedResourceState.FailedData)`
...
```
public static QueuedResourceState.FailedData.Builder newBuilder()
```
...
`[QueuedResourceState.FailedData.Builder](/java/docs/reference/google-cloud-tpu/2.53.0/com.google.cloud.tpu.v2alpha1.QueuedResourceState.FailedData.Builder)`

### newBuilder(QueuedResourceState.FailedData prototype)

```
public static QueuedResourceState.FailedData.Builder newBuilder(QueuedResourceState.FailedData prototype)
```
...
```
public static QueuedResourceState.FailedData parseDelimitedFrom(InputStream input)
```
...
```
public static QueuedResourceState.FailedData parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static QueuedResourceState.FailedData parseFrom(byte[] data)
```
...
```
public static QueuedResourceState.FailedData parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static QueuedResourceState.FailedData parseFrom(ByteString data)
```
...
```
public static QueuedResourceState.FailedData parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static QueuedResourceState.FailedData parseFrom(CodedInputStream input)
```
...
```
public static QueuedResourceState.FailedData parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static QueuedResourceState.FailedData parseFrom(InputStream input)
```
...
```
public static QueuedResourceState.FailedData parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static QueuedResourceState.FailedData parseFrom(ByteBuffer data)
```
...
```
public static QueuedResourceState.FailedData parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<QueuedResourceState.FailedData> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[FailedData](/java/docs/reference/google-cloud-tpu/2.53.0/com.google.cloud.tpu.v2alpha1.QueuedResourceState.FailedData)>`
...
```
public Parser<QueuedResourceState.FailedData> getParserForType()
```
...
```
public QueuedResourceState.FailedData.Builder newBuilderForType()
```
...
```
protected QueuedResourceState.FailedData.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public QueuedResourceState.FailedData.Builder toBuilder()
```
