...
# google-cloud-domains overview (1.84.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Cloud Domains Description:** Allows you to register and manage domains by using Cloud Domains.

[Cloud Domains Product Reference](https://cloud.google.com/domains)

[GitHub Repository](https://github.com/googleapis/google-cloud-java/tree/main/java-domains)

[Maven artifact](https://central.sonatype.com/artifact/com.google.cloud/google-cloud-domains)
...
## Use the Cloud Domains for Java
...
The example below demonstrates how you would import the BOM and include the `google-cloud-domains` artifact.
...
implementation("com.google.cloud:google-cloud-domains")
...
libraryDependencies += "com.google.cloud" % "google-cloud-domains" % "1.84.0"

## Which version ID should I get started with?

For this library, we recommend using [com.google.cloud.domains.v1](https://cloud.google.com/java/docs/reference/google-cloud-domains/1.84.0/com.google.cloud.domains.v1) for new applications.
