...
# Class RemoveGroupMigrationRequest (1.31.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class RemoveGroupMigrationRequest extends GeneratedMessageV3 implements RemoveGroupMigrationRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> RemoveGroupMigrationRequest

## Implements

[RemoveGroupMigrationRequestOrBuilder](/java/docs/reference/google-cloud-vmmigration/1.31.0/com.google.cloud.vmmigration.v1.RemoveGroupMigrationRequestOrBuilder)
...
### MIGRATING\_VM\_FIELD\_NUMBER

```
public static final int MIGRATING_VM_FIELD_NUMBER
```
...
```
public static RemoveGroupMigrationRequest getDefaultInstance()
```
...
`[RemoveGroupMigrationRequest](/java/docs/reference/google-cloud-vmmigration/1.31.0/com.google.cloud.vmmigration.v1.RemoveGroupMigrationRequest)`
...
```
public static RemoveGroupMigrationRequest.Builder newBuilder()
```
...
`[RemoveGroupMigrationRequest.Builder](/java/docs/reference/google-cloud-vmmigration/1.31.0/com.google.cloud.vmmigration.v1.RemoveGroupMigrationRequest.Builder)`

### newBuilder(RemoveGroupMigrationRequest prototype)

```
public static RemoveGroupMigrationRequest.Builder newBuilder(RemoveGroupMigrationRequest prototype)
```
...
```
public static RemoveGroupMigrationRequest parseDelimitedFrom(InputStream input)
```
...
```
public static RemoveGroupMigrationRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RemoveGroupMigrationRequest parseFrom(byte[] data)
```
...
```
public static RemoveGroupMigrationRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RemoveGroupMigrationRequest parseFrom(ByteString data)
```
...
```
public static RemoveGroupMigrationRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RemoveGroupMigrationRequest parseFrom(CodedInputStream input)
```
...
```
public static RemoveGroupMigrationRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RemoveGroupMigrationRequest parseFrom(InputStream input)
```
...
```
public static RemoveGroupMigrationRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RemoveGroupMigrationRequest parseFrom(ByteBuffer data)
```
...
```
public static RemoveGroupMigrationRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<RemoveGroupMigrationRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[RemoveGroupMigrationRequest](/java/docs/reference/google-cloud-vmmigration/1.31.0/com.google.cloud.vmmigration.v1.RemoveGroupMigrationRequest)>`
...
```
public Parser<RemoveGroupMigrationRequest> getParserForType()
```
...
```
public RemoveGroupMigrationRequest.Builder newBuilderForType()
```
...
```
protected RemoveGroupMigrationRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public RemoveGroupMigrationRequest.Builder toBuilder()
```
