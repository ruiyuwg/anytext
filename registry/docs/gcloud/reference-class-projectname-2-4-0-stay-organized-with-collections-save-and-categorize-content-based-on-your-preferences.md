...
# Class ProjectName (2.4.0) Stay organized with collections Save and categorize content based on your preferences.
...
### format(String user, String project)
...
[ProjectName.Builder](/java/docs/reference/google-cloud-os-login/2.4.0/com.google.cloud.oslogin.common.ProjectName.Builder)

### of(String user, String project)
...
[ProjectName](/java/docs/reference/google-cloud-os-login/2.4.0/com.google.cloud.oslogin.common.ProjectName)
...
[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ProjectName](/java/docs/reference/google-cloud-os-login/2.4.0/com.google.cloud.oslogin.common.ProjectName)\>
