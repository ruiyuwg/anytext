...
# Class DeleteAzureClientRequest (0.51.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class DeleteAzureClientRequest extends GeneratedMessageV3 implements DeleteAzureClientRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> DeleteAzureClientRequest

## Implements

[DeleteAzureClientRequestOrBuilder](/java/docs/reference/google-cloud-gke-multi-cloud/0.51.0/com.google.cloud.gkemulticloud.v1.DeleteAzureClientRequestOrBuilder)
...
```
public static DeleteAzureClientRequest getDefaultInstance()
```
...
`[DeleteAzureClientRequest](/java/docs/reference/google-cloud-gke-multi-cloud/0.51.0/com.google.cloud.gkemulticloud.v1.DeleteAzureClientRequest)`
...
```
public static DeleteAzureClientRequest.Builder newBuilder()
```
...
`[DeleteAzureClientRequest.Builder](/java/docs/reference/google-cloud-gke-multi-cloud/0.51.0/com.google.cloud.gkemulticloud.v1.DeleteAzureClientRequest.Builder)`

### newBuilder(DeleteAzureClientRequest prototype)

```
public static DeleteAzureClientRequest.Builder newBuilder(DeleteAzureClientRequest prototype)
```
...
```
public static DeleteAzureClientRequest parseDelimitedFrom(InputStream input)
```
...
```
public static DeleteAzureClientRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteAzureClientRequest parseFrom(byte[] data)
```
...
```
public static DeleteAzureClientRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteAzureClientRequest parseFrom(ByteString data)
```
...
```
public static DeleteAzureClientRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteAzureClientRequest parseFrom(CodedInputStream input)
```
...
```
public static DeleteAzureClientRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteAzureClientRequest parseFrom(InputStream input)
```
...
```
public static DeleteAzureClientRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteAzureClientRequest parseFrom(ByteBuffer data)
```
...
```
public static DeleteAzureClientRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<DeleteAzureClientRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[DeleteAzureClientRequest](/java/docs/reference/google-cloud-gke-multi-cloud/0.51.0/com.google.cloud.gkemulticloud.v1.DeleteAzureClientRequest)>`
...
```
public Parser<DeleteAzureClientRequest> getParserForType()
```
...
```
public DeleteAzureClientRequest.Builder newBuilderForType()
```
...
```
protected DeleteAzureClientRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public DeleteAzureClientRequest.Builder toBuilder()
```
