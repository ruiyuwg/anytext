...
# Class CreateCollectorRequest (0.1.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class CreateCollectorRequest extends GeneratedMessageV3 implements CreateCollectorRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> CreateCollectorRequest

## Implements

[CreateCollectorRequestOrBuilder](/java/docs/reference/google-cloud-rapidmigrationassessment/0.1.0/com.google.cloud.rapidmigrationassessment.v1.CreateCollectorRequestOrBuilder)
...
### COLLECTOR\_ID\_FIELD\_NUMBER

```
public static final int COLLECTOR_ID_FIELD_NUMBER
```
...
```
public static CreateCollectorRequest getDefaultInstance()
```
...
`[CreateCollectorRequest](/java/docs/reference/google-cloud-rapidmigrationassessment/0.1.0/com.google.cloud.rapidmigrationassessment.v1.CreateCollectorRequest)`
...
```
public static CreateCollectorRequest.Builder newBuilder()
```
...
`[CreateCollectorRequest.Builder](/java/docs/reference/google-cloud-rapidmigrationassessment/0.1.0/com.google.cloud.rapidmigrationassessment.v1.CreateCollectorRequest.Builder)`

### newBuilder(CreateCollectorRequest prototype)

```
public static CreateCollectorRequest.Builder newBuilder(CreateCollectorRequest prototype)
```
...
```
public static CreateCollectorRequest parseDelimitedFrom(InputStream input)
```
...
```
public static CreateCollectorRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateCollectorRequest parseFrom(byte[] data)
```
...
```
public static CreateCollectorRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateCollectorRequest parseFrom(ByteString data)
```
...
```
public static CreateCollectorRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateCollectorRequest parseFrom(CodedInputStream input)
```
...
```
public static CreateCollectorRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateCollectorRequest parseFrom(InputStream input)
```
...
```
public static CreateCollectorRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateCollectorRequest parseFrom(ByteBuffer data)
```
...
```
public static CreateCollectorRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<CreateCollectorRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[CreateCollectorRequest](/java/docs/reference/google-cloud-rapidmigrationassessment/0.1.0/com.google.cloud.rapidmigrationassessment.v1.CreateCollectorRequest)>`
...
`[Collector](/java/docs/reference/google-cloud-rapidmigrationassessment/0.1.0/com.google.cloud.rapidmigrationassessment.v1.Collector)`
...
```
public ByteString getCollectorIdBytes()
```
...
`[CollectorOrBuilder](/java/docs/reference/google-cloud-rapidmigrationassessment/0.1.0/com.google.cloud.rapidmigrationassessment.v1.CollectorOrBuilder)`

### getDefaultInstanceForType()

```
public CreateCollectorRequest getDefaultInstanceForType()
```
...
```
public Parser<CreateCollectorRequest> getParserForType()
```
...
```
public CreateCollectorRequest.Builder newBuilderForType()
```
...
```
protected CreateCollectorRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public CreateCollectorRequest.Builder toBuilder()
```
