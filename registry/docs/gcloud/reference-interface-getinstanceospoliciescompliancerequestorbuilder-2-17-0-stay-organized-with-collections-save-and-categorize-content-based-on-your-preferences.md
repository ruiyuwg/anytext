...
# Interface GetInstanceOSPoliciesComplianceRequestOrBuilder (2.17.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface GetInstanceOSPoliciesComplianceRequestOrBuilder extends MessageOrBuilder
```
