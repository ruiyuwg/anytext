...
# Class Instance.HostConfig (0.15.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class Instance.HostConfig extends GeneratedMessageV3 implements Instance.HostConfigOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> Instance.HostConfig

## Implements

[Instance.HostConfigOrBuilder](/java/docs/reference/google-cloud-securesourcemanager/0.15.0/com.google.cloud.securesourcemanager.v1.Instance.HostConfigOrBuilder)
...
### GIT\_HTTP\_FIELD\_NUMBER

```
public static final int GIT_HTTP_FIELD_NUMBER
```
...
### GIT\_SSH\_FIELD\_NUMBER

```
public static final int GIT_SSH_FIELD_NUMBER
```
...
```
public static Instance.HostConfig getDefaultInstance()
```
...
`[Instance.HostConfig](/java/docs/reference/google-cloud-securesourcemanager/0.15.0/com.google.cloud.securesourcemanager.v1.Instance.HostConfig)`
...
```
public static Instance.HostConfig.Builder newBuilder()
```
...
`[Instance.HostConfig.Builder](/java/docs/reference/google-cloud-securesourcemanager/0.15.0/com.google.cloud.securesourcemanager.v1.Instance.HostConfig.Builder)`

### newBuilder(Instance.HostConfig prototype)

```
public static Instance.HostConfig.Builder newBuilder(Instance.HostConfig prototype)
```
...
```
public static Instance.HostConfig parseDelimitedFrom(InputStream input)
```
...
```
public static Instance.HostConfig parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Instance.HostConfig parseFrom(byte[] data)
```
...
```
public static Instance.HostConfig parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Instance.HostConfig parseFrom(ByteString data)
```
...
```
public static Instance.HostConfig parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Instance.HostConfig parseFrom(CodedInputStream input)
```
...
```
public static Instance.HostConfig parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Instance.HostConfig parseFrom(InputStream input)
```
...
```
public static Instance.HostConfig parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Instance.HostConfig parseFrom(ByteBuffer data)
```
...
```
public static Instance.HostConfig parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<Instance.HostConfig> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[HostConfig](/java/docs/reference/google-cloud-securesourcemanager/0.15.0/com.google.cloud.securesourcemanager.v1.Instance.HostConfig)>`
...
```
public Instance.HostConfig getDefaultInstanceForType()
```
...
```
public Parser<Instance.HostConfig> getParserForType()
```
...
```
public Instance.HostConfig.Builder newBuilderForType()
```
...
```
protected Instance.HostConfig.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public Instance.HostConfig.Builder toBuilder()
```
