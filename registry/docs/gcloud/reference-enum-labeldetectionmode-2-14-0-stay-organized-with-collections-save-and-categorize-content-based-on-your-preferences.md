...
# Enum LabelDetectionMode (2.14.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum LabelDetectionMode extends Enum<LabelDetectionMode> implements ProtocolMessageEnum
```

Label detection mode.

Protobuf enum `google.cloud.videointelligence.v1p3beta1.LabelDetectionMode`
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-video-intelligence/2.14.0/com.google.cloud.videointelligence.v1p3beta1.LabelDetectionMode#com_google_cloud_videointelligence_v1p3beta1_LabelDetectionMode_forNumber_int_) instead._
