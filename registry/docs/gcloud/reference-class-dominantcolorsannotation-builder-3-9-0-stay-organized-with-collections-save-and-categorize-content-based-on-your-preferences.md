...
# Class DominantColorsAnnotation.Builder (3.9.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> DominantColorsAnnotation.Builder

## Implements

[DominantColorsAnnotationOrBuilder](/java/docs/reference/google-cloud-vision/3.9.0/com.google.cloud.vision.v1p4beta1.DominantColorsAnnotationOrBuilder)
...
`[Iterable](https://docs.oracle.com/javase/8/docs/api/java/lang/Iterable.html)<? extends com.google.cloud.vision.v1p4beta1.ColorInfo>`  
...
`[DominantColorsAnnotation.Builder](/java/docs/reference/google-cloud-vision/3.9.0/com.google.cloud.vision.v1p4beta1.DominantColorsAnnotation.Builder)`
...
`[ColorInfo](/java/docs/reference/google-cloud-vision/3.9.0/com.google.cloud.vision.v1p4beta1.ColorInfo)`  
...
`[ColorInfo.Builder](/java/docs/reference/google-cloud-vision/3.9.0/com.google.cloud.vision.v1p4beta1.ColorInfo.Builder)`  
...
`[DominantColorsAnnotation](/java/docs/reference/google-cloud-vision/3.9.0/com.google.cloud.vision.v1p4beta1.DominantColorsAnnotation)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Builder](/java/docs/reference/google-cloud-vision/3.9.0/com.google.cloud.vision.v1p4beta1.ColorInfo.Builder)>`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ColorInfo](/java/docs/reference/google-cloud-vision/3.9.0/com.google.cloud.vision.v1p4beta1.ColorInfo)>`
...
`[ColorInfoOrBuilder](/java/docs/reference/google-cloud-vision/3.9.0/com.google.cloud.vision.v1p4beta1.ColorInfoOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.vision.v1p4beta1.ColorInfoOrBuilder>`
