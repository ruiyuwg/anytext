...
# Interface SetMuteRequestOrBuilder (2.49.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface SetMuteRequestOrBuilder extends MessageOrBuilder
```
...
`[Finding.Mute](/java/docs/reference/google-cloud-securitycenter/2.49.0/com.google.cloud.securitycenter.v2.Finding.Mute)`
...
Required. The [relative resource name](https://cloud.google.com/apis/design/resource_names#relative_resource_name) of the finding. If no location is specified, finding is assumed to be in global. The following list shows some examples:
