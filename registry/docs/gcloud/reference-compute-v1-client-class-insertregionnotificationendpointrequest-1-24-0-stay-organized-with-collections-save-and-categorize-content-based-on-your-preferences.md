...
# Compute V1 Client - Class InsertRegionNotificationEndpointRequest (1.24.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[NotificationEndpoint](/php/docs/reference/cloud-compute/1.24.0/V1.NotificationEndpoint)`  
...
`[NotificationEndpoint](/php/docs/reference/cloud-compute/1.24.0/V1.NotificationEndpoint)|null`
...
`[InsertRegionNotificationEndpointRequest](/php/docs/reference/cloud-compute/1.24.0/V1.InsertRegionNotificationEndpointRequest)`
