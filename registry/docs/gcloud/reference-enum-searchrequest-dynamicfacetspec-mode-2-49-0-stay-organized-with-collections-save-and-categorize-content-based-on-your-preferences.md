...
# Enum SearchRequest.DynamicFacetSpec.Mode (2.49.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum SearchRequest.DynamicFacetSpec.Mode extends Enum<SearchRequest.DynamicFacetSpec.Mode> implements ProtocolMessageEnum
```

Enum to control DynamicFacet mode

Protobuf enum `google.cloud.retail.v2alpha.SearchRequest.DynamicFacetSpec.Mode`
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-retail/2.49.0/com.google.cloud.retail.v2alpha.SearchRequest.DynamicFacetSpec.Mode#com_google_cloud_retail_v2alpha_SearchRequest_DynamicFacetSpec_Mode_forNumber_int_) instead._
