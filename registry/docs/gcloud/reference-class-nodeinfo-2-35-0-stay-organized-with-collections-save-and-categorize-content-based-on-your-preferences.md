...
# Class NodeInfo (2.35.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[NodeInfo](/java/docs/reference/google-cloud-redis/2.35.0/com.google.cloud.redis.v1beta1.NodeInfo)`
...
```
public static NodeInfo.Builder newBuilder()
```
...
`[NodeInfo.Builder](/java/docs/reference/google-cloud-redis/2.35.0/com.google.cloud.redis.v1beta1.NodeInfo.Builder)`

### newBuilder(NodeInfo prototype)

```
public static NodeInfo.Builder newBuilder(NodeInfo prototype)
```
...
```
public static NodeInfo parseDelimitedFrom(InputStream input)
```
...
```
public static NodeInfo parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static NodeInfo parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static NodeInfo parseFrom(ByteString data)
```
...
```
public static NodeInfo parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static NodeInfo parseFrom(CodedInputStream input)
```
...
```
public static NodeInfo parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static NodeInfo parseFrom(InputStream input)
```
...
```
public static NodeInfo parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static NodeInfo parseFrom(ByteBuffer data)
```
...
```
public static NodeInfo parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[NodeInfo](/java/docs/reference/google-cloud-redis/2.35.0/com.google.cloud.redis.v1beta1.NodeInfo)>`
...
```
public NodeInfo.Builder newBuilderForType()
```
...
```
protected NodeInfo.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
