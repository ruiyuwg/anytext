...
# Class RangeInfo (0.28.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class RangeInfo extends GeneratedMessage implements RangeInfoOrBuilder
```

Half-open range interval \[start, end)

Protobuf type `google.cloud.modelarmor.v1beta.RangeInfo`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessage.html) \> RangeInfo

## Implements

[RangeInfoOrBuilder](/java/docs/reference/google-cloud-modelarmor/latest/com.google.cloud.modelarmor.v1beta.RangeInfoOrBuilder)
...
`[RangeInfo](/java/docs/reference/google-cloud-modelarmor/latest/com.google.cloud.modelarmor.v1beta.RangeInfo)`
...
```
public static RangeInfo.Builder newBuilder()
```
...
`[RangeInfo.Builder](/java/docs/reference/google-cloud-modelarmor/latest/com.google.cloud.modelarmor.v1beta.RangeInfo.Builder)`

### newBuilder(RangeInfo prototype)

```
public static RangeInfo.Builder newBuilder(RangeInfo prototype)
```
...
```
public static RangeInfo parseDelimitedFrom(InputStream input)
```
...
```
public static RangeInfo parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RangeInfo parseFrom(byte[] data)
```
...
```
public static RangeInfo parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RangeInfo parseFrom(ByteString data)
```
...
```
public static RangeInfo parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RangeInfo parseFrom(CodedInputStream input)
```
...
```
public static RangeInfo parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RangeInfo parseFrom(InputStream input)
```
...
```
public static RangeInfo parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RangeInfo parseFrom(ByteBuffer data)
```
...
```
public static RangeInfo parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<RangeInfo> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[RangeInfo](/java/docs/reference/google-cloud-modelarmor/latest/com.google.cloud.modelarmor.v1beta.RangeInfo)>`
...
```
public Parser<RangeInfo> getParserForType()
```
...
For proto3, value cannot be set to 0 unless the field is optional. Ref: [https://protobuf.dev/programming-guides/proto3/#default](https://protobuf.dev/programming-guides/proto3/#default) Index of first character (inclusive).
...
```
public RangeInfo.Builder newBuilderForType()
```
...
```
protected RangeInfo.Builder newBuilderForType(AbstractMessage.BuilderParent parent)
```
...
```
public RangeInfo.Builder toBuilder()
```
