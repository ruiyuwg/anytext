...
# Interface CreateAssessmentRequestOrBuilder (3.12.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface CreateAssessmentRequestOrBuilder extends MessageOrBuilder
```
...
`[Assessment](/java/docs/reference/google-cloud-recaptchaenterprise/3.12.0/com.google.recaptchaenterprise.v1beta1.Assessment)`
...
```
public abstract AssessmentOrBuilder getAssessmentOrBuilder()
```
...
`[AssessmentOrBuilder](/java/docs/reference/google-cloud-recaptchaenterprise/3.12.0/com.google.recaptchaenterprise.v1beta1.AssessmentOrBuilder)`
...
Required. The name of the project in which the assessment will be created, in the format "projects/{project\_number}".
