...
# Interface DiagnoseInstanceRequestOrBuilder (1.25.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface DiagnoseInstanceRequestOrBuilder extends MessageOrBuilder
```
...
`[DiagnosticConfig](/java/docs/reference/google-cloud-notebooks/1.25.0/com.google.cloud.notebooks.v1.DiagnosticConfig)`
...
`[DiagnosticConfigOrBuilder](/java/docs/reference/google-cloud-notebooks/1.25.0/com.google.cloud.notebooks.v1.DiagnosticConfigOrBuilder)`
