...
# Class BatchTranslateDocumentRequest.Builder (2.40.0) Stay organized with collections Save and categorize content based on your preferences.
...
[BatchTranslateDocumentRequestOrBuilder](/java/docs/reference/google-cloud-translate/2.40.0/com.google.cloud.translate.v3beta1.BatchTranslateDocumentRequestOrBuilder)
...
`[BatchTranslateDocumentRequest.Builder](/java/docs/reference/google-cloud-translate/2.40.0/com.google.cloud.translate.v3beta1.BatchTranslateDocumentRequest.Builder)`
...
`[BatchDocumentInputConfig](/java/docs/reference/google-cloud-translate/2.40.0/com.google.cloud.translate.v3beta1.BatchDocumentInputConfig)`  
...
`[BatchDocumentInputConfig.Builder](/java/docs/reference/google-cloud-translate/2.40.0/com.google.cloud.translate.v3beta1.BatchDocumentInputConfig.Builder)`  
...
`[BatchTranslateDocumentRequest](/java/docs/reference/google-cloud-translate/2.40.0/com.google.cloud.translate.v3beta1.BatchTranslateDocumentRequest)`
...
Use [#getFormatConversionsMap()](/java/docs/reference/google-cloud-translate/2.40.0/com.google.cloud.translate.v3beta1.BatchTranslateDocumentRequest.Builder#com_google_cloud_translate_v3beta1_BatchTranslateDocumentRequest_Builder_getFormatConversionsMap__) instead.
...
Use [#getGlossariesMap()](/java/docs/reference/google-cloud-translate/2.40.0/com.google.cloud.translate.v3beta1.BatchTranslateDocumentRequest.Builder#com_google_cloud_translate_v3beta1_BatchTranslateDocumentRequest_Builder_getGlossariesMap__) instead.
...
`[Map](https://docs.oracle.com/javase/8/docs/api/java/util/Map.html)<[String](https://docs.oracle.com/javase/8/docs/api/java/lang/String.html),[TranslateTextGlossaryConfig](/java/docs/reference/google-cloud-translate/2.40.0/com.google.cloud.translate.v3beta1.TranslateTextGlossaryConfig)>`
...
`[TranslateTextGlossaryConfig](/java/docs/reference/google-cloud-translate/2.40.0/com.google.cloud.translate.v3beta1.TranslateTextGlossaryConfig)`  
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Builder](/java/docs/reference/google-cloud-translate/2.40.0/com.google.cloud.translate.v3beta1.BatchDocumentInputConfig.Builder)>`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[BatchDocumentInputConfig](/java/docs/reference/google-cloud-translate/2.40.0/com.google.cloud.translate.v3beta1.BatchDocumentInputConfig)>`
...
`[BatchDocumentInputConfigOrBuilder](/java/docs/reference/google-cloud-translate/2.40.0/com.google.cloud.translate.v3beta1.BatchDocumentInputConfigOrBuilder)`
...
Use [#getModelsMap()](/java/docs/reference/google-cloud-translate/2.40.0/com.google.cloud.translate.v3beta1.BatchTranslateDocumentRequest.Builder#com_google_cloud_translate_v3beta1_BatchTranslateDocumentRequest_Builder_getModelsMap__) instead.
...
`[BatchDocumentOutputConfig](/java/docs/reference/google-cloud-translate/2.40.0/com.google.cloud.translate.v3beta1.BatchDocumentOutputConfig)`
...
`[BatchDocumentOutputConfig.Builder](/java/docs/reference/google-cloud-translate/2.40.0/com.google.cloud.translate.v3beta1.BatchDocumentOutputConfig.Builder)`
...
`[BatchDocumentOutputConfigOrBuilder](/java/docs/reference/google-cloud-translate/2.40.0/com.google.cloud.translate.v3beta1.BatchDocumentOutputConfigOrBuilder)`
...
`[TranslateTextGlossaryConfig.Builder](/java/docs/reference/google-cloud-translate/2.40.0/com.google.cloud.translate.v3beta1.TranslateTextGlossaryConfig.Builder)`
