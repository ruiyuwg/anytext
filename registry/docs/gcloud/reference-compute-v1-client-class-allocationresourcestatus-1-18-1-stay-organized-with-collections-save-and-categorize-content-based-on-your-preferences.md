...
# Compute V1 Client - Class AllocationResourceStatus (1.18.1) Stay organized with collections Save and categorize content based on your preferences.
...
`[Google\Cloud\Compute\V1\AllocationResourceStatusSpecificSKUAllocation](/php/docs/reference/cloud-compute/1.18.1/V1.AllocationResourceStatusSpecificSKUAllocation)`  
...
`[Google\Cloud\Compute\V1\AllocationResourceStatusSpecificSKUAllocation](/php/docs/reference/cloud-compute/1.18.1/V1.AllocationResourceStatusSpecificSKUAllocation)|null`
