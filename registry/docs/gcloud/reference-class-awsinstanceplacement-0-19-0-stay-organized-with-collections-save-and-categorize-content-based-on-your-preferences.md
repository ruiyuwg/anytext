...
# Class AwsInstancePlacement (0.19.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class AwsInstancePlacement extends GeneratedMessageV3 implements AwsInstancePlacementOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> AwsInstancePlacement

## Implements

[AwsInstancePlacementOrBuilder](/java/docs/reference/google-cloud-gke-multi-cloud/0.19.0/com.google.cloud.gkemulticloud.v1.AwsInstancePlacementOrBuilder)
...
### TENANCY\_FIELD\_NUMBER

```
public static final int TENANCY_FIELD_NUMBER
```
...
```
public static AwsInstancePlacement getDefaultInstance()
```
...
`[AwsInstancePlacement](/java/docs/reference/google-cloud-gke-multi-cloud/0.19.0/com.google.cloud.gkemulticloud.v1.AwsInstancePlacement)`
...
```
public static AwsInstancePlacement.Builder newBuilder()
```
...
`[AwsInstancePlacement.Builder](/java/docs/reference/google-cloud-gke-multi-cloud/0.19.0/com.google.cloud.gkemulticloud.v1.AwsInstancePlacement.Builder)`

### newBuilder(AwsInstancePlacement prototype)

```
public static AwsInstancePlacement.Builder newBuilder(AwsInstancePlacement prototype)
```
...
```
public static AwsInstancePlacement parseDelimitedFrom(InputStream input)
```
...
```
public static AwsInstancePlacement parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AwsInstancePlacement parseFrom(byte[] data)
```
...
```
public static AwsInstancePlacement parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AwsInstancePlacement parseFrom(ByteString data)
```
...
```
public static AwsInstancePlacement parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AwsInstancePlacement parseFrom(CodedInputStream input)
```
...
```
public static AwsInstancePlacement parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AwsInstancePlacement parseFrom(InputStream input)
```
...
```
public static AwsInstancePlacement parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AwsInstancePlacement parseFrom(ByteBuffer data)
```
...
```
public static AwsInstancePlacement parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<AwsInstancePlacement> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[AwsInstancePlacement](/java/docs/reference/google-cloud-gke-multi-cloud/0.19.0/com.google.cloud.gkemulticloud.v1.AwsInstancePlacement)>`
...
```
public Parser<AwsInstancePlacement> getParserForType()
```
...
`[AwsInstancePlacement.Tenancy](/java/docs/reference/google-cloud-gke-multi-cloud/0.19.0/com.google.cloud.gkemulticloud.v1.AwsInstancePlacement.Tenancy)`
...
```
public AwsInstancePlacement.Builder newBuilderForType()
```
...
```
protected AwsInstancePlacement.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public AwsInstancePlacement.Builder toBuilder()
```
