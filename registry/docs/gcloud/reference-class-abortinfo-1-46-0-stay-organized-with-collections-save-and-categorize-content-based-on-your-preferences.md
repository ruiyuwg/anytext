...
# Class AbortInfo (1.46.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> AbortInfo

## Implements

[AbortInfoOrBuilder](/java/docs/reference/google-cloud-network-management/1.46.0/com.google.cloud.networkmanagement.v1.AbortInfoOrBuilder)
...
### PROJECTS\_MISSING\_PERMISSION\_FIELD\_NUMBER

```
public static final int PROJECTS_MISSING_PERMISSION_FIELD_NUMBER
```
...
`[AbortInfo](/java/docs/reference/google-cloud-network-management/1.46.0/com.google.cloud.networkmanagement.v1.AbortInfo)`
...
```
public static AbortInfo.Builder newBuilder()
```
...
`[AbortInfo.Builder](/java/docs/reference/google-cloud-network-management/1.46.0/com.google.cloud.networkmanagement.v1.AbortInfo.Builder)`

### newBuilder(AbortInfo prototype)

```
public static AbortInfo.Builder newBuilder(AbortInfo prototype)
```
...
```
public static AbortInfo parseDelimitedFrom(InputStream input)
```
...
```
public static AbortInfo parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AbortInfo parseFrom(byte[] data)
```
...
```
public static AbortInfo parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AbortInfo parseFrom(ByteString data)
```
...
```
public static AbortInfo parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AbortInfo parseFrom(CodedInputStream input)
```
...
```
public static AbortInfo parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AbortInfo parseFrom(InputStream input)
```
...
```
public static AbortInfo parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AbortInfo parseFrom(ByteBuffer data)
```
...
```
public static AbortInfo parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[AbortInfo](/java/docs/reference/google-cloud-network-management/1.46.0/com.google.cloud.networkmanagement.v1.AbortInfo)>`
...
`[AbortInfo.Cause](/java/docs/reference/google-cloud-network-management/1.46.0/com.google.cloud.networkmanagement.v1.AbortInfo.Cause)`
...
List of project IDs the user specified in the request but lacks access to. In this case, analysis is aborted with the PERMISSION\_DENIED cause.
...
```
public AbortInfo.Builder newBuilderForType()
```
...
```
protected AbortInfo.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public AbortInfo.Builder toBuilder()
```
