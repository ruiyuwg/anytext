...
# Class ListPacketMirroringsRequest (1.95.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListPacketMirroringsRequest extends GeneratedMessage implements ListPacketMirroringsRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessage.html) \> ListPacketMirroringsRequest

## Implements

[ListPacketMirroringsRequestOrBuilder](/java/docs/reference/google-cloud-compute/latest/com.google.cloud.compute.v1.ListPacketMirroringsRequestOrBuilder)
...
### RETURN\_PARTIAL\_SUCCESS\_FIELD\_NUMBER
...
```
public static ListPacketMirroringsRequest getDefaultInstance()
```
...
`[ListPacketMirroringsRequest](/java/docs/reference/google-cloud-compute/latest/com.google.cloud.compute.v1.ListPacketMirroringsRequest)`
...
```
public static ListPacketMirroringsRequest.Builder newBuilder()
```
...
`[ListPacketMirroringsRequest.Builder](/java/docs/reference/google-cloud-compute/latest/com.google.cloud.compute.v1.ListPacketMirroringsRequest.Builder)`

### newBuilder(ListPacketMirroringsRequest prototype)

```
public static ListPacketMirroringsRequest.Builder newBuilder(ListPacketMirroringsRequest prototype)
```
...
```
public static ListPacketMirroringsRequest parseDelimitedFrom(InputStream input)
```
...
```
public static ListPacketMirroringsRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListPacketMirroringsRequest parseFrom(byte[] data)
```
...
```
public static ListPacketMirroringsRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListPacketMirroringsRequest parseFrom(ByteString data)
```
...
```
public static ListPacketMirroringsRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListPacketMirroringsRequest parseFrom(CodedInputStream input)
```
...
```
public static ListPacketMirroringsRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListPacketMirroringsRequest parseFrom(InputStream input)
```
...
```
public static ListPacketMirroringsRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListPacketMirroringsRequest parseFrom(ByteBuffer data)
```
...
```
public static ListPacketMirroringsRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ListPacketMirroringsRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListPacketMirroringsRequest](/java/docs/reference/google-cloud-compute/latest/com.google.cloud.compute.v1.ListPacketMirroringsRequest)>`
...
```
public ListPacketMirroringsRequest getDefaultInstanceForType()
```
...
```
public Parser<ListPacketMirroringsRequest> getParserForType()
```
...
```
public ListPacketMirroringsRequest.Builder newBuilderForType()
```
...
```
protected ListPacketMirroringsRequest.Builder newBuilderForType(AbstractMessage.BuilderParent parent)
```
...
```
public ListPacketMirroringsRequest.Builder toBuilder()
```
