...
# Enum RecognitionConfig.AudioEncoding (4.52.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-speech/4.52.0/com.google.cloud.speech.v1p1beta1.RecognitionConfig.AudioEncoding#com_google_cloud_speech_v1p1beta1_RecognitionConfig_AudioEncoding_forNumber_int_) instead._
