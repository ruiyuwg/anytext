...
# Class SearchUrisResponse.ThreatUri (2.34.0) Stay organized with collections Save and categorize content based on your preferences.
...
[SearchUrisResponse.ThreatUriOrBuilder](/java/docs/reference/google-cloud-webrisk/2.34.0/com.google.webrisk.v1.SearchUrisResponse.ThreatUriOrBuilder)
...
`[SearchUrisResponse.ThreatUri](/java/docs/reference/google-cloud-webrisk/2.34.0/com.google.webrisk.v1.SearchUrisResponse.ThreatUri)`
...
`[SearchUrisResponse.ThreatUri.Builder](/java/docs/reference/google-cloud-webrisk/2.34.0/com.google.webrisk.v1.SearchUrisResponse.ThreatUri.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ThreatUri](/java/docs/reference/google-cloud-webrisk/2.34.0/com.google.webrisk.v1.SearchUrisResponse.ThreatUri)>`
...
`[ThreatType](/java/docs/reference/google-cloud-webrisk/2.34.0/com.google.webrisk.v1.ThreatType)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ThreatType](/java/docs/reference/google-cloud-webrisk/2.34.0/com.google.webrisk.v1.ThreatType)>`
