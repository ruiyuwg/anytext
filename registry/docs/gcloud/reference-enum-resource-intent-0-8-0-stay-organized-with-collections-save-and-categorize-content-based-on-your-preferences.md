...
# Enum Resource.Intent (0.8.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-infra-manager/0.8.0/com.google.cloud.config.v1.Resource.Intent#com_google_cloud_config_v1_Resource_Intent_forNumber_int_) instead._
