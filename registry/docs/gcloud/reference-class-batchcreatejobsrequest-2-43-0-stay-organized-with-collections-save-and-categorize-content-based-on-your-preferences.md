...
# Class BatchCreateJobsRequest (2.43.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class BatchCreateJobsRequest extends GeneratedMessageV3 implements BatchCreateJobsRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> BatchCreateJobsRequest

## Implements

[BatchCreateJobsRequestOrBuilder](/java/docs/reference/google-cloud-talent/2.43.0/com.google.cloud.talent.v4beta1.BatchCreateJobsRequestOrBuilder)
...
```
public static BatchCreateJobsRequest getDefaultInstance()
```
...
`[BatchCreateJobsRequest](/java/docs/reference/google-cloud-talent/2.43.0/com.google.cloud.talent.v4beta1.BatchCreateJobsRequest)`
...
```
public static BatchCreateJobsRequest.Builder newBuilder()
```
...
`[BatchCreateJobsRequest.Builder](/java/docs/reference/google-cloud-talent/2.43.0/com.google.cloud.talent.v4beta1.BatchCreateJobsRequest.Builder)`

### newBuilder(BatchCreateJobsRequest prototype)

```
public static BatchCreateJobsRequest.Builder newBuilder(BatchCreateJobsRequest prototype)
```
...
```
public static BatchCreateJobsRequest parseDelimitedFrom(InputStream input)
```
...
```
public static BatchCreateJobsRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static BatchCreateJobsRequest parseFrom(byte[] data)
```
...
```
public static BatchCreateJobsRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static BatchCreateJobsRequest parseFrom(ByteString data)
```
...
```
public static BatchCreateJobsRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static BatchCreateJobsRequest parseFrom(CodedInputStream input)
```
...
```
public static BatchCreateJobsRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static BatchCreateJobsRequest parseFrom(InputStream input)
```
...
```
public static BatchCreateJobsRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static BatchCreateJobsRequest parseFrom(ByteBuffer data)
```
...
```
public static BatchCreateJobsRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<BatchCreateJobsRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[BatchCreateJobsRequest](/java/docs/reference/google-cloud-talent/2.43.0/com.google.cloud.talent.v4beta1.BatchCreateJobsRequest)>`
...
`[Job](/java/docs/reference/google-cloud-talent/2.43.0/com.google.cloud.talent.v4beta1.Job)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Job](/java/docs/reference/google-cloud-talent/2.43.0/com.google.cloud.talent.v4beta1.Job)>`
...
`[JobOrBuilder](/java/docs/reference/google-cloud-talent/2.43.0/com.google.cloud.talent.v4beta1.JobOrBuilder)`
...
```
public Parser<BatchCreateJobsRequest> getParserForType()
```
...
```
public BatchCreateJobsRequest.Builder newBuilderForType()
```
...
```
protected BatchCreateJobsRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public BatchCreateJobsRequest.Builder toBuilder()
```
