...
# Class StreamingRecognitionResult (4.37.0) Stay organized with collections Save and categorize content based on your preferences.
...
[StreamingRecognitionResultOrBuilder](/java/docs/reference/google-cloud-speech/4.37.0/com.google.cloud.speech.v1p1beta1.StreamingRecognitionResultOrBuilder)
...
### RESULT\_END\_TIME\_FIELD\_NUMBER

```
public static final int RESULT_END_TIME_FIELD_NUMBER
```
...
`[StreamingRecognitionResult](/java/docs/reference/google-cloud-speech/4.37.0/com.google.cloud.speech.v1p1beta1.StreamingRecognitionResult)`
...
`[StreamingRecognitionResult.Builder](/java/docs/reference/google-cloud-speech/4.37.0/com.google.cloud.speech.v1p1beta1.StreamingRecognitionResult.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[StreamingRecognitionResult](/java/docs/reference/google-cloud-speech/4.37.0/com.google.cloud.speech.v1p1beta1.StreamingRecognitionResult)>`
...
`[SpeechRecognitionAlternative](/java/docs/reference/google-cloud-speech/4.37.0/com.google.cloud.speech.v1p1beta1.SpeechRecognitionAlternative)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[SpeechRecognitionAlternative](/java/docs/reference/google-cloud-speech/4.37.0/com.google.cloud.speech.v1p1beta1.SpeechRecognitionAlternative)>`
...
`[SpeechRecognitionAlternativeOrBuilder](/java/docs/reference/google-cloud-speech/4.37.0/com.google.cloud.speech.v1p1beta1.SpeechRecognitionAlternativeOrBuilder)`
