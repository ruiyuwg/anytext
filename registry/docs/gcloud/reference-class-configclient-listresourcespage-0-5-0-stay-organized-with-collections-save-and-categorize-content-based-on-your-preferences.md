...
# Class ConfigClient.ListResourcesPage (0.5.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class ConfigClient.ListResourcesPage extends AbstractPage<ListResourcesRequest,ListResourcesResponse,Resource,ConfigClient.ListResourcesPage>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractPage](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractPage.html) \> ConfigClient.ListResourcesPage
...
### createPage(PageContext<ListResourcesRequest,ListResourcesResponse,Resource> context, ListResourcesResponse response)

```
protected ConfigClient.ListResourcesPage createPage(PageContext<ListResourcesRequest,ListResourcesResponse,Resource> context, ListResourcesResponse response)
```
...
`[PageContext](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PageContext.html)<[ListResourcesRequest](/java/docs/reference/google-cloud-infra-manager/0.5.0/com.google.cloud.config.v1.ListResourcesRequest),[ListResourcesResponse](/java/docs/reference/google-cloud-infra-manager/0.5.0/com.google.cloud.config.v1.ListResourcesResponse),[Resource](/java/docs/reference/google-cloud-infra-manager/0.5.0/com.google.cloud.config.v1.Resource)>`  

`response`

`[ListResourcesResponse](/java/docs/reference/google-cloud-infra-manager/0.5.0/com.google.cloud.config.v1.ListResourcesResponse)`  
...
`[ConfigClient.ListResourcesPage](/java/docs/reference/google-cloud-infra-manager/0.5.0/com.google.cloud.config.v1.ConfigClient.ListResourcesPage)`
...
### createPageAsync(PageContext<ListResourcesRequest,ListResourcesResponse,Resource> context, ApiFuture<ListResourcesResponse> futureResponse)

```
public ApiFuture<ConfigClient.ListResourcesPage> createPageAsync(PageContext<ListResourcesRequest,ListResourcesResponse,Resource> context, ApiFuture<ListResourcesResponse> futureResponse)
```
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListResourcesResponse](/java/docs/reference/google-cloud-infra-manager/0.5.0/com.google.cloud.config.v1.ListResourcesResponse)>`  
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListResourcesPage](/java/docs/reference/google-cloud-infra-manager/0.5.0/com.google.cloud.config.v1.ConfigClient.ListResourcesPage)>`
