...
# Class DeleteGlossaryMetadata.Builder (2.47.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> DeleteGlossaryMetadata.Builder

## Implements

[DeleteGlossaryMetadataOrBuilder](/java/docs/reference/google-cloud-translate/2.47.0/com.google.cloud.translate.v3.DeleteGlossaryMetadataOrBuilder)
...
`[DeleteGlossaryMetadata.Builder](/java/docs/reference/google-cloud-translate/2.47.0/com.google.cloud.translate.v3.DeleteGlossaryMetadata.Builder)`
...
`[DeleteGlossaryMetadata](/java/docs/reference/google-cloud-translate/2.47.0/com.google.cloud.translate.v3.DeleteGlossaryMetadata)`
...
`[DeleteGlossaryMetadata.State](/java/docs/reference/google-cloud-translate/2.47.0/com.google.cloud.translate.v3.DeleteGlossaryMetadata.State)`
...
```
public final DeleteGlossaryMetadata.Builder mergeUnknownFields(UnknownFieldSet unknownFields)
```
...
```
public DeleteGlossaryMetadata.Builder setField(Descriptors.FieldDescriptor field, Object value)
```
...
```
public DeleteGlossaryMetadata.Builder setRepeatedField(Descriptors.FieldDescriptor field, int index, Object value)
```
...
```
public final DeleteGlossaryMetadata.Builder setUnknownFields(UnknownFieldSet unknownFields)
```
