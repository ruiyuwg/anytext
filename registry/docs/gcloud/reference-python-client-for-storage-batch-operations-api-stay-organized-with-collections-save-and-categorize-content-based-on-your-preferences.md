...
# Python Client for Storage Batch Operations API Stay organized with collections Save and categorize content based on your preferences.

Version latestkeyboard\_arrow\_down

-   [0.4.0 (latest)](/python/docs/reference/google-cloud-storagebatchoperations/latest)
-   [0.3.0](/python/docs/reference/google-cloud-storagebatchoperations/0.3.0)
-   [0.2.0](/python/docs/reference/google-cloud-storagebatchoperations/0.2.0)
-   [0.1.3](/python/docs/reference/google-cloud-storagebatchoperations/0.1.3)

[![image](https://img.shields.io/badge/support-preview-orange.svg)](https://github.com/googleapis/google-cloud-python/blob/main/README.rst#stability-levels) [![image](https://img.shields.io/pypi/v/google-cloud-storagebatchoperations.svg)](https://pypi.org/project/google-cloud-storagebatchoperations/) [![image](https://img.shields.io/pypi/pyversions/google-cloud-storagebatchoperations.svg)](https://pypi.org/project/google-cloud-storagebatchoperations/)

[Storage Batch Operations API](https://cloud.google.com/storage/docs/batch-operations/overview): null

-   [Client Library Documentation](https://cloud.google.com/python/docs/reference/google-cloud-storagebatchoperations/latest/summary_overview)
    
-   [Product Documentation](https://cloud.google.com/storage/docs/batch-operations/overview)
...
3.  [Enable the Storage Batch Operations API.](https://cloud.google.com/storage/docs/batch-operations/overview)
...
Code samples and snippets live in the [samples/](https://github.com/googleapis/google-cloud-python/tree/main/packages/google-cloud-storagebatchoperations/samples) folder.
...
-   Read the [Client Library Documentation](https://cloud.google.com/python/docs/reference/google-cloud-storagebatchoperations/latest/summary_overview) for Storage Batch Operations API to see other available methods on the client.
    
-   Read the [Storage Batch Operations API Product documentation](https://cloud.google.com/storage/docs/batch-operations/overview) to learn more about the product and see How-to Guides.
