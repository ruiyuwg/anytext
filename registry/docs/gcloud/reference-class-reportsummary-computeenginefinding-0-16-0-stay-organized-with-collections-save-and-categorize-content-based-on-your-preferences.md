...
# Class ReportSummary.ComputeEngineFinding (0.16.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class ReportSummary.ComputeEngineFinding extends GeneratedMessageV3 implements ReportSummary.ComputeEngineFindingOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ReportSummary.ComputeEngineFinding

## Implements

[ReportSummary.ComputeEngineFindingOrBuilder](/java/docs/reference/google-cloud-migrationcenter/0.16.0/com.google.cloud.migrationcenter.v1.ReportSummary.ComputeEngineFindingOrBuilder)
...
### ALLOCATED\_ASSET\_COUNT\_FIELD\_NUMBER
...
### ALLOCATED\_DISK\_TYPES\_FIELD\_NUMBER

```
public static final int ALLOCATED_DISK_TYPES_FIELD_NUMBER
```
...
### ALLOCATED\_REGIONS\_FIELD\_NUMBER
...
### MACHINE\_SERIES\_ALLOCATIONS\_FIELD\_NUMBER

```
public static final int MACHINE_SERIES_ALLOCATIONS_FIELD_NUMBER
```
...
```
public static ReportSummary.ComputeEngineFinding getDefaultInstance()
```
...
`[ReportSummary.ComputeEngineFinding](/java/docs/reference/google-cloud-migrationcenter/0.16.0/com.google.cloud.migrationcenter.v1.ReportSummary.ComputeEngineFinding)`
...
```
public static ReportSummary.ComputeEngineFinding.Builder newBuilder()
```
...
`[ReportSummary.ComputeEngineFinding.Builder](/java/docs/reference/google-cloud-migrationcenter/0.16.0/com.google.cloud.migrationcenter.v1.ReportSummary.ComputeEngineFinding.Builder)`

### newBuilder(ReportSummary.ComputeEngineFinding prototype)

```
public static ReportSummary.ComputeEngineFinding.Builder newBuilder(ReportSummary.ComputeEngineFinding prototype)
```
...
```
public static ReportSummary.ComputeEngineFinding parseDelimitedFrom(InputStream input)
```
...
```
public static ReportSummary.ComputeEngineFinding parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ReportSummary.ComputeEngineFinding parseFrom(byte[] data)
```
...
```
public static ReportSummary.ComputeEngineFinding parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ReportSummary.ComputeEngineFinding parseFrom(ByteString data)
```
...
```
public static ReportSummary.ComputeEngineFinding parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ReportSummary.ComputeEngineFinding parseFrom(CodedInputStream input)
```
...
```
public static ReportSummary.ComputeEngineFinding parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ReportSummary.ComputeEngineFinding parseFrom(InputStream input)
```
...
```
public static ReportSummary.ComputeEngineFinding parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ReportSummary.ComputeEngineFinding parseFrom(ByteBuffer data)
```
...
```
public static ReportSummary.ComputeEngineFinding parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ReportSummary.ComputeEngineFinding> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ComputeEngineFinding](/java/docs/reference/google-cloud-migrationcenter/0.16.0/com.google.cloud.migrationcenter.v1.ReportSummary.ComputeEngineFinding)>`
...
`[PersistentDiskType](/java/docs/reference/google-cloud-migrationcenter/0.16.0/com.google.cloud.migrationcenter.v1.PersistentDiskType)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[PersistentDiskType](/java/docs/reference/google-cloud-migrationcenter/0.16.0/com.google.cloud.migrationcenter.v1.PersistentDiskType)>`
...
`[ReportSummary.MachineSeriesAllocation](/java/docs/reference/google-cloud-migrationcenter/0.16.0/com.google.cloud.migrationcenter.v1.ReportSummary.MachineSeriesAllocation)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[MachineSeriesAllocation](/java/docs/reference/google-cloud-migrationcenter/0.16.0/com.google.cloud.migrationcenter.v1.ReportSummary.MachineSeriesAllocation)>`
...
`[ReportSummary.MachineSeriesAllocationOrBuilder](/java/docs/reference/google-cloud-migrationcenter/0.16.0/com.google.cloud.migrationcenter.v1.ReportSummary.MachineSeriesAllocationOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.migrationcenter.v1.ReportSummary.MachineSeriesAllocationOrBuilder>`

### getParserForType()

```
public Parser<ReportSummary.ComputeEngineFinding> getParserForType()
```
...
```
public ReportSummary.ComputeEngineFinding.Builder newBuilderForType()
```
...
```
protected ReportSummary.ComputeEngineFinding.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ReportSummary.ComputeEngineFinding.Builder toBuilder()
```
