...
# Enum AccountIssue.Severity (0.14.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum AccountIssue.Severity extends Enum<AccountIssue.Severity> implements ProtocolMessageEnum
```

All possible issue severities.

Protobuf enum `google.shopping.merchant.accounts.v1beta.AccountIssue.Severity`
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-shopping-merchant-accounts/0.14.0/com.google.shopping.merchant.accounts.v1beta.AccountIssue.Severity#com_google_shopping_merchant_accounts_v1beta_AccountIssue_Severity_forNumber_int_) instead._
