...
# Class QueryResult.Builder (6.57.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> QueryResult.Builder

## Implements

[QueryResultOrBuilder](/java/docs/reference/google-cloud-spanner/6.57.0/com.google.spanner.executor.v1.QueryResultOrBuilder)
...
```
public QueryResult.Builder addAllRow(Iterable<? extends ValueList> values)
```
...
`[Iterable](https://docs.oracle.com/javase/8/docs/api/java/lang/Iterable.html)<? extends com.google.spanner.executor.v1.ValueList>`  
...
`[QueryResult.Builder](/java/docs/reference/google-cloud-spanner/6.57.0/com.google.spanner.executor.v1.QueryResult.Builder)`
...
```
public QueryResult.Builder addRow(ValueList value)
```
...
`[ValueList](/java/docs/reference/google-cloud-spanner/6.57.0/com.google.spanner.executor.v1.ValueList)`  
...
```
public QueryResult.Builder addRow(ValueList.Builder builderForValue)
```
...
`[ValueList.Builder](/java/docs/reference/google-cloud-spanner/6.57.0/com.google.spanner.executor.v1.ValueList.Builder)`  
...
```
public QueryResult.Builder addRow(int index, ValueList value)
```
...
```
public QueryResult.Builder addRow(int index, ValueList.Builder builderForValue)
```
...
`[QueryResult](/java/docs/reference/google-cloud-spanner/6.57.0/com.google.spanner.executor.v1.QueryResult)`
...
```
public QueryResult.Builder clearRow()
```
...
```
public QueryResult.Builder clearRowType()
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Builder](/java/docs/reference/google-cloud-spanner/6.57.0/com.google.spanner.executor.v1.ValueList.Builder)>`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ValueList](/java/docs/reference/google-cloud-spanner/6.57.0/com.google.spanner.executor.v1.ValueList)>`
...
`[ValueListOrBuilder](/java/docs/reference/google-cloud-spanner/6.57.0/com.google.spanner.executor.v1.ValueListOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.spanner.executor.v1.ValueListOrBuilder>`
...
`[StructType](/java/docs/reference/google-cloud-spanner/6.57.0/com.google.spanner.v1.StructType)`
...
`[StructType.Builder](/java/docs/reference/google-cloud-spanner/6.57.0/com.google.spanner.v1.StructType.Builder)`
...
`[StructTypeOrBuilder](/java/docs/reference/google-cloud-spanner/6.57.0/com.google.spanner.v1.StructTypeOrBuilder)`
...
```
public QueryResult.Builder mergeRowType(StructType value)
```
...
```
public QueryResult.Builder removeRow(int index)
```
...
```
public QueryResult.Builder setRow(int index, ValueList value)
```
...
```
public QueryResult.Builder setRow(int index, ValueList.Builder builderForValue)
```
...
```
public QueryResult.Builder setRowType(StructType value)
```
...
```
public QueryResult.Builder setRowType(StructType.Builder builderForValue)
```
