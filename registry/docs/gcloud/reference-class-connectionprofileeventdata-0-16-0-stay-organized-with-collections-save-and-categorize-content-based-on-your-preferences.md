...
# Class ConnectionProfileEventData (0.16.0) Stay organized with collections Save and categorize content based on your preferences.

Version latestkeyboard\_arrow\_down

-   [0.16.0 (latest)](/java/docs/reference/google-cloudevent-types/latest/com.google.events.cloud.datastream.v1.ConnectionProfileEventData)
-   [0.15.0](/java/docs/reference/google-cloudevent-types/0.15.0/com.google.events.cloud.datastream.v1.ConnectionProfileEventData)
-   [0.14.1](/java/docs/reference/google-cloudevent-types/0.14.1/com.google.events.cloud.datastream.v1.ConnectionProfileEventData)

```
public final class ConnectionProfileEventData extends GeneratedMessageV3 implements ConnectionProfileEventDataOrBuilder
```

The data within all ConnectionProfile events.

Protobuf type `google.events.cloud.datastream.v1.ConnectionProfileEventData`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ConnectionProfileEventData

## Implements

[ConnectionProfileEventDataOrBuilder](/java/docs/reference/google-cloudevent-types/latest/com.google.events.cloud.datastream.v1.ConnectionProfileEventDataOrBuilder)
...
```
public static ConnectionProfileEventData getDefaultInstance()
```
...
`[ConnectionProfileEventData](/java/docs/reference/google-cloudevent-types/latest/com.google.events.cloud.datastream.v1.ConnectionProfileEventData)`
...
```
public static ConnectionProfileEventData.Builder newBuilder()
```
...
`[ConnectionProfileEventData.Builder](/java/docs/reference/google-cloudevent-types/latest/com.google.events.cloud.datastream.v1.ConnectionProfileEventData.Builder)`

### newBuilder(ConnectionProfileEventData prototype)

```
public static ConnectionProfileEventData.Builder newBuilder(ConnectionProfileEventData prototype)
```
...
```
public static ConnectionProfileEventData parseDelimitedFrom(InputStream input)
```
...
```
public static ConnectionProfileEventData parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ConnectionProfileEventData parseFrom(byte[] data)
```
...
```
public static ConnectionProfileEventData parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ConnectionProfileEventData parseFrom(ByteString data)
```
...
```
public static ConnectionProfileEventData parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ConnectionProfileEventData parseFrom(CodedInputStream input)
```
...
```
public static ConnectionProfileEventData parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ConnectionProfileEventData parseFrom(InputStream input)
```
...
```
public static ConnectionProfileEventData parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ConnectionProfileEventData parseFrom(ByteBuffer data)
```
...
```
public static ConnectionProfileEventData parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ConnectionProfileEventData> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ConnectionProfileEventData](/java/docs/reference/google-cloudevent-types/latest/com.google.events.cloud.datastream.v1.ConnectionProfileEventData)>`
...
```
public ConnectionProfileEventData getDefaultInstanceForType()
```
...
```
public Parser<ConnectionProfileEventData> getParserForType()
```
...
```
public ConnectionProfile getPayload()
```

Optional. The ConnectionProfile event payload. Unset for deletion events.

`optional .google.events.cloud.datastream.v1.ConnectionProfile payload = 1;`
...
`[ConnectionProfile](/java/docs/reference/google-cloudevent-types/latest/com.google.events.cloud.datastream.v1.ConnectionProfile)`
...
```
public ConnectionProfileOrBuilder getPayloadOrBuilder()
```
...
`[ConnectionProfileOrBuilder](/java/docs/reference/google-cloudevent-types/latest/com.google.events.cloud.datastream.v1.ConnectionProfileOrBuilder)`
...
```
public ConnectionProfileEventData.Builder newBuilderForType()
```
...
```
protected ConnectionProfileEventData.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ConnectionProfileEventData.Builder toBuilder()
```
