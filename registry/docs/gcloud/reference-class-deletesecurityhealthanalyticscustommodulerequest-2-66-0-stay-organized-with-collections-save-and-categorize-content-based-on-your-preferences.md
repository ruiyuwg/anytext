...
# Class DeleteSecurityHealthAnalyticsCustomModuleRequest (2.66.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class DeleteSecurityHealthAnalyticsCustomModuleRequest extends GeneratedMessageV3 implements DeleteSecurityHealthAnalyticsCustomModuleRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> DeleteSecurityHealthAnalyticsCustomModuleRequest

## Implements

[DeleteSecurityHealthAnalyticsCustomModuleRequestOrBuilder](/java/docs/reference/google-cloud-securitycenter/2.66.0/com.google.cloud.securitycenter.v1.DeleteSecurityHealthAnalyticsCustomModuleRequestOrBuilder)
...
```
public static DeleteSecurityHealthAnalyticsCustomModuleRequest getDefaultInstance()
```
...
`[DeleteSecurityHealthAnalyticsCustomModuleRequest](/java/docs/reference/google-cloud-securitycenter/2.66.0/com.google.cloud.securitycenter.v1.DeleteSecurityHealthAnalyticsCustomModuleRequest)`
...
```
public static DeleteSecurityHealthAnalyticsCustomModuleRequest.Builder newBuilder()
```
...
`[DeleteSecurityHealthAnalyticsCustomModuleRequest.Builder](/java/docs/reference/google-cloud-securitycenter/2.66.0/com.google.cloud.securitycenter.v1.DeleteSecurityHealthAnalyticsCustomModuleRequest.Builder)`

### newBuilder(DeleteSecurityHealthAnalyticsCustomModuleRequest prototype)

```
public static DeleteSecurityHealthAnalyticsCustomModuleRequest.Builder newBuilder(DeleteSecurityHealthAnalyticsCustomModuleRequest prototype)
```
...
```
public static DeleteSecurityHealthAnalyticsCustomModuleRequest parseDelimitedFrom(InputStream input)
```
...
```
public static DeleteSecurityHealthAnalyticsCustomModuleRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteSecurityHealthAnalyticsCustomModuleRequest parseFrom(byte[] data)
```
...
```
public static DeleteSecurityHealthAnalyticsCustomModuleRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteSecurityHealthAnalyticsCustomModuleRequest parseFrom(ByteString data)
```
...
```
public static DeleteSecurityHealthAnalyticsCustomModuleRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteSecurityHealthAnalyticsCustomModuleRequest parseFrom(CodedInputStream input)
```
...
```
public static DeleteSecurityHealthAnalyticsCustomModuleRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteSecurityHealthAnalyticsCustomModuleRequest parseFrom(InputStream input)
```
...
```
public static DeleteSecurityHealthAnalyticsCustomModuleRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteSecurityHealthAnalyticsCustomModuleRequest parseFrom(ByteBuffer data)
```
...
```
public static DeleteSecurityHealthAnalyticsCustomModuleRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<DeleteSecurityHealthAnalyticsCustomModuleRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[DeleteSecurityHealthAnalyticsCustomModuleRequest](/java/docs/reference/google-cloud-securitycenter/2.66.0/com.google.cloud.securitycenter.v1.DeleteSecurityHealthAnalyticsCustomModuleRequest)>`
...
```
public Parser<DeleteSecurityHealthAnalyticsCustomModuleRequest> getParserForType()
```
...
```
public DeleteSecurityHealthAnalyticsCustomModuleRequest.Builder newBuilderForType()
```
...
```
protected DeleteSecurityHealthAnalyticsCustomModuleRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public DeleteSecurityHealthAnalyticsCustomModuleRequest.Builder toBuilder()
```
