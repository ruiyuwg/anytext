...
# Class PredictResponse (0.8.10) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> PredictResponse

## Implements

[PredictResponseOrBuilder](/java/docs/reference/google-cloud-recommendations-ai/0.8.10/com.google.cloud.recommendationengine.v1beta1.PredictResponseOrBuilder)
...
### ITEMS\_MISSING\_IN\_CATALOG\_FIELD\_NUMBER
...
### RECOMMENDATION\_TOKEN\_FIELD\_NUMBER
...
[PredictResponse](/java/docs/reference/google-cloud-recommendations-ai/0.8.10/com.google.cloud.recommendationengine.v1beta1.PredictResponse)
...
[PredictResponse.Builder](/java/docs/reference/google-cloud-recommendations-ai/0.8.10/com.google.cloud.recommendationengine.v1beta1.PredictResponse.Builder)
...
[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[PredictResponse](/java/docs/reference/google-cloud-recommendations-ai/0.8.10/com.google.cloud.recommendationengine.v1beta1.PredictResponse)\>
...
Use [#getMetadataMap()](/java/docs/reference/google-cloud-recommendations-ai/0.8.10/com.google.cloud.recommendationengine.v1beta1.PredictResponse#com_google_cloud_recommendationengine_v1beta1_PredictResponse_getMetadataMap__) instead.
...
If empty, the list is complete. If nonempty, the token to pass to the next request's PredictRequest.page\_token.
...
[PredictResponse.PredictionResult](/java/docs/reference/google-cloud-recommendations-ai/0.8.10/com.google.cloud.recommendationengine.v1beta1.PredictResponse.PredictionResult)
...
[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[PredictionResult](/java/docs/reference/google-cloud-recommendations-ai/0.8.10/com.google.cloud.recommendationengine.v1beta1.PredictResponse.PredictionResult)\>
...
[PredictResponse.PredictionResultOrBuilder](/java/docs/reference/google-cloud-recommendations-ai/0.8.10/com.google.cloud.recommendationengine.v1beta1.PredictResponse.PredictionResultOrBuilder)
...
[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.recommendationengine.v1beta1.PredictResponse.PredictionResultOrBuilder\>
