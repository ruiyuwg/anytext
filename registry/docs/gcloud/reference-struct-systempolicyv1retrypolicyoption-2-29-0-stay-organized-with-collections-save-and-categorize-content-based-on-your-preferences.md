...
# Struct SystemPolicyV1RetryPolicyOption (2.29.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Alias Of**: `std::shared_ptr< SystemPolicyV1RetryPolicy >`
