...
# Class ReachabilityServiceClient.ListConnectivityTestsFixedSizeCollection (1.23.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class ReachabilityServiceClient.ListConnectivityTestsFixedSizeCollection extends AbstractFixedSizeCollection<ListConnectivityTestsRequest,ListConnectivityTestsResponse,ConnectivityTest,ReachabilityServiceClient.ListConnectivityTestsPage,ReachabilityServiceClient.ListConnectivityTestsFixedSizeCollection>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractFixedSizeCollection](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractFixedSizeCollection.html) \> ReachabilityServiceClient.ListConnectivityTestsFixedSizeCollection
...
### createCollection(List<ReachabilityServiceClient.ListConnectivityTestsPage> pages, int collectionSize)

```
protected ReachabilityServiceClient.ListConnectivityTestsFixedSizeCollection createCollection(List<ReachabilityServiceClient.ListConnectivityTestsPage> pages, int collectionSize)
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ListConnectivityTestsPage](/java/docs/reference/google-cloud-network-management/1.23.0/com.google.cloud.networkmanagement.v1beta1.ReachabilityServiceClient.ListConnectivityTestsPage)>`  
...
`[ReachabilityServiceClient.ListConnectivityTestsFixedSizeCollection](/java/docs/reference/google-cloud-network-management/1.23.0/com.google.cloud.networkmanagement.v1beta1.ReachabilityServiceClient.ListConnectivityTestsFixedSizeCollection)`
