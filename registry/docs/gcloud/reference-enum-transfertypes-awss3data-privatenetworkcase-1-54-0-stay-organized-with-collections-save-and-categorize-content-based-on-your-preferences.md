...
# Enum TransferTypes.AwsS3Data.PrivateNetworkCase (1.54.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum TransferTypes.AwsS3Data.PrivateNetworkCase extends Enum<TransferTypes.AwsS3Data.PrivateNetworkCase> implements Internal.EnumLite, AbstractMessageLite.InternalOneOfEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-storage-transfer/1.54.0/com.google.storagetransfer.v1.proto.TransferTypes.AwsS3Data.PrivateNetworkCase#com_google_storagetransfer_v1_proto_TransferTypes_AwsS3Data_PrivateNetworkCase_forNumber_int_) instead._
