...
# Interface DestroySecretVersionRequestOrBuilder (2.49.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface DestroySecretVersionRequestOrBuilder extends MessageOrBuilder
```
