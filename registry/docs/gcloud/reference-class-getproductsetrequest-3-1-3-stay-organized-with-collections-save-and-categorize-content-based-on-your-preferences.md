...
# Class GetProductSetRequest (3.1.3) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class GetProductSetRequest extends GeneratedMessageV3 implements GetProductSetRequestOrBuilder
```

Request message for the `GetProductSet` method.

Protobuf type `google.cloud.vision.v1p4beta1.GetProductSetRequest`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> GetProductSetRequest

## Implements

[GetProductSetRequestOrBuilder](/java/docs/reference/google-cloud-vision/3.1.3/com.google.cloud.vision.v1p4beta1.GetProductSetRequestOrBuilder)
...
```
public static GetProductSetRequest getDefaultInstance()
```
...
[GetProductSetRequest](/java/docs/reference/google-cloud-vision/3.1.3/com.google.cloud.vision.v1p4beta1.GetProductSetRequest)
...
```
public static GetProductSetRequest.Builder newBuilder()
```
...
[GetProductSetRequest.Builder](/java/docs/reference/google-cloud-vision/3.1.3/com.google.cloud.vision.v1p4beta1.GetProductSetRequest.Builder)

### newBuilder(GetProductSetRequest prototype)

```
public static GetProductSetRequest.Builder newBuilder(GetProductSetRequest prototype)
```
...
```
public static GetProductSetRequest parseDelimitedFrom(InputStream input)
```
...
```
public static GetProductSetRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetProductSetRequest parseFrom(byte[] data)
```
...
```
public static GetProductSetRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetProductSetRequest parseFrom(ByteString data)
```
...
```
public static GetProductSetRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetProductSetRequest parseFrom(CodedInputStream input)
```
...
```
public static GetProductSetRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetProductSetRequest parseFrom(InputStream input)
```
...
```
public static GetProductSetRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetProductSetRequest parseFrom(ByteBuffer data)
```
...
```
public static GetProductSetRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<GetProductSetRequest> parser()
```
...
[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[GetProductSetRequest](/java/docs/reference/google-cloud-vision/3.1.3/com.google.cloud.vision.v1p4beta1.GetProductSetRequest)\>
...
```
public Parser<GetProductSetRequest> getParserForType()
```
...
```
public GetProductSetRequest.Builder newBuilderForType()
```
...
```
protected GetProductSetRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public GetProductSetRequest.Builder toBuilder()
```
