...
# Interface ListWorkstationsRequestOrBuilder (0.12.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface ListWorkstationsRequestOrBuilder extends MessageOrBuilder
```
