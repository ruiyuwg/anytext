...
# Class EkmServiceClient.ListLocationsPage (2.35.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class EkmServiceClient.ListLocationsPage extends AbstractPage<ListLocationsRequest,ListLocationsResponse,Location,EkmServiceClient.ListLocationsPage>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractPage](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractPage.html) \> EkmServiceClient.ListLocationsPage
...
```
protected EkmServiceClient.ListLocationsPage createPage(PageContext<ListLocationsRequest,ListLocationsResponse,Location> context, ListLocationsResponse response)
```
...
`[EkmServiceClient.ListLocationsPage](/java/docs/reference/google-cloud-kms/2.35.0/com.google.cloud.kms.v1.EkmServiceClient.ListLocationsPage)`
...
```
public ApiFuture<EkmServiceClient.ListLocationsPage> createPageAsync(PageContext<ListLocationsRequest,ListLocationsResponse,Location> context, ApiFuture<ListLocationsResponse> futureResponse)
```
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListLocationsPage](/java/docs/reference/google-cloud-kms/2.35.0/com.google.cloud.kms.v1.EkmServiceClient.ListLocationsPage)>`
