...
# Class ProposeBlueprintRequest (0.11.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ProposeBlueprintRequest extends GeneratedMessageV3 implements ProposeBlueprintRequestOrBuilder
```

Request object for `ProposeBlueprint`.

Protobuf type `google.cloud.telcoautomation.v1alpha1.ProposeBlueprintRequest`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ProposeBlueprintRequest

## Implements

[ProposeBlueprintRequestOrBuilder](/java/docs/reference/google-cloud-telcoautomation/0.11.0/com.google.cloud.telcoautomation.v1alpha1.ProposeBlueprintRequestOrBuilder)
...
```
public static ProposeBlueprintRequest getDefaultInstance()
```
...
`[ProposeBlueprintRequest](/java/docs/reference/google-cloud-telcoautomation/0.11.0/com.google.cloud.telcoautomation.v1alpha1.ProposeBlueprintRequest)`
...
```
public static ProposeBlueprintRequest.Builder newBuilder()
```
...
`[ProposeBlueprintRequest.Builder](/java/docs/reference/google-cloud-telcoautomation/0.11.0/com.google.cloud.telcoautomation.v1alpha1.ProposeBlueprintRequest.Builder)`

### newBuilder(ProposeBlueprintRequest prototype)

```
public static ProposeBlueprintRequest.Builder newBuilder(ProposeBlueprintRequest prototype)
```
...
```
public static ProposeBlueprintRequest parseDelimitedFrom(InputStream input)
```
...
```
public static ProposeBlueprintRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ProposeBlueprintRequest parseFrom(byte[] data)
```
...
```
public static ProposeBlueprintRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ProposeBlueprintRequest parseFrom(ByteString data)
```
...
```
public static ProposeBlueprintRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ProposeBlueprintRequest parseFrom(CodedInputStream input)
```
...
```
public static ProposeBlueprintRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ProposeBlueprintRequest parseFrom(InputStream input)
```
...
```
public static ProposeBlueprintRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ProposeBlueprintRequest parseFrom(ByteBuffer data)
```
...
```
public static ProposeBlueprintRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ProposeBlueprintRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ProposeBlueprintRequest](/java/docs/reference/google-cloud-telcoautomation/0.11.0/com.google.cloud.telcoautomation.v1alpha1.ProposeBlueprintRequest)>`
...
```
public ProposeBlueprintRequest getDefaultInstanceForType()
```
...
```
public Parser<ProposeBlueprintRequest> getParserForType()
```
...
```
public ProposeBlueprintRequest.Builder newBuilderForType()
```
...
```
protected ProposeBlueprintRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ProposeBlueprintRequest.Builder toBuilder()
```
