...
# Enum EffectiveSecurityHealthAnalyticsCustomModule.EnablementState (2.38.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-securitycenter/2.38.0/com.google.cloud.securitycenter.v1.EffectiveSecurityHealthAnalyticsCustomModule.EnablementState#com_google_cloud_securitycenter_v1_EffectiveSecurityHealthAnalyticsCustomModule_EnablementState_forNumber_int_) instead._
