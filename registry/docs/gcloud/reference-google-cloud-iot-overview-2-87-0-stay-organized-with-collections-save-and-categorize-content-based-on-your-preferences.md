...
# google-cloud-iot overview (2.87.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Cloud Internet of Things (IoT) Core Description:** Is a complete set of tools to connect, process, store, and analyze data both at the edge and in the cloud. The platform consists of scalable, fully-managed cloud services; an integrated software stack for edge/on-premises computing with machine learning capabilities for all your IoT needs.

[Cloud Internet of Things (IoT) Core Product Reference](https://cloud.google.com/iot)

[GitHub Repository](https://github.com/googleapis/google-cloud-java/tree/main/java-iot)

[Maven artifact](https://central.sonatype.com/artifact/com.google.cloud/google-cloud-iot)
...
-   [Enable the API](https://console.cloud.google.com/apis/library/cloudiot.googleapis.com)
-   [Set up authentication](https://cloud.google.com/docs/authentication/client-libraries)

## Use the Cloud Internet of Things (IoT) Core for Java
...
The example below demonstrates how you would import the BOM and include the `google-cloud-iot` artifact.
...
For this library, we recommend using [com.google.cloud.iot.v1](https://cloud.google.com/java/docs/reference/google-cloud-iot/2.87.0/com.google.cloud.iot.v1) for new applications.
