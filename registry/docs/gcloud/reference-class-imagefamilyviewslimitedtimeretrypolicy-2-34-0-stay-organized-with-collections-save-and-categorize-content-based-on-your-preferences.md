...
# Class ImageFamilyViewsLimitedTimeRetryPolicy (2.34.0) Stay organized with collections Save and categorize content based on your preferences.
...
A retry policy for [`ImageFamilyViewsConnection`](/cpp/docs/reference/compute/2.34.0/classgoogle_1_1cloud_1_1compute__image__family__views__v1_1_1ImageFamilyViewsConnection) based on elapsed time.
...
`ImageFamilyViewsLimitedTimeRetryPolicy const &`  
...
`std::unique_ptr< ImageFamilyViewsRetryPolicy >`

## Type Aliases

### BaseType

**Alias Of**: `ImageFamilyViewsRetryPolicy`
