...
# Class CreateKeyRingRequest (2.49.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class CreateKeyRingRequest extends GeneratedMessageV3 implements CreateKeyRingRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> CreateKeyRingRequest

## Implements

[CreateKeyRingRequestOrBuilder](/java/docs/reference/google-cloud-kms/2.49.0/com.google.cloud.kms.v1.CreateKeyRingRequestOrBuilder)
...
### KEY\_RING\_FIELD\_NUMBER

```
public static final int KEY_RING_FIELD_NUMBER
```
...
### KEY\_RING\_ID\_FIELD\_NUMBER

```
public static final int KEY_RING_ID_FIELD_NUMBER
```
...
```
public static CreateKeyRingRequest getDefaultInstance()
```
...
`[CreateKeyRingRequest](/java/docs/reference/google-cloud-kms/2.49.0/com.google.cloud.kms.v1.CreateKeyRingRequest)`
...
```
public static CreateKeyRingRequest.Builder newBuilder()
```
...
`[CreateKeyRingRequest.Builder](/java/docs/reference/google-cloud-kms/2.49.0/com.google.cloud.kms.v1.CreateKeyRingRequest.Builder)`

### newBuilder(CreateKeyRingRequest prototype)

```
public static CreateKeyRingRequest.Builder newBuilder(CreateKeyRingRequest prototype)
```
...
```
public static CreateKeyRingRequest parseDelimitedFrom(InputStream input)
```
...
```
public static CreateKeyRingRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateKeyRingRequest parseFrom(byte[] data)
```
...
```
public static CreateKeyRingRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateKeyRingRequest parseFrom(ByteString data)
```
...
```
public static CreateKeyRingRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateKeyRingRequest parseFrom(CodedInputStream input)
```
...
```
public static CreateKeyRingRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateKeyRingRequest parseFrom(InputStream input)
```
...
```
public static CreateKeyRingRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateKeyRingRequest parseFrom(ByteBuffer data)
```
...
```
public static CreateKeyRingRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<CreateKeyRingRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[CreateKeyRingRequest](/java/docs/reference/google-cloud-kms/2.49.0/com.google.cloud.kms.v1.CreateKeyRingRequest)>`
...
`[KeyRing](/java/docs/reference/google-cloud-kms/2.49.0/com.google.cloud.kms.v1.KeyRing)`
...
`[KeyRingOrBuilder](/java/docs/reference/google-cloud-kms/2.49.0/com.google.cloud.kms.v1.KeyRingOrBuilder)`
...
```
public Parser<CreateKeyRingRequest> getParserForType()
```
...
```
public CreateKeyRingRequest.Builder newBuilderForType()
```
...
```
protected CreateKeyRingRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public CreateKeyRingRequest.Builder toBuilder()
```
