...
# Class PredictionService (1.2.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://learn.microsoft.com/dotnet/api/system.object) \> PredictionService
...
### BindService(PredictionService.PredictionServiceBase)

```
public static ServerServiceDefinition BindService(PredictionService.PredictionServiceBase serviceImpl)
```
...
`[PredictionService.PredictionServiceBase](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/1.2.0/Google.Cloud.AIPlatform.V1.PredictionService.PredictionServiceBase)`  
...
### BindService(ServiceBinderBase, PredictionService.PredictionServiceBase)
