...
# Class HttpConfig (2.55.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class HttpConfig extends GeneratedMessageV3 implements HttpConfigOrBuilder
```
...
### HTTP\_ENABLED\_STATE\_FIELD\_NUMBER

```
public static final int HTTP_ENABLED_STATE_FIELD_NUMBER
```
...
`[HttpConfig](/java/docs/reference/google-cloud-iot/2.55.0/com.google.cloud.iot.v1.HttpConfig)`
...
`[HttpConfig.Builder](/java/docs/reference/google-cloud-iot/2.55.0/com.google.cloud.iot.v1.HttpConfig.Builder)`

### newBuilder(HttpConfig prototype)

```
public static HttpConfig.Builder newBuilder(HttpConfig prototype)
```
...
```
public static HttpConfig parseDelimitedFrom(InputStream input)
```
...
```
public static HttpConfig parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static HttpConfig parseFrom(byte[] data)
```
...
```
public static HttpConfig parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static HttpConfig parseFrom(ByteString data)
```
...
```
public static HttpConfig parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static HttpConfig parseFrom(CodedInputStream input)
```
...
```
public static HttpConfig parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static HttpConfig parseFrom(InputStream input)
```
...
```
public static HttpConfig parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static HttpConfig parseFrom(ByteBuffer data)
```
...
```
public static HttpConfig parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<HttpConfig> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[HttpConfig](/java/docs/reference/google-cloud-iot/2.55.0/com.google.cloud.iot.v1.HttpConfig)>`
...
`[HttpState](/java/docs/reference/google-cloud-iot/2.55.0/com.google.cloud.iot.v1.HttpState)`
...
```
public Parser<HttpConfig> getParserForType()
```
...
```
public HttpConfig.Builder newBuilderForType()
```
...
```
protected HttpConfig.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public HttpConfig.Builder toBuilder()
```
