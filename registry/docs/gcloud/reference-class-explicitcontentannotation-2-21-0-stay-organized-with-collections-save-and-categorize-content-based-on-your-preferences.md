...
# Class ExplicitContentAnnotation (2.21.0) Stay organized with collections Save and categorize content based on your preferences.
...
[ExplicitContentAnnotationOrBuilder](/java/docs/reference/google-cloud-video-intelligence/2.21.0/com.google.cloud.videointelligence.v1beta2.ExplicitContentAnnotationOrBuilder)
...
`[ExplicitContentAnnotation](/java/docs/reference/google-cloud-video-intelligence/2.21.0/com.google.cloud.videointelligence.v1beta2.ExplicitContentAnnotation)`
...
`[ExplicitContentAnnotation.Builder](/java/docs/reference/google-cloud-video-intelligence/2.21.0/com.google.cloud.videointelligence.v1beta2.ExplicitContentAnnotation.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ExplicitContentAnnotation](/java/docs/reference/google-cloud-video-intelligence/2.21.0/com.google.cloud.videointelligence.v1beta2.ExplicitContentAnnotation)>`
...
`[ExplicitContentFrame](/java/docs/reference/google-cloud-video-intelligence/2.21.0/com.google.cloud.videointelligence.v1beta2.ExplicitContentFrame)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ExplicitContentFrame](/java/docs/reference/google-cloud-video-intelligence/2.21.0/com.google.cloud.videointelligence.v1beta2.ExplicitContentFrame)>`
...
`[ExplicitContentFrameOrBuilder](/java/docs/reference/google-cloud-video-intelligence/2.21.0/com.google.cloud.videointelligence.v1beta2.ExplicitContentFrameOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.videointelligence.v1beta2.ExplicitContentFrameOrBuilder>`
