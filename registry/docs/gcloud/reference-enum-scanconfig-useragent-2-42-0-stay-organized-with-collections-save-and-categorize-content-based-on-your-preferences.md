...
# Enum ScanConfig.UserAgent (2.42.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-websecurityscanner/2.42.0/com.google.cloud.websecurityscanner.v1beta.ScanConfig.UserAgent#com_google_cloud_websecurityscanner_v1beta_ScanConfig_UserAgent_forNumber_int_) instead._
