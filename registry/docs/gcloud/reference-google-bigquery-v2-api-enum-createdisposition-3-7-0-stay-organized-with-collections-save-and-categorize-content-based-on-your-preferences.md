...
# Google BigQuery v2 API - Enum CreateDisposition (3.7.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Google.Cloud.BigQuery.V2](/dotnet/docs/reference/Google.Cloud.BigQuery.V2/3.7.0/Google.Cloud.BigQuery.V2)
