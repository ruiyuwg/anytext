...
# Interface ShotChangeDetectionConfigOrBuilder (2.46.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface ShotChangeDetectionConfigOrBuilder extends MessageOrBuilder
```
