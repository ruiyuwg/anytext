...
# Interface CreateOperatorRequestOrBuilder (0.9.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[Operator](/java/docs/reference/google-cloud-visionai/0.9.0/com.google.cloud.visionai.v1.Operator)`
...
`[OperatorOrBuilder](/java/docs/reference/google-cloud-visionai/0.9.0/com.google.cloud.visionai.v1.OperatorOrBuilder)`
