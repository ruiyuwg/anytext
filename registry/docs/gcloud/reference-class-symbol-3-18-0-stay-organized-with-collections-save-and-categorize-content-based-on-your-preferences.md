...
# Class Symbol (3.18.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class Symbol extends GeneratedMessageV3 implements SymbolOrBuilder
```
...
`[Symbol](/java/docs/reference/google-cloud-vision/3.18.0/com.google.cloud.vision.v1.Symbol)`
...
`[Symbol.Builder](/java/docs/reference/google-cloud-vision/3.18.0/com.google.cloud.vision.v1.Symbol.Builder)`

### newBuilder(Symbol prototype)

```
public static Symbol.Builder newBuilder(Symbol prototype)
```
...
```
public static Symbol parseDelimitedFrom(InputStream input)
```
...
```
public static Symbol parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Symbol parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Symbol parseFrom(ByteString data)
```
...
```
public static Symbol parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Symbol parseFrom(CodedInputStream input)
```
...
```
public static Symbol parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Symbol parseFrom(InputStream input)
```
...
```
public static Symbol parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Symbol parseFrom(ByteBuffer data)
```
...
```
public static Symbol parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[Symbol](/java/docs/reference/google-cloud-vision/3.18.0/com.google.cloud.vision.v1.Symbol)>`
...
`[BoundingPoly](/java/docs/reference/google-cloud-vision/3.18.0/com.google.cloud.vision.v1.BoundingPoly)`
...
`[BoundingPolyOrBuilder](/java/docs/reference/google-cloud-vision/3.18.0/com.google.cloud.vision.v1.BoundingPolyOrBuilder)`
...
`[TextAnnotation.TextProperty](/java/docs/reference/google-cloud-vision/3.18.0/com.google.cloud.vision.v1.TextAnnotation.TextProperty)`
...
`[TextAnnotation.TextPropertyOrBuilder](/java/docs/reference/google-cloud-vision/3.18.0/com.google.cloud.vision.v1.TextAnnotation.TextPropertyOrBuilder)`
...
```
public Symbol.Builder newBuilderForType()
```
...
```
protected Symbol.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
