...
# Class Action.PublishToStackdriver (3.91.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class Action.PublishToStackdriver extends GeneratedMessage implements Action.PublishToStackdriverOrBuilder
```

Enable Stackdriver metric dlp.googleapis.com/finding\_count. This will publish a metric to stack driver on each infotype requested and how many findings were found for it. CustomDetectors will be bucketed as 'Custom' under the Stackdriver label 'info\_type'.

Protobuf type `google.privacy.dlp.v2.Action.PublishToStackdriver`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessage.html) \> Action.PublishToStackdriver

## Implements

[Action.PublishToStackdriverOrBuilder](/java/docs/reference/google-cloud-dlp/latest/com.google.privacy.dlp.v2.Action.PublishToStackdriverOrBuilder)
...
```
public static Action.PublishToStackdriver getDefaultInstance()
```
...
`[Action.PublishToStackdriver](/java/docs/reference/google-cloud-dlp/latest/com.google.privacy.dlp.v2.Action.PublishToStackdriver)`
...
```
public static Action.PublishToStackdriver.Builder newBuilder()
```
...
`[Action.PublishToStackdriver.Builder](/java/docs/reference/google-cloud-dlp/latest/com.google.privacy.dlp.v2.Action.PublishToStackdriver.Builder)`

### newBuilder(Action.PublishToStackdriver prototype)

```
public static Action.PublishToStackdriver.Builder newBuilder(Action.PublishToStackdriver prototype)
```
...
```
public static Action.PublishToStackdriver parseDelimitedFrom(InputStream input)
```
...
```
public static Action.PublishToStackdriver parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Action.PublishToStackdriver parseFrom(byte[] data)
```
...
```
public static Action.PublishToStackdriver parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Action.PublishToStackdriver parseFrom(ByteString data)
```
...
```
public static Action.PublishToStackdriver parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Action.PublishToStackdriver parseFrom(CodedInputStream input)
```
...
```
public static Action.PublishToStackdriver parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Action.PublishToStackdriver parseFrom(InputStream input)
```
...
```
public static Action.PublishToStackdriver parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Action.PublishToStackdriver parseFrom(ByteBuffer data)
```
...
```
public static Action.PublishToStackdriver parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<Action.PublishToStackdriver> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[PublishToStackdriver](/java/docs/reference/google-cloud-dlp/latest/com.google.privacy.dlp.v2.Action.PublishToStackdriver)>`
...
```
public Parser<Action.PublishToStackdriver> getParserForType()
```
...
```
public Action.PublishToStackdriver.Builder newBuilderForType()
```
...
```
protected Action.PublishToStackdriver.Builder newBuilderForType(AbstractMessage.BuilderParent parent)
```
...
```
public Action.PublishToStackdriver.Builder toBuilder()
```
