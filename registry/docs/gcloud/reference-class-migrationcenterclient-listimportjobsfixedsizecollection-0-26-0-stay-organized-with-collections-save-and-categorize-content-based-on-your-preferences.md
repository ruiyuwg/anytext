...
# Class MigrationCenterClient.ListImportJobsFixedSizeCollection (0.26.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class MigrationCenterClient.ListImportJobsFixedSizeCollection extends AbstractFixedSizeCollection<ListImportJobsRequest,ListImportJobsResponse,ImportJob,MigrationCenterClient.ListImportJobsPage,MigrationCenterClient.ListImportJobsFixedSizeCollection>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractFixedSizeCollection](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractFixedSizeCollection.html) \> MigrationCenterClient.ListImportJobsFixedSizeCollection
...
### createCollection(List<MigrationCenterClient.ListImportJobsPage> pages, int collectionSize)

```
protected MigrationCenterClient.ListImportJobsFixedSizeCollection createCollection(List<MigrationCenterClient.ListImportJobsPage> pages, int collectionSize)
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ListImportJobsPage](/java/docs/reference/google-cloud-migrationcenter/0.26.0/com.google.cloud.migrationcenter.v1.MigrationCenterClient.ListImportJobsPage)>`  
...
`[MigrationCenterClient.ListImportJobsFixedSizeCollection](/java/docs/reference/google-cloud-migrationcenter/0.26.0/com.google.cloud.migrationcenter.v1.MigrationCenterClient.ListImportJobsFixedSizeCollection)`
