...
# Class ListEffectiveSecurityHealthAnalyticsCustomModulesResponse (2.64.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListEffectiveSecurityHealthAnalyticsCustomModulesResponse

## Implements

[ListEffectiveSecurityHealthAnalyticsCustomModulesResponseOrBuilder](/java/docs/reference/google-cloud-securitycenter/2.64.0/com.google.cloud.securitycenter.v1.ListEffectiveSecurityHealthAnalyticsCustomModulesResponseOrBuilder)
...
### EFFECTIVE\_SECURITY\_HEALTH\_ANALYTICS\_CUSTOM\_MODULES\_FIELD\_NUMBER
...
`[ListEffectiveSecurityHealthAnalyticsCustomModulesResponse](/java/docs/reference/google-cloud-securitycenter/2.64.0/com.google.cloud.securitycenter.v1.ListEffectiveSecurityHealthAnalyticsCustomModulesResponse)`
...
`[ListEffectiveSecurityHealthAnalyticsCustomModulesResponse.Builder](/java/docs/reference/google-cloud-securitycenter/2.64.0/com.google.cloud.securitycenter.v1.ListEffectiveSecurityHealthAnalyticsCustomModulesResponse.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListEffectiveSecurityHealthAnalyticsCustomModulesResponse](/java/docs/reference/google-cloud-securitycenter/2.64.0/com.google.cloud.securitycenter.v1.ListEffectiveSecurityHealthAnalyticsCustomModulesResponse)>`
...
`[EffectiveSecurityHealthAnalyticsCustomModule](/java/docs/reference/google-cloud-securitycenter/2.64.0/com.google.cloud.securitycenter.v1.EffectiveSecurityHealthAnalyticsCustomModule)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[EffectiveSecurityHealthAnalyticsCustomModule](/java/docs/reference/google-cloud-securitycenter/2.64.0/com.google.cloud.securitycenter.v1.EffectiveSecurityHealthAnalyticsCustomModule)>`
...
`[EffectiveSecurityHealthAnalyticsCustomModuleOrBuilder](/java/docs/reference/google-cloud-securitycenter/2.64.0/com.google.cloud.securitycenter.v1.EffectiveSecurityHealthAnalyticsCustomModuleOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.securitycenter.v1.EffectiveSecurityHealthAnalyticsCustomModuleOrBuilder>`
