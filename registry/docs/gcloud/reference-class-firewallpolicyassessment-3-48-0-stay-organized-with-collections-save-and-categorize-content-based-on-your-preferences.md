...
# Class FirewallPolicyAssessment (3.48.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> FirewallPolicyAssessment

## Implements

[FirewallPolicyAssessmentOrBuilder](/java/docs/reference/google-cloud-recaptchaenterprise/3.48.0/com.google.recaptchaenterprise.v1.FirewallPolicyAssessmentOrBuilder)
...
### FIREWALL\_POLICY\_FIELD\_NUMBER
...
`[FirewallPolicyAssessment](/java/docs/reference/google-cloud-recaptchaenterprise/3.48.0/com.google.recaptchaenterprise.v1.FirewallPolicyAssessment)`
...
`[FirewallPolicyAssessment.Builder](/java/docs/reference/google-cloud-recaptchaenterprise/3.48.0/com.google.recaptchaenterprise.v1.FirewallPolicyAssessment.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[FirewallPolicyAssessment](/java/docs/reference/google-cloud-recaptchaenterprise/3.48.0/com.google.recaptchaenterprise.v1.FirewallPolicyAssessment)>`
...
Output only. If the processing of a policy config fails, an error is populated and the firewall\_policy is left empty.
...
`[FirewallPolicy](/java/docs/reference/google-cloud-recaptchaenterprise/3.48.0/com.google.recaptchaenterprise.v1.FirewallPolicy)`
...
`[FirewallPolicyOrBuilder](/java/docs/reference/google-cloud-recaptchaenterprise/3.48.0/com.google.recaptchaenterprise.v1.FirewallPolicyOrBuilder)`
