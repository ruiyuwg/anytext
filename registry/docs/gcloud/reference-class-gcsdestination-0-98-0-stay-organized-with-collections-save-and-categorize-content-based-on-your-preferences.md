...
# Class GcsDestination (0.98.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class GcsDestination extends GeneratedMessage implements GcsDestinationOrBuilder
```

Google Cloud Storage location for a Dialogflow operation that writes or exports objects (e.g. exported agent or transcripts) outside of Dialogflow.

Protobuf type `google.cloud.dialogflow.cx.v3beta1.GcsDestination`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessage.html) \> GcsDestination

## Implements

[GcsDestinationOrBuilder](/java/docs/reference/google-cloud-dialogflow-cx/latest/com.google.cloud.dialogflow.cx.v3beta1.GcsDestinationOrBuilder)
...
`[GcsDestination](/java/docs/reference/google-cloud-dialogflow-cx/latest/com.google.cloud.dialogflow.cx.v3beta1.GcsDestination)`
...
`[GcsDestination.Builder](/java/docs/reference/google-cloud-dialogflow-cx/latest/com.google.cloud.dialogflow.cx.v3beta1.GcsDestination.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[GcsDestination](/java/docs/reference/google-cloud-dialogflow-cx/latest/com.google.cloud.dialogflow.cx.v3beta1.GcsDestination)>`
...
```
protected GcsDestination.Builder newBuilderForType(AbstractMessage.BuilderParent parent)
```
