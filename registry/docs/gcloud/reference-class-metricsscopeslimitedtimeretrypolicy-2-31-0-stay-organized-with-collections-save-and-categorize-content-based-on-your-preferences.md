...
# Class MetricsScopesLimitedTimeRetryPolicy (2.31.0) Stay organized with collections Save and categorize content based on your preferences.
...
A retry policy for [`MetricsScopesConnection`](/cpp/docs/reference/monitoring/2.31.0/classgoogle_1_1cloud_1_1monitoring__metricsscope__v1_1_1MetricsScopesConnection) based on elapsed time.
...
`MetricsScopesLimitedTimeRetryPolicy const &`  
...
`std::unique_ptr< MetricsScopesRetryPolicy >`

## Type Aliases

### BaseType

**Alias Of**: `MetricsScopesRetryPolicy`
