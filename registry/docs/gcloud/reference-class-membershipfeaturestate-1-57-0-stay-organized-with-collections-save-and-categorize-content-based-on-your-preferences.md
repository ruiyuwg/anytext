...
# Class MembershipFeatureState (1.57.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> MembershipFeatureState

## Implements

[MembershipFeatureStateOrBuilder](/java/docs/reference/google-cloud-gkehub/1.57.0/com.google.cloud.gkehub.v1.MembershipFeatureStateOrBuilder)
...
### CONFIGMANAGEMENT\_FIELD\_NUMBER
...
`[MembershipFeatureState](/java/docs/reference/google-cloud-gkehub/1.57.0/com.google.cloud.gkehub.v1.MembershipFeatureState)`
...
`[MembershipFeatureState.Builder](/java/docs/reference/google-cloud-gkehub/1.57.0/com.google.cloud.gkehub.v1.MembershipFeatureState.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[MembershipFeatureState](/java/docs/reference/google-cloud-gkehub/1.57.0/com.google.cloud.gkehub.v1.MembershipFeatureState)>`
...
`[MembershipState](/java/docs/reference/google-cloud-gkehub/1.57.0/com.google.cloud.gkehub.configmanagement.v1.MembershipState)`
...
`[MembershipStateOrBuilder](/java/docs/reference/google-cloud-gkehub/1.57.0/com.google.cloud.gkehub.configmanagement.v1.MembershipStateOrBuilder)`
...
`[MembershipFeatureState.FeatureStateCase](/java/docs/reference/google-cloud-gkehub/1.57.0/com.google.cloud.gkehub.v1.MembershipFeatureState.FeatureStateCase)`
...
`[FeatureState](/java/docs/reference/google-cloud-gkehub/1.57.0/com.google.cloud.gkehub.v1.FeatureState)`
...
`[FeatureStateOrBuilder](/java/docs/reference/google-cloud-gkehub/1.57.0/com.google.cloud.gkehub.v1.FeatureStateOrBuilder)`
