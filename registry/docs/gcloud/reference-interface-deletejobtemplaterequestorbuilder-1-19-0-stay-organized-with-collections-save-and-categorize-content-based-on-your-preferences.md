...
# Interface DeleteJobTemplateRequestOrBuilder (1.19.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface DeleteJobTemplateRequestOrBuilder extends MessageOrBuilder
```
