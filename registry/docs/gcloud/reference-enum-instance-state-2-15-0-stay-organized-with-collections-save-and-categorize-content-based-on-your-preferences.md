...
# Enum Instance.State (2.15.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-memcache/2.15.0/com.google.cloud.memcache.v1beta2.Instance.State#com_google_cloud_memcache_v1beta2_Instance_State_forNumber_int_) instead._
