...
# Class Instance.Node (2.41.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> Instance.Node

## Implements

[Instance.NodeOrBuilder](/java/docs/reference/google-cloud-memcache/2.41.0/com.google.cloud.memcache.v1beta2.Instance.NodeOrBuilder)
...
### UPDATE\_AVAILABLE\_FIELD\_NUMBER
...
`[Instance.Node](/java/docs/reference/google-cloud-memcache/2.41.0/com.google.cloud.memcache.v1beta2.Instance.Node)`
...
`[Instance.Node.Builder](/java/docs/reference/google-cloud-memcache/2.41.0/com.google.cloud.memcache.v1beta2.Instance.Node.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[Node](/java/docs/reference/google-cloud-memcache/2.41.0/com.google.cloud.memcache.v1beta2.Instance.Node)>`
...
`[MemcacheParameters](/java/docs/reference/google-cloud-memcache/2.41.0/com.google.cloud.memcache.v1beta2.MemcacheParameters)`
...
`[MemcacheParametersOrBuilder](/java/docs/reference/google-cloud-memcache/2.41.0/com.google.cloud.memcache.v1beta2.MemcacheParametersOrBuilder)`
...
`[Instance.Node.State](/java/docs/reference/google-cloud-memcache/2.41.0/com.google.cloud.memcache.v1beta2.Instance.Node.State)`
