...
# Class GetVolumeRestoreRequest (0.32.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class GetVolumeRestoreRequest extends GeneratedMessageV3 implements GetVolumeRestoreRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> GetVolumeRestoreRequest

## Implements

[GetVolumeRestoreRequestOrBuilder](/java/docs/reference/google-cloud-gke-backup/0.32.0/com.google.cloud.gkebackup.v1.GetVolumeRestoreRequestOrBuilder)
...
```
public static GetVolumeRestoreRequest getDefaultInstance()
```
...
`[GetVolumeRestoreRequest](/java/docs/reference/google-cloud-gke-backup/0.32.0/com.google.cloud.gkebackup.v1.GetVolumeRestoreRequest)`
...
```
public static GetVolumeRestoreRequest.Builder newBuilder()
```
...
`[GetVolumeRestoreRequest.Builder](/java/docs/reference/google-cloud-gke-backup/0.32.0/com.google.cloud.gkebackup.v1.GetVolumeRestoreRequest.Builder)`

### newBuilder(GetVolumeRestoreRequest prototype)

```
public static GetVolumeRestoreRequest.Builder newBuilder(GetVolumeRestoreRequest prototype)
```
...
```
public static GetVolumeRestoreRequest parseDelimitedFrom(InputStream input)
```
...
```
public static GetVolumeRestoreRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetVolumeRestoreRequest parseFrom(byte[] data)
```
...
```
public static GetVolumeRestoreRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetVolumeRestoreRequest parseFrom(ByteString data)
```
...
```
public static GetVolumeRestoreRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetVolumeRestoreRequest parseFrom(CodedInputStream input)
```
...
```
public static GetVolumeRestoreRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetVolumeRestoreRequest parseFrom(InputStream input)
```
...
```
public static GetVolumeRestoreRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetVolumeRestoreRequest parseFrom(ByteBuffer data)
```
...
```
public static GetVolumeRestoreRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<GetVolumeRestoreRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[GetVolumeRestoreRequest](/java/docs/reference/google-cloud-gke-backup/0.32.0/com.google.cloud.gkebackup.v1.GetVolumeRestoreRequest)>`
...
```
public Parser<GetVolumeRestoreRequest> getParserForType()
```
...
```
public GetVolumeRestoreRequest.Builder newBuilderForType()
```
...
```
protected GetVolumeRestoreRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public GetVolumeRestoreRequest.Builder toBuilder()
```
