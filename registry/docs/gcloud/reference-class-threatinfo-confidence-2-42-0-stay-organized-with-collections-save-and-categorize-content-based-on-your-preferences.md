...
# Class ThreatInfo.Confidence (2.42.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class ThreatInfo.Confidence extends GeneratedMessageV3 implements ThreatInfo.ConfidenceOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ThreatInfo.Confidence

## Implements

[ThreatInfo.ConfidenceOrBuilder](/java/docs/reference/google-cloud-webrisk/2.42.0/com.google.webrisk.v1.ThreatInfo.ConfidenceOrBuilder)
...
```
public static ThreatInfo.Confidence getDefaultInstance()
```
...
`[ThreatInfo.Confidence](/java/docs/reference/google-cloud-webrisk/2.42.0/com.google.webrisk.v1.ThreatInfo.Confidence)`
...
```
public static ThreatInfo.Confidence.Builder newBuilder()
```
...
`[ThreatInfo.Confidence.Builder](/java/docs/reference/google-cloud-webrisk/2.42.0/com.google.webrisk.v1.ThreatInfo.Confidence.Builder)`

### newBuilder(ThreatInfo.Confidence prototype)

```
public static ThreatInfo.Confidence.Builder newBuilder(ThreatInfo.Confidence prototype)
```
...
```
public static ThreatInfo.Confidence parseDelimitedFrom(InputStream input)
```
...
```
public static ThreatInfo.Confidence parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ThreatInfo.Confidence parseFrom(byte[] data)
```
...
```
public static ThreatInfo.Confidence parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ThreatInfo.Confidence parseFrom(ByteString data)
```
...
```
public static ThreatInfo.Confidence parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ThreatInfo.Confidence parseFrom(CodedInputStream input)
```
...
```
public static ThreatInfo.Confidence parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ThreatInfo.Confidence parseFrom(InputStream input)
```
...
```
public static ThreatInfo.Confidence parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ThreatInfo.Confidence parseFrom(ByteBuffer data)
```
...
```
public static ThreatInfo.Confidence parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ThreatInfo.Confidence> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[Confidence](/java/docs/reference/google-cloud-webrisk/2.42.0/com.google.webrisk.v1.ThreatInfo.Confidence)>`
...
`[ThreatInfo.Confidence.ConfidenceLevel](/java/docs/reference/google-cloud-webrisk/2.42.0/com.google.webrisk.v1.ThreatInfo.Confidence.ConfidenceLevel)`
...
```
public Parser<ThreatInfo.Confidence> getParserForType()
```
...
`[ThreatInfo.Confidence.ValueCase](/java/docs/reference/google-cloud-webrisk/2.42.0/com.google.webrisk.v1.ThreatInfo.Confidence.ValueCase)`
...
```
public ThreatInfo.Confidence.Builder newBuilderForType()
```
...
```
protected ThreatInfo.Confidence.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ThreatInfo.Confidence.Builder toBuilder()
```
