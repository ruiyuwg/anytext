...
# Class Interstitials (0.48.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> Interstitials

## Implements

[InterstitialsOrBuilder](/java/docs/reference/google-cloud-video-stitcher/0.48.0/com.google.cloud.video.stitcher.v1.InterstitialsOrBuilder)
...
### SESSION\_CONTENT\_FIELD\_NUMBER
...
`[Interstitials](/java/docs/reference/google-cloud-video-stitcher/0.48.0/com.google.cloud.video.stitcher.v1.Interstitials)`
...
`[Interstitials.Builder](/java/docs/reference/google-cloud-video-stitcher/0.48.0/com.google.cloud.video.stitcher.v1.Interstitials.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[Interstitials](/java/docs/reference/google-cloud-video-stitcher/0.48.0/com.google.cloud.video.stitcher.v1.Interstitials)>`
...
`[VodSessionAdBreak](/java/docs/reference/google-cloud-video-stitcher/0.48.0/com.google.cloud.video.stitcher.v1.VodSessionAdBreak)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[VodSessionAdBreak](/java/docs/reference/google-cloud-video-stitcher/0.48.0/com.google.cloud.video.stitcher.v1.VodSessionAdBreak)>`
...
`[VodSessionAdBreakOrBuilder](/java/docs/reference/google-cloud-video-stitcher/0.48.0/com.google.cloud.video.stitcher.v1.VodSessionAdBreakOrBuilder)`
...
`[VodSessionContent](/java/docs/reference/google-cloud-video-stitcher/0.48.0/com.google.cloud.video.stitcher.v1.VodSessionContent)`
...
`[VodSessionContentOrBuilder](/java/docs/reference/google-cloud-video-stitcher/0.48.0/com.google.cloud.video.stitcher.v1.VodSessionContentOrBuilder)`
