...
# Class VpcAccessServiceClient.ListConnectorsFixedSizeCollection (2.16.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class VpcAccessServiceClient.ListConnectorsFixedSizeCollection extends AbstractFixedSizeCollection<ListConnectorsRequest,ListConnectorsResponse,Connector,VpcAccessServiceClient.ListConnectorsPage,VpcAccessServiceClient.ListConnectorsFixedSizeCollection>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractFixedSizeCollection](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractFixedSizeCollection.html) \> VpcAccessServiceClient.ListConnectorsFixedSizeCollection
...
### createCollection(List<VpcAccessServiceClient.ListConnectorsPage> pages, int collectionSize)

```
protected VpcAccessServiceClient.ListConnectorsFixedSizeCollection createCollection(List<VpcAccessServiceClient.ListConnectorsPage> pages, int collectionSize)
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ListConnectorsPage](/java/docs/reference/google-cloud-vpcaccess/2.16.0/com.google.cloud.vpcaccess.v1.VpcAccessServiceClient.ListConnectorsPage)>`  
...
`[VpcAccessServiceClient.ListConnectorsFixedSizeCollection](/java/docs/reference/google-cloud-vpcaccess/2.16.0/com.google.cloud.vpcaccess.v1.VpcAccessServiceClient.ListConnectorsFixedSizeCollection)`
