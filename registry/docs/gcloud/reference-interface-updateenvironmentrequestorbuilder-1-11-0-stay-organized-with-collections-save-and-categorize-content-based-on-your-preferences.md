...
# Interface UpdateEnvironmentRequestOrBuilder (1.11.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[Environment](/java/docs/reference/google-cloud-orchestration-airflow/1.11.0/com.google.cloud.orchestration.airflow.service.v1.Environment)`
...
`[EnvironmentOrBuilder](/java/docs/reference/google-cloud-orchestration-airflow/1.11.0/com.google.cloud.orchestration.airflow.service.v1.EnvironmentOrBuilder)`
