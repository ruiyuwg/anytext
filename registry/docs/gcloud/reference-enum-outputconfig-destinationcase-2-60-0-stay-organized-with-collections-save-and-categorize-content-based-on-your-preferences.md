...
# Enum OutputConfig.DestinationCase (2.60.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum OutputConfig.DestinationCase extends Enum<OutputConfig.DestinationCase> implements Internal.EnumLite, AbstractMessageLite.InternalOneOfEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-retail/2.60.0/com.google.cloud.retail.v2alpha.OutputConfig.DestinationCase#com_google_cloud_retail_v2alpha_OutputConfig_DestinationCase_forNumber_int_) instead._
