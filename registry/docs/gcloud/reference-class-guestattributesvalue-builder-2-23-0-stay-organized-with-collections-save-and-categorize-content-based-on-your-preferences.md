...
# Class GuestAttributesValue.Builder (2.23.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> GuestAttributesValue.Builder

## Implements

[GuestAttributesValueOrBuilder](/java/docs/reference/google-cloud-tpu/2.23.0/com.google.cloud.tpu.v2.GuestAttributesValueOrBuilder)
...
`[Iterable](https://docs.oracle.com/javase/8/docs/api/java/lang/Iterable.html)<? extends com.google.cloud.tpu.v2.GuestAttributesEntry>`  
...
`[GuestAttributesValue.Builder](/java/docs/reference/google-cloud-tpu/2.23.0/com.google.cloud.tpu.v2.GuestAttributesValue.Builder)`
...
`[GuestAttributesEntry](/java/docs/reference/google-cloud-tpu/2.23.0/com.google.cloud.tpu.v2.GuestAttributesEntry)`  
...
`[GuestAttributesEntry.Builder](/java/docs/reference/google-cloud-tpu/2.23.0/com.google.cloud.tpu.v2.GuestAttributesEntry.Builder)`  
...
`[GuestAttributesValue](/java/docs/reference/google-cloud-tpu/2.23.0/com.google.cloud.tpu.v2.GuestAttributesValue)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Builder](/java/docs/reference/google-cloud-tpu/2.23.0/com.google.cloud.tpu.v2.GuestAttributesEntry.Builder)>`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[GuestAttributesEntry](/java/docs/reference/google-cloud-tpu/2.23.0/com.google.cloud.tpu.v2.GuestAttributesEntry)>`
...
`[GuestAttributesEntryOrBuilder](/java/docs/reference/google-cloud-tpu/2.23.0/com.google.cloud.tpu.v2.GuestAttributesEntryOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.tpu.v2.GuestAttributesEntryOrBuilder>`
