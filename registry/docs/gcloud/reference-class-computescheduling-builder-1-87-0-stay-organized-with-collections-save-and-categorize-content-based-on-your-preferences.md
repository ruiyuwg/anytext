...
# Class ComputeScheduling.Builder (1.87.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class ComputeScheduling.Builder extends GeneratedMessage.Builder<ComputeScheduling.Builder> implements ComputeSchedulingOrBuilder
```
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessage.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessage.Builder.html) \> ComputeScheduling.Builder

## Implements

[ComputeSchedulingOrBuilder](/java/docs/reference/google-cloud-vmmigration/latest/com.google.cloud.vmmigration.v1.ComputeSchedulingOrBuilder)
...
`[Iterable](https://docs.oracle.com/javase/8/docs/api/java/lang/Iterable.html)<? extends com.google.cloud.vmmigration.v1.SchedulingNodeAffinity>`  
...
`[ComputeScheduling.Builder](/java/docs/reference/google-cloud-vmmigration/latest/com.google.cloud.vmmigration.v1.ComputeScheduling.Builder)`
...
`[SchedulingNodeAffinity](/java/docs/reference/google-cloud-vmmigration/latest/com.google.cloud.vmmigration.v1.SchedulingNodeAffinity)`  
...
`[SchedulingNodeAffinity.Builder](/java/docs/reference/google-cloud-vmmigration/latest/com.google.cloud.vmmigration.v1.SchedulingNodeAffinity.Builder)`  
...
`[ComputeScheduling](/java/docs/reference/google-cloud-vmmigration/latest/com.google.cloud.vmmigration.v1.ComputeScheduling)`
...
The minimum number of virtual CPUs this instance will consume when running on a sole-tenant node. Ignored if no node\_affinites are configured.
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Builder](/java/docs/reference/google-cloud-vmmigration/latest/com.google.cloud.vmmigration.v1.SchedulingNodeAffinity.Builder)>`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[SchedulingNodeAffinity](/java/docs/reference/google-cloud-vmmigration/latest/com.google.cloud.vmmigration.v1.SchedulingNodeAffinity)>`
...
`[SchedulingNodeAffinityOrBuilder](/java/docs/reference/google-cloud-vmmigration/latest/com.google.cloud.vmmigration.v1.SchedulingNodeAffinityOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.vmmigration.v1.SchedulingNodeAffinityOrBuilder>`
...
`[ComputeScheduling.OnHostMaintenance](/java/docs/reference/google-cloud-vmmigration/latest/com.google.cloud.vmmigration.v1.ComputeScheduling.OnHostMaintenance)`
...
`[ComputeScheduling.RestartType](/java/docs/reference/google-cloud-vmmigration/latest/com.google.cloud.vmmigration.v1.ComputeScheduling.RestartType)`
...
The enum numeric value on the wire for restartType to set.
