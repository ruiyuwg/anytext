...
# Class SecurityCenterClient.GroupAssetsPage (2.57.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class SecurityCenterClient.GroupAssetsPage extends AbstractPage<GroupAssetsRequest,GroupAssetsResponse,GroupResult,SecurityCenterClient.GroupAssetsPage>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractPage](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractPage.html) \> SecurityCenterClient.GroupAssetsPage
...
### createPage(PageContext<GroupAssetsRequest,GroupAssetsResponse,GroupResult> context, GroupAssetsResponse response)

```
protected SecurityCenterClient.GroupAssetsPage createPage(PageContext<GroupAssetsRequest,GroupAssetsResponse,GroupResult> context, GroupAssetsResponse response)
```
...
`[PageContext](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PageContext.html)<[GroupAssetsRequest](/java/docs/reference/google-cloud-securitycenter/2.57.0/com.google.cloud.securitycenter.v1p1beta1.GroupAssetsRequest),[GroupAssetsResponse](/java/docs/reference/google-cloud-securitycenter/2.57.0/com.google.cloud.securitycenter.v1p1beta1.GroupAssetsResponse),[GroupResult](/java/docs/reference/google-cloud-securitycenter/2.57.0/com.google.cloud.securitycenter.v1p1beta1.GroupResult)>`  

`response`

`[GroupAssetsResponse](/java/docs/reference/google-cloud-securitycenter/2.57.0/com.google.cloud.securitycenter.v1p1beta1.GroupAssetsResponse)`  
...
`[SecurityCenterClient.GroupAssetsPage](/java/docs/reference/google-cloud-securitycenter/2.57.0/com.google.cloud.securitycenter.v1p1beta1.SecurityCenterClient.GroupAssetsPage)`
...
### createPageAsync(PageContext<GroupAssetsRequest,GroupAssetsResponse,GroupResult> context, ApiFuture<GroupAssetsResponse> futureResponse)

```
public ApiFuture<SecurityCenterClient.GroupAssetsPage> createPageAsync(PageContext<GroupAssetsRequest,GroupAssetsResponse,GroupResult> context, ApiFuture<GroupAssetsResponse> futureResponse)
```
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[GroupAssetsResponse](/java/docs/reference/google-cloud-securitycenter/2.57.0/com.google.cloud.securitycenter.v1p1beta1.GroupAssetsResponse)>`  
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[GroupAssetsPage](/java/docs/reference/google-cloud-securitycenter/2.57.0/com.google.cloud.securitycenter.v1p1beta1.SecurityCenterClient.GroupAssetsPage)>`
