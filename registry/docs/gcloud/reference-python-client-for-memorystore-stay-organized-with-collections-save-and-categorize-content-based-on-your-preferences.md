...
# Python Client for Memorystore Stay organized with collections Save and categorize content based on your preferences.

Version latestkeyboard\_arrow\_down

-   [0.3.0 (latest)](/python/docs/reference/google-cloud-memorystore/latest)
-   [0.2.0](/python/docs/reference/google-cloud-memorystore/0.2.0)
-   [0.1.3](/python/docs/reference/google-cloud-memorystore/0.1.3)

[![image](https://img.shields.io/badge/support-preview-orange.svg)](https://github.com/googleapis/google-cloud-python/blob/main/README.rst#stability-levels) [![image](https://img.shields.io/pypi/v/google-cloud-memorystore.svg)](https://pypi.org/project/google-cloud-memorystore/) [![image](https://img.shields.io/pypi/pyversions/google-cloud-memorystore.svg)](https://pypi.org/project/google-cloud-memorystore/)

[Memorystore](https://cloud.google.com/memorystore/docs/valkey): Memorystore for Valkey is a fully managed Valkey Cluster service for Google Cloud. Applications running on Google Cloud can achieve extreme performance by leveraging the highly scalable, available, secure Valkey service without the burden of managing complex Valkey deployments.

-   [Client Library Documentation](https://cloud.google.com/python/docs/reference/google-cloud-memorystore/latest/summary_overview)
    
-   [Product Documentation](https://cloud.google.com/memorystore/docs/valkey)
...
3.  [Enable the Memorystore.](https://cloud.google.com/memorystore/docs/valkey)
...
Code samples and snippets live in the [samples/](https://github.com/googleapis/google-cloud-python/tree/main/packages/google-cloud-memorystore/samples) folder.
...
-   Read the [Client Library Documentation](https://cloud.google.com/python/docs/reference/google-cloud-memorystore/latest/summary_overview) for Memorystore to see other available methods on the client.
    
-   Read the [Memorystore Product documentation](https://cloud.google.com/memorystore/docs/valkey) to learn more about the product and see How-to Guides.
