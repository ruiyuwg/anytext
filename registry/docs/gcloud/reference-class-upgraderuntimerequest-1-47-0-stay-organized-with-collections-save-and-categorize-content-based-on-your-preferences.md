...
# Class UpgradeRuntimeRequest (1.47.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class UpgradeRuntimeRequest extends GeneratedMessageV3 implements UpgradeRuntimeRequestOrBuilder
```

Request for upgrading a Managed Notebook Runtime to the latest version. option (google.api.message\_visibility).restriction = "TRUSTED\_TESTER,SPECIAL\_TESTER";

Protobuf type `google.cloud.notebooks.v1.UpgradeRuntimeRequest`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> UpgradeRuntimeRequest

## Implements

[UpgradeRuntimeRequestOrBuilder](/java/docs/reference/google-cloud-notebooks/1.47.0/com.google.cloud.notebooks.v1.UpgradeRuntimeRequestOrBuilder)
...
```
public static UpgradeRuntimeRequest getDefaultInstance()
```
...
`[UpgradeRuntimeRequest](/java/docs/reference/google-cloud-notebooks/1.47.0/com.google.cloud.notebooks.v1.UpgradeRuntimeRequest)`
...
```
public static UpgradeRuntimeRequest.Builder newBuilder()
```
...
`[UpgradeRuntimeRequest.Builder](/java/docs/reference/google-cloud-notebooks/1.47.0/com.google.cloud.notebooks.v1.UpgradeRuntimeRequest.Builder)`

### newBuilder(UpgradeRuntimeRequest prototype)

```
public static UpgradeRuntimeRequest.Builder newBuilder(UpgradeRuntimeRequest prototype)
```
...
```
public static UpgradeRuntimeRequest parseDelimitedFrom(InputStream input)
```
...
```
public static UpgradeRuntimeRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpgradeRuntimeRequest parseFrom(byte[] data)
```
...
```
public static UpgradeRuntimeRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpgradeRuntimeRequest parseFrom(ByteString data)
```
...
```
public static UpgradeRuntimeRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpgradeRuntimeRequest parseFrom(CodedInputStream input)
```
...
```
public static UpgradeRuntimeRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpgradeRuntimeRequest parseFrom(InputStream input)
```
...
```
public static UpgradeRuntimeRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpgradeRuntimeRequest parseFrom(ByteBuffer data)
```
...
```
public static UpgradeRuntimeRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<UpgradeRuntimeRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[UpgradeRuntimeRequest](/java/docs/reference/google-cloud-notebooks/1.47.0/com.google.cloud.notebooks.v1.UpgradeRuntimeRequest)>`
...
```
public UpgradeRuntimeRequest getDefaultInstanceForType()
```
...
```
public Parser<UpgradeRuntimeRequest> getParserForType()
```
...
```
public UpgradeRuntimeRequest.Builder newBuilderForType()
```
...
```
protected UpgradeRuntimeRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public UpgradeRuntimeRequest.Builder toBuilder()
```
