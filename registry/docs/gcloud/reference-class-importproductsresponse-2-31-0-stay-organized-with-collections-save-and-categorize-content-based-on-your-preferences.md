...
# Class ImportProductsResponse (2.31.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ImportProductsResponse extends GeneratedMessageV3 implements ImportProductsResponseOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ImportProductsResponse

## Implements

[ImportProductsResponseOrBuilder](/java/docs/reference/google-cloud-retail/2.31.0/com.google.cloud.retail.v2beta.ImportProductsResponseOrBuilder)
...
```
public static ImportProductsResponse getDefaultInstance()
```
...
`[ImportProductsResponse](/java/docs/reference/google-cloud-retail/2.31.0/com.google.cloud.retail.v2beta.ImportProductsResponse)`
...
```
public static ImportProductsResponse.Builder newBuilder()
```
...
`[ImportProductsResponse.Builder](/java/docs/reference/google-cloud-retail/2.31.0/com.google.cloud.retail.v2beta.ImportProductsResponse.Builder)`

### newBuilder(ImportProductsResponse prototype)

```
public static ImportProductsResponse.Builder newBuilder(ImportProductsResponse prototype)
```
...
```
public static ImportProductsResponse parseDelimitedFrom(InputStream input)
```
...
```
public static ImportProductsResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ImportProductsResponse parseFrom(byte[] data)
```
...
```
public static ImportProductsResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ImportProductsResponse parseFrom(ByteString data)
```
...
```
public static ImportProductsResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ImportProductsResponse parseFrom(CodedInputStream input)
```
...
```
public static ImportProductsResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ImportProductsResponse parseFrom(InputStream input)
```
...
```
public static ImportProductsResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ImportProductsResponse parseFrom(ByteBuffer data)
```
...
```
public static ImportProductsResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ImportProductsResponse> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ImportProductsResponse](/java/docs/reference/google-cloud-retail/2.31.0/com.google.cloud.retail.v2beta.ImportProductsResponse)>`
...
```
public ImportProductsResponse getDefaultInstanceForType()
```
...
`.google.cloud.retail.v2beta.ImportErrorsConfig errors_config = 2;`
...
`[ImportErrorsConfig](/java/docs/reference/google-cloud-retail/2.31.0/com.google.cloud.retail.v2beta.ImportErrorsConfig)`
...
`[ImportErrorsConfigOrBuilder](/java/docs/reference/google-cloud-retail/2.31.0/com.google.cloud.retail.v2beta.ImportErrorsConfigOrBuilder)`

### getParserForType()

```
public Parser<ImportProductsResponse> getParserForType()
```
...
```
public ImportProductsResponse.Builder newBuilderForType()
```
...
```
protected ImportProductsResponse.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ImportProductsResponse.Builder toBuilder()
```
