...
# Interface DominantColorsAnnotationOrBuilder (3.7.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[ColorInfo](/java/docs/reference/google-cloud-vision/3.7.0/com.google.cloud.vision.v1p2beta1.ColorInfo)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ColorInfo](/java/docs/reference/google-cloud-vision/3.7.0/com.google.cloud.vision.v1p2beta1.ColorInfo)>`
...
`[ColorInfoOrBuilder](/java/docs/reference/google-cloud-vision/3.7.0/com.google.cloud.vision.v1p2beta1.ColorInfoOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.vision.v1p2beta1.ColorInfoOrBuilder>`
