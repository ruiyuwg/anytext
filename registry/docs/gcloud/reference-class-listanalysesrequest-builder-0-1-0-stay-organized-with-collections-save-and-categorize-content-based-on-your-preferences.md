...
# Class ListAnalysesRequest.Builder (0.1.0) Stay organized with collections Save and categorize content based on your preferences.
...
Protobuf type `google.cloud.visionai.v1.ListAnalysesRequest`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> ListAnalysesRequest.Builder

## Implements

[ListAnalysesRequestOrBuilder](/java/docs/reference/google-cloud-visionai/0.1.0/com.google.cloud.visionai.v1.ListAnalysesRequestOrBuilder)
...
`[ListAnalysesRequest.Builder](/java/docs/reference/google-cloud-visionai/0.1.0/com.google.cloud.visionai.v1.ListAnalysesRequest.Builder)`
...
`[ListAnalysesRequest](/java/docs/reference/google-cloud-visionai/0.1.0/com.google.cloud.visionai.v1.ListAnalysesRequest)`
...
```
public ListAnalysesRequest.Builder clearOrderBy()
```
...
```
public ListAnalysesRequest.Builder setOrderBy(String value)
```
...
```
public ListAnalysesRequest.Builder setOrderByBytes(ByteString value)
```
