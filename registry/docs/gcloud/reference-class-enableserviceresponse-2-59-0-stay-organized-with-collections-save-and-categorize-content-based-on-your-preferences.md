...
# Class EnableServiceResponse (2.59.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class EnableServiceResponse extends GeneratedMessageV3 implements EnableServiceResponseOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> EnableServiceResponse

## Implements

[EnableServiceResponseOrBuilder](/java/docs/reference/google-cloud-service-usage/2.59.0/com.google.api.serviceusage.v1.EnableServiceResponseOrBuilder)
...
```
public static EnableServiceResponse getDefaultInstance()
```
...
`[EnableServiceResponse](/java/docs/reference/google-cloud-service-usage/2.59.0/com.google.api.serviceusage.v1.EnableServiceResponse)`
...
```
public static EnableServiceResponse.Builder newBuilder()
```
...
`[EnableServiceResponse.Builder](/java/docs/reference/google-cloud-service-usage/2.59.0/com.google.api.serviceusage.v1.EnableServiceResponse.Builder)`

### newBuilder(EnableServiceResponse prototype)

```
public static EnableServiceResponse.Builder newBuilder(EnableServiceResponse prototype)
```
...
```
public static EnableServiceResponse parseDelimitedFrom(InputStream input)
```
...
```
public static EnableServiceResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static EnableServiceResponse parseFrom(byte[] data)
```
...
```
public static EnableServiceResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static EnableServiceResponse parseFrom(ByteString data)
```
...
```
public static EnableServiceResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static EnableServiceResponse parseFrom(CodedInputStream input)
```
...
```
public static EnableServiceResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static EnableServiceResponse parseFrom(InputStream input)
```
...
```
public static EnableServiceResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static EnableServiceResponse parseFrom(ByteBuffer data)
```
...
```
public static EnableServiceResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<EnableServiceResponse> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[EnableServiceResponse](/java/docs/reference/google-cloud-service-usage/2.59.0/com.google.api.serviceusage.v1.EnableServiceResponse)>`
...
```
public Parser<EnableServiceResponse> getParserForType()
```
...
`[Service](/java/docs/reference/google-cloud-service-usage/2.59.0/com.google.api.serviceusage.v1.Service)`
...
`[ServiceOrBuilder](/java/docs/reference/google-cloud-service-usage/2.59.0/com.google.api.serviceusage.v1.ServiceOrBuilder)`
...
```
public EnableServiceResponse.Builder newBuilderForType()
```
...
```
protected EnableServiceResponse.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public EnableServiceResponse.Builder toBuilder()
```
