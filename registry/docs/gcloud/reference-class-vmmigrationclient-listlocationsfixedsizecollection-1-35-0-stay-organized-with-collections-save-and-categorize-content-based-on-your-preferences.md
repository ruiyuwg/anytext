...
# Class VmMigrationClient.ListLocationsFixedSizeCollection (1.35.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class VmMigrationClient.ListLocationsFixedSizeCollection extends AbstractFixedSizeCollection<ListLocationsRequest,ListLocationsResponse,Location,VmMigrationClient.ListLocationsPage,VmMigrationClient.ListLocationsFixedSizeCollection>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractFixedSizeCollection](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractFixedSizeCollection.html) \> VmMigrationClient.ListLocationsFixedSizeCollection
...
### createCollection(List<VmMigrationClient.ListLocationsPage> pages, int collectionSize)

```
protected VmMigrationClient.ListLocationsFixedSizeCollection createCollection(List<VmMigrationClient.ListLocationsPage> pages, int collectionSize)
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ListLocationsPage](/java/docs/reference/google-cloud-vmmigration/1.35.0/com.google.cloud.vmmigration.v1.VmMigrationClient.ListLocationsPage)>`  
...
`[VmMigrationClient.ListLocationsFixedSizeCollection](/java/docs/reference/google-cloud-vmmigration/1.35.0/com.google.cloud.vmmigration.v1.VmMigrationClient.ListLocationsFixedSizeCollection)`
