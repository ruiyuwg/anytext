...
# Class ListQuotaGroupsResponse (0.12.0) Stay organized with collections Save and categorize content based on your preferences.
...
[ListQuotaGroupsResponseOrBuilder](/java/docs/reference/google-shopping-merchant-quota/0.12.0/com.google.shopping.merchant.quota.v1beta.ListQuotaGroupsResponseOrBuilder)
...
`[ListQuotaGroupsResponse](/java/docs/reference/google-shopping-merchant-quota/0.12.0/com.google.shopping.merchant.quota.v1beta.ListQuotaGroupsResponse)`
...
`[ListQuotaGroupsResponse.Builder](/java/docs/reference/google-shopping-merchant-quota/0.12.0/com.google.shopping.merchant.quota.v1beta.ListQuotaGroupsResponse.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListQuotaGroupsResponse](/java/docs/reference/google-shopping-merchant-quota/0.12.0/com.google.shopping.merchant.quota.v1beta.ListQuotaGroupsResponse)>`
...
`[QuotaGroup](/java/docs/reference/google-shopping-merchant-quota/0.12.0/com.google.shopping.merchant.quota.v1beta.QuotaGroup)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[QuotaGroup](/java/docs/reference/google-shopping-merchant-quota/0.12.0/com.google.shopping.merchant.quota.v1beta.QuotaGroup)>`
...
`[QuotaGroupOrBuilder](/java/docs/reference/google-shopping-merchant-quota/0.12.0/com.google.shopping.merchant.quota.v1beta.QuotaGroupOrBuilder)`
