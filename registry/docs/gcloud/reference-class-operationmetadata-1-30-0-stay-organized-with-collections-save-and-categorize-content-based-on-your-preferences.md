...
# Class OperationMetadata (1.30.0) Stay organized with collections Save and categorize content based on your preferences.
...
[OperationMetadataOrBuilder](/java/docs/reference/google-cloud-network-management/1.30.0/com.google.cloud.networkmanagement.v1.OperationMetadataOrBuilder)
...
### CANCEL\_REQUESTED\_FIELD\_NUMBER
...
`[OperationMetadata](/java/docs/reference/google-cloud-network-management/1.30.0/com.google.cloud.networkmanagement.v1.OperationMetadata)`
...
`[OperationMetadata.Builder](/java/docs/reference/google-cloud-network-management/1.30.0/com.google.cloud.networkmanagement.v1.OperationMetadata.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[OperationMetadata](/java/docs/reference/google-cloud-network-management/1.30.0/com.google.cloud.networkmanagement.v1.OperationMetadata)>`
