...
# Interface RemoveGroupMigrationRequestOrBuilder (1.52.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface RemoveGroupMigrationRequestOrBuilder extends MessageOrBuilder
```
