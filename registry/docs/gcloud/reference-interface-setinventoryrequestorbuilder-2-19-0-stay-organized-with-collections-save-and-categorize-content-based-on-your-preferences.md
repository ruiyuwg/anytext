...
# Interface SetInventoryRequestOrBuilder (2.19.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[Product](/java/docs/reference/google-cloud-retail/2.19.0/com.google.cloud.retail.v2beta.Product)`
...
`[ProductOrBuilder](/java/docs/reference/google-cloud-retail/2.19.0/com.google.cloud.retail.v2beta.ProductOrBuilder)`
