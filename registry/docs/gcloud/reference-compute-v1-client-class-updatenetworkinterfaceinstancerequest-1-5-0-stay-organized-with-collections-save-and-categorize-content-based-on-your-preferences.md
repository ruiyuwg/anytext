...
# Compute V1 Client - Class UpdateNetworkInterfaceInstanceRequest (1.5.0) Stay organized with collections Save and categorize content based on your preferences.
...
Reference documentation and code samples for the Compute V1 Client class UpdateNetworkInterfaceInstanceRequest.

A request message for Instances.UpdateNetworkInterface. See the method description for details.

Generated from protobuf message `google.cloud.compute.v1.UpdateNetworkInterfaceInstanceRequest`
...
`[Google\Cloud\Compute\V1\NetworkInterface](/php/docs/reference/cloud-compute/1.5.0/V1.NetworkInterface)`  
...
Generated from protobuf field `.google.cloud.compute.v1.NetworkInterface network_interface_resource = 325814789 [(.google.api.field_behavior) = REQUIRED];`
...
`[Google\Cloud\Compute\V1\NetworkInterface](/php/docs/reference/cloud-compute/1.5.0/V1.NetworkInterface)|null`
