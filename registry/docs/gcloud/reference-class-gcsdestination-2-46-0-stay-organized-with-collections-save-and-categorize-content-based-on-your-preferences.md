...
# Class GcsDestination (2.46.0) Stay organized with collections Save and categorize content based on your preferences.
...
[GcsDestinationOrBuilder](/java/docs/reference/google-cloud-redis/2.46.0/com.google.cloud.redis.v1beta1.GcsDestinationOrBuilder)
...
`[GcsDestination](/java/docs/reference/google-cloud-redis/2.46.0/com.google.cloud.redis.v1beta1.GcsDestination)`
...
`[GcsDestination.Builder](/java/docs/reference/google-cloud-redis/2.46.0/com.google.cloud.redis.v1beta1.GcsDestination.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[GcsDestination](/java/docs/reference/google-cloud-redis/2.46.0/com.google.cloud.redis.v1beta1.GcsDestination)>`
...
Required. Data destination URI (e.g. 'gs://my\_bucket/my\_object'). Existing files will be overwritten.
