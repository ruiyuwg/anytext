...
# Class OsConfigZonalServiceClient.ListOSPolicyAssignmentRevisionsPage (2.48.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class OsConfigZonalServiceClient.ListOSPolicyAssignmentRevisionsPage extends AbstractPage<ListOSPolicyAssignmentRevisionsRequest,ListOSPolicyAssignmentRevisionsResponse,OSPolicyAssignment,OsConfigZonalServiceClient.ListOSPolicyAssignmentRevisionsPage>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractPage](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractPage.html) \> OsConfigZonalServiceClient.ListOSPolicyAssignmentRevisionsPage
...
### createPage(PageContext<ListOSPolicyAssignmentRevisionsRequest,ListOSPolicyAssignmentRevisionsResponse,OSPolicyAssignment> context, ListOSPolicyAssignmentRevisionsResponse response)

```
protected OsConfigZonalServiceClient.ListOSPolicyAssignmentRevisionsPage createPage(PageContext<ListOSPolicyAssignmentRevisionsRequest,ListOSPolicyAssignmentRevisionsResponse,OSPolicyAssignment> context, ListOSPolicyAssignmentRevisionsResponse response)
```
...
`[PageContext](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PageContext.html)<[ListOSPolicyAssignmentRevisionsRequest](/java/docs/reference/google-cloud-os-config/2.48.0/com.google.cloud.osconfig.v1alpha.ListOSPolicyAssignmentRevisionsRequest),[ListOSPolicyAssignmentRevisionsResponse](/java/docs/reference/google-cloud-os-config/2.48.0/com.google.cloud.osconfig.v1alpha.ListOSPolicyAssignmentRevisionsResponse),[OSPolicyAssignment](/java/docs/reference/google-cloud-os-config/2.48.0/com.google.cloud.osconfig.v1alpha.OSPolicyAssignment)>`  

`response`

`[ListOSPolicyAssignmentRevisionsResponse](/java/docs/reference/google-cloud-os-config/2.48.0/com.google.cloud.osconfig.v1alpha.ListOSPolicyAssignmentRevisionsResponse)`  
...
`[OsConfigZonalServiceClient.ListOSPolicyAssignmentRevisionsPage](/java/docs/reference/google-cloud-os-config/2.48.0/com.google.cloud.osconfig.v1alpha.OsConfigZonalServiceClient.ListOSPolicyAssignmentRevisionsPage)`
...
### createPageAsync(PageContext<ListOSPolicyAssignmentRevisionsRequest,ListOSPolicyAssignmentRevisionsResponse,OSPolicyAssignment> context, ApiFuture<ListOSPolicyAssignmentRevisionsResponse> futureResponse)

```
public ApiFuture<OsConfigZonalServiceClient.ListOSPolicyAssignmentRevisionsPage> createPageAsync(PageContext<ListOSPolicyAssignmentRevisionsRequest,ListOSPolicyAssignmentRevisionsResponse,OSPolicyAssignment> context, ApiFuture<ListOSPolicyAssignmentRevisionsResponse> futureResponse)
```
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListOSPolicyAssignmentRevisionsResponse](/java/docs/reference/google-cloud-os-config/2.48.0/com.google.cloud.osconfig.v1alpha.ListOSPolicyAssignmentRevisionsResponse)>`  
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListOSPolicyAssignmentRevisionsPage](/java/docs/reference/google-cloud-os-config/2.48.0/com.google.cloud.osconfig.v1alpha.OsConfigZonalServiceClient.ListOSPolicyAssignmentRevisionsPage)>`
