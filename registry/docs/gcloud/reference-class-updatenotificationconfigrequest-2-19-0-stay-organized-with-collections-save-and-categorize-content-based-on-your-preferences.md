...
# Class UpdateNotificationConfigRequest (2.19.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class UpdateNotificationConfigRequest extends GeneratedMessageV3 implements UpdateNotificationConfigRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> UpdateNotificationConfigRequest

## Implements

[UpdateNotificationConfigRequestOrBuilder](/java/docs/reference/google-cloud-securitycenter/2.19.0/com.google.cloud.securitycenter.v1p1beta1.UpdateNotificationConfigRequestOrBuilder)
...
### NOTIFICATION\_CONFIG\_FIELD\_NUMBER
...
```
public static UpdateNotificationConfigRequest getDefaultInstance()
```
...
`[UpdateNotificationConfigRequest](/java/docs/reference/google-cloud-securitycenter/2.19.0/com.google.cloud.securitycenter.v1p1beta1.UpdateNotificationConfigRequest)`
...
```
public static UpdateNotificationConfigRequest.Builder newBuilder()
```
...
`[UpdateNotificationConfigRequest.Builder](/java/docs/reference/google-cloud-securitycenter/2.19.0/com.google.cloud.securitycenter.v1p1beta1.UpdateNotificationConfigRequest.Builder)`

### newBuilder(UpdateNotificationConfigRequest prototype)

```
public static UpdateNotificationConfigRequest.Builder newBuilder(UpdateNotificationConfigRequest prototype)
```
...
```
public static UpdateNotificationConfigRequest parseDelimitedFrom(InputStream input)
```
...
```
public static UpdateNotificationConfigRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateNotificationConfigRequest parseFrom(byte[] data)
```
...
```
public static UpdateNotificationConfigRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateNotificationConfigRequest parseFrom(ByteString data)
```
...
```
public static UpdateNotificationConfigRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateNotificationConfigRequest parseFrom(CodedInputStream input)
```
...
```
public static UpdateNotificationConfigRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateNotificationConfigRequest parseFrom(InputStream input)
```
...
```
public static UpdateNotificationConfigRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateNotificationConfigRequest parseFrom(ByteBuffer data)
```
...
```
public static UpdateNotificationConfigRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<UpdateNotificationConfigRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[UpdateNotificationConfigRequest](/java/docs/reference/google-cloud-securitycenter/2.19.0/com.google.cloud.securitycenter.v1p1beta1.UpdateNotificationConfigRequest)>`
...
`[NotificationConfig](/java/docs/reference/google-cloud-securitycenter/2.19.0/com.google.cloud.securitycenter.v1p1beta1.NotificationConfig)`
...
`[NotificationConfigOrBuilder](/java/docs/reference/google-cloud-securitycenter/2.19.0/com.google.cloud.securitycenter.v1p1beta1.NotificationConfigOrBuilder)`

### getParserForType()

```
public Parser<UpdateNotificationConfigRequest> getParserForType()
```
...
```
public UpdateNotificationConfigRequest.Builder newBuilderForType()
```
...
```
protected UpdateNotificationConfigRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public UpdateNotificationConfigRequest.Builder toBuilder()
```
