...
# google-cloud-memcache overview (2.87.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Cloud Memcache Description:** Is a fully-managed in-memory data store service for Memcache.

[Cloud Memcache Product Reference](https://cloud.google.com/memorystore/)

[GitHub Repository](https://github.com/googleapis/google-cloud-java/tree/main/java-memcache)

[Maven artifact](https://central.sonatype.com/artifact/com.google.cloud/google-cloud-memcache)
...
-   [Enable the API](https://console.cloud.google.com/apis/library/memcache.googleapis.com)
-   [Set up authentication](https://cloud.google.com/docs/authentication/client-libraries)

## Use the Cloud Memcache for Java
...
The example below demonstrates how you would import the BOM and include the `google-cloud-memcache` artifact.
...
libraryDependencies += "com.google.cloud" % "google-cloud-memcache" % "2.87.0"

## Which version ID should I get started with?

For this library, we recommend using [com.google.cloud.memcache.v1](https://cloud.google.com/java/docs/reference/google-cloud-memcache/2.87.0/com.google.cloud.memcache.v1) for new applications.
