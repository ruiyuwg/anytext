...
# Class ControlServiceLimitedErrorCountRetryPolicy (2.14.0) Stay organized with collections Save and categorize content based on your preferences.
...
A retry policy for [`ControlServiceConnection`](/cpp/docs/reference/retail/2.14.0/classgoogle_1_1cloud_1_1retail__v2_1_1ControlServiceConnection) based on counting errors.
...
-   [`kUnavailable`](/cpp/docs/reference/retail/2.14.0/namespacegoogle_1_1cloud_1a90e17f75452470f0f3ee1a06ffe58847)
...
`ControlServiceLimitedErrorCountRetryPolicy const &`  
...
`std::unique_ptr< ControlServiceRetryPolicy >`

## Type Aliases

### BaseType

**Alias Of**: `ControlServiceRetryPolicy`
