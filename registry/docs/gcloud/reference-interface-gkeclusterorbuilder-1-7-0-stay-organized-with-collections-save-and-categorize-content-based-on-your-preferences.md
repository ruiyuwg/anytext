...
# Interface GkeClusterOrBuilder (1.7.0) Stay organized with collections Save and categorize content based on your preferences.
...
Output only. If cluster\_missing is set then it denotes that the GKE cluster no longer exists in the GKE Control Plane.
