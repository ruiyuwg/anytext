...
# Class ReplicationStatus.UserManagedStatus.ReplicaStatus (2.35.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class ReplicationStatus.UserManagedStatus.ReplicaStatus extends GeneratedMessageV3 implements ReplicationStatus.UserManagedStatus.ReplicaStatusOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ReplicationStatus.UserManagedStatus.ReplicaStatus

## Implements

[ReplicationStatus.UserManagedStatus.ReplicaStatusOrBuilder](/java/docs/reference/google-cloud-secretmanager/2.35.0/com.google.cloud.secretmanager.v1.ReplicationStatus.UserManagedStatus.ReplicaStatusOrBuilder)
...
### CUSTOMER\_MANAGED\_ENCRYPTION\_FIELD\_NUMBER
...
```
public static ReplicationStatus.UserManagedStatus.ReplicaStatus getDefaultInstance()
```
...
`[ReplicationStatus.UserManagedStatus.ReplicaStatus](/java/docs/reference/google-cloud-secretmanager/2.35.0/com.google.cloud.secretmanager.v1.ReplicationStatus.UserManagedStatus.ReplicaStatus)`
...
```
public static ReplicationStatus.UserManagedStatus.ReplicaStatus.Builder newBuilder()
```
...
`[ReplicationStatus.UserManagedStatus.ReplicaStatus.Builder](/java/docs/reference/google-cloud-secretmanager/2.35.0/com.google.cloud.secretmanager.v1.ReplicationStatus.UserManagedStatus.ReplicaStatus.Builder)`

### newBuilder(ReplicationStatus.UserManagedStatus.ReplicaStatus prototype)

```
public static ReplicationStatus.UserManagedStatus.ReplicaStatus.Builder newBuilder(ReplicationStatus.UserManagedStatus.ReplicaStatus prototype)
```
...
```
public static ReplicationStatus.UserManagedStatus.ReplicaStatus parseDelimitedFrom(InputStream input)
```
...
```
public static ReplicationStatus.UserManagedStatus.ReplicaStatus parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ReplicationStatus.UserManagedStatus.ReplicaStatus parseFrom(byte[] data)
```
...
```
public static ReplicationStatus.UserManagedStatus.ReplicaStatus parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ReplicationStatus.UserManagedStatus.ReplicaStatus parseFrom(ByteString data)
```
...
```
public static ReplicationStatus.UserManagedStatus.ReplicaStatus parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ReplicationStatus.UserManagedStatus.ReplicaStatus parseFrom(CodedInputStream input)
```
...
```
public static ReplicationStatus.UserManagedStatus.ReplicaStatus parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ReplicationStatus.UserManagedStatus.ReplicaStatus parseFrom(InputStream input)
```
...
```
public static ReplicationStatus.UserManagedStatus.ReplicaStatus parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ReplicationStatus.UserManagedStatus.ReplicaStatus parseFrom(ByteBuffer data)
```
...
```
public static ReplicationStatus.UserManagedStatus.ReplicaStatus parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ReplicationStatus.UserManagedStatus.ReplicaStatus> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ReplicaStatus](/java/docs/reference/google-cloud-secretmanager/2.35.0/com.google.cloud.secretmanager.v1.ReplicationStatus.UserManagedStatus.ReplicaStatus)>`
...
`[CustomerManagedEncryptionStatus](/java/docs/reference/google-cloud-secretmanager/2.35.0/com.google.cloud.secretmanager.v1.CustomerManagedEncryptionStatus)`
...
`[CustomerManagedEncryptionStatusOrBuilder](/java/docs/reference/google-cloud-secretmanager/2.35.0/com.google.cloud.secretmanager.v1.CustomerManagedEncryptionStatusOrBuilder)`

### getDefaultInstanceForType()

```
public ReplicationStatus.UserManagedStatus.ReplicaStatus getDefaultInstanceForType()
```
...
```
public Parser<ReplicationStatus.UserManagedStatus.ReplicaStatus> getParserForType()
```
...
```
public ReplicationStatus.UserManagedStatus.ReplicaStatus.Builder newBuilderForType()
```
...
```
protected ReplicationStatus.UserManagedStatus.ReplicaStatus.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ReplicationStatus.UserManagedStatus.ReplicaStatus.Builder toBuilder()
```
