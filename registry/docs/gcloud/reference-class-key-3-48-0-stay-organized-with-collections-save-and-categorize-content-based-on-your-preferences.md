...
# Class Key (3.48.0) Stay organized with collections Save and categorize content based on your preferences.
...
### ANDROID\_SETTINGS\_FIELD\_NUMBER
...
### EXPRESS\_SETTINGS\_FIELD\_NUMBER

```
public static final int EXPRESS_SETTINGS_FIELD_NUMBER
```
...
### TESTING\_OPTIONS\_FIELD\_NUMBER
...
`[Key](/java/docs/reference/google-cloud-recaptchaenterprise/3.48.0/com.google.recaptchaenterprise.v1.Key)`
...
`[Key.Builder](/java/docs/reference/google-cloud-recaptchaenterprise/3.48.0/com.google.recaptchaenterprise.v1.Key.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[Key](/java/docs/reference/google-cloud-recaptchaenterprise/3.48.0/com.google.recaptchaenterprise.v1.Key)>`
...
`[AndroidKeySettings](/java/docs/reference/google-cloud-recaptchaenterprise/3.48.0/com.google.recaptchaenterprise.v1.AndroidKeySettings)`
...
`[AndroidKeySettingsOrBuilder](/java/docs/reference/google-cloud-recaptchaenterprise/3.48.0/com.google.recaptchaenterprise.v1.AndroidKeySettingsOrBuilder)`
...
```
public ExpressKeySettings getExpressSettings()
```
...
`[ExpressKeySettings](/java/docs/reference/google-cloud-recaptchaenterprise/3.48.0/com.google.recaptchaenterprise.v1.ExpressKeySettings)`
...
```
public ExpressKeySettingsOrBuilder getExpressSettingsOrBuilder()
```
...
`[ExpressKeySettingsOrBuilder](/java/docs/reference/google-cloud-recaptchaenterprise/3.48.0/com.google.recaptchaenterprise.v1.ExpressKeySettingsOrBuilder)`
...
`[IOSKeySettings](/java/docs/reference/google-cloud-recaptchaenterprise/3.48.0/com.google.recaptchaenterprise.v1.IOSKeySettings)`
...
`[IOSKeySettingsOrBuilder](/java/docs/reference/google-cloud-recaptchaenterprise/3.48.0/com.google.recaptchaenterprise.v1.IOSKeySettingsOrBuilder)`
...
Use [#getLabelsMap()](/java/docs/reference/google-cloud-recaptchaenterprise/3.48.0/com.google.recaptchaenterprise.v1.Key#com_google_recaptchaenterprise_v1_Key_getLabelsMap__) instead.
...
`[Key.PlatformSettingsCase](/java/docs/reference/google-cloud-recaptchaenterprise/3.48.0/com.google.recaptchaenterprise.v1.Key.PlatformSettingsCase)`
...
`[TestingOptions](/java/docs/reference/google-cloud-recaptchaenterprise/3.48.0/com.google.recaptchaenterprise.v1.TestingOptions)`
...
`[TestingOptionsOrBuilder](/java/docs/reference/google-cloud-recaptchaenterprise/3.48.0/com.google.recaptchaenterprise.v1.TestingOptionsOrBuilder)`
...
`[WafSettings](/java/docs/reference/google-cloud-recaptchaenterprise/3.48.0/com.google.recaptchaenterprise.v1.WafSettings)`
...
`[WafSettingsOrBuilder](/java/docs/reference/google-cloud-recaptchaenterprise/3.48.0/com.google.recaptchaenterprise.v1.WafSettingsOrBuilder)`
...
`[WebKeySettings](/java/docs/reference/google-cloud-recaptchaenterprise/3.48.0/com.google.recaptchaenterprise.v1.WebKeySettings)`
...
`[WebKeySettingsOrBuilder](/java/docs/reference/google-cloud-recaptchaenterprise/3.48.0/com.google.recaptchaenterprise.v1.WebKeySettingsOrBuilder)`
...
Whether the expressSettings field is set.
