...
# Class CreateClientTlsPolicyRequest.Builder (0.27.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> CreateClientTlsPolicyRequest.Builder

## Implements

[CreateClientTlsPolicyRequestOrBuilder](/java/docs/reference/google-cloud-network-security/0.27.0/com.google.cloud.networksecurity.v1beta1.CreateClientTlsPolicyRequestOrBuilder)
...
`[CreateClientTlsPolicyRequest.Builder](/java/docs/reference/google-cloud-network-security/0.27.0/com.google.cloud.networksecurity.v1beta1.CreateClientTlsPolicyRequest.Builder)`
...
`[CreateClientTlsPolicyRequest](/java/docs/reference/google-cloud-network-security/0.27.0/com.google.cloud.networksecurity.v1beta1.CreateClientTlsPolicyRequest)`
...
Required. Short name of the ClientTlsPolicy resource to be created. This value should be 1-63 characters long, containing only letters, numbers, hyphens, and underscores, and should not start with a number. E.g. "client\_mtls\_policy".
...
`[ClientTlsPolicy](/java/docs/reference/google-cloud-network-security/0.27.0/com.google.cloud.networksecurity.v1beta1.ClientTlsPolicy)`
...
`[ClientTlsPolicy.Builder](/java/docs/reference/google-cloud-network-security/0.27.0/com.google.cloud.networksecurity.v1beta1.ClientTlsPolicy.Builder)`
...
`[ClientTlsPolicyOrBuilder](/java/docs/reference/google-cloud-network-security/0.27.0/com.google.cloud.networksecurity.v1beta1.ClientTlsPolicyOrBuilder)`
