...
# Google Cloud Ai Platform V1 Client - Class StreamingReadFeatureValuesRequest (1.20.0) Stay organized with collections Save and categorize content based on your preferences.
...
Reference documentation and code samples for the Google Cloud Ai Platform V1 Client class StreamingReadFeatureValuesRequest.

Request message for [FeaturestoreOnlineServingService.StreamingReadFeatureValues](/php/docs/reference/cloud-ai-platform/1.20.0/V1.Client.FeaturestoreOnlineServingServiceClient#_Google_Cloud_AIPlatform_V1_Client_FeaturestoreOnlineServingServiceClient__streamingReadFeatureValues__).

Generated from protobuf message `google.cloud.aiplatform.v1.StreamingReadFeatureValuesRequest`
...
`[FeatureSelector](/php/docs/reference/cloud-ai-platform/1.20.0/V1.FeatureSelector)`  
...
`[FeatureSelector](/php/docs/reference/cloud-ai-platform/1.20.0/V1.FeatureSelector)|null`
...
`[StreamingReadFeatureValuesRequest](/php/docs/reference/cloud-ai-platform/1.20.0/V1.StreamingReadFeatureValuesRequest)`
