...
# Class GetNodeTypeRequest (0.47.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class GetNodeTypeRequest extends GeneratedMessageV3 implements GetNodeTypeRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> GetNodeTypeRequest

## Implements

[GetNodeTypeRequestOrBuilder](/java/docs/reference/google-cloud-vmwareengine/0.47.0/com.google.cloud.vmwareengine.v1.GetNodeTypeRequestOrBuilder)
...
```
public static GetNodeTypeRequest getDefaultInstance()
```
...
`[GetNodeTypeRequest](/java/docs/reference/google-cloud-vmwareengine/0.47.0/com.google.cloud.vmwareengine.v1.GetNodeTypeRequest)`
...
```
public static GetNodeTypeRequest.Builder newBuilder()
```
...
`[GetNodeTypeRequest.Builder](/java/docs/reference/google-cloud-vmwareengine/0.47.0/com.google.cloud.vmwareengine.v1.GetNodeTypeRequest.Builder)`

### newBuilder(GetNodeTypeRequest prototype)

```
public static GetNodeTypeRequest.Builder newBuilder(GetNodeTypeRequest prototype)
```
...
```
public static GetNodeTypeRequest parseDelimitedFrom(InputStream input)
```
...
```
public static GetNodeTypeRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetNodeTypeRequest parseFrom(byte[] data)
```
...
```
public static GetNodeTypeRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetNodeTypeRequest parseFrom(ByteString data)
```
...
```
public static GetNodeTypeRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetNodeTypeRequest parseFrom(CodedInputStream input)
```
...
```
public static GetNodeTypeRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetNodeTypeRequest parseFrom(InputStream input)
```
...
```
public static GetNodeTypeRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetNodeTypeRequest parseFrom(ByteBuffer data)
```
...
```
public static GetNodeTypeRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<GetNodeTypeRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[GetNodeTypeRequest](/java/docs/reference/google-cloud-vmwareengine/0.47.0/com.google.cloud.vmwareengine.v1.GetNodeTypeRequest)>`
...
Required. The resource name of the node type to retrieve. Resource names are schemeless URIs that follow the conventions in [https://cloud.google.com/apis/design/resource\_names](https://cloud.google.com/apis/design/resource_names). For example: `projects/my-proj/locations/us-central1-a/nodeTypes/standard-72`
...
```
public Parser<GetNodeTypeRequest> getParserForType()
```
...
```
public GetNodeTypeRequest.Builder newBuilderForType()
```
...
```
protected GetNodeTypeRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public GetNodeTypeRequest.Builder toBuilder()
```
