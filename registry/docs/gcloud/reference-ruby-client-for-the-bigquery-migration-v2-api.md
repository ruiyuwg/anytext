...
-   [0.17.1 (latest)](/ruby/docs/reference/google-cloud-bigquery-migration-v2/latest)
-   [0.17.0](/ruby/docs/reference/google-cloud-bigquery-migration-v2/0.17.0)
-   [0.16.0](/ruby/docs/reference/google-cloud-bigquery-migration-v2/0.16.0)
-   [0.15.1](/ruby/docs/reference/google-cloud-bigquery-migration-v2/0.15.1)
-   [0.14.1](/ruby/docs/reference/google-cloud-bigquery-migration-v2/0.14.1)
-   [0.13.0](/ruby/docs/reference/google-cloud-bigquery-migration-v2/0.13.0)
-   [0.12.0](/ruby/docs/reference/google-cloud-bigquery-migration-v2/0.12.0)
-   [0.11.1](/ruby/docs/reference/google-cloud-bigquery-migration-v2/0.11.1)
-   [0.10.0](/ruby/docs/reference/google-cloud-bigquery-migration-v2/0.10.0)
-   [0.9.2](/ruby/docs/reference/google-cloud-bigquery-migration-v2/0.9.2)
-   [0.8.0](/ruby/docs/reference/google-cloud-bigquery-migration-v2/0.8.0)
-   [0.7.0](/ruby/docs/reference/google-cloud-bigquery-migration-v2/0.7.0)
-   [0.6.0](/ruby/docs/reference/google-cloud-bigquery-migration-v2/0.6.0)
-   [0.5.0](/ruby/docs/reference/google-cloud-bigquery-migration-v2/0.5.0)
-   [0.4.0](/ruby/docs/reference/google-cloud-bigquery-migration-v2/0.4.0)
-   [0.3.0](/ruby/docs/reference/google-cloud-bigquery-migration-v2/0.3.0)
-   [0.2.0](/ruby/docs/reference/google-cloud-bigquery-migration-v2/0.2.0)
-   [0.1.0](/ruby/docs/reference/google-cloud-bigquery-migration-v2/0.1.0)
...
This gem is a _versioned_ client. It provides basic client classes for a specific version of the BigQuery Migration V2 API. Most users should consider using the main client gem, [google-cloud-bigquery-migration](https://rubygems.org/gems/google-cloud-bigquery-migration). See the section below titled _Which client should I use?_ for more information.

## Installation

```
$ gem install google-cloud-bigquery-migration-v2
```
...
3.  [Enable the API.](https://console.cloud.google.com/apis/library/bigquerymigration.googleapis.com)
4.  [Set up authentication.](https://docs.cloud.google.com/ruby/docs/reference/google-cloud-bigquery-migration-v2/latest/AUTHENTICATION "Set up authentication.")
...
response \= client.create\_migration\_workflow request

View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-bigquery-migration-v2/latest) for class and method documentation.

See also the [Product Documentation](https://cloud.google.com/bigquery/docs/migration-intro) for general usage information.
...
Most modern Ruby client libraries for Google APIs come in two flavors: the main client library with a name such as `google-cloud-bigquery-migration`, and lower-level _versioned_ client libraries with names such as `google-cloud-bigquery-migration-v2`. _In most cases, you should install the main client._
