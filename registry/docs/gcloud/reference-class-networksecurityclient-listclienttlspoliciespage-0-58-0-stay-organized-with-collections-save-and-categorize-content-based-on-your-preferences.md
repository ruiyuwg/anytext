...
# Class NetworkSecurityClient.ListClientTlsPoliciesPage (0.58.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class NetworkSecurityClient.ListClientTlsPoliciesPage extends AbstractPage<ListClientTlsPoliciesRequest,ListClientTlsPoliciesResponse,ClientTlsPolicy,NetworkSecurityClient.ListClientTlsPoliciesPage>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractPage](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractPage.html) \> NetworkSecurityClient.ListClientTlsPoliciesPage
...
### createPage(PageContext<ListClientTlsPoliciesRequest,ListClientTlsPoliciesResponse,ClientTlsPolicy> context, ListClientTlsPoliciesResponse response)

```
protected NetworkSecurityClient.ListClientTlsPoliciesPage createPage(PageContext<ListClientTlsPoliciesRequest,ListClientTlsPoliciesResponse,ClientTlsPolicy> context, ListClientTlsPoliciesResponse response)
```
...
`[PageContext](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PageContext.html)<[ListClientTlsPoliciesRequest](/java/docs/reference/google-cloud-network-security/0.58.0/com.google.cloud.networksecurity.v1.ListClientTlsPoliciesRequest),[ListClientTlsPoliciesResponse](/java/docs/reference/google-cloud-network-security/0.58.0/com.google.cloud.networksecurity.v1.ListClientTlsPoliciesResponse),[ClientTlsPolicy](/java/docs/reference/google-cloud-network-security/0.58.0/com.google.cloud.networksecurity.v1.ClientTlsPolicy)>`  

`response`

`[ListClientTlsPoliciesResponse](/java/docs/reference/google-cloud-network-security/0.58.0/com.google.cloud.networksecurity.v1.ListClientTlsPoliciesResponse)`  
...
`[NetworkSecurityClient.ListClientTlsPoliciesPage](/java/docs/reference/google-cloud-network-security/0.58.0/com.google.cloud.networksecurity.v1.NetworkSecurityClient.ListClientTlsPoliciesPage)`
...
### createPageAsync(PageContext<ListClientTlsPoliciesRequest,ListClientTlsPoliciesResponse,ClientTlsPolicy> context, ApiFuture<ListClientTlsPoliciesResponse> futureResponse)

```
public ApiFuture<NetworkSecurityClient.ListClientTlsPoliciesPage> createPageAsync(PageContext<ListClientTlsPoliciesRequest,ListClientTlsPoliciesResponse,ClientTlsPolicy> context, ApiFuture<ListClientTlsPoliciesResponse> futureResponse)
```
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListClientTlsPoliciesResponse](/java/docs/reference/google-cloud-network-security/0.58.0/com.google.cloud.networksecurity.v1.ListClientTlsPoliciesResponse)>`  
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListClientTlsPoliciesPage](/java/docs/reference/google-cloud-network-security/0.58.0/com.google.cloud.networksecurity.v1.NetworkSecurityClient.ListClientTlsPoliciesPage)>`
