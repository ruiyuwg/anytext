...
# google-cloud-notebooks overview (1.85.0) Stay organized with collections Save and categorize content based on your preferences.
...
**AI Platform Notebooks Description:** Is a managed service that offers an integrated and secure JupyterLab environment for data scientists and machine learning developers to experiment, develop, and deploy models into production. Users can create instances running JupyterLab that come pre-installed with the latest data science and machine learning frameworks in a single click.

[AI Platform Notebooks Product Reference](https://cloud.google.com/ai-platform-notebooks)

[GitHub Repository](https://github.com/googleapis/google-cloud-java/tree/main/java-notebooks)

[Maven artifact](https://central.sonatype.com/artifact/com.google.cloud/google-cloud-notebooks)
...
-   [Enable the API](https://console.cloud.google.com/apis/library/notebooks.googleapis.com)
-   [Set up authentication](https://cloud.google.com/docs/authentication/client-libraries)

## Use the AI Platform Notebooks for Java
...
The example below demonstrates how you would import the BOM and include the `google-cloud-notebooks` artifact.
...
libraryDependencies += "com.google.cloud" % "google-cloud-notebooks" % "1.85.0"

## Which version ID should I get started with?

For this library, we recommend using [com.google.cloud.notebooks.v2](https://cloud.google.com/java/docs/reference/google-cloud-notebooks/1.85.0/com.google.cloud.notebooks.v2) for new applications.
