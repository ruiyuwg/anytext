...
# Class GetExternalAddressRequest (0.34.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class GetExternalAddressRequest extends GeneratedMessageV3 implements GetExternalAddressRequestOrBuilder
```

Request message for VmwareEngine.GetExternalAddress

Protobuf type `google.cloud.vmwareengine.v1.GetExternalAddressRequest`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> GetExternalAddressRequest

## Implements

[GetExternalAddressRequestOrBuilder](/java/docs/reference/google-cloud-vmwareengine/0.34.0/com.google.cloud.vmwareengine.v1.GetExternalAddressRequestOrBuilder)
...
```
public static GetExternalAddressRequest getDefaultInstance()
```
...
`[GetExternalAddressRequest](/java/docs/reference/google-cloud-vmwareengine/0.34.0/com.google.cloud.vmwareengine.v1.GetExternalAddressRequest)`
...
```
public static GetExternalAddressRequest.Builder newBuilder()
```
...
`[GetExternalAddressRequest.Builder](/java/docs/reference/google-cloud-vmwareengine/0.34.0/com.google.cloud.vmwareengine.v1.GetExternalAddressRequest.Builder)`

### newBuilder(GetExternalAddressRequest prototype)

```
public static GetExternalAddressRequest.Builder newBuilder(GetExternalAddressRequest prototype)
```
...
```
public static GetExternalAddressRequest parseDelimitedFrom(InputStream input)
```
...
```
public static GetExternalAddressRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetExternalAddressRequest parseFrom(byte[] data)
```
...
```
public static GetExternalAddressRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetExternalAddressRequest parseFrom(ByteString data)
```
...
```
public static GetExternalAddressRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetExternalAddressRequest parseFrom(CodedInputStream input)
```
...
```
public static GetExternalAddressRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetExternalAddressRequest parseFrom(InputStream input)
```
...
```
public static GetExternalAddressRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetExternalAddressRequest parseFrom(ByteBuffer data)
```
...
```
public static GetExternalAddressRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<GetExternalAddressRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[GetExternalAddressRequest](/java/docs/reference/google-cloud-vmwareengine/0.34.0/com.google.cloud.vmwareengine.v1.GetExternalAddressRequest)>`
...
```
public GetExternalAddressRequest getDefaultInstanceForType()
```
...
Required. The resource name of the external IP address to retrieve. Resource names are schemeless URIs that follow the conventions in [https://cloud.google.com/apis/design/resource\_names](https://cloud.google.com/apis/design/resource_names). For example: `projects/my-project/locations/us-central1-a/privateClouds/my-cloud/externalAddresses/my-ip`
...
```
public Parser<GetExternalAddressRequest> getParserForType()
```
...
```
public GetExternalAddressRequest.Builder newBuilderForType()
```
...
```
protected GetExternalAddressRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public GetExternalAddressRequest.Builder toBuilder()
```
