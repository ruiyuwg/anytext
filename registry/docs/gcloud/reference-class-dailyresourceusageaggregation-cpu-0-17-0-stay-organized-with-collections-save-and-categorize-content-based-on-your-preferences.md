...
# Class DailyResourceUsageAggregation.CPU (0.17.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class DailyResourceUsageAggregation.CPU extends GeneratedMessageV3 implements DailyResourceUsageAggregation.CPUOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> DailyResourceUsageAggregation.CPU

## Implements

[DailyResourceUsageAggregation.CPUOrBuilder](/java/docs/reference/google-cloud-migrationcenter/0.17.0/com.google.cloud.migrationcenter.v1.DailyResourceUsageAggregation.CPUOrBuilder)
...
### UTILIZATION\_PERCENTAGE\_FIELD\_NUMBER

```
public static final int UTILIZATION_PERCENTAGE_FIELD_NUMBER
```
...
```
public static DailyResourceUsageAggregation.CPU getDefaultInstance()
```
...
`[DailyResourceUsageAggregation.CPU](/java/docs/reference/google-cloud-migrationcenter/0.17.0/com.google.cloud.migrationcenter.v1.DailyResourceUsageAggregation.CPU)`
...
```
public static DailyResourceUsageAggregation.CPU.Builder newBuilder()
```
...
`[DailyResourceUsageAggregation.CPU.Builder](/java/docs/reference/google-cloud-migrationcenter/0.17.0/com.google.cloud.migrationcenter.v1.DailyResourceUsageAggregation.CPU.Builder)`

### newBuilder(DailyResourceUsageAggregation.CPU prototype)

```
public static DailyResourceUsageAggregation.CPU.Builder newBuilder(DailyResourceUsageAggregation.CPU prototype)
```
...
```
public static DailyResourceUsageAggregation.CPU parseDelimitedFrom(InputStream input)
```
...
```
public static DailyResourceUsageAggregation.CPU parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DailyResourceUsageAggregation.CPU parseFrom(byte[] data)
```
...
```
public static DailyResourceUsageAggregation.CPU parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DailyResourceUsageAggregation.CPU parseFrom(ByteString data)
```
...
```
public static DailyResourceUsageAggregation.CPU parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DailyResourceUsageAggregation.CPU parseFrom(CodedInputStream input)
```
...
```
public static DailyResourceUsageAggregation.CPU parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DailyResourceUsageAggregation.CPU parseFrom(InputStream input)
```
...
```
public static DailyResourceUsageAggregation.CPU parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DailyResourceUsageAggregation.CPU parseFrom(ByteBuffer data)
```
...
```
public static DailyResourceUsageAggregation.CPU parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<DailyResourceUsageAggregation.CPU> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[CPU](/java/docs/reference/google-cloud-migrationcenter/0.17.0/com.google.cloud.migrationcenter.v1.DailyResourceUsageAggregation.CPU)>`
...
```
public DailyResourceUsageAggregation.CPU getDefaultInstanceForType()
```
...
```
public Parser<DailyResourceUsageAggregation.CPU> getParserForType()
```
...
```
public DailyResourceUsageAggregation.Stats getUtilizationPercentage()
```
...
`[DailyResourceUsageAggregation.Stats](/java/docs/reference/google-cloud-migrationcenter/0.17.0/com.google.cloud.migrationcenter.v1.DailyResourceUsageAggregation.Stats)`

The utilizationPercentage.

### getUtilizationPercentageOrBuilder()

```
public DailyResourceUsageAggregation.StatsOrBuilder getUtilizationPercentageOrBuilder()
```
...
`[DailyResourceUsageAggregation.StatsOrBuilder](/java/docs/reference/google-cloud-migrationcenter/0.17.0/com.google.cloud.migrationcenter.v1.DailyResourceUsageAggregation.StatsOrBuilder)`
...
Whether the utilizationPercentage field is set.
...
```
public DailyResourceUsageAggregation.CPU.Builder newBuilderForType()
```
...
```
protected DailyResourceUsageAggregation.CPU.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public DailyResourceUsageAggregation.CPU.Builder toBuilder()
```
