...
# Class ListDashboardsRequest (2.23.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListDashboardsRequest extends GeneratedMessageV3 implements ListDashboardsRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListDashboardsRequest

## Implements

[ListDashboardsRequestOrBuilder](/java/docs/reference/google-cloud-monitoring-dashboard/2.23.0/com.google.monitoring.dashboard.v1.ListDashboardsRequestOrBuilder)
...
`[ListDashboardsRequest](/java/docs/reference/google-cloud-monitoring-dashboard/2.23.0/com.google.monitoring.dashboard.v1.ListDashboardsRequest)`
...
```
public static ListDashboardsRequest.Builder newBuilder()
```
...
`[ListDashboardsRequest.Builder](/java/docs/reference/google-cloud-monitoring-dashboard/2.23.0/com.google.monitoring.dashboard.v1.ListDashboardsRequest.Builder)`

### newBuilder(ListDashboardsRequest prototype)

```
public static ListDashboardsRequest.Builder newBuilder(ListDashboardsRequest prototype)
```
...
```
public static ListDashboardsRequest parseDelimitedFrom(InputStream input)
```
...
```
public static ListDashboardsRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListDashboardsRequest parseFrom(byte[] data)
```
...
```
public static ListDashboardsRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListDashboardsRequest parseFrom(ByteString data)
```
...
```
public static ListDashboardsRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListDashboardsRequest parseFrom(CodedInputStream input)
```
...
```
public static ListDashboardsRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListDashboardsRequest parseFrom(InputStream input)
```
...
```
public static ListDashboardsRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListDashboardsRequest parseFrom(ByteBuffer data)
```
...
```
public static ListDashboardsRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListDashboardsRequest](/java/docs/reference/google-cloud-monitoring-dashboard/2.23.0/com.google.monitoring.dashboard.v1.ListDashboardsRequest)>`
...
```
public ListDashboardsRequest.Builder newBuilderForType()
```
...
```
protected ListDashboardsRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
