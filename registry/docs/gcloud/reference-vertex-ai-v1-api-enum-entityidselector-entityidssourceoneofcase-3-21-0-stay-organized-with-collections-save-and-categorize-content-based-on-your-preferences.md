...
# Vertex AI v1 API - Enum EntityIdSelector.EntityIdsSourceOneofCase (3.21.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum EntityIdSelector.EntityIdsSourceOneofCase
```

Reference documentation and code samples for the Vertex AI v1 API enum EntityIdSelector.EntityIdsSourceOneofCase.
