...
# Class SearchCapability (0.16.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class SearchCapability extends GeneratedMessageV3 implements SearchCapabilityOrBuilder
```

The capability and metadata of search capability.

Protobuf type `google.cloud.visionai.v1.SearchCapability`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> SearchCapability

## Implements

[SearchCapabilityOrBuilder](/java/docs/reference/google-cloud-visionai/0.16.0/com.google.cloud.visionai.v1.SearchCapabilityOrBuilder)
...
```
public static SearchCapability getDefaultInstance()
```
...
`[SearchCapability](/java/docs/reference/google-cloud-visionai/0.16.0/com.google.cloud.visionai.v1.SearchCapability)`
...
```
public static SearchCapability.Builder newBuilder()
```
...
`[SearchCapability.Builder](/java/docs/reference/google-cloud-visionai/0.16.0/com.google.cloud.visionai.v1.SearchCapability.Builder)`

### newBuilder(SearchCapability prototype)

```
public static SearchCapability.Builder newBuilder(SearchCapability prototype)
```
...
```
public static SearchCapability parseDelimitedFrom(InputStream input)
```
...
```
public static SearchCapability parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SearchCapability parseFrom(byte[] data)
```
...
```
public static SearchCapability parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SearchCapability parseFrom(ByteString data)
```
...
```
public static SearchCapability parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SearchCapability parseFrom(CodedInputStream input)
```
...
```
public static SearchCapability parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SearchCapability parseFrom(InputStream input)
```
...
```
public static SearchCapability parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SearchCapability parseFrom(ByteBuffer data)
```
...
```
public static SearchCapability parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<SearchCapability> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[SearchCapability](/java/docs/reference/google-cloud-visionai/0.16.0/com.google.cloud.visionai.v1.SearchCapability)>`
...
```
public SearchCapability getDefaultInstanceForType()
```
...
```
public Parser<SearchCapability> getParserForType()
```
...
```
public SearchCapability.Type getType()
```
...
`[SearchCapability.Type](/java/docs/reference/google-cloud-visionai/0.16.0/com.google.cloud.visionai.v1.SearchCapability.Type)`
...
```
public SearchCapability.Builder newBuilderForType()
```
...
```
protected SearchCapability.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public SearchCapability.Builder toBuilder()
```
