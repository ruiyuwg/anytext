...
# Google Cloud Ai Platform V1 Client - Class DeleteModelVersionRequest (1.7.0) Stay organized with collections Save and categorize content based on your preferences.
...
Reference documentation and code samples for the Google Cloud Ai Platform V1 Client class DeleteModelVersionRequest.

Request message for [ModelService.DeleteModelVersion](/php/docs/reference/cloud-ai-platform/1.7.0/V1.Client.ModelServiceClient#_Google_Cloud_AIPlatform_V1_Client_ModelServiceClient__deleteModelVersion__).

Generated from protobuf message `google.cloud.aiplatform.v1.DeleteModelVersionRequest`
...
`[Google\Cloud\AIPlatform\V1\DeleteModelVersionRequest](/php/docs/reference/cloud-ai-platform/1.7.0/V1.DeleteModelVersionRequest)`
