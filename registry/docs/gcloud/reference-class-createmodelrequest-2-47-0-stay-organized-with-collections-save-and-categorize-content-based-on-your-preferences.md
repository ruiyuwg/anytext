...
# Class CreateModelRequest (2.47.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class CreateModelRequest extends GeneratedMessageV3 implements CreateModelRequestOrBuilder
```

Request for creating a model.

Protobuf type `google.cloud.retail.v2alpha.CreateModelRequest`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> CreateModelRequest

## Implements

[CreateModelRequestOrBuilder](/java/docs/reference/google-cloud-retail/2.47.0/com.google.cloud.retail.v2alpha.CreateModelRequestOrBuilder)
...
`[CreateModelRequest](/java/docs/reference/google-cloud-retail/2.47.0/com.google.cloud.retail.v2alpha.CreateModelRequest)`
...
```
public static CreateModelRequest.Builder newBuilder()
```
...
`[CreateModelRequest.Builder](/java/docs/reference/google-cloud-retail/2.47.0/com.google.cloud.retail.v2alpha.CreateModelRequest.Builder)`

### newBuilder(CreateModelRequest prototype)

```
public static CreateModelRequest.Builder newBuilder(CreateModelRequest prototype)
```
...
```
public static CreateModelRequest parseDelimitedFrom(InputStream input)
```
...
```
public static CreateModelRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateModelRequest parseFrom(byte[] data)
```
...
```
public static CreateModelRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateModelRequest parseFrom(ByteString data)
```
...
```
public static CreateModelRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateModelRequest parseFrom(CodedInputStream input)
```
...
```
public static CreateModelRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateModelRequest parseFrom(InputStream input)
```
...
```
public static CreateModelRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateModelRequest parseFrom(ByteBuffer data)
```
...
```
public static CreateModelRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[CreateModelRequest](/java/docs/reference/google-cloud-retail/2.47.0/com.google.cloud.retail.v2alpha.CreateModelRequest)>`
...
`[Model](/java/docs/reference/google-cloud-retail/2.47.0/com.google.cloud.retail.v2alpha.Model)`
...
`[ModelOrBuilder](/java/docs/reference/google-cloud-retail/2.47.0/com.google.cloud.retail.v2alpha.ModelOrBuilder)`
...
```
public CreateModelRequest.Builder newBuilderForType()
```
...
```
protected CreateModelRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
