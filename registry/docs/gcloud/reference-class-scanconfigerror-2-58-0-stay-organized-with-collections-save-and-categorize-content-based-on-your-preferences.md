...
# Class ScanConfigError (2.58.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ScanConfigError

## Implements

[ScanConfigErrorOrBuilder](/java/docs/reference/google-cloud-websecurityscanner/2.58.0/com.google.cloud.websecurityscanner.v1.ScanConfigErrorOrBuilder)
...
`[ScanConfigError](/java/docs/reference/google-cloud-websecurityscanner/2.58.0/com.google.cloud.websecurityscanner.v1.ScanConfigError)`
...
`[ScanConfigError.Builder](/java/docs/reference/google-cloud-websecurityscanner/2.58.0/com.google.cloud.websecurityscanner.v1.ScanConfigError.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ScanConfigError](/java/docs/reference/google-cloud-websecurityscanner/2.58.0/com.google.cloud.websecurityscanner.v1.ScanConfigError)>`
...
`[ScanConfigError.Code](/java/docs/reference/google-cloud-websecurityscanner/2.58.0/com.google.cloud.websecurityscanner.v1.ScanConfigError.Code)`
...
Output only. Indicates the full name of the ScanConfig field that triggers this error, for example "scan\_config.max\_qps". This field is provided for troubleshooting purposes only and its actual value can change in the future.
