...
# Interface TextAnnotationOrBuilder (3.57.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[Page](/java/docs/reference/google-cloud-vision/3.57.0/com.google.cloud.vision.v1.Page)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Page](/java/docs/reference/google-cloud-vision/3.57.0/com.google.cloud.vision.v1.Page)>`
...
`[PageOrBuilder](/java/docs/reference/google-cloud-vision/3.57.0/com.google.cloud.vision.v1.PageOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.vision.v1.PageOrBuilder>`
