...
# Enum CatalogAttribute.DynamicFacetableOption (2.19.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-retail/2.19.0/com.google.cloud.retail.v2beta.CatalogAttribute.DynamicFacetableOption#com_google_cloud_retail_v2beta_CatalogAttribute_DynamicFacetableOption_forNumber_int_) instead._
