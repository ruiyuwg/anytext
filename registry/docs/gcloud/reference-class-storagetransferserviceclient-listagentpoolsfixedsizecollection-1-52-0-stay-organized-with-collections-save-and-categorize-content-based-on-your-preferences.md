...
# Class StorageTransferServiceClient.ListAgentPoolsFixedSizeCollection (1.52.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class StorageTransferServiceClient.ListAgentPoolsFixedSizeCollection extends AbstractFixedSizeCollection<TransferProto.ListAgentPoolsRequest,TransferProto.ListAgentPoolsResponse,TransferTypes.AgentPool,StorageTransferServiceClient.ListAgentPoolsPage,StorageTransferServiceClient.ListAgentPoolsFixedSizeCollection>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractFixedSizeCollection](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractFixedSizeCollection.html) \> StorageTransferServiceClient.ListAgentPoolsFixedSizeCollection
...
### createCollection(List<StorageTransferServiceClient.ListAgentPoolsPage> pages, int collectionSize)

```
protected StorageTransferServiceClient.ListAgentPoolsFixedSizeCollection createCollection(List<StorageTransferServiceClient.ListAgentPoolsPage> pages, int collectionSize)
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ListAgentPoolsPage](/java/docs/reference/google-cloud-storage-transfer/1.52.0/com.google.storagetransfer.v1.proto.StorageTransferServiceClient.ListAgentPoolsPage)>`  
...
`[StorageTransferServiceClient.ListAgentPoolsFixedSizeCollection](/java/docs/reference/google-cloud-storage-transfer/1.52.0/com.google.storagetransfer.v1.proto.StorageTransferServiceClient.ListAgentPoolsFixedSizeCollection)`
