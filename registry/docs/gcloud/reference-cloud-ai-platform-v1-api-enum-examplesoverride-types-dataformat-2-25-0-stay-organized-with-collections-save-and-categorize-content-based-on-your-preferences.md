...
# Cloud AI Platform v1 API - Enum ExamplesOverride.Types.DataFormat (2.25.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum ExamplesOverride.Types.DataFormat
```

Reference documentation and code samples for the Cloud AI Platform v1 API enum ExamplesOverride.Types.DataFormat.
