...
# Class RevisionsClient.ListRevisionsFixedSizeCollection (0.31.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class RevisionsClient.ListRevisionsFixedSizeCollection extends AbstractFixedSizeCollection<ListRevisionsRequest,ListRevisionsResponse,Revision,RevisionsClient.ListRevisionsPage,RevisionsClient.ListRevisionsFixedSizeCollection>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractFixedSizeCollection](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractFixedSizeCollection.html) \> RevisionsClient.ListRevisionsFixedSizeCollection
...
### createCollection(List<RevisionsClient.ListRevisionsPage> pages, int collectionSize)

```
protected RevisionsClient.ListRevisionsFixedSizeCollection createCollection(List<RevisionsClient.ListRevisionsPage> pages, int collectionSize)
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ListRevisionsPage](/java/docs/reference/google-cloud-run/0.31.0/com.google.cloud.run.v2.RevisionsClient.ListRevisionsPage)>`  
...
`[RevisionsClient.ListRevisionsFixedSizeCollection](/java/docs/reference/google-cloud-run/0.31.0/com.google.cloud.run.v2.RevisionsClient.ListRevisionsFixedSizeCollection)`
