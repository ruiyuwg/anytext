...
# Class Tile (2.54.0) Stay organized with collections Save and categorize content based on your preferences.
...
### PRODUCT\_ATTRIBUTE\_INTERVAL\_FIELD\_NUMBER
...
### PRODUCT\_ATTRIBUTE\_VALUE\_FIELD\_NUMBER
...
### REPRESENTATIVE\_PRODUCT\_ID\_FIELD\_NUMBER
...
`[Tile](/java/docs/reference/google-cloud-retail/2.54.0/com.google.cloud.retail.v2beta.Tile)`
...
`[Tile.Builder](/java/docs/reference/google-cloud-retail/2.54.0/com.google.cloud.retail.v2beta.Tile.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[Tile](/java/docs/reference/google-cloud-retail/2.54.0/com.google.cloud.retail.v2beta.Tile)>`
...
`[Tile.ProductAttributeCase](/java/docs/reference/google-cloud-retail/2.54.0/com.google.cloud.retail.v2beta.Tile.ProductAttributeCase)`
...
`[ProductAttributeInterval](/java/docs/reference/google-cloud-retail/2.54.0/com.google.cloud.retail.v2beta.ProductAttributeInterval)`
...
`[ProductAttributeIntervalOrBuilder](/java/docs/reference/google-cloud-retail/2.54.0/com.google.cloud.retail.v2beta.ProductAttributeIntervalOrBuilder)`
...
`[ProductAttributeValue](/java/docs/reference/google-cloud-retail/2.54.0/com.google.cloud.retail.v2beta.ProductAttributeValue)`
...
`[ProductAttributeValueOrBuilder](/java/docs/reference/google-cloud-retail/2.54.0/com.google.cloud.retail.v2beta.ProductAttributeValueOrBuilder)`
