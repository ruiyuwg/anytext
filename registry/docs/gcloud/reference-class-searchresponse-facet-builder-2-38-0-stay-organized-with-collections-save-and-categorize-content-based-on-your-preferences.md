...
# Class SearchResponse.Facet.Builder (2.38.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> SearchResponse.Facet.Builder

## Implements

[SearchResponse.FacetOrBuilder](/java/docs/reference/google-cloud-retail/2.38.0/com.google.cloud.retail.v2.SearchResponse.FacetOrBuilder)
...
`[Iterable](https://docs.oracle.com/javase/8/docs/api/java/lang/Iterable.html)<? extends com.google.cloud.retail.v2.SearchResponse.Facet.FacetValue>`  
...
`[SearchResponse.Facet.Builder](/java/docs/reference/google-cloud-retail/2.38.0/com.google.cloud.retail.v2.SearchResponse.Facet.Builder)`
...
`[SearchResponse.Facet.FacetValue](/java/docs/reference/google-cloud-retail/2.38.0/com.google.cloud.retail.v2.SearchResponse.Facet.FacetValue)`  
...
`[SearchResponse.Facet.FacetValue.Builder](/java/docs/reference/google-cloud-retail/2.38.0/com.google.cloud.retail.v2.SearchResponse.Facet.FacetValue.Builder)`  
...
`[SearchResponse.Facet](/java/docs/reference/google-cloud-retail/2.38.0/com.google.cloud.retail.v2.SearchResponse.Facet)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Builder](/java/docs/reference/google-cloud-retail/2.38.0/com.google.cloud.retail.v2.SearchResponse.Facet.FacetValue.Builder)>`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[FacetValue](/java/docs/reference/google-cloud-retail/2.38.0/com.google.cloud.retail.v2.SearchResponse.Facet.FacetValue)>`
...
`[SearchResponse.Facet.FacetValueOrBuilder](/java/docs/reference/google-cloud-retail/2.38.0/com.google.cloud.retail.v2.SearchResponse.Facet.FacetValueOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.retail.v2.SearchResponse.Facet.FacetValueOrBuilder>`
