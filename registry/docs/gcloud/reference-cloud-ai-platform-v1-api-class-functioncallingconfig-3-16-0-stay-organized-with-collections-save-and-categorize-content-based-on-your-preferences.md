...
# Cloud AI Platform v1 API - Class FunctionCallingConfig (3.16.0) Stay organized with collections Save and categorize content based on your preferences.
...
[object](https://learn.microsoft.com/dotnet/api/system.object) \> FunctionCallingConfig

## Implements

[IMessage](https://cloud.google.com/dotnet/docs/reference/Google.Protobuf/latest/Google.Protobuf.IMessage-1.html)[FunctionCallingConfig](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.16.0/Google.Cloud.AIPlatform.V1.FunctionCallingConfig), [IEquatable](https://learn.microsoft.com/dotnet/api/system.iequatable-1)[FunctionCallingConfig](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.16.0/Google.Cloud.AIPlatform.V1.FunctionCallingConfig), [IDeepCloneable](https://cloud.google.com/dotnet/docs/reference/Google.Protobuf/latest/Google.Protobuf.IDeepCloneable-1.html)[FunctionCallingConfig](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.16.0/Google.Cloud.AIPlatform.V1.FunctionCallingConfig), [IBufferMessage](https://cloud.google.com/dotnet/docs/reference/Google.Protobuf/latest/Google.Protobuf.IBufferMessage.html), [IMessage](https://cloud.google.com/dotnet/docs/reference/Google.Protobuf/latest/Google.Protobuf.IMessage.html)
...
`[FunctionCallingConfig](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.16.0/Google.Cloud.AIPlatform.V1.FunctionCallingConfig)`  
...
`[FunctionCallingConfig](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.16.0/Google.Cloud.AIPlatform.V1.FunctionCallingConfig)[Types](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.16.0/Google.Cloud.AIPlatform.V1.FunctionCallingConfig.Types)[Mode](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.16.0/Google.Cloud.AIPlatform.V1.FunctionCallingConfig.Types.Mode)`
