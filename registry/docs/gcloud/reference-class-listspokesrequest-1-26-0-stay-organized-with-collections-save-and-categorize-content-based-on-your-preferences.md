...
# Class ListSpokesRequest (1.26.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListSpokesRequest extends GeneratedMessageV3 implements ListSpokesRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListSpokesRequest

## Implements

[ListSpokesRequestOrBuilder](/java/docs/reference/google-cloud-networkconnectivity/1.26.0/com.google.cloud.networkconnectivity.v1.ListSpokesRequestOrBuilder)
...
```
public static ListSpokesRequest getDefaultInstance()
```
...
`[ListSpokesRequest](/java/docs/reference/google-cloud-networkconnectivity/1.26.0/com.google.cloud.networkconnectivity.v1.ListSpokesRequest)`
...
```
public static ListSpokesRequest.Builder newBuilder()
```
...
`[ListSpokesRequest.Builder](/java/docs/reference/google-cloud-networkconnectivity/1.26.0/com.google.cloud.networkconnectivity.v1.ListSpokesRequest.Builder)`

### newBuilder(ListSpokesRequest prototype)

```
public static ListSpokesRequest.Builder newBuilder(ListSpokesRequest prototype)
```
...
```
public static ListSpokesRequest parseDelimitedFrom(InputStream input)
```
...
```
public static ListSpokesRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListSpokesRequest parseFrom(byte[] data)
```
...
```
public static ListSpokesRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListSpokesRequest parseFrom(ByteString data)
```
...
```
public static ListSpokesRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListSpokesRequest parseFrom(CodedInputStream input)
```
...
```
public static ListSpokesRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListSpokesRequest parseFrom(InputStream input)
```
...
```
public static ListSpokesRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListSpokesRequest parseFrom(ByteBuffer data)
```
...
```
public static ListSpokesRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ListSpokesRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListSpokesRequest](/java/docs/reference/google-cloud-networkconnectivity/1.26.0/com.google.cloud.networkconnectivity.v1.ListSpokesRequest)>`
...
```
public ListSpokesRequest getDefaultInstanceForType()
```
...
```
public Parser<ListSpokesRequest> getParserForType()
```
...
```
public ListSpokesRequest.Builder newBuilderForType()
```
...
```
protected ListSpokesRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ListSpokesRequest.Builder toBuilder()
```
