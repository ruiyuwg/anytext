...
# Interface GetPolicyBasedRouteRequestOrBuilder (1.32.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface GetPolicyBasedRouteRequestOrBuilder extends MessageOrBuilder
```
