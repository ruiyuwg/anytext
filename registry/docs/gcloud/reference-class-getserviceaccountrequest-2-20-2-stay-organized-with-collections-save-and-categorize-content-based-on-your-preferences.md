...
# Class GetServiceAccountRequest (2.20.2) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class GetServiceAccountRequest extends GeneratedMessageV3 implements GetServiceAccountRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> GetServiceAccountRequest

## Implements

[GetServiceAccountRequestOrBuilder](/java/docs/reference/google-cloud-storage/2.20.2/com.google.storage.v2.GetServiceAccountRequestOrBuilder)
...
`[GetServiceAccountRequest](/java/docs/reference/google-cloud-storage/2.20.2/com.google.storage.v2.GetServiceAccountRequest)`
...
```
public static GetServiceAccountRequest.Builder newBuilder()
```
...
`[GetServiceAccountRequest.Builder](/java/docs/reference/google-cloud-storage/2.20.2/com.google.storage.v2.GetServiceAccountRequest.Builder)`

### newBuilder(GetServiceAccountRequest prototype)

```
public static GetServiceAccountRequest.Builder newBuilder(GetServiceAccountRequest prototype)
```
...
```
public static GetServiceAccountRequest parseDelimitedFrom(InputStream input)
```
...
```
public static GetServiceAccountRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetServiceAccountRequest parseFrom(byte[] data)
```
...
```
public static GetServiceAccountRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetServiceAccountRequest parseFrom(ByteString data)
```
...
```
public static GetServiceAccountRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetServiceAccountRequest parseFrom(CodedInputStream input)
```
...
```
public static GetServiceAccountRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetServiceAccountRequest parseFrom(InputStream input)
```
...
```
public static GetServiceAccountRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetServiceAccountRequest parseFrom(ByteBuffer data)
```
...
```
public static GetServiceAccountRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<GetServiceAccountRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[GetServiceAccountRequest](/java/docs/reference/google-cloud-storage/2.20.2/com.google.storage.v2.GetServiceAccountRequest)>`
...
```
public Parser<GetServiceAccountRequest> getParserForType()
```
...
```
public GetServiceAccountRequest.Builder newBuilderForType()
```
...
```
protected GetServiceAccountRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public GetServiceAccountRequest.Builder toBuilder()
```
