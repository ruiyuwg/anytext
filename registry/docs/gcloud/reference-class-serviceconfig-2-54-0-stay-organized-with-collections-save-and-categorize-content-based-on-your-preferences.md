...
# Class ServiceConfig (2.54.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ServiceConfig

## Implements

[ServiceConfigOrBuilder](/java/docs/reference/google-cloud-service-usage/2.54.0/com.google.api.serviceusage.v1beta1.ServiceConfigOrBuilder)
...
### MONITORED\_RESOURCES\_FIELD\_NUMBER
...
`[ServiceConfig](/java/docs/reference/google-cloud-service-usage/2.54.0/com.google.api.serviceusage.v1beta1.ServiceConfig)`
...
`[ServiceConfig.Builder](/java/docs/reference/google-cloud-service-usage/2.54.0/com.google.api.serviceusage.v1beta1.ServiceConfig.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ServiceConfig](/java/docs/reference/google-cloud-service-usage/2.54.0/com.google.api.serviceusage.v1beta1.ServiceConfig)>`
...
`[Api](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Api.html)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Api](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Api.html)>`
...
`[ApiOrBuilder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.ApiOrBuilder.html)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.protobuf.ApiOrBuilder>`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<com.google.api.Endpoint>`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.api.EndpointOrBuilder>`
...
Monitoring configuration. This should not include the 'producer\_destinations' field.
