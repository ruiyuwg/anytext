...
# Interface Overlay.AnimationStaticOrBuilder (1.43.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static interface Overlay.AnimationStaticOrBuilder extends MessageOrBuilder
```
...
`[Overlay.NormalizedCoordinate](/java/docs/reference/google-cloud-video-transcoder/1.43.0/com.google.cloud.video.transcoder.v1.Overlay.NormalizedCoordinate)`
...
`[Overlay.NormalizedCoordinateOrBuilder](/java/docs/reference/google-cloud-video-transcoder/1.43.0/com.google.cloud.video.transcoder.v1.Overlay.NormalizedCoordinateOrBuilder)`
