...
# Enum UniversalAction.ActionTypeCase (2.30.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum UniversalAction.ActionTypeCase extends Enum<UniversalAction.ActionTypeCase> implements Internal.EnumLite, AbstractMessageLite.InternalOneOfEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-gsuite-addons/2.30.0/com.google.apps.script.type.gmail.UniversalAction.ActionTypeCase#com_google_apps_script_type_gmail_UniversalAction_ActionTypeCase_forNumber_int_) instead._
