...
# Class ListInsightsRequest (2.38.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListInsightsRequest extends GeneratedMessageV3 implements ListInsightsRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListInsightsRequest

## Implements

[ListInsightsRequestOrBuilder](/java/docs/reference/google-cloud-recommender/2.38.0/com.google.cloud.recommender.v1beta1.ListInsightsRequestOrBuilder)
...
```
public static ListInsightsRequest getDefaultInstance()
```
...
`[ListInsightsRequest](/java/docs/reference/google-cloud-recommender/2.38.0/com.google.cloud.recommender.v1beta1.ListInsightsRequest)`
...
```
public static ListInsightsRequest.Builder newBuilder()
```
...
`[ListInsightsRequest.Builder](/java/docs/reference/google-cloud-recommender/2.38.0/com.google.cloud.recommender.v1beta1.ListInsightsRequest.Builder)`

### newBuilder(ListInsightsRequest prototype)

```
public static ListInsightsRequest.Builder newBuilder(ListInsightsRequest prototype)
```
...
```
public static ListInsightsRequest parseDelimitedFrom(InputStream input)
```
...
```
public static ListInsightsRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListInsightsRequest parseFrom(byte[] data)
```
...
```
public static ListInsightsRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListInsightsRequest parseFrom(ByteString data)
```
...
```
public static ListInsightsRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListInsightsRequest parseFrom(CodedInputStream input)
```
...
```
public static ListInsightsRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListInsightsRequest parseFrom(InputStream input)
```
...
```
public static ListInsightsRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListInsightsRequest parseFrom(ByteBuffer data)
```
...
```
public static ListInsightsRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ListInsightsRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListInsightsRequest](/java/docs/reference/google-cloud-recommender/2.38.0/com.google.cloud.recommender.v1beta1.ListInsightsRequest)>`
...
-   `stateInfo.state = ACTIVE AND (severity = CRITICAL OR severity = HIGH)`
    ...
    (These expressions are based on the filter language described at [https://google.aip.dev/160](https://google.aip.dev/160))
...
-   `organizations/[ORGANIZATION_ID]/locations/[LOCATION]/insightTypes/[INSIGHT_TYPE_ID]`
    ...
    LOCATION here refers to GCP Locations: [https://cloud.google.com/about/locations/](https://cloud.google.com/about/locations/) INSIGHT\_TYPE\_ID refers to supported insight types: [https://cloud.google.com/recommender/docs/insights/insight-types](https://cloud.google.com/recommender/docs/insights/insight-types).
...
```
public Parser<ListInsightsRequest> getParserForType()
```
...
```
public ListInsightsRequest.Builder newBuilderForType()
```
...
```
protected ListInsightsRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ListInsightsRequest.Builder toBuilder()
```
