...
# Interface GetGatewayRequestOrBuilder (0.14.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface GetGatewayRequestOrBuilder extends MessageOrBuilder
```
