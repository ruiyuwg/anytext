...
# Class CloudRedisClient.ListLocationsPage (2.90.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class CloudRedisClient.ListLocationsPage extends AbstractPage<ListLocationsRequest,ListLocationsResponse,Location,CloudRedisClient.ListLocationsPage>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractPage](https://docs.cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractPage.html) \> CloudRedisClient.ListLocationsPage
...
```
protected CloudRedisClient.ListLocationsPage createPage(PageContext<ListLocationsRequest,ListLocationsResponse,Location> context, ListLocationsResponse response)
```
...
`[CloudRedisClient.ListLocationsPage](/java/docs/reference/google-cloud-redis/latest/com.google.cloud.redis.v1.CloudRedisClient.ListLocationsPage)`
...
```
public ApiFuture<CloudRedisClient.ListLocationsPage> createPageAsync(PageContext<ListLocationsRequest,ListLocationsResponse,Location> context, ApiFuture<ListLocationsResponse> futureResponse)
```
...
`[ApiFuture](https://docs.cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListLocationsPage](/java/docs/reference/google-cloud-redis/latest/com.google.cloud.redis.v1.CloudRedisClient.ListLocationsPage)>`
