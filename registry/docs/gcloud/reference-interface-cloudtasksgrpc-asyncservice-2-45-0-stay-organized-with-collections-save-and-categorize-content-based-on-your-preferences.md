...
# Interface CloudTasksGrpc.AsyncService (2.45.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[CreateQueueRequest](/java/docs/reference/google-cloud-tasks/2.45.0/com.google.cloud.tasks.v2.CreateQueueRequest)`  

`responseObserver`

`io.grpc.stub.StreamObserver<[Queue](/java/docs/reference/google-cloud-tasks/2.45.0/com.google.cloud.tasks.v2.Queue)>`  
...
`[CreateTaskRequest](/java/docs/reference/google-cloud-tasks/2.45.0/com.google.cloud.tasks.v2.CreateTaskRequest)`  

`responseObserver`

`io.grpc.stub.StreamObserver<[Task](/java/docs/reference/google-cloud-tasks/2.45.0/com.google.cloud.tasks.v2.Task)>`  
...
`[DeleteQueueRequest](/java/docs/reference/google-cloud-tasks/2.45.0/com.google.cloud.tasks.v2.DeleteQueueRequest)`  
...
`[DeleteTaskRequest](/java/docs/reference/google-cloud-tasks/2.45.0/com.google.cloud.tasks.v2.DeleteTaskRequest)`  
...
`[GetQueueRequest](/java/docs/reference/google-cloud-tasks/2.45.0/com.google.cloud.tasks.v2.GetQueueRequest)`  
...
`[GetTaskRequest](/java/docs/reference/google-cloud-tasks/2.45.0/com.google.cloud.tasks.v2.GetTaskRequest)`  
...
`[ListQueuesRequest](/java/docs/reference/google-cloud-tasks/2.45.0/com.google.cloud.tasks.v2.ListQueuesRequest)`  

`responseObserver`

`io.grpc.stub.StreamObserver<[ListQueuesResponse](/java/docs/reference/google-cloud-tasks/2.45.0/com.google.cloud.tasks.v2.ListQueuesResponse)>`  
...
`[ListTasksRequest](/java/docs/reference/google-cloud-tasks/2.45.0/com.google.cloud.tasks.v2.ListTasksRequest)`  

`responseObserver`

`io.grpc.stub.StreamObserver<[ListTasksResponse](/java/docs/reference/google-cloud-tasks/2.45.0/com.google.cloud.tasks.v2.ListTasksResponse)>`  
...
`[PauseQueueRequest](/java/docs/reference/google-cloud-tasks/2.45.0/com.google.cloud.tasks.v2.PauseQueueRequest)`  
...
`[PurgeQueueRequest](/java/docs/reference/google-cloud-tasks/2.45.0/com.google.cloud.tasks.v2.PurgeQueueRequest)`  
...
`[ResumeQueueRequest](/java/docs/reference/google-cloud-tasks/2.45.0/com.google.cloud.tasks.v2.ResumeQueueRequest)`  
...
`[RunTaskRequest](/java/docs/reference/google-cloud-tasks/2.45.0/com.google.cloud.tasks.v2.RunTaskRequest)`  
...
`[UpdateQueueRequest](/java/docs/reference/google-cloud-tasks/2.45.0/com.google.cloud.tasks.v2.UpdateQueueRequest)`  
