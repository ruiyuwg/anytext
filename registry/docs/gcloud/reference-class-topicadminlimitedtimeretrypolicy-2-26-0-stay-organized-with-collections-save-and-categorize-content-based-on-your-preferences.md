...
# Class TopicAdminLimitedTimeRetryPolicy (2.26.0) Stay organized with collections Save and categorize content based on your preferences.
...
A retry policy for [`TopicAdminConnection`](/cpp/docs/reference/pubsub/2.26.0/classgoogle_1_1cloud_1_1pubsub__admin_1_1TopicAdminConnection) based on elapsed time.
...
-   [`kUnavailable`](/cpp/docs/reference/pubsub/2.26.0/namespacegoogle_1_1cloud_1a90e17f75452470f0f3ee1a06ffe58847)
