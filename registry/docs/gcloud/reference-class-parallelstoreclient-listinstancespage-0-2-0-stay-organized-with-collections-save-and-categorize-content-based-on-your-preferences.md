...
# Class ParallelstoreClient.ListInstancesPage (0.2.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class ParallelstoreClient.ListInstancesPage extends AbstractPage<ListInstancesRequest,ListInstancesResponse,Instance,ParallelstoreClient.ListInstancesPage>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractPage](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractPage.html) \> ParallelstoreClient.ListInstancesPage
...
```
protected ParallelstoreClient.ListInstancesPage createPage(PageContext<ListInstancesRequest,ListInstancesResponse,Instance> context, ListInstancesResponse response)
```
...
`[PageContext](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PageContext.html)<[ListInstancesRequest](/java/docs/reference/google-cloud-parallelstore/0.2.0/com.google.cloud.parallelstore.v1beta.ListInstancesRequest),[ListInstancesResponse](/java/docs/reference/google-cloud-parallelstore/0.2.0/com.google.cloud.parallelstore.v1beta.ListInstancesResponse),[Instance](/java/docs/reference/google-cloud-parallelstore/0.2.0/com.google.cloud.parallelstore.v1beta.Instance)>`  

`response`

`[ListInstancesResponse](/java/docs/reference/google-cloud-parallelstore/0.2.0/com.google.cloud.parallelstore.v1beta.ListInstancesResponse)`  
...
`[ParallelstoreClient.ListInstancesPage](/java/docs/reference/google-cloud-parallelstore/0.2.0/com.google.cloud.parallelstore.v1beta.ParallelstoreClient.ListInstancesPage)`
...
```
public ApiFuture<ParallelstoreClient.ListInstancesPage> createPageAsync(PageContext<ListInstancesRequest,ListInstancesResponse,Instance> context, ApiFuture<ListInstancesResponse> futureResponse)
```
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListInstancesResponse](/java/docs/reference/google-cloud-parallelstore/0.2.0/com.google.cloud.parallelstore.v1beta.ListInstancesResponse)>`  
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListInstancesPage](/java/docs/reference/google-cloud-parallelstore/0.2.0/com.google.cloud.parallelstore.v1beta.ParallelstoreClient.ListInstancesPage)>`
