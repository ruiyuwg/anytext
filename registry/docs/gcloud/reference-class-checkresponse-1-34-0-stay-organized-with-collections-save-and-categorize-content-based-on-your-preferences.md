...
# Class CheckResponse (1.34.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> CheckResponse

## Implements

[CheckResponseOrBuilder](/java/docs/reference/google-cloud-service-control/1.34.0/com.google.api.servicecontrol.v1.CheckResponseOrBuilder)
...
### SERVICE\_ROLLOUT\_ID\_FIELD\_NUMBER
...
`[CheckResponse](/java/docs/reference/google-cloud-service-control/1.34.0/com.google.api.servicecontrol.v1.CheckResponse)`
...
`[CheckResponse.Builder](/java/docs/reference/google-cloud-service-control/1.34.0/com.google.api.servicecontrol.v1.CheckResponse.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[CheckResponse](/java/docs/reference/google-cloud-service-control/1.34.0/com.google.api.servicecontrol.v1.CheckResponse)>`
...
`[CheckError](/java/docs/reference/google-cloud-service-control/1.34.0/com.google.api.servicecontrol.v1.CheckError)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[CheckError](/java/docs/reference/google-cloud-service-control/1.34.0/com.google.api.servicecontrol.v1.CheckError)>`
...
`[CheckErrorOrBuilder](/java/docs/reference/google-cloud-service-control/1.34.0/com.google.api.servicecontrol.v1.CheckErrorOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.api.servicecontrol.v1.CheckErrorOrBuilder>`
...
`[CheckResponse.CheckInfo](/java/docs/reference/google-cloud-service-control/1.34.0/com.google.api.servicecontrol.v1.CheckResponse.CheckInfo)`
...
`[CheckResponse.CheckInfoOrBuilder](/java/docs/reference/google-cloud-service-control/1.34.0/com.google.api.servicecontrol.v1.CheckResponse.CheckInfoOrBuilder)`
...
The same operation\_id value used in the CheckRequest. Used for logging and diagnostics purposes.
