...
# google-cloud-talent overview (2.88.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Talent Solution Description:** Allows you to transform your job search and candidate matching capabilities with Cloud Talent Solution, designed to support enterprise talent acquisition technology and evolve with your growing needs. This AI solution includes features such as Job Search and Profile Search (Beta) to provide candidates and employers with an enhanced talent acquisition experience. Learn more about Cloud Talent Solution from the product overview page.

[Talent Solution Product Reference](https://cloud.google.com/solutions/talent-solution/)

[GitHub Repository](https://github.com/googleapis/google-cloud-java/tree/main/java-talent)

[Maven artifact](https://central.sonatype.com/artifact/com.google.cloud/google-cloud-talent)
...
-   [Enable the API](https://console.cloud.google.com/apis/library/jobs.googleapis.com)
-   [Set up authentication](https://cloud.google.com/docs/authentication/client-libraries)

## Use the Talent Solution for Java
...
The example below demonstrates how you would import the BOM and include the `google-cloud-talent` artifact.
...
For this library, we recommend using [com.google.cloud.talent.v4](https://cloud.google.com/java/docs/reference/google-cloud-talent/2.88.0/com.google.cloud.talent.v4) for new applications.
