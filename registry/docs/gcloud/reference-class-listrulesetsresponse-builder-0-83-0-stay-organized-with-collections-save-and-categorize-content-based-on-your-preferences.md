...
# Class ListRuleSetsResponse.Builder (0.83.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class ListRuleSetsResponse.Builder extends GeneratedMessage.Builder<ListRuleSetsResponse.Builder> implements ListRuleSetsResponseOrBuilder
```
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessage.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessage.Builder.html) \> ListRuleSetsResponse.Builder

## Implements

[ListRuleSetsResponseOrBuilder](/java/docs/reference/google-cloud-contentwarehouse/latest/com.google.cloud.contentwarehouse.v1.ListRuleSetsResponseOrBuilder)
...
### addAllRuleSets(Iterable<? extends RuleSet> values)

```
public ListRuleSetsResponse.Builder addAllRuleSets(Iterable<? extends RuleSet> values)
```
...
`[Iterable](https://docs.oracle.com/javase/8/docs/api/java/lang/Iterable.html)<? extends com.google.cloud.contentwarehouse.v1.RuleSet>`  
...
`[ListRuleSetsResponse.Builder](/java/docs/reference/google-cloud-contentwarehouse/latest/com.google.cloud.contentwarehouse.v1.ListRuleSetsResponse.Builder)`

### addRuleSets(RuleSet value)

```
public ListRuleSetsResponse.Builder addRuleSets(RuleSet value)
```
...
`[RuleSet](/java/docs/reference/google-cloud-contentwarehouse/latest/com.google.cloud.contentwarehouse.v1.RuleSet)`  
...
### addRuleSets(RuleSet.Builder builderForValue)

```
public ListRuleSetsResponse.Builder addRuleSets(RuleSet.Builder builderForValue)
```
...
`[RuleSet.Builder](/java/docs/reference/google-cloud-contentwarehouse/latest/com.google.cloud.contentwarehouse.v1.RuleSet.Builder)`  
...
### addRuleSets(int index, RuleSet value)

```
public ListRuleSetsResponse.Builder addRuleSets(int index, RuleSet value)
```
...
### addRuleSets(int index, RuleSet.Builder builderForValue)

```
public ListRuleSetsResponse.Builder addRuleSets(int index, RuleSet.Builder builderForValue)
```
...
```
public RuleSet.Builder addRuleSetsBuilder()
```
...
### addRuleSetsBuilder(int index)

```
public RuleSet.Builder addRuleSetsBuilder(int index)
```
...
`[ListRuleSetsResponse](/java/docs/reference/google-cloud-contentwarehouse/latest/com.google.cloud.contentwarehouse.v1.ListRuleSetsResponse)`

### buildPartial()

```
public ListRuleSetsResponse buildPartial()
```
...
```
public ListRuleSetsResponse.Builder clear()
```
...
```
public ListRuleSetsResponse.Builder clearNextPageToken()
```
...
```
public ListRuleSetsResponse.Builder clearRuleSets()
```
...
```
public ListRuleSetsResponse getDefaultInstanceForType()
```
...
```
public RuleSet getRuleSets(int index)
```
...
### getRuleSetsBuilder(int index)

```
public RuleSet.Builder getRuleSetsBuilder(int index)
```
...
```
public List<RuleSet.Builder> getRuleSetsBuilderList()
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Builder](/java/docs/reference/google-cloud-contentwarehouse/latest/com.google.cloud.contentwarehouse.v1.RuleSet.Builder)>`
...
```
public List<RuleSet> getRuleSetsList()
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[RuleSet](/java/docs/reference/google-cloud-contentwarehouse/latest/com.google.cloud.contentwarehouse.v1.RuleSet)>`

### getRuleSetsOrBuilder(int index)

```
public RuleSetOrBuilder getRuleSetsOrBuilder(int index)
```
...
`[RuleSetOrBuilder](/java/docs/reference/google-cloud-contentwarehouse/latest/com.google.cloud.contentwarehouse.v1.RuleSetOrBuilder)`

### getRuleSetsOrBuilderList()

```
public List<? extends RuleSetOrBuilder> getRuleSetsOrBuilderList()
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.contentwarehouse.v1.RuleSetOrBuilder>`
...
### mergeFrom(ListRuleSetsResponse other)

```
public ListRuleSetsResponse.Builder mergeFrom(ListRuleSetsResponse other)
```
...
```
public ListRuleSetsResponse.Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public ListRuleSetsResponse.Builder mergeFrom(Message other)
```
...
### removeRuleSets(int index)

```
public ListRuleSetsResponse.Builder removeRuleSets(int index)
```
...
```
public ListRuleSetsResponse.Builder setNextPageToken(String value)
```
...
```
public ListRuleSetsResponse.Builder setNextPageTokenBytes(ByteString value)
```
...
### setRuleSets(int index, RuleSet value)

```
public ListRuleSetsResponse.Builder setRuleSets(int index, RuleSet value)
```
...
### setRuleSets(int index, RuleSet.Builder builderForValue)

```
public ListRuleSetsResponse.Builder setRuleSets(int index, RuleSet.Builder builderForValue)
```
