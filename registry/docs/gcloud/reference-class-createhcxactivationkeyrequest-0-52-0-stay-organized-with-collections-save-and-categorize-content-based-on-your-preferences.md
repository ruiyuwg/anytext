...
# Class CreateHcxActivationKeyRequest (0.52.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> CreateHcxActivationKeyRequest

## Implements

[CreateHcxActivationKeyRequestOrBuilder](/java/docs/reference/google-cloud-vmwareengine/0.52.0/com.google.cloud.vmwareengine.v1.CreateHcxActivationKeyRequestOrBuilder)
...
### HCX\_ACTIVATION\_KEY\_FIELD\_NUMBER

```
public static final int HCX_ACTIVATION_KEY_FIELD_NUMBER
```
...
### HCX\_ACTIVATION\_KEY\_ID\_FIELD\_NUMBER
...
`[CreateHcxActivationKeyRequest](/java/docs/reference/google-cloud-vmwareengine/0.52.0/com.google.cloud.vmwareengine.v1.CreateHcxActivationKeyRequest)`
...
```
public static CreateHcxActivationKeyRequest.Builder newBuilder()
```
...
`[CreateHcxActivationKeyRequest.Builder](/java/docs/reference/google-cloud-vmwareengine/0.52.0/com.google.cloud.vmwareengine.v1.CreateHcxActivationKeyRequest.Builder)`

### newBuilder(CreateHcxActivationKeyRequest prototype)

```
public static CreateHcxActivationKeyRequest.Builder newBuilder(CreateHcxActivationKeyRequest prototype)
```
...
```
public static CreateHcxActivationKeyRequest parseDelimitedFrom(InputStream input)
```
...
```
public static CreateHcxActivationKeyRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateHcxActivationKeyRequest parseFrom(byte[] data)
```
...
```
public static CreateHcxActivationKeyRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateHcxActivationKeyRequest parseFrom(ByteString data)
```
...
```
public static CreateHcxActivationKeyRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateHcxActivationKeyRequest parseFrom(CodedInputStream input)
```
...
```
public static CreateHcxActivationKeyRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateHcxActivationKeyRequest parseFrom(InputStream input)
```
...
```
public static CreateHcxActivationKeyRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateHcxActivationKeyRequest parseFrom(ByteBuffer data)
```
...
```
public static CreateHcxActivationKeyRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[CreateHcxActivationKeyRequest](/java/docs/reference/google-cloud-vmwareengine/0.52.0/com.google.cloud.vmwareengine.v1.CreateHcxActivationKeyRequest)>`
...
`[HcxActivationKey](/java/docs/reference/google-cloud-vmwareengine/0.52.0/com.google.cloud.vmwareengine.v1.HcxActivationKey)`
...
`[HcxActivationKeyOrBuilder](/java/docs/reference/google-cloud-vmwareengine/0.52.0/com.google.cloud.vmwareengine.v1.HcxActivationKeyOrBuilder)`
...
```
public CreateHcxActivationKeyRequest.Builder newBuilderForType()
```
...
```
protected CreateHcxActivationKeyRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public CreateHcxActivationKeyRequest.Builder toBuilder()
```
