...
# Struct AutoscalersRetryPolicyOption (2.17.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Alias Of**: `std::shared_ptr< AutoscalersRetryPolicy >`
