...
# Class Vehicle.LoadLimit (1.12.0) Stay organized with collections Save and categorize content based on your preferences.
...
### COST\_PER\_UNIT\_ABOVE\_SOFT\_MAX\_FIELD\_NUMBER
...
### END\_LOAD\_INTERVAL\_FIELD\_NUMBER
...
### SOFT\_MAX\_LOAD\_FIELD\_NUMBER
...
### START\_LOAD\_INTERVAL\_FIELD\_NUMBER
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[LoadLimit](/java/docs/reference/google-cloud-optimization/1.12.0/com.google.cloud.optimization.v1.Vehicle.LoadLimit)>`
...
If the load ever exceeds soft\_max\_load along this vehicle's route, the following cost penalty applies (only once per vehicle): (load - soft\_max\_load)

-   cost\_per\_unit\_above\_soft\_max. All costs add up and must be in the same unit as Shipment.penalty\_cost.
...
A soft limit of the load. See cost\_per\_unit\_above\_soft\_max.
