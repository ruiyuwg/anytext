...
# Vertex AI v1 API - Class Event.Types (3.20.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class Event.Types
```

Reference documentation and code samples for the Vertex AI v1 API class Event.Types.

Container for nested types declared in the Event message type.

## Inheritance

[object](https://learn.microsoft.com/dotnet/api/system.object) \> Event.Types
