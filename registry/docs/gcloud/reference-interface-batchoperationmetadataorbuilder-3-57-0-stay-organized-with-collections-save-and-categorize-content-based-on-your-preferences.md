...
# Interface BatchOperationMetadataOrBuilder (3.57.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[BatchOperationMetadata.State](/java/docs/reference/google-cloud-vision/3.57.0/com.google.cloud.vision.v1p4beta1.BatchOperationMetadata.State)`
