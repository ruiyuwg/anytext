...
# Class CryptoKeyPathName (2.47.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> CryptoKeyPathName
...
`[CryptoKeyPathName.Builder](/java/docs/reference/google-cloud-kms/2.47.0/com.google.cloud.kms.v1.CryptoKeyPathName.Builder)`
...
`[CryptoKeyPathName](/java/docs/reference/google-cloud-kms/2.47.0/com.google.cloud.kms.v1.CryptoKeyPathName)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[CryptoKeyPathName](/java/docs/reference/google-cloud-kms/2.47.0/com.google.cloud.kms.v1.CryptoKeyPathName)>`
