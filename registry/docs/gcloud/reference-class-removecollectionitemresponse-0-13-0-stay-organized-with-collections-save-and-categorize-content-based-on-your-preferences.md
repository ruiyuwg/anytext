...
# Class RemoveCollectionItemResponse (0.13.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class RemoveCollectionItemResponse extends GeneratedMessageV3 implements RemoveCollectionItemResponseOrBuilder
```

Request message for RemoveCollectionItem.

Protobuf type `google.cloud.visionai.v1.RemoveCollectionItemResponse`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> RemoveCollectionItemResponse

## Implements

[RemoveCollectionItemResponseOrBuilder](/java/docs/reference/google-cloud-visionai/0.13.0/com.google.cloud.visionai.v1.RemoveCollectionItemResponseOrBuilder)
...
```
public static RemoveCollectionItemResponse getDefaultInstance()
```
...
`[RemoveCollectionItemResponse](/java/docs/reference/google-cloud-visionai/0.13.0/com.google.cloud.visionai.v1.RemoveCollectionItemResponse)`
...
```
public static RemoveCollectionItemResponse.Builder newBuilder()
```
...
`[RemoveCollectionItemResponse.Builder](/java/docs/reference/google-cloud-visionai/0.13.0/com.google.cloud.visionai.v1.RemoveCollectionItemResponse.Builder)`

### newBuilder(RemoveCollectionItemResponse prototype)

```
public static RemoveCollectionItemResponse.Builder newBuilder(RemoveCollectionItemResponse prototype)
```
...
```
public static RemoveCollectionItemResponse parseDelimitedFrom(InputStream input)
```
...
```
public static RemoveCollectionItemResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RemoveCollectionItemResponse parseFrom(byte[] data)
```
...
```
public static RemoveCollectionItemResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RemoveCollectionItemResponse parseFrom(ByteString data)
```
...
```
public static RemoveCollectionItemResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RemoveCollectionItemResponse parseFrom(CodedInputStream input)
```
...
```
public static RemoveCollectionItemResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RemoveCollectionItemResponse parseFrom(InputStream input)
```
...
```
public static RemoveCollectionItemResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RemoveCollectionItemResponse parseFrom(ByteBuffer data)
```
...
```
public static RemoveCollectionItemResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<RemoveCollectionItemResponse> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[RemoveCollectionItemResponse](/java/docs/reference/google-cloud-visionai/0.13.0/com.google.cloud.visionai.v1.RemoveCollectionItemResponse)>`
...
```
public RemoveCollectionItemResponse getDefaultInstanceForType()
```
...
`.google.cloud.visionai.v1.CollectionItem item = 1;`
...
`[CollectionItem](/java/docs/reference/google-cloud-visionai/0.13.0/com.google.cloud.visionai.v1.CollectionItem)`
...
```
public CollectionItemOrBuilder getItemOrBuilder()
```
...
`[CollectionItemOrBuilder](/java/docs/reference/google-cloud-visionai/0.13.0/com.google.cloud.visionai.v1.CollectionItemOrBuilder)`

### getParserForType()

```
public Parser<RemoveCollectionItemResponse> getParserForType()
```
...
```
public RemoveCollectionItemResponse.Builder newBuilderForType()
```
...
```
protected RemoveCollectionItemResponse.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public RemoveCollectionItemResponse.Builder toBuilder()
```
