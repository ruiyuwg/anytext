...
# Enum VolumeRestore.VolumeType (0.39.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum VolumeRestore.VolumeType extends Enum<VolumeRestore.VolumeType> implements ProtocolMessageEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-gke-backup/0.39.0/com.google.cloud.gkebackup.v1.VolumeRestore.VolumeType#com_google_cloud_gkebackup_v1_VolumeRestore_VolumeType_forNumber_int_) instead._
