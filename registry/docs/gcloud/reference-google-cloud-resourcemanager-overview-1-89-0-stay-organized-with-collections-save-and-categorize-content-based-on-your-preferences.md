...
# google-cloud-resourcemanager overview (1.89.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Resource Manager API Description:** Enables you to programmatically manage resources by project, folder, and organization.

[Resource Manager API Product Reference](https://cloud.google.com/resource-manager)

[GitHub Repository](https://github.com/googleapis/google-cloud-java/tree/main/java-resourcemanager)

[Maven artifact](https://central.sonatype.com/artifact/com.google.cloud/google-cloud-resourcemanager)
...
## Use the Resource Manager API for Java
...
The example below demonstrates how you would import the BOM and include the `google-cloud-resourcemanager` artifact.
...
For this library, we recommend using [com.google.cloud.resourcemanager.v3](https://cloud.google.com/java/docs/reference/google-cloud-resourcemanager/1.89.0/com.google.cloud.resourcemanager.v3) for new applications.
