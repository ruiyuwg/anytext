...
# Class EnvironmentsLimitedTimeRetryPolicy (2.34.0) Stay organized with collections Save and categorize content based on your preferences.
...
A retry policy for [`EnvironmentsConnection`](/cpp/docs/reference/dialogflow_es/2.34.0/classgoogle_1_1cloud_1_1dialogflow__es_1_1EnvironmentsConnection) based on elapsed time.
...
`EnvironmentsLimitedTimeRetryPolicy const &`  
...
`std::unique_ptr< EnvironmentsRetryPolicy >`

## Type Aliases

### BaseType

**Alias Of**: `EnvironmentsRetryPolicy`
