...
# Interface GetLfpStoreRequestOrBuilder (0.7.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface GetLfpStoreRequestOrBuilder extends MessageOrBuilder
```
