...
# Class CancelCutoverJobResponse (1.12.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class CancelCutoverJobResponse extends GeneratedMessageV3 implements CancelCutoverJobResponseOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> CancelCutoverJobResponse

## Implements

[CancelCutoverJobResponseOrBuilder](/java/docs/reference/google-cloud-vmmigration/1.12.0/com.google.cloud.vmmigration.v1.CancelCutoverJobResponseOrBuilder)
...
```
public static CancelCutoverJobResponse getDefaultInstance()
```
...
`[CancelCutoverJobResponse](/java/docs/reference/google-cloud-vmmigration/1.12.0/com.google.cloud.vmmigration.v1.CancelCutoverJobResponse)`
...
```
public static CancelCutoverJobResponse.Builder newBuilder()
```
...
`[CancelCutoverJobResponse.Builder](/java/docs/reference/google-cloud-vmmigration/1.12.0/com.google.cloud.vmmigration.v1.CancelCutoverJobResponse.Builder)`

### newBuilder(CancelCutoverJobResponse prototype)

```
public static CancelCutoverJobResponse.Builder newBuilder(CancelCutoverJobResponse prototype)
```
...
```
public static CancelCutoverJobResponse parseDelimitedFrom(InputStream input)
```
...
```
public static CancelCutoverJobResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CancelCutoverJobResponse parseFrom(byte[] data)
```
...
```
public static CancelCutoverJobResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CancelCutoverJobResponse parseFrom(ByteString data)
```
...
```
public static CancelCutoverJobResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CancelCutoverJobResponse parseFrom(CodedInputStream input)
```
...
```
public static CancelCutoverJobResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CancelCutoverJobResponse parseFrom(InputStream input)
```
...
```
public static CancelCutoverJobResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CancelCutoverJobResponse parseFrom(ByteBuffer data)
```
...
```
public static CancelCutoverJobResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<CancelCutoverJobResponse> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[CancelCutoverJobResponse](/java/docs/reference/google-cloud-vmmigration/1.12.0/com.google.cloud.vmmigration.v1.CancelCutoverJobResponse)>`
...
```
public CancelCutoverJobResponse getDefaultInstanceForType()
```
...
```
public Parser<CancelCutoverJobResponse> getParserForType()
```
...
```
public CancelCutoverJobResponse.Builder newBuilderForType()
```
...
```
protected CancelCutoverJobResponse.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public CancelCutoverJobResponse.Builder toBuilder()
```
