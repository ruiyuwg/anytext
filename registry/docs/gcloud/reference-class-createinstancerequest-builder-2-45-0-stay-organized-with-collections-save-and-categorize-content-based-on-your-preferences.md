...
# Class CreateInstanceRequest.Builder (2.45.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> CreateInstanceRequest.Builder

## Implements

[CreateInstanceRequestOrBuilder](/java/docs/reference/google-cloud-memcache/2.45.0/com.google.cloud.memcache.v1beta2.CreateInstanceRequestOrBuilder)
...
`[CreateInstanceRequest.Builder](/java/docs/reference/google-cloud-memcache/2.45.0/com.google.cloud.memcache.v1beta2.CreateInstanceRequest.Builder)`
...
`[CreateInstanceRequest](/java/docs/reference/google-cloud-memcache/2.45.0/com.google.cloud.memcache.v1beta2.CreateInstanceRequest)`
...
```
public CreateInstanceRequest.Builder clearResource()
```
...
`[Instance](/java/docs/reference/google-cloud-memcache/2.45.0/com.google.cloud.memcache.v1beta2.Instance)`
...
`[Instance.Builder](/java/docs/reference/google-cloud-memcache/2.45.0/com.google.cloud.memcache.v1beta2.Instance.Builder)`
...
`[InstanceOrBuilder](/java/docs/reference/google-cloud-memcache/2.45.0/com.google.cloud.memcache.v1beta2.InstanceOrBuilder)`
...
```
public CreateInstanceRequest.Builder mergeResource(Instance value)
```
...
```
public CreateInstanceRequest.Builder setResource(Instance value)
```
...
```
public CreateInstanceRequest.Builder setResource(Instance.Builder builderForValue)
```
