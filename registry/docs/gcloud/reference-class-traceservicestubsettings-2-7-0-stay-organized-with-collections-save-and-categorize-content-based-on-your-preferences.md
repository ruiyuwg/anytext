...
# Class TraceServiceStubSettings (2.7.0) Stay organized with collections Save and categorize content based on your preferences.
...
Settings class to configure an instance of [TraceServiceStub](/java/docs/reference/google-cloud-trace/2.7.0/com.google.cloud.trace.v1.stub.TraceServiceStub).
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [StubSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.StubSettings.html) \> TraceServiceStubSettings
...
```
public static TraceServiceStubSettings.Builder newBuilder()
```
...
[TraceServiceStubSettings.Builder](/java/docs/reference/google-cloud-trace/2.7.0/com.google.cloud.trace.v1.stub.TraceServiceStubSettings.Builder)

### newBuilder(ClientContext clientContext)

```
public static TraceServiceStubSettings.Builder newBuilder(ClientContext clientContext)
```
...
```
public static TraceServiceStubSettings.Builder newHttpJsonBuilder()
```
...
### TraceServiceStubSettings(TraceServiceStubSettings.Builder settingsBuilder)

```
protected TraceServiceStubSettings(TraceServiceStubSettings.Builder settingsBuilder)
```
...
```
public TraceServiceStub createStub()
```
...
[TraceServiceStub](/java/docs/reference/google-cloud-trace/2.7.0/com.google.cloud.trace.v1.stub.TraceServiceStub)
...
[UnaryCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.html)<[GetTraceRequest](/java/docs/reference/google-cloud-trace/2.7.0/com.google.devtools.cloudtrace.v1.GetTraceRequest),[Trace](/java/docs/reference/google-cloud-trace/2.7.0/com.google.devtools.cloudtrace.v1.Trace)\>
...
[PagedCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PagedCallSettings.html)<[ListTracesRequest](/java/docs/reference/google-cloud-trace/2.7.0/com.google.devtools.cloudtrace.v1.ListTracesRequest),[ListTracesResponse](/java/docs/reference/google-cloud-trace/2.7.0/com.google.devtools.cloudtrace.v1.ListTracesResponse),[ListTracesPagedResponse](/java/docs/reference/google-cloud-trace/2.7.0/com.google.cloud.trace.v1.TraceServiceClient.ListTracesPagedResponse)\>
...
[UnaryCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.html)<[PatchTracesRequest](/java/docs/reference/google-cloud-trace/2.7.0/com.google.devtools.cloudtrace.v1.PatchTracesRequest),[Empty](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Empty.html)\>

### toBuilder()

```
public TraceServiceStubSettings.Builder toBuilder()
```
