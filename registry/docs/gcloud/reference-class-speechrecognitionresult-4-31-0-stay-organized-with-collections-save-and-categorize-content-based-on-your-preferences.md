...
# Class SpeechRecognitionResult (4.31.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> SpeechRecognitionResult

## Implements

[SpeechRecognitionResultOrBuilder](/java/docs/reference/google-cloud-speech/4.31.0/com.google.cloud.speech.v2.SpeechRecognitionResultOrBuilder)
...
`[SpeechRecognitionResult](/java/docs/reference/google-cloud-speech/4.31.0/com.google.cloud.speech.v2.SpeechRecognitionResult)`
...
`[SpeechRecognitionResult.Builder](/java/docs/reference/google-cloud-speech/4.31.0/com.google.cloud.speech.v2.SpeechRecognitionResult.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[SpeechRecognitionResult](/java/docs/reference/google-cloud-speech/4.31.0/com.google.cloud.speech.v2.SpeechRecognitionResult)>`
...
`[SpeechRecognitionAlternative](/java/docs/reference/google-cloud-speech/4.31.0/com.google.cloud.speech.v2.SpeechRecognitionAlternative)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[SpeechRecognitionAlternative](/java/docs/reference/google-cloud-speech/4.31.0/com.google.cloud.speech.v2.SpeechRecognitionAlternative)>`
...
`[SpeechRecognitionAlternativeOrBuilder](/java/docs/reference/google-cloud-speech/4.31.0/com.google.cloud.speech.v2.SpeechRecognitionAlternativeOrBuilder)`
