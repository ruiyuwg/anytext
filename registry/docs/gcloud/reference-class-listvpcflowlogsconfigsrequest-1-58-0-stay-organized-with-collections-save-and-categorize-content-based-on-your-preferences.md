...
# Class ListVpcFlowLogsConfigsRequest (1.58.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListVpcFlowLogsConfigsRequest extends GeneratedMessageV3 implements ListVpcFlowLogsConfigsRequestOrBuilder
```

Request for the `ListVpcFlowLogsConfigs` method.

Protobuf type `google.cloud.networkmanagement.v1beta1.ListVpcFlowLogsConfigsRequest`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListVpcFlowLogsConfigsRequest

## Implements

[ListVpcFlowLogsConfigsRequestOrBuilder](/java/docs/reference/google-cloud-network-management/1.58.0/com.google.cloud.networkmanagement.v1beta1.ListVpcFlowLogsConfigsRequestOrBuilder)
...
```
public static ListVpcFlowLogsConfigsRequest getDefaultInstance()
```
...
`[ListVpcFlowLogsConfigsRequest](/java/docs/reference/google-cloud-network-management/1.58.0/com.google.cloud.networkmanagement.v1beta1.ListVpcFlowLogsConfigsRequest)`
...
```
public static ListVpcFlowLogsConfigsRequest.Builder newBuilder()
```
...
`[ListVpcFlowLogsConfigsRequest.Builder](/java/docs/reference/google-cloud-network-management/1.58.0/com.google.cloud.networkmanagement.v1beta1.ListVpcFlowLogsConfigsRequest.Builder)`

### newBuilder(ListVpcFlowLogsConfigsRequest prototype)

```
public static ListVpcFlowLogsConfigsRequest.Builder newBuilder(ListVpcFlowLogsConfigsRequest prototype)
```
...
```
public static ListVpcFlowLogsConfigsRequest parseDelimitedFrom(InputStream input)
```
...
```
public static ListVpcFlowLogsConfigsRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListVpcFlowLogsConfigsRequest parseFrom(byte[] data)
```
...
```
public static ListVpcFlowLogsConfigsRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListVpcFlowLogsConfigsRequest parseFrom(ByteString data)
```
...
```
public static ListVpcFlowLogsConfigsRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListVpcFlowLogsConfigsRequest parseFrom(CodedInputStream input)
```
...
```
public static ListVpcFlowLogsConfigsRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListVpcFlowLogsConfigsRequest parseFrom(InputStream input)
```
...
```
public static ListVpcFlowLogsConfigsRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListVpcFlowLogsConfigsRequest parseFrom(ByteBuffer data)
```
...
```
public static ListVpcFlowLogsConfigsRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ListVpcFlowLogsConfigsRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListVpcFlowLogsConfigsRequest](/java/docs/reference/google-cloud-network-management/1.58.0/com.google.cloud.networkmanagement.v1beta1.ListVpcFlowLogsConfigsRequest)>`
...
```
public ListVpcFlowLogsConfigsRequest getDefaultInstanceForType()
```
...
```
public Parser<ListVpcFlowLogsConfigsRequest> getParserForType()
```
...
```
public ListVpcFlowLogsConfigsRequest.Builder newBuilderForType()
```
...
```
protected ListVpcFlowLogsConfigsRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ListVpcFlowLogsConfigsRequest.Builder toBuilder()
```
