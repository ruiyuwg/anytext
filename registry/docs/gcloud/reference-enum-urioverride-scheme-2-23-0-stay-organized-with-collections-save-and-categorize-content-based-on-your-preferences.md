...
# Enum UriOverride.Scheme (2.23.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum UriOverride.Scheme extends Enum<UriOverride.Scheme> implements ProtocolMessageEnum
```
...
Convert the scheme to HTTP, e.g., [https://www.google.ca](https://www.google.ca) will change to [http://www.google.ca](http://www.google.ca).

`HTTP = 1;`

`HTTPS`

Convert the scheme to HTTPS, e.g., [http://www.google.ca](http://www.google.ca) will change to [https://www.google.ca](https://www.google.ca).
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-tasks/2.23.0/com.google.cloud.tasks.v2beta3.UriOverride.Scheme#com_google_cloud_tasks_v2beta3_UriOverride_Scheme_forNumber_int_) instead._
