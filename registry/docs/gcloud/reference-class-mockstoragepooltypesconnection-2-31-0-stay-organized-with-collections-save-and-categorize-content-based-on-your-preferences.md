...
# Class MockStoragePoolTypesConnection (2.31.0) Stay organized with collections Save and categorize content based on your preferences.
...
Application developers may want to test their code with simulated responses, including errors, from an object of type `StoragePoolTypesClient`. To do so, construct an object of type `StoragePoolTypesClient` with an instance of this class. Then use the Google Test framework functions to program the behavior of this mock.
...
### virtual AggregatedListStoragePoolTypes(google::cloud::cpp::compute::storage\_pool\_types::v1::AggregatedListStoragePoolTypesRequest)
...
`google::cloud::cpp::compute::storage_pool_types::v1::AggregatedListStoragePoolTypesRequest`  
...
### virtual GetStoragePoolType(google::cloud::cpp::compute::storage\_pool\_types::v1::GetStoragePoolTypeRequest const &)
...
### virtual ListStoragePoolTypes(google::cloud::cpp::compute::storage\_pool\_types::v1::ListStoragePoolTypesRequest)
...
`google::cloud::cpp::compute::storage_pool_types::v1::ListStoragePoolTypesRequest`  
