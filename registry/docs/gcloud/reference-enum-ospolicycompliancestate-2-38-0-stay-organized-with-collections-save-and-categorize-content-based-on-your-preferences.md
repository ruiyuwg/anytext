...
# Enum OSPolicyComplianceState (2.38.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum OSPolicyComplianceState extends Enum<OSPolicyComplianceState> implements ProtocolMessageEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-os-config/2.38.0/com.google.cloud.osconfig.v1alpha.OSPolicyComplianceState#com_google_cloud_osconfig_v1alpha_OSPolicyComplianceState_forNumber_int_) instead._
