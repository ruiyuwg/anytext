...
# Enum CVSSv3.Scope (2.17.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/grafeas/2.17.0/io.grafeas.v1.CVSSv3.Scope#io_grafeas_v1_CVSSv3_Scope_forNumber_int_) instead._
