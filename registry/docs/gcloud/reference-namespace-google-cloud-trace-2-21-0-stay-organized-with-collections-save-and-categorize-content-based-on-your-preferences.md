...
# Namespace google::cloud::trace (2.21.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated:** This namespace is deprecated, prefer the types defined in [`trace_v2`](/cpp/docs/reference/trace/2.21.0/namespacegoogle_1_1cloud_1_1trace__v2).
