...
# Class CloudMemcacheClient.ListInstancesFixedSizeCollection (2.6.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ListInstancesPage](/java/docs/reference/google-cloud-memcache/2.6.0/com.google.cloud.memcache.v1.CloudMemcacheClient.ListInstancesPage)>`  
...
[CloudMemcacheClient.ListInstancesFixedSizeCollection](/java/docs/reference/google-cloud-memcache/2.6.0/com.google.cloud.memcache.v1.CloudMemcacheClient.ListInstancesFixedSizeCollection)
