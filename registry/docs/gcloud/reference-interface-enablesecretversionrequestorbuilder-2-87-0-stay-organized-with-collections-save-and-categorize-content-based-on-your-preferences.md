...
# Interface EnableSecretVersionRequestOrBuilder (2.87.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface EnableSecretVersionRequestOrBuilder extends MessageOrBuilder
```
