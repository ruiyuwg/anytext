...
# Enum TransferTypes.TransferOperation.Status (1.0.4) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-storage-transfer/1.0.4/com.google.storagetransfer.v1.proto.TransferTypes.TransferOperation.Status#com_google_storagetransfer_v1_proto_TransferTypes_TransferOperation_Status_forNumber_int_) instead._
