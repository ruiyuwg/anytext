...
# Class GetDatacenterConnectorRequest (1.39.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class GetDatacenterConnectorRequest extends GeneratedMessageV3 implements GetDatacenterConnectorRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> GetDatacenterConnectorRequest

## Implements

[GetDatacenterConnectorRequestOrBuilder](/java/docs/reference/google-cloud-vmmigration/1.39.0/com.google.cloud.vmmigration.v1.GetDatacenterConnectorRequestOrBuilder)
...
```
public static GetDatacenterConnectorRequest getDefaultInstance()
```
...
`[GetDatacenterConnectorRequest](/java/docs/reference/google-cloud-vmmigration/1.39.0/com.google.cloud.vmmigration.v1.GetDatacenterConnectorRequest)`
...
```
public static GetDatacenterConnectorRequest.Builder newBuilder()
```
...
`[GetDatacenterConnectorRequest.Builder](/java/docs/reference/google-cloud-vmmigration/1.39.0/com.google.cloud.vmmigration.v1.GetDatacenterConnectorRequest.Builder)`

### newBuilder(GetDatacenterConnectorRequest prototype)

```
public static GetDatacenterConnectorRequest.Builder newBuilder(GetDatacenterConnectorRequest prototype)
```
...
```
public static GetDatacenterConnectorRequest parseDelimitedFrom(InputStream input)
```
...
```
public static GetDatacenterConnectorRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetDatacenterConnectorRequest parseFrom(byte[] data)
```
...
```
public static GetDatacenterConnectorRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetDatacenterConnectorRequest parseFrom(ByteString data)
```
...
```
public static GetDatacenterConnectorRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetDatacenterConnectorRequest parseFrom(CodedInputStream input)
```
...
```
public static GetDatacenterConnectorRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetDatacenterConnectorRequest parseFrom(InputStream input)
```
...
```
public static GetDatacenterConnectorRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetDatacenterConnectorRequest parseFrom(ByteBuffer data)
```
...
```
public static GetDatacenterConnectorRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<GetDatacenterConnectorRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[GetDatacenterConnectorRequest](/java/docs/reference/google-cloud-vmmigration/1.39.0/com.google.cloud.vmmigration.v1.GetDatacenterConnectorRequest)>`
...
```
public GetDatacenterConnectorRequest getDefaultInstanceForType()
```
...
```
public Parser<GetDatacenterConnectorRequest> getParserForType()
```
...
```
public GetDatacenterConnectorRequest.Builder newBuilderForType()
```
...
```
protected GetDatacenterConnectorRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public GetDatacenterConnectorRequest.Builder toBuilder()
```
