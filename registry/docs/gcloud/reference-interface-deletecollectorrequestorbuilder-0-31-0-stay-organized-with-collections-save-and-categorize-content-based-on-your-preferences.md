...
# Interface DeleteCollectorRequestOrBuilder (0.31.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface DeleteCollectorRequestOrBuilder extends MessageOrBuilder
```
