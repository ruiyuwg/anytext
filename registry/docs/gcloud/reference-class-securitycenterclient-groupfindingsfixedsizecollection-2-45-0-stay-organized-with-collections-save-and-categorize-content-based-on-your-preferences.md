...
# Class SecurityCenterClient.GroupFindingsFixedSizeCollection (2.45.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class SecurityCenterClient.GroupFindingsFixedSizeCollection extends AbstractFixedSizeCollection<GroupFindingsRequest,GroupFindingsResponse,GroupResult,SecurityCenterClient.GroupFindingsPage,SecurityCenterClient.GroupFindingsFixedSizeCollection>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractFixedSizeCollection](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractFixedSizeCollection.html) \> SecurityCenterClient.GroupFindingsFixedSizeCollection
...
### createCollection(List<SecurityCenterClient.GroupFindingsPage> pages, int collectionSize)

```
protected SecurityCenterClient.GroupFindingsFixedSizeCollection createCollection(List<SecurityCenterClient.GroupFindingsPage> pages, int collectionSize)
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[GroupFindingsPage](/java/docs/reference/google-cloud-securitycenter/2.45.0/com.google.cloud.securitycenter.v1p1beta1.SecurityCenterClient.GroupFindingsPage)>`  
...
`[SecurityCenterClient.GroupFindingsFixedSizeCollection](/java/docs/reference/google-cloud-securitycenter/2.45.0/com.google.cloud.securitycenter.v1p1beta1.SecurityCenterClient.GroupFindingsFixedSizeCollection)`
