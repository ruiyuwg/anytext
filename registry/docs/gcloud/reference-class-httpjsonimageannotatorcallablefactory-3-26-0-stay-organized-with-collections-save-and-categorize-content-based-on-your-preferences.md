...
# Class HttpJsonImageAnnotatorCallableFactory (3.26.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public class HttpJsonImageAnnotatorCallableFactory implements HttpJsonStubCallableFactory<Operation,OperationsStub>
```
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> HttpJsonImageAnnotatorCallableFactory
...
### HttpJsonImageAnnotatorCallableFactory()

```
public HttpJsonImageAnnotatorCallableFactory()
```
