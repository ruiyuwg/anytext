...
# Class CreateUserRequest (0.15.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class CreateUserRequest extends GeneratedMessageV3 implements CreateUserRequestOrBuilder
```

Request message for the `CreateUser` method.

Protobuf type `google.shopping.merchant.accounts.v1beta.CreateUserRequest`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> CreateUserRequest

## Implements

[CreateUserRequestOrBuilder](/java/docs/reference/google-shopping-merchant-accounts/0.15.0/com.google.shopping.merchant.accounts.v1beta.CreateUserRequestOrBuilder)
...
`[CreateUserRequest](/java/docs/reference/google-shopping-merchant-accounts/0.15.0/com.google.shopping.merchant.accounts.v1beta.CreateUserRequest)`
...
```
public static CreateUserRequest.Builder newBuilder()
```
...
`[CreateUserRequest.Builder](/java/docs/reference/google-shopping-merchant-accounts/0.15.0/com.google.shopping.merchant.accounts.v1beta.CreateUserRequest.Builder)`

### newBuilder(CreateUserRequest prototype)

```
public static CreateUserRequest.Builder newBuilder(CreateUserRequest prototype)
```
...
```
public static CreateUserRequest parseDelimitedFrom(InputStream input)
```
...
```
public static CreateUserRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateUserRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateUserRequest parseFrom(ByteString data)
```
...
```
public static CreateUserRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateUserRequest parseFrom(CodedInputStream input)
```
...
```
public static CreateUserRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateUserRequest parseFrom(InputStream input)
```
...
```
public static CreateUserRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateUserRequest parseFrom(ByteBuffer data)
```
...
```
public static CreateUserRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[CreateUserRequest](/java/docs/reference/google-shopping-merchant-accounts/0.15.0/com.google.shopping.merchant.accounts.v1beta.CreateUserRequest)>`
...
`[User](/java/docs/reference/google-shopping-merchant-accounts/0.15.0/com.google.shopping.merchant.accounts.v1beta.User)`
...
`[UserOrBuilder](/java/docs/reference/google-shopping-merchant-accounts/0.15.0/com.google.shopping.merchant.accounts.v1beta.UserOrBuilder)`
...
```
public CreateUserRequest.Builder newBuilderForType()
```
...
```
protected CreateUserRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
