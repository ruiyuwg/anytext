...
# Class Pool.NetworkConfig (0.42.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class Pool.NetworkConfig extends GeneratedMessageV3 implements Pool.NetworkConfigOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> Pool.NetworkConfig

## Implements

[Pool.NetworkConfigOrBuilder](/java/docs/reference/google-cloud-live-stream/0.42.0/com.google.cloud.video.livestream.v1.Pool.NetworkConfigOrBuilder)
...
### PEERED\_NETWORK\_FIELD\_NUMBER
...
```
public static Pool.NetworkConfig getDefaultInstance()
```
...
`[Pool.NetworkConfig](/java/docs/reference/google-cloud-live-stream/0.42.0/com.google.cloud.video.livestream.v1.Pool.NetworkConfig)`
...
```
public static Pool.NetworkConfig.Builder newBuilder()
```
...
`[Pool.NetworkConfig.Builder](/java/docs/reference/google-cloud-live-stream/0.42.0/com.google.cloud.video.livestream.v1.Pool.NetworkConfig.Builder)`

### newBuilder(Pool.NetworkConfig prototype)

```
public static Pool.NetworkConfig.Builder newBuilder(Pool.NetworkConfig prototype)
```
...
```
public static Pool.NetworkConfig parseDelimitedFrom(InputStream input)
```
...
```
public static Pool.NetworkConfig parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Pool.NetworkConfig parseFrom(byte[] data)
```
...
```
public static Pool.NetworkConfig parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Pool.NetworkConfig parseFrom(ByteString data)
```
...
```
public static Pool.NetworkConfig parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Pool.NetworkConfig parseFrom(CodedInputStream input)
```
...
```
public static Pool.NetworkConfig parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Pool.NetworkConfig parseFrom(InputStream input)
```
...
```
public static Pool.NetworkConfig parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Pool.NetworkConfig parseFrom(ByteBuffer data)
```
...
```
public static Pool.NetworkConfig parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<Pool.NetworkConfig> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[NetworkConfig](/java/docs/reference/google-cloud-live-stream/0.42.0/com.google.cloud.video.livestream.v1.Pool.NetworkConfig)>`
...
```
public Parser<Pool.NetworkConfig> getParserForType()
```
...
peered\_network is the network resource URL of the network that is peered to the service provider network. Must be of the format projects/NETWORK\_PROJECT\_NUMBER/global/networks/NETWORK\_NAME, where NETWORK\_PROJECT\_NUMBER is the project number of the Cloud project that holds your VPC network and NETWORK\_NAME is the name of your VPC network. If peered\_network is omitted or empty, the pool will use endpoints that are publicly available.
...
```
public Pool.NetworkConfig.Builder newBuilderForType()
```
...
```
protected Pool.NetworkConfig.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public Pool.NetworkConfig.Builder toBuilder()
```
