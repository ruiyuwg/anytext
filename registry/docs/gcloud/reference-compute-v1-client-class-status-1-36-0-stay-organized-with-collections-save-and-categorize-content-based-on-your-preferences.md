...
# Compute V1 Client - Class Status (1.36.0) Stay organized with collections Save and categorize content based on your preferences.
...
Status contains string constants that represent the names of each value in the google.cloud.compute.v1.Image.Status descriptor.

## Namespace

Google \\ Cloud \\ Compute \\ V1 \\ Enums \\ Image
