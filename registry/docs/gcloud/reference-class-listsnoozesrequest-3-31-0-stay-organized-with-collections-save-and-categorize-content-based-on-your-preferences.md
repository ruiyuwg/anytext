...
# Class ListSnoozesRequest (3.31.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListSnoozesRequest extends GeneratedMessageV3 implements ListSnoozesRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListSnoozesRequest

## Implements

[ListSnoozesRequestOrBuilder](/java/docs/reference/google-cloud-monitoring/3.31.0/com.google.monitoring.v3.ListSnoozesRequestOrBuilder)
...
```
public static ListSnoozesRequest getDefaultInstance()
```
...
`[ListSnoozesRequest](/java/docs/reference/google-cloud-monitoring/3.31.0/com.google.monitoring.v3.ListSnoozesRequest)`
...
```
public static ListSnoozesRequest.Builder newBuilder()
```
...
`[ListSnoozesRequest.Builder](/java/docs/reference/google-cloud-monitoring/3.31.0/com.google.monitoring.v3.ListSnoozesRequest.Builder)`

### newBuilder(ListSnoozesRequest prototype)

```
public static ListSnoozesRequest.Builder newBuilder(ListSnoozesRequest prototype)
```
...
```
public static ListSnoozesRequest parseDelimitedFrom(InputStream input)
```
...
```
public static ListSnoozesRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListSnoozesRequest parseFrom(byte[] data)
```
...
```
public static ListSnoozesRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListSnoozesRequest parseFrom(ByteString data)
```
...
```
public static ListSnoozesRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListSnoozesRequest parseFrom(CodedInputStream input)
```
...
```
public static ListSnoozesRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListSnoozesRequest parseFrom(InputStream input)
```
...
```
public static ListSnoozesRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListSnoozesRequest parseFrom(ByteBuffer data)
```
...
```
public static ListSnoozesRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ListSnoozesRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListSnoozesRequest](/java/docs/reference/google-cloud-monitoring/3.31.0/com.google.monitoring.v3.ListSnoozesRequest)>`
...
```
public Parser<ListSnoozesRequest> getParserForType()
```
...
```
public ListSnoozesRequest.Builder newBuilderForType()
```
...
```
protected ListSnoozesRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ListSnoozesRequest.Builder toBuilder()
```
