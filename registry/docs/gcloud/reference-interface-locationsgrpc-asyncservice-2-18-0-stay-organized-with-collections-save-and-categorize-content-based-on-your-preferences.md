...
# Interface LocationsGrpc.AsyncService (2.18.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[GetLocationRequest](/java/docs/reference/google-cloud-translate/2.18.0/com.google.cloud.location.GetLocationRequest)`  

`responseObserver`

`io.grpc.stub.StreamObserver<[Location](/java/docs/reference/google-cloud-translate/2.18.0/com.google.cloud.location.Location)>`  
...
`[ListLocationsRequest](/java/docs/reference/google-cloud-translate/2.18.0/com.google.cloud.location.ListLocationsRequest)`  

`responseObserver`

`io.grpc.stub.StreamObserver<[ListLocationsResponse](/java/docs/reference/google-cloud-translate/2.18.0/com.google.cloud.location.ListLocationsResponse)>`  
