...
# Cloud AI Platform v1 API - Class DedicatedResources (2.20.0) Stay organized with collections Save and categorize content based on your preferences.
...
Reference documentation and code samples for the Cloud AI Platform v1 API class DedicatedResources.
...
[IMessage](https://cloud.google.com/dotnet/docs/reference/Google.Protobuf/latest/Google.Protobuf.IMessage-1.html)[DedicatedResources](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/2.20.0/Google.Cloud.AIPlatform.V1.DedicatedResources), [IEquatable](https://learn.microsoft.com/dotnet/api/system.iequatable-1)[DedicatedResources](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/2.20.0/Google.Cloud.AIPlatform.V1.DedicatedResources), [IDeepCloneable](https://cloud.google.com/dotnet/docs/reference/Google.Protobuf/latest/Google.Protobuf.IDeepCloneable-1.html)[DedicatedResources](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/2.20.0/Google.Cloud.AIPlatform.V1.DedicatedResources), [IBufferMessage](https://cloud.google.com/dotnet/docs/reference/Google.Protobuf/latest/Google.Protobuf.IBufferMessage.html), [IMessage](https://cloud.google.com/dotnet/docs/reference/Google.Protobuf/latest/Google.Protobuf.IMessage.html)
...
[Google.Cloud.AIPlatform.V1](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/2.20.0/Google.Cloud.AIPlatform.V1)
...
`[DedicatedResources](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/2.20.0/Google.Cloud.AIPlatform.V1.DedicatedResources)`  
...
`[RepeatedField](https://cloud.google.com/dotnet/docs/reference/Google.Protobuf/latest/Google.Protobuf.Collections.RepeatedField-1.html)[AutoscalingMetricSpec](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/2.20.0/Google.Cloud.AIPlatform.V1.AutoscalingMetricSpec)`
...
`[MachineSpec](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/2.20.0/Google.Cloud.AIPlatform.V1.MachineSpec)`
