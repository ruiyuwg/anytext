...
# Class ProjectName (2.53.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[ProjectName.Builder](/java/docs/reference/google-cloud-os-config/2.53.0/com.google.cloud.osconfig.v1beta.ProjectName.Builder)`
...
`[ProjectName](/java/docs/reference/google-cloud-os-config/2.53.0/com.google.cloud.osconfig.v1beta.ProjectName)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ProjectName](/java/docs/reference/google-cloud-os-config/2.53.0/com.google.cloud.osconfig.v1beta.ProjectName)>`
