...
# Class OperationMetadata (1.17.0) Stay organized with collections Save and categorize content based on your preferences.
...
[OperationMetadataOrBuilder](/java/docs/reference/google-cloud-gkehub/1.17.0/com.google.cloud.gkehub.v1.OperationMetadataOrBuilder)
...
`[OperationMetadata](/java/docs/reference/google-cloud-gkehub/1.17.0/com.google.cloud.gkehub.v1.OperationMetadata)`
...
`[OperationMetadata.Builder](/java/docs/reference/google-cloud-gkehub/1.17.0/com.google.cloud.gkehub.v1.OperationMetadata.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[OperationMetadata](/java/docs/reference/google-cloud-gkehub/1.17.0/com.google.cloud.gkehub.v1.OperationMetadata)>`
