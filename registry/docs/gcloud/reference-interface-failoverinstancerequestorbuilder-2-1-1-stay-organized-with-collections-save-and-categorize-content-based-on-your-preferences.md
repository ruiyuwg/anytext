...
# Interface FailoverInstanceRequestOrBuilder (2.1.1) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface FailoverInstanceRequestOrBuilder extends MessageOrBuilder
```
...
```
public abstract FailoverInstanceRequest.DataProtectionMode getDataProtectionMode()
```
...
[FailoverInstanceRequest.DataProtectionMode](/java/docs/reference/google-cloud-redis/2.1.1/com.google.cloud.redis.v1beta1.FailoverInstanceRequest.DataProtectionMode)
...
```
public abstract int getDataProtectionModeValue()
```
