...
# Class ListControlsRequest (2.36.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListControlsRequest extends GeneratedMessageV3 implements ListControlsRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListControlsRequest

## Implements

[ListControlsRequestOrBuilder](/java/docs/reference/google-cloud-retail/2.36.0/com.google.cloud.retail.v2beta.ListControlsRequestOrBuilder)
...
```
public static ListControlsRequest getDefaultInstance()
```
...
`[ListControlsRequest](/java/docs/reference/google-cloud-retail/2.36.0/com.google.cloud.retail.v2beta.ListControlsRequest)`
...
```
public static ListControlsRequest.Builder newBuilder()
```
...
`[ListControlsRequest.Builder](/java/docs/reference/google-cloud-retail/2.36.0/com.google.cloud.retail.v2beta.ListControlsRequest.Builder)`

### newBuilder(ListControlsRequest prototype)

```
public static ListControlsRequest.Builder newBuilder(ListControlsRequest prototype)
```
...
```
public static ListControlsRequest parseDelimitedFrom(InputStream input)
```
...
```
public static ListControlsRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListControlsRequest parseFrom(byte[] data)
```
...
```
public static ListControlsRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListControlsRequest parseFrom(ByteString data)
```
...
```
public static ListControlsRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListControlsRequest parseFrom(CodedInputStream input)
```
...
```
public static ListControlsRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListControlsRequest parseFrom(InputStream input)
```
...
```
public static ListControlsRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListControlsRequest parseFrom(ByteBuffer data)
```
...
```
public static ListControlsRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ListControlsRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListControlsRequest](/java/docs/reference/google-cloud-retail/2.36.0/com.google.cloud.retail.v2beta.ListControlsRequest)>`
...
```
public Parser<ListControlsRequest> getParserForType()
```
...
```
public ListControlsRequest.Builder newBuilderForType()
```
...
```
protected ListControlsRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ListControlsRequest.Builder toBuilder()
```
