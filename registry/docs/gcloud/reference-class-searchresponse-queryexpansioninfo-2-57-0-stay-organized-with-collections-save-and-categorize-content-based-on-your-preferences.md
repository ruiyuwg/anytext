...
# Class SearchResponse.QueryExpansionInfo (2.57.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class SearchResponse.QueryExpansionInfo extends GeneratedMessageV3 implements SearchResponse.QueryExpansionInfoOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> SearchResponse.QueryExpansionInfo

## Implements

[SearchResponse.QueryExpansionInfoOrBuilder](/java/docs/reference/google-cloud-retail/2.57.0/com.google.cloud.retail.v2beta.SearchResponse.QueryExpansionInfoOrBuilder)
...
### EXPANDED\_QUERY\_FIELD\_NUMBER

```
public static final int EXPANDED_QUERY_FIELD_NUMBER
```
...
### PINNED\_RESULT\_COUNT\_FIELD\_NUMBER

```
public static final int PINNED_RESULT_COUNT_FIELD_NUMBER
```
...
```
public static SearchResponse.QueryExpansionInfo getDefaultInstance()
```
...
`[SearchResponse.QueryExpansionInfo](/java/docs/reference/google-cloud-retail/2.57.0/com.google.cloud.retail.v2beta.SearchResponse.QueryExpansionInfo)`
...
```
public static SearchResponse.QueryExpansionInfo.Builder newBuilder()
```
...
`[SearchResponse.QueryExpansionInfo.Builder](/java/docs/reference/google-cloud-retail/2.57.0/com.google.cloud.retail.v2beta.SearchResponse.QueryExpansionInfo.Builder)`

### newBuilder(SearchResponse.QueryExpansionInfo prototype)

```
public static SearchResponse.QueryExpansionInfo.Builder newBuilder(SearchResponse.QueryExpansionInfo prototype)
```
...
```
public static SearchResponse.QueryExpansionInfo parseDelimitedFrom(InputStream input)
```
...
```
public static SearchResponse.QueryExpansionInfo parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SearchResponse.QueryExpansionInfo parseFrom(byte[] data)
```
...
```
public static SearchResponse.QueryExpansionInfo parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SearchResponse.QueryExpansionInfo parseFrom(ByteString data)
```
...
```
public static SearchResponse.QueryExpansionInfo parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SearchResponse.QueryExpansionInfo parseFrom(CodedInputStream input)
```
...
```
public static SearchResponse.QueryExpansionInfo parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SearchResponse.QueryExpansionInfo parseFrom(InputStream input)
```
...
```
public static SearchResponse.QueryExpansionInfo parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SearchResponse.QueryExpansionInfo parseFrom(ByteBuffer data)
```
...
```
public static SearchResponse.QueryExpansionInfo parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<SearchResponse.QueryExpansionInfo> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[QueryExpansionInfo](/java/docs/reference/google-cloud-retail/2.57.0/com.google.cloud.retail.v2beta.SearchResponse.QueryExpansionInfo)>`
...
```
public Parser<SearchResponse.QueryExpansionInfo> getParserForType()
```
...
Number of pinned results. This field will only be set when expansion happens and SearchRequest.QueryExpansionSpec.pin\_unexpanded\_results is set to true.
...
```
public SearchResponse.QueryExpansionInfo.Builder newBuilderForType()
```
...
```
protected SearchResponse.QueryExpansionInfo.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public SearchResponse.QueryExpansionInfo.Builder toBuilder()
```
