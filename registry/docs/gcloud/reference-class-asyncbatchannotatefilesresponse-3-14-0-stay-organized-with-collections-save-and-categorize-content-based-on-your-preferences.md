...
# Class AsyncBatchAnnotateFilesResponse (3.14.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> AsyncBatchAnnotateFilesResponse

## Implements

[AsyncBatchAnnotateFilesResponseOrBuilder](/java/docs/reference/google-cloud-vision/3.14.0/com.google.cloud.vision.v1.AsyncBatchAnnotateFilesResponseOrBuilder)
...
`[AsyncBatchAnnotateFilesResponse](/java/docs/reference/google-cloud-vision/3.14.0/com.google.cloud.vision.v1.AsyncBatchAnnotateFilesResponse)`
...
`[AsyncBatchAnnotateFilesResponse.Builder](/java/docs/reference/google-cloud-vision/3.14.0/com.google.cloud.vision.v1.AsyncBatchAnnotateFilesResponse.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[AsyncBatchAnnotateFilesResponse](/java/docs/reference/google-cloud-vision/3.14.0/com.google.cloud.vision.v1.AsyncBatchAnnotateFilesResponse)>`
...
`[AsyncAnnotateFileResponse](/java/docs/reference/google-cloud-vision/3.14.0/com.google.cloud.vision.v1.AsyncAnnotateFileResponse)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[AsyncAnnotateFileResponse](/java/docs/reference/google-cloud-vision/3.14.0/com.google.cloud.vision.v1.AsyncAnnotateFileResponse)>`
...
`[AsyncAnnotateFileResponseOrBuilder](/java/docs/reference/google-cloud-vision/3.14.0/com.google.cloud.vision.v1.AsyncAnnotateFileResponseOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.vision.v1.AsyncAnnotateFileResponseOrBuilder>`
