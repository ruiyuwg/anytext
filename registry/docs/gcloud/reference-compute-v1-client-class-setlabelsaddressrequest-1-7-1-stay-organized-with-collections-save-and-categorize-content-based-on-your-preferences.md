...
# Compute V1 Client - Class SetLabelsAddressRequest (1.7.1) Stay organized with collections Save and categorize content based on your preferences.
...
`[Google\Cloud\Compute\V1\RegionSetLabelsRequest](/php/docs/reference/cloud-compute/1.7.1/V1.RegionSetLabelsRequest)`  
...
`[Google\Cloud\Compute\V1\RegionSetLabelsRequest](/php/docs/reference/cloud-compute/1.7.1/V1.RegionSetLabelsRequest)|null`
