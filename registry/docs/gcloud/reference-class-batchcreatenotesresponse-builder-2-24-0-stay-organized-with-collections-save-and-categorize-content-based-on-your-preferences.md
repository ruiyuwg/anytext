...
# Class BatchCreateNotesResponse.Builder (2.24.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> BatchCreateNotesResponse.Builder

## Implements

[BatchCreateNotesResponseOrBuilder](/java/docs/reference/grafeas/2.24.0/io.grafeas.v1.BatchCreateNotesResponseOrBuilder)
...
`[Iterable](https://docs.oracle.com/javase/8/docs/api/java/lang/Iterable.html)<? extends io.grafeas.v1.Note>`  
...
`[BatchCreateNotesResponse.Builder](/java/docs/reference/grafeas/2.24.0/io.grafeas.v1.BatchCreateNotesResponse.Builder)`
...
`[Note](/java/docs/reference/grafeas/2.24.0/io.grafeas.v1.Note)`  
...
`[Note.Builder](/java/docs/reference/grafeas/2.24.0/io.grafeas.v1.Note.Builder)`  
...
`[BatchCreateNotesResponse](/java/docs/reference/grafeas/2.24.0/io.grafeas.v1.BatchCreateNotesResponse)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Builder](/java/docs/reference/grafeas/2.24.0/io.grafeas.v1.Note.Builder)>`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Note](/java/docs/reference/grafeas/2.24.0/io.grafeas.v1.Note)>`
...
`[NoteOrBuilder](/java/docs/reference/grafeas/2.24.0/io.grafeas.v1.NoteOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends io.grafeas.v1.NoteOrBuilder>`
