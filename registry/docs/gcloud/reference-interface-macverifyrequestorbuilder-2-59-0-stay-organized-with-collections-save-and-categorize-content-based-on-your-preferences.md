...
# Interface MacVerifyRequestOrBuilder (2.59.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface MacVerifyRequestOrBuilder extends MessageOrBuilder
```
...
```
public abstract ByteString getMac()
```
...
```
public abstract Int64ValueOrBuilder getMacCrc32COrBuilder()
```
...
```
public abstract boolean hasMacCrc32C()
```
