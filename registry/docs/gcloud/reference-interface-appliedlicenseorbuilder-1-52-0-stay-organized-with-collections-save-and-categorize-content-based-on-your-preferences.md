...
# Interface AppliedLicenseOrBuilder (1.52.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[AppliedLicense.Type](/java/docs/reference/google-cloud-vmmigration/1.52.0/com.google.cloud.vmmigration.v1.AppliedLicense.Type)`
