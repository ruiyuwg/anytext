...
# Class GetJobRequest.Builder (0.28.0) Stay organized with collections Save and categorize content based on your preferences.
...
[GetJobRequestOrBuilder](/java/docs/reference/google-cloud-run/0.28.0/com.google.cloud.run.v2.GetJobRequestOrBuilder)
...
`[GetJobRequest.Builder](/java/docs/reference/google-cloud-run/0.28.0/com.google.cloud.run.v2.GetJobRequest.Builder)`
...
`[GetJobRequest](/java/docs/reference/google-cloud-run/0.28.0/com.google.cloud.run.v2.GetJobRequest)`
