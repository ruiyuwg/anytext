...
# Class GetMetricsRequest (2.5.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class GetMetricsRequest extends GeneratedMessageV3 implements GetMetricsRequestOrBuilder
```

The get metrics request message.

Protobuf type `google.cloud.recaptchaenterprise.v1.GetMetricsRequest`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> GetMetricsRequest

## Implements

[GetMetricsRequestOrBuilder](/java/docs/reference/google-cloud-recaptchaenterprise/2.5.0/com.google.recaptchaenterprise.v1.GetMetricsRequestOrBuilder)
...
[GetMetricsRequest](/java/docs/reference/google-cloud-recaptchaenterprise/2.5.0/com.google.recaptchaenterprise.v1.GetMetricsRequest)
...
```
public static GetMetricsRequest.Builder newBuilder()
```
...
[GetMetricsRequest.Builder](/java/docs/reference/google-cloud-recaptchaenterprise/2.5.0/com.google.recaptchaenterprise.v1.GetMetricsRequest.Builder)

### newBuilder(GetMetricsRequest prototype)

```
public static GetMetricsRequest.Builder newBuilder(GetMetricsRequest prototype)
```
...
```
public static GetMetricsRequest parseDelimitedFrom(InputStream input)
```
...
```
public static GetMetricsRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetMetricsRequest parseFrom(byte[] data)
```
...
```
public static GetMetricsRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetMetricsRequest parseFrom(ByteString data)
```
...
```
public static GetMetricsRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetMetricsRequest parseFrom(CodedInputStream input)
```
...
```
public static GetMetricsRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetMetricsRequest parseFrom(InputStream input)
```
...
```
public static GetMetricsRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetMetricsRequest parseFrom(ByteBuffer data)
```
...
```
public static GetMetricsRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[GetMetricsRequest](/java/docs/reference/google-cloud-recaptchaenterprise/2.5.0/com.google.recaptchaenterprise.v1.GetMetricsRequest)\>
...
```
public GetMetricsRequest.Builder newBuilderForType()
```
...
```
protected GetMetricsRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public GetMetricsRequest.Builder toBuilder()
```
