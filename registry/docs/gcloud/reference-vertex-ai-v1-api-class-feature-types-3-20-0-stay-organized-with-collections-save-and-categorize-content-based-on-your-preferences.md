...
# Vertex AI v1 API - Class Feature.Types (3.20.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class Feature.Types
```

Reference documentation and code samples for the Vertex AI v1 API class Feature.Types.

Container for nested types declared in the Feature message type.

## Inheritance

[object](https://learn.microsoft.com/dotnet/api/system.object) \> Feature.Types
