...
# Class ServiceAccountName (0.27.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> ServiceAccountName
...
`[ServiceAccountName.Builder](/java/docs/reference/google-cloud-securitycenter-settings/0.27.0/com.google.cloud.securitycenter.settings.v1beta1.ServiceAccountName.Builder)`
...
`[ServiceAccountName](/java/docs/reference/google-cloud-securitycenter-settings/0.27.0/com.google.cloud.securitycenter.settings.v1beta1.ServiceAccountName)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ServiceAccountName](/java/docs/reference/google-cloud-securitycenter-settings/0.27.0/com.google.cloud.securitycenter.settings.v1beta1.ServiceAccountName)>`
