...
# Class SpannerIODetails.Builder (0.91.0) Stay organized with collections Save and categorize content based on your preferences.

0.91.0 (latest) 0.89.0 0.87.0 0.86.0 0.85.0 0.84.0 0.82.0 0.80.0 0.79.0 0.78.0 0.77.0 0.76.0 0.74.0 0.72.0 0.71.0 0.68.0 0.67.0 0.66.0 0.64.0 0.63.0 0.62.0 0.61.0 0.60.0 0.59.0 0.58.0 0.57.0 0.56.0 0.55.0 0.53.0 0.52.0 0.51.0 0.50.0 0.49.0 0.48.0 0.47.0 0.46.0 0.45.0 0.44.0 0.43.0 0.41.0 0.40.0 0.39.0 0.38.0 0.37.0 0.36.0 0.35.0 0.34.0 0.33.0 0.32.0 0.31.0 0.28.0 0.27.0 0.26.0 0.25.0 0.24.0 0.23.0 0.22.0 0.21.0 0.20.0 0.19.0 0.18.0 0.17.0 0.16.0 0.15.0 0.13.0 0.12.0 0.11.0 0.10.0 0.9.0 0.8.0 0.5.0

```
public static final class SpannerIODetails.Builder extends GeneratedMessage.Builder<SpannerIODetails.Builder> implements SpannerIODetailsOrBuilder
```
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessage.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessage.Builder.html) \> SpannerIODetails.Builder

## Implements

[SpannerIODetailsOrBuilder](/java/docs/reference/google-cloud-dataflow/latest/com.google.dataflow.v1beta3.SpannerIODetailsOrBuilder)
...
`[SpannerIODetails](/java/docs/reference/google-cloud-dataflow/latest/com.google.dataflow.v1beta3.SpannerIODetails)`

### buildPartial()

```
public SpannerIODetails buildPartial()
```
...
```
public SpannerIODetails.Builder clear()
```
...
`[SpannerIODetails.Builder](/java/docs/reference/google-cloud-dataflow/latest/com.google.dataflow.v1beta3.SpannerIODetails.Builder)`
...
```
public SpannerIODetails.Builder clearDatabaseId()
```
...
```
public SpannerIODetails.Builder clearInstanceId()
```
...
```
public SpannerIODetails.Builder clearProjectId()
```
...
```
public SpannerIODetails getDefaultInstanceForType()
```
...
### mergeFrom(SpannerIODetails other)

```
public SpannerIODetails.Builder mergeFrom(SpannerIODetails other)
```
...
```
public SpannerIODetails.Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public SpannerIODetails.Builder mergeFrom(Message other)
```
...
```
public SpannerIODetails.Builder setDatabaseId(String value)
```
...
```
public SpannerIODetails.Builder setDatabaseIdBytes(ByteString value)
```
...
```
public SpannerIODetails.Builder setInstanceId(String value)
```
...
```
public SpannerIODetails.Builder setInstanceIdBytes(ByteString value)
```
...
```
public SpannerIODetails.Builder setProjectId(String value)
```
...
```
public SpannerIODetails.Builder setProjectIdBytes(ByteString value)
```
