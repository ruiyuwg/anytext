...
# Class DeleteDeviceRegistryRequest (2.28.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class DeleteDeviceRegistryRequest extends GeneratedMessageV3 implements DeleteDeviceRegistryRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> DeleteDeviceRegistryRequest

## Implements

[DeleteDeviceRegistryRequestOrBuilder](/java/docs/reference/google-cloud-iot/2.28.0/com.google.cloud.iot.v1.DeleteDeviceRegistryRequestOrBuilder)
...
```
public static DeleteDeviceRegistryRequest getDefaultInstance()
```
...
`[DeleteDeviceRegistryRequest](/java/docs/reference/google-cloud-iot/2.28.0/com.google.cloud.iot.v1.DeleteDeviceRegistryRequest)`
...
```
public static DeleteDeviceRegistryRequest.Builder newBuilder()
```
...
`[DeleteDeviceRegistryRequest.Builder](/java/docs/reference/google-cloud-iot/2.28.0/com.google.cloud.iot.v1.DeleteDeviceRegistryRequest.Builder)`

### newBuilder(DeleteDeviceRegistryRequest prototype)

```
public static DeleteDeviceRegistryRequest.Builder newBuilder(DeleteDeviceRegistryRequest prototype)
```
...
```
public static DeleteDeviceRegistryRequest parseDelimitedFrom(InputStream input)
```
...
```
public static DeleteDeviceRegistryRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteDeviceRegistryRequest parseFrom(byte[] data)
```
...
```
public static DeleteDeviceRegistryRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteDeviceRegistryRequest parseFrom(ByteString data)
```
...
```
public static DeleteDeviceRegistryRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteDeviceRegistryRequest parseFrom(CodedInputStream input)
```
...
```
public static DeleteDeviceRegistryRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteDeviceRegistryRequest parseFrom(InputStream input)
```
...
```
public static DeleteDeviceRegistryRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteDeviceRegistryRequest parseFrom(ByteBuffer data)
```
...
```
public static DeleteDeviceRegistryRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<DeleteDeviceRegistryRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[DeleteDeviceRegistryRequest](/java/docs/reference/google-cloud-iot/2.28.0/com.google.cloud.iot.v1.DeleteDeviceRegistryRequest)>`
...
```
public Parser<DeleteDeviceRegistryRequest> getParserForType()
```
...
```
public DeleteDeviceRegistryRequest.Builder newBuilderForType()
```
...
```
protected DeleteDeviceRegistryRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public DeleteDeviceRegistryRequest.Builder toBuilder()
```
