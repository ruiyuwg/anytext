...
# Enum PartOfSpeech.Gender (2.28.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum PartOfSpeech.Gender extends Enum<PartOfSpeech.Gender> implements ProtocolMessageEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-language/2.28.0/com.google.cloud.language.v1beta2.PartOfSpeech.Gender#com_google_cloud_language_v1beta2_PartOfSpeech_Gender_forNumber_int_) instead._
