...
# Interface UpdateInstanceConfigRequestOrBuilder (1.46.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public abstract InstanceConfig getConfig()
```
...
`[InstanceConfig](/java/docs/reference/google-cloud-notebooks/1.46.0/com.google.cloud.notebooks.v1.InstanceConfig)`
...
```
public abstract InstanceConfigOrBuilder getConfigOrBuilder()
```
...
`[InstanceConfigOrBuilder](/java/docs/reference/google-cloud-notebooks/1.46.0/com.google.cloud.notebooks.v1.InstanceConfigOrBuilder)`
