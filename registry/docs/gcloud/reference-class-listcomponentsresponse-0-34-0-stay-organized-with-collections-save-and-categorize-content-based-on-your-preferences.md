...
# Class ListComponentsResponse (0.34.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListComponentsResponse extends GeneratedMessageV3 implements ListComponentsResponseOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListComponentsResponse

## Implements

[ListComponentsResponseOrBuilder](/java/docs/reference/google-cloud-securitycenter-settings/0.34.0/com.google.cloud.securitycenter.settings.v1beta1.ListComponentsResponseOrBuilder)
...
`[ListComponentsResponse](/java/docs/reference/google-cloud-securitycenter-settings/0.34.0/com.google.cloud.securitycenter.settings.v1beta1.ListComponentsResponse)`
...
```
public static ListComponentsResponse.Builder newBuilder()
```
...
`[ListComponentsResponse.Builder](/java/docs/reference/google-cloud-securitycenter-settings/0.34.0/com.google.cloud.securitycenter.settings.v1beta1.ListComponentsResponse.Builder)`

### newBuilder(ListComponentsResponse prototype)

```
public static ListComponentsResponse.Builder newBuilder(ListComponentsResponse prototype)
```
...
```
public static ListComponentsResponse parseDelimitedFrom(InputStream input)
```
...
```
public static ListComponentsResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListComponentsResponse parseFrom(byte[] data)
```
...
```
public static ListComponentsResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListComponentsResponse parseFrom(ByteString data)
```
...
```
public static ListComponentsResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListComponentsResponse parseFrom(CodedInputStream input)
```
...
```
public static ListComponentsResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListComponentsResponse parseFrom(InputStream input)
```
...
```
public static ListComponentsResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListComponentsResponse parseFrom(ByteBuffer data)
```
...
```
public static ListComponentsResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListComponentsResponse](/java/docs/reference/google-cloud-securitycenter-settings/0.34.0/com.google.cloud.securitycenter.settings.v1beta1.ListComponentsResponse)>`
...
```
public ListComponentsResponse.Builder newBuilderForType()
```
...
```
protected ListComponentsResponse.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ListComponentsResponse.Builder toBuilder()
```
