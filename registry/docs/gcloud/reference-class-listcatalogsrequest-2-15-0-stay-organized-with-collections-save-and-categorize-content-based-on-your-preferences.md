...
# Class ListCatalogsRequest (2.15.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListCatalogsRequest

## Implements

[ListCatalogsRequestOrBuilder](/java/docs/reference/google-cloud-retail/2.15.0/com.google.cloud.retail.v2beta.ListCatalogsRequestOrBuilder)
...
`[ListCatalogsRequest](/java/docs/reference/google-cloud-retail/2.15.0/com.google.cloud.retail.v2beta.ListCatalogsRequest)`
...
`[ListCatalogsRequest.Builder](/java/docs/reference/google-cloud-retail/2.15.0/com.google.cloud.retail.v2beta.ListCatalogsRequest.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListCatalogsRequest](/java/docs/reference/google-cloud-retail/2.15.0/com.google.cloud.retail.v2beta.ListCatalogsRequest)>`
...
Maximum number of Catalogs to return. If unspecified, defaults to 50. The maximum allowed value is 1000. Values above 1000 will be coerced to 1000. If this field is negative, an INVALID\_ARGUMENT is returned.
...
Required. The account resource name with an associated location. If the caller does not have permission to list Catalogs under this location, regardless of whether or not this location exists, a PERMISSION\_DENIED error is returned.
