...
# Class VideoObjectTrackingPredictionResult.DetectedObject.Builder (0.10.0) Stay organized with collections Save and categorize content based on your preferences.
...
Each DetectedObject is one particular identification of an object specified with the AnnotationSpec id and display\_name, the bounding box, the associated confidence score and the corresponding track\_id.

Protobuf type `google.cloud.visionai.v1.VideoObjectTrackingPredictionResult.DetectedObject`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> VideoObjectTrackingPredictionResult.DetectedObject.Builder

## Implements

[VideoObjectTrackingPredictionResult.DetectedObjectOrBuilder](/java/docs/reference/google-cloud-visionai/0.10.0/com.google.cloud.visionai.v1.VideoObjectTrackingPredictionResult.DetectedObjectOrBuilder)
...
`[VideoObjectTrackingPredictionResult.DetectedObject.Builder](/java/docs/reference/google-cloud-visionai/0.10.0/com.google.cloud.visionai.v1.VideoObjectTrackingPredictionResult.DetectedObject.Builder)`
...
`[VideoObjectTrackingPredictionResult.DetectedObject](/java/docs/reference/google-cloud-visionai/0.10.0/com.google.cloud.visionai.v1.VideoObjectTrackingPredictionResult.DetectedObject)`
...
The same object may be identified on muitiple frames which are typical adjacent. The set of frames where a particular object has been detected form a track. This track\_id can be used to trace down all frames for an detected object.
...
`[VideoObjectTrackingPredictionResult.BoundingBox](/java/docs/reference/google-cloud-visionai/0.10.0/com.google.cloud.visionai.v1.VideoObjectTrackingPredictionResult.BoundingBox)`
...
`[VideoObjectTrackingPredictionResult.BoundingBox.Builder](/java/docs/reference/google-cloud-visionai/0.10.0/com.google.cloud.visionai.v1.VideoObjectTrackingPredictionResult.BoundingBox.Builder)`
...
`[VideoObjectTrackingPredictionResult.BoundingBoxOrBuilder](/java/docs/reference/google-cloud-visionai/0.10.0/com.google.cloud.visionai.v1.VideoObjectTrackingPredictionResult.BoundingBoxOrBuilder)`
