...
# Class PredictionServiceRetryPolicy (2.16.0) Stay organized with collections Save and categorize content based on your preferences.
...
The retry policy for [`PredictionServiceConnection`](/cpp/docs/reference/automl/2.16.0/classgoogle_1_1cloud_1_1automl__v1_1_1PredictionServiceConnection).
