...
# Class SearchDeploymentRevisionsResponse (0.28.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class SearchDeploymentRevisionsResponse extends GeneratedMessageV3 implements SearchDeploymentRevisionsResponseOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> SearchDeploymentRevisionsResponse

## Implements

[SearchDeploymentRevisionsResponseOrBuilder](/java/docs/reference/google-cloud-telcoautomation/0.28.0/com.google.cloud.telcoautomation.v1alpha1.SearchDeploymentRevisionsResponseOrBuilder)
...
```
public static SearchDeploymentRevisionsResponse getDefaultInstance()
```
...
`[SearchDeploymentRevisionsResponse](/java/docs/reference/google-cloud-telcoautomation/0.28.0/com.google.cloud.telcoautomation.v1alpha1.SearchDeploymentRevisionsResponse)`
...
```
public static SearchDeploymentRevisionsResponse.Builder newBuilder()
```
...
`[SearchDeploymentRevisionsResponse.Builder](/java/docs/reference/google-cloud-telcoautomation/0.28.0/com.google.cloud.telcoautomation.v1alpha1.SearchDeploymentRevisionsResponse.Builder)`

### newBuilder(SearchDeploymentRevisionsResponse prototype)

```
public static SearchDeploymentRevisionsResponse.Builder newBuilder(SearchDeploymentRevisionsResponse prototype)
```
...
```
public static SearchDeploymentRevisionsResponse parseDelimitedFrom(InputStream input)
```
...
```
public static SearchDeploymentRevisionsResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SearchDeploymentRevisionsResponse parseFrom(byte[] data)
```
...
```
public static SearchDeploymentRevisionsResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SearchDeploymentRevisionsResponse parseFrom(ByteString data)
```
...
```
public static SearchDeploymentRevisionsResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SearchDeploymentRevisionsResponse parseFrom(CodedInputStream input)
```
...
```
public static SearchDeploymentRevisionsResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SearchDeploymentRevisionsResponse parseFrom(InputStream input)
```
...
```
public static SearchDeploymentRevisionsResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SearchDeploymentRevisionsResponse parseFrom(ByteBuffer data)
```
...
```
public static SearchDeploymentRevisionsResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<SearchDeploymentRevisionsResponse> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[SearchDeploymentRevisionsResponse](/java/docs/reference/google-cloud-telcoautomation/0.28.0/com.google.cloud.telcoautomation.v1alpha1.SearchDeploymentRevisionsResponse)>`
...
```
public SearchDeploymentRevisionsResponse getDefaultInstanceForType()
```
...
`[Deployment](/java/docs/reference/google-cloud-telcoautomation/0.28.0/com.google.cloud.telcoautomation.v1alpha1.Deployment)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Deployment](/java/docs/reference/google-cloud-telcoautomation/0.28.0/com.google.cloud.telcoautomation.v1alpha1.Deployment)>`
...
`[DeploymentOrBuilder](/java/docs/reference/google-cloud-telcoautomation/0.28.0/com.google.cloud.telcoautomation.v1alpha1.DeploymentOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.telcoautomation.v1alpha1.DeploymentOrBuilder>`
...
```
public Parser<SearchDeploymentRevisionsResponse> getParserForType()
```
...
```
public SearchDeploymentRevisionsResponse.Builder newBuilderForType()
```
...
```
protected SearchDeploymentRevisionsResponse.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public SearchDeploymentRevisionsResponse.Builder toBuilder()
```
