...
# Class DeleteGlossaryResponse (2.87.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class DeleteGlossaryResponse extends GeneratedMessage implements DeleteGlossaryResponseOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessage.html) \> DeleteGlossaryResponse

## Implements

[DeleteGlossaryResponseOrBuilder](/java/docs/reference/google-cloud-translate/latest/com.google.cloud.translate.v3.DeleteGlossaryResponseOrBuilder)
...
`[DeleteGlossaryResponse](/java/docs/reference/google-cloud-translate/latest/com.google.cloud.translate.v3.DeleteGlossaryResponse)`
...
```
public static DeleteGlossaryResponse.Builder newBuilder()
```
...
`[DeleteGlossaryResponse.Builder](/java/docs/reference/google-cloud-translate/latest/com.google.cloud.translate.v3.DeleteGlossaryResponse.Builder)`

### newBuilder(DeleteGlossaryResponse prototype)

```
public static DeleteGlossaryResponse.Builder newBuilder(DeleteGlossaryResponse prototype)
```
...
```
public static DeleteGlossaryResponse parseDelimitedFrom(InputStream input)
```
...
```
public static DeleteGlossaryResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteGlossaryResponse parseFrom(byte[] data)
```
...
```
public static DeleteGlossaryResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteGlossaryResponse parseFrom(ByteString data)
```
...
```
public static DeleteGlossaryResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteGlossaryResponse parseFrom(CodedInputStream input)
```
...
```
public static DeleteGlossaryResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteGlossaryResponse parseFrom(InputStream input)
```
...
```
public static DeleteGlossaryResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteGlossaryResponse parseFrom(ByteBuffer data)
```
...
```
public static DeleteGlossaryResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<DeleteGlossaryResponse> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[DeleteGlossaryResponse](/java/docs/reference/google-cloud-translate/latest/com.google.cloud.translate.v3.DeleteGlossaryResponse)>`
...
```
public Parser<DeleteGlossaryResponse> getParserForType()
```
...
```
public DeleteGlossaryResponse.Builder newBuilderForType()
```
...
```
protected DeleteGlossaryResponse.Builder newBuilderForType(AbstractMessage.BuilderParent parent)
```
...
```
public DeleteGlossaryResponse.Builder toBuilder()
```
