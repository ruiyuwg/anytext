...
# Class OsConfigZonalServiceClient.ListOSPolicyAssignmentReportsFixedSizeCollection (2.45.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class OsConfigZonalServiceClient.ListOSPolicyAssignmentReportsFixedSizeCollection extends AbstractFixedSizeCollection<ListOSPolicyAssignmentReportsRequest,ListOSPolicyAssignmentReportsResponse,OSPolicyAssignmentReport,OsConfigZonalServiceClient.ListOSPolicyAssignmentReportsPage,OsConfigZonalServiceClient.ListOSPolicyAssignmentReportsFixedSizeCollection>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractFixedSizeCollection](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractFixedSizeCollection.html) \> OsConfigZonalServiceClient.ListOSPolicyAssignmentReportsFixedSizeCollection
...
### createCollection(List<OsConfigZonalServiceClient.ListOSPolicyAssignmentReportsPage> pages, int collectionSize)

```
protected OsConfigZonalServiceClient.ListOSPolicyAssignmentReportsFixedSizeCollection createCollection(List<OsConfigZonalServiceClient.ListOSPolicyAssignmentReportsPage> pages, int collectionSize)
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ListOSPolicyAssignmentReportsPage](/java/docs/reference/google-cloud-os-config/2.45.0/com.google.cloud.osconfig.v1.OsConfigZonalServiceClient.ListOSPolicyAssignmentReportsPage)>`  
...
`[OsConfigZonalServiceClient.ListOSPolicyAssignmentReportsFixedSizeCollection](/java/docs/reference/google-cloud-os-config/2.45.0/com.google.cloud.osconfig.v1.OsConfigZonalServiceClient.ListOSPolicyAssignmentReportsFixedSizeCollection)`
