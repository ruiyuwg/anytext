...
# Class OperationMetadata.Builder (0.43.0) Stay organized with collections Save and categorize content based on your preferences.
...
[OperationMetadataOrBuilder](/java/docs/reference/google-cloud-vmwareengine/0.43.0/com.google.cloud.vmwareengine.v1.OperationMetadataOrBuilder)
...
`[OperationMetadata.Builder](/java/docs/reference/google-cloud-vmwareengine/0.43.0/com.google.cloud.vmwareengine.v1.OperationMetadata.Builder)`
...
`[OperationMetadata](/java/docs/reference/google-cloud-vmwareengine/0.43.0/com.google.cloud.vmwareengine.v1.OperationMetadata)`
...
```
public OperationMetadata.Builder clearStatusMessage()
```
