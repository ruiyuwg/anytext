...
# Override compute\_region\_disk\_types\_v1::RegionDiskTypesClient Authentication Defaults
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::compute_region_disk_types_v1::RegionDiskTypesClient(
