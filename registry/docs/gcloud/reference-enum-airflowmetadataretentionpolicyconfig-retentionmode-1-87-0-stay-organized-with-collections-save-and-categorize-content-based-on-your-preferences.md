...
# Enum AirflowMetadataRetentionPolicyConfig.RetentionMode (1.87.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum AirflowMetadataRetentionPolicyConfig.RetentionMode extends Enum<AirflowMetadataRetentionPolicyConfig.RetentionMode> implements ProtocolMessageEnum
```

Describes retention policy.

Protobuf enum `google.cloud.orchestration.airflow.service.v1.AirflowMetadataRetentionPolicyConfig.RetentionMode`
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-orchestration-airflow/latest/com.google.cloud.orchestration.airflow.service.v1.AirflowMetadataRetentionPolicyConfig.RetentionMode#com_google_cloud_orchestration_airflow_service_v1_AirflowMetadataRetentionPolicyConfig_RetentionMode_forNumber_int_) instead._
