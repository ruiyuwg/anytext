...
# Class GrpcWebRiskServiceV1Beta1CallableFactory (2.47.0) Stay organized with collections Save and categorize content based on your preferences.
...
gRPC callable factory implementation for the WebRiskServiceV1Beta1 service API.

This class is for advanced usage.

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> GrpcWebRiskServiceV1Beta1CallableFactory
...
```
public GrpcWebRiskServiceV1Beta1CallableFactory()
```
