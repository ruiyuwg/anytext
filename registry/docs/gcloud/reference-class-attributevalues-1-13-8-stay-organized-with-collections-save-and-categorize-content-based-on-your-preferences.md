...
# Class AttributeValues (1.13.8) Stay organized with collections Save and categorize content based on your preferences.

1.16.2 (latest) 1.16.1 1.15.21 1.14.8 1.13.8 1.12.22 1.11.2 1.10.0 1.9.4 1.8.0 1.7.1 1.6.3 1.5.5 1.4.12

```
public final class AttributeValues extends GeneratedMessageV3 implements AttributeValuesOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> AttributeValues

## Implements

[AttributeValuesOrBuilder](/java/docs/reference/google-cloud-pubsublite/1.13.8/com.google.cloud.pubsublite.proto.AttributeValuesOrBuilder)
...
```
public static AttributeValues getDefaultInstance()
```
...
`[AttributeValues](/java/docs/reference/google-cloud-pubsublite/1.13.8/com.google.cloud.pubsublite.proto.AttributeValues)`
...
```
public static AttributeValues.Builder newBuilder()
```
...
`[AttributeValues.Builder](/java/docs/reference/google-cloud-pubsublite/1.13.8/com.google.cloud.pubsublite.proto.AttributeValues.Builder)`

### newBuilder(AttributeValues prototype)

```
public static AttributeValues.Builder newBuilder(AttributeValues prototype)
```
...
```
public static AttributeValues parseDelimitedFrom(InputStream input)
```
...
```
public static AttributeValues parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AttributeValues parseFrom(byte[] data)
```
...
```
public static AttributeValues parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AttributeValues parseFrom(ByteString data)
```
...
```
public static AttributeValues parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AttributeValues parseFrom(CodedInputStream input)
```
...
```
public static AttributeValues parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AttributeValues parseFrom(InputStream input)
```
...
```
public static AttributeValues parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AttributeValues parseFrom(ByteBuffer data)
```
...
```
public static AttributeValues parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<AttributeValues> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[AttributeValues](/java/docs/reference/google-cloud-pubsublite/1.13.8/com.google.cloud.pubsublite.proto.AttributeValues)>`
...
```
public Parser<AttributeValues> getParserForType()
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ByteString](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.ByteString.html)>`
...
```
public AttributeValues.Builder newBuilderForType()
```
...
```
protected AttributeValues.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public AttributeValues.Builder toBuilder()
```
