...
# Class OperationMetadata (0.3.0) Stay organized with collections Save and categorize content based on your preferences.
...
Protobuf type `google.cloud.parallelstore.v1beta.OperationMetadata`
...
[OperationMetadataOrBuilder](/java/docs/reference/google-cloud-parallelstore/0.3.0/com.google.cloud.parallelstore.v1beta.OperationMetadataOrBuilder)
...
`[OperationMetadata](/java/docs/reference/google-cloud-parallelstore/0.3.0/com.google.cloud.parallelstore.v1beta.OperationMetadata)`
...
`[OperationMetadata.Builder](/java/docs/reference/google-cloud-parallelstore/0.3.0/com.google.cloud.parallelstore.v1beta.OperationMetadata.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[OperationMetadata](/java/docs/reference/google-cloud-parallelstore/0.3.0/com.google.cloud.parallelstore.v1beta.OperationMetadata)>`
