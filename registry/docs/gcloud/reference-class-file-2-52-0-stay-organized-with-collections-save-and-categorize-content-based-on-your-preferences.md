...
# Class File (2.52.0) Stay organized with collections Save and categorize content based on your preferences.
...
### PARTIALLY\_HASHED\_FIELD\_NUMBER
...
`[File](/java/docs/reference/google-cloud-securitycenter/2.52.0/com.google.cloud.securitycenter.v2.File)`
...
`[File.Builder](/java/docs/reference/google-cloud-securitycenter/2.52.0/com.google.cloud.securitycenter.v2.File.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[File](/java/docs/reference/google-cloud-securitycenter/2.52.0/com.google.cloud.securitycenter.v2.File)>`
...
`[File.DiskPath](/java/docs/reference/google-cloud-securitycenter/2.52.0/com.google.cloud.securitycenter.v2.File.DiskPath)`
...
`[File.DiskPathOrBuilder](/java/docs/reference/google-cloud-securitycenter/2.52.0/com.google.cloud.securitycenter.v2.File.DiskPathOrBuilder)`
