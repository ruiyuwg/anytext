...
# Class WorkloadsConfig.SchedulerResource (1.32.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class WorkloadsConfig.SchedulerResource extends GeneratedMessageV3 implements WorkloadsConfig.SchedulerResourceOrBuilder
```

Configuration for resources used by Airflow schedulers.

Protobuf type `google.cloud.orchestration.airflow.service.v1beta1.WorkloadsConfig.SchedulerResource`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> WorkloadsConfig.SchedulerResource

## Implements

[WorkloadsConfig.SchedulerResourceOrBuilder](/java/docs/reference/google-cloud-orchestration-airflow/1.32.0/com.google.cloud.orchestration.airflow.service.v1beta1.WorkloadsConfig.SchedulerResourceOrBuilder)
...
### STORAGE\_GB\_FIELD\_NUMBER

```
public static final int STORAGE_GB_FIELD_NUMBER
```
...
```
public static WorkloadsConfig.SchedulerResource getDefaultInstance()
```
...
`[WorkloadsConfig.SchedulerResource](/java/docs/reference/google-cloud-orchestration-airflow/1.32.0/com.google.cloud.orchestration.airflow.service.v1beta1.WorkloadsConfig.SchedulerResource)`
...
```
public static WorkloadsConfig.SchedulerResource.Builder newBuilder()
```
...
`[WorkloadsConfig.SchedulerResource.Builder](/java/docs/reference/google-cloud-orchestration-airflow/1.32.0/com.google.cloud.orchestration.airflow.service.v1beta1.WorkloadsConfig.SchedulerResource.Builder)`

### newBuilder(WorkloadsConfig.SchedulerResource prototype)

```
public static WorkloadsConfig.SchedulerResource.Builder newBuilder(WorkloadsConfig.SchedulerResource prototype)
```
...
```
public static WorkloadsConfig.SchedulerResource parseDelimitedFrom(InputStream input)
```
...
```
public static WorkloadsConfig.SchedulerResource parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static WorkloadsConfig.SchedulerResource parseFrom(byte[] data)
```
...
```
public static WorkloadsConfig.SchedulerResource parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static WorkloadsConfig.SchedulerResource parseFrom(ByteString data)
```
...
```
public static WorkloadsConfig.SchedulerResource parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static WorkloadsConfig.SchedulerResource parseFrom(CodedInputStream input)
```
...
```
public static WorkloadsConfig.SchedulerResource parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static WorkloadsConfig.SchedulerResource parseFrom(InputStream input)
```
...
```
public static WorkloadsConfig.SchedulerResource parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static WorkloadsConfig.SchedulerResource parseFrom(ByteBuffer data)
```
...
```
public static WorkloadsConfig.SchedulerResource parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<WorkloadsConfig.SchedulerResource> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[SchedulerResource](/java/docs/reference/google-cloud-orchestration-airflow/1.32.0/com.google.cloud.orchestration.airflow.service.v1beta1.WorkloadsConfig.SchedulerResource)>`
...
```
public Parser<WorkloadsConfig.SchedulerResource> getParserForType()
```
...
```
public WorkloadsConfig.SchedulerResource.Builder newBuilderForType()
```
...
```
protected WorkloadsConfig.SchedulerResource.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public WorkloadsConfig.SchedulerResource.Builder toBuilder()
```
