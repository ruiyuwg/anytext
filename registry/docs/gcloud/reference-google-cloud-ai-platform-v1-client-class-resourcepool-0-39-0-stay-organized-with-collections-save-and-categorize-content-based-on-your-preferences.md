...
# Google Cloud Ai Platform V1 Client - Class ResourcePool (0.39.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[Google\Cloud\AIPlatform\V1\MachineSpec](/php/docs/reference/cloud-ai-platform/0.39.0/V1.MachineSpec)`  
...
`[Google\Cloud\AIPlatform\V1\DiskSpec](/php/docs/reference/cloud-ai-platform/0.39.0/V1.DiskSpec)`  
...
`[Google\Cloud\AIPlatform\V1\ResourcePool\AutoscalingSpec](/php/docs/reference/cloud-ai-platform/0.39.0/V1.ResourcePool.AutoscalingSpec)`  
...
`[Google\Cloud\AIPlatform\V1\MachineSpec](/php/docs/reference/cloud-ai-platform/0.39.0/V1.MachineSpec)|null`
...
`[Google\Cloud\AIPlatform\V1\DiskSpec](/php/docs/reference/cloud-ai-platform/0.39.0/V1.DiskSpec)|null`
...
`[Google\Cloud\AIPlatform\V1\ResourcePool\AutoscalingSpec](/php/docs/reference/cloud-ai-platform/0.39.0/V1.ResourcePool.AutoscalingSpec)|null`
