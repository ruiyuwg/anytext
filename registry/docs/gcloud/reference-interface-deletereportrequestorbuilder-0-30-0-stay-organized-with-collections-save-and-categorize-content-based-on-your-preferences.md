...
# Interface DeleteReportRequestOrBuilder (0.30.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface DeleteReportRequestOrBuilder extends MessageOrBuilder
```
