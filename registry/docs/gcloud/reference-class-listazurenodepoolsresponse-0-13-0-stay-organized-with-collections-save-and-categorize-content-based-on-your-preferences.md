...
# Class ListAzureNodePoolsResponse (0.13.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListAzureNodePoolsResponse

## Implements

[ListAzureNodePoolsResponseOrBuilder](/java/docs/reference/google-cloud-gke-multi-cloud/0.13.0/com.google.cloud.gkemulticloud.v1.ListAzureNodePoolsResponseOrBuilder)
...
### AZURE\_NODE\_POOLS\_FIELD\_NUMBER

```
public static final int AZURE_NODE_POOLS_FIELD_NUMBER
```
...
`[ListAzureNodePoolsResponse](/java/docs/reference/google-cloud-gke-multi-cloud/0.13.0/com.google.cloud.gkemulticloud.v1.ListAzureNodePoolsResponse)`
...
```
public static ListAzureNodePoolsResponse.Builder newBuilder()
```
...
`[ListAzureNodePoolsResponse.Builder](/java/docs/reference/google-cloud-gke-multi-cloud/0.13.0/com.google.cloud.gkemulticloud.v1.ListAzureNodePoolsResponse.Builder)`

### newBuilder(ListAzureNodePoolsResponse prototype)

```
public static ListAzureNodePoolsResponse.Builder newBuilder(ListAzureNodePoolsResponse prototype)
```
...
```
public static ListAzureNodePoolsResponse parseDelimitedFrom(InputStream input)
```
...
```
public static ListAzureNodePoolsResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListAzureNodePoolsResponse parseFrom(byte[] data)
```
...
```
public static ListAzureNodePoolsResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListAzureNodePoolsResponse parseFrom(ByteString data)
```
...
```
public static ListAzureNodePoolsResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListAzureNodePoolsResponse parseFrom(CodedInputStream input)
```
...
```
public static ListAzureNodePoolsResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListAzureNodePoolsResponse parseFrom(InputStream input)
```
...
```
public static ListAzureNodePoolsResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListAzureNodePoolsResponse parseFrom(ByteBuffer data)
```
...
```
public static ListAzureNodePoolsResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListAzureNodePoolsResponse](/java/docs/reference/google-cloud-gke-multi-cloud/0.13.0/com.google.cloud.gkemulticloud.v1.ListAzureNodePoolsResponse)>`
...
```
public AzureNodePool getAzureNodePools(int index)
```
...
`[AzureNodePool](/java/docs/reference/google-cloud-gke-multi-cloud/0.13.0/com.google.cloud.gkemulticloud.v1.AzureNodePool)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[AzureNodePool](/java/docs/reference/google-cloud-gke-multi-cloud/0.13.0/com.google.cloud.gkemulticloud.v1.AzureNodePool)>`

### getAzureNodePoolsOrBuilder(int index)

```
public AzureNodePoolOrBuilder getAzureNodePoolsOrBuilder(int index)
```
...
`[AzureNodePoolOrBuilder](/java/docs/reference/google-cloud-gke-multi-cloud/0.13.0/com.google.cloud.gkemulticloud.v1.AzureNodePoolOrBuilder)`
...
```
public ListAzureNodePoolsResponse getDefaultInstanceForType()
```
...
```
public ListAzureNodePoolsResponse.Builder newBuilderForType()
```
...
```
protected ListAzureNodePoolsResponse.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ListAzureNodePoolsResponse.Builder toBuilder()
```
