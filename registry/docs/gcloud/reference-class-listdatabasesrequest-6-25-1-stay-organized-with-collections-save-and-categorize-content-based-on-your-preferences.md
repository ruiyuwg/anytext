...
# Class ListDatabasesRequest (6.25.1) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListDatabasesRequest extends GeneratedMessageV3 implements ListDatabasesRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListDatabasesRequest

## Implements

[ListDatabasesRequestOrBuilder](/java/docs/reference/google-cloud-spanner/6.25.1/com.google.spanner.admin.database.v1.ListDatabasesRequestOrBuilder)
...
`[ListDatabasesRequest](/java/docs/reference/google-cloud-spanner/6.25.1/com.google.spanner.admin.database.v1.ListDatabasesRequest)`
...
```
public static ListDatabasesRequest.Builder newBuilder()
```
...
`[ListDatabasesRequest.Builder](/java/docs/reference/google-cloud-spanner/6.25.1/com.google.spanner.admin.database.v1.ListDatabasesRequest.Builder)`

### newBuilder(ListDatabasesRequest prototype)

```
public static ListDatabasesRequest.Builder newBuilder(ListDatabasesRequest prototype)
```
...
```
public static ListDatabasesRequest parseDelimitedFrom(InputStream input)
```
...
```
public static ListDatabasesRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListDatabasesRequest parseFrom(byte[] data)
```
...
```
public static ListDatabasesRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListDatabasesRequest parseFrom(ByteString data)
```
...
```
public static ListDatabasesRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListDatabasesRequest parseFrom(CodedInputStream input)
```
...
```
public static ListDatabasesRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListDatabasesRequest parseFrom(InputStream input)
```
...
```
public static ListDatabasesRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListDatabasesRequest parseFrom(ByteBuffer data)
```
...
```
public static ListDatabasesRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListDatabasesRequest](/java/docs/reference/google-cloud-spanner/6.25.1/com.google.spanner.admin.database.v1.ListDatabasesRequest)>`
...
If non-empty, `page_token` should contain a next\_page\_token from a previous ListDatabasesResponse.
...
```
public ListDatabasesRequest.Builder newBuilderForType()
```
...
```
protected ListDatabasesRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
