...
# Class FraudPreventionAssessment (3.31.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> FraudPreventionAssessment

## Implements

[FraudPreventionAssessmentOrBuilder](/java/docs/reference/google-cloud-recaptchaenterprise/3.31.0/com.google.recaptchaenterprise.v1.FraudPreventionAssessmentOrBuilder)
...
### BEHAVIORAL\_TRUST\_VERDICT\_FIELD\_NUMBER
...
### CARD\_TESTING\_VERDICT\_FIELD\_NUMBER
...
### STOLEN\_INSTRUMENT\_VERDICT\_FIELD\_NUMBER
...
### TRANSACTION\_RISK\_FIELD\_NUMBER
...
`[FraudPreventionAssessment](/java/docs/reference/google-cloud-recaptchaenterprise/3.31.0/com.google.recaptchaenterprise.v1.FraudPreventionAssessment)`
...
`[FraudPreventionAssessment.Builder](/java/docs/reference/google-cloud-recaptchaenterprise/3.31.0/com.google.recaptchaenterprise.v1.FraudPreventionAssessment.Builder)`
...
```
public static FraudPreventionAssessment parseDelimitedFrom(InputStream input)
```
...
```
public static FraudPreventionAssessment parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static FraudPreventionAssessment parseFrom(byte[] data)
```
...
```
public static FraudPreventionAssessment parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static FraudPreventionAssessment parseFrom(ByteString data)
```
...
```
public static FraudPreventionAssessment parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static FraudPreventionAssessment parseFrom(CodedInputStream input)
```
...
```
public static FraudPreventionAssessment parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static FraudPreventionAssessment parseFrom(InputStream input)
```
...
```
public static FraudPreventionAssessment parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static FraudPreventionAssessment parseFrom(ByteBuffer data)
```
...
```
public static FraudPreventionAssessment parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[FraudPreventionAssessment](/java/docs/reference/google-cloud-recaptchaenterprise/3.31.0/com.google.recaptchaenterprise.v1.FraudPreventionAssessment)>`
...
`[FraudPreventionAssessment.BehavioralTrustVerdict](/java/docs/reference/google-cloud-recaptchaenterprise/3.31.0/com.google.recaptchaenterprise.v1.FraudPreventionAssessment.BehavioralTrustVerdict)`
...
`[FraudPreventionAssessment.BehavioralTrustVerdictOrBuilder](/java/docs/reference/google-cloud-recaptchaenterprise/3.31.0/com.google.recaptchaenterprise.v1.FraudPreventionAssessment.BehavioralTrustVerdictOrBuilder)`
...
`[FraudPreventionAssessment.CardTestingVerdict](/java/docs/reference/google-cloud-recaptchaenterprise/3.31.0/com.google.recaptchaenterprise.v1.FraudPreventionAssessment.CardTestingVerdict)`
...
`[FraudPreventionAssessment.CardTestingVerdictOrBuilder](/java/docs/reference/google-cloud-recaptchaenterprise/3.31.0/com.google.recaptchaenterprise.v1.FraudPreventionAssessment.CardTestingVerdictOrBuilder)`
...
`[FraudPreventionAssessment.StolenInstrumentVerdict](/java/docs/reference/google-cloud-recaptchaenterprise/3.31.0/com.google.recaptchaenterprise.v1.FraudPreventionAssessment.StolenInstrumentVerdict)`
...
`[FraudPreventionAssessment.StolenInstrumentVerdictOrBuilder](/java/docs/reference/google-cloud-recaptchaenterprise/3.31.0/com.google.recaptchaenterprise.v1.FraudPreventionAssessment.StolenInstrumentVerdictOrBuilder)`
...
```
protected FraudPreventionAssessment.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
