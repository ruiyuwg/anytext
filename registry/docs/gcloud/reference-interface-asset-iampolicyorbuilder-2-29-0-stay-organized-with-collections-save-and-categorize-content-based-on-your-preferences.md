...
# Interface Asset.IamPolicyOrBuilder (2.29.0) Stay organized with collections Save and categorize content based on your preferences.
...
The JSON representation of the Policy associated with the asset. See [https://cloud.google.com/iam/docs/reference/rest/v1/Policy](https://cloud.google.com/iam/docs/reference/rest/v1/Policy) for format details.
