...
# Interface ComponentSettings.DetectorSettingsOrBuilder (0.45.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[ComponentEnablementState](/java/docs/reference/google-cloud-securitycenter-settings/0.45.0/com.google.cloud.securitycenter.settings.v1beta1.ComponentEnablementState)`
