...
# Enum GlossaryEntry.DataCase (2.56.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum GlossaryEntry.DataCase extends Enum<GlossaryEntry.DataCase> implements Internal.EnumLite, AbstractMessageLite.InternalOneOfEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-translate/2.56.0/com.google.cloud.translate.v3.GlossaryEntry.DataCase#com_google_cloud_translate_v3_GlossaryEntry_DataCase_forNumber_int_) instead._
