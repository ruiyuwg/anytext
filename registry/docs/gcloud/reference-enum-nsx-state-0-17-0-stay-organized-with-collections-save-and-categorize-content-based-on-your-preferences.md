...
# Enum Nsx.State (0.17.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-vmwareengine/0.17.0/com.google.cloud.vmwareengine.v1.Nsx.State#com_google_cloud_vmwareengine_v1_Nsx_State_forNumber_int_) instead._
