...
# Interface GetAuthorizationRequestOrBuilder (2.31.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface GetAuthorizationRequestOrBuilder extends MessageOrBuilder
```
