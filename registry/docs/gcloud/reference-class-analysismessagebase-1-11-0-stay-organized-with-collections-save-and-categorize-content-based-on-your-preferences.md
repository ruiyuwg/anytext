...
# Class AnalysisMessageBase (1.11.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> AnalysisMessageBase

## Implements

[AnalysisMessageBaseOrBuilder](/java/docs/reference/google-cloud-gkehub/1.11.0/com.google.cloud.gkehub.servicemesh.v1alpha.AnalysisMessageBaseOrBuilder)
...
### DOCUMENTATION\_URL\_FIELD\_NUMBER
...
`[AnalysisMessageBase](/java/docs/reference/google-cloud-gkehub/1.11.0/com.google.cloud.gkehub.servicemesh.v1alpha.AnalysisMessageBase)`
...
```
public static AnalysisMessageBase.Builder newBuilder()
```
...
`[AnalysisMessageBase.Builder](/java/docs/reference/google-cloud-gkehub/1.11.0/com.google.cloud.gkehub.servicemesh.v1alpha.AnalysisMessageBase.Builder)`

### newBuilder(AnalysisMessageBase prototype)

```
public static AnalysisMessageBase.Builder newBuilder(AnalysisMessageBase prototype)
```
...
```
public static AnalysisMessageBase parseDelimitedFrom(InputStream input)
```
...
```
public static AnalysisMessageBase parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AnalysisMessageBase parseFrom(byte[] data)
```
...
```
public static AnalysisMessageBase parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AnalysisMessageBase parseFrom(ByteString data)
```
...
```
public static AnalysisMessageBase parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AnalysisMessageBase parseFrom(CodedInputStream input)
```
...
```
public static AnalysisMessageBase parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AnalysisMessageBase parseFrom(InputStream input)
```
...
```
public static AnalysisMessageBase parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AnalysisMessageBase parseFrom(ByteBuffer data)
```
...
```
public static AnalysisMessageBase parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[AnalysisMessageBase](/java/docs/reference/google-cloud-gkehub/1.11.0/com.google.cloud.gkehub.servicemesh.v1alpha.AnalysisMessageBase)>`
...
`[AnalysisMessageBase.Level](/java/docs/reference/google-cloud-gkehub/1.11.0/com.google.cloud.gkehub.servicemesh.v1alpha.AnalysisMessageBase.Level)`
...
`[AnalysisMessageBase.Type](/java/docs/reference/google-cloud-gkehub/1.11.0/com.google.cloud.gkehub.servicemesh.v1alpha.AnalysisMessageBase.Type)`
...
`[AnalysisMessageBase.TypeOrBuilder](/java/docs/reference/google-cloud-gkehub/1.11.0/com.google.cloud.gkehub.servicemesh.v1alpha.AnalysisMessageBase.TypeOrBuilder)`
...
```
public AnalysisMessageBase.Builder newBuilderForType()
```
...
```
protected AnalysisMessageBase.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public AnalysisMessageBase.Builder toBuilder()
```
