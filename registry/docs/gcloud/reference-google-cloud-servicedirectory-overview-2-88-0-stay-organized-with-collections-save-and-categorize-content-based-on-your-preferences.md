...
# google-cloud-servicedirectory overview (2.88.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Service Directory Description:** Allows the registration and lookup of service endpoints.

[Service Directory Product Reference](https://cloud.google.com/service-directory/)

[GitHub Repository](https://github.com/googleapis/google-cloud-java/tree/main/java-servicedirectory)

[Maven artifact](https://central.sonatype.com/artifact/com.google.cloud/google-cloud-servicedirectory)
...
-   [Enable the API](https://console.cloud.google.com/apis/library/servicedirectory.googleapis.com)
-   [Set up authentication](https://cloud.google.com/docs/authentication/client-libraries)

## Use the Service Directory for Java
...
The example below demonstrates how you would import the BOM and include the `google-cloud-servicedirectory` artifact.
...
libraryDependencies += "com.google.cloud" % "google-cloud-servicedirectory" % "2.88.0"

## Which version ID should I get started with?

For this library, we recommend using [com.google.cloud.servicedirectory.v1](https://cloud.google.com/java/docs/reference/google-cloud-servicedirectory/2.88.0/com.google.cloud.servicedirectory.v1) for new applications.
