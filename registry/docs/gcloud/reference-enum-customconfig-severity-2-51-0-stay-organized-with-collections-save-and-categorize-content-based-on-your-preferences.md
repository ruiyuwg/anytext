...
# Enum CustomConfig.Severity (2.51.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-securitycenter/2.51.0/com.google.cloud.securitycenter.v1.CustomConfig.Severity#com_google_cloud_securitycenter_v1_CustomConfig_Severity_forNumber_int_) instead._
