...
# Class CreateOSPolicyAssignmentRequest (2.36.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class CreateOSPolicyAssignmentRequest extends GeneratedMessageV3 implements CreateOSPolicyAssignmentRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> CreateOSPolicyAssignmentRequest

## Implements

[CreateOSPolicyAssignmentRequestOrBuilder](/java/docs/reference/google-cloud-os-config/2.36.0/com.google.cloud.osconfig.v1alpha.CreateOSPolicyAssignmentRequestOrBuilder)
...
### OS\_POLICY\_ASSIGNMENT\_FIELD\_NUMBER
...
### OS\_POLICY\_ASSIGNMENT\_ID\_FIELD\_NUMBER

```
public static final int OS_POLICY_ASSIGNMENT_ID_FIELD_NUMBER
```
...
```
public static CreateOSPolicyAssignmentRequest getDefaultInstance()
```
...
`[CreateOSPolicyAssignmentRequest](/java/docs/reference/google-cloud-os-config/2.36.0/com.google.cloud.osconfig.v1alpha.CreateOSPolicyAssignmentRequest)`
...
```
public static CreateOSPolicyAssignmentRequest.Builder newBuilder()
```
...
`[CreateOSPolicyAssignmentRequest.Builder](/java/docs/reference/google-cloud-os-config/2.36.0/com.google.cloud.osconfig.v1alpha.CreateOSPolicyAssignmentRequest.Builder)`

### newBuilder(CreateOSPolicyAssignmentRequest prototype)

```
public static CreateOSPolicyAssignmentRequest.Builder newBuilder(CreateOSPolicyAssignmentRequest prototype)
```
...
```
public static CreateOSPolicyAssignmentRequest parseDelimitedFrom(InputStream input)
```
...
```
public static CreateOSPolicyAssignmentRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateOSPolicyAssignmentRequest parseFrom(byte[] data)
```
...
```
public static CreateOSPolicyAssignmentRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateOSPolicyAssignmentRequest parseFrom(ByteString data)
```
...
```
public static CreateOSPolicyAssignmentRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateOSPolicyAssignmentRequest parseFrom(CodedInputStream input)
```
...
```
public static CreateOSPolicyAssignmentRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateOSPolicyAssignmentRequest parseFrom(InputStream input)
```
...
```
public static CreateOSPolicyAssignmentRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateOSPolicyAssignmentRequest parseFrom(ByteBuffer data)
```
...
```
public static CreateOSPolicyAssignmentRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<CreateOSPolicyAssignmentRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[CreateOSPolicyAssignmentRequest](/java/docs/reference/google-cloud-os-config/2.36.0/com.google.cloud.osconfig.v1alpha.CreateOSPolicyAssignmentRequest)>`
...
`[OSPolicyAssignment](/java/docs/reference/google-cloud-os-config/2.36.0/com.google.cloud.osconfig.v1alpha.OSPolicyAssignment)`
...
```
public ByteString getOsPolicyAssignmentIdBytes()
```
...
`[OSPolicyAssignmentOrBuilder](/java/docs/reference/google-cloud-os-config/2.36.0/com.google.cloud.osconfig.v1alpha.OSPolicyAssignmentOrBuilder)`
...
```
public Parser<CreateOSPolicyAssignmentRequest> getParserForType()
```
...
```
public CreateOSPolicyAssignmentRequest.Builder newBuilderForType()
```
...
```
protected CreateOSPolicyAssignmentRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public CreateOSPolicyAssignmentRequest.Builder toBuilder()
```
