...
# Class DeleteHttpRouteRequest (0.13.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class DeleteHttpRouteRequest extends GeneratedMessageV3 implements DeleteHttpRouteRequestOrBuilder
```

Request used by the DeleteHttpRoute method.

Protobuf type `google.cloud.networkservices.v1.DeleteHttpRouteRequest`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> DeleteHttpRouteRequest

## Implements

[DeleteHttpRouteRequestOrBuilder](/java/docs/reference/google-cloud-networkservices/0.13.0/com.google.cloud.networkservices.v1.DeleteHttpRouteRequestOrBuilder)
...
```
public static DeleteHttpRouteRequest getDefaultInstance()
```
...
`[DeleteHttpRouteRequest](/java/docs/reference/google-cloud-networkservices/0.13.0/com.google.cloud.networkservices.v1.DeleteHttpRouteRequest)`
...
```
public static DeleteHttpRouteRequest.Builder newBuilder()
```
...
`[DeleteHttpRouteRequest.Builder](/java/docs/reference/google-cloud-networkservices/0.13.0/com.google.cloud.networkservices.v1.DeleteHttpRouteRequest.Builder)`

### newBuilder(DeleteHttpRouteRequest prototype)

```
public static DeleteHttpRouteRequest.Builder newBuilder(DeleteHttpRouteRequest prototype)
```
...
```
public static DeleteHttpRouteRequest parseDelimitedFrom(InputStream input)
```
...
```
public static DeleteHttpRouteRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteHttpRouteRequest parseFrom(byte[] data)
```
...
```
public static DeleteHttpRouteRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteHttpRouteRequest parseFrom(ByteString data)
```
...
```
public static DeleteHttpRouteRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteHttpRouteRequest parseFrom(CodedInputStream input)
```
...
```
public static DeleteHttpRouteRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteHttpRouteRequest parseFrom(InputStream input)
```
...
```
public static DeleteHttpRouteRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteHttpRouteRequest parseFrom(ByteBuffer data)
```
...
```
public static DeleteHttpRouteRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<DeleteHttpRouteRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[DeleteHttpRouteRequest](/java/docs/reference/google-cloud-networkservices/0.13.0/com.google.cloud.networkservices.v1.DeleteHttpRouteRequest)>`
...
```
public DeleteHttpRouteRequest getDefaultInstanceForType()
```
...
```
public Parser<DeleteHttpRouteRequest> getParserForType()
```
...
```
public DeleteHttpRouteRequest.Builder newBuilderForType()
```
...
```
protected DeleteHttpRouteRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public DeleteHttpRouteRequest.Builder toBuilder()
```
