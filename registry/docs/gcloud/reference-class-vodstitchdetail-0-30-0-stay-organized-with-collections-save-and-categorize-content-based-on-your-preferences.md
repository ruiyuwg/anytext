...
# Class VodStitchDetail (0.30.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> VodStitchDetail

## Implements

[VodStitchDetailOrBuilder](/java/docs/reference/google-cloud-video-stitcher/0.30.0/com.google.cloud.video.stitcher.v1.VodStitchDetailOrBuilder)
...
### AD\_STITCH\_DETAILS\_FIELD\_NUMBER
...
`[VodStitchDetail](/java/docs/reference/google-cloud-video-stitcher/0.30.0/com.google.cloud.video.stitcher.v1.VodStitchDetail)`
...
`[VodStitchDetail.Builder](/java/docs/reference/google-cloud-video-stitcher/0.30.0/com.google.cloud.video.stitcher.v1.VodStitchDetail.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[VodStitchDetail](/java/docs/reference/google-cloud-video-stitcher/0.30.0/com.google.cloud.video.stitcher.v1.VodStitchDetail)>`
...
`[AdStitchDetail](/java/docs/reference/google-cloud-video-stitcher/0.30.0/com.google.cloud.video.stitcher.v1.AdStitchDetail)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[AdStitchDetail](/java/docs/reference/google-cloud-video-stitcher/0.30.0/com.google.cloud.video.stitcher.v1.AdStitchDetail)>`
...
`[AdStitchDetailOrBuilder](/java/docs/reference/google-cloud-video-stitcher/0.30.0/com.google.cloud.video.stitcher.v1.AdStitchDetailOrBuilder)`
