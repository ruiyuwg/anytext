...
# Class LoggingConfig (2.48.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> LoggingConfig

## Implements

[LoggingConfigOrBuilder](/java/docs/reference/google-cloud-retail/2.48.0/com.google.cloud.retail.v2alpha.LoggingConfigOrBuilder)
...
### DEFAULT\_LOG\_GENERATION\_RULE\_FIELD\_NUMBER

```
public static final int DEFAULT_LOG_GENERATION_RULE_FIELD_NUMBER
```
...
### SERVICE\_LOG\_GENERATION\_RULES\_FIELD\_NUMBER

```
public static final int SERVICE_LOG_GENERATION_RULES_FIELD_NUMBER
```
...
`[LoggingConfig](/java/docs/reference/google-cloud-retail/2.48.0/com.google.cloud.retail.v2alpha.LoggingConfig)`
...
`[LoggingConfig.Builder](/java/docs/reference/google-cloud-retail/2.48.0/com.google.cloud.retail.v2alpha.LoggingConfig.Builder)`
...
```
public static LoggingConfig parseDelimitedFrom(InputStream input)
```
...
```
public static LoggingConfig parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static LoggingConfig parseFrom(byte[] data)
```
...
```
public static LoggingConfig parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static LoggingConfig parseFrom(ByteString data)
```
...
```
public static LoggingConfig parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static LoggingConfig parseFrom(CodedInputStream input)
```
...
```
public static LoggingConfig parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static LoggingConfig parseFrom(InputStream input)
```
...
```
public static LoggingConfig parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static LoggingConfig parseFrom(ByteBuffer data)
```
...
```
public static LoggingConfig parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[LoggingConfig](/java/docs/reference/google-cloud-retail/2.48.0/com.google.cloud.retail.v2alpha.LoggingConfig)>`
...
`[LoggingConfig.LogGenerationRule](/java/docs/reference/google-cloud-retail/2.48.0/com.google.cloud.retail.v2alpha.LoggingConfig.LogGenerationRule)`
...
`[LoggingConfig.LogGenerationRuleOrBuilder](/java/docs/reference/google-cloud-retail/2.48.0/com.google.cloud.retail.v2alpha.LoggingConfig.LogGenerationRuleOrBuilder)`
...
This overrides the default\_log\_generation\_rule for the services specified. For those not mentioned, they will fallback to the default log generation rule.
...
`[LoggingConfig.ServiceLogGenerationRule](/java/docs/reference/google-cloud-retail/2.48.0/com.google.cloud.retail.v2alpha.LoggingConfig.ServiceLogGenerationRule)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ServiceLogGenerationRule](/java/docs/reference/google-cloud-retail/2.48.0/com.google.cloud.retail.v2alpha.LoggingConfig.ServiceLogGenerationRule)>`
...
`[LoggingConfig.ServiceLogGenerationRuleOrBuilder](/java/docs/reference/google-cloud-retail/2.48.0/com.google.cloud.retail.v2alpha.LoggingConfig.ServiceLogGenerationRuleOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.retail.v2alpha.LoggingConfig.ServiceLogGenerationRuleOrBuilder>`
