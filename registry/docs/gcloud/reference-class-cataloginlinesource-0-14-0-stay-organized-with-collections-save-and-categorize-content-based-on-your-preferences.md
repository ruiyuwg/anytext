...
# Class CatalogInlineSource (0.14.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class CatalogInlineSource extends GeneratedMessageV3 implements CatalogInlineSourceOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> CatalogInlineSource

## Implements

[CatalogInlineSourceOrBuilder](/java/docs/reference/google-cloud-recommendations-ai/0.14.0/com.google.cloud.recommendationengine.v1beta1.CatalogInlineSourceOrBuilder)
...
### CATALOG\_ITEMS\_FIELD\_NUMBER

```
public static final int CATALOG_ITEMS_FIELD_NUMBER
```
...
```
public static CatalogInlineSource getDefaultInstance()
```
...
[CatalogInlineSource](/java/docs/reference/google-cloud-recommendations-ai/0.14.0/com.google.cloud.recommendationengine.v1beta1.CatalogInlineSource)
...
```
public static CatalogInlineSource.Builder newBuilder()
```
...
[CatalogInlineSource.Builder](/java/docs/reference/google-cloud-recommendations-ai/0.14.0/com.google.cloud.recommendationengine.v1beta1.CatalogInlineSource.Builder)

### newBuilder(CatalogInlineSource prototype)

```
public static CatalogInlineSource.Builder newBuilder(CatalogInlineSource prototype)
```
...
```
public static CatalogInlineSource parseDelimitedFrom(InputStream input)
```
...
```
public static CatalogInlineSource parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CatalogInlineSource parseFrom(byte[] data)
```
...
```
public static CatalogInlineSource parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CatalogInlineSource parseFrom(ByteString data)
```
...
```
public static CatalogInlineSource parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CatalogInlineSource parseFrom(CodedInputStream input)
```
...
```
public static CatalogInlineSource parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CatalogInlineSource parseFrom(InputStream input)
```
...
```
public static CatalogInlineSource parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CatalogInlineSource parseFrom(ByteBuffer data)
```
...
```
public static CatalogInlineSource parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<CatalogInlineSource> parser()
```
...
[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[CatalogInlineSource](/java/docs/reference/google-cloud-recommendations-ai/0.14.0/com.google.cloud.recommendationengine.v1beta1.CatalogInlineSource)\>
...
[CatalogItem](/java/docs/reference/google-cloud-recommendations-ai/0.14.0/com.google.cloud.recommendationengine.v1beta1.CatalogItem)
...
[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[CatalogItem](/java/docs/reference/google-cloud-recommendations-ai/0.14.0/com.google.cloud.recommendationengine.v1beta1.CatalogItem)\>
...
[CatalogItemOrBuilder](/java/docs/reference/google-cloud-recommendations-ai/0.14.0/com.google.cloud.recommendationengine.v1beta1.CatalogItemOrBuilder)
...
```
public Parser<CatalogInlineSource> getParserForType()
```
...
```
public CatalogInlineSource.Builder newBuilderForType()
```
...
```
protected CatalogInlineSource.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public CatalogInlineSource.Builder toBuilder()
```
