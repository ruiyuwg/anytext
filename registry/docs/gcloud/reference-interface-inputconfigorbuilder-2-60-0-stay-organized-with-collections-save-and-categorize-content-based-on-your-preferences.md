...
# Interface InputConfigOrBuilder (2.60.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[GcsSource](/java/docs/reference/google-cloud-redis/2.60.0/com.google.cloud.redis.v1.GcsSource)`
...
`[GcsSourceOrBuilder](/java/docs/reference/google-cloud-redis/2.60.0/com.google.cloud.redis.v1.GcsSourceOrBuilder)`
...
`[InputConfig.SourceCase](/java/docs/reference/google-cloud-redis/2.60.0/com.google.cloud.redis.v1.InputConfig.SourceCase)`
