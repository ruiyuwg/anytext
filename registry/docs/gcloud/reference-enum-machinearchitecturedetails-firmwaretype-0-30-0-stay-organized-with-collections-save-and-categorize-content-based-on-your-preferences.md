...
# Enum MachineArchitectureDetails.FirmwareType (0.30.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum MachineArchitectureDetails.FirmwareType extends Enum<MachineArchitectureDetails.FirmwareType> implements ProtocolMessageEnum
```
...
`FIRMWARE_TYPE_UNSPECIFIED_VALUE`
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-migrationcenter/0.30.0/com.google.cloud.migrationcenter.v1.MachineArchitectureDetails.FirmwareType#com_google_cloud_migrationcenter_v1_MachineArchitectureDetails_FirmwareType_forNumber_int_) instead._
