...
# Class SetDefaultBranchRequest (2.49.0) Stay organized with collections Save and categorize content based on your preferences.
...
Request message to set a specified branch as new default\_branch.

Protobuf type `google.cloud.retail.v2.SetDefaultBranchRequest`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> SetDefaultBranchRequest

## Implements

[SetDefaultBranchRequestOrBuilder](/java/docs/reference/google-cloud-retail/2.49.0/com.google.cloud.retail.v2.SetDefaultBranchRequestOrBuilder)
...
`[SetDefaultBranchRequest](/java/docs/reference/google-cloud-retail/2.49.0/com.google.cloud.retail.v2.SetDefaultBranchRequest)`
...
`[SetDefaultBranchRequest.Builder](/java/docs/reference/google-cloud-retail/2.49.0/com.google.cloud.retail.v2.SetDefaultBranchRequest.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[SetDefaultBranchRequest](/java/docs/reference/google-cloud-retail/2.49.0/com.google.cloud.retail.v2.SetDefaultBranchRequest)>`
...
This field must be one of "0", "1" or "2". Otherwise, an INVALID\_ARGUMENT error is returned.

If there are no sufficient active products in the targeted branch and force is not set, a FAILED\_PRECONDITION error is returned.
...
If set to true, it permits switching to a branch with branch\_id even if it has no sufficient active products.
...
This field must be a UTF-8 encoded string with a length limit of 1,000 characters. Otherwise, an INVALID\_ARGUMENT error is returned.
