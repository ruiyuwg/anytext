...
# Enum CVSSv3.AttackVector (2.34.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum CVSSv3.AttackVector extends Enum<CVSSv3.AttackVector> implements ProtocolMessageEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-os-config/2.34.0/com.google.cloud.osconfig.v1.CVSSv3.AttackVector#com_google_cloud_osconfig_v1_CVSSv3_AttackVector_forNumber_int_) instead._
