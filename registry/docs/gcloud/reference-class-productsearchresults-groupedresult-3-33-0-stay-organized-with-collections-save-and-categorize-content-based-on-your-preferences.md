...
# Class ProductSearchResults.GroupedResult (3.33.0) Stay organized with collections Save and categorize content based on your preferences.
...
[ProductSearchResults.GroupedResultOrBuilder](/java/docs/reference/google-cloud-vision/3.33.0/com.google.cloud.vision.v1p4beta1.ProductSearchResults.GroupedResultOrBuilder)
...
`[ProductSearchResults.GroupedResult](/java/docs/reference/google-cloud-vision/3.33.0/com.google.cloud.vision.v1p4beta1.ProductSearchResults.GroupedResult)`
...
`[ProductSearchResults.GroupedResult.Builder](/java/docs/reference/google-cloud-vision/3.33.0/com.google.cloud.vision.v1p4beta1.ProductSearchResults.GroupedResult.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[GroupedResult](/java/docs/reference/google-cloud-vision/3.33.0/com.google.cloud.vision.v1p4beta1.ProductSearchResults.GroupedResult)>`
...
`[BoundingPoly](/java/docs/reference/google-cloud-vision/3.33.0/com.google.cloud.vision.v1p4beta1.BoundingPoly)`
...
`[BoundingPolyOrBuilder](/java/docs/reference/google-cloud-vision/3.33.0/com.google.cloud.vision.v1p4beta1.BoundingPolyOrBuilder)`
...
`[ProductSearchResults.ObjectAnnotation](/java/docs/reference/google-cloud-vision/3.33.0/com.google.cloud.vision.v1p4beta1.ProductSearchResults.ObjectAnnotation)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ObjectAnnotation](/java/docs/reference/google-cloud-vision/3.33.0/com.google.cloud.vision.v1p4beta1.ProductSearchResults.ObjectAnnotation)>`
...
`[ProductSearchResults.ObjectAnnotationOrBuilder](/java/docs/reference/google-cloud-vision/3.33.0/com.google.cloud.vision.v1p4beta1.ProductSearchResults.ObjectAnnotationOrBuilder)`
...
`[ProductSearchResults.Result](/java/docs/reference/google-cloud-vision/3.33.0/com.google.cloud.vision.v1p4beta1.ProductSearchResults.Result)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Result](/java/docs/reference/google-cloud-vision/3.33.0/com.google.cloud.vision.v1p4beta1.ProductSearchResults.Result)>`
...
`[ProductSearchResults.ResultOrBuilder](/java/docs/reference/google-cloud-vision/3.33.0/com.google.cloud.vision.v1p4beta1.ProductSearchResults.ResultOrBuilder)`
