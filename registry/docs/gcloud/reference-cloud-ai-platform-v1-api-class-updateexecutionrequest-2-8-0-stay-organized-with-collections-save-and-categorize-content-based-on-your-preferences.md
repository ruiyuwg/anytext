...
# Cloud AI Platform v1 API - Class UpdateExecutionRequest (2.8.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://learn.microsoft.com/dotnet/api/system.object) \> UpdateExecutionRequest

## Implements

[IMessage](https://cloud.google.com/dotnet/docs/reference/Google.Protobuf/latest/Google.Protobuf.IMessage-1.html)<[UpdateExecutionRequest](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/2.8.0/Google.Cloud.AIPlatform.V1.UpdateExecutionRequest)\>, [IEquatable](https://learn.microsoft.com/dotnet/api/system.iequatable-1)<[UpdateExecutionRequest](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/2.8.0/Google.Cloud.AIPlatform.V1.UpdateExecutionRequest)\>, [IDeepCloneable](https://cloud.google.com/dotnet/docs/reference/Google.Protobuf/latest/Google.Protobuf.IDeepCloneable-1.html)<[UpdateExecutionRequest](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/2.8.0/Google.Cloud.AIPlatform.V1.UpdateExecutionRequest)\>, [IBufferMessage](https://cloud.google.com/dotnet/docs/reference/Google.Protobuf/latest/Google.Protobuf.IBufferMessage.html), [IMessage](https://cloud.google.com/dotnet/docs/reference/Google.Protobuf/latest/Google.Protobuf.IMessage.html)
...
`[UpdateExecutionRequest](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/2.8.0/Google.Cloud.AIPlatform.V1.UpdateExecutionRequest)`  
...
`[Execution](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/2.8.0/Google.Cloud.AIPlatform.V1.Execution)`
