...
# Class ImportProductSetsRequest (3.85.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ImportProductSetsRequest extends GeneratedMessage implements ImportProductSetsRequestOrBuilder
```

Request message for the `ImportProductSets` method.

Protobuf type `google.cloud.vision.v1p4beta1.ImportProductSetsRequest`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessage.html) \> ImportProductSetsRequest

## Implements

[ImportProductSetsRequestOrBuilder](/java/docs/reference/google-cloud-vision/latest/com.google.cloud.vision.v1p4beta1.ImportProductSetsRequestOrBuilder)
...
```
public static ImportProductSetsRequest getDefaultInstance()
```
...
`[ImportProductSetsRequest](/java/docs/reference/google-cloud-vision/latest/com.google.cloud.vision.v1p4beta1.ImportProductSetsRequest)`
...
```
public static ImportProductSetsRequest.Builder newBuilder()
```
...
`[ImportProductSetsRequest.Builder](/java/docs/reference/google-cloud-vision/latest/com.google.cloud.vision.v1p4beta1.ImportProductSetsRequest.Builder)`

### newBuilder(ImportProductSetsRequest prototype)

```
public static ImportProductSetsRequest.Builder newBuilder(ImportProductSetsRequest prototype)
```
...
```
public static ImportProductSetsRequest parseDelimitedFrom(InputStream input)
```
...
```
public static ImportProductSetsRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ImportProductSetsRequest parseFrom(byte[] data)
```
...
```
public static ImportProductSetsRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ImportProductSetsRequest parseFrom(ByteString data)
```
...
```
public static ImportProductSetsRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ImportProductSetsRequest parseFrom(CodedInputStream input)
```
...
```
public static ImportProductSetsRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ImportProductSetsRequest parseFrom(InputStream input)
```
...
```
public static ImportProductSetsRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ImportProductSetsRequest parseFrom(ByteBuffer data)
```
...
```
public static ImportProductSetsRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ImportProductSetsRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ImportProductSetsRequest](/java/docs/reference/google-cloud-vision/latest/com.google.cloud.vision.v1p4beta1.ImportProductSetsRequest)>`
...
`[ImportProductSetsInputConfig](/java/docs/reference/google-cloud-vision/latest/com.google.cloud.vision.v1p4beta1.ImportProductSetsInputConfig)`
...
`[ImportProductSetsInputConfigOrBuilder](/java/docs/reference/google-cloud-vision/latest/com.google.cloud.vision.v1p4beta1.ImportProductSetsInputConfigOrBuilder)`
...
```
public Parser<ImportProductSetsRequest> getParserForType()
```
...
```
public ImportProductSetsRequest.Builder newBuilderForType()
```
...
```
protected ImportProductSetsRequest.Builder newBuilderForType(AbstractMessage.BuilderParent parent)
```
...
```
public ImportProductSetsRequest.Builder toBuilder()
```
