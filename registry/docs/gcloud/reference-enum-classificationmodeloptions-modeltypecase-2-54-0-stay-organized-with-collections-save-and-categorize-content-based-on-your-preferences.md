...
# Enum ClassificationModelOptions.ModelTypeCase (2.54.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum ClassificationModelOptions.ModelTypeCase extends Enum<ClassificationModelOptions.ModelTypeCase> implements Internal.EnumLite, AbstractMessageLite.InternalOneOfEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-language/2.54.0/com.google.cloud.language.v1.ClassificationModelOptions.ModelTypeCase#com_google_cloud_language_v1_ClassificationModelOptions_ModelTypeCase_forNumber_int_) instead._
