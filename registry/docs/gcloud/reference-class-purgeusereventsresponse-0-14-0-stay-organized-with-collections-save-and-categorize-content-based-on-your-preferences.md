...
# Class PurgeUserEventsResponse (0.14.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class PurgeUserEventsResponse extends GeneratedMessageV3 implements PurgeUserEventsResponseOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> PurgeUserEventsResponse

## Implements

[PurgeUserEventsResponseOrBuilder](/java/docs/reference/google-cloud-recommendations-ai/0.14.0/com.google.cloud.recommendationengine.v1beta1.PurgeUserEventsResponseOrBuilder)
...
### PURGED\_EVENTS\_COUNT\_FIELD\_NUMBER

```
public static final int PURGED_EVENTS_COUNT_FIELD_NUMBER
```
...
### USER\_EVENTS\_SAMPLE\_FIELD\_NUMBER

```
public static final int USER_EVENTS_SAMPLE_FIELD_NUMBER
```
...
```
public static PurgeUserEventsResponse getDefaultInstance()
```
...
[PurgeUserEventsResponse](/java/docs/reference/google-cloud-recommendations-ai/0.14.0/com.google.cloud.recommendationengine.v1beta1.PurgeUserEventsResponse)
...
```
public static PurgeUserEventsResponse.Builder newBuilder()
```
...
[PurgeUserEventsResponse.Builder](/java/docs/reference/google-cloud-recommendations-ai/0.14.0/com.google.cloud.recommendationengine.v1beta1.PurgeUserEventsResponse.Builder)

### newBuilder(PurgeUserEventsResponse prototype)

```
public static PurgeUserEventsResponse.Builder newBuilder(PurgeUserEventsResponse prototype)
```
...
```
public static PurgeUserEventsResponse parseDelimitedFrom(InputStream input)
```
...
```
public static PurgeUserEventsResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PurgeUserEventsResponse parseFrom(byte[] data)
```
...
```
public static PurgeUserEventsResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PurgeUserEventsResponse parseFrom(ByteString data)
```
...
```
public static PurgeUserEventsResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PurgeUserEventsResponse parseFrom(CodedInputStream input)
```
...
```
public static PurgeUserEventsResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PurgeUserEventsResponse parseFrom(InputStream input)
```
...
```
public static PurgeUserEventsResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PurgeUserEventsResponse parseFrom(ByteBuffer data)
```
...
```
public static PurgeUserEventsResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<PurgeUserEventsResponse> parser()
```
...
[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[PurgeUserEventsResponse](/java/docs/reference/google-cloud-recommendations-ai/0.14.0/com.google.cloud.recommendationengine.v1beta1.PurgeUserEventsResponse)\>
...
```
public PurgeUserEventsResponse getDefaultInstanceForType()
```
...
```
public Parser<PurgeUserEventsResponse> getParserForType()
```
...
### getUserEventsSample(int index)

```
public UserEvent getUserEventsSample(int index)
```
...
[UserEvent](/java/docs/reference/google-cloud-recommendations-ai/0.14.0/com.google.cloud.recommendationengine.v1beta1.UserEvent)

### getUserEventsSampleCount()
...
```
public List<UserEvent> getUserEventsSampleList()
```
...
[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[UserEvent](/java/docs/reference/google-cloud-recommendations-ai/0.14.0/com.google.cloud.recommendationengine.v1beta1.UserEvent)\>

### getUserEventsSampleOrBuilder(int index)

```
public UserEventOrBuilder getUserEventsSampleOrBuilder(int index)
```
...
[UserEventOrBuilder](/java/docs/reference/google-cloud-recommendations-ai/0.14.0/com.google.cloud.recommendationengine.v1beta1.UserEventOrBuilder)

### getUserEventsSampleOrBuilderList()

```
public List<? extends UserEventOrBuilder> getUserEventsSampleOrBuilderList()
```
...
[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.recommendationengine.v1beta1.UserEventOrBuilder\>
...
```
public PurgeUserEventsResponse.Builder newBuilderForType()
```
...
```
protected PurgeUserEventsResponse.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public PurgeUserEventsResponse.Builder toBuilder()
```
