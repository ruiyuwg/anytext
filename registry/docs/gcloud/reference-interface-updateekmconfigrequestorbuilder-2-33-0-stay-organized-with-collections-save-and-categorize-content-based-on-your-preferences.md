...
# Interface UpdateEkmConfigRequestOrBuilder (2.33.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface UpdateEkmConfigRequestOrBuilder extends MessageOrBuilder
```
...
```
public abstract EkmConfig getEkmConfig()
```
...
`[EkmConfig](/java/docs/reference/google-cloud-kms/2.33.0/com.google.cloud.kms.v1.EkmConfig)`

The ekmConfig.

### getEkmConfigOrBuilder()

```
public abstract EkmConfigOrBuilder getEkmConfigOrBuilder()
```
...
`[EkmConfigOrBuilder](/java/docs/reference/google-cloud-kms/2.33.0/com.google.cloud.kms.v1.EkmConfigOrBuilder)`
...
```
public abstract boolean hasEkmConfig()
```
...
Whether the ekmConfig field is set.
