...
# Class Paragraph (3.47.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class Paragraph extends GeneratedMessageV3 implements ParagraphOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> Paragraph

## Implements

[ParagraphOrBuilder](/java/docs/reference/google-cloud-vision/3.47.0/com.google.cloud.vision.v1p4beta1.ParagraphOrBuilder)
...
`[Paragraph](/java/docs/reference/google-cloud-vision/3.47.0/com.google.cloud.vision.v1p4beta1.Paragraph)`
...
```
public static Paragraph.Builder newBuilder()
```
...
`[Paragraph.Builder](/java/docs/reference/google-cloud-vision/3.47.0/com.google.cloud.vision.v1p4beta1.Paragraph.Builder)`

### newBuilder(Paragraph prototype)

```
public static Paragraph.Builder newBuilder(Paragraph prototype)
```
...
```
public static Paragraph parseDelimitedFrom(InputStream input)
```
...
```
public static Paragraph parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Paragraph parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Paragraph parseFrom(ByteString data)
```
...
```
public static Paragraph parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Paragraph parseFrom(CodedInputStream input)
```
...
```
public static Paragraph parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Paragraph parseFrom(InputStream input)
```
...
```
public static Paragraph parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Paragraph parseFrom(ByteBuffer data)
```
...
```
public static Paragraph parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[Paragraph](/java/docs/reference/google-cloud-vision/3.47.0/com.google.cloud.vision.v1p4beta1.Paragraph)>`
...
`[BoundingPoly](/java/docs/reference/google-cloud-vision/3.47.0/com.google.cloud.vision.v1p4beta1.BoundingPoly)`
...
`[BoundingPolyOrBuilder](/java/docs/reference/google-cloud-vision/3.47.0/com.google.cloud.vision.v1p4beta1.BoundingPolyOrBuilder)`
...
`[TextAnnotation.TextProperty](/java/docs/reference/google-cloud-vision/3.47.0/com.google.cloud.vision.v1p4beta1.TextAnnotation.TextProperty)`
...
`[TextAnnotation.TextPropertyOrBuilder](/java/docs/reference/google-cloud-vision/3.47.0/com.google.cloud.vision.v1p4beta1.TextAnnotation.TextPropertyOrBuilder)`
...
`[Word](/java/docs/reference/google-cloud-vision/3.47.0/com.google.cloud.vision.v1p4beta1.Word)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Word](/java/docs/reference/google-cloud-vision/3.47.0/com.google.cloud.vision.v1p4beta1.Word)>`
...
`[WordOrBuilder](/java/docs/reference/google-cloud-vision/3.47.0/com.google.cloud.vision.v1p4beta1.WordOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.vision.v1p4beta1.WordOrBuilder>`
...
```
public Paragraph.Builder newBuilderForType()
```
...
```
protected Paragraph.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public Paragraph.Builder toBuilder()
```
