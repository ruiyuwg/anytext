...
# Class ListQueuedResourcesResponse (2.14.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListQueuedResourcesResponse extends GeneratedMessageV3 implements ListQueuedResourcesResponseOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListQueuedResourcesResponse

## Implements

[ListQueuedResourcesResponseOrBuilder](/java/docs/reference/google-cloud-tpu/2.14.0/com.google.cloud.tpu.v2alpha1.ListQueuedResourcesResponseOrBuilder)
...
### QUEUED\_RESOURCES\_FIELD\_NUMBER

```
public static final int QUEUED_RESOURCES_FIELD_NUMBER
```
...
```
public static ListQueuedResourcesResponse getDefaultInstance()
```
...
`[ListQueuedResourcesResponse](/java/docs/reference/google-cloud-tpu/2.14.0/com.google.cloud.tpu.v2alpha1.ListQueuedResourcesResponse)`
...
```
public static ListQueuedResourcesResponse.Builder newBuilder()
```
...
`[ListQueuedResourcesResponse.Builder](/java/docs/reference/google-cloud-tpu/2.14.0/com.google.cloud.tpu.v2alpha1.ListQueuedResourcesResponse.Builder)`

### newBuilder(ListQueuedResourcesResponse prototype)

```
public static ListQueuedResourcesResponse.Builder newBuilder(ListQueuedResourcesResponse prototype)
```
...
```
public static ListQueuedResourcesResponse parseDelimitedFrom(InputStream input)
```
...
```
public static ListQueuedResourcesResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListQueuedResourcesResponse parseFrom(byte[] data)
```
...
```
public static ListQueuedResourcesResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListQueuedResourcesResponse parseFrom(ByteString data)
```
...
```
public static ListQueuedResourcesResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListQueuedResourcesResponse parseFrom(CodedInputStream input)
```
...
```
public static ListQueuedResourcesResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListQueuedResourcesResponse parseFrom(InputStream input)
```
...
```
public static ListQueuedResourcesResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListQueuedResourcesResponse parseFrom(ByteBuffer data)
```
...
```
public static ListQueuedResourcesResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ListQueuedResourcesResponse> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListQueuedResourcesResponse](/java/docs/reference/google-cloud-tpu/2.14.0/com.google.cloud.tpu.v2alpha1.ListQueuedResourcesResponse)>`
...
```
public ListQueuedResourcesResponse getDefaultInstanceForType()
```
...
```
public Parser<ListQueuedResourcesResponse> getParserForType()
```
...
### getQueuedResources(int index)

```
public QueuedResource getQueuedResources(int index)
```

The listed queued resources.

`repeated .google.cloud.tpu.v2alpha1.QueuedResource queued_resources = 1;`
...
`[QueuedResource](/java/docs/reference/google-cloud-tpu/2.14.0/com.google.cloud.tpu.v2alpha1.QueuedResource)`

### getQueuedResourcesCount()
...
```
public List<QueuedResource> getQueuedResourcesList()
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[QueuedResource](/java/docs/reference/google-cloud-tpu/2.14.0/com.google.cloud.tpu.v2alpha1.QueuedResource)>`

### getQueuedResourcesOrBuilder(int index)

```
public QueuedResourceOrBuilder getQueuedResourcesOrBuilder(int index)
```
...
`[QueuedResourceOrBuilder](/java/docs/reference/google-cloud-tpu/2.14.0/com.google.cloud.tpu.v2alpha1.QueuedResourceOrBuilder)`

### getQueuedResourcesOrBuilderList()

```
public List<? extends QueuedResourceOrBuilder> getQueuedResourcesOrBuilderList()
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.tpu.v2alpha1.QueuedResourceOrBuilder>`
...
```
public ListQueuedResourcesResponse.Builder newBuilderForType()
```
...
```
protected ListQueuedResourcesResponse.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ListQueuedResourcesResponse.Builder toBuilder()
```
