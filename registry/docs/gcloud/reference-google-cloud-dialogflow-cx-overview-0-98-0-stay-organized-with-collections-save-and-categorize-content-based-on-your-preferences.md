...
# google-cloud-dialogflow-cx overview (0.98.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Dialogflow CX Description:** Provides a new way of designing agents, taking a state machine approach to agent design. This gives you clear and explicit control over a conversation, a better end-user experience, and a better development workflow.

[Dialogflow CX Product Reference](https://cloud.google.com/dialogflow/cx/docs)

[GitHub Repository](https://github.com/googleapis/google-cloud-java/tree/main/java-dialogflow-cx)

[Maven artifact](https://central.sonatype.com/artifact/com.google.cloud/google-cloud-dialogflow-cx)
...
-   [Enable the API](https://console.cloud.google.com/apis/library/dialogflow-cx.googleapis.com)
...
The example below demonstrates how you would import the BOM and include the `google-cloud-dialogflow-cx` artifact.
...
For this library, we recommend using [com.google.cloud.dialogflow.cx.v3](https://cloud.google.com/java/docs/reference/google-cloud-dialogflow-cx/0.98.0/com.google.cloud.dialogflow.cx.v3) for new applications.
