...
# Class CertificateAuthority.IssuingOptions (2.6.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class CertificateAuthority.IssuingOptions extends GeneratedMessageV3 implements CertificateAuthority.IssuingOptionsOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> CertificateAuthority.IssuingOptions

## Implements

[CertificateAuthority.IssuingOptionsOrBuilder](/java/docs/reference/google-cloud-security-private-ca/2.6.0/com.google.cloud.security.privateca.v1beta1.CertificateAuthority.IssuingOptionsOrBuilder)
...
### INCLUDE\_CA\_CERT\_URL\_FIELD\_NUMBER

```
public static final int INCLUDE_CA_CERT_URL_FIELD_NUMBER
```
...
### INCLUDE\_CRL\_ACCESS\_URL\_FIELD\_NUMBER

```
public static final int INCLUDE_CRL_ACCESS_URL_FIELD_NUMBER
```
...
```
public static CertificateAuthority.IssuingOptions getDefaultInstance()
```
...
[CertificateAuthority.IssuingOptions](/java/docs/reference/google-cloud-security-private-ca/2.6.0/com.google.cloud.security.privateca.v1beta1.CertificateAuthority.IssuingOptions)
...
```
public static CertificateAuthority.IssuingOptions.Builder newBuilder()
```
...
[CertificateAuthority.IssuingOptions.Builder](/java/docs/reference/google-cloud-security-private-ca/2.6.0/com.google.cloud.security.privateca.v1beta1.CertificateAuthority.IssuingOptions.Builder)

### newBuilder(CertificateAuthority.IssuingOptions prototype)

```
public static CertificateAuthority.IssuingOptions.Builder newBuilder(CertificateAuthority.IssuingOptions prototype)
```
...
```
public static CertificateAuthority.IssuingOptions parseDelimitedFrom(InputStream input)
```
...
```
public static CertificateAuthority.IssuingOptions parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CertificateAuthority.IssuingOptions parseFrom(byte[] data)
```
...
```
public static CertificateAuthority.IssuingOptions parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CertificateAuthority.IssuingOptions parseFrom(ByteString data)
```
...
```
public static CertificateAuthority.IssuingOptions parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CertificateAuthority.IssuingOptions parseFrom(CodedInputStream input)
```
...
```
public static CertificateAuthority.IssuingOptions parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CertificateAuthority.IssuingOptions parseFrom(InputStream input)
```
...
```
public static CertificateAuthority.IssuingOptions parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CertificateAuthority.IssuingOptions parseFrom(ByteBuffer data)
```
...
```
public static CertificateAuthority.IssuingOptions parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<CertificateAuthority.IssuingOptions> parser()
```
...
[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[IssuingOptions](/java/docs/reference/google-cloud-security-private-ca/2.6.0/com.google.cloud.security.privateca.v1beta1.CertificateAuthority.IssuingOptions)\>
...
```
public Parser<CertificateAuthority.IssuingOptions> getParserForType()
```
...
```
public CertificateAuthority.IssuingOptions.Builder newBuilderForType()
```
...
```
protected CertificateAuthority.IssuingOptions.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public CertificateAuthority.IssuingOptions.Builder toBuilder()
```
