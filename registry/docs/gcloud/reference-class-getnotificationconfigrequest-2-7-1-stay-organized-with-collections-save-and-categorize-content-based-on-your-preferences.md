...
# Class GetNotificationConfigRequest (2.7.1) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class GetNotificationConfigRequest extends GeneratedMessageV3 implements GetNotificationConfigRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> GetNotificationConfigRequest

## Implements

[GetNotificationConfigRequestOrBuilder](/java/docs/reference/google-cloud-securitycenter/2.7.1/com.google.cloud.securitycenter.v1.GetNotificationConfigRequestOrBuilder)
...
```
public static GetNotificationConfigRequest getDefaultInstance()
```
...
[GetNotificationConfigRequest](/java/docs/reference/google-cloud-securitycenter/2.7.1/com.google.cloud.securitycenter.v1.GetNotificationConfigRequest)
...
```
public static GetNotificationConfigRequest.Builder newBuilder()
```
...
[GetNotificationConfigRequest.Builder](/java/docs/reference/google-cloud-securitycenter/2.7.1/com.google.cloud.securitycenter.v1.GetNotificationConfigRequest.Builder)

### newBuilder(GetNotificationConfigRequest prototype)

```
public static GetNotificationConfigRequest.Builder newBuilder(GetNotificationConfigRequest prototype)
```
...
```
public static GetNotificationConfigRequest parseDelimitedFrom(InputStream input)
```
...
```
public static GetNotificationConfigRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetNotificationConfigRequest parseFrom(byte[] data)
```
...
```
public static GetNotificationConfigRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetNotificationConfigRequest parseFrom(ByteString data)
```
...
```
public static GetNotificationConfigRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetNotificationConfigRequest parseFrom(CodedInputStream input)
```
...
```
public static GetNotificationConfigRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetNotificationConfigRequest parseFrom(InputStream input)
```
...
```
public static GetNotificationConfigRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetNotificationConfigRequest parseFrom(ByteBuffer data)
```
...
```
public static GetNotificationConfigRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<GetNotificationConfigRequest> parser()
```
...
[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[GetNotificationConfigRequest](/java/docs/reference/google-cloud-securitycenter/2.7.1/com.google.cloud.securitycenter.v1.GetNotificationConfigRequest)\>
...
Required. Name of the notification config to get. Its format is "organizations/\[organization\_id\]/notificationConfigs/\[config\_id\]".
...
```
public Parser<GetNotificationConfigRequest> getParserForType()
```
...
```
public GetNotificationConfigRequest.Builder newBuilderForType()
```
...
```
protected GetNotificationConfigRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public GetNotificationConfigRequest.Builder toBuilder()
```
