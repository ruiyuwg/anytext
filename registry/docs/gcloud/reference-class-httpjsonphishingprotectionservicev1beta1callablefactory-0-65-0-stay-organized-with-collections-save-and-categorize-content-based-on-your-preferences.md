...
# Class HttpJsonPhishingProtectionServiceV1Beta1CallableFactory (0.65.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public class HttpJsonPhishingProtectionServiceV1Beta1CallableFactory implements HttpJsonStubCallableFactory<Operation,OperationsStub>
```
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> HttpJsonPhishingProtectionServiceV1Beta1CallableFactory
...
### HttpJsonPhishingProtectionServiceV1Beta1CallableFactory()

```
public HttpJsonPhishingProtectionServiceV1Beta1CallableFactory()
```
...
_The surface for long-running operations is not stable yet and may change in the future._
