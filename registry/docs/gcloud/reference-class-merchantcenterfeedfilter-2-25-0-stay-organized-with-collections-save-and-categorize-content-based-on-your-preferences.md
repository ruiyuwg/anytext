...
# Class MerchantCenterFeedFilter (2.25.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class MerchantCenterFeedFilter extends GeneratedMessageV3 implements MerchantCenterFeedFilterOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> MerchantCenterFeedFilter

## Implements

[MerchantCenterFeedFilterOrBuilder](/java/docs/reference/google-cloud-retail/2.25.0/com.google.cloud.retail.v2alpha.MerchantCenterFeedFilterOrBuilder)
...
### PRIMARY\_FEED\_ID\_FIELD\_NUMBER

```
public static final int PRIMARY_FEED_ID_FIELD_NUMBER
```
...
### PRIMARY\_FEED\_NAME\_FIELD\_NUMBER

```
public static final int PRIMARY_FEED_NAME_FIELD_NUMBER
```
...
```
public static MerchantCenterFeedFilter getDefaultInstance()
```
...
`[MerchantCenterFeedFilter](/java/docs/reference/google-cloud-retail/2.25.0/com.google.cloud.retail.v2alpha.MerchantCenterFeedFilter)`
...
```
public static MerchantCenterFeedFilter.Builder newBuilder()
```
...
`[MerchantCenterFeedFilter.Builder](/java/docs/reference/google-cloud-retail/2.25.0/com.google.cloud.retail.v2alpha.MerchantCenterFeedFilter.Builder)`

### newBuilder(MerchantCenterFeedFilter prototype)

```
public static MerchantCenterFeedFilter.Builder newBuilder(MerchantCenterFeedFilter prototype)
```
...
```
public static MerchantCenterFeedFilter parseDelimitedFrom(InputStream input)
```
...
```
public static MerchantCenterFeedFilter parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static MerchantCenterFeedFilter parseFrom(byte[] data)
```
...
```
public static MerchantCenterFeedFilter parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static MerchantCenterFeedFilter parseFrom(ByteString data)
```
...
```
public static MerchantCenterFeedFilter parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static MerchantCenterFeedFilter parseFrom(CodedInputStream input)
```
...
```
public static MerchantCenterFeedFilter parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static MerchantCenterFeedFilter parseFrom(InputStream input)
```
...
```
public static MerchantCenterFeedFilter parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static MerchantCenterFeedFilter parseFrom(ByteBuffer data)
```
...
```
public static MerchantCenterFeedFilter parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<MerchantCenterFeedFilter> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[MerchantCenterFeedFilter](/java/docs/reference/google-cloud-retail/2.25.0/com.google.cloud.retail.v2alpha.MerchantCenterFeedFilter)>`
...
```
public Parser<MerchantCenterFeedFilter> getParserForType()
```
...
```
public MerchantCenterFeedFilter.Builder newBuilderForType()
```
...
```
protected MerchantCenterFeedFilter.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public MerchantCenterFeedFilter.Builder toBuilder()
```
