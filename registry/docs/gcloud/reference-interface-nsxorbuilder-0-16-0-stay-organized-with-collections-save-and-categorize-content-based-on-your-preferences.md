...
# Interface NsxOrBuilder (0.16.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface NsxOrBuilder extends MessageOrBuilder
```
...
```
public abstract Nsx.State getState()
```
...
`[Nsx.State](/java/docs/reference/google-cloud-vmwareengine/0.16.0/com.google.cloud.vmwareengine.v1.Nsx.State)`
