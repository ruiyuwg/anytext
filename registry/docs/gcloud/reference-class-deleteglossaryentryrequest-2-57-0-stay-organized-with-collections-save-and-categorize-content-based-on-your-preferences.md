...
# Class DeleteGlossaryEntryRequest (2.57.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class DeleteGlossaryEntryRequest extends GeneratedMessageV3 implements DeleteGlossaryEntryRequestOrBuilder
```

Request message for Delete Glossary Entry

Protobuf type `google.cloud.translation.v3.DeleteGlossaryEntryRequest`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> DeleteGlossaryEntryRequest

## Implements

[DeleteGlossaryEntryRequestOrBuilder](/java/docs/reference/google-cloud-translate/2.57.0/com.google.cloud.translate.v3.DeleteGlossaryEntryRequestOrBuilder)
...
```
public static DeleteGlossaryEntryRequest getDefaultInstance()
```
...
`[DeleteGlossaryEntryRequest](/java/docs/reference/google-cloud-translate/2.57.0/com.google.cloud.translate.v3.DeleteGlossaryEntryRequest)`
...
```
public static DeleteGlossaryEntryRequest.Builder newBuilder()
```
...
`[DeleteGlossaryEntryRequest.Builder](/java/docs/reference/google-cloud-translate/2.57.0/com.google.cloud.translate.v3.DeleteGlossaryEntryRequest.Builder)`

### newBuilder(DeleteGlossaryEntryRequest prototype)

```
public static DeleteGlossaryEntryRequest.Builder newBuilder(DeleteGlossaryEntryRequest prototype)
```
...
```
public static DeleteGlossaryEntryRequest parseDelimitedFrom(InputStream input)
```
...
```
public static DeleteGlossaryEntryRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteGlossaryEntryRequest parseFrom(byte[] data)
```
...
```
public static DeleteGlossaryEntryRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteGlossaryEntryRequest parseFrom(ByteString data)
```
...
```
public static DeleteGlossaryEntryRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteGlossaryEntryRequest parseFrom(CodedInputStream input)
```
...
```
public static DeleteGlossaryEntryRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteGlossaryEntryRequest parseFrom(InputStream input)
```
...
```
public static DeleteGlossaryEntryRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteGlossaryEntryRequest parseFrom(ByteBuffer data)
```
...
```
public static DeleteGlossaryEntryRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<DeleteGlossaryEntryRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[DeleteGlossaryEntryRequest](/java/docs/reference/google-cloud-translate/2.57.0/com.google.cloud.translate.v3.DeleteGlossaryEntryRequest)>`
...
```
public DeleteGlossaryEntryRequest getDefaultInstanceForType()
```
...
```
public Parser<DeleteGlossaryEntryRequest> getParserForType()
```
...
```
public DeleteGlossaryEntryRequest.Builder newBuilderForType()
```
...
```
protected DeleteGlossaryEntryRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public DeleteGlossaryEntryRequest.Builder toBuilder()
```
