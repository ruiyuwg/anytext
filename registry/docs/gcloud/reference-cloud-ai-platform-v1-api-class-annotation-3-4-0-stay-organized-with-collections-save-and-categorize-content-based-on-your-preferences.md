...
# Cloud AI Platform v1 API - Class Annotation (3.4.0) Stay organized with collections Save and categorize content based on your preferences.
...
[IMessage](https://cloud.google.com/dotnet/docs/reference/Google.Protobuf/latest/Google.Protobuf.IMessage-1.html)[Annotation](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.4.0/Google.Cloud.AIPlatform.V1.Annotation), [IEquatable](https://learn.microsoft.com/dotnet/api/system.iequatable-1)[Annotation](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.4.0/Google.Cloud.AIPlatform.V1.Annotation), [IDeepCloneable](https://cloud.google.com/dotnet/docs/reference/Google.Protobuf/latest/Google.Protobuf.IDeepCloneable-1.html)[Annotation](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.4.0/Google.Cloud.AIPlatform.V1.Annotation), [IBufferMessage](https://cloud.google.com/dotnet/docs/reference/Google.Protobuf/latest/Google.Protobuf.IBufferMessage.html), [IMessage](https://cloud.google.com/dotnet/docs/reference/Google.Protobuf/latest/Google.Protobuf.IMessage.html)
...
`[Annotation](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.4.0/Google.Cloud.AIPlatform.V1.Annotation)`  
...
[AnnotationName](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.4.0/Google.Cloud.AIPlatform.V1.AnnotationName)\-typed view over the [Name](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.4.0/Google.Cloud.AIPlatform.V1.Annotation#Google_Cloud_AIPlatform_V1_Annotation_Name) resource name property.
...
`[AnnotationName](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.4.0/Google.Cloud.AIPlatform.V1.AnnotationName)`
...
`[UserActionReference](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.4.0/Google.Cloud.AIPlatform.V1.UserActionReference)`
