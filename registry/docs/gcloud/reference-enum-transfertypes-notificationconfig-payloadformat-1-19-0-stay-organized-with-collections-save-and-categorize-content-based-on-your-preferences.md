...
# Enum TransferTypes.NotificationConfig.PayloadFormat (1.19.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-storage-transfer/1.19.0/com.google.storagetransfer.v1.proto.TransferTypes.NotificationConfig.PayloadFormat#com_google_storagetransfer_v1_proto_TransferTypes_NotificationConfig_PayloadFormat_forNumber_int_) instead._
