...
# Interface SecurityHealthAnalyticsModuleOrBuilder (0.19.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[EnablementState](/java/docs/reference/google-cloud-securityposture/0.19.0/com.google.cloud.securityposture.v1.EnablementState)`
...
Required. The name of the module eg: BIGQUERY\_TABLE\_CMEK\_DISABLED.
