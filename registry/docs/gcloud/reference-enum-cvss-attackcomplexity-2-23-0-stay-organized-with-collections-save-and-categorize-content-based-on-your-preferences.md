...
# Enum CVSS.AttackComplexity (2.23.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum CVSS.AttackComplexity extends Enum<CVSS.AttackComplexity> implements ProtocolMessageEnum
```
...
`ATTACK_COMPLEXITY_MEDIUM_VALUE`
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/grafeas/2.23.0/io.grafeas.v1.CVSS.AttackComplexity#io_grafeas_v1_CVSS_AttackComplexity_forNumber_int_) instead._
