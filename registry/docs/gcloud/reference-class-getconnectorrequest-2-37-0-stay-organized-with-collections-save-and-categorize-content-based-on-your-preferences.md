...
# Class GetConnectorRequest (2.37.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class GetConnectorRequest extends GeneratedMessageV3 implements GetConnectorRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> GetConnectorRequest

## Implements

[GetConnectorRequestOrBuilder](/java/docs/reference/google-cloud-vpcaccess/2.37.0/com.google.cloud.vpcaccess.v1.GetConnectorRequestOrBuilder)
...
```
public static GetConnectorRequest getDefaultInstance()
```
...
`[GetConnectorRequest](/java/docs/reference/google-cloud-vpcaccess/2.37.0/com.google.cloud.vpcaccess.v1.GetConnectorRequest)`
...
```
public static GetConnectorRequest.Builder newBuilder()
```
...
`[GetConnectorRequest.Builder](/java/docs/reference/google-cloud-vpcaccess/2.37.0/com.google.cloud.vpcaccess.v1.GetConnectorRequest.Builder)`

### newBuilder(GetConnectorRequest prototype)

```
public static GetConnectorRequest.Builder newBuilder(GetConnectorRequest prototype)
```
...
```
public static GetConnectorRequest parseDelimitedFrom(InputStream input)
```
...
```
public static GetConnectorRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetConnectorRequest parseFrom(byte[] data)
```
...
```
public static GetConnectorRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetConnectorRequest parseFrom(ByteString data)
```
...
```
public static GetConnectorRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetConnectorRequest parseFrom(CodedInputStream input)
```
...
```
public static GetConnectorRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetConnectorRequest parseFrom(InputStream input)
```
...
```
public static GetConnectorRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetConnectorRequest parseFrom(ByteBuffer data)
```
...
```
public static GetConnectorRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<GetConnectorRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[GetConnectorRequest](/java/docs/reference/google-cloud-vpcaccess/2.37.0/com.google.cloud.vpcaccess.v1.GetConnectorRequest)>`
...
```
public GetConnectorRequest getDefaultInstanceForType()
```
...
```
public Parser<GetConnectorRequest> getParserForType()
```
...
```
public GetConnectorRequest.Builder newBuilderForType()
```
...
```
protected GetConnectorRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public GetConnectorRequest.Builder toBuilder()
```
