...
# Class RegionList (1.95.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class RegionList extends GeneratedMessage implements RegionListOrBuilder
```
...
`[RegionList](/java/docs/reference/google-cloud-compute/latest/com.google.cloud.compute.v1.RegionList)`
...
```
public static RegionList.Builder newBuilder()
```
...
`[RegionList.Builder](/java/docs/reference/google-cloud-compute/latest/com.google.cloud.compute.v1.RegionList.Builder)`

### newBuilder(RegionList prototype)

```
public static RegionList.Builder newBuilder(RegionList prototype)
```
...
```
public static RegionList parseDelimitedFrom(InputStream input)
```
...
```
public static RegionList parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RegionList parseFrom(byte[] data)
```
...
```
public static RegionList parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RegionList parseFrom(ByteString data)
```
...
```
public static RegionList parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RegionList parseFrom(CodedInputStream input)
```
...
```
public static RegionList parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RegionList parseFrom(InputStream input)
```
...
```
public static RegionList parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RegionList parseFrom(ByteBuffer data)
```
...
```
public static RegionList parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[RegionList](/java/docs/reference/google-cloud-compute/latest/com.google.cloud.compute.v1.RegionList)>`
...
```
public Region getItems(int index)
```

A list of Region resources.

`repeated .google.cloud.compute.v1.Region items = 100526016;`
...
`[Region](/java/docs/reference/google-cloud-compute/latest/com.google.cloud.compute.v1.Region)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Region](/java/docs/reference/google-cloud-compute/latest/com.google.cloud.compute.v1.Region)>`

### getItemsOrBuilder(int index)

```
public RegionOrBuilder getItemsOrBuilder(int index)
```
...
`[RegionOrBuilder](/java/docs/reference/google-cloud-compute/latest/com.google.cloud.compute.v1.RegionOrBuilder)`

### getItemsOrBuilderList()

```
public List<? extends RegionOrBuilder> getItemsOrBuilderList()
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.compute.v1.RegionOrBuilder>`
...
`[Warning](/java/docs/reference/google-cloud-compute/latest/com.google.cloud.compute.v1.Warning)`
...
`[WarningOrBuilder](/java/docs/reference/google-cloud-compute/latest/com.google.cloud.compute.v1.WarningOrBuilder)`
...
```
public RegionList.Builder newBuilderForType()
```
...
```
protected RegionList.Builder newBuilderForType(AbstractMessage.BuilderParent parent)
```
...
```
public RegionList.Builder toBuilder()
```
