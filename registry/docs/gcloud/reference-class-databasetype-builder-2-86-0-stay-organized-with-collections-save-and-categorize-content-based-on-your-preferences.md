...
# Class DatabaseType.Builder (2.86.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class DatabaseType.Builder extends GeneratedMessage.Builder<DatabaseType.Builder> implements DatabaseTypeOrBuilder
```
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessage.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessage.Builder.html) \> DatabaseType.Builder

## Implements

[DatabaseTypeOrBuilder](/java/docs/reference/google-cloud-dms/latest/com.google.cloud.clouddms.v1.DatabaseTypeOrBuilder)
...
`[DatabaseType](/java/docs/reference/google-cloud-dms/latest/com.google.cloud.clouddms.v1.DatabaseType)`

### buildPartial()

```
public DatabaseType buildPartial()
```
...
```
public DatabaseType.Builder clear()
```
...
`[DatabaseType.Builder](/java/docs/reference/google-cloud-dms/latest/com.google.cloud.clouddms.v1.DatabaseType.Builder)`
...
```
public DatabaseType.Builder clearEngine()
```

The database engine.

`.google.cloud.clouddms.v1.DatabaseEngine engine = 2;`
...
```
public DatabaseType.Builder clearProvider()
```

The database provider.

`.google.cloud.clouddms.v1.DatabaseProvider provider = 1;`
...
```
public DatabaseType getDefaultInstanceForType()
```
...
`[DatabaseEngine](/java/docs/reference/google-cloud-dms/latest/com.google.cloud.clouddms.v1.DatabaseEngine)`
...
`[DatabaseProvider](/java/docs/reference/google-cloud-dms/latest/com.google.cloud.clouddms.v1.DatabaseProvider)`
...
### mergeFrom(DatabaseType other)

```
public DatabaseType.Builder mergeFrom(DatabaseType other)
```
...
```
public DatabaseType.Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public DatabaseType.Builder mergeFrom(Message other)
```
...
### setEngine(DatabaseEngine value)

```
public DatabaseType.Builder setEngine(DatabaseEngine value)
```
...
```
public DatabaseType.Builder setEngineValue(int value)
```
...
```
public DatabaseType.Builder setProvider(DatabaseProvider value)
```
...
```
public DatabaseType.Builder setProviderValue(int value)
```
