...
# google-cloud-privilegedaccessmanager overview (0.1.0)

## Key Reference Links

**Privileged Access Manager API Description:** Privileged Access Manager API Privileged Access Manager (PAM) helps you on your journey towards least privilege and helps mitigate risks tied to privileged access misuse or abuse.

[Privileged Access Manager API Product Reference](https://cloud.google.com/java/docs/reference/google-cloud-privilegedaccessmanager/latest/overview)

[GitHub Repository (includes samples)](https://github.com/googleapis/google-cloud-java/tree/main/java-privilegedaccessmanager)

[Maven artifact](https://central.sonatype.com/artifact/com.google.cloud/google-cloud-privilegedaccessmanager)
...
-   [Enable the API](https://console.cloud.google.com/apis/library/privilegedaccessmanager.googleapis.com)
...
<dependencies>
 <dependency>
   <groupId>com.google.cloud</groupId>
   <artifactId>google-cloud-privilegedaccessmanager</artifactId>
 </dependency>
</dependencies>
...
implementation 'com.google.cloud:google-cloud-privilegedaccessmanager'
...
libraryDependencies += "com.google.cloud" % "google-cloud-privilegedaccessmanager" % "0.1.0"

## Which version ID should I get started with?

For this library, we recommend using [com.google.cloud.privilegedaccessmanager.v1](https://cloud.google.com/java/docs/reference/google-cloud-privilegedaccessmanager/0.1.0/com.google.cloud.privilegedaccessmanager.v1) for new applications.
