...
# Class CryptoKeyVersionName.Builder (2.42.0) Stay organized with collections Save and categorize content based on your preferences.
...
Builder for projects/{project}/locations/{location}/keyRings/{key\_ring}/cryptoKeys/{crypto\_key}/cryptoKeyVersions/{crypto\_key\_version}.

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> CryptoKeyVersionName.Builder
...
`[CryptoKeyVersionName](/java/docs/reference/google-cloud-kms/2.42.0/com.google.cloud.kms.v1.CryptoKeyVersionName)`
...
`[CryptoKeyVersionName.Builder](/java/docs/reference/google-cloud-kms/2.42.0/com.google.cloud.kms.v1.CryptoKeyVersionName.Builder)`
