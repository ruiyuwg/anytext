...
# Class ExperimentsLimitedErrorCountRetryPolicy (2.27.0) Stay organized with collections Save and categorize content based on your preferences.
...
A retry policy for [`ExperimentsConnection`](/cpp/docs/reference/dialogflow_cx/2.27.0/classgoogle_1_1cloud_1_1dialogflow__cx_1_1ExperimentsConnection) based on counting errors.
...
`ExperimentsLimitedErrorCountRetryPolicy const &`  
...
`std::unique_ptr< ExperimentsRetryPolicy >`

## Type Aliases

### BaseType

**Alias Of**: `ExperimentsRetryPolicy`
