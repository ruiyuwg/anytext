...
# Interface CreateTenantRequestOrBuilder (2.13.0) Stay organized with collections Save and categorize content based on your preferences.
...
Required. Resource name of the project under which the tenant is created. The format is "projects/{project\_id}", for example, "projects/foo".
...
`[Tenant](/java/docs/reference/google-cloud-talent/2.13.0/com.google.cloud.talent.v4beta1.Tenant)`
...
`[TenantOrBuilder](/java/docs/reference/google-cloud-talent/2.13.0/com.google.cloud.talent.v4beta1.TenantOrBuilder)`
