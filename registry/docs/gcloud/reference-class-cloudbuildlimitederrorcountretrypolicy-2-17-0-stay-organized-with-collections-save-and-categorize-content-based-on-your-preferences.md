...
# Class CloudBuildLimitedErrorCountRetryPolicy (2.17.0) Stay organized with collections Save and categorize content based on your preferences.
...
A retry policy for [`CloudBuildConnection`](/cpp/docs/reference/cloudbuild/2.17.0/classgoogle_1_1cloud_1_1cloudbuild__v1_1_1CloudBuildConnection) based on counting errors.
...
`CloudBuildLimitedErrorCountRetryPolicy const &`  
...
`std::unique_ptr< CloudBuildRetryPolicy >`

## Type Aliases

### BaseType

**Alias Of**: `CloudBuildRetryPolicy`
