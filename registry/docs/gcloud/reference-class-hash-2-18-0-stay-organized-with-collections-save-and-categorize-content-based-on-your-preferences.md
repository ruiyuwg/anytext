...
# Class Hash (2.18.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class Hash extends GeneratedMessageV3 implements HashOrBuilder
```
...
`[Hash](/java/docs/reference/grafeas/2.18.0/io.grafeas.v1.Hash)`
...
```
public static Hash.Builder newBuilder()
```
...
`[Hash.Builder](/java/docs/reference/grafeas/2.18.0/io.grafeas.v1.Hash.Builder)`

### newBuilder(Hash prototype)

```
public static Hash.Builder newBuilder(Hash prototype)
```
...
```
public static Hash parseDelimitedFrom(InputStream input)
```
...
```
public static Hash parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Hash parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Hash parseFrom(ByteString data)
```
...
```
public static Hash parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Hash parseFrom(CodedInputStream input)
```
...
```
public static Hash parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Hash parseFrom(InputStream input)
```
...
```
public static Hash parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Hash parseFrom(ByteBuffer data)
```
...
```
public static Hash parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[Hash](/java/docs/reference/grafeas/2.18.0/io.grafeas.v1.Hash)>`
...
```
public Hash.Builder newBuilderForType()
```
...
```
protected Hash.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
