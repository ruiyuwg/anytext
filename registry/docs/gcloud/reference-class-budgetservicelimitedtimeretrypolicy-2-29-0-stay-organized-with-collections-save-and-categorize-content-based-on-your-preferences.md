...
# Class BudgetServiceLimitedTimeRetryPolicy (2.29.0) Stay organized with collections Save and categorize content based on your preferences.
...
A retry policy for [`BudgetServiceConnection`](/cpp/docs/reference/billing/2.29.0/classgoogle_1_1cloud_1_1billing__budgets__v1_1_1BudgetServiceConnection) based on elapsed time.
...
`BudgetServiceLimitedTimeRetryPolicy const &`  
...
`std::unique_ptr< BudgetServiceRetryPolicy >`

## Type Aliases

### BaseType

**Alias Of**: `BudgetServiceRetryPolicy`
