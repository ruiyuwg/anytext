...
# Class VulnerableParameters (2.9.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class VulnerableParameters extends GeneratedMessageV3 implements VulnerableParametersOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> VulnerableParameters

## Implements

[VulnerableParametersOrBuilder](/java/docs/reference/google-cloud-websecurityscanner/2.9.0/com.google.cloud.websecurityscanner.v1beta.VulnerableParametersOrBuilder)
...
### PARAMETER\_NAMES\_FIELD\_NUMBER
...
```
public static VulnerableParameters getDefaultInstance()
```
...
`[VulnerableParameters](/java/docs/reference/google-cloud-websecurityscanner/2.9.0/com.google.cloud.websecurityscanner.v1beta.VulnerableParameters)`
...
```
public static VulnerableParameters.Builder newBuilder()
```
...
`[VulnerableParameters.Builder](/java/docs/reference/google-cloud-websecurityscanner/2.9.0/com.google.cloud.websecurityscanner.v1beta.VulnerableParameters.Builder)`

### newBuilder(VulnerableParameters prototype)

```
public static VulnerableParameters.Builder newBuilder(VulnerableParameters prototype)
```
...
```
public static VulnerableParameters parseDelimitedFrom(InputStream input)
```
...
```
public static VulnerableParameters parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static VulnerableParameters parseFrom(byte[] data)
```
...
```
public static VulnerableParameters parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static VulnerableParameters parseFrom(ByteString data)
```
...
```
public static VulnerableParameters parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static VulnerableParameters parseFrom(CodedInputStream input)
```
...
```
public static VulnerableParameters parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static VulnerableParameters parseFrom(InputStream input)
```
...
```
public static VulnerableParameters parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static VulnerableParameters parseFrom(ByteBuffer data)
```
...
```
public static VulnerableParameters parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<VulnerableParameters> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[VulnerableParameters](/java/docs/reference/google-cloud-websecurityscanner/2.9.0/com.google.cloud.websecurityscanner.v1beta.VulnerableParameters)>`
...
```
public Parser<VulnerableParameters> getParserForType()
```
...
```
public VulnerableParameters.Builder newBuilderForType()
```
...
```
protected VulnerableParameters.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public VulnerableParameters.Builder toBuilder()
```
