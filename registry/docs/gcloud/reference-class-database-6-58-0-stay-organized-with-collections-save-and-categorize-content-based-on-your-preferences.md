...
# Class Database (6.58.0) Stay organized with collections Save and categorize content based on your preferences.
...
[DatabaseOrBuilder](/java/docs/reference/google-cloud-spanner/6.58.0/com.google.spanner.admin.database.v1.DatabaseOrBuilder)
...
### DATABASE\_DIALECT\_FIELD\_NUMBER
...
### DEFAULT\_LEADER\_FIELD\_NUMBER
...
### EARLIEST\_VERSION\_TIME\_FIELD\_NUMBER
...
### ENABLE\_DROP\_PROTECTION\_FIELD\_NUMBER
...
### ENCRYPTION\_CONFIG\_FIELD\_NUMBER
...
### ENCRYPTION\_INFO\_FIELD\_NUMBER
...
### VERSION\_RETENTION\_PERIOD\_FIELD\_NUMBER
...
`[Database](/java/docs/reference/google-cloud-spanner/6.58.0/com.google.spanner.admin.database.v1.Database)`
...
`[Database.Builder](/java/docs/reference/google-cloud-spanner/6.58.0/com.google.spanner.admin.database.v1.Database.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[Database](/java/docs/reference/google-cloud-spanner/6.58.0/com.google.spanner.admin.database.v1.Database)>`
...
`[DatabaseDialect](/java/docs/reference/google-cloud-spanner/6.58.0/com.google.spanner.admin.database.v1.DatabaseDialect)`
...
`[EncryptionConfig](/java/docs/reference/google-cloud-spanner/6.58.0/com.google.spanner.admin.database.v1.EncryptionConfig)`
...
`[EncryptionConfigOrBuilder](/java/docs/reference/google-cloud-spanner/6.58.0/com.google.spanner.admin.database.v1.EncryptionConfigOrBuilder)`
...
`[EncryptionInfo](/java/docs/reference/google-cloud-spanner/6.58.0/com.google.spanner.admin.database.v1.EncryptionInfo)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[EncryptionInfo](/java/docs/reference/google-cloud-spanner/6.58.0/com.google.spanner.admin.database.v1.EncryptionInfo)>`
...
`[EncryptionInfoOrBuilder](/java/docs/reference/google-cloud-spanner/6.58.0/com.google.spanner.admin.database.v1.EncryptionInfoOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.spanner.admin.database.v1.EncryptionInfoOrBuilder>`
...
`[RestoreInfo](/java/docs/reference/google-cloud-spanner/6.58.0/com.google.spanner.admin.database.v1.RestoreInfo)`
...
`[RestoreInfoOrBuilder](/java/docs/reference/google-cloud-spanner/6.58.0/com.google.spanner.admin.database.v1.RestoreInfoOrBuilder)`
...
`[Database.State](/java/docs/reference/google-cloud-spanner/6.58.0/com.google.spanner.admin.database.v1.Database.State)`
