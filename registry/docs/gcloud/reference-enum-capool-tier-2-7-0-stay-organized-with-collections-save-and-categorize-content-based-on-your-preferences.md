...
# Enum CaPool.Tier (2.7.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum CaPool.Tier extends Enum<CaPool.Tier> implements ProtocolMessageEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-security-private-ca/2.7.0/com.google.cloud.security.privateca.v1.CaPool.Tier#com_google_cloud_security_privateca_v1_CaPool_Tier_forNumber_int_) instead._
