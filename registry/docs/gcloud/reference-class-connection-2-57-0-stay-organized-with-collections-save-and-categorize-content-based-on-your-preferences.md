...
# Class Connection (2.57.0) Stay organized with collections Save and categorize content based on your preferences.
...
Protobuf type `google.cloud.securitycenter.v2.Connection`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> Connection

## Implements

[ConnectionOrBuilder](/java/docs/reference/google-cloud-securitycenter/2.57.0/com.google.cloud.securitycenter.v2.ConnectionOrBuilder)
...
### DESTINATION\_IP\_FIELD\_NUMBER
...
### DESTINATION\_PORT\_FIELD\_NUMBER
...
`[Connection](/java/docs/reference/google-cloud-securitycenter/2.57.0/com.google.cloud.securitycenter.v2.Connection)`
...
`[Connection.Builder](/java/docs/reference/google-cloud-securitycenter/2.57.0/com.google.cloud.securitycenter.v2.Connection.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[Connection](/java/docs/reference/google-cloud-securitycenter/2.57.0/com.google.cloud.securitycenter.v2.Connection)>`
...
`.google.cloud.securitycenter.v2.Connection.Protocol protocol = 5;`
...
`[Connection.Protocol](/java/docs/reference/google-cloud-securitycenter/2.57.0/com.google.cloud.securitycenter.v2.Connection.Protocol)`
