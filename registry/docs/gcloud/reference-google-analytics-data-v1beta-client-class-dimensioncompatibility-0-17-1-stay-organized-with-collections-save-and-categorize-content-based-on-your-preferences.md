...
# Google Analytics Data V1beta Client - Class DimensionCompatibility (0.17.1) Stay organized with collections Save and categorize content based on your preferences.
...
`[Google\Analytics\Data\V1beta\DimensionMetadata](/php/docs/reference/analytics-data/0.17.1/V1beta.DimensionMetadata)`  
...
`[Google\Analytics\Data\V1beta\DimensionMetadata](/php/docs/reference/analytics-data/0.17.1/V1beta.DimensionMetadata)|null`
