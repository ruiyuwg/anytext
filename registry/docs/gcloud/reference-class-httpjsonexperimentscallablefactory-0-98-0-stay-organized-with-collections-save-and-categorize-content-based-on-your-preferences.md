...
# Class HttpJsonExperimentsCallableFactory (0.98.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public class HttpJsonExperimentsCallableFactory implements HttpJsonStubCallableFactory<Operation,OperationsStub>
```
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> HttpJsonExperimentsCallableFactory
...
### HttpJsonExperimentsCallableFactory()

```
public HttpJsonExperimentsCallableFactory()
```
