...
# Class HierarchyControllerConfig (1.39.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class HierarchyControllerConfig extends GeneratedMessageV3 implements HierarchyControllerConfigOrBuilder
```

Configuration for Hierarchy Controller

Protobuf type `google.cloud.gkehub.configmanagement.v1alpha.HierarchyControllerConfig`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> HierarchyControllerConfig

## Implements

[HierarchyControllerConfigOrBuilder](/java/docs/reference/google-cloud-gkehub/1.39.0/com.google.cloud.gkehub.configmanagement.v1alpha.HierarchyControllerConfigOrBuilder)
...
### ENABLE\_HIERARCHICAL\_RESOURCE\_QUOTA\_FIELD\_NUMBER

```
public static final int ENABLE_HIERARCHICAL_RESOURCE_QUOTA_FIELD_NUMBER
```
...
### ENABLE\_POD\_TREE\_LABELS\_FIELD\_NUMBER

```
public static final int ENABLE_POD_TREE_LABELS_FIELD_NUMBER
```
...
```
public static HierarchyControllerConfig getDefaultInstance()
```
...
`[HierarchyControllerConfig](/java/docs/reference/google-cloud-gkehub/1.39.0/com.google.cloud.gkehub.configmanagement.v1alpha.HierarchyControllerConfig)`
...
```
public static HierarchyControllerConfig.Builder newBuilder()
```
...
`[HierarchyControllerConfig.Builder](/java/docs/reference/google-cloud-gkehub/1.39.0/com.google.cloud.gkehub.configmanagement.v1alpha.HierarchyControllerConfig.Builder)`

### newBuilder(HierarchyControllerConfig prototype)

```
public static HierarchyControllerConfig.Builder newBuilder(HierarchyControllerConfig prototype)
```
...
```
public static HierarchyControllerConfig parseDelimitedFrom(InputStream input)
```
...
```
public static HierarchyControllerConfig parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static HierarchyControllerConfig parseFrom(byte[] data)
```
...
```
public static HierarchyControllerConfig parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static HierarchyControllerConfig parseFrom(ByteString data)
```
...
```
public static HierarchyControllerConfig parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static HierarchyControllerConfig parseFrom(CodedInputStream input)
```
...
```
public static HierarchyControllerConfig parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static HierarchyControllerConfig parseFrom(InputStream input)
```
...
```
public static HierarchyControllerConfig parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static HierarchyControllerConfig parseFrom(ByteBuffer data)
```
...
```
public static HierarchyControllerConfig parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<HierarchyControllerConfig> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[HierarchyControllerConfig](/java/docs/reference/google-cloud-gkehub/1.39.0/com.google.cloud.gkehub.configmanagement.v1alpha.HierarchyControllerConfig)>`
...
```
public Parser<HierarchyControllerConfig> getParserForType()
```
...
```
public HierarchyControllerConfig.Builder newBuilderForType()
```
...
```
protected HierarchyControllerConfig.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public HierarchyControllerConfig.Builder toBuilder()
```
