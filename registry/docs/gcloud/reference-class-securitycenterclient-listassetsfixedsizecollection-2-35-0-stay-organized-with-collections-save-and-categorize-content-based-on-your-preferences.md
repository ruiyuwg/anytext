...
# Class SecurityCenterClient.ListAssetsFixedSizeCollection (2.35.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class SecurityCenterClient.ListAssetsFixedSizeCollection extends AbstractFixedSizeCollection<ListAssetsRequest,ListAssetsResponse,ListAssetsResponse.ListAssetsResult,SecurityCenterClient.ListAssetsPage,SecurityCenterClient.ListAssetsFixedSizeCollection>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractFixedSizeCollection](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractFixedSizeCollection.html) \> SecurityCenterClient.ListAssetsFixedSizeCollection
...
### createCollection(List<SecurityCenterClient.ListAssetsPage> pages, int collectionSize)

```
protected SecurityCenterClient.ListAssetsFixedSizeCollection createCollection(List<SecurityCenterClient.ListAssetsPage> pages, int collectionSize)
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ListAssetsPage](/java/docs/reference/google-cloud-securitycenter/2.35.0/com.google.cloud.securitycenter.v1.SecurityCenterClient.ListAssetsPage)>`  
...
`[SecurityCenterClient.ListAssetsFixedSizeCollection](/java/docs/reference/google-cloud-securitycenter/2.35.0/com.google.cloud.securitycenter.v1.SecurityCenterClient.ListAssetsFixedSizeCollection)`
