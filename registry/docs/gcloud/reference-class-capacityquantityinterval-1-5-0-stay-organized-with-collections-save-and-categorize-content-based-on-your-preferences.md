...
# Class CapacityQuantityInterval (1.5.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class CapacityQuantityInterval extends GeneratedMessageV3 implements CapacityQuantityIntervalOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> CapacityQuantityInterval

## Implements

[CapacityQuantityIntervalOrBuilder](/java/docs/reference/google-cloud-optimization/1.5.0/com.google.cloud.optimization.v1.CapacityQuantityIntervalOrBuilder)
...
```
public static CapacityQuantityInterval getDefaultInstance()
```
...
[CapacityQuantityInterval](/java/docs/reference/google-cloud-optimization/1.5.0/com.google.cloud.optimization.v1.CapacityQuantityInterval)
...
```
public static CapacityQuantityInterval.Builder newBuilder()
```
...
[CapacityQuantityInterval.Builder](/java/docs/reference/google-cloud-optimization/1.5.0/com.google.cloud.optimization.v1.CapacityQuantityInterval.Builder)

### newBuilder(CapacityQuantityInterval prototype)

```
public static CapacityQuantityInterval.Builder newBuilder(CapacityQuantityInterval prototype)
```
...
```
public static CapacityQuantityInterval parseDelimitedFrom(InputStream input)
```
...
```
public static CapacityQuantityInterval parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CapacityQuantityInterval parseFrom(byte[] data)
```
...
```
public static CapacityQuantityInterval parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CapacityQuantityInterval parseFrom(ByteString data)
```
...
```
public static CapacityQuantityInterval parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CapacityQuantityInterval parseFrom(CodedInputStream input)
```
...
```
public static CapacityQuantityInterval parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CapacityQuantityInterval parseFrom(InputStream input)
```
...
```
public static CapacityQuantityInterval parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CapacityQuantityInterval parseFrom(ByteBuffer data)
```
...
```
public static CapacityQuantityInterval parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<CapacityQuantityInterval> parser()
```
...
[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[CapacityQuantityInterval](/java/docs/reference/google-cloud-optimization/1.5.0/com.google.cloud.optimization.v1.CapacityQuantityInterval)\>
...
```
public Parser<CapacityQuantityInterval> getParserForType()
```
...
```
public CapacityQuantityInterval.Builder newBuilderForType()
```
...
```
protected CapacityQuantityInterval.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public CapacityQuantityInterval.Builder toBuilder()
```
