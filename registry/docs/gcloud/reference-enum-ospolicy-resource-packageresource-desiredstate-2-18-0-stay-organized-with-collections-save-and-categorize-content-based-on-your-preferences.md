...
# Enum OSPolicy.Resource.PackageResource.DesiredState (2.18.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-os-config/2.18.0/com.google.cloud.osconfig.v1.OSPolicy.Resource.PackageResource.DesiredState#com_google_cloud_osconfig_v1_OSPolicy_Resource_PackageResource_DesiredState_forNumber_int_) instead._
