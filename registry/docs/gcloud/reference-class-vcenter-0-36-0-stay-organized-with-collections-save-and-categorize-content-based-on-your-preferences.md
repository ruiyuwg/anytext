...
# Class Vcenter (0.36.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class Vcenter extends GeneratedMessageV3 implements VcenterOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> Vcenter

## Implements

[VcenterOrBuilder](/java/docs/reference/google-cloud-vmwareengine/0.36.0/com.google.cloud.vmwareengine.v1.VcenterOrBuilder)
...
```
public static Vcenter getDefaultInstance()
```
...
`[Vcenter](/java/docs/reference/google-cloud-vmwareengine/0.36.0/com.google.cloud.vmwareengine.v1.Vcenter)`
...
```
public static Vcenter.Builder newBuilder()
```
...
`[Vcenter.Builder](/java/docs/reference/google-cloud-vmwareengine/0.36.0/com.google.cloud.vmwareengine.v1.Vcenter.Builder)`

### newBuilder(Vcenter prototype)

```
public static Vcenter.Builder newBuilder(Vcenter prototype)
```
...
```
public static Vcenter parseDelimitedFrom(InputStream input)
```
...
```
public static Vcenter parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Vcenter parseFrom(byte[] data)
```
...
```
public static Vcenter parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Vcenter parseFrom(ByteString data)
```
...
```
public static Vcenter parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Vcenter parseFrom(CodedInputStream input)
```
...
```
public static Vcenter parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Vcenter parseFrom(InputStream input)
```
...
```
public static Vcenter parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Vcenter parseFrom(ByteBuffer data)
```
...
```
public static Vcenter parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<Vcenter> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[Vcenter](/java/docs/reference/google-cloud-vmwareengine/0.36.0/com.google.cloud.vmwareengine.v1.Vcenter)>`
...
```
public Vcenter getDefaultInstanceForType()
```
...
```
public Parser<Vcenter> getParserForType()
```
...
`[Vcenter.State](/java/docs/reference/google-cloud-vmwareengine/0.36.0/com.google.cloud.vmwareengine.v1.Vcenter.State)`
...
```
public Vcenter.Builder newBuilderForType()
```
...
```
protected Vcenter.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public Vcenter.Builder toBuilder()
```
