...
# google-cloud-workflow-executions overview (2.42.0)
...
[GitHub Repository (includes samples)](https://github.com/googleapis/google-cloud-java/tree/main/java-workflow-executions)
...
For this library, we recommend using [com.google.cloud.workflows.executions.v1](https://cloud.google.com/java/docs/reference/google-cloud-workflow-executions/2.42.0/com.google.cloud.workflows.executions.v1) for new applications.
