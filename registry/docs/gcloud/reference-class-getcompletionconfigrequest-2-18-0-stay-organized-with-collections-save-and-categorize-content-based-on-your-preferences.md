...
# Class GetCompletionConfigRequest (2.18.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class GetCompletionConfigRequest extends GeneratedMessageV3 implements GetCompletionConfigRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> GetCompletionConfigRequest

## Implements

[GetCompletionConfigRequestOrBuilder](/java/docs/reference/google-cloud-retail/2.18.0/com.google.cloud.retail.v2.GetCompletionConfigRequestOrBuilder)
...
```
public static GetCompletionConfigRequest getDefaultInstance()
```
...
`[GetCompletionConfigRequest](/java/docs/reference/google-cloud-retail/2.18.0/com.google.cloud.retail.v2.GetCompletionConfigRequest)`
...
```
public static GetCompletionConfigRequest.Builder newBuilder()
```
...
`[GetCompletionConfigRequest.Builder](/java/docs/reference/google-cloud-retail/2.18.0/com.google.cloud.retail.v2.GetCompletionConfigRequest.Builder)`

### newBuilder(GetCompletionConfigRequest prototype)

```
public static GetCompletionConfigRequest.Builder newBuilder(GetCompletionConfigRequest prototype)
```
...
```
public static GetCompletionConfigRequest parseDelimitedFrom(InputStream input)
```
...
```
public static GetCompletionConfigRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetCompletionConfigRequest parseFrom(byte[] data)
```
...
```
public static GetCompletionConfigRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetCompletionConfigRequest parseFrom(ByteString data)
```
...
```
public static GetCompletionConfigRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetCompletionConfigRequest parseFrom(CodedInputStream input)
```
...
```
public static GetCompletionConfigRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetCompletionConfigRequest parseFrom(InputStream input)
```
...
```
public static GetCompletionConfigRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetCompletionConfigRequest parseFrom(ByteBuffer data)
```
...
```
public static GetCompletionConfigRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<GetCompletionConfigRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[GetCompletionConfigRequest](/java/docs/reference/google-cloud-retail/2.18.0/com.google.cloud.retail.v2.GetCompletionConfigRequest)>`
...
```
public GetCompletionConfigRequest getDefaultInstanceForType()
```
...
```
public Parser<GetCompletionConfigRequest> getParserForType()
```
...
```
public GetCompletionConfigRequest.Builder newBuilderForType()
```
...
```
protected GetCompletionConfigRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public GetCompletionConfigRequest.Builder toBuilder()
```
