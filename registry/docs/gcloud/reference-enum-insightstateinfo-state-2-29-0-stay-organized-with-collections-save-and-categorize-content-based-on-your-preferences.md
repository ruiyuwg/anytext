...
# Enum InsightStateInfo.State (2.29.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum InsightStateInfo.State extends Enum<InsightStateInfo.State> implements ProtocolMessageEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-recommender/2.29.0/com.google.cloud.recommender.v1.InsightStateInfo.State#com_google_cloud_recommender_v1_InsightStateInfo_State_forNumber_int_) instead._
