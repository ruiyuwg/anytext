...
# Enum Inventory.Item.DetailsCase (2.45.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum Inventory.Item.DetailsCase extends Enum<Inventory.Item.DetailsCase> implements Internal.EnumLite, AbstractMessageLite.InternalOneOfEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-os-config/2.45.0/com.google.cloud.osconfig.v1alpha.Inventory.Item.DetailsCase#com_google_cloud_osconfig_v1alpha_Inventory_Item_DetailsCase_forNumber_int_) instead._
