...
# Class CreateProductRequest.Builder (2.0.19) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> CreateProductRequest.Builder

## Implements

[CreateProductRequestOrBuilder](/java/docs/reference/google-cloud-retail/2.0.19/com.google.cloud.retail.v2.CreateProductRequestOrBuilder)
...
[CreateProductRequest.Builder](/java/docs/reference/google-cloud-retail/2.0.19/com.google.cloud.retail.v2.CreateProductRequest.Builder)
...
[CreateProductRequest](/java/docs/reference/google-cloud-retail/2.0.19/com.google.cloud.retail.v2.CreateProductRequest)
...
Required. The ID to use for the Product, which will become the final component of the Product.name. If the caller does not have permission to create the Product, regardless of whether or not it exists, a PERMISSION\_DENIED error is returned. This field must be unique among all Products with the same parent. Otherwise, an ALREADY\_EXISTS error is returned. This field must be a UTF-8 encoded string with a length limit of 128 characters. Otherwise, an INVALID\_ARGUMENT error is returned.
...
[Product](/java/docs/reference/google-cloud-retail/2.0.19/com.google.cloud.retail.v2.Product)
...
[Product.Builder](/java/docs/reference/google-cloud-retail/2.0.19/com.google.cloud.retail.v2.Product.Builder)
...
[ProductOrBuilder](/java/docs/reference/google-cloud-retail/2.0.19/com.google.cloud.retail.v2.ProductOrBuilder)
...
```
public CreateProductRequest.Builder mergeFrom(CreateProductRequest other)
```
...
```
public CreateProductRequest.Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public CreateProductRequest.Builder mergeFrom(Message other)
```
...
```
public final CreateProductRequest.Builder mergeUnknownFields(UnknownFieldSet unknownFields)
```
...
```
public CreateProductRequest.Builder setField(Descriptors.FieldDescriptor field, Object value)
```
...
```
public CreateProductRequest.Builder setParentBytes(ByteString value)
```
...
```
public CreateProductRequest.Builder setProductIdBytes(ByteString value)
```
...
```
public CreateProductRequest.Builder setRepeatedField(Descriptors.FieldDescriptor field, int index, Object value)
```
...
```
public final CreateProductRequest.Builder setUnknownFields(UnknownFieldSet unknownFields)
```
