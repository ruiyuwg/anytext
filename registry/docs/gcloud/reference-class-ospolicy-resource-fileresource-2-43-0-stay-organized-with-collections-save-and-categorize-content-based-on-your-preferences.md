...
# Class OSPolicy.Resource.FileResource (2.43.0) Stay organized with collections Save and categorize content based on your preferences.
...
[OSPolicy.Resource.FileResourceOrBuilder](/java/docs/reference/google-cloud-os-config/2.43.0/com.google.cloud.osconfig.v1alpha.OSPolicy.Resource.FileResourceOrBuilder)
...
`[OSPolicy.Resource.FileResource](/java/docs/reference/google-cloud-os-config/2.43.0/com.google.cloud.osconfig.v1alpha.OSPolicy.Resource.FileResource)`
...
`[OSPolicy.Resource.FileResource.Builder](/java/docs/reference/google-cloud-os-config/2.43.0/com.google.cloud.osconfig.v1alpha.OSPolicy.Resource.FileResource.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[FileResource](/java/docs/reference/google-cloud-os-config/2.43.0/com.google.cloud.osconfig.v1alpha.OSPolicy.Resource.FileResource)>`
...
`[OSPolicy.Resource.File](/java/docs/reference/google-cloud-os-config/2.43.0/com.google.cloud.osconfig.v1alpha.OSPolicy.Resource.File)`
...
`[OSPolicy.Resource.FileOrBuilder](/java/docs/reference/google-cloud-os-config/2.43.0/com.google.cloud.osconfig.v1alpha.OSPolicy.Resource.FileOrBuilder)`
...
`[OSPolicy.Resource.FileResource.SourceCase](/java/docs/reference/google-cloud-os-config/2.43.0/com.google.cloud.osconfig.v1alpha.OSPolicy.Resource.FileResource.SourceCase)`
...
`[OSPolicy.Resource.FileResource.DesiredState](/java/docs/reference/google-cloud-os-config/2.43.0/com.google.cloud.osconfig.v1alpha.OSPolicy.Resource.FileResource.DesiredState)`
