...
# Class CloudRedisGrpc.CloudRedisBlockingStub (2.45.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class CloudRedisGrpc.CloudRedisBlockingStub extends AbstractBlockingStub<CloudRedisGrpc.CloudRedisBlockingStub>
```
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> io.grpc.stub.AbstractStub \> io.grpc.stub.AbstractBlockingStub \> CloudRedisGrpc.CloudRedisBlockingStub
...
```
protected CloudRedisGrpc.CloudRedisBlockingStub build(Channel channel, CallOptions callOptions)
```
...
`[CloudRedisGrpc.CloudRedisBlockingStub](/java/docs/reference/google-cloud-redis/2.45.0/com.google.cloud.redis.v1beta1.CloudRedisGrpc.CloudRedisBlockingStub)`
...
`[CreateInstanceRequest](/java/docs/reference/google-cloud-redis/2.45.0/com.google.cloud.redis.v1beta1.CreateInstanceRequest)`  
...
`[DeleteInstanceRequest](/java/docs/reference/google-cloud-redis/2.45.0/com.google.cloud.redis.v1beta1.DeleteInstanceRequest)`  
...
`[ExportInstanceRequest](/java/docs/reference/google-cloud-redis/2.45.0/com.google.cloud.redis.v1beta1.ExportInstanceRequest)`  
...
`[FailoverInstanceRequest](/java/docs/reference/google-cloud-redis/2.45.0/com.google.cloud.redis.v1beta1.FailoverInstanceRequest)`  
...
`[GetInstanceRequest](/java/docs/reference/google-cloud-redis/2.45.0/com.google.cloud.redis.v1beta1.GetInstanceRequest)`  
...
`[Instance](/java/docs/reference/google-cloud-redis/2.45.0/com.google.cloud.redis.v1beta1.Instance)`
...
`[GetInstanceAuthStringRequest](/java/docs/reference/google-cloud-redis/2.45.0/com.google.cloud.redis.v1beta1.GetInstanceAuthStringRequest)`  
...
`[InstanceAuthString](/java/docs/reference/google-cloud-redis/2.45.0/com.google.cloud.redis.v1beta1.InstanceAuthString)`
...
`[ImportInstanceRequest](/java/docs/reference/google-cloud-redis/2.45.0/com.google.cloud.redis.v1beta1.ImportInstanceRequest)`  
...
`[ListInstancesRequest](/java/docs/reference/google-cloud-redis/2.45.0/com.google.cloud.redis.v1beta1.ListInstancesRequest)`  
...
`[ListInstancesResponse](/java/docs/reference/google-cloud-redis/2.45.0/com.google.cloud.redis.v1beta1.ListInstancesResponse)`
...
`[RescheduleMaintenanceRequest](/java/docs/reference/google-cloud-redis/2.45.0/com.google.cloud.redis.v1beta1.RescheduleMaintenanceRequest)`  
...
`[UpdateInstanceRequest](/java/docs/reference/google-cloud-redis/2.45.0/com.google.cloud.redis.v1beta1.UpdateInstanceRequest)`  
...
`[UpgradeInstanceRequest](/java/docs/reference/google-cloud-redis/2.45.0/com.google.cloud.redis.v1beta1.UpgradeInstanceRequest)`  
