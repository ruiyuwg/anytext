...
# Enum SavedDisk.Architecture (1.93.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum SavedDisk.Architecture extends Enum<SavedDisk.Architecture> implements ProtocolMessageEnum
```
...
Machines with architecture X86\_64
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-compute/latest/com.google.cloud.compute.v1.SavedDisk.Architecture#com_google_cloud_compute_v1_SavedDisk_Architecture_forNumber_int_) instead._
