...
# Interface ListInstancesResponseOrBuilder (2.56.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Instance](/java/docs/reference/google-cloud-memcache/2.56.0/com.google.cloud.memcache.v1.Instance)>`
...
`[InstanceOrBuilder](/java/docs/reference/google-cloud-memcache/2.56.0/com.google.cloud.memcache.v1.InstanceOrBuilder)`
