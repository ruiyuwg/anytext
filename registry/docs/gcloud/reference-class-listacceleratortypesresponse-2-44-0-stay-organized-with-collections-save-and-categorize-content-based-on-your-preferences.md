...
# Class ListAcceleratorTypesResponse (2.44.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListAcceleratorTypesResponse extends GeneratedMessageV3 implements ListAcceleratorTypesResponseOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListAcceleratorTypesResponse

## Implements

[ListAcceleratorTypesResponseOrBuilder](/java/docs/reference/google-cloud-tpu/2.44.0/com.google.cloud.tpu.v2.ListAcceleratorTypesResponseOrBuilder)
...
### ACCELERATOR\_TYPES\_FIELD\_NUMBER

```
public static final int ACCELERATOR_TYPES_FIELD_NUMBER
```
...
```
public static ListAcceleratorTypesResponse getDefaultInstance()
```
...
`[ListAcceleratorTypesResponse](/java/docs/reference/google-cloud-tpu/2.44.0/com.google.cloud.tpu.v2.ListAcceleratorTypesResponse)`
...
```
public static ListAcceleratorTypesResponse.Builder newBuilder()
```
...
`[ListAcceleratorTypesResponse.Builder](/java/docs/reference/google-cloud-tpu/2.44.0/com.google.cloud.tpu.v2.ListAcceleratorTypesResponse.Builder)`

### newBuilder(ListAcceleratorTypesResponse prototype)

```
public static ListAcceleratorTypesResponse.Builder newBuilder(ListAcceleratorTypesResponse prototype)
```
...
```
public static ListAcceleratorTypesResponse parseDelimitedFrom(InputStream input)
```
...
```
public static ListAcceleratorTypesResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListAcceleratorTypesResponse parseFrom(byte[] data)
```
...
```
public static ListAcceleratorTypesResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListAcceleratorTypesResponse parseFrom(ByteString data)
```
...
```
public static ListAcceleratorTypesResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListAcceleratorTypesResponse parseFrom(CodedInputStream input)
```
...
```
public static ListAcceleratorTypesResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListAcceleratorTypesResponse parseFrom(InputStream input)
```
...
```
public static ListAcceleratorTypesResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListAcceleratorTypesResponse parseFrom(ByteBuffer data)
```
...
```
public static ListAcceleratorTypesResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ListAcceleratorTypesResponse> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListAcceleratorTypesResponse](/java/docs/reference/google-cloud-tpu/2.44.0/com.google.cloud.tpu.v2.ListAcceleratorTypesResponse)>`
...
`[AcceleratorType](/java/docs/reference/google-cloud-tpu/2.44.0/com.google.cloud.tpu.v2.AcceleratorType)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[AcceleratorType](/java/docs/reference/google-cloud-tpu/2.44.0/com.google.cloud.tpu.v2.AcceleratorType)>`
...
`[AcceleratorTypeOrBuilder](/java/docs/reference/google-cloud-tpu/2.44.0/com.google.cloud.tpu.v2.AcceleratorTypeOrBuilder)`
...
```
public ListAcceleratorTypesResponse getDefaultInstanceForType()
```
...
```
public Parser<ListAcceleratorTypesResponse> getParserForType()
```
...
```
public ListAcceleratorTypesResponse.Builder newBuilderForType()
```
...
```
protected ListAcceleratorTypesResponse.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ListAcceleratorTypesResponse.Builder toBuilder()
```
