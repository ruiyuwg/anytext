...
# Class ListClustersResponse (0.22.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListClustersResponse

## Implements

[ListClustersResponseOrBuilder](/java/docs/reference/google-cloud-vmwareengine/0.22.0/com.google.cloud.vmwareengine.v1.ListClustersResponseOrBuilder)
...
`[ListClustersResponse](/java/docs/reference/google-cloud-vmwareengine/0.22.0/com.google.cloud.vmwareengine.v1.ListClustersResponse)`
...
`[ListClustersResponse.Builder](/java/docs/reference/google-cloud-vmwareengine/0.22.0/com.google.cloud.vmwareengine.v1.ListClustersResponse.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListClustersResponse](/java/docs/reference/google-cloud-vmwareengine/0.22.0/com.google.cloud.vmwareengine.v1.ListClustersResponse)>`
...
`repeated .google.cloud.vmwareengine.v1.Cluster clusters = 1;`
...
`[Cluster](/java/docs/reference/google-cloud-vmwareengine/0.22.0/com.google.cloud.vmwareengine.v1.Cluster)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Cluster](/java/docs/reference/google-cloud-vmwareengine/0.22.0/com.google.cloud.vmwareengine.v1.Cluster)>`
...
`[ClusterOrBuilder](/java/docs/reference/google-cloud-vmwareengine/0.22.0/com.google.cloud.vmwareengine.v1.ClusterOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.vmwareengine.v1.ClusterOrBuilder>`
