...
# Enum Volume.StorageCase (0.6.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum Volume.StorageCase extends Enum<Volume.StorageCase> implements Internal.EnumLite, AbstractMessageLite.InternalOneOfEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-life-sciences/0.6.0/com.google.cloud.lifesciences.v2beta.Volume.StorageCase#com_google_cloud_lifesciences_v2beta_Volume_StorageCase_forNumber_int_) instead._
