...
# Interface Endpoint.AppEngineVersionEndpointOrBuilder (1.32.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static interface Endpoint.AppEngineVersionEndpointOrBuilder extends MessageOrBuilder
```
