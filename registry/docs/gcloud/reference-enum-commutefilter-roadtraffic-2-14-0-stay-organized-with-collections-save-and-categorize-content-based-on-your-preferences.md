...
# Enum CommuteFilter.RoadTraffic (2.14.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-talent/2.14.0/com.google.cloud.talent.v4beta1.CommuteFilter.RoadTraffic#com_google_cloud_talent_v4beta1_CommuteFilter_RoadTraffic_forNumber_int_) instead._
