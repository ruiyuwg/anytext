...
# Class BigQueryWriteLimitedTimeRetryPolicy (2.37.0) Stay organized with collections Save and categorize content based on your preferences.
...
A retry policy for [`BigQueryWriteConnection`](/cpp/docs/reference/bigquery/2.37.0/classgoogle_1_1cloud_1_1bigquery__storage__v1_1_1BigQueryWriteConnection) based on elapsed time.
...
### BigQueryWriteLimitedTimeRetryPolicy(std::chrono::duration< DurationRep, DurationPeriod >)
...
### BigQueryWriteLimitedTimeRetryPolicy(BigQueryWriteLimitedTimeRetryPolicy &&)
...
### BigQueryWriteLimitedTimeRetryPolicy(BigQueryWriteLimitedTimeRetryPolicy const &)
...
`BigQueryWriteLimitedTimeRetryPolicy const &`  
...
`std::unique_ptr< BigQueryWriteRetryPolicy >`

## Type Aliases

### BaseType

**Alias Of**: `BigQueryWriteRetryPolicy`
