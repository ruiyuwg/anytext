...
# Google Analytics Data V1alpha Client - Class FunnelFilterExpressionList (0.19.0) Stay organized with collections Save and categorize content based on your preferences.
...
`array<[Google\Analytics\Data\V1alpha\FunnelFilterExpression](/php/docs/reference/analytics-data/0.19.0/V1alpha.FunnelFilterExpression)>`  
