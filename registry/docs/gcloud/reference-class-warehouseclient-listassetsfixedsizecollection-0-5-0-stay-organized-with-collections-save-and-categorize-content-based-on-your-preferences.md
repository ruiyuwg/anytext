...
# Class WarehouseClient.ListAssetsFixedSizeCollection (0.5.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class WarehouseClient.ListAssetsFixedSizeCollection extends AbstractFixedSizeCollection<ListAssetsRequest,ListAssetsResponse,Asset,WarehouseClient.ListAssetsPage,WarehouseClient.ListAssetsFixedSizeCollection>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractFixedSizeCollection](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractFixedSizeCollection.html) \> WarehouseClient.ListAssetsFixedSizeCollection
...
### createCollection(List<WarehouseClient.ListAssetsPage> pages, int collectionSize)

```
protected WarehouseClient.ListAssetsFixedSizeCollection createCollection(List<WarehouseClient.ListAssetsPage> pages, int collectionSize)
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ListAssetsPage](/java/docs/reference/google-cloud-visionai/0.5.0/com.google.cloud.visionai.v1.WarehouseClient.ListAssetsPage)>`  
...
`[WarehouseClient.ListAssetsFixedSizeCollection](/java/docs/reference/google-cloud-visionai/0.5.0/com.google.cloud.visionai.v1.WarehouseClient.ListAssetsFixedSizeCollection)`
