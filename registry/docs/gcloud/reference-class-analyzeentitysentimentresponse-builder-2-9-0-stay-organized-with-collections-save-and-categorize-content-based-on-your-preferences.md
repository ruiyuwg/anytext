...
# Class AnalyzeEntitySentimentResponse.Builder (2.9.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> AnalyzeEntitySentimentResponse.Builder

## Implements

[AnalyzeEntitySentimentResponseOrBuilder](/java/docs/reference/google-cloud-language/2.9.0/com.google.cloud.language.v1beta2.AnalyzeEntitySentimentResponseOrBuilder)
...
`[Iterable](https://docs.oracle.com/javase/8/docs/api/java/lang/Iterable.html)<? extends com.google.cloud.language.v1beta2.Entity>`  
...
[AnalyzeEntitySentimentResponse.Builder](/java/docs/reference/google-cloud-language/2.9.0/com.google.cloud.language.v1beta2.AnalyzeEntitySentimentResponse.Builder)
...
`[Entity](/java/docs/reference/google-cloud-language/2.9.0/com.google.cloud.language.v1beta2.Entity)`  
...
`[Entity.Builder](/java/docs/reference/google-cloud-language/2.9.0/com.google.cloud.language.v1beta2.Entity.Builder)`  
...
```
public AnalyzeEntitySentimentResponse.Builder addRepeatedField(Descriptors.FieldDescriptor field, Object value)
```
...
[AnalyzeEntitySentimentResponse](/java/docs/reference/google-cloud-language/2.9.0/com.google.cloud.language.v1beta2.AnalyzeEntitySentimentResponse)
...
```
public AnalyzeEntitySentimentResponse.Builder clearField(Descriptors.FieldDescriptor field)
```
...
```
public AnalyzeEntitySentimentResponse.Builder clearOneof(Descriptors.OneofDescriptor oneof)
```
...
```
public AnalyzeEntitySentimentResponse.Builder clone()
```
...
[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Builder](/java/docs/reference/google-cloud-language/2.9.0/com.google.cloud.language.v1beta2.Entity.Builder)\>
...
[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Entity](/java/docs/reference/google-cloud-language/2.9.0/com.google.cloud.language.v1beta2.Entity)\>
...
[EntityOrBuilder](/java/docs/reference/google-cloud-language/2.9.0/com.google.cloud.language.v1beta2.EntityOrBuilder)
...
[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.language.v1beta2.EntityOrBuilder\>
...
```
public AnalyzeEntitySentimentResponse.Builder setField(Descriptors.FieldDescriptor field, Object value)
```
...
```
public AnalyzeEntitySentimentResponse.Builder setRepeatedField(Descriptors.FieldDescriptor field, int index, Object value)
```
