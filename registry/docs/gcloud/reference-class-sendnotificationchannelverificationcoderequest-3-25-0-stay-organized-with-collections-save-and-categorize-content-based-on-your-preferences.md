...
# Class SendNotificationChannelVerificationCodeRequest (3.25.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class SendNotificationChannelVerificationCodeRequest extends GeneratedMessageV3 implements SendNotificationChannelVerificationCodeRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> SendNotificationChannelVerificationCodeRequest

## Implements

[SendNotificationChannelVerificationCodeRequestOrBuilder](/java/docs/reference/google-cloud-monitoring/3.25.0/com.google.monitoring.v3.SendNotificationChannelVerificationCodeRequestOrBuilder)
...
```
public static SendNotificationChannelVerificationCodeRequest getDefaultInstance()
```
...
`[SendNotificationChannelVerificationCodeRequest](/java/docs/reference/google-cloud-monitoring/3.25.0/com.google.monitoring.v3.SendNotificationChannelVerificationCodeRequest)`
...
```
public static SendNotificationChannelVerificationCodeRequest.Builder newBuilder()
```
...
`[SendNotificationChannelVerificationCodeRequest.Builder](/java/docs/reference/google-cloud-monitoring/3.25.0/com.google.monitoring.v3.SendNotificationChannelVerificationCodeRequest.Builder)`

### newBuilder(SendNotificationChannelVerificationCodeRequest prototype)

```
public static SendNotificationChannelVerificationCodeRequest.Builder newBuilder(SendNotificationChannelVerificationCodeRequest prototype)
```
...
```
public static SendNotificationChannelVerificationCodeRequest parseDelimitedFrom(InputStream input)
```
...
```
public static SendNotificationChannelVerificationCodeRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SendNotificationChannelVerificationCodeRequest parseFrom(byte[] data)
```
...
```
public static SendNotificationChannelVerificationCodeRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SendNotificationChannelVerificationCodeRequest parseFrom(ByteString data)
```
...
```
public static SendNotificationChannelVerificationCodeRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SendNotificationChannelVerificationCodeRequest parseFrom(CodedInputStream input)
```
...
```
public static SendNotificationChannelVerificationCodeRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SendNotificationChannelVerificationCodeRequest parseFrom(InputStream input)
```
...
```
public static SendNotificationChannelVerificationCodeRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SendNotificationChannelVerificationCodeRequest parseFrom(ByteBuffer data)
```
...
```
public static SendNotificationChannelVerificationCodeRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<SendNotificationChannelVerificationCodeRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[SendNotificationChannelVerificationCodeRequest](/java/docs/reference/google-cloud-monitoring/3.25.0/com.google.monitoring.v3.SendNotificationChannelVerificationCodeRequest)>`
...
```
public Parser<SendNotificationChannelVerificationCodeRequest> getParserForType()
```
...
```
public SendNotificationChannelVerificationCodeRequest.Builder newBuilderForType()
```
...
```
protected SendNotificationChannelVerificationCodeRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public SendNotificationChannelVerificationCodeRequest.Builder toBuilder()
```
