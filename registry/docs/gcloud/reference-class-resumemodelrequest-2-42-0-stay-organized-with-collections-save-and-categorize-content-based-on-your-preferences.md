...
# Class ResumeModelRequest (2.42.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ResumeModelRequest extends GeneratedMessageV3 implements ResumeModelRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ResumeModelRequest

## Implements

[ResumeModelRequestOrBuilder](/java/docs/reference/google-cloud-retail/2.42.0/com.google.cloud.retail.v2beta.ResumeModelRequestOrBuilder)
...
```
public static ResumeModelRequest getDefaultInstance()
```
...
`[ResumeModelRequest](/java/docs/reference/google-cloud-retail/2.42.0/com.google.cloud.retail.v2beta.ResumeModelRequest)`
...
```
public static ResumeModelRequest.Builder newBuilder()
```
...
`[ResumeModelRequest.Builder](/java/docs/reference/google-cloud-retail/2.42.0/com.google.cloud.retail.v2beta.ResumeModelRequest.Builder)`

### newBuilder(ResumeModelRequest prototype)

```
public static ResumeModelRequest.Builder newBuilder(ResumeModelRequest prototype)
```
...
```
public static ResumeModelRequest parseDelimitedFrom(InputStream input)
```
...
```
public static ResumeModelRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ResumeModelRequest parseFrom(byte[] data)
```
...
```
public static ResumeModelRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ResumeModelRequest parseFrom(ByteString data)
```
...
```
public static ResumeModelRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ResumeModelRequest parseFrom(CodedInputStream input)
```
...
```
public static ResumeModelRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ResumeModelRequest parseFrom(InputStream input)
```
...
```
public static ResumeModelRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ResumeModelRequest parseFrom(ByteBuffer data)
```
...
```
public static ResumeModelRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ResumeModelRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ResumeModelRequest](/java/docs/reference/google-cloud-retail/2.42.0/com.google.cloud.retail.v2beta.ResumeModelRequest)>`
...
```
public ResumeModelRequest getDefaultInstanceForType()
```
...
```
public Parser<ResumeModelRequest> getParserForType()
```
...
```
public ResumeModelRequest.Builder newBuilderForType()
```
...
```
protected ResumeModelRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ResumeModelRequest.Builder toBuilder()
```
