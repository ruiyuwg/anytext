...
# Class BatchUpdateJobsRequest.Builder (2.57.0) Stay organized with collections Save and categorize content based on your preferences.
...
[BatchUpdateJobsRequestOrBuilder](/java/docs/reference/google-cloud-talent/2.57.0/com.google.cloud.talent.v4beta1.BatchUpdateJobsRequestOrBuilder)
...
`[Iterable](https://docs.oracle.com/javase/8/docs/api/java/lang/Iterable.html)<? extends com.google.cloud.talent.v4beta1.Job>`  
...
`[BatchUpdateJobsRequest.Builder](/java/docs/reference/google-cloud-talent/2.57.0/com.google.cloud.talent.v4beta1.BatchUpdateJobsRequest.Builder)`
...
`[Job](/java/docs/reference/google-cloud-talent/2.57.0/com.google.cloud.talent.v4beta1.Job)`  
...
`[Job.Builder](/java/docs/reference/google-cloud-talent/2.57.0/com.google.cloud.talent.v4beta1.Job.Builder)`  
...
`[BatchUpdateJobsRequest](/java/docs/reference/google-cloud-talent/2.57.0/com.google.cloud.talent.v4beta1.BatchUpdateJobsRequest)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Builder](/java/docs/reference/google-cloud-talent/2.57.0/com.google.cloud.talent.v4beta1.Job.Builder)>`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Job](/java/docs/reference/google-cloud-talent/2.57.0/com.google.cloud.talent.v4beta1.Job)>`
...
`[JobOrBuilder](/java/docs/reference/google-cloud-talent/2.57.0/com.google.cloud.talent.v4beta1.JobOrBuilder)`
