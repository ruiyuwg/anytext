...
# Class CreateTimeSeriesSummary (3.8.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class CreateTimeSeriesSummary extends GeneratedMessageV3 implements CreateTimeSeriesSummaryOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> CreateTimeSeriesSummary

## Implements

[CreateTimeSeriesSummaryOrBuilder](/java/docs/reference/google-cloud-monitoring/3.8.0/com.google.monitoring.v3.CreateTimeSeriesSummaryOrBuilder)
...
### SUCCESS\_POINT\_COUNT\_FIELD\_NUMBER
...
### TOTAL\_POINT\_COUNT\_FIELD\_NUMBER

```
public static final int TOTAL_POINT_COUNT_FIELD_NUMBER
```
...
```
public static CreateTimeSeriesSummary getDefaultInstance()
```
...
[CreateTimeSeriesSummary](/java/docs/reference/google-cloud-monitoring/3.8.0/com.google.monitoring.v3.CreateTimeSeriesSummary)
...
```
public static CreateTimeSeriesSummary.Builder newBuilder()
```
...
[CreateTimeSeriesSummary.Builder](/java/docs/reference/google-cloud-monitoring/3.8.0/com.google.monitoring.v3.CreateTimeSeriesSummary.Builder)
...
```
public static CreateTimeSeriesSummary parseDelimitedFrom(InputStream input)
```
...
```
public static CreateTimeSeriesSummary parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateTimeSeriesSummary parseFrom(byte[] data)
```
...
```
public static CreateTimeSeriesSummary parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateTimeSeriesSummary parseFrom(ByteString data)
```
...
```
public static CreateTimeSeriesSummary parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateTimeSeriesSummary parseFrom(CodedInputStream input)
```
...
```
public static CreateTimeSeriesSummary parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateTimeSeriesSummary parseFrom(InputStream input)
```
...
```
public static CreateTimeSeriesSummary parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateTimeSeriesSummary parseFrom(ByteBuffer data)
```
...
```
public static CreateTimeSeriesSummary parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<CreateTimeSeriesSummary> parser()
```
...
[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[CreateTimeSeriesSummary](/java/docs/reference/google-cloud-monitoring/3.8.0/com.google.monitoring.v3.CreateTimeSeriesSummary)\>
...
```
public CreateTimeSeriesSummary getDefaultInstanceForType()
```
...
```
public CreateTimeSeriesSummary.Error getErrors(int index)
```
...
[CreateTimeSeriesSummary.Error](/java/docs/reference/google-cloud-monitoring/3.8.0/com.google.monitoring.v3.CreateTimeSeriesSummary.Error)
...
```
public List<CreateTimeSeriesSummary.Error> getErrorsList()
```
...
[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Error](/java/docs/reference/google-cloud-monitoring/3.8.0/com.google.monitoring.v3.CreateTimeSeriesSummary.Error)\>

### getErrorsOrBuilder(int index)

```
public CreateTimeSeriesSummary.ErrorOrBuilder getErrorsOrBuilder(int index)
```
...
[CreateTimeSeriesSummary.ErrorOrBuilder](/java/docs/reference/google-cloud-monitoring/3.8.0/com.google.monitoring.v3.CreateTimeSeriesSummary.ErrorOrBuilder)

### getErrorsOrBuilderList()

```
public List<? extends CreateTimeSeriesSummary.ErrorOrBuilder> getErrorsOrBuilderList()
```
...
[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.monitoring.v3.CreateTimeSeriesSummary.ErrorOrBuilder\>

### getParserForType()

```
public Parser<CreateTimeSeriesSummary> getParserForType()
```
...
```
public CreateTimeSeriesSummary.Builder newBuilderForType()
```
...
```
protected CreateTimeSeriesSummary.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
