...
# Enum PostureTemplate.State (0.12.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-securityposture/0.12.0/com.google.cloud.securityposture.v1.PostureTemplate.State#com_google_cloud_securityposture_v1_PostureTemplate_State_forNumber_int_) instead._
