...
# Interface NetworkInterfaceOrBuilder (1.46.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[NetworkInterface.NicType](/java/docs/reference/google-cloud-notebooks/1.46.0/com.google.cloud.notebooks.v2.NetworkInterface.NicType)`
