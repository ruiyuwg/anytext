...
# Class WorkloadsConfig.WorkerResource (1.13.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class WorkloadsConfig.WorkerResource extends GeneratedMessageV3 implements WorkloadsConfig.WorkerResourceOrBuilder
```

Configuration for resources used by Airflow workers.

Protobuf type `google.cloud.orchestration.airflow.service.v1.WorkloadsConfig.WorkerResource`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> WorkloadsConfig.WorkerResource

## Implements

[WorkloadsConfig.WorkerResourceOrBuilder](/java/docs/reference/google-cloud-orchestration-airflow/1.13.0/com.google.cloud.orchestration.airflow.service.v1.WorkloadsConfig.WorkerResourceOrBuilder)
...
```
public static WorkloadsConfig.WorkerResource getDefaultInstance()
```
...
`[WorkloadsConfig.WorkerResource](/java/docs/reference/google-cloud-orchestration-airflow/1.13.0/com.google.cloud.orchestration.airflow.service.v1.WorkloadsConfig.WorkerResource)`
...
```
public static WorkloadsConfig.WorkerResource.Builder newBuilder()
```
...
`[WorkloadsConfig.WorkerResource.Builder](/java/docs/reference/google-cloud-orchestration-airflow/1.13.0/com.google.cloud.orchestration.airflow.service.v1.WorkloadsConfig.WorkerResource.Builder)`

### newBuilder(WorkloadsConfig.WorkerResource prototype)

```
public static WorkloadsConfig.WorkerResource.Builder newBuilder(WorkloadsConfig.WorkerResource prototype)
```
...
```
public static WorkloadsConfig.WorkerResource parseDelimitedFrom(InputStream input)
```
...
```
public static WorkloadsConfig.WorkerResource parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static WorkloadsConfig.WorkerResource parseFrom(byte[] data)
```
...
```
public static WorkloadsConfig.WorkerResource parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static WorkloadsConfig.WorkerResource parseFrom(ByteString data)
```
...
```
public static WorkloadsConfig.WorkerResource parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static WorkloadsConfig.WorkerResource parseFrom(CodedInputStream input)
```
...
```
public static WorkloadsConfig.WorkerResource parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static WorkloadsConfig.WorkerResource parseFrom(InputStream input)
```
...
```
public static WorkloadsConfig.WorkerResource parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static WorkloadsConfig.WorkerResource parseFrom(ByteBuffer data)
```
...
```
public static WorkloadsConfig.WorkerResource parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<WorkloadsConfig.WorkerResource> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[WorkerResource](/java/docs/reference/google-cloud-orchestration-airflow/1.13.0/com.google.cloud.orchestration.airflow.service.v1.WorkloadsConfig.WorkerResource)>`
...
```
public Parser<WorkloadsConfig.WorkerResource> getParserForType()
```
...
```
public WorkloadsConfig.WorkerResource.Builder newBuilderForType()
```
...
```
protected WorkloadsConfig.WorkerResource.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public WorkloadsConfig.WorkerResource.Builder toBuilder()
```
