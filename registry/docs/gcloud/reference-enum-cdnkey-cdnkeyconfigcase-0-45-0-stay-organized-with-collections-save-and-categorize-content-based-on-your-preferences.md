...
# Enum CdnKey.CdnKeyConfigCase (0.45.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum CdnKey.CdnKeyConfigCase extends Enum<CdnKey.CdnKeyConfigCase> implements Internal.EnumLite, AbstractMessageLite.InternalOneOfEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-video-stitcher/0.45.0/com.google.cloud.video.stitcher.v1.CdnKey.CdnKeyConfigCase#com_google_cloud_video_stitcher_v1_CdnKey_CdnKeyConfigCase_forNumber_int_) instead._
