...
# Class OutputConfig (1.29.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> OutputConfig

## Implements

[OutputConfigOrBuilder](/java/docs/reference/google-cloud-optimization/1.29.0/com.google.cloud.optimization.v1.OutputConfigOrBuilder)
...
### GCS\_DESTINATION\_FIELD\_NUMBER
...
`[OutputConfig](/java/docs/reference/google-cloud-optimization/1.29.0/com.google.cloud.optimization.v1.OutputConfig)`
...
`[OutputConfig.Builder](/java/docs/reference/google-cloud-optimization/1.29.0/com.google.cloud.optimization.v1.OutputConfig.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[OutputConfig](/java/docs/reference/google-cloud-optimization/1.29.0/com.google.cloud.optimization.v1.OutputConfig)>`
...
`[DataFormat](/java/docs/reference/google-cloud-optimization/1.29.0/com.google.cloud.optimization.v1.DataFormat)`
...
`[OutputConfig.DestinationCase](/java/docs/reference/google-cloud-optimization/1.29.0/com.google.cloud.optimization.v1.OutputConfig.DestinationCase)`
...
`[GcsDestination](/java/docs/reference/google-cloud-optimization/1.29.0/com.google.cloud.optimization.v1.GcsDestination)`
...
`[GcsDestinationOrBuilder](/java/docs/reference/google-cloud-optimization/1.29.0/com.google.cloud.optimization.v1.GcsDestinationOrBuilder)`
