...
# Class CreateDeploymentRequest (0.7.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> CreateDeploymentRequest

## Implements

[CreateDeploymentRequestOrBuilder](/java/docs/reference/google-cloud-infra-manager/0.7.0/com.google.cloud.config.v1.CreateDeploymentRequestOrBuilder)
...
`[CreateDeploymentRequest](/java/docs/reference/google-cloud-infra-manager/0.7.0/com.google.cloud.config.v1.CreateDeploymentRequest)`
...
`[CreateDeploymentRequest.Builder](/java/docs/reference/google-cloud-infra-manager/0.7.0/com.google.cloud.config.v1.CreateDeploymentRequest.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[CreateDeploymentRequest](/java/docs/reference/google-cloud-infra-manager/0.7.0/com.google.cloud.config.v1.CreateDeploymentRequest)>`
...
`[Deployment](/java/docs/reference/google-cloud-infra-manager/0.7.0/com.google.cloud.config.v1.Deployment)`
...
`[DeploymentOrBuilder](/java/docs/reference/google-cloud-infra-manager/0.7.0/com.google.cloud.config.v1.DeploymentOrBuilder)`
...
Required. The parent in whose context the Deployment is created. The parent value is in the format: 'projects/{project\_id}/locations/{location}'.
