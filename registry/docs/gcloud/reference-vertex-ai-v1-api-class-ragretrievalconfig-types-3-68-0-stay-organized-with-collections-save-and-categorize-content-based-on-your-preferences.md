...
# Vertex AI v1 API - Class RagRetrievalConfig.Types (3.68.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class RagRetrievalConfig.Types
```

Reference documentation and code samples for the Vertex AI v1 API class RagRetrievalConfig.Types.

Container for nested types declared in the RagRetrievalConfig message type.

## Inheritance

[object](https://learn.microsoft.com/dotnet/api/system.object) \> RagRetrievalConfig.Types
