...
# Enum CVSS.Authentication (2.34.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum CVSS.Authentication extends Enum<CVSS.Authentication> implements ProtocolMessageEnum
```
...
`AUTHENTICATION_UNSPECIFIED_VALUE`
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/grafeas/2.34.0/io.grafeas.v1.CVSS.Authentication#io_grafeas_v1_CVSS_Authentication_forNumber_int_) instead._
