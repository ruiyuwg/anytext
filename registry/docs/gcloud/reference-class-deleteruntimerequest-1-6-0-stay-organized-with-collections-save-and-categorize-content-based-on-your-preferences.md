...
# Class DeleteRuntimeRequest (1.6.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class DeleteRuntimeRequest extends GeneratedMessageV3 implements DeleteRuntimeRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> DeleteRuntimeRequest

## Implements

[DeleteRuntimeRequestOrBuilder](/java/docs/reference/google-cloud-notebooks/1.6.0/com.google.cloud.notebooks.v1.DeleteRuntimeRequestOrBuilder)
...
```
public static DeleteRuntimeRequest getDefaultInstance()
```
...
[DeleteRuntimeRequest](/java/docs/reference/google-cloud-notebooks/1.6.0/com.google.cloud.notebooks.v1.DeleteRuntimeRequest)
...
```
public static DeleteRuntimeRequest.Builder newBuilder()
```
...
[DeleteRuntimeRequest.Builder](/java/docs/reference/google-cloud-notebooks/1.6.0/com.google.cloud.notebooks.v1.DeleteRuntimeRequest.Builder)

### newBuilder(DeleteRuntimeRequest prototype)

```
public static DeleteRuntimeRequest.Builder newBuilder(DeleteRuntimeRequest prototype)
```
...
```
public static DeleteRuntimeRequest parseDelimitedFrom(InputStream input)
```
...
```
public static DeleteRuntimeRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteRuntimeRequest parseFrom(byte[] data)
```
...
```
public static DeleteRuntimeRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteRuntimeRequest parseFrom(ByteString data)
```
...
```
public static DeleteRuntimeRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteRuntimeRequest parseFrom(CodedInputStream input)
```
...
```
public static DeleteRuntimeRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteRuntimeRequest parseFrom(InputStream input)
```
...
```
public static DeleteRuntimeRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteRuntimeRequest parseFrom(ByteBuffer data)
```
...
```
public static DeleteRuntimeRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<DeleteRuntimeRequest> parser()
```
...
[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[DeleteRuntimeRequest](/java/docs/reference/google-cloud-notebooks/1.6.0/com.google.cloud.notebooks.v1.DeleteRuntimeRequest)\>
...
```
public Parser<DeleteRuntimeRequest> getParserForType()
```
...
```
public DeleteRuntimeRequest.Builder newBuilderForType()
```
...
```
protected DeleteRuntimeRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public DeleteRuntimeRequest.Builder toBuilder()
```
