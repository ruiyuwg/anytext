...
# Interface RefreshRuntimeTokenInternalRequestOrBuilder (1.2.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface RefreshRuntimeTokenInternalRequestOrBuilder extends MessageOrBuilder
```
