...
# Class ModelServiceClient.ListModelsFixedSizeCollection (2.45.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class ModelServiceClient.ListModelsFixedSizeCollection extends AbstractFixedSizeCollection<ListModelsRequest,ListModelsResponse,Model,ModelServiceClient.ListModelsPage,ModelServiceClient.ListModelsFixedSizeCollection>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractFixedSizeCollection](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractFixedSizeCollection.html) \> ModelServiceClient.ListModelsFixedSizeCollection
...
### createCollection(List<ModelServiceClient.ListModelsPage> pages, int collectionSize)

```
protected ModelServiceClient.ListModelsFixedSizeCollection createCollection(List<ModelServiceClient.ListModelsPage> pages, int collectionSize)
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ListModelsPage](/java/docs/reference/google-cloud-retail/2.45.0/com.google.cloud.retail.v2.ModelServiceClient.ListModelsPage)>`  
...
`[ModelServiceClient.ListModelsFixedSizeCollection](/java/docs/reference/google-cloud-retail/2.45.0/com.google.cloud.retail.v2.ModelServiceClient.ListModelsFixedSizeCollection)`
