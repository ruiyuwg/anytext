...
# Class CreateImportJobRequest (2.9.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class CreateImportJobRequest extends GeneratedMessageV3 implements CreateImportJobRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> CreateImportJobRequest

## Implements

[CreateImportJobRequestOrBuilder](/java/docs/reference/google-cloud-kms/2.9.0/com.google.cloud.kms.v1.CreateImportJobRequestOrBuilder)
...
### IMPORT\_JOB\_ID\_FIELD\_NUMBER

```
public static final int IMPORT_JOB_ID_FIELD_NUMBER
```
...
```
public static CreateImportJobRequest getDefaultInstance()
```
...
[CreateImportJobRequest](/java/docs/reference/google-cloud-kms/2.9.0/com.google.cloud.kms.v1.CreateImportJobRequest)
...
```
public static CreateImportJobRequest.Builder newBuilder()
```
...
[CreateImportJobRequest.Builder](/java/docs/reference/google-cloud-kms/2.9.0/com.google.cloud.kms.v1.CreateImportJobRequest.Builder)

### newBuilder(CreateImportJobRequest prototype)

```
public static CreateImportJobRequest.Builder newBuilder(CreateImportJobRequest prototype)
```
...
```
public static CreateImportJobRequest parseDelimitedFrom(InputStream input)
```
...
```
public static CreateImportJobRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateImportJobRequest parseFrom(byte[] data)
```
...
```
public static CreateImportJobRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateImportJobRequest parseFrom(ByteString data)
```
...
```
public static CreateImportJobRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateImportJobRequest parseFrom(CodedInputStream input)
```
...
```
public static CreateImportJobRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateImportJobRequest parseFrom(InputStream input)
```
...
```
public static CreateImportJobRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateImportJobRequest parseFrom(ByteBuffer data)
```
...
```
public static CreateImportJobRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<CreateImportJobRequest> parser()
```
...
[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[CreateImportJobRequest](/java/docs/reference/google-cloud-kms/2.9.0/com.google.cloud.kms.v1.CreateImportJobRequest)\>
...
[ImportJob](/java/docs/reference/google-cloud-kms/2.9.0/com.google.cloud.kms.v1.ImportJob)
...
[ImportJobOrBuilder](/java/docs/reference/google-cloud-kms/2.9.0/com.google.cloud.kms.v1.ImportJobOrBuilder)
...
```
public Parser<CreateImportJobRequest> getParserForType()
```
...
```
public CreateImportJobRequest.Builder newBuilderForType()
```
...
```
protected CreateImportJobRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public CreateImportJobRequest.Builder toBuilder()
```
