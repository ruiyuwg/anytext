...
# Class AuthorizationPolicy (0.42.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> AuthorizationPolicy

## Implements

[AuthorizationPolicyOrBuilder](/java/docs/reference/google-cloud-network-security/0.42.0/com.google.cloud.networksecurity.v1.AuthorizationPolicyOrBuilder)
...
`[AuthorizationPolicy](/java/docs/reference/google-cloud-network-security/0.42.0/com.google.cloud.networksecurity.v1.AuthorizationPolicy)`
...
```
public static AuthorizationPolicy.Builder newBuilder()
```
...
`[AuthorizationPolicy.Builder](/java/docs/reference/google-cloud-network-security/0.42.0/com.google.cloud.networksecurity.v1.AuthorizationPolicy.Builder)`

### newBuilder(AuthorizationPolicy prototype)

```
public static AuthorizationPolicy.Builder newBuilder(AuthorizationPolicy prototype)
```
...
```
public static AuthorizationPolicy parseDelimitedFrom(InputStream input)
```
...
```
public static AuthorizationPolicy parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AuthorizationPolicy parseFrom(byte[] data)
```
...
```
public static AuthorizationPolicy parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AuthorizationPolicy parseFrom(ByteString data)
```
...
```
public static AuthorizationPolicy parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AuthorizationPolicy parseFrom(CodedInputStream input)
```
...
```
public static AuthorizationPolicy parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AuthorizationPolicy parseFrom(InputStream input)
```
...
```
public static AuthorizationPolicy parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AuthorizationPolicy parseFrom(ByteBuffer data)
```
...
```
public static AuthorizationPolicy parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[AuthorizationPolicy](/java/docs/reference/google-cloud-network-security/0.42.0/com.google.cloud.networksecurity.v1.AuthorizationPolicy)>`
...
`[AuthorizationPolicy.Action](/java/docs/reference/google-cloud-network-security/0.42.0/com.google.cloud.networksecurity.v1.AuthorizationPolicy.Action)`
...
Use [#getLabelsMap()](/java/docs/reference/google-cloud-network-security/0.42.0/com.google.cloud.networksecurity.v1.AuthorizationPolicy#com_google_cloud_networksecurity_v1_AuthorizationPolicy_getLabelsMap__) instead.
...
`[AuthorizationPolicy.Rule](/java/docs/reference/google-cloud-network-security/0.42.0/com.google.cloud.networksecurity.v1.AuthorizationPolicy.Rule)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Rule](/java/docs/reference/google-cloud-network-security/0.42.0/com.google.cloud.networksecurity.v1.AuthorizationPolicy.Rule)>`
...
`[AuthorizationPolicy.RuleOrBuilder](/java/docs/reference/google-cloud-network-security/0.42.0/com.google.cloud.networksecurity.v1.AuthorizationPolicy.RuleOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.networksecurity.v1.AuthorizationPolicy.RuleOrBuilder>`
...
```
public AuthorizationPolicy.Builder newBuilderForType()
```
...
```
protected AuthorizationPolicy.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public AuthorizationPolicy.Builder toBuilder()
```
