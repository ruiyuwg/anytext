...
# Class AnnotateVideoProgress.Builder (2.14.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class AnnotateVideoProgress.Builder extends GeneratedMessageV3.Builder<AnnotateVideoProgress.Builder> implements AnnotateVideoProgressOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> AnnotateVideoProgress.Builder

## Implements

[AnnotateVideoProgressOrBuilder](/java/docs/reference/google-cloud-video-intelligence/2.14.0/com.google.cloud.videointelligence.v1.AnnotateVideoProgressOrBuilder)
...
`[Iterable](https://docs.oracle.com/javase/8/docs/api/java/lang/Iterable.html)<? extends com.google.cloud.videointelligence.v1.VideoAnnotationProgress>`  
...
`[AnnotateVideoProgress.Builder](/java/docs/reference/google-cloud-video-intelligence/2.14.0/com.google.cloud.videointelligence.v1.AnnotateVideoProgress.Builder)`
...
`[VideoAnnotationProgress](/java/docs/reference/google-cloud-video-intelligence/2.14.0/com.google.cloud.videointelligence.v1.VideoAnnotationProgress)`  
...
`[VideoAnnotationProgress.Builder](/java/docs/reference/google-cloud-video-intelligence/2.14.0/com.google.cloud.videointelligence.v1.VideoAnnotationProgress.Builder)`  
...
```
public AnnotateVideoProgress.Builder addRepeatedField(Descriptors.FieldDescriptor field, Object value)
```
...
`[AnnotateVideoProgress](/java/docs/reference/google-cloud-video-intelligence/2.14.0/com.google.cloud.videointelligence.v1.AnnotateVideoProgress)`
...
```
public AnnotateVideoProgress.Builder clearField(Descriptors.FieldDescriptor field)
```
...
```
public AnnotateVideoProgress.Builder clearOneof(Descriptors.OneofDescriptor oneof)
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Builder](/java/docs/reference/google-cloud-video-intelligence/2.14.0/com.google.cloud.videointelligence.v1.VideoAnnotationProgress.Builder)>`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[VideoAnnotationProgress](/java/docs/reference/google-cloud-video-intelligence/2.14.0/com.google.cloud.videointelligence.v1.VideoAnnotationProgress)>`
...
`[VideoAnnotationProgressOrBuilder](/java/docs/reference/google-cloud-video-intelligence/2.14.0/com.google.cloud.videointelligence.v1.VideoAnnotationProgressOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.videointelligence.v1.VideoAnnotationProgressOrBuilder>`
...
```
public final AnnotateVideoProgress.Builder mergeUnknownFields(UnknownFieldSet unknownFields)
```
...
```
public AnnotateVideoProgress.Builder setField(Descriptors.FieldDescriptor field, Object value)
```
...
```
public AnnotateVideoProgress.Builder setRepeatedField(Descriptors.FieldDescriptor field, int index, Object value)
```
...
```
public final AnnotateVideoProgress.Builder setUnknownFields(UnknownFieldSet unknownFields)
```
