...
# Interface LocalDiskInitializeParamsOrBuilder (1.19.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[LocalDiskInitializeParams.DiskType](/java/docs/reference/google-cloud-notebooks/1.19.0/com.google.cloud.notebooks.v1.LocalDiskInitializeParams.DiskType)`
...
Use [#getLabelsMap()](/java/docs/reference/google-cloud-notebooks/1.19.0/com.google.cloud.notebooks.v1.LocalDiskInitializeParamsOrBuilder#com_google_cloud_notebooks_v1_LocalDiskInitializeParamsOrBuilder_getLabelsMap__) instead.
