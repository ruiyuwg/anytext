...
# Class HttpJsonAccountLabelsServiceCallableFactory (0.7.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public class HttpJsonAccountLabelsServiceCallableFactory implements HttpJsonStubCallableFactory<Operation,OperationsStub>
```
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> HttpJsonAccountLabelsServiceCallableFactory
...
### HttpJsonAccountLabelsServiceCallableFactory()

```
public HttpJsonAccountLabelsServiceCallableFactory()
```
