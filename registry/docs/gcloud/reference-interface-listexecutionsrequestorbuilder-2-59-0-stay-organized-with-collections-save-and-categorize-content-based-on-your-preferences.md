...
# Interface ListExecutionsRequestOrBuilder (2.59.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[ExecutionView](/java/docs/reference/google-cloud-workflow-executions/2.59.0/com.google.cloud.workflows.executions.v1beta.ExecutionView)`
