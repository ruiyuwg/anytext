...
# Class ListDeploymentsResponse.Builder (2.45.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> ListDeploymentsResponse.Builder

## Implements

[ListDeploymentsResponseOrBuilder](/java/docs/reference/google-cloud-gsuite-addons/2.45.0/com.google.cloud.gsuiteaddons.v1.ListDeploymentsResponseOrBuilder)
...
`[Iterable](https://docs.oracle.com/javase/8/docs/api/java/lang/Iterable.html)<? extends com.google.cloud.gsuiteaddons.v1.Deployment>`  
...
`[ListDeploymentsResponse.Builder](/java/docs/reference/google-cloud-gsuite-addons/2.45.0/com.google.cloud.gsuiteaddons.v1.ListDeploymentsResponse.Builder)`
...
`[Deployment](/java/docs/reference/google-cloud-gsuite-addons/2.45.0/com.google.cloud.gsuiteaddons.v1.Deployment)`  
...
`[Deployment.Builder](/java/docs/reference/google-cloud-gsuite-addons/2.45.0/com.google.cloud.gsuiteaddons.v1.Deployment.Builder)`  
...
`[ListDeploymentsResponse](/java/docs/reference/google-cloud-gsuite-addons/2.45.0/com.google.cloud.gsuiteaddons.v1.ListDeploymentsResponse)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Builder](/java/docs/reference/google-cloud-gsuite-addons/2.45.0/com.google.cloud.gsuiteaddons.v1.Deployment.Builder)>`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Deployment](/java/docs/reference/google-cloud-gsuite-addons/2.45.0/com.google.cloud.gsuiteaddons.v1.Deployment)>`
...
`[DeploymentOrBuilder](/java/docs/reference/google-cloud-gsuite-addons/2.45.0/com.google.cloud.gsuiteaddons.v1.DeploymentOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.gsuiteaddons.v1.DeploymentOrBuilder>`
