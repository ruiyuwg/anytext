...
# Class AllocateQuotaResponse (1.24.0) Stay organized with collections Save and categorize content based on your preferences.
...
[AllocateQuotaResponseOrBuilder](/java/docs/reference/google-cloud-service-control/1.24.0/com.google.api.servicecontrol.v1.AllocateQuotaResponseOrBuilder)
...
`[AllocateQuotaResponse](/java/docs/reference/google-cloud-service-control/1.24.0/com.google.api.servicecontrol.v1.AllocateQuotaResponse)`
...
`[AllocateQuotaResponse.Builder](/java/docs/reference/google-cloud-service-control/1.24.0/com.google.api.servicecontrol.v1.AllocateQuotaResponse.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[AllocateQuotaResponse](/java/docs/reference/google-cloud-service-control/1.24.0/com.google.api.servicecontrol.v1.AllocateQuotaResponse)>`
...
`[QuotaError](/java/docs/reference/google-cloud-service-control/1.24.0/com.google.api.servicecontrol.v1.QuotaError)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[QuotaError](/java/docs/reference/google-cloud-service-control/1.24.0/com.google.api.servicecontrol.v1.QuotaError)>`
...
`[QuotaErrorOrBuilder](/java/docs/reference/google-cloud-service-control/1.24.0/com.google.api.servicecontrol.v1.QuotaErrorOrBuilder)`
...
`[MetricValueSet](/java/docs/reference/google-cloud-service-control/1.24.0/com.google.api.servicecontrol.v1.MetricValueSet)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[MetricValueSet](/java/docs/reference/google-cloud-service-control/1.24.0/com.google.api.servicecontrol.v1.MetricValueSet)>`
...
`[MetricValueSetOrBuilder](/java/docs/reference/google-cloud-service-control/1.24.0/com.google.api.servicecontrol.v1.MetricValueSetOrBuilder)`
