...
# Class CollectionName (0.5.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> CollectionName
...
### format(String projectNumber, String location, String corpus, String collection)
...
`[CollectionName.Builder](/java/docs/reference/google-cloud-visionai/0.5.0/com.google.cloud.visionai.v1.CollectionName.Builder)`

### of(String projectNumber, String location, String corpus, String collection)
...
`[CollectionName](/java/docs/reference/google-cloud-visionai/0.5.0/com.google.cloud.visionai.v1.CollectionName)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[CollectionName](/java/docs/reference/google-cloud-visionai/0.5.0/com.google.cloud.visionai.v1.CollectionName)>`
