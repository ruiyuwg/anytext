...
# google-cloud-tasks overview (2.87.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Cloud Tasks Description:** A fully managed service that allows you to manage the execution, dispatch and delivery of a large number of distributed tasks. You can asynchronously perform work outside of a user request. Your tasks can be executed on App Engine or any arbitrary HTTP endpoint.

[Cloud Tasks Product Reference](https://cloud.google.com/tasks/docs/)

[GitHub Repository](https://github.com/googleapis/google-cloud-java/tree/main/java-tasks)

[Maven artifact](https://central.sonatype.com/artifact/com.google.cloud/google-cloud-tasks)
...
-   [Enable the API](https://console.cloud.google.com/apis/library/cloudtasks.googleapis.com)
-   [Set up authentication](https://cloud.google.com/docs/authentication/client-libraries)

## Use the Cloud Tasks for Java
...
The example below demonstrates how you would import the BOM and include the `google-cloud-tasks` artifact.
...
For this library, we recommend using [com.google.cloud.tasks.v2](https://cloud.google.com/java/docs/reference/google-cloud-tasks/2.87.0/com.google.cloud.tasks.v2) for new applications.
