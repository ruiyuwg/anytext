...
# Class IamCredentialsStubSettings.Builder (2.33.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class IamCredentialsStubSettings.Builder extends StubSettings.Builder<IamCredentialsStubSettings,IamCredentialsStubSettings.Builder>
```
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [StubSettings.Builder](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.StubSettings.Builder.html) \> IamCredentialsStubSettings.Builder
...
`[IamCredentialsStubSettings](/java/docs/reference/google-cloud-iamcredentials/2.33.0/com.google.cloud.iam.credentials.v1.stub.IamCredentialsStubSettings)`  
...
```
public IamCredentialsStubSettings.Builder applyToAllUnaryMethods(ApiFunction<UnaryCallSettings.Builder<?,?>,Void> settingsUpdater)
```
...
`[IamCredentialsStubSettings.Builder](/java/docs/reference/google-cloud-iamcredentials/2.33.0/com.google.cloud.iam.credentials.v1.stub.IamCredentialsStubSettings.Builder)`

### build()

```
public IamCredentialsStubSettings build()
```
...
`[Builder](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.Builder.html)<[GenerateAccessTokenRequest](/java/docs/reference/google-cloud-iamcredentials/2.33.0/com.google.cloud.iam.credentials.v1.GenerateAccessTokenRequest),[GenerateAccessTokenResponse](/java/docs/reference/google-cloud-iamcredentials/2.33.0/com.google.cloud.iam.credentials.v1.GenerateAccessTokenResponse)>`
...
`[Builder](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.Builder.html)<[GenerateIdTokenRequest](/java/docs/reference/google-cloud-iamcredentials/2.33.0/com.google.cloud.iam.credentials.v1.GenerateIdTokenRequest),[GenerateIdTokenResponse](/java/docs/reference/google-cloud-iamcredentials/2.33.0/com.google.cloud.iam.credentials.v1.GenerateIdTokenResponse)>`
...
`[Builder](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.Builder.html)<[SignBlobRequest](/java/docs/reference/google-cloud-iamcredentials/2.33.0/com.google.cloud.iam.credentials.v1.SignBlobRequest),[SignBlobResponse](/java/docs/reference/google-cloud-iamcredentials/2.33.0/com.google.cloud.iam.credentials.v1.SignBlobResponse)>`
...
`[Builder](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.Builder.html)<[SignJwtRequest](/java/docs/reference/google-cloud-iamcredentials/2.33.0/com.google.cloud.iam.credentials.v1.SignJwtRequest),[SignJwtResponse](/java/docs/reference/google-cloud-iamcredentials/2.33.0/com.google.cloud.iam.credentials.v1.SignJwtResponse)>`
