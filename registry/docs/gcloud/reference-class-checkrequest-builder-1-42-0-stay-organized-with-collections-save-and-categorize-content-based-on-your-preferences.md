...
# Class CheckRequest.Builder (1.42.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> CheckRequest.Builder

## Implements

[CheckRequestOrBuilder](/java/docs/reference/google-cloud-service-control/1.42.0/com.google.api.servicecontrol.v2.CheckRequestOrBuilder)
...
`[Iterable](https://docs.oracle.com/javase/8/docs/api/java/lang/Iterable.html)<? extends com.google.api.servicecontrol.v2.ResourceInfo>`  
...
`[CheckRequest.Builder](/java/docs/reference/google-cloud-service-control/1.42.0/com.google.api.servicecontrol.v2.CheckRequest.Builder)`
...
`[ResourceInfo](/java/docs/reference/google-cloud-service-control/1.42.0/com.google.api.servicecontrol.v2.ResourceInfo)`  
...
`[ResourceInfo.Builder](/java/docs/reference/google-cloud-service-control/1.42.0/com.google.api.servicecontrol.v2.ResourceInfo.Builder)`  
...
`[CheckRequest](/java/docs/reference/google-cloud-service-control/1.42.0/com.google.api.servicecontrol.v2.CheckRequest)`
...
See [google.api.Service](https://cloud.google.com/service-management/reference/rpc/google.api#google.api.Service) for the definition of a service name.
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Builder](/java/docs/reference/google-cloud-service-control/1.42.0/com.google.api.servicecontrol.v2.ResourceInfo.Builder)>`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ResourceInfo](/java/docs/reference/google-cloud-service-control/1.42.0/com.google.api.servicecontrol.v2.ResourceInfo)>`
...
`[ResourceInfoOrBuilder](/java/docs/reference/google-cloud-service-control/1.42.0/com.google.api.servicecontrol.v2.ResourceInfoOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.api.servicecontrol.v2.ResourceInfoOrBuilder>`
