...
# Class GrpcPrivilegedAccessManagerCallableFactory (0.9.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public class GrpcPrivilegedAccessManagerCallableFactory implements GrpcStubCallableFactory
```

gRPC callable factory implementation for the PrivilegedAccessManager service API.

This class is for advanced usage.

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> GrpcPrivilegedAccessManagerCallableFactory
...
### GrpcPrivilegedAccessManagerCallableFactory()

```
public GrpcPrivilegedAccessManagerCallableFactory()
```
