...
# Interface CreateInstanceRequestOrBuilder (1.85.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[Instance](/java/docs/reference/google-cloud-notebooks/latest/com.google.cloud.notebooks.v1.Instance)`
...
`[InstanceOrBuilder](/java/docs/reference/google-cloud-notebooks/latest/com.google.cloud.notebooks.v1.InstanceOrBuilder)`
