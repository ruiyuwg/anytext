...
# Interface CertificateConfigOrBuilder (2.44.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[PublicKey](/java/docs/reference/google-cloud-security-private-ca/2.44.0/com.google.cloud.security.privateca.v1.PublicKey)`
...
`[PublicKeyOrBuilder](/java/docs/reference/google-cloud-security-private-ca/2.44.0/com.google.cloud.security.privateca.v1.PublicKeyOrBuilder)`
...
`[CertificateConfig.SubjectConfig](/java/docs/reference/google-cloud-security-private-ca/2.44.0/com.google.cloud.security.privateca.v1.CertificateConfig.SubjectConfig)`
...
`[CertificateConfig.SubjectConfigOrBuilder](/java/docs/reference/google-cloud-security-private-ca/2.44.0/com.google.cloud.security.privateca.v1.CertificateConfig.SubjectConfigOrBuilder)`

### getSubjectKeyId()

```
public abstract CertificateConfig.KeyId getSubjectKeyId()
```
...
`[CertificateConfig.KeyId](/java/docs/reference/google-cloud-security-private-ca/2.44.0/com.google.cloud.security.privateca.v1.CertificateConfig.KeyId)`
...
```
public abstract CertificateConfig.KeyIdOrBuilder getSubjectKeyIdOrBuilder()
```
...
`[CertificateConfig.KeyIdOrBuilder](/java/docs/reference/google-cloud-security-private-ca/2.44.0/com.google.cloud.security.privateca.v1.CertificateConfig.KeyIdOrBuilder)`
...
`[X509Parameters](/java/docs/reference/google-cloud-security-private-ca/2.44.0/com.google.cloud.security.privateca.v1.X509Parameters)`
...
`[X509ParametersOrBuilder](/java/docs/reference/google-cloud-security-private-ca/2.44.0/com.google.cloud.security.privateca.v1.X509ParametersOrBuilder)`
