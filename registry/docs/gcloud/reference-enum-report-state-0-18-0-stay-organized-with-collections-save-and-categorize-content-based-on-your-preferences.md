...
# Enum Report.State (0.18.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum Report.State extends Enum<Report.State> implements ProtocolMessageEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-migrationcenter/0.18.0/com.google.cloud.migrationcenter.v1.Report.State#com_google_cloud_migrationcenter_v1_Report_State_forNumber_int_) instead._
