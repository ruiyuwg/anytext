...
# Class CloudRedisClusterSettings (0.19.0) Stay organized with collections Save and categorize content based on your preferences.
...
Settings class to configure an instance of [CloudRedisClusterClient](/java/docs/reference/google-cloud-redis-cluster/0.19.0/com.google.cloud.redis.cluster.v1beta1.CloudRedisClusterClient).
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [ClientSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.ClientSettings.html) \> CloudRedisClusterSettings
...
### create(CloudRedisClusterStubSettings stub)
...
`[CloudRedisClusterStubSettings](/java/docs/reference/google-cloud-redis-cluster/0.19.0/com.google.cloud.redis.cluster.v1.stub.CloudRedisClusterStubSettings)`  
...
`[CloudRedisClusterSettings](/java/docs/reference/google-cloud-redis-cluster/0.19.0/com.google.cloud.redis.cluster.v1.CloudRedisClusterSettings)`
...
```
public static CloudRedisClusterSettings.Builder newBuilder()
```
...
`[CloudRedisClusterSettings.Builder](/java/docs/reference/google-cloud-redis-cluster/0.19.0/com.google.cloud.redis.cluster.v1.CloudRedisClusterSettings.Builder)`

### newBuilder(ClientContext clientContext)

```
public static CloudRedisClusterSettings.Builder newBuilder(ClientContext clientContext)
```
...
```
public static CloudRedisClusterSettings.Builder newHttpJsonBuilder()
```
...
### CloudRedisClusterSettings(CloudRedisClusterSettings.Builder settingsBuilder)

```
protected CloudRedisClusterSettings(CloudRedisClusterSettings.Builder settingsBuilder)
```
...
`[OperationCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.OperationCallSettings.html)<[CreateClusterRequest](/java/docs/reference/google-cloud-redis-cluster/0.19.0/com.google.cloud.redis.cluster.v1.CreateClusterRequest),[Cluster](/java/docs/reference/google-cloud-redis-cluster/0.19.0/com.google.cloud.redis.cluster.v1.Cluster),[Any](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Any.html)>`
...
`[UnaryCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.html)<[CreateClusterRequest](/java/docs/reference/google-cloud-redis-cluster/0.19.0/com.google.cloud.redis.cluster.v1.CreateClusterRequest),[Operation](https://cloud.google.com/java/docs/reference/gax/latest/com.google.longrunning.Operation.html)>`
...
`[OperationCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.OperationCallSettings.html)<[DeleteClusterRequest](/java/docs/reference/google-cloud-redis-cluster/0.19.0/com.google.cloud.redis.cluster.v1.DeleteClusterRequest),[Empty](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Empty.html),[Any](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Any.html)>`
...
`[UnaryCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.html)<[DeleteClusterRequest](/java/docs/reference/google-cloud-redis-cluster/0.19.0/com.google.cloud.redis.cluster.v1.DeleteClusterRequest),[Operation](https://cloud.google.com/java/docs/reference/gax/latest/com.google.longrunning.Operation.html)>`
...
`[UnaryCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.html)<[GetClusterCertificateAuthorityRequest](/java/docs/reference/google-cloud-redis-cluster/0.19.0/com.google.cloud.redis.cluster.v1.GetClusterCertificateAuthorityRequest),[CertificateAuthority](/java/docs/reference/google-cloud-redis-cluster/0.19.0/com.google.cloud.redis.cluster.v1.CertificateAuthority)>`
...
`[UnaryCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.html)<[GetClusterRequest](/java/docs/reference/google-cloud-redis-cluster/0.19.0/com.google.cloud.redis.cluster.v1.GetClusterRequest),[Cluster](/java/docs/reference/google-cloud-redis-cluster/0.19.0/com.google.cloud.redis.cluster.v1.Cluster)>`
...
`[PagedCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PagedCallSettings.html)<[ListClustersRequest](/java/docs/reference/google-cloud-redis-cluster/0.19.0/com.google.cloud.redis.cluster.v1.ListClustersRequest),[ListClustersResponse](/java/docs/reference/google-cloud-redis-cluster/0.19.0/com.google.cloud.redis.cluster.v1.ListClustersResponse),[ListClustersPagedResponse](/java/docs/reference/google-cloud-redis-cluster/0.19.0/com.google.cloud.redis.cluster.v1.CloudRedisClusterClient.ListClustersPagedResponse)>`
...
`[PagedCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PagedCallSettings.html)<com.google.cloud.location.ListLocationsRequest,com.google.cloud.location.ListLocationsResponse,[ListLocationsPagedResponse](/java/docs/reference/google-cloud-redis-cluster/0.19.0/com.google.cloud.redis.cluster.v1.CloudRedisClusterClient.ListLocationsPagedResponse)>`

### toBuilder()

```
public CloudRedisClusterSettings.Builder toBuilder()
```
...
`[OperationCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.OperationCallSettings.html)<[UpdateClusterRequest](/java/docs/reference/google-cloud-redis-cluster/0.19.0/com.google.cloud.redis.cluster.v1.UpdateClusterRequest),[Cluster](/java/docs/reference/google-cloud-redis-cluster/0.19.0/com.google.cloud.redis.cluster.v1.Cluster),[Any](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Any.html)>`
...
`[UnaryCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.html)<[UpdateClusterRequest](/java/docs/reference/google-cloud-redis-cluster/0.19.0/com.google.cloud.redis.cluster.v1.UpdateClusterRequest),[Operation](https://cloud.google.com/java/docs/reference/gax/latest/com.google.longrunning.Operation.html)>`
