...
# Class ProductCatalogItem (0.40.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ProductCatalogItem

## Implements

[ProductCatalogItemOrBuilder](/java/docs/reference/google-cloud-recommendations-ai/0.40.0/com.google.cloud.recommendationengine.v1beta1.ProductCatalogItemOrBuilder)
...
### AVAILABLE\_QUANTITY\_FIELD\_NUMBER
...
### CANONICAL\_PRODUCT\_URI\_FIELD\_NUMBER
...
`[ProductCatalogItem](/java/docs/reference/google-cloud-recommendations-ai/0.40.0/com.google.cloud.recommendationengine.v1beta1.ProductCatalogItem)`
...
`[ProductCatalogItem.Builder](/java/docs/reference/google-cloud-recommendations-ai/0.40.0/com.google.cloud.recommendationengine.v1beta1.ProductCatalogItem.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ProductCatalogItem](/java/docs/reference/google-cloud-recommendations-ai/0.40.0/com.google.cloud.recommendationengine.v1beta1.ProductCatalogItem)>`
...
Use [#getCostsMap()](/java/docs/reference/google-cloud-recommendations-ai/0.40.0/com.google.cloud.recommendationengine.v1beta1.ProductCatalogItem#com_google_cloud_recommendationengine_v1beta1_ProductCatalogItem_getCostsMap__) instead.
...
`[Map](https://docs.oracle.com/javase/8/docs/api/java/util/Map.html)<[String](https://docs.oracle.com/javase/8/docs/api/java/lang/String.html),[Float](https://docs.oracle.com/javase/8/docs/api/java/lang/Float.html)>`
...
`[ProductCatalogItem.ExactPrice](/java/docs/reference/google-cloud-recommendations-ai/0.40.0/com.google.cloud.recommendationengine.v1beta1.ProductCatalogItem.ExactPrice)`
...
`[ProductCatalogItem.ExactPriceOrBuilder](/java/docs/reference/google-cloud-recommendations-ai/0.40.0/com.google.cloud.recommendationengine.v1beta1.ProductCatalogItem.ExactPriceOrBuilder)`
...
`[Image](/java/docs/reference/google-cloud-recommendations-ai/0.40.0/com.google.cloud.recommendationengine.v1beta1.Image)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Image](/java/docs/reference/google-cloud-recommendations-ai/0.40.0/com.google.cloud.recommendationengine.v1beta1.Image)>`
...
`[ImageOrBuilder](/java/docs/reference/google-cloud-recommendations-ai/0.40.0/com.google.cloud.recommendationengine.v1beta1.ImageOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.recommendationengine.v1beta1.ImageOrBuilder>`
...
`[ProductCatalogItem.PriceCase](/java/docs/reference/google-cloud-recommendations-ai/0.40.0/com.google.cloud.recommendationengine.v1beta1.ProductCatalogItem.PriceCase)`
...
`[ProductCatalogItem.PriceRange](/java/docs/reference/google-cloud-recommendations-ai/0.40.0/com.google.cloud.recommendationengine.v1beta1.ProductCatalogItem.PriceRange)`
...
`[ProductCatalogItem.PriceRangeOrBuilder](/java/docs/reference/google-cloud-recommendations-ai/0.40.0/com.google.cloud.recommendationengine.v1beta1.ProductCatalogItem.PriceRangeOrBuilder)`
...
`[ProductCatalogItem.StockState](/java/docs/reference/google-cloud-recommendations-ai/0.40.0/com.google.cloud.recommendationengine.v1beta1.ProductCatalogItem.StockState)`
