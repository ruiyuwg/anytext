...
# Interface LintPolicyRequestOrBuilder (3.12.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[LintPolicyRequest.LintObjectCase](/java/docs/reference/google-iam-admin/3.12.0/com.google.iam.admin.v1.LintPolicyRequest.LintObjectCase)`
