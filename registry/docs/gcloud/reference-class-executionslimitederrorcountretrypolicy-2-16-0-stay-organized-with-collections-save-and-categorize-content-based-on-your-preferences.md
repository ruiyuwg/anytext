...
# Class ExecutionsLimitedErrorCountRetryPolicy (2.16.0) Stay organized with collections Save and categorize content based on your preferences.
...
A retry policy for [`ExecutionsConnection`](/cpp/docs/reference/workflows/2.16.0/classgoogle_1_1cloud_1_1workflows__executions__v1_1_1ExecutionsConnection) based on counting errors.
...
### ExecutionsLimitedErrorCountRetryPolicy(int)
...
### ExecutionsLimitedErrorCountRetryPolicy(ExecutionsLimitedErrorCountRetryPolicy const &)
...
`ExecutionsLimitedErrorCountRetryPolicy const &`  
...
`std::unique_ptr< ExecutionsRetryPolicy >`

## Type Aliases

### BaseType

**Alias Of**: `ExecutionsRetryPolicy`
