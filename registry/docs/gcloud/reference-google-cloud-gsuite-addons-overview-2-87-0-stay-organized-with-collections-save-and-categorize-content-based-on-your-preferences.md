...
# google-cloud-gsuite-addons overview (2.87.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Google Workspace Add-ons API Product Reference](https://developers.google.com/workspace/add-ons/overview)

[GitHub Repository](https://github.com/googleapis/google-cloud-java/tree/main/java-gsuite-addons)

[Maven artifact](https://central.sonatype.com/artifact/com.google.cloud/google-cloud-gsuite-addons)
...
-   [Enable the API](https://console.cloud.google.com/apis/library/gsuiteaddons.googleapis.com)
...
The example below demonstrates how you would import the BOM and include the `google-cloud-gsuite-addons` artifact.
...
implementation("com.google.cloud:google-cloud-gsuite-addons")
...
libraryDependencies += "com.google.cloud" % "google-cloud-gsuite-addons" % "2.87.0"

## Which version ID should I get started with?

For this library, we recommend using [com.google.cloud.gsuiteaddons.v1](https://cloud.google.com/java/docs/reference/google-cloud-gsuite-addons/2.87.0/com.google.cloud.gsuiteaddons.v1) for new applications.
