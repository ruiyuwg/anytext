...
# Class GetCertificateAuthorityRequest (2.24.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class GetCertificateAuthorityRequest extends GeneratedMessageV3 implements GetCertificateAuthorityRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> GetCertificateAuthorityRequest

## Implements

[GetCertificateAuthorityRequestOrBuilder](/java/docs/reference/google-cloud-security-private-ca/2.24.0/com.google.cloud.security.privateca.v1beta1.GetCertificateAuthorityRequestOrBuilder)
...
```
public static GetCertificateAuthorityRequest getDefaultInstance()
```
...
`[GetCertificateAuthorityRequest](/java/docs/reference/google-cloud-security-private-ca/2.24.0/com.google.cloud.security.privateca.v1beta1.GetCertificateAuthorityRequest)`
...
```
public static GetCertificateAuthorityRequest.Builder newBuilder()
```
...
`[GetCertificateAuthorityRequest.Builder](/java/docs/reference/google-cloud-security-private-ca/2.24.0/com.google.cloud.security.privateca.v1beta1.GetCertificateAuthorityRequest.Builder)`

### newBuilder(GetCertificateAuthorityRequest prototype)

```
public static GetCertificateAuthorityRequest.Builder newBuilder(GetCertificateAuthorityRequest prototype)
```
...
```
public static GetCertificateAuthorityRequest parseDelimitedFrom(InputStream input)
```
...
```
public static GetCertificateAuthorityRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetCertificateAuthorityRequest parseFrom(byte[] data)
```
...
```
public static GetCertificateAuthorityRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetCertificateAuthorityRequest parseFrom(ByteString data)
```
...
```
public static GetCertificateAuthorityRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetCertificateAuthorityRequest parseFrom(CodedInputStream input)
```
...
```
public static GetCertificateAuthorityRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetCertificateAuthorityRequest parseFrom(InputStream input)
```
...
```
public static GetCertificateAuthorityRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetCertificateAuthorityRequest parseFrom(ByteBuffer data)
```
...
```
public static GetCertificateAuthorityRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<GetCertificateAuthorityRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[GetCertificateAuthorityRequest](/java/docs/reference/google-cloud-security-private-ca/2.24.0/com.google.cloud.security.privateca.v1beta1.GetCertificateAuthorityRequest)>`
...
```
public GetCertificateAuthorityRequest getDefaultInstanceForType()
```
...
```
public Parser<GetCertificateAuthorityRequest> getParserForType()
```
...
```
public GetCertificateAuthorityRequest.Builder newBuilderForType()
```
...
```
protected GetCertificateAuthorityRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public GetCertificateAuthorityRequest.Builder toBuilder()
```
