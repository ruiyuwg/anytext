...
# Class EntityAnnotation (3.13.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> EntityAnnotation

## Implements

[EntityAnnotationOrBuilder](/java/docs/reference/google-cloud-vision/3.13.0/com.google.cloud.vision.v1p3beta1.EntityAnnotationOrBuilder)
...
`[EntityAnnotation](/java/docs/reference/google-cloud-vision/3.13.0/com.google.cloud.vision.v1p3beta1.EntityAnnotation)`
...
`[EntityAnnotation.Builder](/java/docs/reference/google-cloud-vision/3.13.0/com.google.cloud.vision.v1p3beta1.EntityAnnotation.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[EntityAnnotation](/java/docs/reference/google-cloud-vision/3.13.0/com.google.cloud.vision.v1p3beta1.EntityAnnotation)>`
...
`[BoundingPoly](/java/docs/reference/google-cloud-vision/3.13.0/com.google.cloud.vision.v1p3beta1.BoundingPoly)`
...
`[BoundingPolyOrBuilder](/java/docs/reference/google-cloud-vision/3.13.0/com.google.cloud.vision.v1p3beta1.BoundingPolyOrBuilder)`
...
`[LocationInfo](/java/docs/reference/google-cloud-vision/3.13.0/com.google.cloud.vision.v1p3beta1.LocationInfo)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[LocationInfo](/java/docs/reference/google-cloud-vision/3.13.0/com.google.cloud.vision.v1p3beta1.LocationInfo)>`
...
`[LocationInfoOrBuilder](/java/docs/reference/google-cloud-vision/3.13.0/com.google.cloud.vision.v1p3beta1.LocationInfoOrBuilder)`
...
`[Property](/java/docs/reference/google-cloud-vision/3.13.0/com.google.cloud.vision.v1p3beta1.Property)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Property](/java/docs/reference/google-cloud-vision/3.13.0/com.google.cloud.vision.v1p3beta1.Property)>`
...
`[PropertyOrBuilder](/java/docs/reference/google-cloud-vision/3.13.0/com.google.cloud.vision.v1p3beta1.PropertyOrBuilder)`
