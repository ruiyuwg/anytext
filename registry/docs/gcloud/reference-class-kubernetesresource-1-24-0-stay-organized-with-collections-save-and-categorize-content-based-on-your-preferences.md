...
# Class KubernetesResource (1.24.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> KubernetesResource

## Implements

[KubernetesResourceOrBuilder](/java/docs/reference/google-cloud-gkehub/1.24.0/com.google.cloud.gkehub.v1.KubernetesResourceOrBuilder)
...
### CONNECT\_RESOURCES\_FIELD\_NUMBER
...
### MEMBERSHIP\_CR\_MANIFEST\_FIELD\_NUMBER
...
### MEMBERSHIP\_RESOURCES\_FIELD\_NUMBER
...
### RESOURCE\_OPTIONS\_FIELD\_NUMBER
...
`[KubernetesResource](/java/docs/reference/google-cloud-gkehub/1.24.0/com.google.cloud.gkehub.v1.KubernetesResource)`
...
`[KubernetesResource.Builder](/java/docs/reference/google-cloud-gkehub/1.24.0/com.google.cloud.gkehub.v1.KubernetesResource.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[KubernetesResource](/java/docs/reference/google-cloud-gkehub/1.24.0/com.google.cloud.gkehub.v1.KubernetesResource)>`
...
`[ResourceManifest](/java/docs/reference/google-cloud-gkehub/1.24.0/com.google.cloud.gkehub.v1.ResourceManifest)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ResourceManifest](/java/docs/reference/google-cloud-gkehub/1.24.0/com.google.cloud.gkehub.v1.ResourceManifest)>`
...
`[ResourceManifestOrBuilder](/java/docs/reference/google-cloud-gkehub/1.24.0/com.google.cloud.gkehub.v1.ResourceManifestOrBuilder)`
...
`[ResourceOptions](/java/docs/reference/google-cloud-gkehub/1.24.0/com.google.cloud.gkehub.v1.ResourceOptions)`
...
`[ResourceOptionsOrBuilder](/java/docs/reference/google-cloud-gkehub/1.24.0/com.google.cloud.gkehub.v1.ResourceOptionsOrBuilder)`
