...
# Google Cloud Ai Platform V1 Client - Class MergeVersionAliasesRequest (0.19.0) Stay organized with collections Save and categorize content based on your preferences.
...
Request message for [ModelService.MergeVersionAliases](/php/docs/reference/cloud-ai-platform/0.19.0/V1.ModelServiceClient#_Google_Cloud_AIPlatform_V1_ModelServiceClient__mergeVersionAliases__).
...
Example: `projects/{project}/locations/{location}/models/{model}@1234` Please see [Google\\Cloud\\AIPlatform\\V1\\ModelServiceClient::modelName()](/php/docs/reference/cloud-ai-platform/0.19.0/V1.ModelServiceClient#_Google_Cloud_AIPlatform_V1_ModelServiceClient__modelName__) for help formatting this field.
...
`[Google\Cloud\AIPlatform\V1\MergeVersionAliasesRequest](/php/docs/reference/cloud-ai-platform/0.19.0/V1.MergeVersionAliasesRequest)`
