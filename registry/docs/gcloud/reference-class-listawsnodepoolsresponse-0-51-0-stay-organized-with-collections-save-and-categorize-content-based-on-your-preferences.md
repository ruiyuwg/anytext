...
# Class ListAwsNodePoolsResponse (0.51.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListAwsNodePoolsResponse

## Implements

[ListAwsNodePoolsResponseOrBuilder](/java/docs/reference/google-cloud-gke-multi-cloud/0.51.0/com.google.cloud.gkemulticloud.v1.ListAwsNodePoolsResponseOrBuilder)
...
### AWS\_NODE\_POOLS\_FIELD\_NUMBER
...
`[ListAwsNodePoolsResponse](/java/docs/reference/google-cloud-gke-multi-cloud/0.51.0/com.google.cloud.gkemulticloud.v1.ListAwsNodePoolsResponse)`
...
`[ListAwsNodePoolsResponse.Builder](/java/docs/reference/google-cloud-gke-multi-cloud/0.51.0/com.google.cloud.gkemulticloud.v1.ListAwsNodePoolsResponse.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListAwsNodePoolsResponse](/java/docs/reference/google-cloud-gke-multi-cloud/0.51.0/com.google.cloud.gkemulticloud.v1.ListAwsNodePoolsResponse)>`
...
`[AwsNodePool](/java/docs/reference/google-cloud-gke-multi-cloud/0.51.0/com.google.cloud.gkemulticloud.v1.AwsNodePool)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[AwsNodePool](/java/docs/reference/google-cloud-gke-multi-cloud/0.51.0/com.google.cloud.gkemulticloud.v1.AwsNodePool)>`
...
`[AwsNodePoolOrBuilder](/java/docs/reference/google-cloud-gke-multi-cloud/0.51.0/com.google.cloud.gkemulticloud.v1.AwsNodePoolOrBuilder)`
