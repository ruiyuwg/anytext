...
# Enum ImportErrorsConfig.DestinationCase (2.26.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-retail/2.26.0/com.google.cloud.retail.v2beta.ImportErrorsConfig.DestinationCase#com_google_cloud_retail_v2beta_ImportErrorsConfig_DestinationCase_forNumber_int_) instead._
