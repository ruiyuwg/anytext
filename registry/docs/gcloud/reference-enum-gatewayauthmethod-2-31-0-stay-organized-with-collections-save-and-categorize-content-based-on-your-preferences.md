...
# Enum GatewayAuthMethod (2.31.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-iot/2.31.0/com.google.cloud.iot.v1.GatewayAuthMethod#com_google_cloud_iot_v1_GatewayAuthMethod_forNumber_int_) instead._
