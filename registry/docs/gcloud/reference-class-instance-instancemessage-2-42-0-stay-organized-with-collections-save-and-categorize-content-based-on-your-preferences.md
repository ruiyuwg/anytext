...
# Class Instance.InstanceMessage (2.42.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Instance.InstanceMessageOrBuilder](/java/docs/reference/google-cloud-memcache/2.42.0/com.google.cloud.memcache.v1beta2.Instance.InstanceMessageOrBuilder)
...
`[Instance.InstanceMessage](/java/docs/reference/google-cloud-memcache/2.42.0/com.google.cloud.memcache.v1beta2.Instance.InstanceMessage)`
...
`[Instance.InstanceMessage.Builder](/java/docs/reference/google-cloud-memcache/2.42.0/com.google.cloud.memcache.v1beta2.Instance.InstanceMessage.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[InstanceMessage](/java/docs/reference/google-cloud-memcache/2.42.0/com.google.cloud.memcache.v1beta2.Instance.InstanceMessage)>`
...
`[Instance.InstanceMessage.Code](/java/docs/reference/google-cloud-memcache/2.42.0/com.google.cloud.memcache.v1beta2.Instance.InstanceMessage.Code)`
