...
# Class NetworkSecurityClient.ListAuthorizationPoliciesPagedResponse (0.47.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[PageContext](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PageContext.html)<[ListAuthorizationPoliciesRequest](/java/docs/reference/google-cloud-network-security/0.47.0/com.google.cloud.networksecurity.v1.ListAuthorizationPoliciesRequest),[ListAuthorizationPoliciesResponse](/java/docs/reference/google-cloud-network-security/0.47.0/com.google.cloud.networksecurity.v1.ListAuthorizationPoliciesResponse),[AuthorizationPolicy](/java/docs/reference/google-cloud-network-security/0.47.0/com.google.cloud.networksecurity.v1.AuthorizationPolicy)>`  

`futureResponse`

`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListAuthorizationPoliciesResponse](/java/docs/reference/google-cloud-network-security/0.47.0/com.google.cloud.networksecurity.v1.ListAuthorizationPoliciesResponse)>`  
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListAuthorizationPoliciesPagedResponse](/java/docs/reference/google-cloud-network-security/0.47.0/com.google.cloud.networksecurity.v1.NetworkSecurityClient.ListAuthorizationPoliciesPagedResponse)>`
