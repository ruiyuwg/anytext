...
# Enum PresetTopology (1.86.0) Stay organized with collections Save and categorize content based on your preferences.
...
Preset topology is unspecified. When policy\_mode = PRESET, it defaults to MESH.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-networkconnectivity/latest/com.google.cloud.networkconnectivity.v1.PresetTopology#com_google_cloud_networkconnectivity_v1_PresetTopology_forNumber_int_) instead._
