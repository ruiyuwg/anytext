...
# Class TelcoAutomationClient.SearchBlueprintRevisionsFixedSizeCollection (0.9.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class TelcoAutomationClient.SearchBlueprintRevisionsFixedSizeCollection extends AbstractFixedSizeCollection<SearchBlueprintRevisionsRequest,SearchBlueprintRevisionsResponse,Blueprint,TelcoAutomationClient.SearchBlueprintRevisionsPage,TelcoAutomationClient.SearchBlueprintRevisionsFixedSizeCollection>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractFixedSizeCollection](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractFixedSizeCollection.html) \> TelcoAutomationClient.SearchBlueprintRevisionsFixedSizeCollection
...
### createCollection(List<TelcoAutomationClient.SearchBlueprintRevisionsPage> pages, int collectionSize)

```
protected TelcoAutomationClient.SearchBlueprintRevisionsFixedSizeCollection createCollection(List<TelcoAutomationClient.SearchBlueprintRevisionsPage> pages, int collectionSize)
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[SearchBlueprintRevisionsPage](/java/docs/reference/google-cloud-telcoautomation/0.9.0/com.google.cloud.telcoautomation.v1.TelcoAutomationClient.SearchBlueprintRevisionsPage)>`  
...
`[TelcoAutomationClient.SearchBlueprintRevisionsFixedSizeCollection](/java/docs/reference/google-cloud-telcoautomation/0.9.0/com.google.cloud.telcoautomation.v1.TelcoAutomationClient.SearchBlueprintRevisionsFixedSizeCollection)`
