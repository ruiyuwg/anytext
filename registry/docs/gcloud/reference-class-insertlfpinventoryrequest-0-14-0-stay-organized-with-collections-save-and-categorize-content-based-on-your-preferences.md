...
# Class InsertLfpInventoryRequest (0.14.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class InsertLfpInventoryRequest extends GeneratedMessageV3 implements InsertLfpInventoryRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> InsertLfpInventoryRequest

## Implements

[InsertLfpInventoryRequestOrBuilder](/java/docs/reference/google-shopping-merchant-lfp/0.14.0/com.google.shopping.merchant.lfp.v1beta.InsertLfpInventoryRequestOrBuilder)
...
### LFP\_INVENTORY\_FIELD\_NUMBER

```
public static final int LFP_INVENTORY_FIELD_NUMBER
```
...
```
public static InsertLfpInventoryRequest getDefaultInstance()
```
...
`[InsertLfpInventoryRequest](/java/docs/reference/google-shopping-merchant-lfp/0.14.0/com.google.shopping.merchant.lfp.v1beta.InsertLfpInventoryRequest)`
...
```
public static InsertLfpInventoryRequest.Builder newBuilder()
```
...
`[InsertLfpInventoryRequest.Builder](/java/docs/reference/google-shopping-merchant-lfp/0.14.0/com.google.shopping.merchant.lfp.v1beta.InsertLfpInventoryRequest.Builder)`

### newBuilder(InsertLfpInventoryRequest prototype)

```
public static InsertLfpInventoryRequest.Builder newBuilder(InsertLfpInventoryRequest prototype)
```
...
```
public static InsertLfpInventoryRequest parseDelimitedFrom(InputStream input)
```
...
```
public static InsertLfpInventoryRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static InsertLfpInventoryRequest parseFrom(byte[] data)
```
...
```
public static InsertLfpInventoryRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static InsertLfpInventoryRequest parseFrom(ByteString data)
```
...
```
public static InsertLfpInventoryRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static InsertLfpInventoryRequest parseFrom(CodedInputStream input)
```
...
```
public static InsertLfpInventoryRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static InsertLfpInventoryRequest parseFrom(InputStream input)
```
...
```
public static InsertLfpInventoryRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static InsertLfpInventoryRequest parseFrom(ByteBuffer data)
```
...
```
public static InsertLfpInventoryRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<InsertLfpInventoryRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[InsertLfpInventoryRequest](/java/docs/reference/google-shopping-merchant-lfp/0.14.0/com.google.shopping.merchant.lfp.v1beta.InsertLfpInventoryRequest)>`
...
`[LfpInventory](/java/docs/reference/google-shopping-merchant-lfp/0.14.0/com.google.shopping.merchant.lfp.v1beta.LfpInventory)`
...
`[LfpInventoryOrBuilder](/java/docs/reference/google-shopping-merchant-lfp/0.14.0/com.google.shopping.merchant.lfp.v1beta.LfpInventoryOrBuilder)`
...
```
public Parser<InsertLfpInventoryRequest> getParserForType()
```
...
```
public InsertLfpInventoryRequest.Builder newBuilderForType()
```
...
```
protected InsertLfpInventoryRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public InsertLfpInventoryRequest.Builder toBuilder()
```
