...
# Google Cloud Ai Platform V1 Client - Class MetadataSchemaType (1.6.0) Stay organized with collections Save and categorize content based on your preferences.
...
Reference documentation and code samples for the Google Cloud Ai Platform V1 Client class MetadataSchemaType.

Describes the type of the MetadataSchema.

Protobuf type `google.cloud.aiplatform.v1.MetadataSchema.MetadataSchemaType`
...
### METADATA\_SCHEMA\_TYPE\_UNSPECIFIED
...
Generated from protobuf enum `METADATA_SCHEMA_TYPE_UNSPECIFIED = 0;`
...
Generated from protobuf enum `ARTIFACT_TYPE = 1;`
...
Generated from protobuf enum `EXECUTION_TYPE = 2;`
...
Generated from protobuf enum `CONTEXT_TYPE = 3;`
