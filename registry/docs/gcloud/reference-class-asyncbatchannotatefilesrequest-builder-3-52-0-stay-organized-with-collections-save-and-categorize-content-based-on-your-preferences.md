...
# Class AsyncBatchAnnotateFilesRequest.Builder (3.52.0) Stay organized with collections Save and categorize content based on your preferences.
...
[AsyncBatchAnnotateFilesRequestOrBuilder](/java/docs/reference/google-cloud-vision/3.52.0/com.google.cloud.vision.v1p2beta1.AsyncBatchAnnotateFilesRequestOrBuilder)
...
`[Iterable](https://docs.oracle.com/javase/8/docs/api/java/lang/Iterable.html)<? extends com.google.cloud.vision.v1p2beta1.AsyncAnnotateFileRequest>`  
...
`[AsyncBatchAnnotateFilesRequest.Builder](/java/docs/reference/google-cloud-vision/3.52.0/com.google.cloud.vision.v1p2beta1.AsyncBatchAnnotateFilesRequest.Builder)`
...
`[AsyncAnnotateFileRequest](/java/docs/reference/google-cloud-vision/3.52.0/com.google.cloud.vision.v1p2beta1.AsyncAnnotateFileRequest)`  
...
`[AsyncAnnotateFileRequest.Builder](/java/docs/reference/google-cloud-vision/3.52.0/com.google.cloud.vision.v1p2beta1.AsyncAnnotateFileRequest.Builder)`  
...
`[AsyncBatchAnnotateFilesRequest](/java/docs/reference/google-cloud-vision/3.52.0/com.google.cloud.vision.v1p2beta1.AsyncBatchAnnotateFilesRequest)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Builder](/java/docs/reference/google-cloud-vision/3.52.0/com.google.cloud.vision.v1p2beta1.AsyncAnnotateFileRequest.Builder)>`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[AsyncAnnotateFileRequest](/java/docs/reference/google-cloud-vision/3.52.0/com.google.cloud.vision.v1p2beta1.AsyncAnnotateFileRequest)>`
...
`[AsyncAnnotateFileRequestOrBuilder](/java/docs/reference/google-cloud-vision/3.52.0/com.google.cloud.vision.v1p2beta1.AsyncAnnotateFileRequestOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.vision.v1p2beta1.AsyncAnnotateFileRequestOrBuilder>`
