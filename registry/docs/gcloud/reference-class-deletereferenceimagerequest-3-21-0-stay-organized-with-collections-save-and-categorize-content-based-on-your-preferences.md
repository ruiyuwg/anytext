...
# Class DeleteReferenceImageRequest (3.21.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class DeleteReferenceImageRequest extends GeneratedMessageV3 implements DeleteReferenceImageRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> DeleteReferenceImageRequest

## Implements

[DeleteReferenceImageRequestOrBuilder](/java/docs/reference/google-cloud-vision/3.21.0/com.google.cloud.vision.v1p4beta1.DeleteReferenceImageRequestOrBuilder)
...
```
public static DeleteReferenceImageRequest getDefaultInstance()
```
...
`[DeleteReferenceImageRequest](/java/docs/reference/google-cloud-vision/3.21.0/com.google.cloud.vision.v1p4beta1.DeleteReferenceImageRequest)`
...
```
public static DeleteReferenceImageRequest.Builder newBuilder()
```
...
`[DeleteReferenceImageRequest.Builder](/java/docs/reference/google-cloud-vision/3.21.0/com.google.cloud.vision.v1p4beta1.DeleteReferenceImageRequest.Builder)`

### newBuilder(DeleteReferenceImageRequest prototype)

```
public static DeleteReferenceImageRequest.Builder newBuilder(DeleteReferenceImageRequest prototype)
```
...
```
public static DeleteReferenceImageRequest parseDelimitedFrom(InputStream input)
```
...
```
public static DeleteReferenceImageRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteReferenceImageRequest parseFrom(byte[] data)
```
...
```
public static DeleteReferenceImageRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteReferenceImageRequest parseFrom(ByteString data)
```
...
```
public static DeleteReferenceImageRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteReferenceImageRequest parseFrom(CodedInputStream input)
```
...
```
public static DeleteReferenceImageRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteReferenceImageRequest parseFrom(InputStream input)
```
...
```
public static DeleteReferenceImageRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteReferenceImageRequest parseFrom(ByteBuffer data)
```
...
```
public static DeleteReferenceImageRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<DeleteReferenceImageRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[DeleteReferenceImageRequest](/java/docs/reference/google-cloud-vision/3.21.0/com.google.cloud.vision.v1p4beta1.DeleteReferenceImageRequest)>`
...
```
public Parser<DeleteReferenceImageRequest> getParserForType()
```
...
```
public DeleteReferenceImageRequest.Builder newBuilderForType()
```
...
```
protected DeleteReferenceImageRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public DeleteReferenceImageRequest.Builder toBuilder()
```
