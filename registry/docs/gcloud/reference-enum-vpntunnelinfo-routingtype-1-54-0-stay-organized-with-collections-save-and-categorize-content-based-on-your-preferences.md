...
# Enum VpnTunnelInfo.RoutingType (1.54.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum VpnTunnelInfo.RoutingType extends Enum<VpnTunnelInfo.RoutingType> implements ProtocolMessageEnum
```
...
Protobuf enum `google.cloud.networkmanagement.v1beta1.VpnTunnelInfo.RoutingType`
...
`ROUTING_TYPE_UNSPECIFIED_VALUE`
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-network-management/1.54.0/com.google.cloud.networkmanagement.v1beta1.VpnTunnelInfo.RoutingType#com_google_cloud_networkmanagement_v1beta1_VpnTunnelInfo_RoutingType_forNumber_int_) instead._
