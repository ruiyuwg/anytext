...
# Interface ListEffectiveSecurityHealthAnalyticsCustomModulesResponseOrBuilder (2.59.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[EffectiveSecurityHealthAnalyticsCustomModule](/java/docs/reference/google-cloud-securitycenter/2.59.0/com.google.cloud.securitycenter.v1.EffectiveSecurityHealthAnalyticsCustomModule)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[EffectiveSecurityHealthAnalyticsCustomModule](/java/docs/reference/google-cloud-securitycenter/2.59.0/com.google.cloud.securitycenter.v1.EffectiveSecurityHealthAnalyticsCustomModule)>`
...
`[EffectiveSecurityHealthAnalyticsCustomModuleOrBuilder](/java/docs/reference/google-cloud-securitycenter/2.59.0/com.google.cloud.securitycenter.v1.EffectiveSecurityHealthAnalyticsCustomModuleOrBuilder)`
