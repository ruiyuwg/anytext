...
# Class Rotation (2.14.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class Rotation extends GeneratedMessageV3 implements RotationOrBuilder
```

The rotation time and period for a Secret. At next\_rotation\_time, Secret Manager will send a Pub/Sub notification to the topics configured on the Secret. Secret.topics must be set to configure rotation.

Protobuf type `google.cloud.secretmanager.v1.Rotation`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> Rotation

## Implements

[RotationOrBuilder](/java/docs/reference/google-cloud-secretmanager/2.14.0/com.google.cloud.secretmanager.v1.RotationOrBuilder)
...
### NEXT\_ROTATION\_TIME\_FIELD\_NUMBER
...
### ROTATION\_PERIOD\_FIELD\_NUMBER
...
`[Rotation](/java/docs/reference/google-cloud-secretmanager/2.14.0/com.google.cloud.secretmanager.v1.Rotation)`
...
```
public static Rotation.Builder newBuilder()
```
...
`[Rotation.Builder](/java/docs/reference/google-cloud-secretmanager/2.14.0/com.google.cloud.secretmanager.v1.Rotation.Builder)`

### newBuilder(Rotation prototype)

```
public static Rotation.Builder newBuilder(Rotation prototype)
```
...
```
public static Rotation parseDelimitedFrom(InputStream input)
```
...
```
public static Rotation parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Rotation parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Rotation parseFrom(ByteString data)
```
...
```
public static Rotation parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Rotation parseFrom(CodedInputStream input)
```
...
```
public static Rotation parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Rotation parseFrom(InputStream input)
```
...
```
public static Rotation parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Rotation parseFrom(ByteBuffer data)
```
...
```
public static Rotation parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[Rotation](/java/docs/reference/google-cloud-secretmanager/2.14.0/com.google.cloud.secretmanager.v1.Rotation)>`
...
Optional. Timestamp in UTC at which the Secret is scheduled to rotate. Cannot be set to less than 300s (5 min) in the future and at most 3153600000s (100 years). next\_rotation\_time MUST be set if rotation\_period is set.
...
Input only. The Duration between rotation notifications. Must be in seconds and at least 3600s (1h) and at most 3153600000s (100 years). If rotation\_period is set, next\_rotation\_time must be set. next\_rotation\_time will be advanced by this period when the service automatically sends rotation notifications.
...
```
public Rotation.Builder newBuilderForType()
```
...
```
protected Rotation.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public Rotation.Builder toBuilder()
```
