...
# Class SessionsRetryPolicy (2.34.0) Stay organized with collections Save and categorize content based on your preferences.
...
The retry policy for [`SessionsConnection`](/cpp/docs/reference/dialogflow_cx/2.34.0/classgoogle_1_1cloud_1_1dialogflow__cx_1_1SessionsConnection).
