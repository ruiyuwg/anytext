...
# Class ListNotificationChannelsResponse.Builder (3.42.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> ListNotificationChannelsResponse.Builder

## Implements

[ListNotificationChannelsResponseOrBuilder](/java/docs/reference/google-cloud-monitoring/3.42.0/com.google.monitoring.v3.ListNotificationChannelsResponseOrBuilder)
...
`[Iterable](https://docs.oracle.com/javase/8/docs/api/java/lang/Iterable.html)<? extends com.google.monitoring.v3.NotificationChannel>`  
...
`[ListNotificationChannelsResponse.Builder](/java/docs/reference/google-cloud-monitoring/3.42.0/com.google.monitoring.v3.ListNotificationChannelsResponse.Builder)`
...
`[NotificationChannel](/java/docs/reference/google-cloud-monitoring/3.42.0/com.google.monitoring.v3.NotificationChannel)`  
...
`[NotificationChannel.Builder](/java/docs/reference/google-cloud-monitoring/3.42.0/com.google.monitoring.v3.NotificationChannel.Builder)`  
...
`[ListNotificationChannelsResponse](/java/docs/reference/google-cloud-monitoring/3.42.0/com.google.monitoring.v3.ListNotificationChannelsResponse)`
...
The total number of notification channels in all pages. This number is only an estimate, and may change in subsequent pages. [https://aip.dev/158](https://aip.dev/158)
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Builder](/java/docs/reference/google-cloud-monitoring/3.42.0/com.google.monitoring.v3.NotificationChannel.Builder)>`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[NotificationChannel](/java/docs/reference/google-cloud-monitoring/3.42.0/com.google.monitoring.v3.NotificationChannel)>`
...
`[NotificationChannelOrBuilder](/java/docs/reference/google-cloud-monitoring/3.42.0/com.google.monitoring.v3.NotificationChannelOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.monitoring.v3.NotificationChannelOrBuilder>`
