...
# Enum LocationMetadata.Capability (0.41.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum LocationMetadata.Capability extends Enum<LocationMetadata.Capability> implements ProtocolMessageEnum
```

Capability of a location.

Protobuf enum `google.cloud.vmwareengine.v1.LocationMetadata.Capability`
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-vmwareengine/0.41.0/com.google.cloud.vmwareengine.v1.LocationMetadata.Capability#com_google_cloud_vmwareengine_v1_LocationMetadata_Capability_forNumber_int_) instead._
