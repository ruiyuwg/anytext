...
# Google Cloud Ai Platform V1 Client - Class ExplanationBaseline (0.22.0) Stay organized with collections Save and categorize content based on your preferences.
...
Output from [BatchPredictionJob](/php/docs/reference/cloud-ai-platform/0.22.0/V1.BatchPredictionJob) for Model Monitoring baseline dataset, which can be used to generate baseline attribution scores.
...
`[Google\Cloud\AIPlatform\V1\GcsDestination](/php/docs/reference/cloud-ai-platform/0.22.0/V1.GcsDestination)`  

Cloud Storage location for BatchExplain output.

`↳ bigquery`

`[Google\Cloud\AIPlatform\V1\BigQueryDestination](/php/docs/reference/cloud-ai-platform/0.22.0/V1.BigQueryDestination)`  
...
`[Google\Cloud\AIPlatform\V1\GcsDestination](/php/docs/reference/cloud-ai-platform/0.22.0/V1.GcsDestination)|null`
...
`[Google\Cloud\AIPlatform\V1\BigQueryDestination](/php/docs/reference/cloud-ai-platform/0.22.0/V1.BigQueryDestination)|null`
