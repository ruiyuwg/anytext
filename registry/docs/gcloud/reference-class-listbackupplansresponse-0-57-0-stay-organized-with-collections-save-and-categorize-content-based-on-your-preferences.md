...
# Class ListBackupPlansResponse (0.57.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListBackupPlansResponse extends GeneratedMessageV3 implements ListBackupPlansResponseOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListBackupPlansResponse

## Implements

[ListBackupPlansResponseOrBuilder](/java/docs/reference/google-cloud-gke-backup/0.57.0/com.google.cloud.gkebackup.v1.ListBackupPlansResponseOrBuilder)
...
### BACKUP\_PLANS\_FIELD\_NUMBER

```
public static final int BACKUP_PLANS_FIELD_NUMBER
```
...
```
public static ListBackupPlansResponse getDefaultInstance()
```
...
`[ListBackupPlansResponse](/java/docs/reference/google-cloud-gke-backup/0.57.0/com.google.cloud.gkebackup.v1.ListBackupPlansResponse)`
...
```
public static ListBackupPlansResponse.Builder newBuilder()
```
...
`[ListBackupPlansResponse.Builder](/java/docs/reference/google-cloud-gke-backup/0.57.0/com.google.cloud.gkebackup.v1.ListBackupPlansResponse.Builder)`

### newBuilder(ListBackupPlansResponse prototype)

```
public static ListBackupPlansResponse.Builder newBuilder(ListBackupPlansResponse prototype)
```
...
```
public static ListBackupPlansResponse parseDelimitedFrom(InputStream input)
```
...
```
public static ListBackupPlansResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListBackupPlansResponse parseFrom(byte[] data)
```
...
```
public static ListBackupPlansResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListBackupPlansResponse parseFrom(ByteString data)
```
...
```
public static ListBackupPlansResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListBackupPlansResponse parseFrom(CodedInputStream input)
```
...
```
public static ListBackupPlansResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListBackupPlansResponse parseFrom(InputStream input)
```
...
```
public static ListBackupPlansResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListBackupPlansResponse parseFrom(ByteBuffer data)
```
...
```
public static ListBackupPlansResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ListBackupPlansResponse> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListBackupPlansResponse](/java/docs/reference/google-cloud-gke-backup/0.57.0/com.google.cloud.gkebackup.v1.ListBackupPlansResponse)>`
...
`[BackupPlan](/java/docs/reference/google-cloud-gke-backup/0.57.0/com.google.cloud.gkebackup.v1.BackupPlan)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[BackupPlan](/java/docs/reference/google-cloud-gke-backup/0.57.0/com.google.cloud.gkebackup.v1.BackupPlan)>`
...
`[BackupPlanOrBuilder](/java/docs/reference/google-cloud-gke-backup/0.57.0/com.google.cloud.gkebackup.v1.BackupPlanOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.gkebackup.v1.BackupPlanOrBuilder>`
...
A token which may be sent as page\_token in a subsequent `ListBackupPlans` call to retrieve the next page of results. If this field is omitted or empty, then there are no more results to return.
...
```
public Parser<ListBackupPlansResponse> getParserForType()
```
...
```
public ListBackupPlansResponse.Builder newBuilderForType()
```
...
```
protected ListBackupPlansResponse.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ListBackupPlansResponse.Builder toBuilder()
```
