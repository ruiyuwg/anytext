...
# Class WebSecurityScannerClient.ListScanRunsPage (2.11.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[WebSecurityScannerClient.ListScanRunsPage](/java/docs/reference/google-cloud-websecurityscanner/2.11.0/com.google.cloud.websecurityscanner.v1.WebSecurityScannerClient.ListScanRunsPage)`
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListScanRunsResponse](/java/docs/reference/google-cloud-websecurityscanner/2.11.0/com.google.cloud.websecurityscanner.v1.ListScanRunsResponse)>`  
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListScanRunsPage](/java/docs/reference/google-cloud-websecurityscanner/2.11.0/com.google.cloud.websecurityscanner.v1.WebSecurityScannerClient.ListScanRunsPage)>`
