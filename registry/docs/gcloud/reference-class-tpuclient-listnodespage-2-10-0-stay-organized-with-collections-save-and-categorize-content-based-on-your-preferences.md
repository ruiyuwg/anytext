...
# Class TpuClient.ListNodesPage (2.10.0) Stay organized with collections Save and categorize content based on your preferences.
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractPage](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractPage.html) \> TpuClient.ListNodesPage
...
`[PageContext](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PageContext.html)<[ListNodesRequest](/java/docs/reference/google-cloud-tpu/2.10.0/com.google.cloud.tpu.v2alpha1.ListNodesRequest),[ListNodesResponse](/java/docs/reference/google-cloud-tpu/2.10.0/com.google.cloud.tpu.v2alpha1.ListNodesResponse),[Node](/java/docs/reference/google-cloud-tpu/2.10.0/com.google.cloud.tpu.v2alpha1.Node)>`  

`response`

`[ListNodesResponse](/java/docs/reference/google-cloud-tpu/2.10.0/com.google.cloud.tpu.v2alpha1.ListNodesResponse)`  
...
`[TpuClient.ListNodesPage](/java/docs/reference/google-cloud-tpu/2.10.0/com.google.cloud.tpu.v2alpha1.TpuClient.ListNodesPage)`
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListNodesResponse](/java/docs/reference/google-cloud-tpu/2.10.0/com.google.cloud.tpu.v2alpha1.ListNodesResponse)>`  
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListNodesPage](/java/docs/reference/google-cloud-tpu/2.10.0/com.google.cloud.tpu.v2alpha1.TpuClient.ListNodesPage)>`
