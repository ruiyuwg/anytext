...
# Enum Document.SourceCase (2.49.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-language/2.49.0/com.google.cloud.language.v1.Document.SourceCase#com_google_cloud_language_v1_Document_SourceCase_forNumber_int_) instead._
