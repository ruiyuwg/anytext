...
# Class ErrorFrame.Builder (0.28.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> ErrorFrame.Builder

## Implements

[ErrorFrameOrBuilder](/java/docs/reference/google-cloud-migrationcenter/0.28.0/com.google.cloud.migrationcenter.v1.ErrorFrameOrBuilder)
...
`[Iterable](https://docs.oracle.com/javase/8/docs/api/java/lang/Iterable.html)<? extends com.google.cloud.migrationcenter.v1.FrameViolationEntry>`  
...
`[ErrorFrame.Builder](/java/docs/reference/google-cloud-migrationcenter/0.28.0/com.google.cloud.migrationcenter.v1.ErrorFrame.Builder)`
...
`[FrameViolationEntry](/java/docs/reference/google-cloud-migrationcenter/0.28.0/com.google.cloud.migrationcenter.v1.FrameViolationEntry)`  
...
`[FrameViolationEntry.Builder](/java/docs/reference/google-cloud-migrationcenter/0.28.0/com.google.cloud.migrationcenter.v1.FrameViolationEntry.Builder)`  
...
`[ErrorFrame](/java/docs/reference/google-cloud-migrationcenter/0.28.0/com.google.cloud.migrationcenter.v1.ErrorFrame)`
...
`[AssetFrame](/java/docs/reference/google-cloud-migrationcenter/0.28.0/com.google.cloud.migrationcenter.v1.AssetFrame)`
...
`[AssetFrame.Builder](/java/docs/reference/google-cloud-migrationcenter/0.28.0/com.google.cloud.migrationcenter.v1.AssetFrame.Builder)`
...
`[AssetFrameOrBuilder](/java/docs/reference/google-cloud-migrationcenter/0.28.0/com.google.cloud.migrationcenter.v1.AssetFrameOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Builder](/java/docs/reference/google-cloud-migrationcenter/0.28.0/com.google.cloud.migrationcenter.v1.FrameViolationEntry.Builder)>`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[FrameViolationEntry](/java/docs/reference/google-cloud-migrationcenter/0.28.0/com.google.cloud.migrationcenter.v1.FrameViolationEntry)>`
...
`[FrameViolationEntryOrBuilder](/java/docs/reference/google-cloud-migrationcenter/0.28.0/com.google.cloud.migrationcenter.v1.FrameViolationEntryOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.migrationcenter.v1.FrameViolationEntryOrBuilder>`
