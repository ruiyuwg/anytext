...
# Interface GetTaskRequestOrBuilder (2.41.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[Task.View](/java/docs/reference/google-cloud-tasks/2.41.0/com.google.cloud.tasks.v2beta3.Task.View)`
