...
# Enum PatchDeployments.PatchDeployment.State (2.89.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-os-config/latest/com.google.cloud.osconfig.v1.PatchDeployments.PatchDeployment.State#com_google_cloud_osconfig_v1_PatchDeployments_PatchDeployment_State_forNumber_int_) instead._
