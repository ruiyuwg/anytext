...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessage.html) \> StateCondition

## Implements

[StateConditionOrBuilder](/java/docs/reference/google-cloud-eventarc/latest/com.google.cloud.eventarc.v1.StateConditionOrBuilder)
...
```
public static StateCondition getDefaultInstance()
```
...
`[StateCondition](/java/docs/reference/google-cloud-eventarc/latest/com.google.cloud.eventarc.v1.StateCondition)`
...
```
public static StateCondition.Builder newBuilder()
```
...
`[StateCondition.Builder](/java/docs/reference/google-cloud-eventarc/latest/com.google.cloud.eventarc.v1.StateCondition.Builder)`

### newBuilder(StateCondition prototype)

```
public static StateCondition.Builder newBuilder(StateCondition prototype)
```
...
```
public static StateCondition parseDelimitedFrom(InputStream input)
```
...
```
public static StateCondition parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static StateCondition parseFrom(byte[] data)
```
...
```
public static StateCondition parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static StateCondition parseFrom(ByteString data)
```
...
```
public static StateCondition parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static StateCondition parseFrom(CodedInputStream input)
```
...
```
public static StateCondition parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static StateCondition parseFrom(InputStream input)
```
...
```
public static StateCondition parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static StateCondition parseFrom(ByteBuffer data)
```
...
```
public static StateCondition parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<StateCondition> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[StateCondition](/java/docs/reference/google-cloud-eventarc/latest/com.google.cloud.eventarc.v1.StateCondition)>`
...
```
public StateCondition getDefaultInstanceForType()
```
...
```
public Parser<StateCondition> getParserForType()
```
...
```
public StateCondition.Builder newBuilderForType()
```
...
```
protected StateCondition.Builder newBuilderForType(AbstractMessage.BuilderParent parent)
```
...
```
public StateCondition.Builder toBuilder()
```
