...
# Class UpdateMembershipRequest (1.58.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class UpdateMembershipRequest extends GeneratedMessageV3 implements UpdateMembershipRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> UpdateMembershipRequest

## Implements

[UpdateMembershipRequestOrBuilder](/java/docs/reference/google-cloud-gkehub/1.58.0/com.google.cloud.gkehub.v1.UpdateMembershipRequestOrBuilder)
...
```
public static UpdateMembershipRequest getDefaultInstance()
```
...
`[UpdateMembershipRequest](/java/docs/reference/google-cloud-gkehub/1.58.0/com.google.cloud.gkehub.v1.UpdateMembershipRequest)`
...
```
public static UpdateMembershipRequest.Builder newBuilder()
```
...
`[UpdateMembershipRequest.Builder](/java/docs/reference/google-cloud-gkehub/1.58.0/com.google.cloud.gkehub.v1.UpdateMembershipRequest.Builder)`

### newBuilder(UpdateMembershipRequest prototype)

```
public static UpdateMembershipRequest.Builder newBuilder(UpdateMembershipRequest prototype)
```
...
```
public static UpdateMembershipRequest parseDelimitedFrom(InputStream input)
```
...
```
public static UpdateMembershipRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateMembershipRequest parseFrom(byte[] data)
```
...
```
public static UpdateMembershipRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateMembershipRequest parseFrom(ByteString data)
```
...
```
public static UpdateMembershipRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateMembershipRequest parseFrom(CodedInputStream input)
```
...
```
public static UpdateMembershipRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateMembershipRequest parseFrom(InputStream input)
```
...
```
public static UpdateMembershipRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateMembershipRequest parseFrom(ByteBuffer data)
```
...
```
public static UpdateMembershipRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<UpdateMembershipRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[UpdateMembershipRequest](/java/docs/reference/google-cloud-gkehub/1.58.0/com.google.cloud.gkehub.v1.UpdateMembershipRequest)>`
...
```
public Parser<UpdateMembershipRequest> getParserForType()
```
...
`[Membership](/java/docs/reference/google-cloud-gkehub/1.58.0/com.google.cloud.gkehub.v1.Membership)`
...
`[MembershipOrBuilder](/java/docs/reference/google-cloud-gkehub/1.58.0/com.google.cloud.gkehub.v1.MembershipOrBuilder)`
...
```
public UpdateMembershipRequest.Builder newBuilderForType()
```
...
```
protected UpdateMembershipRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public UpdateMembershipRequest.Builder toBuilder()
```
