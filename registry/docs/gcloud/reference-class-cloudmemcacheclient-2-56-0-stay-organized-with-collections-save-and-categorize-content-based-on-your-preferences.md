...
# Class CloudMemcacheClient (2.56.0) Stay organized with collections Save and categorize content based on your preferences.
...
[GitHub Repository](https://github.com/googleapis/google-cloud-java/tree/main/java-memcache/google-cloud-memcache/src/main/java/com/google/cloud/memcache/v1/CloudMemcacheClient.java)

[Product Reference](https://cloud.google.com/memorystore/)
...
`[CloudMemcacheClient](/java/docs/reference/google-cloud-memcache/2.56.0/com.google.cloud.memcache.v1.CloudMemcacheClient)`
...
`[CloudMemcacheSettings](/java/docs/reference/google-cloud-memcache/2.56.0/com.google.cloud.memcache.v1.CloudMemcacheSettings)`  
...
`[CloudMemcacheStub](/java/docs/reference/google-cloud-memcache/2.56.0/com.google.cloud.memcache.v1.stub.CloudMemcacheStub)`  
...
`[ApplyParametersRequest](/java/docs/reference/google-cloud-memcache/2.56.0/com.google.cloud.memcache.v1.ApplyParametersRequest)`  
...
`[OperationFuture](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.longrunning.OperationFuture.html)<[Instance](/java/docs/reference/google-cloud-memcache/2.56.0/com.google.cloud.memcache.v1.Instance),[OperationMetadata](/java/docs/reference/google-cloud-memcache/2.56.0/com.google.cloud.memcache.v1.OperationMetadata)>`
...
`[InstanceName](/java/docs/reference/google-cloud-memcache/2.56.0/com.google.cloud.memcache.v1.InstanceName)`  
...
`[UnaryCallable](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallable.html)<[ApplyParametersRequest](/java/docs/reference/google-cloud-memcache/2.56.0/com.google.cloud.memcache.v1.ApplyParametersRequest),[Operation](https://cloud.google.com/java/docs/reference/gax/latest/com.google.longrunning.Operation.html)>`
...
`[OperationCallable](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.OperationCallable.html)<[ApplyParametersRequest](/java/docs/reference/google-cloud-memcache/2.56.0/com.google.cloud.memcache.v1.ApplyParametersRequest),[Instance](/java/docs/reference/google-cloud-memcache/2.56.0/com.google.cloud.memcache.v1.Instance),[OperationMetadata](/java/docs/reference/google-cloud-memcache/2.56.0/com.google.cloud.memcache.v1.OperationMetadata)>`
...
`[CreateInstanceRequest](/java/docs/reference/google-cloud-memcache/2.56.0/com.google.cloud.memcache.v1.CreateInstanceRequest)`  
...
`[LocationName](/java/docs/reference/google-cloud-memcache/2.56.0/com.google.cloud.memcache.v1.LocationName)`  

Required. The resource name of the instance location using the form: `projects/{project_id}/locations/{location_id}` where `location_id` refers to a GCP region

`instance`

`[Instance](/java/docs/reference/google-cloud-memcache/2.56.0/com.google.cloud.memcache.v1.Instance)`  
...
`[UnaryCallable](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallable.html)<[CreateInstanceRequest](/java/docs/reference/google-cloud-memcache/2.56.0/com.google.cloud.memcache.v1.CreateInstanceRequest),[Operation](https://cloud.google.com/java/docs/reference/gax/latest/com.google.longrunning.Operation.html)>`
...
`[OperationCallable](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.OperationCallable.html)<[CreateInstanceRequest](/java/docs/reference/google-cloud-memcache/2.56.0/com.google.cloud.memcache.v1.CreateInstanceRequest),[Instance](/java/docs/reference/google-cloud-memcache/2.56.0/com.google.cloud.memcache.v1.Instance),[OperationMetadata](/java/docs/reference/google-cloud-memcache/2.56.0/com.google.cloud.memcache.v1.OperationMetadata)>`
...
`[DeleteInstanceRequest](/java/docs/reference/google-cloud-memcache/2.56.0/com.google.cloud.memcache.v1.DeleteInstanceRequest)`  
...
`[UnaryCallable](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallable.html)<[DeleteInstanceRequest](/java/docs/reference/google-cloud-memcache/2.56.0/com.google.cloud.memcache.v1.DeleteInstanceRequest),[Operation](https://cloud.google.com/java/docs/reference/gax/latest/com.google.longrunning.Operation.html)>`
...
`[OperationCallable](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.OperationCallable.html)<[DeleteInstanceRequest](/java/docs/reference/google-cloud-memcache/2.56.0/com.google.cloud.memcache.v1.DeleteInstanceRequest),[Empty](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Empty.html),[OperationMetadata](/java/docs/reference/google-cloud-memcache/2.56.0/com.google.cloud.memcache.v1.OperationMetadata)>`
...
`[GetInstanceRequest](/java/docs/reference/google-cloud-memcache/2.56.0/com.google.cloud.memcache.v1.GetInstanceRequest)`  
...
`[UnaryCallable](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallable.html)<[GetInstanceRequest](/java/docs/reference/google-cloud-memcache/2.56.0/com.google.cloud.memcache.v1.GetInstanceRequest),[Instance](/java/docs/reference/google-cloud-memcache/2.56.0/com.google.cloud.memcache.v1.Instance)>`
...
`[ListInstancesRequest](/java/docs/reference/google-cloud-memcache/2.56.0/com.google.cloud.memcache.v1.ListInstancesRequest)`  
...
`[CloudMemcacheClient.ListInstancesPagedResponse](/java/docs/reference/google-cloud-memcache/2.56.0/com.google.cloud.memcache.v1.CloudMemcacheClient.ListInstancesPagedResponse)`
...
`[UnaryCallable](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallable.html)<[ListInstancesRequest](/java/docs/reference/google-cloud-memcache/2.56.0/com.google.cloud.memcache.v1.ListInstancesRequest),[ListInstancesResponse](/java/docs/reference/google-cloud-memcache/2.56.0/com.google.cloud.memcache.v1.ListInstancesResponse)>`
...
`[UnaryCallable](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallable.html)<[ListInstancesRequest](/java/docs/reference/google-cloud-memcache/2.56.0/com.google.cloud.memcache.v1.ListInstancesRequest),[ListInstancesPagedResponse](/java/docs/reference/google-cloud-memcache/2.56.0/com.google.cloud.memcache.v1.CloudMemcacheClient.ListInstancesPagedResponse)>`
...
`[CloudMemcacheClient.ListLocationsPagedResponse](/java/docs/reference/google-cloud-memcache/2.56.0/com.google.cloud.memcache.v1.CloudMemcacheClient.ListLocationsPagedResponse)`
...
`[UnaryCallable](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallable.html)<com.google.cloud.location.ListLocationsRequest,[ListLocationsPagedResponse](/java/docs/reference/google-cloud-memcache/2.56.0/com.google.cloud.memcache.v1.CloudMemcacheClient.ListLocationsPagedResponse)>`
...
`[RescheduleMaintenanceRequest.RescheduleType](/java/docs/reference/google-cloud-memcache/2.56.0/com.google.cloud.memcache.v1.RescheduleMaintenanceRequest.RescheduleType)`  
...
Timestamp when the maintenance shall be rescheduled to if reschedule\_type=SPECIFIC\_TIME, in RFC 3339 format, for example `2012-11-15T16:19:00.094Z`.
...
`[RescheduleMaintenanceRequest](/java/docs/reference/google-cloud-memcache/2.56.0/com.google.cloud.memcache.v1.RescheduleMaintenanceRequest)`  
...
`[UnaryCallable](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallable.html)<[RescheduleMaintenanceRequest](/java/docs/reference/google-cloud-memcache/2.56.0/com.google.cloud.memcache.v1.RescheduleMaintenanceRequest),[Operation](https://cloud.google.com/java/docs/reference/gax/latest/com.google.longrunning.Operation.html)>`
...
`[OperationCallable](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.OperationCallable.html)<[RescheduleMaintenanceRequest](/java/docs/reference/google-cloud-memcache/2.56.0/com.google.cloud.memcache.v1.RescheduleMaintenanceRequest),[Instance](/java/docs/reference/google-cloud-memcache/2.56.0/com.google.cloud.memcache.v1.Instance),[OperationMetadata](/java/docs/reference/google-cloud-memcache/2.56.0/com.google.cloud.memcache.v1.OperationMetadata)>`
...
`[UpdateInstanceRequest](/java/docs/reference/google-cloud-memcache/2.56.0/com.google.cloud.memcache.v1.UpdateInstanceRequest)`  
...
`[UnaryCallable](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallable.html)<[UpdateInstanceRequest](/java/docs/reference/google-cloud-memcache/2.56.0/com.google.cloud.memcache.v1.UpdateInstanceRequest),[Operation](https://cloud.google.com/java/docs/reference/gax/latest/com.google.longrunning.Operation.html)>`
...
`[OperationCallable](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.OperationCallable.html)<[UpdateInstanceRequest](/java/docs/reference/google-cloud-memcache/2.56.0/com.google.cloud.memcache.v1.UpdateInstanceRequest),[Instance](/java/docs/reference/google-cloud-memcache/2.56.0/com.google.cloud.memcache.v1.Instance),[OperationMetadata](/java/docs/reference/google-cloud-memcache/2.56.0/com.google.cloud.memcache.v1.OperationMetadata)>`
...
`[MemcacheParameters](/java/docs/reference/google-cloud-memcache/2.56.0/com.google.cloud.memcache.v1.MemcacheParameters)`  
...
`[UpdateParametersRequest](/java/docs/reference/google-cloud-memcache/2.56.0/com.google.cloud.memcache.v1.UpdateParametersRequest)`  
...
`[UnaryCallable](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallable.html)<[UpdateParametersRequest](/java/docs/reference/google-cloud-memcache/2.56.0/com.google.cloud.memcache.v1.UpdateParametersRequest),[Operation](https://cloud.google.com/java/docs/reference/gax/latest/com.google.longrunning.Operation.html)>`
...
`[OperationCallable](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.OperationCallable.html)<[UpdateParametersRequest](/java/docs/reference/google-cloud-memcache/2.56.0/com.google.cloud.memcache.v1.UpdateParametersRequest),[Instance](/java/docs/reference/google-cloud-memcache/2.56.0/com.google.cloud.memcache.v1.Instance),[OperationMetadata](/java/docs/reference/google-cloud-memcache/2.56.0/com.google.cloud.memcache.v1.OperationMetadata)>`
