...
# google-cloud-websecurityscanner overview (2.87.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Cloud Security Scanner Description:** Identifies security vulnerabilities in your App Engine, Compute Engine, and Google Kubernetes Engine web applications. It crawls your application, following all links within the scope of your starting URLs, and attempts to exercise as many user inputs and event handlers as possible.

[Cloud Security Scanner Product Reference](https://cloud.google.com/security-scanner/docs/)

[GitHub Repository](https://github.com/googleapis/google-cloud-java/tree/main/java-websecurityscanner)

[Maven artifact](https://central.sonatype.com/artifact/com.google.cloud/google-cloud-websecurityscanner)
...
-   [Enable the API](https://console.cloud.google.com/apis/library/websecurityscanner.googleapis.com)
-   [Set up authentication](https://cloud.google.com/docs/authentication/client-libraries)

## Use the Cloud Security Scanner for Java
...
The example below demonstrates how you would import the BOM and include the `google-cloud-websecurityscanner` artifact.
...
libraryDependencies += "com.google.cloud" % "google-cloud-websecurityscanner" % "2.87.0"

## Which version ID should I get started with?

For this library, we recommend using [com.google.cloud.websecurityscanner.v1](https://cloud.google.com/java/docs/reference/google-cloud-websecurityscanner/2.87.0/com.google.cloud.websecurityscanner.v1) for new applications.
