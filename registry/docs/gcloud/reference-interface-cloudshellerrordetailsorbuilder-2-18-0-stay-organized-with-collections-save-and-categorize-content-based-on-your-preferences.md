...
# Interface CloudShellErrorDetailsOrBuilder (2.18.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[CloudShellErrorDetails.CloudShellErrorCode](/java/docs/reference/google-cloud-shell/2.18.0/com.google.cloud.shell.v1.CloudShellErrorDetails.CloudShellErrorCode)`
