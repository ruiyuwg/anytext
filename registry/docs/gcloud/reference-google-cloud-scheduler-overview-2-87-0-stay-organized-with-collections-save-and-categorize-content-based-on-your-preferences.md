...
# google-cloud-scheduler overview (2.87.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Google Cloud Scheduler Description:** Lets you set up scheduled units of work to be executed at defined times or regular intervals. These work units are commonly known as cron jobs. Typical use cases might include sending out a report email on a daily basis, updating some cached data every 10 minutes, or updating some summary information once an hour.

[Google Cloud Scheduler Product Reference](https://cloud.google.com/scheduler/docs)

[GitHub Repository](https://github.com/googleapis/google-cloud-java/tree/main/java-scheduler)

[Maven artifact](https://central.sonatype.com/artifact/com.google.cloud/google-cloud-scheduler)
...
-   [Enable the API](https://console.cloud.google.com/apis/library/cloudscheduler.googleapis.com)
-   [Set up authentication](https://cloud.google.com/docs/authentication/client-libraries)

## Use the Google Cloud Scheduler for Java
...
The example below demonstrates how you would import the BOM and include the `google-cloud-scheduler` artifact.
...
For this library, we recommend using [com.google.cloud.scheduler.v1](https://cloud.google.com/java/docs/reference/google-cloud-scheduler/2.87.0/com.google.cloud.scheduler.v1) for new applications.
