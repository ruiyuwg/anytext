...
# Class NetworkServicesClient.ListTlsRoutesFixedSizeCollection (0.12.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class NetworkServicesClient.ListTlsRoutesFixedSizeCollection extends AbstractFixedSizeCollection<ListTlsRoutesRequest,ListTlsRoutesResponse,TlsRoute,NetworkServicesClient.ListTlsRoutesPage,NetworkServicesClient.ListTlsRoutesFixedSizeCollection>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractFixedSizeCollection](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractFixedSizeCollection.html) \> NetworkServicesClient.ListTlsRoutesFixedSizeCollection
...
### createCollection(List<NetworkServicesClient.ListTlsRoutesPage> pages, int collectionSize)

```
protected NetworkServicesClient.ListTlsRoutesFixedSizeCollection createCollection(List<NetworkServicesClient.ListTlsRoutesPage> pages, int collectionSize)
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ListTlsRoutesPage](/java/docs/reference/google-cloud-networkservices/0.12.0/com.google.cloud.networkservices.v1.NetworkServicesClient.ListTlsRoutesPage)>`  
...
`[NetworkServicesClient.ListTlsRoutesFixedSizeCollection](/java/docs/reference/google-cloud-networkservices/0.12.0/com.google.cloud.networkservices.v1.NetworkServicesClient.ListTlsRoutesFixedSizeCollection)`
