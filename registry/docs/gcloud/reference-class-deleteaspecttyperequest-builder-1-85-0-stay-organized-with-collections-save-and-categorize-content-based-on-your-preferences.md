...
# Class DeleteAspectTypeRequest.Builder (1.85.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class DeleteAspectTypeRequest.Builder extends GeneratedMessage.Builder<DeleteAspectTypeRequest.Builder> implements DeleteAspectTypeRequestOrBuilder
```

Delete AspectType Request.

Protobuf type `google.cloud.dataplex.v1.DeleteAspectTypeRequest`

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessage.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessage.Builder.html) \> DeleteAspectTypeRequest.Builder

## Implements

[DeleteAspectTypeRequestOrBuilder](/java/docs/reference/google-cloud-dataplex/latest/com.google.cloud.dataplex.v1.DeleteAspectTypeRequestOrBuilder)
...
```
public DeleteAspectTypeRequest build()
```
...
`[DeleteAspectTypeRequest](/java/docs/reference/google-cloud-dataplex/latest/com.google.cloud.dataplex.v1.DeleteAspectTypeRequest)`

### buildPartial()

```
public DeleteAspectTypeRequest buildPartial()
```
...
```
public DeleteAspectTypeRequest.Builder clear()
```
...
`[DeleteAspectTypeRequest.Builder](/java/docs/reference/google-cloud-dataplex/latest/com.google.cloud.dataplex.v1.DeleteAspectTypeRequest.Builder)`
...
```
public DeleteAspectTypeRequest.Builder clearEtag()
```
...
```
public DeleteAspectTypeRequest.Builder clearName()
```
...
```
public DeleteAspectTypeRequest getDefaultInstanceForType()
```
...
### mergeFrom(DeleteAspectTypeRequest other)

```
public DeleteAspectTypeRequest.Builder mergeFrom(DeleteAspectTypeRequest other)
```
...
```
public DeleteAspectTypeRequest.Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public DeleteAspectTypeRequest.Builder mergeFrom(Message other)
```
...
```
public DeleteAspectTypeRequest.Builder setEtag(String value)
```
...
```
public DeleteAspectTypeRequest.Builder setEtagBytes(ByteString value)
```
...
```
public DeleteAspectTypeRequest.Builder setName(String value)
```
...
```
public DeleteAspectTypeRequest.Builder setNameBytes(ByteString value)
```
