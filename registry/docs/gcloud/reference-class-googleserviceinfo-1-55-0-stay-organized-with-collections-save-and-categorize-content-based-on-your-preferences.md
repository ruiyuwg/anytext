...
# Class GoogleServiceInfo (1.55.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class GoogleServiceInfo extends GeneratedMessageV3 implements GoogleServiceInfoOrBuilder
```

For display only. Details of a Google Service sending packets to a VPC network. Although the source IP might be a publicly routable address, some Google Services use special routes within Google production infrastructure to reach Compute Engine Instances. [https://cloud.google.com/vpc/docs/routes#special\_return\_paths](https://cloud.google.com/vpc/docs/routes#special_return_paths)

Protobuf type `google.cloud.networkmanagement.v1.GoogleServiceInfo`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> GoogleServiceInfo

## Implements

[GoogleServiceInfoOrBuilder](/java/docs/reference/google-cloud-network-management/1.55.0/com.google.cloud.networkmanagement.v1.GoogleServiceInfoOrBuilder)
...
### GOOGLE\_SERVICE\_TYPE\_FIELD\_NUMBER

```
public static final int GOOGLE_SERVICE_TYPE_FIELD_NUMBER
```
...
```
public static GoogleServiceInfo getDefaultInstance()
```
...
`[GoogleServiceInfo](/java/docs/reference/google-cloud-network-management/1.55.0/com.google.cloud.networkmanagement.v1.GoogleServiceInfo)`
...
```
public static GoogleServiceInfo.Builder newBuilder()
```
...
`[GoogleServiceInfo.Builder](/java/docs/reference/google-cloud-network-management/1.55.0/com.google.cloud.networkmanagement.v1.GoogleServiceInfo.Builder)`

### newBuilder(GoogleServiceInfo prototype)

```
public static GoogleServiceInfo.Builder newBuilder(GoogleServiceInfo prototype)
```
...
```
public static GoogleServiceInfo parseDelimitedFrom(InputStream input)
```
...
```
public static GoogleServiceInfo parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GoogleServiceInfo parseFrom(byte[] data)
```
...
```
public static GoogleServiceInfo parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GoogleServiceInfo parseFrom(ByteString data)
```
...
```
public static GoogleServiceInfo parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GoogleServiceInfo parseFrom(CodedInputStream input)
```
...
```
public static GoogleServiceInfo parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GoogleServiceInfo parseFrom(InputStream input)
```
...
```
public static GoogleServiceInfo parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GoogleServiceInfo parseFrom(ByteBuffer data)
```
...
```
public static GoogleServiceInfo parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<GoogleServiceInfo> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[GoogleServiceInfo](/java/docs/reference/google-cloud-network-management/1.55.0/com.google.cloud.networkmanagement.v1.GoogleServiceInfo)>`
...
`[GoogleServiceInfo.GoogleServiceType](/java/docs/reference/google-cloud-network-management/1.55.0/com.google.cloud.networkmanagement.v1.GoogleServiceInfo.GoogleServiceType)`
...
```
public Parser<GoogleServiceInfo> getParserForType()
```
...
```
public GoogleServiceInfo.Builder newBuilderForType()
```
...
```
protected GoogleServiceInfo.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public GoogleServiceInfo.Builder toBuilder()
```
