...
# Interface PreprocessingConfig.PadOrBuilder (0.56.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static interface PreprocessingConfig.PadOrBuilder extends MessageOrBuilder
```
