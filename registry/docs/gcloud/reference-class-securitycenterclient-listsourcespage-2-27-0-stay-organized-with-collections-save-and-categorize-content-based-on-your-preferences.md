...
# Class SecurityCenterClient.ListSourcesPage (2.27.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class SecurityCenterClient.ListSourcesPage extends AbstractPage<ListSourcesRequest,ListSourcesResponse,Source,SecurityCenterClient.ListSourcesPage>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractPage](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractPage.html) \> SecurityCenterClient.ListSourcesPage
...
```
protected SecurityCenterClient.ListSourcesPage createPage(PageContext<ListSourcesRequest,ListSourcesResponse,Source> context, ListSourcesResponse response)
```
...
`[PageContext](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PageContext.html)<[ListSourcesRequest](/java/docs/reference/google-cloud-securitycenter/2.27.0/com.google.cloud.securitycenter.v1beta1.ListSourcesRequest),[ListSourcesResponse](/java/docs/reference/google-cloud-securitycenter/2.27.0/com.google.cloud.securitycenter.v1beta1.ListSourcesResponse),[Source](/java/docs/reference/google-cloud-securitycenter/2.27.0/com.google.cloud.securitycenter.v1beta1.Source)>`  

`response`

`[ListSourcesResponse](/java/docs/reference/google-cloud-securitycenter/2.27.0/com.google.cloud.securitycenter.v1beta1.ListSourcesResponse)`  
...
`[SecurityCenterClient.ListSourcesPage](/java/docs/reference/google-cloud-securitycenter/2.27.0/com.google.cloud.securitycenter.v1beta1.SecurityCenterClient.ListSourcesPage)`
...
```
public ApiFuture<SecurityCenterClient.ListSourcesPage> createPageAsync(PageContext<ListSourcesRequest,ListSourcesResponse,Source> context, ApiFuture<ListSourcesResponse> futureResponse)
```
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListSourcesResponse](/java/docs/reference/google-cloud-securitycenter/2.27.0/com.google.cloud.securitycenter.v1beta1.ListSourcesResponse)>`  
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListSourcesPage](/java/docs/reference/google-cloud-securitycenter/2.27.0/com.google.cloud.securitycenter.v1beta1.SecurityCenterClient.ListSourcesPage)>`
