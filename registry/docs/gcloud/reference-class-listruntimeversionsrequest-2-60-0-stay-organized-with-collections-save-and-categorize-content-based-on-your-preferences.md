...
# Class ListRuntimeVersionsRequest (2.60.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListRuntimeVersionsRequest extends GeneratedMessageV3 implements ListRuntimeVersionsRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListRuntimeVersionsRequest

## Implements

[ListRuntimeVersionsRequestOrBuilder](/java/docs/reference/google-cloud-tpu/2.60.0/com.google.cloud.tpu.v2.ListRuntimeVersionsRequestOrBuilder)
...
```
public static ListRuntimeVersionsRequest getDefaultInstance()
```
...
`[ListRuntimeVersionsRequest](/java/docs/reference/google-cloud-tpu/2.60.0/com.google.cloud.tpu.v2.ListRuntimeVersionsRequest)`
...
```
public static ListRuntimeVersionsRequest.Builder newBuilder()
```
...
`[ListRuntimeVersionsRequest.Builder](/java/docs/reference/google-cloud-tpu/2.60.0/com.google.cloud.tpu.v2.ListRuntimeVersionsRequest.Builder)`

### newBuilder(ListRuntimeVersionsRequest prototype)

```
public static ListRuntimeVersionsRequest.Builder newBuilder(ListRuntimeVersionsRequest prototype)
```
...
```
public static ListRuntimeVersionsRequest parseDelimitedFrom(InputStream input)
```
...
```
public static ListRuntimeVersionsRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListRuntimeVersionsRequest parseFrom(byte[] data)
```
...
```
public static ListRuntimeVersionsRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListRuntimeVersionsRequest parseFrom(ByteString data)
```
...
```
public static ListRuntimeVersionsRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListRuntimeVersionsRequest parseFrom(CodedInputStream input)
```
...
```
public static ListRuntimeVersionsRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListRuntimeVersionsRequest parseFrom(InputStream input)
```
...
```
public static ListRuntimeVersionsRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListRuntimeVersionsRequest parseFrom(ByteBuffer data)
```
...
```
public static ListRuntimeVersionsRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ListRuntimeVersionsRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListRuntimeVersionsRequest](/java/docs/reference/google-cloud-tpu/2.60.0/com.google.cloud.tpu.v2.ListRuntimeVersionsRequest)>`
...
```
public ListRuntimeVersionsRequest getDefaultInstanceForType()
```
...
```
public Parser<ListRuntimeVersionsRequest> getParserForType()
```
...
```
public ListRuntimeVersionsRequest.Builder newBuilderForType()
```
...
```
protected ListRuntimeVersionsRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ListRuntimeVersionsRequest.Builder toBuilder()
```
