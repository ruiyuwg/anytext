...
# Class HistogramQuery (2.30.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class HistogramQuery extends GeneratedMessageV3 implements HistogramQueryOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> HistogramQuery

## Implements

[HistogramQueryOrBuilder](/java/docs/reference/google-cloud-talent/2.30.0/com.google.cloud.talent.v4beta1.HistogramQueryOrBuilder)
...
### HISTOGRAM\_QUERY\_FIELD\_NUMBER
...
`[HistogramQuery](/java/docs/reference/google-cloud-talent/2.30.0/com.google.cloud.talent.v4beta1.HistogramQuery)`
...
```
public static HistogramQuery.Builder newBuilder()
```
...
`[HistogramQuery.Builder](/java/docs/reference/google-cloud-talent/2.30.0/com.google.cloud.talent.v4beta1.HistogramQuery.Builder)`

### newBuilder(HistogramQuery prototype)

```
public static HistogramQuery.Builder newBuilder(HistogramQuery prototype)
```
...
```
public static HistogramQuery parseDelimitedFrom(InputStream input)
```
...
```
public static HistogramQuery parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static HistogramQuery parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static HistogramQuery parseFrom(ByteString data)
```
...
```
public static HistogramQuery parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static HistogramQuery parseFrom(CodedInputStream input)
```
...
```
public static HistogramQuery parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static HistogramQuery parseFrom(InputStream input)
```
...
```
public static HistogramQuery parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static HistogramQuery parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<HistogramQuery> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[HistogramQuery](/java/docs/reference/google-cloud-talent/2.30.0/com.google.cloud.talent.v4beta1.HistogramQuery)>`
...
See SearchJobsRequest.histogram\_queries and SearchProfilesRequest.histogram\_queries for details about syntax.
...
```
public Parser<HistogramQuery> getParserForType()
```
...
```
protected HistogramQuery.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
