...
# Interface MeshCertificatesOrBuilder (2.90.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface MeshCertificatesOrBuilder extends MessageOrBuilder
```
...
enable\_certificates controls issuance of workload mTLS certificates.
...
Requires Workload Identity (workload\_pool must be non-empty).
