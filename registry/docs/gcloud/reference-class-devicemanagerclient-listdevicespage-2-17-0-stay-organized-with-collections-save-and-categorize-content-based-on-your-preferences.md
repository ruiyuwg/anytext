...
# Class DeviceManagerClient.ListDevicesPage (2.17.0) Stay organized with collections Save and categorize content based on your preferences.
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractPage](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractPage.html) \> DeviceManagerClient.ListDevicesPage
...
`[PageContext](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PageContext.html)<[ListDevicesRequest](/java/docs/reference/google-cloud-iot/2.17.0/com.google.cloud.iot.v1.ListDevicesRequest),[ListDevicesResponse](/java/docs/reference/google-cloud-iot/2.17.0/com.google.cloud.iot.v1.ListDevicesResponse),[Device](/java/docs/reference/google-cloud-iot/2.17.0/com.google.cloud.iot.v1.Device)>`  

`response`

`[ListDevicesResponse](/java/docs/reference/google-cloud-iot/2.17.0/com.google.cloud.iot.v1.ListDevicesResponse)`  
...
`[DeviceManagerClient.ListDevicesPage](/java/docs/reference/google-cloud-iot/2.17.0/com.google.cloud.iot.v1.DeviceManagerClient.ListDevicesPage)`
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListDevicesResponse](/java/docs/reference/google-cloud-iot/2.17.0/com.google.cloud.iot.v1.ListDevicesResponse)>`  
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListDevicesPage](/java/docs/reference/google-cloud-iot/2.17.0/com.google.cloud.iot.v1.DeviceManagerClient.ListDevicesPage)>`
