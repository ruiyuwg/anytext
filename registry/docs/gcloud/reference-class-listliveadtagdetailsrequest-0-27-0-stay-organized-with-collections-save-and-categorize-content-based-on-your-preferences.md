...
# Class ListLiveAdTagDetailsRequest (0.27.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListLiveAdTagDetailsRequest extends GeneratedMessageV3 implements ListLiveAdTagDetailsRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListLiveAdTagDetailsRequest

## Implements

[ListLiveAdTagDetailsRequestOrBuilder](/java/docs/reference/google-cloud-video-stitcher/0.27.0/com.google.cloud.video.stitcher.v1.ListLiveAdTagDetailsRequestOrBuilder)
...
```
public static ListLiveAdTagDetailsRequest getDefaultInstance()
```
...
`[ListLiveAdTagDetailsRequest](/java/docs/reference/google-cloud-video-stitcher/0.27.0/com.google.cloud.video.stitcher.v1.ListLiveAdTagDetailsRequest)`
...
```
public static ListLiveAdTagDetailsRequest.Builder newBuilder()
```
...
`[ListLiveAdTagDetailsRequest.Builder](/java/docs/reference/google-cloud-video-stitcher/0.27.0/com.google.cloud.video.stitcher.v1.ListLiveAdTagDetailsRequest.Builder)`

### newBuilder(ListLiveAdTagDetailsRequest prototype)

```
public static ListLiveAdTagDetailsRequest.Builder newBuilder(ListLiveAdTagDetailsRequest prototype)
```
...
```
public static ListLiveAdTagDetailsRequest parseDelimitedFrom(InputStream input)
```
...
```
public static ListLiveAdTagDetailsRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListLiveAdTagDetailsRequest parseFrom(byte[] data)
```
...
```
public static ListLiveAdTagDetailsRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListLiveAdTagDetailsRequest parseFrom(ByteString data)
```
...
```
public static ListLiveAdTagDetailsRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListLiveAdTagDetailsRequest parseFrom(CodedInputStream input)
```
...
```
public static ListLiveAdTagDetailsRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListLiveAdTagDetailsRequest parseFrom(InputStream input)
```
...
```
public static ListLiveAdTagDetailsRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListLiveAdTagDetailsRequest parseFrom(ByteBuffer data)
```
...
```
public static ListLiveAdTagDetailsRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ListLiveAdTagDetailsRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListLiveAdTagDetailsRequest](/java/docs/reference/google-cloud-video-stitcher/0.27.0/com.google.cloud.video.stitcher.v1.ListLiveAdTagDetailsRequest)>`
...
```
public ListLiveAdTagDetailsRequest getDefaultInstanceForType()
```
...
```
public Parser<ListLiveAdTagDetailsRequest> getParserForType()
```
...
```
public ListLiveAdTagDetailsRequest.Builder newBuilderForType()
```
...
```
protected ListLiveAdTagDetailsRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ListLiveAdTagDetailsRequest.Builder toBuilder()
```
