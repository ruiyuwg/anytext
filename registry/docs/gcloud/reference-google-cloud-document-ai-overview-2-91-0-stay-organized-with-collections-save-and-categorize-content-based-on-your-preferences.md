...
# google-cloud-document-ai overview (2.91.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Document AI Description:** Allows developers to unlock insights from your documents with machine learning.

[Document AI Product Reference](https://cloud.google.com/compute/docs/documentai/)

[GitHub Repository](https://github.com/googleapis/google-cloud-java/tree/main/java-document-ai)

[Maven artifact](https://central.sonatype.com/artifact/com.google.cloud/google-cloud-document-ai)
...
-   [Enable the API](https://console.cloud.google.com/apis/library/documentai.googleapis.com)
-   [Set up authentication](https://cloud.google.com/docs/authentication/client-libraries)

## Use the Document AI for Java
...
The example below demonstrates how you would import the BOM and include the `google-cloud-document-ai` artifact.
...
For this library, we recommend using [com.google.cloud.documentai.v1](https://cloud.google.com/java/docs/reference/google-cloud-document-ai/2.91.0/com.google.cloud.documentai.v1) for new applications.
