...
# Class RegistrationServiceClient.ListServicesFixedSizeCollection (2.53.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class RegistrationServiceClient.ListServicesFixedSizeCollection extends AbstractFixedSizeCollection<ListServicesRequest,ListServicesResponse,Service,RegistrationServiceClient.ListServicesPage,RegistrationServiceClient.ListServicesFixedSizeCollection>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractFixedSizeCollection](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractFixedSizeCollection.html) \> RegistrationServiceClient.ListServicesFixedSizeCollection
...
### createCollection(List<RegistrationServiceClient.ListServicesPage> pages, int collectionSize)

```
protected RegistrationServiceClient.ListServicesFixedSizeCollection createCollection(List<RegistrationServiceClient.ListServicesPage> pages, int collectionSize)
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ListServicesPage](/java/docs/reference/google-cloud-servicedirectory/2.53.0/com.google.cloud.servicedirectory.v1.RegistrationServiceClient.ListServicesPage)>`  
...
`[RegistrationServiceClient.ListServicesFixedSizeCollection](/java/docs/reference/google-cloud-servicedirectory/2.53.0/com.google.cloud.servicedirectory.v1.RegistrationServiceClient.ListServicesFixedSizeCollection)`
