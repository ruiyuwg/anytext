...
# Class AzureClustersClient.ListAzureClustersPage (0.27.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class AzureClustersClient.ListAzureClustersPage extends AbstractPage<ListAzureClustersRequest,ListAzureClustersResponse,AzureCluster,AzureClustersClient.ListAzureClustersPage>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractPage](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractPage.html) \> AzureClustersClient.ListAzureClustersPage
...
### createPage(PageContext<ListAzureClustersRequest,ListAzureClustersResponse,AzureCluster> context, ListAzureClustersResponse response)

```
protected AzureClustersClient.ListAzureClustersPage createPage(PageContext<ListAzureClustersRequest,ListAzureClustersResponse,AzureCluster> context, ListAzureClustersResponse response)
```
...
`[PageContext](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PageContext.html)<[ListAzureClustersRequest](/java/docs/reference/google-cloud-gke-multi-cloud/0.27.0/com.google.cloud.gkemulticloud.v1.ListAzureClustersRequest),[ListAzureClustersResponse](/java/docs/reference/google-cloud-gke-multi-cloud/0.27.0/com.google.cloud.gkemulticloud.v1.ListAzureClustersResponse),[AzureCluster](/java/docs/reference/google-cloud-gke-multi-cloud/0.27.0/com.google.cloud.gkemulticloud.v1.AzureCluster)>`  

`response`

`[ListAzureClustersResponse](/java/docs/reference/google-cloud-gke-multi-cloud/0.27.0/com.google.cloud.gkemulticloud.v1.ListAzureClustersResponse)`  
...
`[AzureClustersClient.ListAzureClustersPage](/java/docs/reference/google-cloud-gke-multi-cloud/0.27.0/com.google.cloud.gkemulticloud.v1.AzureClustersClient.ListAzureClustersPage)`
...
### createPageAsync(PageContext<ListAzureClustersRequest,ListAzureClustersResponse,AzureCluster> context, ApiFuture<ListAzureClustersResponse> futureResponse)

```
public ApiFuture<AzureClustersClient.ListAzureClustersPage> createPageAsync(PageContext<ListAzureClustersRequest,ListAzureClustersResponse,AzureCluster> context, ApiFuture<ListAzureClustersResponse> futureResponse)
```
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListAzureClustersResponse](/java/docs/reference/google-cloud-gke-multi-cloud/0.27.0/com.google.cloud.gkemulticloud.v1.ListAzureClustersResponse)>`  
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListAzureClustersPage](/java/docs/reference/google-cloud-gke-multi-cloud/0.27.0/com.google.cloud.gkemulticloud.v1.AzureClustersClient.ListAzureClustersPage)>`
