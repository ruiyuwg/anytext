...
# Class NotificationMessage (2.29.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> NotificationMessage

## Implements

[NotificationMessageOrBuilder](/java/docs/reference/google-cloud-securitycenter/2.29.0/com.google.cloud.securitycenter.v1p1beta1.NotificationMessageOrBuilder)
...
### NOTIFICATION\_CONFIG\_NAME\_FIELD\_NUMBER
...
`[NotificationMessage](/java/docs/reference/google-cloud-securitycenter/2.29.0/com.google.cloud.securitycenter.v1p1beta1.NotificationMessage)`
...
`[NotificationMessage.Builder](/java/docs/reference/google-cloud-securitycenter/2.29.0/com.google.cloud.securitycenter.v1p1beta1.NotificationMessage.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[NotificationMessage](/java/docs/reference/google-cloud-securitycenter/2.29.0/com.google.cloud.securitycenter.v1p1beta1.NotificationMessage)>`
...
`[NotificationMessage.EventCase](/java/docs/reference/google-cloud-securitycenter/2.29.0/com.google.cloud.securitycenter.v1p1beta1.NotificationMessage.EventCase)`
...
`[Finding](/java/docs/reference/google-cloud-securitycenter/2.29.0/com.google.cloud.securitycenter.v1p1beta1.Finding)`
...
`[FindingOrBuilder](/java/docs/reference/google-cloud-securitycenter/2.29.0/com.google.cloud.securitycenter.v1p1beta1.FindingOrBuilder)`
...
`[Resource](/java/docs/reference/google-cloud-securitycenter/2.29.0/com.google.cloud.securitycenter.v1p1beta1.Resource)`
...
`[ResourceOrBuilder](/java/docs/reference/google-cloud-securitycenter/2.29.0/com.google.cloud.securitycenter.v1p1beta1.ResourceOrBuilder)`
