...
# Class ListEdgeSlmsRequest (0.3.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListEdgeSlmsRequest extends GeneratedMessageV3 implements ListEdgeSlmsRequestOrBuilder
```

Message for requesting list of EdgeSlms

Protobuf type `google.cloud.telcoautomation.v1.ListEdgeSlmsRequest`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListEdgeSlmsRequest

## Implements

[ListEdgeSlmsRequestOrBuilder](/java/docs/reference/google-cloud-telcoautomation/0.3.0/com.google.cloud.telcoautomation.v1.ListEdgeSlmsRequestOrBuilder)
...
```
public static ListEdgeSlmsRequest getDefaultInstance()
```
...
`[ListEdgeSlmsRequest](/java/docs/reference/google-cloud-telcoautomation/0.3.0/com.google.cloud.telcoautomation.v1.ListEdgeSlmsRequest)`
...
```
public static ListEdgeSlmsRequest.Builder newBuilder()
```
...
`[ListEdgeSlmsRequest.Builder](/java/docs/reference/google-cloud-telcoautomation/0.3.0/com.google.cloud.telcoautomation.v1.ListEdgeSlmsRequest.Builder)`

### newBuilder(ListEdgeSlmsRequest prototype)

```
public static ListEdgeSlmsRequest.Builder newBuilder(ListEdgeSlmsRequest prototype)
```
...
```
public static ListEdgeSlmsRequest parseDelimitedFrom(InputStream input)
```
...
```
public static ListEdgeSlmsRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListEdgeSlmsRequest parseFrom(byte[] data)
```
...
```
public static ListEdgeSlmsRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListEdgeSlmsRequest parseFrom(ByteString data)
```
...
```
public static ListEdgeSlmsRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListEdgeSlmsRequest parseFrom(CodedInputStream input)
```
...
```
public static ListEdgeSlmsRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListEdgeSlmsRequest parseFrom(InputStream input)
```
...
```
public static ListEdgeSlmsRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListEdgeSlmsRequest parseFrom(ByteBuffer data)
```
...
```
public static ListEdgeSlmsRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ListEdgeSlmsRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListEdgeSlmsRequest](/java/docs/reference/google-cloud-telcoautomation/0.3.0/com.google.cloud.telcoautomation.v1.ListEdgeSlmsRequest)>`
...
```
public ListEdgeSlmsRequest getDefaultInstanceForType()
```
...
```
public Parser<ListEdgeSlmsRequest> getParserForType()
```
...
```
public ListEdgeSlmsRequest.Builder newBuilderForType()
```
...
```
protected ListEdgeSlmsRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ListEdgeSlmsRequest.Builder toBuilder()
```
