...
# Class UpdateNetworkPeeringRequest (0.43.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class UpdateNetworkPeeringRequest extends GeneratedMessageV3 implements UpdateNetworkPeeringRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> UpdateNetworkPeeringRequest

## Implements

[UpdateNetworkPeeringRequestOrBuilder](/java/docs/reference/google-cloud-vmwareengine/0.43.0/com.google.cloud.vmwareengine.v1.UpdateNetworkPeeringRequestOrBuilder)
...
### NETWORK\_PEERING\_FIELD\_NUMBER
...
```
public static UpdateNetworkPeeringRequest getDefaultInstance()
```
...
`[UpdateNetworkPeeringRequest](/java/docs/reference/google-cloud-vmwareengine/0.43.0/com.google.cloud.vmwareengine.v1.UpdateNetworkPeeringRequest)`
...
```
public static UpdateNetworkPeeringRequest.Builder newBuilder()
```
...
`[UpdateNetworkPeeringRequest.Builder](/java/docs/reference/google-cloud-vmwareengine/0.43.0/com.google.cloud.vmwareengine.v1.UpdateNetworkPeeringRequest.Builder)`

### newBuilder(UpdateNetworkPeeringRequest prototype)

```
public static UpdateNetworkPeeringRequest.Builder newBuilder(UpdateNetworkPeeringRequest prototype)
```
...
```
public static UpdateNetworkPeeringRequest parseDelimitedFrom(InputStream input)
```
...
```
public static UpdateNetworkPeeringRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateNetworkPeeringRequest parseFrom(byte[] data)
```
...
```
public static UpdateNetworkPeeringRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateNetworkPeeringRequest parseFrom(ByteString data)
```
...
```
public static UpdateNetworkPeeringRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateNetworkPeeringRequest parseFrom(CodedInputStream input)
```
...
```
public static UpdateNetworkPeeringRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateNetworkPeeringRequest parseFrom(InputStream input)
```
...
```
public static UpdateNetworkPeeringRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateNetworkPeeringRequest parseFrom(ByteBuffer data)
```
...
```
public static UpdateNetworkPeeringRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<UpdateNetworkPeeringRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[UpdateNetworkPeeringRequest](/java/docs/reference/google-cloud-vmwareengine/0.43.0/com.google.cloud.vmwareengine.v1.UpdateNetworkPeeringRequest)>`
...
`[NetworkPeering](/java/docs/reference/google-cloud-vmwareengine/0.43.0/com.google.cloud.vmwareengine.v1.NetworkPeering)`
...
`[NetworkPeeringOrBuilder](/java/docs/reference/google-cloud-vmwareengine/0.43.0/com.google.cloud.vmwareengine.v1.NetworkPeeringOrBuilder)`

### getParserForType()

```
public Parser<UpdateNetworkPeeringRequest> getParserForType()
```
...
```
public UpdateNetworkPeeringRequest.Builder newBuilderForType()
```
...
```
protected UpdateNetworkPeeringRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public UpdateNetworkPeeringRequest.Builder toBuilder()
```
