...
# Class CloudTasksClient.ListTasksPage (2.43.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class CloudTasksClient.ListTasksPage extends AbstractPage<ListTasksRequest,ListTasksResponse,Task,CloudTasksClient.ListTasksPage>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractPage](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractPage.html) \> CloudTasksClient.ListTasksPage
...
### createPage(PageContext<ListTasksRequest,ListTasksResponse,Task> context, ListTasksResponse response)

```
protected CloudTasksClient.ListTasksPage createPage(PageContext<ListTasksRequest,ListTasksResponse,Task> context, ListTasksResponse response)
```
...
`[PageContext](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PageContext.html)<[ListTasksRequest](/java/docs/reference/google-cloud-tasks/2.43.0/com.google.cloud.tasks.v2.ListTasksRequest),[ListTasksResponse](/java/docs/reference/google-cloud-tasks/2.43.0/com.google.cloud.tasks.v2.ListTasksResponse),[Task](/java/docs/reference/google-cloud-tasks/2.43.0/com.google.cloud.tasks.v2.Task)>`  

`response`

`[ListTasksResponse](/java/docs/reference/google-cloud-tasks/2.43.0/com.google.cloud.tasks.v2.ListTasksResponse)`  
...
`[CloudTasksClient.ListTasksPage](/java/docs/reference/google-cloud-tasks/2.43.0/com.google.cloud.tasks.v2.CloudTasksClient.ListTasksPage)`
...
### createPageAsync(PageContext<ListTasksRequest,ListTasksResponse,Task> context, ApiFuture<ListTasksResponse> futureResponse)

```
public ApiFuture<CloudTasksClient.ListTasksPage> createPageAsync(PageContext<ListTasksRequest,ListTasksResponse,Task> context, ApiFuture<ListTasksResponse> futureResponse)
```
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListTasksResponse](/java/docs/reference/google-cloud-tasks/2.43.0/com.google.cloud.tasks.v2.ListTasksResponse)>`  
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListTasksPage](/java/docs/reference/google-cloud-tasks/2.43.0/com.google.cloud.tasks.v2.CloudTasksClient.ListTasksPage)>`
