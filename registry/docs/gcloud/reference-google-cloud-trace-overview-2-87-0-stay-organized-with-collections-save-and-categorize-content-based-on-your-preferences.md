...
# google-cloud-trace overview (2.87.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Stackdriver Trace Description:** Is a distributed tracing system that collects latency data from your applications and displays it in the Google Cloud Platform Console. You can track how requests propagate through your application and receive detailed near real-time performance insights.

[Stackdriver Trace Product Reference](https://cloud.google.com/trace/docs/)

[GitHub Repository](https://github.com/googleapis/google-cloud-java/tree/main/java-trace)

[Maven artifact](https://central.sonatype.com/artifact/com.google.cloud/google-cloud-trace)
...
-   [Enable the API](https://console.cloud.google.com/apis/library/cloudtrace.googleapis.com)
-   [Set up authentication](https://cloud.google.com/docs/authentication/client-libraries)

## Use the Stackdriver Trace for Java
...
The example below demonstrates how you would import the BOM and include the `google-cloud-trace` artifact.
...
For this library, we recommend using [com.google.devtools.cloudtrace.v2](https://cloud.google.com/java/docs/reference/google-cloud-trace/2.87.0/com.google.devtools.cloudtrace.v2) for new applications.
