...
# Class GetInsightRequest (2.17.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class GetInsightRequest extends GeneratedMessageV3 implements GetInsightRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> GetInsightRequest

## Implements

[GetInsightRequestOrBuilder](/java/docs/reference/google-cloud-recommender/2.17.0/com.google.cloud.recommender.v1.GetInsightRequestOrBuilder)
...
```
public static GetInsightRequest getDefaultInstance()
```
...
`[GetInsightRequest](/java/docs/reference/google-cloud-recommender/2.17.0/com.google.cloud.recommender.v1.GetInsightRequest)`
...
```
public static GetInsightRequest.Builder newBuilder()
```
...
`[GetInsightRequest.Builder](/java/docs/reference/google-cloud-recommender/2.17.0/com.google.cloud.recommender.v1.GetInsightRequest.Builder)`

### newBuilder(GetInsightRequest prototype)

```
public static GetInsightRequest.Builder newBuilder(GetInsightRequest prototype)
```
...
```
public static GetInsightRequest parseDelimitedFrom(InputStream input)
```
...
```
public static GetInsightRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetInsightRequest parseFrom(byte[] data)
```
...
```
public static GetInsightRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetInsightRequest parseFrom(ByteString data)
```
...
```
public static GetInsightRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetInsightRequest parseFrom(CodedInputStream input)
```
...
```
public static GetInsightRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetInsightRequest parseFrom(InputStream input)
```
...
```
public static GetInsightRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetInsightRequest parseFrom(ByteBuffer data)
```
...
```
public static GetInsightRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<GetInsightRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[GetInsightRequest](/java/docs/reference/google-cloud-recommender/2.17.0/com.google.cloud.recommender.v1.GetInsightRequest)>`
...
```
public GetInsightRequest getDefaultInstanceForType()
```
...
```
public Parser<GetInsightRequest> getParserForType()
```
...
```
public GetInsightRequest.Builder newBuilderForType()
```
...
```
protected GetInsightRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public GetInsightRequest.Builder toBuilder()
```
