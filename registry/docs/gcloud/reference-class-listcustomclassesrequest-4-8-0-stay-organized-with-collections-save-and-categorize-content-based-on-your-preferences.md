...
# Class ListCustomClassesRequest (4.8.0) Stay organized with collections Save and categorize content based on your preferences.
...
[ListCustomClassesRequestOrBuilder](/java/docs/reference/google-cloud-speech/4.8.0/com.google.cloud.speech.v2.ListCustomClassesRequestOrBuilder)
...
`[ListCustomClassesRequest](/java/docs/reference/google-cloud-speech/4.8.0/com.google.cloud.speech.v2.ListCustomClassesRequest)`
...
`[ListCustomClassesRequest.Builder](/java/docs/reference/google-cloud-speech/4.8.0/com.google.cloud.speech.v2.ListCustomClassesRequest.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListCustomClassesRequest](/java/docs/reference/google-cloud-speech/4.8.0/com.google.cloud.speech.v2.ListCustomClassesRequest)>`
...
Number of results per requests. A valid page\_size ranges from 0 to 20 inclusive. If the page\_size is zero or unspecified, a page size of 5 will be chosen. If the page size exceeds 20, it will be coerced down to 20. Note that a call might return fewer results than the requested page size.
