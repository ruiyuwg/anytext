...
# google-cloud-translate overview (2.87.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Cloud Translation Description:** Can dynamically translate text between thousands of language pairs. Translation lets websites and programs programmatically integrate with the translation service.

[Cloud Translation Product Reference](https://cloud.google.com/translate/docs/)

[GitHub Repository](https://github.com/googleapis/google-cloud-java/tree/main/java-translate)

[Maven artifact](https://central.sonatype.com/artifact/com.google.cloud/google-cloud-translate)
...
-   [Enable the API](https://console.cloud.google.com/apis/library/translate.googleapis.com)
-   [Set up authentication](https://cloud.google.com/docs/authentication/client-libraries)

## Use the Cloud Translation for Java
...
The example below demonstrates how you would import the BOM and include the `google-cloud-translate` artifact.
...
libraryDependencies += "com.google.cloud" % "google-cloud-translate" % "2.87.0"

## Which version ID should I get started with?

For this library, we recommend using [com.google.cloud.translate.v3](https://cloud.google.com/java/docs/reference/google-cloud-translate/2.87.0/com.google.cloud.translate.v3) for new applications.
