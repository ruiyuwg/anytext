...
# Class RemoveIpOverrideRequest (3.54.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class RemoveIpOverrideRequest extends GeneratedMessageV3 implements RemoveIpOverrideRequestOrBuilder
```

The RemoveIpOverride request message.

Protobuf type `google.cloud.recaptchaenterprise.v1.RemoveIpOverrideRequest`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> RemoveIpOverrideRequest

## Implements

[RemoveIpOverrideRequestOrBuilder](/java/docs/reference/google-cloud-recaptchaenterprise/3.54.0/com.google.recaptchaenterprise.v1.RemoveIpOverrideRequestOrBuilder)
...
### IP\_OVERRIDE\_DATA\_FIELD\_NUMBER

```
public static final int IP_OVERRIDE_DATA_FIELD_NUMBER
```
...
```
public static RemoveIpOverrideRequest getDefaultInstance()
```
...
`[RemoveIpOverrideRequest](/java/docs/reference/google-cloud-recaptchaenterprise/3.54.0/com.google.recaptchaenterprise.v1.RemoveIpOverrideRequest)`
...
```
public static RemoveIpOverrideRequest.Builder newBuilder()
```
...
`[RemoveIpOverrideRequest.Builder](/java/docs/reference/google-cloud-recaptchaenterprise/3.54.0/com.google.recaptchaenterprise.v1.RemoveIpOverrideRequest.Builder)`

### newBuilder(RemoveIpOverrideRequest prototype)

```
public static RemoveIpOverrideRequest.Builder newBuilder(RemoveIpOverrideRequest prototype)
```
...
```
public static RemoveIpOverrideRequest parseDelimitedFrom(InputStream input)
```
...
```
public static RemoveIpOverrideRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RemoveIpOverrideRequest parseFrom(byte[] data)
```
...
```
public static RemoveIpOverrideRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RemoveIpOverrideRequest parseFrom(ByteString data)
```
...
```
public static RemoveIpOverrideRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RemoveIpOverrideRequest parseFrom(CodedInputStream input)
```
...
```
public static RemoveIpOverrideRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RemoveIpOverrideRequest parseFrom(InputStream input)
```
...
```
public static RemoveIpOverrideRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RemoveIpOverrideRequest parseFrom(ByteBuffer data)
```
...
```
public static RemoveIpOverrideRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<RemoveIpOverrideRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[RemoveIpOverrideRequest](/java/docs/reference/google-cloud-recaptchaenterprise/3.54.0/com.google.recaptchaenterprise.v1.RemoveIpOverrideRequest)>`
...
```
public RemoveIpOverrideRequest getDefaultInstanceForType()
```
...
```
public IpOverrideData getIpOverrideData()
```
...
`[IpOverrideData](/java/docs/reference/google-cloud-recaptchaenterprise/3.54.0/com.google.recaptchaenterprise.v1.IpOverrideData)`

The ipOverrideData.

### getIpOverrideDataOrBuilder()

```
public IpOverrideDataOrBuilder getIpOverrideDataOrBuilder()
```
...
`[IpOverrideDataOrBuilder](/java/docs/reference/google-cloud-recaptchaenterprise/3.54.0/com.google.recaptchaenterprise.v1.IpOverrideDataOrBuilder)`
...
```
public Parser<RemoveIpOverrideRequest> getParserForType()
```
...
Whether the ipOverrideData field is set.
...
```
public RemoveIpOverrideRequest.Builder newBuilderForType()
```
...
```
protected RemoveIpOverrideRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public RemoveIpOverrideRequest.Builder toBuilder()
```
