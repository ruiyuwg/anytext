...
# Interface ListImportJobsResponseOrBuilder (2.21.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[ImportJob](/java/docs/reference/google-cloud-kms/2.21.0/com.google.cloud.kms.v1.ImportJob)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ImportJob](/java/docs/reference/google-cloud-kms/2.21.0/com.google.cloud.kms.v1.ImportJob)>`
...
`[ImportJobOrBuilder](/java/docs/reference/google-cloud-kms/2.21.0/com.google.cloud.kms.v1.ImportJobOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.kms.v1.ImportJobOrBuilder>`
...
A token to retrieve next page of results. Pass this value in ListImportJobsRequest.page\_token to retrieve the next page of results.
