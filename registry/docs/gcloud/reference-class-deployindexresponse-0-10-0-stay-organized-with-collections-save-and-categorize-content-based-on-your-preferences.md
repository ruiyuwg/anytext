...
# Class DeployIndexResponse (0.10.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class DeployIndexResponse extends GeneratedMessageV3 implements DeployIndexResponseOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> DeployIndexResponse

## Implements

[DeployIndexResponseOrBuilder](/java/docs/reference/google-cloud-visionai/0.10.0/com.google.cloud.visionai.v1.DeployIndexResponseOrBuilder)
...
```
public static DeployIndexResponse getDefaultInstance()
```
...
`[DeployIndexResponse](/java/docs/reference/google-cloud-visionai/0.10.0/com.google.cloud.visionai.v1.DeployIndexResponse)`
...
```
public static DeployIndexResponse.Builder newBuilder()
```
...
`[DeployIndexResponse.Builder](/java/docs/reference/google-cloud-visionai/0.10.0/com.google.cloud.visionai.v1.DeployIndexResponse.Builder)`

### newBuilder(DeployIndexResponse prototype)

```
public static DeployIndexResponse.Builder newBuilder(DeployIndexResponse prototype)
```
...
```
public static DeployIndexResponse parseDelimitedFrom(InputStream input)
```
...
```
public static DeployIndexResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeployIndexResponse parseFrom(byte[] data)
```
...
```
public static DeployIndexResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeployIndexResponse parseFrom(ByteString data)
```
...
```
public static DeployIndexResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeployIndexResponse parseFrom(CodedInputStream input)
```
...
```
public static DeployIndexResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeployIndexResponse parseFrom(InputStream input)
```
...
```
public static DeployIndexResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeployIndexResponse parseFrom(ByteBuffer data)
```
...
```
public static DeployIndexResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<DeployIndexResponse> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[DeployIndexResponse](/java/docs/reference/google-cloud-visionai/0.10.0/com.google.cloud.visionai.v1.DeployIndexResponse)>`
...
```
public Parser<DeployIndexResponse> getParserForType()
```
...
```
public DeployIndexResponse.Builder newBuilderForType()
```
...
```
protected DeployIndexResponse.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public DeployIndexResponse.Builder toBuilder()
```
