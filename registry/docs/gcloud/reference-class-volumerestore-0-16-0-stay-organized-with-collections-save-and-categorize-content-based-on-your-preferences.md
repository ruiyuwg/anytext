...
# Class VolumeRestore (0.16.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> VolumeRestore

## Implements

[VolumeRestoreOrBuilder](/java/docs/reference/google-cloud-gke-backup/0.16.0/com.google.cloud.gkebackup.v1.VolumeRestoreOrBuilder)
...
`[VolumeRestore](/java/docs/reference/google-cloud-gke-backup/0.16.0/com.google.cloud.gkebackup.v1.VolumeRestore)`
...
`[VolumeRestore.Builder](/java/docs/reference/google-cloud-gke-backup/0.16.0/com.google.cloud.gkebackup.v1.VolumeRestore.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[VolumeRestore](/java/docs/reference/google-cloud-gke-backup/0.16.0/com.google.cloud.gkebackup.v1.VolumeRestore)>`
...
`[VolumeRestore.State](/java/docs/reference/google-cloud-gke-backup/0.16.0/com.google.cloud.gkebackup.v1.VolumeRestore.State)`
...
`[NamespacedName](/java/docs/reference/google-cloud-gke-backup/0.16.0/com.google.cloud.gkebackup.v1.NamespacedName)`
...
`[NamespacedNameOrBuilder](/java/docs/reference/google-cloud-gke-backup/0.16.0/com.google.cloud.gkebackup.v1.NamespacedNameOrBuilder)`
...
`[VolumeRestore.VolumeType](/java/docs/reference/google-cloud-gke-backup/0.16.0/com.google.cloud.gkebackup.v1.VolumeRestore.VolumeType)`
