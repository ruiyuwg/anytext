...
# Enum OperatingSystemFamily (0.16.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum OperatingSystemFamily extends Enum<OperatingSystemFamily> implements ProtocolMessageEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-migrationcenter/0.16.0/com.google.cloud.migrationcenter.v1.OperatingSystemFamily#com_google_cloud_migrationcenter_v1_OperatingSystemFamily_forNumber_int_) instead._
