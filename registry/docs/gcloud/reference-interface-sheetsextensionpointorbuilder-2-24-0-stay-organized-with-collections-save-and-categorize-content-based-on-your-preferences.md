...
# Interface SheetsExtensionPointOrBuilder (2.24.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface SheetsExtensionPointOrBuilder extends MessageOrBuilder
```
