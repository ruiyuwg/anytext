...
# Vertex AI v1 API - Enum DynamicRetrievalConfig.Types.Mode (3.22.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum DynamicRetrievalConfig.Types.Mode
```

Reference documentation and code samples for the Vertex AI v1 API enum DynamicRetrievalConfig.Types.Mode.
