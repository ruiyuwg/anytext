...
# Class RunAssetDiscoveryResponse (2.38.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class RunAssetDiscoveryResponse extends GeneratedMessageV3 implements RunAssetDiscoveryResponseOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> RunAssetDiscoveryResponse

## Implements

[RunAssetDiscoveryResponseOrBuilder](/java/docs/reference/google-cloud-securitycenter/2.38.0/com.google.cloud.securitycenter.v1beta1.RunAssetDiscoveryResponseOrBuilder)
...
```
public static RunAssetDiscoveryResponse getDefaultInstance()
```
...
`[RunAssetDiscoveryResponse](/java/docs/reference/google-cloud-securitycenter/2.38.0/com.google.cloud.securitycenter.v1beta1.RunAssetDiscoveryResponse)`
...
```
public static RunAssetDiscoveryResponse.Builder newBuilder()
```
...
`[RunAssetDiscoveryResponse.Builder](/java/docs/reference/google-cloud-securitycenter/2.38.0/com.google.cloud.securitycenter.v1beta1.RunAssetDiscoveryResponse.Builder)`

### newBuilder(RunAssetDiscoveryResponse prototype)

```
public static RunAssetDiscoveryResponse.Builder newBuilder(RunAssetDiscoveryResponse prototype)
```
...
```
public static RunAssetDiscoveryResponse parseDelimitedFrom(InputStream input)
```
...
```
public static RunAssetDiscoveryResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RunAssetDiscoveryResponse parseFrom(byte[] data)
```
...
```
public static RunAssetDiscoveryResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RunAssetDiscoveryResponse parseFrom(ByteString data)
```
...
```
public static RunAssetDiscoveryResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RunAssetDiscoveryResponse parseFrom(CodedInputStream input)
```
...
```
public static RunAssetDiscoveryResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RunAssetDiscoveryResponse parseFrom(InputStream input)
```
...
```
public static RunAssetDiscoveryResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RunAssetDiscoveryResponse parseFrom(ByteBuffer data)
```
...
```
public static RunAssetDiscoveryResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<RunAssetDiscoveryResponse> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[RunAssetDiscoveryResponse](/java/docs/reference/google-cloud-securitycenter/2.38.0/com.google.cloud.securitycenter.v1beta1.RunAssetDiscoveryResponse)>`
...
```
public RunAssetDiscoveryResponse getDefaultInstanceForType()
```
...
```
public Parser<RunAssetDiscoveryResponse> getParserForType()
```
...
```
public RunAssetDiscoveryResponse.State getState()
```

The state of an asset discovery run.

`.google.cloud.securitycenter.v1beta1.RunAssetDiscoveryResponse.State state = 1;`
...
`[RunAssetDiscoveryResponse.State](/java/docs/reference/google-cloud-securitycenter/2.38.0/com.google.cloud.securitycenter.v1beta1.RunAssetDiscoveryResponse.State)`
...
```
public RunAssetDiscoveryResponse.Builder newBuilderForType()
```
...
```
protected RunAssetDiscoveryResponse.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public RunAssetDiscoveryResponse.Builder toBuilder()
```
