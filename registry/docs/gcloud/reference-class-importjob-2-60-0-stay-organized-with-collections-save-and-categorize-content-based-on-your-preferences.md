...
# Class ImportJob (2.60.0) Stay organized with collections Save and categorize content based on your preferences.
...
When an ImportJob is created, Cloud KMS will generate a "wrapping key", which is a public/private key pair. You use the wrapping key to encrypt (also known as wrap) the pre-existing key material to protect it during the import process. The nature of the wrapping key depends on the choice of import\_method. When the wrapping key generation is complete, the state will be set to ACTIVE and the public\_key can be fetched. The fetched public key can then be used to wrap your pre-existing key material.
...
[ImportJobOrBuilder](/java/docs/reference/google-cloud-kms/2.60.0/com.google.cloud.kms.v1.ImportJobOrBuilder)
...
### EXPIRE\_EVENT\_TIME\_FIELD\_NUMBER
...
`[ImportJob](/java/docs/reference/google-cloud-kms/2.60.0/com.google.cloud.kms.v1.ImportJob)`
...
`[ImportJob.Builder](/java/docs/reference/google-cloud-kms/2.60.0/com.google.cloud.kms.v1.ImportJob.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ImportJob](/java/docs/reference/google-cloud-kms/2.60.0/com.google.cloud.kms.v1.ImportJob)>`
...
`[KeyOperationAttestation](/java/docs/reference/google-cloud-kms/2.60.0/com.google.cloud.kms.v1.KeyOperationAttestation)`
...
`[KeyOperationAttestationOrBuilder](/java/docs/reference/google-cloud-kms/2.60.0/com.google.cloud.kms.v1.KeyOperationAttestationOrBuilder)`
...
`[ImportJob.ImportMethod](/java/docs/reference/google-cloud-kms/2.60.0/com.google.cloud.kms.v1.ImportJob.ImportMethod)`
...
Required. Immutable. The protection level of the ImportJob. This must match the protection\_level of the version\_template on the CryptoKey you attempt to import into.
...
`[ProtectionLevel](/java/docs/reference/google-cloud-kms/2.60.0/com.google.cloud.kms.v1.ProtectionLevel)`
...
`[ImportJob.WrappingPublicKey](/java/docs/reference/google-cloud-kms/2.60.0/com.google.cloud.kms.v1.ImportJob.WrappingPublicKey)`
...
`[ImportJob.WrappingPublicKeyOrBuilder](/java/docs/reference/google-cloud-kms/2.60.0/com.google.cloud.kms.v1.ImportJob.WrappingPublicKeyOrBuilder)`
...
`[ImportJob.ImportJobState](/java/docs/reference/google-cloud-kms/2.60.0/com.google.cloud.kms.v1.ImportJob.ImportJobState)`
