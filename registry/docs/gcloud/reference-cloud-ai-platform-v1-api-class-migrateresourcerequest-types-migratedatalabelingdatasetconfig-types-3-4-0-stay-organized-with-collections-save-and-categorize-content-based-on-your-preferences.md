...
# Cloud AI Platform v1 API - Class MigrateResourceRequest.Types.MigrateDataLabelingDatasetConfig.Types (3.4.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class MigrateResourceRequest.Types.MigrateDataLabelingDatasetConfig.Types
```

Reference documentation and code samples for the Cloud AI Platform v1 API class MigrateResourceRequest.Types.MigrateDataLabelingDatasetConfig.Types.

Container for nested types declared in the MigrateDataLabelingDatasetConfig message type.

## Inheritance

[object](https://learn.microsoft.com/dotnet/api/system.object) \> MigrateResourceRequest.Types.MigrateDataLabelingDatasetConfig.Types
