...
# Class OperationMetadata (2.31.0) Stay organized with collections Save and categorize content based on your preferences.
...
Protobuf type `google.cloud.redis.v1.OperationMetadata`
...
[OperationMetadataOrBuilder](/java/docs/reference/google-cloud-redis/2.31.0/com.google.cloud.redis.v1.OperationMetadataOrBuilder)
...
`[OperationMetadata](/java/docs/reference/google-cloud-redis/2.31.0/com.google.cloud.redis.v1.OperationMetadata)`
...
`[OperationMetadata.Builder](/java/docs/reference/google-cloud-redis/2.31.0/com.google.cloud.redis.v1.OperationMetadata.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[OperationMetadata](/java/docs/reference/google-cloud-redis/2.31.0/com.google.cloud.redis.v1.OperationMetadata)>`
