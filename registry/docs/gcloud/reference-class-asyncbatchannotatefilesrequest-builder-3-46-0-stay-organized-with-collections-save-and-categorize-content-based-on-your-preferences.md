...
# Class AsyncBatchAnnotateFilesRequest.Builder (3.46.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> AsyncBatchAnnotateFilesRequest.Builder

## Implements

[AsyncBatchAnnotateFilesRequestOrBuilder](/java/docs/reference/google-cloud-vision/3.46.0/com.google.cloud.vision.v1.AsyncBatchAnnotateFilesRequestOrBuilder)
...
`[Iterable](https://docs.oracle.com/javase/8/docs/api/java/lang/Iterable.html)<? extends com.google.cloud.vision.v1.AsyncAnnotateFileRequest>`  
...
`[AsyncBatchAnnotateFilesRequest.Builder](/java/docs/reference/google-cloud-vision/3.46.0/com.google.cloud.vision.v1.AsyncBatchAnnotateFilesRequest.Builder)`
...
`[AsyncAnnotateFileRequest](/java/docs/reference/google-cloud-vision/3.46.0/com.google.cloud.vision.v1.AsyncAnnotateFileRequest)`  
...
`[AsyncAnnotateFileRequest.Builder](/java/docs/reference/google-cloud-vision/3.46.0/com.google.cloud.vision.v1.AsyncAnnotateFileRequest.Builder)`  
...
`[AsyncBatchAnnotateFilesRequest](/java/docs/reference/google-cloud-vision/3.46.0/com.google.cloud.vision.v1.AsyncBatchAnnotateFilesRequest)`
...
Use [#getLabelsMap()](/java/docs/reference/google-cloud-vision/3.46.0/com.google.cloud.vision.v1.AsyncBatchAnnotateFilesRequest.Builder#com_google_cloud_vision_v1_AsyncBatchAnnotateFilesRequest_Builder_getLabelsMap__) instead.
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Builder](/java/docs/reference/google-cloud-vision/3.46.0/com.google.cloud.vision.v1.AsyncAnnotateFileRequest.Builder)>`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[AsyncAnnotateFileRequest](/java/docs/reference/google-cloud-vision/3.46.0/com.google.cloud.vision.v1.AsyncAnnotateFileRequest)>`
...
`[AsyncAnnotateFileRequestOrBuilder](/java/docs/reference/google-cloud-vision/3.46.0/com.google.cloud.vision.v1.AsyncAnnotateFileRequestOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.vision.v1.AsyncAnnotateFileRequestOrBuilder>`
