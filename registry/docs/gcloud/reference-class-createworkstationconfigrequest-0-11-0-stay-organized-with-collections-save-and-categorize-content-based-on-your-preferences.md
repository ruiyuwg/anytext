...
# Class CreateWorkstationConfigRequest (0.11.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class CreateWorkstationConfigRequest extends GeneratedMessageV3 implements CreateWorkstationConfigRequestOrBuilder
```

Message for creating a CreateWorkstationConfig.

Protobuf type `google.cloud.workstations.v1beta.CreateWorkstationConfigRequest`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> CreateWorkstationConfigRequest

## Implements

[CreateWorkstationConfigRequestOrBuilder](/java/docs/reference/google-cloud-workstations/0.11.0/com.google.cloud.workstations.v1beta.CreateWorkstationConfigRequestOrBuilder)
...
### WORKSTATION\_CONFIG\_FIELD\_NUMBER

```
public static final int WORKSTATION_CONFIG_FIELD_NUMBER
```
...
### WORKSTATION\_CONFIG\_ID\_FIELD\_NUMBER

```
public static final int WORKSTATION_CONFIG_ID_FIELD_NUMBER
```
...
```
public static CreateWorkstationConfigRequest getDefaultInstance()
```
...
`[CreateWorkstationConfigRequest](/java/docs/reference/google-cloud-workstations/0.11.0/com.google.cloud.workstations.v1beta.CreateWorkstationConfigRequest)`
...
```
public static CreateWorkstationConfigRequest.Builder newBuilder()
```
...
`[CreateWorkstationConfigRequest.Builder](/java/docs/reference/google-cloud-workstations/0.11.0/com.google.cloud.workstations.v1beta.CreateWorkstationConfigRequest.Builder)`

### newBuilder(CreateWorkstationConfigRequest prototype)

```
public static CreateWorkstationConfigRequest.Builder newBuilder(CreateWorkstationConfigRequest prototype)
```
...
```
public static CreateWorkstationConfigRequest parseDelimitedFrom(InputStream input)
```
...
```
public static CreateWorkstationConfigRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateWorkstationConfigRequest parseFrom(byte[] data)
```
...
```
public static CreateWorkstationConfigRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateWorkstationConfigRequest parseFrom(ByteString data)
```
...
```
public static CreateWorkstationConfigRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateWorkstationConfigRequest parseFrom(CodedInputStream input)
```
...
```
public static CreateWorkstationConfigRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateWorkstationConfigRequest parseFrom(InputStream input)
```
...
```
public static CreateWorkstationConfigRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateWorkstationConfigRequest parseFrom(ByteBuffer data)
```
...
```
public static CreateWorkstationConfigRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<CreateWorkstationConfigRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[CreateWorkstationConfigRequest](/java/docs/reference/google-cloud-workstations/0.11.0/com.google.cloud.workstations.v1beta.CreateWorkstationConfigRequest)>`
...
```
public Parser<CreateWorkstationConfigRequest> getParserForType()
```
...
`[WorkstationConfig](/java/docs/reference/google-cloud-workstations/0.11.0/com.google.cloud.workstations.v1beta.WorkstationConfig)`
...
```
public ByteString getWorkstationConfigIdBytes()
```
...
`[WorkstationConfigOrBuilder](/java/docs/reference/google-cloud-workstations/0.11.0/com.google.cloud.workstations.v1beta.WorkstationConfigOrBuilder)`
...
```
public CreateWorkstationConfigRequest.Builder newBuilderForType()
```
...
```
protected CreateWorkstationConfigRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public CreateWorkstationConfigRequest.Builder toBuilder()
```
