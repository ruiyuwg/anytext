...
# Class SetFindingStateRequest (2.50.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class SetFindingStateRequest extends GeneratedMessageV3 implements SetFindingStateRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> SetFindingStateRequest

## Implements

[SetFindingStateRequestOrBuilder](/java/docs/reference/google-cloud-securitycenter/2.50.0/com.google.cloud.securitycenter.v1p1beta1.SetFindingStateRequestOrBuilder)
...
```
public static SetFindingStateRequest getDefaultInstance()
```
...
`[SetFindingStateRequest](/java/docs/reference/google-cloud-securitycenter/2.50.0/com.google.cloud.securitycenter.v1p1beta1.SetFindingStateRequest)`
...
```
public static SetFindingStateRequest.Builder newBuilder()
```
...
`[SetFindingStateRequest.Builder](/java/docs/reference/google-cloud-securitycenter/2.50.0/com.google.cloud.securitycenter.v1p1beta1.SetFindingStateRequest.Builder)`

### newBuilder(SetFindingStateRequest prototype)

```
public static SetFindingStateRequest.Builder newBuilder(SetFindingStateRequest prototype)
```
...
```
public static SetFindingStateRequest parseDelimitedFrom(InputStream input)
```
...
```
public static SetFindingStateRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SetFindingStateRequest parseFrom(byte[] data)
```
...
```
public static SetFindingStateRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SetFindingStateRequest parseFrom(ByteString data)
```
...
```
public static SetFindingStateRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SetFindingStateRequest parseFrom(CodedInputStream input)
```
...
```
public static SetFindingStateRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SetFindingStateRequest parseFrom(InputStream input)
```
...
```
public static SetFindingStateRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SetFindingStateRequest parseFrom(ByteBuffer data)
```
...
```
public static SetFindingStateRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<SetFindingStateRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[SetFindingStateRequest](/java/docs/reference/google-cloud-securitycenter/2.50.0/com.google.cloud.securitycenter.v1p1beta1.SetFindingStateRequest)>`
...
```
public Parser<SetFindingStateRequest> getParserForType()
```
...
`[Finding.State](/java/docs/reference/google-cloud-securitycenter/2.50.0/com.google.cloud.securitycenter.v1p1beta1.Finding.State)`
...
```
public SetFindingStateRequest.Builder newBuilderForType()
```
...
```
protected SetFindingStateRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public SetFindingStateRequest.Builder toBuilder()
```
