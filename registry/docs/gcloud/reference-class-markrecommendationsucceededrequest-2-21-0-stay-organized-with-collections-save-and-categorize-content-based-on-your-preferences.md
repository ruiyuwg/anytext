...
# Class MarkRecommendationSucceededRequest (2.21.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class MarkRecommendationSucceededRequest extends GeneratedMessageV3 implements MarkRecommendationSucceededRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> MarkRecommendationSucceededRequest

## Implements

[MarkRecommendationSucceededRequestOrBuilder](/java/docs/reference/google-cloud-recommender/2.21.0/com.google.cloud.recommender.v1beta1.MarkRecommendationSucceededRequestOrBuilder)
...
### STATE\_METADATA\_FIELD\_NUMBER
...
```
public static MarkRecommendationSucceededRequest getDefaultInstance()
```
...
`[MarkRecommendationSucceededRequest](/java/docs/reference/google-cloud-recommender/2.21.0/com.google.cloud.recommender.v1beta1.MarkRecommendationSucceededRequest)`
...
```
public static MarkRecommendationSucceededRequest.Builder newBuilder()
```
...
`[MarkRecommendationSucceededRequest.Builder](/java/docs/reference/google-cloud-recommender/2.21.0/com.google.cloud.recommender.v1beta1.MarkRecommendationSucceededRequest.Builder)`

### newBuilder(MarkRecommendationSucceededRequest prototype)

```
public static MarkRecommendationSucceededRequest.Builder newBuilder(MarkRecommendationSucceededRequest prototype)
```
...
```
public static MarkRecommendationSucceededRequest parseDelimitedFrom(InputStream input)
```
...
```
public static MarkRecommendationSucceededRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static MarkRecommendationSucceededRequest parseFrom(byte[] data)
```
...
```
public static MarkRecommendationSucceededRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static MarkRecommendationSucceededRequest parseFrom(ByteString data)
```
...
```
public static MarkRecommendationSucceededRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static MarkRecommendationSucceededRequest parseFrom(CodedInputStream input)
```
...
```
public static MarkRecommendationSucceededRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static MarkRecommendationSucceededRequest parseFrom(InputStream input)
```
...
```
public static MarkRecommendationSucceededRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static MarkRecommendationSucceededRequest parseFrom(ByteBuffer data)
```
...
```
public static MarkRecommendationSucceededRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<MarkRecommendationSucceededRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[MarkRecommendationSucceededRequest](/java/docs/reference/google-cloud-recommender/2.21.0/com.google.cloud.recommender.v1beta1.MarkRecommendationSucceededRequest)>`
...
```
public MarkRecommendationSucceededRequest getDefaultInstanceForType()
```
...
```
public Parser<MarkRecommendationSucceededRequest> getParserForType()
```
...
Use [#getStateMetadataMap()](/java/docs/reference/google-cloud-recommender/2.21.0/com.google.cloud.recommender.v1beta1.MarkRecommendationSucceededRequest#com_google_cloud_recommender_v1beta1_MarkRecommendationSucceededRequest_getStateMetadataMap__) instead.
...
```
public MarkRecommendationSucceededRequest.Builder newBuilderForType()
```
...
```
protected MarkRecommendationSucceededRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public MarkRecommendationSucceededRequest.Builder toBuilder()
```
