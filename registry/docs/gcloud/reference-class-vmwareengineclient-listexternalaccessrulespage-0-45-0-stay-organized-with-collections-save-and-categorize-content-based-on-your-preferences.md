...
# Class VmwareEngineClient.ListExternalAccessRulesPage (0.45.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class VmwareEngineClient.ListExternalAccessRulesPage extends AbstractPage<ListExternalAccessRulesRequest,ListExternalAccessRulesResponse,ExternalAccessRule,VmwareEngineClient.ListExternalAccessRulesPage>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractPage](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractPage.html) \> VmwareEngineClient.ListExternalAccessRulesPage
...
### createPage(PageContext<ListExternalAccessRulesRequest,ListExternalAccessRulesResponse,ExternalAccessRule> context, ListExternalAccessRulesResponse response)

```
protected VmwareEngineClient.ListExternalAccessRulesPage createPage(PageContext<ListExternalAccessRulesRequest,ListExternalAccessRulesResponse,ExternalAccessRule> context, ListExternalAccessRulesResponse response)
```
...
`[PageContext](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PageContext.html)<[ListExternalAccessRulesRequest](/java/docs/reference/google-cloud-vmwareengine/0.45.0/com.google.cloud.vmwareengine.v1.ListExternalAccessRulesRequest),[ListExternalAccessRulesResponse](/java/docs/reference/google-cloud-vmwareengine/0.45.0/com.google.cloud.vmwareengine.v1.ListExternalAccessRulesResponse),[ExternalAccessRule](/java/docs/reference/google-cloud-vmwareengine/0.45.0/com.google.cloud.vmwareengine.v1.ExternalAccessRule)>`  

`response`

`[ListExternalAccessRulesResponse](/java/docs/reference/google-cloud-vmwareengine/0.45.0/com.google.cloud.vmwareengine.v1.ListExternalAccessRulesResponse)`  
...
`[VmwareEngineClient.ListExternalAccessRulesPage](/java/docs/reference/google-cloud-vmwareengine/0.45.0/com.google.cloud.vmwareengine.v1.VmwareEngineClient.ListExternalAccessRulesPage)`
...
### createPageAsync(PageContext<ListExternalAccessRulesRequest,ListExternalAccessRulesResponse,ExternalAccessRule> context, ApiFuture<ListExternalAccessRulesResponse> futureResponse)

```
public ApiFuture<VmwareEngineClient.ListExternalAccessRulesPage> createPageAsync(PageContext<ListExternalAccessRulesRequest,ListExternalAccessRulesResponse,ExternalAccessRule> context, ApiFuture<ListExternalAccessRulesResponse> futureResponse)
```
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListExternalAccessRulesResponse](/java/docs/reference/google-cloud-vmwareengine/0.45.0/com.google.cloud.vmwareengine.v1.ListExternalAccessRulesResponse)>`  
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListExternalAccessRulesPage](/java/docs/reference/google-cloud-vmwareengine/0.45.0/com.google.cloud.vmwareengine.v1.VmwareEngineClient.ListExternalAccessRulesPage)>`
