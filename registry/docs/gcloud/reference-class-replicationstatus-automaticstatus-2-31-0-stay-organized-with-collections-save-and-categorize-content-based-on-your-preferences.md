...
# Class ReplicationStatus.AutomaticStatus (2.31.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class ReplicationStatus.AutomaticStatus extends GeneratedMessageV3 implements ReplicationStatus.AutomaticStatusOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ReplicationStatus.AutomaticStatus

## Implements

[ReplicationStatus.AutomaticStatusOrBuilder](/java/docs/reference/google-cloud-secretmanager/2.31.0/com.google.cloud.secretmanager.v1.ReplicationStatus.AutomaticStatusOrBuilder)
...
```
public static ReplicationStatus.AutomaticStatus getDefaultInstance()
```
...
`[ReplicationStatus.AutomaticStatus](/java/docs/reference/google-cloud-secretmanager/2.31.0/com.google.cloud.secretmanager.v1.ReplicationStatus.AutomaticStatus)`
...
```
public static ReplicationStatus.AutomaticStatus.Builder newBuilder()
```
...
`[ReplicationStatus.AutomaticStatus.Builder](/java/docs/reference/google-cloud-secretmanager/2.31.0/com.google.cloud.secretmanager.v1.ReplicationStatus.AutomaticStatus.Builder)`

### newBuilder(ReplicationStatus.AutomaticStatus prototype)

```
public static ReplicationStatus.AutomaticStatus.Builder newBuilder(ReplicationStatus.AutomaticStatus prototype)
```
...
```
public static ReplicationStatus.AutomaticStatus parseDelimitedFrom(InputStream input)
```
...
```
public static ReplicationStatus.AutomaticStatus parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ReplicationStatus.AutomaticStatus parseFrom(byte[] data)
```
...
```
public static ReplicationStatus.AutomaticStatus parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ReplicationStatus.AutomaticStatus parseFrom(ByteString data)
```
...
```
public static ReplicationStatus.AutomaticStatus parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ReplicationStatus.AutomaticStatus parseFrom(CodedInputStream input)
```
...
```
public static ReplicationStatus.AutomaticStatus parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ReplicationStatus.AutomaticStatus parseFrom(InputStream input)
```
...
```
public static ReplicationStatus.AutomaticStatus parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ReplicationStatus.AutomaticStatus parseFrom(ByteBuffer data)
```
...
```
public static ReplicationStatus.AutomaticStatus parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ReplicationStatus.AutomaticStatus> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[AutomaticStatus](/java/docs/reference/google-cloud-secretmanager/2.31.0/com.google.cloud.secretmanager.v1.ReplicationStatus.AutomaticStatus)>`
...
`[CustomerManagedEncryptionStatus](/java/docs/reference/google-cloud-secretmanager/2.31.0/com.google.cloud.secretmanager.v1.CustomerManagedEncryptionStatus)`
...
`[CustomerManagedEncryptionStatusOrBuilder](/java/docs/reference/google-cloud-secretmanager/2.31.0/com.google.cloud.secretmanager.v1.CustomerManagedEncryptionStatusOrBuilder)`
...
```
public Parser<ReplicationStatus.AutomaticStatus> getParserForType()
```
...
```
public ReplicationStatus.AutomaticStatus.Builder newBuilderForType()
```
...
```
protected ReplicationStatus.AutomaticStatus.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ReplicationStatus.AutomaticStatus.Builder toBuilder()
```
