...
# Class AccountDefenderAssessment (3.51.0) Stay organized with collections Save and categorize content based on your preferences.
...
Protobuf type `google.cloud.recaptchaenterprise.v1beta1.AccountDefenderAssessment`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> AccountDefenderAssessment

## Implements

[AccountDefenderAssessmentOrBuilder](/java/docs/reference/google-cloud-recaptchaenterprise/3.51.0/com.google.recaptchaenterprise.v1beta1.AccountDefenderAssessmentOrBuilder)
...
`[AccountDefenderAssessment](/java/docs/reference/google-cloud-recaptchaenterprise/3.51.0/com.google.recaptchaenterprise.v1beta1.AccountDefenderAssessment)`
...
```
public static AccountDefenderAssessment.Builder newBuilder()
```
...
`[AccountDefenderAssessment.Builder](/java/docs/reference/google-cloud-recaptchaenterprise/3.51.0/com.google.recaptchaenterprise.v1beta1.AccountDefenderAssessment.Builder)`

### newBuilder(AccountDefenderAssessment prototype)

```
public static AccountDefenderAssessment.Builder newBuilder(AccountDefenderAssessment prototype)
```
...
```
public static AccountDefenderAssessment parseDelimitedFrom(InputStream input)
```
...
```
public static AccountDefenderAssessment parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AccountDefenderAssessment parseFrom(byte[] data)
```
...
```
public static AccountDefenderAssessment parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AccountDefenderAssessment parseFrom(ByteString data)
```
...
```
public static AccountDefenderAssessment parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AccountDefenderAssessment parseFrom(CodedInputStream input)
```
...
```
public static AccountDefenderAssessment parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AccountDefenderAssessment parseFrom(InputStream input)
```
...
```
public static AccountDefenderAssessment parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AccountDefenderAssessment parseFrom(ByteBuffer data)
```
...
```
public static AccountDefenderAssessment parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[AccountDefenderAssessment](/java/docs/reference/google-cloud-recaptchaenterprise/3.51.0/com.google.recaptchaenterprise.v1beta1.AccountDefenderAssessment)>`
...
```
public AccountDefenderAssessment getDefaultInstanceForType()
```
...
```
public AccountDefenderAssessment.AccountDefenderLabel getLabels(int index)
```
...
`[AccountDefenderAssessment.AccountDefenderLabel](/java/docs/reference/google-cloud-recaptchaenterprise/3.51.0/com.google.recaptchaenterprise.v1beta1.AccountDefenderAssessment.AccountDefenderLabel)`
...
```
public List<AccountDefenderAssessment.AccountDefenderLabel> getLabelsList()
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[AccountDefenderLabel](/java/docs/reference/google-cloud-recaptchaenterprise/3.51.0/com.google.recaptchaenterprise.v1beta1.AccountDefenderAssessment.AccountDefenderLabel)>`
...
```
public AccountDefenderAssessment.Builder newBuilderForType()
```
...
```
protected AccountDefenderAssessment.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public AccountDefenderAssessment.Builder toBuilder()
```
