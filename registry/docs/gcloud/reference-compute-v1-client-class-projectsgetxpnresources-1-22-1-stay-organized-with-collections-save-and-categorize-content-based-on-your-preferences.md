...
# Compute V1 Client - Class ProjectsGetXpnResources (1.22.1) Stay organized with collections Save and categorize content based on your preferences.
...
`array<[XpnResourceId](/php/docs/reference/cloud-compute/1.22.1/V1.XpnResourceId)>`  
