...
# google-cloud-vision overview (3.85.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Cloud Vision Description:** Allows developers to easily integrate vision detection features within applications, including image labeling, face and landmark detection, optical character recognition (OCR), and tagging of explicit content.

[Cloud Vision Product Reference](https://cloud.google.com/vision/docs/)

[GitHub Repository](https://github.com/googleapis/google-cloud-java/tree/main/java-vision)

[Maven artifact](https://central.sonatype.com/artifact/com.google.cloud/google-cloud-vision)
...
-   [Enable the API](https://console.cloud.google.com/apis/library/vision.googleapis.com)
-   [Set up authentication](https://cloud.google.com/docs/authentication/client-libraries)

## Use the Cloud Vision for Java
...
The example below demonstrates how you would import the BOM and include the `google-cloud-vision` artifact.
...
For this library, we recommend using [com.google.cloud.vision.v1](https://cloud.google.com/java/docs/reference/google-cloud-vision/3.85.0/com.google.cloud.vision.v1) for new applications.
