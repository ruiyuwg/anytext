...
# Class AwsProxyConfig (0.86.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class AwsProxyConfig extends GeneratedMessage implements AwsProxyConfigOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessage.html) \> AwsProxyConfig

## Implements

[AwsProxyConfigOrBuilder](/java/docs/reference/google-cloud-gke-multi-cloud/latest/com.google.cloud.gkemulticloud.v1.AwsProxyConfigOrBuilder)
...
### SECRET\_ARN\_FIELD\_NUMBER (deprecated)
...
### SECRET\_VERSION\_FIELD\_NUMBER (deprecated)
...
`[AwsProxyConfig](/java/docs/reference/google-cloud-gke-multi-cloud/latest/com.google.cloud.gkemulticloud.v1.AwsProxyConfig)`
...
`[AwsProxyConfig.Builder](/java/docs/reference/google-cloud-gke-multi-cloud/latest/com.google.cloud.gkemulticloud.v1.AwsProxyConfig.Builder)`

### newBuilder(AwsProxyConfig prototype) (deprecated)
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[AwsProxyConfig](/java/docs/reference/google-cloud-gke-multi-cloud/latest/com.google.cloud.gkemulticloud.v1.AwsProxyConfig)>`
...
```
protected AwsProxyConfig.Builder newBuilderForType(AbstractMessage.BuilderParent parent)
```
