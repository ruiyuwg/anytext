...
# Class SubmitUriMetadata (2.19.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class SubmitUriMetadata extends GeneratedMessageV3 implements SubmitUriMetadataOrBuilder
```

Metadata for the Submit URI long-running operation. option (google.api.message\_visibility).restriction = "TRUSTED\_TESTER";

Protobuf type `google.cloud.webrisk.v1.SubmitUriMetadata`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> SubmitUriMetadata

## Implements

[SubmitUriMetadataOrBuilder](/java/docs/reference/google-cloud-webrisk/2.19.0/com.google.webrisk.v1.SubmitUriMetadataOrBuilder)
...
```
public static SubmitUriMetadata getDefaultInstance()
```
...
`[SubmitUriMetadata](/java/docs/reference/google-cloud-webrisk/2.19.0/com.google.webrisk.v1.SubmitUriMetadata)`
...
```
public static SubmitUriMetadata.Builder newBuilder()
```
...
`[SubmitUriMetadata.Builder](/java/docs/reference/google-cloud-webrisk/2.19.0/com.google.webrisk.v1.SubmitUriMetadata.Builder)`

### newBuilder(SubmitUriMetadata prototype)

```
public static SubmitUriMetadata.Builder newBuilder(SubmitUriMetadata prototype)
```
...
```
public static SubmitUriMetadata parseDelimitedFrom(InputStream input)
```
...
```
public static SubmitUriMetadata parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SubmitUriMetadata parseFrom(byte[] data)
```
...
```
public static SubmitUriMetadata parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SubmitUriMetadata parseFrom(ByteString data)
```
...
```
public static SubmitUriMetadata parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SubmitUriMetadata parseFrom(CodedInputStream input)
```
...
```
public static SubmitUriMetadata parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SubmitUriMetadata parseFrom(InputStream input)
```
...
```
public static SubmitUriMetadata parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SubmitUriMetadata parseFrom(ByteBuffer data)
```
...
```
public static SubmitUriMetadata parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<SubmitUriMetadata> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[SubmitUriMetadata](/java/docs/reference/google-cloud-webrisk/2.19.0/com.google.webrisk.v1.SubmitUriMetadata)>`
...
```
public SubmitUriMetadata getDefaultInstanceForType()
```
...
```
public Parser<SubmitUriMetadata> getParserForType()
```
...
```
public SubmitUriMetadata.State getState()
```
...
`[SubmitUriMetadata.State](/java/docs/reference/google-cloud-webrisk/2.19.0/com.google.webrisk.v1.SubmitUriMetadata.State)`
...
```
public SubmitUriMetadata.Builder newBuilderForType()
```
...
```
protected SubmitUriMetadata.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public SubmitUriMetadata.Builder toBuilder()
```
