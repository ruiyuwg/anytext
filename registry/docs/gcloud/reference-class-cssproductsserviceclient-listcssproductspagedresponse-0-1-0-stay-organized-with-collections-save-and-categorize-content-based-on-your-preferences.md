...
# Class CssProductsServiceClient.ListCssProductsPagedResponse (0.1.0) Stay organized with collections Save and categorize content based on your preferences.
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractPagedListResponse](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractPagedListResponse.html) \> CssProductsServiceClient.ListCssProductsPagedResponse
...
`[PageContext](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PageContext.html)<[ListCssProductsRequest](/java/docs/reference/google-shopping-css/0.1.0/com.google.shopping.css.v1.ListCssProductsRequest),[ListCssProductsResponse](/java/docs/reference/google-shopping-css/0.1.0/com.google.shopping.css.v1.ListCssProductsResponse),[CssProduct](/java/docs/reference/google-shopping-css/0.1.0/com.google.shopping.css.v1.CssProduct)>`  

`futureResponse`

`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListCssProductsResponse](/java/docs/reference/google-shopping-css/0.1.0/com.google.shopping.css.v1.ListCssProductsResponse)>`  
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListCssProductsPagedResponse](/java/docs/reference/google-shopping-css/0.1.0/com.google.shopping.css.v1.CssProductsServiceClient.ListCssProductsPagedResponse)>`
