...
# Enum DSSEAttestationOccurrence.DecodedPayloadCase (2.30.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum DSSEAttestationOccurrence.DecodedPayloadCase extends Enum<DSSEAttestationOccurrence.DecodedPayloadCase> implements Internal.EnumLite, AbstractMessageLite.InternalOneOfEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/grafeas/2.30.0/io.grafeas.v1.DSSEAttestationOccurrence.DecodedPayloadCase#io_grafeas_v1_DSSEAttestationOccurrence_DecodedPayloadCase_forNumber_int_) instead._
