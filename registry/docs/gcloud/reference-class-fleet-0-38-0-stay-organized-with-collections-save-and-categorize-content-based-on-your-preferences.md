...
# Class Fleet (0.38.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class Fleet extends GeneratedMessageV3 implements FleetOrBuilder
```
...
`[Fleet](/java/docs/reference/google-cloud-gke-multi-cloud/0.38.0/com.google.cloud.gkemulticloud.v1.Fleet)`
...
`[Fleet.Builder](/java/docs/reference/google-cloud-gke-multi-cloud/0.38.0/com.google.cloud.gkemulticloud.v1.Fleet.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[Fleet](/java/docs/reference/google-cloud-gke-multi-cloud/0.38.0/com.google.cloud.gkemulticloud.v1.Fleet)>`
...
```
protected Fleet.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
