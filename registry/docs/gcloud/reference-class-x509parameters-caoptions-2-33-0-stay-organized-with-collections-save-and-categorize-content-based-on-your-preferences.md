...
# Class X509Parameters.CaOptions (2.33.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class X509Parameters.CaOptions extends GeneratedMessageV3 implements X509Parameters.CaOptionsOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> X509Parameters.CaOptions

## Implements

[X509Parameters.CaOptionsOrBuilder](/java/docs/reference/google-cloud-security-private-ca/2.33.0/com.google.cloud.security.privateca.v1.X509Parameters.CaOptionsOrBuilder)
...
### IS\_CA\_FIELD\_NUMBER

```
public static final int IS_CA_FIELD_NUMBER
```
...
### MAX\_ISSUER\_PATH\_LENGTH\_FIELD\_NUMBER

```
public static final int MAX_ISSUER_PATH_LENGTH_FIELD_NUMBER
```
...
```
public static X509Parameters.CaOptions getDefaultInstance()
```
...
`[X509Parameters.CaOptions](/java/docs/reference/google-cloud-security-private-ca/2.33.0/com.google.cloud.security.privateca.v1.X509Parameters.CaOptions)`
...
```
public static X509Parameters.CaOptions.Builder newBuilder()
```
...
`[X509Parameters.CaOptions.Builder](/java/docs/reference/google-cloud-security-private-ca/2.33.0/com.google.cloud.security.privateca.v1.X509Parameters.CaOptions.Builder)`

### newBuilder(X509Parameters.CaOptions prototype)

```
public static X509Parameters.CaOptions.Builder newBuilder(X509Parameters.CaOptions prototype)
```
...
```
public static X509Parameters.CaOptions parseDelimitedFrom(InputStream input)
```
...
```
public static X509Parameters.CaOptions parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static X509Parameters.CaOptions parseFrom(byte[] data)
```
...
```
public static X509Parameters.CaOptions parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static X509Parameters.CaOptions parseFrom(ByteString data)
```
...
```
public static X509Parameters.CaOptions parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static X509Parameters.CaOptions parseFrom(CodedInputStream input)
```
...
```
public static X509Parameters.CaOptions parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static X509Parameters.CaOptions parseFrom(InputStream input)
```
...
```
public static X509Parameters.CaOptions parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static X509Parameters.CaOptions parseFrom(ByteBuffer data)
```
...
```
public static X509Parameters.CaOptions parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<X509Parameters.CaOptions> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[CaOptions](/java/docs/reference/google-cloud-security-private-ca/2.33.0/com.google.cloud.security.privateca.v1.X509Parameters.CaOptions)>`
...
```
public Parser<X509Parameters.CaOptions> getParserForType()
```
...
```
public X509Parameters.CaOptions.Builder newBuilderForType()
```
...
```
protected X509Parameters.CaOptions.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public X509Parameters.CaOptions.Builder toBuilder()
```
