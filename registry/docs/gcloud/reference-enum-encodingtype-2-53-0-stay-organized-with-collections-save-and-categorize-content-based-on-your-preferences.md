...
# Enum EncodingType (2.53.0) Stay organized with collections Save and categorize content based on your preferences.
...
Protobuf enum `google.cloud.language.v1.EncodingType`
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-language/2.53.0/com.google.cloud.language.v1.EncodingType#com_google_cloud_language_v1_EncodingType_forNumber_int_) instead._
