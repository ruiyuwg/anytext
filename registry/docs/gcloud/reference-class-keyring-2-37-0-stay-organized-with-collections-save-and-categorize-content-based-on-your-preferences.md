...
# Class KeyRing (2.37.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class KeyRing extends GeneratedMessageV3 implements KeyRingOrBuilder
```
...
```
public static KeyRing getDefaultInstance()
```
...
`[KeyRing](/java/docs/reference/google-cloud-kms/2.37.0/com.google.cloud.kms.v1.KeyRing)`
...
```
public static KeyRing.Builder newBuilder()
```
...
`[KeyRing.Builder](/java/docs/reference/google-cloud-kms/2.37.0/com.google.cloud.kms.v1.KeyRing.Builder)`

### newBuilder(KeyRing prototype)

```
public static KeyRing.Builder newBuilder(KeyRing prototype)
```
...
```
public static KeyRing parseDelimitedFrom(InputStream input)
```
...
```
public static KeyRing parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static KeyRing parseFrom(byte[] data)
```
...
```
public static KeyRing parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static KeyRing parseFrom(ByteString data)
```
...
```
public static KeyRing parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static KeyRing parseFrom(CodedInputStream input)
```
...
```
public static KeyRing parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static KeyRing parseFrom(InputStream input)
```
...
```
public static KeyRing parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static KeyRing parseFrom(ByteBuffer data)
```
...
```
public static KeyRing parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<KeyRing> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[KeyRing](/java/docs/reference/google-cloud-kms/2.37.0/com.google.cloud.kms.v1.KeyRing)>`
...
```
public Parser<KeyRing> getParserForType()
```
...
```
public KeyRing.Builder newBuilderForType()
```
...
```
protected KeyRing.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public KeyRing.Builder toBuilder()
```
