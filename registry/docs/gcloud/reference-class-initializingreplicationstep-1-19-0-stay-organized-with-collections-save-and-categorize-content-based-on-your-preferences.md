...
# Class InitializingReplicationStep (1.19.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class InitializingReplicationStep extends GeneratedMessageV3 implements InitializingReplicationStepOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> InitializingReplicationStep

## Implements

[InitializingReplicationStepOrBuilder](/java/docs/reference/google-cloud-vmmigration/1.19.0/com.google.cloud.vmmigration.v1.InitializingReplicationStepOrBuilder)
...
```
public static InitializingReplicationStep getDefaultInstance()
```
...
`[InitializingReplicationStep](/java/docs/reference/google-cloud-vmmigration/1.19.0/com.google.cloud.vmmigration.v1.InitializingReplicationStep)`
...
```
public static InitializingReplicationStep.Builder newBuilder()
```
...
`[InitializingReplicationStep.Builder](/java/docs/reference/google-cloud-vmmigration/1.19.0/com.google.cloud.vmmigration.v1.InitializingReplicationStep.Builder)`

### newBuilder(InitializingReplicationStep prototype)

```
public static InitializingReplicationStep.Builder newBuilder(InitializingReplicationStep prototype)
```
...
```
public static InitializingReplicationStep parseDelimitedFrom(InputStream input)
```
...
```
public static InitializingReplicationStep parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static InitializingReplicationStep parseFrom(byte[] data)
```
...
```
public static InitializingReplicationStep parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static InitializingReplicationStep parseFrom(ByteString data)
```
...
```
public static InitializingReplicationStep parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static InitializingReplicationStep parseFrom(CodedInputStream input)
```
...
```
public static InitializingReplicationStep parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static InitializingReplicationStep parseFrom(InputStream input)
```
...
```
public static InitializingReplicationStep parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static InitializingReplicationStep parseFrom(ByteBuffer data)
```
...
```
public static InitializingReplicationStep parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<InitializingReplicationStep> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[InitializingReplicationStep](/java/docs/reference/google-cloud-vmmigration/1.19.0/com.google.cloud.vmmigration.v1.InitializingReplicationStep)>`
...
```
public InitializingReplicationStep getDefaultInstanceForType()
```
...
```
public Parser<InitializingReplicationStep> getParserForType()
```
...
```
public InitializingReplicationStep.Builder newBuilderForType()
```
...
```
protected InitializingReplicationStep.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public InitializingReplicationStep.Builder toBuilder()
```
