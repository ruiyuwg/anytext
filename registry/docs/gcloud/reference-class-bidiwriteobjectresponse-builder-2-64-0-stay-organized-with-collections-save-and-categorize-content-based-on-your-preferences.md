...
# Class BidiWriteObjectResponse.Builder (2.64.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class BidiWriteObjectResponse.Builder extends GeneratedMessage.Builder<BidiWriteObjectResponse.Builder> implements BidiWriteObjectResponseOrBuilder
```
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessage.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessage.Builder.html) \> BidiWriteObjectResponse.Builder

## Implements

[BidiWriteObjectResponseOrBuilder](/java/docs/reference/google-cloud-storage/latest/com.google.storage.v2.BidiWriteObjectResponseOrBuilder)
...
`[BidiWriteObjectResponse](/java/docs/reference/google-cloud-storage/latest/com.google.storage.v2.BidiWriteObjectResponse)`
...
`[BidiWriteObjectResponse.Builder](/java/docs/reference/google-cloud-storage/latest/com.google.storage.v2.BidiWriteObjectResponse.Builder)`
...
An optional write handle that is returned periodically in response messages. Clients should save it for later use in establishing a new stream if a connection is interrupted.
...
`[Object](/java/docs/reference/google-cloud-storage/latest/com.google.storage.v2.Object)`
...
`[Object.Builder](/java/docs/reference/google-cloud-storage/latest/com.google.storage.v2.Object.Builder)`
...
`[ObjectOrBuilder](/java/docs/reference/google-cloud-storage/latest/com.google.storage.v2.ObjectOrBuilder)`
...
`[BidiWriteHandle](/java/docs/reference/google-cloud-storage/latest/com.google.storage.v2.BidiWriteHandle)`
...
`[BidiWriteHandle.Builder](/java/docs/reference/google-cloud-storage/latest/com.google.storage.v2.BidiWriteHandle.Builder)`
...
`[BidiWriteHandleOrBuilder](/java/docs/reference/google-cloud-storage/latest/com.google.storage.v2.BidiWriteHandleOrBuilder)`
...
`[BidiWriteObjectResponse.WriteStatusCase](/java/docs/reference/google-cloud-storage/latest/com.google.storage.v2.BidiWriteObjectResponse.WriteStatusCase)`
