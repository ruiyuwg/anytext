...
# Google Cloud Ai Platform V1 Client - Class FeatureGroup (1.18.0) Stay organized with collections Save and categorize content based on your preferences.
...
Generated from protobuf message `google.cloud.aiplatform.v1.FeatureView.FeatureRegistrySource.FeatureGroup`
