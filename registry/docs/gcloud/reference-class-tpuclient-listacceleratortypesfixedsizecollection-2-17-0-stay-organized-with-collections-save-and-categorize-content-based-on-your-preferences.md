...
# Class TpuClient.ListAcceleratorTypesFixedSizeCollection (2.17.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class TpuClient.ListAcceleratorTypesFixedSizeCollection extends AbstractFixedSizeCollection<ListAcceleratorTypesRequest,ListAcceleratorTypesResponse,AcceleratorType,TpuClient.ListAcceleratorTypesPage,TpuClient.ListAcceleratorTypesFixedSizeCollection>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractFixedSizeCollection](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractFixedSizeCollection.html) \> TpuClient.ListAcceleratorTypesFixedSizeCollection
...
### createCollection(List<TpuClient.ListAcceleratorTypesPage> pages, int collectionSize)

```
protected TpuClient.ListAcceleratorTypesFixedSizeCollection createCollection(List<TpuClient.ListAcceleratorTypesPage> pages, int collectionSize)
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ListAcceleratorTypesPage](/java/docs/reference/google-cloud-tpu/2.17.0/com.google.cloud.tpu.v1.TpuClient.ListAcceleratorTypesPage)>`  
...
`[TpuClient.ListAcceleratorTypesFixedSizeCollection](/java/docs/reference/google-cloud-tpu/2.17.0/com.google.cloud.tpu.v1.TpuClient.ListAcceleratorTypesFixedSizeCollection)`
