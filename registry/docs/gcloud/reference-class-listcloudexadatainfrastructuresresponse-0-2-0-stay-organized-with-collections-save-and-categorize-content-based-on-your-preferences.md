...
# Class ListCloudExadataInfrastructuresResponse (0.2.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListCloudExadataInfrastructuresResponse

## Implements

[ListCloudExadataInfrastructuresResponseOrBuilder](/java/docs/reference/google-cloud-oracledatabase/0.2.0/com.google.cloud.oracledatabase.v1.ListCloudExadataInfrastructuresResponseOrBuilder)
...
### CLOUD\_EXADATA\_INFRASTRUCTURES\_FIELD\_NUMBER

```
public static final int CLOUD_EXADATA_INFRASTRUCTURES_FIELD_NUMBER
```
...
`[ListCloudExadataInfrastructuresResponse](/java/docs/reference/google-cloud-oracledatabase/0.2.0/com.google.cloud.oracledatabase.v1.ListCloudExadataInfrastructuresResponse)`
...
```
public static ListCloudExadataInfrastructuresResponse.Builder newBuilder()
```
...
`[ListCloudExadataInfrastructuresResponse.Builder](/java/docs/reference/google-cloud-oracledatabase/0.2.0/com.google.cloud.oracledatabase.v1.ListCloudExadataInfrastructuresResponse.Builder)`

### newBuilder(ListCloudExadataInfrastructuresResponse prototype)

```
public static ListCloudExadataInfrastructuresResponse.Builder newBuilder(ListCloudExadataInfrastructuresResponse prototype)
```
...
```
public static ListCloudExadataInfrastructuresResponse parseDelimitedFrom(InputStream input)
```
...
```
public static ListCloudExadataInfrastructuresResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListCloudExadataInfrastructuresResponse parseFrom(byte[] data)
```
...
```
public static ListCloudExadataInfrastructuresResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListCloudExadataInfrastructuresResponse parseFrom(ByteString data)
```
...
```
public static ListCloudExadataInfrastructuresResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListCloudExadataInfrastructuresResponse parseFrom(CodedInputStream input)
```
...
```
public static ListCloudExadataInfrastructuresResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListCloudExadataInfrastructuresResponse parseFrom(InputStream input)
```
...
```
public static ListCloudExadataInfrastructuresResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListCloudExadataInfrastructuresResponse parseFrom(ByteBuffer data)
```
...
```
public static ListCloudExadataInfrastructuresResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListCloudExadataInfrastructuresResponse](/java/docs/reference/google-cloud-oracledatabase/0.2.0/com.google.cloud.oracledatabase.v1.ListCloudExadataInfrastructuresResponse)>`
...
`[CloudExadataInfrastructure](/java/docs/reference/google-cloud-oracledatabase/0.2.0/com.google.cloud.oracledatabase.v1.CloudExadataInfrastructure)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[CloudExadataInfrastructure](/java/docs/reference/google-cloud-oracledatabase/0.2.0/com.google.cloud.oracledatabase.v1.CloudExadataInfrastructure)>`
...
`[CloudExadataInfrastructureOrBuilder](/java/docs/reference/google-cloud-oracledatabase/0.2.0/com.google.cloud.oracledatabase.v1.CloudExadataInfrastructureOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.oracledatabase.v1.CloudExadataInfrastructureOrBuilder>`
...
```
public ListCloudExadataInfrastructuresResponse.Builder newBuilderForType()
```
...
```
protected ListCloudExadataInfrastructuresResponse.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ListCloudExadataInfrastructuresResponse.Builder toBuilder()
```
