...
# Enum OnPremCluster.ClusterType (1.6.0) Stay organized with collections Save and categorize content based on your preferences.
...
CLUSTERTYPE\_UNSPECIFIED

The ClusterType is not set.

`CLUSTERTYPE_UNSPECIFIED = 0;`

CLUSTERTYPE\_UNSPECIFIED\_VALUE
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-gkehub/1.6.0/com.google.cloud.gkehub.v1beta1.OnPremCluster.ClusterType#com_google_cloud_gkehub_v1beta1_OnPremCluster_ClusterType_forNumber_int_) instead._
