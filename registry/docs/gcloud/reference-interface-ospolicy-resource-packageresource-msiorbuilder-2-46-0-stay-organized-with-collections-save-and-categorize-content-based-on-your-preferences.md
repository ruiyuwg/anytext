...
# Interface OSPolicy.Resource.PackageResource.MSIOrBuilder (2.46.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[OSPolicy.Resource.File](/java/docs/reference/google-cloud-os-config/2.46.0/com.google.cloud.osconfig.v1.OSPolicy.Resource.File)`
...
`[OSPolicy.Resource.FileOrBuilder](/java/docs/reference/google-cloud-os-config/2.46.0/com.google.cloud.osconfig.v1.OSPolicy.Resource.FileOrBuilder)`
