...
# Class PublisherLimitedTimeRetryPolicy (2.36.0) Stay organized with collections Save and categorize content based on your preferences.
...
### PublisherLimitedTimeRetryPolicy(std::chrono::duration< DurationRep, DurationPeriod >)
...
### PublisherLimitedTimeRetryPolicy(PublisherLimitedTimeRetryPolicy &&)
...
### PublisherLimitedTimeRetryPolicy(PublisherLimitedTimeRetryPolicy const &)
...
`PublisherLimitedTimeRetryPolicy const &`  
...
`std::unique_ptr< PublisherRetryPolicy >`

## Type Aliases

### BaseType

**Alias Of**: `PublisherRetryPolicy`
