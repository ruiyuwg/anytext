...
# Class CompanyServiceStubSettings (2.14.0) Stay organized with collections Save and categorize content based on your preferences.
...
Settings class to configure an instance of [CompanyServiceStub](/java/docs/reference/google-cloud-talent/2.14.0/com.google.cloud.talent.v4.stub.CompanyServiceStub).
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [StubSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.StubSettings.html) \> CompanyServiceStubSettings
...
```
public static CompanyServiceStubSettings.Builder newBuilder()
```
...
`[CompanyServiceStubSettings.Builder](/java/docs/reference/google-cloud-talent/2.14.0/com.google.cloud.talent.v4.stub.CompanyServiceStubSettings.Builder)`

### newBuilder(ClientContext clientContext)

```
public static CompanyServiceStubSettings.Builder newBuilder(ClientContext clientContext)
```
...
```
public static CompanyServiceStubSettings.Builder newHttpJsonBuilder()
```
...
### CompanyServiceStubSettings(CompanyServiceStubSettings.Builder settingsBuilder)

```
protected CompanyServiceStubSettings(CompanyServiceStubSettings.Builder settingsBuilder)
```
...
`[UnaryCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.html)<[CreateCompanyRequest](/java/docs/reference/google-cloud-talent/2.14.0/com.google.cloud.talent.v4.CreateCompanyRequest),[Company](/java/docs/reference/google-cloud-talent/2.14.0/com.google.cloud.talent.v4.Company)>`

### createStub()

```
public CompanyServiceStub createStub()
```
...
`[CompanyServiceStub](/java/docs/reference/google-cloud-talent/2.14.0/com.google.cloud.talent.v4.stub.CompanyServiceStub)`
...
`[UnaryCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.html)<[DeleteCompanyRequest](/java/docs/reference/google-cloud-talent/2.14.0/com.google.cloud.talent.v4.DeleteCompanyRequest),[Empty](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Empty.html)>`
...
`[UnaryCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.html)<[GetCompanyRequest](/java/docs/reference/google-cloud-talent/2.14.0/com.google.cloud.talent.v4.GetCompanyRequest),[Company](/java/docs/reference/google-cloud-talent/2.14.0/com.google.cloud.talent.v4.Company)>`
...
`[PagedCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PagedCallSettings.html)<[ListCompaniesRequest](/java/docs/reference/google-cloud-talent/2.14.0/com.google.cloud.talent.v4.ListCompaniesRequest),[ListCompaniesResponse](/java/docs/reference/google-cloud-talent/2.14.0/com.google.cloud.talent.v4.ListCompaniesResponse),[ListCompaniesPagedResponse](/java/docs/reference/google-cloud-talent/2.14.0/com.google.cloud.talent.v4.CompanyServiceClient.ListCompaniesPagedResponse)>`

### toBuilder()

```
public CompanyServiceStubSettings.Builder toBuilder()
```
...
`[UnaryCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.html)<[UpdateCompanyRequest](/java/docs/reference/google-cloud-talent/2.14.0/com.google.cloud.talent.v4.UpdateCompanyRequest),[Company](/java/docs/reference/google-cloud-talent/2.14.0/com.google.cloud.talent.v4.Company)>`
