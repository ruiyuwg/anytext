...
# Class ListPrincipalAccessBoundaryPoliciesResponse.Builder (1.61.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class ListPrincipalAccessBoundaryPoliciesResponse.Builder extends GeneratedMessage.Builder<ListPrincipalAccessBoundaryPoliciesResponse.Builder> implements ListPrincipalAccessBoundaryPoliciesResponseOrBuilder
```

Response message for ListPrincipalAccessBoundaryPolicies method.

Protobuf type `google.iam.v3beta.ListPrincipalAccessBoundaryPoliciesResponse`

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessage.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessage.Builder.html) \> ListPrincipalAccessBoundaryPoliciesResponse.Builder

## Implements

[ListPrincipalAccessBoundaryPoliciesResponseOrBuilder](/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v3beta.ListPrincipalAccessBoundaryPoliciesResponseOrBuilder)
...
### addAllPrincipalAccessBoundaryPolicies(Iterable<? extends PrincipalAccessBoundaryPolicy> values)

```
public ListPrincipalAccessBoundaryPoliciesResponse.Builder addAllPrincipalAccessBoundaryPolicies(Iterable<? extends PrincipalAccessBoundaryPolicy> values)
```
...
`[Iterable](https://docs.oracle.com/javase/8/docs/api/java/lang/Iterable.html)<? extends com.google.iam.v3beta.PrincipalAccessBoundaryPolicy>`  
...
`[ListPrincipalAccessBoundaryPoliciesResponse.Builder](/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v3beta.ListPrincipalAccessBoundaryPoliciesResponse.Builder)`

### addPrincipalAccessBoundaryPolicies(PrincipalAccessBoundaryPolicy value)

```
public ListPrincipalAccessBoundaryPoliciesResponse.Builder addPrincipalAccessBoundaryPolicies(PrincipalAccessBoundaryPolicy value)
```
...
`[PrincipalAccessBoundaryPolicy](/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v3beta.PrincipalAccessBoundaryPolicy)`  
...
### addPrincipalAccessBoundaryPolicies(PrincipalAccessBoundaryPolicy.Builder builderForValue)

```
public ListPrincipalAccessBoundaryPoliciesResponse.Builder addPrincipalAccessBoundaryPolicies(PrincipalAccessBoundaryPolicy.Builder builderForValue)
```
...
`[PrincipalAccessBoundaryPolicy.Builder](/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v3beta.PrincipalAccessBoundaryPolicy.Builder)`  
...
### addPrincipalAccessBoundaryPolicies(int index, PrincipalAccessBoundaryPolicy value)

```
public ListPrincipalAccessBoundaryPoliciesResponse.Builder addPrincipalAccessBoundaryPolicies(int index, PrincipalAccessBoundaryPolicy value)
```
...
### addPrincipalAccessBoundaryPolicies(int index, PrincipalAccessBoundaryPolicy.Builder builderForValue)

```
public ListPrincipalAccessBoundaryPoliciesResponse.Builder addPrincipalAccessBoundaryPolicies(int index, PrincipalAccessBoundaryPolicy.Builder builderForValue)
```
...
```
public PrincipalAccessBoundaryPolicy.Builder addPrincipalAccessBoundaryPoliciesBuilder()
```
...
```
public PrincipalAccessBoundaryPolicy.Builder addPrincipalAccessBoundaryPoliciesBuilder(int index)
```
...
```
public ListPrincipalAccessBoundaryPoliciesResponse build()
```
...
`[ListPrincipalAccessBoundaryPoliciesResponse](/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v3beta.ListPrincipalAccessBoundaryPoliciesResponse)`

### buildPartial()

```
public ListPrincipalAccessBoundaryPoliciesResponse buildPartial()
```
...
```
public ListPrincipalAccessBoundaryPoliciesResponse.Builder clear()
```
...
```
public ListPrincipalAccessBoundaryPoliciesResponse.Builder clearNextPageToken()
```
...
### clearPrincipalAccessBoundaryPolicies()

```
public ListPrincipalAccessBoundaryPoliciesResponse.Builder clearPrincipalAccessBoundaryPolicies()
```
...
```
public ListPrincipalAccessBoundaryPoliciesResponse getDefaultInstanceForType()
```
...
```
public PrincipalAccessBoundaryPolicy getPrincipalAccessBoundaryPolicies(int index)
```
...
```
public PrincipalAccessBoundaryPolicy.Builder getPrincipalAccessBoundaryPoliciesBuilder(int index)
```
...
```
public List<PrincipalAccessBoundaryPolicy.Builder> getPrincipalAccessBoundaryPoliciesBuilderList()
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Builder](/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v3beta.PrincipalAccessBoundaryPolicy.Builder)>`
...
```
public List<PrincipalAccessBoundaryPolicy> getPrincipalAccessBoundaryPoliciesList()
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[PrincipalAccessBoundaryPolicy](/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v3beta.PrincipalAccessBoundaryPolicy)>`

### getPrincipalAccessBoundaryPoliciesOrBuilder(int index)

```
public PrincipalAccessBoundaryPolicyOrBuilder getPrincipalAccessBoundaryPoliciesOrBuilder(int index)
```
...
`[PrincipalAccessBoundaryPolicyOrBuilder](/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v3beta.PrincipalAccessBoundaryPolicyOrBuilder)`

### getPrincipalAccessBoundaryPoliciesOrBuilderList()

```
public List<? extends PrincipalAccessBoundaryPolicyOrBuilder> getPrincipalAccessBoundaryPoliciesOrBuilderList()
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.iam.v3beta.PrincipalAccessBoundaryPolicyOrBuilder>`
...
### mergeFrom(ListPrincipalAccessBoundaryPoliciesResponse other)

```
public ListPrincipalAccessBoundaryPoliciesResponse.Builder mergeFrom(ListPrincipalAccessBoundaryPoliciesResponse other)
```
...
```
public ListPrincipalAccessBoundaryPoliciesResponse.Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public ListPrincipalAccessBoundaryPoliciesResponse.Builder mergeFrom(Message other)
```
...
### removePrincipalAccessBoundaryPolicies(int index)

```
public ListPrincipalAccessBoundaryPoliciesResponse.Builder removePrincipalAccessBoundaryPolicies(int index)
```
...
```
public ListPrincipalAccessBoundaryPoliciesResponse.Builder setNextPageToken(String value)
```
...
```
public ListPrincipalAccessBoundaryPoliciesResponse.Builder setNextPageTokenBytes(ByteString value)
```
...
### setPrincipalAccessBoundaryPolicies(int index, PrincipalAccessBoundaryPolicy value)

```
public ListPrincipalAccessBoundaryPoliciesResponse.Builder setPrincipalAccessBoundaryPolicies(int index, PrincipalAccessBoundaryPolicy value)
```
...
### setPrincipalAccessBoundaryPolicies(int index, PrincipalAccessBoundaryPolicy.Builder builderForValue)

```
public ListPrincipalAccessBoundaryPoliciesResponse.Builder setPrincipalAccessBoundaryPolicies(int index, PrincipalAccessBoundaryPolicy.Builder builderForValue)
```
