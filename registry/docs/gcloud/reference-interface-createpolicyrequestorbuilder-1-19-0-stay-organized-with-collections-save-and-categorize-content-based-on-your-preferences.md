...
# Interface CreatePolicyRequestOrBuilder (1.19.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[Policy](/java/docs/reference/google-iam-policy/1.19.0/com.google.iam.v2.Policy)`
...
```
public abstract ByteString getPolicyIdBytes()
```
...
`[PolicyOrBuilder](/java/docs/reference/google-iam-policy/1.19.0/com.google.iam.v2.PolicyOrBuilder)`
