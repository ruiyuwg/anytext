...
# Google Cloud Ai Platform V1 Client - Class NfsMount (1.19.0) Stay organized with collections Save and categorize content based on your preferences.
...
Required. Destination mount path. The NFS will be mounted for the user under /mnt/nfs/<mount\_point>
