...
# Enum Hcx.State (0.2.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum Hcx.State extends Enum<Hcx.State> implements ProtocolMessageEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-vmwareengine/0.2.0/com.google.cloud.vmwareengine.v1.Hcx.State#com_google_cloud_vmwareengine_v1_Hcx_State_forNumber_int_) instead._
