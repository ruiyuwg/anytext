...
# Class PrivateEnvironmentConfig.Builder (1.47.0) Stay organized with collections Save and categorize content based on your preferences.
...
[PrivateEnvironmentConfigOrBuilder](/java/docs/reference/google-cloud-orchestration-airflow/1.47.0/com.google.cloud.orchestration.airflow.service.v1.PrivateEnvironmentConfigOrBuilder)
...
`[PrivateEnvironmentConfig.Builder](/java/docs/reference/google-cloud-orchestration-airflow/1.47.0/com.google.cloud.orchestration.airflow.service.v1.PrivateEnvironmentConfig.Builder)`
...
`[PrivateEnvironmentConfig](/java/docs/reference/google-cloud-orchestration-airflow/1.47.0/com.google.cloud.orchestration.airflow.service.v1.PrivateEnvironmentConfig)`
...
Optional. The CIDR block from which IP range for Cloud Composer Network in tenant project will be reserved. Needs to be disjoint from private\_cluster\_config.master\_ipv4\_cidr\_block and cloud\_sql\_ipv4\_cidr\_block.

This field is supported for Cloud Composer environments in versions composer-2._._\-airflow-_._.\* and newer.
...
`[NetworkingConfig](/java/docs/reference/google-cloud-orchestration-airflow/1.47.0/com.google.cloud.orchestration.airflow.service.v1.NetworkingConfig)`
...
`[NetworkingConfig.Builder](/java/docs/reference/google-cloud-orchestration-airflow/1.47.0/com.google.cloud.orchestration.airflow.service.v1.NetworkingConfig.Builder)`
...
`[NetworkingConfigOrBuilder](/java/docs/reference/google-cloud-orchestration-airflow/1.47.0/com.google.cloud.orchestration.airflow.service.v1.NetworkingConfigOrBuilder)`
...
`[PrivateClusterConfig](/java/docs/reference/google-cloud-orchestration-airflow/1.47.0/com.google.cloud.orchestration.airflow.service.v1.PrivateClusterConfig)`
...
`[PrivateClusterConfig.Builder](/java/docs/reference/google-cloud-orchestration-airflow/1.47.0/com.google.cloud.orchestration.airflow.service.v1.PrivateClusterConfig.Builder)`
...
`[PrivateClusterConfigOrBuilder](/java/docs/reference/google-cloud-orchestration-airflow/1.47.0/com.google.cloud.orchestration.airflow.service.v1.PrivateClusterConfigOrBuilder)`
