...
# Class ScoreDistribution (3.16.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ScoreDistribution

## Implements

[ScoreDistributionOrBuilder](/java/docs/reference/google-cloud-recaptchaenterprise/3.16.0/com.google.recaptchaenterprise.v1.ScoreDistributionOrBuilder)
...
`[ScoreDistribution](/java/docs/reference/google-cloud-recaptchaenterprise/3.16.0/com.google.recaptchaenterprise.v1.ScoreDistribution)`
...
`[ScoreDistribution.Builder](/java/docs/reference/google-cloud-recaptchaenterprise/3.16.0/com.google.recaptchaenterprise.v1.ScoreDistribution.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ScoreDistribution](/java/docs/reference/google-cloud-recaptchaenterprise/3.16.0/com.google.recaptchaenterprise.v1.ScoreDistribution)>`
...
Use [#getScoreBucketsMap()](/java/docs/reference/google-cloud-recaptchaenterprise/3.16.0/com.google.recaptchaenterprise.v1.ScoreDistribution#com_google_recaptchaenterprise_v1_ScoreDistribution_getScoreBucketsMap__) instead.
...
`[Map](https://docs.oracle.com/javase/8/docs/api/java/util/Map.html)<[Integer](https://docs.oracle.com/javase/8/docs/api/java/lang/Integer.html),java.lang.Long>`
