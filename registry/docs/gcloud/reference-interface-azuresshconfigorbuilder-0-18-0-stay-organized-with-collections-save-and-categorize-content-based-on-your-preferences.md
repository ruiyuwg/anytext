...
# Interface AzureSshConfigOrBuilder (0.18.0) Stay organized with collections Save and categorize content based on your preferences.
...
Required. The SSH public key data for VMs managed by Anthos. This accepts the authorized\_keys file format used in OpenSSH according to the sshd(8) manual page.
