...
# Enum IPAllocationPolicy.ClusterIpAllocationCase (1.49.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-orchestration-airflow/1.49.0/com.google.cloud.orchestration.airflow.service.v1.IPAllocationPolicy.ClusterIpAllocationCase#com_google_cloud_orchestration_airflow_service_v1_IPAllocationPolicy_ClusterIpAllocationCase_forNumber_int_) instead._
