...
# Class ReplicationStatus.Builder (2.54.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> ReplicationStatus.Builder

## Implements

[ReplicationStatusOrBuilder](/java/docs/reference/google-cloud-secretmanager/2.54.0/com.google.cloud.secretmanager.v1.ReplicationStatusOrBuilder)
...
`[ReplicationStatus.Builder](/java/docs/reference/google-cloud-secretmanager/2.54.0/com.google.cloud.secretmanager.v1.ReplicationStatus.Builder)`
...
`[ReplicationStatus](/java/docs/reference/google-cloud-secretmanager/2.54.0/com.google.cloud.secretmanager.v1.ReplicationStatus)`
...
`[ReplicationStatus.AutomaticStatus](/java/docs/reference/google-cloud-secretmanager/2.54.0/com.google.cloud.secretmanager.v1.ReplicationStatus.AutomaticStatus)`
...
`[ReplicationStatus.AutomaticStatus.Builder](/java/docs/reference/google-cloud-secretmanager/2.54.0/com.google.cloud.secretmanager.v1.ReplicationStatus.AutomaticStatus.Builder)`
...
`[ReplicationStatus.AutomaticStatusOrBuilder](/java/docs/reference/google-cloud-secretmanager/2.54.0/com.google.cloud.secretmanager.v1.ReplicationStatus.AutomaticStatusOrBuilder)`
...
`[ReplicationStatus.ReplicationStatusCase](/java/docs/reference/google-cloud-secretmanager/2.54.0/com.google.cloud.secretmanager.v1.ReplicationStatus.ReplicationStatusCase)`
...
`[ReplicationStatus.UserManagedStatus](/java/docs/reference/google-cloud-secretmanager/2.54.0/com.google.cloud.secretmanager.v1.ReplicationStatus.UserManagedStatus)`
...
`[ReplicationStatus.UserManagedStatus.Builder](/java/docs/reference/google-cloud-secretmanager/2.54.0/com.google.cloud.secretmanager.v1.ReplicationStatus.UserManagedStatus.Builder)`
...
`[ReplicationStatus.UserManagedStatusOrBuilder](/java/docs/reference/google-cloud-secretmanager/2.54.0/com.google.cloud.secretmanager.v1.ReplicationStatus.UserManagedStatusOrBuilder)`
...
```
public ReplicationStatus.Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
