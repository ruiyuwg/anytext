...
# Compute V1 Client - Class Status (1.5.0) Stay organized with collections Save and categorize content based on your preferences.
...
Status contains string constants that represent the names of each value in the google.cloud.compute.v1.SslCertificateManagedSslCertificate.Status descriptor.
...
### MANAGED\_CERTIFICATE\_STATUS\_UNSPECIFIED
...
### PROVISIONING\_FAILED

```
Value: 'PROVISIONING_FAILED'
```

### PROVISIONING\_FAILED\_PERMANENTLY
