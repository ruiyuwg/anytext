...
# Class KeyManagementServiceLimitedErrorCountRetryPolicy (2.23.0) Stay organized with collections Save and categorize content based on your preferences.
...
A retry policy for [`KeyManagementServiceConnection`](/cpp/docs/reference/kms/2.23.0/classgoogle_1_1cloud_1_1kms__v1_1_1KeyManagementServiceConnection) based on counting errors.
...
`KeyManagementServiceLimitedErrorCountRetryPolicy const &`  
...
`std::unique_ptr< KeyManagementServiceRetryPolicy >`

## Type Aliases

### BaseType

**Alias Of**: `KeyManagementServiceRetryPolicy`
