...
# Class GetServiceIdentityMetadata (2.12.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class GetServiceIdentityMetadata extends GeneratedMessageV3 implements GetServiceIdentityMetadataOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> GetServiceIdentityMetadata

## Implements

[GetServiceIdentityMetadataOrBuilder](/java/docs/reference/google-cloud-service-usage/2.12.0/com.google.api.serviceusage.v1beta1.GetServiceIdentityMetadataOrBuilder)
...
```
public static GetServiceIdentityMetadata getDefaultInstance()
```
...
`[GetServiceIdentityMetadata](/java/docs/reference/google-cloud-service-usage/2.12.0/com.google.api.serviceusage.v1beta1.GetServiceIdentityMetadata)`
...
```
public static GetServiceIdentityMetadata.Builder newBuilder()
```
...
`[GetServiceIdentityMetadata.Builder](/java/docs/reference/google-cloud-service-usage/2.12.0/com.google.api.serviceusage.v1beta1.GetServiceIdentityMetadata.Builder)`

### newBuilder(GetServiceIdentityMetadata prototype)

```
public static GetServiceIdentityMetadata.Builder newBuilder(GetServiceIdentityMetadata prototype)
```
...
```
public static GetServiceIdentityMetadata parseDelimitedFrom(InputStream input)
```
...
```
public static GetServiceIdentityMetadata parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetServiceIdentityMetadata parseFrom(byte[] data)
```
...
```
public static GetServiceIdentityMetadata parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetServiceIdentityMetadata parseFrom(ByteString data)
```
...
```
public static GetServiceIdentityMetadata parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetServiceIdentityMetadata parseFrom(CodedInputStream input)
```
...
```
public static GetServiceIdentityMetadata parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetServiceIdentityMetadata parseFrom(InputStream input)
```
...
```
public static GetServiceIdentityMetadata parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetServiceIdentityMetadata parseFrom(ByteBuffer data)
```
...
```
public static GetServiceIdentityMetadata parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<GetServiceIdentityMetadata> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[GetServiceIdentityMetadata](/java/docs/reference/google-cloud-service-usage/2.12.0/com.google.api.serviceusage.v1beta1.GetServiceIdentityMetadata)>`
...
```
public Parser<GetServiceIdentityMetadata> getParserForType()
```
...
```
public GetServiceIdentityMetadata.Builder newBuilderForType()
```
...
```
protected GetServiceIdentityMetadata.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public GetServiceIdentityMetadata.Builder toBuilder()
```
