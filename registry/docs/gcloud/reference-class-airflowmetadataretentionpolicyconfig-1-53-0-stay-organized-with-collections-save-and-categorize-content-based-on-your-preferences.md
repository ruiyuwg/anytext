...
# Class AirflowMetadataRetentionPolicyConfig (1.53.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class AirflowMetadataRetentionPolicyConfig extends GeneratedMessageV3 implements AirflowMetadataRetentionPolicyConfigOrBuilder
```

The policy for airflow metadata database retention.

Protobuf type `google.cloud.orchestration.airflow.service.v1beta1.AirflowMetadataRetentionPolicyConfig`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> AirflowMetadataRetentionPolicyConfig

## Implements

[AirflowMetadataRetentionPolicyConfigOrBuilder](/java/docs/reference/google-cloud-orchestration-airflow/1.53.0/com.google.cloud.orchestration.airflow.service.v1beta1.AirflowMetadataRetentionPolicyConfigOrBuilder)
...
### RETENTION\_DAYS\_FIELD\_NUMBER
...
### RETENTION\_MODE\_FIELD\_NUMBER

```
public static final int RETENTION_MODE_FIELD_NUMBER
```
...
```
public static AirflowMetadataRetentionPolicyConfig getDefaultInstance()
```
...
`[AirflowMetadataRetentionPolicyConfig](/java/docs/reference/google-cloud-orchestration-airflow/1.53.0/com.google.cloud.orchestration.airflow.service.v1beta1.AirflowMetadataRetentionPolicyConfig)`
...
```
public static AirflowMetadataRetentionPolicyConfig.Builder newBuilder()
```
...
`[AirflowMetadataRetentionPolicyConfig.Builder](/java/docs/reference/google-cloud-orchestration-airflow/1.53.0/com.google.cloud.orchestration.airflow.service.v1beta1.AirflowMetadataRetentionPolicyConfig.Builder)`

### newBuilder(AirflowMetadataRetentionPolicyConfig prototype)

```
public static AirflowMetadataRetentionPolicyConfig.Builder newBuilder(AirflowMetadataRetentionPolicyConfig prototype)
```
...
```
public static AirflowMetadataRetentionPolicyConfig parseDelimitedFrom(InputStream input)
```
...
```
public static AirflowMetadataRetentionPolicyConfig parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AirflowMetadataRetentionPolicyConfig parseFrom(byte[] data)
```
...
```
public static AirflowMetadataRetentionPolicyConfig parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AirflowMetadataRetentionPolicyConfig parseFrom(ByteString data)
```
...
```
public static AirflowMetadataRetentionPolicyConfig parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AirflowMetadataRetentionPolicyConfig parseFrom(CodedInputStream input)
```
...
```
public static AirflowMetadataRetentionPolicyConfig parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AirflowMetadataRetentionPolicyConfig parseFrom(InputStream input)
```
...
```
public static AirflowMetadataRetentionPolicyConfig parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AirflowMetadataRetentionPolicyConfig parseFrom(ByteBuffer data)
```
...
```
public static AirflowMetadataRetentionPolicyConfig parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<AirflowMetadataRetentionPolicyConfig> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[AirflowMetadataRetentionPolicyConfig](/java/docs/reference/google-cloud-orchestration-airflow/1.53.0/com.google.cloud.orchestration.airflow.service.v1beta1.AirflowMetadataRetentionPolicyConfig)>`
...
```
public Parser<AirflowMetadataRetentionPolicyConfig> getParserForType()
```
...
`[AirflowMetadataRetentionPolicyConfig.RetentionMode](/java/docs/reference/google-cloud-orchestration-airflow/1.53.0/com.google.cloud.orchestration.airflow.service.v1beta1.AirflowMetadataRetentionPolicyConfig.RetentionMode)`
...
```
public AirflowMetadataRetentionPolicyConfig.Builder newBuilderForType()
```
...
```
protected AirflowMetadataRetentionPolicyConfig.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public AirflowMetadataRetentionPolicyConfig.Builder toBuilder()
```
