...
# Class CreateReportConfigRequest (0.69.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class CreateReportConfigRequest extends GeneratedMessage implements CreateReportConfigRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessage.html) \> CreateReportConfigRequest

## Implements

[CreateReportConfigRequestOrBuilder](/java/docs/reference/google-cloud-migrationcenter/latest/com.google.cloud.migrationcenter.v1.CreateReportConfigRequestOrBuilder)
...
### REPORT\_CONFIG\_ID\_FIELD\_NUMBER

```
public static final int REPORT_CONFIG_ID_FIELD_NUMBER
```
...
```
public static CreateReportConfigRequest getDefaultInstance()
```
...
`[CreateReportConfigRequest](/java/docs/reference/google-cloud-migrationcenter/latest/com.google.cloud.migrationcenter.v1.CreateReportConfigRequest)`
...
```
public static CreateReportConfigRequest.Builder newBuilder()
```
...
`[CreateReportConfigRequest.Builder](/java/docs/reference/google-cloud-migrationcenter/latest/com.google.cloud.migrationcenter.v1.CreateReportConfigRequest.Builder)`

### newBuilder(CreateReportConfigRequest prototype)

```
public static CreateReportConfigRequest.Builder newBuilder(CreateReportConfigRequest prototype)
```
...
```
public static CreateReportConfigRequest parseDelimitedFrom(InputStream input)
```
...
```
public static CreateReportConfigRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateReportConfigRequest parseFrom(byte[] data)
```
...
```
public static CreateReportConfigRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateReportConfigRequest parseFrom(ByteString data)
```
...
```
public static CreateReportConfigRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateReportConfigRequest parseFrom(CodedInputStream input)
```
...
```
public static CreateReportConfigRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateReportConfigRequest parseFrom(InputStream input)
```
...
```
public static CreateReportConfigRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateReportConfigRequest parseFrom(ByteBuffer data)
```
...
```
public static CreateReportConfigRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<CreateReportConfigRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[CreateReportConfigRequest](/java/docs/reference/google-cloud-migrationcenter/latest/com.google.cloud.migrationcenter.v1.CreateReportConfigRequest)>`
...
```
public Parser<CreateReportConfigRequest> getParserForType()
```
...
`[ReportConfig](/java/docs/reference/google-cloud-migrationcenter/latest/com.google.cloud.migrationcenter.v1.ReportConfig)`
...
Required. User specified ID for the report config. It will become the last component of the report config name. The ID must be unique within the project, must conform with RFC-1034, is restricted to lower-cased letters, and has a maximum length of 63 characters. The ID must match the regular expression: [a-z](/java/docs/reference/google-cloud-migrationcenter/latest/[a-z0-9-]{0,61}[a-z0-9])?.
...
`[ReportConfigOrBuilder](/java/docs/reference/google-cloud-migrationcenter/latest/com.google.cloud.migrationcenter.v1.ReportConfigOrBuilder)`
...
```
public CreateReportConfigRequest.Builder newBuilderForType()
```
...
```
protected CreateReportConfigRequest.Builder newBuilderForType(AbstractMessage.BuilderParent parent)
```
...
```
public CreateReportConfigRequest.Builder toBuilder()
```
