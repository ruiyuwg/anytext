...
# Class DeleteProjectRequest (1.38.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class DeleteProjectRequest extends GeneratedMessageV3 implements DeleteProjectRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> DeleteProjectRequest

## Implements

[DeleteProjectRequestOrBuilder](/java/docs/reference/google-cloud-resourcemanager/1.38.0/com.google.cloud.resourcemanager.v3.DeleteProjectRequestOrBuilder)
...
`[DeleteProjectRequest](/java/docs/reference/google-cloud-resourcemanager/1.38.0/com.google.cloud.resourcemanager.v3.DeleteProjectRequest)`
...
```
public static DeleteProjectRequest.Builder newBuilder()
```
...
`[DeleteProjectRequest.Builder](/java/docs/reference/google-cloud-resourcemanager/1.38.0/com.google.cloud.resourcemanager.v3.DeleteProjectRequest.Builder)`

### newBuilder(DeleteProjectRequest prototype)

```
public static DeleteProjectRequest.Builder newBuilder(DeleteProjectRequest prototype)
```
...
```
public static DeleteProjectRequest parseDelimitedFrom(InputStream input)
```
...
```
public static DeleteProjectRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteProjectRequest parseFrom(byte[] data)
```
...
```
public static DeleteProjectRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteProjectRequest parseFrom(ByteString data)
```
...
```
public static DeleteProjectRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteProjectRequest parseFrom(CodedInputStream input)
```
...
```
public static DeleteProjectRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteProjectRequest parseFrom(InputStream input)
```
...
```
public static DeleteProjectRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteProjectRequest parseFrom(ByteBuffer data)
```
...
```
public static DeleteProjectRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[DeleteProjectRequest](/java/docs/reference/google-cloud-resourcemanager/1.38.0/com.google.cloud.resourcemanager.v3.DeleteProjectRequest)>`
...
```
public DeleteProjectRequest.Builder newBuilderForType()
```
...
```
protected DeleteProjectRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
