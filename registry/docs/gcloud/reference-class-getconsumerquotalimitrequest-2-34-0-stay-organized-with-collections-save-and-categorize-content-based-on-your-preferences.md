...
# Class GetConsumerQuotaLimitRequest (2.34.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class GetConsumerQuotaLimitRequest extends GeneratedMessageV3 implements GetConsumerQuotaLimitRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> GetConsumerQuotaLimitRequest

## Implements

[GetConsumerQuotaLimitRequestOrBuilder](/java/docs/reference/google-cloud-service-usage/2.34.0/com.google.api.serviceusage.v1beta1.GetConsumerQuotaLimitRequestOrBuilder)
...
```
public static GetConsumerQuotaLimitRequest getDefaultInstance()
```
...
`[GetConsumerQuotaLimitRequest](/java/docs/reference/google-cloud-service-usage/2.34.0/com.google.api.serviceusage.v1beta1.GetConsumerQuotaLimitRequest)`
...
```
public static GetConsumerQuotaLimitRequest.Builder newBuilder()
```
...
`[GetConsumerQuotaLimitRequest.Builder](/java/docs/reference/google-cloud-service-usage/2.34.0/com.google.api.serviceusage.v1beta1.GetConsumerQuotaLimitRequest.Builder)`

### newBuilder(GetConsumerQuotaLimitRequest prototype)

```
public static GetConsumerQuotaLimitRequest.Builder newBuilder(GetConsumerQuotaLimitRequest prototype)
```
...
```
public static GetConsumerQuotaLimitRequest parseDelimitedFrom(InputStream input)
```
...
```
public static GetConsumerQuotaLimitRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetConsumerQuotaLimitRequest parseFrom(byte[] data)
```
...
```
public static GetConsumerQuotaLimitRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetConsumerQuotaLimitRequest parseFrom(ByteString data)
```
...
```
public static GetConsumerQuotaLimitRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetConsumerQuotaLimitRequest parseFrom(CodedInputStream input)
```
...
```
public static GetConsumerQuotaLimitRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetConsumerQuotaLimitRequest parseFrom(InputStream input)
```
...
```
public static GetConsumerQuotaLimitRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetConsumerQuotaLimitRequest parseFrom(ByteBuffer data)
```
...
```
public static GetConsumerQuotaLimitRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<GetConsumerQuotaLimitRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[GetConsumerQuotaLimitRequest](/java/docs/reference/google-cloud-service-usage/2.34.0/com.google.api.serviceusage.v1beta1.GetConsumerQuotaLimitRequest)>`
...
```
public Parser<GetConsumerQuotaLimitRequest> getParserForType()
```
...
`[QuotaView](/java/docs/reference/google-cloud-service-usage/2.34.0/com.google.api.serviceusage.v1beta1.QuotaView)`
...
```
public GetConsumerQuotaLimitRequest.Builder newBuilderForType()
```
...
```
protected GetConsumerQuotaLimitRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public GetConsumerQuotaLimitRequest.Builder toBuilder()
```
