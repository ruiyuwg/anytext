...
# Interface SpokeSummary.SpokeTypeCountOrBuilder (1.39.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[SpokeType](/java/docs/reference/google-cloud-networkconnectivity/1.39.0/com.google.cloud.networkconnectivity.v1.SpokeType)`
