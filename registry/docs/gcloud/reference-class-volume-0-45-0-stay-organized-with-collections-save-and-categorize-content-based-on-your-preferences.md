...
# Class Volume (0.45.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[Volume](/java/docs/reference/google-cloud-run/0.45.0/com.google.cloud.run.v2.Volume)`
...
`[Volume.Builder](/java/docs/reference/google-cloud-run/0.45.0/com.google.cloud.run.v2.Volume.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[Volume](/java/docs/reference/google-cloud-run/0.45.0/com.google.cloud.run.v2.Volume)>`
...
For Cloud SQL volumes, contains the specific instances that should be mounted. Visit [https://cloud.google.com/sql/docs/mysql/connect-run](https://cloud.google.com/sql/docs/mysql/connect-run) for more information on how to connect Cloud SQL and Cloud Run.
...
`[CloudSqlInstance](/java/docs/reference/google-cloud-run/0.45.0/com.google.cloud.run.v2.CloudSqlInstance)`
...
`[CloudSqlInstanceOrBuilder](/java/docs/reference/google-cloud-run/0.45.0/com.google.cloud.run.v2.CloudSqlInstanceOrBuilder)`
...
`[EmptyDirVolumeSource](/java/docs/reference/google-cloud-run/0.45.0/com.google.cloud.run.v2.EmptyDirVolumeSource)`
...
`[EmptyDirVolumeSourceOrBuilder](/java/docs/reference/google-cloud-run/0.45.0/com.google.cloud.run.v2.EmptyDirVolumeSourceOrBuilder)`

### getGcs()

```
public GCSVolumeSource getGcs()
```
...
`[GCSVolumeSource](/java/docs/reference/google-cloud-run/0.45.0/com.google.cloud.run.v2.GCSVolumeSource)`
...
```
public GCSVolumeSourceOrBuilder getGcsOrBuilder()
```
...
`[GCSVolumeSourceOrBuilder](/java/docs/reference/google-cloud-run/0.45.0/com.google.cloud.run.v2.GCSVolumeSourceOrBuilder)`
...
`[NFSVolumeSource](/java/docs/reference/google-cloud-run/0.45.0/com.google.cloud.run.v2.NFSVolumeSource)`
...
`[NFSVolumeSourceOrBuilder](/java/docs/reference/google-cloud-run/0.45.0/com.google.cloud.run.v2.NFSVolumeSourceOrBuilder)`
...
`[SecretVolumeSource](/java/docs/reference/google-cloud-run/0.45.0/com.google.cloud.run.v2.SecretVolumeSource)`
...
`[SecretVolumeSourceOrBuilder](/java/docs/reference/google-cloud-run/0.45.0/com.google.cloud.run.v2.SecretVolumeSourceOrBuilder)`
...
`[Volume.VolumeTypeCase](/java/docs/reference/google-cloud-run/0.45.0/com.google.cloud.run.v2.Volume.VolumeTypeCase)`
