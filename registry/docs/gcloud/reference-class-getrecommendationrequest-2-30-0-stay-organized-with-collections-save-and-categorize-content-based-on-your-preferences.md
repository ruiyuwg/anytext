...
# Class GetRecommendationRequest (2.30.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class GetRecommendationRequest extends GeneratedMessageV3 implements GetRecommendationRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> GetRecommendationRequest

## Implements

[GetRecommendationRequestOrBuilder](/java/docs/reference/google-cloud-recommender/2.30.0/com.google.cloud.recommender.v1.GetRecommendationRequestOrBuilder)
...
```
public static GetRecommendationRequest getDefaultInstance()
```
...
`[GetRecommendationRequest](/java/docs/reference/google-cloud-recommender/2.30.0/com.google.cloud.recommender.v1.GetRecommendationRequest)`
...
```
public static GetRecommendationRequest.Builder newBuilder()
```
...
`[GetRecommendationRequest.Builder](/java/docs/reference/google-cloud-recommender/2.30.0/com.google.cloud.recommender.v1.GetRecommendationRequest.Builder)`

### newBuilder(GetRecommendationRequest prototype)

```
public static GetRecommendationRequest.Builder newBuilder(GetRecommendationRequest prototype)
```
...
```
public static GetRecommendationRequest parseDelimitedFrom(InputStream input)
```
...
```
public static GetRecommendationRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetRecommendationRequest parseFrom(byte[] data)
```
...
```
public static GetRecommendationRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetRecommendationRequest parseFrom(ByteString data)
```
...
```
public static GetRecommendationRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetRecommendationRequest parseFrom(CodedInputStream input)
```
...
```
public static GetRecommendationRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetRecommendationRequest parseFrom(InputStream input)
```
...
```
public static GetRecommendationRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetRecommendationRequest parseFrom(ByteBuffer data)
```
...
```
public static GetRecommendationRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<GetRecommendationRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[GetRecommendationRequest](/java/docs/reference/google-cloud-recommender/2.30.0/com.google.cloud.recommender.v1.GetRecommendationRequest)>`
...
```
public GetRecommendationRequest getDefaultInstanceForType()
```
...
```
public Parser<GetRecommendationRequest> getParserForType()
```
...
```
public GetRecommendationRequest.Builder newBuilderForType()
```
...
```
protected GetRecommendationRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public GetRecommendationRequest.Builder toBuilder()
```
