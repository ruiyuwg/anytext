...
# Class VpcAccessServiceClient.ListConnectorsPage (2.53.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class VpcAccessServiceClient.ListConnectorsPage extends AbstractPage<ListConnectorsRequest,ListConnectorsResponse,Connector,VpcAccessServiceClient.ListConnectorsPage>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractPage](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractPage.html) \> VpcAccessServiceClient.ListConnectorsPage
...
### createPage(PageContext<ListConnectorsRequest,ListConnectorsResponse,Connector> context, ListConnectorsResponse response)

```
protected VpcAccessServiceClient.ListConnectorsPage createPage(PageContext<ListConnectorsRequest,ListConnectorsResponse,Connector> context, ListConnectorsResponse response)
```
...
`[PageContext](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PageContext.html)<[ListConnectorsRequest](/java/docs/reference/google-cloud-vpcaccess/2.53.0/com.google.cloud.vpcaccess.v1.ListConnectorsRequest),[ListConnectorsResponse](/java/docs/reference/google-cloud-vpcaccess/2.53.0/com.google.cloud.vpcaccess.v1.ListConnectorsResponse),[Connector](/java/docs/reference/google-cloud-vpcaccess/2.53.0/com.google.cloud.vpcaccess.v1.Connector)>`  

`response`

`[ListConnectorsResponse](/java/docs/reference/google-cloud-vpcaccess/2.53.0/com.google.cloud.vpcaccess.v1.ListConnectorsResponse)`  
...
`[VpcAccessServiceClient.ListConnectorsPage](/java/docs/reference/google-cloud-vpcaccess/2.53.0/com.google.cloud.vpcaccess.v1.VpcAccessServiceClient.ListConnectorsPage)`
...
### createPageAsync(PageContext<ListConnectorsRequest,ListConnectorsResponse,Connector> context, ApiFuture<ListConnectorsResponse> futureResponse)

```
public ApiFuture<VpcAccessServiceClient.ListConnectorsPage> createPageAsync(PageContext<ListConnectorsRequest,ListConnectorsResponse,Connector> context, ApiFuture<ListConnectorsResponse> futureResponse)
```
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListConnectorsResponse](/java/docs/reference/google-cloud-vpcaccess/2.53.0/com.google.cloud.vpcaccess.v1.ListConnectorsResponse)>`  
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListConnectorsPage](/java/docs/reference/google-cloud-vpcaccess/2.53.0/com.google.cloud.vpcaccess.v1.VpcAccessServiceClient.ListConnectorsPage)>`
