...
# Class DnsBindPermission.Builder (0.52.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> DnsBindPermission.Builder

## Implements

[DnsBindPermissionOrBuilder](/java/docs/reference/google-cloud-vmwareengine/0.52.0/com.google.cloud.vmwareengine.v1.DnsBindPermissionOrBuilder)
...
`[Iterable](https://docs.oracle.com/javase/8/docs/api/java/lang/Iterable.html)<? extends com.google.cloud.vmwareengine.v1.Principal>`  
...
`[DnsBindPermission.Builder](/java/docs/reference/google-cloud-vmwareengine/0.52.0/com.google.cloud.vmwareengine.v1.DnsBindPermission.Builder)`
...
`[Principal](/java/docs/reference/google-cloud-vmwareengine/0.52.0/com.google.cloud.vmwareengine.v1.Principal)`  
...
`[Principal.Builder](/java/docs/reference/google-cloud-vmwareengine/0.52.0/com.google.cloud.vmwareengine.v1.Principal.Builder)`  
...
`[DnsBindPermission](/java/docs/reference/google-cloud-vmwareengine/0.52.0/com.google.cloud.vmwareengine.v1.DnsBindPermission)`
...
Required. Output only. The name of the resource which stores the users/service accounts having the permission to bind to the corresponding intranet VPC of the consumer project. DnsBindPermission is a global resource and location can only be global. Resource names are schemeless URIs that follow the conventions in [https://cloud.google.com/apis/design/resource\_names](https://cloud.google.com/apis/design/resource_names). For example: `projects/my-project/locations/global/dnsBindPermission`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Builder](/java/docs/reference/google-cloud-vmwareengine/0.52.0/com.google.cloud.vmwareengine.v1.Principal.Builder)>`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Principal](/java/docs/reference/google-cloud-vmwareengine/0.52.0/com.google.cloud.vmwareengine.v1.Principal)>`
...
`[PrincipalOrBuilder](/java/docs/reference/google-cloud-vmwareengine/0.52.0/com.google.cloud.vmwareengine.v1.PrincipalOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.vmwareengine.v1.PrincipalOrBuilder>`
