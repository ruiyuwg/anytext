...
# Class ListProfilesResponse (2.48.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListProfilesResponse

## Implements

[ListProfilesResponseOrBuilder](/java/docs/reference/google-cloud-profiler/2.48.0/com.google.devtools.cloudprofiler.v2.ListProfilesResponseOrBuilder)
...
### SKIPPED\_PROFILES\_FIELD\_NUMBER

```
public static final int SKIPPED_PROFILES_FIELD_NUMBER
```
...
`[ListProfilesResponse](/java/docs/reference/google-cloud-profiler/2.48.0/com.google.devtools.cloudprofiler.v2.ListProfilesResponse)`
...
`[ListProfilesResponse.Builder](/java/docs/reference/google-cloud-profiler/2.48.0/com.google.devtools.cloudprofiler.v2.ListProfilesResponse.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListProfilesResponse](/java/docs/reference/google-cloud-profiler/2.48.0/com.google.devtools.cloudprofiler.v2.ListProfilesResponse)>`
...
`[Profile](/java/docs/reference/google-cloud-profiler/2.48.0/com.google.devtools.cloudprofiler.v2.Profile)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Profile](/java/docs/reference/google-cloud-profiler/2.48.0/com.google.devtools.cloudprofiler.v2.Profile)>`
...
`[ProfileOrBuilder](/java/docs/reference/google-cloud-profiler/2.48.0/com.google.devtools.cloudprofiler.v2.ProfileOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.devtools.cloudprofiler.v2.ProfileOrBuilder>`
