...
# Enum OSPolicy.Mode (2.15.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-os-config/2.15.0/com.google.cloud.osconfig.v1.OSPolicy.Mode#com_google_cloud_osconfig_v1_OSPolicy_Mode_forNumber_int_) instead._
