...
# Class DeleteFeatureRequest (1.1.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class DeleteFeatureRequest extends GeneratedMessageV3 implements DeleteFeatureRequestOrBuilder
```

Request message for `GkeHub.DeleteFeature` method.

Protobuf type `google.cloud.gkehub.v1alpha.DeleteFeatureRequest`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> DeleteFeatureRequest

## Implements

[DeleteFeatureRequestOrBuilder](/java/docs/reference/google-cloud-gkehub/1.1.0/com.google.cloud.gkehub.v1alpha.DeleteFeatureRequestOrBuilder)
...
```
public static DeleteFeatureRequest getDefaultInstance()
```
...
[DeleteFeatureRequest](/java/docs/reference/google-cloud-gkehub/1.1.0/com.google.cloud.gkehub.v1alpha.DeleteFeatureRequest)
...
```
public static DeleteFeatureRequest.Builder newBuilder()
```
...
[DeleteFeatureRequest.Builder](/java/docs/reference/google-cloud-gkehub/1.1.0/com.google.cloud.gkehub.v1alpha.DeleteFeatureRequest.Builder)

### newBuilder(DeleteFeatureRequest prototype)

```
public static DeleteFeatureRequest.Builder newBuilder(DeleteFeatureRequest prototype)
```
...
```
public static DeleteFeatureRequest parseDelimitedFrom(InputStream input)
```
...
```
public static DeleteFeatureRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteFeatureRequest parseFrom(byte[] data)
```
...
```
public static DeleteFeatureRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteFeatureRequest parseFrom(ByteString data)
```
...
```
public static DeleteFeatureRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteFeatureRequest parseFrom(CodedInputStream input)
```
...
```
public static DeleteFeatureRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteFeatureRequest parseFrom(InputStream input)
```
...
```
public static DeleteFeatureRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteFeatureRequest parseFrom(ByteBuffer data)
```
...
```
public static DeleteFeatureRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<DeleteFeatureRequest> parser()
```
...
[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[DeleteFeatureRequest](/java/docs/reference/google-cloud-gkehub/1.1.0/com.google.cloud.gkehub.v1alpha.DeleteFeatureRequest)\>
...
```
public Parser<DeleteFeatureRequest> getParserForType()
```
...
```
public DeleteFeatureRequest.Builder newBuilderForType()
```
...
```
protected DeleteFeatureRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public DeleteFeatureRequest.Builder toBuilder()
```
