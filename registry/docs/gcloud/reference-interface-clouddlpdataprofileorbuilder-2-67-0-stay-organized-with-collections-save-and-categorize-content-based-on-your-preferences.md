...
# Interface CloudDlpDataProfileOrBuilder (2.67.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[CloudDlpDataProfile.ParentType](/java/docs/reference/google-cloud-securitycenter/2.67.0/com.google.cloud.securitycenter.v2.CloudDlpDataProfile.ParentType)`
