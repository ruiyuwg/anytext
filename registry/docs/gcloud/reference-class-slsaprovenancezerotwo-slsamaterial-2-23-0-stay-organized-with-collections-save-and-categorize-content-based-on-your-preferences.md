...
# Class SlsaProvenanceZeroTwo.SlsaMaterial (2.23.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class SlsaProvenanceZeroTwo.SlsaMaterial extends GeneratedMessageV3 implements SlsaProvenanceZeroTwo.SlsaMaterialOrBuilder
```

The collection of artifacts that influenced the build including sources, dependencies, build tools, base images, and so on.

Protobuf type `grafeas.v1.SlsaProvenanceZeroTwo.SlsaMaterial`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> SlsaProvenanceZeroTwo.SlsaMaterial

## Implements

[SlsaProvenanceZeroTwo.SlsaMaterialOrBuilder](/java/docs/reference/grafeas/2.23.0/io.grafeas.v1.SlsaProvenanceZeroTwo.SlsaMaterialOrBuilder)
...
```
public static SlsaProvenanceZeroTwo.SlsaMaterial getDefaultInstance()
```
...
`[SlsaProvenanceZeroTwo.SlsaMaterial](/java/docs/reference/grafeas/2.23.0/io.grafeas.v1.SlsaProvenanceZeroTwo.SlsaMaterial)`
...
```
public static SlsaProvenanceZeroTwo.SlsaMaterial.Builder newBuilder()
```
...
`[SlsaProvenanceZeroTwo.SlsaMaterial.Builder](/java/docs/reference/grafeas/2.23.0/io.grafeas.v1.SlsaProvenanceZeroTwo.SlsaMaterial.Builder)`

### newBuilder(SlsaProvenanceZeroTwo.SlsaMaterial prototype)

```
public static SlsaProvenanceZeroTwo.SlsaMaterial.Builder newBuilder(SlsaProvenanceZeroTwo.SlsaMaterial prototype)
```
...
```
public static SlsaProvenanceZeroTwo.SlsaMaterial parseDelimitedFrom(InputStream input)
```
...
```
public static SlsaProvenanceZeroTwo.SlsaMaterial parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SlsaProvenanceZeroTwo.SlsaMaterial parseFrom(byte[] data)
```
...
```
public static SlsaProvenanceZeroTwo.SlsaMaterial parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SlsaProvenanceZeroTwo.SlsaMaterial parseFrom(ByteString data)
```
...
```
public static SlsaProvenanceZeroTwo.SlsaMaterial parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SlsaProvenanceZeroTwo.SlsaMaterial parseFrom(CodedInputStream input)
```
...
```
public static SlsaProvenanceZeroTwo.SlsaMaterial parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SlsaProvenanceZeroTwo.SlsaMaterial parseFrom(InputStream input)
```
...
```
public static SlsaProvenanceZeroTwo.SlsaMaterial parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SlsaProvenanceZeroTwo.SlsaMaterial parseFrom(ByteBuffer data)
```
...
```
public static SlsaProvenanceZeroTwo.SlsaMaterial parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<SlsaProvenanceZeroTwo.SlsaMaterial> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[SlsaMaterial](/java/docs/reference/grafeas/2.23.0/io.grafeas.v1.SlsaProvenanceZeroTwo.SlsaMaterial)>`
...
```
public SlsaProvenanceZeroTwo.SlsaMaterial getDefaultInstanceForType()
```
...
Use [#getDigestMap()](/java/docs/reference/grafeas/2.23.0/io.grafeas.v1.SlsaProvenanceZeroTwo.SlsaMaterial#io_grafeas_v1_SlsaProvenanceZeroTwo_SlsaMaterial_getDigestMap__) instead.
...
```
public Parser<SlsaProvenanceZeroTwo.SlsaMaterial> getParserForType()
```
...
```
public SlsaProvenanceZeroTwo.SlsaMaterial.Builder newBuilderForType()
```
...
```
protected SlsaProvenanceZeroTwo.SlsaMaterial.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public SlsaProvenanceZeroTwo.SlsaMaterial.Builder toBuilder()
```
