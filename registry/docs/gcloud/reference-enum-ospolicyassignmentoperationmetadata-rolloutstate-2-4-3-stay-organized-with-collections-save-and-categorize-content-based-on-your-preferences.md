...
# Enum OSPolicyAssignmentOperationMetadata.RolloutState (2.4.3) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum OSPolicyAssignmentOperationMetadata.RolloutState extends Enum<OSPolicyAssignmentOperationMetadata.RolloutState> implements ProtocolMessageEnum
```
...
ROLLOUT\_STATE\_UNSPECIFIED

Invalid value

`ROLLOUT_STATE_UNSPECIFIED = 0;`

ROLLOUT\_STATE\_UNSPECIFIED\_VALUE
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-os-config/2.4.3/com.google.cloud.osconfig.v1alpha.OSPolicyAssignmentOperationMetadata.RolloutState#com_google_cloud_osconfig_v1alpha_OSPolicyAssignmentOperationMetadata_RolloutState_forNumber_int_) instead._
