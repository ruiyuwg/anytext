...
# Enum TransactionOptions.ReadWrite.ReadLockMode (6.83.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-spanner/6.83.0/com.google.spanner.v1.TransactionOptions.ReadWrite.ReadLockMode#com_google_spanner_v1_TransactionOptions_ReadWrite_ReadLockMode_forNumber_int_) instead._
