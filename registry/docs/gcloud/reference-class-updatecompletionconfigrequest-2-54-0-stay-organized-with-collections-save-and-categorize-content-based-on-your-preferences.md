...
# Class UpdateCompletionConfigRequest (2.54.0) Stay organized with collections Save and categorize content based on your preferences.
...
[UpdateCompletionConfigRequestOrBuilder](/java/docs/reference/google-cloud-retail/2.54.0/com.google.cloud.retail.v2alpha.UpdateCompletionConfigRequestOrBuilder)
...
`[UpdateCompletionConfigRequest](/java/docs/reference/google-cloud-retail/2.54.0/com.google.cloud.retail.v2alpha.UpdateCompletionConfigRequest)`
...
`[UpdateCompletionConfigRequest.Builder](/java/docs/reference/google-cloud-retail/2.54.0/com.google.cloud.retail.v2alpha.UpdateCompletionConfigRequest.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[UpdateCompletionConfigRequest](/java/docs/reference/google-cloud-retail/2.54.0/com.google.cloud.retail.v2alpha.UpdateCompletionConfigRequest)>`
...
If the caller does not have permission to update the CompletionConfig, then a PERMISSION\_DENIED error is returned.

If the CompletionConfig to update does not exist, a NOT\_FOUND error is returned.
...
`[CompletionConfig](/java/docs/reference/google-cloud-retail/2.54.0/com.google.cloud.retail.v2alpha.CompletionConfig)`
...
`[CompletionConfigOrBuilder](/java/docs/reference/google-cloud-retail/2.54.0/com.google.cloud.retail.v2alpha.CompletionConfigOrBuilder)`
...
-   CompletionConfig.auto\_learning
