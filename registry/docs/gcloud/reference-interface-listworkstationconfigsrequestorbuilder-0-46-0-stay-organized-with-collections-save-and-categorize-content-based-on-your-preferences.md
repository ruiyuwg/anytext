...
# Interface ListWorkstationConfigsRequestOrBuilder (0.46.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface ListWorkstationConfigsRequestOrBuilder extends MessageOrBuilder
```
