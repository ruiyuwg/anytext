...
# Class UpdateReportConfigRequest (0.22.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class UpdateReportConfigRequest extends GeneratedMessageV3 implements UpdateReportConfigRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> UpdateReportConfigRequest

## Implements

[UpdateReportConfigRequestOrBuilder](/java/docs/reference/google-cloud-storageinsights/0.22.0/com.google.cloud.storageinsights.v1.UpdateReportConfigRequestOrBuilder)
...
```
public static UpdateReportConfigRequest getDefaultInstance()
```
...
`[UpdateReportConfigRequest](/java/docs/reference/google-cloud-storageinsights/0.22.0/com.google.cloud.storageinsights.v1.UpdateReportConfigRequest)`
...
```
public static UpdateReportConfigRequest.Builder newBuilder()
```
...
`[UpdateReportConfigRequest.Builder](/java/docs/reference/google-cloud-storageinsights/0.22.0/com.google.cloud.storageinsights.v1.UpdateReportConfigRequest.Builder)`

### newBuilder(UpdateReportConfigRequest prototype)

```
public static UpdateReportConfigRequest.Builder newBuilder(UpdateReportConfigRequest prototype)
```
...
```
public static UpdateReportConfigRequest parseDelimitedFrom(InputStream input)
```
...
```
public static UpdateReportConfigRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateReportConfigRequest parseFrom(byte[] data)
```
...
```
public static UpdateReportConfigRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateReportConfigRequest parseFrom(ByteString data)
```
...
```
public static UpdateReportConfigRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateReportConfigRequest parseFrom(CodedInputStream input)
```
...
```
public static UpdateReportConfigRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateReportConfigRequest parseFrom(InputStream input)
```
...
```
public static UpdateReportConfigRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateReportConfigRequest parseFrom(ByteBuffer data)
```
...
```
public static UpdateReportConfigRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<UpdateReportConfigRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[UpdateReportConfigRequest](/java/docs/reference/google-cloud-storageinsights/0.22.0/com.google.cloud.storageinsights.v1.UpdateReportConfigRequest)>`
...
```
public Parser<UpdateReportConfigRequest> getParserForType()
```
...
`[ReportConfig](/java/docs/reference/google-cloud-storageinsights/0.22.0/com.google.cloud.storageinsights.v1.ReportConfig)`
...
`[ReportConfigOrBuilder](/java/docs/reference/google-cloud-storageinsights/0.22.0/com.google.cloud.storageinsights.v1.ReportConfigOrBuilder)`
...
```
public UpdateReportConfigRequest.Builder newBuilderForType()
```
...
```
protected UpdateReportConfigRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public UpdateReportConfigRequest.Builder toBuilder()
```
