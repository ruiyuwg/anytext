...
# Class DeleteRoleRequest (3.38.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class DeleteRoleRequest extends GeneratedMessageV3 implements DeleteRoleRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> DeleteRoleRequest

## Implements

[DeleteRoleRequestOrBuilder](/java/docs/reference/google-iam-admin/3.38.0/com.google.iam.admin.v1.DeleteRoleRequestOrBuilder)
...
`[DeleteRoleRequest](/java/docs/reference/google-iam-admin/3.38.0/com.google.iam.admin.v1.DeleteRoleRequest)`
...
```
public static DeleteRoleRequest.Builder newBuilder()
```
...
`[DeleteRoleRequest.Builder](/java/docs/reference/google-iam-admin/3.38.0/com.google.iam.admin.v1.DeleteRoleRequest.Builder)`

### newBuilder(DeleteRoleRequest prototype)

```
public static DeleteRoleRequest.Builder newBuilder(DeleteRoleRequest prototype)
```
...
```
public static DeleteRoleRequest parseDelimitedFrom(InputStream input)
```
...
```
public static DeleteRoleRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteRoleRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteRoleRequest parseFrom(ByteString data)
```
...
```
public static DeleteRoleRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteRoleRequest parseFrom(CodedInputStream input)
```
...
```
public static DeleteRoleRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteRoleRequest parseFrom(InputStream input)
```
...
```
public static DeleteRoleRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteRoleRequest parseFrom(ByteBuffer data)
```
...
```
public static DeleteRoleRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<DeleteRoleRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[DeleteRoleRequest](/java/docs/reference/google-iam-admin/3.38.0/com.google.iam.admin.v1.DeleteRoleRequest)>`
...
```
public Parser<DeleteRoleRequest> getParserForType()
```
...
```
public DeleteRoleRequest.Builder newBuilderForType()
```
...
```
protected DeleteRoleRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public DeleteRoleRequest.Builder toBuilder()
```
