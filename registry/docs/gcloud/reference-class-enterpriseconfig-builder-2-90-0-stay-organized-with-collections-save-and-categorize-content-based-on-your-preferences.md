...
# Class EnterpriseConfig.Builder (2.90.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class EnterpriseConfig.Builder extends GeneratedMessage.Builder<EnterpriseConfig.Builder> implements EnterpriseConfigOrBuilder
```
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessage.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessage.Builder.html) \> EnterpriseConfig.Builder

## Implements

[EnterpriseConfigOrBuilder](/java/docs/reference/google-cloud-container/latest/com.google.container.v1beta1.EnterpriseConfigOrBuilder)
...
`[EnterpriseConfig](/java/docs/reference/google-cloud-container/latest/com.google.container.v1beta1.EnterpriseConfig)`

### buildPartial()

```
public EnterpriseConfig buildPartial()
```
...
```
public EnterpriseConfig.Builder clear()
```
...
`[EnterpriseConfig.Builder](/java/docs/reference/google-cloud-container/latest/com.google.container.v1beta1.EnterpriseConfig.Builder)`
...
```
public EnterpriseConfig.Builder clearClusterTier()
```

Output only. cluster\_tier indicates the effective tier of the cluster.
...
```
public EnterpriseConfig.Builder clearDesiredTier()
```

desired\_tier specifies the desired tier of the cluster.
...
```
public EnterpriseConfig.ClusterTier getClusterTier()
```
...
`[EnterpriseConfig.ClusterTier](/java/docs/reference/google-cloud-container/latest/com.google.container.v1beta1.EnterpriseConfig.ClusterTier)`
...
```
public EnterpriseConfig getDefaultInstanceForType()
```
...
```
public EnterpriseConfig.ClusterTier getDesiredTier()
```
...
### mergeFrom(EnterpriseConfig other)

```
public EnterpriseConfig.Builder mergeFrom(EnterpriseConfig other)
```
...
```
public EnterpriseConfig.Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public EnterpriseConfig.Builder mergeFrom(Message other)
```
...
### setClusterTier(EnterpriseConfig.ClusterTier value)

```
public EnterpriseConfig.Builder setClusterTier(EnterpriseConfig.ClusterTier value)
```
...
### setClusterTierValue(int value)

```
public EnterpriseConfig.Builder setClusterTierValue(int value)
```
...
The enum numeric value on the wire for clusterTier to set.
...
### setDesiredTier(EnterpriseConfig.ClusterTier value)

```
public EnterpriseConfig.Builder setDesiredTier(EnterpriseConfig.ClusterTier value)
```
...
### setDesiredTierValue(int value)

```
public EnterpriseConfig.Builder setDesiredTierValue(int value)
```
...
The enum numeric value on the wire for desiredTier to set.
