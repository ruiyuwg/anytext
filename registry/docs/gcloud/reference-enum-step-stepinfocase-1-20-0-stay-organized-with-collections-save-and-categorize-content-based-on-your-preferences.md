...
# Enum Step.StepInfoCase (1.20.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum Step.StepInfoCase extends Enum<Step.StepInfoCase> implements Internal.EnumLite, AbstractMessageLite.InternalOneOfEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-network-management/1.20.0/com.google.cloud.networkmanagement.v1beta1.Step.StepInfoCase#com_google_cloud_networkmanagement_v1beta1_Step_StepInfoCase_forNumber_int_) instead._
