...
# Class HttpJsonFleetRoutingCallableFactory (1.85.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public class HttpJsonFleetRoutingCallableFactory implements HttpJsonStubCallableFactory<Operation,OperationsStub>
```
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> HttpJsonFleetRoutingCallableFactory
...
### HttpJsonFleetRoutingCallableFactory()

```
public HttpJsonFleetRoutingCallableFactory()
```
