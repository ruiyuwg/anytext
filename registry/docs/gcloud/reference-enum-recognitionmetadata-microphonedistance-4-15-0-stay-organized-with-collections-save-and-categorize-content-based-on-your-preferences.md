...
# Enum RecognitionMetadata.MicrophoneDistance (4.15.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-speech/4.15.0/com.google.cloud.speech.v1p1beta1.RecognitionMetadata.MicrophoneDistance#com_google_cloud_speech_v1p1beta1_RecognitionMetadata_MicrophoneDistance_forNumber_int_) instead._
