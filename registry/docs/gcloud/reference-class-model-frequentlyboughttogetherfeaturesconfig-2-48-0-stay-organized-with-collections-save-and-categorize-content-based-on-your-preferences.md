...
# Class Model.FrequentlyBoughtTogetherFeaturesConfig (2.48.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class Model.FrequentlyBoughtTogetherFeaturesConfig extends GeneratedMessageV3 implements Model.FrequentlyBoughtTogetherFeaturesConfigOrBuilder
```

Additional configs for the frequently-bought-together model type.

Protobuf type `google.cloud.retail.v2alpha.Model.FrequentlyBoughtTogetherFeaturesConfig`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> Model.FrequentlyBoughtTogetherFeaturesConfig

## Implements

[Model.FrequentlyBoughtTogetherFeaturesConfigOrBuilder](/java/docs/reference/google-cloud-retail/2.48.0/com.google.cloud.retail.v2alpha.Model.FrequentlyBoughtTogetherFeaturesConfigOrBuilder)
...
### CONTEXT\_PRODUCTS\_TYPE\_FIELD\_NUMBER

```
public static final int CONTEXT_PRODUCTS_TYPE_FIELD_NUMBER
```
...
```
public static Model.FrequentlyBoughtTogetherFeaturesConfig getDefaultInstance()
```
...
`[Model.FrequentlyBoughtTogetherFeaturesConfig](/java/docs/reference/google-cloud-retail/2.48.0/com.google.cloud.retail.v2alpha.Model.FrequentlyBoughtTogetherFeaturesConfig)`
...
```
public static Model.FrequentlyBoughtTogetherFeaturesConfig.Builder newBuilder()
```
...
`[Model.FrequentlyBoughtTogetherFeaturesConfig.Builder](/java/docs/reference/google-cloud-retail/2.48.0/com.google.cloud.retail.v2alpha.Model.FrequentlyBoughtTogetherFeaturesConfig.Builder)`

### newBuilder(Model.FrequentlyBoughtTogetherFeaturesConfig prototype)

```
public static Model.FrequentlyBoughtTogetherFeaturesConfig.Builder newBuilder(Model.FrequentlyBoughtTogetherFeaturesConfig prototype)
```
...
```
public static Model.FrequentlyBoughtTogetherFeaturesConfig parseDelimitedFrom(InputStream input)
```
...
```
public static Model.FrequentlyBoughtTogetherFeaturesConfig parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Model.FrequentlyBoughtTogetherFeaturesConfig parseFrom(byte[] data)
```
...
```
public static Model.FrequentlyBoughtTogetherFeaturesConfig parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Model.FrequentlyBoughtTogetherFeaturesConfig parseFrom(ByteString data)
```
...
```
public static Model.FrequentlyBoughtTogetherFeaturesConfig parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Model.FrequentlyBoughtTogetherFeaturesConfig parseFrom(CodedInputStream input)
```
...
```
public static Model.FrequentlyBoughtTogetherFeaturesConfig parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Model.FrequentlyBoughtTogetherFeaturesConfig parseFrom(InputStream input)
```
...
```
public static Model.FrequentlyBoughtTogetherFeaturesConfig parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Model.FrequentlyBoughtTogetherFeaturesConfig parseFrom(ByteBuffer data)
```
...
```
public static Model.FrequentlyBoughtTogetherFeaturesConfig parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<Model.FrequentlyBoughtTogetherFeaturesConfig> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[FrequentlyBoughtTogetherFeaturesConfig](/java/docs/reference/google-cloud-retail/2.48.0/com.google.cloud.retail.v2alpha.Model.FrequentlyBoughtTogetherFeaturesConfig)>`
...
Optional. Specifies the context of the model when it is used in predict requests. Can only be set for the `frequently-bought-together` type. If it isn't specified, it defaults to MULTIPLE\_CONTEXT\_PRODUCTS.
...
`[Model.ContextProductsType](/java/docs/reference/google-cloud-retail/2.48.0/com.google.cloud.retail.v2alpha.Model.ContextProductsType)`
...
```
public Parser<Model.FrequentlyBoughtTogetherFeaturesConfig> getParserForType()
```
...
```
public Model.FrequentlyBoughtTogetherFeaturesConfig.Builder newBuilderForType()
```
...
```
protected Model.FrequentlyBoughtTogetherFeaturesConfig.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public Model.FrequentlyBoughtTogetherFeaturesConfig.Builder toBuilder()
```
