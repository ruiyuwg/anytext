...
# Google Cloud Ai Platform V1 Client - Class SuggestTrialsResponse (0.38.0) Stay organized with collections Save and categorize content based on your preferences.
...
`array<[Google\Cloud\AIPlatform\V1\Trial](/php/docs/reference/cloud-ai-platform/0.38.0/V1.Trial)>`  
