...
# Enum EventThreatDetectionCustomModule.EnablementState (0.8.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum EventThreatDetectionCustomModule.EnablementState extends Enum<EventThreatDetectionCustomModule.EnablementState> implements ProtocolMessageEnum
```

The enablement state of the module.

Protobuf enum `google.cloud.securitycentermanagement.v1.EventThreatDetectionCustomModule.EnablementState`
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-securitycentermanagement/0.8.0/com.google.cloud.securitycentermanagement.v1.EventThreatDetectionCustomModule.EnablementState#com_google_cloud_securitycentermanagement_v1_EventThreatDetectionCustomModule_EnablementState_forNumber_int_) instead._
