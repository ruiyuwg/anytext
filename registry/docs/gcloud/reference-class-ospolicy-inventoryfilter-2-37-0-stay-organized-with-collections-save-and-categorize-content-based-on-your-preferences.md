...
# Class OSPolicy.InventoryFilter (2.37.0) Stay organized with collections Save and categorize content based on your preferences.
...
[OSPolicy.InventoryFilterOrBuilder](/java/docs/reference/google-cloud-os-config/2.37.0/com.google.cloud.osconfig.v1.OSPolicy.InventoryFilterOrBuilder)
...
`[OSPolicy.InventoryFilter](/java/docs/reference/google-cloud-os-config/2.37.0/com.google.cloud.osconfig.v1.OSPolicy.InventoryFilter)`
...
`[OSPolicy.InventoryFilter.Builder](/java/docs/reference/google-cloud-os-config/2.37.0/com.google.cloud.osconfig.v1.OSPolicy.InventoryFilter.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[InventoryFilter](/java/docs/reference/google-cloud-os-config/2.37.0/com.google.cloud.osconfig.v1.OSPolicy.InventoryFilter)>`
...
Prefix matches are supported if asterisk(_) is provided as the last character. For example, to match all versions with a major version of `7`, specify the following value for this field `7.`_
