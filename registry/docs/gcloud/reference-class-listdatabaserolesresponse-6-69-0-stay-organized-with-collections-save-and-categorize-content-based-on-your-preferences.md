...
# Class ListDatabaseRolesResponse (6.69.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListDatabaseRolesResponse

## Implements

[ListDatabaseRolesResponseOrBuilder](/java/docs/reference/google-cloud-spanner/6.69.0/com.google.spanner.admin.database.v1.ListDatabaseRolesResponseOrBuilder)
...
### DATABASE\_ROLES\_FIELD\_NUMBER
...
`[ListDatabaseRolesResponse](/java/docs/reference/google-cloud-spanner/6.69.0/com.google.spanner.admin.database.v1.ListDatabaseRolesResponse)`
...
`[ListDatabaseRolesResponse.Builder](/java/docs/reference/google-cloud-spanner/6.69.0/com.google.spanner.admin.database.v1.ListDatabaseRolesResponse.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListDatabaseRolesResponse](/java/docs/reference/google-cloud-spanner/6.69.0/com.google.spanner.admin.database.v1.ListDatabaseRolesResponse)>`
...
`[DatabaseRole](/java/docs/reference/google-cloud-spanner/6.69.0/com.google.spanner.admin.database.v1.DatabaseRole)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[DatabaseRole](/java/docs/reference/google-cloud-spanner/6.69.0/com.google.spanner.admin.database.v1.DatabaseRole)>`
...
`[DatabaseRoleOrBuilder](/java/docs/reference/google-cloud-spanner/6.69.0/com.google.spanner.admin.database.v1.DatabaseRoleOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.spanner.admin.database.v1.DatabaseRoleOrBuilder>`
