...
# Interface GetParticipantSessionRequestOrBuilder (0.2.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface GetParticipantSessionRequestOrBuilder extends MessageOrBuilder
```
