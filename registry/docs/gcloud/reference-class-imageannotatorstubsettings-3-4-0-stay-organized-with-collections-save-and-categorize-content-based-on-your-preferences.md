...
# Class ImageAnnotatorStubSettings (3.4.0) Stay organized with collections Save and categorize content based on your preferences.
...
Settings class to configure an instance of [ImageAnnotatorStub](/java/docs/reference/google-cloud-vision/3.4.0/com.google.cloud.vision.v1p1beta1.stub.ImageAnnotatorStub).
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [StubSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.StubSettings.html) \> ImageAnnotatorStubSettings
...
```
public static ImageAnnotatorStubSettings.Builder newBuilder()
```
...
[ImageAnnotatorStubSettings.Builder](/java/docs/reference/google-cloud-vision/3.4.0/com.google.cloud.vision.v1p1beta1.stub.ImageAnnotatorStubSettings.Builder)

### newBuilder(ClientContext clientContext)

```
public static ImageAnnotatorStubSettings.Builder newBuilder(ClientContext clientContext)
```
...
```
public static ImageAnnotatorStubSettings.Builder newHttpJsonBuilder()
```
...
### ImageAnnotatorStubSettings(ImageAnnotatorStubSettings.Builder settingsBuilder)

```
protected ImageAnnotatorStubSettings(ImageAnnotatorStubSettings.Builder settingsBuilder)
```
...
[UnaryCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.html)<[BatchAnnotateImagesRequest](/java/docs/reference/google-cloud-vision/3.4.0/com.google.cloud.vision.v1p1beta1.BatchAnnotateImagesRequest),[BatchAnnotateImagesResponse](/java/docs/reference/google-cloud-vision/3.4.0/com.google.cloud.vision.v1p1beta1.BatchAnnotateImagesResponse)\>

### createStub()

```
public ImageAnnotatorStub createStub()
```
...
[ImageAnnotatorStub](/java/docs/reference/google-cloud-vision/3.4.0/com.google.cloud.vision.v1p1beta1.stub.ImageAnnotatorStub)
...
```
public ImageAnnotatorStubSettings.Builder toBuilder()
```
