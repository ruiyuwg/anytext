...
-   [1.5.0 (latest)](/ruby/docs/reference/google-cloud-batch-v1/latest)
-   [1.4.1](/ruby/docs/reference/google-cloud-batch-v1/1.4.1)
-   [1.3.0](/ruby/docs/reference/google-cloud-batch-v1/1.3.0)
-   [1.2.0](/ruby/docs/reference/google-cloud-batch-v1/1.2.0)
-   [1.1.1](/ruby/docs/reference/google-cloud-batch-v1/1.1.1)
-   [1.0.0](/ruby/docs/reference/google-cloud-batch-v1/1.0.0)
-   [0.21.0](/ruby/docs/reference/google-cloud-batch-v1/0.21.0)
-   [0.20.1](/ruby/docs/reference/google-cloud-batch-v1/0.20.1)
-   [0.19.2](/ruby/docs/reference/google-cloud-batch-v1/0.19.2)
-   [0.18.3](/ruby/docs/reference/google-cloud-batch-v1/0.18.3)
-   [0.17.4](/ruby/docs/reference/google-cloud-batch-v1/0.17.4)
-   [0.16.2](/ruby/docs/reference/google-cloud-batch-v1/0.16.2)
-   [0.15.1](/ruby/docs/reference/google-cloud-batch-v1/0.15.1)
-   [0.14.0](/ruby/docs/reference/google-cloud-batch-v1/0.14.0)
-   [0.13.1](/ruby/docs/reference/google-cloud-batch-v1/0.13.1)
-   [0.12.0](/ruby/docs/reference/google-cloud-batch-v1/0.12.0)
-   [0.11.1](/ruby/docs/reference/google-cloud-batch-v1/0.11.1)
-   [0.10.5](/ruby/docs/reference/google-cloud-batch-v1/0.10.5)
-   [0.9.0](/ruby/docs/reference/google-cloud-batch-v1/0.9.0)
-   [0.8.0](/ruby/docs/reference/google-cloud-batch-v1/0.8.0)
-   [0.7.0](/ruby/docs/reference/google-cloud-batch-v1/0.7.0)
-   [0.6.0](/ruby/docs/reference/google-cloud-batch-v1/0.6.0)
-   [0.5.0](/ruby/docs/reference/google-cloud-batch-v1/0.5.0)
-   [0.4.3](/ruby/docs/reference/google-cloud-batch-v1/0.4.3)
-   [0.3.0](/ruby/docs/reference/google-cloud-batch-v1/0.3.0)
-   [0.2.0](/ruby/docs/reference/google-cloud-batch-v1/0.2.0)
-   [0.1.0](/ruby/docs/reference/google-cloud-batch-v1/0.1.0)
...
This gem is a _versioned_ client. It provides basic client classes for a specific version of the Batch V1 API. Most users should consider using the main client gem, [google-cloud-batch](https://rubygems.org/gems/google-cloud-batch). See the section below titled _Which client should I use?_ for more information.

## Installation

```
$ gem install google-cloud-batch-v1
```
...
3.  [Enable the API.](https://console.cloud.google.com/apis/library/batch.googleapis.com)
4.  [Set up authentication.](https://docs.cloud.google.com/ruby/docs/reference/google-cloud-batch-v1/latest/AUTHENTICATION "Set up authentication.")
...
response \= client.create\_job request

View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-batch-v1/latest) for class and method documentation.
...
Most modern Ruby client libraries for Google APIs come in two flavors: the main client library with a name such as `google-cloud-batch`, and lower-level _versioned_ client libraries with names such as `google-cloud-batch-v1`. _In most cases, you should install the main client._
...
You can use a versioned client if you are content with a possibly lower-level class interface, you explicitly want to avoid features provided by the main client, or you want to access a specific service version not be covered by the main client. You can identify versioned client gems because the service version is part of the name, e.g. `google-cloud-batch-v1`.
