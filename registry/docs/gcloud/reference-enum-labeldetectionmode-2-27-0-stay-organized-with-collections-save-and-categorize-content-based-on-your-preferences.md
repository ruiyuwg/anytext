...
# Enum LabelDetectionMode (2.27.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-video-intelligence/2.27.0/com.google.cloud.videointelligence.v1p2beta1.LabelDetectionMode#com_google_cloud_videointelligence_v1p2beta1_LabelDetectionMode_forNumber_int_) instead._
