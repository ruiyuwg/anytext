...
# Interface BatchGetSettingsRequestOrBuilder (0.44.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface BatchGetSettingsRequestOrBuilder extends MessageOrBuilder
```
