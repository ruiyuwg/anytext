...
# Google Cloud Ai Platform V1 Client - Class ResourceRuntime (1.3.0) Stay organized with collections Save and categorize content based on your preferences.
...
Reference documentation and code samples for the Google Cloud Ai Platform V1 Client class ResourceRuntime.

Persistent Cluster runtime information as output

Generated from protobuf message `google.cloud.aiplatform.v1.ResourceRuntime`
...
Example: { "RAY\_HEAD\_NODE\_INTERNAL\_IP": "head-node-IP:10001" "RAY\_DASHBOARD\_URI": "ray-dashboard-address:8888" }
