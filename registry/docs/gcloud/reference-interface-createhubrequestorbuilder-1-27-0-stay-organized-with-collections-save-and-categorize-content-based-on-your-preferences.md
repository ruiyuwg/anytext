...
# Interface CreateHubRequestOrBuilder (1.27.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[Hub](/java/docs/reference/google-cloud-networkconnectivity/1.27.0/com.google.cloud.networkconnectivity.v1.Hub)`
...
`[HubOrBuilder](/java/docs/reference/google-cloud-networkconnectivity/1.27.0/com.google.cloud.networkconnectivity.v1.HubOrBuilder)`
