...
# Class RecommenderClient.ListRecommendationsFixedSizeCollection (2.35.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ListRecommendationsPage](/java/docs/reference/google-cloud-recommender/2.35.0/com.google.cloud.recommender.v1.RecommenderClient.ListRecommendationsPage)>`  
...
`[RecommenderClient.ListRecommendationsFixedSizeCollection](/java/docs/reference/google-cloud-recommender/2.35.0/com.google.cloud.recommender.v1.RecommenderClient.ListRecommendationsFixedSizeCollection)`
