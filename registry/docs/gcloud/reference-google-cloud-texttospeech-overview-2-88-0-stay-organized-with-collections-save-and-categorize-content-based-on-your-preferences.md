...
# google-cloud-texttospeech overview (2.88.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Cloud Text-to-Speech Description:** Enables easy integration of Google text recognition technologies into developer applications. Send text and receive synthesized audio output from the Cloud Text-to-Speech API service.

[Cloud Text-to-Speech Product Reference](https://cloud.google.com/text-to-speech)

[GitHub Repository](https://github.com/googleapis/google-cloud-java/tree/main/java-texttospeech)

[Maven artifact](https://central.sonatype.com/artifact/com.google.cloud/google-cloud-texttospeech)
...
## Use the Cloud Text-to-Speech for Java
...
The example below demonstrates how you would import the BOM and include the `google-cloud-texttospeech` artifact.
...
libraryDependencies += "com.google.cloud" % "google-cloud-texttospeech" % "2.88.0"

## Which version ID should I get started with?

For this library, we recommend using [com.google.cloud.texttospeech.v1](https://cloud.google.com/java/docs/reference/google-cloud-texttospeech/2.88.0/com.google.cloud.texttospeech.v1) for new applications.
