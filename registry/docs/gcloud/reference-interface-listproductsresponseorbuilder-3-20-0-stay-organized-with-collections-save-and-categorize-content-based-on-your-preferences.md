...
# Interface ListProductsResponseOrBuilder (3.20.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[Product](/java/docs/reference/google-cloud-vision/3.20.0/com.google.cloud.vision.v1p3beta1.Product)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Product](/java/docs/reference/google-cloud-vision/3.20.0/com.google.cloud.vision.v1p3beta1.Product)>`
...
`[ProductOrBuilder](/java/docs/reference/google-cloud-vision/3.20.0/com.google.cloud.vision.v1p3beta1.ProductOrBuilder)`
