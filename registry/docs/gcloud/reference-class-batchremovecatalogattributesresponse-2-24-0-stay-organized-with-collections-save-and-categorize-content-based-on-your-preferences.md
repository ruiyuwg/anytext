...
# Class BatchRemoveCatalogAttributesResponse (2.24.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class BatchRemoveCatalogAttributesResponse extends GeneratedMessageV3 implements BatchRemoveCatalogAttributesResponseOrBuilder
```

Response of the CatalogService.BatchRemoveCatalogAttributes.

Protobuf type `google.cloud.retail.v2alpha.BatchRemoveCatalogAttributesResponse`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> BatchRemoveCatalogAttributesResponse

## Implements

[BatchRemoveCatalogAttributesResponseOrBuilder](/java/docs/reference/google-cloud-retail/2.24.0/com.google.cloud.retail.v2alpha.BatchRemoveCatalogAttributesResponseOrBuilder)
...
### DELETED\_CATALOG\_ATTRIBUTES\_FIELD\_NUMBER

```
public static final int DELETED_CATALOG_ATTRIBUTES_FIELD_NUMBER
```
...
### RESET\_CATALOG\_ATTRIBUTES\_FIELD\_NUMBER

```
public static final int RESET_CATALOG_ATTRIBUTES_FIELD_NUMBER
```
...
```
public static BatchRemoveCatalogAttributesResponse getDefaultInstance()
```
...
`[BatchRemoveCatalogAttributesResponse](/java/docs/reference/google-cloud-retail/2.24.0/com.google.cloud.retail.v2alpha.BatchRemoveCatalogAttributesResponse)`
...
```
public static BatchRemoveCatalogAttributesResponse.Builder newBuilder()
```
...
`[BatchRemoveCatalogAttributesResponse.Builder](/java/docs/reference/google-cloud-retail/2.24.0/com.google.cloud.retail.v2alpha.BatchRemoveCatalogAttributesResponse.Builder)`

### newBuilder(BatchRemoveCatalogAttributesResponse prototype)

```
public static BatchRemoveCatalogAttributesResponse.Builder newBuilder(BatchRemoveCatalogAttributesResponse prototype)
```
...
```
public static BatchRemoveCatalogAttributesResponse parseDelimitedFrom(InputStream input)
```
...
```
public static BatchRemoveCatalogAttributesResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static BatchRemoveCatalogAttributesResponse parseFrom(byte[] data)
```
...
```
public static BatchRemoveCatalogAttributesResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static BatchRemoveCatalogAttributesResponse parseFrom(ByteString data)
```
...
```
public static BatchRemoveCatalogAttributesResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static BatchRemoveCatalogAttributesResponse parseFrom(CodedInputStream input)
```
...
```
public static BatchRemoveCatalogAttributesResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static BatchRemoveCatalogAttributesResponse parseFrom(InputStream input)
```
...
```
public static BatchRemoveCatalogAttributesResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static BatchRemoveCatalogAttributesResponse parseFrom(ByteBuffer data)
```
...
```
public static BatchRemoveCatalogAttributesResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<BatchRemoveCatalogAttributesResponse> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[BatchRemoveCatalogAttributesResponse](/java/docs/reference/google-cloud-retail/2.24.0/com.google.cloud.retail.v2alpha.BatchRemoveCatalogAttributesResponse)>`
...
```
public Parser<BatchRemoveCatalogAttributesResponse> getParserForType()
```
...
```
public BatchRemoveCatalogAttributesResponse.Builder newBuilderForType()
```
...
```
protected BatchRemoveCatalogAttributesResponse.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public BatchRemoveCatalogAttributesResponse.Builder toBuilder()
```
