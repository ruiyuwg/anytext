...
# Class LocationName (2.49.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[LocationName.Builder](/java/docs/reference/google-cloud-memcache/2.49.0/com.google.cloud.memcache.v1beta2.LocationName.Builder)`
...
`[LocationName](/java/docs/reference/google-cloud-memcache/2.49.0/com.google.cloud.memcache.v1beta2.LocationName)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[LocationName](/java/docs/reference/google-cloud-memcache/2.49.0/com.google.cloud.memcache.v1beta2.LocationName)>`
