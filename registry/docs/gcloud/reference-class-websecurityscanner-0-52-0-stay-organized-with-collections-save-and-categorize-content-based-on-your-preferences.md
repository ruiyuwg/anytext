...
# Class WebSecurityScanner (0.52.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class WebSecurityScanner extends GeneratedMessageV3 implements WebSecurityScannerOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> WebSecurityScanner

## Implements

[WebSecurityScannerOrBuilder](/java/docs/reference/google-cloud-securitycenter-settings/0.52.0/com.google.cloud.securitycenter.settings.v1beta1.WebSecurityScannerOrBuilder)
...
```
public static WebSecurityScanner getDefaultInstance()
```
...
`[WebSecurityScanner](/java/docs/reference/google-cloud-securitycenter-settings/0.52.0/com.google.cloud.securitycenter.settings.v1beta1.WebSecurityScanner)`
...
```
public static WebSecurityScanner.Builder newBuilder()
```
...
`[WebSecurityScanner.Builder](/java/docs/reference/google-cloud-securitycenter-settings/0.52.0/com.google.cloud.securitycenter.settings.v1beta1.WebSecurityScanner.Builder)`

### newBuilder(WebSecurityScanner prototype)

```
public static WebSecurityScanner.Builder newBuilder(WebSecurityScanner prototype)
```
...
```
public static WebSecurityScanner parseDelimitedFrom(InputStream input)
```
...
```
public static WebSecurityScanner parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static WebSecurityScanner parseFrom(byte[] data)
```
...
```
public static WebSecurityScanner parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static WebSecurityScanner parseFrom(ByteString data)
```
...
```
public static WebSecurityScanner parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static WebSecurityScanner parseFrom(CodedInputStream input)
```
...
```
public static WebSecurityScanner parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static WebSecurityScanner parseFrom(InputStream input)
```
...
```
public static WebSecurityScanner parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static WebSecurityScanner parseFrom(ByteBuffer data)
```
...
```
public static WebSecurityScanner parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<WebSecurityScanner> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[WebSecurityScanner](/java/docs/reference/google-cloud-securitycenter-settings/0.52.0/com.google.cloud.securitycenter.settings.v1beta1.WebSecurityScanner)>`
...
```
public WebSecurityScanner getDefaultInstanceForType()
```
...
```
public Parser<WebSecurityScanner> getParserForType()
```
...
```
public WebSecurityScanner.Builder newBuilderForType()
```
...
```
protected WebSecurityScanner.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public WebSecurityScanner.Builder toBuilder()
```
