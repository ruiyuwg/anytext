...
# Class VodSessionAdBreak (0.22.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> VodSessionAdBreak

## Implements

[VodSessionAdBreakOrBuilder](/java/docs/reference/google-cloud-video-stitcher/0.22.0/com.google.cloud.video.stitcher.v1.VodSessionAdBreakOrBuilder)
...
### END\_TIME\_OFFSET\_FIELD\_NUMBER
...
### PROGRESS\_EVENTS\_FIELD\_NUMBER
...
### START\_TIME\_OFFSET\_FIELD\_NUMBER
...
`[VodSessionAdBreak](/java/docs/reference/google-cloud-video-stitcher/0.22.0/com.google.cloud.video.stitcher.v1.VodSessionAdBreak)`
...
`[VodSessionAdBreak.Builder](/java/docs/reference/google-cloud-video-stitcher/0.22.0/com.google.cloud.video.stitcher.v1.VodSessionAdBreak.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[VodSessionAdBreak](/java/docs/reference/google-cloud-video-stitcher/0.22.0/com.google.cloud.video.stitcher.v1.VodSessionAdBreak)>`
...
`[VodSessionAd](/java/docs/reference/google-cloud-video-stitcher/0.22.0/com.google.cloud.video.stitcher.v1.VodSessionAd)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[VodSessionAd](/java/docs/reference/google-cloud-video-stitcher/0.22.0/com.google.cloud.video.stitcher.v1.VodSessionAd)>`
...
`[VodSessionAdOrBuilder](/java/docs/reference/google-cloud-video-stitcher/0.22.0/com.google.cloud.video.stitcher.v1.VodSessionAdOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.video.stitcher.v1.VodSessionAdOrBuilder>`
...
`[ProgressEvent](/java/docs/reference/google-cloud-video-stitcher/0.22.0/com.google.cloud.video.stitcher.v1.ProgressEvent)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ProgressEvent](/java/docs/reference/google-cloud-video-stitcher/0.22.0/com.google.cloud.video.stitcher.v1.ProgressEvent)>`
...
`[ProgressEventOrBuilder](/java/docs/reference/google-cloud-video-stitcher/0.22.0/com.google.cloud.video.stitcher.v1.ProgressEventOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.video.stitcher.v1.ProgressEventOrBuilder>`
