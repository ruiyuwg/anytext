...
# Class ServiceMonitoringServiceClient.ListServicesFixedSizeCollection (3.53.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class ServiceMonitoringServiceClient.ListServicesFixedSizeCollection extends AbstractFixedSizeCollection<ListServicesRequest,ListServicesResponse,Service,ServiceMonitoringServiceClient.ListServicesPage,ServiceMonitoringServiceClient.ListServicesFixedSizeCollection>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractFixedSizeCollection](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractFixedSizeCollection.html) \> ServiceMonitoringServiceClient.ListServicesFixedSizeCollection
...
### createCollection(List<ServiceMonitoringServiceClient.ListServicesPage> pages, int collectionSize)

```
protected ServiceMonitoringServiceClient.ListServicesFixedSizeCollection createCollection(List<ServiceMonitoringServiceClient.ListServicesPage> pages, int collectionSize)
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ListServicesPage](/java/docs/reference/google-cloud-monitoring/3.53.0/com.google.cloud.monitoring.v3.ServiceMonitoringServiceClient.ListServicesPage)>`  
...
`[ServiceMonitoringServiceClient.ListServicesFixedSizeCollection](/java/docs/reference/google-cloud-monitoring/3.53.0/com.google.cloud.monitoring.v3.ServiceMonitoringServiceClient.ListServicesFixedSizeCollection)`
