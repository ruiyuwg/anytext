...
# Interface FaceDetectionConfigOrBuilder (2.20.0) Stay organized with collections Save and categorize content based on your preferences.
...
Whether to enable face attributes detection, such as glasses, dark\_glasses, mouth\_open etc. Ignored if 'include\_bounding\_boxes' is set to false.
