...
# Google Cloud Ai Platform V1 Client - Class SearchTrialSpec (0.20.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[Google\Cloud\AIPlatform\V1\CustomJobSpec](/php/docs/reference/cloud-ai-platform/0.20.0/V1.CustomJobSpec)`  
...
`[Google\Cloud\AIPlatform\V1\CustomJobSpec](/php/docs/reference/cloud-ai-platform/0.20.0/V1.CustomJobSpec)|null`
