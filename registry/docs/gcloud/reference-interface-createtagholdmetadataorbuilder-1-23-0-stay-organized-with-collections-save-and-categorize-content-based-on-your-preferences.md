...
# Interface CreateTagHoldMetadataOrBuilder (1.23.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface CreateTagHoldMetadataOrBuilder extends MessageOrBuilder
```
