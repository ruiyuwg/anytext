...
# Class PauseMigrationResponse (1.6.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class PauseMigrationResponse extends GeneratedMessageV3 implements PauseMigrationResponseOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> PauseMigrationResponse

## Implements

[PauseMigrationResponseOrBuilder](/java/docs/reference/google-cloud-vmmigration/1.6.0/com.google.cloud.vmmigration.v1.PauseMigrationResponseOrBuilder)
...
```
public static PauseMigrationResponse getDefaultInstance()
```
...
[PauseMigrationResponse](/java/docs/reference/google-cloud-vmmigration/1.6.0/com.google.cloud.vmmigration.v1.PauseMigrationResponse)
...
```
public static PauseMigrationResponse.Builder newBuilder()
```
...
[PauseMigrationResponse.Builder](/java/docs/reference/google-cloud-vmmigration/1.6.0/com.google.cloud.vmmigration.v1.PauseMigrationResponse.Builder)

### newBuilder(PauseMigrationResponse prototype)

```
public static PauseMigrationResponse.Builder newBuilder(PauseMigrationResponse prototype)
```
...
```
public static PauseMigrationResponse parseDelimitedFrom(InputStream input)
```
...
```
public static PauseMigrationResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PauseMigrationResponse parseFrom(byte[] data)
```
...
```
public static PauseMigrationResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PauseMigrationResponse parseFrom(ByteString data)
```
...
```
public static PauseMigrationResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PauseMigrationResponse parseFrom(CodedInputStream input)
```
...
```
public static PauseMigrationResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PauseMigrationResponse parseFrom(InputStream input)
```
...
```
public static PauseMigrationResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PauseMigrationResponse parseFrom(ByteBuffer data)
```
...
```
public static PauseMigrationResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<PauseMigrationResponse> parser()
```
...
[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[PauseMigrationResponse](/java/docs/reference/google-cloud-vmmigration/1.6.0/com.google.cloud.vmmigration.v1.PauseMigrationResponse)\>
...
```
public PauseMigrationResponse getDefaultInstanceForType()
```
...
```
public Parser<PauseMigrationResponse> getParserForType()
```
...
```
public PauseMigrationResponse.Builder newBuilderForType()
```
...
```
protected PauseMigrationResponse.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public PauseMigrationResponse.Builder toBuilder()
```
