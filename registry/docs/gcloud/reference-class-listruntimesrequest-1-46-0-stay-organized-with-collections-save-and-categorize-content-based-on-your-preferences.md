...
# Class ListRuntimesRequest (1.46.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListRuntimesRequest extends GeneratedMessageV3 implements ListRuntimesRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListRuntimesRequest

## Implements

[ListRuntimesRequestOrBuilder](/java/docs/reference/google-cloud-notebooks/1.46.0/com.google.cloud.notebooks.v1.ListRuntimesRequestOrBuilder)
...
```
public static ListRuntimesRequest getDefaultInstance()
```
...
`[ListRuntimesRequest](/java/docs/reference/google-cloud-notebooks/1.46.0/com.google.cloud.notebooks.v1.ListRuntimesRequest)`
...
```
public static ListRuntimesRequest.Builder newBuilder()
```
...
`[ListRuntimesRequest.Builder](/java/docs/reference/google-cloud-notebooks/1.46.0/com.google.cloud.notebooks.v1.ListRuntimesRequest.Builder)`

### newBuilder(ListRuntimesRequest prototype)

```
public static ListRuntimesRequest.Builder newBuilder(ListRuntimesRequest prototype)
```
...
```
public static ListRuntimesRequest parseDelimitedFrom(InputStream input)
```
...
```
public static ListRuntimesRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListRuntimesRequest parseFrom(byte[] data)
```
...
```
public static ListRuntimesRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListRuntimesRequest parseFrom(ByteString data)
```
...
```
public static ListRuntimesRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListRuntimesRequest parseFrom(CodedInputStream input)
```
...
```
public static ListRuntimesRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListRuntimesRequest parseFrom(InputStream input)
```
...
```
public static ListRuntimesRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListRuntimesRequest parseFrom(ByteBuffer data)
```
...
```
public static ListRuntimesRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ListRuntimesRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListRuntimesRequest](/java/docs/reference/google-cloud-notebooks/1.46.0/com.google.cloud.notebooks.v1.ListRuntimesRequest)>`
...
```
public Parser<ListRuntimesRequest> getParserForType()
```
...
```
public ListRuntimesRequest.Builder newBuilderForType()
```
...
```
protected ListRuntimesRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ListRuntimesRequest.Builder toBuilder()
```
