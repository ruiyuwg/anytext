...
# Class Database (2.56.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> Database

## Implements

[DatabaseOrBuilder](/java/docs/reference/google-cloud-securitycenter/2.56.0/com.google.cloud.securitycenter.v2.DatabaseOrBuilder)
...
`[Database](/java/docs/reference/google-cloud-securitycenter/2.56.0/com.google.cloud.securitycenter.v2.Database)`
...
`[Database.Builder](/java/docs/reference/google-cloud-securitycenter/2.56.0/com.google.cloud.securitycenter.v2.Database.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[Database](/java/docs/reference/google-cloud-securitycenter/2.56.0/com.google.cloud.securitycenter.v2.Database)>`
...
The version of the database, for example, POSTGRES\_14. See [the complete list](https://cloud.google.com/sql/docs/mysql/admin-api/rest/v1/SqlDatabaseVersion).
