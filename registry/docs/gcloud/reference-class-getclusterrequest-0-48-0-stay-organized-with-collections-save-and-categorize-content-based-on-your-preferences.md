...
# Class GetClusterRequest (0.48.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class GetClusterRequest extends GeneratedMessageV3 implements GetClusterRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> GetClusterRequest

## Implements

[GetClusterRequestOrBuilder](/java/docs/reference/google-cloud-vmwareengine/0.48.0/com.google.cloud.vmwareengine.v1.GetClusterRequestOrBuilder)
...
```
public static GetClusterRequest getDefaultInstance()
```
...
`[GetClusterRequest](/java/docs/reference/google-cloud-vmwareengine/0.48.0/com.google.cloud.vmwareengine.v1.GetClusterRequest)`
...
```
public static GetClusterRequest.Builder newBuilder()
```
...
`[GetClusterRequest.Builder](/java/docs/reference/google-cloud-vmwareengine/0.48.0/com.google.cloud.vmwareengine.v1.GetClusterRequest.Builder)`

### newBuilder(GetClusterRequest prototype)

```
public static GetClusterRequest.Builder newBuilder(GetClusterRequest prototype)
```
...
```
public static GetClusterRequest parseDelimitedFrom(InputStream input)
```
...
```
public static GetClusterRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetClusterRequest parseFrom(byte[] data)
```
...
```
public static GetClusterRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetClusterRequest parseFrom(ByteString data)
```
...
```
public static GetClusterRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetClusterRequest parseFrom(CodedInputStream input)
```
...
```
public static GetClusterRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetClusterRequest parseFrom(InputStream input)
```
...
```
public static GetClusterRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetClusterRequest parseFrom(ByteBuffer data)
```
...
```
public static GetClusterRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<GetClusterRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[GetClusterRequest](/java/docs/reference/google-cloud-vmwareengine/0.48.0/com.google.cloud.vmwareengine.v1.GetClusterRequest)>`
...
Required. The cluster resource name to retrieve. Resource names are schemeless URIs that follow the conventions in [https://cloud.google.com/apis/design/resource\_names](https://cloud.google.com/apis/design/resource_names). For example: `projects/my-project/locations/us-central1-a/privateClouds/my-cloud/clusters/my-cluster`
...
```
public Parser<GetClusterRequest> getParserForType()
```
...
```
public GetClusterRequest.Builder newBuilderForType()
```
...
```
protected GetClusterRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public GetClusterRequest.Builder toBuilder()
```
