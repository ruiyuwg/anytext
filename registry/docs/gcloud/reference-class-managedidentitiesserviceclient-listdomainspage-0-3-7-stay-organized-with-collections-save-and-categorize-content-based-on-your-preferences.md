...
# Class ManagedIdentitiesServiceClient.ListDomainsPage (0.3.7) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class ManagedIdentitiesServiceClient.ListDomainsPage extends AbstractPage<ListDomainsRequest,ListDomainsResponse,Domain,ManagedIdentitiesServiceClient.ListDomainsPage>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractPage](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractPage.html) \> ManagedIdentitiesServiceClient.ListDomainsPage
...
### createPage(PageContext<ListDomainsRequest,ListDomainsResponse,Domain> context, ListDomainsResponse response)

```
protected ManagedIdentitiesServiceClient.ListDomainsPage createPage(PageContext<ListDomainsRequest,ListDomainsResponse,Domain> context, ListDomainsResponse response)
```
...
`[PageContext](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PageContext.html)<[ListDomainsRequest](/java/docs/reference/google-cloud-managed-identities/0.3.7/com.google.cloud.managedidentities.v1.ListDomainsRequest),[ListDomainsResponse](/java/docs/reference/google-cloud-managed-identities/0.3.7/com.google.cloud.managedidentities.v1.ListDomainsResponse),[Domain](/java/docs/reference/google-cloud-managed-identities/0.3.7/com.google.cloud.managedidentities.v1.Domain)>`  

response

`[ListDomainsResponse](/java/docs/reference/google-cloud-managed-identities/0.3.7/com.google.cloud.managedidentities.v1.ListDomainsResponse)`  
...
[ManagedIdentitiesServiceClient.ListDomainsPage](/java/docs/reference/google-cloud-managed-identities/0.3.7/com.google.cloud.managedidentities.v1.ManagedIdentitiesServiceClient.ListDomainsPage)
...
### createPageAsync(PageContext<ListDomainsRequest,ListDomainsResponse,Domain> context, ApiFuture<ListDomainsResponse> futureResponse)

```
public ApiFuture<ManagedIdentitiesServiceClient.ListDomainsPage> createPageAsync(PageContext<ListDomainsRequest,ListDomainsResponse,Domain> context, ApiFuture<ListDomainsResponse> futureResponse)
```
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListDomainsResponse](/java/docs/reference/google-cloud-managed-identities/0.3.7/com.google.cloud.managedidentities.v1.ListDomainsResponse)>`  
...
[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListDomainsPage](/java/docs/reference/google-cloud-managed-identities/0.3.7/com.google.cloud.managedidentities.v1.ManagedIdentitiesServiceClient.ListDomainsPage)\>
