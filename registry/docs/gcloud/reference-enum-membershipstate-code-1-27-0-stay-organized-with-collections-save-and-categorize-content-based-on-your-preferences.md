...
# Enum MembershipState.Code (1.27.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum MembershipState.Code extends Enum<MembershipState.Code> implements ProtocolMessageEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-gkehub/1.27.0/com.google.cloud.gkehub.v1.MembershipState.Code#com_google_cloud_gkehub_v1_MembershipState_Code_forNumber_int_) instead._
