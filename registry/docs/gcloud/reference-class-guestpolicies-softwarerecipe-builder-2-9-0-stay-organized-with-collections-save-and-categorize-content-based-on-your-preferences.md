...
# Class GuestPolicies.SoftwareRecipe.Builder (2.9.0) Stay organized with collections Save and categorize content based on your preferences.
...
[GuestPolicies.SoftwareRecipeOrBuilder](/java/docs/reference/google-cloud-os-config/2.9.0/com.google.cloud.osconfig.v1beta.GuestPolicies.SoftwareRecipeOrBuilder)
...
[GuestPolicies.SoftwareRecipe.Builder](/java/docs/reference/google-cloud-os-config/2.9.0/com.google.cloud.osconfig.v1beta.GuestPolicies.SoftwareRecipe.Builder)
...
`[GuestPolicies.SoftwareRecipe.Artifact](/java/docs/reference/google-cloud-os-config/2.9.0/com.google.cloud.osconfig.v1beta.GuestPolicies.SoftwareRecipe.Artifact)`  
...
`[GuestPolicies.SoftwareRecipe.Artifact.Builder](/java/docs/reference/google-cloud-os-config/2.9.0/com.google.cloud.osconfig.v1beta.GuestPolicies.SoftwareRecipe.Artifact.Builder)`  
...
`[GuestPolicies.SoftwareRecipe.Step](/java/docs/reference/google-cloud-os-config/2.9.0/com.google.cloud.osconfig.v1beta.GuestPolicies.SoftwareRecipe.Step)`  
...
`[GuestPolicies.SoftwareRecipe.Step.Builder](/java/docs/reference/google-cloud-os-config/2.9.0/com.google.cloud.osconfig.v1beta.GuestPolicies.SoftwareRecipe.Step.Builder)`  
...
[GuestPolicies.SoftwareRecipe](/java/docs/reference/google-cloud-os-config/2.9.0/com.google.cloud.osconfig.v1beta.GuestPolicies.SoftwareRecipe)
...
[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Builder](/java/docs/reference/google-cloud-os-config/2.9.0/com.google.cloud.osconfig.v1beta.GuestPolicies.SoftwareRecipe.Artifact.Builder)\>
...
[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Artifact](/java/docs/reference/google-cloud-os-config/2.9.0/com.google.cloud.osconfig.v1beta.GuestPolicies.SoftwareRecipe.Artifact)\>
...
[GuestPolicies.SoftwareRecipe.ArtifactOrBuilder](/java/docs/reference/google-cloud-os-config/2.9.0/com.google.cloud.osconfig.v1beta.GuestPolicies.SoftwareRecipe.ArtifactOrBuilder)
...
[GuestPolicies.DesiredState](/java/docs/reference/google-cloud-os-config/2.9.0/com.google.cloud.osconfig.v1beta.GuestPolicies.DesiredState)
...
[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Builder](/java/docs/reference/google-cloud-os-config/2.9.0/com.google.cloud.osconfig.v1beta.GuestPolicies.SoftwareRecipe.Step.Builder)\>
...
[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Step](/java/docs/reference/google-cloud-os-config/2.9.0/com.google.cloud.osconfig.v1beta.GuestPolicies.SoftwareRecipe.Step)\>
...
[GuestPolicies.SoftwareRecipe.StepOrBuilder](/java/docs/reference/google-cloud-os-config/2.9.0/com.google.cloud.osconfig.v1beta.GuestPolicies.SoftwareRecipe.StepOrBuilder)
