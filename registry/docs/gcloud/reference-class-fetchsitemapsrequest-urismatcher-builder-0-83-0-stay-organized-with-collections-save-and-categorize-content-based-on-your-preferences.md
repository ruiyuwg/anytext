...
# Class FetchSitemapsRequest.UrisMatcher.Builder (0.83.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class FetchSitemapsRequest.UrisMatcher.Builder extends GeneratedMessage.Builder<FetchSitemapsRequest.UrisMatcher.Builder> implements FetchSitemapsRequest.UrisMatcherOrBuilder
```
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessage.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessage.Builder.html) \> FetchSitemapsRequest.UrisMatcher.Builder

## Implements

[FetchSitemapsRequest.UrisMatcherOrBuilder](/java/docs/reference/google-cloud-discoveryengine/latest/com.google.cloud.discoveryengine.v1beta.FetchSitemapsRequest.UrisMatcherOrBuilder)
...
```
public FetchSitemapsRequest.UrisMatcher.Builder addAllUris(Iterable<String> values)
```
...
`[FetchSitemapsRequest.UrisMatcher.Builder](/java/docs/reference/google-cloud-discoveryengine/latest/com.google.cloud.discoveryengine.v1beta.FetchSitemapsRequest.UrisMatcher.Builder)`
...
```
public FetchSitemapsRequest.UrisMatcher.Builder addUris(String value)
```
...
```
public FetchSitemapsRequest.UrisMatcher.Builder addUrisBytes(ByteString value)
```
...
```
public FetchSitemapsRequest.UrisMatcher build()
```
...
`[FetchSitemapsRequest.UrisMatcher](/java/docs/reference/google-cloud-discoveryengine/latest/com.google.cloud.discoveryengine.v1beta.FetchSitemapsRequest.UrisMatcher)`

### buildPartial()

```
public FetchSitemapsRequest.UrisMatcher buildPartial()
```
...
```
public FetchSitemapsRequest.UrisMatcher.Builder clear()
```
...
```
public FetchSitemapsRequest.UrisMatcher.Builder clearUris()
```
...
```
public FetchSitemapsRequest.UrisMatcher getDefaultInstanceForType()
```
...
```
public FetchSitemapsRequest.UrisMatcher.Builder mergeFrom(FetchSitemapsRequest.UrisMatcher other)
```
...
```
public FetchSitemapsRequest.UrisMatcher.Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public FetchSitemapsRequest.UrisMatcher.Builder mergeFrom(Message other)
```
...
```
public FetchSitemapsRequest.UrisMatcher.Builder setUris(int index, String value)
```
