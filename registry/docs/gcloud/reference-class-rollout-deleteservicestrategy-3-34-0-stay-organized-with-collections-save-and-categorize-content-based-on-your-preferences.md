...
# Class Rollout.DeleteServiceStrategy (3.34.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class Rollout.DeleteServiceStrategy extends GeneratedMessageV3 implements Rollout.DeleteServiceStrategyOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> Rollout.DeleteServiceStrategy

## Implements

[Rollout.DeleteServiceStrategyOrBuilder](/java/docs/reference/google-cloud-service-management/3.34.0/com.google.api.servicemanagement.v1.Rollout.DeleteServiceStrategyOrBuilder)
...
```
public static Rollout.DeleteServiceStrategy getDefaultInstance()
```
...
`[Rollout.DeleteServiceStrategy](/java/docs/reference/google-cloud-service-management/3.34.0/com.google.api.servicemanagement.v1.Rollout.DeleteServiceStrategy)`
...
```
public static Rollout.DeleteServiceStrategy.Builder newBuilder()
```
...
`[Rollout.DeleteServiceStrategy.Builder](/java/docs/reference/google-cloud-service-management/3.34.0/com.google.api.servicemanagement.v1.Rollout.DeleteServiceStrategy.Builder)`

### newBuilder(Rollout.DeleteServiceStrategy prototype)

```
public static Rollout.DeleteServiceStrategy.Builder newBuilder(Rollout.DeleteServiceStrategy prototype)
```
...
```
public static Rollout.DeleteServiceStrategy parseDelimitedFrom(InputStream input)
```
...
```
public static Rollout.DeleteServiceStrategy parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Rollout.DeleteServiceStrategy parseFrom(byte[] data)
```
...
```
public static Rollout.DeleteServiceStrategy parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Rollout.DeleteServiceStrategy parseFrom(ByteString data)
```
...
```
public static Rollout.DeleteServiceStrategy parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Rollout.DeleteServiceStrategy parseFrom(CodedInputStream input)
```
...
```
public static Rollout.DeleteServiceStrategy parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Rollout.DeleteServiceStrategy parseFrom(InputStream input)
```
...
```
public static Rollout.DeleteServiceStrategy parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Rollout.DeleteServiceStrategy parseFrom(ByteBuffer data)
```
...
```
public static Rollout.DeleteServiceStrategy parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<Rollout.DeleteServiceStrategy> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[DeleteServiceStrategy](/java/docs/reference/google-cloud-service-management/3.34.0/com.google.api.servicemanagement.v1.Rollout.DeleteServiceStrategy)>`
...
```
public Rollout.DeleteServiceStrategy getDefaultInstanceForType()
```
...
```
public Parser<Rollout.DeleteServiceStrategy> getParserForType()
```
...
```
public Rollout.DeleteServiceStrategy.Builder newBuilderForType()
```
...
```
protected Rollout.DeleteServiceStrategy.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public Rollout.DeleteServiceStrategy.Builder toBuilder()
```
