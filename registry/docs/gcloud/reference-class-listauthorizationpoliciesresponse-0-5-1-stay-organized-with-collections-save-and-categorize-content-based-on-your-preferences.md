...
# Class ListAuthorizationPoliciesResponse (0.5.1) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListAuthorizationPoliciesResponse extends GeneratedMessageV3 implements ListAuthorizationPoliciesResponseOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListAuthorizationPoliciesResponse

## Implements

[ListAuthorizationPoliciesResponseOrBuilder](/java/docs/reference/google-cloud-network-security/0.5.1/com.google.cloud.networksecurity.v1beta1.ListAuthorizationPoliciesResponseOrBuilder)
...
### AUTHORIZATION\_POLICIES\_FIELD\_NUMBER

```
public static final int AUTHORIZATION_POLICIES_FIELD_NUMBER
```
...
```
public static ListAuthorizationPoliciesResponse getDefaultInstance()
```
...
[ListAuthorizationPoliciesResponse](/java/docs/reference/google-cloud-network-security/0.5.1/com.google.cloud.networksecurity.v1beta1.ListAuthorizationPoliciesResponse)
...
```
public static ListAuthorizationPoliciesResponse.Builder newBuilder()
```
...
[ListAuthorizationPoliciesResponse.Builder](/java/docs/reference/google-cloud-network-security/0.5.1/com.google.cloud.networksecurity.v1beta1.ListAuthorizationPoliciesResponse.Builder)

### newBuilder(ListAuthorizationPoliciesResponse prototype)

```
public static ListAuthorizationPoliciesResponse.Builder newBuilder(ListAuthorizationPoliciesResponse prototype)
```
...
```
public static ListAuthorizationPoliciesResponse parseDelimitedFrom(InputStream input)
```
...
```
public static ListAuthorizationPoliciesResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListAuthorizationPoliciesResponse parseFrom(byte[] data)
```
...
```
public static ListAuthorizationPoliciesResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListAuthorizationPoliciesResponse parseFrom(ByteString data)
```
...
```
public static ListAuthorizationPoliciesResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListAuthorizationPoliciesResponse parseFrom(CodedInputStream input)
```
...
```
public static ListAuthorizationPoliciesResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListAuthorizationPoliciesResponse parseFrom(InputStream input)
```
...
```
public static ListAuthorizationPoliciesResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListAuthorizationPoliciesResponse parseFrom(ByteBuffer data)
```
...
```
public static ListAuthorizationPoliciesResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ListAuthorizationPoliciesResponse> parser()
```
...
[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListAuthorizationPoliciesResponse](/java/docs/reference/google-cloud-network-security/0.5.1/com.google.cloud.networksecurity.v1beta1.ListAuthorizationPoliciesResponse)\>
...
```
public AuthorizationPolicy getAuthorizationPolicies(int index)
```
...
[AuthorizationPolicy](/java/docs/reference/google-cloud-network-security/0.5.1/com.google.cloud.networksecurity.v1beta1.AuthorizationPolicy)
...
```
public List<AuthorizationPolicy> getAuthorizationPoliciesList()
```
...
[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[AuthorizationPolicy](/java/docs/reference/google-cloud-network-security/0.5.1/com.google.cloud.networksecurity.v1beta1.AuthorizationPolicy)\>

### getAuthorizationPoliciesOrBuilder(int index)

```
public AuthorizationPolicyOrBuilder getAuthorizationPoliciesOrBuilder(int index)
```
...
[AuthorizationPolicyOrBuilder](/java/docs/reference/google-cloud-network-security/0.5.1/com.google.cloud.networksecurity.v1beta1.AuthorizationPolicyOrBuilder)

### getAuthorizationPoliciesOrBuilderList()

```
public List<? extends AuthorizationPolicyOrBuilder> getAuthorizationPoliciesOrBuilderList()
```
...
[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.networksecurity.v1beta1.AuthorizationPolicyOrBuilder\>

### getDefaultInstanceForType()

```
public ListAuthorizationPoliciesResponse getDefaultInstanceForType()
```
...
```
public Parser<ListAuthorizationPoliciesResponse> getParserForType()
```
...
```
public ListAuthorizationPoliciesResponse.Builder newBuilderForType()
```
...
```
protected ListAuthorizationPoliciesResponse.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ListAuthorizationPoliciesResponse.Builder toBuilder()
```
