...
# Cloud Translation V3 Client - Class DatasetOutputConfig (1.20.2) Stay organized with collections Save and categorize content based on your preferences.
...
`[GcsOutputDestination](/php/docs/reference/cloud-translate/1.20.2/V3.GcsOutputDestination)`  
...
`[GcsOutputDestination](/php/docs/reference/cloud-translate/1.20.2/V3.GcsOutputDestination)|null`
