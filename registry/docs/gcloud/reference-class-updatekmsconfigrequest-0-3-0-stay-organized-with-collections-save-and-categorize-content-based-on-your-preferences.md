...
# Class UpdateKmsConfigRequest (0.3.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class UpdateKmsConfigRequest extends GeneratedMessageV3 implements UpdateKmsConfigRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> UpdateKmsConfigRequest

## Implements

[UpdateKmsConfigRequestOrBuilder](/java/docs/reference/google-cloud-netapp/0.3.0/com.google.cloud.netapp.v1.UpdateKmsConfigRequestOrBuilder)
...
```
public static UpdateKmsConfigRequest getDefaultInstance()
```
...
`[UpdateKmsConfigRequest](/java/docs/reference/google-cloud-netapp/0.3.0/com.google.cloud.netapp.v1.UpdateKmsConfigRequest)`
...
```
public static UpdateKmsConfigRequest.Builder newBuilder()
```
...
`[UpdateKmsConfigRequest.Builder](/java/docs/reference/google-cloud-netapp/0.3.0/com.google.cloud.netapp.v1.UpdateKmsConfigRequest.Builder)`

### newBuilder(UpdateKmsConfigRequest prototype)

```
public static UpdateKmsConfigRequest.Builder newBuilder(UpdateKmsConfigRequest prototype)
```
...
```
public static UpdateKmsConfigRequest parseDelimitedFrom(InputStream input)
```
...
```
public static UpdateKmsConfigRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateKmsConfigRequest parseFrom(byte[] data)
```
...
```
public static UpdateKmsConfigRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateKmsConfigRequest parseFrom(ByteString data)
```
...
```
public static UpdateKmsConfigRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateKmsConfigRequest parseFrom(CodedInputStream input)
```
...
```
public static UpdateKmsConfigRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateKmsConfigRequest parseFrom(InputStream input)
```
...
```
public static UpdateKmsConfigRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateKmsConfigRequest parseFrom(ByteBuffer data)
```
...
```
public static UpdateKmsConfigRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<UpdateKmsConfigRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[UpdateKmsConfigRequest](/java/docs/reference/google-cloud-netapp/0.3.0/com.google.cloud.netapp.v1.UpdateKmsConfigRequest)>`
...
```
public UpdateKmsConfigRequest getDefaultInstanceForType()
```
...
`[KmsConfig](/java/docs/reference/google-cloud-netapp/0.3.0/com.google.cloud.netapp.v1.KmsConfig)`
...
`[KmsConfigOrBuilder](/java/docs/reference/google-cloud-netapp/0.3.0/com.google.cloud.netapp.v1.KmsConfigOrBuilder)`

### getParserForType()

```
public Parser<UpdateKmsConfigRequest> getParserForType()
```
...
Required. Field mask is used to specify the fields to be overwritten in the KmsConfig resource by the update. The fields specified in the update\_mask are relative to the resource, not the full request. A field will be overwritten if it is in the mask. If the user does not provide a mask then all fields will be overwritten.
...
```
public UpdateKmsConfigRequest.Builder newBuilderForType()
```
...
```
protected UpdateKmsConfigRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public UpdateKmsConfigRequest.Builder toBuilder()
```
