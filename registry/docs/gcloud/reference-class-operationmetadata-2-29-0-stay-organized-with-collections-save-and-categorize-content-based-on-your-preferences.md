...
# Class OperationMetadata (2.29.0) Stay organized with collections Save and categorize content based on your preferences.
...
[OperationMetadataOrBuilder](/java/docs/reference/google-cloud-service-usage/2.29.0/com.google.api.serviceusage.v1.OperationMetadataOrBuilder)
...
### RESOURCE\_NAMES\_FIELD\_NUMBER
...
`[OperationMetadata](/java/docs/reference/google-cloud-service-usage/2.29.0/com.google.api.serviceusage.v1.OperationMetadata)`
...
`[OperationMetadata.Builder](/java/docs/reference/google-cloud-service-usage/2.29.0/com.google.api.serviceusage.v1.OperationMetadata.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[OperationMetadata](/java/docs/reference/google-cloud-service-usage/2.29.0/com.google.api.serviceusage.v1.OperationMetadata)>`
