...
# Interface ListFoldersResponseOrBuilder (1.45.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[Folder](/java/docs/reference/google-cloud-resourcemanager/1.45.0/com.google.cloud.resourcemanager.v3.Folder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Folder](/java/docs/reference/google-cloud-resourcemanager/1.45.0/com.google.cloud.resourcemanager.v3.Folder)>`
...
`[FolderOrBuilder](/java/docs/reference/google-cloud-resourcemanager/1.45.0/com.google.cloud.resourcemanager.v3.FolderOrBuilder)`
