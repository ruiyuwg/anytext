...
# Interface BinauthzVersionOrBuilder (1.59.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface BinauthzVersionOrBuilder extends MessageOrBuilder
```
...
```
public abstract String getWebhookVersion()
```
...
```
public abstract ByteString getWebhookVersionBytes()
```
