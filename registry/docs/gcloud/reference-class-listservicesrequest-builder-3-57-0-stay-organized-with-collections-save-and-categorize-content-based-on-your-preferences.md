...
# Class ListServicesRequest.Builder (3.57.0) Stay organized with collections Save and categorize content based on your preferences.
...
[ListServicesRequestOrBuilder](/java/docs/reference/google-cloud-service-management/3.57.0/com.google.api.servicemanagement.v1.ListServicesRequestOrBuilder)
...
`[ListServicesRequest.Builder](/java/docs/reference/google-cloud-service-management/3.57.0/com.google.api.servicemanagement.v1.ListServicesRequest.Builder)`
...
`[ListServicesRequest](/java/docs/reference/google-cloud-service-management/3.57.0/com.google.api.servicemanagement.v1.ListServicesRequest)`
...
### clearConsumerId() (deprecated)

```
public ListServicesRequest.Builder clearConsumerId()
```

**Deprecated.** _google.api.servicemanagement.v1.ListServicesRequest.consumer\_id is deprecated. See google/api/servicemanagement/v1/servicemanager.proto;l=278_
...
```
public ListServicesRequest.Builder clearProducerProjectId()
```
...
### setConsumerId(String value) (deprecated)

```
public ListServicesRequest.Builder setConsumerId(String value)
```
...
### setConsumerIdBytes(ByteString value) (deprecated)

```
public ListServicesRequest.Builder setConsumerIdBytes(ByteString value)
```
...
```
public ListServicesRequest.Builder setProducerProjectId(String value)
```
...
```
public ListServicesRequest.Builder setProducerProjectIdBytes(ByteString value)
```
