...
# Class UpdateNamespaceRequest (2.36.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> UpdateNamespaceRequest

## Implements

[UpdateNamespaceRequestOrBuilder](/java/docs/reference/google-cloud-servicedirectory/2.36.0/com.google.cloud.servicedirectory.v1beta1.UpdateNamespaceRequestOrBuilder)
...
`[UpdateNamespaceRequest](/java/docs/reference/google-cloud-servicedirectory/2.36.0/com.google.cloud.servicedirectory.v1beta1.UpdateNamespaceRequest)`
...
`[UpdateNamespaceRequest.Builder](/java/docs/reference/google-cloud-servicedirectory/2.36.0/com.google.cloud.servicedirectory.v1beta1.UpdateNamespaceRequest.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[UpdateNamespaceRequest](/java/docs/reference/google-cloud-servicedirectory/2.36.0/com.google.cloud.servicedirectory.v1beta1.UpdateNamespaceRequest)>`
...
`[Namespace](/java/docs/reference/google-cloud-servicedirectory/2.36.0/com.google.cloud.servicedirectory.v1beta1.Namespace)`
...
`[NamespaceOrBuilder](/java/docs/reference/google-cloud-servicedirectory/2.36.0/com.google.cloud.servicedirectory.v1beta1.NamespaceOrBuilder)`
...
```
public UpdateNamespaceRequest.Builder newBuilderForType()
```
...
```
protected UpdateNamespaceRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
