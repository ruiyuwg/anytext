...
# Class EdgeCluster (1.11.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class EdgeCluster extends GeneratedMessageV3 implements EdgeClusterOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> EdgeCluster

## Implements

[EdgeClusterOrBuilder](/java/docs/reference/google-cloud-gkehub/1.11.0/com.google.cloud.gkehub.v1beta1.EdgeClusterOrBuilder)
...
```
public static EdgeCluster getDefaultInstance()
```
...
`[EdgeCluster](/java/docs/reference/google-cloud-gkehub/1.11.0/com.google.cloud.gkehub.v1beta1.EdgeCluster)`
...
```
public static EdgeCluster.Builder newBuilder()
```
...
`[EdgeCluster.Builder](/java/docs/reference/google-cloud-gkehub/1.11.0/com.google.cloud.gkehub.v1beta1.EdgeCluster.Builder)`

### newBuilder(EdgeCluster prototype)

```
public static EdgeCluster.Builder newBuilder(EdgeCluster prototype)
```
...
```
public static EdgeCluster parseDelimitedFrom(InputStream input)
```
...
```
public static EdgeCluster parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static EdgeCluster parseFrom(byte[] data)
```
...
```
public static EdgeCluster parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static EdgeCluster parseFrom(ByteString data)
```
...
```
public static EdgeCluster parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static EdgeCluster parseFrom(CodedInputStream input)
```
...
```
public static EdgeCluster parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static EdgeCluster parseFrom(InputStream input)
```
...
```
public static EdgeCluster parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static EdgeCluster parseFrom(ByteBuffer data)
```
...
```
public static EdgeCluster parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<EdgeCluster> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[EdgeCluster](/java/docs/reference/google-cloud-gkehub/1.11.0/com.google.cloud.gkehub.v1beta1.EdgeCluster)>`
...
```
public EdgeCluster getDefaultInstanceForType()
```
...
```
public Parser<EdgeCluster> getParserForType()
```
...
```
public EdgeCluster.Builder newBuilderForType()
```
...
```
protected EdgeCluster.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public EdgeCluster.Builder toBuilder()
```
