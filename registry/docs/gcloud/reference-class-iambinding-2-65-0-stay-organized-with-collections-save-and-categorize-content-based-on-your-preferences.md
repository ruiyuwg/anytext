...
# Class IamBinding (2.65.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class IamBinding extends GeneratedMessageV3 implements IamBindingOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> IamBinding

## Implements

[IamBindingOrBuilder](/java/docs/reference/google-cloud-securitycenter/2.65.0/com.google.cloud.securitycenter.v1.IamBindingOrBuilder)
...
```
public static IamBinding getDefaultInstance()
```
...
`[IamBinding](/java/docs/reference/google-cloud-securitycenter/2.65.0/com.google.cloud.securitycenter.v1.IamBinding)`
...
```
public static IamBinding.Builder newBuilder()
```
...
`[IamBinding.Builder](/java/docs/reference/google-cloud-securitycenter/2.65.0/com.google.cloud.securitycenter.v1.IamBinding.Builder)`

### newBuilder(IamBinding prototype)

```
public static IamBinding.Builder newBuilder(IamBinding prototype)
```
...
```
public static IamBinding parseDelimitedFrom(InputStream input)
```
...
```
public static IamBinding parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static IamBinding parseFrom(byte[] data)
```
...
```
public static IamBinding parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static IamBinding parseFrom(ByteString data)
```
...
```
public static IamBinding parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static IamBinding parseFrom(CodedInputStream input)
```
...
```
public static IamBinding parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static IamBinding parseFrom(InputStream input)
```
...
```
public static IamBinding parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static IamBinding parseFrom(ByteBuffer data)
```
...
```
public static IamBinding parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<IamBinding> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[IamBinding](/java/docs/reference/google-cloud-securitycenter/2.65.0/com.google.cloud.securitycenter.v1.IamBinding)>`
...
```
public IamBinding.Action getAction()
```
...
`[IamBinding.Action](/java/docs/reference/google-cloud-securitycenter/2.65.0/com.google.cloud.securitycenter.v1.IamBinding.Action)`
...
```
public IamBinding getDefaultInstanceForType()
```
...
```
public Parser<IamBinding> getParserForType()
```
...
```
public IamBinding.Builder newBuilderForType()
```
...
```
protected IamBinding.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public IamBinding.Builder toBuilder()
```
