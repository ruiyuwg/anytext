...
# Class HttpJsonPoliciesCallableFactory (1.29.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public class HttpJsonPoliciesCallableFactory implements HttpJsonStubCallableFactory<Operation,OperationsStub>
```
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> HttpJsonPoliciesCallableFactory
...
### HttpJsonPoliciesCallableFactory()

```
public HttpJsonPoliciesCallableFactory()
```
