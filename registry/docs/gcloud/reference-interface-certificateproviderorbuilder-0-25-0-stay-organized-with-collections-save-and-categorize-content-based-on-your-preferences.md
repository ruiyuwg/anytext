...
# Interface CertificateProviderOrBuilder (0.25.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[CertificateProviderInstance](/java/docs/reference/google-cloud-network-security/0.25.0/com.google.cloud.networksecurity.v1.CertificateProviderInstance)`
...
`[CertificateProviderInstanceOrBuilder](/java/docs/reference/google-cloud-network-security/0.25.0/com.google.cloud.networksecurity.v1.CertificateProviderInstanceOrBuilder)`
...
`[GrpcEndpoint](/java/docs/reference/google-cloud-network-security/0.25.0/com.google.cloud.networksecurity.v1.GrpcEndpoint)`
...
`[GrpcEndpointOrBuilder](/java/docs/reference/google-cloud-network-security/0.25.0/com.google.cloud.networksecurity.v1.GrpcEndpointOrBuilder)`

### getTypeCase()

```
public abstract CertificateProvider.TypeCase getTypeCase()
```
...
`[CertificateProvider.TypeCase](/java/docs/reference/google-cloud-network-security/0.25.0/com.google.cloud.networksecurity.v1.CertificateProvider.TypeCase)`
