...
# Class SecurityCenterClient.ListFindingsFixedSizeCollection (2.49.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class SecurityCenterClient.ListFindingsFixedSizeCollection extends AbstractFixedSizeCollection<ListFindingsRequest,ListFindingsResponse,ListFindingsResponse.ListFindingsResult,SecurityCenterClient.ListFindingsPage,SecurityCenterClient.ListFindingsFixedSizeCollection>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractFixedSizeCollection](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractFixedSizeCollection.html) \> SecurityCenterClient.ListFindingsFixedSizeCollection
...
### createCollection(List<SecurityCenterClient.ListFindingsPage> pages, int collectionSize)

```
protected SecurityCenterClient.ListFindingsFixedSizeCollection createCollection(List<SecurityCenterClient.ListFindingsPage> pages, int collectionSize)
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ListFindingsPage](/java/docs/reference/google-cloud-securitycenter/2.49.0/com.google.cloud.securitycenter.v1.SecurityCenterClient.ListFindingsPage)>`  
...
`[SecurityCenterClient.ListFindingsFixedSizeCollection](/java/docs/reference/google-cloud-securitycenter/2.49.0/com.google.cloud.securitycenter.v1.SecurityCenterClient.ListFindingsFixedSizeCollection)`
