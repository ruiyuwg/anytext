...
# Class DeleteProjectMetadata (1.3.2) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class DeleteProjectMetadata extends GeneratedMessageV3 implements DeleteProjectMetadataOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> DeleteProjectMetadata

## Implements

[DeleteProjectMetadataOrBuilder](/java/docs/reference/google-cloud-resourcemanager/1.3.2/com.google.cloud.resourcemanager.v3.DeleteProjectMetadataOrBuilder)
...
```
public static DeleteProjectMetadata getDefaultInstance()
```
...
[DeleteProjectMetadata](/java/docs/reference/google-cloud-resourcemanager/1.3.2/com.google.cloud.resourcemanager.v3.DeleteProjectMetadata)
...
```
public static DeleteProjectMetadata.Builder newBuilder()
```
...
[DeleteProjectMetadata.Builder](/java/docs/reference/google-cloud-resourcemanager/1.3.2/com.google.cloud.resourcemanager.v3.DeleteProjectMetadata.Builder)

### newBuilder(DeleteProjectMetadata prototype)

```
public static DeleteProjectMetadata.Builder newBuilder(DeleteProjectMetadata prototype)
```
...
```
public static DeleteProjectMetadata parseDelimitedFrom(InputStream input)
```
...
```
public static DeleteProjectMetadata parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteProjectMetadata parseFrom(byte[] data)
```
...
```
public static DeleteProjectMetadata parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteProjectMetadata parseFrom(ByteString data)
```
...
```
public static DeleteProjectMetadata parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteProjectMetadata parseFrom(CodedInputStream input)
```
...
```
public static DeleteProjectMetadata parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteProjectMetadata parseFrom(InputStream input)
```
...
```
public static DeleteProjectMetadata parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteProjectMetadata parseFrom(ByteBuffer data)
```
...
```
public static DeleteProjectMetadata parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<DeleteProjectMetadata> parser()
```
...
[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[DeleteProjectMetadata](/java/docs/reference/google-cloud-resourcemanager/1.3.2/com.google.cloud.resourcemanager.v3.DeleteProjectMetadata)\>
...
```
public Parser<DeleteProjectMetadata> getParserForType()
```
...
```
public DeleteProjectMetadata.Builder newBuilderForType()
```
...
```
protected DeleteProjectMetadata.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public DeleteProjectMetadata.Builder toBuilder()
```
