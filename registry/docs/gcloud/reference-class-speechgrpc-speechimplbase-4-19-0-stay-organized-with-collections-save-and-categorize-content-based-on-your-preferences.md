...
# Class SpeechGrpc.SpeechImplBase (4.19.0) Stay organized with collections Save and categorize content based on your preferences.
...
io.grpc.BindableService, [SpeechGrpc.AsyncService](/java/docs/reference/google-cloud-speech/4.19.0/com.google.cloud.speech.v2.SpeechGrpc.AsyncService)
