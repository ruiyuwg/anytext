...
# Class OSPolicy.InventoryFilter (2.17.0) Stay organized with collections Save and categorize content based on your preferences.
...
[OSPolicy.InventoryFilterOrBuilder](/java/docs/reference/google-cloud-os-config/2.17.0/com.google.cloud.osconfig.v1.OSPolicy.InventoryFilterOrBuilder)
...
`[OSPolicy.InventoryFilter](/java/docs/reference/google-cloud-os-config/2.17.0/com.google.cloud.osconfig.v1.OSPolicy.InventoryFilter)`
...
`[OSPolicy.InventoryFilter.Builder](/java/docs/reference/google-cloud-os-config/2.17.0/com.google.cloud.osconfig.v1.OSPolicy.InventoryFilter.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[InventoryFilter](/java/docs/reference/google-cloud-os-config/2.17.0/com.google.cloud.osconfig.v1.OSPolicy.InventoryFilter)>`
