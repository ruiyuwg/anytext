...
# Interface WriteUserEventRequestOrBuilder (0.66.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[UserEventOrBuilder](/java/docs/reference/google-cloud-recommendations-ai/0.66.0/com.google.cloud.recommendationengine.v1beta1.UserEventOrBuilder)`
