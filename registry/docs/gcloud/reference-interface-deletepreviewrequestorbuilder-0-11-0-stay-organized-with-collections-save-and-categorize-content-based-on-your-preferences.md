...
# Interface DeletePreviewRequestOrBuilder (0.11.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface DeletePreviewRequestOrBuilder extends MessageOrBuilder
```
...
Required. The name of the Preview in the format: 'projects/{project\_id}/locations/{location}/previews/{preview}'.
