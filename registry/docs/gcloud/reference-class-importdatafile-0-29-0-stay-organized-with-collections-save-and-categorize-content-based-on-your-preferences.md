...
# Class ImportDataFile (0.29.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ImportDataFile extends GeneratedMessageV3 implements ImportDataFileOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ImportDataFile

## Implements

[ImportDataFileOrBuilder](/java/docs/reference/google-cloud-migrationcenter/0.29.0/com.google.cloud.migrationcenter.v1.ImportDataFileOrBuilder)
...
### UPLOAD\_FILE\_INFO\_FIELD\_NUMBER

```
public static final int UPLOAD_FILE_INFO_FIELD_NUMBER
```
...
```
public static ImportDataFile getDefaultInstance()
```
...
`[ImportDataFile](/java/docs/reference/google-cloud-migrationcenter/0.29.0/com.google.cloud.migrationcenter.v1.ImportDataFile)`
...
```
public static ImportDataFile.Builder newBuilder()
```
...
`[ImportDataFile.Builder](/java/docs/reference/google-cloud-migrationcenter/0.29.0/com.google.cloud.migrationcenter.v1.ImportDataFile.Builder)`

### newBuilder(ImportDataFile prototype)

```
public static ImportDataFile.Builder newBuilder(ImportDataFile prototype)
```
...
```
public static ImportDataFile parseDelimitedFrom(InputStream input)
```
...
```
public static ImportDataFile parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ImportDataFile parseFrom(byte[] data)
```
...
```
public static ImportDataFile parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ImportDataFile parseFrom(ByteString data)
```
...
```
public static ImportDataFile parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ImportDataFile parseFrom(CodedInputStream input)
```
...
```
public static ImportDataFile parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ImportDataFile parseFrom(InputStream input)
```
...
```
public static ImportDataFile parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ImportDataFile parseFrom(ByteBuffer data)
```
...
```
public static ImportDataFile parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ImportDataFile> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ImportDataFile](/java/docs/reference/google-cloud-migrationcenter/0.29.0/com.google.cloud.migrationcenter.v1.ImportDataFile)>`
...
`[ImportDataFile.FileInfoCase](/java/docs/reference/google-cloud-migrationcenter/0.29.0/com.google.cloud.migrationcenter.v1.ImportDataFile.FileInfoCase)`
...
`[ImportJobFormat](/java/docs/reference/google-cloud-migrationcenter/0.29.0/com.google.cloud.migrationcenter.v1.ImportJobFormat)`
...
```
public Parser<ImportDataFile> getParserForType()
```
...
`[ImportDataFile.State](/java/docs/reference/google-cloud-migrationcenter/0.29.0/com.google.cloud.migrationcenter.v1.ImportDataFile.State)`
...
`[UploadFileInfo](/java/docs/reference/google-cloud-migrationcenter/0.29.0/com.google.cloud.migrationcenter.v1.UploadFileInfo)`
...
`[UploadFileInfoOrBuilder](/java/docs/reference/google-cloud-migrationcenter/0.29.0/com.google.cloud.migrationcenter.v1.UploadFileInfoOrBuilder)`
...
```
public ImportDataFile.Builder newBuilderForType()
```
...
```
protected ImportDataFile.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ImportDataFile.Builder toBuilder()
```
