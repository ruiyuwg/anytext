...
# Enum UtilizationReportView (1.49.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-vmmigration/1.49.0/com.google.cloud.vmmigration.v1.UtilizationReportView#com_google_cloud_vmmigration_v1_UtilizationReportView_forNumber_int_) instead._
