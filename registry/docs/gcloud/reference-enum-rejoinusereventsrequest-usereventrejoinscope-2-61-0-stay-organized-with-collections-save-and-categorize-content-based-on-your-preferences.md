...
# Enum RejoinUserEventsRequest.UserEventRejoinScope (2.61.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum RejoinUserEventsRequest.UserEventRejoinScope extends Enum<RejoinUserEventsRequest.UserEventRejoinScope> implements ProtocolMessageEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-retail/2.61.0/com.google.cloud.retail.v2.RejoinUserEventsRequest.UserEventRejoinScope#com_google_cloud_retail_v2_RejoinUserEventsRequest_UserEventRejoinScope_forNumber_int_) instead._
