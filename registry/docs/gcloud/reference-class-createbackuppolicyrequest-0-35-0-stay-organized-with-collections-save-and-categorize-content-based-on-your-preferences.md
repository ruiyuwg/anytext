...
# Class CreateBackupPolicyRequest (0.35.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class CreateBackupPolicyRequest extends GeneratedMessageV3 implements CreateBackupPolicyRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> CreateBackupPolicyRequest

## Implements

[CreateBackupPolicyRequestOrBuilder](/java/docs/reference/google-cloud-netapp/0.35.0/com.google.cloud.netapp.v1.CreateBackupPolicyRequestOrBuilder)
...
### BACKUP\_POLICY\_ID\_FIELD\_NUMBER

```
public static final int BACKUP_POLICY_ID_FIELD_NUMBER
```
...
```
public static CreateBackupPolicyRequest getDefaultInstance()
```
...
`[CreateBackupPolicyRequest](/java/docs/reference/google-cloud-netapp/0.35.0/com.google.cloud.netapp.v1.CreateBackupPolicyRequest)`
...
```
public static CreateBackupPolicyRequest.Builder newBuilder()
```
...
`[CreateBackupPolicyRequest.Builder](/java/docs/reference/google-cloud-netapp/0.35.0/com.google.cloud.netapp.v1.CreateBackupPolicyRequest.Builder)`

### newBuilder(CreateBackupPolicyRequest prototype)

```
public static CreateBackupPolicyRequest.Builder newBuilder(CreateBackupPolicyRequest prototype)
```
...
```
public static CreateBackupPolicyRequest parseDelimitedFrom(InputStream input)
```
...
```
public static CreateBackupPolicyRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateBackupPolicyRequest parseFrom(byte[] data)
```
...
```
public static CreateBackupPolicyRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateBackupPolicyRequest parseFrom(ByteString data)
```
...
```
public static CreateBackupPolicyRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateBackupPolicyRequest parseFrom(CodedInputStream input)
```
...
```
public static CreateBackupPolicyRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateBackupPolicyRequest parseFrom(InputStream input)
```
...
```
public static CreateBackupPolicyRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CreateBackupPolicyRequest parseFrom(ByteBuffer data)
```
...
```
public static CreateBackupPolicyRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<CreateBackupPolicyRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[CreateBackupPolicyRequest](/java/docs/reference/google-cloud-netapp/0.35.0/com.google.cloud.netapp.v1.CreateBackupPolicyRequest)>`
...
`[BackupPolicy](/java/docs/reference/google-cloud-netapp/0.35.0/com.google.cloud.netapp.v1.BackupPolicy)`
...
`[BackupPolicyOrBuilder](/java/docs/reference/google-cloud-netapp/0.35.0/com.google.cloud.netapp.v1.BackupPolicyOrBuilder)`
...
```
public Parser<CreateBackupPolicyRequest> getParserForType()
```
...
```
public CreateBackupPolicyRequest.Builder newBuilderForType()
```
...
```
protected CreateBackupPolicyRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public CreateBackupPolicyRequest.Builder toBuilder()
```
