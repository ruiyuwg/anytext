...
# Enum WorkstationConfig.PersistentDirectory.DirectoryTypeCase (0.19.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum WorkstationConfig.PersistentDirectory.DirectoryTypeCase extends Enum<WorkstationConfig.PersistentDirectory.DirectoryTypeCase> implements Internal.EnumLite, AbstractMessageLite.InternalOneOfEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-workstations/0.19.0/com.google.cloud.workstations.v1beta.WorkstationConfig.PersistentDirectory.DirectoryTypeCase#com_google_cloud_workstations_v1beta_WorkstationConfig_PersistentDirectory_DirectoryTypeCase_forNumber_int_) instead._
