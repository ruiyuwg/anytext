...
# Class SubmitConfigSourceRequest (3.21.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> SubmitConfigSourceRequest

## Implements

[SubmitConfigSourceRequestOrBuilder](/java/docs/reference/google-cloud-service-management/3.21.0/com.google.api.servicemanagement.v1.SubmitConfigSourceRequestOrBuilder)
...
`[SubmitConfigSourceRequest](/java/docs/reference/google-cloud-service-management/3.21.0/com.google.api.servicemanagement.v1.SubmitConfigSourceRequest)`
...
```
public static SubmitConfigSourceRequest.Builder newBuilder()
```
...
`[SubmitConfigSourceRequest.Builder](/java/docs/reference/google-cloud-service-management/3.21.0/com.google.api.servicemanagement.v1.SubmitConfigSourceRequest.Builder)`

### newBuilder(SubmitConfigSourceRequest prototype)

```
public static SubmitConfigSourceRequest.Builder newBuilder(SubmitConfigSourceRequest prototype)
```
...
```
public static SubmitConfigSourceRequest parseDelimitedFrom(InputStream input)
```
...
```
public static SubmitConfigSourceRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SubmitConfigSourceRequest parseFrom(byte[] data)
```
...
```
public static SubmitConfigSourceRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SubmitConfigSourceRequest parseFrom(ByteString data)
```
...
```
public static SubmitConfigSourceRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SubmitConfigSourceRequest parseFrom(CodedInputStream input)
```
...
```
public static SubmitConfigSourceRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SubmitConfigSourceRequest parseFrom(InputStream input)
```
...
```
public static SubmitConfigSourceRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SubmitConfigSourceRequest parseFrom(ByteBuffer data)
```
...
```
public static SubmitConfigSourceRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[SubmitConfigSourceRequest](/java/docs/reference/google-cloud-service-management/3.21.0/com.google.api.servicemanagement.v1.SubmitConfigSourceRequest)>`
...
`[ConfigSource](/java/docs/reference/google-cloud-service-management/3.21.0/com.google.api.servicemanagement.v1.ConfigSource)`
...
`[ConfigSourceOrBuilder](/java/docs/reference/google-cloud-service-management/3.21.0/com.google.api.servicemanagement.v1.ConfigSourceOrBuilder)`
...
```
public SubmitConfigSourceRequest.Builder newBuilderForType()
```
...
```
protected SubmitConfigSourceRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public SubmitConfigSourceRequest.Builder toBuilder()
```
