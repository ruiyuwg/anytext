...
# Class GetRouteRequest (1.47.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class GetRouteRequest extends GeneratedMessageV3 implements GetRouteRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> GetRouteRequest

## Implements

[GetRouteRequestOrBuilder](/java/docs/reference/google-cloud-networkconnectivity/1.47.0/com.google.cloud.networkconnectivity.v1.GetRouteRequestOrBuilder)
...
`[GetRouteRequest](/java/docs/reference/google-cloud-networkconnectivity/1.47.0/com.google.cloud.networkconnectivity.v1.GetRouteRequest)`
...
```
public static GetRouteRequest.Builder newBuilder()
```
...
`[GetRouteRequest.Builder](/java/docs/reference/google-cloud-networkconnectivity/1.47.0/com.google.cloud.networkconnectivity.v1.GetRouteRequest.Builder)`

### newBuilder(GetRouteRequest prototype)

```
public static GetRouteRequest.Builder newBuilder(GetRouteRequest prototype)
```
...
```
public static GetRouteRequest parseDelimitedFrom(InputStream input)
```
...
```
public static GetRouteRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetRouteRequest parseFrom(byte[] data)
```
...
```
public static GetRouteRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetRouteRequest parseFrom(ByteString data)
```
...
```
public static GetRouteRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetRouteRequest parseFrom(CodedInputStream input)
```
...
```
public static GetRouteRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetRouteRequest parseFrom(InputStream input)
```
...
```
public static GetRouteRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetRouteRequest parseFrom(ByteBuffer data)
```
...
```
public static GetRouteRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[GetRouteRequest](/java/docs/reference/google-cloud-networkconnectivity/1.47.0/com.google.cloud.networkconnectivity.v1.GetRouteRequest)>`
...
```
public GetRouteRequest getDefaultInstanceForType()
```
...
```
public Parser<GetRouteRequest> getParserForType()
```
...
```
public GetRouteRequest.Builder newBuilderForType()
```
...
```
protected GetRouteRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public GetRouteRequest.Builder toBuilder()
```
