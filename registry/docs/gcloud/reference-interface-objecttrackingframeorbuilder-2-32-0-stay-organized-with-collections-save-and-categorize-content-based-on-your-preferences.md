...
# Interface ObjectTrackingFrameOrBuilder (2.32.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[NormalizedBoundingBox](/java/docs/reference/google-cloud-video-intelligence/2.32.0/com.google.cloud.videointelligence.v1.NormalizedBoundingBox)`
...
`[NormalizedBoundingBoxOrBuilder](/java/docs/reference/google-cloud-video-intelligence/2.32.0/com.google.cloud.videointelligence.v1.NormalizedBoundingBoxOrBuilder)`
