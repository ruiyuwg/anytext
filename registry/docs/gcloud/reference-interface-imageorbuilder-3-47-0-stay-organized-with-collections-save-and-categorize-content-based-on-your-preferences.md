...
# Interface ImageOrBuilder (3.47.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[ImageSource](/java/docs/reference/google-cloud-vision/3.47.0/com.google.cloud.vision.v1p1beta1.ImageSource)`
...
`[ImageSourceOrBuilder](/java/docs/reference/google-cloud-vision/3.47.0/com.google.cloud.vision.v1p1beta1.ImageSourceOrBuilder)`
