...
# Interface BatchCreateNotesRequestOrBuilder (2.53.0) Stay organized with collections Save and categorize content based on your preferences.
...
Use [#getNotesMap()](/java/docs/reference/grafeas/2.53.0/io.grafeas.v1.BatchCreateNotesRequestOrBuilder#io_grafeas_v1_BatchCreateNotesRequestOrBuilder_getNotesMap__) instead.
...
`[Map](https://docs.oracle.com/javase/8/docs/api/java/util/Map.html)<[String](https://docs.oracle.com/javase/8/docs/api/java/lang/String.html),[Note](/java/docs/reference/grafeas/2.53.0/io.grafeas.v1.Note)>`
...
`[Note](/java/docs/reference/grafeas/2.53.0/io.grafeas.v1.Note)`  
