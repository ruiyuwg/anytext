...
# Class PredictionServiceStub (2.31.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[UnaryCallable](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallable.html)<[PredictRequest](/java/docs/reference/google-cloud-retail/2.31.0/com.google.cloud.retail.v2alpha.PredictRequest),[PredictResponse](/java/docs/reference/google-cloud-retail/2.31.0/com.google.cloud.retail.v2alpha.PredictResponse)>`
