...
# Class AnswerQueryRequest.SafetySpec.Builder (0.83.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class AnswerQueryRequest.SafetySpec.Builder extends GeneratedMessage.Builder<AnswerQueryRequest.SafetySpec.Builder> implements AnswerQueryRequest.SafetySpecOrBuilder
```

Safety specification.

Protobuf type `google.cloud.discoveryengine.v1beta.AnswerQueryRequest.SafetySpec`

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessage.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessage.Builder.html) \> AnswerQueryRequest.SafetySpec.Builder

## Implements

[AnswerQueryRequest.SafetySpecOrBuilder](/java/docs/reference/google-cloud-discoveryengine/latest/com.google.cloud.discoveryengine.v1beta.AnswerQueryRequest.SafetySpecOrBuilder)
...
```
public AnswerQueryRequest.SafetySpec build()
```
...
`[AnswerQueryRequest.SafetySpec](/java/docs/reference/google-cloud-discoveryengine/latest/com.google.cloud.discoveryengine.v1beta.AnswerQueryRequest.SafetySpec)`

### buildPartial()

```
public AnswerQueryRequest.SafetySpec buildPartial()
```
...
```
public AnswerQueryRequest.SafetySpec.Builder clear()
```
...
`[AnswerQueryRequest.SafetySpec.Builder](/java/docs/reference/google-cloud-discoveryengine/latest/com.google.cloud.discoveryengine.v1beta.AnswerQueryRequest.SafetySpec.Builder)`
...
```
public AnswerQueryRequest.SafetySpec.Builder clearEnable()
```
...
```
public AnswerQueryRequest.SafetySpec getDefaultInstanceForType()
```
...
### mergeFrom(AnswerQueryRequest.SafetySpec other)

```
public AnswerQueryRequest.SafetySpec.Builder mergeFrom(AnswerQueryRequest.SafetySpec other)
```
...
```
public AnswerQueryRequest.SafetySpec.Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public AnswerQueryRequest.SafetySpec.Builder mergeFrom(Message other)
```
...
```
public AnswerQueryRequest.SafetySpec.Builder setEnable(boolean value)
```
