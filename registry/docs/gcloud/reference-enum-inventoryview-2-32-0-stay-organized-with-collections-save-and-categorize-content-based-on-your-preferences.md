...
# Enum InventoryView (2.32.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum InventoryView extends Enum<InventoryView> implements ProtocolMessageEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-os-config/2.32.0/com.google.cloud.osconfig.v1alpha.InventoryView#com_google_cloud_osconfig_v1alpha_InventoryView_forNumber_int_) instead._
