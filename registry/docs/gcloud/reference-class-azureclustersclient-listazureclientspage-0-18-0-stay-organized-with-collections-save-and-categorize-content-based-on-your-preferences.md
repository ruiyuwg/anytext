...
# Class AzureClustersClient.ListAzureClientsPage (0.18.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class AzureClustersClient.ListAzureClientsPage extends AbstractPage<ListAzureClientsRequest,ListAzureClientsResponse,AzureClient,AzureClustersClient.ListAzureClientsPage>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractPage](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractPage.html) \> AzureClustersClient.ListAzureClientsPage
...
### createPage(PageContext<ListAzureClientsRequest,ListAzureClientsResponse,AzureClient> context, ListAzureClientsResponse response)

```
protected AzureClustersClient.ListAzureClientsPage createPage(PageContext<ListAzureClientsRequest,ListAzureClientsResponse,AzureClient> context, ListAzureClientsResponse response)
```
...
`[PageContext](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PageContext.html)<[ListAzureClientsRequest](/java/docs/reference/google-cloud-gke-multi-cloud/0.18.0/com.google.cloud.gkemulticloud.v1.ListAzureClientsRequest),[ListAzureClientsResponse](/java/docs/reference/google-cloud-gke-multi-cloud/0.18.0/com.google.cloud.gkemulticloud.v1.ListAzureClientsResponse),[AzureClient](/java/docs/reference/google-cloud-gke-multi-cloud/0.18.0/com.google.cloud.gkemulticloud.v1.AzureClient)>`  

`response`

`[ListAzureClientsResponse](/java/docs/reference/google-cloud-gke-multi-cloud/0.18.0/com.google.cloud.gkemulticloud.v1.ListAzureClientsResponse)`  
...
`[AzureClustersClient.ListAzureClientsPage](/java/docs/reference/google-cloud-gke-multi-cloud/0.18.0/com.google.cloud.gkemulticloud.v1.AzureClustersClient.ListAzureClientsPage)`
...
### createPageAsync(PageContext<ListAzureClientsRequest,ListAzureClientsResponse,AzureClient> context, ApiFuture<ListAzureClientsResponse> futureResponse)

```
public ApiFuture<AzureClustersClient.ListAzureClientsPage> createPageAsync(PageContext<ListAzureClientsRequest,ListAzureClientsResponse,AzureClient> context, ApiFuture<ListAzureClientsResponse> futureResponse)
```
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListAzureClientsResponse](/java/docs/reference/google-cloud-gke-multi-cloud/0.18.0/com.google.cloud.gkemulticloud.v1.ListAzureClientsResponse)>`  
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListAzureClientsPage](/java/docs/reference/google-cloud-gke-multi-cloud/0.18.0/com.google.cloud.gkemulticloud.v1.AzureClustersClient.ListAzureClientsPage)>`
