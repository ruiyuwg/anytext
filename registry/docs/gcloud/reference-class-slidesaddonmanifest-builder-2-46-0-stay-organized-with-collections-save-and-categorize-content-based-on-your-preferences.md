...
# Class SlidesAddOnManifest.Builder (2.46.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class SlidesAddOnManifest.Builder extends GeneratedMessageV3.Builder<SlidesAddOnManifest.Builder> implements SlidesAddOnManifestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> SlidesAddOnManifest.Builder
...
```
public SlidesAddOnManifest.Builder addRepeatedField(Descriptors.FieldDescriptor field, Object value)
```
...
`[SlidesAddOnManifest.Builder](/java/docs/reference/google-cloud-gsuite-addons/2.46.0/com.google.apps.script.type.slides.SlidesAddOnManifest.Builder)`
...
```
public SlidesAddOnManifest.Builder clearField(Descriptors.FieldDescriptor field)
```
...
```
public SlidesAddOnManifest.Builder clearOneof(Descriptors.OneofDescriptor oneof)
```
...
```
public SlidesAddOnManifest.Builder clone()
```
...
`[HomepageExtensionPoint](/java/docs/reference/google-cloud-gsuite-addons/2.46.0/com.google.apps.script.type.HomepageExtensionPoint)`
...
`[HomepageExtensionPoint.Builder](/java/docs/reference/google-cloud-gsuite-addons/2.46.0/com.google.apps.script.type.HomepageExtensionPoint.Builder)`
...
`[HomepageExtensionPointOrBuilder](/java/docs/reference/google-cloud-gsuite-addons/2.46.0/com.google.apps.script.type.HomepageExtensionPointOrBuilder)`
...
`[SlidesExtensionPoint](/java/docs/reference/google-cloud-gsuite-addons/2.46.0/com.google.apps.script.type.slides.SlidesExtensionPoint)`
...
`[SlidesExtensionPoint.Builder](/java/docs/reference/google-cloud-gsuite-addons/2.46.0/com.google.apps.script.type.slides.SlidesExtensionPoint.Builder)`
...
`[SlidesExtensionPointOrBuilder](/java/docs/reference/google-cloud-gsuite-addons/2.46.0/com.google.apps.script.type.slides.SlidesExtensionPointOrBuilder)`
...
```
public final SlidesAddOnManifest.Builder mergeUnknownFields(UnknownFieldSet unknownFields)
```
...
```
public SlidesAddOnManifest.Builder setField(Descriptors.FieldDescriptor field, Object value)
```
...
```
public SlidesAddOnManifest.Builder setRepeatedField(Descriptors.FieldDescriptor field, int index, Object value)
```
...
```
public final SlidesAddOnManifest.Builder setUnknownFields(UnknownFieldSet unknownFields)
```
