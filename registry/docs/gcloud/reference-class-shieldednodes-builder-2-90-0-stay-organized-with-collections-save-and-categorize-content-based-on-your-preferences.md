...
# Class ShieldedNodes.Builder (2.90.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class ShieldedNodes.Builder extends GeneratedMessage.Builder<ShieldedNodes.Builder> implements ShieldedNodesOrBuilder
```

Configuration of Shielded Nodes feature.

Protobuf type `google.container.v1beta1.ShieldedNodes`

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessage.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessage.Builder.html) \> ShieldedNodes.Builder

## Implements

[ShieldedNodesOrBuilder](/java/docs/reference/google-cloud-container/latest/com.google.container.v1beta1.ShieldedNodesOrBuilder)
...
`[ShieldedNodes](/java/docs/reference/google-cloud-container/latest/com.google.container.v1beta1.ShieldedNodes)`

### buildPartial()

```
public ShieldedNodes buildPartial()
```
...
```
public ShieldedNodes.Builder clear()
```
...
`[ShieldedNodes.Builder](/java/docs/reference/google-cloud-container/latest/com.google.container.v1beta1.ShieldedNodes.Builder)`
...
```
public ShieldedNodes.Builder clearEnabled()
```
...
```
public ShieldedNodes getDefaultInstanceForType()
```
...
### mergeFrom(ShieldedNodes other)

```
public ShieldedNodes.Builder mergeFrom(ShieldedNodes other)
```
...
```
public ShieldedNodes.Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public ShieldedNodes.Builder mergeFrom(Message other)
```
...
```
public ShieldedNodes.Builder setEnabled(boolean value)
```
