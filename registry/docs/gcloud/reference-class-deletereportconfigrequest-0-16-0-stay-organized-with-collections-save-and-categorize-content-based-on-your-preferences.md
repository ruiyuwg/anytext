...
# Class DeleteReportConfigRequest (0.16.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class DeleteReportConfigRequest extends GeneratedMessageV3 implements DeleteReportConfigRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> DeleteReportConfigRequest

## Implements

[DeleteReportConfigRequestOrBuilder](/java/docs/reference/google-cloud-storageinsights/0.16.0/com.google.cloud.storageinsights.v1.DeleteReportConfigRequestOrBuilder)
...
```
public static DeleteReportConfigRequest getDefaultInstance()
```
...
`[DeleteReportConfigRequest](/java/docs/reference/google-cloud-storageinsights/0.16.0/com.google.cloud.storageinsights.v1.DeleteReportConfigRequest)`
...
```
public static DeleteReportConfigRequest.Builder newBuilder()
```
...
`[DeleteReportConfigRequest.Builder](/java/docs/reference/google-cloud-storageinsights/0.16.0/com.google.cloud.storageinsights.v1.DeleteReportConfigRequest.Builder)`

### newBuilder(DeleteReportConfigRequest prototype)

```
public static DeleteReportConfigRequest.Builder newBuilder(DeleteReportConfigRequest prototype)
```
...
```
public static DeleteReportConfigRequest parseDelimitedFrom(InputStream input)
```
...
```
public static DeleteReportConfigRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteReportConfigRequest parseFrom(byte[] data)
```
...
```
public static DeleteReportConfigRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteReportConfigRequest parseFrom(ByteString data)
```
...
```
public static DeleteReportConfigRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteReportConfigRequest parseFrom(CodedInputStream input)
```
...
```
public static DeleteReportConfigRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteReportConfigRequest parseFrom(InputStream input)
```
...
```
public static DeleteReportConfigRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteReportConfigRequest parseFrom(ByteBuffer data)
```
...
```
public static DeleteReportConfigRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<DeleteReportConfigRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[DeleteReportConfigRequest](/java/docs/reference/google-cloud-storageinsights/0.16.0/com.google.cloud.storageinsights.v1.DeleteReportConfigRequest)>`
...
```
public DeleteReportConfigRequest getDefaultInstanceForType()
```
...
```
public Parser<DeleteReportConfigRequest> getParserForType()
```
...
```
public DeleteReportConfigRequest.Builder newBuilderForType()
```
...
```
protected DeleteReportConfigRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public DeleteReportConfigRequest.Builder toBuilder()
```
