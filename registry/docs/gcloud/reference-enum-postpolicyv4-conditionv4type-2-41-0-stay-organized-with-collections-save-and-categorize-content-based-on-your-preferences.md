...
# Enum PostPolicyV4.ConditionV4Type (2.41.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum PostPolicyV4.ConditionV4Type extends Enum<PostPolicyV4.ConditionV4Type>
```
