...
# Interface NodePool.NodeConfigOrBuilder (0.84.0) Stay organized with collections Save and categorize content based on your preferences.
...
Use [#getLabelsMap()](/java/docs/reference/google-cloud-distributedcloudedge/latest/com.google.cloud.edgecontainer.v1.NodePool.NodeConfigOrBuilder#com_google_cloud_edgecontainer_v1_NodePool_NodeConfigOrBuilder_getLabelsMap__) instead.
...
```
public abstract String getNodeStorageSchema()
```
...
```
public abstract ByteString getNodeStorageSchemaBytes()
```
