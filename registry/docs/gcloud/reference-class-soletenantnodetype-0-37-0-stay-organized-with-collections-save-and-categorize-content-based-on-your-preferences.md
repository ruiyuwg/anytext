...
# Class SoleTenantNodeType (0.37.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class SoleTenantNodeType extends GeneratedMessageV3 implements SoleTenantNodeTypeOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> SoleTenantNodeType

## Implements

[SoleTenantNodeTypeOrBuilder](/java/docs/reference/google-cloud-migrationcenter/0.37.0/com.google.cloud.migrationcenter.v1.SoleTenantNodeTypeOrBuilder)
...
```
public static SoleTenantNodeType getDefaultInstance()
```
...
`[SoleTenantNodeType](/java/docs/reference/google-cloud-migrationcenter/0.37.0/com.google.cloud.migrationcenter.v1.SoleTenantNodeType)`
...
```
public static SoleTenantNodeType.Builder newBuilder()
```
...
`[SoleTenantNodeType.Builder](/java/docs/reference/google-cloud-migrationcenter/0.37.0/com.google.cloud.migrationcenter.v1.SoleTenantNodeType.Builder)`

### newBuilder(SoleTenantNodeType prototype)

```
public static SoleTenantNodeType.Builder newBuilder(SoleTenantNodeType prototype)
```
...
```
public static SoleTenantNodeType parseDelimitedFrom(InputStream input)
```
...
```
public static SoleTenantNodeType parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SoleTenantNodeType parseFrom(byte[] data)
```
...
```
public static SoleTenantNodeType parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SoleTenantNodeType parseFrom(ByteString data)
```
...
```
public static SoleTenantNodeType parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SoleTenantNodeType parseFrom(CodedInputStream input)
```
...
```
public static SoleTenantNodeType parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SoleTenantNodeType parseFrom(InputStream input)
```
...
```
public static SoleTenantNodeType parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SoleTenantNodeType parseFrom(ByteBuffer data)
```
...
```
public static SoleTenantNodeType parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<SoleTenantNodeType> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[SoleTenantNodeType](/java/docs/reference/google-cloud-migrationcenter/0.37.0/com.google.cloud.migrationcenter.v1.SoleTenantNodeType)>`
...
Name of the Sole Tenant node. Consult [https://cloud.google.com/compute/docs/nodes/sole-tenant-nodes](https://cloud.google.com/compute/docs/nodes/sole-tenant-nodes)
...
```
public Parser<SoleTenantNodeType> getParserForType()
```
...
```
public SoleTenantNodeType.Builder newBuilderForType()
```
...
```
protected SoleTenantNodeType.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public SoleTenantNodeType.Builder toBuilder()
```
