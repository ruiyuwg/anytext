...
# Class CloudRedisGrpc.CloudRedisStub (2.1.1) Stay organized with collections Save and categorize content based on your preferences.
...
[CloudRedisGrpc.CloudRedisStub](/java/docs/reference/google-cloud-redis/2.1.1/com.google.cloud.redis.v1.CloudRedisGrpc.CloudRedisStub)
...
`[CreateInstanceRequest](/java/docs/reference/google-cloud-redis/2.1.1/com.google.cloud.redis.v1.CreateInstanceRequest)`  
...
`[DeleteInstanceRequest](/java/docs/reference/google-cloud-redis/2.1.1/com.google.cloud.redis.v1.DeleteInstanceRequest)`  
...
`[ExportInstanceRequest](/java/docs/reference/google-cloud-redis/2.1.1/com.google.cloud.redis.v1.ExportInstanceRequest)`  
...
`[FailoverInstanceRequest](/java/docs/reference/google-cloud-redis/2.1.1/com.google.cloud.redis.v1.FailoverInstanceRequest)`  
...
`[GetInstanceRequest](/java/docs/reference/google-cloud-redis/2.1.1/com.google.cloud.redis.v1.GetInstanceRequest)`  

responseObserver

`io.grpc.stub.StreamObserver<[Instance](/java/docs/reference/google-cloud-redis/2.1.1/com.google.cloud.redis.v1.Instance)>`  
...
`[ImportInstanceRequest](/java/docs/reference/google-cloud-redis/2.1.1/com.google.cloud.redis.v1.ImportInstanceRequest)`  
...
`[ListInstancesRequest](/java/docs/reference/google-cloud-redis/2.1.1/com.google.cloud.redis.v1.ListInstancesRequest)`  

responseObserver

`io.grpc.stub.StreamObserver<[ListInstancesResponse](/java/docs/reference/google-cloud-redis/2.1.1/com.google.cloud.redis.v1.ListInstancesResponse)>`  
...
`[UpdateInstanceRequest](/java/docs/reference/google-cloud-redis/2.1.1/com.google.cloud.redis.v1.UpdateInstanceRequest)`  
...
`[UpgradeInstanceRequest](/java/docs/reference/google-cloud-redis/2.1.1/com.google.cloud.redis.v1.UpgradeInstanceRequest)`  
