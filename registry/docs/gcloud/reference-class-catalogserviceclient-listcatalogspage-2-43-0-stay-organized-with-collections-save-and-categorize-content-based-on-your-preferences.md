...
# Class CatalogServiceClient.ListCatalogsPage (2.43.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[PageContext](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PageContext.html)<[ListCatalogsRequest](/java/docs/reference/google-cloud-retail/2.43.0/com.google.cloud.retail.v2.ListCatalogsRequest),[ListCatalogsResponse](/java/docs/reference/google-cloud-retail/2.43.0/com.google.cloud.retail.v2.ListCatalogsResponse),[Catalog](/java/docs/reference/google-cloud-retail/2.43.0/com.google.cloud.retail.v2.Catalog)>`  

`response`

`[ListCatalogsResponse](/java/docs/reference/google-cloud-retail/2.43.0/com.google.cloud.retail.v2.ListCatalogsResponse)`  
...
`[CatalogServiceClient.ListCatalogsPage](/java/docs/reference/google-cloud-retail/2.43.0/com.google.cloud.retail.v2.CatalogServiceClient.ListCatalogsPage)`
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListCatalogsResponse](/java/docs/reference/google-cloud-retail/2.43.0/com.google.cloud.retail.v2.ListCatalogsResponse)>`  
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListCatalogsPage](/java/docs/reference/google-cloud-retail/2.43.0/com.google.cloud.retail.v2.CatalogServiceClient.ListCatalogsPage)>`
