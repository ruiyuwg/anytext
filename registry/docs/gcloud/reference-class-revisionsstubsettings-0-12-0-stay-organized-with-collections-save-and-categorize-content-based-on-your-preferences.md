...
# Class RevisionsStubSettings (0.12.0) Stay organized with collections Save and categorize content based on your preferences.
...
Settings class to configure an instance of [RevisionsStub](/java/docs/reference/google-cloud-run/0.12.0/com.google.cloud.run.v2.stub.RevisionsStub).
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [StubSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.StubSettings.html) \> RevisionsStubSettings
...
```
public static RevisionsStubSettings.Builder newBuilder()
```
...
`[RevisionsStubSettings.Builder](/java/docs/reference/google-cloud-run/0.12.0/com.google.cloud.run.v2.stub.RevisionsStubSettings.Builder)`

### newBuilder(ClientContext clientContext)

```
public static RevisionsStubSettings.Builder newBuilder(ClientContext clientContext)
```
...
```
public static RevisionsStubSettings.Builder newHttpJsonBuilder()
```
...
### RevisionsStubSettings(RevisionsStubSettings.Builder settingsBuilder)

```
protected RevisionsStubSettings(RevisionsStubSettings.Builder settingsBuilder)
```
...
```
public RevisionsStub createStub()
```
...
`[RevisionsStub](/java/docs/reference/google-cloud-run/0.12.0/com.google.cloud.run.v2.stub.RevisionsStub)`
...
`[OperationCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.OperationCallSettings.html)<[DeleteRevisionRequest](/java/docs/reference/google-cloud-run/0.12.0/com.google.cloud.run.v2.DeleteRevisionRequest),[Revision](/java/docs/reference/google-cloud-run/0.12.0/com.google.cloud.run.v2.Revision),[Revision](/java/docs/reference/google-cloud-run/0.12.0/com.google.cloud.run.v2.Revision)>`
...
`[UnaryCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.html)<[DeleteRevisionRequest](/java/docs/reference/google-cloud-run/0.12.0/com.google.cloud.run.v2.DeleteRevisionRequest),[Operation](https://cloud.google.com/java/docs/reference/gax/latest/com.google.longrunning.Operation.html)>`
...
`[UnaryCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.html)<[GetRevisionRequest](/java/docs/reference/google-cloud-run/0.12.0/com.google.cloud.run.v2.GetRevisionRequest),[Revision](/java/docs/reference/google-cloud-run/0.12.0/com.google.cloud.run.v2.Revision)>`
...
`[PagedCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PagedCallSettings.html)<[ListRevisionsRequest](/java/docs/reference/google-cloud-run/0.12.0/com.google.cloud.run.v2.ListRevisionsRequest),[ListRevisionsResponse](/java/docs/reference/google-cloud-run/0.12.0/com.google.cloud.run.v2.ListRevisionsResponse),[ListRevisionsPagedResponse](/java/docs/reference/google-cloud-run/0.12.0/com.google.cloud.run.v2.RevisionsClient.ListRevisionsPagedResponse)>`

### toBuilder()

```
public RevisionsStubSettings.Builder toBuilder()
```
