...
# Interface UpdateActiveDirectoryRequestOrBuilder (0.13.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface UpdateActiveDirectoryRequestOrBuilder extends MessageOrBuilder
```
...
`[ActiveDirectory](/java/docs/reference/google-cloud-netapp/0.13.0/com.google.cloud.netapp.v1.ActiveDirectory)`
...
`[ActiveDirectoryOrBuilder](/java/docs/reference/google-cloud-netapp/0.13.0/com.google.cloud.netapp.v1.ActiveDirectoryOrBuilder)`
...
Required. Field mask is used to specify the fields to be overwritten in the Active Directory resource by the update. The fields specified in the update\_mask are relative to the resource, not the full request. A field will be overwritten if it is in the mask. If the user does not provide a mask then all fields will be overwritten.
