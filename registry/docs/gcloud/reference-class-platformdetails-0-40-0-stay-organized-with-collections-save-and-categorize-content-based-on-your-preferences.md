...
# Class PlatformDetails (0.40.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> PlatformDetails

## Implements

[PlatformDetailsOrBuilder](/java/docs/reference/google-cloud-migrationcenter/0.40.0/com.google.cloud.migrationcenter.v1.PlatformDetailsOrBuilder)
...
### AWS\_EC2\_DETAILS\_FIELD\_NUMBER
...
### AZURE\_VM\_DETAILS\_FIELD\_NUMBER
...
### GENERIC\_DETAILS\_FIELD\_NUMBER
...
### PHYSICAL\_DETAILS\_FIELD\_NUMBER
...
### VMWARE\_DETAILS\_FIELD\_NUMBER
...
`[PlatformDetails](/java/docs/reference/google-cloud-migrationcenter/0.40.0/com.google.cloud.migrationcenter.v1.PlatformDetails)`
...
`[PlatformDetails.Builder](/java/docs/reference/google-cloud-migrationcenter/0.40.0/com.google.cloud.migrationcenter.v1.PlatformDetails.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[PlatformDetails](/java/docs/reference/google-cloud-migrationcenter/0.40.0/com.google.cloud.migrationcenter.v1.PlatformDetails)>`
...
`[AwsEc2PlatformDetails](/java/docs/reference/google-cloud-migrationcenter/0.40.0/com.google.cloud.migrationcenter.v1.AwsEc2PlatformDetails)`
...
`[AwsEc2PlatformDetailsOrBuilder](/java/docs/reference/google-cloud-migrationcenter/0.40.0/com.google.cloud.migrationcenter.v1.AwsEc2PlatformDetailsOrBuilder)`
...
`[AzureVmPlatformDetails](/java/docs/reference/google-cloud-migrationcenter/0.40.0/com.google.cloud.migrationcenter.v1.AzureVmPlatformDetails)`
...
`[AzureVmPlatformDetailsOrBuilder](/java/docs/reference/google-cloud-migrationcenter/0.40.0/com.google.cloud.migrationcenter.v1.AzureVmPlatformDetailsOrBuilder)`
...
`[GenericPlatformDetails](/java/docs/reference/google-cloud-migrationcenter/0.40.0/com.google.cloud.migrationcenter.v1.GenericPlatformDetails)`
...
`[GenericPlatformDetailsOrBuilder](/java/docs/reference/google-cloud-migrationcenter/0.40.0/com.google.cloud.migrationcenter.v1.GenericPlatformDetailsOrBuilder)`
...
`[PhysicalPlatformDetails](/java/docs/reference/google-cloud-migrationcenter/0.40.0/com.google.cloud.migrationcenter.v1.PhysicalPlatformDetails)`
...
`[PhysicalPlatformDetailsOrBuilder](/java/docs/reference/google-cloud-migrationcenter/0.40.0/com.google.cloud.migrationcenter.v1.PhysicalPlatformDetailsOrBuilder)`
...
`[PlatformDetails.VendorDetailsCase](/java/docs/reference/google-cloud-migrationcenter/0.40.0/com.google.cloud.migrationcenter.v1.PlatformDetails.VendorDetailsCase)`
...
`[VmwarePlatformDetails](/java/docs/reference/google-cloud-migrationcenter/0.40.0/com.google.cloud.migrationcenter.v1.VmwarePlatformDetails)`
...
`[VmwarePlatformDetailsOrBuilder](/java/docs/reference/google-cloud-migrationcenter/0.40.0/com.google.cloud.migrationcenter.v1.VmwarePlatformDetailsOrBuilder)`
