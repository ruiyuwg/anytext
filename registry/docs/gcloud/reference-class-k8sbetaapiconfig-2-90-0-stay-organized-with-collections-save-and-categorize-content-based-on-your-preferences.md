...
# Class K8sBetaAPIConfig (2.90.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class K8sBetaAPIConfig extends GeneratedMessage implements K8sBetaAPIConfigOrBuilder
```

Kubernetes open source beta apis enabled on the cluster.

Protobuf type `google.container.v1beta1.K8sBetaAPIConfig`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessage.html) \> K8sBetaAPIConfig

## Implements

[K8sBetaAPIConfigOrBuilder](/java/docs/reference/google-cloud-container/latest/com.google.container.v1beta1.K8sBetaAPIConfigOrBuilder)
...
### ENABLED\_APIS\_FIELD\_NUMBER

```
public static final int ENABLED_APIS_FIELD_NUMBER
```
...
```
public static K8sBetaAPIConfig getDefaultInstance()
```
...
`[K8sBetaAPIConfig](/java/docs/reference/google-cloud-container/latest/com.google.container.v1beta1.K8sBetaAPIConfig)`
...
```
public static K8sBetaAPIConfig.Builder newBuilder()
```
...
`[K8sBetaAPIConfig.Builder](/java/docs/reference/google-cloud-container/latest/com.google.container.v1beta1.K8sBetaAPIConfig.Builder)`

### newBuilder(K8sBetaAPIConfig prototype)

```
public static K8sBetaAPIConfig.Builder newBuilder(K8sBetaAPIConfig prototype)
```
...
```
public static K8sBetaAPIConfig parseDelimitedFrom(InputStream input)
```
...
```
public static K8sBetaAPIConfig parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static K8sBetaAPIConfig parseFrom(byte[] data)
```
...
```
public static K8sBetaAPIConfig parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static K8sBetaAPIConfig parseFrom(ByteString data)
```
...
```
public static K8sBetaAPIConfig parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static K8sBetaAPIConfig parseFrom(CodedInputStream input)
```
...
```
public static K8sBetaAPIConfig parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static K8sBetaAPIConfig parseFrom(InputStream input)
```
...
```
public static K8sBetaAPIConfig parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static K8sBetaAPIConfig parseFrom(ByteBuffer data)
```
...
```
public static K8sBetaAPIConfig parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<K8sBetaAPIConfig> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[K8sBetaAPIConfig](/java/docs/reference/google-cloud-container/latest/com.google.container.v1beta1.K8sBetaAPIConfig)>`
...
```
public K8sBetaAPIConfig getDefaultInstanceForType()
```
...
```
public String getEnabledApis(int index)
```
...
```
public ByteString getEnabledApisBytes(int index)
```
...
```
public ProtocolStringList getEnabledApisList()
```
...
```
public Parser<K8sBetaAPIConfig> getParserForType()
```
...
```
public K8sBetaAPIConfig.Builder newBuilderForType()
```
...
```
protected K8sBetaAPIConfig.Builder newBuilderForType(AbstractMessage.BuilderParent parent)
```
...
```
public K8sBetaAPIConfig.Builder toBuilder()
```
