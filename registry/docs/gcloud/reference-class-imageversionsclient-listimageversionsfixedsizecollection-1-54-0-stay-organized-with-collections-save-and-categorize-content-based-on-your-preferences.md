...
# Class ImageVersionsClient.ListImageVersionsFixedSizeCollection (1.54.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class ImageVersionsClient.ListImageVersionsFixedSizeCollection extends AbstractFixedSizeCollection<ListImageVersionsRequest,ListImageVersionsResponse,ImageVersion,ImageVersionsClient.ListImageVersionsPage,ImageVersionsClient.ListImageVersionsFixedSizeCollection>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractFixedSizeCollection](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractFixedSizeCollection.html) \> ImageVersionsClient.ListImageVersionsFixedSizeCollection
...
### createCollection(List<ImageVersionsClient.ListImageVersionsPage> pages, int collectionSize)

```
protected ImageVersionsClient.ListImageVersionsFixedSizeCollection createCollection(List<ImageVersionsClient.ListImageVersionsPage> pages, int collectionSize)
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ListImageVersionsPage](/java/docs/reference/google-cloud-orchestration-airflow/1.54.0/com.google.cloud.orchestration.airflow.service.v1.ImageVersionsClient.ListImageVersionsPage)>`  
...
`[ImageVersionsClient.ListImageVersionsFixedSizeCollection](/java/docs/reference/google-cloud-orchestration-airflow/1.54.0/com.google.cloud.orchestration.airflow.service.v1.ImageVersionsClient.ListImageVersionsFixedSizeCollection)`
