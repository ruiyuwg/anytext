...
# Namespace google::cloud::datastream (2.15.1) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated:** This namespace is deprecated, prefer the types defined in [`datastream_v1`](/cpp/docs/reference/datastream/2.15.1/namespacegoogle_1_1cloud_1_1datastream__v1).
