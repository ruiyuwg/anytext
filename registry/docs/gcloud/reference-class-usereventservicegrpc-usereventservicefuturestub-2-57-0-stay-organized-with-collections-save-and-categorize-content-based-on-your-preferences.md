...
# Class UserEventServiceGrpc.UserEventServiceFutureStub (2.57.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[UserEventServiceGrpc.UserEventServiceFutureStub](/java/docs/reference/google-cloud-retail/2.57.0/com.google.cloud.retail.v2.UserEventServiceGrpc.UserEventServiceFutureStub)`
...
`[CollectUserEventRequest](/java/docs/reference/google-cloud-retail/2.57.0/com.google.cloud.retail.v2.CollectUserEventRequest)`  
...
`[ImportUserEventsRequest](/java/docs/reference/google-cloud-retail/2.57.0/com.google.cloud.retail.v2.ImportUserEventsRequest)`  
...
`[PurgeUserEventsRequest](/java/docs/reference/google-cloud-retail/2.57.0/com.google.cloud.retail.v2.PurgeUserEventsRequest)`  
...
`[RejoinUserEventsRequest](/java/docs/reference/google-cloud-retail/2.57.0/com.google.cloud.retail.v2.RejoinUserEventsRequest)`  
...
`[WriteUserEventRequest](/java/docs/reference/google-cloud-retail/2.57.0/com.google.cloud.retail.v2.WriteUserEventRequest)`  
...
`com.google.common.util.concurrent.ListenableFuture<[UserEvent](/java/docs/reference/google-cloud-retail/2.57.0/com.google.cloud.retail.v2.UserEvent)>`
