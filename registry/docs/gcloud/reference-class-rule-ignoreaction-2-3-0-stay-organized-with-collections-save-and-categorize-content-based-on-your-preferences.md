...
# Class Rule.IgnoreAction (2.3.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class Rule.IgnoreAction extends GeneratedMessageV3 implements Rule.IgnoreActionOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> Rule.IgnoreAction

## Implements

[Rule.IgnoreActionOrBuilder](/java/docs/reference/google-cloud-retail/2.3.0/com.google.cloud.retail.v2alpha.Rule.IgnoreActionOrBuilder)
...
### IGNORE\_TERMS\_FIELD\_NUMBER

```
public static final int IGNORE_TERMS_FIELD_NUMBER
```
...
```
public static Rule.IgnoreAction getDefaultInstance()
```
...
[Rule.IgnoreAction](/java/docs/reference/google-cloud-retail/2.3.0/com.google.cloud.retail.v2alpha.Rule.IgnoreAction)
...
```
public static Rule.IgnoreAction.Builder newBuilder()
```
...
[Rule.IgnoreAction.Builder](/java/docs/reference/google-cloud-retail/2.3.0/com.google.cloud.retail.v2alpha.Rule.IgnoreAction.Builder)

### newBuilder(Rule.IgnoreAction prototype)

```
public static Rule.IgnoreAction.Builder newBuilder(Rule.IgnoreAction prototype)
```
...
```
public static Rule.IgnoreAction parseDelimitedFrom(InputStream input)
```
...
```
public static Rule.IgnoreAction parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Rule.IgnoreAction parseFrom(byte[] data)
```
...
```
public static Rule.IgnoreAction parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Rule.IgnoreAction parseFrom(ByteString data)
```
...
```
public static Rule.IgnoreAction parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Rule.IgnoreAction parseFrom(CodedInputStream input)
```
...
```
public static Rule.IgnoreAction parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Rule.IgnoreAction parseFrom(InputStream input)
```
...
```
public static Rule.IgnoreAction parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Rule.IgnoreAction parseFrom(ByteBuffer data)
```
...
```
public static Rule.IgnoreAction parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<Rule.IgnoreAction> parser()
```
...
[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[IgnoreAction](/java/docs/reference/google-cloud-retail/2.3.0/com.google.cloud.retail.v2alpha.Rule.IgnoreAction)\>
...
```
public Parser<Rule.IgnoreAction> getParserForType()
```
...
```
public Rule.IgnoreAction.Builder newBuilderForType()
```
...
```
protected Rule.IgnoreAction.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public Rule.IgnoreAction.Builder toBuilder()
```
