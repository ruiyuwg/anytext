...
# Class ListReferenceImagesResponse (3.57.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListReferenceImagesResponse extends GeneratedMessageV3 implements ListReferenceImagesResponseOrBuilder
```

Response message for the `ListReferenceImages` method.

Protobuf type `google.cloud.vision.v1p3beta1.ListReferenceImagesResponse`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListReferenceImagesResponse

## Implements

[ListReferenceImagesResponseOrBuilder](/java/docs/reference/google-cloud-vision/3.57.0/com.google.cloud.vision.v1p3beta1.ListReferenceImagesResponseOrBuilder)
...
### REFERENCE\_IMAGES\_FIELD\_NUMBER
...
`[ListReferenceImagesResponse](/java/docs/reference/google-cloud-vision/3.57.0/com.google.cloud.vision.v1p3beta1.ListReferenceImagesResponse)`
...
```
public static ListReferenceImagesResponse.Builder newBuilder()
```
...
`[ListReferenceImagesResponse.Builder](/java/docs/reference/google-cloud-vision/3.57.0/com.google.cloud.vision.v1p3beta1.ListReferenceImagesResponse.Builder)`

### newBuilder(ListReferenceImagesResponse prototype)

```
public static ListReferenceImagesResponse.Builder newBuilder(ListReferenceImagesResponse prototype)
```
...
```
public static ListReferenceImagesResponse parseDelimitedFrom(InputStream input)
```
...
```
public static ListReferenceImagesResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListReferenceImagesResponse parseFrom(byte[] data)
```
...
```
public static ListReferenceImagesResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListReferenceImagesResponse parseFrom(ByteString data)
```
...
```
public static ListReferenceImagesResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListReferenceImagesResponse parseFrom(CodedInputStream input)
```
...
```
public static ListReferenceImagesResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListReferenceImagesResponse parseFrom(InputStream input)
```
...
```
public static ListReferenceImagesResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListReferenceImagesResponse parseFrom(ByteBuffer data)
```
...
```
public static ListReferenceImagesResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListReferenceImagesResponse](/java/docs/reference/google-cloud-vision/3.57.0/com.google.cloud.vision.v1p3beta1.ListReferenceImagesResponse)>`
...
```
public Parser<ListReferenceImagesResponse> getParserForType()
```
...
`[ReferenceImage](/java/docs/reference/google-cloud-vision/3.57.0/com.google.cloud.vision.v1p3beta1.ReferenceImage)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ReferenceImage](/java/docs/reference/google-cloud-vision/3.57.0/com.google.cloud.vision.v1p3beta1.ReferenceImage)>`
...
`[ReferenceImageOrBuilder](/java/docs/reference/google-cloud-vision/3.57.0/com.google.cloud.vision.v1p3beta1.ReferenceImageOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.vision.v1p3beta1.ReferenceImageOrBuilder>`
...
```
public ListReferenceImagesResponse.Builder newBuilderForType()
```
...
```
protected ListReferenceImagesResponse.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ListReferenceImagesResponse.Builder toBuilder()
```
