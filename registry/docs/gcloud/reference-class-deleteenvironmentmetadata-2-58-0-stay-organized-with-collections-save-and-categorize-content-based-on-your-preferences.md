...
# Class DeleteEnvironmentMetadata (2.58.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class DeleteEnvironmentMetadata extends GeneratedMessageV3 implements DeleteEnvironmentMetadataOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> DeleteEnvironmentMetadata

## Implements

[DeleteEnvironmentMetadataOrBuilder](/java/docs/reference/google-cloud-shell/2.58.0/com.google.cloud.shell.v1.DeleteEnvironmentMetadataOrBuilder)
...
```
public static DeleteEnvironmentMetadata getDefaultInstance()
```
...
`[DeleteEnvironmentMetadata](/java/docs/reference/google-cloud-shell/2.58.0/com.google.cloud.shell.v1.DeleteEnvironmentMetadata)`
...
```
public static DeleteEnvironmentMetadata.Builder newBuilder()
```
...
`[DeleteEnvironmentMetadata.Builder](/java/docs/reference/google-cloud-shell/2.58.0/com.google.cloud.shell.v1.DeleteEnvironmentMetadata.Builder)`

### newBuilder(DeleteEnvironmentMetadata prototype)

```
public static DeleteEnvironmentMetadata.Builder newBuilder(DeleteEnvironmentMetadata prototype)
```
...
```
public static DeleteEnvironmentMetadata parseDelimitedFrom(InputStream input)
```
...
```
public static DeleteEnvironmentMetadata parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteEnvironmentMetadata parseFrom(byte[] data)
```
...
```
public static DeleteEnvironmentMetadata parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteEnvironmentMetadata parseFrom(ByteString data)
```
...
```
public static DeleteEnvironmentMetadata parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteEnvironmentMetadata parseFrom(CodedInputStream input)
```
...
```
public static DeleteEnvironmentMetadata parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteEnvironmentMetadata parseFrom(InputStream input)
```
...
```
public static DeleteEnvironmentMetadata parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteEnvironmentMetadata parseFrom(ByteBuffer data)
```
...
```
public static DeleteEnvironmentMetadata parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<DeleteEnvironmentMetadata> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[DeleteEnvironmentMetadata](/java/docs/reference/google-cloud-shell/2.58.0/com.google.cloud.shell.v1.DeleteEnvironmentMetadata)>`
...
```
public DeleteEnvironmentMetadata getDefaultInstanceForType()
```
...
```
public Parser<DeleteEnvironmentMetadata> getParserForType()
```
...
```
public DeleteEnvironmentMetadata.Builder newBuilderForType()
```
...
```
protected DeleteEnvironmentMetadata.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public DeleteEnvironmentMetadata.Builder toBuilder()
```
