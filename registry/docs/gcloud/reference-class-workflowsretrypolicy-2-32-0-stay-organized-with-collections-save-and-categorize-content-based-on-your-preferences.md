...
# Class WorkflowsRetryPolicy (2.32.0) Stay organized with collections Save and categorize content based on your preferences.
...
The retry policy for [`WorkflowsConnection`](/cpp/docs/reference/workflows/2.32.0/classgoogle_1_1cloud_1_1workflows__v1_1_1WorkflowsConnection).
...
`std::unique_ptr< WorkflowsRetryPolicy >`
