...
# Class GetRegionRequest (1.15.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class GetRegionRequest extends GeneratedMessage implements GetRegionRequestOrBuilder
```

Request message for the `GetRegion` method.

Protobuf type `google.shopping.merchant.accounts.v1.GetRegionRequest`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessage.html) \> GetRegionRequest

## Implements

[GetRegionRequestOrBuilder](/java/docs/reference/google-shopping-merchant-accounts/latest/com.google.shopping.merchant.accounts.v1.GetRegionRequestOrBuilder)
...
`[GetRegionRequest](/java/docs/reference/google-shopping-merchant-accounts/latest/com.google.shopping.merchant.accounts.v1.GetRegionRequest)`
...
```
public static GetRegionRequest.Builder newBuilder()
```
...
`[GetRegionRequest.Builder](/java/docs/reference/google-shopping-merchant-accounts/latest/com.google.shopping.merchant.accounts.v1.GetRegionRequest.Builder)`

### newBuilder(GetRegionRequest prototype)

```
public static GetRegionRequest.Builder newBuilder(GetRegionRequest prototype)
```
...
```
public static GetRegionRequest parseDelimitedFrom(InputStream input)
```
...
```
public static GetRegionRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetRegionRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetRegionRequest parseFrom(ByteString data)
```
...
```
public static GetRegionRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetRegionRequest parseFrom(CodedInputStream input)
```
...
```
public static GetRegionRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetRegionRequest parseFrom(InputStream input)
```
...
```
public static GetRegionRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetRegionRequest parseFrom(ByteBuffer data)
```
...
```
public static GetRegionRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<GetRegionRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[GetRegionRequest](/java/docs/reference/google-shopping-merchant-accounts/latest/com.google.shopping.merchant.accounts.v1.GetRegionRequest)>`
...
```
public Parser<GetRegionRequest> getParserForType()
```
...
```
public GetRegionRequest.Builder newBuilderForType()
```
...
```
protected GetRegionRequest.Builder newBuilderForType(AbstractMessage.BuilderParent parent)
```
...
```
public GetRegionRequest.Builder toBuilder()
```
