...
-   [2.4.0 (latest)](/ruby/docs/reference/google-cloud-edge_network-v1/latest)
-   [2.3.1](/ruby/docs/reference/google-cloud-edge_network-v1/2.3.1)
-   [2.2.0](/ruby/docs/reference/google-cloud-edge_network-v1/2.2.0)
-   [2.1.0](/ruby/docs/reference/google-cloud-edge_network-v1/2.1.0)
-   [2.0.2](/ruby/docs/reference/google-cloud-edge_network-v1/2.0.2)
-   [1.2.0](/ruby/docs/reference/google-cloud-edge_network-v1/1.2.0)
-   [1.1.0](/ruby/docs/reference/google-cloud-edge_network-v1/1.1.0)
-   [1.0.3](/ruby/docs/reference/google-cloud-edge_network-v1/1.0.3)
-   [0.5.0](/ruby/docs/reference/google-cloud-edge_network-v1/0.5.0)
-   [0.4.1](/ruby/docs/reference/google-cloud-edge_network-v1/0.4.1)
-   [0.3.1](/ruby/docs/reference/google-cloud-edge_network-v1/0.3.1)
-   [0.2.1](/ruby/docs/reference/google-cloud-edge_network-v1/0.2.1)
-   [0.1.0](/ruby/docs/reference/google-cloud-edge_network-v1/0.1.0)
...
This gem is a _versioned_ client. It provides basic client classes for a specific version of the Distributed Cloud Edge Network V1 API. Most users should consider using the main client gem, [google-cloud-edge\_network](https://rubygems.org/gems/google-cloud-edge_network). See the section below titled _Which client should I use?_ for more information.
...
3.  [Enable the API.](https://console.cloud.google.com/apis/library/edgenetwork.googleapis.com)
4.  [Set up authentication.](https://docs.cloud.google.com/ruby/docs/reference/google-cloud-edge_network-v1/latest/AUTHENTICATION "Set up authentication.")

## Quick Start

require "google/cloud/edge\_network/v1"
...
response \= client.initialize\_zone request

View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-edge_network-v1/latest) for class and method documentation.

See also the [Product Documentation](https://cloud.google.com/distributed-cloud/edge/latest/docs/overview) for general usage information.
...
Most modern Ruby client libraries for Google APIs come in two flavors: the main client library with a name such as `google-cloud-edge_network`, and lower-level _versioned_ client libraries with names such as `google-cloud-edge_network-v1`. _In most cases, you should install the main client._
