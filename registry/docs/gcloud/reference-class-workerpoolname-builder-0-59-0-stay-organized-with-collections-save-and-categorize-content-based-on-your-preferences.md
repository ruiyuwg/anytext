...
# Class WorkerPoolName.Builder (0.59.0) Stay organized with collections Save and categorize content based on your preferences.
...
Builder for projects/{project}/locations/{location}/workerPools/{worker\_pool}.

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> WorkerPoolName.Builder
...
`[WorkerPoolName](/java/docs/reference/google-cloud-run/0.59.0/com.google.cloud.run.v2.WorkerPoolName)`
...
`[WorkerPoolName.Builder](/java/docs/reference/google-cloud-run/0.59.0/com.google.cloud.run.v2.WorkerPoolName.Builder)`
