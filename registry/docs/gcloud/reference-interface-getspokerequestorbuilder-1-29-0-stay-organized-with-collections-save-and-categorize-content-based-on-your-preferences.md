...
# Interface GetSpokeRequestOrBuilder (1.29.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface GetSpokeRequestOrBuilder extends MessageOrBuilder
```
