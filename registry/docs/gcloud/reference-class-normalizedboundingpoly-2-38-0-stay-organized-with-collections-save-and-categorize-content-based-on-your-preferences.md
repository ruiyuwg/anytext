...
# Class NormalizedBoundingPoly (2.38.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class NormalizedBoundingPoly extends GeneratedMessageV3 implements NormalizedBoundingPolyOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> NormalizedBoundingPoly

## Implements

[NormalizedBoundingPolyOrBuilder](/java/docs/reference/google-cloud-video-intelligence/2.38.0/com.google.cloud.videointelligence.v1p3beta1.NormalizedBoundingPolyOrBuilder)
...
```
public static NormalizedBoundingPoly getDefaultInstance()
```
...
`[NormalizedBoundingPoly](/java/docs/reference/google-cloud-video-intelligence/2.38.0/com.google.cloud.videointelligence.v1p3beta1.NormalizedBoundingPoly)`
...
```
public static NormalizedBoundingPoly.Builder newBuilder()
```
...
`[NormalizedBoundingPoly.Builder](/java/docs/reference/google-cloud-video-intelligence/2.38.0/com.google.cloud.videointelligence.v1p3beta1.NormalizedBoundingPoly.Builder)`

### newBuilder(NormalizedBoundingPoly prototype)

```
public static NormalizedBoundingPoly.Builder newBuilder(NormalizedBoundingPoly prototype)
```
...
```
public static NormalizedBoundingPoly parseDelimitedFrom(InputStream input)
```
...
```
public static NormalizedBoundingPoly parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static NormalizedBoundingPoly parseFrom(byte[] data)
```
...
```
public static NormalizedBoundingPoly parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static NormalizedBoundingPoly parseFrom(ByteString data)
```
...
```
public static NormalizedBoundingPoly parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static NormalizedBoundingPoly parseFrom(CodedInputStream input)
```
...
```
public static NormalizedBoundingPoly parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static NormalizedBoundingPoly parseFrom(InputStream input)
```
...
```
public static NormalizedBoundingPoly parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static NormalizedBoundingPoly parseFrom(ByteBuffer data)
```
...
```
public static NormalizedBoundingPoly parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<NormalizedBoundingPoly> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[NormalizedBoundingPoly](/java/docs/reference/google-cloud-video-intelligence/2.38.0/com.google.cloud.videointelligence.v1p3beta1.NormalizedBoundingPoly)>`
...
```
public Parser<NormalizedBoundingPoly> getParserForType()
```
...
`[NormalizedVertex](/java/docs/reference/google-cloud-video-intelligence/2.38.0/com.google.cloud.videointelligence.v1p3beta1.NormalizedVertex)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[NormalizedVertex](/java/docs/reference/google-cloud-video-intelligence/2.38.0/com.google.cloud.videointelligence.v1p3beta1.NormalizedVertex)>`
...
`[NormalizedVertexOrBuilder](/java/docs/reference/google-cloud-video-intelligence/2.38.0/com.google.cloud.videointelligence.v1p3beta1.NormalizedVertexOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.videointelligence.v1p3beta1.NormalizedVertexOrBuilder>`
...
```
public NormalizedBoundingPoly.Builder newBuilderForType()
```
...
```
protected NormalizedBoundingPoly.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public NormalizedBoundingPoly.Builder toBuilder()
```
