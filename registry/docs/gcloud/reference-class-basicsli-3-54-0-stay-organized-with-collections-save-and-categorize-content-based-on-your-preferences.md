...
# Class BasicSli (3.54.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[BasicSli](/java/docs/reference/google-cloud-monitoring/3.54.0/com.google.monitoring.v3.BasicSli)`
...
`[BasicSli.Builder](/java/docs/reference/google-cloud-monitoring/3.54.0/com.google.monitoring.v3.BasicSli.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[BasicSli](/java/docs/reference/google-cloud-monitoring/3.54.0/com.google.monitoring.v3.BasicSli)>`
...
`[BasicSli.AvailabilityCriteria](/java/docs/reference/google-cloud-monitoring/3.54.0/com.google.monitoring.v3.BasicSli.AvailabilityCriteria)`
...
`[BasicSli.AvailabilityCriteriaOrBuilder](/java/docs/reference/google-cloud-monitoring/3.54.0/com.google.monitoring.v3.BasicSli.AvailabilityCriteriaOrBuilder)`
...
`[BasicSli.LatencyCriteria](/java/docs/reference/google-cloud-monitoring/3.54.0/com.google.monitoring.v3.BasicSli.LatencyCriteria)`
...
`[BasicSli.LatencyCriteriaOrBuilder](/java/docs/reference/google-cloud-monitoring/3.54.0/com.google.monitoring.v3.BasicSli.LatencyCriteriaOrBuilder)`
...
`[BasicSli.SliCriteriaCase](/java/docs/reference/google-cloud-monitoring/3.54.0/com.google.monitoring.v3.BasicSli.SliCriteriaCase)`
