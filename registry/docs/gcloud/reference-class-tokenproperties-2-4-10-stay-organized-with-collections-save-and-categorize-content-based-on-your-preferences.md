...
# Class TokenProperties (2.4.10) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> TokenProperties

## Implements

[TokenPropertiesOrBuilder](/java/docs/reference/google-cloud-recaptchaenterprise/2.4.10/com.google.recaptchaenterprise.v1.TokenPropertiesOrBuilder)
...
### INVALID\_REASON\_FIELD\_NUMBER
...
[TokenProperties](/java/docs/reference/google-cloud-recaptchaenterprise/2.4.10/com.google.recaptchaenterprise.v1.TokenProperties)
...
[TokenProperties.Builder](/java/docs/reference/google-cloud-recaptchaenterprise/2.4.10/com.google.recaptchaenterprise.v1.TokenProperties.Builder)
...
[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[TokenProperties](/java/docs/reference/google-cloud-recaptchaenterprise/2.4.10/com.google.recaptchaenterprise.v1.TokenProperties)\>
...
[TokenProperties.InvalidReason](/java/docs/reference/google-cloud-recaptchaenterprise/2.4.10/com.google.recaptchaenterprise.v1.TokenProperties.InvalidReason)
...
Whether the provided user response token is valid. When valid = false, the reason could be specified in invalid\_reason or it could also be due to a user failing to solve a challenge or a sitekey mismatch (i.e the sitekey used to generate the token was different than the one specified in the assessment).
