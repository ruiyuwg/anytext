...
# Enum GatewayType (2.7.0) Stay organized with collections Save and categorize content based on your preferences.
...
GATEWAY\_TYPE\_UNSPECIFIED

If unspecified, the device is considered a non-gateway device.

`GATEWAY_TYPE_UNSPECIFIED = 0;`

GATEWAY\_TYPE\_UNSPECIFIED\_VALUE
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-iot/2.7.0/com.google.cloud.iot.v1.GatewayType#com_google_cloud_iot_v1_GatewayType_forNumber_int_) instead._
