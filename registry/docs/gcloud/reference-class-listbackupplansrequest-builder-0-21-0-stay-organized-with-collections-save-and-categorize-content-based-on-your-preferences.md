...
# Class ListBackupPlansRequest.Builder (0.21.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> ListBackupPlansRequest.Builder

## Implements

[ListBackupPlansRequestOrBuilder](/java/docs/reference/google-cloud-gke-backup/0.21.0/com.google.cloud.gkebackup.v1.ListBackupPlansRequestOrBuilder)
...
`[ListBackupPlansRequest.Builder](/java/docs/reference/google-cloud-gke-backup/0.21.0/com.google.cloud.gkebackup.v1.ListBackupPlansRequest.Builder)`
...
`[ListBackupPlansRequest](/java/docs/reference/google-cloud-gke-backup/0.21.0/com.google.cloud.gkebackup.v1.ListBackupPlansRequest)`
...
The target number of results to return in a single response. If not specified, a default value will be chosen by the service. Note that the response may inclue a partial list and a caller should only rely on the response's next\_page\_token to determine if there are more instances left to be queried.
...
The value of next\_page\_token received from a previous `ListBackupPlans` call. Provide this to retrieve the subsequent page in a multi-page list of results. When paginating, all other parameters provided to `ListBackupPlans` must match the call that provided the page token.
