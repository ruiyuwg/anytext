...
# Interface Options.ReadOption (6.72.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static interface Options.ReadOption
```
