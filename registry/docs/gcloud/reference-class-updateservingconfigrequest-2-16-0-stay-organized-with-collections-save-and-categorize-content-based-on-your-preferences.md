...
# Class UpdateServingConfigRequest (2.16.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class UpdateServingConfigRequest extends GeneratedMessageV3 implements UpdateServingConfigRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> UpdateServingConfigRequest

## Implements

[UpdateServingConfigRequestOrBuilder](/java/docs/reference/google-cloud-retail/2.16.0/com.google.cloud.retail.v2beta.UpdateServingConfigRequestOrBuilder)
...
```
public static UpdateServingConfigRequest getDefaultInstance()
```
...
`[UpdateServingConfigRequest](/java/docs/reference/google-cloud-retail/2.16.0/com.google.cloud.retail.v2beta.UpdateServingConfigRequest)`
...
```
public static UpdateServingConfigRequest.Builder newBuilder()
```
...
`[UpdateServingConfigRequest.Builder](/java/docs/reference/google-cloud-retail/2.16.0/com.google.cloud.retail.v2beta.UpdateServingConfigRequest.Builder)`

### newBuilder(UpdateServingConfigRequest prototype)

```
public static UpdateServingConfigRequest.Builder newBuilder(UpdateServingConfigRequest prototype)
```
...
```
public static UpdateServingConfigRequest parseDelimitedFrom(InputStream input)
```
...
```
public static UpdateServingConfigRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateServingConfigRequest parseFrom(byte[] data)
```
...
```
public static UpdateServingConfigRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateServingConfigRequest parseFrom(ByteString data)
```
...
```
public static UpdateServingConfigRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateServingConfigRequest parseFrom(CodedInputStream input)
```
...
```
public static UpdateServingConfigRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateServingConfigRequest parseFrom(InputStream input)
```
...
```
public static UpdateServingConfigRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateServingConfigRequest parseFrom(ByteBuffer data)
```
...
```
public static UpdateServingConfigRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<UpdateServingConfigRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[UpdateServingConfigRequest](/java/docs/reference/google-cloud-retail/2.16.0/com.google.cloud.retail.v2beta.UpdateServingConfigRequest)>`
...
```
public UpdateServingConfigRequest getDefaultInstanceForType()
```
...
```
public Parser<UpdateServingConfigRequest> getParserForType()
```
...
`[ServingConfig](/java/docs/reference/google-cloud-retail/2.16.0/com.google.cloud.retail.v2beta.ServingConfig)`
...
`[ServingConfigOrBuilder](/java/docs/reference/google-cloud-retail/2.16.0/com.google.cloud.retail.v2beta.ServingConfigOrBuilder)`
...
```
public UpdateServingConfigRequest.Builder newBuilderForType()
```
...
```
protected UpdateServingConfigRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public UpdateServingConfigRequest.Builder toBuilder()
```
