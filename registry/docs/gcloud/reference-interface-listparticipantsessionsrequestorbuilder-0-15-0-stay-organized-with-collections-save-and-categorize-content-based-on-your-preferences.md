...
# Interface ListParticipantSessionsRequestOrBuilder (0.15.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface ListParticipantSessionsRequestOrBuilder extends MessageOrBuilder
```
