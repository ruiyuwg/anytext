...
# Class IsInstanceUpgradeableRequest (1.32.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class IsInstanceUpgradeableRequest extends GeneratedMessageV3 implements IsInstanceUpgradeableRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> IsInstanceUpgradeableRequest

## Implements

[IsInstanceUpgradeableRequestOrBuilder](/java/docs/reference/google-cloud-notebooks/1.32.0/com.google.cloud.notebooks.v1beta1.IsInstanceUpgradeableRequestOrBuilder)
...
### NOTEBOOK\_INSTANCE\_FIELD\_NUMBER

```
public static final int NOTEBOOK_INSTANCE_FIELD_NUMBER
```
...
```
public static IsInstanceUpgradeableRequest getDefaultInstance()
```
...
`[IsInstanceUpgradeableRequest](/java/docs/reference/google-cloud-notebooks/1.32.0/com.google.cloud.notebooks.v1beta1.IsInstanceUpgradeableRequest)`
...
```
public static IsInstanceUpgradeableRequest.Builder newBuilder()
```
...
`[IsInstanceUpgradeableRequest.Builder](/java/docs/reference/google-cloud-notebooks/1.32.0/com.google.cloud.notebooks.v1beta1.IsInstanceUpgradeableRequest.Builder)`

### newBuilder(IsInstanceUpgradeableRequest prototype)

```
public static IsInstanceUpgradeableRequest.Builder newBuilder(IsInstanceUpgradeableRequest prototype)
```
...
```
public static IsInstanceUpgradeableRequest parseDelimitedFrom(InputStream input)
```
...
```
public static IsInstanceUpgradeableRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static IsInstanceUpgradeableRequest parseFrom(byte[] data)
```
...
```
public static IsInstanceUpgradeableRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static IsInstanceUpgradeableRequest parseFrom(ByteString data)
```
...
```
public static IsInstanceUpgradeableRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static IsInstanceUpgradeableRequest parseFrom(CodedInputStream input)
```
...
```
public static IsInstanceUpgradeableRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static IsInstanceUpgradeableRequest parseFrom(InputStream input)
```
...
```
public static IsInstanceUpgradeableRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static IsInstanceUpgradeableRequest parseFrom(ByteBuffer data)
```
...
```
public static IsInstanceUpgradeableRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<IsInstanceUpgradeableRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[IsInstanceUpgradeableRequest](/java/docs/reference/google-cloud-notebooks/1.32.0/com.google.cloud.notebooks.v1beta1.IsInstanceUpgradeableRequest)>`
...
```
public ByteString getNotebookInstanceBytes()
```
...
```
public Parser<IsInstanceUpgradeableRequest> getParserForType()
```
...
```
public IsInstanceUpgradeableRequest.Builder newBuilderForType()
```
...
```
protected IsInstanceUpgradeableRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public IsInstanceUpgradeableRequest.Builder toBuilder()
```
