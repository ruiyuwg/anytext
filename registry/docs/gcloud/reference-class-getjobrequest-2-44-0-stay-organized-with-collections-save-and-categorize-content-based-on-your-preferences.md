...
# Class GetJobRequest (2.44.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class GetJobRequest extends GeneratedMessageV3 implements GetJobRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> GetJobRequest

## Implements

[GetJobRequestOrBuilder](/java/docs/reference/google-cloud-talent/2.44.0/com.google.cloud.talent.v4beta1.GetJobRequestOrBuilder)
...
`[GetJobRequest](/java/docs/reference/google-cloud-talent/2.44.0/com.google.cloud.talent.v4beta1.GetJobRequest)`
...
```
public static GetJobRequest.Builder newBuilder()
```
...
`[GetJobRequest.Builder](/java/docs/reference/google-cloud-talent/2.44.0/com.google.cloud.talent.v4beta1.GetJobRequest.Builder)`

### newBuilder(GetJobRequest prototype)

```
public static GetJobRequest.Builder newBuilder(GetJobRequest prototype)
```
...
```
public static GetJobRequest parseDelimitedFrom(InputStream input)
```
...
```
public static GetJobRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetJobRequest parseFrom(byte[] data)
```
...
```
public static GetJobRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetJobRequest parseFrom(ByteString data)
```
...
```
public static GetJobRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetJobRequest parseFrom(CodedInputStream input)
```
...
```
public static GetJobRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetJobRequest parseFrom(InputStream input)
```
...
```
public static GetJobRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetJobRequest parseFrom(ByteBuffer data)
```
...
```
public static GetJobRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[GetJobRequest](/java/docs/reference/google-cloud-talent/2.44.0/com.google.cloud.talent.v4beta1.GetJobRequest)>`
...
```
public GetJobRequest.Builder newBuilderForType()
```
...
```
protected GetJobRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public GetJobRequest.Builder toBuilder()
```
