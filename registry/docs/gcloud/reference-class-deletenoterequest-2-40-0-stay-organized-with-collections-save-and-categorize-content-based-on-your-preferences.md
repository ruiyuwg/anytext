...
# Class DeleteNoteRequest (2.40.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class DeleteNoteRequest extends GeneratedMessageV3 implements DeleteNoteRequestOrBuilder
```
...
`[DeleteNoteRequest](/java/docs/reference/grafeas/2.40.0/io.grafeas.v1.DeleteNoteRequest)`
...
```
public static DeleteNoteRequest.Builder newBuilder()
```
...
`[DeleteNoteRequest.Builder](/java/docs/reference/grafeas/2.40.0/io.grafeas.v1.DeleteNoteRequest.Builder)`

### newBuilder(DeleteNoteRequest prototype)

```
public static DeleteNoteRequest.Builder newBuilder(DeleteNoteRequest prototype)
```
...
```
public static DeleteNoteRequest parseDelimitedFrom(InputStream input)
```
...
```
public static DeleteNoteRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteNoteRequest parseFrom(byte[] data)
```
...
```
public static DeleteNoteRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteNoteRequest parseFrom(ByteString data)
```
...
```
public static DeleteNoteRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteNoteRequest parseFrom(CodedInputStream input)
```
...
```
public static DeleteNoteRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteNoteRequest parseFrom(InputStream input)
```
...
```
public static DeleteNoteRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteNoteRequest parseFrom(ByteBuffer data)
```
...
```
public static DeleteNoteRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[DeleteNoteRequest](/java/docs/reference/grafeas/2.40.0/io.grafeas.v1.DeleteNoteRequest)>`
...
```
public Parser<DeleteNoteRequest> getParserForType()
```
...
```
public DeleteNoteRequest.Builder newBuilderForType()
```
...
```
protected DeleteNoteRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public DeleteNoteRequest.Builder toBuilder()
```
