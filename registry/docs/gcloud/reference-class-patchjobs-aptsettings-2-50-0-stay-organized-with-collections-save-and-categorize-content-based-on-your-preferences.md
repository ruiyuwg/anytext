...
# Class PatchJobs.AptSettings (2.50.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class PatchJobs.AptSettings extends GeneratedMessageV3 implements PatchJobs.AptSettingsOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> PatchJobs.AptSettings

## Implements

[PatchJobs.AptSettingsOrBuilder](/java/docs/reference/google-cloud-os-config/2.50.0/com.google.cloud.osconfig.v1beta.PatchJobs.AptSettingsOrBuilder)
...
### EXCLUSIVE\_PACKAGES\_FIELD\_NUMBER
...
```
public static PatchJobs.AptSettings getDefaultInstance()
```
...
`[PatchJobs.AptSettings](/java/docs/reference/google-cloud-os-config/2.50.0/com.google.cloud.osconfig.v1beta.PatchJobs.AptSettings)`
...
```
public static PatchJobs.AptSettings.Builder newBuilder()
```
...
`[PatchJobs.AptSettings.Builder](/java/docs/reference/google-cloud-os-config/2.50.0/com.google.cloud.osconfig.v1beta.PatchJobs.AptSettings.Builder)`

### newBuilder(PatchJobs.AptSettings prototype)

```
public static PatchJobs.AptSettings.Builder newBuilder(PatchJobs.AptSettings prototype)
```
...
```
public static PatchJobs.AptSettings parseDelimitedFrom(InputStream input)
```
...
```
public static PatchJobs.AptSettings parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PatchJobs.AptSettings parseFrom(byte[] data)
```
...
```
public static PatchJobs.AptSettings parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PatchJobs.AptSettings parseFrom(ByteString data)
```
...
```
public static PatchJobs.AptSettings parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PatchJobs.AptSettings parseFrom(CodedInputStream input)
```
...
```
public static PatchJobs.AptSettings parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PatchJobs.AptSettings parseFrom(InputStream input)
```
...
```
public static PatchJobs.AptSettings parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PatchJobs.AptSettings parseFrom(ByteBuffer data)
```
...
```
public static PatchJobs.AptSettings parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<PatchJobs.AptSettings> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[AptSettings](/java/docs/reference/google-cloud-os-config/2.50.0/com.google.cloud.osconfig.v1beta.PatchJobs.AptSettings)>`
...
```
public Parser<PatchJobs.AptSettings> getParserForType()
```
...
`[PatchJobs.AptSettings.Type](/java/docs/reference/google-cloud-os-config/2.50.0/com.google.cloud.osconfig.v1beta.PatchJobs.AptSettings.Type)`
...
```
public PatchJobs.AptSettings.Builder newBuilderForType()
```
...
```
protected PatchJobs.AptSettings.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public PatchJobs.AptSettings.Builder toBuilder()
```
