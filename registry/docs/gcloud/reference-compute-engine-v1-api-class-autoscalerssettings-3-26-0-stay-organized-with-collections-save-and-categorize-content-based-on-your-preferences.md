...
# Compute Engine v1 API - Class AutoscalersSettings (3.26.0) Stay organized with collections Save and categorize content based on your preferences.
...
Settings for [AutoscalersClient](/dotnet/docs/reference/Google.Cloud.Compute.V1/latest/Google.Cloud.Compute.V1.AutoscalersClient) instances.
...
Constructs a new [AutoscalersSettings](/dotnet/docs/reference/Google.Cloud.Compute.V1/latest/Google.Cloud.Compute.V1.AutoscalersSettings) object with default settings.
...
[CallSettings](https://cloud.google.com/dotnet/docs/reference/Google.Api.Gax/latest/Google.Api.Gax.Grpc.CallSettings.html) for synchronous and asynchronous calls to `AutoscalersClient.TestIamPermissions` and `AutoscalersClient.TestIamPermissionsAsync`.
...
`[AutoscalersSettings](/dotnet/docs/reference/Google.Cloud.Compute.V1/latest/Google.Cloud.Compute.V1.AutoscalersSettings)`

A deep clone of this [AutoscalersSettings](/dotnet/docs/reference/Google.Cloud.Compute.V1/latest/Google.Cloud.Compute.V1.AutoscalersSettings) object.
...
Get a new instance of the default [AutoscalersSettings](/dotnet/docs/reference/Google.Cloud.Compute.V1/latest/Google.Cloud.Compute.V1.AutoscalersSettings).
...
A new instance of the default [AutoscalersSettings](/dotnet/docs/reference/Google.Cloud.Compute.V1/latest/Google.Cloud.Compute.V1.AutoscalersSettings).
