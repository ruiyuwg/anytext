...
# Class MigrationCenterClient.ListReportConfigsFixedSizeCollection (0.36.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class MigrationCenterClient.ListReportConfigsFixedSizeCollection extends AbstractFixedSizeCollection<ListReportConfigsRequest,ListReportConfigsResponse,ReportConfig,MigrationCenterClient.ListReportConfigsPage,MigrationCenterClient.ListReportConfigsFixedSizeCollection>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractFixedSizeCollection](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractFixedSizeCollection.html) \> MigrationCenterClient.ListReportConfigsFixedSizeCollection
...
### createCollection(List<MigrationCenterClient.ListReportConfigsPage> pages, int collectionSize)

```
protected MigrationCenterClient.ListReportConfigsFixedSizeCollection createCollection(List<MigrationCenterClient.ListReportConfigsPage> pages, int collectionSize)
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ListReportConfigsPage](/java/docs/reference/google-cloud-migrationcenter/0.36.0/com.google.cloud.migrationcenter.v1.MigrationCenterClient.ListReportConfigsPage)>`  
...
`[MigrationCenterClient.ListReportConfigsFixedSizeCollection](/java/docs/reference/google-cloud-migrationcenter/0.36.0/com.google.cloud.migrationcenter.v1.MigrationCenterClient.ListReportConfigsFixedSizeCollection)`
