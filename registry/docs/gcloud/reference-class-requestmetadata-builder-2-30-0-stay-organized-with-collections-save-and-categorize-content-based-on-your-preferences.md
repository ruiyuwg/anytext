...
# Class RequestMetadata.Builder (2.30.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> RequestMetadata.Builder

## Implements

[RequestMetadataOrBuilder](/java/docs/reference/google-cloud-talent/2.30.0/com.google.cloud.talent.v4.RequestMetadataOrBuilder)
...
`[RequestMetadata.Builder](/java/docs/reference/google-cloud-talent/2.30.0/com.google.cloud.talent.v4.RequestMetadata.Builder)`
...
`[RequestMetadata](/java/docs/reference/google-cloud-talent/2.30.0/com.google.cloud.talent.v4.RequestMetadata)`
...
Only set when any of domain, session\_id and user\_id isn't available for some reason. It is highly recommended not to set this field and provide accurate domain, session\_id and user\_id for the best service experience.
...
Required if allow\_missing\_ids is unset or `false`.
...
`[DeviceInfo](/java/docs/reference/google-cloud-talent/2.30.0/com.google.cloud.talent.v4.DeviceInfo)`
...
`[DeviceInfo.Builder](/java/docs/reference/google-cloud-talent/2.30.0/com.google.cloud.talent.v4.DeviceInfo.Builder)`
...
`[DeviceInfoOrBuilder](/java/docs/reference/google-cloud-talent/2.30.0/com.google.cloud.talent.v4.DeviceInfoOrBuilder)`
