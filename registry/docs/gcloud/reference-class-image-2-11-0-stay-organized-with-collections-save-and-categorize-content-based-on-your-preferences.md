...
# Class Image (2.11.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[Image](/java/docs/reference/google-cloud-retail/2.11.0/com.google.cloud.retail.v2beta.Image)`
...
`[Image.Builder](/java/docs/reference/google-cloud-retail/2.11.0/com.google.cloud.retail.v2beta.Image.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[Image](/java/docs/reference/google-cloud-retail/2.11.0/com.google.cloud.retail.v2beta.Image)>`
...
Height of the image in number of pixels. This field must be nonnegative. Otherwise, an INVALID\_ARGUMENT error is returned.
...
Required. URI of the image. This field must be a valid UTF-8 encoded URI with a length limit of 5,000 characters. Otherwise, an INVALID\_ARGUMENT error is returned. Google Merchant Center property [image\_link](https://support.google.com/merchants/answer/6324350). Schema.org property [Product.image](https://schema.org/image).
...
Width of the image in number of pixels. This field must be nonnegative. Otherwise, an INVALID\_ARGUMENT error is returned.
