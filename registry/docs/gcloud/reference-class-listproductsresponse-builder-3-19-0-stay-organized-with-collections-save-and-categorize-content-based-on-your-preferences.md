...
# Class ListProductsResponse.Builder (3.19.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Builder](/java/docs/reference/google-cloud-vision/3.19.0/com.google.cloud.vision.v1.Product.Builder)>`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Product](/java/docs/reference/google-cloud-vision/3.19.0/com.google.cloud.vision.v1.Product)>`
