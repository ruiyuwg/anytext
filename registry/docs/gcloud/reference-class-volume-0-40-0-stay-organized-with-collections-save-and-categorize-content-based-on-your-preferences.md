...
# Class Volume (0.40.0) Stay organized with collections Save and categorize content based on your preferences.
...
[VolumeOrBuilder](/java/docs/reference/google-cloud-run/0.40.0/com.google.cloud.run.v2.VolumeOrBuilder)
...
`[Volume](/java/docs/reference/google-cloud-run/0.40.0/com.google.cloud.run.v2.Volume)`
...
`[Volume.Builder](/java/docs/reference/google-cloud-run/0.40.0/com.google.cloud.run.v2.Volume.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[Volume](/java/docs/reference/google-cloud-run/0.40.0/com.google.cloud.run.v2.Volume)>`
...
`[CloudSqlInstance](/java/docs/reference/google-cloud-run/0.40.0/com.google.cloud.run.v2.CloudSqlInstance)`
...
`[CloudSqlInstanceOrBuilder](/java/docs/reference/google-cloud-run/0.40.0/com.google.cloud.run.v2.CloudSqlInstanceOrBuilder)`
...
`[EmptyDirVolumeSource](/java/docs/reference/google-cloud-run/0.40.0/com.google.cloud.run.v2.EmptyDirVolumeSource)`
...
`[EmptyDirVolumeSourceOrBuilder](/java/docs/reference/google-cloud-run/0.40.0/com.google.cloud.run.v2.EmptyDirVolumeSourceOrBuilder)`
...
`[GCSVolumeSource](/java/docs/reference/google-cloud-run/0.40.0/com.google.cloud.run.v2.GCSVolumeSource)`
...
`[GCSVolumeSourceOrBuilder](/java/docs/reference/google-cloud-run/0.40.0/com.google.cloud.run.v2.GCSVolumeSourceOrBuilder)`
...
`[NFSVolumeSource](/java/docs/reference/google-cloud-run/0.40.0/com.google.cloud.run.v2.NFSVolumeSource)`
...
`[NFSVolumeSourceOrBuilder](/java/docs/reference/google-cloud-run/0.40.0/com.google.cloud.run.v2.NFSVolumeSourceOrBuilder)`
...
`[SecretVolumeSource](/java/docs/reference/google-cloud-run/0.40.0/com.google.cloud.run.v2.SecretVolumeSource)`
...
`[SecretVolumeSourceOrBuilder](/java/docs/reference/google-cloud-run/0.40.0/com.google.cloud.run.v2.SecretVolumeSourceOrBuilder)`
...
`[Volume.VolumeTypeCase](/java/docs/reference/google-cloud-run/0.40.0/com.google.cloud.run.v2.Volume.VolumeTypeCase)`
