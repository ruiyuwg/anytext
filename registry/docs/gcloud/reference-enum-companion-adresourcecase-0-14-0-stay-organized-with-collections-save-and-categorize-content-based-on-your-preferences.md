...
# Enum Companion.AdResourceCase (0.14.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum Companion.AdResourceCase extends Enum<Companion.AdResourceCase> implements Internal.EnumLite, AbstractMessageLite.InternalOneOfEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-video-stitcher/0.14.0/com.google.cloud.video.stitcher.v1.Companion.AdResourceCase#com_google_cloud_video_stitcher_v1_Companion_AdResourceCase_forNumber_int_) instead._
