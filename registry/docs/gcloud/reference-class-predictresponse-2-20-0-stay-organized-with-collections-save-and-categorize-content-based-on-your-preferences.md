...
# Class PredictResponse (2.20.0) Stay organized with collections Save and categorize content based on your preferences.
...
[PredictResponseOrBuilder](/java/docs/reference/google-cloud-retail/2.20.0/com.google.cloud.retail.v2beta.PredictResponseOrBuilder)
...
`[PredictResponse](/java/docs/reference/google-cloud-retail/2.20.0/com.google.cloud.retail.v2beta.PredictResponse)`
...
`[PredictResponse.Builder](/java/docs/reference/google-cloud-retail/2.20.0/com.google.cloud.retail.v2beta.PredictResponse.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[PredictResponse](/java/docs/reference/google-cloud-retail/2.20.0/com.google.cloud.retail.v2beta.PredictResponse)>`
...
`[PredictResponse.PredictionResult](/java/docs/reference/google-cloud-retail/2.20.0/com.google.cloud.retail.v2beta.PredictResponse.PredictionResult)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[PredictionResult](/java/docs/reference/google-cloud-retail/2.20.0/com.google.cloud.retail.v2beta.PredictResponse.PredictionResult)>`
...
`[PredictResponse.PredictionResultOrBuilder](/java/docs/reference/google-cloud-retail/2.20.0/com.google.cloud.retail.v2beta.PredictResponse.PredictionResultOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.retail.v2beta.PredictResponse.PredictionResultOrBuilder>`
