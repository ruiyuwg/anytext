...
# Class BatchGetSettingsResponse (0.52.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class BatchGetSettingsResponse extends GeneratedMessageV3 implements BatchGetSettingsResponseOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> BatchGetSettingsResponse

## Implements

[BatchGetSettingsResponseOrBuilder](/java/docs/reference/google-cloud-securitycenter-settings/0.52.0/com.google.cloud.securitycenter.settings.v1beta1.BatchGetSettingsResponseOrBuilder)
...
```
public static BatchGetSettingsResponse getDefaultInstance()
```
...
`[BatchGetSettingsResponse](/java/docs/reference/google-cloud-securitycenter-settings/0.52.0/com.google.cloud.securitycenter.settings.v1beta1.BatchGetSettingsResponse)`
...
```
public static BatchGetSettingsResponse.Builder newBuilder()
```
...
`[BatchGetSettingsResponse.Builder](/java/docs/reference/google-cloud-securitycenter-settings/0.52.0/com.google.cloud.securitycenter.settings.v1beta1.BatchGetSettingsResponse.Builder)`

### newBuilder(BatchGetSettingsResponse prototype)

```
public static BatchGetSettingsResponse.Builder newBuilder(BatchGetSettingsResponse prototype)
```
...
```
public static BatchGetSettingsResponse parseDelimitedFrom(InputStream input)
```
...
```
public static BatchGetSettingsResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static BatchGetSettingsResponse parseFrom(byte[] data)
```
...
```
public static BatchGetSettingsResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static BatchGetSettingsResponse parseFrom(ByteString data)
```
...
```
public static BatchGetSettingsResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static BatchGetSettingsResponse parseFrom(CodedInputStream input)
```
...
```
public static BatchGetSettingsResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static BatchGetSettingsResponse parseFrom(InputStream input)
```
...
```
public static BatchGetSettingsResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static BatchGetSettingsResponse parseFrom(ByteBuffer data)
```
...
```
public static BatchGetSettingsResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<BatchGetSettingsResponse> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[BatchGetSettingsResponse](/java/docs/reference/google-cloud-securitycenter-settings/0.52.0/com.google.cloud.securitycenter.settings.v1beta1.BatchGetSettingsResponse)>`
...
```
public Parser<BatchGetSettingsResponse> getParserForType()
```
...
`[Settings](/java/docs/reference/google-cloud-securitycenter-settings/0.52.0/com.google.cloud.securitycenter.settings.v1beta1.Settings)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Settings](/java/docs/reference/google-cloud-securitycenter-settings/0.52.0/com.google.cloud.securitycenter.settings.v1beta1.Settings)>`
...
`[SettingsOrBuilder](/java/docs/reference/google-cloud-securitycenter-settings/0.52.0/com.google.cloud.securitycenter.settings.v1beta1.SettingsOrBuilder)`
...
```
public BatchGetSettingsResponse.Builder newBuilderForType()
```
...
```
protected BatchGetSettingsResponse.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public BatchGetSettingsResponse.Builder toBuilder()
```
