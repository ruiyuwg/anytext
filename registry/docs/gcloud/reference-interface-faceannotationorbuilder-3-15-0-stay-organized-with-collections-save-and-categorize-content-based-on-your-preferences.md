...
# Interface FaceAnnotationOrBuilder (3.15.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[Likelihood](/java/docs/reference/google-cloud-vision/3.15.0/com.google.cloud.vision.v1.Likelihood)`
...
`[FaceAnnotation.Landmark](/java/docs/reference/google-cloud-vision/3.15.0/com.google.cloud.vision.v1.FaceAnnotation.Landmark)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Landmark](/java/docs/reference/google-cloud-vision/3.15.0/com.google.cloud.vision.v1.FaceAnnotation.Landmark)>`
...
`[FaceAnnotation.LandmarkOrBuilder](/java/docs/reference/google-cloud-vision/3.15.0/com.google.cloud.vision.v1.FaceAnnotation.LandmarkOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.vision.v1.FaceAnnotation.LandmarkOrBuilder>`
