...
# Class GetProductRequest (2.17.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class GetProductRequest extends GeneratedMessageV3 implements GetProductRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> GetProductRequest

## Implements

[GetProductRequestOrBuilder](/java/docs/reference/google-cloud-retail/2.17.0/com.google.cloud.retail.v2beta.GetProductRequestOrBuilder)
...
`[GetProductRequest](/java/docs/reference/google-cloud-retail/2.17.0/com.google.cloud.retail.v2beta.GetProductRequest)`
...
```
public static GetProductRequest.Builder newBuilder()
```
...
`[GetProductRequest.Builder](/java/docs/reference/google-cloud-retail/2.17.0/com.google.cloud.retail.v2beta.GetProductRequest.Builder)`

### newBuilder(GetProductRequest prototype)

```
public static GetProductRequest.Builder newBuilder(GetProductRequest prototype)
```
...
```
public static GetProductRequest parseDelimitedFrom(InputStream input)
```
...
```
public static GetProductRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetProductRequest parseFrom(byte[] data)
```
...
```
public static GetProductRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetProductRequest parseFrom(ByteString data)
```
...
```
public static GetProductRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetProductRequest parseFrom(CodedInputStream input)
```
...
```
public static GetProductRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetProductRequest parseFrom(InputStream input)
```
...
```
public static GetProductRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetProductRequest parseFrom(ByteBuffer data)
```
...
```
public static GetProductRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[GetProductRequest](/java/docs/reference/google-cloud-retail/2.17.0/com.google.cloud.retail.v2beta.GetProductRequest)>`
...
Required. Full resource name of Product, such as `projects/*/locations/global/catalogs/default_catalog/branches/default_branch/products/some_product_id`. If the caller does not have permission to access the Product, regardless of whether or not it exists, a PERMISSION\_DENIED error is returned. If the requested Product does not exist, a NOT\_FOUND error is returned.
...
```
public GetProductRequest.Builder newBuilderForType()
```
...
```
protected GetProductRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public GetProductRequest.Builder toBuilder()
```
