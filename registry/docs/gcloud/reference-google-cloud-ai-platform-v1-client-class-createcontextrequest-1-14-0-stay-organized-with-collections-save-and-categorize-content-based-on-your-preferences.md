...
# Google Cloud Ai Platform V1 Client - Class CreateContextRequest (1.14.0) Stay organized with collections Save and categorize content based on your preferences.
...
Request message for [MetadataService.CreateContext](/php/docs/reference/cloud-ai-platform/1.14.0/V1.Client.MetadataServiceClient#_Google_Cloud_AIPlatform_V1_Client_MetadataServiceClient__createContext__).
...
`[Context](/php/docs/reference/cloud-ai-platform/1.14.0/V1.Context)`  
...
`[Context](/php/docs/reference/cloud-ai-platform/1.14.0/V1.Context)|null`
...
Required. The resource name of the MetadataStore where the Context should be created. Format: `projects/{project}/locations/{location}/metadataStores/{metadatastore}` Please see MetadataServiceClient::metadataStoreName() for help formatting this field.
...
`[CreateContextRequest](/php/docs/reference/cloud-ai-platform/1.14.0/V1.CreateContextRequest)`
