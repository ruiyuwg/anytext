...
# Class OSPolicy.ResourceGroup (2.61.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> OSPolicy.ResourceGroup

## Implements

[OSPolicy.ResourceGroupOrBuilder](/java/docs/reference/google-cloud-os-config/2.61.0/com.google.cloud.osconfig.v1.OSPolicy.ResourceGroupOrBuilder)
...
### INVENTORY\_FILTERS\_FIELD\_NUMBER
...
`[OSPolicy.ResourceGroup](/java/docs/reference/google-cloud-os-config/2.61.0/com.google.cloud.osconfig.v1.OSPolicy.ResourceGroup)`
...
`[OSPolicy.ResourceGroup.Builder](/java/docs/reference/google-cloud-os-config/2.61.0/com.google.cloud.osconfig.v1.OSPolicy.ResourceGroup.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ResourceGroup](/java/docs/reference/google-cloud-os-config/2.61.0/com.google.cloud.osconfig.v1.OSPolicy.ResourceGroup)>`
...
`[OSPolicy.InventoryFilter](/java/docs/reference/google-cloud-os-config/2.61.0/com.google.cloud.osconfig.v1.OSPolicy.InventoryFilter)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[InventoryFilter](/java/docs/reference/google-cloud-os-config/2.61.0/com.google.cloud.osconfig.v1.OSPolicy.InventoryFilter)>`
...
`[OSPolicy.InventoryFilterOrBuilder](/java/docs/reference/google-cloud-os-config/2.61.0/com.google.cloud.osconfig.v1.OSPolicy.InventoryFilterOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.osconfig.v1.OSPolicy.InventoryFilterOrBuilder>`
...
`[OSPolicy.Resource](/java/docs/reference/google-cloud-os-config/2.61.0/com.google.cloud.osconfig.v1.OSPolicy.Resource)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Resource](/java/docs/reference/google-cloud-os-config/2.61.0/com.google.cloud.osconfig.v1.OSPolicy.Resource)>`
...
`[OSPolicy.ResourceOrBuilder](/java/docs/reference/google-cloud-os-config/2.61.0/com.google.cloud.osconfig.v1.OSPolicy.ResourceOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.osconfig.v1.OSPolicy.ResourceOrBuilder>`
