...
# Class FacetBucket.Range (0.15.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class FacetBucket.Range extends GeneratedMessageV3 implements FacetBucket.RangeOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> FacetBucket.Range

## Implements

[FacetBucket.RangeOrBuilder](/java/docs/reference/google-cloud-visionai/0.15.0/com.google.cloud.visionai.v1.FacetBucket.RangeOrBuilder)
...
```
public static FacetBucket.Range getDefaultInstance()
```
...
`[FacetBucket.Range](/java/docs/reference/google-cloud-visionai/0.15.0/com.google.cloud.visionai.v1.FacetBucket.Range)`
...
```
public static FacetBucket.Range.Builder newBuilder()
```
...
`[FacetBucket.Range.Builder](/java/docs/reference/google-cloud-visionai/0.15.0/com.google.cloud.visionai.v1.FacetBucket.Range.Builder)`

### newBuilder(FacetBucket.Range prototype)

```
public static FacetBucket.Range.Builder newBuilder(FacetBucket.Range prototype)
```
...
```
public static FacetBucket.Range parseDelimitedFrom(InputStream input)
```
...
```
public static FacetBucket.Range parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static FacetBucket.Range parseFrom(byte[] data)
```
...
```
public static FacetBucket.Range parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static FacetBucket.Range parseFrom(ByteString data)
```
...
```
public static FacetBucket.Range parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static FacetBucket.Range parseFrom(CodedInputStream input)
```
...
```
public static FacetBucket.Range parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static FacetBucket.Range parseFrom(InputStream input)
```
...
```
public static FacetBucket.Range parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static FacetBucket.Range parseFrom(ByteBuffer data)
```
...
```
public static FacetBucket.Range parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<FacetBucket.Range> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[Range](/java/docs/reference/google-cloud-visionai/0.15.0/com.google.cloud.visionai.v1.FacetBucket.Range)>`
...
`[FacetValue](/java/docs/reference/google-cloud-visionai/0.15.0/com.google.cloud.visionai.v1.FacetValue)`
...
`[FacetValueOrBuilder](/java/docs/reference/google-cloud-visionai/0.15.0/com.google.cloud.visionai.v1.FacetValueOrBuilder)`

### getParserForType()

```
public Parser<FacetBucket.Range> getParserForType()
```
...
```
public FacetBucket.Range.Builder newBuilderForType()
```
...
```
protected FacetBucket.Range.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public FacetBucket.Range.Builder toBuilder()
```
