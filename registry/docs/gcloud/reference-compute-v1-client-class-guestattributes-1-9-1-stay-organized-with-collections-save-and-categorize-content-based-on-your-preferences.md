...
# Compute V1 Client - Class GuestAttributes (1.9.1) Stay organized with collections Save and categorize content based on your preferences.
...
`[Google\Cloud\Compute\V1\GuestAttributesValue](/php/docs/reference/cloud-compute/1.9.1/V1.GuestAttributesValue)`  
...
`[Google\Cloud\Compute\V1\GuestAttributesValue](/php/docs/reference/cloud-compute/1.9.1/V1.GuestAttributesValue)|null`
