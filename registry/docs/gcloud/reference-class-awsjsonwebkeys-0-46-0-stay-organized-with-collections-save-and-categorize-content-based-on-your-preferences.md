...
# Class AwsJsonWebKeys (0.46.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class AwsJsonWebKeys extends GeneratedMessageV3 implements AwsJsonWebKeysOrBuilder
```

AwsJsonWebKeys is a valid JSON Web Key Set as specififed in RFC 7517.

Protobuf type `google.cloud.gkemulticloud.v1.AwsJsonWebKeys`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> AwsJsonWebKeys

## Implements

[AwsJsonWebKeysOrBuilder](/java/docs/reference/google-cloud-gke-multi-cloud/0.46.0/com.google.cloud.gkemulticloud.v1.AwsJsonWebKeysOrBuilder)
...
```
public static AwsJsonWebKeys getDefaultInstance()
```
...
`[AwsJsonWebKeys](/java/docs/reference/google-cloud-gke-multi-cloud/0.46.0/com.google.cloud.gkemulticloud.v1.AwsJsonWebKeys)`
...
```
public static AwsJsonWebKeys.Builder newBuilder()
```
...
`[AwsJsonWebKeys.Builder](/java/docs/reference/google-cloud-gke-multi-cloud/0.46.0/com.google.cloud.gkemulticloud.v1.AwsJsonWebKeys.Builder)`

### newBuilder(AwsJsonWebKeys prototype)

```
public static AwsJsonWebKeys.Builder newBuilder(AwsJsonWebKeys prototype)
```
...
```
public static AwsJsonWebKeys parseDelimitedFrom(InputStream input)
```
...
```
public static AwsJsonWebKeys parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AwsJsonWebKeys parseFrom(byte[] data)
```
...
```
public static AwsJsonWebKeys parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AwsJsonWebKeys parseFrom(ByteString data)
```
...
```
public static AwsJsonWebKeys parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AwsJsonWebKeys parseFrom(CodedInputStream input)
```
...
```
public static AwsJsonWebKeys parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AwsJsonWebKeys parseFrom(InputStream input)
```
...
```
public static AwsJsonWebKeys parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AwsJsonWebKeys parseFrom(ByteBuffer data)
```
...
```
public static AwsJsonWebKeys parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<AwsJsonWebKeys> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[AwsJsonWebKeys](/java/docs/reference/google-cloud-gke-multi-cloud/0.46.0/com.google.cloud.gkemulticloud.v1.AwsJsonWebKeys)>`
...
```
public AwsJsonWebKeys getDefaultInstanceForType()
```
...
`[Jwk](/java/docs/reference/google-cloud-gke-multi-cloud/0.46.0/com.google.cloud.gkemulticloud.v1.Jwk)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Jwk](/java/docs/reference/google-cloud-gke-multi-cloud/0.46.0/com.google.cloud.gkemulticloud.v1.Jwk)>`
...
`[JwkOrBuilder](/java/docs/reference/google-cloud-gke-multi-cloud/0.46.0/com.google.cloud.gkemulticloud.v1.JwkOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.gkemulticloud.v1.JwkOrBuilder>`

### getParserForType()

```
public Parser<AwsJsonWebKeys> getParserForType()
```
...
```
public AwsJsonWebKeys.Builder newBuilderForType()
```
...
```
protected AwsJsonWebKeys.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public AwsJsonWebKeys.Builder toBuilder()
```
