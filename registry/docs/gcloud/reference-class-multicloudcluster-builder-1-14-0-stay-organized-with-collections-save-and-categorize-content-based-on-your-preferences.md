...
# Class MultiCloudCluster.Builder (1.14.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class MultiCloudCluster.Builder extends GeneratedMessageV3.Builder<MultiCloudCluster.Builder> implements MultiCloudClusterOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> MultiCloudCluster.Builder

## Implements

[MultiCloudClusterOrBuilder](/java/docs/reference/google-cloud-gkehub/1.14.0/com.google.cloud.gkehub.v1beta1.MultiCloudClusterOrBuilder)
...
```
public MultiCloudCluster.Builder addRepeatedField(Descriptors.FieldDescriptor field, Object value)
```
...
`[MultiCloudCluster.Builder](/java/docs/reference/google-cloud-gkehub/1.14.0/com.google.cloud.gkehub.v1beta1.MultiCloudCluster.Builder)`
...
`[MultiCloudCluster](/java/docs/reference/google-cloud-gkehub/1.14.0/com.google.cloud.gkehub.v1beta1.MultiCloudCluster)`
...
Output only. If cluster\_missing is set then it denotes that API(gkemulticloud.googleapis.com) resource for this GKE Multi-Cloud cluster no longer exists.
...
```
public MultiCloudCluster.Builder clearField(Descriptors.FieldDescriptor field)
```
...
```
public MultiCloudCluster.Builder clearOneof(Descriptors.OneofDescriptor oneof)
```
...
```
public MultiCloudCluster.Builder clone()
```
...
```
public final MultiCloudCluster.Builder mergeUnknownFields(UnknownFieldSet unknownFields)
```
...
```
public MultiCloudCluster.Builder setField(Descriptors.FieldDescriptor field, Object value)
```
...
```
public MultiCloudCluster.Builder setRepeatedField(Descriptors.FieldDescriptor field, int index, Object value)
```
...
```
public final MultiCloudCluster.Builder setUnknownFields(UnknownFieldSet unknownFields)
```
