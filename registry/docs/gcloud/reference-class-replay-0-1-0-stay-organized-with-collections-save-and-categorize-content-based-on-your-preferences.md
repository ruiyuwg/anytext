...
# Class Replay (0.1.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> Replay

## Implements

[ReplayOrBuilder](/java/docs/reference/google-cloud-policysimulator/0.1.0/com.google.cloud.policysimulator.v1.ReplayOrBuilder)
...
### RESULTS\_SUMMARY\_FIELD\_NUMBER
...
`[Replay](/java/docs/reference/google-cloud-policysimulator/0.1.0/com.google.cloud.policysimulator.v1.Replay)`
...
`[Replay.Builder](/java/docs/reference/google-cloud-policysimulator/0.1.0/com.google.cloud.policysimulator.v1.Replay.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[Replay](/java/docs/reference/google-cloud-policysimulator/0.1.0/com.google.cloud.policysimulator.v1.Replay)>`
...
`[ReplayConfig](/java/docs/reference/google-cloud-policysimulator/0.1.0/com.google.cloud.policysimulator.v1.ReplayConfig)`
...
`[ReplayConfigOrBuilder](/java/docs/reference/google-cloud-policysimulator/0.1.0/com.google.cloud.policysimulator.v1.ReplayConfigOrBuilder)`
...
`[Replay.ResultsSummary](/java/docs/reference/google-cloud-policysimulator/0.1.0/com.google.cloud.policysimulator.v1.Replay.ResultsSummary)`
...
`[Replay.ResultsSummaryOrBuilder](/java/docs/reference/google-cloud-policysimulator/0.1.0/com.google.cloud.policysimulator.v1.Replay.ResultsSummaryOrBuilder)`
...
`[Replay.State](/java/docs/reference/google-cloud-policysimulator/0.1.0/com.google.cloud.policysimulator.v1.Replay.State)`
