...
# Cloud AI Platform v1 API - Class PersistentResource.Types (3.1.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class PersistentResource.Types
```

Reference documentation and code samples for the Cloud AI Platform v1 API class PersistentResource.Types.

Container for nested types declared in the PersistentResource message type.

## Inheritance

[object](https://learn.microsoft.com/dotnet/api/system.object) \> PersistentResource.Types
