...
# Enum Tenant.DataUsageType (2.52.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum Tenant.DataUsageType extends Enum<Tenant.DataUsageType> implements ProtocolMessageEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-talent/2.52.0/com.google.cloud.talent.v4beta1.Tenant.DataUsageType#com_google_cloud_talent_v4beta1_Tenant_DataUsageType_forNumber_int_) instead._
