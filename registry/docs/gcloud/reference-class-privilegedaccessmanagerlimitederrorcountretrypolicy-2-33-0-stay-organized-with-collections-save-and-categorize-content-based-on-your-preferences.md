...
# Class PrivilegedAccessManagerLimitedErrorCountRetryPolicy (2.33.0) Stay organized with collections Save and categorize content based on your preferences.
...
A retry policy for [`PrivilegedAccessManagerConnection`](/cpp/docs/reference/privilegedaccessmanager/2.33.0/classgoogle_1_1cloud_1_1privilegedaccessmanager__v1_1_1PrivilegedAccessManagerConnection) based on counting errors.
...
`PrivilegedAccessManagerLimitedErrorCountRetryPolicy const &`  
...
`std::unique_ptr< PrivilegedAccessManagerRetryPolicy >`
