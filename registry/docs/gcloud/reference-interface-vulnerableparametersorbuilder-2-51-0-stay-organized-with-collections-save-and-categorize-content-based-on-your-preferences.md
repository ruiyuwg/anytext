...
# Interface VulnerableParametersOrBuilder (2.51.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public abstract String getParameterNames(int index)
```
...
```
public abstract ByteString getParameterNamesBytes(int index)
```
...
```
public abstract int getParameterNamesCount()
```
...
```
public abstract List<String> getParameterNamesList()
```
