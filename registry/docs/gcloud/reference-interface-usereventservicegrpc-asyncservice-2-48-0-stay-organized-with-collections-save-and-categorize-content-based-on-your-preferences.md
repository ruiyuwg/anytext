...
# Interface UserEventServiceGrpc.AsyncService (2.48.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[CollectUserEventRequest](/java/docs/reference/google-cloud-retail/2.48.0/com.google.cloud.retail.v2.CollectUserEventRequest)`  
...
`[ImportUserEventsRequest](/java/docs/reference/google-cloud-retail/2.48.0/com.google.cloud.retail.v2.ImportUserEventsRequest)`  
...
`[PurgeUserEventsRequest](/java/docs/reference/google-cloud-retail/2.48.0/com.google.cloud.retail.v2.PurgeUserEventsRequest)`  
...
`[RejoinUserEventsRequest](/java/docs/reference/google-cloud-retail/2.48.0/com.google.cloud.retail.v2.RejoinUserEventsRequest)`  
...
`[WriteUserEventRequest](/java/docs/reference/google-cloud-retail/2.48.0/com.google.cloud.retail.v2.WriteUserEventRequest)`  

`responseObserver`

`io.grpc.stub.StreamObserver<[UserEvent](/java/docs/reference/google-cloud-retail/2.48.0/com.google.cloud.retail.v2.UserEvent)>`  
