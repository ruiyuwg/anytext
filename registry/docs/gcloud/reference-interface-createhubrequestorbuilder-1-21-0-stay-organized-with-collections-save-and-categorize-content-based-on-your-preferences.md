...
# Interface CreateHubRequestOrBuilder (1.21.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[Hub](/java/docs/reference/google-cloud-networkconnectivity/1.21.0/com.google.cloud.networkconnectivity.v1.Hub)`
...
```
public abstract String getHubId()
```
...
```
public abstract ByteString getHubIdBytes()
```
...
```
public abstract HubOrBuilder getHubOrBuilder()
```
...
`[HubOrBuilder](/java/docs/reference/google-cloud-networkconnectivity/1.21.0/com.google.cloud.networkconnectivity.v1.HubOrBuilder)`
