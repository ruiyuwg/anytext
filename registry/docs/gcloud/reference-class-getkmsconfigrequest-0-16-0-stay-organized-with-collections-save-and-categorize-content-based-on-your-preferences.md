...
# Class GetKmsConfigRequest (0.16.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class GetKmsConfigRequest extends GeneratedMessageV3 implements GetKmsConfigRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> GetKmsConfigRequest

## Implements

[GetKmsConfigRequestOrBuilder](/java/docs/reference/google-cloud-netapp/0.16.0/com.google.cloud.netapp.v1.GetKmsConfigRequestOrBuilder)
...
```
public static GetKmsConfigRequest getDefaultInstance()
```
...
`[GetKmsConfigRequest](/java/docs/reference/google-cloud-netapp/0.16.0/com.google.cloud.netapp.v1.GetKmsConfigRequest)`
...
```
public static GetKmsConfigRequest.Builder newBuilder()
```
...
`[GetKmsConfigRequest.Builder](/java/docs/reference/google-cloud-netapp/0.16.0/com.google.cloud.netapp.v1.GetKmsConfigRequest.Builder)`

### newBuilder(GetKmsConfigRequest prototype)

```
public static GetKmsConfigRequest.Builder newBuilder(GetKmsConfigRequest prototype)
```
...
```
public static GetKmsConfigRequest parseDelimitedFrom(InputStream input)
```
...
```
public static GetKmsConfigRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetKmsConfigRequest parseFrom(byte[] data)
```
...
```
public static GetKmsConfigRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetKmsConfigRequest parseFrom(ByteString data)
```
...
```
public static GetKmsConfigRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetKmsConfigRequest parseFrom(CodedInputStream input)
```
...
```
public static GetKmsConfigRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetKmsConfigRequest parseFrom(InputStream input)
```
...
```
public static GetKmsConfigRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetKmsConfigRequest parseFrom(ByteBuffer data)
```
...
```
public static GetKmsConfigRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<GetKmsConfigRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[GetKmsConfigRequest](/java/docs/reference/google-cloud-netapp/0.16.0/com.google.cloud.netapp.v1.GetKmsConfigRequest)>`
...
```
public GetKmsConfigRequest getDefaultInstanceForType()
```
...
```
public Parser<GetKmsConfigRequest> getParserForType()
```
...
```
public GetKmsConfigRequest.Builder newBuilderForType()
```
...
```
protected GetKmsConfigRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public GetKmsConfigRequest.Builder toBuilder()
```
