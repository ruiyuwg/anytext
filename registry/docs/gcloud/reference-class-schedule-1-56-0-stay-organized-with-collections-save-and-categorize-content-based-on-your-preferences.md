...
# Class Schedule (1.56.0) Stay organized with collections Save and categorize content based on your preferences.
...
### EXECUTION\_TEMPLATE\_FIELD\_NUMBER
...
### RECENT\_EXECUTIONS\_FIELD\_NUMBER
...
`[Schedule](/java/docs/reference/google-cloud-notebooks/1.56.0/com.google.cloud.notebooks.v1.Schedule)`
...
`[Schedule.Builder](/java/docs/reference/google-cloud-notebooks/1.56.0/com.google.cloud.notebooks.v1.Schedule.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[Schedule](/java/docs/reference/google-cloud-notebooks/1.56.0/com.google.cloud.notebooks.v1.Schedule)>`
...
Cron-tab formatted schedule by which the job will execute. Format: minute, hour, day of month, month, day of week, e.g. `0 0 * * WED` = every Wednesday More examples: [https://crontab.guru/examples.html](https://crontab.guru/examples.html)
...
`[ExecutionTemplate](/java/docs/reference/google-cloud-notebooks/1.56.0/com.google.cloud.notebooks.v1.ExecutionTemplate)`
...
`[ExecutionTemplateOrBuilder](/java/docs/reference/google-cloud-notebooks/1.56.0/com.google.cloud.notebooks.v1.ExecutionTemplateOrBuilder)`
...
`[Execution](/java/docs/reference/google-cloud-notebooks/1.56.0/com.google.cloud.notebooks.v1.Execution)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Execution](/java/docs/reference/google-cloud-notebooks/1.56.0/com.google.cloud.notebooks.v1.Execution)>`
...
`[ExecutionOrBuilder](/java/docs/reference/google-cloud-notebooks/1.56.0/com.google.cloud.notebooks.v1.ExecutionOrBuilder)`
...
`[Schedule.State](/java/docs/reference/google-cloud-notebooks/1.56.0/com.google.cloud.notebooks.v1.Schedule.State)`
...
Timezone on which the cron\_schedule. The value of this field must be a time zone name from the tz database. TZ Database: [https://en.wikipedia.org/wiki/List\_of\_tz\_database\_time\_zones](https://en.wikipedia.org/wiki/List_of_tz_database_time_zones)
