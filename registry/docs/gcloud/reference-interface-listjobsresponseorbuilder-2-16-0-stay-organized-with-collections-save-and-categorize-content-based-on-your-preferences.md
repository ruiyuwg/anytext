...
# Interface ListJobsResponseOrBuilder (2.16.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[Job](/java/docs/reference/google-cloud-talent/2.16.0/com.google.cloud.talent.v4beta1.Job)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Job](/java/docs/reference/google-cloud-talent/2.16.0/com.google.cloud.talent.v4beta1.Job)>`
...
`[JobOrBuilder](/java/docs/reference/google-cloud-talent/2.16.0/com.google.cloud.talent.v4beta1.JobOrBuilder)`
...
`[ResponseMetadata](/java/docs/reference/google-cloud-talent/2.16.0/com.google.cloud.talent.v4beta1.ResponseMetadata)`
...
`[ResponseMetadataOrBuilder](/java/docs/reference/google-cloud-talent/2.16.0/com.google.cloud.talent.v4beta1.ResponseMetadataOrBuilder)`
