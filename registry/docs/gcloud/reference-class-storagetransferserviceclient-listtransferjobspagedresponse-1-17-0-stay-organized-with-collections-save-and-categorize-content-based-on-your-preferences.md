...
# Class StorageTransferServiceClient.ListTransferJobsPagedResponse (1.17.0) Stay organized with collections Save and categorize content based on your preferences.
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractPagedListResponse](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractPagedListResponse.html) \> StorageTransferServiceClient.ListTransferJobsPagedResponse
...
`[PageContext](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PageContext.html)<[ListTransferJobsRequest](/java/docs/reference/google-cloud-storage-transfer/1.17.0/com.google.storagetransfer.v1.proto.TransferProto.ListTransferJobsRequest),[ListTransferJobsResponse](/java/docs/reference/google-cloud-storage-transfer/1.17.0/com.google.storagetransfer.v1.proto.TransferProto.ListTransferJobsResponse),[TransferJob](/java/docs/reference/google-cloud-storage-transfer/1.17.0/com.google.storagetransfer.v1.proto.TransferTypes.TransferJob)>`  

`futureResponse`

`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListTransferJobsResponse](/java/docs/reference/google-cloud-storage-transfer/1.17.0/com.google.storagetransfer.v1.proto.TransferProto.ListTransferJobsResponse)>`  
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListTransferJobsPagedResponse](/java/docs/reference/google-cloud-storage-transfer/1.17.0/com.google.storagetransfer.v1.proto.StorageTransferServiceClient.ListTransferJobsPagedResponse)>`
