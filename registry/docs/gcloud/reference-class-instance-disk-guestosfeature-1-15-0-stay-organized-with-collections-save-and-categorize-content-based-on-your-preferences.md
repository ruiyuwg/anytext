...
# Class Instance.Disk.GuestOsFeature (1.15.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class Instance.Disk.GuestOsFeature extends GeneratedMessageV3 implements Instance.Disk.GuestOsFeatureOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> Instance.Disk.GuestOsFeature

## Implements

[Instance.Disk.GuestOsFeatureOrBuilder](/java/docs/reference/google-cloud-notebooks/1.15.0/com.google.cloud.notebooks.v1.Instance.Disk.GuestOsFeatureOrBuilder)
...
```
public static Instance.Disk.GuestOsFeature getDefaultInstance()
```
...
`[Instance.Disk.GuestOsFeature](/java/docs/reference/google-cloud-notebooks/1.15.0/com.google.cloud.notebooks.v1.Instance.Disk.GuestOsFeature)`
...
```
public static Instance.Disk.GuestOsFeature.Builder newBuilder()
```
...
`[Instance.Disk.GuestOsFeature.Builder](/java/docs/reference/google-cloud-notebooks/1.15.0/com.google.cloud.notebooks.v1.Instance.Disk.GuestOsFeature.Builder)`

### newBuilder(Instance.Disk.GuestOsFeature prototype)

```
public static Instance.Disk.GuestOsFeature.Builder newBuilder(Instance.Disk.GuestOsFeature prototype)
```
...
```
public static Instance.Disk.GuestOsFeature parseDelimitedFrom(InputStream input)
```
...
```
public static Instance.Disk.GuestOsFeature parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Instance.Disk.GuestOsFeature parseFrom(byte[] data)
```
...
```
public static Instance.Disk.GuestOsFeature parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Instance.Disk.GuestOsFeature parseFrom(ByteString data)
```
...
```
public static Instance.Disk.GuestOsFeature parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Instance.Disk.GuestOsFeature parseFrom(CodedInputStream input)
```
...
```
public static Instance.Disk.GuestOsFeature parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Instance.Disk.GuestOsFeature parseFrom(InputStream input)
```
...
```
public static Instance.Disk.GuestOsFeature parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Instance.Disk.GuestOsFeature parseFrom(ByteBuffer data)
```
...
```
public static Instance.Disk.GuestOsFeature parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<Instance.Disk.GuestOsFeature> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[GuestOsFeature](/java/docs/reference/google-cloud-notebooks/1.15.0/com.google.cloud.notebooks.v1.Instance.Disk.GuestOsFeature)>`
...
```
public Parser<Instance.Disk.GuestOsFeature> getParserForType()
```
...
```
public Instance.Disk.GuestOsFeature.Builder newBuilderForType()
```
...
```
protected Instance.Disk.GuestOsFeature.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public Instance.Disk.GuestOsFeature.Builder toBuilder()
```
