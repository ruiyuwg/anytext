...
# Compute V1 Client - Class LicensesClient (1.25.0) Stay organized with collections Save and categorize content based on your preferences.
...
The async variant is [LicensesClient::deleteAsync()](/php/docs/reference/cloud-compute/1.25.0/V1.Client.LicensesClient#_Google_Cloud_Compute_V1_Client_LicensesClient__deleteAsync__) .
...
`[Google\Cloud\Compute\V1\DeleteLicenseRequest](/php/docs/reference/cloud-compute/1.25.0/V1.DeleteLicenseRequest)`  
...
The async variant is [LicensesClient::getAsync()](/php/docs/reference/cloud-compute/1.25.0/V1.Client.LicensesClient#_Google_Cloud_Compute_V1_Client_LicensesClient__getAsync__) .
...
`[Google\Cloud\Compute\V1\GetLicenseRequest](/php/docs/reference/cloud-compute/1.25.0/V1.GetLicenseRequest)`  
...
`[Google\Cloud\Compute\V1\License](/php/docs/reference/cloud-compute/1.25.0/V1.License)`
...
The async variant is [LicensesClient::getIamPolicyAsync()](/php/docs/reference/cloud-compute/1.25.0/V1.Client.LicensesClient#_Google_Cloud_Compute_V1_Client_LicensesClient__getIamPolicyAsync__) .
...
`[Google\Cloud\Compute\V1\GetIamPolicyLicenseRequest](/php/docs/reference/cloud-compute/1.25.0/V1.GetIamPolicyLicenseRequest)`  
...
`[Google\Cloud\Compute\V1\Policy](/php/docs/reference/cloud-compute/1.25.0/V1.Policy)`
...
The async variant is [LicensesClient::insertAsync()](/php/docs/reference/cloud-compute/1.25.0/V1.Client.LicensesClient#_Google_Cloud_Compute_V1_Client_LicensesClient__insertAsync__) .
...
`[Google\Cloud\Compute\V1\InsertLicenseRequest](/php/docs/reference/cloud-compute/1.25.0/V1.InsertLicenseRequest)`  
...
The async variant is [LicensesClient::listAsync()](/php/docs/reference/cloud-compute/1.25.0/V1.Client.LicensesClient#_Google_Cloud_Compute_V1_Client_LicensesClient__listAsync__) .
...
`[Google\Cloud\Compute\V1\ListLicensesRequest](/php/docs/reference/cloud-compute/1.25.0/V1.ListLicensesRequest)`  
...
The async variant is [LicensesClient::setIamPolicyAsync()](/php/docs/reference/cloud-compute/1.25.0/V1.Client.LicensesClient#_Google_Cloud_Compute_V1_Client_LicensesClient__setIamPolicyAsync__) .
...
`[Google\Cloud\Compute\V1\SetIamPolicyLicenseRequest](/php/docs/reference/cloud-compute/1.25.0/V1.SetIamPolicyLicenseRequest)`  
...
The async variant is [LicensesClient::testIamPermissionsAsync()](/php/docs/reference/cloud-compute/1.25.0/V1.Client.LicensesClient#_Google_Cloud_Compute_V1_Client_LicensesClient__testIamPermissionsAsync__) .
...
`[Google\Cloud\Compute\V1\TestIamPermissionsLicenseRequest](/php/docs/reference/cloud-compute/1.25.0/V1.TestIamPermissionsLicenseRequest)`  
...
`[Google\Cloud\Compute\V1\TestPermissionsResponse](/php/docs/reference/cloud-compute/1.25.0/V1.TestPermissionsResponse)`
...
`[GuzzleHttp\Promise\PromiseInterface](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-GuzzleHttp.Promise.Promise.html)<[Google\Cloud\Compute\V1\License](/php/docs/reference/cloud-compute/1.25.0/V1.License)>`
...
`[GuzzleHttp\Promise\PromiseInterface](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-GuzzleHttp.Promise.Promise.html)<[Google\Cloud\Compute\V1\Policy](/php/docs/reference/cloud-compute/1.25.0/V1.Policy)>`
...
`[GuzzleHttp\Promise\PromiseInterface](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-GuzzleHttp.Promise.Promise.html)<[Google\Cloud\Compute\V1\TestPermissionsResponse](/php/docs/reference/cloud-compute/1.25.0/V1.TestPermissionsResponse)>`
...
`[Google\Cloud\Compute\V1\GlobalOperationsClient](/php/docs/reference/cloud-compute/1.25.0/V1.GlobalOperationsClient)`
