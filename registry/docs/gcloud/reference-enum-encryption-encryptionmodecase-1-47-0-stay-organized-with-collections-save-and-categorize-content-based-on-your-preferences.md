...
# Enum Encryption.EncryptionModeCase (1.47.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum Encryption.EncryptionModeCase extends Enum<Encryption.EncryptionModeCase> implements Internal.EnumLite, AbstractMessageLite.InternalOneOfEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-video-transcoder/1.47.0/com.google.cloud.video.transcoder.v1.Encryption.EncryptionModeCase#com_google_cloud_video_transcoder_v1_Encryption_EncryptionModeCase_forNumber_int_) instead._
