...
# Class DataChangeRecord (6.62.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> DataChangeRecord

## Implements

[DataChangeRecordOrBuilder](/java/docs/reference/google-cloud-spanner/6.62.0/com.google.spanner.executor.v1.DataChangeRecordOrBuilder)
...
### IS\_LAST\_RECORD\_FIELD\_NUMBER
...
### IS\_SYSTEM\_TRANSACTION\_FIELD\_NUMBER
...
### PARTITION\_COUNT\_FIELD\_NUMBER
...
### RECORD\_SEQUENCE\_FIELD\_NUMBER
...
### TRANSACTION\_ID\_FIELD\_NUMBER
...
### TRANSACTION\_TAG\_FIELD\_NUMBER
...
### VALUE\_CAPTURE\_TYPE\_FIELD\_NUMBER
...
`[DataChangeRecord](/java/docs/reference/google-cloud-spanner/6.62.0/com.google.spanner.executor.v1.DataChangeRecord)`
...
`[DataChangeRecord.Builder](/java/docs/reference/google-cloud-spanner/6.62.0/com.google.spanner.executor.v1.DataChangeRecord.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[DataChangeRecord](/java/docs/reference/google-cloud-spanner/6.62.0/com.google.spanner.executor.v1.DataChangeRecord)>`
...
`[DataChangeRecord.ColumnType](/java/docs/reference/google-cloud-spanner/6.62.0/com.google.spanner.executor.v1.DataChangeRecord.ColumnType)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ColumnType](/java/docs/reference/google-cloud-spanner/6.62.0/com.google.spanner.executor.v1.DataChangeRecord.ColumnType)>`
...
`[DataChangeRecord.ColumnTypeOrBuilder](/java/docs/reference/google-cloud-spanner/6.62.0/com.google.spanner.executor.v1.DataChangeRecord.ColumnTypeOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.spanner.executor.v1.DataChangeRecord.ColumnTypeOrBuilder>`
...
`[DataChangeRecord.Mod](/java/docs/reference/google-cloud-spanner/6.62.0/com.google.spanner.executor.v1.DataChangeRecord.Mod)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Mod](/java/docs/reference/google-cloud-spanner/6.62.0/com.google.spanner.executor.v1.DataChangeRecord.Mod)>`
...
`[DataChangeRecord.ModOrBuilder](/java/docs/reference/google-cloud-spanner/6.62.0/com.google.spanner.executor.v1.DataChangeRecord.ModOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.spanner.executor.v1.DataChangeRecord.ModOrBuilder>`
...
One of value capture type: NEW\_VALUES, OLD\_VALUES, OLD\_AND\_NEW\_VALUES.
