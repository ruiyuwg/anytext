...
# Interface CreateFeatureRequestOrBuilder (1.31.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[Feature](/java/docs/reference/google-cloud-gkehub/1.31.0/com.google.cloud.gkehub.v1alpha.Feature)`
...
`[FeatureOrBuilder](/java/docs/reference/google-cloud-gkehub/1.31.0/com.google.cloud.gkehub.v1alpha.FeatureOrBuilder)`
