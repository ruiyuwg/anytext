...
# Enum Control.ControlCase (2.39.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum Control.ControlCase extends Enum<Control.ControlCase> implements Internal.EnumLite, AbstractMessageLite.InternalOneOfEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-retail/2.39.0/com.google.cloud.retail.v2alpha.Control.ControlCase#com_google_cloud_retail_v2alpha_Control_ControlCase_forNumber_int_) instead._
