...
# Interface DeleteExampleStoreRequestOrBuilder (3.88.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface DeleteExampleStoreRequestOrBuilder extends MessageOrBuilder
```
