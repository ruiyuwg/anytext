...
# google-cloud-recaptchaenterprise overview (3.84.0) Stay organized with collections Save and categorize content based on your preferences.
...
**reCAPTCHA Enterprise Description:** Is a service that protects your site from spam and abuse.

[reCAPTCHA Enterprise Product Reference](https://cloud.google.com/recaptcha-enterprise/docs/)

[GitHub Repository](https://github.com/googleapis/google-cloud-java/tree/main/java-recaptchaenterprise)

[Maven artifact](https://central.sonatype.com/artifact/com.google.cloud/google-cloud-recaptchaenterprise)
...
-   [Enable the API](https://console.cloud.google.com/apis/library/recaptchaenterprise.googleapis.com)
-   [Set up authentication](https://cloud.google.com/docs/authentication/client-libraries)

## Use the reCAPTCHA Enterprise for Java
...
The example below demonstrates how you would import the BOM and include the `google-cloud-recaptchaenterprise` artifact.
...
libraryDependencies += "com.google.cloud" % "google-cloud-recaptchaenterprise" % "3.84.0"

## Which version ID should I get started with?

For this library, we recommend using [com.google.recaptchaenterprise.v1](https://cloud.google.com/java/docs/reference/google-cloud-recaptchaenterprise/3.84.0/com.google.recaptchaenterprise.v1) for new applications.
