...
# Enum PartOfSpeech.Aspect (2.13.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-language/2.13.0/com.google.cloud.language.v1beta2.PartOfSpeech.Aspect#com_google_cloud_language_v1beta2_PartOfSpeech_Aspect_forNumber_int_) instead._
