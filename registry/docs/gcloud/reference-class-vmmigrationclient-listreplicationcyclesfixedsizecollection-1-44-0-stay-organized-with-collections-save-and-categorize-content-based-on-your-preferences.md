...
# Class VmMigrationClient.ListReplicationCyclesFixedSizeCollection (1.44.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class VmMigrationClient.ListReplicationCyclesFixedSizeCollection extends AbstractFixedSizeCollection<ListReplicationCyclesRequest,ListReplicationCyclesResponse,ReplicationCycle,VmMigrationClient.ListReplicationCyclesPage,VmMigrationClient.ListReplicationCyclesFixedSizeCollection>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractFixedSizeCollection](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractFixedSizeCollection.html) \> VmMigrationClient.ListReplicationCyclesFixedSizeCollection
...
### createCollection(List<VmMigrationClient.ListReplicationCyclesPage> pages, int collectionSize)

```
protected VmMigrationClient.ListReplicationCyclesFixedSizeCollection createCollection(List<VmMigrationClient.ListReplicationCyclesPage> pages, int collectionSize)
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ListReplicationCyclesPage](/java/docs/reference/google-cloud-vmmigration/1.44.0/com.google.cloud.vmmigration.v1.VmMigrationClient.ListReplicationCyclesPage)>`  
...
`[VmMigrationClient.ListReplicationCyclesFixedSizeCollection](/java/docs/reference/google-cloud-vmmigration/1.44.0/com.google.cloud.vmmigration.v1.VmMigrationClient.ListReplicationCyclesFixedSizeCollection)`
