...
# Cloud AI Platform v1 API - Class DeployedModel.Types (3.16.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class DeployedModel.Types
```

Reference documentation and code samples for the Cloud AI Platform v1 API class DeployedModel.Types.

Container for nested types declared in the DeployedModel message type.

## Inheritance

[object](https://learn.microsoft.com/dotnet/api/system.object) \> DeployedModel.Types
