...
# Compute V1 Client - Class Metadata (1.27.0) Stay organized with collections Save and categorize content based on your preferences.
...
Metadata contains string constants that represent the names of each value in the google.cloud.compute.v1.SubnetworkLogConfig.Metadata descriptor.

## Namespace

Google \\ Cloud \\ Compute \\ V1 \\ Enums \\ SubnetworkLogConfig
