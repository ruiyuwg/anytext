...
# Class GetSubnetRequest (0.21.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class GetSubnetRequest extends GeneratedMessageV3 implements GetSubnetRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> GetSubnetRequest

## Implements

[GetSubnetRequestOrBuilder](/java/docs/reference/google-cloud-vmwareengine/0.21.0/com.google.cloud.vmwareengine.v1.GetSubnetRequestOrBuilder)
...
```
public static GetSubnetRequest getDefaultInstance()
```
...
`[GetSubnetRequest](/java/docs/reference/google-cloud-vmwareengine/0.21.0/com.google.cloud.vmwareengine.v1.GetSubnetRequest)`
...
```
public static GetSubnetRequest.Builder newBuilder()
```
...
`[GetSubnetRequest.Builder](/java/docs/reference/google-cloud-vmwareengine/0.21.0/com.google.cloud.vmwareengine.v1.GetSubnetRequest.Builder)`

### newBuilder(GetSubnetRequest prototype)

```
public static GetSubnetRequest.Builder newBuilder(GetSubnetRequest prototype)
```
...
```
public static GetSubnetRequest parseDelimitedFrom(InputStream input)
```
...
```
public static GetSubnetRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetSubnetRequest parseFrom(byte[] data)
```
...
```
public static GetSubnetRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetSubnetRequest parseFrom(ByteString data)
```
...
```
public static GetSubnetRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetSubnetRequest parseFrom(CodedInputStream input)
```
...
```
public static GetSubnetRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetSubnetRequest parseFrom(InputStream input)
```
...
```
public static GetSubnetRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetSubnetRequest parseFrom(ByteBuffer data)
```
...
```
public static GetSubnetRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<GetSubnetRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[GetSubnetRequest](/java/docs/reference/google-cloud-vmwareengine/0.21.0/com.google.cloud.vmwareengine.v1.GetSubnetRequest)>`
...
Required. The resource name of the subnet to retrieve. Resource names are schemeless URIs that follow the conventions in [https://cloud.google.com/apis/design/resource\_names](https://cloud.google.com/apis/design/resource_names). For example: `projects/my-project/locations/us-central1-a/privateClouds/my-cloud/subnets/my-subnet`
...
```
public Parser<GetSubnetRequest> getParserForType()
```
...
```
public GetSubnetRequest.Builder newBuilderForType()
```
...
```
protected GetSubnetRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public GetSubnetRequest.Builder toBuilder()
```
