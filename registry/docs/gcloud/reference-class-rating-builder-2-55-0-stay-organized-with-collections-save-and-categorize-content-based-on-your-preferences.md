...
# Class Rating.Builder (2.55.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> Rating.Builder

## Implements

[RatingOrBuilder](/java/docs/reference/google-cloud-retail/2.55.0/com.google.cloud.retail.v2beta.RatingOrBuilder)
...
List of rating counts per rating value (index = rating - 1). The list is empty if there is no rating. If the list is non-empty, its size is always 5. Otherwise, an INVALID\_ARGUMENT error is returned.
...
`[Rating.Builder](/java/docs/reference/google-cloud-retail/2.55.0/com.google.cloud.retail.v2beta.Rating.Builder)`
...
`[Rating](/java/docs/reference/google-cloud-retail/2.55.0/com.google.cloud.retail.v2beta.Rating)`
...
The rating is scaled at 1-5. Otherwise, an INVALID\_ARGUMENT error is returned.
...
The total number of ratings. This value is independent of the value of rating\_histogram.

This value must be nonnegative. Otherwise, an INVALID\_ARGUMENT error is returned.
