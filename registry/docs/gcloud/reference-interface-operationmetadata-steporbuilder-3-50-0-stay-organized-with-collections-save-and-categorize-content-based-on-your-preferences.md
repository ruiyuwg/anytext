...
# Interface OperationMetadata.StepOrBuilder (3.50.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[OperationMetadata.Status](/java/docs/reference/google-cloud-service-management/3.50.0/com.google.api.servicemanagement.v1.OperationMetadata.Status)`
