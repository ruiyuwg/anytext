...
# Google Cloud Ai Platform V1 Client - Class GetArtifactRequest (0.15.0) Stay organized with collections Save and categorize content based on your preferences.
...
Reference documentation and code samples for the Google Cloud Ai Platform V1 Client class GetArtifactRequest.

Request message for [MetadataService.GetArtifact](/php/docs/reference/cloud-ai-platform/0.15.0/V1.MetadataServiceClient#_Google_Cloud_AIPlatform_V1_MetadataServiceClient__getArtifact__).

Generated from protobuf message `google.cloud.aiplatform.v1.GetArtifactRequest`
