...
# Class AzureNodePoolName.Builder (0.31.0) Stay organized with collections Save and categorize content based on your preferences.
...
Builder for projects/{project}/locations/{location}/azureClusters/{azure\_cluster}/azureNodePools/{azure\_node\_pool}.

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> AzureNodePoolName.Builder
...
`[AzureNodePoolName](/java/docs/reference/google-cloud-gke-multi-cloud/0.31.0/com.google.cloud.gkemulticloud.v1.AzureNodePoolName)`
...
`[AzureNodePoolName.Builder](/java/docs/reference/google-cloud-gke-multi-cloud/0.31.0/com.google.cloud.gkemulticloud.v1.AzureNodePoolName.Builder)`
