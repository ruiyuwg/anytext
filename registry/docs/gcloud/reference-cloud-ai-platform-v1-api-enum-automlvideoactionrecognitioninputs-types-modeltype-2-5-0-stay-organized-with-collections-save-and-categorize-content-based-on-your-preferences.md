...
# Cloud AI Platform v1 API - Enum AutoMlVideoActionRecognitionInputs.Types.ModelType (2.5.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Google.Cloud.AIPlatform.V1.Schema.TrainingJob.Definition](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/2.5.0/Google.Cloud.AIPlatform.V1.Schema.TrainingJob.Definition)
