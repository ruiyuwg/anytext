...
-   [Samples](https://docs.cloud.google.com/compute/docs/samples)

# Create a route in a network Stay organized with collections Save and categorize content based on your preferences.
...
Before trying this sample, follow the Go setup instructions in the [Compute Engine quickstart using client libraries](/compute/docs/api/using-libraries). For more information, see the [Compute Engine Go API reference documentation](/go/docs/reference/cloud.google.com/go/compute/latest/apiv1).

To authenticate to Compute Engine, set up Application Default Credentials. For more information, see [Set up authentication for a local development environment](/docs/authentication/set-up-adc-local-dev-environment).
...
Before trying this sample, follow the Java setup instructions in the [Compute Engine quickstart using client libraries](/compute/docs/api/using-libraries). For more information, see the [Compute Engine Java API reference documentation](/java/docs/reference/google-cloud-compute/latest/overview).
...
Before trying this sample, follow the Python setup instructions in the [Compute Engine quickstart using client libraries](/compute/docs/api/using-libraries). For more information, see the [Compute Engine Python API reference documentation](/python/docs/reference/compute/latest).
...
To search and filter code samples for other Google Cloud products, see the [Google Cloud sample browser](/docs/samples?product=compute).
