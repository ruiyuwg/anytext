...
# Cloud AI Platform v1 API - Enum Examples.Types.ExampleGcsSource.Types.DataFormat (2.23.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum Examples.Types.ExampleGcsSource.Types.DataFormat
```

Reference documentation and code samples for the Cloud AI Platform v1 API enum Examples.Types.ExampleGcsSource.Types.DataFormat.
