...
# Enum SsmlVoiceGender (2.41.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-texttospeech/2.41.0/com.google.cloud.texttospeech.v1.SsmlVoiceGender#com_google_cloud_texttospeech_v1_SsmlVoiceGender_forNumber_int_) instead._
