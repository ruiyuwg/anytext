...
# Interface ListAttachedClustersResponseOrBuilder (0.86.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[AttachedCluster](/java/docs/reference/google-cloud-gke-multi-cloud/latest/com.google.cloud.gkemulticloud.v1.AttachedCluster)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[AttachedCluster](/java/docs/reference/google-cloud-gke-multi-cloud/latest/com.google.cloud.gkemulticloud.v1.AttachedCluster)>`
...
`[AttachedClusterOrBuilder](/java/docs/reference/google-cloud-gke-multi-cloud/latest/com.google.cloud.gkemulticloud.v1.AttachedClusterOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.gkemulticloud.v1.AttachedClusterOrBuilder>`
