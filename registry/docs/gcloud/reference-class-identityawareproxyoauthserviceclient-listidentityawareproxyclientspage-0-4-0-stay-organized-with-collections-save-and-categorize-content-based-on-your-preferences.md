...
# Class IdentityAwareProxyOAuthServiceClient.ListIdentityAwareProxyClientsPage (0.4.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class IdentityAwareProxyOAuthServiceClient.ListIdentityAwareProxyClientsPage extends AbstractPage<ListIdentityAwareProxyClientsRequest,ListIdentityAwareProxyClientsResponse,IdentityAwareProxyClient,IdentityAwareProxyOAuthServiceClient.ListIdentityAwareProxyClientsPage>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractPage](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractPage.html) \> IdentityAwareProxyOAuthServiceClient.ListIdentityAwareProxyClientsPage
...
### createPage(PageContext<ListIdentityAwareProxyClientsRequest,ListIdentityAwareProxyClientsResponse,IdentityAwareProxyClient> context, ListIdentityAwareProxyClientsResponse response)

```
protected IdentityAwareProxyOAuthServiceClient.ListIdentityAwareProxyClientsPage createPage(PageContext<ListIdentityAwareProxyClientsRequest,ListIdentityAwareProxyClientsResponse,IdentityAwareProxyClient> context, ListIdentityAwareProxyClientsResponse response)
```
...
`[PageContext](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PageContext.html)<[ListIdentityAwareProxyClientsRequest](/java/docs/reference/google-cloud-iap/0.4.0/com.google.cloud.iap.v1.ListIdentityAwareProxyClientsRequest),[ListIdentityAwareProxyClientsResponse](/java/docs/reference/google-cloud-iap/0.4.0/com.google.cloud.iap.v1.ListIdentityAwareProxyClientsResponse),[IdentityAwareProxyClient](/java/docs/reference/google-cloud-iap/0.4.0/com.google.cloud.iap.v1.IdentityAwareProxyClient)>`  

`response`

`[ListIdentityAwareProxyClientsResponse](/java/docs/reference/google-cloud-iap/0.4.0/com.google.cloud.iap.v1.ListIdentityAwareProxyClientsResponse)`  
...
`[IdentityAwareProxyOAuthServiceClient.ListIdentityAwareProxyClientsPage](/java/docs/reference/google-cloud-iap/0.4.0/com.google.cloud.iap.v1.IdentityAwareProxyOAuthServiceClient.ListIdentityAwareProxyClientsPage)`
...
### createPageAsync(PageContext<ListIdentityAwareProxyClientsRequest,ListIdentityAwareProxyClientsResponse,IdentityAwareProxyClient> context, ApiFuture<ListIdentityAwareProxyClientsResponse> futureResponse)

```
public ApiFuture<IdentityAwareProxyOAuthServiceClient.ListIdentityAwareProxyClientsPage> createPageAsync(PageContext<ListIdentityAwareProxyClientsRequest,ListIdentityAwareProxyClientsResponse,IdentityAwareProxyClient> context, ApiFuture<ListIdentityAwareProxyClientsResponse> futureResponse)
```
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListIdentityAwareProxyClientsResponse](/java/docs/reference/google-cloud-iap/0.4.0/com.google.cloud.iap.v1.ListIdentityAwareProxyClientsResponse)>`  
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListIdentityAwareProxyClientsPage](/java/docs/reference/google-cloud-iap/0.4.0/com.google.cloud.iap.v1.IdentityAwareProxyOAuthServiceClient.ListIdentityAwareProxyClientsPage)>`
