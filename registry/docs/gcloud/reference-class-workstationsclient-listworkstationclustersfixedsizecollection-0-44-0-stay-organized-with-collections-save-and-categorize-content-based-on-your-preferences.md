...
# Class WorkstationsClient.ListWorkstationClustersFixedSizeCollection (0.44.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class WorkstationsClient.ListWorkstationClustersFixedSizeCollection extends AbstractFixedSizeCollection<ListWorkstationClustersRequest,ListWorkstationClustersResponse,WorkstationCluster,WorkstationsClient.ListWorkstationClustersPage,WorkstationsClient.ListWorkstationClustersFixedSizeCollection>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractFixedSizeCollection](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractFixedSizeCollection.html) \> WorkstationsClient.ListWorkstationClustersFixedSizeCollection
...
### createCollection(List<WorkstationsClient.ListWorkstationClustersPage> pages, int collectionSize)

```
protected WorkstationsClient.ListWorkstationClustersFixedSizeCollection createCollection(List<WorkstationsClient.ListWorkstationClustersPage> pages, int collectionSize)
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ListWorkstationClustersPage](/java/docs/reference/google-cloud-workstations/0.44.0/com.google.cloud.workstations.v1beta.WorkstationsClient.ListWorkstationClustersPage)>`  
...
`[WorkstationsClient.ListWorkstationClustersFixedSizeCollection](/java/docs/reference/google-cloud-workstations/0.44.0/com.google.cloud.workstations.v1beta.WorkstationsClient.ListWorkstationClustersFixedSizeCollection)`
