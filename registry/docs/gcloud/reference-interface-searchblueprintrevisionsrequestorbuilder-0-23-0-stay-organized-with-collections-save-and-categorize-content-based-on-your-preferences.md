...
# Interface SearchBlueprintRevisionsRequestOrBuilder (0.23.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface SearchBlueprintRevisionsRequestOrBuilder extends MessageOrBuilder
```
