...
# Enum OSPolicyAssignmentOperationMetadata.RolloutState (2.38.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-os-config/2.38.0/com.google.cloud.osconfig.v1.OSPolicyAssignmentOperationMetadata.RolloutState#com_google_cloud_osconfig_v1_OSPolicyAssignmentOperationMetadata_RolloutState_forNumber_int_) instead._
