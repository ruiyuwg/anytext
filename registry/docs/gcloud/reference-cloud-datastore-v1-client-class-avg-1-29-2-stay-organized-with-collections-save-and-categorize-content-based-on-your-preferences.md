...
# Cloud Datastore V1 Client - Class Avg (1.29.2) Stay organized with collections Save and categorize content based on your preferences.
...
`[Google\Cloud\Datastore\V1\PropertyReference](/php/docs/reference/cloud-datastore/1.29.2/V1.PropertyReference)`  
...
`[Google\Cloud\Datastore\V1\PropertyReference](/php/docs/reference/cloud-datastore/1.29.2/V1.PropertyReference)|null`
