...
# Class AddFulfillmentPlacesMetadata (2.33.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class AddFulfillmentPlacesMetadata extends GeneratedMessageV3 implements AddFulfillmentPlacesMetadataOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> AddFulfillmentPlacesMetadata

## Implements

[AddFulfillmentPlacesMetadataOrBuilder](/java/docs/reference/google-cloud-retail/2.33.0/com.google.cloud.retail.v2.AddFulfillmentPlacesMetadataOrBuilder)
...
```
public static AddFulfillmentPlacesMetadata getDefaultInstance()
```
...
`[AddFulfillmentPlacesMetadata](/java/docs/reference/google-cloud-retail/2.33.0/com.google.cloud.retail.v2.AddFulfillmentPlacesMetadata)`
...
```
public static AddFulfillmentPlacesMetadata.Builder newBuilder()
```
...
`[AddFulfillmentPlacesMetadata.Builder](/java/docs/reference/google-cloud-retail/2.33.0/com.google.cloud.retail.v2.AddFulfillmentPlacesMetadata.Builder)`

### newBuilder(AddFulfillmentPlacesMetadata prototype)

```
public static AddFulfillmentPlacesMetadata.Builder newBuilder(AddFulfillmentPlacesMetadata prototype)
```
...
```
public static AddFulfillmentPlacesMetadata parseDelimitedFrom(InputStream input)
```
...
```
public static AddFulfillmentPlacesMetadata parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AddFulfillmentPlacesMetadata parseFrom(byte[] data)
```
...
```
public static AddFulfillmentPlacesMetadata parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AddFulfillmentPlacesMetadata parseFrom(ByteString data)
```
...
```
public static AddFulfillmentPlacesMetadata parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AddFulfillmentPlacesMetadata parseFrom(CodedInputStream input)
```
...
```
public static AddFulfillmentPlacesMetadata parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AddFulfillmentPlacesMetadata parseFrom(InputStream input)
```
...
```
public static AddFulfillmentPlacesMetadata parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AddFulfillmentPlacesMetadata parseFrom(ByteBuffer data)
```
...
```
public static AddFulfillmentPlacesMetadata parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<AddFulfillmentPlacesMetadata> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[AddFulfillmentPlacesMetadata](/java/docs/reference/google-cloud-retail/2.33.0/com.google.cloud.retail.v2.AddFulfillmentPlacesMetadata)>`
...
```
public AddFulfillmentPlacesMetadata getDefaultInstanceForType()
```
...
```
public Parser<AddFulfillmentPlacesMetadata> getParserForType()
```
...
```
public AddFulfillmentPlacesMetadata.Builder newBuilderForType()
```
...
```
protected AddFulfillmentPlacesMetadata.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public AddFulfillmentPlacesMetadata.Builder toBuilder()
```
