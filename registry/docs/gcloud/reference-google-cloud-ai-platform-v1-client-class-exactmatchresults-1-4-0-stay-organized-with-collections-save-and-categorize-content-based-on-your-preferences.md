...
# Google Cloud Ai Platform V1 Client - Class ExactMatchResults (1.4.0) Stay organized with collections Save and categorize content based on your preferences.
...
`array<[Google\Cloud\AIPlatform\V1\ExactMatchMetricValue](/php/docs/reference/cloud-ai-platform/1.4.0/V1.ExactMatchMetricValue)>`  
