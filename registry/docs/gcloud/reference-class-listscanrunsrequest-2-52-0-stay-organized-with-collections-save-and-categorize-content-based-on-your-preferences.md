...
# Class ListScanRunsRequest (2.52.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListScanRunsRequest extends GeneratedMessageV3 implements ListScanRunsRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListScanRunsRequest

## Implements

[ListScanRunsRequestOrBuilder](/java/docs/reference/google-cloud-websecurityscanner/2.52.0/com.google.cloud.websecurityscanner.v1.ListScanRunsRequestOrBuilder)
...
```
public static ListScanRunsRequest getDefaultInstance()
```
...
`[ListScanRunsRequest](/java/docs/reference/google-cloud-websecurityscanner/2.52.0/com.google.cloud.websecurityscanner.v1.ListScanRunsRequest)`
...
```
public static ListScanRunsRequest.Builder newBuilder()
```
...
`[ListScanRunsRequest.Builder](/java/docs/reference/google-cloud-websecurityscanner/2.52.0/com.google.cloud.websecurityscanner.v1.ListScanRunsRequest.Builder)`

### newBuilder(ListScanRunsRequest prototype)

```
public static ListScanRunsRequest.Builder newBuilder(ListScanRunsRequest prototype)
```
...
```
public static ListScanRunsRequest parseDelimitedFrom(InputStream input)
```
...
```
public static ListScanRunsRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListScanRunsRequest parseFrom(byte[] data)
```
...
```
public static ListScanRunsRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListScanRunsRequest parseFrom(ByteString data)
```
...
```
public static ListScanRunsRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListScanRunsRequest parseFrom(CodedInputStream input)
```
...
```
public static ListScanRunsRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListScanRunsRequest parseFrom(InputStream input)
```
...
```
public static ListScanRunsRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListScanRunsRequest parseFrom(ByteBuffer data)
```
...
```
public static ListScanRunsRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ListScanRunsRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListScanRunsRequest](/java/docs/reference/google-cloud-websecurityscanner/2.52.0/com.google.cloud.websecurityscanner.v1.ListScanRunsRequest)>`
...
```
public Parser<ListScanRunsRequest> getParserForType()
```
...
```
public ListScanRunsRequest.Builder newBuilderForType()
```
...
```
protected ListScanRunsRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ListScanRunsRequest.Builder toBuilder()
```
