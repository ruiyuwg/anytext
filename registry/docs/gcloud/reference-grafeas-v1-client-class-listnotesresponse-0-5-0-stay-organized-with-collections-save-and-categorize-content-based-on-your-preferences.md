...
# Grafeas V1 Client - Class ListNotesResponse (0.5.0) Stay organized with collections Save and categorize content based on your preferences.
...
`array<[Grafeas\V1\Note](/php/docs/reference/grafeas/0.5.0/V1.Note)>`  
