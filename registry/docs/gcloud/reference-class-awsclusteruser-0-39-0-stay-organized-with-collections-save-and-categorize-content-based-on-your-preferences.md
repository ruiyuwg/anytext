...
# Class AwsClusterUser (0.39.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class AwsClusterUser extends GeneratedMessageV3 implements AwsClusterUserOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> AwsClusterUser

## Implements

[AwsClusterUserOrBuilder](/java/docs/reference/google-cloud-gke-multi-cloud/0.39.0/com.google.cloud.gkemulticloud.v1.AwsClusterUserOrBuilder)
...
```
public static AwsClusterUser getDefaultInstance()
```
...
`[AwsClusterUser](/java/docs/reference/google-cloud-gke-multi-cloud/0.39.0/com.google.cloud.gkemulticloud.v1.AwsClusterUser)`
...
```
public static AwsClusterUser.Builder newBuilder()
```
...
`[AwsClusterUser.Builder](/java/docs/reference/google-cloud-gke-multi-cloud/0.39.0/com.google.cloud.gkemulticloud.v1.AwsClusterUser.Builder)`

### newBuilder(AwsClusterUser prototype)

```
public static AwsClusterUser.Builder newBuilder(AwsClusterUser prototype)
```
...
```
public static AwsClusterUser parseDelimitedFrom(InputStream input)
```
...
```
public static AwsClusterUser parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AwsClusterUser parseFrom(byte[] data)
```
...
```
public static AwsClusterUser parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AwsClusterUser parseFrom(ByteString data)
```
...
```
public static AwsClusterUser parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AwsClusterUser parseFrom(CodedInputStream input)
```
...
```
public static AwsClusterUser parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AwsClusterUser parseFrom(InputStream input)
```
...
```
public static AwsClusterUser parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AwsClusterUser parseFrom(ByteBuffer data)
```
...
```
public static AwsClusterUser parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<AwsClusterUser> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[AwsClusterUser](/java/docs/reference/google-cloud-gke-multi-cloud/0.39.0/com.google.cloud.gkemulticloud.v1.AwsClusterUser)>`
...
```
public AwsClusterUser getDefaultInstanceForType()
```
...
```
public Parser<AwsClusterUser> getParserForType()
```
...
```
public AwsClusterUser.Builder newBuilderForType()
```
...
```
protected AwsClusterUser.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public AwsClusterUser.Builder toBuilder()
```
