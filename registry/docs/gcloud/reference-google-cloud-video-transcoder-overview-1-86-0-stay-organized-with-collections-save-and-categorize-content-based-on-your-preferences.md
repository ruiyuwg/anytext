...
# google-cloud-video-transcoder overview (1.86.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Video Transcoder Description:** Allows you to transcode videos into a variety of formats. The Transcoder API benefits broadcasters, production companies, businesses, and individuals looking to transform their video content for use across a variety of user devices.

[Video Transcoder Product Reference](https://cloud.google.com/transcoder/docs)

[GitHub Repository](https://github.com/googleapis/google-cloud-java/tree/main/java-video-transcoder)

[Maven artifact](https://central.sonatype.com/artifact/com.google.cloud/google-cloud-video-transcoder)
...
-   [Enable the API](https://console.cloud.google.com/apis/library/transcoder.googleapis.com)
-   [Set up authentication](https://cloud.google.com/docs/authentication/client-libraries)

## Use the Video Transcoder for Java
...
The example below demonstrates how you would import the BOM and include the `google-cloud-video-transcoder` artifact.
...
For this library, we recommend using [com.google.cloud.video.transcoder.v1](https://cloud.google.com/java/docs/reference/google-cloud-video-transcoder/1.86.0/com.google.cloud.video.transcoder.v1) for new applications.
