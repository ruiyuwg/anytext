...
# Class ListProductsResponse (3.57.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListProductsResponse extends GeneratedMessageV3 implements ListProductsResponseOrBuilder
```

Response message for the `ListProducts` method.

Protobuf type `google.cloud.vision.v1p4beta1.ListProductsResponse`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListProductsResponse

## Implements

[ListProductsResponseOrBuilder](/java/docs/reference/google-cloud-vision/3.57.0/com.google.cloud.vision.v1p4beta1.ListProductsResponseOrBuilder)
...
`[ListProductsResponse](/java/docs/reference/google-cloud-vision/3.57.0/com.google.cloud.vision.v1p4beta1.ListProductsResponse)`
...
```
public static ListProductsResponse.Builder newBuilder()
```
...
`[ListProductsResponse.Builder](/java/docs/reference/google-cloud-vision/3.57.0/com.google.cloud.vision.v1p4beta1.ListProductsResponse.Builder)`

### newBuilder(ListProductsResponse prototype)

```
public static ListProductsResponse.Builder newBuilder(ListProductsResponse prototype)
```
...
```
public static ListProductsResponse parseDelimitedFrom(InputStream input)
```
...
```
public static ListProductsResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListProductsResponse parseFrom(byte[] data)
```
...
```
public static ListProductsResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListProductsResponse parseFrom(ByteString data)
```
...
```
public static ListProductsResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListProductsResponse parseFrom(CodedInputStream input)
```
...
```
public static ListProductsResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListProductsResponse parseFrom(InputStream input)
```
...
```
public static ListProductsResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListProductsResponse parseFrom(ByteBuffer data)
```
...
```
public static ListProductsResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListProductsResponse](/java/docs/reference/google-cloud-vision/3.57.0/com.google.cloud.vision.v1p4beta1.ListProductsResponse)>`
...
```
public Parser<ListProductsResponse> getParserForType()
```
...
`[Product](/java/docs/reference/google-cloud-vision/3.57.0/com.google.cloud.vision.v1p4beta1.Product)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Product](/java/docs/reference/google-cloud-vision/3.57.0/com.google.cloud.vision.v1p4beta1.Product)>`
...
`[ProductOrBuilder](/java/docs/reference/google-cloud-vision/3.57.0/com.google.cloud.vision.v1p4beta1.ProductOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.vision.v1p4beta1.ProductOrBuilder>`
...
```
public ListProductsResponse.Builder newBuilderForType()
```
...
```
protected ListProductsResponse.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
