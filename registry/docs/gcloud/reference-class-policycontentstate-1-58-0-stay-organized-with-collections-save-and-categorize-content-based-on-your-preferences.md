...
# Class PolicyContentState (1.58.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> PolicyContentState

## Implements

[PolicyContentStateOrBuilder](/java/docs/reference/google-cloud-gkehub/1.58.0/com.google.cloud.gkehub.policycontroller.v1beta.PolicyContentStateOrBuilder)
...
### REFERENTIAL\_SYNC\_CONFIG\_STATE\_FIELD\_NUMBER
...
### TEMPLATE\_LIBRARY\_STATE\_FIELD\_NUMBER
...
`[PolicyContentState](/java/docs/reference/google-cloud-gkehub/1.58.0/com.google.cloud.gkehub.policycontroller.v1beta.PolicyContentState)`
...
`[PolicyContentState.Builder](/java/docs/reference/google-cloud-gkehub/1.58.0/com.google.cloud.gkehub.policycontroller.v1beta.PolicyContentState.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[PolicyContentState](/java/docs/reference/google-cloud-gkehub/1.58.0/com.google.cloud.gkehub.policycontroller.v1beta.PolicyContentState)>`
...
Use [#getBundleStatesMap()](/java/docs/reference/google-cloud-gkehub/1.58.0/com.google.cloud.gkehub.policycontroller.v1beta.PolicyContentState#com_google_cloud_gkehub_policycontroller_v1beta_PolicyContentState_getBundleStatesMap__) instead.
...
`[Map](https://docs.oracle.com/javase/8/docs/api/java/util/Map.html)<[String](https://docs.oracle.com/javase/8/docs/api/java/lang/String.html),[OnClusterState](/java/docs/reference/google-cloud-gkehub/1.58.0/com.google.cloud.gkehub.policycontroller.v1beta.OnClusterState)>`
...
`[OnClusterState](/java/docs/reference/google-cloud-gkehub/1.58.0/com.google.cloud.gkehub.policycontroller.v1beta.OnClusterState)`  
...
`[OnClusterStateOrBuilder](/java/docs/reference/google-cloud-gkehub/1.58.0/com.google.cloud.gkehub.policycontroller.v1beta.OnClusterStateOrBuilder)`
