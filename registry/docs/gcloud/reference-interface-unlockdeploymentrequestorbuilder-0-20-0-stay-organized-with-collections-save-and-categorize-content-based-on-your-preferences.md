...
# Interface UnlockDeploymentRequestOrBuilder (0.20.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface UnlockDeploymentRequestOrBuilder extends MessageOrBuilder
```
...
Required. The name of the deployment in the format: 'projects/{project\_id}/locations/{location}/deployments/{deployment}'.
