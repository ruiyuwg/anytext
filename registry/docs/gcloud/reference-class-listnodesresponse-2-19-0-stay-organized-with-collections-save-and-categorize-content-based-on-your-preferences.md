...
# Class ListNodesResponse (2.19.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListNodesResponse extends GeneratedMessageV3 implements ListNodesResponseOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListNodesResponse

## Implements

[ListNodesResponseOrBuilder](/java/docs/reference/google-cloud-tpu/2.19.0/com.google.cloud.tpu.v1.ListNodesResponseOrBuilder)
...
```
public static ListNodesResponse getDefaultInstance()
```
...
`[ListNodesResponse](/java/docs/reference/google-cloud-tpu/2.19.0/com.google.cloud.tpu.v1.ListNodesResponse)`
...
```
public static ListNodesResponse.Builder newBuilder()
```
...
`[ListNodesResponse.Builder](/java/docs/reference/google-cloud-tpu/2.19.0/com.google.cloud.tpu.v1.ListNodesResponse.Builder)`

### newBuilder(ListNodesResponse prototype)

```
public static ListNodesResponse.Builder newBuilder(ListNodesResponse prototype)
```
...
```
public static ListNodesResponse parseDelimitedFrom(InputStream input)
```
...
```
public static ListNodesResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListNodesResponse parseFrom(byte[] data)
```
...
```
public static ListNodesResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListNodesResponse parseFrom(ByteString data)
```
...
```
public static ListNodesResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListNodesResponse parseFrom(CodedInputStream input)
```
...
```
public static ListNodesResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListNodesResponse parseFrom(InputStream input)
```
...
```
public static ListNodesResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListNodesResponse parseFrom(ByteBuffer data)
```
...
```
public static ListNodesResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ListNodesResponse> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListNodesResponse](/java/docs/reference/google-cloud-tpu/2.19.0/com.google.cloud.tpu.v1.ListNodesResponse)>`
...
```
public ListNodesResponse getDefaultInstanceForType()
```
...
`repeated .google.cloud.tpu.v1.Node nodes = 1;`
...
`[Node](/java/docs/reference/google-cloud-tpu/2.19.0/com.google.cloud.tpu.v1.Node)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Node](/java/docs/reference/google-cloud-tpu/2.19.0/com.google.cloud.tpu.v1.Node)>`
...
`[NodeOrBuilder](/java/docs/reference/google-cloud-tpu/2.19.0/com.google.cloud.tpu.v1.NodeOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.tpu.v1.NodeOrBuilder>`

### getParserForType()

```
public Parser<ListNodesResponse> getParserForType()
```
...
```
public ListNodesResponse.Builder newBuilderForType()
```
...
```
protected ListNodesResponse.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ListNodesResponse.Builder toBuilder()
```
