...
# Struct TasksRetryPolicyOption (2.15.1) Stay organized with collections Save and categorize content based on your preferences.
...
**Alias Of**: `std::shared_ptr< TasksRetryPolicy >`
