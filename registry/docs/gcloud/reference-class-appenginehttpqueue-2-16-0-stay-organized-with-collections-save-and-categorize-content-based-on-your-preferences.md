...
# Class AppEngineHttpQueue (2.16.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class AppEngineHttpQueue extends GeneratedMessageV3 implements AppEngineHttpQueueOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> AppEngineHttpQueue

## Implements

[AppEngineHttpQueueOrBuilder](/java/docs/reference/google-cloud-tasks/2.16.0/com.google.cloud.tasks.v2beta3.AppEngineHttpQueueOrBuilder)
...
### APP\_ENGINE\_ROUTING\_OVERRIDE\_FIELD\_NUMBER
...
```
public static AppEngineHttpQueue getDefaultInstance()
```
...
`[AppEngineHttpQueue](/java/docs/reference/google-cloud-tasks/2.16.0/com.google.cloud.tasks.v2beta3.AppEngineHttpQueue)`
...
```
public static AppEngineHttpQueue.Builder newBuilder()
```
...
`[AppEngineHttpQueue.Builder](/java/docs/reference/google-cloud-tasks/2.16.0/com.google.cloud.tasks.v2beta3.AppEngineHttpQueue.Builder)`

### newBuilder(AppEngineHttpQueue prototype)

```
public static AppEngineHttpQueue.Builder newBuilder(AppEngineHttpQueue prototype)
```
...
```
public static AppEngineHttpQueue parseDelimitedFrom(InputStream input)
```
...
```
public static AppEngineHttpQueue parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AppEngineHttpQueue parseFrom(byte[] data)
```
...
```
public static AppEngineHttpQueue parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AppEngineHttpQueue parseFrom(ByteString data)
```
...
```
public static AppEngineHttpQueue parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AppEngineHttpQueue parseFrom(CodedInputStream input)
```
...
```
public static AppEngineHttpQueue parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AppEngineHttpQueue parseFrom(InputStream input)
```
...
```
public static AppEngineHttpQueue parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AppEngineHttpQueue parseFrom(ByteBuffer data)
```
...
```
public static AppEngineHttpQueue parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<AppEngineHttpQueue> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[AppEngineHttpQueue](/java/docs/reference/google-cloud-tasks/2.16.0/com.google.cloud.tasks.v2beta3.AppEngineHttpQueue)>`
...
Overrides for the task-level app\_engine\_routing. If set, `app_engine_routing_override` is used for all tasks in the queue, no matter what the setting is for the task-level app\_engine\_routing.
...
`[AppEngineRouting](/java/docs/reference/google-cloud-tasks/2.16.0/com.google.cloud.tasks.v2beta3.AppEngineRouting)`
...
`[AppEngineRoutingOrBuilder](/java/docs/reference/google-cloud-tasks/2.16.0/com.google.cloud.tasks.v2beta3.AppEngineRoutingOrBuilder)`
...
```
public Parser<AppEngineHttpQueue> getParserForType()
```
...
```
public AppEngineHttpQueue.Builder newBuilderForType()
```
...
```
protected AppEngineHttpQueue.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public AppEngineHttpQueue.Builder toBuilder()
```
