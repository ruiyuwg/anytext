...
# Enum RunAssetDiscoveryResponse.State (2.55.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-securitycenter/2.55.0/com.google.cloud.securitycenter.v1beta1.RunAssetDiscoveryResponse.State#com_google_cloud_securitycenter_v1beta1_RunAssetDiscoveryResponse_State_forNumber_int_) instead._
