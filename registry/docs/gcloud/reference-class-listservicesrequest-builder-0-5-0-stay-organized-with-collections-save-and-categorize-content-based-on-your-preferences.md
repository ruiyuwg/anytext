...
# Class ListServicesRequest.Builder (0.5.0) Stay organized with collections Save and categorize content based on your preferences.
...
[ListServicesRequestOrBuilder](/java/docs/reference/google-cloud-run/0.5.0/com.google.cloud.run.v2.ListServicesRequestOrBuilder)
...
[ListServicesRequest.Builder](/java/docs/reference/google-cloud-run/0.5.0/com.google.cloud.run.v2.ListServicesRequest.Builder)
...
[ListServicesRequest](/java/docs/reference/google-cloud-run/0.5.0/com.google.cloud.run.v2.ListServicesRequest)
...
```
public ListServicesRequest.Builder clearShowDeleted()
```
...
```
public ListServicesRequest.Builder setShowDeleted(boolean value)
```
