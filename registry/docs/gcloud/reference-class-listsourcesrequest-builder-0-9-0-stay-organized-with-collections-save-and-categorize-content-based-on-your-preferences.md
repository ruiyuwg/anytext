...
# Class ListSourcesRequest.Builder (0.9.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> ListSourcesRequest.Builder

## Implements

[ListSourcesRequestOrBuilder](/java/docs/reference/google-cloud-migrationcenter/0.9.0/com.google.cloud.migrationcenter.v1.ListSourcesRequestOrBuilder)
...
`[ListSourcesRequest.Builder](/java/docs/reference/google-cloud-migrationcenter/0.9.0/com.google.cloud.migrationcenter.v1.ListSourcesRequest.Builder)`
...
`[ListSourcesRequest](/java/docs/reference/google-cloud-migrationcenter/0.9.0/com.google.cloud.migrationcenter.v1.ListSourcesRequest)`
...
```
public ListSourcesRequest.Builder clearFilter()
```
...
```
public ListSourcesRequest.Builder clearOrderBy()
```

Field to sort by. See [https://google.aip.dev/132#ordering](https://google.aip.dev/132#ordering) for more details.
...
```
public ListSourcesRequest.Builder setFilter(String value)
```
...
```
public ListSourcesRequest.Builder setFilterBytes(ByteString value)
```
...
```
public ListSourcesRequest.Builder setOrderBy(String value)
```
...
```
public ListSourcesRequest.Builder setOrderByBytes(ByteString value)
```
