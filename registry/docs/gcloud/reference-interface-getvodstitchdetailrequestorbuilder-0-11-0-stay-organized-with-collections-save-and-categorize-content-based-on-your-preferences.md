...
# Interface GetVodStitchDetailRequestOrBuilder (0.11.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface GetVodStitchDetailRequestOrBuilder extends MessageOrBuilder
```
