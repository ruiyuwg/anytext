...
# Class PrivateCatalogGrpc.PrivateCatalogImplBase (0.15.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[SearchCatalogsRequest](/java/docs/reference/google-cloud-private-catalog/0.15.0/com.google.cloud.privatecatalog.v1beta1.SearchCatalogsRequest)`  

`responseObserver`

`io.grpc.stub.StreamObserver<[SearchCatalogsResponse](/java/docs/reference/google-cloud-private-catalog/0.15.0/com.google.cloud.privatecatalog.v1beta1.SearchCatalogsResponse)>`  
...
`[SearchProductsRequest](/java/docs/reference/google-cloud-private-catalog/0.15.0/com.google.cloud.privatecatalog.v1beta1.SearchProductsRequest)`  

`responseObserver`

`io.grpc.stub.StreamObserver<[SearchProductsResponse](/java/docs/reference/google-cloud-private-catalog/0.15.0/com.google.cloud.privatecatalog.v1beta1.SearchProductsResponse)>`  
...
`[SearchVersionsRequest](/java/docs/reference/google-cloud-private-catalog/0.15.0/com.google.cloud.privatecatalog.v1beta1.SearchVersionsRequest)`  

`responseObserver`

`io.grpc.stub.StreamObserver<[SearchVersionsResponse](/java/docs/reference/google-cloud-private-catalog/0.15.0/com.google.cloud.privatecatalog.v1beta1.SearchVersionsResponse)>`  
