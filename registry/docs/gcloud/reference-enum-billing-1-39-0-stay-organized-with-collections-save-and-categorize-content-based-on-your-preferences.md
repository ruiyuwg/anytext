...
# Enum Billing (1.39.0) Stay organized with collections Save and categorize content based on your preferences.
...
Protobuf enum `google.cloud.gkehub.multiclusteringress.v1beta.Billing`
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-gkehub/1.39.0/com.google.cloud.gkehub.multiclusteringress.v1beta.Billing#com_google_cloud_gkehub_multiclusteringress_v1beta_Billing_forNumber_int_) instead._
