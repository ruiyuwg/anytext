...
# Enum ScanConfig.UserAgent (2.35.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum ScanConfig.UserAgent extends Enum<ScanConfig.UserAgent> implements ProtocolMessageEnum
```
...
The user agent is unknown. Service will default to CHROME\_LINUX.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-websecurityscanner/2.35.0/com.google.cloud.websecurityscanner.v1.ScanConfig.UserAgent#com_google_cloud_websecurityscanner_v1_ScanConfig_UserAgent_forNumber_int_) instead._
