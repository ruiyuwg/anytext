...
# Class BatchUpdateJobsResponse (2.58.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class BatchUpdateJobsResponse extends GeneratedMessageV3 implements BatchUpdateJobsResponseOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> BatchUpdateJobsResponse

## Implements

[BatchUpdateJobsResponseOrBuilder](/java/docs/reference/google-cloud-talent/2.58.0/com.google.cloud.talent.v4.BatchUpdateJobsResponseOrBuilder)
...
```
public static BatchUpdateJobsResponse getDefaultInstance()
```
...
`[BatchUpdateJobsResponse](/java/docs/reference/google-cloud-talent/2.58.0/com.google.cloud.talent.v4.BatchUpdateJobsResponse)`
...
```
public static BatchUpdateJobsResponse.Builder newBuilder()
```
...
`[BatchUpdateJobsResponse.Builder](/java/docs/reference/google-cloud-talent/2.58.0/com.google.cloud.talent.v4.BatchUpdateJobsResponse.Builder)`

### newBuilder(BatchUpdateJobsResponse prototype)

```
public static BatchUpdateJobsResponse.Builder newBuilder(BatchUpdateJobsResponse prototype)
```
...
```
public static BatchUpdateJobsResponse parseDelimitedFrom(InputStream input)
```
...
```
public static BatchUpdateJobsResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static BatchUpdateJobsResponse parseFrom(byte[] data)
```
...
```
public static BatchUpdateJobsResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static BatchUpdateJobsResponse parseFrom(ByteString data)
```
...
```
public static BatchUpdateJobsResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static BatchUpdateJobsResponse parseFrom(CodedInputStream input)
```
...
```
public static BatchUpdateJobsResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static BatchUpdateJobsResponse parseFrom(InputStream input)
```
...
```
public static BatchUpdateJobsResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static BatchUpdateJobsResponse parseFrom(ByteBuffer data)
```
...
```
public static BatchUpdateJobsResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<BatchUpdateJobsResponse> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[BatchUpdateJobsResponse](/java/docs/reference/google-cloud-talent/2.58.0/com.google.cloud.talent.v4.BatchUpdateJobsResponse)>`
...
`[JobResult](/java/docs/reference/google-cloud-talent/2.58.0/com.google.cloud.talent.v4.JobResult)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[JobResult](/java/docs/reference/google-cloud-talent/2.58.0/com.google.cloud.talent.v4.JobResult)>`
...
`[JobResultOrBuilder](/java/docs/reference/google-cloud-talent/2.58.0/com.google.cloud.talent.v4.JobResultOrBuilder)`
...
```
public Parser<BatchUpdateJobsResponse> getParserForType()
```
...
```
public BatchUpdateJobsResponse.Builder newBuilderForType()
```
...
```
protected BatchUpdateJobsResponse.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public BatchUpdateJobsResponse.Builder toBuilder()
```
