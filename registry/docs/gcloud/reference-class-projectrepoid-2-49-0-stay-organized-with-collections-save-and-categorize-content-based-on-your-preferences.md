...
# Class ProjectRepoId (2.49.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[ProjectRepoId](/java/docs/reference/grafeas/2.49.0/io.grafeas.v1.ProjectRepoId)`
...
`[ProjectRepoId.Builder](/java/docs/reference/grafeas/2.49.0/io.grafeas.v1.ProjectRepoId.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ProjectRepoId](/java/docs/reference/grafeas/2.49.0/io.grafeas.v1.ProjectRepoId)>`
