...
# Class GetNamespacedTagValueRequest (1.39.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class GetNamespacedTagValueRequest extends GeneratedMessageV3 implements GetNamespacedTagValueRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> GetNamespacedTagValueRequest

## Implements

[GetNamespacedTagValueRequestOrBuilder](/java/docs/reference/google-cloud-resourcemanager/1.39.0/com.google.cloud.resourcemanager.v3.GetNamespacedTagValueRequestOrBuilder)
...
```
public static GetNamespacedTagValueRequest getDefaultInstance()
```
...
`[GetNamespacedTagValueRequest](/java/docs/reference/google-cloud-resourcemanager/1.39.0/com.google.cloud.resourcemanager.v3.GetNamespacedTagValueRequest)`
...
```
public static GetNamespacedTagValueRequest.Builder newBuilder()
```
...
`[GetNamespacedTagValueRequest.Builder](/java/docs/reference/google-cloud-resourcemanager/1.39.0/com.google.cloud.resourcemanager.v3.GetNamespacedTagValueRequest.Builder)`

### newBuilder(GetNamespacedTagValueRequest prototype)

```
public static GetNamespacedTagValueRequest.Builder newBuilder(GetNamespacedTagValueRequest prototype)
```
...
```
public static GetNamespacedTagValueRequest parseDelimitedFrom(InputStream input)
```
...
```
public static GetNamespacedTagValueRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetNamespacedTagValueRequest parseFrom(byte[] data)
```
...
```
public static GetNamespacedTagValueRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetNamespacedTagValueRequest parseFrom(ByteString data)
```
...
```
public static GetNamespacedTagValueRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetNamespacedTagValueRequest parseFrom(CodedInputStream input)
```
...
```
public static GetNamespacedTagValueRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetNamespacedTagValueRequest parseFrom(InputStream input)
```
...
```
public static GetNamespacedTagValueRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetNamespacedTagValueRequest parseFrom(ByteBuffer data)
```
...
```
public static GetNamespacedTagValueRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<GetNamespacedTagValueRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[GetNamespacedTagValueRequest](/java/docs/reference/google-cloud-resourcemanager/1.39.0/com.google.cloud.resourcemanager.v3.GetNamespacedTagValueRequest)>`
...
```
public GetNamespacedTagValueRequest getDefaultInstanceForType()
```
...
```
public Parser<GetNamespacedTagValueRequest> getParserForType()
```
...
```
public GetNamespacedTagValueRequest.Builder newBuilderForType()
```
...
```
protected GetNamespacedTagValueRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public GetNamespacedTagValueRequest.Builder toBuilder()
```
