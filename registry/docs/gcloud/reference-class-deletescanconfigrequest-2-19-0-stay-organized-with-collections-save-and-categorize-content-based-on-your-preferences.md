...
# Class DeleteScanConfigRequest (2.19.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class DeleteScanConfigRequest extends GeneratedMessageV3 implements DeleteScanConfigRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> DeleteScanConfigRequest

## Implements

[DeleteScanConfigRequestOrBuilder](/java/docs/reference/google-cloud-websecurityscanner/2.19.0/com.google.cloud.websecurityscanner.v1.DeleteScanConfigRequestOrBuilder)
...
```
public static DeleteScanConfigRequest getDefaultInstance()
```
...
```
public static DeleteScanConfigRequest.Builder newBuilder()
```
...
`[DeleteScanConfigRequest.Builder](/java/docs/reference/google-cloud-websecurityscanner/2.19.0/com.google.cloud.websecurityscanner.v1.DeleteScanConfigRequest.Builder)`

### newBuilder(DeleteScanConfigRequest prototype)

```
public static DeleteScanConfigRequest.Builder newBuilder(DeleteScanConfigRequest prototype)
```
...
```
public static DeleteScanConfigRequest parseDelimitedFrom(InputStream input)
```
...
```
public static DeleteScanConfigRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteScanConfigRequest parseFrom(byte[] data)
```
...
```
public static DeleteScanConfigRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteScanConfigRequest parseFrom(ByteString data)
```
...
```
public static DeleteScanConfigRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteScanConfigRequest parseFrom(CodedInputStream input)
```
...
```
public static DeleteScanConfigRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteScanConfigRequest parseFrom(InputStream input)
```
...
```
public static DeleteScanConfigRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteScanConfigRequest parseFrom(ByteBuffer data)
```
...
```
public static DeleteScanConfigRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<DeleteScanConfigRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[DeleteScanConfigRequest](/java/docs/reference/google-cloud-websecurityscanner/2.19.0/com.google.cloud.websecurityscanner.v1.DeleteScanConfigRequest)>`
...
```
public DeleteScanConfigRequest getDefaultInstanceForType()
```
...
```
public Parser<DeleteScanConfigRequest> getParserForType()
```
...
```
public DeleteScanConfigRequest.Builder newBuilderForType()
```
...
```
protected DeleteScanConfigRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public DeleteScanConfigRequest.Builder toBuilder()
```
