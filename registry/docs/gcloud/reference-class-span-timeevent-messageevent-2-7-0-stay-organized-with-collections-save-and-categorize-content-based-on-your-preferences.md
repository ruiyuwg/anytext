...
# Class Span.TimeEvent.MessageEvent (2.7.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> Span.TimeEvent.MessageEvent

## Implements

[Span.TimeEvent.MessageEventOrBuilder](/java/docs/reference/google-cloud-trace/2.7.0/com.google.devtools.cloudtrace.v2.Span.TimeEvent.MessageEventOrBuilder)
...
### COMPRESSED\_SIZE\_BYTES\_FIELD\_NUMBER
...
### UNCOMPRESSED\_SIZE\_BYTES\_FIELD\_NUMBER
...
[Span.TimeEvent.MessageEvent](/java/docs/reference/google-cloud-trace/2.7.0/com.google.devtools.cloudtrace.v2.Span.TimeEvent.MessageEvent)
...
[Span.TimeEvent.MessageEvent.Builder](/java/docs/reference/google-cloud-trace/2.7.0/com.google.devtools.cloudtrace.v2.Span.TimeEvent.MessageEvent.Builder)

### newBuilder(Span.TimeEvent.MessageEvent prototype)
...
```
public static Span.TimeEvent.MessageEvent parseDelimitedFrom(InputStream input)
```
...
```
public static Span.TimeEvent.MessageEvent parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Span.TimeEvent.MessageEvent parseFrom(byte[] data)
```
...
```
public static Span.TimeEvent.MessageEvent parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Span.TimeEvent.MessageEvent parseFrom(ByteString data)
```
...
```
public static Span.TimeEvent.MessageEvent parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Span.TimeEvent.MessageEvent parseFrom(CodedInputStream input)
```
...
```
public static Span.TimeEvent.MessageEvent parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Span.TimeEvent.MessageEvent parseFrom(InputStream input)
```
...
```
public static Span.TimeEvent.MessageEvent parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Span.TimeEvent.MessageEvent parseFrom(ByteBuffer data)
```
...
```
public static Span.TimeEvent.MessageEvent parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[MessageEvent](/java/docs/reference/google-cloud-trace/2.7.0/com.google.devtools.cloudtrace.v2.Span.TimeEvent.MessageEvent)\>
...
[Span.TimeEvent.MessageEvent.Type](/java/docs/reference/google-cloud-trace/2.7.0/com.google.devtools.cloudtrace.v2.Span.TimeEvent.MessageEvent.Type)
