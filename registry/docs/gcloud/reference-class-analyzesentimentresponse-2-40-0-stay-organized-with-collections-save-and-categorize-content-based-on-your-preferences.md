...
# Class AnalyzeSentimentResponse (2.40.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> AnalyzeSentimentResponse

## Implements

[AnalyzeSentimentResponseOrBuilder](/java/docs/reference/google-cloud-language/2.40.0/com.google.cloud.language.v1beta2.AnalyzeSentimentResponseOrBuilder)
...
### DOCUMENT\_SENTIMENT\_FIELD\_NUMBER
...
`[AnalyzeSentimentResponse](/java/docs/reference/google-cloud-language/2.40.0/com.google.cloud.language.v1beta2.AnalyzeSentimentResponse)`
...
`[AnalyzeSentimentResponse.Builder](/java/docs/reference/google-cloud-language/2.40.0/com.google.cloud.language.v1beta2.AnalyzeSentimentResponse.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[AnalyzeSentimentResponse](/java/docs/reference/google-cloud-language/2.40.0/com.google.cloud.language.v1beta2.AnalyzeSentimentResponse)>`
...
`[Sentiment](/java/docs/reference/google-cloud-language/2.40.0/com.google.cloud.language.v1beta2.Sentiment)`
...
`[SentimentOrBuilder](/java/docs/reference/google-cloud-language/2.40.0/com.google.cloud.language.v1beta2.SentimentOrBuilder)`
...
`[Sentence](/java/docs/reference/google-cloud-language/2.40.0/com.google.cloud.language.v1beta2.Sentence)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Sentence](/java/docs/reference/google-cloud-language/2.40.0/com.google.cloud.language.v1beta2.Sentence)>`
...
`[SentenceOrBuilder](/java/docs/reference/google-cloud-language/2.40.0/com.google.cloud.language.v1beta2.SentenceOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.language.v1beta2.SentenceOrBuilder>`
