...
# google-cloud-video-intelligence overview (2.86.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Cloud Video Intelligence Description:** Allows developers to use Google video analysis technology as part of their applications.

[Cloud Video Intelligence Product Reference](https://cloud.google.com/video-intelligence/docs/)

[GitHub Repository](https://github.com/googleapis/google-cloud-java/tree/main/java-video-intelligence)

[Maven artifact](https://central.sonatype.com/artifact/com.google.cloud/google-cloud-video-intelligence)
...
-   [Enable the API](https://console.cloud.google.com/apis/library/videointelligence.googleapis.com)
-   [Set up authentication](https://cloud.google.com/docs/authentication/client-libraries)

## Use the Cloud Video Intelligence for Java
...
The example below demonstrates how you would import the BOM and include the `google-cloud-video-intelligence` artifact.
...
libraryDependencies += "com.google.cloud" % "google-cloud-video-intelligence" % "2.86.0"

## Which version ID should I get started with?

For this library, we recommend using [com.google.cloud.videointelligence.v1](https://cloud.google.com/java/docs/reference/google-cloud-video-intelligence/2.86.0/com.google.cloud.videointelligence.v1) for new applications.
