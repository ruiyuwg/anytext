...
# Class SearchRequest.BoostSpec.Builder (2.31.0) Stay organized with collections Save and categorize content based on your preferences.
...
[SearchRequest.BoostSpecOrBuilder](/java/docs/reference/google-cloud-retail/2.31.0/com.google.cloud.retail.v2.SearchRequest.BoostSpecOrBuilder)
...
`[SearchRequest.BoostSpec.Builder](/java/docs/reference/google-cloud-retail/2.31.0/com.google.cloud.retail.v2.SearchRequest.BoostSpec.Builder)`
...
`[SearchRequest.BoostSpec.ConditionBoostSpec](/java/docs/reference/google-cloud-retail/2.31.0/com.google.cloud.retail.v2.SearchRequest.BoostSpec.ConditionBoostSpec)`  
...
`[SearchRequest.BoostSpec.ConditionBoostSpec.Builder](/java/docs/reference/google-cloud-retail/2.31.0/com.google.cloud.retail.v2.SearchRequest.BoostSpec.ConditionBoostSpec.Builder)`  
...
`[SearchRequest.BoostSpec](/java/docs/reference/google-cloud-retail/2.31.0/com.google.cloud.retail.v2.SearchRequest.BoostSpec)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Builder](/java/docs/reference/google-cloud-retail/2.31.0/com.google.cloud.retail.v2.SearchRequest.BoostSpec.ConditionBoostSpec.Builder)>`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ConditionBoostSpec](/java/docs/reference/google-cloud-retail/2.31.0/com.google.cloud.retail.v2.SearchRequest.BoostSpec.ConditionBoostSpec)>`
...
`[SearchRequest.BoostSpec.ConditionBoostSpecOrBuilder](/java/docs/reference/google-cloud-retail/2.31.0/com.google.cloud.retail.v2.SearchRequest.BoostSpec.ConditionBoostSpecOrBuilder)`
