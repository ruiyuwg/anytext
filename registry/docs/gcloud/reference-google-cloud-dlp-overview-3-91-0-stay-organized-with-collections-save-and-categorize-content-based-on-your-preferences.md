...
# google-cloud-dlp overview (3.91.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Cloud Data Loss Prevention Description:** Provides programmatic access to a powerful detection engine for personally identifiable information and other privacy-sensitive data in unstructured data streams, like text blocks and images.

[Cloud Data Loss Prevention Product Reference](https://cloud.google.com/dlp/docs/)

[GitHub Repository](https://github.com/googleapis/google-cloud-java/tree/main/java-dlp)

[Maven artifact](https://central.sonatype.com/artifact/com.google.cloud/google-cloud-dlp)
...
-   [Enable the API](https://console.cloud.google.com/apis/library/dlp.googleapis.com)
-   [Set up authentication](https://cloud.google.com/docs/authentication/client-libraries)

## Use the Cloud Data Loss Prevention for Java
...
The example below demonstrates how you would import the BOM and include the `google-cloud-dlp` artifact.
...
libraryDependencies += "com.google.cloud" % "google-cloud-dlp" % "3.91.0"

## Which version ID should I get started with?

For this library, we recommend using [com.google.privacy.dlp.v2](https://cloud.google.com/java/docs/reference/google-cloud-dlp/3.91.0/com.google.privacy.dlp.v2) for new applications.
