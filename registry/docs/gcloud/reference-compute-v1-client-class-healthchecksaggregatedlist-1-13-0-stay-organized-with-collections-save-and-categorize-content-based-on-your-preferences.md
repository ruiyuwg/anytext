...
# Compute V1 Client - Class HealthChecksAggregatedList (1.13.0) Stay organized with collections Save and categorize content based on your preferences.
...
Reference documentation and code samples for the Compute V1 Client class HealthChecksAggregatedList.

Generated from protobuf message `google.cloud.compute.v1.HealthChecksAggregatedList`
...
`[Google\Cloud\Compute\V1\Warning](/php/docs/reference/cloud-compute/1.13.0/V1.Warning)`  
...
`[Google\Cloud\Compute\V1\Warning](/php/docs/reference/cloud-compute/1.13.0/V1.Warning)|null`
