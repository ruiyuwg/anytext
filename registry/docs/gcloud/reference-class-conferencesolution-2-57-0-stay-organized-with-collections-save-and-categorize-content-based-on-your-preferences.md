...
# Class ConferenceSolution (2.57.0) Stay organized with collections Save and categorize content based on your preferences.
...
[ConferenceSolutionOrBuilder](/java/docs/reference/google-cloud-gsuite-addons/2.57.0/com.google.apps.script.type.calendar.ConferenceSolutionOrBuilder)
...
`[ConferenceSolution](/java/docs/reference/google-cloud-gsuite-addons/2.57.0/com.google.apps.script.type.calendar.ConferenceSolution)`
...
`[ConferenceSolution.Builder](/java/docs/reference/google-cloud-gsuite-addons/2.57.0/com.google.apps.script.type.calendar.ConferenceSolution.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ConferenceSolution](/java/docs/reference/google-cloud-gsuite-addons/2.57.0/com.google.apps.script.type.calendar.ConferenceSolution)>`
