...
# Class Sentiment (2.34.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[Sentiment](/java/docs/reference/google-cloud-language/2.34.0/com.google.cloud.language.v1.Sentiment)`
...
`[Sentiment.Builder](/java/docs/reference/google-cloud-language/2.34.0/com.google.cloud.language.v1.Sentiment.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[Sentiment](/java/docs/reference/google-cloud-language/2.34.0/com.google.cloud.language.v1.Sentiment)>`
