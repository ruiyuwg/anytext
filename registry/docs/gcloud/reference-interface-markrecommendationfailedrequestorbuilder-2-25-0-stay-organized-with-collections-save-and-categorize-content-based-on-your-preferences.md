...
# Interface MarkRecommendationFailedRequestOrBuilder (2.25.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface MarkRecommendationFailedRequestOrBuilder extends MessageOrBuilder
```
...
Use [#getStateMetadataMap()](/java/docs/reference/google-cloud-recommender/2.25.0/com.google.cloud.recommender.v1beta1.MarkRecommendationFailedRequestOrBuilder#com_google_cloud_recommender_v1beta1_MarkRecommendationFailedRequestOrBuilder_getStateMetadataMap__) instead.
