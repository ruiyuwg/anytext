...
# Class ImageAnnotatorGrpc.ImageAnnotatorFutureStub (3.42.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[BatchAnnotateImagesRequest](/java/docs/reference/google-cloud-vision/3.42.0/com.google.cloud.vision.v1p1beta1.BatchAnnotateImagesRequest)`  
...
`com.google.common.util.concurrent.ListenableFuture<[BatchAnnotateImagesResponse](/java/docs/reference/google-cloud-vision/3.42.0/com.google.cloud.vision.v1p1beta1.BatchAnnotateImagesResponse)>`
...
`[ImageAnnotatorGrpc.ImageAnnotatorFutureStub](/java/docs/reference/google-cloud-vision/3.42.0/com.google.cloud.vision.v1p1beta1.ImageAnnotatorGrpc.ImageAnnotatorFutureStub)`
