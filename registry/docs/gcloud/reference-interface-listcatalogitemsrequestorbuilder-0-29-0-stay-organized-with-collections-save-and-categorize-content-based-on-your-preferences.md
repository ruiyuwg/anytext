...
# Interface ListCatalogItemsRequestOrBuilder (0.29.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface ListCatalogItemsRequestOrBuilder extends MessageOrBuilder
```
...
Optional. The previous ListCatalogItemsResponse.next\_page\_token.
