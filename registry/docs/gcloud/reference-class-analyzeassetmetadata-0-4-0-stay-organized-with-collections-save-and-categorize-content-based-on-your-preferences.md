...
# Class AnalyzeAssetMetadata (0.4.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class AnalyzeAssetMetadata extends GeneratedMessageV3 implements AnalyzeAssetMetadataOrBuilder
```

Metadata for AnalyzeAsset.

Protobuf type `google.cloud.visionai.v1.AnalyzeAssetMetadata`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> AnalyzeAssetMetadata

## Implements

[AnalyzeAssetMetadataOrBuilder](/java/docs/reference/google-cloud-visionai/0.4.0/com.google.cloud.visionai.v1.AnalyzeAssetMetadataOrBuilder)
...
### ANALYSIS\_STATUS\_FIELD\_NUMBER
...
```
public static AnalyzeAssetMetadata getDefaultInstance()
```
...
`[AnalyzeAssetMetadata](/java/docs/reference/google-cloud-visionai/0.4.0/com.google.cloud.visionai.v1.AnalyzeAssetMetadata)`
...
```
public static AnalyzeAssetMetadata.Builder newBuilder()
```
...
`[AnalyzeAssetMetadata.Builder](/java/docs/reference/google-cloud-visionai/0.4.0/com.google.cloud.visionai.v1.AnalyzeAssetMetadata.Builder)`

### newBuilder(AnalyzeAssetMetadata prototype)

```
public static AnalyzeAssetMetadata.Builder newBuilder(AnalyzeAssetMetadata prototype)
```
...
```
public static AnalyzeAssetMetadata parseDelimitedFrom(InputStream input)
```
...
```
public static AnalyzeAssetMetadata parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AnalyzeAssetMetadata parseFrom(byte[] data)
```
...
```
public static AnalyzeAssetMetadata parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AnalyzeAssetMetadata parseFrom(ByteString data)
```
...
```
public static AnalyzeAssetMetadata parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AnalyzeAssetMetadata parseFrom(CodedInputStream input)
```
...
```
public static AnalyzeAssetMetadata parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AnalyzeAssetMetadata parseFrom(InputStream input)
```
...
```
public static AnalyzeAssetMetadata parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AnalyzeAssetMetadata parseFrom(ByteBuffer data)
```
...
```
public static AnalyzeAssetMetadata parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<AnalyzeAssetMetadata> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[AnalyzeAssetMetadata](/java/docs/reference/google-cloud-visionai/0.4.0/com.google.cloud.visionai.v1.AnalyzeAssetMetadata)>`
...
```
public AnalyzeAssetMetadata.AnalysisStatus getAnalysisStatus(int index)
```
...
`[AnalyzeAssetMetadata.AnalysisStatus](/java/docs/reference/google-cloud-visionai/0.4.0/com.google.cloud.visionai.v1.AnalyzeAssetMetadata.AnalysisStatus)`
...
```
public List<AnalyzeAssetMetadata.AnalysisStatus> getAnalysisStatusList()
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[AnalysisStatus](/java/docs/reference/google-cloud-visionai/0.4.0/com.google.cloud.visionai.v1.AnalyzeAssetMetadata.AnalysisStatus)>`

### getAnalysisStatusOrBuilder(int index)

```
public AnalyzeAssetMetadata.AnalysisStatusOrBuilder getAnalysisStatusOrBuilder(int index)
```
...
`[AnalyzeAssetMetadata.AnalysisStatusOrBuilder](/java/docs/reference/google-cloud-visionai/0.4.0/com.google.cloud.visionai.v1.AnalyzeAssetMetadata.AnalysisStatusOrBuilder)`

### getAnalysisStatusOrBuilderList()

```
public List<? extends AnalyzeAssetMetadata.AnalysisStatusOrBuilder> getAnalysisStatusOrBuilderList()
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.visionai.v1.AnalyzeAssetMetadata.AnalysisStatusOrBuilder>`

### getDefaultInstanceForType()

```
public AnalyzeAssetMetadata getDefaultInstanceForType()
```
...
```
public Parser<AnalyzeAssetMetadata> getParserForType()
```
...
```
public AnalyzeAssetMetadata.Builder newBuilderForType()
```
...
```
protected AnalyzeAssetMetadata.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public AnalyzeAssetMetadata.Builder toBuilder()
```
