...
# Enum Entity.Type (2.49.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-language/2.49.0/com.google.cloud.language.v1beta2.Entity.Type#com_google_cloud_language_v1beta2_Entity_Type_forNumber_int_) instead._
