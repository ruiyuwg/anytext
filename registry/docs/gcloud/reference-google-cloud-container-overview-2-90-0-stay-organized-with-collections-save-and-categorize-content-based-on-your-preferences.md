...
# google-cloud-container overview (2.90.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Kubernetes Engine Description:** Is an enterprise-grade platform for containerized applications, including stateful and stateless, AI and ML, Linux and Windows, complex and simple web apps, API, and backend services. Leverage industry-first features like four-way auto-scaling and no-stress management. Optimize GPU and TPU provisioning, use integrated developer tools, and get multi-cluster support from SREs.

[Kubernetes Engine Product Reference](https://cloud.google.com/kubernetes-engine/)

[GitHub Repository](https://github.com/googleapis/google-cloud-java/tree/main/java-container)

[Maven artifact](https://central.sonatype.com/artifact/com.google.cloud/google-cloud-container)
...
-   [Enable the API](https://console.cloud.google.com/apis/library/container.googleapis.com)
-   [Set up authentication](https://cloud.google.com/docs/authentication/client-libraries)

## Use the Kubernetes Engine for Java
...
The example below demonstrates how you would import the BOM and include the `google-cloud-container` artifact.
...
libraryDependencies += "com.google.cloud" % "google-cloud-container" % "2.90.0"

## Which version ID should I get started with?

For this library, we recommend using [com.google.container.v1](https://cloud.google.com/java/docs/reference/google-cloud-container/2.90.0/com.google.container.v1) for new applications.
