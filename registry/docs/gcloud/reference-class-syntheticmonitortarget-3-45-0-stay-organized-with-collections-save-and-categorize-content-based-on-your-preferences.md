...
# Class SyntheticMonitorTarget (3.45.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class SyntheticMonitorTarget extends GeneratedMessageV3 implements SyntheticMonitorTargetOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> SyntheticMonitorTarget

## Implements

[SyntheticMonitorTargetOrBuilder](/java/docs/reference/google-cloud-monitoring/3.45.0/com.google.monitoring.v3.SyntheticMonitorTargetOrBuilder)
...
### CLOUD\_FUNCTION\_V2\_FIELD\_NUMBER

```
public static final int CLOUD_FUNCTION_V2_FIELD_NUMBER
```
...
```
public static SyntheticMonitorTarget getDefaultInstance()
```
...
`[SyntheticMonitorTarget](/java/docs/reference/google-cloud-monitoring/3.45.0/com.google.monitoring.v3.SyntheticMonitorTarget)`
...
```
public static SyntheticMonitorTarget.Builder newBuilder()
```
...
`[SyntheticMonitorTarget.Builder](/java/docs/reference/google-cloud-monitoring/3.45.0/com.google.monitoring.v3.SyntheticMonitorTarget.Builder)`

### newBuilder(SyntheticMonitorTarget prototype)

```
public static SyntheticMonitorTarget.Builder newBuilder(SyntheticMonitorTarget prototype)
```
...
```
public static SyntheticMonitorTarget parseDelimitedFrom(InputStream input)
```
...
```
public static SyntheticMonitorTarget parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SyntheticMonitorTarget parseFrom(byte[] data)
```
...
```
public static SyntheticMonitorTarget parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SyntheticMonitorTarget parseFrom(ByteString data)
```
...
```
public static SyntheticMonitorTarget parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SyntheticMonitorTarget parseFrom(CodedInputStream input)
```
...
```
public static SyntheticMonitorTarget parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SyntheticMonitorTarget parseFrom(InputStream input)
```
...
```
public static SyntheticMonitorTarget parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SyntheticMonitorTarget parseFrom(ByteBuffer data)
```
...
```
public static SyntheticMonitorTarget parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<SyntheticMonitorTarget> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[SyntheticMonitorTarget](/java/docs/reference/google-cloud-monitoring/3.45.0/com.google.monitoring.v3.SyntheticMonitorTarget)>`
...
`[SyntheticMonitorTarget.CloudFunctionV2Target](/java/docs/reference/google-cloud-monitoring/3.45.0/com.google.monitoring.v3.SyntheticMonitorTarget.CloudFunctionV2Target)`
...
`[SyntheticMonitorTarget.CloudFunctionV2TargetOrBuilder](/java/docs/reference/google-cloud-monitoring/3.45.0/com.google.monitoring.v3.SyntheticMonitorTarget.CloudFunctionV2TargetOrBuilder)`
...
```
public Parser<SyntheticMonitorTarget> getParserForType()
```
...
`[SyntheticMonitorTarget.TargetCase](/java/docs/reference/google-cloud-monitoring/3.45.0/com.google.monitoring.v3.SyntheticMonitorTarget.TargetCase)`
...
```
public SyntheticMonitorTarget.Builder newBuilderForType()
```
...
```
protected SyntheticMonitorTarget.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public SyntheticMonitorTarget.Builder toBuilder()
```
