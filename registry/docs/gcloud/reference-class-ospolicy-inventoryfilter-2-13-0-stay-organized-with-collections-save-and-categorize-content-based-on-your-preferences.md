...
# Class OSPolicy.InventoryFilter (2.13.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class OSPolicy.InventoryFilter extends GeneratedMessageV3 implements OSPolicy.InventoryFilterOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> OSPolicy.InventoryFilter

## Implements

[OSPolicy.InventoryFilterOrBuilder](/java/docs/reference/google-cloud-os-config/2.13.0/com.google.cloud.osconfig.v1.OSPolicy.InventoryFilterOrBuilder)
...
### OS\_SHORT\_NAME\_FIELD\_NUMBER
...
```
public static OSPolicy.InventoryFilter getDefaultInstance()
```
...
`[OSPolicy.InventoryFilter](/java/docs/reference/google-cloud-os-config/2.13.0/com.google.cloud.osconfig.v1.OSPolicy.InventoryFilter)`
...
```
public static OSPolicy.InventoryFilter.Builder newBuilder()
```
...
`[OSPolicy.InventoryFilter.Builder](/java/docs/reference/google-cloud-os-config/2.13.0/com.google.cloud.osconfig.v1.OSPolicy.InventoryFilter.Builder)`

### newBuilder(OSPolicy.InventoryFilter prototype)

```
public static OSPolicy.InventoryFilter.Builder newBuilder(OSPolicy.InventoryFilter prototype)
```
...
```
public static OSPolicy.InventoryFilter parseDelimitedFrom(InputStream input)
```
...
```
public static OSPolicy.InventoryFilter parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static OSPolicy.InventoryFilter parseFrom(byte[] data)
```
...
```
public static OSPolicy.InventoryFilter parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static OSPolicy.InventoryFilter parseFrom(ByteString data)
```
...
```
public static OSPolicy.InventoryFilter parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static OSPolicy.InventoryFilter parseFrom(CodedInputStream input)
```
...
```
public static OSPolicy.InventoryFilter parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static OSPolicy.InventoryFilter parseFrom(InputStream input)
```
...
```
public static OSPolicy.InventoryFilter parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static OSPolicy.InventoryFilter parseFrom(ByteBuffer data)
```
...
```
public static OSPolicy.InventoryFilter parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<OSPolicy.InventoryFilter> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[InventoryFilter](/java/docs/reference/google-cloud-os-config/2.13.0/com.google.cloud.osconfig.v1.OSPolicy.InventoryFilter)>`
...
The OS version Prefix matches are supported if asterisk(_) is provided as the last character. For example, to match all versions with a major version of `7`, specify the following value for this field `7.`_ An empty string matches all OS versions.
...
```
public Parser<OSPolicy.InventoryFilter> getParserForType()
```
...
```
public OSPolicy.InventoryFilter.Builder newBuilderForType()
```
...
```
protected OSPolicy.InventoryFilter.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public OSPolicy.InventoryFilter.Builder toBuilder()
```
