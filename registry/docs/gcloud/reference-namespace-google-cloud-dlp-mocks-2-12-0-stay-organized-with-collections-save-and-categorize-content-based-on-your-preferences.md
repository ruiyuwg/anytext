...
# Namespace google::cloud::dlp\_mocks (2.12.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated:** This namespace is deprecated, prefer the types defined in [`dlp_v2_mocks`](/cpp/docs/reference/dlp/2.12.0/namespacegoogle_1_1cloud_1_1dlp__v2__mocks).
