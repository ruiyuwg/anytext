...
# Enum Control.ActionCase (0.83.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum Control.ActionCase extends Enum<Control.ActionCase> implements Internal.EnumLite, AbstractMessageLite.InternalOneOfEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-discoveryengine/latest/com.google.cloud.discoveryengine.v1beta.Control.ActionCase#com_google_cloud_discoveryengine_v1beta_Control_ActionCase_forNumber_int_) instead._
