...
# Interface LocalDisk.RuntimeGuestOsFeatureOrBuilder (1.45.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static interface LocalDisk.RuntimeGuestOsFeatureOrBuilder extends MessageOrBuilder
```
