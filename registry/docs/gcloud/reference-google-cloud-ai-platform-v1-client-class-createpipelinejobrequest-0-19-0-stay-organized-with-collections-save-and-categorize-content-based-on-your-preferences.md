...
# Google Cloud Ai Platform V1 Client - Class CreatePipelineJobRequest (0.19.0) Stay organized with collections Save and categorize content based on your preferences.
...
Request message for [PipelineService.CreatePipelineJob](/php/docs/reference/cloud-ai-platform/0.19.0/V1.PipelineServiceClient#_Google_Cloud_AIPlatform_V1_PipelineServiceClient__createPipelineJob__).
...
`[Google\Cloud\AIPlatform\V1\PipelineJob](/php/docs/reference/cloud-ai-platform/0.19.0/V1.PipelineJob)`  
...
`[Google\Cloud\AIPlatform\V1\PipelineJob](/php/docs/reference/cloud-ai-platform/0.19.0/V1.PipelineJob)|null`
...
Required. The resource name of the Location to create the PipelineJob in. Format: `projects/{project}/locations/{location}` Please see [Google\\Cloud\\AIPlatform\\V1\\PipelineServiceClient::locationName()](/php/docs/reference/cloud-ai-platform/0.19.0/V1.PipelineServiceClient#_Google_Cloud_AIPlatform_V1_PipelineServiceClient__locationName__) for help formatting this field.
...
`[Google\Cloud\AIPlatform\V1\CreatePipelineJobRequest](/php/docs/reference/cloud-ai-platform/0.19.0/V1.CreatePipelineJobRequest)`
