...
# Interface GetReferenceImageRequestOrBuilder (3.51.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface GetReferenceImageRequestOrBuilder extends MessageOrBuilder
```
