...
# Interface MacSignRequestOrBuilder (2.9.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface MacSignRequestOrBuilder extends MessageOrBuilder
```
...
```
public abstract Int64Value getDataCrc32C()
```
...
```
public abstract Int64ValueOrBuilder getDataCrc32COrBuilder()
```
