...
# Class DetectedLandmark (2.16.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class DetectedLandmark extends GeneratedMessageV3 implements DetectedLandmarkOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> DetectedLandmark

## Implements

[DetectedLandmarkOrBuilder](/java/docs/reference/google-cloud-video-intelligence/2.16.0/com.google.cloud.videointelligence.v1.DetectedLandmarkOrBuilder)
...
```
public static DetectedLandmark getDefaultInstance()
```
...
`[DetectedLandmark](/java/docs/reference/google-cloud-video-intelligence/2.16.0/com.google.cloud.videointelligence.v1.DetectedLandmark)`
...
```
public static DetectedLandmark.Builder newBuilder()
```
...
`[DetectedLandmark.Builder](/java/docs/reference/google-cloud-video-intelligence/2.16.0/com.google.cloud.videointelligence.v1.DetectedLandmark.Builder)`

### newBuilder(DetectedLandmark prototype)

```
public static DetectedLandmark.Builder newBuilder(DetectedLandmark prototype)
```
...
```
public static DetectedLandmark parseDelimitedFrom(InputStream input)
```
...
```
public static DetectedLandmark parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DetectedLandmark parseFrom(byte[] data)
```
...
```
public static DetectedLandmark parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DetectedLandmark parseFrom(ByteString data)
```
...
```
public static DetectedLandmark parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DetectedLandmark parseFrom(CodedInputStream input)
```
...
```
public static DetectedLandmark parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DetectedLandmark parseFrom(InputStream input)
```
...
```
public static DetectedLandmark parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DetectedLandmark parseFrom(ByteBuffer data)
```
...
```
public static DetectedLandmark parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<DetectedLandmark> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[DetectedLandmark](/java/docs/reference/google-cloud-video-intelligence/2.16.0/com.google.cloud.videointelligence.v1.DetectedLandmark)>`
...
The name of this landmark, for example, left\_hand, right\_shoulder.
...
```
public Parser<DetectedLandmark> getParserForType()
```
...
`[NormalizedVertex](/java/docs/reference/google-cloud-video-intelligence/2.16.0/com.google.cloud.videointelligence.v1.NormalizedVertex)`
...
`[NormalizedVertexOrBuilder](/java/docs/reference/google-cloud-video-intelligence/2.16.0/com.google.cloud.videointelligence.v1.NormalizedVertexOrBuilder)`
...
```
public DetectedLandmark.Builder newBuilderForType()
```
...
```
protected DetectedLandmark.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public DetectedLandmark.Builder toBuilder()
```
