...
# Class Service (2.47.0) Stay organized with collections Save and categorize content based on your preferences.
...
[ServiceOrBuilder](/java/docs/reference/google-cloud-service-usage/2.47.0/com.google.api.serviceusage.v1.ServiceOrBuilder)
...
`[Service](/java/docs/reference/google-cloud-service-usage/2.47.0/com.google.api.serviceusage.v1.Service)`
...
`[Service.Builder](/java/docs/reference/google-cloud-service-usage/2.47.0/com.google.api.serviceusage.v1.Service.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[Service](/java/docs/reference/google-cloud-service-usage/2.47.0/com.google.api.serviceusage.v1.Service)>`
...
`[ServiceConfig](/java/docs/reference/google-cloud-service-usage/2.47.0/com.google.api.serviceusage.v1.ServiceConfig)`
...
`[ServiceConfigOrBuilder](/java/docs/reference/google-cloud-service-usage/2.47.0/com.google.api.serviceusage.v1.ServiceConfigOrBuilder)`
...
`[State](/java/docs/reference/google-cloud-service-usage/2.47.0/com.google.api.serviceusage.v1.State)`
