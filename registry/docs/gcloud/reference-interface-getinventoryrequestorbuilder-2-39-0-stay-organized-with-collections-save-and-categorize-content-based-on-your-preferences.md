...
# Interface GetInventoryRequestOrBuilder (2.39.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[InventoryView](/java/docs/reference/google-cloud-os-config/2.39.0/com.google.cloud.osconfig.v1.InventoryView)`
