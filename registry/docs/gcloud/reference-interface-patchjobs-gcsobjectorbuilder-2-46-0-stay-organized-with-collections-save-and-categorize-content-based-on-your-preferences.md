...
# Interface PatchJobs.GcsObjectOrBuilder (2.46.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static interface PatchJobs.GcsObjectOrBuilder extends MessageOrBuilder
```
