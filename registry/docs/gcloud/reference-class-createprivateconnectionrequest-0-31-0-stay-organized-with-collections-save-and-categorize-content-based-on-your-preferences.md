...
# Class CreatePrivateConnectionRequest (0.31.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> CreatePrivateConnectionRequest

## Implements

[CreatePrivateConnectionRequestOrBuilder](/java/docs/reference/google-cloud-vmwareengine/0.31.0/com.google.cloud.vmwareengine.v1.CreatePrivateConnectionRequestOrBuilder)
...
### PRIVATE\_CONNECTION\_FIELD\_NUMBER
...
### PRIVATE\_CONNECTION\_ID\_FIELD\_NUMBER
...
`[CreatePrivateConnectionRequest](/java/docs/reference/google-cloud-vmwareengine/0.31.0/com.google.cloud.vmwareengine.v1.CreatePrivateConnectionRequest)`
...
`[CreatePrivateConnectionRequest.Builder](/java/docs/reference/google-cloud-vmwareengine/0.31.0/com.google.cloud.vmwareengine.v1.CreatePrivateConnectionRequest.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[CreatePrivateConnectionRequest](/java/docs/reference/google-cloud-vmwareengine/0.31.0/com.google.cloud.vmwareengine.v1.CreatePrivateConnectionRequest)>`
...
Required. The resource name of the location to create the new private connection in. Private connection is a regional resource. Resource names are schemeless URIs that follow the conventions in [https://cloud.google.com/apis/design/resource\_names](https://cloud.google.com/apis/design/resource_names). For example: `projects/my-project/locations/us-central1`
...
`[PrivateConnection](/java/docs/reference/google-cloud-vmwareengine/0.31.0/com.google.cloud.vmwareengine.v1.PrivateConnection)`
...
`[PrivateConnectionOrBuilder](/java/docs/reference/google-cloud-vmwareengine/0.31.0/com.google.cloud.vmwareengine.v1.PrivateConnectionOrBuilder)`
