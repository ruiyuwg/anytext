...
# Enum TransferTypes.TransferSpec.DataSinkCase (1.15.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum TransferTypes.TransferSpec.DataSinkCase extends Enum<TransferTypes.TransferSpec.DataSinkCase> implements Internal.EnumLite, AbstractMessageLite.InternalOneOfEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-storage-transfer/1.15.0/com.google.storagetransfer.v1.proto.TransferTypes.TransferSpec.DataSinkCase#com_google_storagetransfer_v1_proto_TransferTypes_TransferSpec_DataSinkCase_forNumber_int_) instead._
