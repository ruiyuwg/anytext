...
# Class AnalyzeEntitiesRequest (2.33.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> AnalyzeEntitiesRequest

## Implements

[AnalyzeEntitiesRequestOrBuilder](/java/docs/reference/google-cloud-language/2.33.0/com.google.cloud.language.v2.AnalyzeEntitiesRequestOrBuilder)
...
`[AnalyzeEntitiesRequest](/java/docs/reference/google-cloud-language/2.33.0/com.google.cloud.language.v2.AnalyzeEntitiesRequest)`
...
```
public static AnalyzeEntitiesRequest.Builder newBuilder()
```
...
`[AnalyzeEntitiesRequest.Builder](/java/docs/reference/google-cloud-language/2.33.0/com.google.cloud.language.v2.AnalyzeEntitiesRequest.Builder)`

### newBuilder(AnalyzeEntitiesRequest prototype)

```
public static AnalyzeEntitiesRequest.Builder newBuilder(AnalyzeEntitiesRequest prototype)
```
...
```
public static AnalyzeEntitiesRequest parseDelimitedFrom(InputStream input)
```
...
```
public static AnalyzeEntitiesRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AnalyzeEntitiesRequest parseFrom(byte[] data)
```
...
```
public static AnalyzeEntitiesRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AnalyzeEntitiesRequest parseFrom(ByteString data)
```
...
```
public static AnalyzeEntitiesRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AnalyzeEntitiesRequest parseFrom(CodedInputStream input)
```
...
```
public static AnalyzeEntitiesRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AnalyzeEntitiesRequest parseFrom(InputStream input)
```
...
```
public static AnalyzeEntitiesRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AnalyzeEntitiesRequest parseFrom(ByteBuffer data)
```
...
```
public static AnalyzeEntitiesRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[AnalyzeEntitiesRequest](/java/docs/reference/google-cloud-language/2.33.0/com.google.cloud.language.v2.AnalyzeEntitiesRequest)>`
...
`[Document](/java/docs/reference/google-cloud-language/2.33.0/com.google.cloud.language.v2.Document)`
...
`[DocumentOrBuilder](/java/docs/reference/google-cloud-language/2.33.0/com.google.cloud.language.v2.DocumentOrBuilder)`
...
`[EncodingType](/java/docs/reference/google-cloud-language/2.33.0/com.google.cloud.language.v2.EncodingType)`
...
```
public AnalyzeEntitiesRequest.Builder newBuilderForType()
```
...
```
protected AnalyzeEntitiesRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public AnalyzeEntitiesRequest.Builder toBuilder()
```
