...
# Class RedisInstanceInfo (1.54.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class RedisInstanceInfo extends GeneratedMessageV3 implements RedisInstanceInfoOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> RedisInstanceInfo

## Implements

[RedisInstanceInfoOrBuilder](/java/docs/reference/google-cloud-network-management/1.54.0/com.google.cloud.networkmanagement.v1.RedisInstanceInfoOrBuilder)
...
### PRIMARY\_ENDPOINT\_IP\_FIELD\_NUMBER

```
public static final int PRIMARY_ENDPOINT_IP_FIELD_NUMBER
```
...
### READ\_ENDPOINT\_IP\_FIELD\_NUMBER

```
public static final int READ_ENDPOINT_IP_FIELD_NUMBER
```
...
```
public static RedisInstanceInfo getDefaultInstance()
```
...
`[RedisInstanceInfo](/java/docs/reference/google-cloud-network-management/1.54.0/com.google.cloud.networkmanagement.v1.RedisInstanceInfo)`
...
```
public static RedisInstanceInfo.Builder newBuilder()
```
...
`[RedisInstanceInfo.Builder](/java/docs/reference/google-cloud-network-management/1.54.0/com.google.cloud.networkmanagement.v1.RedisInstanceInfo.Builder)`

### newBuilder(RedisInstanceInfo prototype)

```
public static RedisInstanceInfo.Builder newBuilder(RedisInstanceInfo prototype)
```
...
```
public static RedisInstanceInfo parseDelimitedFrom(InputStream input)
```
...
```
public static RedisInstanceInfo parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RedisInstanceInfo parseFrom(byte[] data)
```
...
```
public static RedisInstanceInfo parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RedisInstanceInfo parseFrom(ByteString data)
```
...
```
public static RedisInstanceInfo parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RedisInstanceInfo parseFrom(CodedInputStream input)
```
...
```
public static RedisInstanceInfo parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RedisInstanceInfo parseFrom(InputStream input)
```
...
```
public static RedisInstanceInfo parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RedisInstanceInfo parseFrom(ByteBuffer data)
```
...
```
public static RedisInstanceInfo parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<RedisInstanceInfo> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[RedisInstanceInfo](/java/docs/reference/google-cloud-network-management/1.54.0/com.google.cloud.networkmanagement.v1.RedisInstanceInfo)>`
...
```
public Parser<RedisInstanceInfo> getParserForType()
```
...
```
public RedisInstanceInfo.Builder newBuilderForType()
```
...
```
protected RedisInstanceInfo.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public RedisInstanceInfo.Builder toBuilder()
```
