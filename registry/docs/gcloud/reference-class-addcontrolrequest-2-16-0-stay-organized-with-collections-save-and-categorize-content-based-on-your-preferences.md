...
# Class AddControlRequest (2.16.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class AddControlRequest extends GeneratedMessageV3 implements AddControlRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> AddControlRequest

## Implements

[AddControlRequestOrBuilder](/java/docs/reference/google-cloud-retail/2.16.0/com.google.cloud.retail.v2beta.AddControlRequestOrBuilder)
...
```
public static AddControlRequest getDefaultInstance()
```
...
`[AddControlRequest](/java/docs/reference/google-cloud-retail/2.16.0/com.google.cloud.retail.v2beta.AddControlRequest)`
...
```
public static AddControlRequest.Builder newBuilder()
```
...
`[AddControlRequest.Builder](/java/docs/reference/google-cloud-retail/2.16.0/com.google.cloud.retail.v2beta.AddControlRequest.Builder)`

### newBuilder(AddControlRequest prototype)

```
public static AddControlRequest.Builder newBuilder(AddControlRequest prototype)
```
...
```
public static AddControlRequest parseDelimitedFrom(InputStream input)
```
...
```
public static AddControlRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AddControlRequest parseFrom(byte[] data)
```
...
```
public static AddControlRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AddControlRequest parseFrom(ByteString data)
```
...
```
public static AddControlRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AddControlRequest parseFrom(CodedInputStream input)
```
...
```
public static AddControlRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AddControlRequest parseFrom(InputStream input)
```
...
```
public static AddControlRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AddControlRequest parseFrom(ByteBuffer data)
```
...
```
public static AddControlRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<AddControlRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[AddControlRequest](/java/docs/reference/google-cloud-retail/2.16.0/com.google.cloud.retail.v2beta.AddControlRequest)>`
...
Required. The id of the control to apply. Assumed to be in the same catalog as the serving config - if id is not found a NOT\_FOUND error is returned.
...
```
public AddControlRequest getDefaultInstanceForType()
```
...
```
public Parser<AddControlRequest> getParserForType()
```
...
```
public AddControlRequest.Builder newBuilderForType()
```
...
```
protected AddControlRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public AddControlRequest.Builder toBuilder()
```
