...
# Class SearchRequest.FacetSpec.FacetKey.Builder (2.22.0) Stay organized with collections Save and categorize content based on your preferences.
...
[SearchRequest.FacetSpec.FacetKeyOrBuilder](/java/docs/reference/google-cloud-retail/2.22.0/com.google.cloud.retail.v2beta.SearchRequest.FacetSpec.FacetKeyOrBuilder)
...
`[SearchRequest.FacetSpec.FacetKey.Builder](/java/docs/reference/google-cloud-retail/2.22.0/com.google.cloud.retail.v2beta.SearchRequest.FacetSpec.FacetKey.Builder)`
...
`[Iterable](https://docs.oracle.com/javase/8/docs/api/java/lang/Iterable.html)<? extends com.google.cloud.retail.v2beta.Interval>`  
...
`[Interval](/java/docs/reference/google-cloud-retail/2.22.0/com.google.cloud.retail.v2beta.Interval)`  
...
`[Interval.Builder](/java/docs/reference/google-cloud-retail/2.22.0/com.google.cloud.retail.v2beta.Interval.Builder)`  
...
`[SearchRequest.FacetSpec.FacetKey](/java/docs/reference/google-cloud-retail/2.22.0/com.google.cloud.retail.v2beta.SearchRequest.FacetSpec.FacetKey)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Builder](/java/docs/reference/google-cloud-retail/2.22.0/com.google.cloud.retail.v2beta.Interval.Builder)>`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Interval](/java/docs/reference/google-cloud-retail/2.22.0/com.google.cloud.retail.v2beta.Interval)>`
...
`[IntervalOrBuilder](/java/docs/reference/google-cloud-retail/2.22.0/com.google.cloud.retail.v2beta.IntervalOrBuilder)`
