...
# Class ListDeploymentsRequest (0.57.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListDeploymentsRequest extends GeneratedMessage implements ListDeploymentsRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessage.html) \> ListDeploymentsRequest

## Implements

[ListDeploymentsRequestOrBuilder](/java/docs/reference/google-cloud-telcoautomation/latest/com.google.cloud.telcoautomation.v1alpha1.ListDeploymentsRequestOrBuilder)
...
`[ListDeploymentsRequest](/java/docs/reference/google-cloud-telcoautomation/latest/com.google.cloud.telcoautomation.v1alpha1.ListDeploymentsRequest)`
...
`[ListDeploymentsRequest.Builder](/java/docs/reference/google-cloud-telcoautomation/latest/com.google.cloud.telcoautomation.v1alpha1.ListDeploymentsRequest.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListDeploymentsRequest](/java/docs/reference/google-cloud-telcoautomation/latest/com.google.cloud.telcoautomation.v1alpha1.ListDeploymentsRequest)>`
...
```
protected ListDeploymentsRequest.Builder newBuilderForType(AbstractMessage.BuilderParent parent)
```
