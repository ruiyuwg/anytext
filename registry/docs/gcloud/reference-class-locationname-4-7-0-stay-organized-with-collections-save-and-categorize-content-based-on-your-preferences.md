...
# Class LocationName (4.7.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[LocationName.Builder](/java/docs/reference/google-cloud-speech/4.7.0/com.google.cloud.speech.v1p1beta1.LocationName.Builder)`
...
`[LocationName](/java/docs/reference/google-cloud-speech/4.7.0/com.google.cloud.speech.v1p1beta1.LocationName)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[LocationName](/java/docs/reference/google-cloud-speech/4.7.0/com.google.cloud.speech.v1p1beta1.LocationName)>`
