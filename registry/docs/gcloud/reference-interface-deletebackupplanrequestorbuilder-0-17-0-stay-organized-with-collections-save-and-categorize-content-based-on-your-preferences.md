...
# Interface DeleteBackupPlanRequestOrBuilder (0.17.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface DeleteBackupPlanRequestOrBuilder extends MessageOrBuilder
```
