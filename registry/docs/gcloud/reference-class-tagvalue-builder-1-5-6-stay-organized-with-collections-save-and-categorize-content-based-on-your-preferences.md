...
# Class TagValue.Builder (1.5.6) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class TagValue.Builder extends GeneratedMessageV3.Builder<TagValue.Builder> implements TagValueOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> TagValue.Builder

## Implements

[TagValueOrBuilder](/java/docs/reference/google-cloud-resourcemanager/1.5.6/com.google.cloud.resourcemanager.v3.TagValueOrBuilder)
...
```
public TagValue.Builder addRepeatedField(Descriptors.FieldDescriptor field, Object value)
```
...
[TagValue.Builder](/java/docs/reference/google-cloud-resourcemanager/1.5.6/com.google.cloud.resourcemanager.v3.TagValue.Builder)
...
[TagValue](/java/docs/reference/google-cloud-resourcemanager/1.5.6/com.google.cloud.resourcemanager.v3.TagValue)
...
```
public TagValue.Builder clearField(Descriptors.FieldDescriptor field)
```
...
```
public TagValue.Builder clearOneof(Descriptors.OneofDescriptor oneof)
```
...
```
public final TagValue.Builder mergeUnknownFields(UnknownFieldSet unknownFields)
```
...
```
public TagValue.Builder setField(Descriptors.FieldDescriptor field, Object value)
```
...
```
public TagValue.Builder setRepeatedField(Descriptors.FieldDescriptor field, int index, Object value)
```
...
```
public final TagValue.Builder setUnknownFields(UnknownFieldSet unknownFields)
```
