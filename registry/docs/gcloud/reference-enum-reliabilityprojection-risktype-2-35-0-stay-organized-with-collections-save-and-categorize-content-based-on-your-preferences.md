...
# Enum ReliabilityProjection.RiskType (2.35.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum ReliabilityProjection.RiskType extends Enum<ReliabilityProjection.RiskType> implements ProtocolMessageEnum
```

The risk associated with the reliability issue.

Protobuf enum `google.cloud.recommender.v1.ReliabilityProjection.RiskType`
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-recommender/2.35.0/com.google.cloud.recommender.v1.ReliabilityProjection.RiskType#com_google_cloud_recommender_v1_ReliabilityProjection_RiskType_forNumber_int_) instead._
