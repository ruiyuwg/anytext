...
# Class LocationName (2.12.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[LocationName.Builder](/java/docs/reference/google-cloud-tpu/2.12.0/com.google.cloud.tpu.v2.LocationName.Builder)`
...
`[LocationName](/java/docs/reference/google-cloud-tpu/2.12.0/com.google.cloud.tpu.v2.LocationName)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[LocationName](/java/docs/reference/google-cloud-tpu/2.12.0/com.google.cloud.tpu.v2.LocationName)>`
