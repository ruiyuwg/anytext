...
# Class GrpcStreamsServiceCallableFactory (0.4.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public class GrpcStreamsServiceCallableFactory implements GrpcStubCallableFactory
```

gRPC callable factory implementation for the StreamsService service API.

This class is for advanced usage.

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> GrpcStreamsServiceCallableFactory
...
```
public GrpcStreamsServiceCallableFactory()
```
