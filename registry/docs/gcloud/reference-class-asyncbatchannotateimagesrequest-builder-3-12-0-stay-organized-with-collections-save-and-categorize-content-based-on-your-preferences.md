...
# Class AsyncBatchAnnotateImagesRequest.Builder (3.12.0) Stay organized with collections Save and categorize content based on your preferences.
...
[AsyncBatchAnnotateImagesRequestOrBuilder](/java/docs/reference/google-cloud-vision/3.12.0/com.google.cloud.vision.v1.AsyncBatchAnnotateImagesRequestOrBuilder)
...
`[AsyncBatchAnnotateImagesRequest.Builder](/java/docs/reference/google-cloud-vision/3.12.0/com.google.cloud.vision.v1.AsyncBatchAnnotateImagesRequest.Builder)`
...
`[AnnotateImageRequest](/java/docs/reference/google-cloud-vision/3.12.0/com.google.cloud.vision.v1.AnnotateImageRequest)`  
...
`[AnnotateImageRequest.Builder](/java/docs/reference/google-cloud-vision/3.12.0/com.google.cloud.vision.v1.AnnotateImageRequest.Builder)`  
...
`[AsyncBatchAnnotateImagesRequest](/java/docs/reference/google-cloud-vision/3.12.0/com.google.cloud.vision.v1.AsyncBatchAnnotateImagesRequest)`
...
`[OutputConfig](/java/docs/reference/google-cloud-vision/3.12.0/com.google.cloud.vision.v1.OutputConfig)`
...
`[OutputConfig.Builder](/java/docs/reference/google-cloud-vision/3.12.0/com.google.cloud.vision.v1.OutputConfig.Builder)`
...
`[OutputConfigOrBuilder](/java/docs/reference/google-cloud-vision/3.12.0/com.google.cloud.vision.v1.OutputConfigOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Builder](/java/docs/reference/google-cloud-vision/3.12.0/com.google.cloud.vision.v1.AnnotateImageRequest.Builder)>`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[AnnotateImageRequest](/java/docs/reference/google-cloud-vision/3.12.0/com.google.cloud.vision.v1.AnnotateImageRequest)>`
...
`[AnnotateImageRequestOrBuilder](/java/docs/reference/google-cloud-vision/3.12.0/com.google.cloud.vision.v1.AnnotateImageRequestOrBuilder)`
