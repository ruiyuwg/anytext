...
# Class ProductName (2.13.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[ProductName.Builder](/java/docs/reference/google-cloud-retail/2.13.0/com.google.cloud.retail.v2alpha.ProductName.Builder)`
...
`[ProductName](/java/docs/reference/google-cloud-retail/2.13.0/com.google.cloud.retail.v2alpha.ProductName)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ProductName](/java/docs/reference/google-cloud-retail/2.13.0/com.google.cloud.retail.v2alpha.ProductName)>`
