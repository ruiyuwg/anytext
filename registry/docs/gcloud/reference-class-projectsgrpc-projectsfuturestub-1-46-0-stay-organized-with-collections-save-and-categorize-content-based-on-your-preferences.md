...
# Class ProjectsGrpc.ProjectsFutureStub (1.46.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class ProjectsGrpc.ProjectsFutureStub extends AbstractFutureStub<ProjectsGrpc.ProjectsFutureStub>
```
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> io.grpc.stub.AbstractStub \> io.grpc.stub.AbstractFutureStub \> ProjectsGrpc.ProjectsFutureStub
...
```
protected ProjectsGrpc.ProjectsFutureStub build(Channel channel, CallOptions callOptions)
```
...
`[ProjectsGrpc.ProjectsFutureStub](/java/docs/reference/google-cloud-resourcemanager/1.46.0/com.google.cloud.resourcemanager.v3.ProjectsGrpc.ProjectsFutureStub)`
...
```
public ListenableFuture<Operation> createProject(CreateProjectRequest request)
```
...
`[CreateProjectRequest](/java/docs/reference/google-cloud-resourcemanager/1.46.0/com.google.cloud.resourcemanager.v3.CreateProjectRequest)`  
...
```
public ListenableFuture<Operation> deleteProject(DeleteProjectRequest request)
```
...
`[DeleteProjectRequest](/java/docs/reference/google-cloud-resourcemanager/1.46.0/com.google.cloud.resourcemanager.v3.DeleteProjectRequest)`  
...
`[GetProjectRequest](/java/docs/reference/google-cloud-resourcemanager/1.46.0/com.google.cloud.resourcemanager.v3.GetProjectRequest)`  
...
`com.google.common.util.concurrent.ListenableFuture<[Project](/java/docs/reference/google-cloud-resourcemanager/1.46.0/com.google.cloud.resourcemanager.v3.Project)>`

### listProjects(ListProjectsRequest request)

```
public ListenableFuture<ListProjectsResponse> listProjects(ListProjectsRequest request)
```
...
`[ListProjectsRequest](/java/docs/reference/google-cloud-resourcemanager/1.46.0/com.google.cloud.resourcemanager.v3.ListProjectsRequest)`  
...
`com.google.common.util.concurrent.ListenableFuture<[ListProjectsResponse](/java/docs/reference/google-cloud-resourcemanager/1.46.0/com.google.cloud.resourcemanager.v3.ListProjectsResponse)>`

### moveProject(MoveProjectRequest request)

```
public ListenableFuture<Operation> moveProject(MoveProjectRequest request)
```
...
`[MoveProjectRequest](/java/docs/reference/google-cloud-resourcemanager/1.46.0/com.google.cloud.resourcemanager.v3.MoveProjectRequest)`  
...
```
public ListenableFuture<SearchProjectsResponse> searchProjects(SearchProjectsRequest request)
```
...
`[SearchProjectsRequest](/java/docs/reference/google-cloud-resourcemanager/1.46.0/com.google.cloud.resourcemanager.v3.SearchProjectsRequest)`  
...
`com.google.common.util.concurrent.ListenableFuture<[SearchProjectsResponse](/java/docs/reference/google-cloud-resourcemanager/1.46.0/com.google.cloud.resourcemanager.v3.SearchProjectsResponse)>`
...
### undeleteProject(UndeleteProjectRequest request)

```
public ListenableFuture<Operation> undeleteProject(UndeleteProjectRequest request)
```
...
`[UndeleteProjectRequest](/java/docs/reference/google-cloud-resourcemanager/1.46.0/com.google.cloud.resourcemanager.v3.UndeleteProjectRequest)`  
...
```
public ListenableFuture<Operation> updateProject(UpdateProjectRequest request)
```
...
`[UpdateProjectRequest](/java/docs/reference/google-cloud-resourcemanager/1.46.0/com.google.cloud.resourcemanager.v3.UpdateProjectRequest)`  
