...
# Enum SearchRequest.SpellCorrectionSpec.Mode (2.49.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-retail/2.49.0/com.google.cloud.retail.v2.SearchRequest.SpellCorrectionSpec.Mode#com_google_cloud_retail_v2_SearchRequest_SpellCorrectionSpec_Mode_forNumber_int_) instead._
