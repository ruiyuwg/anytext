...
# Interface DiscardBlueprintChangesResponseOrBuilder (0.17.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface DiscardBlueprintChangesResponseOrBuilder extends MessageOrBuilder
```
