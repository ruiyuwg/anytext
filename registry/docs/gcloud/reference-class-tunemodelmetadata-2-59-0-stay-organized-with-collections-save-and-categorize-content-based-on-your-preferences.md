...
# Class TuneModelMetadata (2.59.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class TuneModelMetadata extends GeneratedMessageV3 implements TuneModelMetadataOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> TuneModelMetadata

## Implements

[TuneModelMetadataOrBuilder](/java/docs/reference/google-cloud-retail/2.59.0/com.google.cloud.retail.v2.TuneModelMetadataOrBuilder)
...
```
public static TuneModelMetadata getDefaultInstance()
```
...
`[TuneModelMetadata](/java/docs/reference/google-cloud-retail/2.59.0/com.google.cloud.retail.v2.TuneModelMetadata)`
...
```
public static TuneModelMetadata.Builder newBuilder()
```
...
`[TuneModelMetadata.Builder](/java/docs/reference/google-cloud-retail/2.59.0/com.google.cloud.retail.v2.TuneModelMetadata.Builder)`

### newBuilder(TuneModelMetadata prototype)

```
public static TuneModelMetadata.Builder newBuilder(TuneModelMetadata prototype)
```
...
```
public static TuneModelMetadata parseDelimitedFrom(InputStream input)
```
...
```
public static TuneModelMetadata parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static TuneModelMetadata parseFrom(byte[] data)
```
...
```
public static TuneModelMetadata parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static TuneModelMetadata parseFrom(ByteString data)
```
...
```
public static TuneModelMetadata parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static TuneModelMetadata parseFrom(CodedInputStream input)
```
...
```
public static TuneModelMetadata parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static TuneModelMetadata parseFrom(InputStream input)
```
...
```
public static TuneModelMetadata parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static TuneModelMetadata parseFrom(ByteBuffer data)
```
...
```
public static TuneModelMetadata parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<TuneModelMetadata> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[TuneModelMetadata](/java/docs/reference/google-cloud-retail/2.59.0/com.google.cloud.retail.v2.TuneModelMetadata)>`
...
```
public Parser<TuneModelMetadata> getParserForType()
```
...
```
public TuneModelMetadata.Builder newBuilderForType()
```
...
```
protected TuneModelMetadata.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public TuneModelMetadata.Builder toBuilder()
```
