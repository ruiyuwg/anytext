...
# Class GetPoolRequest (0.26.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class GetPoolRequest extends GeneratedMessageV3 implements GetPoolRequestOrBuilder
```

Request message for "LivestreamService.GetPool".

Protobuf type `google.cloud.video.livestream.v1.GetPoolRequest`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> GetPoolRequest

## Implements

[GetPoolRequestOrBuilder](/java/docs/reference/google-cloud-live-stream/0.26.0/com.google.cloud.video.livestream.v1.GetPoolRequestOrBuilder)
...
```
public static GetPoolRequest getDefaultInstance()
```
...
`[GetPoolRequest](/java/docs/reference/google-cloud-live-stream/0.26.0/com.google.cloud.video.livestream.v1.GetPoolRequest)`
...
```
public static GetPoolRequest.Builder newBuilder()
```
...
`[GetPoolRequest.Builder](/java/docs/reference/google-cloud-live-stream/0.26.0/com.google.cloud.video.livestream.v1.GetPoolRequest.Builder)`

### newBuilder(GetPoolRequest prototype)

```
public static GetPoolRequest.Builder newBuilder(GetPoolRequest prototype)
```
...
```
public static GetPoolRequest parseDelimitedFrom(InputStream input)
```
...
```
public static GetPoolRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetPoolRequest parseFrom(byte[] data)
```
...
```
public static GetPoolRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetPoolRequest parseFrom(ByteString data)
```
...
```
public static GetPoolRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetPoolRequest parseFrom(CodedInputStream input)
```
...
```
public static GetPoolRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetPoolRequest parseFrom(InputStream input)
```
...
```
public static GetPoolRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetPoolRequest parseFrom(ByteBuffer data)
```
...
```
public static GetPoolRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<GetPoolRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[GetPoolRequest](/java/docs/reference/google-cloud-live-stream/0.26.0/com.google.cloud.video.livestream.v1.GetPoolRequest)>`
...
```
public GetPoolRequest getDefaultInstanceForType()
```
...
```
public Parser<GetPoolRequest> getParserForType()
```
...
```
public GetPoolRequest.Builder newBuilderForType()
```
...
```
protected GetPoolRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public GetPoolRequest.Builder toBuilder()
```
