...
# Class Execution.StackTrace (2.22.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class Execution.StackTrace extends GeneratedMessageV3 implements Execution.StackTraceOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> Execution.StackTrace

## Implements

[Execution.StackTraceOrBuilder](/java/docs/reference/google-cloud-workflow-executions/2.22.0/com.google.cloud.workflows.executions.v1.Execution.StackTraceOrBuilder)
...
```
public static Execution.StackTrace getDefaultInstance()
```
...
`[Execution.StackTrace](/java/docs/reference/google-cloud-workflow-executions/2.22.0/com.google.cloud.workflows.executions.v1.Execution.StackTrace)`
...
```
public static Execution.StackTrace.Builder newBuilder()
```
...
`[Execution.StackTrace.Builder](/java/docs/reference/google-cloud-workflow-executions/2.22.0/com.google.cloud.workflows.executions.v1.Execution.StackTrace.Builder)`

### newBuilder(Execution.StackTrace prototype)

```
public static Execution.StackTrace.Builder newBuilder(Execution.StackTrace prototype)
```
...
```
public static Execution.StackTrace parseDelimitedFrom(InputStream input)
```
...
```
public static Execution.StackTrace parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Execution.StackTrace parseFrom(byte[] data)
```
...
```
public static Execution.StackTrace parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Execution.StackTrace parseFrom(ByteString data)
```
...
```
public static Execution.StackTrace parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Execution.StackTrace parseFrom(CodedInputStream input)
```
...
```
public static Execution.StackTrace parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Execution.StackTrace parseFrom(InputStream input)
```
...
```
public static Execution.StackTrace parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Execution.StackTrace parseFrom(ByteBuffer data)
```
...
```
public static Execution.StackTrace parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<Execution.StackTrace> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[StackTrace](/java/docs/reference/google-cloud-workflow-executions/2.22.0/com.google.cloud.workflows.executions.v1.Execution.StackTrace)>`
...
`[Execution.StackTraceElement](/java/docs/reference/google-cloud-workflow-executions/2.22.0/com.google.cloud.workflows.executions.v1.Execution.StackTraceElement)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[StackTraceElement](/java/docs/reference/google-cloud-workflow-executions/2.22.0/com.google.cloud.workflows.executions.v1.Execution.StackTraceElement)>`
...
`[Execution.StackTraceElementOrBuilder](/java/docs/reference/google-cloud-workflow-executions/2.22.0/com.google.cloud.workflows.executions.v1.Execution.StackTraceElementOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.workflows.executions.v1.Execution.StackTraceElementOrBuilder>`

### getParserForType()

```
public Parser<Execution.StackTrace> getParserForType()
```
...
```
public Execution.StackTrace.Builder newBuilderForType()
```
...
```
protected Execution.StackTrace.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public Execution.StackTrace.Builder toBuilder()
```
