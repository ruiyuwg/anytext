...
# Class CrawledUrl (2.51.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class CrawledUrl extends GeneratedMessageV3 implements CrawledUrlOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> CrawledUrl

## Implements

[CrawledUrlOrBuilder](/java/docs/reference/google-cloud-websecurityscanner/2.51.0/com.google.cloud.websecurityscanner.v1beta.CrawledUrlOrBuilder)
...
```
public static CrawledUrl getDefaultInstance()
```
...
`[CrawledUrl](/java/docs/reference/google-cloud-websecurityscanner/2.51.0/com.google.cloud.websecurityscanner.v1beta.CrawledUrl)`
...
```
public static CrawledUrl.Builder newBuilder()
```
...
`[CrawledUrl.Builder](/java/docs/reference/google-cloud-websecurityscanner/2.51.0/com.google.cloud.websecurityscanner.v1beta.CrawledUrl.Builder)`

### newBuilder(CrawledUrl prototype)

```
public static CrawledUrl.Builder newBuilder(CrawledUrl prototype)
```
...
```
public static CrawledUrl parseDelimitedFrom(InputStream input)
```
...
```
public static CrawledUrl parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CrawledUrl parseFrom(byte[] data)
```
...
```
public static CrawledUrl parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CrawledUrl parseFrom(ByteString data)
```
...
```
public static CrawledUrl parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CrawledUrl parseFrom(CodedInputStream input)
```
...
```
public static CrawledUrl parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CrawledUrl parseFrom(InputStream input)
```
...
```
public static CrawledUrl parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CrawledUrl parseFrom(ByteBuffer data)
```
...
```
public static CrawledUrl parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<CrawledUrl> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[CrawledUrl](/java/docs/reference/google-cloud-websecurityscanner/2.51.0/com.google.cloud.websecurityscanner.v1beta.CrawledUrl)>`
...
```
public CrawledUrl getDefaultInstanceForType()
```
...
```
public Parser<CrawledUrl> getParserForType()
```
...
```
public CrawledUrl.Builder newBuilderForType()
```
...
```
protected CrawledUrl.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public CrawledUrl.Builder toBuilder()
```
