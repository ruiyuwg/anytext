...
# Class RunImportJobRequest (0.27.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class RunImportJobRequest extends GeneratedMessageV3 implements RunImportJobRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> RunImportJobRequest

## Implements

[RunImportJobRequestOrBuilder](/java/docs/reference/google-cloud-migrationcenter/0.27.0/com.google.cloud.migrationcenter.v1.RunImportJobRequestOrBuilder)
...
```
public static RunImportJobRequest getDefaultInstance()
```
...
`[RunImportJobRequest](/java/docs/reference/google-cloud-migrationcenter/0.27.0/com.google.cloud.migrationcenter.v1.RunImportJobRequest)`
...
```
public static RunImportJobRequest.Builder newBuilder()
```
...
`[RunImportJobRequest.Builder](/java/docs/reference/google-cloud-migrationcenter/0.27.0/com.google.cloud.migrationcenter.v1.RunImportJobRequest.Builder)`

### newBuilder(RunImportJobRequest prototype)

```
public static RunImportJobRequest.Builder newBuilder(RunImportJobRequest prototype)
```
...
```
public static RunImportJobRequest parseDelimitedFrom(InputStream input)
```
...
```
public static RunImportJobRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RunImportJobRequest parseFrom(byte[] data)
```
...
```
public static RunImportJobRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RunImportJobRequest parseFrom(ByteString data)
```
...
```
public static RunImportJobRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RunImportJobRequest parseFrom(CodedInputStream input)
```
...
```
public static RunImportJobRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RunImportJobRequest parseFrom(InputStream input)
```
...
```
public static RunImportJobRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RunImportJobRequest parseFrom(ByteBuffer data)
```
...
```
public static RunImportJobRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<RunImportJobRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[RunImportJobRequest](/java/docs/reference/google-cloud-migrationcenter/0.27.0/com.google.cloud.migrationcenter.v1.RunImportJobRequest)>`
...
```
public RunImportJobRequest getDefaultInstanceForType()
```
...
```
public Parser<RunImportJobRequest> getParserForType()
```
...
```
public RunImportJobRequest.Builder newBuilderForType()
```
...
```
protected RunImportJobRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public RunImportJobRequest.Builder toBuilder()
```
