...
# Interface CreateSourceRequestOrBuilder (2.45.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[Source](/java/docs/reference/google-cloud-securitycenter/2.45.0/com.google.cloud.securitycenter.v1beta1.Source)`
...
`[SourceOrBuilder](/java/docs/reference/google-cloud-securitycenter/2.45.0/com.google.cloud.securitycenter.v1beta1.SourceOrBuilder)`
