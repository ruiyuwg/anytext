...
# Class RegistrationServiceLimitedTimeRetryPolicy (2.35.0) Stay organized with collections Save and categorize content based on your preferences.
...
A retry policy for [`RegistrationServiceConnection`](/cpp/docs/reference/servicedirectory/2.35.0/classgoogle_1_1cloud_1_1servicedirectory__v1_1_1RegistrationServiceConnection) based on elapsed time.
...
### RegistrationServiceLimitedTimeRetryPolicy(std::chrono::duration< DurationRep, DurationPeriod >)
...
### RegistrationServiceLimitedTimeRetryPolicy(RegistrationServiceLimitedTimeRetryPolicy &&)
...
### RegistrationServiceLimitedTimeRetryPolicy(RegistrationServiceLimitedTimeRetryPolicy const &)
...
`RegistrationServiceLimitedTimeRetryPolicy const &`  
...
`std::unique_ptr< RegistrationServiceRetryPolicy >`

## Type Aliases

### BaseType

**Alias Of**: `RegistrationServiceRetryPolicy`
