...
# Interface NsxOrBuilder (0.35.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[Nsx.State](/java/docs/reference/google-cloud-vmwareengine/0.35.0/com.google.cloud.vmwareengine.v1.Nsx.State)`
