...
# Enum EncodingType (2.36.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-language/2.36.0/com.google.cloud.language.v1beta2.EncodingType#com_google_cloud_language_v1beta2_EncodingType_forNumber_int_) instead._
