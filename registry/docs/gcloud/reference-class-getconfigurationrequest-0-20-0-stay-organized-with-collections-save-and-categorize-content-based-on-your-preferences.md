...
# Class GetConfigurationRequest (0.20.0) Stay organized with collections Save and categorize content based on your preferences.

0.20.0 (latest) 0.18.0 0.16.0 0.15.0 0.14.0 0.13.0 0.11.0 0.9.0 0.8.0 0.7.0 0.6.0 0.5.0 0.3.0 0.1.0

```
public final class GetConfigurationRequest extends GeneratedMessage implements GetConfigurationRequestOrBuilder
```

Message for getting a Configuration

Protobuf type `google.cloud.licensemanager.v1.GetConfigurationRequest`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessage.html) \> GetConfigurationRequest

## Implements

[GetConfigurationRequestOrBuilder](/java/docs/reference/google-cloud-licensemanager/latest/com.google.cloud.licensemanager.v1.GetConfigurationRequestOrBuilder)
...
`[GetConfigurationRequest](/java/docs/reference/google-cloud-licensemanager/latest/com.google.cloud.licensemanager.v1.GetConfigurationRequest)`
...
```
public static GetConfigurationRequest.Builder newBuilder()
```
...
`[GetConfigurationRequest.Builder](/java/docs/reference/google-cloud-licensemanager/latest/com.google.cloud.licensemanager.v1.GetConfigurationRequest.Builder)`

### newBuilder(GetConfigurationRequest prototype)

```
public static GetConfigurationRequest.Builder newBuilder(GetConfigurationRequest prototype)
```
...
```
public static GetConfigurationRequest parseDelimitedFrom(InputStream input)
```
...
```
public static GetConfigurationRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetConfigurationRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetConfigurationRequest parseFrom(ByteString data)
```
...
```
public static GetConfigurationRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetConfigurationRequest parseFrom(CodedInputStream input)
```
...
```
public static GetConfigurationRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetConfigurationRequest parseFrom(InputStream input)
```
...
```
public static GetConfigurationRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetConfigurationRequest parseFrom(ByteBuffer data)
```
...
```
public static GetConfigurationRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[GetConfigurationRequest](/java/docs/reference/google-cloud-licensemanager/latest/com.google.cloud.licensemanager.v1.GetConfigurationRequest)>`
...
```
public GetConfigurationRequest.Builder newBuilderForType()
```
...
```
protected GetConfigurationRequest.Builder newBuilderForType(AbstractMessage.BuilderParent parent)
```
