...
# Class LoadSnapshotRequest (1.27.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> LoadSnapshotRequest

## Implements

[LoadSnapshotRequestOrBuilder](/java/docs/reference/google-cloud-orchestration-airflow/1.27.0/com.google.cloud.orchestration.airflow.service.v1beta1.LoadSnapshotRequestOrBuilder)
...
### SKIP\_AIRFLOW\_OVERRIDES\_SETTING\_FIELD\_NUMBER
...
### SKIP\_ENVIRONMENT\_VARIABLES\_SETTING\_FIELD\_NUMBER
...
### SKIP\_GCS\_DATA\_COPYING\_FIELD\_NUMBER
...
### SKIP\_PYPI\_PACKAGES\_INSTALLATION\_FIELD\_NUMBER
...
`[LoadSnapshotRequest](/java/docs/reference/google-cloud-orchestration-airflow/1.27.0/com.google.cloud.orchestration.airflow.service.v1beta1.LoadSnapshotRequest)`
...
`[LoadSnapshotRequest.Builder](/java/docs/reference/google-cloud-orchestration-airflow/1.27.0/com.google.cloud.orchestration.airflow.service.v1beta1.LoadSnapshotRequest.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[LoadSnapshotRequest](/java/docs/reference/google-cloud-orchestration-airflow/1.27.0/com.google.cloud.orchestration.airflow.service.v1beta1.LoadSnapshotRequest)>`
...
A Cloud Storage path to a snapshot to load, e.g.: "gs://my-bucket/snapshots/project\_location\_environment\_timestamp".
