...
# Class ListHydratedDeploymentsRequest (0.57.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListHydratedDeploymentsRequest extends GeneratedMessage implements ListHydratedDeploymentsRequestOrBuilder
```

Request object for `ListHydratedDeployments`.

Protobuf type `google.cloud.telcoautomation.v1.ListHydratedDeploymentsRequest`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessage.html) \> ListHydratedDeploymentsRequest

## Implements

[ListHydratedDeploymentsRequestOrBuilder](/java/docs/reference/google-cloud-telcoautomation/latest/com.google.cloud.telcoautomation.v1.ListHydratedDeploymentsRequestOrBuilder)
...
```
public static ListHydratedDeploymentsRequest getDefaultInstance()
```
...
`[ListHydratedDeploymentsRequest](/java/docs/reference/google-cloud-telcoautomation/latest/com.google.cloud.telcoautomation.v1.ListHydratedDeploymentsRequest)`
...
```
public static ListHydratedDeploymentsRequest.Builder newBuilder()
```
...
`[ListHydratedDeploymentsRequest.Builder](/java/docs/reference/google-cloud-telcoautomation/latest/com.google.cloud.telcoautomation.v1.ListHydratedDeploymentsRequest.Builder)`

### newBuilder(ListHydratedDeploymentsRequest prototype)

```
public static ListHydratedDeploymentsRequest.Builder newBuilder(ListHydratedDeploymentsRequest prototype)
```
...
```
public static ListHydratedDeploymentsRequest parseDelimitedFrom(InputStream input)
```
...
```
public static ListHydratedDeploymentsRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListHydratedDeploymentsRequest parseFrom(byte[] data)
```
...
```
public static ListHydratedDeploymentsRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListHydratedDeploymentsRequest parseFrom(ByteString data)
```
...
```
public static ListHydratedDeploymentsRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListHydratedDeploymentsRequest parseFrom(CodedInputStream input)
```
...
```
public static ListHydratedDeploymentsRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListHydratedDeploymentsRequest parseFrom(InputStream input)
```
...
```
public static ListHydratedDeploymentsRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListHydratedDeploymentsRequest parseFrom(ByteBuffer data)
```
...
```
public static ListHydratedDeploymentsRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ListHydratedDeploymentsRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListHydratedDeploymentsRequest](/java/docs/reference/google-cloud-telcoautomation/latest/com.google.cloud.telcoautomation.v1.ListHydratedDeploymentsRequest)>`
...
```
public Parser<ListHydratedDeploymentsRequest> getParserForType()
```
...
```
public ListHydratedDeploymentsRequest.Builder newBuilderForType()
```
...
```
protected ListHydratedDeploymentsRequest.Builder newBuilderForType(AbstractMessage.BuilderParent parent)
```
...
```
public ListHydratedDeploymentsRequest.Builder toBuilder()
```
