...
# Interface UpdateTenantRequestOrBuilder (2.18.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[Tenant](/java/docs/reference/google-cloud-talent/2.18.0/com.google.cloud.talent.v4beta1.Tenant)`
...
`[TenantOrBuilder](/java/docs/reference/google-cloud-talent/2.18.0/com.google.cloud.talent.v4beta1.TenantOrBuilder)`
...
Strongly recommended for the best service experience. If update\_mask is provided, only the specified fields in tenant are updated. Otherwise all the fields are updated. A field mask to specify the tenant fields to be updated. Only top level fields of Tenant are supported.
