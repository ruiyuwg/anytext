...
# Class AzureClient (0.55.0) Stay organized with collections Save and categorize content based on your preferences.
...
[GitHub Repository](https://github.com/googleapis/google-cloud-java/tree/main/java-gke-multi-cloud/google-cloud-gke-multi-cloud/src/main/java/com/google/cloud/gkemulticloud/v1/AzureClient.java)
...
### APPLICATION\_ID\_FIELD\_NUMBER
...
### PEM\_CERTIFICATE\_FIELD\_NUMBER
...
`[AzureClient](/java/docs/reference/google-cloud-gke-multi-cloud/0.55.0/com.google.cloud.gkemulticloud.v1.AzureClient)`
...
`[AzureClient.Builder](/java/docs/reference/google-cloud-gke-multi-cloud/0.55.0/com.google.cloud.gkemulticloud.v1.AzureClient.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[AzureClient](/java/docs/reference/google-cloud-gke-multi-cloud/0.55.0/com.google.cloud.gkemulticloud.v1.AzureClient)>`
...
Use [#getAnnotationsMap()](/java/docs/reference/google-cloud-gke-multi-cloud/0.55.0/com.google.cloud.gkemulticloud.v1.AzureClient#com_google_cloud_gkemulticloud_v1_AzureClient_getAnnotationsMap__) instead.
