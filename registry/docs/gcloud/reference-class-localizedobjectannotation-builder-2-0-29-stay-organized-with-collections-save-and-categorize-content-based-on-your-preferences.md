...
# Class LocalizedObjectAnnotation.Builder (2.0.29) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class LocalizedObjectAnnotation.Builder extends GeneratedMessageV3.Builder<LocalizedObjectAnnotation.Builder> implements LocalizedObjectAnnotationOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> LocalizedObjectAnnotation.Builder

## Implements

[LocalizedObjectAnnotationOrBuilder](/java/docs/reference/google-cloud-vision/2.0.29/com.google.cloud.vision.v1p4beta1.LocalizedObjectAnnotationOrBuilder)
...
```
public LocalizedObjectAnnotation.Builder addRepeatedField(Descriptors.FieldDescriptor field, Object value)
```
...
[LocalizedObjectAnnotation.Builder](/java/docs/reference/google-cloud-vision/2.0.29/com.google.cloud.vision.v1p4beta1.LocalizedObjectAnnotation.Builder)
...
[LocalizedObjectAnnotation](/java/docs/reference/google-cloud-vision/2.0.29/com.google.cloud.vision.v1p4beta1.LocalizedObjectAnnotation)
...
```
public LocalizedObjectAnnotation.Builder clearField(Descriptors.FieldDescriptor field)
```
...
```
public LocalizedObjectAnnotation.Builder clearOneof(Descriptors.OneofDescriptor oneof)
```
...
[BoundingPoly](/java/docs/reference/google-cloud-vision/2.0.29/com.google.cloud.vision.v1p4beta1.BoundingPoly)
...
[BoundingPoly.Builder](/java/docs/reference/google-cloud-vision/2.0.29/com.google.cloud.vision.v1p4beta1.BoundingPoly.Builder)
...
[BoundingPolyOrBuilder](/java/docs/reference/google-cloud-vision/2.0.29/com.google.cloud.vision.v1p4beta1.BoundingPolyOrBuilder)
...
```
public LocalizedObjectAnnotation.Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public LocalizedObjectAnnotation.Builder mergeFrom(Message other)
```
...
```
public final LocalizedObjectAnnotation.Builder mergeUnknownFields(UnknownFieldSet unknownFields)
```
...
```
public LocalizedObjectAnnotation.Builder setField(Descriptors.FieldDescriptor field, Object value)
```
...
```
public LocalizedObjectAnnotation.Builder setLanguageCodeBytes(ByteString value)
```
...
```
public LocalizedObjectAnnotation.Builder setMidBytes(ByteString value)
```
...
```
public LocalizedObjectAnnotation.Builder setNameBytes(ByteString value)
```
...
```
public LocalizedObjectAnnotation.Builder setRepeatedField(Descriptors.FieldDescriptor field, int index, Object value)
```
...
```
public final LocalizedObjectAnnotation.Builder setUnknownFields(UnknownFieldSet unknownFields)
```
