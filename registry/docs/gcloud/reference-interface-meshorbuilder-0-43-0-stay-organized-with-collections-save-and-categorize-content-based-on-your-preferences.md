...
# Interface MeshOrBuilder (0.43.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[EnvoyHeaders](/java/docs/reference/google-cloud-networkservices/latest/com.google.cloud.networkservices.v1.EnvoyHeaders)`
...
Identifier. Name of the Mesh resource. It matches pattern `projects/*/locations/global/meshes/<mesh_name>`.
...
Whether the envoyHeaders field is set.
