...
# Class SetInstanceAcceleratorRequest (1.53.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class SetInstanceAcceleratorRequest extends GeneratedMessageV3 implements SetInstanceAcceleratorRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> SetInstanceAcceleratorRequest

## Implements

[SetInstanceAcceleratorRequestOrBuilder](/java/docs/reference/google-cloud-notebooks/1.53.0/com.google.cloud.notebooks.v1beta1.SetInstanceAcceleratorRequestOrBuilder)
...
```
public static SetInstanceAcceleratorRequest getDefaultInstance()
```
...
`[SetInstanceAcceleratorRequest](/java/docs/reference/google-cloud-notebooks/1.53.0/com.google.cloud.notebooks.v1beta1.SetInstanceAcceleratorRequest)`
...
```
public static SetInstanceAcceleratorRequest.Builder newBuilder()
```
...
`[SetInstanceAcceleratorRequest.Builder](/java/docs/reference/google-cloud-notebooks/1.53.0/com.google.cloud.notebooks.v1beta1.SetInstanceAcceleratorRequest.Builder)`

### newBuilder(SetInstanceAcceleratorRequest prototype)

```
public static SetInstanceAcceleratorRequest.Builder newBuilder(SetInstanceAcceleratorRequest prototype)
```
...
```
public static SetInstanceAcceleratorRequest parseDelimitedFrom(InputStream input)
```
...
```
public static SetInstanceAcceleratorRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SetInstanceAcceleratorRequest parseFrom(byte[] data)
```
...
```
public static SetInstanceAcceleratorRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SetInstanceAcceleratorRequest parseFrom(ByteString data)
```
...
```
public static SetInstanceAcceleratorRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SetInstanceAcceleratorRequest parseFrom(CodedInputStream input)
```
...
```
public static SetInstanceAcceleratorRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SetInstanceAcceleratorRequest parseFrom(InputStream input)
```
...
```
public static SetInstanceAcceleratorRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SetInstanceAcceleratorRequest parseFrom(ByteBuffer data)
```
...
```
public static SetInstanceAcceleratorRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<SetInstanceAcceleratorRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[SetInstanceAcceleratorRequest](/java/docs/reference/google-cloud-notebooks/1.53.0/com.google.cloud.notebooks.v1beta1.SetInstanceAcceleratorRequest)>`
...
```
public SetInstanceAcceleratorRequest getDefaultInstanceForType()
```
...
```
public Parser<SetInstanceAcceleratorRequest> getParserForType()
```
...
```
public Instance.AcceleratorType getType()
```
...
`[Instance.AcceleratorType](/java/docs/reference/google-cloud-notebooks/1.53.0/com.google.cloud.notebooks.v1beta1.Instance.AcceleratorType)`
...
```
public SetInstanceAcceleratorRequest.Builder newBuilderForType()
```
...
```
protected SetInstanceAcceleratorRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public SetInstanceAcceleratorRequest.Builder toBuilder()
```
