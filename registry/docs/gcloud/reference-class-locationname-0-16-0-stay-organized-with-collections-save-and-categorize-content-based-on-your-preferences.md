...
# Class LocationName (0.16.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[LocationName.Builder](/java/docs/reference/google-cloud-workstations/0.16.0/com.google.cloud.workstations.v1beta.LocationName.Builder)`
...
`[LocationName](/java/docs/reference/google-cloud-workstations/0.16.0/com.google.cloud.workstations.v1beta.LocationName)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[LocationName](/java/docs/reference/google-cloud-workstations/0.16.0/com.google.cloud.workstations.v1beta.LocationName)>`
