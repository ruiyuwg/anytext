...
# Interface FetchDatabasePropertiesResponseOrBuilder (1.44.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface FetchDatabasePropertiesResponseOrBuilder extends MessageOrBuilder
```
...
```
public abstract boolean getIsFailoverReplicaAvailable()
```
...
```
public abstract String getPrimaryGceZone()
```
...
```
public abstract ByteString getPrimaryGceZoneBytes()
```
...
```
public abstract String getSecondaryGceZone()
```
...
```
public abstract ByteString getSecondaryGceZoneBytes()
```
