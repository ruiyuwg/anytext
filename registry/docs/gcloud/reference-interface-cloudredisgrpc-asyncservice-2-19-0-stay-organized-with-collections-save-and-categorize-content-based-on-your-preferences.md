...
# Interface CloudRedisGrpc.AsyncService (2.19.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[CreateInstanceRequest](/java/docs/reference/google-cloud-redis/2.19.0/com.google.cloud.redis.v1beta1.CreateInstanceRequest)`  
...
`[DeleteInstanceRequest](/java/docs/reference/google-cloud-redis/2.19.0/com.google.cloud.redis.v1beta1.DeleteInstanceRequest)`  
...
`[ExportInstanceRequest](/java/docs/reference/google-cloud-redis/2.19.0/com.google.cloud.redis.v1beta1.ExportInstanceRequest)`  
...
`[FailoverInstanceRequest](/java/docs/reference/google-cloud-redis/2.19.0/com.google.cloud.redis.v1beta1.FailoverInstanceRequest)`  
...
`[GetInstanceRequest](/java/docs/reference/google-cloud-redis/2.19.0/com.google.cloud.redis.v1beta1.GetInstanceRequest)`  

`responseObserver`

`io.grpc.stub.StreamObserver<[Instance](/java/docs/reference/google-cloud-redis/2.19.0/com.google.cloud.redis.v1beta1.Instance)>`  
...
`[GetInstanceAuthStringRequest](/java/docs/reference/google-cloud-redis/2.19.0/com.google.cloud.redis.v1beta1.GetInstanceAuthStringRequest)`  

`responseObserver`

`io.grpc.stub.StreamObserver<[InstanceAuthString](/java/docs/reference/google-cloud-redis/2.19.0/com.google.cloud.redis.v1beta1.InstanceAuthString)>`  
...
`[ImportInstanceRequest](/java/docs/reference/google-cloud-redis/2.19.0/com.google.cloud.redis.v1beta1.ImportInstanceRequest)`  
...
`[ListInstancesRequest](/java/docs/reference/google-cloud-redis/2.19.0/com.google.cloud.redis.v1beta1.ListInstancesRequest)`  

`responseObserver`

`io.grpc.stub.StreamObserver<[ListInstancesResponse](/java/docs/reference/google-cloud-redis/2.19.0/com.google.cloud.redis.v1beta1.ListInstancesResponse)>`  
...
`[RescheduleMaintenanceRequest](/java/docs/reference/google-cloud-redis/2.19.0/com.google.cloud.redis.v1beta1.RescheduleMaintenanceRequest)`  
...
`[UpdateInstanceRequest](/java/docs/reference/google-cloud-redis/2.19.0/com.google.cloud.redis.v1beta1.UpdateInstanceRequest)`  
...
`[UpgradeInstanceRequest](/java/docs/reference/google-cloud-redis/2.19.0/com.google.cloud.redis.v1beta1.UpgradeInstanceRequest)`  
