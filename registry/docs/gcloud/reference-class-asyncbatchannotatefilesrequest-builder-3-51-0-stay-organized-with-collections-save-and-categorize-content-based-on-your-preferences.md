...
# Class AsyncBatchAnnotateFilesRequest.Builder (3.51.0) Stay organized with collections Save and categorize content based on your preferences.
...
Protobuf type `google.cloud.vision.v1p3beta1.AsyncBatchAnnotateFilesRequest`
...
[AsyncBatchAnnotateFilesRequestOrBuilder](/java/docs/reference/google-cloud-vision/3.51.0/com.google.cloud.vision.v1p3beta1.AsyncBatchAnnotateFilesRequestOrBuilder)
...
`[Iterable](https://docs.oracle.com/javase/8/docs/api/java/lang/Iterable.html)<? extends com.google.cloud.vision.v1p3beta1.AsyncAnnotateFileRequest>`  
...
`[AsyncBatchAnnotateFilesRequest.Builder](/java/docs/reference/google-cloud-vision/3.51.0/com.google.cloud.vision.v1p3beta1.AsyncBatchAnnotateFilesRequest.Builder)`
...
`[AsyncAnnotateFileRequest](/java/docs/reference/google-cloud-vision/3.51.0/com.google.cloud.vision.v1p3beta1.AsyncAnnotateFileRequest)`  
...
`[AsyncAnnotateFileRequest.Builder](/java/docs/reference/google-cloud-vision/3.51.0/com.google.cloud.vision.v1p3beta1.AsyncAnnotateFileRequest.Builder)`  
...
`[AsyncBatchAnnotateFilesRequest](/java/docs/reference/google-cloud-vision/3.51.0/com.google.cloud.vision.v1p3beta1.AsyncBatchAnnotateFilesRequest)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Builder](/java/docs/reference/google-cloud-vision/3.51.0/com.google.cloud.vision.v1p3beta1.AsyncAnnotateFileRequest.Builder)>`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[AsyncAnnotateFileRequest](/java/docs/reference/google-cloud-vision/3.51.0/com.google.cloud.vision.v1p3beta1.AsyncAnnotateFileRequest)>`
...
`[AsyncAnnotateFileRequestOrBuilder](/java/docs/reference/google-cloud-vision/3.51.0/com.google.cloud.vision.v1p3beta1.AsyncAnnotateFileRequestOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.vision.v1p3beta1.AsyncAnnotateFileRequestOrBuilder>`
