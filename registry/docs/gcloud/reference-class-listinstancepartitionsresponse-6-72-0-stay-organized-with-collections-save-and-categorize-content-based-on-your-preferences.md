...
# Class ListInstancePartitionsResponse (6.72.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListInstancePartitionsResponse extends GeneratedMessageV3 implements ListInstancePartitionsResponseOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListInstancePartitionsResponse

## Implements

[ListInstancePartitionsResponseOrBuilder](/java/docs/reference/google-cloud-spanner/6.72.0/com.google.spanner.admin.instance.v1.ListInstancePartitionsResponseOrBuilder)
...
### INSTANCE\_PARTITIONS\_FIELD\_NUMBER
...
```
public static ListInstancePartitionsResponse getDefaultInstance()
```
...
`[ListInstancePartitionsResponse](/java/docs/reference/google-cloud-spanner/6.72.0/com.google.spanner.admin.instance.v1.ListInstancePartitionsResponse)`
...
```
public static ListInstancePartitionsResponse.Builder newBuilder()
```
...
`[ListInstancePartitionsResponse.Builder](/java/docs/reference/google-cloud-spanner/6.72.0/com.google.spanner.admin.instance.v1.ListInstancePartitionsResponse.Builder)`

### newBuilder(ListInstancePartitionsResponse prototype)

```
public static ListInstancePartitionsResponse.Builder newBuilder(ListInstancePartitionsResponse prototype)
```
...
```
public static ListInstancePartitionsResponse parseDelimitedFrom(InputStream input)
```
...
```
public static ListInstancePartitionsResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListInstancePartitionsResponse parseFrom(byte[] data)
```
...
```
public static ListInstancePartitionsResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListInstancePartitionsResponse parseFrom(ByteString data)
```
...
```
public static ListInstancePartitionsResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListInstancePartitionsResponse parseFrom(CodedInputStream input)
```
...
```
public static ListInstancePartitionsResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListInstancePartitionsResponse parseFrom(InputStream input)
```
...
```
public static ListInstancePartitionsResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListInstancePartitionsResponse parseFrom(ByteBuffer data)
```
...
```
public static ListInstancePartitionsResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ListInstancePartitionsResponse> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListInstancePartitionsResponse](/java/docs/reference/google-cloud-spanner/6.72.0/com.google.spanner.admin.instance.v1.ListInstancePartitionsResponse)>`
...
`[InstancePartition](/java/docs/reference/google-cloud-spanner/6.72.0/com.google.spanner.admin.instance.v1.InstancePartition)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[InstancePartition](/java/docs/reference/google-cloud-spanner/6.72.0/com.google.spanner.admin.instance.v1.InstancePartition)>`
...
`[InstancePartitionOrBuilder](/java/docs/reference/google-cloud-spanner/6.72.0/com.google.spanner.admin.instance.v1.InstancePartitionOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.spanner.admin.instance.v1.InstancePartitionOrBuilder>`
...
```
public Parser<ListInstancePartitionsResponse> getParserForType()
```
...
The list of unreachable instance partitions. It includes the names of instance partitions whose metadata could not be retrieved within instance\_partition\_deadline.
...
```
public ListInstancePartitionsResponse.Builder newBuilderForType()
```
...
```
protected ListInstancePartitionsResponse.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ListInstancePartitionsResponse.Builder toBuilder()
```
