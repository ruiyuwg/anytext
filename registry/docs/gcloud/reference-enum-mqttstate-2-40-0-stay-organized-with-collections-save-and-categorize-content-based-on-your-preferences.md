...
# Enum MqttState (2.40.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-iot/2.40.0/com.google.cloud.iot.v1.MqttState#com_google_cloud_iot_v1_MqttState_forNumber_int_) instead._
