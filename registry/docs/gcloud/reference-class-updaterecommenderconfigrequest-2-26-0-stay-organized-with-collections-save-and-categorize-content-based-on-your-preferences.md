...
# Class UpdateRecommenderConfigRequest (2.26.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> UpdateRecommenderConfigRequest

## Implements

[UpdateRecommenderConfigRequestOrBuilder](/java/docs/reference/google-cloud-recommender/2.26.0/com.google.cloud.recommender.v1beta1.UpdateRecommenderConfigRequestOrBuilder)
...
### RECOMMENDER\_CONFIG\_FIELD\_NUMBER

```
public static final int RECOMMENDER_CONFIG_FIELD_NUMBER
```
...
`[UpdateRecommenderConfigRequest](/java/docs/reference/google-cloud-recommender/2.26.0/com.google.cloud.recommender.v1beta1.UpdateRecommenderConfigRequest)`
...
```
public static UpdateRecommenderConfigRequest.Builder newBuilder()
```
...
`[UpdateRecommenderConfigRequest.Builder](/java/docs/reference/google-cloud-recommender/2.26.0/com.google.cloud.recommender.v1beta1.UpdateRecommenderConfigRequest.Builder)`

### newBuilder(UpdateRecommenderConfigRequest prototype)

```
public static UpdateRecommenderConfigRequest.Builder newBuilder(UpdateRecommenderConfigRequest prototype)
```
...
```
public static UpdateRecommenderConfigRequest parseDelimitedFrom(InputStream input)
```
...
```
public static UpdateRecommenderConfigRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateRecommenderConfigRequest parseFrom(byte[] data)
```
...
```
public static UpdateRecommenderConfigRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateRecommenderConfigRequest parseFrom(ByteString data)
```
...
```
public static UpdateRecommenderConfigRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateRecommenderConfigRequest parseFrom(CodedInputStream input)
```
...
```
public static UpdateRecommenderConfigRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateRecommenderConfigRequest parseFrom(InputStream input)
```
...
```
public static UpdateRecommenderConfigRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateRecommenderConfigRequest parseFrom(ByteBuffer data)
```
...
```
public static UpdateRecommenderConfigRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[UpdateRecommenderConfigRequest](/java/docs/reference/google-cloud-recommender/2.26.0/com.google.cloud.recommender.v1beta1.UpdateRecommenderConfigRequest)>`
...
```
public UpdateRecommenderConfigRequest getDefaultInstanceForType()
```
...
`[RecommenderConfig](/java/docs/reference/google-cloud-recommender/2.26.0/com.google.cloud.recommender.v1beta1.RecommenderConfig)`
...
`[RecommenderConfigOrBuilder](/java/docs/reference/google-cloud-recommender/2.26.0/com.google.cloud.recommender.v1beta1.RecommenderConfigOrBuilder)`
...
```
public UpdateRecommenderConfigRequest.Builder newBuilderForType()
```
...
```
protected UpdateRecommenderConfigRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public UpdateRecommenderConfigRequest.Builder toBuilder()
```
