...
# Enum SparkChartType (2.51.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum SparkChartType extends Enum<SparkChartType> implements ProtocolMessageEnum
```
...
`SPARK_CHART_TYPE_UNSPECIFIED_VALUE`
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-monitoring-dashboard/2.51.0/com.google.monitoring.dashboard.v1.SparkChartType#com_google_monitoring_dashboard_v1_SparkChartType_forNumber_int_) instead._
