...
# Enum AssetReference.AssetValidationState (0.38.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-private-catalog/0.38.0/com.google.cloud.privatecatalog.v1beta1.AssetReference.AssetValidationState#com_google_cloud_privatecatalog_v1beta1_AssetReference_AssetValidationState_forNumber_int_) instead._
