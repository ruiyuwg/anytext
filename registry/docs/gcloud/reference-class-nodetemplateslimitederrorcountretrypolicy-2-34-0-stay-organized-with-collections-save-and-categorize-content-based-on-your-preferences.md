...
# Class NodeTemplatesLimitedErrorCountRetryPolicy (2.34.0) Stay organized with collections Save and categorize content based on your preferences.
...
A retry policy for [`NodeTemplatesConnection`](/cpp/docs/reference/compute/2.34.0/classgoogle_1_1cloud_1_1compute__node__templates__v1_1_1NodeTemplatesConnection) based on counting errors.
...
`NodeTemplatesLimitedErrorCountRetryPolicy const &`  
...
`std::unique_ptr< NodeTemplatesRetryPolicy >`

## Type Aliases

### BaseType

**Alias Of**: `NodeTemplatesRetryPolicy`
