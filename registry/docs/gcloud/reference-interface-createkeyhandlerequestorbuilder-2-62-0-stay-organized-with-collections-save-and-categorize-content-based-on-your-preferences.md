...
# Interface CreateKeyHandleRequestOrBuilder (2.62.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface CreateKeyHandleRequestOrBuilder extends MessageOrBuilder
```
...
`[KeyHandle](/java/docs/reference/google-cloud-kms/2.62.0/com.google.cloud.kms.v1.KeyHandle)`
...
```
public abstract String getKeyHandleId()
```
...
```
public abstract ByteString getKeyHandleIdBytes()
```
...
```
public abstract KeyHandleOrBuilder getKeyHandleOrBuilder()
```
...
`[KeyHandleOrBuilder](/java/docs/reference/google-cloud-kms/2.62.0/com.google.cloud.kms.v1.KeyHandleOrBuilder)`
...
```
public abstract boolean hasKeyHandle()
```
