...
# google-cloud-dataproc overview (4.84.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Dataproc Product Reference](https://cloud.google.com/dataproc)

[GitHub Repository](https://github.com/googleapis/google-cloud-java/tree/main/java-dataproc)

[Maven artifact](https://central.sonatype.com/artifact/com.google.cloud/google-cloud-dataproc)
...
-   [Enable the API](https://console.cloud.google.com/apis/library/dataproc.googleapis.com)
...
libraryDependencies += "com.google.cloud" % "google-cloud-dataproc" % "4.84.0"

## Which version ID should I get started with?

For this library, we recommend using [com.google.cloud.dataproc.v1](https://cloud.google.com/java/docs/reference/google-cloud-dataproc/4.84.0/com.google.cloud.dataproc.v1) for new applications.
