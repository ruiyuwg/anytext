...
# google-cloud-gkehub overview (1.87.0) Stay organized with collections Save and categorize content based on your preferences.
...
**GKE Hub API Description:** Provides a unified way to work with Kubernetes clusters as part of Anthos, extending GKE to work in multiple environments. You have consistent, unified, and secure infrastructure, cluster, and container management, whether you're using Anthos on Google Cloud (with traditional GKE), hybrid cloud, or multiple public clouds.

[GKE Hub API Product Reference](https://cloud.google.com/anthos/gke/docs/)

[GitHub Repository](https://github.com/googleapis/google-cloud-java/tree/main/java-gkehub)

[Maven artifact](https://central.sonatype.com/artifact/com.google.cloud/google-cloud-gkehub)
...
-   [Enable the API](https://console.cloud.google.com/apis/library/gkehub.googleapis.com)
-   [Set up authentication](https://cloud.google.com/docs/authentication/client-libraries)

## Use the GKE Hub API for Java
...
The example below demonstrates how you would import the BOM and include the `google-cloud-gkehub` artifact.
...
For this library, we recommend using [com.google.cloud.gkehub.rbacrolebindingactuation.v1](https://cloud.google.com/java/docs/reference/google-cloud-gkehub/1.87.0/com.google.cloud.gkehub.rbacrolebindingactuation.v1) for new applications.
