...
# Class DeleteJobRequest (0.58.0) Stay organized with collections Save and categorize content based on your preferences.
...
[DeleteJobRequestOrBuilder](/java/docs/reference/google-cloud-run/0.58.0/com.google.cloud.run.v2.DeleteJobRequestOrBuilder)
...
`[DeleteJobRequest](/java/docs/reference/google-cloud-run/0.58.0/com.google.cloud.run.v2.DeleteJobRequest)`
...
`[DeleteJobRequest.Builder](/java/docs/reference/google-cloud-run/0.58.0/com.google.cloud.run.v2.DeleteJobRequest.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[DeleteJobRequest](/java/docs/reference/google-cloud-run/0.58.0/com.google.cloud.run.v2.DeleteJobRequest)>`
