...
# Enum Inventory.Item.OriginType (2.42.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-os-config/2.42.0/com.google.cloud.osconfig.v1alpha.Inventory.Item.OriginType#com_google_cloud_osconfig_v1alpha_Inventory_Item_OriginType_forNumber_int_) instead._
