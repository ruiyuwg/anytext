...
# Class SecurityPosture (2.59.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> SecurityPosture

## Implements

[SecurityPostureOrBuilder](/java/docs/reference/google-cloud-securitycenter/2.59.0/com.google.cloud.securitycenter.v1.SecurityPostureOrBuilder)
...
### CHANGED\_POLICY\_FIELD\_NUMBER
...
### POLICY\_DRIFT\_DETAILS\_FIELD\_NUMBER
...
### POSTURE\_DEPLOYMENT\_FIELD\_NUMBER
...
### POSTURE\_DEPLOYMENT\_RESOURCE\_FIELD\_NUMBER
...
`[SecurityPosture](/java/docs/reference/google-cloud-securitycenter/2.59.0/com.google.cloud.securitycenter.v1.SecurityPosture)`
...
`[SecurityPosture.Builder](/java/docs/reference/google-cloud-securitycenter/2.59.0/com.google.cloud.securitycenter.v1.SecurityPosture.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[SecurityPosture](/java/docs/reference/google-cloud-securitycenter/2.59.0/com.google.cloud.securitycenter.v1.SecurityPosture)>`
...
`[SecurityPosture.PolicyDriftDetails](/java/docs/reference/google-cloud-securitycenter/2.59.0/com.google.cloud.securitycenter.v1.SecurityPosture.PolicyDriftDetails)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[PolicyDriftDetails](/java/docs/reference/google-cloud-securitycenter/2.59.0/com.google.cloud.securitycenter.v1.SecurityPosture.PolicyDriftDetails)>`
...
`[SecurityPosture.PolicyDriftDetailsOrBuilder](/java/docs/reference/google-cloud-securitycenter/2.59.0/com.google.cloud.securitycenter.v1.SecurityPosture.PolicyDriftDetailsOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.securitycenter.v1.SecurityPosture.PolicyDriftDetailsOrBuilder>`
