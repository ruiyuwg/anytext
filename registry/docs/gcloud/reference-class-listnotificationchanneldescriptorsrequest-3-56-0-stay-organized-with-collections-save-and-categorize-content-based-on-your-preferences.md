...
# Class ListNotificationChannelDescriptorsRequest (3.56.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListNotificationChannelDescriptorsRequest extends GeneratedMessageV3 implements ListNotificationChannelDescriptorsRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListNotificationChannelDescriptorsRequest

## Implements

[ListNotificationChannelDescriptorsRequestOrBuilder](/java/docs/reference/google-cloud-monitoring/3.56.0/com.google.monitoring.v3.ListNotificationChannelDescriptorsRequestOrBuilder)
...
```
public static ListNotificationChannelDescriptorsRequest getDefaultInstance()
```
...
`[ListNotificationChannelDescriptorsRequest](/java/docs/reference/google-cloud-monitoring/3.56.0/com.google.monitoring.v3.ListNotificationChannelDescriptorsRequest)`
...
```
public static ListNotificationChannelDescriptorsRequest.Builder newBuilder()
```
...
`[ListNotificationChannelDescriptorsRequest.Builder](/java/docs/reference/google-cloud-monitoring/3.56.0/com.google.monitoring.v3.ListNotificationChannelDescriptorsRequest.Builder)`

### newBuilder(ListNotificationChannelDescriptorsRequest prototype)

```
public static ListNotificationChannelDescriptorsRequest.Builder newBuilder(ListNotificationChannelDescriptorsRequest prototype)
```
...
```
public static ListNotificationChannelDescriptorsRequest parseDelimitedFrom(InputStream input)
```
...
```
public static ListNotificationChannelDescriptorsRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListNotificationChannelDescriptorsRequest parseFrom(byte[] data)
```
...
```
public static ListNotificationChannelDescriptorsRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListNotificationChannelDescriptorsRequest parseFrom(ByteString data)
```
...
```
public static ListNotificationChannelDescriptorsRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListNotificationChannelDescriptorsRequest parseFrom(CodedInputStream input)
```
...
```
public static ListNotificationChannelDescriptorsRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListNotificationChannelDescriptorsRequest parseFrom(InputStream input)
```
...
```
public static ListNotificationChannelDescriptorsRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListNotificationChannelDescriptorsRequest parseFrom(ByteBuffer data)
```
...
```
public static ListNotificationChannelDescriptorsRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ListNotificationChannelDescriptorsRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListNotificationChannelDescriptorsRequest](/java/docs/reference/google-cloud-monitoring/3.56.0/com.google.monitoring.v3.ListNotificationChannelDescriptorsRequest)>`
...
Note that this [names](https://cloud.google.com/monitoring/api/v3#project_name) the parent container in which to look for the descriptors; to retrieve a single descriptor by name, use the GetNotificationChannelDescriptor operation, instead.
...
```
public Parser<ListNotificationChannelDescriptorsRequest> getParserForType()
```
...
```
public ListNotificationChannelDescriptorsRequest.Builder newBuilderForType()
```
...
```
protected ListNotificationChannelDescriptorsRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ListNotificationChannelDescriptorsRequest.Builder toBuilder()
```
