...
# Enum Overlay.Animation.AnimationTypeCase (1.39.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum Overlay.Animation.AnimationTypeCase extends Enum<Overlay.Animation.AnimationTypeCase> implements Internal.EnumLite, AbstractMessageLite.InternalOneOfEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-video-transcoder/1.39.0/com.google.cloud.video.transcoder.v1.Overlay.Animation.AnimationTypeCase#com_google_cloud_video_transcoder_v1_Overlay_Animation_AnimationTypeCase_forNumber_int_) instead._
