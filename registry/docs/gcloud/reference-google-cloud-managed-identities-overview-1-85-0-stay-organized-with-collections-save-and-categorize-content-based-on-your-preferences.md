...
# google-cloud-managed-identities overview (1.85.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Managed Service for Microsoft Active Directory Description:** Is a highly available, hardened Google Cloud service running actual Microsoft AD that enables you to manage authentication and authorization for your AD-dependent workloads, automate AD server maintenance and security configuration, and connect your on-premises AD domain to the cloud.

[Managed Service for Microsoft Active Directory Product Reference](https://cloud.google.com/managed-microsoft-ad/)

[GitHub Repository](https://github.com/googleapis/google-cloud-java/tree/main/java-managed-identities)

[Maven artifact](https://central.sonatype.com/artifact/com.google.cloud/google-cloud-managed-identities)
...
-   [Enable the API](https://console.cloud.google.com/apis/library/managedidentities.googleapis.com)
-   [Set up authentication](https://cloud.google.com/docs/authentication/client-libraries)

## Use the Managed Service for Microsoft Active Directory for Java
...
The example below demonstrates how you would import the BOM and include the `google-cloud-managed-identities` artifact.
...
For this library, we recommend using [com.google.cloud.managedidentities.v1](https://cloud.google.com/java/docs/reference/google-cloud-managed-identities/1.85.0/com.google.cloud.managedidentities.v1) for new applications.
