...
# Compute V1 Client - Class WeightError (1.28.0) Stay organized with collections Save and categorize content based on your preferences.
...
WeightError contains string constants that represent the names of each value in the google.cloud.compute.v1.HealthStatus.WeightError descriptor.

## Namespace

Google \\ Cloud \\ Compute \\ V1 \\ Enums \\ HealthStatus

## Constants

### UNDEFINED\_WEIGHT\_ERROR

```
Value: 'UNDEFINED_WEIGHT_ERROR'
```
