...
# Class EnvironmentName (1.56.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> EnvironmentName
...
### format(String project, String location, String environment)
...
`[EnvironmentName.Builder](/java/docs/reference/google-cloud-orchestration-airflow/1.56.0/com.google.cloud.orchestration.airflow.service.v1.EnvironmentName.Builder)`

### of(String project, String location, String environment)
...
`[EnvironmentName](/java/docs/reference/google-cloud-orchestration-airflow/1.56.0/com.google.cloud.orchestration.airflow.service.v1.EnvironmentName)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[EnvironmentName](/java/docs/reference/google-cloud-orchestration-airflow/1.56.0/com.google.cloud.orchestration.airflow.service.v1.EnvironmentName)>`
