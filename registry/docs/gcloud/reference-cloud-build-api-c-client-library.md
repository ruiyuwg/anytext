...
An idiomatic C++ client library for the [Cloud Build API](https://cloud.google.com/build), a service that executes your builds on Google Cloud Platform's infrastructure.
...
-   [`cloudbuild_v1::CloudBuildClient`](/cpp/docs/reference/cloudbuild/2.11.0/classgoogle_1_1cloud_1_1cloudbuild__v1_1_1CloudBuildClient)
-   [`cloudbuild_v2::RepositoryManagerClient`](/cpp/docs/reference/cloudbuild/2.11.0/classgoogle_1_1cloud_1_1cloudbuild__v2_1_1RepositoryManagerClient)
...
-   [How to Override the Default Endpoint](/cpp/docs/reference/cloudbuild/2.11.0/cloudbuild-override-endpoint) - describes how to override the default endpoint.
-   [How to Override the Authentication Credentials](/cpp/docs/reference/cloudbuild/2.11.0/cloudbuild-override-authentication) - describes how to change the authentication credentials used by the library.
-   [Environment Variables](/cpp/docs/reference/cloudbuild/2.11.0/cloudbuild-env) - describes environment variables that can configure the behavior of the library.
