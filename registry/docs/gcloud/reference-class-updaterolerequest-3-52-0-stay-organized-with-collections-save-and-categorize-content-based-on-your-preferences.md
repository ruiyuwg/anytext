...
# Class UpdateRoleRequest (3.52.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class UpdateRoleRequest extends GeneratedMessageV3 implements UpdateRoleRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> UpdateRoleRequest

## Implements

[UpdateRoleRequestOrBuilder](/java/docs/reference/google-iam-admin/3.52.0/com.google.iam.admin.v1.UpdateRoleRequestOrBuilder)
...
```
public static UpdateRoleRequest getDefaultInstance()
```
...
`[UpdateRoleRequest](/java/docs/reference/google-iam-admin/3.52.0/com.google.iam.admin.v1.UpdateRoleRequest)`
...
```
public static UpdateRoleRequest.Builder newBuilder()
```
...
`[UpdateRoleRequest.Builder](/java/docs/reference/google-iam-admin/3.52.0/com.google.iam.admin.v1.UpdateRoleRequest.Builder)`

### newBuilder(UpdateRoleRequest prototype)

```
public static UpdateRoleRequest.Builder newBuilder(UpdateRoleRequest prototype)
```
...
```
public static UpdateRoleRequest parseDelimitedFrom(InputStream input)
```
...
```
public static UpdateRoleRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateRoleRequest parseFrom(byte[] data)
```
...
```
public static UpdateRoleRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateRoleRequest parseFrom(ByteString data)
```
...
```
public static UpdateRoleRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateRoleRequest parseFrom(CodedInputStream input)
```
...
```
public static UpdateRoleRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateRoleRequest parseFrom(InputStream input)
```
...
```
public static UpdateRoleRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateRoleRequest parseFrom(ByteBuffer data)
```
...
```
public static UpdateRoleRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<UpdateRoleRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[UpdateRoleRequest](/java/docs/reference/google-iam-admin/3.52.0/com.google.iam.admin.v1.UpdateRoleRequest)>`
...
```
public Parser<UpdateRoleRequest> getParserForType()
```
...
`[Role](/java/docs/reference/google-iam-admin/3.52.0/com.google.iam.admin.v1.Role)`
...
`[RoleOrBuilder](/java/docs/reference/google-iam-admin/3.52.0/com.google.iam.admin.v1.RoleOrBuilder)`
...
```
public UpdateRoleRequest.Builder newBuilderForType()
```
...
```
protected UpdateRoleRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
