...
# Class EventServiceSettings (2.14.0) Stay organized with collections Save and categorize content based on your preferences.
...
Settings class to configure an instance of [EventServiceClient](/java/docs/reference/google-cloud-talent/2.14.0/com.google.cloud.talent.v4beta1.EventServiceClient).
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [ClientSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.ClientSettings.html) \> EventServiceSettings
...
### create(EventServiceStubSettings stub)
...
`[EventServiceStubSettings](/java/docs/reference/google-cloud-talent/2.14.0/com.google.cloud.talent.v4.stub.EventServiceStubSettings)`  
...
`[EventServiceSettings](/java/docs/reference/google-cloud-talent/2.14.0/com.google.cloud.talent.v4.EventServiceSettings)`
...
```
public static EventServiceSettings.Builder newBuilder()
```
...
`[EventServiceSettings.Builder](/java/docs/reference/google-cloud-talent/2.14.0/com.google.cloud.talent.v4.EventServiceSettings.Builder)`

### newBuilder(ClientContext clientContext)

```
public static EventServiceSettings.Builder newBuilder(ClientContext clientContext)
```
...
```
public static EventServiceSettings.Builder newHttpJsonBuilder()
```
...
### EventServiceSettings(EventServiceSettings.Builder settingsBuilder)

```
protected EventServiceSettings(EventServiceSettings.Builder settingsBuilder)
```
...
`[UnaryCallSettings](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.html)<[CreateClientEventRequest](/java/docs/reference/google-cloud-talent/2.14.0/com.google.cloud.talent.v4.CreateClientEventRequest),[ClientEvent](/java/docs/reference/google-cloud-talent/2.14.0/com.google.cloud.talent.v4.ClientEvent)>`

### toBuilder()

```
public EventServiceSettings.Builder toBuilder()
```
