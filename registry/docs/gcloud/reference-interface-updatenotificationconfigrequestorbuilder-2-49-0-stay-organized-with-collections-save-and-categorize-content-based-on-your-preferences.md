...
# Interface UpdateNotificationConfigRequestOrBuilder (2.49.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[NotificationConfig](/java/docs/reference/google-cloud-securitycenter/2.49.0/com.google.cloud.securitycenter.v1p1beta1.NotificationConfig)`
...
`[NotificationConfigOrBuilder](/java/docs/reference/google-cloud-securitycenter/2.49.0/com.google.cloud.securitycenter.v1p1beta1.NotificationConfigOrBuilder)`
