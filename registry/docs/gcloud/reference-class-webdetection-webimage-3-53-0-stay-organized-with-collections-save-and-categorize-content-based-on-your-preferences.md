...
# Class WebDetection.WebImage (3.53.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class WebDetection.WebImage extends GeneratedMessageV3 implements WebDetection.WebImageOrBuilder
```

Metadata for online images.

Protobuf type `google.cloud.vision.v1p4beta1.WebDetection.WebImage`
...
[WebDetection.WebImageOrBuilder](/java/docs/reference/google-cloud-vision/3.53.0/com.google.cloud.vision.v1p4beta1.WebDetection.WebImageOrBuilder)
...
```
public static WebDetection.WebImage getDefaultInstance()
```
...
`[WebDetection.WebImage](/java/docs/reference/google-cloud-vision/3.53.0/com.google.cloud.vision.v1p4beta1.WebDetection.WebImage)`
...
```
public static WebDetection.WebImage.Builder newBuilder()
```
...
`[WebDetection.WebImage.Builder](/java/docs/reference/google-cloud-vision/3.53.0/com.google.cloud.vision.v1p4beta1.WebDetection.WebImage.Builder)`

### newBuilder(WebDetection.WebImage prototype)

```
public static WebDetection.WebImage.Builder newBuilder(WebDetection.WebImage prototype)
```
...
```
public static WebDetection.WebImage parseDelimitedFrom(InputStream input)
```
...
```
public static WebDetection.WebImage parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static WebDetection.WebImage parseFrom(byte[] data)
```
...
```
public static WebDetection.WebImage parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static WebDetection.WebImage parseFrom(ByteString data)
```
...
```
public static WebDetection.WebImage parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static WebDetection.WebImage parseFrom(CodedInputStream input)
```
...
```
public static WebDetection.WebImage parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static WebDetection.WebImage parseFrom(InputStream input)
```
...
```
public static WebDetection.WebImage parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static WebDetection.WebImage parseFrom(ByteBuffer data)
```
...
```
public static WebDetection.WebImage parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<WebDetection.WebImage> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[WebImage](/java/docs/reference/google-cloud-vision/3.53.0/com.google.cloud.vision.v1p4beta1.WebDetection.WebImage)>`
...
```
public WebDetection.WebImage getDefaultInstanceForType()
```
...
```
public Parser<WebDetection.WebImage> getParserForType()
```
...
```
public WebDetection.WebImage.Builder newBuilderForType()
```
...
```
protected WebDetection.WebImage.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public WebDetection.WebImage.Builder toBuilder()
```
