...
# Compute V1 Client - Class RegionInstanceGroupManagersSuspendInstancesRequest (1.27.0) Stay organized with collections Save and categorize content based on your preferences.
...
The URLs of one or more instances to suspend. This can be a full URL or a partial URL, such as zones/\[ZONE\]/instances/\[INSTANCE\_NAME\].
