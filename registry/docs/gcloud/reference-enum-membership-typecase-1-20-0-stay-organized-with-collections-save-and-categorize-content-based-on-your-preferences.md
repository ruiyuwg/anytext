...
# Enum Membership.TypeCase (1.20.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum Membership.TypeCase extends Enum<Membership.TypeCase> implements Internal.EnumLite, AbstractMessageLite.InternalOneOfEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-gkehub/1.20.0/com.google.cloud.gkehub.v1.Membership.TypeCase#com_google_cloud_gkehub_v1_Membership_TypeCase_forNumber_int_) instead._
