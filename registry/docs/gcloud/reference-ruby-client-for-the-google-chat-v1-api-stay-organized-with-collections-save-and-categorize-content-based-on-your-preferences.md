...
# Ruby Client for the Google Chat V1 API Stay organized with collections Save and categorize content based on your preferences.

Version latestkeyboard\_arrow\_down

-   [0.19.0 (latest)](/ruby/docs/reference/google-apps-chat-v1/latest)
-   [0.18.0](/ruby/docs/reference/google-apps-chat-v1/0.18.0)
-   [0.17.0](/ruby/docs/reference/google-apps-chat-v1/0.17.0)
-   [0.16.0](/ruby/docs/reference/google-apps-chat-v1/0.16.0)
-   [0.15.0](/ruby/docs/reference/google-apps-chat-v1/0.15.0)
-   [0.14.0](/ruby/docs/reference/google-apps-chat-v1/0.14.0)
-   [0.13.0](/ruby/docs/reference/google-apps-chat-v1/0.13.0)
-   [0.12.0](/ruby/docs/reference/google-apps-chat-v1/0.12.0)
-   [0.11.1](/ruby/docs/reference/google-apps-chat-v1/0.11.1)
-   [0.10.0](/ruby/docs/reference/google-apps-chat-v1/0.10.0)
-   [0.9.1](/ruby/docs/reference/google-apps-chat-v1/0.9.1)
-   [0.8.0](/ruby/docs/reference/google-apps-chat-v1/0.8.0)
-   [0.7.0](/ruby/docs/reference/google-apps-chat-v1/0.7.0)
-   [0.6.0](/ruby/docs/reference/google-apps-chat-v1/0.6.0)
-   [0.5.1](/ruby/docs/reference/google-apps-chat-v1/0.5.1)
-   [0.4.0](/ruby/docs/reference/google-apps-chat-v1/0.4.0)
-   [0.3.1](/ruby/docs/reference/google-apps-chat-v1/0.3.1)
-   [0.2.0](/ruby/docs/reference/google-apps-chat-v1/0.2.0)
-   [0.1.2](/ruby/docs/reference/google-apps-chat-v1/0.1.2)
...
This gem is a _versioned_ client. It provides basic client classes for a specific version of the Google Chat V1 API. Most users should consider using the main client gem, [google-apps-chat](https://rubygems.org/gems/google-apps-chat). See the section below titled _Which client should I use?_ for more information.

## Installation

```
$ gem install google-apps-chat-v1
```
...
3.  [Enable the API.](https://console.cloud.google.com/apis/library/chat.googleapis.com)
4.  [Set up authentication.](https://docs.cloud.google.com/ruby/docs/reference/google-apps-chat-v1/latest/AUTHENTICATION "Set up authentication.")
...
response \= client.create\_message request

View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-apps-chat-v1/latest) for class and method documentation.

See also the [Product Documentation](https://developers.google.com/chat/concepts) for general usage information.
...
Most modern Ruby client libraries for Google APIs come in two flavors: the main client library with a name such as `google-apps-chat`, and lower-level _versioned_ client libraries with names such as `google-apps-chat-v1`. _In most cases, you should install the main client._
...
You can use a versioned client if you are content with a possibly lower-level class interface, you explicitly want to avoid features provided by the main client, or you want to access a specific service version not be covered by the main client. You can identify versioned client gems because the service version is part of the name, e.g. `google-apps-chat-v1`.
