...
# Class CompletionServiceStubSettings.Builder (2.60.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class CompletionServiceStubSettings.Builder extends StubSettings.Builder<CompletionServiceStubSettings,CompletionServiceStubSettings.Builder>
```
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [StubSettings.Builder](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.StubSettings.Builder.html) \> CompletionServiceStubSettings.Builder
...
`[CompletionServiceStubSettings](/java/docs/reference/google-cloud-retail/2.60.0/com.google.cloud.retail.v2.stub.CompletionServiceStubSettings)`  
...
```
public CompletionServiceStubSettings.Builder applyToAllUnaryMethods(ApiFunction<UnaryCallSettings.Builder<?,?>,Void> settingsUpdater)
```
...
`[CompletionServiceStubSettings.Builder](/java/docs/reference/google-cloud-retail/2.60.0/com.google.cloud.retail.v2.stub.CompletionServiceStubSettings.Builder)`

### build()

```
public CompletionServiceStubSettings build()
```
...
`[Builder](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.Builder.html)<[CompleteQueryRequest](/java/docs/reference/google-cloud-retail/2.60.0/com.google.cloud.retail.v2.CompleteQueryRequest),[CompleteQueryResponse](/java/docs/reference/google-cloud-retail/2.60.0/com.google.cloud.retail.v2.CompleteQueryResponse)>`

### importCompletionDataOperationSettings()

```
public OperationCallSettings.Builder<ImportCompletionDataRequest,ImportCompletionDataResponse,ImportMetadata> importCompletionDataOperationSettings()
```
...
`[Builder](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.OperationCallSettings.Builder.html)<[ImportCompletionDataRequest](/java/docs/reference/google-cloud-retail/2.60.0/com.google.cloud.retail.v2.ImportCompletionDataRequest),[ImportCompletionDataResponse](/java/docs/reference/google-cloud-retail/2.60.0/com.google.cloud.retail.v2.ImportCompletionDataResponse),[ImportMetadata](/java/docs/reference/google-cloud-retail/2.60.0/com.google.cloud.retail.v2.ImportMetadata)>`

### importCompletionDataSettings()

```
public UnaryCallSettings.Builder<ImportCompletionDataRequest,Operation> importCompletionDataSettings()
```
...
`[Builder](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.Builder.html)<[ImportCompletionDataRequest](/java/docs/reference/google-cloud-retail/2.60.0/com.google.cloud.retail.v2.ImportCompletionDataRequest),[Operation](https://cloud.google.com/java/docs/reference/gax/latest/com.google.longrunning.Operation.html)>`
