...
# Class DeleteMetricDescriptorRequest (3.8.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class DeleteMetricDescriptorRequest extends GeneratedMessageV3 implements DeleteMetricDescriptorRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> DeleteMetricDescriptorRequest

## Implements

[DeleteMetricDescriptorRequestOrBuilder](/java/docs/reference/google-cloud-monitoring/3.8.0/com.google.monitoring.v3.DeleteMetricDescriptorRequestOrBuilder)
...
```
public static DeleteMetricDescriptorRequest getDefaultInstance()
```
...
[DeleteMetricDescriptorRequest](/java/docs/reference/google-cloud-monitoring/3.8.0/com.google.monitoring.v3.DeleteMetricDescriptorRequest)
...
```
public static DeleteMetricDescriptorRequest.Builder newBuilder()
```
...
[DeleteMetricDescriptorRequest.Builder](/java/docs/reference/google-cloud-monitoring/3.8.0/com.google.monitoring.v3.DeleteMetricDescriptorRequest.Builder)

### newBuilder(DeleteMetricDescriptorRequest prototype)

```
public static DeleteMetricDescriptorRequest.Builder newBuilder(DeleteMetricDescriptorRequest prototype)
```
...
```
public static DeleteMetricDescriptorRequest parseDelimitedFrom(InputStream input)
```
...
```
public static DeleteMetricDescriptorRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteMetricDescriptorRequest parseFrom(byte[] data)
```
...
```
public static DeleteMetricDescriptorRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteMetricDescriptorRequest parseFrom(ByteString data)
```
...
```
public static DeleteMetricDescriptorRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteMetricDescriptorRequest parseFrom(CodedInputStream input)
```
...
```
public static DeleteMetricDescriptorRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteMetricDescriptorRequest parseFrom(InputStream input)
```
...
```
public static DeleteMetricDescriptorRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteMetricDescriptorRequest parseFrom(ByteBuffer data)
```
...
```
public static DeleteMetricDescriptorRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<DeleteMetricDescriptorRequest> parser()
```
...
[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[DeleteMetricDescriptorRequest](/java/docs/reference/google-cloud-monitoring/3.8.0/com.google.monitoring.v3.DeleteMetricDescriptorRequest)\>
...
```
public DeleteMetricDescriptorRequest getDefaultInstanceForType()
```
...
Required. The metric descriptor on which to execute the request. The format is: projects/\[PROJECT\_ID\_OR\_NUMBER\]/metricDescriptors/\[METRIC\_ID\] An example of `[METRIC_ID]` is: `"custom.googleapis.com/my_test_metric"`.
...
```
public Parser<DeleteMetricDescriptorRequest> getParserForType()
```
...
```
public DeleteMetricDescriptorRequest.Builder newBuilderForType()
```
...
```
protected DeleteMetricDescriptorRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public DeleteMetricDescriptorRequest.Builder toBuilder()
```
