...
# Class DeleteServiceRequest.Builder (0.46.0) Stay organized with collections Save and categorize content based on your preferences.
...
[DeleteServiceRequestOrBuilder](/java/docs/reference/google-cloud-run/0.46.0/com.google.cloud.run.v2.DeleteServiceRequestOrBuilder)
...
`[DeleteServiceRequest.Builder](/java/docs/reference/google-cloud-run/0.46.0/com.google.cloud.run.v2.DeleteServiceRequest.Builder)`
...
`[DeleteServiceRequest](/java/docs/reference/google-cloud-run/0.46.0/com.google.cloud.run.v2.DeleteServiceRequest)`
