...
# Enum Feature (2.40.0) Stay organized with collections Save and categorize content based on your preferences.
...
Protobuf enum `google.cloud.videointelligence.v1p3beta1.Feature`
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-video-intelligence/2.40.0/com.google.cloud.videointelligence.v1p3beta1.Feature#com_google_cloud_videointelligence_v1p3beta1_Feature_forNumber_int_) instead._
