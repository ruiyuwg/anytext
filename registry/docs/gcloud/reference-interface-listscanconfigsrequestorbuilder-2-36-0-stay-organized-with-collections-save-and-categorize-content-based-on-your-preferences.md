...
# Interface ListScanConfigsRequestOrBuilder (2.36.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface ListScanConfigsRequestOrBuilder extends MessageOrBuilder
```
