...
# Class ListUptimeCheckIpsRequest (3.14.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListUptimeCheckIpsRequest extends GeneratedMessageV3 implements ListUptimeCheckIpsRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListUptimeCheckIpsRequest

## Implements

[ListUptimeCheckIpsRequestOrBuilder](/java/docs/reference/google-cloud-monitoring/3.14.0/com.google.monitoring.v3.ListUptimeCheckIpsRequestOrBuilder)
...
```
public static ListUptimeCheckIpsRequest getDefaultInstance()
```
...
`[ListUptimeCheckIpsRequest](/java/docs/reference/google-cloud-monitoring/3.14.0/com.google.monitoring.v3.ListUptimeCheckIpsRequest)`
...
```
public static ListUptimeCheckIpsRequest.Builder newBuilder()
```
...
`[ListUptimeCheckIpsRequest.Builder](/java/docs/reference/google-cloud-monitoring/3.14.0/com.google.monitoring.v3.ListUptimeCheckIpsRequest.Builder)`

### newBuilder(ListUptimeCheckIpsRequest prototype)

```
public static ListUptimeCheckIpsRequest.Builder newBuilder(ListUptimeCheckIpsRequest prototype)
```
...
```
public static ListUptimeCheckIpsRequest parseDelimitedFrom(InputStream input)
```
...
```
public static ListUptimeCheckIpsRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListUptimeCheckIpsRequest parseFrom(byte[] data)
```
...
```
public static ListUptimeCheckIpsRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListUptimeCheckIpsRequest parseFrom(ByteString data)
```
...
```
public static ListUptimeCheckIpsRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListUptimeCheckIpsRequest parseFrom(CodedInputStream input)
```
...
```
public static ListUptimeCheckIpsRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListUptimeCheckIpsRequest parseFrom(InputStream input)
```
...
```
public static ListUptimeCheckIpsRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListUptimeCheckIpsRequest parseFrom(ByteBuffer data)
```
...
```
public static ListUptimeCheckIpsRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ListUptimeCheckIpsRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListUptimeCheckIpsRequest](/java/docs/reference/google-cloud-monitoring/3.14.0/com.google.monitoring.v3.ListUptimeCheckIpsRequest)>`
...
The maximum number of results to return in a single response. The server may further constrain the maximum number of results returned in a single page. If the page\_size is <=0, the server will decide the number of results to be returned. NOTE: this field is not yet implemented
...
```
public Parser<ListUptimeCheckIpsRequest> getParserForType()
```
...
```
public ListUptimeCheckIpsRequest.Builder newBuilderForType()
```
...
```
protected ListUptimeCheckIpsRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ListUptimeCheckIpsRequest.Builder toBuilder()
```
