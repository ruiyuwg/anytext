...
# Enum RouteInfo.RouteScope (1.88.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-network-management/latest/com.google.cloud.networkmanagement.v1.RouteInfo.RouteScope#com_google_cloud_networkmanagement_v1_RouteInfo_RouteScope_forNumber_int_) instead._
