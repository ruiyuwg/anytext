...
# Interface GetMembershipRequestOrBuilder (1.22.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface GetMembershipRequestOrBuilder extends MessageOrBuilder
```
