...
# Class AdaptiveMtFile (2.59.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class AdaptiveMtFile extends GeneratedMessageV3 implements AdaptiveMtFileOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> AdaptiveMtFile

## Implements

[AdaptiveMtFileOrBuilder](/java/docs/reference/google-cloud-translate/2.59.0/com.google.cloud.translate.v3.AdaptiveMtFileOrBuilder)
...
```
public static AdaptiveMtFile getDefaultInstance()
```
...
`[AdaptiveMtFile](/java/docs/reference/google-cloud-translate/2.59.0/com.google.cloud.translate.v3.AdaptiveMtFile)`
...
```
public static AdaptiveMtFile.Builder newBuilder()
```
...
`[AdaptiveMtFile.Builder](/java/docs/reference/google-cloud-translate/2.59.0/com.google.cloud.translate.v3.AdaptiveMtFile.Builder)`

### newBuilder(AdaptiveMtFile prototype)

```
public static AdaptiveMtFile.Builder newBuilder(AdaptiveMtFile prototype)
```
...
```
public static AdaptiveMtFile parseDelimitedFrom(InputStream input)
```
...
```
public static AdaptiveMtFile parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AdaptiveMtFile parseFrom(byte[] data)
```
...
```
public static AdaptiveMtFile parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AdaptiveMtFile parseFrom(ByteString data)
```
...
```
public static AdaptiveMtFile parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AdaptiveMtFile parseFrom(CodedInputStream input)
```
...
```
public static AdaptiveMtFile parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AdaptiveMtFile parseFrom(InputStream input)
```
...
```
public static AdaptiveMtFile parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AdaptiveMtFile parseFrom(ByteBuffer data)
```
...
```
public static AdaptiveMtFile parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<AdaptiveMtFile> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[AdaptiveMtFile](/java/docs/reference/google-cloud-translate/2.59.0/com.google.cloud.translate.v3.AdaptiveMtFile)>`
...
```
public Parser<AdaptiveMtFile> getParserForType()
```
...
```
public AdaptiveMtFile.Builder newBuilderForType()
```
...
```
protected AdaptiveMtFile.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public AdaptiveMtFile.Builder toBuilder()
```
