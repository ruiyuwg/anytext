...
# Class AddPublicKeyResponse (2.47.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class AddPublicKeyResponse extends GeneratedMessageV3 implements AddPublicKeyResponseOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> AddPublicKeyResponse

## Implements

[AddPublicKeyResponseOrBuilder](/java/docs/reference/google-cloud-shell/2.47.0/com.google.cloud.shell.v1.AddPublicKeyResponseOrBuilder)
...
```
public static AddPublicKeyResponse getDefaultInstance()
```
...
`[AddPublicKeyResponse](/java/docs/reference/google-cloud-shell/2.47.0/com.google.cloud.shell.v1.AddPublicKeyResponse)`
...
```
public static AddPublicKeyResponse.Builder newBuilder()
```
...
`[AddPublicKeyResponse.Builder](/java/docs/reference/google-cloud-shell/2.47.0/com.google.cloud.shell.v1.AddPublicKeyResponse.Builder)`

### newBuilder(AddPublicKeyResponse prototype)

```
public static AddPublicKeyResponse.Builder newBuilder(AddPublicKeyResponse prototype)
```
...
```
public static AddPublicKeyResponse parseDelimitedFrom(InputStream input)
```
...
```
public static AddPublicKeyResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AddPublicKeyResponse parseFrom(byte[] data)
```
...
```
public static AddPublicKeyResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AddPublicKeyResponse parseFrom(ByteString data)
```
...
```
public static AddPublicKeyResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AddPublicKeyResponse parseFrom(CodedInputStream input)
```
...
```
public static AddPublicKeyResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AddPublicKeyResponse parseFrom(InputStream input)
```
...
```
public static AddPublicKeyResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AddPublicKeyResponse parseFrom(ByteBuffer data)
```
...
```
public static AddPublicKeyResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<AddPublicKeyResponse> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[AddPublicKeyResponse](/java/docs/reference/google-cloud-shell/2.47.0/com.google.cloud.shell.v1.AddPublicKeyResponse)>`
...
```
public Parser<AddPublicKeyResponse> getParserForType()
```
...
```
public AddPublicKeyResponse.Builder newBuilderForType()
```
...
```
protected AddPublicKeyResponse.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public AddPublicKeyResponse.Builder toBuilder()
```
