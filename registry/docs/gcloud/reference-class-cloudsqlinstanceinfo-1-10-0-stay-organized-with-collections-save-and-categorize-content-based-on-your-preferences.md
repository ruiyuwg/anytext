...
# Class CloudSQLInstanceInfo (1.10.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> CloudSQLInstanceInfo

## Implements

[CloudSQLInstanceInfoOrBuilder](/java/docs/reference/google-cloud-network-management/1.10.0/com.google.cloud.networkmanagement.v1.CloudSQLInstanceInfoOrBuilder)
...
`[CloudSQLInstanceInfo](/java/docs/reference/google-cloud-network-management/1.10.0/com.google.cloud.networkmanagement.v1.CloudSQLInstanceInfo)`
...
```
public static CloudSQLInstanceInfo.Builder newBuilder()
```
...
`[CloudSQLInstanceInfo.Builder](/java/docs/reference/google-cloud-network-management/1.10.0/com.google.cloud.networkmanagement.v1.CloudSQLInstanceInfo.Builder)`

### newBuilder(CloudSQLInstanceInfo prototype)

```
public static CloudSQLInstanceInfo.Builder newBuilder(CloudSQLInstanceInfo prototype)
```
...
```
public static CloudSQLInstanceInfo parseDelimitedFrom(InputStream input)
```
...
```
public static CloudSQLInstanceInfo parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CloudSQLInstanceInfo parseFrom(byte[] data)
```
...
```
public static CloudSQLInstanceInfo parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CloudSQLInstanceInfo parseFrom(ByteString data)
```
...
```
public static CloudSQLInstanceInfo parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CloudSQLInstanceInfo parseFrom(CodedInputStream input)
```
...
```
public static CloudSQLInstanceInfo parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CloudSQLInstanceInfo parseFrom(InputStream input)
```
...
```
public static CloudSQLInstanceInfo parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CloudSQLInstanceInfo parseFrom(ByteBuffer data)
```
...
```
public static CloudSQLInstanceInfo parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[CloudSQLInstanceInfo](/java/docs/reference/google-cloud-network-management/1.10.0/com.google.cloud.networkmanagement.v1.CloudSQLInstanceInfo)>`
...
```
public CloudSQLInstanceInfo.Builder newBuilderForType()
```
...
```
protected CloudSQLInstanceInfo.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public CloudSQLInstanceInfo.Builder toBuilder()
```
