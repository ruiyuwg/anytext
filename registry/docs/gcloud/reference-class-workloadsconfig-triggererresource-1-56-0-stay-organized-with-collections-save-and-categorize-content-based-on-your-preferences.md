...
# Class WorkloadsConfig.TriggererResource (1.56.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class WorkloadsConfig.TriggererResource extends GeneratedMessageV3 implements WorkloadsConfig.TriggererResourceOrBuilder
```

Configuration for resources used by Airflow triggerers.

Protobuf type `google.cloud.orchestration.airflow.service.v1.WorkloadsConfig.TriggererResource`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> WorkloadsConfig.TriggererResource

## Implements

[WorkloadsConfig.TriggererResourceOrBuilder](/java/docs/reference/google-cloud-orchestration-airflow/1.56.0/com.google.cloud.orchestration.airflow.service.v1.WorkloadsConfig.TriggererResourceOrBuilder)
...
```
public static WorkloadsConfig.TriggererResource getDefaultInstance()
```
...
`[WorkloadsConfig.TriggererResource](/java/docs/reference/google-cloud-orchestration-airflow/1.56.0/com.google.cloud.orchestration.airflow.service.v1.WorkloadsConfig.TriggererResource)`
...
```
public static WorkloadsConfig.TriggererResource.Builder newBuilder()
```
...
`[WorkloadsConfig.TriggererResource.Builder](/java/docs/reference/google-cloud-orchestration-airflow/1.56.0/com.google.cloud.orchestration.airflow.service.v1.WorkloadsConfig.TriggererResource.Builder)`

### newBuilder(WorkloadsConfig.TriggererResource prototype)

```
public static WorkloadsConfig.TriggererResource.Builder newBuilder(WorkloadsConfig.TriggererResource prototype)
```
...
```
public static WorkloadsConfig.TriggererResource parseDelimitedFrom(InputStream input)
```
...
```
public static WorkloadsConfig.TriggererResource parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static WorkloadsConfig.TriggererResource parseFrom(byte[] data)
```
...
```
public static WorkloadsConfig.TriggererResource parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static WorkloadsConfig.TriggererResource parseFrom(ByteString data)
```
...
```
public static WorkloadsConfig.TriggererResource parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static WorkloadsConfig.TriggererResource parseFrom(CodedInputStream input)
```
...
```
public static WorkloadsConfig.TriggererResource parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static WorkloadsConfig.TriggererResource parseFrom(InputStream input)
```
...
```
public static WorkloadsConfig.TriggererResource parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static WorkloadsConfig.TriggererResource parseFrom(ByteBuffer data)
```
...
```
public static WorkloadsConfig.TriggererResource parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<WorkloadsConfig.TriggererResource> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[TriggererResource](/java/docs/reference/google-cloud-orchestration-airflow/1.56.0/com.google.cloud.orchestration.airflow.service.v1.WorkloadsConfig.TriggererResource)>`
...
```
public WorkloadsConfig.TriggererResource getDefaultInstanceForType()
```
...
```
public Parser<WorkloadsConfig.TriggererResource> getParserForType()
```
...
```
public WorkloadsConfig.TriggererResource.Builder newBuilderForType()
```
...
```
protected WorkloadsConfig.TriggererResource.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public WorkloadsConfig.TriggererResource.Builder toBuilder()
```
