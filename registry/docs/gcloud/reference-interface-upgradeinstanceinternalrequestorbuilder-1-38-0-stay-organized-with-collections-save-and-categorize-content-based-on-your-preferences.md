...
# Interface UpgradeInstanceInternalRequestOrBuilder (1.38.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface UpgradeInstanceInternalRequestOrBuilder extends MessageOrBuilder
```
