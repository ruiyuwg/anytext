...
# Class TcpRoute.RouteRule.Builder (0.7.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> TcpRoute.RouteRule.Builder

## Implements

[TcpRoute.RouteRuleOrBuilder](/java/docs/reference/google-cloud-networkservices/0.7.0/com.google.cloud.networkservices.v1.TcpRoute.RouteRuleOrBuilder)
...
`[Iterable](https://docs.oracle.com/javase/8/docs/api/java/lang/Iterable.html)<? extends com.google.cloud.networkservices.v1.TcpRoute.RouteMatch>`  
...
`[TcpRoute.RouteRule.Builder](/java/docs/reference/google-cloud-networkservices/0.7.0/com.google.cloud.networkservices.v1.TcpRoute.RouteRule.Builder)`
...
`[TcpRoute.RouteMatch](/java/docs/reference/google-cloud-networkservices/0.7.0/com.google.cloud.networkservices.v1.TcpRoute.RouteMatch)`  
...
`[TcpRoute.RouteMatch.Builder](/java/docs/reference/google-cloud-networkservices/0.7.0/com.google.cloud.networkservices.v1.TcpRoute.RouteMatch.Builder)`  
...
`[TcpRoute.RouteRule](/java/docs/reference/google-cloud-networkservices/0.7.0/com.google.cloud.networkservices.v1.TcpRoute.RouteRule)`
...
`[TcpRoute.RouteAction](/java/docs/reference/google-cloud-networkservices/0.7.0/com.google.cloud.networkservices.v1.TcpRoute.RouteAction)`
...
`[TcpRoute.RouteAction.Builder](/java/docs/reference/google-cloud-networkservices/0.7.0/com.google.cloud.networkservices.v1.TcpRoute.RouteAction.Builder)`
...
`[TcpRoute.RouteActionOrBuilder](/java/docs/reference/google-cloud-networkservices/0.7.0/com.google.cloud.networkservices.v1.TcpRoute.RouteActionOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Builder](/java/docs/reference/google-cloud-networkservices/0.7.0/com.google.cloud.networkservices.v1.TcpRoute.RouteMatch.Builder)>`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[RouteMatch](/java/docs/reference/google-cloud-networkservices/0.7.0/com.google.cloud.networkservices.v1.TcpRoute.RouteMatch)>`
...
`[TcpRoute.RouteMatchOrBuilder](/java/docs/reference/google-cloud-networkservices/0.7.0/com.google.cloud.networkservices.v1.TcpRoute.RouteMatchOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.networkservices.v1.TcpRoute.RouteMatchOrBuilder>`
