...
# Class SectionHeader (2.42.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class SectionHeader extends GeneratedMessageV3 implements SectionHeaderOrBuilder
```
...
Protobuf type `google.monitoring.dashboard.v1.SectionHeader`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> SectionHeader

## Implements

[SectionHeaderOrBuilder](/java/docs/reference/google-cloud-monitoring-dashboard/2.42.0/com.google.monitoring.dashboard.v1.SectionHeaderOrBuilder)
...
### DIVIDER\_BELOW\_FIELD\_NUMBER

```
public static final int DIVIDER_BELOW_FIELD_NUMBER
```
...
`[SectionHeader](/java/docs/reference/google-cloud-monitoring-dashboard/2.42.0/com.google.monitoring.dashboard.v1.SectionHeader)`
...
```
public static SectionHeader.Builder newBuilder()
```
...
`[SectionHeader.Builder](/java/docs/reference/google-cloud-monitoring-dashboard/2.42.0/com.google.monitoring.dashboard.v1.SectionHeader.Builder)`

### newBuilder(SectionHeader prototype)

```
public static SectionHeader.Builder newBuilder(SectionHeader prototype)
```
...
```
public static SectionHeader parseDelimitedFrom(InputStream input)
```
...
```
public static SectionHeader parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SectionHeader parseFrom(byte[] data)
```
...
```
public static SectionHeader parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SectionHeader parseFrom(ByteString data)
```
...
```
public static SectionHeader parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SectionHeader parseFrom(CodedInputStream input)
```
...
```
public static SectionHeader parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SectionHeader parseFrom(InputStream input)
```
...
```
public static SectionHeader parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SectionHeader parseFrom(ByteBuffer data)
```
...
```
public static SectionHeader parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[SectionHeader](/java/docs/reference/google-cloud-monitoring-dashboard/2.42.0/com.google.monitoring.dashboard.v1.SectionHeader)>`
...
```
public SectionHeader.Builder newBuilderForType()
```
...
```
protected SectionHeader.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public SectionHeader.Builder toBuilder()
```
