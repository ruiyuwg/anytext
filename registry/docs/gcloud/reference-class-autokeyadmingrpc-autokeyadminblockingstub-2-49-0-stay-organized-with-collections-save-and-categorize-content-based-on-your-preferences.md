...
# Class AutokeyAdminGrpc.AutokeyAdminBlockingStub (2.49.0) Stay organized with collections Save and categorize content based on your preferences.
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> io.grpc.stub.AbstractStub \> io.grpc.stub.AbstractBlockingStub \> AutokeyAdminGrpc.AutokeyAdminBlockingStub
...
`[AutokeyAdminGrpc.AutokeyAdminBlockingStub](/java/docs/reference/google-cloud-kms/2.49.0/com.google.cloud.kms.v1.AutokeyAdminGrpc.AutokeyAdminBlockingStub)`
...
`[GetAutokeyConfigRequest](/java/docs/reference/google-cloud-kms/2.49.0/com.google.cloud.kms.v1.GetAutokeyConfigRequest)`  
...
`[AutokeyConfig](/java/docs/reference/google-cloud-kms/2.49.0/com.google.cloud.kms.v1.AutokeyConfig)`
...
`[ShowEffectiveAutokeyConfigRequest](/java/docs/reference/google-cloud-kms/2.49.0/com.google.cloud.kms.v1.ShowEffectiveAutokeyConfigRequest)`  
...
`[ShowEffectiveAutokeyConfigResponse](/java/docs/reference/google-cloud-kms/2.49.0/com.google.cloud.kms.v1.ShowEffectiveAutokeyConfigResponse)`
...
`[UpdateAutokeyConfigRequest](/java/docs/reference/google-cloud-kms/2.49.0/com.google.cloud.kms.v1.UpdateAutokeyConfigRequest)`  
