...
# Class CustomConfig.CustomOutputSpec (2.35.0) Stay organized with collections Save and categorize content based on your preferences.
...
[CustomConfig.CustomOutputSpecOrBuilder](/java/docs/reference/google-cloud-securitycenter/2.35.0/com.google.cloud.securitycenter.v1.CustomConfig.CustomOutputSpecOrBuilder)
...
`[CustomConfig.CustomOutputSpec](/java/docs/reference/google-cloud-securitycenter/2.35.0/com.google.cloud.securitycenter.v1.CustomConfig.CustomOutputSpec)`
...
`[CustomConfig.CustomOutputSpec.Builder](/java/docs/reference/google-cloud-securitycenter/2.35.0/com.google.cloud.securitycenter.v1.CustomConfig.CustomOutputSpec.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[CustomOutputSpec](/java/docs/reference/google-cloud-securitycenter/2.35.0/com.google.cloud.securitycenter.v1.CustomConfig.CustomOutputSpec)>`
...
`[CustomConfig.CustomOutputSpec.Property](/java/docs/reference/google-cloud-securitycenter/2.35.0/com.google.cloud.securitycenter.v1.CustomConfig.CustomOutputSpec.Property)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Property](/java/docs/reference/google-cloud-securitycenter/2.35.0/com.google.cloud.securitycenter.v1.CustomConfig.CustomOutputSpec.Property)>`
...
`[CustomConfig.CustomOutputSpec.PropertyOrBuilder](/java/docs/reference/google-cloud-securitycenter/2.35.0/com.google.cloud.securitycenter.v1.CustomConfig.CustomOutputSpec.PropertyOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.securitycenter.v1.CustomConfig.CustomOutputSpec.PropertyOrBuilder>`
