...
# Class SearchRequest.DynamicFacetSpec (2.4.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class SearchRequest.DynamicFacetSpec extends GeneratedMessageV3 implements SearchRequest.DynamicFacetSpecOrBuilder
```

The specifications of dynamically generated facets.

Protobuf type `google.cloud.retail.v2alpha.SearchRequest.DynamicFacetSpec`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> SearchRequest.DynamicFacetSpec

## Implements

[SearchRequest.DynamicFacetSpecOrBuilder](/java/docs/reference/google-cloud-retail/2.4.0/com.google.cloud.retail.v2alpha.SearchRequest.DynamicFacetSpecOrBuilder)
...
```
public static SearchRequest.DynamicFacetSpec getDefaultInstance()
```
...
[SearchRequest.DynamicFacetSpec](/java/docs/reference/google-cloud-retail/2.4.0/com.google.cloud.retail.v2alpha.SearchRequest.DynamicFacetSpec)
...
```
public static SearchRequest.DynamicFacetSpec.Builder newBuilder()
```
...
[SearchRequest.DynamicFacetSpec.Builder](/java/docs/reference/google-cloud-retail/2.4.0/com.google.cloud.retail.v2alpha.SearchRequest.DynamicFacetSpec.Builder)

### newBuilder(SearchRequest.DynamicFacetSpec prototype)

```
public static SearchRequest.DynamicFacetSpec.Builder newBuilder(SearchRequest.DynamicFacetSpec prototype)
```
...
```
public static SearchRequest.DynamicFacetSpec parseDelimitedFrom(InputStream input)
```
...
```
public static SearchRequest.DynamicFacetSpec parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SearchRequest.DynamicFacetSpec parseFrom(byte[] data)
```
...
```
public static SearchRequest.DynamicFacetSpec parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SearchRequest.DynamicFacetSpec parseFrom(ByteString data)
```
...
```
public static SearchRequest.DynamicFacetSpec parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SearchRequest.DynamicFacetSpec parseFrom(CodedInputStream input)
```
...
```
public static SearchRequest.DynamicFacetSpec parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SearchRequest.DynamicFacetSpec parseFrom(InputStream input)
```
...
```
public static SearchRequest.DynamicFacetSpec parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static SearchRequest.DynamicFacetSpec parseFrom(ByteBuffer data)
```
...
```
public static SearchRequest.DynamicFacetSpec parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<SearchRequest.DynamicFacetSpec> parser()
```
...
[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[DynamicFacetSpec](/java/docs/reference/google-cloud-retail/2.4.0/com.google.cloud.retail.v2alpha.SearchRequest.DynamicFacetSpec)\>
...
```
public SearchRequest.DynamicFacetSpec getDefaultInstanceForType()
```
...
```
public SearchRequest.DynamicFacetSpec.Mode getMode()
```
...
[SearchRequest.DynamicFacetSpec.Mode](/java/docs/reference/google-cloud-retail/2.4.0/com.google.cloud.retail.v2alpha.SearchRequest.DynamicFacetSpec.Mode)
...
```
public Parser<SearchRequest.DynamicFacetSpec> getParserForType()
```
...
```
public SearchRequest.DynamicFacetSpec.Builder newBuilderForType()
```
...
```
protected SearchRequest.DynamicFacetSpec.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public SearchRequest.DynamicFacetSpec.Builder toBuilder()
```
