...
# Class AllocateQuotaResponse (1.55.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> AllocateQuotaResponse

## Implements

[AllocateQuotaResponseOrBuilder](/java/docs/reference/google-cloud-service-control/1.55.0/com.google.api.servicecontrol.v1.AllocateQuotaResponseOrBuilder)
...
### ALLOCATE\_ERRORS\_FIELD\_NUMBER
...
### SERVICE\_CONFIG\_ID\_FIELD\_NUMBER
...
`[AllocateQuotaResponse](/java/docs/reference/google-cloud-service-control/1.55.0/com.google.api.servicecontrol.v1.AllocateQuotaResponse)`
...
`[AllocateQuotaResponse.Builder](/java/docs/reference/google-cloud-service-control/1.55.0/com.google.api.servicecontrol.v1.AllocateQuotaResponse.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[AllocateQuotaResponse](/java/docs/reference/google-cloud-service-control/1.55.0/com.google.api.servicecontrol.v1.AllocateQuotaResponse)>`
...
`[QuotaError](/java/docs/reference/google-cloud-service-control/1.55.0/com.google.api.servicecontrol.v1.QuotaError)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[QuotaError](/java/docs/reference/google-cloud-service-control/1.55.0/com.google.api.servicecontrol.v1.QuotaError)>`
...
`[QuotaErrorOrBuilder](/java/docs/reference/google-cloud-service-control/1.55.0/com.google.api.servicecontrol.v1.QuotaErrorOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.api.servicecontrol.v1.QuotaErrorOrBuilder>`
...
The same operation\_id value used in the AllocateQuotaRequest. Used for logging and diagnostics purposes.
...
1.  Per quota group or per quota metric incremental usage will be specified using the following delta metric : "serviceruntime.googleapis.com/api/consumer/quota\_used\_count"
...
`[MetricValueSet](/java/docs/reference/google-cloud-service-control/1.55.0/com.google.api.servicecontrol.v1.MetricValueSet)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[MetricValueSet](/java/docs/reference/google-cloud-service-control/1.55.0/com.google.api.servicecontrol.v1.MetricValueSet)>`
...
`[MetricValueSetOrBuilder](/java/docs/reference/google-cloud-service-control/1.55.0/com.google.api.servicecontrol.v1.MetricValueSetOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.api.servicecontrol.v1.MetricValueSetOrBuilder>`
