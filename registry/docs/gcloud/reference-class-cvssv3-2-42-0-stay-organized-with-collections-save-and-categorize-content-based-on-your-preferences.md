...
# Class CVSSv3 (2.42.0) Stay organized with collections Save and categorize content based on your preferences.
...
Common Vulnerability Scoring System version 3. For details, see [https://www.first.org/cvss/specification-document](https://www.first.org/cvss/specification-document)

Protobuf type `google.cloud.osconfig.v1alpha.CVSSv3`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> CVSSv3

## Implements

[CVSSv3OrBuilder](/java/docs/reference/google-cloud-os-config/2.42.0/com.google.cloud.osconfig.v1alpha.CVSSv3OrBuilder)
...
### ATTACK\_COMPLEXITY\_FIELD\_NUMBER
...
### AVAILABILITY\_IMPACT\_FIELD\_NUMBER
...
### CONFIDENTIALITY\_IMPACT\_FIELD\_NUMBER
...
### EXPLOITABILITY\_SCORE\_FIELD\_NUMBER
...
### INTEGRITY\_IMPACT\_FIELD\_NUMBER
...
### PRIVILEGES\_REQUIRED\_FIELD\_NUMBER
...
### USER\_INTERACTION\_FIELD\_NUMBER
...
`[CVSSv3](/java/docs/reference/google-cloud-os-config/2.42.0/com.google.cloud.osconfig.v1alpha.CVSSv3)`
...
`[CVSSv3.Builder](/java/docs/reference/google-cloud-os-config/2.42.0/com.google.cloud.osconfig.v1alpha.CVSSv3.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[CVSSv3](/java/docs/reference/google-cloud-os-config/2.42.0/com.google.cloud.osconfig.v1alpha.CVSSv3)>`
...
`[CVSSv3.AttackComplexity](/java/docs/reference/google-cloud-os-config/2.42.0/com.google.cloud.osconfig.v1alpha.CVSSv3.AttackComplexity)`
...
`[CVSSv3.AttackVector](/java/docs/reference/google-cloud-os-config/2.42.0/com.google.cloud.osconfig.v1alpha.CVSSv3.AttackVector)`
...
`[CVSSv3.Impact](/java/docs/reference/google-cloud-os-config/2.42.0/com.google.cloud.osconfig.v1alpha.CVSSv3.Impact)`
...
The base score is a function of the base metric scores. [https://www.first.org/cvss/specification-document#Base-Metrics](https://www.first.org/cvss/specification-document#Base-Metrics)
...
The Exploitability sub-score equation is derived from the Base Exploitability metrics. [https://www.first.org/cvss/specification-document#2-1-Exploitability-Metrics](https://www.first.org/cvss/specification-document#2-1-Exploitability-Metrics)
...
`[CVSSv3.PrivilegesRequired](/java/docs/reference/google-cloud-os-config/2.42.0/com.google.cloud.osconfig.v1alpha.CVSSv3.PrivilegesRequired)`
...
`[CVSSv3.Scope](/java/docs/reference/google-cloud-os-config/2.42.0/com.google.cloud.osconfig.v1alpha.CVSSv3.Scope)`
...
`[CVSSv3.UserInteraction](/java/docs/reference/google-cloud-os-config/2.42.0/com.google.cloud.osconfig.v1alpha.CVSSv3.UserInteraction)`
