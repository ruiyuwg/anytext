...
# Enum MuteConfig.MuteConfigType (2.57.0) Stay organized with collections Save and categorize content based on your preferences.
...
Protobuf enum `google.cloud.securitycenter.v1.MuteConfig.MuteConfigType`
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-securitycenter/2.57.0/com.google.cloud.securitycenter.v1.MuteConfig.MuteConfigType#com_google_cloud_securitycenter_v1_MuteConfig_MuteConfigType_forNumber_int_) instead._
