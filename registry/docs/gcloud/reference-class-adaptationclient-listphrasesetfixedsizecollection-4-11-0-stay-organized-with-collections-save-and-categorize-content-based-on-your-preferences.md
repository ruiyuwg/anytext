...
# Class AdaptationClient.ListPhraseSetFixedSizeCollection (4.11.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class AdaptationClient.ListPhraseSetFixedSizeCollection extends AbstractFixedSizeCollection<ListPhraseSetRequest,ListPhraseSetResponse,PhraseSet,AdaptationClient.ListPhraseSetPage,AdaptationClient.ListPhraseSetFixedSizeCollection>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractFixedSizeCollection](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractFixedSizeCollection.html) \> AdaptationClient.ListPhraseSetFixedSizeCollection
...
### createCollection(List<AdaptationClient.ListPhraseSetPage> pages, int collectionSize)

```
protected AdaptationClient.ListPhraseSetFixedSizeCollection createCollection(List<AdaptationClient.ListPhraseSetPage> pages, int collectionSize)
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ListPhraseSetPage](/java/docs/reference/google-cloud-speech/4.11.0/com.google.cloud.speech.v1.AdaptationClient.ListPhraseSetPage)>`  
...
`[AdaptationClient.ListPhraseSetFixedSizeCollection](/java/docs/reference/google-cloud-speech/4.11.0/com.google.cloud.speech.v1.AdaptationClient.ListPhraseSetFixedSizeCollection)`
