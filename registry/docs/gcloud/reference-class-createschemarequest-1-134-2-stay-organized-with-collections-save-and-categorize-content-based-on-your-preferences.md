...
# Class CreateSchemaRequest (1.134.2) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> CreateSchemaRequest

## Implements

[CreateSchemaRequestOrBuilder](/java/docs/reference/google-cloud-pubsub/1.134.2/com.google.pubsub.v1.CreateSchemaRequestOrBuilder)
...
`[CreateSchemaRequest](/java/docs/reference/google-cloud-pubsub/1.134.2/com.google.pubsub.v1.CreateSchemaRequest)`
...
`[CreateSchemaRequest.Builder](/java/docs/reference/google-cloud-pubsub/1.134.2/com.google.pubsub.v1.CreateSchemaRequest.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[CreateSchemaRequest](/java/docs/reference/google-cloud-pubsub/1.134.2/com.google.pubsub.v1.CreateSchemaRequest)>`
...
`[Schema](/java/docs/reference/google-cloud-pubsub/1.134.2/com.google.pubsub.v1.Schema)`
...
See [https://cloud.google.com/pubsub/docs/pubsub-basics#resource\_names](https://cloud.google.com/pubsub/docs/pubsub-basics#resource_names) for resource name constraints.
...
`[SchemaOrBuilder](/java/docs/reference/google-cloud-pubsub/1.134.2/com.google.pubsub.v1.SchemaOrBuilder)`
