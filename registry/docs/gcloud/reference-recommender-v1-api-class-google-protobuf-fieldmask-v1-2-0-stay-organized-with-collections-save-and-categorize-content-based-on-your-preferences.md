...
# Recommender V1 API - Class Google::Protobuf::FieldMask (v1.2.0) Stay organized with collections Save and categorize content based on your preferences.

Version 1.2.0keyboard\_arrow\_down

-   [1.4.1 (latest)](/ruby/docs/reference/google-cloud-recommender-v1/latest/Google-Protobuf-FieldMask)
-   [1.4.0](/ruby/docs/reference/google-cloud-recommender-v1/1.4.0/Google-Protobuf-FieldMask)
-   [1.3.0](/ruby/docs/reference/google-cloud-recommender-v1/1.3.0/Google-Protobuf-FieldMask)
-   [1.2.1](/ruby/docs/reference/google-cloud-recommender-v1/1.2.1/Google-Protobuf-FieldMask)
-   [1.1.0](/ruby/docs/reference/google-cloud-recommender-v1/1.1.0/Google-Protobuf-FieldMask)
-   [1.0.1](/ruby/docs/reference/google-cloud-recommender-v1/1.0.1/Google-Protobuf-FieldMask)
-   [0.18.0](/ruby/docs/reference/google-cloud-recommender-v1/0.18.0/Google-Protobuf-FieldMask)
-   [0.17.2](/ruby/docs/reference/google-cloud-recommender-v1/0.17.2/Google-Protobuf-FieldMask)
-   [0.16.0](/ruby/docs/reference/google-cloud-recommender-v1/0.16.0/Google-Protobuf-FieldMask)
-   [0.15.0](/ruby/docs/reference/google-cloud-recommender-v1/0.15.0/Google-Protobuf-FieldMask)
-   [0.14.0](/ruby/docs/reference/google-cloud-recommender-v1/0.14.0/Google-Protobuf-FieldMask)
-   [0.13.1](/ruby/docs/reference/google-cloud-recommender-v1/0.13.1/Google-Protobuf-FieldMask)
-   [0.12.0](/ruby/docs/reference/google-cloud-recommender-v1/0.12.0/Google-Protobuf-FieldMask)
-   [0.11.0](/ruby/docs/reference/google-cloud-recommender-v1/0.11.0/Google-Protobuf-FieldMask)
-   [0.10.0](/ruby/docs/reference/google-cloud-recommender-v1/0.10.0/Google-Protobuf-FieldMask)
-   [0.9.0](/ruby/docs/reference/google-cloud-recommender-v1/0.9.0/Google-Protobuf-FieldMask)
-   [0.8.6](/ruby/docs/reference/google-cloud-recommender-v1/0.8.6/Google-Protobuf-FieldMask)

Reference documentation and code samples for the Recommender V1 API class Google::Protobuf::FieldMask.
...
-   **value** (::Array<::String>) — The set of field mask paths.
