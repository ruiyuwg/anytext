...
# Class ProtectedResourcesSummaryName (0.19.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> ProtectedResourcesSummaryName
...
`[ProtectedResourcesSummaryName.Builder](/java/docs/reference/google-cloud-kmsinventory/0.19.0/com.google.cloud.kms.inventory.v1.ProtectedResourcesSummaryName.Builder)`
...
`[ProtectedResourcesSummaryName.ProjectLocationKeyRingCryptoKeyCryptoKeyVersionBuilder](/java/docs/reference/google-cloud-kmsinventory/0.19.0/com.google.cloud.kms.inventory.v1.ProtectedResourcesSummaryName.ProjectLocationKeyRingCryptoKeyCryptoKeyVersionBuilder)`
...
`[ProtectedResourcesSummaryName](/java/docs/reference/google-cloud-kmsinventory/0.19.0/com.google.cloud.kms.inventory.v1.ProtectedResourcesSummaryName)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ProtectedResourcesSummaryName](/java/docs/reference/google-cloud-kmsinventory/0.19.0/com.google.cloud.kms.inventory.v1.ProtectedResourcesSummaryName)>`
