...
# Class ListScanConfigsRequest (2.87.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListScanConfigsRequest extends GeneratedMessage implements ListScanConfigsRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessage.html) \> ListScanConfigsRequest

## Implements

[ListScanConfigsRequestOrBuilder](/java/docs/reference/google-cloud-websecurityscanner/latest/com.google.cloud.websecurityscanner.v1alpha.ListScanConfigsRequestOrBuilder)
...
`[ListScanConfigsRequest](/java/docs/reference/google-cloud-websecurityscanner/latest/com.google.cloud.websecurityscanner.v1alpha.ListScanConfigsRequest)`
...
`[ListScanConfigsRequest.Builder](/java/docs/reference/google-cloud-websecurityscanner/latest/com.google.cloud.websecurityscanner.v1alpha.ListScanConfigsRequest.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListScanConfigsRequest](/java/docs/reference/google-cloud-websecurityscanner/latest/com.google.cloud.websecurityscanner.v1alpha.ListScanConfigsRequest)>`
...
```
protected ListScanConfigsRequest.Builder newBuilderForType(AbstractMessage.BuilderParent parent)
```
