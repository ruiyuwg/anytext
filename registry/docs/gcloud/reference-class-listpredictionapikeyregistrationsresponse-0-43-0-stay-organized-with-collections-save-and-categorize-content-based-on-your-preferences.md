...
# Class ListPredictionApiKeyRegistrationsResponse (0.43.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListPredictionApiKeyRegistrationsResponse extends GeneratedMessageV3 implements ListPredictionApiKeyRegistrationsResponseOrBuilder
```

Response message for the `ListPredictionApiKeyRegistrations`.

Protobuf type `google.cloud.recommendationengine.v1beta1.ListPredictionApiKeyRegistrationsResponse`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListPredictionApiKeyRegistrationsResponse

## Implements

[ListPredictionApiKeyRegistrationsResponseOrBuilder](/java/docs/reference/google-cloud-recommendations-ai/0.43.0/com.google.cloud.recommendationengine.v1beta1.ListPredictionApiKeyRegistrationsResponseOrBuilder)
...
### PREDICTION\_API\_KEY\_REGISTRATIONS\_FIELD\_NUMBER

```
public static final int PREDICTION_API_KEY_REGISTRATIONS_FIELD_NUMBER
```
...
```
public static ListPredictionApiKeyRegistrationsResponse getDefaultInstance()
```
...
`[ListPredictionApiKeyRegistrationsResponse](/java/docs/reference/google-cloud-recommendations-ai/0.43.0/com.google.cloud.recommendationengine.v1beta1.ListPredictionApiKeyRegistrationsResponse)`
...
```
public static ListPredictionApiKeyRegistrationsResponse.Builder newBuilder()
```
...
`[ListPredictionApiKeyRegistrationsResponse.Builder](/java/docs/reference/google-cloud-recommendations-ai/0.43.0/com.google.cloud.recommendationengine.v1beta1.ListPredictionApiKeyRegistrationsResponse.Builder)`

### newBuilder(ListPredictionApiKeyRegistrationsResponse prototype)

```
public static ListPredictionApiKeyRegistrationsResponse.Builder newBuilder(ListPredictionApiKeyRegistrationsResponse prototype)
```
...
```
public static ListPredictionApiKeyRegistrationsResponse parseDelimitedFrom(InputStream input)
```
...
```
public static ListPredictionApiKeyRegistrationsResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListPredictionApiKeyRegistrationsResponse parseFrom(byte[] data)
```
...
```
public static ListPredictionApiKeyRegistrationsResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListPredictionApiKeyRegistrationsResponse parseFrom(ByteString data)
```
...
```
public static ListPredictionApiKeyRegistrationsResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListPredictionApiKeyRegistrationsResponse parseFrom(CodedInputStream input)
```
...
```
public static ListPredictionApiKeyRegistrationsResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListPredictionApiKeyRegistrationsResponse parseFrom(InputStream input)
```
...
```
public static ListPredictionApiKeyRegistrationsResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListPredictionApiKeyRegistrationsResponse parseFrom(ByteBuffer data)
```
...
```
public static ListPredictionApiKeyRegistrationsResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ListPredictionApiKeyRegistrationsResponse> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListPredictionApiKeyRegistrationsResponse](/java/docs/reference/google-cloud-recommendations-ai/0.43.0/com.google.cloud.recommendationengine.v1beta1.ListPredictionApiKeyRegistrationsResponse)>`
...
```
public ListPredictionApiKeyRegistrationsResponse getDefaultInstanceForType()
```
...
```
public Parser<ListPredictionApiKeyRegistrationsResponse> getParserForType()
```
...
```
public PredictionApiKeyRegistration getPredictionApiKeyRegistrations(int index)
```
...
`[PredictionApiKeyRegistration](/java/docs/reference/google-cloud-recommendations-ai/0.43.0/com.google.cloud.recommendationengine.v1beta1.PredictionApiKeyRegistration)`
...
```
public List<PredictionApiKeyRegistration> getPredictionApiKeyRegistrationsList()
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[PredictionApiKeyRegistration](/java/docs/reference/google-cloud-recommendations-ai/0.43.0/com.google.cloud.recommendationengine.v1beta1.PredictionApiKeyRegistration)>`

### getPredictionApiKeyRegistrationsOrBuilder(int index)

```
public PredictionApiKeyRegistrationOrBuilder getPredictionApiKeyRegistrationsOrBuilder(int index)
```
...
`[PredictionApiKeyRegistrationOrBuilder](/java/docs/reference/google-cloud-recommendations-ai/0.43.0/com.google.cloud.recommendationengine.v1beta1.PredictionApiKeyRegistrationOrBuilder)`

### getPredictionApiKeyRegistrationsOrBuilderList()

```
public List<? extends PredictionApiKeyRegistrationOrBuilder> getPredictionApiKeyRegistrationsOrBuilderList()
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.recommendationengine.v1beta1.PredictionApiKeyRegistrationOrBuilder>`
...
```
public ListPredictionApiKeyRegistrationsResponse.Builder newBuilderForType()
```
...
```
protected ListPredictionApiKeyRegistrationsResponse.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ListPredictionApiKeyRegistrationsResponse.Builder toBuilder()
```
