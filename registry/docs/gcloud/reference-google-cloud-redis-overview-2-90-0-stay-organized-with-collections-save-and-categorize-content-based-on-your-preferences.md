...
# google-cloud-redis overview (2.90.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Cloud Redis Description:** Is a fully managed Redis service for the Google Cloud. Applications running on Google Cloud can achieve extreme performance by leveraging the highly scalable, available, secure Redis service without the burden of managing complex Redis deployments.

[Cloud Redis Product Reference](https://cloud.google.com/memorystore/docs/redis/)

[GitHub Repository](https://github.com/googleapis/google-cloud-java/tree/main/java-redis)

[Maven artifact](https://central.sonatype.com/artifact/com.google.cloud/google-cloud-redis)
...
-   [Enable the API](https://console.cloud.google.com/apis/library/redis.googleapis.com)
-   [Set up authentication](https://cloud.google.com/docs/authentication/client-libraries)

## Use the Cloud Redis for Java
...
The example below demonstrates how you would import the BOM and include the `google-cloud-redis` artifact.
...
libraryDependencies += "com.google.cloud" % "google-cloud-redis" % "2.90.0"

## Which version ID should I get started with?

For this library, we recommend using [com.google.cloud.redis.v1](https://cloud.google.com/java/docs/reference/google-cloud-redis/2.90.0/com.google.cloud.redis.v1) for new applications.
