...
# Exception RemoteTranslateHelper.TranslateHelperException (2.52.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class RemoteTranslateHelper.TranslateHelperException extends RuntimeException
```
...
```
public static RemoteTranslateHelper.TranslateHelperException translate(Exception ex)
```
...
`[RemoteTranslateHelper.TranslateHelperException](/java/docs/reference/google-cloud-translate/2.52.0/com.google.cloud.translate.testing.RemoteTranslateHelper.TranslateHelperException)`

## Constructors

### TranslateHelperException(String message)
...
### TranslateHelperException(String message, Throwable cause)
