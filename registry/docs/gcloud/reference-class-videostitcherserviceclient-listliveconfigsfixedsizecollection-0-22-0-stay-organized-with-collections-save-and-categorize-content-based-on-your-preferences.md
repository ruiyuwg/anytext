...
# Class VideoStitcherServiceClient.ListLiveConfigsFixedSizeCollection (0.22.0) Stay organized with collections Save and categorize content based on your preferences.
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractFixedSizeCollection](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractFixedSizeCollection.html) \> VideoStitcherServiceClient.ListLiveConfigsFixedSizeCollection
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ListLiveConfigsPage](/java/docs/reference/google-cloud-video-stitcher/0.22.0/com.google.cloud.video.stitcher.v1.VideoStitcherServiceClient.ListLiveConfigsPage)>`  
...
`[VideoStitcherServiceClient.ListLiveConfigsFixedSizeCollection](/java/docs/reference/google-cloud-video-stitcher/0.22.0/com.google.cloud.video.stitcher.v1.VideoStitcherServiceClient.ListLiveConfigsFixedSizeCollection)`
