...
# Class AnnotateAssessmentRequest.Builder (3.13.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> AnnotateAssessmentRequest.Builder

## Implements

[AnnotateAssessmentRequestOrBuilder](/java/docs/reference/google-cloud-recaptchaenterprise/3.13.0/com.google.recaptchaenterprise.v1beta1.AnnotateAssessmentRequestOrBuilder)
...
`[Iterable](https://docs.oracle.com/javase/8/docs/api/java/lang/Iterable.html)<? extends com.google.recaptchaenterprise.v1beta1.AnnotateAssessmentRequest.Reason>`  
...
`[AnnotateAssessmentRequest.Builder](/java/docs/reference/google-cloud-recaptchaenterprise/3.13.0/com.google.recaptchaenterprise.v1beta1.AnnotateAssessmentRequest.Builder)`
...
`[AnnotateAssessmentRequest.Reason](/java/docs/reference/google-cloud-recaptchaenterprise/3.13.0/com.google.recaptchaenterprise.v1beta1.AnnotateAssessmentRequest.Reason)`  
...
`[AnnotateAssessmentRequest](/java/docs/reference/google-cloud-recaptchaenterprise/3.13.0/com.google.recaptchaenterprise.v1beta1.AnnotateAssessmentRequest)`
...
Optional. Optional unique stable hashed user identifier to apply to the assessment. This is an alternative to setting the hashed\_account\_id in CreateAssessment, for example when the account identifier is not yet known in the initial request. It is recommended that the identifier is hashed using hmac-sha256 with stable secret.
...
Required. The resource name of the Assessment, in the format "projects/{project\_number}/assessments/{assessment\_id}".
...
`[AnnotateAssessmentRequest.Annotation](/java/docs/reference/google-cloud-recaptchaenterprise/3.13.0/com.google.recaptchaenterprise.v1beta1.AnnotateAssessmentRequest.Annotation)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Reason](/java/docs/reference/google-cloud-recaptchaenterprise/3.13.0/com.google.recaptchaenterprise.v1beta1.AnnotateAssessmentRequest.Reason)>`
...
`[TransactionEvent](/java/docs/reference/google-cloud-recaptchaenterprise/3.13.0/com.google.recaptchaenterprise.v1beta1.TransactionEvent)`
...
`[TransactionEvent.Builder](/java/docs/reference/google-cloud-recaptchaenterprise/3.13.0/com.google.recaptchaenterprise.v1beta1.TransactionEvent.Builder)`
...
`[TransactionEventOrBuilder](/java/docs/reference/google-cloud-recaptchaenterprise/3.13.0/com.google.recaptchaenterprise.v1beta1.TransactionEventOrBuilder)`
