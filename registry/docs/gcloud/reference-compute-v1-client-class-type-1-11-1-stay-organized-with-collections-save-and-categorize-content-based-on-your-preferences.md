...
# Compute V1 Client - Class Type (1.11.1) Stay organized with collections Save and categorize content based on your preferences.
...
Type contains string constants that represent the names of each value in the google.cloud.compute.v1.ResourceCommitment.Type descriptor.

## Namespace

Google \\ Cloud \\ Compute \\ V1 \\ Enums \\ ResourceCommitment
