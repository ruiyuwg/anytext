...
# Interface PersonDetectionAnnotationOrBuilder (2.36.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[Track](/java/docs/reference/google-cloud-video-intelligence/2.36.0/com.google.cloud.videointelligence.v1p3beta1.Track)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Track](/java/docs/reference/google-cloud-video-intelligence/2.36.0/com.google.cloud.videointelligence.v1p3beta1.Track)>`
...
`[TrackOrBuilder](/java/docs/reference/google-cloud-video-intelligence/2.36.0/com.google.cloud.videointelligence.v1p3beta1.TrackOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.videointelligence.v1p3beta1.TrackOrBuilder>`
