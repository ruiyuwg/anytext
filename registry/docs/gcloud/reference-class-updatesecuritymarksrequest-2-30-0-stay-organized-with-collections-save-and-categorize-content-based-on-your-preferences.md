...
# Class UpdateSecurityMarksRequest (2.30.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class UpdateSecurityMarksRequest extends GeneratedMessageV3 implements UpdateSecurityMarksRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> UpdateSecurityMarksRequest

## Implements

[UpdateSecurityMarksRequestOrBuilder](/java/docs/reference/google-cloud-securitycenter/2.30.0/com.google.cloud.securitycenter.v1beta1.UpdateSecurityMarksRequestOrBuilder)
...
### SECURITY\_MARKS\_FIELD\_NUMBER
...
```
public static UpdateSecurityMarksRequest getDefaultInstance()
```
...
`[UpdateSecurityMarksRequest](/java/docs/reference/google-cloud-securitycenter/2.30.0/com.google.cloud.securitycenter.v1beta1.UpdateSecurityMarksRequest)`
...
```
public static UpdateSecurityMarksRequest.Builder newBuilder()
```
...
`[UpdateSecurityMarksRequest.Builder](/java/docs/reference/google-cloud-securitycenter/2.30.0/com.google.cloud.securitycenter.v1beta1.UpdateSecurityMarksRequest.Builder)`

### newBuilder(UpdateSecurityMarksRequest prototype)

```
public static UpdateSecurityMarksRequest.Builder newBuilder(UpdateSecurityMarksRequest prototype)
```
...
```
public static UpdateSecurityMarksRequest parseDelimitedFrom(InputStream input)
```
...
```
public static UpdateSecurityMarksRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateSecurityMarksRequest parseFrom(byte[] data)
```
...
```
public static UpdateSecurityMarksRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateSecurityMarksRequest parseFrom(ByteString data)
```
...
```
public static UpdateSecurityMarksRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateSecurityMarksRequest parseFrom(CodedInputStream input)
```
...
```
public static UpdateSecurityMarksRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateSecurityMarksRequest parseFrom(InputStream input)
```
...
```
public static UpdateSecurityMarksRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static UpdateSecurityMarksRequest parseFrom(ByteBuffer data)
```
...
```
public static UpdateSecurityMarksRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<UpdateSecurityMarksRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[UpdateSecurityMarksRequest](/java/docs/reference/google-cloud-securitycenter/2.30.0/com.google.cloud.securitycenter.v1beta1.UpdateSecurityMarksRequest)>`
...
```
public Parser<UpdateSecurityMarksRequest> getParserForType()
```
...
`[SecurityMarks](/java/docs/reference/google-cloud-securitycenter/2.30.0/com.google.cloud.securitycenter.v1beta1.SecurityMarks)`
...
`[SecurityMarksOrBuilder](/java/docs/reference/google-cloud-securitycenter/2.30.0/com.google.cloud.securitycenter.v1beta1.SecurityMarksOrBuilder)`
...
```
public UpdateSecurityMarksRequest.Builder newBuilderForType()
```
...
```
protected UpdateSecurityMarksRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public UpdateSecurityMarksRequest.Builder toBuilder()
```
