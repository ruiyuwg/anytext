...
# Interface TaskOrBuilder (2.35.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[AppEngineHttpRequest](/java/docs/reference/google-cloud-tasks/2.35.0/com.google.cloud.tasks.v2.AppEngineHttpRequest)`
...
`[AppEngineHttpRequestOrBuilder](/java/docs/reference/google-cloud-tasks/2.35.0/com.google.cloud.tasks.v2.AppEngineHttpRequestOrBuilder)`
...
`[Attempt](/java/docs/reference/google-cloud-tasks/2.35.0/com.google.cloud.tasks.v2.Attempt)`
...
`[AttemptOrBuilder](/java/docs/reference/google-cloud-tasks/2.35.0/com.google.cloud.tasks.v2.AttemptOrBuilder)`
...
`[HttpRequest](/java/docs/reference/google-cloud-tasks/2.35.0/com.google.cloud.tasks.v2.HttpRequest)`
...
`[HttpRequestOrBuilder](/java/docs/reference/google-cloud-tasks/2.35.0/com.google.cloud.tasks.v2.HttpRequestOrBuilder)`
...
`[Task.MessageTypeCase](/java/docs/reference/google-cloud-tasks/2.35.0/com.google.cloud.tasks.v2.Task.MessageTypeCase)`
...
`[Task.View](/java/docs/reference/google-cloud-tasks/2.35.0/com.google.cloud.tasks.v2.Task.View)`
