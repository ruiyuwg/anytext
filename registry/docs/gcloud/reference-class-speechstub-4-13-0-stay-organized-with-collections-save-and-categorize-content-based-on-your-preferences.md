...
# Class SpeechStub (4.13.0) Stay organized with collections Save and categorize content based on your preferences.
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> SpeechStub
...
`[UnaryCallable](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallable.html)<[LongRunningRecognizeRequest](/java/docs/reference/google-cloud-speech/4.13.0/com.google.cloud.speech.v1.LongRunningRecognizeRequest),[Operation](https://cloud.google.com/java/docs/reference/gax/latest/com.google.longrunning.Operation.html)>`
...
`[OperationCallable](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.OperationCallable.html)<[LongRunningRecognizeRequest](/java/docs/reference/google-cloud-speech/4.13.0/com.google.cloud.speech.v1.LongRunningRecognizeRequest),[LongRunningRecognizeResponse](/java/docs/reference/google-cloud-speech/4.13.0/com.google.cloud.speech.v1.LongRunningRecognizeResponse),[LongRunningRecognizeMetadata](/java/docs/reference/google-cloud-speech/4.13.0/com.google.cloud.speech.v1.LongRunningRecognizeMetadata)>`
...
`[UnaryCallable](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallable.html)<[RecognizeRequest](/java/docs/reference/google-cloud-speech/4.13.0/com.google.cloud.speech.v1.RecognizeRequest),[RecognizeResponse](/java/docs/reference/google-cloud-speech/4.13.0/com.google.cloud.speech.v1.RecognizeResponse)>`
...
`[BidiStreamingCallable](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.BidiStreamingCallable.html)<[StreamingRecognizeRequest](/java/docs/reference/google-cloud-speech/4.13.0/com.google.cloud.speech.v1.StreamingRecognizeRequest),[StreamingRecognizeResponse](/java/docs/reference/google-cloud-speech/4.13.0/com.google.cloud.speech.v1.StreamingRecognizeResponse)>`
