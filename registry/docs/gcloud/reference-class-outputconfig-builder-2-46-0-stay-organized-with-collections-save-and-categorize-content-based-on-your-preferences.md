...
# Class OutputConfig.Builder (2.46.0) Stay organized with collections Save and categorize content based on your preferences.
...
Protobuf type `google.cloud.redis.v1.OutputConfig`
...
[OutputConfigOrBuilder](/java/docs/reference/google-cloud-redis/2.46.0/com.google.cloud.redis.v1.OutputConfigOrBuilder)
...
`[OutputConfig.Builder](/java/docs/reference/google-cloud-redis/2.46.0/com.google.cloud.redis.v1.OutputConfig.Builder)`
...
`[OutputConfig](/java/docs/reference/google-cloud-redis/2.46.0/com.google.cloud.redis.v1.OutputConfig)`
...
`[OutputConfig.DestinationCase](/java/docs/reference/google-cloud-redis/2.46.0/com.google.cloud.redis.v1.OutputConfig.DestinationCase)`
...
`[GcsDestination](/java/docs/reference/google-cloud-redis/2.46.0/com.google.cloud.redis.v1.GcsDestination)`
...
`[GcsDestination.Builder](/java/docs/reference/google-cloud-redis/2.46.0/com.google.cloud.redis.v1.GcsDestination.Builder)`
...
`[GcsDestinationOrBuilder](/java/docs/reference/google-cloud-redis/2.46.0/com.google.cloud.redis.v1.GcsDestinationOrBuilder)`
