...
# google-cloud-os-config overview (2.89.0) Stay organized with collections Save and categorize content based on your preferences.
...
**OS Config API Description:** Provides OS management tools that can be used for patch management, patch compliance, and configuration management on VM instances.

[OS Config API Product Reference](https://cloud.google.com/compute/docs/os-patch-management)

[GitHub Repository](https://github.com/googleapis/google-cloud-java/tree/main/java-os-config)

[Maven artifact](https://central.sonatype.com/artifact/com.google.cloud/google-cloud-os-config)
...
-   [Enable the API](https://console.cloud.google.com/apis/library/osconfig.googleapis.com)
-   [Set up authentication](https://cloud.google.com/docs/authentication/client-libraries)

## Use the OS Config API for Java
...
The example below demonstrates how you would import the BOM and include the `google-cloud-os-config` artifact.
...
For this library, we recommend using [com.google.cloud.osconfig.v1](https://cloud.google.com/java/docs/reference/google-cloud-os-config/2.89.0/com.google.cloud.osconfig.v1) for new applications.
