...
# Class ListQuotaGroupsResponse (0.10.0) Stay organized with collections Save and categorize content based on your preferences.

1.15.0 (latest) 1.13.0 1.11.0 1.10.0 1.8.0 1.6.0 1.4.0 1.3.0 1.2.0 1.1.0 1.0.0 0.33.0 0.31.0 0.30.0 0.27.0 0.26.0 0.25.0 0.23.0 0.22.0 0.21.0 0.20.0 0.19.0 0.18.0 0.17.0 0.16.0 0.15.0 0.14.0 0.12.0 0.11.0 0.10.0 0.9.0 0.8.0 0.7.0 0.6.0 0.5.0 0.4.0 0.3.0 0.2.0
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListQuotaGroupsResponse

## Implements

[ListQuotaGroupsResponseOrBuilder](/java/docs/reference/google-shopping-merchant-quota/0.10.0/com.google.shopping.merchant.quota.v1beta.ListQuotaGroupsResponseOrBuilder)
...
`[ListQuotaGroupsResponse](/java/docs/reference/google-shopping-merchant-quota/0.10.0/com.google.shopping.merchant.quota.v1beta.ListQuotaGroupsResponse)`
...
`[ListQuotaGroupsResponse.Builder](/java/docs/reference/google-shopping-merchant-quota/0.10.0/com.google.shopping.merchant.quota.v1beta.ListQuotaGroupsResponse.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListQuotaGroupsResponse](/java/docs/reference/google-shopping-merchant-quota/0.10.0/com.google.shopping.merchant.quota.v1beta.ListQuotaGroupsResponse)>`
...
`[QuotaGroup](/java/docs/reference/google-shopping-merchant-quota/0.10.0/com.google.shopping.merchant.quota.v1beta.QuotaGroup)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[QuotaGroup](/java/docs/reference/google-shopping-merchant-quota/0.10.0/com.google.shopping.merchant.quota.v1beta.QuotaGroup)>`
...
`[QuotaGroupOrBuilder](/java/docs/reference/google-shopping-merchant-quota/0.10.0/com.google.shopping.merchant.quota.v1beta.QuotaGroupOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.shopping.merchant.quota.v1beta.QuotaGroupOrBuilder>`
