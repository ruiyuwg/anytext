...
# Class CloudSchedulerSettings.Builder (2.22.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class CloudSchedulerSettings.Builder extends ClientSettings.Builder<CloudSchedulerSettings,CloudSchedulerSettings.Builder>
```
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [ClientSettings.Builder](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.ClientSettings.Builder.html) \> CloudSchedulerSettings.Builder
...
### Builder(CloudSchedulerSettings settings)
...
`[CloudSchedulerSettings](/java/docs/reference/google-cloud-scheduler/2.22.0/com.google.cloud.scheduler.v1beta1.CloudSchedulerSettings)`  

### Builder(CloudSchedulerStubSettings.Builder stubSettings)
...
`[CloudSchedulerStubSettings.Builder](/java/docs/reference/google-cloud-scheduler/2.22.0/com.google.cloud.scheduler.v1beta1.stub.CloudSchedulerStubSettings.Builder)`  
...
```
public CloudSchedulerSettings.Builder applyToAllUnaryMethods(ApiFunction<UnaryCallSettings.Builder<?,?>,Void> settingsUpdater)
```
...
`[CloudSchedulerSettings.Builder](/java/docs/reference/google-cloud-scheduler/2.22.0/com.google.cloud.scheduler.v1beta1.CloudSchedulerSettings.Builder)`

### build()

```
public CloudSchedulerSettings build()
```
...
`[Builder](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.Builder.html)<[CreateJobRequest](/java/docs/reference/google-cloud-scheduler/2.22.0/com.google.cloud.scheduler.v1beta1.CreateJobRequest),[Job](/java/docs/reference/google-cloud-scheduler/2.22.0/com.google.cloud.scheduler.v1beta1.Job)>`
...
`[Builder](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.Builder.html)<[DeleteJobRequest](/java/docs/reference/google-cloud-scheduler/2.22.0/com.google.cloud.scheduler.v1beta1.DeleteJobRequest),[Empty](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Empty.html)>`
...
`[Builder](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.Builder.html)<[GetJobRequest](/java/docs/reference/google-cloud-scheduler/2.22.0/com.google.cloud.scheduler.v1beta1.GetJobRequest),[Job](/java/docs/reference/google-cloud-scheduler/2.22.0/com.google.cloud.scheduler.v1beta1.Job)>`
...
`[Builder](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PagedCallSettings.Builder.html)<[ListJobsRequest](/java/docs/reference/google-cloud-scheduler/2.22.0/com.google.cloud.scheduler.v1beta1.ListJobsRequest),[ListJobsResponse](/java/docs/reference/google-cloud-scheduler/2.22.0/com.google.cloud.scheduler.v1beta1.ListJobsResponse),[ListJobsPagedResponse](/java/docs/reference/google-cloud-scheduler/2.22.0/com.google.cloud.scheduler.v1beta1.CloudSchedulerClient.ListJobsPagedResponse)>`
...
`[Builder](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PagedCallSettings.Builder.html)<com.google.cloud.location.ListLocationsRequest,com.google.cloud.location.ListLocationsResponse,[ListLocationsPagedResponse](/java/docs/reference/google-cloud-scheduler/2.22.0/com.google.cloud.scheduler.v1beta1.CloudSchedulerClient.ListLocationsPagedResponse)>`
...
`[Builder](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.Builder.html)<[PauseJobRequest](/java/docs/reference/google-cloud-scheduler/2.22.0/com.google.cloud.scheduler.v1beta1.PauseJobRequest),[Job](/java/docs/reference/google-cloud-scheduler/2.22.0/com.google.cloud.scheduler.v1beta1.Job)>`
...
`[Builder](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.Builder.html)<[ResumeJobRequest](/java/docs/reference/google-cloud-scheduler/2.22.0/com.google.cloud.scheduler.v1beta1.ResumeJobRequest),[Job](/java/docs/reference/google-cloud-scheduler/2.22.0/com.google.cloud.scheduler.v1beta1.Job)>`
...
`[Builder](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.Builder.html)<[RunJobRequest](/java/docs/reference/google-cloud-scheduler/2.22.0/com.google.cloud.scheduler.v1beta1.RunJobRequest),[Job](/java/docs/reference/google-cloud-scheduler/2.22.0/com.google.cloud.scheduler.v1beta1.Job)>`
...
`[Builder](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.UnaryCallSettings.Builder.html)<[UpdateJobRequest](/java/docs/reference/google-cloud-scheduler/2.22.0/com.google.cloud.scheduler.v1beta1.UpdateJobRequest),[Job](/java/docs/reference/google-cloud-scheduler/2.22.0/com.google.cloud.scheduler.v1beta1.Job)>`
