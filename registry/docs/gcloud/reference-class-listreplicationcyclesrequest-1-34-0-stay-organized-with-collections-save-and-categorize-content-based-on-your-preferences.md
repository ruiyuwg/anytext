...
# Class ListReplicationCyclesRequest (1.34.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListReplicationCyclesRequest extends GeneratedMessageV3 implements ListReplicationCyclesRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListReplicationCyclesRequest

## Implements

[ListReplicationCyclesRequestOrBuilder](/java/docs/reference/google-cloud-vmmigration/1.34.0/com.google.cloud.vmmigration.v1.ListReplicationCyclesRequestOrBuilder)
...
```
public static ListReplicationCyclesRequest getDefaultInstance()
```
...
`[ListReplicationCyclesRequest](/java/docs/reference/google-cloud-vmmigration/1.34.0/com.google.cloud.vmmigration.v1.ListReplicationCyclesRequest)`
...
```
public static ListReplicationCyclesRequest.Builder newBuilder()
```
...
`[ListReplicationCyclesRequest.Builder](/java/docs/reference/google-cloud-vmmigration/1.34.0/com.google.cloud.vmmigration.v1.ListReplicationCyclesRequest.Builder)`

### newBuilder(ListReplicationCyclesRequest prototype)

```
public static ListReplicationCyclesRequest.Builder newBuilder(ListReplicationCyclesRequest prototype)
```
...
```
public static ListReplicationCyclesRequest parseDelimitedFrom(InputStream input)
```
...
```
public static ListReplicationCyclesRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListReplicationCyclesRequest parseFrom(byte[] data)
```
...
```
public static ListReplicationCyclesRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListReplicationCyclesRequest parseFrom(ByteString data)
```
...
```
public static ListReplicationCyclesRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListReplicationCyclesRequest parseFrom(CodedInputStream input)
```
...
```
public static ListReplicationCyclesRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListReplicationCyclesRequest parseFrom(InputStream input)
```
...
```
public static ListReplicationCyclesRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListReplicationCyclesRequest parseFrom(ByteBuffer data)
```
...
```
public static ListReplicationCyclesRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ListReplicationCyclesRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListReplicationCyclesRequest](/java/docs/reference/google-cloud-vmmigration/1.34.0/com.google.cloud.vmmigration.v1.ListReplicationCyclesRequest)>`
...
```
public Parser<ListReplicationCyclesRequest> getParserForType()
```
...
```
public ListReplicationCyclesRequest.Builder newBuilderForType()
```
...
```
protected ListReplicationCyclesRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ListReplicationCyclesRequest.Builder toBuilder()
```
