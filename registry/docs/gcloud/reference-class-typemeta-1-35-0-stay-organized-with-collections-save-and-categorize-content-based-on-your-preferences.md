...
# Class TypeMeta (1.35.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[TypeMeta](/java/docs/reference/google-cloud-gkehub/1.35.0/com.google.cloud.gkehub.v1beta1.TypeMeta)`
...
```
public static TypeMeta.Builder newBuilder()
```
...
`[TypeMeta.Builder](/java/docs/reference/google-cloud-gkehub/1.35.0/com.google.cloud.gkehub.v1beta1.TypeMeta.Builder)`

### newBuilder(TypeMeta prototype)

```
public static TypeMeta.Builder newBuilder(TypeMeta prototype)
```
...
```
public static TypeMeta parseDelimitedFrom(InputStream input)
```
...
```
public static TypeMeta parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static TypeMeta parseFrom(byte[] data)
```
...
```
public static TypeMeta parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static TypeMeta parseFrom(ByteString data)
```
...
```
public static TypeMeta parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static TypeMeta parseFrom(CodedInputStream input)
```
...
```
public static TypeMeta parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static TypeMeta parseFrom(InputStream input)
```
...
```
public static TypeMeta parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static TypeMeta parseFrom(ByteBuffer data)
```
...
```
public static TypeMeta parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[TypeMeta](/java/docs/reference/google-cloud-gkehub/1.35.0/com.google.cloud.gkehub.v1beta1.TypeMeta)>`
...
```
public TypeMeta.Builder newBuilderForType()
```
...
```
protected TypeMeta.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public TypeMeta.Builder toBuilder()
```
