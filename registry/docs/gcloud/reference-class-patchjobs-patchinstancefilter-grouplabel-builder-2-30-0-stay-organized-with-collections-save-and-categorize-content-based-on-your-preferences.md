...
# Class PatchJobs.PatchInstanceFilter.GroupLabel.Builder (2.30.0) Stay organized with collections Save and categorize content based on your preferences.
...
[PatchJobs.PatchInstanceFilter.GroupLabelOrBuilder](/java/docs/reference/google-cloud-os-config/2.30.0/com.google.cloud.osconfig.v1.PatchJobs.PatchInstanceFilter.GroupLabelOrBuilder)
...
`[PatchJobs.PatchInstanceFilter.GroupLabel.Builder](/java/docs/reference/google-cloud-os-config/2.30.0/com.google.cloud.osconfig.v1.PatchJobs.PatchInstanceFilter.GroupLabel.Builder)`
...
`[PatchJobs.PatchInstanceFilter.GroupLabel](/java/docs/reference/google-cloud-os-config/2.30.0/com.google.cloud.osconfig.v1.PatchJobs.PatchInstanceFilter.GroupLabel)`
...
Use [#getLabelsMap()](/java/docs/reference/google-cloud-os-config/2.30.0/com.google.cloud.osconfig.v1.PatchJobs.PatchInstanceFilter.GroupLabel.Builder#com_google_cloud_osconfig_v1_PatchJobs_PatchInstanceFilter_GroupLabel_Builder_getLabelsMap__) instead.
