...
# Class ModelServiceClient.ListModelsPagedResponse (2.89.0) Stay organized with collections Save and categorize content based on your preferences.
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractPagedListResponse](https://docs.cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractPagedListResponse.html) \> ModelServiceClient.ListModelsPagedResponse
...
`[PageContext](https://docs.cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PageContext.html)<[ListModelsRequest](/java/docs/reference/google-cloud-retail/latest/com.google.cloud.retail.v2alpha.ListModelsRequest),[ListModelsResponse](/java/docs/reference/google-cloud-retail/latest/com.google.cloud.retail.v2alpha.ListModelsResponse),[Model](/java/docs/reference/google-cloud-retail/latest/com.google.cloud.retail.v2alpha.Model)>`  

`futureResponse`

`[ApiFuture](https://docs.cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListModelsResponse](/java/docs/reference/google-cloud-retail/latest/com.google.cloud.retail.v2alpha.ListModelsResponse)>`  
...
`[ApiFuture](https://docs.cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListModelsPagedResponse](/java/docs/reference/google-cloud-retail/latest/com.google.cloud.retail.v2alpha.ModelServiceClient.ListModelsPagedResponse)>`
