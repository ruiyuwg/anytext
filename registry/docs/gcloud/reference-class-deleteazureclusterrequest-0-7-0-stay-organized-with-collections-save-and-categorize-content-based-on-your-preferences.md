...
# Class DeleteAzureClusterRequest (0.7.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class DeleteAzureClusterRequest extends GeneratedMessageV3 implements DeleteAzureClusterRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> DeleteAzureClusterRequest

## Implements

[DeleteAzureClusterRequestOrBuilder](/java/docs/reference/google-cloud-gke-multi-cloud/0.7.0/com.google.cloud.gkemulticloud.v1.DeleteAzureClusterRequestOrBuilder)
...
```
public static DeleteAzureClusterRequest getDefaultInstance()
```
...
[DeleteAzureClusterRequest](/java/docs/reference/google-cloud-gke-multi-cloud/0.7.0/com.google.cloud.gkemulticloud.v1.DeleteAzureClusterRequest)
...
```
public static DeleteAzureClusterRequest.Builder newBuilder()
```
...
[DeleteAzureClusterRequest.Builder](/java/docs/reference/google-cloud-gke-multi-cloud/0.7.0/com.google.cloud.gkemulticloud.v1.DeleteAzureClusterRequest.Builder)

### newBuilder(DeleteAzureClusterRequest prototype)

```
public static DeleteAzureClusterRequest.Builder newBuilder(DeleteAzureClusterRequest prototype)
```
...
```
public static DeleteAzureClusterRequest parseDelimitedFrom(InputStream input)
```
...
```
public static DeleteAzureClusterRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteAzureClusterRequest parseFrom(byte[] data)
```
...
```
public static DeleteAzureClusterRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteAzureClusterRequest parseFrom(ByteString data)
```
...
```
public static DeleteAzureClusterRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteAzureClusterRequest parseFrom(CodedInputStream input)
```
...
```
public static DeleteAzureClusterRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteAzureClusterRequest parseFrom(InputStream input)
```
...
```
public static DeleteAzureClusterRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteAzureClusterRequest parseFrom(ByteBuffer data)
```
...
```
public static DeleteAzureClusterRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<DeleteAzureClusterRequest> parser()
```
...
[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[DeleteAzureClusterRequest](/java/docs/reference/google-cloud-gke-multi-cloud/0.7.0/com.google.cloud.gkemulticloud.v1.DeleteAzureClusterRequest)\>
...
Required. The resource name the AzureCluster to delete. `AzureCluster` names are formatted as `projects/<project-id>/locations/<region>/azureClusters/<cluster-id>`. See [Resource Names](https://cloud.google.com/apis/design/resource_names) for more details on GCP resource names.
...
```
public Parser<DeleteAzureClusterRequest> getParserForType()
```
...
```
public DeleteAzureClusterRequest.Builder newBuilderForType()
```
...
```
protected DeleteAzureClusterRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public DeleteAzureClusterRequest.Builder toBuilder()
```
