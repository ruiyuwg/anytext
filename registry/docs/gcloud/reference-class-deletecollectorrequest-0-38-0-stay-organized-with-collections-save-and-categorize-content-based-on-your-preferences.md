...
# Class DeleteCollectorRequest (0.38.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class DeleteCollectorRequest extends GeneratedMessageV3 implements DeleteCollectorRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> DeleteCollectorRequest

## Implements

[DeleteCollectorRequestOrBuilder](/java/docs/reference/google-cloud-rapidmigrationassessment/0.38.0/com.google.cloud.rapidmigrationassessment.v1.DeleteCollectorRequestOrBuilder)
...
```
public static DeleteCollectorRequest getDefaultInstance()
```
...
`[DeleteCollectorRequest](/java/docs/reference/google-cloud-rapidmigrationassessment/0.38.0/com.google.cloud.rapidmigrationassessment.v1.DeleteCollectorRequest)`
...
```
public static DeleteCollectorRequest.Builder newBuilder()
```
...
`[DeleteCollectorRequest.Builder](/java/docs/reference/google-cloud-rapidmigrationassessment/0.38.0/com.google.cloud.rapidmigrationassessment.v1.DeleteCollectorRequest.Builder)`

### newBuilder(DeleteCollectorRequest prototype)

```
public static DeleteCollectorRequest.Builder newBuilder(DeleteCollectorRequest prototype)
```
...
```
public static DeleteCollectorRequest parseDelimitedFrom(InputStream input)
```
...
```
public static DeleteCollectorRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteCollectorRequest parseFrom(byte[] data)
```
...
```
public static DeleteCollectorRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteCollectorRequest parseFrom(ByteString data)
```
...
```
public static DeleteCollectorRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteCollectorRequest parseFrom(CodedInputStream input)
```
...
```
public static DeleteCollectorRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteCollectorRequest parseFrom(InputStream input)
```
...
```
public static DeleteCollectorRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteCollectorRequest parseFrom(ByteBuffer data)
```
...
```
public static DeleteCollectorRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<DeleteCollectorRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[DeleteCollectorRequest](/java/docs/reference/google-cloud-rapidmigrationassessment/0.38.0/com.google.cloud.rapidmigrationassessment.v1.DeleteCollectorRequest)>`
...
```
public DeleteCollectorRequest getDefaultInstanceForType()
```
...
```
public Parser<DeleteCollectorRequest> getParserForType()
```
...
```
public DeleteCollectorRequest.Builder newBuilderForType()
```
...
```
protected DeleteCollectorRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public DeleteCollectorRequest.Builder toBuilder()
```
