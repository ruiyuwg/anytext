...
# Interface TranslateTextResponseOrBuilder (2.31.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[Translation](/java/docs/reference/google-cloud-translate/2.31.0/com.google.cloud.translate.v3beta1.Translation)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Translation](/java/docs/reference/google-cloud-translate/2.31.0/com.google.cloud.translate.v3beta1.Translation)>`
...
`[TranslationOrBuilder](/java/docs/reference/google-cloud-translate/2.31.0/com.google.cloud.translate.v3beta1.TranslationOrBuilder)`
