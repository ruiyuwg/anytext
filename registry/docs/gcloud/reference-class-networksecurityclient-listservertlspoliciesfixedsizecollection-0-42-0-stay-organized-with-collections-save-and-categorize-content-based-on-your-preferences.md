...
# Class NetworkSecurityClient.ListServerTlsPoliciesFixedSizeCollection (0.42.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class NetworkSecurityClient.ListServerTlsPoliciesFixedSizeCollection extends AbstractFixedSizeCollection<ListServerTlsPoliciesRequest,ListServerTlsPoliciesResponse,ServerTlsPolicy,NetworkSecurityClient.ListServerTlsPoliciesPage,NetworkSecurityClient.ListServerTlsPoliciesFixedSizeCollection>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractFixedSizeCollection](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractFixedSizeCollection.html) \> NetworkSecurityClient.ListServerTlsPoliciesFixedSizeCollection
...
### createCollection(List<NetworkSecurityClient.ListServerTlsPoliciesPage> pages, int collectionSize)

```
protected NetworkSecurityClient.ListServerTlsPoliciesFixedSizeCollection createCollection(List<NetworkSecurityClient.ListServerTlsPoliciesPage> pages, int collectionSize)
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ListServerTlsPoliciesPage](/java/docs/reference/google-cloud-network-security/0.42.0/com.google.cloud.networksecurity.v1.NetworkSecurityClient.ListServerTlsPoliciesPage)>`  
...
`[NetworkSecurityClient.ListServerTlsPoliciesFixedSizeCollection](/java/docs/reference/google-cloud-network-security/0.42.0/com.google.cloud.networksecurity.v1.NetworkSecurityClient.ListServerTlsPoliciesFixedSizeCollection)`
