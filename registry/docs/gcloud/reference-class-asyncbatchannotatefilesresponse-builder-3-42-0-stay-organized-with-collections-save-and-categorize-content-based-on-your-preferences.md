...
# Class AsyncBatchAnnotateFilesResponse.Builder (3.42.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> AsyncBatchAnnotateFilesResponse.Builder

## Implements

[AsyncBatchAnnotateFilesResponseOrBuilder](/java/docs/reference/google-cloud-vision/3.42.0/com.google.cloud.vision.v1p3beta1.AsyncBatchAnnotateFilesResponseOrBuilder)
...
`[Iterable](https://docs.oracle.com/javase/8/docs/api/java/lang/Iterable.html)<? extends com.google.cloud.vision.v1p3beta1.AsyncAnnotateFileResponse>`  
...
`[AsyncBatchAnnotateFilesResponse.Builder](/java/docs/reference/google-cloud-vision/3.42.0/com.google.cloud.vision.v1p3beta1.AsyncBatchAnnotateFilesResponse.Builder)`
...
`[AsyncAnnotateFileResponse](/java/docs/reference/google-cloud-vision/3.42.0/com.google.cloud.vision.v1p3beta1.AsyncAnnotateFileResponse)`  
...
`[AsyncAnnotateFileResponse.Builder](/java/docs/reference/google-cloud-vision/3.42.0/com.google.cloud.vision.v1p3beta1.AsyncAnnotateFileResponse.Builder)`  
...
`[AsyncBatchAnnotateFilesResponse](/java/docs/reference/google-cloud-vision/3.42.0/com.google.cloud.vision.v1p3beta1.AsyncBatchAnnotateFilesResponse)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Builder](/java/docs/reference/google-cloud-vision/3.42.0/com.google.cloud.vision.v1p3beta1.AsyncAnnotateFileResponse.Builder)>`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[AsyncAnnotateFileResponse](/java/docs/reference/google-cloud-vision/3.42.0/com.google.cloud.vision.v1p3beta1.AsyncAnnotateFileResponse)>`
...
`[AsyncAnnotateFileResponseOrBuilder](/java/docs/reference/google-cloud-vision/3.42.0/com.google.cloud.vision.v1p3beta1.AsyncAnnotateFileResponseOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.vision.v1p3beta1.AsyncAnnotateFileResponseOrBuilder>`
