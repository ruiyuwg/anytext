...
# Interface DeleteCustomClassRequestOrBuilder (4.47.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface DeleteCustomClassRequestOrBuilder extends MessageOrBuilder
```
