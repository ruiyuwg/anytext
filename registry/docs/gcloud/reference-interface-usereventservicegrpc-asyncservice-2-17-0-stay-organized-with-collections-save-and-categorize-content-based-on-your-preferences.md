...
# Interface UserEventServiceGrpc.AsyncService (2.17.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[CollectUserEventRequest](/java/docs/reference/google-cloud-retail/2.17.0/com.google.cloud.retail.v2alpha.CollectUserEventRequest)`  
...
`[ImportUserEventsRequest](/java/docs/reference/google-cloud-retail/2.17.0/com.google.cloud.retail.v2alpha.ImportUserEventsRequest)`  
...
`[PurgeUserEventsRequest](/java/docs/reference/google-cloud-retail/2.17.0/com.google.cloud.retail.v2alpha.PurgeUserEventsRequest)`  
...
`[RejoinUserEventsRequest](/java/docs/reference/google-cloud-retail/2.17.0/com.google.cloud.retail.v2alpha.RejoinUserEventsRequest)`  
...
`[WriteUserEventRequest](/java/docs/reference/google-cloud-retail/2.17.0/com.google.cloud.retail.v2alpha.WriteUserEventRequest)`  

`responseObserver`

`io.grpc.stub.StreamObserver<[UserEvent](/java/docs/reference/google-cloud-retail/2.17.0/com.google.cloud.retail.v2alpha.UserEvent)>`  
