...
# Class CertificateExtensionConstraints (2.35.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class CertificateExtensionConstraints extends GeneratedMessageV3 implements CertificateExtensionConstraintsOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> CertificateExtensionConstraints

## Implements

[CertificateExtensionConstraintsOrBuilder](/java/docs/reference/google-cloud-security-private-ca/2.35.0/com.google.cloud.security.privateca.v1.CertificateExtensionConstraintsOrBuilder)
...
### ADDITIONAL\_EXTENSIONS\_FIELD\_NUMBER
...
### KNOWN\_EXTENSIONS\_FIELD\_NUMBER

```
public static final int KNOWN_EXTENSIONS_FIELD_NUMBER
```
...
```
public static CertificateExtensionConstraints getDefaultInstance()
```
...
`[CertificateExtensionConstraints](/java/docs/reference/google-cloud-security-private-ca/2.35.0/com.google.cloud.security.privateca.v1.CertificateExtensionConstraints)`
...
```
public static CertificateExtensionConstraints.Builder newBuilder()
```
...
`[CertificateExtensionConstraints.Builder](/java/docs/reference/google-cloud-security-private-ca/2.35.0/com.google.cloud.security.privateca.v1.CertificateExtensionConstraints.Builder)`

### newBuilder(CertificateExtensionConstraints prototype)

```
public static CertificateExtensionConstraints.Builder newBuilder(CertificateExtensionConstraints prototype)
```
...
```
public static CertificateExtensionConstraints parseDelimitedFrom(InputStream input)
```
...
```
public static CertificateExtensionConstraints parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CertificateExtensionConstraints parseFrom(byte[] data)
```
...
```
public static CertificateExtensionConstraints parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CertificateExtensionConstraints parseFrom(ByteString data)
```
...
```
public static CertificateExtensionConstraints parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CertificateExtensionConstraints parseFrom(CodedInputStream input)
```
...
```
public static CertificateExtensionConstraints parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CertificateExtensionConstraints parseFrom(InputStream input)
```
...
```
public static CertificateExtensionConstraints parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static CertificateExtensionConstraints parseFrom(ByteBuffer data)
```
...
```
public static CertificateExtensionConstraints parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<CertificateExtensionConstraints> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[CertificateExtensionConstraints](/java/docs/reference/google-cloud-security-private-ca/2.35.0/com.google.cloud.security.privateca.v1.CertificateExtensionConstraints)>`
...
`[ObjectId](/java/docs/reference/google-cloud-security-private-ca/2.35.0/com.google.cloud.security.privateca.v1.ObjectId)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ObjectId](/java/docs/reference/google-cloud-security-private-ca/2.35.0/com.google.cloud.security.privateca.v1.ObjectId)>`
...
`[ObjectIdOrBuilder](/java/docs/reference/google-cloud-security-private-ca/2.35.0/com.google.cloud.security.privateca.v1.ObjectIdOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.security.privateca.v1.ObjectIdOrBuilder>`
...
`[CertificateExtensionConstraints.KnownCertificateExtension](/java/docs/reference/google-cloud-security-private-ca/2.35.0/com.google.cloud.security.privateca.v1.CertificateExtensionConstraints.KnownCertificateExtension)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[KnownCertificateExtension](/java/docs/reference/google-cloud-security-private-ca/2.35.0/com.google.cloud.security.privateca.v1.CertificateExtensionConstraints.KnownCertificateExtension)>`
...
```
public Parser<CertificateExtensionConstraints> getParserForType()
```
...
```
public CertificateExtensionConstraints.Builder newBuilderForType()
```
...
```
protected CertificateExtensionConstraints.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public CertificateExtensionConstraints.Builder toBuilder()
```
