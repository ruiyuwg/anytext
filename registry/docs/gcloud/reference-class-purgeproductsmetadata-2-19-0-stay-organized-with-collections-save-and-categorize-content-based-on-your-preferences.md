...
# Class PurgeProductsMetadata (2.19.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class PurgeProductsMetadata extends GeneratedMessageV3 implements PurgeProductsMetadataOrBuilder
```
...
Protobuf type `google.cloud.retail.v2alpha.PurgeProductsMetadata`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> PurgeProductsMetadata

## Implements

[PurgeProductsMetadataOrBuilder](/java/docs/reference/google-cloud-retail/2.19.0/com.google.cloud.retail.v2alpha.PurgeProductsMetadataOrBuilder)
...
```
public static PurgeProductsMetadata getDefaultInstance()
```
...
`[PurgeProductsMetadata](/java/docs/reference/google-cloud-retail/2.19.0/com.google.cloud.retail.v2alpha.PurgeProductsMetadata)`
...
```
public static PurgeProductsMetadata.Builder newBuilder()
```
...
`[PurgeProductsMetadata.Builder](/java/docs/reference/google-cloud-retail/2.19.0/com.google.cloud.retail.v2alpha.PurgeProductsMetadata.Builder)`

### newBuilder(PurgeProductsMetadata prototype)

```
public static PurgeProductsMetadata.Builder newBuilder(PurgeProductsMetadata prototype)
```
...
```
public static PurgeProductsMetadata parseDelimitedFrom(InputStream input)
```
...
```
public static PurgeProductsMetadata parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PurgeProductsMetadata parseFrom(byte[] data)
```
...
```
public static PurgeProductsMetadata parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PurgeProductsMetadata parseFrom(ByteString data)
```
...
```
public static PurgeProductsMetadata parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PurgeProductsMetadata parseFrom(CodedInputStream input)
```
...
```
public static PurgeProductsMetadata parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PurgeProductsMetadata parseFrom(InputStream input)
```
...
```
public static PurgeProductsMetadata parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PurgeProductsMetadata parseFrom(ByteBuffer data)
```
...
```
public static PurgeProductsMetadata parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<PurgeProductsMetadata> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[PurgeProductsMetadata](/java/docs/reference/google-cloud-retail/2.19.0/com.google.cloud.retail.v2alpha.PurgeProductsMetadata)>`
...
```
public PurgeProductsMetadata getDefaultInstanceForType()
```
...
```
public Parser<PurgeProductsMetadata> getParserForType()
```
...
```
public PurgeProductsMetadata.Builder newBuilderForType()
```
...
```
protected PurgeProductsMetadata.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public PurgeProductsMetadata.Builder toBuilder()
```
