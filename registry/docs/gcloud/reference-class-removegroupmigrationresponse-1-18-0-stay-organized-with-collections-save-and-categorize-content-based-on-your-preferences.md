...
# Class RemoveGroupMigrationResponse (1.18.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class RemoveGroupMigrationResponse extends GeneratedMessageV3 implements RemoveGroupMigrationResponseOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> RemoveGroupMigrationResponse

## Implements

[RemoveGroupMigrationResponseOrBuilder](/java/docs/reference/google-cloud-vmmigration/1.18.0/com.google.cloud.vmmigration.v1.RemoveGroupMigrationResponseOrBuilder)
...
```
public static RemoveGroupMigrationResponse getDefaultInstance()
```
...
`[RemoveGroupMigrationResponse](/java/docs/reference/google-cloud-vmmigration/1.18.0/com.google.cloud.vmmigration.v1.RemoveGroupMigrationResponse)`
...
```
public static RemoveGroupMigrationResponse.Builder newBuilder()
```
...
`[RemoveGroupMigrationResponse.Builder](/java/docs/reference/google-cloud-vmmigration/1.18.0/com.google.cloud.vmmigration.v1.RemoveGroupMigrationResponse.Builder)`

### newBuilder(RemoveGroupMigrationResponse prototype)

```
public static RemoveGroupMigrationResponse.Builder newBuilder(RemoveGroupMigrationResponse prototype)
```
...
```
public static RemoveGroupMigrationResponse parseDelimitedFrom(InputStream input)
```
...
```
public static RemoveGroupMigrationResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RemoveGroupMigrationResponse parseFrom(byte[] data)
```
...
```
public static RemoveGroupMigrationResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RemoveGroupMigrationResponse parseFrom(ByteString data)
```
...
```
public static RemoveGroupMigrationResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RemoveGroupMigrationResponse parseFrom(CodedInputStream input)
```
...
```
public static RemoveGroupMigrationResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RemoveGroupMigrationResponse parseFrom(InputStream input)
```
...
```
public static RemoveGroupMigrationResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static RemoveGroupMigrationResponse parseFrom(ByteBuffer data)
```
...
```
public static RemoveGroupMigrationResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<RemoveGroupMigrationResponse> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[RemoveGroupMigrationResponse](/java/docs/reference/google-cloud-vmmigration/1.18.0/com.google.cloud.vmmigration.v1.RemoveGroupMigrationResponse)>`
...
```
public RemoveGroupMigrationResponse getDefaultInstanceForType()
```
...
```
public Parser<RemoveGroupMigrationResponse> getParserForType()
```
...
```
public RemoveGroupMigrationResponse.Builder newBuilderForType()
```
...
```
protected RemoveGroupMigrationResponse.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public RemoveGroupMigrationResponse.Builder toBuilder()
```
