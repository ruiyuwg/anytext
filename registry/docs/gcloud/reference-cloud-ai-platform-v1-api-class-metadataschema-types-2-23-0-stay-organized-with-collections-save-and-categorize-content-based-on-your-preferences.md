...
# Cloud AI Platform v1 API - Class MetadataSchema.Types (2.23.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class MetadataSchema.Types
```

Reference documentation and code samples for the Cloud AI Platform v1 API class MetadataSchema.Types.

Container for nested types declared in the MetadataSchema message type.

## Inheritance

[object](https://learn.microsoft.com/dotnet/api/system.object) \> MetadataSchema.Types
