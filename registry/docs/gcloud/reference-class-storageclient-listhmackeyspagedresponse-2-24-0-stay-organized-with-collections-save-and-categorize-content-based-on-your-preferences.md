...
# Class StorageClient.ListHmacKeysPagedResponse (2.24.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class StorageClient.ListHmacKeysPagedResponse extends AbstractPagedListResponse<ListHmacKeysRequest,ListHmacKeysResponse,HmacKeyMetadata,StorageClient.ListHmacKeysPage,StorageClient.ListHmacKeysFixedSizeCollection>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractPagedListResponse](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractPagedListResponse.html) \> StorageClient.ListHmacKeysPagedResponse
...
### createAsync(PageContext<ListHmacKeysRequest,ListHmacKeysResponse,HmacKeyMetadata> context, ApiFuture<ListHmacKeysResponse> futureResponse)

```
public static ApiFuture<StorageClient.ListHmacKeysPagedResponse> createAsync(PageContext<ListHmacKeysRequest,ListHmacKeysResponse,HmacKeyMetadata> context, ApiFuture<ListHmacKeysResponse> futureResponse)
```
...
`[PageContext](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PageContext.html)<[ListHmacKeysRequest](/java/docs/reference/google-cloud-storage/2.24.0/com.google.storage.v2.ListHmacKeysRequest),[ListHmacKeysResponse](/java/docs/reference/google-cloud-storage/2.24.0/com.google.storage.v2.ListHmacKeysResponse),[HmacKeyMetadata](/java/docs/reference/google-cloud-storage/2.24.0/com.google.storage.v2.HmacKeyMetadata)>`  

`futureResponse`

`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListHmacKeysResponse](/java/docs/reference/google-cloud-storage/2.24.0/com.google.storage.v2.ListHmacKeysResponse)>`  
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListHmacKeysPagedResponse](/java/docs/reference/google-cloud-storage/2.24.0/com.google.storage.v2.StorageClient.ListHmacKeysPagedResponse)>`
