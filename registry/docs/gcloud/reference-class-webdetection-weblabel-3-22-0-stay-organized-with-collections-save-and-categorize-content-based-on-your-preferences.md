...
# Class WebDetection.WebLabel (3.22.0) Stay organized with collections Save and categorize content based on your preferences.
...
[WebDetection.WebLabelOrBuilder](/java/docs/reference/google-cloud-vision/3.22.0/com.google.cloud.vision.v1p2beta1.WebDetection.WebLabelOrBuilder)
...
`[WebDetection.WebLabel](/java/docs/reference/google-cloud-vision/3.22.0/com.google.cloud.vision.v1p2beta1.WebDetection.WebLabel)`
...
`[WebDetection.WebLabel.Builder](/java/docs/reference/google-cloud-vision/3.22.0/com.google.cloud.vision.v1p2beta1.WebDetection.WebLabel.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[WebLabel](/java/docs/reference/google-cloud-vision/3.22.0/com.google.cloud.vision.v1p2beta1.WebDetection.WebLabel)>`
...
The BCP-47 language code for `label`, such as "en-US" or "sr-Latn". For more information, see [http://www.unicode.org/reports/tr35/#Unicode\_locale\_identifier](http://www.unicode.org/reports/tr35/#Unicode_locale_identifier).
