...
# Class MetadataServiceLimitedTimeRetryPolicy (2.26.0) Stay organized with collections Save and categorize content based on your preferences.
...
A retry policy for [`MetadataServiceConnection`](/cpp/docs/reference/dataplex/2.26.0/classgoogle_1_1cloud_1_1dataplex__v1_1_1MetadataServiceConnection) based on elapsed time.
...
### MetadataServiceLimitedTimeRetryPolicy(std::chrono::duration< DurationRep, DurationPeriod >)
...
### MetadataServiceLimitedTimeRetryPolicy(MetadataServiceLimitedTimeRetryPolicy &&)
...
### MetadataServiceLimitedTimeRetryPolicy(MetadataServiceLimitedTimeRetryPolicy const &)
...
`MetadataServiceLimitedTimeRetryPolicy const &`  
...
`std::unique_ptr< MetadataServiceRetryPolicy >`

## Type Aliases

### BaseType

**Alias Of**: `MetadataServiceRetryPolicy`
