...
# Class OSPolicyAssignment.Rollout (2.51.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class OSPolicyAssignment.Rollout extends GeneratedMessageV3 implements OSPolicyAssignment.RolloutOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> OSPolicyAssignment.Rollout

## Implements

[OSPolicyAssignment.RolloutOrBuilder](/java/docs/reference/google-cloud-os-config/2.51.0/com.google.cloud.osconfig.v1alpha.OSPolicyAssignment.RolloutOrBuilder)
...
### DISRUPTION\_BUDGET\_FIELD\_NUMBER
...
### MIN\_WAIT\_DURATION\_FIELD\_NUMBER
...
```
public static OSPolicyAssignment.Rollout getDefaultInstance()
```
...
`[OSPolicyAssignment.Rollout](/java/docs/reference/google-cloud-os-config/2.51.0/com.google.cloud.osconfig.v1alpha.OSPolicyAssignment.Rollout)`
...
```
public static OSPolicyAssignment.Rollout.Builder newBuilder()
```
...
`[OSPolicyAssignment.Rollout.Builder](/java/docs/reference/google-cloud-os-config/2.51.0/com.google.cloud.osconfig.v1alpha.OSPolicyAssignment.Rollout.Builder)`

### newBuilder(OSPolicyAssignment.Rollout prototype)

```
public static OSPolicyAssignment.Rollout.Builder newBuilder(OSPolicyAssignment.Rollout prototype)
```
...
```
public static OSPolicyAssignment.Rollout parseDelimitedFrom(InputStream input)
```
...
```
public static OSPolicyAssignment.Rollout parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static OSPolicyAssignment.Rollout parseFrom(byte[] data)
```
...
```
public static OSPolicyAssignment.Rollout parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static OSPolicyAssignment.Rollout parseFrom(ByteString data)
```
...
```
public static OSPolicyAssignment.Rollout parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static OSPolicyAssignment.Rollout parseFrom(CodedInputStream input)
```
...
```
public static OSPolicyAssignment.Rollout parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static OSPolicyAssignment.Rollout parseFrom(InputStream input)
```
...
```
public static OSPolicyAssignment.Rollout parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static OSPolicyAssignment.Rollout parseFrom(ByteBuffer data)
```
...
```
public static OSPolicyAssignment.Rollout parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<OSPolicyAssignment.Rollout> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[Rollout](/java/docs/reference/google-cloud-os-config/2.51.0/com.google.cloud.osconfig.v1alpha.OSPolicyAssignment.Rollout)>`
...
`[FixedOrPercent](/java/docs/reference/google-cloud-os-config/2.51.0/com.google.cloud.osconfig.v1alpha.FixedOrPercent)`
...
`[FixedOrPercentOrBuilder](/java/docs/reference/google-cloud-os-config/2.51.0/com.google.cloud.osconfig.v1alpha.FixedOrPercentOrBuilder)`
...
```
public Parser<OSPolicyAssignment.Rollout> getParserForType()
```
...
```
public OSPolicyAssignment.Rollout.Builder newBuilderForType()
```
...
```
protected OSPolicyAssignment.Rollout.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public OSPolicyAssignment.Rollout.Builder toBuilder()
```
