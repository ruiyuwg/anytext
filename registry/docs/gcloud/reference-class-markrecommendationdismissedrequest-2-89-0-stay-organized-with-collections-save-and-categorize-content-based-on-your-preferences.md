...
# Class MarkRecommendationDismissedRequest (2.89.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class MarkRecommendationDismissedRequest extends GeneratedMessage implements MarkRecommendationDismissedRequestOrBuilder
```

Request for the `MarkRecommendationDismissed` Method.

Protobuf type `google.cloud.recommender.v1.MarkRecommendationDismissedRequest`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessage.html) \> MarkRecommendationDismissedRequest

## Implements

[MarkRecommendationDismissedRequestOrBuilder](/java/docs/reference/google-cloud-recommender/latest/com.google.cloud.recommender.v1.MarkRecommendationDismissedRequestOrBuilder)
...
```
public static MarkRecommendationDismissedRequest getDefaultInstance()
```
...
`[MarkRecommendationDismissedRequest](/java/docs/reference/google-cloud-recommender/latest/com.google.cloud.recommender.v1.MarkRecommendationDismissedRequest)`
...
```
public static MarkRecommendationDismissedRequest.Builder newBuilder()
```
...
`[MarkRecommendationDismissedRequest.Builder](/java/docs/reference/google-cloud-recommender/latest/com.google.cloud.recommender.v1.MarkRecommendationDismissedRequest.Builder)`

### newBuilder(MarkRecommendationDismissedRequest prototype)

```
public static MarkRecommendationDismissedRequest.Builder newBuilder(MarkRecommendationDismissedRequest prototype)
```
...
```
public static MarkRecommendationDismissedRequest parseDelimitedFrom(InputStream input)
```
...
```
public static MarkRecommendationDismissedRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static MarkRecommendationDismissedRequest parseFrom(byte[] data)
```
...
```
public static MarkRecommendationDismissedRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static MarkRecommendationDismissedRequest parseFrom(ByteString data)
```
...
```
public static MarkRecommendationDismissedRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static MarkRecommendationDismissedRequest parseFrom(CodedInputStream input)
```
...
```
public static MarkRecommendationDismissedRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static MarkRecommendationDismissedRequest parseFrom(InputStream input)
```
...
```
public static MarkRecommendationDismissedRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static MarkRecommendationDismissedRequest parseFrom(ByteBuffer data)
```
...
```
public static MarkRecommendationDismissedRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<MarkRecommendationDismissedRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[MarkRecommendationDismissedRequest](/java/docs/reference/google-cloud-recommender/latest/com.google.cloud.recommender.v1.MarkRecommendationDismissedRequest)>`
...
```
public MarkRecommendationDismissedRequest getDefaultInstanceForType()
```
...
```
public Parser<MarkRecommendationDismissedRequest> getParserForType()
```
...
```
public MarkRecommendationDismissedRequest.Builder newBuilderForType()
```
...
```
protected MarkRecommendationDismissedRequest.Builder newBuilderForType(AbstractMessage.BuilderParent parent)
```
...
```
public MarkRecommendationDismissedRequest.Builder toBuilder()
```
