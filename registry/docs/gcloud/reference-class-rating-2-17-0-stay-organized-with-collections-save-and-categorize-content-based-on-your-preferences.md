...
# Class Rating (2.17.0) Stay organized with collections Save and categorize content based on your preferences.
...
### AVERAGE\_RATING\_FIELD\_NUMBER
...
### RATING\_HISTOGRAM\_FIELD\_NUMBER
...
`[Rating](/java/docs/reference/google-cloud-retail/2.17.0/com.google.cloud.retail.v2alpha.Rating)`
...
`[Rating.Builder](/java/docs/reference/google-cloud-retail/2.17.0/com.google.cloud.retail.v2alpha.Rating.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[Rating](/java/docs/reference/google-cloud-retail/2.17.0/com.google.cloud.retail.v2alpha.Rating)>`
...
The average rating of the Product. The rating is scaled at 1-5. Otherwise, an INVALID\_ARGUMENT error is returned.
...
The total number of ratings. This value is independent of the value of rating\_histogram. This value must be nonnegative. Otherwise, an INVALID\_ARGUMENT error is returned.
...
List of rating counts per rating value (index = rating - 1). The list is empty if there is no rating. If the list is non-empty, its size is always 5. Otherwise, an INVALID\_ARGUMENT error is returned. For example, \[41, 14, 13, 47, 303\]. It means that the Product got 41 ratings with 1 star, 14 ratings with 2 star, and so on.
