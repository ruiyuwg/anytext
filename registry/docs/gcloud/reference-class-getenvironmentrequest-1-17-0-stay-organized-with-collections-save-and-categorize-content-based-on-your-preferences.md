...
# Class GetEnvironmentRequest (1.17.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class GetEnvironmentRequest extends GeneratedMessageV3 implements GetEnvironmentRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> GetEnvironmentRequest

## Implements

[GetEnvironmentRequestOrBuilder](/java/docs/reference/google-cloud-notebooks/1.17.0/com.google.cloud.notebooks.v1beta1.GetEnvironmentRequestOrBuilder)
...
`[GetEnvironmentRequest](/java/docs/reference/google-cloud-notebooks/1.17.0/com.google.cloud.notebooks.v1beta1.GetEnvironmentRequest)`
...
```
public static GetEnvironmentRequest.Builder newBuilder()
```
...
`[GetEnvironmentRequest.Builder](/java/docs/reference/google-cloud-notebooks/1.17.0/com.google.cloud.notebooks.v1beta1.GetEnvironmentRequest.Builder)`

### newBuilder(GetEnvironmentRequest prototype)

```
public static GetEnvironmentRequest.Builder newBuilder(GetEnvironmentRequest prototype)
```
...
```
public static GetEnvironmentRequest parseDelimitedFrom(InputStream input)
```
...
```
public static GetEnvironmentRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetEnvironmentRequest parseFrom(byte[] data)
```
...
```
public static GetEnvironmentRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetEnvironmentRequest parseFrom(ByteString data)
```
...
```
public static GetEnvironmentRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetEnvironmentRequest parseFrom(CodedInputStream input)
```
...
```
public static GetEnvironmentRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetEnvironmentRequest parseFrom(InputStream input)
```
...
```
public static GetEnvironmentRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetEnvironmentRequest parseFrom(ByteBuffer data)
```
...
```
public static GetEnvironmentRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<GetEnvironmentRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[GetEnvironmentRequest](/java/docs/reference/google-cloud-notebooks/1.17.0/com.google.cloud.notebooks.v1beta1.GetEnvironmentRequest)>`
...
```
public Parser<GetEnvironmentRequest> getParserForType()
```
...
```
public GetEnvironmentRequest.Builder newBuilderForType()
```
...
```
protected GetEnvironmentRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public GetEnvironmentRequest.Builder toBuilder()
```
