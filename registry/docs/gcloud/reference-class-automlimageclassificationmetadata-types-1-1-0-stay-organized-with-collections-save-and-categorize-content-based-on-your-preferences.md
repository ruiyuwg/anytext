...
# Class AutoMlImageClassificationMetadata.Types (1.1.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://learn.microsoft.com/dotnet/api/system.object) \> AutoMlImageClassificationMetadata.Types
...
[Google.Cloud.AIPlatform.V1.Schema.TrainingJob.Definition](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/1.1.0/Google.Cloud.AIPlatform.V1.Schema.TrainingJob.Definition)
