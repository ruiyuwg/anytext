...
# Class ListTagBindingsResponse (1.5.6) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListTagBindingsResponse extends GeneratedMessageV3 implements ListTagBindingsResponseOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListTagBindingsResponse

## Implements

[ListTagBindingsResponseOrBuilder](/java/docs/reference/google-cloud-resourcemanager/1.5.6/com.google.cloud.resourcemanager.v3.ListTagBindingsResponseOrBuilder)
...
### TAG\_BINDINGS\_FIELD\_NUMBER

```
public static final int TAG_BINDINGS_FIELD_NUMBER
```
...
```
public static ListTagBindingsResponse getDefaultInstance()
```
...
[ListTagBindingsResponse](/java/docs/reference/google-cloud-resourcemanager/1.5.6/com.google.cloud.resourcemanager.v3.ListTagBindingsResponse)
...
```
public static ListTagBindingsResponse.Builder newBuilder()
```
...
[ListTagBindingsResponse.Builder](/java/docs/reference/google-cloud-resourcemanager/1.5.6/com.google.cloud.resourcemanager.v3.ListTagBindingsResponse.Builder)

### newBuilder(ListTagBindingsResponse prototype)

```
public static ListTagBindingsResponse.Builder newBuilder(ListTagBindingsResponse prototype)
```
...
```
public static ListTagBindingsResponse parseDelimitedFrom(InputStream input)
```
...
```
public static ListTagBindingsResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListTagBindingsResponse parseFrom(byte[] data)
```
...
```
public static ListTagBindingsResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListTagBindingsResponse parseFrom(ByteString data)
```
...
```
public static ListTagBindingsResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListTagBindingsResponse parseFrom(CodedInputStream input)
```
...
```
public static ListTagBindingsResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListTagBindingsResponse parseFrom(InputStream input)
```
...
```
public static ListTagBindingsResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListTagBindingsResponse parseFrom(ByteBuffer data)
```
...
```
public static ListTagBindingsResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ListTagBindingsResponse> parser()
```
...
[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListTagBindingsResponse](/java/docs/reference/google-cloud-resourcemanager/1.5.6/com.google.cloud.resourcemanager.v3.ListTagBindingsResponse)\>
...
```
public Parser<ListTagBindingsResponse> getParserForType()
```
...
[TagBinding](/java/docs/reference/google-cloud-resourcemanager/1.5.6/com.google.cloud.resourcemanager.v3.TagBinding)
...
[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[TagBinding](/java/docs/reference/google-cloud-resourcemanager/1.5.6/com.google.cloud.resourcemanager.v3.TagBinding)\>
...
[TagBindingOrBuilder](/java/docs/reference/google-cloud-resourcemanager/1.5.6/com.google.cloud.resourcemanager.v3.TagBindingOrBuilder)
...
[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.resourcemanager.v3.TagBindingOrBuilder\>
...
```
public ListTagBindingsResponse.Builder newBuilderForType()
```
...
```
protected ListTagBindingsResponse.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ListTagBindingsResponse.Builder toBuilder()
```
