...
# Vertex AI v1 API - Enum NotebookRuntime.Types.HealthState (3.22.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum NotebookRuntime.Types.HealthState
```

Reference documentation and code samples for the Vertex AI v1 API enum NotebookRuntime.Types.HealthState.
