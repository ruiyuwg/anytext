...
# Interface UpdateHmacKeyRequestOrBuilder (2.27.1) Stay organized with collections Save and categorize content based on your preferences.
...
Required. The HMAC key to update. If present, the hmac\_key's `id` field will be used to identify the key. Otherwise, the hmac\_key's access\_id and project fields will be used to identify the key.
...
`[HmacKeyMetadata](/java/docs/reference/google-cloud-storage/2.27.1/com.google.storage.v2.HmacKeyMetadata)`
...
`[HmacKeyMetadataOrBuilder](/java/docs/reference/google-cloud-storage/2.27.1/com.google.storage.v2.HmacKeyMetadataOrBuilder)`
...
Update mask for hmac\_key. Not specifying any fields will mean only the `state` field is updated to the value specified in `hmac_key`.
