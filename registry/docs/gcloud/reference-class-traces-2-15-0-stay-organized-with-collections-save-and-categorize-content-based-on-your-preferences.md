...
# Class Traces (2.15.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class Traces extends GeneratedMessageV3 implements TracesOrBuilder
```
...
`[Traces](/java/docs/reference/google-cloud-trace/2.15.0/com.google.devtools.cloudtrace.v1.Traces)`
...
```
public static Traces.Builder newBuilder()
```
...
`[Traces.Builder](/java/docs/reference/google-cloud-trace/2.15.0/com.google.devtools.cloudtrace.v1.Traces.Builder)`
...
```
public static Traces parseDelimitedFrom(InputStream input)
```
...
```
public static Traces parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Traces parseFrom(byte[] data)
```
...
```
public static Traces parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Traces parseFrom(ByteString data)
```
...
```
public static Traces parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Traces parseFrom(CodedInputStream input)
```
...
```
public static Traces parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Traces parseFrom(InputStream input)
```
...
```
public static Traces parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Traces parseFrom(ByteBuffer data)
```
...
```
public static Traces parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[Traces](/java/docs/reference/google-cloud-trace/2.15.0/com.google.devtools.cloudtrace.v1.Traces)>`
...
`[Trace](/java/docs/reference/google-cloud-trace/2.15.0/com.google.devtools.cloudtrace.v1.Trace)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Trace](/java/docs/reference/google-cloud-trace/2.15.0/com.google.devtools.cloudtrace.v1.Trace)>`
...
`[TraceOrBuilder](/java/docs/reference/google-cloud-trace/2.15.0/com.google.devtools.cloudtrace.v1.TraceOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.devtools.cloudtrace.v1.TraceOrBuilder>`
...
```
public Traces.Builder newBuilderForType()
```
...
```
protected Traces.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
