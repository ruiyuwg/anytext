...
# google-cloud-security-private-ca overview (2.89.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Certificate Authority Service Description:** Simplifies the deployment and management of private CAs without managing infrastructure.

[Certificate Authority Service Product Reference](https://cloud.google.com/certificate-authority-service/docs)

[GitHub Repository](https://github.com/googleapis/google-cloud-java/tree/main/java-security-private-ca)

[Maven artifact](https://central.sonatype.com/artifact/com.google.cloud/google-cloud-security-private-ca)
...
-   [Enable the API](https://console.cloud.google.com/apis/library/privateca.googleapis.com)
-   [Set up authentication](https://cloud.google.com/docs/authentication/client-libraries)

## Use the Certificate Authority Service for Java
...
The example below demonstrates how you would import the BOM and include the `google-cloud-security-private-ca` artifact.
...
implementation("com.google.cloud:google-cloud-security-private-ca")
...
libraryDependencies += "com.google.cloud" % "google-cloud-security-private-ca" % "2.89.0"

## Which version ID should I get started with?

For this library, we recommend using [com.google.cloud.security.privateca.v1](https://cloud.google.com/java/docs/reference/google-cloud-security-private-ca/2.89.0/com.google.cloud.security.privateca.v1) for new applications.
