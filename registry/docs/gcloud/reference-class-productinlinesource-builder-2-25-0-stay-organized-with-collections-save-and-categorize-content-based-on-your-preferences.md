...
# Class ProductInlineSource.Builder (2.25.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessageV3.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.Builder.html) \> ProductInlineSource.Builder

## Implements

[ProductInlineSourceOrBuilder](/java/docs/reference/google-cloud-retail/2.25.0/com.google.cloud.retail.v2beta.ProductInlineSourceOrBuilder)
...
`[Iterable](https://docs.oracle.com/javase/8/docs/api/java/lang/Iterable.html)<? extends com.google.cloud.retail.v2beta.Product>`  
...
`[ProductInlineSource.Builder](/java/docs/reference/google-cloud-retail/2.25.0/com.google.cloud.retail.v2beta.ProductInlineSource.Builder)`
...
`[Product](/java/docs/reference/google-cloud-retail/2.25.0/com.google.cloud.retail.v2beta.Product)`  
...
`[Product.Builder](/java/docs/reference/google-cloud-retail/2.25.0/com.google.cloud.retail.v2beta.Product.Builder)`  
...
`[ProductInlineSource](/java/docs/reference/google-cloud-retail/2.25.0/com.google.cloud.retail.v2beta.ProductInlineSource)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Builder](/java/docs/reference/google-cloud-retail/2.25.0/com.google.cloud.retail.v2beta.Product.Builder)>`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Product](/java/docs/reference/google-cloud-retail/2.25.0/com.google.cloud.retail.v2beta.Product)>`
...
`[ProductOrBuilder](/java/docs/reference/google-cloud-retail/2.25.0/com.google.cloud.retail.v2beta.ProductOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.retail.v2beta.ProductOrBuilder>`
