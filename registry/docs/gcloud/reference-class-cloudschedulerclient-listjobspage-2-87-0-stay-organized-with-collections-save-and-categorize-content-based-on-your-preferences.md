...
# Class CloudSchedulerClient.ListJobsPage (2.87.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class CloudSchedulerClient.ListJobsPage extends AbstractPage<ListJobsRequest,ListJobsResponse,Job,CloudSchedulerClient.ListJobsPage>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractPage](https://docs.cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractPage.html) \> CloudSchedulerClient.ListJobsPage
...
```
protected CloudSchedulerClient.ListJobsPage createPage(PageContext<ListJobsRequest,ListJobsResponse,Job> context, ListJobsResponse response)
```
...
`[PageContext](https://docs.cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PageContext.html)<[ListJobsRequest](/java/docs/reference/google-cloud-scheduler/latest/com.google.cloud.scheduler.v1.ListJobsRequest),[ListJobsResponse](/java/docs/reference/google-cloud-scheduler/latest/com.google.cloud.scheduler.v1.ListJobsResponse),[Job](/java/docs/reference/google-cloud-scheduler/latest/com.google.cloud.scheduler.v1.Job)>`  

`response`

`[ListJobsResponse](/java/docs/reference/google-cloud-scheduler/latest/com.google.cloud.scheduler.v1.ListJobsResponse)`  
...
`[CloudSchedulerClient.ListJobsPage](/java/docs/reference/google-cloud-scheduler/latest/com.google.cloud.scheduler.v1.CloudSchedulerClient.ListJobsPage)`
...
```
public ApiFuture<CloudSchedulerClient.ListJobsPage> createPageAsync(PageContext<ListJobsRequest,ListJobsResponse,Job> context, ApiFuture<ListJobsResponse> futureResponse)
```
...
`[ApiFuture](https://docs.cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListJobsResponse](/java/docs/reference/google-cloud-scheduler/latest/com.google.cloud.scheduler.v1.ListJobsResponse)>`  
...
`[ApiFuture](https://docs.cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListJobsPage](/java/docs/reference/google-cloud-scheduler/latest/com.google.cloud.scheduler.v1.CloudSchedulerClient.ListJobsPage)>`
