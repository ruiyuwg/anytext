...
# Class ImportCompletionDataRequest (2.4.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ImportCompletionDataRequest

## Implements

[ImportCompletionDataRequestOrBuilder](/java/docs/reference/google-cloud-retail/2.4.0/com.google.cloud.retail.v2beta.ImportCompletionDataRequestOrBuilder)
...
### NOTIFICATION\_PUBSUB\_TOPIC\_FIELD\_NUMBER
...
[ImportCompletionDataRequest](/java/docs/reference/google-cloud-retail/2.4.0/com.google.cloud.retail.v2beta.ImportCompletionDataRequest)
...
```
public static ImportCompletionDataRequest.Builder newBuilder()
```
...
[ImportCompletionDataRequest.Builder](/java/docs/reference/google-cloud-retail/2.4.0/com.google.cloud.retail.v2beta.ImportCompletionDataRequest.Builder)

### newBuilder(ImportCompletionDataRequest prototype)

```
public static ImportCompletionDataRequest.Builder newBuilder(ImportCompletionDataRequest prototype)
```
...
```
public static ImportCompletionDataRequest parseDelimitedFrom(InputStream input)
```
...
```
public static ImportCompletionDataRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ImportCompletionDataRequest parseFrom(byte[] data)
```
...
```
public static ImportCompletionDataRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ImportCompletionDataRequest parseFrom(ByteString data)
```
...
```
public static ImportCompletionDataRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ImportCompletionDataRequest parseFrom(CodedInputStream input)
```
...
```
public static ImportCompletionDataRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ImportCompletionDataRequest parseFrom(InputStream input)
```
...
```
public static ImportCompletionDataRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ImportCompletionDataRequest parseFrom(ByteBuffer data)
```
...
```
public static ImportCompletionDataRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ImportCompletionDataRequest](/java/docs/reference/google-cloud-retail/2.4.0/com.google.cloud.retail.v2beta.ImportCompletionDataRequest)\>
...
[CompletionDataInputConfig](/java/docs/reference/google-cloud-retail/2.4.0/com.google.cloud.retail.v2beta.CompletionDataInputConfig)
...
[CompletionDataInputConfigOrBuilder](/java/docs/reference/google-cloud-retail/2.4.0/com.google.cloud.retail.v2beta.CompletionDataInputConfigOrBuilder)
...
```
public ImportCompletionDataRequest.Builder newBuilderForType()
```
...
```
protected ImportCompletionDataRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ImportCompletionDataRequest.Builder toBuilder()
```
