...
# Class MachineArchitectureDetails (0.2.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> MachineArchitectureDetails

## Implements

[MachineArchitectureDetailsOrBuilder](/java/docs/reference/google-cloud-migrationcenter/0.2.0/com.google.cloud.migrationcenter.v1.MachineArchitectureDetailsOrBuilder)
...
### CPU\_ARCHITECTURE\_FIELD\_NUMBER
...
### CPU\_SOCKET\_COUNT\_FIELD\_NUMBER
...
### CPU\_THREAD\_COUNT\_FIELD\_NUMBER
...
`[MachineArchitectureDetails](/java/docs/reference/google-cloud-migrationcenter/0.2.0/com.google.cloud.migrationcenter.v1.MachineArchitectureDetails)`
...
`[MachineArchitectureDetails.Builder](/java/docs/reference/google-cloud-migrationcenter/0.2.0/com.google.cloud.migrationcenter.v1.MachineArchitectureDetails.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[MachineArchitectureDetails](/java/docs/reference/google-cloud-migrationcenter/0.2.0/com.google.cloud.migrationcenter.v1.MachineArchitectureDetails)>`
...
`[BiosDetails](/java/docs/reference/google-cloud-migrationcenter/0.2.0/com.google.cloud.migrationcenter.v1.BiosDetails)`
...
`[BiosDetailsOrBuilder](/java/docs/reference/google-cloud-migrationcenter/0.2.0/com.google.cloud.migrationcenter.v1.BiosDetailsOrBuilder)`
...
CPU architecture, e.g., "x64-based PC", "x86\_64", "i686" etc.
...
`[MachineArchitectureDetails.FirmwareType](/java/docs/reference/google-cloud-migrationcenter/0.2.0/com.google.cloud.migrationcenter.v1.MachineArchitectureDetails.FirmwareType)`
...
`[MachineArchitectureDetails.CpuHyperThreading](/java/docs/reference/google-cloud-migrationcenter/0.2.0/com.google.cloud.migrationcenter.v1.MachineArchitectureDetails.CpuHyperThreading)`
