...
# Method: googleapis.compute.v1.targetHttpsProxies.setSslCertificates Stay organized with collections Save and categorize content based on your preferences.
...
Required. Name of the TargetHttpsProxy resource to set an SslCertificates resource for.
...
`object ([TargetHttpsProxiesSetSslCertificatesRequest](/workflows/docs/reference/googleapis/compute/v1/Overview#TargetHttpsProxiesSetSslCertificatesRequest))`
...
Some fields might be optional or required. To identify required fields, refer to the [API documentation](https://cloud.google.com/compute/docs/reference/rest/v1/targetHttpsProxies/setSslCertificates).

### YAML

\- setSslCertificates:
    call: googleapis.compute.v1.targetHttpsProxies.setSslCertificates
    args:
        project: ...
        targetHttpsProxy: ...
        requestId: ...
        body:
            sslCertificates: ...
    result: setSslCertificatesResult
