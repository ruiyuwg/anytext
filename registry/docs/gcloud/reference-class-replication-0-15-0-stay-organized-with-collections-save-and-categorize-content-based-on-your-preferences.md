...
# Class Replication (0.15.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> Replication

## Implements

[ReplicationOrBuilder](/java/docs/reference/google-cloud-netapp/0.15.0/com.google.cloud.netapp.v1.ReplicationOrBuilder)
...
### DESTINATION\_VOLUME\_FIELD\_NUMBER
...
### DESTINATION\_VOLUME\_PARAMETERS\_FIELD\_NUMBER
...
### REPLICATION\_SCHEDULE\_FIELD\_NUMBER
...
### TRANSFER\_STATS\_FIELD\_NUMBER
...
`[Replication](/java/docs/reference/google-cloud-netapp/0.15.0/com.google.cloud.netapp.v1.Replication)`
...
`[Replication.Builder](/java/docs/reference/google-cloud-netapp/0.15.0/com.google.cloud.netapp.v1.Replication.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[Replication](/java/docs/reference/google-cloud-netapp/0.15.0/com.google.cloud.netapp.v1.Replication)>`
...
Output only. Full name of destination volume resource. Example : "projects/{project}/locations/{location}/volumes/{volume\_id}"
...
`[DestinationVolumeParameters](/java/docs/reference/google-cloud-netapp/0.15.0/com.google.cloud.netapp.v1.DestinationVolumeParameters)`
...
`[DestinationVolumeParametersOrBuilder](/java/docs/reference/google-cloud-netapp/0.15.0/com.google.cloud.netapp.v1.DestinationVolumeParametersOrBuilder)`
...
Use [#getLabelsMap()](/java/docs/reference/google-cloud-netapp/0.15.0/com.google.cloud.netapp.v1.Replication#com_google_cloud_netapp_v1_Replication_getLabelsMap__) instead.
...
`[Replication.MirrorState](/java/docs/reference/google-cloud-netapp/0.15.0/com.google.cloud.netapp.v1.Replication.MirrorState)`
...
`[Replication.ReplicationSchedule](/java/docs/reference/google-cloud-netapp/0.15.0/com.google.cloud.netapp.v1.Replication.ReplicationSchedule)`
...
`[Replication.ReplicationRole](/java/docs/reference/google-cloud-netapp/0.15.0/com.google.cloud.netapp.v1.Replication.ReplicationRole)`
...
Output only. Full name of source volume resource. Example : "projects/{project}/locations/{location}/volumes/{volume\_id}"
...
`[Replication.State](/java/docs/reference/google-cloud-netapp/0.15.0/com.google.cloud.netapp.v1.Replication.State)`
...
`[TransferStats](/java/docs/reference/google-cloud-netapp/0.15.0/com.google.cloud.netapp.v1.TransferStats)`
...
`[TransferStatsOrBuilder](/java/docs/reference/google-cloud-netapp/0.15.0/com.google.cloud.netapp.v1.TransferStatsOrBuilder)`
