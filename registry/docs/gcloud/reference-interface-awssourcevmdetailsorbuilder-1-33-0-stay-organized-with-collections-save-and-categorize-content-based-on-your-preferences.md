...
# Interface AwsSourceVmDetailsOrBuilder (1.33.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[AwsSourceVmDetails.Firmware](/java/docs/reference/google-cloud-vmmigration/1.33.0/com.google.cloud.vmmigration.v1.AwsSourceVmDetails.Firmware)`
