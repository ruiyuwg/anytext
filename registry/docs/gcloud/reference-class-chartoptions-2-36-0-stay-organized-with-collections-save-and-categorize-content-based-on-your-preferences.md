...
# Class ChartOptions (2.36.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ChartOptions extends GeneratedMessageV3 implements ChartOptionsOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ChartOptions

## Implements

[ChartOptionsOrBuilder](/java/docs/reference/google-cloud-monitoring-dashboard/2.36.0/com.google.monitoring.dashboard.v1.ChartOptionsOrBuilder)
...
`[ChartOptions](/java/docs/reference/google-cloud-monitoring-dashboard/2.36.0/com.google.monitoring.dashboard.v1.ChartOptions)`
...
```
public static ChartOptions.Builder newBuilder()
```
...
`[ChartOptions.Builder](/java/docs/reference/google-cloud-monitoring-dashboard/2.36.0/com.google.monitoring.dashboard.v1.ChartOptions.Builder)`

### newBuilder(ChartOptions prototype)

```
public static ChartOptions.Builder newBuilder(ChartOptions prototype)
```
...
```
public static ChartOptions parseDelimitedFrom(InputStream input)
```
...
```
public static ChartOptions parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ChartOptions parseFrom(byte[] data)
```
...
```
public static ChartOptions parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ChartOptions parseFrom(ByteString data)
```
...
```
public static ChartOptions parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ChartOptions parseFrom(CodedInputStream input)
```
...
```
public static ChartOptions parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ChartOptions parseFrom(InputStream input)
```
...
```
public static ChartOptions parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ChartOptions parseFrom(ByteBuffer data)
```
...
```
public static ChartOptions parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ChartOptions> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ChartOptions](/java/docs/reference/google-cloud-monitoring-dashboard/2.36.0/com.google.monitoring.dashboard.v1.ChartOptions)>`
...
```
public ChartOptions.Mode getMode()
```
...
`[ChartOptions.Mode](/java/docs/reference/google-cloud-monitoring-dashboard/2.36.0/com.google.monitoring.dashboard.v1.ChartOptions.Mode)`
...
```
public ChartOptions.Builder newBuilderForType()
```
...
```
protected ChartOptions.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ChartOptions.Builder toBuilder()
```
