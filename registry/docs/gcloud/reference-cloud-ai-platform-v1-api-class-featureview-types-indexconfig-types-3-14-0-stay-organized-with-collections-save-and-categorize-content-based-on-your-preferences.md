...
# Cloud AI Platform v1 API - Class FeatureView.Types.IndexConfig.Types (3.14.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class FeatureView.Types.IndexConfig.Types
```

Reference documentation and code samples for the Cloud AI Platform v1 API class FeatureView.Types.IndexConfig.Types.

Container for nested types declared in the IndexConfig message type.

## Inheritance

[object](https://learn.microsoft.com/dotnet/api/system.object) \> FeatureView.Types.IndexConfig.Types
