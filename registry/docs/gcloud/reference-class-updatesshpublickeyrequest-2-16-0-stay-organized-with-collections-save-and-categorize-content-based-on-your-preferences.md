...
# Class UpdateSshPublicKeyRequest (2.16.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> UpdateSshPublicKeyRequest

## Implements

[UpdateSshPublicKeyRequestOrBuilder](/java/docs/reference/google-cloud-os-login/2.16.0/com.google.cloud.oslogin.v1.UpdateSshPublicKeyRequestOrBuilder)
...
### SSH\_PUBLIC\_KEY\_FIELD\_NUMBER
...
`[UpdateSshPublicKeyRequest](/java/docs/reference/google-cloud-os-login/2.16.0/com.google.cloud.oslogin.v1.UpdateSshPublicKeyRequest)`
...
`[UpdateSshPublicKeyRequest.Builder](/java/docs/reference/google-cloud-os-login/2.16.0/com.google.cloud.oslogin.v1.UpdateSshPublicKeyRequest.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[UpdateSshPublicKeyRequest](/java/docs/reference/google-cloud-os-login/2.16.0/com.google.cloud.oslogin.v1.UpdateSshPublicKeyRequest)>`
...
`[OsLoginProto.SshPublicKey](/java/docs/reference/google-cloud-os-login/2.16.0/com.google.cloud.oslogin.common.OsLoginProto.SshPublicKey)`
...
`[OsLoginProto.SshPublicKeyOrBuilder](/java/docs/reference/google-cloud-os-login/2.16.0/com.google.cloud.oslogin.common.OsLoginProto.SshPublicKeyOrBuilder)`
