...
# Enum Text.TextStyle.VerticalAlignment (2.55.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum Text.TextStyle.VerticalAlignment extends Enum<Text.TextStyle.VerticalAlignment> implements ProtocolMessageEnum
```

The vertical alignment of both the title and content on a text widget

Protobuf enum `google.monitoring.dashboard.v1.Text.TextStyle.VerticalAlignment`
...
No vertical alignment specified, will default to V\_TOP
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-monitoring-dashboard/2.55.0/com.google.monitoring.dashboard.v1.Text.TextStyle.VerticalAlignment#com_google_monitoring_dashboard_v1_Text_TextStyle_VerticalAlignment_forNumber_int_) instead._
