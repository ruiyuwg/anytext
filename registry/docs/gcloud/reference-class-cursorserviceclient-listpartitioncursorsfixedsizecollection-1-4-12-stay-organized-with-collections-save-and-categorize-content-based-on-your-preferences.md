...
# Class CursorServiceClient.ListPartitionCursorsFixedSizeCollection (1.4.12) Stay organized with collections Save and categorize content based on your preferences.

1.16.2 (latest) 1.16.1 1.15.21 1.14.8 1.13.8 1.12.22 1.11.2 1.10.0 1.9.4 1.8.0 1.7.1 1.6.3 1.5.5 1.4.12

```
public static class CursorServiceClient.ListPartitionCursorsFixedSizeCollection extends AbstractFixedSizeCollection<ListPartitionCursorsRequest,ListPartitionCursorsResponse,PartitionCursor,CursorServiceClient.ListPartitionCursorsPage,CursorServiceClient.ListPartitionCursorsFixedSizeCollection>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractFixedSizeCollection](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractFixedSizeCollection.html) \> CursorServiceClient.ListPartitionCursorsFixedSizeCollection
...
### createCollection(List<CursorServiceClient.ListPartitionCursorsPage> pages, int collectionSize)

```
protected CursorServiceClient.ListPartitionCursorsFixedSizeCollection createCollection(List<CursorServiceClient.ListPartitionCursorsPage> pages, int collectionSize)
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ListPartitionCursorsPage](/java/docs/reference/google-cloud-pubsublite/1.4.12/com.google.cloud.pubsublite.v1.CursorServiceClient.ListPartitionCursorsPage)>`  
...
[CursorServiceClient.ListPartitionCursorsFixedSizeCollection](/java/docs/reference/google-cloud-pubsublite/1.4.12/com.google.cloud.pubsublite.v1.CursorServiceClient.ListPartitionCursorsFixedSizeCollection)
