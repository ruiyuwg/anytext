...
# Class AttachTrustRequest (1.16.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class AttachTrustRequest extends GeneratedMessageV3 implements AttachTrustRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> AttachTrustRequest

## Implements

[AttachTrustRequestOrBuilder](/java/docs/reference/google-cloud-managed-identities/1.16.0/com.google.cloud.managedidentities.v1.AttachTrustRequestOrBuilder)
...
```
public static AttachTrustRequest getDefaultInstance()
```
...
`[AttachTrustRequest](/java/docs/reference/google-cloud-managed-identities/1.16.0/com.google.cloud.managedidentities.v1.AttachTrustRequest)`
...
```
public static AttachTrustRequest.Builder newBuilder()
```
...
`[AttachTrustRequest.Builder](/java/docs/reference/google-cloud-managed-identities/1.16.0/com.google.cloud.managedidentities.v1.AttachTrustRequest.Builder)`

### newBuilder(AttachTrustRequest prototype)

```
public static AttachTrustRequest.Builder newBuilder(AttachTrustRequest prototype)
```
...
```
public static AttachTrustRequest parseDelimitedFrom(InputStream input)
```
...
```
public static AttachTrustRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AttachTrustRequest parseFrom(byte[] data)
```
...
```
public static AttachTrustRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AttachTrustRequest parseFrom(ByteString data)
```
...
```
public static AttachTrustRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AttachTrustRequest parseFrom(CodedInputStream input)
```
...
```
public static AttachTrustRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AttachTrustRequest parseFrom(InputStream input)
```
...
```
public static AttachTrustRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AttachTrustRequest parseFrom(ByteBuffer data)
```
...
```
public static AttachTrustRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<AttachTrustRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[AttachTrustRequest](/java/docs/reference/google-cloud-managed-identities/1.16.0/com.google.cloud.managedidentities.v1.AttachTrustRequest)>`
...
```
public AttachTrustRequest getDefaultInstanceForType()
```
...
```
public Parser<AttachTrustRequest> getParserForType()
```
...
`[Trust](/java/docs/reference/google-cloud-managed-identities/1.16.0/com.google.cloud.managedidentities.v1.Trust)`
...
`[TrustOrBuilder](/java/docs/reference/google-cloud-managed-identities/1.16.0/com.google.cloud.managedidentities.v1.TrustOrBuilder)`
...
```
public AttachTrustRequest.Builder newBuilderForType()
```
...
```
protected AttachTrustRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public AttachTrustRequest.Builder toBuilder()
```
