...
# Class ListInstanceOSPoliciesCompliancesResponse (2.8.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListInstanceOSPoliciesCompliancesResponse extends GeneratedMessageV3 implements ListInstanceOSPoliciesCompliancesResponseOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListInstanceOSPoliciesCompliancesResponse

## Implements

[ListInstanceOSPoliciesCompliancesResponseOrBuilder](/java/docs/reference/google-cloud-os-config/2.8.0/com.google.cloud.osconfig.v1alpha.ListInstanceOSPoliciesCompliancesResponseOrBuilder)
...
### INSTANCE\_OS\_POLICIES\_COMPLIANCES\_FIELD\_NUMBER

```
public static final int INSTANCE_OS_POLICIES_COMPLIANCES_FIELD_NUMBER
```
...
```
public static ListInstanceOSPoliciesCompliancesResponse getDefaultInstance()
```
...
[ListInstanceOSPoliciesCompliancesResponse](/java/docs/reference/google-cloud-os-config/2.8.0/com.google.cloud.osconfig.v1alpha.ListInstanceOSPoliciesCompliancesResponse)
...
```
public static ListInstanceOSPoliciesCompliancesResponse.Builder newBuilder()
```
...
[ListInstanceOSPoliciesCompliancesResponse.Builder](/java/docs/reference/google-cloud-os-config/2.8.0/com.google.cloud.osconfig.v1alpha.ListInstanceOSPoliciesCompliancesResponse.Builder)

### newBuilder(ListInstanceOSPoliciesCompliancesResponse prototype)

```
public static ListInstanceOSPoliciesCompliancesResponse.Builder newBuilder(ListInstanceOSPoliciesCompliancesResponse prototype)
```
...
```
public static ListInstanceOSPoliciesCompliancesResponse parseDelimitedFrom(InputStream input)
```
...
```
public static ListInstanceOSPoliciesCompliancesResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListInstanceOSPoliciesCompliancesResponse parseFrom(byte[] data)
```
...
```
public static ListInstanceOSPoliciesCompliancesResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListInstanceOSPoliciesCompliancesResponse parseFrom(ByteString data)
```
...
```
public static ListInstanceOSPoliciesCompliancesResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListInstanceOSPoliciesCompliancesResponse parseFrom(CodedInputStream input)
```
...
```
public static ListInstanceOSPoliciesCompliancesResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListInstanceOSPoliciesCompliancesResponse parseFrom(InputStream input)
```
...
```
public static ListInstanceOSPoliciesCompliancesResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListInstanceOSPoliciesCompliancesResponse parseFrom(ByteBuffer data)
```
...
```
public static ListInstanceOSPoliciesCompliancesResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ListInstanceOSPoliciesCompliancesResponse> parser()
```
...
[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListInstanceOSPoliciesCompliancesResponse](/java/docs/reference/google-cloud-os-config/2.8.0/com.google.cloud.osconfig.v1alpha.ListInstanceOSPoliciesCompliancesResponse)\>
...
[InstanceOSPoliciesCompliance](/java/docs/reference/google-cloud-os-config/2.8.0/com.google.cloud.osconfig.v1alpha.InstanceOSPoliciesCompliance)
...
[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[InstanceOSPoliciesCompliance](/java/docs/reference/google-cloud-os-config/2.8.0/com.google.cloud.osconfig.v1alpha.InstanceOSPoliciesCompliance)\>
...
[InstanceOSPoliciesComplianceOrBuilder](/java/docs/reference/google-cloud-os-config/2.8.0/com.google.cloud.osconfig.v1alpha.InstanceOSPoliciesComplianceOrBuilder)
...
```
public Parser<ListInstanceOSPoliciesCompliancesResponse> getParserForType()
```
...
```
public ListInstanceOSPoliciesCompliancesResponse.Builder newBuilderForType()
```
...
```
protected ListInstanceOSPoliciesCompliancesResponse.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ListInstanceOSPoliciesCompliancesResponse.Builder toBuilder()
```
