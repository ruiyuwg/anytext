...
# Cloud AI Platform v1 API - Class UpdateFeatureGroupRequest (3.4.0) Stay organized with collections Save and categorize content based on your preferences.
...
[object](https://learn.microsoft.com/dotnet/api/system.object) \> UpdateFeatureGroupRequest

## Implements

[IMessage](https://cloud.google.com/dotnet/docs/reference/Google.Protobuf/latest/Google.Protobuf.IMessage-1.html)[UpdateFeatureGroupRequest](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.4.0/Google.Cloud.AIPlatform.V1.UpdateFeatureGroupRequest), [IEquatable](https://learn.microsoft.com/dotnet/api/system.iequatable-1)[UpdateFeatureGroupRequest](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.4.0/Google.Cloud.AIPlatform.V1.UpdateFeatureGroupRequest), [IDeepCloneable](https://cloud.google.com/dotnet/docs/reference/Google.Protobuf/latest/Google.Protobuf.IDeepCloneable-1.html)[UpdateFeatureGroupRequest](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.4.0/Google.Cloud.AIPlatform.V1.UpdateFeatureGroupRequest), [IBufferMessage](https://cloud.google.com/dotnet/docs/reference/Google.Protobuf/latest/Google.Protobuf.IBufferMessage.html), [IMessage](https://cloud.google.com/dotnet/docs/reference/Google.Protobuf/latest/Google.Protobuf.IMessage.html)
...
`[UpdateFeatureGroupRequest](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.4.0/Google.Cloud.AIPlatform.V1.UpdateFeatureGroupRequest)`  
...
`[FeatureGroup](/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/3.4.0/Google.Cloud.AIPlatform.V1.FeatureGroup)`
