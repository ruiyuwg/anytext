...
# Class ListImportDataFilesResponse (0.36.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListImportDataFilesResponse extends GeneratedMessageV3 implements ListImportDataFilesResponseOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListImportDataFilesResponse

## Implements

[ListImportDataFilesResponseOrBuilder](/java/docs/reference/google-cloud-migrationcenter/0.36.0/com.google.cloud.migrationcenter.v1.ListImportDataFilesResponseOrBuilder)
...
### IMPORT\_DATA\_FILES\_FIELD\_NUMBER

```
public static final int IMPORT_DATA_FILES_FIELD_NUMBER
```
...
```
public static ListImportDataFilesResponse getDefaultInstance()
```
...
`[ListImportDataFilesResponse](/java/docs/reference/google-cloud-migrationcenter/0.36.0/com.google.cloud.migrationcenter.v1.ListImportDataFilesResponse)`
...
```
public static ListImportDataFilesResponse.Builder newBuilder()
```
...
`[ListImportDataFilesResponse.Builder](/java/docs/reference/google-cloud-migrationcenter/0.36.0/com.google.cloud.migrationcenter.v1.ListImportDataFilesResponse.Builder)`

### newBuilder(ListImportDataFilesResponse prototype)

```
public static ListImportDataFilesResponse.Builder newBuilder(ListImportDataFilesResponse prototype)
```
...
```
public static ListImportDataFilesResponse parseDelimitedFrom(InputStream input)
```
...
```
public static ListImportDataFilesResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListImportDataFilesResponse parseFrom(byte[] data)
```
...
```
public static ListImportDataFilesResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListImportDataFilesResponse parseFrom(ByteString data)
```
...
```
public static ListImportDataFilesResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListImportDataFilesResponse parseFrom(CodedInputStream input)
```
...
```
public static ListImportDataFilesResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListImportDataFilesResponse parseFrom(InputStream input)
```
...
```
public static ListImportDataFilesResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListImportDataFilesResponse parseFrom(ByteBuffer data)
```
...
```
public static ListImportDataFilesResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ListImportDataFilesResponse> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListImportDataFilesResponse](/java/docs/reference/google-cloud-migrationcenter/0.36.0/com.google.cloud.migrationcenter.v1.ListImportDataFilesResponse)>`
...
```
public ListImportDataFilesResponse getDefaultInstanceForType()
```
...
### getImportDataFiles(int index)

```
public ImportDataFile getImportDataFiles(int index)
```

The list of import data files.

`repeated .google.cloud.migrationcenter.v1.ImportDataFile import_data_files = 1;`
...
`[ImportDataFile](/java/docs/reference/google-cloud-migrationcenter/0.36.0/com.google.cloud.migrationcenter.v1.ImportDataFile)`

### getImportDataFilesCount()
...
```
public List<ImportDataFile> getImportDataFilesList()
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[ImportDataFile](/java/docs/reference/google-cloud-migrationcenter/0.36.0/com.google.cloud.migrationcenter.v1.ImportDataFile)>`

### getImportDataFilesOrBuilder(int index)

```
public ImportDataFileOrBuilder getImportDataFilesOrBuilder(int index)
```
...
`[ImportDataFileOrBuilder](/java/docs/reference/google-cloud-migrationcenter/0.36.0/com.google.cloud.migrationcenter.v1.ImportDataFileOrBuilder)`

### getImportDataFilesOrBuilderList()

```
public List<? extends ImportDataFileOrBuilder> getImportDataFilesOrBuilderList()
```
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.migrationcenter.v1.ImportDataFileOrBuilder>`
...
```
public Parser<ListImportDataFilesResponse> getParserForType()
```
...
```
public ListImportDataFilesResponse.Builder newBuilderForType()
```
...
```
protected ListImportDataFilesResponse.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ListImportDataFilesResponse.Builder toBuilder()
```
