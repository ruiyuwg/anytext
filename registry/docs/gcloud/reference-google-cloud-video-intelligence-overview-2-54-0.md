...
# google-cloud-video-intelligence overview (2.54.0)
...
[GitHub Repository (includes samples)](https://github.com/googleapis/google-cloud-java/tree/main/java-video-intelligence)
...
libraryDependencies += "com.google.cloud" % "google-cloud-video-intelligence" % "2.54.0"

## Which version ID should I get started with?

For this library, we recommend using [com.google.cloud.videointelligence.v1](https://cloud.google.com/java/docs/reference/google-cloud-video-intelligence/2.54.0/com.google.cloud.videointelligence.v1) for new applications.
