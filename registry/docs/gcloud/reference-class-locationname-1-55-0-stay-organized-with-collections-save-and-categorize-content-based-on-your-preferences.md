...
# Class LocationName (1.55.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[LocationName.Builder](/java/docs/reference/google-cloud-managed-identities/1.55.0/com.google.cloud.managedidentities.v1.LocationName.Builder)`
...
`[LocationName](/java/docs/reference/google-cloud-managed-identities/1.55.0/com.google.cloud.managedidentities.v1.LocationName)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[LocationName](/java/docs/reference/google-cloud-managed-identities/1.55.0/com.google.cloud.managedidentities.v1.LocationName)>`
