...
# Enum UpgradeHistoryEntry.State (1.51.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum UpgradeHistoryEntry.State extends Enum<UpgradeHistoryEntry.State> implements ProtocolMessageEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-notebooks/1.51.0/com.google.cloud.notebooks.v2.UpgradeHistoryEntry.State#com_google_cloud_notebooks_v2_UpgradeHistoryEntry_State_forNumber_int_) instead._
