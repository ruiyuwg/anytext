...
# Enum ScanRun.ResultState (2.18.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-websecurityscanner/2.18.0/com.google.cloud.websecurityscanner.v1beta.ScanRun.ResultState#com_google_cloud_websecurityscanner_v1beta_ScanRun_ResultState_forNumber_int_) instead._
