...
# Enum BasicSli.SliCriteriaCase (3.6.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum BasicSli.SliCriteriaCase extends Enum<BasicSli.SliCriteriaCase> implements Internal.EnumLite, AbstractMessageLite.InternalOneOfEnum
```
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-monitoring/3.6.0/com.google.monitoring.v3.BasicSli.SliCriteriaCase#com_google_monitoring_v3_BasicSli_SliCriteriaCase_forNumber_int_) instead._
