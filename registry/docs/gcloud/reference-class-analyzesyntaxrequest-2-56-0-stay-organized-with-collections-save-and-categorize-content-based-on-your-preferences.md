...
# Class AnalyzeSyntaxRequest (2.56.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class AnalyzeSyntaxRequest extends GeneratedMessageV3 implements AnalyzeSyntaxRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> AnalyzeSyntaxRequest

## Implements

[AnalyzeSyntaxRequestOrBuilder](/java/docs/reference/google-cloud-language/2.56.0/com.google.cloud.language.v1.AnalyzeSyntaxRequestOrBuilder)
...
```
public static AnalyzeSyntaxRequest getDefaultInstance()
```
...
`[AnalyzeSyntaxRequest](/java/docs/reference/google-cloud-language/2.56.0/com.google.cloud.language.v1.AnalyzeSyntaxRequest)`
...
```
public static AnalyzeSyntaxRequest.Builder newBuilder()
```
...
`[AnalyzeSyntaxRequest.Builder](/java/docs/reference/google-cloud-language/2.56.0/com.google.cloud.language.v1.AnalyzeSyntaxRequest.Builder)`

### newBuilder(AnalyzeSyntaxRequest prototype)

```
public static AnalyzeSyntaxRequest.Builder newBuilder(AnalyzeSyntaxRequest prototype)
```
...
```
public static AnalyzeSyntaxRequest parseDelimitedFrom(InputStream input)
```
...
```
public static AnalyzeSyntaxRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AnalyzeSyntaxRequest parseFrom(byte[] data)
```
...
```
public static AnalyzeSyntaxRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AnalyzeSyntaxRequest parseFrom(ByteString data)
```
...
```
public static AnalyzeSyntaxRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AnalyzeSyntaxRequest parseFrom(CodedInputStream input)
```
...
```
public static AnalyzeSyntaxRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AnalyzeSyntaxRequest parseFrom(InputStream input)
```
...
```
public static AnalyzeSyntaxRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static AnalyzeSyntaxRequest parseFrom(ByteBuffer data)
```
...
```
public static AnalyzeSyntaxRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<AnalyzeSyntaxRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[AnalyzeSyntaxRequest](/java/docs/reference/google-cloud-language/2.56.0/com.google.cloud.language.v1.AnalyzeSyntaxRequest)>`
...
```
public AnalyzeSyntaxRequest getDefaultInstanceForType()
```
...
`[Document](/java/docs/reference/google-cloud-language/2.56.0/com.google.cloud.language.v1.Document)`
...
`[DocumentOrBuilder](/java/docs/reference/google-cloud-language/2.56.0/com.google.cloud.language.v1.DocumentOrBuilder)`
...
`[EncodingType](/java/docs/reference/google-cloud-language/2.56.0/com.google.cloud.language.v1.EncodingType)`
...
```
public Parser<AnalyzeSyntaxRequest> getParserForType()
```
...
```
public AnalyzeSyntaxRequest.Builder newBuilderForType()
```
...
```
protected AnalyzeSyntaxRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public AnalyzeSyntaxRequest.Builder toBuilder()
```
