...
# Class GcsSource (0.9.0) Stay organized with collections Save and categorize content based on your preferences.
...
[GcsSourceOrBuilder](/java/docs/reference/google-cloud-visionai/0.9.0/com.google.cloud.visionai.v1.GcsSourceOrBuilder)
...
`[GcsSource](/java/docs/reference/google-cloud-visionai/0.9.0/com.google.cloud.visionai.v1.GcsSource)`
...
`[GcsSource.Builder](/java/docs/reference/google-cloud-visionai/0.9.0/com.google.cloud.visionai.v1.GcsSource.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[GcsSource](/java/docs/reference/google-cloud-visionai/0.9.0/com.google.cloud.visionai.v1.GcsSource)>`
