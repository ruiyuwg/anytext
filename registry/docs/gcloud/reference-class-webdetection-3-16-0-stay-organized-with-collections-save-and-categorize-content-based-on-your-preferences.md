...
# Class WebDetection (3.16.0) Stay organized with collections Save and categorize content based on your preferences.
...
[WebDetectionOrBuilder](/java/docs/reference/google-cloud-vision/3.16.0/com.google.cloud.vision.v1.WebDetectionOrBuilder)
...
`[WebDetection](/java/docs/reference/google-cloud-vision/3.16.0/com.google.cloud.vision.v1.WebDetection)`
...
`[WebDetection.Builder](/java/docs/reference/google-cloud-vision/3.16.0/com.google.cloud.vision.v1.WebDetection.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[WebDetection](/java/docs/reference/google-cloud-vision/3.16.0/com.google.cloud.vision.v1.WebDetection)>`
...
`[WebDetection.WebLabel](/java/docs/reference/google-cloud-vision/3.16.0/com.google.cloud.vision.v1.WebDetection.WebLabel)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[WebLabel](/java/docs/reference/google-cloud-vision/3.16.0/com.google.cloud.vision.v1.WebDetection.WebLabel)>`
...
`[WebDetection.WebLabelOrBuilder](/java/docs/reference/google-cloud-vision/3.16.0/com.google.cloud.vision.v1.WebDetection.WebLabelOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.vision.v1.WebDetection.WebLabelOrBuilder>`
...
`[WebDetection.WebImage](/java/docs/reference/google-cloud-vision/3.16.0/com.google.cloud.vision.v1.WebDetection.WebImage)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[WebImage](/java/docs/reference/google-cloud-vision/3.16.0/com.google.cloud.vision.v1.WebDetection.WebImage)>`
...
`[WebDetection.WebImageOrBuilder](/java/docs/reference/google-cloud-vision/3.16.0/com.google.cloud.vision.v1.WebDetection.WebImageOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.vision.v1.WebDetection.WebImageOrBuilder>`
...
`[WebDetection.WebPage](/java/docs/reference/google-cloud-vision/3.16.0/com.google.cloud.vision.v1.WebDetection.WebPage)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[WebPage](/java/docs/reference/google-cloud-vision/3.16.0/com.google.cloud.vision.v1.WebDetection.WebPage)>`
...
`[WebDetection.WebPageOrBuilder](/java/docs/reference/google-cloud-vision/3.16.0/com.google.cloud.vision.v1.WebDetection.WebPageOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.vision.v1.WebDetection.WebPageOrBuilder>`
...
`[WebDetection.WebEntity](/java/docs/reference/google-cloud-vision/3.16.0/com.google.cloud.vision.v1.WebDetection.WebEntity)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[WebEntity](/java/docs/reference/google-cloud-vision/3.16.0/com.google.cloud.vision.v1.WebDetection.WebEntity)>`
...
`[WebDetection.WebEntityOrBuilder](/java/docs/reference/google-cloud-vision/3.16.0/com.google.cloud.vision.v1.WebDetection.WebEntityOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.vision.v1.WebDetection.WebEntityOrBuilder>`
