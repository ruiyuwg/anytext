...
# Interface PurgeUserEventsRequestOrBuilder (2.17.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface PurgeUserEventsRequestOrBuilder extends MessageOrBuilder
```
