...
# Class MigrationCenterClient.ListPreferenceSetsPage (0.37.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class MigrationCenterClient.ListPreferenceSetsPage extends AbstractPage<ListPreferenceSetsRequest,ListPreferenceSetsResponse,PreferenceSet,MigrationCenterClient.ListPreferenceSetsPage>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractPage](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractPage.html) \> MigrationCenterClient.ListPreferenceSetsPage
...
### createPage(PageContext<ListPreferenceSetsRequest,ListPreferenceSetsResponse,PreferenceSet> context, ListPreferenceSetsResponse response)

```
protected MigrationCenterClient.ListPreferenceSetsPage createPage(PageContext<ListPreferenceSetsRequest,ListPreferenceSetsResponse,PreferenceSet> context, ListPreferenceSetsResponse response)
```
...
`[PageContext](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PageContext.html)<[ListPreferenceSetsRequest](/java/docs/reference/google-cloud-migrationcenter/0.37.0/com.google.cloud.migrationcenter.v1.ListPreferenceSetsRequest),[ListPreferenceSetsResponse](/java/docs/reference/google-cloud-migrationcenter/0.37.0/com.google.cloud.migrationcenter.v1.ListPreferenceSetsResponse),[PreferenceSet](/java/docs/reference/google-cloud-migrationcenter/0.37.0/com.google.cloud.migrationcenter.v1.PreferenceSet)>`  

`response`

`[ListPreferenceSetsResponse](/java/docs/reference/google-cloud-migrationcenter/0.37.0/com.google.cloud.migrationcenter.v1.ListPreferenceSetsResponse)`  
...
`[MigrationCenterClient.ListPreferenceSetsPage](/java/docs/reference/google-cloud-migrationcenter/0.37.0/com.google.cloud.migrationcenter.v1.MigrationCenterClient.ListPreferenceSetsPage)`
...
### createPageAsync(PageContext<ListPreferenceSetsRequest,ListPreferenceSetsResponse,PreferenceSet> context, ApiFuture<ListPreferenceSetsResponse> futureResponse)

```
public ApiFuture<MigrationCenterClient.ListPreferenceSetsPage> createPageAsync(PageContext<ListPreferenceSetsRequest,ListPreferenceSetsResponse,PreferenceSet> context, ApiFuture<ListPreferenceSetsResponse> futureResponse)
```
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListPreferenceSetsResponse](/java/docs/reference/google-cloud-migrationcenter/0.37.0/com.google.cloud.migrationcenter.v1.ListPreferenceSetsResponse)>`  
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListPreferenceSetsPage](/java/docs/reference/google-cloud-migrationcenter/0.37.0/com.google.cloud.migrationcenter.v1.MigrationCenterClient.ListPreferenceSetsPage)>`
