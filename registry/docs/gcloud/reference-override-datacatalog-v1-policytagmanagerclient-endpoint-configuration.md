...
# Override datacatalog\_v1::PolicyTagManagerClient Endpoint Configuration
  ...
  auto client = google::cloud::datacatalog_v1::PolicyTagManagerClient(
      google::cloud::datacatalog_v1::MakePolicyTagManagerConnection(options));
```
