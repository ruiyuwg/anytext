...
# Interface DiscoveryOccurrenceOrBuilder (2.59.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[DiscoveryOccurrence.AnalysisCompleted](/java/docs/reference/grafeas/2.59.0/io.grafeas.v1.DiscoveryOccurrence.AnalysisCompleted)`
...
`[DiscoveryOccurrence.AnalysisCompletedOrBuilder](/java/docs/reference/grafeas/2.59.0/io.grafeas.v1.DiscoveryOccurrence.AnalysisCompletedOrBuilder)`
...
`[DiscoveryOccurrence.AnalysisStatus](/java/docs/reference/grafeas/2.59.0/io.grafeas.v1.DiscoveryOccurrence.AnalysisStatus)`
...
`[DiscoveryOccurrence.ContinuousAnalysis](/java/docs/reference/grafeas/2.59.0/io.grafeas.v1.DiscoveryOccurrence.ContinuousAnalysis)`
...
`[DiscoveryOccurrence.SBOMStatus](/java/docs/reference/grafeas/2.59.0/io.grafeas.v1.DiscoveryOccurrence.SBOMStatus)`
...
`[DiscoveryOccurrence.SBOMStatusOrBuilder](/java/docs/reference/grafeas/2.59.0/io.grafeas.v1.DiscoveryOccurrence.SBOMStatusOrBuilder)`
...
`[DiscoveryOccurrence.VulnerabilityAttestation](/java/docs/reference/grafeas/2.59.0/io.grafeas.v1.DiscoveryOccurrence.VulnerabilityAttestation)`
...
`[DiscoveryOccurrence.VulnerabilityAttestationOrBuilder](/java/docs/reference/grafeas/2.59.0/io.grafeas.v1.DiscoveryOccurrence.VulnerabilityAttestationOrBuilder)`
