...
# Enum CryptoKeyVersion.CryptoKeyVersionView (2.44.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-kms/2.44.0/com.google.cloud.kms.v1.CryptoKeyVersion.CryptoKeyVersionView#com_google_cloud_kms_v1_CryptoKeyVersion_CryptoKeyVersionView_forNumber_int_) instead._
