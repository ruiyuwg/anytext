...
# Class ImportAttachedClusterRequest (0.36.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ImportAttachedClusterRequest extends GeneratedMessageV3 implements ImportAttachedClusterRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ImportAttachedClusterRequest

## Implements

[ImportAttachedClusterRequestOrBuilder](/java/docs/reference/google-cloud-gke-multi-cloud/0.36.0/com.google.cloud.gkemulticloud.v1.ImportAttachedClusterRequestOrBuilder)
...
### FLEET\_MEMBERSHIP\_FIELD\_NUMBER

```
public static final int FLEET_MEMBERSHIP_FIELD_NUMBER
```
...
### PLATFORM\_VERSION\_FIELD\_NUMBER
...
```
public static ImportAttachedClusterRequest getDefaultInstance()
```
...
`[ImportAttachedClusterRequest](/java/docs/reference/google-cloud-gke-multi-cloud/0.36.0/com.google.cloud.gkemulticloud.v1.ImportAttachedClusterRequest)`
...
```
public static ImportAttachedClusterRequest.Builder newBuilder()
```
...
`[ImportAttachedClusterRequest.Builder](/java/docs/reference/google-cloud-gke-multi-cloud/0.36.0/com.google.cloud.gkemulticloud.v1.ImportAttachedClusterRequest.Builder)`

### newBuilder(ImportAttachedClusterRequest prototype)

```
public static ImportAttachedClusterRequest.Builder newBuilder(ImportAttachedClusterRequest prototype)
```
...
```
public static ImportAttachedClusterRequest parseDelimitedFrom(InputStream input)
```
...
```
public static ImportAttachedClusterRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ImportAttachedClusterRequest parseFrom(byte[] data)
```
...
```
public static ImportAttachedClusterRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ImportAttachedClusterRequest parseFrom(ByteString data)
```
...
```
public static ImportAttachedClusterRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ImportAttachedClusterRequest parseFrom(CodedInputStream input)
```
...
```
public static ImportAttachedClusterRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ImportAttachedClusterRequest parseFrom(InputStream input)
```
...
```
public static ImportAttachedClusterRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ImportAttachedClusterRequest parseFrom(ByteBuffer data)
```
...
```
public static ImportAttachedClusterRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ImportAttachedClusterRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ImportAttachedClusterRequest](/java/docs/reference/google-cloud-gke-multi-cloud/0.36.0/com.google.cloud.gkemulticloud.v1.ImportAttachedClusterRequest)>`
...
```
public Parser<ImportAttachedClusterRequest> getParserForType()
```
...
`[AttachedProxyConfig](/java/docs/reference/google-cloud-gke-multi-cloud/0.36.0/com.google.cloud.gkemulticloud.v1.AttachedProxyConfig)`
...
`[AttachedProxyConfigOrBuilder](/java/docs/reference/google-cloud-gke-multi-cloud/0.36.0/com.google.cloud.gkemulticloud.v1.AttachedProxyConfigOrBuilder)`
...
```
public ImportAttachedClusterRequest.Builder newBuilderForType()
```
...
```
protected ImportAttachedClusterRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ImportAttachedClusterRequest.Builder toBuilder()
```
