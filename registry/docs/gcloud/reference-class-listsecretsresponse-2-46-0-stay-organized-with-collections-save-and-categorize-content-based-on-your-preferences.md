...
# Class ListSecretsResponse (2.46.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ListSecretsResponse extends GeneratedMessageV3 implements ListSecretsResponseOrBuilder
```

Response message for SecretManagerService.ListSecrets.

Protobuf type `google.cloud.secretmanager.v1beta2.ListSecretsResponse`

## Inheritance

[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ListSecretsResponse

## Implements

[ListSecretsResponseOrBuilder](/java/docs/reference/google-cloud-secretmanager/2.46.0/com.google.cloud.secretmanager.v1beta2.ListSecretsResponseOrBuilder)
...
`[ListSecretsResponse](/java/docs/reference/google-cloud-secretmanager/2.46.0/com.google.cloud.secretmanager.v1beta2.ListSecretsResponse)`
...
```
public static ListSecretsResponse.Builder newBuilder()
```
...
`[ListSecretsResponse.Builder](/java/docs/reference/google-cloud-secretmanager/2.46.0/com.google.cloud.secretmanager.v1beta2.ListSecretsResponse.Builder)`

### newBuilder(ListSecretsResponse prototype)

```
public static ListSecretsResponse.Builder newBuilder(ListSecretsResponse prototype)
```
...
```
public static ListSecretsResponse parseDelimitedFrom(InputStream input)
```
...
```
public static ListSecretsResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListSecretsResponse parseFrom(byte[] data)
```
...
```
public static ListSecretsResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListSecretsResponse parseFrom(ByteString data)
```
...
```
public static ListSecretsResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListSecretsResponse parseFrom(CodedInputStream input)
```
...
```
public static ListSecretsResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListSecretsResponse parseFrom(InputStream input)
```
...
```
public static ListSecretsResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ListSecretsResponse parseFrom(ByteBuffer data)
```
...
```
public static ListSecretsResponse parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ListSecretsResponse](/java/docs/reference/google-cloud-secretmanager/2.46.0/com.google.cloud.secretmanager.v1beta2.ListSecretsResponse)>`
...
A token to retrieve the next page of results. Pass this value in ListSecretsRequest.page\_token to retrieve the next page.
...
The list of Secrets sorted in reverse by create\_time (newest first).

`repeated .google.cloud.secretmanager.v1beta2.Secret secrets = 1;`
...
`[Secret](/java/docs/reference/google-cloud-secretmanager/2.46.0/com.google.cloud.secretmanager.v1beta2.Secret)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[Secret](/java/docs/reference/google-cloud-secretmanager/2.46.0/com.google.cloud.secretmanager.v1beta2.Secret)>`
...
`[SecretOrBuilder](/java/docs/reference/google-cloud-secretmanager/2.46.0/com.google.cloud.secretmanager.v1beta2.SecretOrBuilder)`
...
`[List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<? extends com.google.cloud.secretmanager.v1beta2.SecretOrBuilder>`
...
```
public ListSecretsResponse.Builder newBuilderForType()
```
...
```
protected ListSecretsResponse.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ListSecretsResponse.Builder toBuilder()
```
