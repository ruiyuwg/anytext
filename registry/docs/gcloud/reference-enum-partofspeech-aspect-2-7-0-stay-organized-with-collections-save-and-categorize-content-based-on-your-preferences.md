...
# Enum PartOfSpeech.Aspect (2.7.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public enum PartOfSpeech.Aspect extends Enum<PartOfSpeech.Aspect> implements ProtocolMessageEnum
```

The characteristic of a verb that expresses time flow during an event.

Protobuf enum `google.cloud.language.v1.PartOfSpeech.Aspect`
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-language/2.7.0/com.google.cloud.language.v1.PartOfSpeech.Aspect#com_google_cloud_language_v1_PartOfSpeech_Aspect_forNumber_int_) instead._
