...
# Enum BatchTranslateMetadata.State (2.32.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-translate/2.32.0/com.google.cloud.translate.v3.BatchTranslateMetadata.State#com_google_cloud_translate_v3_BatchTranslateMetadata_State_forNumber_int_) instead._
