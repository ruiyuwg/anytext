...
# Interface IamCheckerGrpc.AsyncService (1.26.0) Stay organized with collections Save and categorize content based on your preferences.
...
`[TroubleshootIamPolicyRequest](/java/docs/reference/google-cloud-policy-troubleshooter/1.26.0/com.google.cloud.policytroubleshooter.v1.TroubleshootIamPolicyRequest)`  

`responseObserver`

`io.grpc.stub.StreamObserver<[TroubleshootIamPolicyResponse](/java/docs/reference/google-cloud-policy-troubleshooter/1.26.0/com.google.cloud.policytroubleshooter.v1.TroubleshootIamPolicyResponse)>`  
