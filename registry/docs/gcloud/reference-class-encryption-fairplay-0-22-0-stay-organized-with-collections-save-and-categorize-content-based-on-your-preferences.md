...
# Class Encryption.Fairplay (0.22.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static final class Encryption.Fairplay extends GeneratedMessageV3 implements Encryption.FairplayOrBuilder
```
...
[Encryption.FairplayOrBuilder](/java/docs/reference/google-cloud-live-stream/0.22.0/com.google.cloud.video.livestream.v1.Encryption.FairplayOrBuilder)
...
```
public static Encryption.Fairplay getDefaultInstance()
```
...
`[Encryption.Fairplay](/java/docs/reference/google-cloud-live-stream/0.22.0/com.google.cloud.video.livestream.v1.Encryption.Fairplay)`
...
```
public static Encryption.Fairplay.Builder newBuilder()
```
...
`[Encryption.Fairplay.Builder](/java/docs/reference/google-cloud-live-stream/0.22.0/com.google.cloud.video.livestream.v1.Encryption.Fairplay.Builder)`

### newBuilder(Encryption.Fairplay prototype)

```
public static Encryption.Fairplay.Builder newBuilder(Encryption.Fairplay prototype)
```
...
```
public static Encryption.Fairplay parseDelimitedFrom(InputStream input)
```
...
```
public static Encryption.Fairplay parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Encryption.Fairplay parseFrom(byte[] data)
```
...
```
public static Encryption.Fairplay parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Encryption.Fairplay parseFrom(ByteString data)
```
...
```
public static Encryption.Fairplay parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Encryption.Fairplay parseFrom(CodedInputStream input)
```
...
```
public static Encryption.Fairplay parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Encryption.Fairplay parseFrom(InputStream input)
```
...
```
public static Encryption.Fairplay parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Encryption.Fairplay parseFrom(ByteBuffer data)
```
...
```
public static Encryption.Fairplay parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<Encryption.Fairplay> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[Fairplay](/java/docs/reference/google-cloud-live-stream/0.22.0/com.google.cloud.video.livestream.v1.Encryption.Fairplay)>`
...
```
public Encryption.Fairplay getDefaultInstanceForType()
```
...
```
public Parser<Encryption.Fairplay> getParserForType()
```
...
```
public Encryption.Fairplay.Builder newBuilderForType()
```
...
```
protected Encryption.Fairplay.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public Encryption.Fairplay.Builder toBuilder()
```
