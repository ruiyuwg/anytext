...
# Class GetEffectiveSecurityHealthAnalyticsCustomModuleRequest (2.63.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class GetEffectiveSecurityHealthAnalyticsCustomModuleRequest extends GeneratedMessageV3 implements GetEffectiveSecurityHealthAnalyticsCustomModuleRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> GetEffectiveSecurityHealthAnalyticsCustomModuleRequest

## Implements

[GetEffectiveSecurityHealthAnalyticsCustomModuleRequestOrBuilder](/java/docs/reference/google-cloud-securitycenter/2.63.0/com.google.cloud.securitycenter.v1.GetEffectiveSecurityHealthAnalyticsCustomModuleRequestOrBuilder)
...
```
public static GetEffectiveSecurityHealthAnalyticsCustomModuleRequest getDefaultInstance()
```
...
`[GetEffectiveSecurityHealthAnalyticsCustomModuleRequest](/java/docs/reference/google-cloud-securitycenter/2.63.0/com.google.cloud.securitycenter.v1.GetEffectiveSecurityHealthAnalyticsCustomModuleRequest)`
...
```
public static GetEffectiveSecurityHealthAnalyticsCustomModuleRequest.Builder newBuilder()
```
...
`[GetEffectiveSecurityHealthAnalyticsCustomModuleRequest.Builder](/java/docs/reference/google-cloud-securitycenter/2.63.0/com.google.cloud.securitycenter.v1.GetEffectiveSecurityHealthAnalyticsCustomModuleRequest.Builder)`

### newBuilder(GetEffectiveSecurityHealthAnalyticsCustomModuleRequest prototype)

```
public static GetEffectiveSecurityHealthAnalyticsCustomModuleRequest.Builder newBuilder(GetEffectiveSecurityHealthAnalyticsCustomModuleRequest prototype)
```
...
```
public static GetEffectiveSecurityHealthAnalyticsCustomModuleRequest parseDelimitedFrom(InputStream input)
```
...
```
public static GetEffectiveSecurityHealthAnalyticsCustomModuleRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetEffectiveSecurityHealthAnalyticsCustomModuleRequest parseFrom(byte[] data)
```
...
```
public static GetEffectiveSecurityHealthAnalyticsCustomModuleRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetEffectiveSecurityHealthAnalyticsCustomModuleRequest parseFrom(ByteString data)
```
...
```
public static GetEffectiveSecurityHealthAnalyticsCustomModuleRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetEffectiveSecurityHealthAnalyticsCustomModuleRequest parseFrom(CodedInputStream input)
```
...
```
public static GetEffectiveSecurityHealthAnalyticsCustomModuleRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetEffectiveSecurityHealthAnalyticsCustomModuleRequest parseFrom(InputStream input)
```
...
```
public static GetEffectiveSecurityHealthAnalyticsCustomModuleRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static GetEffectiveSecurityHealthAnalyticsCustomModuleRequest parseFrom(ByteBuffer data)
```
...
```
public static GetEffectiveSecurityHealthAnalyticsCustomModuleRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<GetEffectiveSecurityHealthAnalyticsCustomModuleRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[GetEffectiveSecurityHealthAnalyticsCustomModuleRequest](/java/docs/reference/google-cloud-securitycenter/2.63.0/com.google.cloud.securitycenter.v1.GetEffectiveSecurityHealthAnalyticsCustomModuleRequest)>`
...
```
public Parser<GetEffectiveSecurityHealthAnalyticsCustomModuleRequest> getParserForType()
```
...
```
public GetEffectiveSecurityHealthAnalyticsCustomModuleRequest.Builder newBuilderForType()
```
...
```
protected GetEffectiveSecurityHealthAnalyticsCustomModuleRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public GetEffectiveSecurityHealthAnalyticsCustomModuleRequest.Builder toBuilder()
```
