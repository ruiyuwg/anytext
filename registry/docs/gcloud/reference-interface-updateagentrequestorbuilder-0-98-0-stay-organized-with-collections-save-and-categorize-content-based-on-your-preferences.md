...
# Interface UpdateAgentRequestOrBuilder (0.98.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface UpdateAgentRequestOrBuilder extends MessageOrBuilder
```
...
`[Agent](/java/docs/reference/google-cloud-dialogflow-cx/latest/com.google.cloud.dialogflow.cx.v3beta1.Agent)`
...
`[AgentOrBuilder](/java/docs/reference/google-cloud-dialogflow-cx/latest/com.google.cloud.dialogflow.cx.v3beta1.AgentOrBuilder)`
