...
# Interface ImportProductsResponseOrBuilder (2.1.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public interface ImportProductsResponseOrBuilder extends MessageOrBuilder
```
...
[ImportErrorsConfig](/java/docs/reference/google-cloud-retail/2.1.0/com.google.cloud.retail.v2.ImportErrorsConfig)
...
[ImportErrorsConfigOrBuilder](/java/docs/reference/google-cloud-retail/2.1.0/com.google.cloud.retail.v2.ImportErrorsConfigOrBuilder)
