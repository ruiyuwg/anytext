...
# Class ModifyCloudToDeviceConfigRequest (2.27.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class ModifyCloudToDeviceConfigRequest extends GeneratedMessageV3 implements ModifyCloudToDeviceConfigRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> ModifyCloudToDeviceConfigRequest

## Implements

[ModifyCloudToDeviceConfigRequestOrBuilder](/java/docs/reference/google-cloud-iot/2.27.0/com.google.cloud.iot.v1.ModifyCloudToDeviceConfigRequestOrBuilder)
...
### VERSION\_TO\_UPDATE\_FIELD\_NUMBER

```
public static final int VERSION_TO_UPDATE_FIELD_NUMBER
```
...
```
public static ModifyCloudToDeviceConfigRequest getDefaultInstance()
```
...
`[ModifyCloudToDeviceConfigRequest](/java/docs/reference/google-cloud-iot/2.27.0/com.google.cloud.iot.v1.ModifyCloudToDeviceConfigRequest)`
...
```
public static ModifyCloudToDeviceConfigRequest.Builder newBuilder()
```
...
`[ModifyCloudToDeviceConfigRequest.Builder](/java/docs/reference/google-cloud-iot/2.27.0/com.google.cloud.iot.v1.ModifyCloudToDeviceConfigRequest.Builder)`

### newBuilder(ModifyCloudToDeviceConfigRequest prototype)

```
public static ModifyCloudToDeviceConfigRequest.Builder newBuilder(ModifyCloudToDeviceConfigRequest prototype)
```
...
```
public static ModifyCloudToDeviceConfigRequest parseDelimitedFrom(InputStream input)
```
...
```
public static ModifyCloudToDeviceConfigRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ModifyCloudToDeviceConfigRequest parseFrom(byte[] data)
```
...
```
public static ModifyCloudToDeviceConfigRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ModifyCloudToDeviceConfigRequest parseFrom(ByteString data)
```
...
```
public static ModifyCloudToDeviceConfigRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ModifyCloudToDeviceConfigRequest parseFrom(CodedInputStream input)
```
...
```
public static ModifyCloudToDeviceConfigRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ModifyCloudToDeviceConfigRequest parseFrom(InputStream input)
```
...
```
public static ModifyCloudToDeviceConfigRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static ModifyCloudToDeviceConfigRequest parseFrom(ByteBuffer data)
```
...
```
public static ModifyCloudToDeviceConfigRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<ModifyCloudToDeviceConfigRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[ModifyCloudToDeviceConfigRequest](/java/docs/reference/google-cloud-iot/2.27.0/com.google.cloud.iot.v1.ModifyCloudToDeviceConfigRequest)>`
...
```
public Parser<ModifyCloudToDeviceConfigRequest> getParserForType()
```
...
```
public ModifyCloudToDeviceConfigRequest.Builder newBuilderForType()
```
...
```
protected ModifyCloudToDeviceConfigRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public ModifyCloudToDeviceConfigRequest.Builder toBuilder()
```
