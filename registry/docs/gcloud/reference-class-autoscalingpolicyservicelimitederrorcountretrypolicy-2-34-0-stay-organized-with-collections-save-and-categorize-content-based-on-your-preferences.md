...
# Class AutoscalingPolicyServiceLimitedErrorCountRetryPolicy (2.34.0) Stay organized with collections Save and categorize content based on your preferences.
...
A retry policy for [`AutoscalingPolicyServiceConnection`](/cpp/docs/reference/dataproc/2.34.0/classgoogle_1_1cloud_1_1dataproc__v1_1_1AutoscalingPolicyServiceConnection) based on counting errors.
...
`AutoscalingPolicyServiceLimitedErrorCountRetryPolicy const &`  
...
`std::unique_ptr< AutoscalingPolicyServiceRetryPolicy >`

## Type Aliases

### BaseType

**Alias Of**: `AutoscalingPolicyServiceRetryPolicy`
