...
# Class DeleteJobRequest (2.48.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class DeleteJobRequest extends GeneratedMessageV3 implements DeleteJobRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> DeleteJobRequest

## Implements

[DeleteJobRequestOrBuilder](/java/docs/reference/google-cloud-scheduler/2.48.0/com.google.cloud.scheduler.v1beta1.DeleteJobRequestOrBuilder)
...
### LEGACY\_APP\_ENGINE\_CRON\_FIELD\_NUMBER
...
`[DeleteJobRequest](/java/docs/reference/google-cloud-scheduler/2.48.0/com.google.cloud.scheduler.v1beta1.DeleteJobRequest)`
...
```
public static DeleteJobRequest.Builder newBuilder()
```
...
`[DeleteJobRequest.Builder](/java/docs/reference/google-cloud-scheduler/2.48.0/com.google.cloud.scheduler.v1beta1.DeleteJobRequest.Builder)`

### newBuilder(DeleteJobRequest prototype)

```
public static DeleteJobRequest.Builder newBuilder(DeleteJobRequest prototype)
```
...
```
public static DeleteJobRequest parseDelimitedFrom(InputStream input)
```
...
```
public static DeleteJobRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteJobRequest parseFrom(byte[] data)
```
...
```
public static DeleteJobRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteJobRequest parseFrom(ByteString data)
```
...
```
public static DeleteJobRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteJobRequest parseFrom(CodedInputStream input)
```
...
```
public static DeleteJobRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteJobRequest parseFrom(InputStream input)
```
...
```
public static DeleteJobRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static DeleteJobRequest parseFrom(ByteBuffer data)
```
...
```
public static DeleteJobRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[DeleteJobRequest](/java/docs/reference/google-cloud-scheduler/2.48.0/com.google.cloud.scheduler.v1beta1.DeleteJobRequest)>`
...
This field is used to manage the legacy App Engine Cron jobs using the Cloud Scheduler API. If the field is set to true, the job in the \_\_cron queue with the corresponding name will be deleted instead.
...
```
public DeleteJobRequest.Builder newBuilderForType()
```
...
```
protected DeleteJobRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
