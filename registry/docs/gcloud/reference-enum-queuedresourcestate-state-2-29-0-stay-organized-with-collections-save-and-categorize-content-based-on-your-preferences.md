...
# Enum QueuedResourceState.State (2.29.0) Stay organized with collections Save and categorize content based on your preferences.
...
**Deprecated.** _Use [#forNumber(int)](/java/docs/reference/google-cloud-tpu/2.29.0/com.google.cloud.tpu.v2alpha1.QueuedResourceState.State#com_google_cloud_tpu_v2alpha1_QueuedResourceState_State_forNumber_int_) instead._
