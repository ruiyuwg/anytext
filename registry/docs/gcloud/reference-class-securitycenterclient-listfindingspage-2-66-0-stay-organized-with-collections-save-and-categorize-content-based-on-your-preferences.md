...
# Class SecurityCenterClient.ListFindingsPage (2.66.0) Stay organized with collections Save and categorize content based on your preferences.
...
[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractPage](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractPage.html) \> SecurityCenterClient.ListFindingsPage
...
`[PageContext](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.rpc.PageContext.html)<[ListFindingsRequest](/java/docs/reference/google-cloud-securitycenter/2.66.0/com.google.cloud.securitycenter.v1p1beta1.ListFindingsRequest),[ListFindingsResponse](/java/docs/reference/google-cloud-securitycenter/2.66.0/com.google.cloud.securitycenter.v1p1beta1.ListFindingsResponse),[ListFindingsResult](/java/docs/reference/google-cloud-securitycenter/2.66.0/com.google.cloud.securitycenter.v1p1beta1.ListFindingsResponse.ListFindingsResult)>`  

`response`

`[ListFindingsResponse](/java/docs/reference/google-cloud-securitycenter/2.66.0/com.google.cloud.securitycenter.v1p1beta1.ListFindingsResponse)`  
...
`[SecurityCenterClient.ListFindingsPage](/java/docs/reference/google-cloud-securitycenter/2.66.0/com.google.cloud.securitycenter.v1p1beta1.SecurityCenterClient.ListFindingsPage)`
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListFindingsResponse](/java/docs/reference/google-cloud-securitycenter/2.66.0/com.google.cloud.securitycenter.v1p1beta1.ListFindingsResponse)>`  
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListFindingsPage](/java/docs/reference/google-cloud-securitycenter/2.66.0/com.google.cloud.securitycenter.v1p1beta1.SecurityCenterClient.ListFindingsPage)>`
