...
# Class PauseModelRequest (2.24.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class PauseModelRequest extends GeneratedMessageV3 implements PauseModelRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> PauseModelRequest

## Implements

[PauseModelRequestOrBuilder](/java/docs/reference/google-cloud-retail/2.24.0/com.google.cloud.retail.v2beta.PauseModelRequestOrBuilder)
...
```
public static PauseModelRequest getDefaultInstance()
```
...
`[PauseModelRequest](/java/docs/reference/google-cloud-retail/2.24.0/com.google.cloud.retail.v2beta.PauseModelRequest)`
...
```
public static PauseModelRequest.Builder newBuilder()
```
...
`[PauseModelRequest.Builder](/java/docs/reference/google-cloud-retail/2.24.0/com.google.cloud.retail.v2beta.PauseModelRequest.Builder)`

### newBuilder(PauseModelRequest prototype)

```
public static PauseModelRequest.Builder newBuilder(PauseModelRequest prototype)
```
...
```
public static PauseModelRequest parseDelimitedFrom(InputStream input)
```
...
```
public static PauseModelRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PauseModelRequest parseFrom(byte[] data)
```
...
```
public static PauseModelRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PauseModelRequest parseFrom(ByteString data)
```
...
```
public static PauseModelRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PauseModelRequest parseFrom(CodedInputStream input)
```
...
```
public static PauseModelRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PauseModelRequest parseFrom(InputStream input)
```
...
```
public static PauseModelRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PauseModelRequest parseFrom(ByteBuffer data)
```
...
```
public static PauseModelRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<PauseModelRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[PauseModelRequest](/java/docs/reference/google-cloud-retail/2.24.0/com.google.cloud.retail.v2beta.PauseModelRequest)>`
...
```
public PauseModelRequest getDefaultInstanceForType()
```
...
```
public Parser<PauseModelRequest> getParserForType()
```
...
```
public PauseModelRequest.Builder newBuilderForType()
```
...
```
protected PauseModelRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
...
```
public PauseModelRequest.Builder toBuilder()
```
