...
# Class PurgeProductsRequest (2.34.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public final class PurgeProductsRequest extends GeneratedMessageV3 implements PurgeProductsRequestOrBuilder
```
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> PurgeProductsRequest

## Implements

[PurgeProductsRequestOrBuilder](/java/docs/reference/google-cloud-retail/2.34.0/com.google.cloud.retail.v2alpha.PurgeProductsRequestOrBuilder)
...
```
public static PurgeProductsRequest getDefaultInstance()
```
...
`[PurgeProductsRequest](/java/docs/reference/google-cloud-retail/2.34.0/com.google.cloud.retail.v2alpha.PurgeProductsRequest)`
...
```
public static PurgeProductsRequest.Builder newBuilder()
```
...
`[PurgeProductsRequest.Builder](/java/docs/reference/google-cloud-retail/2.34.0/com.google.cloud.retail.v2alpha.PurgeProductsRequest.Builder)`

### newBuilder(PurgeProductsRequest prototype)

```
public static PurgeProductsRequest.Builder newBuilder(PurgeProductsRequest prototype)
```
...
```
public static PurgeProductsRequest parseDelimitedFrom(InputStream input)
```
...
```
public static PurgeProductsRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PurgeProductsRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PurgeProductsRequest parseFrom(ByteString data)
```
...
```
public static PurgeProductsRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PurgeProductsRequest parseFrom(CodedInputStream input)
```
...
```
public static PurgeProductsRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PurgeProductsRequest parseFrom(InputStream input)
```
...
```
public static PurgeProductsRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public static PurgeProductsRequest parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry)
```
...
```
public static Parser<PurgeProductsRequest> parser()
```
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[PurgeProductsRequest](/java/docs/reference/google-cloud-retail/2.34.0/com.google.cloud.retail.v2alpha.PurgeProductsRequest)>`
...
-   Comparators (">", "<", ">=", "<=", "="). Examples:
    ...
    -   create\_time <= "2015-02-13T17:05:46Z"
    -   availability = "IN\_STOCK"
-   Conjunctions ("AND") Examples:
    
    -   create\_time <= "2015-02-13T17:05:46Z" AND availability = "PREORDER"
-   Disjunctions ("OR") Examples:
    
    -   create\_time <= "2015-02-13T17:05:46Z" OR availability = "IN\_STOCK"
-   Can support nested queries. Examples:
    
    -   (create\_time <= "2015-02-13T17:05:46Z" AND availability = "PREORDER") OR (create\_time >= "2015-02-14T13:03:32Z" AND availability = "IN\_STOCK")
-   Filter Limits:
...
-   Delete back order products created before a timestamp. create\_time <= "2015-02-13T17:05:46Z" OR availability = "BACKORDER"
...
```
public Parser<PurgeProductsRequest> getParserForType()
```
...
```
protected PurgeProductsRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent parent)
```
