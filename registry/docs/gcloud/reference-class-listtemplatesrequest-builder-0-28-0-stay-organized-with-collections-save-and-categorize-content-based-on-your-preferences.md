...
# Class ListTemplatesRequest.Builder (0.28.0) Stay organized with collections Save and categorize content based on your preferences.

0.28.0 (latest) 0.26.0 0.24.0 0.23.0 0.21.0 0.19.0 0.17.0 0.16.0 0.15.0 0.14.0 0.13.0 0.11.0 0.9.0 0.8.0 0.5.0 0.4.0 0.3.0 0.1.0

```
public static final class ListTemplatesRequest.Builder extends GeneratedMessage.Builder<ListTemplatesRequest.Builder> implements ListTemplatesRequestOrBuilder
```

Message for requesting list of Templates

Protobuf type `google.cloud.modelarmor.v1beta.ListTemplatesRequest`

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite.Builder<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.Builder.html) \> [AbstractMessage.Builder<BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.Builder.html) \> [GeneratedMessage.Builder](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessage.Builder.html) \> ListTemplatesRequest.Builder

## Implements

[ListTemplatesRequestOrBuilder](/java/docs/reference/google-cloud-modelarmor/latest/com.google.cloud.modelarmor.v1beta.ListTemplatesRequestOrBuilder)
...
`[ListTemplatesRequest](/java/docs/reference/google-cloud-modelarmor/latest/com.google.cloud.modelarmor.v1beta.ListTemplatesRequest)`

### buildPartial()

```
public ListTemplatesRequest buildPartial()
```
...
```
public ListTemplatesRequest.Builder clear()
```
...
`[ListTemplatesRequest.Builder](/java/docs/reference/google-cloud-modelarmor/latest/com.google.cloud.modelarmor.v1beta.ListTemplatesRequest.Builder)`
...
```
public ListTemplatesRequest.Builder clearFilter()
```
...
```
public ListTemplatesRequest.Builder clearOrderBy()
```
...
```
public ListTemplatesRequest.Builder clearPageSize()
```
...
```
public ListTemplatesRequest.Builder clearPageToken()
```
...
```
public ListTemplatesRequest.Builder clearParent()
```
...
```
public ListTemplatesRequest getDefaultInstanceForType()
```
...
### mergeFrom(ListTemplatesRequest other)

```
public ListTemplatesRequest.Builder mergeFrom(ListTemplatesRequest other)
```
...
```
public ListTemplatesRequest.Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry)
```
...
```
public ListTemplatesRequest.Builder mergeFrom(Message other)
```
...
```
public ListTemplatesRequest.Builder setFilter(String value)
```
...
```
public ListTemplatesRequest.Builder setFilterBytes(ByteString value)
```
...
```
public ListTemplatesRequest.Builder setOrderBy(String value)
```
...
```
public ListTemplatesRequest.Builder setOrderByBytes(ByteString value)
```
...
```
public ListTemplatesRequest.Builder setPageSize(int value)
```
...
```
public ListTemplatesRequest.Builder setPageToken(String value)
```
...
```
public ListTemplatesRequest.Builder setPageTokenBytes(ByteString value)
```
...
```
public ListTemplatesRequest.Builder setParent(String value)
```
...
```
public ListTemplatesRequest.Builder setParentBytes(ByteString value)
```
