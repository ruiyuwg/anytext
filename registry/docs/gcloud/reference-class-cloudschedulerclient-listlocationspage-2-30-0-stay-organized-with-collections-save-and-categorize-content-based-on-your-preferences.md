...
# Class CloudSchedulerClient.ListLocationsPage (2.30.0) Stay organized with collections Save and categorize content based on your preferences.
...
```
public static class CloudSchedulerClient.ListLocationsPage extends AbstractPage<ListLocationsRequest,ListLocationsResponse,Location,CloudSchedulerClient.ListLocationsPage>
```

## Inheritance

[java.lang.Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractPage](https://cloud.google.com/java/docs/reference/gax/latest/com.google.api.gax.paging.AbstractPage.html) \> CloudSchedulerClient.ListLocationsPage
...
```
protected CloudSchedulerClient.ListLocationsPage createPage(PageContext<ListLocationsRequest,ListLocationsResponse,Location> context, ListLocationsResponse response)
```
...
`[CloudSchedulerClient.ListLocationsPage](/java/docs/reference/google-cloud-scheduler/2.30.0/com.google.cloud.scheduler.v1.CloudSchedulerClient.ListLocationsPage)`
...
```
public ApiFuture<CloudSchedulerClient.ListLocationsPage> createPageAsync(PageContext<ListLocationsRequest,ListLocationsResponse,Location> context, ApiFuture<ListLocationsResponse> futureResponse)
```
...
`[ApiFuture](https://cloud.google.com/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html)<[ListLocationsPage](/java/docs/reference/google-cloud-scheduler/2.30.0/com.google.cloud.scheduler.v1.CloudSchedulerClient.ListLocationsPage)>`
