...
# Class AnalysisMessage (1.49.0) Stay organized with collections Save and categorize content based on your preferences.
...
[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) \> [AbstractMessageLite<MessageType,BuilderType>](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessageLite.html) \> [AbstractMessage](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.AbstractMessage.html) \> [GeneratedMessageV3](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.GeneratedMessageV3.html) \> AnalysisMessage

## Implements

[AnalysisMessageOrBuilder](/java/docs/reference/google-cloud-gkehub/1.49.0/com.google.cloud.gkehub.servicemesh.v1alpha.AnalysisMessageOrBuilder)
...
### RESOURCE\_PATHS\_FIELD\_NUMBER
...
`[AnalysisMessage](/java/docs/reference/google-cloud-gkehub/1.49.0/com.google.cloud.gkehub.servicemesh.v1alpha.AnalysisMessage)`
...
`[AnalysisMessage.Builder](/java/docs/reference/google-cloud-gkehub/1.49.0/com.google.cloud.gkehub.servicemesh.v1alpha.AnalysisMessage.Builder)`
...
`[Parser](https://cloud.google.com/java/docs/reference/protobuf/latest/com.google.protobuf.Parser.html)<[AnalysisMessage](/java/docs/reference/google-cloud-gkehub/1.49.0/com.google.cloud.gkehub.servicemesh.v1alpha.AnalysisMessage)>`
...
A UI can combine these args with a template (based on message\_base.type) to produce an internationalized message.
...
`[AnalysisMessageBase](/java/docs/reference/google-cloud-gkehub/1.49.0/com.google.cloud.gkehub.servicemesh.v1alpha.AnalysisMessageBase)`
...
`[AnalysisMessageBaseOrBuilder](/java/docs/reference/google-cloud-gkehub/1.49.0/com.google.cloud.gkehub.servicemesh.v1alpha.AnalysisMessageBaseOrBuilder)`
...
-   MEMBERSHIP\_ID if the cause is a specific member cluster
-   MEMBERSHIP\_ID/(NAMESPACE\\/)?RESOURCETYPE/NAME if the cause is a resource in a cluster
