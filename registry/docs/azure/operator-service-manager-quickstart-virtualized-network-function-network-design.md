...
| \<nf-name>.bicep                    | Bicep file per Network Function (NF) RET provided in the input file, for deploying the NF. This template is converted to an ARM template and uploaded to the artifact store when you run the publish command                                                                                                                                              |
| **nsd-cli-output/base**             |                                                                                                                                                                                                                                                                                                                                   |
| deploy.bicep                        | Bicep file to create the publisher, storage accounts, and network service design group shared by all NSDVs of this NSD group                                                                                                                                                                                                   |
| **nsd-cli-output/nsdDefinition**    |                                                                                                                                                                                                                                                                                                                                   |
| deploy.bicep                        | Bicep file to create the Network Service Design Version (NSDV). This template contains child resource element templates, which are taken from the published NFs or ARM templates (for infrastructure) defined in the nsd-input.jsonc file                                                                                       |
