...
:::image type="content" source="./media/backup-azure-configure-backup-reports/recovery-services-vault-diagnostics-settings.png" alt-text="Screenshot shows the recovery services vault diagnostics settings pane." lightbox="./media/backup-azure-configure-backup-reports/recovery-services-vault-diagnostics-settings.png":::
...
1. Select **Save**.
   ...
   :::image type="content" source="./media/backup-azure-configure-backup-reports/recovery-services-vault-diagnostics-settings.png" alt-text="Screenshot shows the recovery services vault diagnostics settings parameter selections." lightbox="./media/backup-azure-configure-backup-reports/recovery-services-vault-diagnostics-settings.png":::
