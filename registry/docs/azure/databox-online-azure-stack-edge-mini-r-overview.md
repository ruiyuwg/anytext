...
[Deploy Azure Machine Learning hardware accelerated models on Azure Stack Edge Mini R](/azure/machine-learning/how-to-deploy-fpga-web-service#deploy-to-a-local-edge-server).
