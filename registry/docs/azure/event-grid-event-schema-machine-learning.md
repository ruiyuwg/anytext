...
| `ServiceComputeType` | string | The compute type (for example, ACI, AKS) of the deployed service. |
...
| Title | Description |
| ----- | ----- |
| [Consume Azure Machine Learning events](/azure/machine-learning/how-to-use-event-grid) | Overview of integrating Azure Machine Learning with Event Grid. |

## Next steps

* For an introduction to Azure Event Grid, see [What is Event Grid?](overview.md)
* For more information about creating an Azure Event Grid subscription, see [Event Grid subscription schema](subscription-creation-schema.md)
* For an introduction to using Azure Event Grid with Azure Machine Learning, see [Consume Azure Machine Learning events](/azure/machine-learning/how-to-use-event-grid)
