---
title: Azure Stack Edge 2510 release notes
description: Describes critical open issues and resolutions for the Azure Stack Edge running 2510 release.
services: databox
author: alkohli
...
# Azure Stack Edge 2510 release notes

[!INCLUDE [applies-to-GPU-and-pro-r-and-mini-r-skus](../../includes/azure-stack-edge-applies-to-gpu-pro-r-mini-r-sku.md)]

The following release notes identify critical open issues and resolved issues for the 2510 release for your Azure Stack Edge devices. Features and issues that correspond to a specific model of Azure Stack Edge are called out wherever applicable.
