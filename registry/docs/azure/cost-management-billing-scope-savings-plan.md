...
- **Shared scope** - Applies benefits to eligible resources within subscriptions that are in the EA Enrollment or MCA Billing Profile. Shared scope benefits are applied to all Microsoft Entra tenants in the Enrollment/Billing Profile.
...
4. Savings plans with shared scope.
