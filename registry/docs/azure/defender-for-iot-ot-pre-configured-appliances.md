...
This article is part of a series of articles that describes the [deployment path](ot-deploy/ot-deploy-path.md) for operational technology (OT) monitoring with Microsoft Defender for IoT. The article lists the catalog of the preconfigured appliances available for Microsoft Defender for IoT OT appliances. To jump to articles with more details about each appliance, use the links in the tables in this article
...
|**L500**    |  [HPE ProLiant DL20 Gen11 Plus](appliance-catalog/hpe-proliant-dl20-gen-11-nhp-2lff.md)<br> (NHP 2LFF)|
