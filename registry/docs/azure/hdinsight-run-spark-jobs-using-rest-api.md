---
title: Use Apache Spark REST API to submit remote jobs to an Entra enabled HDInsight Spark cluster
...
# Use Apache Spark REST API to submit remote jobs to an Entra enabled HDInsight Spark cluster
...
An Entra enabled Apache Spark cluster on HDInsight. For instructions, see [Create Apache Spark clusters in Azure HDInsight](../spark/apache-spark-jupyter-spark-sql.md).
