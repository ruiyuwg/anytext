...
The following release notes identify critical open issues and resolved issues for the 2506 release for your Azure Stack Edge devices. Features and issues that correspond to a specific model of Azure Stack Edge are called out wherever applicable.
...
This article applies to the **Azure Stack Edge 2506** release, which maps to software version **3.3.2506.1090**.
...
> If you update to Azure Stack Edge 2506 before updating to Packet Core 2308.0.1, you will experience a total system outage. In this case, you must delete and re-create the Azure Kubernetes service cluster on your Azure Stack Edge device.
