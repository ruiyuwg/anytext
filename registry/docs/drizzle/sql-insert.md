...
As the PostgreSQL documentation mentions: <Callout>
A query (SELECT statement) that supplies the rows to be inserted </Callout>
...
\<Tabs items={\["Query Builder", "Callback", "SQL template tag"]}> <Tab>
