...
For **local development** (like running `drizzle-kit push` or `drizzle-kit studio`), you must use the **public URL**. The private `*.railway.internal` hostname will not resolve from your local machine. </Callout>
...
![](@/assets/images/tutorials/bun-railway-deployment-successful.png)
...
![](@/assets/images/tutorials/bun-railway-canvas-postgres-add-new-service.png)
