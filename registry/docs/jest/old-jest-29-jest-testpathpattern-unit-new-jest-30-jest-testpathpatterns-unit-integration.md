...
## Jest Expect & Matchers[​](#jest-expect--matchers "Direct link to Jest Expect & Matchers")

### Removal of Alias Matcher Functions[​](#removal-of-alias-matcher-functions "Direct link to Removal of Alias Matcher Functions")
...
### Non-enumerable properties[​](#non-enumerable-properties "Direct link to Non-enumerable properties")
...
### Improved Type Inference for CalledWith[​](#improved-type-inference-for-calledwith "Direct link to Improved Type Inference for CalledWith")
...
## Configuration Updates[​](#configuration-updates "Direct link to Configuration Updates")

### Support for `.mts` and `.cts` File Extensions[​](#support-for-mts-and-cts-file-extensions "Direct link to support-for-mts-and-cts-file-extensions")
...
### `--testPathPattern` was renamed to `--testPathPatterns`[​](#--testpathpattern-was-renamed-to---testpathpatterns "Direct link to --testpathpattern-was-renamed-to---testpathpatterns")
...
### Removed `--init` Command[​](#removed---init-command "Direct link to removed---init-command")
...
### Other CLI Changes[​](#other-cli-changes "Direct link to Other CLI Changes")
...
## Test Runner Behavior Changes[​](#test-runner-behavior-changes "Direct link to Test Runner Behavior Changes")

### Unhandled Promise Rejections in Tests[​](#unhandled-promise-rejections-in-tests "Direct link to Unhandled Promise Rejections in Tests")
...
### Custom Test Sequencers[​](#custom-test-sequencers "Direct link to Custom Test Sequencers")
...
### Required `globalConfig` in Runtime[​](#required-globalconfig-in-runtime "Direct link to required-globalconfig-in-runtime")
...
## Snapshots and Output Changes[​](#snapshots-and-output-changes "Direct link to Snapshots and Output Changes")

### Update broken documentation link[​](#update-broken-documentation-link "Direct link to Update broken documentation link")
...
### Error Causes in Snapshots[​](#error-causes-in-snapshots "Direct link to Error Causes in Snapshots")
...
### React Empty String Rendering[​](#react-empty-string-rendering "Direct link to React Empty String Rendering")
...
### Improved Object Printing in `pretty-format`[​](#improved-object-printing-in-pretty-format "Direct link to improved-object-printing-in-pretty-format")

`ArrayBuffer` and `DataView` are now printed in a human-readable way instead of as objects with internal fields.

## Jest Mock API Changes[​](#jest-mock-api-changes "Direct link to Jest Mock API Changes")

### `jest.genMockFromModule` Removed[​](#jestgenmockfrommodule-removed "Direct link to jestgenmockfrommodule-removed")
...
### Removed Mock Function Types[​](#removed-mock-function-types "Direct link to Removed Mock Function Types")
...
If you were using `jest.SpyInstance` (for instance, to annotate the return of `jest.spyOn`), you should update to using [`jest.Spied`](/docs/mock-function-api#jestspiedsource).

### `jest.mock` only works with case-sensitive module path[​](#jestmock-only-works-with-case-sensitive-module-path "Direct link to jestmock-only-works-with-case-sensitive-module-path")
...
## Module & Runtime Changes[​](#module--runtime-changes "Direct link to Module & Runtime Changes")

### ESM Module Support and Internal Restructuring[​](#esm-module-support-and-internal-restructuring "Direct link to ESM Module Support and Internal Restructuring")
...
### Glob Pattern Matching Changes[​](#glob-pattern-matching-changes "Direct link to Glob Pattern Matching Changes")
