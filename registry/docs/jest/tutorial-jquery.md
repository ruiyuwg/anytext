...
To get started with the JSDOM [test environment](/docs/configuration#testenvironment-string), the `jest-environment-jsdom` package must be installed if it's not already:
