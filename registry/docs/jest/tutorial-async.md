...
First, enable Babel support in Jest as documented in the [Getting Started](/docs/getting-started#using-babel) guide.
...
If you'd like to test timers, like `setTimeout`, take a look at the [Timer mocks](/docs/timer-mocks) documentation.
