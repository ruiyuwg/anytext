...
![](/assets/images/failedSnapshotTest-81a3c266fde34840be14bbcc4090162e.png)
...
![](/assets/images/interactiveSnapshot-58ae38e9cae13140c56d8472453f0595.png)
...
![](/assets/images/interactiveSnapshotUpdate-a17d8d77f94702048b4d0e0e4c580719.gif)

Once you're finished, Jest will give you a summary before returning back to watch mode:

![](/assets/images/interactiveSnapshotDone-59ee291ee320accbc4bfc4f33b22638a.png)
...
Other ways this can be done is using the [snapshot serializer](/docs/configuration#snapshotserializers-arraystring) or [mocking](/docs/mock-functions) the library responsible for generating the random part of the code you're snapshotting.
...
For example, if you have a [Clock](https://github.com/jestjs/jest/blob/main/examples/snapshot/Clock.js) component that uses `Date.now()`, the snapshot generated from this component will be different every time the test case is run. In this case we can [mock the Date.now() method](/docs/mock-functions) to return a consistent value every time the test is run:
