...
URL: https://docs.deno.com/deploy/privacy\_policy
...
website at <https://deno.com> (the “Site”); (ii) any websites,
...
*Account Credentials*. When you register to create an account with us, we will
...
- *Device data*. We may collect data such as the type of device and its
  operating system and settings, browser type, mobile device carrier, country,
  IP address, and unique identifiers.

- *Internet and other or electronic activity data*. This includes information
  about your interaction with our Sites, emails, and other online content.

- *Tracking Data*. We may collect tracking data using first and third-party
...
*Analytics Services*. We may use third-party web analytics services, such as
...
*Aggregated Data*. We may analyze your personal information in aggregate form
...
*Service Providers/Vendors*. Like many businesses, we hire other companies to
...
*Reorganization*. If, in the future, Deno undergoes a corporate, partnership, or
business reorganization, we may transfer the Information, including personal
information, to the new or surviving entity. 

*Protection of Rights and Compliance*. We may use your Information to protect
...
<support@deno.com>. We will use commercially reasonable
...
*Browser-Based Opt-Outs*. You may be able to disable tracking technologies using
...
*Self-Regulatory Program Opt-Outs*. Two self-regulatory programs are available
...
*Google Analytics Opt-Out.* To opt out of Google Analytics cookies, visit
...
<support@deno.com> and we will endeavor to delete that
...
us at <support@deno.com> with the subject line “Nevada
...
Please reach out to <support@deno.com> for any
