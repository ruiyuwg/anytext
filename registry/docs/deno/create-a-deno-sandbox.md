...
| <code class="js-only">allowNet</code><code class="py-only">allow\_net</code> | Optional list of allowed outbound hosts. See [Outbound network control](./security#outbound-network-control).                                        |
...
| <code class="js-only">memoryMb</code><code class="py-only">memory\_mb</code> | Allocate between 768 and 4096 MB of RAM for memory-heavy tasks or tighter budgets.                                                                   |
