...
URL: https://docs.deno.com/examples/tunnel\_tutorial/
...
| Name              | Value                              |
| ----------------- | ---------------------------------- |
| TUTORIAL\_MESSAGE  | This message is set in Deno Deploy |
| TUTORIAL\_USERNAME | \[Your Name]                        |
| TUTORIAL\_ACCENT   | #0099ff                            |
