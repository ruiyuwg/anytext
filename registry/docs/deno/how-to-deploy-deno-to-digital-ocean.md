...
URL: https://docs.deno.com/examples/digital\_ocean\_tutorial/
...
- [DIGITALOCEAN\_ACCESS\_TOKEN](https://docs.digitalocean.com/reference/api/create-personal-access-token/)
- DIGITALOCEAN\_HOST (the IP address of your Droplet)
- DIGITALOCEAN\_USERNAME (the default is `root`)
- DIGITALOCEAN\_SSHKEY (more on this below)
