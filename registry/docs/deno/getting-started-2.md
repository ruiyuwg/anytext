...
URL: https://docs.deno.com/sandbox/getting\_started
...
- <code class="js-only">allowNet</code><code class="py-only">allow\_net</code>:
...
- <code class="js-only">memoryMb</code><code class="py-only">memory\_mb</code>:
