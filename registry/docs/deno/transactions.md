...
The Deno KV store utilizes *optimistic concurrency control transactions* rather
than *interactive transactions* like many SQL systems like PostgreSQL or MySQL.
