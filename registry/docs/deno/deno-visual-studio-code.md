...
[vscode\_deno](https://marketplace.visualstudio.com/items?itemName=denoland.vscode-deno)
extension.
...
*References* setting mentioned above.
...
https://github.com/denoland/vscode\_deno is the next step.
