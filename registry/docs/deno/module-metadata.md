...
URL: https://docs.deno.com/examples/module\_metadata\_tutorial/
...
- The string
  ...
  will give you the fully resolved path to the current module. *For local
  modules only*.
- The string
