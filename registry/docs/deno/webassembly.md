...
[import map](https://github.com/WICG/import-maps) via the *deno.json*:
...
the [web\_sys](https://rustwasm.github.io/wasm-bindgen/web-sys/index.html) and
[js\_sys](https://rustwasm.github.io/wasm-bindgen/contributing/js-sys/index.html)
