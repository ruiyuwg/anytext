...
[![NPM Version](https://badgen.net/npm/v/response-time)](https://npmjs.org/package/response-time) [![NPM Downloads](https://badgen.net/npm/dm/response-time)](https://npmjs.org/package/response-time) [![Node.js Version](https://badgen.net/npm/node/response-time)](https://nodejs.org/en/download) [![Build Status](https://badgen.net/github/checks/express/response-time/master?label=ci)](https://github.com/express/response-time/actions/workflows/ci.yml) [![Test Coverage](https://badgen.net/coveralls/c/github/express/response-time/master)](https://coveralls.io/r/express/response-time?branch=master)
