...
-   [Express 4.x](/en/4x/api.html) requires Node.js 0.10 or higher.
-   [Express 5.x](/en/5x/api.html) requires Node.js 18 or higher.
...
[Edit this page](
            https://github.com/expressjs/expressjs.com/edit/gh-pages/en/starter/installing.md
          )
