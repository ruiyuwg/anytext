...
[![NPM Version](https://badgen.net/npm/v/compression)](https://npmjs.org/package/compression) [![NPM Downloads](https://badgen.net/npm/dm/compression)](https://npmcharts.com/compare/compression?minimal=true) [![Build Status](https://badgen.net/github/checks/expressjs/compression/master?label=CI)](https://github.com/expressjs/compression/actions?query=workflow%3Aci) [![OpenSSF Scorecard Badge](https://api.scorecard.dev/projects/github.com/expressjs/compression/badge)](https://ossf.github.io/scorecard-visualizer/#/projects/github.com/expressjs/compression) [![Funding](https://badgen.net/badge/icon/sponsor/pink?icon=github&label=Open%20Collective)](https://opencollective.com/express)
...
`compression()` accepts these properties in the options object. In addition to those listed below, [zlib](https://nodejs.org/api/zlib.html) options may be passed in to the options object or [brotli](https://nodejs.org/api/zlib.html#zlib_class_brotlioptions) options.
...
See [Node.js documentation](https://nodejs.org/api/zlib.html#zlib_memory_usage_tuning) regarding the usage.
...
The byte threshold for the response body size before compression is considered for the response. This is a number of bytes or any string accepted by the [bytes](https://www.npmjs.com/package/bytes) module.
