...
[![NPM Version](https://badgen.net/npm/v/cookie-parser)](https://npmjs.org/package/cookie-parser) [![NPM Downloads](https://badgen.net/npm/dm/cookie-parser)](https://npmjs.org/package/cookie-parser) [![Build Status](https://badgen.net/github/checks/expressjs/cookie-parser/master?label=ci)](https://github.com/expressjs/cookie-parser/actions?query=workflow%3Aci) [![Test Coverage](https://badgen.net/coveralls/c/github/expressjs/cookie-parser/master)](https://coveralls.io/r/expressjs/cookie-parser?branch=master)
