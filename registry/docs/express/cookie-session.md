...
[![NPM Version](https://img.shields.io/npm/v/cookie-session)](https://npmjs.org/package/cookie-session) [![NPM Downloads](https://img.shields.io/npm/dw/cookie-session)](https://npmjs.org/package/cookie-session) [![Build Status](https://img.shields.io/github/actions/workflow/status/expressjs/cookie-session/ci.yml)](https://github.com/expressjs/cookie-session/actions?query=workflow%3Aci) [![Test Coverage](https://img.shields.io/coverallsCoverage/github/expressjs/cookie-session?branch=master)](https://coveralls.io/r/expressjs/cookie-session?branch=master)
...
Because the entire session object is encoded and stored in a cookie, it is possible to exceed the maximum cookie size limits on different browsers. The [RFC6265 specification](https://tools.ietf.org/html/rfc6265#section-6.1) recommends that a browser **SHOULD** allow

> At least 4096 bytes per cookie (as measured by the sum of the length of the cookie’s name, value, and attributes)

In practice this limit differs slightly across browsers. See a list of [browser limits here](http://browsercookielimits.iain.guru). As a rule of thumb **don’t exceed 4093 bytes per domain**.
