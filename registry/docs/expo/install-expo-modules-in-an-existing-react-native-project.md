...
Depending on how you [initialized the project](/bare/overview), there are two ways you can install the Expo modules: [automatically](/bare/installing-expo-modules#automatic-installation) or [manually](/bare/installing-expo-modules#manual-installation).
...
- ✓ **When the command succeeds**, you will be able to add any Expo module in your app! Proceed to [Usage](/bare/installing-expo-modules#usage) for more information.
...
To exclude any of these modules, refer to the following guide on [excluding modules from autolinking](/bare/installing-expo-modules#excluding-specific-modules-from-autolinking).
