...
A list of paths relative to the app's root directory that Expo Autolinking should search for modules to autolink. Useful when your project has a custom structure or you want to link local packages from directories different than **node\_modules**. The paths you specify must still be structured like **node\_modules** directories.
...
> Before **SDK 54**, this list defaulted to the your app's **node\_modules** directory, and all **node\_modules** directories above it in monorepos. To opt back into to the old behavior, set this list to your app's **node\_modules** directories, for example: `["../../node_modules", "./node_modules"]`.
