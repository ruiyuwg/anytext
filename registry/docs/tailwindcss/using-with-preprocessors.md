...
For the best development experience, we highly recommend that you [use PostCSS exclusively](#using-post-css-as-your-preprocessor), and that you don't use preprocessors like Sass or Less in your Tailwind projects.
...
<TipBad>Won't work, Sass will generate an error</TipBad>
...
<TipGood>Wrap the screen() function in parentheses</TipGood>
...
<TipBad>Won't work, Stylus will generate an error</TipBad>
