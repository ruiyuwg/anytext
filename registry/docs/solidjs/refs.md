...
3. [JSX as a value](#jsx-as-a-value)
4. [Refs in Solid](#refs-in-solid)
   1. [Signals as refs](#signals-as-refs)
5. [Forwarding refs](#forwarding-refs)
6. [Directives](#directives)

Contribute

1. [Edit this page](https://github.com/solidjs/solid-docs/edit/main/src/routes/concepts/refs.mdx)
2. [Report an issue with this page](https://github.com/solidjs/solid-docs-next/issues/new?assignees=ladybluenotes\&labels=improve+documentation%2Cpending+review\&projects=\&template=CONTENT.yml\&title=[Content]:\&subject=/concepts/refs.mdx\&page=https://docs.solidjs.com/concepts/refs)
