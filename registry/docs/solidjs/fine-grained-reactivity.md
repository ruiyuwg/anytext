...
- [Memos](/concepts/derived-values/memos) resemble [effects](/concepts/effects) but are distinct in that they *return* a signal and optimize computations through caching. They update based on the behavior of effects, but are more ideal for computational optimization.
