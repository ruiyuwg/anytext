...
1. [Overview](#_top)
2. [Writing an API route](#writing-an-api-route)
3. [Session management](#session-management)
4. [Exposing a GraphQL API](#exposing-a-graphql-api)
5. [Exposing a tRPC server route](#exposing-a-trpc-server-route)

Contribute

1. [Edit this page](https://github.com/solidjs/solid-docs/edit/main/src/routes/solid-start/building-your-application/api-routes.mdx)
