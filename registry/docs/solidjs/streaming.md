...
To control this behavior, you can use suspense boundaries - regions of the component tree defined by a [`<Suspense>` component](/reference/components/suspense). It isolates asynchronous behavior to a specific section of the page.
...
## [When to disable streaming](/solid-router/data-fetching/streaming#when-to-disable-streaming)
