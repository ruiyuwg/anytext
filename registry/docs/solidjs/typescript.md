...
1. [Overview](#_top)
2. [Configuring TypeScript](#configuring-typescript)
3. [Migrating from JavaScript to TypeScript](#migrating-from-javascript-to-typescript)
4. [API types](#api-types)
   1. [Signals](#signals)
   2. [Context](#context)
   3. [Components](#components)
   4. [Event handling](#event-handling)
   5. [ref attribute](#ref-attribute)
5. [Control flow-based narrowing](#control-flow-based-narrowing)
6. [Advanced JSX attributes and directives](#advanced-jsx-attributes-and-directives)
   1. [Custom event handlers](#custom-event-handlers)

Contribute

1. [Edit this page](https://github.com/solidjs/solid-docs/edit/main/src/routes/configuration/typescript.mdx)
2. [Report an issue with this page](https://github.com/solidjs/solid-docs-next/issues/new?assignees=ladybluenotes\&labels=improve+documentation%2Cpending+review\&projects=\&template=CONTENT.yml\&title=[Content]:\&subject=/configuration/typescript.mdx\&page=https://docs.solidjs.com/configuration/typescript)
