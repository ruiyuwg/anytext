...
1. [Overview](#_top)
2. [Try Solid online](#try-solid-online)
3. [Create a Solid project](#create-a-solid-project)

Contribute

1. [Edit this page](https://github.com/solidjs/solid-docs/edit/main/src/routes/quick-start.mdx)
2. [Report an issue with this page](https://github.com/solidjs/solid-docs-next/issues/new?assignees=ladybluenotes\&labels=improve+documentation%2Cpending+review\&projects=\&template=CONTENT.yml\&title=[Content]:\&subject=/quick-start.mdx\&page=https://docs.solidjs.com/quick-start)
