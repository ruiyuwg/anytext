...
waits roughly 20 ms before preloading

focus

preloads immediately

***

## [How Solid Router Detects Intent](/solid-router/advanced-concepts/preloading#how-solid-router-detects-intent)
...
Route modules can export a [`preload`](/solid-router/reference/preload-functions/preload) function that receives params, search values, and router context. The function lets you seed caches, warm derived computations, or coordinate streaming behaviours without blocking the eventual render.
...
## [Imperative Preloading Hooks](/solid-router/advanced-concepts/preloading#imperative-preloading-hooks)

Not every interaction funnels through an anchor element. The [`usePreloadRoute`](/solid-router/reference/primitives/use-preload-route) primitive exposes the same scheduling behaviour for imperative flows like flyout previews, timers, or observer driven experiences.
...
## [Coordinating Nested Lazy Components](/solid-router/advanced-concepts/preloading#coordinating-nested-lazy-components)
...
[Report an issue with this page](https://github.com/solidjs/solid-docs-next/issues/new?assignees=ladybluenotes\&labels=improve+documentation%2Cpending+review\&projects=\&template=CONTENT.yml\&title=[Content]:\&subject=/solid-router/advanced-concepts/preloading.mdx\&page=https://docs.solidjs.com/solid-router/advanced-concepts/preloading)
