...
- [`src/entry-client.tsx`](/solid-start/reference/entrypoints/entry-client) - this file is what loads and *hydrates* the JavaScript for our application on the client side (in browser). In most cases, you will **not** need to modify this file.
...
2. [Report an issue with this page](https://github.com/solidjs/solid-docs-next/issues/new?assignees=ladybluenotes\&labels=improve+documentation%2Cpending+review\&projects=\&template=CONTENT.yml\&title=[Content]:\&subject=/solid-start/getting-started.mdx\&page=https://docs.solidjs.com/solid-start/getting-started)
