...
You can create a set of variables and reuse them aross your organization. Refer to [Scope](/terraform/cloud-docs/variables#scope) to learn more about creating and using variables sets.
