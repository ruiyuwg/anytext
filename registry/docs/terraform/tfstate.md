...
[`applied`](/terraform/cloud-docs/policy-enforcement/import-reference/tfplan-v2#value-applied) collection in `tfplan` more useful,
...
-> **NOTE:** This value is also available via the [`tfplan`](/terraform/cloud-docs/policy-enforcement/import-reference/tfplan-v2)
...
[import-tfplan-terraform-version]: /terraform/cloud-docs/policy-enforcement/import-reference/tfplan-v2#value-terraform_version
