---
page_title: ServiceNow Service Graph Connector for HCP Terraform resource coverage overview
description: >-
  The ServiceNow Service Graph for HCP Terraform integration imports selected resources from major cloud providers into ServiceNow CMDB.
