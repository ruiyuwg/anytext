...
last_modified: 2025-09-06T10:22:39-07:00
...
When connected to a VCS, HCP Terraform can automatically start a workspace run that performs a `terraform plan` operation when someone creates a pull request (PR) in the repository. Refer to [Connecting to VCS](/terraform/cloud-docs/vcs) for additional information.
...
-  **Run details page**. Refer to [Viewing and managing workspace runs](/terraform/cloud-docs/workspaces/run/manage) for additional information.
