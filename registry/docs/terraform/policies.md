---
page_title: /policies API reference for HCP Terraform
description: >-
  Use the HCP Terraform API's `/policies` endpoint to list, show, create, upload, update, and delete Sentinel and OPA policies.
