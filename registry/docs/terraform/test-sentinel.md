---
page_title: Generate mock Sentinel data with HCP Terraform
description: >-
  Learn how to generate mock Sentinel data to test your policies with HCP Terraform.
...
[Terraform Runs and Remote Operations](/terraform/cloud-docs/workspaces/run/remote-operations) section of the docs.
