...
HashiCorp HCP Terraform customers can integrate with Splunk® using the official [HCP Terraform for Splunk](https://splunkbase.splunk.com/app/5141/) app to understand HCP Terraform operations.
