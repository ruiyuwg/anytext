...
- Plan-only runs.
- The planning stages of [saved plan runs](/terraform/cloud-docs/workspaces/run/modes-and-options/#saved-plans). You can only _apply_ a saved plan if no other run is in progress, and applying that plan blocks the run queue as usual. Terraform Enterprise does not yet support this workflow.
...
- Plan-only runs.
- The planning stages of [saved plan runs](/terraform/cloud-docs/workspaces/run/modes-and-options/#saved-plans). You can only _apply_ a saved plan if the workspace is unlocked, and applying that plan locks the workspace as usual. Terraform Enterprise does not yet support this workflow.
...
[Run States and Stages]: /terraform/cloud-docs/workspaces/run/states
