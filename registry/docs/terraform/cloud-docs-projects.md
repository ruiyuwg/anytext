...
By default, a project uses the organization's [default execution mode](/terraform/cloud-docs/users-teams-organizations/organizations/settings#default-execution-mode) when choosing the execution platform, but you can choose a custom execution mode for a project.
