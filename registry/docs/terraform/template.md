---
page_title: /example-endpoint API reference for HCP Terraform
description: Use the HCP Terraform API's `/endpoint-name` to {A meaningful description of this endpoint}. Aim for 130-160 characters total.
