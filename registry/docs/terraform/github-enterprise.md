...
These instructions are for using a self-hosted installation of GitHub Enterprise for HCP Terraform's VCS features. [GitHub.com has separate instructions](/terraform/cloud-docs/vcs/github), as do the [other supported VCS providers](/terraform/cloud-docs/vcs).
