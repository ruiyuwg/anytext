---
page_title: Publish modules to the Terraform registry
description: Learn how to publish and share modules and their versions in the public Terraform registry.
