---
page_title: /vars API reference for HCP Terraform
description: >-
  Use the HCP Terraform API's `/vars` endpoint to manage organization-level variables. Learn how to read, create, update, and delete variables using the API.
