---
page_title: /plan-exports API reference for HCP Terraform
description: >-
  Use the `/plan-exports` endpoint to manage plan exports for a Terraform run. Create and show plan exports, or download and delete exported plan data.
