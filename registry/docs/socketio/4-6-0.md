...
#### Promise-based acknowledgements[​](#promise-based-acknowledgements "Direct link to Promise-based acknowledgements")
...
#### Compatibility (for real) with Express middlewares[​](#compatibility-for-real-with-express-middlewares "Direct link to Compatibility (for real) with Express middlewares")
...
#### Error details in the disconnecting and disconnect events[​](#error-details-in-the-disconnecting-and-disconnect-events "Direct link to Error details in the disconnecting and disconnect events")
...
#### Automatic removal of empty child namespaces[​](#automatic-removal-of-empty-child-namespaces "Direct link to Automatic removal of empty child namespaces")
...
#### A new "addTrailingSlash" option[​](#a-new-addtrailingslash-option "Direct link to A new \"addTrailingSlash\" option")
...
#### A new "addTrailingSlash" option[​](#a-new-addtrailingslash-option-1 "Direct link to A new \"addTrailingSlash\" option")
...
#### Promise-based acknowledgements[​](#promise-based-acknowledgements-1 "Direct link to Promise-based acknowledgements")
...
#### Connection state recovery[​](#connection-state-recovery-1 "Direct link to Connection state recovery")
...
#### Retry mechanism[​](#retry-mechanism "Direct link to Retry mechanism")
