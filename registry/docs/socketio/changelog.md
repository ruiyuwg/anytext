...
Reference: [Migrating from 3.x to 4.0](/docs/v4/migrating-from-3-x-to-4-0/)

## Important milestones[​](#important-milestones "Direct link to Important milestones")
...
Introduction of [Connection state recovery](/docs/v4/connection-state-recovery)

`4.4.0`

November 2021

Support for [uWebSockets.js](/docs/v4/server-installation/#usage-with-uwebsockets)

`4.1.0`

May 2021

Introduction of [`serverSideEmit()`](/docs/v4/server-instance/#serversideemit)
...
## Version usage[​](#version-usage "Direct link to Version usage")

As of June 2024:

`socket.io` package

![Client downloads per version](/images/server-downloads-per-version.png)![Client downloads per version](/images/server-downloads-per-version-dark.png)

`socket.io-client` package

![Client downloads per version](/images/client-downloads-per-version.png)![Client downloads per version](/images/client-downloads-per-version-dark.png)
