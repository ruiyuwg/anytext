...
## Event emitter[​](#event-emitter "Direct link to Event emitter")
...
## WebSocket connection[​](#websocket-connection "Direct link to WebSocket connection")
...
Reference: [https://developer.mozilla.org/en-US/docs/Web/API/WebSocket](https://developer.mozilla.org/en-US/docs/Web/API/WebSocket)
...
## The Engine.IO protocol[​](#the-engineio-protocol "Direct link to The Engine.IO protocol")
...
Used during the upgrade process (not used here).
...
## The Socket.IO protocol[​](#the-socketio-protocol "Direct link to The Socket.IO protocol")
...
Used to acknowledge an event (not used here).

CONNECT\_ERROR

4

Used during the connection to a namespace (not used here).

BINARY\_EVENT

5

Used to send binary data to the other side (not used here).

BINARY\_ACK

6

Used to acknowledge an event (the response includes binary data) (not used here).
...
### Sending an event[​](#sending-an-event "Direct link to Sending an event")
...
### Receiving an event[​](#receiving-an-event "Direct link to Receiving an event")
...
### Disconnecting manually[​](#disconnecting-manually "Direct link to Disconnecting manually")
...
## Ending notes[​](#ending-notes "Direct link to Ending notes")
...
-   [The Engine.IO protocol](#the-engineio-protocol)
    -   [Heartbeat](#heartbeat)
    -   [Reconnection](#reconnection)
-   [The Socket.IO protocol](#the-socketio-protocol)
