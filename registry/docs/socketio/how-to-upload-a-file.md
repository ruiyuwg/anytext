...
### `maxHttpBufferSize` limit[​](#maxhttpbuffersize-limit "Direct link to maxhttpbuffersize-limit")
...
### Over the wire[​](#over-the-wire "Direct link to Over the wire")
...
-   [Additional notes](#additional-notes)
    -   [`maxHttpBufferSize` limit](#maxhttpbuffersize-limit)
