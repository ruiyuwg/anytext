...
#### Support for WebTransport[​](#support-for-webtransport "Direct link to Support for WebTransport")
...
#### Client bundles with CORS headers[​](#client-bundles-with-cors-headers "Direct link to Client bundles with CORS headers")
...
#### Support for WebTransport[​](#support-for-webtransport-1 "Direct link to Support for WebTransport")
...
#### Cookie management for the Node.js client[​](#cookie-management-for-the-nodejs-client "Direct link to Cookie management for the Node.js client")
...
#### Conditional import of the ESM build with debug logs[​](#conditional-import-of-the-esm-build-with-debug-logs "Direct link to Conditional import of the ESM build with debug logs")
