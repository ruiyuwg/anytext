...
Reference: [https://nwjs.readthedocs.io/en/latest/For%20Users/Advanced/JavaScript%20Contexts%20in%20NW.js/](https://nwjs.readthedocs.io/en/latest/For%20Users/Advanced/JavaScript%20Contexts%20in%20NW.js/)

The Socket.IO client can be created in both context, depending on your use case.

### Browser context[​](#browser-context "Direct link to Browser context")
...
![DevTools with NW.js](/assets/images/nwjs-devtools-a6499e484d70d2722090102be196eeaa.png)
...
### Node context[​](#node-context "Direct link to Node context")
...
#### Pros[​](#pros-1 "Direct link to Pros")
...
#### Cons[​](#cons-1 "Direct link to Cons")
...
## Sample project[​](#sample-project "Direct link to Sample project")

[https://github.com/socketio/socket.io/tree/main/examples/nwjs-example](https://github.com/socketio/socket.io/tree/main/examples/nwjs-example)
