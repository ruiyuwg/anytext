...
## Exchange protocol[​](#exchange-protocol "Direct link to Exchange protocol")
...
Used during the [connection to a namespace](#connection-to-a-namespace).

DISCONNECT

1

Used when [disconnecting from a namespace](#disconnection-from-a-namespace).

EVENT

2

Used to [send data](#sending-and-receiving-data) to the other side.

ACK

3

Used to [acknowledge](#acknowledgement) an event.
...
Used to [send binary data](#sending-and-receiving-data) to the other side.

BINARY\_ACK

6

Used to [acknowledge](#acknowledgement) an event (the response includes binary data).

### Connection to a namespace[​](#connection-to-a-namespace "Direct link to Connection to a namespace")
...
### Sending and receiving data[​](#sending-and-receiving-data "Direct link to Sending and receiving data")
...
### Disconnection from a namespace[​](#disconnection-from-a-namespace "Direct link to Disconnection from a namespace")
...
## Packet encoding[​](#packet-encoding "Direct link to Packet encoding")
...
#### Connection to a namespace[​](#connection-to-a-namespace-1 "Direct link to Connection to a namespace")
...
#### Sending and receiving data[​](#sending-and-receiving-data-1 "Direct link to Sending and receiving data")
...
#### Disconnection from a namespace[​](#disconnection-from-a-namespace-1 "Direct link to Disconnection from a namespace")
...
## Sample session[​](#sample-session "Direct link to Sample session")
...
### Difference between v5 and v4[​](#difference-between-v5-and-v4 "Direct link to Difference between v5 and v4")
...
### Difference between v4 and v3[​](#difference-between-v4-and-v3 "Direct link to Difference between v4 and v3")
...
### Difference between v3 and v2[​](#difference-between-v3-and-v2 "Direct link to Difference between v3 and v2")
...
### Difference between v2 and v1[​](#difference-between-v2-and-v1 "Direct link to Difference between v2 and v1")
...
### Initial revision[​](#initial-revision "Direct link to Initial revision")
...
## Test suite[​](#test-suite "Direct link to Test suite")
