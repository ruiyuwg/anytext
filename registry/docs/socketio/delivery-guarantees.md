...
-   the careful design of the [upgrade mechanism](/docs/v4/how-it-works/#upgrade-mechanism)
...
## Message arrival[​](#message-arrival "Direct link to Message arrival")

### At most once[​](#at-most-once "Direct link to At most once")
...
-   a disconnected client will [buffer events until reconnection](/docs/v4/client-offline-behavior/) (though the previous point still applies)
...
#### From client to server[​](#from-client-to-server "Direct link to From client to server")

From the client side, you can achieve an **at least once** guarantee with the [`retries`](/docs/v4/client-options/#retries) option:
...
#### From server to client[​](#from-server-to-client "Direct link to From server to client")
...
-   [`socket.auth`](/docs/v4/client-options/#socket-options) (client)
-   [`socket.handshake`](/docs/v4/server-api/#sockethandshake) (server)
