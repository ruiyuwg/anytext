...
![Chat](/images/private-messaging-part-2-chat.gif)
...
## Updating the server[​](#updating-the-server "Direct link to Updating the server")
...
### Creating multiple servers[​](#creating-multiple-servers "Direct link to Creating multiple servers")
...
![Sticky session](/images/private-messaging-part-4-sticky-session.png)
...
### Sessions & messages[​](#sessions--messages "Direct link to Sessions & messages")
...
### Forwarding messages[​](#forwarding-messages "Direct link to Forwarding messages")
...
![Broadcasting with the Redis adapter](/images/private-messaging-part-4-redis-adapter.png)
...
-   [How it works](#how-it-works)
    -   [Creating multiple servers](#creating-multiple-servers)
