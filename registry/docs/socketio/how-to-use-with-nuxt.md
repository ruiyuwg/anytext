...
Reference: [https://nitro.unjs.io/guide/websocket](https://nitro.unjs.io/guide/websocket)

### Hook the Socket.IO server[​](#hook-the-socketio-server "Direct link to Hook the Socket.IO server")
...
Reference: [https://nuxt.com/docs/guide/directory-structure/components#client-components](https://nuxt.com/docs/guide/directory-structure/components#client-components)
...
-   [Server](#server)
    ...
    -   [Hook the Socket.IO server](#hook-the-socketio-server)
-   [Client](#client)
