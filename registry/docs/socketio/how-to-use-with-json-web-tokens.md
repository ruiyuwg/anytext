...
## Sharing the user context[​](#sharing-the-user-context "Direct link to Sharing the user context")
...
## Manual parsing[​](#manual-parsing "Direct link to Manual parsing")
...
## Using the user ID[​](#using-the-user-id "Direct link to Using the user ID")
...
-   [Sharing the user context](#sharing-the-user-context)
-   [Manual parsing](#manual-parsing)
-   [Using the user ID](#using-the-user-id)
