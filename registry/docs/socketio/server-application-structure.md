...
## Registering event handlers[​](#registering-event-handlers "Direct link to Registering event handlers")
...
### Each file registers its own event handlers[​](#each-file-registers-its-own-event-handlers "Direct link to Each file registers its own event handlers")
...
### All event handlers are registered in the `index.js` file[​](#all-event-handlers-are-registered-in-the-indexjs-file "Direct link to all-event-handlers-are-registered-in-the-indexjs-file")
