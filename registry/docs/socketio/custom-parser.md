...
## Available parsers[​](#available-parsers "Direct link to Available parsers")
...
## Implementing your own parser[​](#implementing-your-own-parser "Direct link to Implementing your own parser")
...
## The default parser[​](#the-default-parser "Direct link to The default parser")
...
## The msgpack parser[​](#the-msgpack-parser "Direct link to The msgpack parser")
...
[https://cdn.socket.io/4.8.3/socket.io.msgpack.min.js](https://cdn.socket.io/4.8.3/socket.io.msgpack.min.js)

cdnjs

[https://cdnjs.cloudflare.com/ajax/libs/socket.io/4.8.3/socket.io.msgpack.min.js](https://cdnjs.cloudflare.com/ajax/libs/socket.io/4.8.3/socket.io.msgpack.min.js)

jsDelivr

[https://cdn.jsdelivr.net/npm/socket.io-client@4.8.3/dist/socket.io.msgpack.min.js](https://cdn.jsdelivr.net/npm/socket.io-client@4.8.3/dist/socket.io.msgpack.min.js)

unpkg

[https://unpkg.com/socket.io-client@4.8.3/dist/socket.io.msgpack.min.js](https://unpkg.com/socket.io-client@4.8.3/dist/socket.io.msgpack.min.js)
