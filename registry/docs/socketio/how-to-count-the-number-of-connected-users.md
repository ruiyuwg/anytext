...
### Single user presence[​](#single-user-presence "Direct link to Single user presence")
...
### All users presence[​](#all-users-presence "Direct link to All users presence")
...
-   [Cluster](#cluster)
    -   [Single user presence](#single-user-presence)
    -   [All users presence](#all-users-presence)
