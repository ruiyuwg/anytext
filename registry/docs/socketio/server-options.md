...
## Socket.IO server options[​](#socketio-server-options "Direct link to Socket.IO server options")
...
### `cleanupEmptyChildNamespaces`[​](#cleanupemptychildnamespaces "Direct link to cleanupemptychildnamespaces")

_Added in v4.6.0_

Default value: `false`

Whether to remove [child namespaces](/docs/v4/namespaces/#dynamic-namespaces) that have no sockets connected to them.
...
### `connectionStateRecovery`[​](#connectionstaterecovery "Direct link to connectionstaterecovery")

_Added in v4.6.0_

Default value: `undefined`

The option for the [Connection state recovery](/docs/v4/connection-state-recovery) feature:
...
### `serveClient`[​](#serveclient "Direct link to serveclient")
...
### `allowEIO3`[​](#alloweio3 "Direct link to alloweio3")
...
### `allowRequest`[​](#allowrequest "Direct link to allowrequest")
...
### `allowUpgrades`[​](#allowupgrades "Direct link to allowupgrades")
...
Since Socket.IO v3, there is no cookie sent by default anymore ([reference](/docs/v4/migrating-from-2-x-to-3-0/#no-more-cookie-by-default)).
...
If you want the browser to send credentials such as cookies, authorization headers or TLS client certificates, you also need to set [`withCredentials`](/docs/v4/client-options/#withcredentials) option to `true` on the client side:
...
### `httpCompression`[​](#httpcompression "Direct link to httpcompression")
...
### `maxHttpBufferSize`[​](#maxhttpbuffersize "Direct link to maxhttpbuffersize")
...
### `perMessageDeflate`[​](#permessagedeflate "Direct link to permessagedeflate")
...
### `pingInterval`[​](#pinginterval "Direct link to pinginterval")
...
### `pingTimeout`[​](#pingtimeout "Direct link to pingtimeout")
...
See also: client-side [`transports`](/docs/v4/client-options/#transports)

### `upgradeTimeout`[​](#upgradetimeout "Direct link to upgradetimeout")

Default value: `10000`

This is the delay in milliseconds before an uncompleted transport upgrade is cancelled.

### `wsEngine`[​](#wsengine "Direct link to wsengine")
...
-   [Socket.IO server options](#socketio-server-options)
    -   [`adapter`](#adapter)
    -   [`cleanupEmptyChildNamespaces`](#cleanupemptychildnamespaces)
