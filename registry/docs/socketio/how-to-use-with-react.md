...
See also: [https://react.dev/learn/sharing-state-between-components](https://react.dev/learn/sharing-state-between-components)
...
## Remarks about the `useEffect` hook[​](#remarks-about-the-useeffect-hook "Direct link to remarks-about-the-useeffect-hook")
...
### Hot module reloading[​](#hot-module-reloading "Direct link to Hot module reloading")
...
Reference: [https://webpack.js.org/concepts/hot-module-replacement/](https://webpack.js.org/concepts/hot-module-replacement/)

### Listeners in a child component[​](#listeners-in-a-child-component "Direct link to Listeners in a child component")
...
### Temporary disconnections[​](#temporary-disconnections "Direct link to Temporary disconnections")
...
-   [Example](#example)
-   [Remarks about the `useEffect` hook](#remarks-about-the-useeffect-hook)
    -   [Cleanup](#cleanup)
    -   [Dependencies](#dependencies)
    -   [Disconnection](#disconnection)
-   [Important notes](#important-notes)
    -   [Hot module reloading](#hot-module-reloading)
    -   [Listeners in a child component](#listeners-in-a-child-component)
    -   [Temporary disconnections](#temporary-disconnections)
