...
Reference: [https://reactnative.dev/](https://reactnative.dev/)

All tips from our [React guide](/how-to/use-with-react) can be applied with React Native as well.

## Connection URL[​](#connection-url "Direct link to Connection URL")
...
the IP of your machine (provided that you are on the same network)
...
### Cleartext traffic blocked on Android[​](#cleartext-traffic-blocked-on-android "Direct link to Cleartext traffic blocked on Android")
...
android/app/src/debug/res/xml/network\_security\_config.xml
...
Reference: [https://developer.android.com/privacy-and-security/security-config](https://developer.android.com/privacy-and-security/security-config)

### With a self-signed certificate[​](#with-a-self-signed-certificate "Direct link to With a self-signed certificate")
...
-   [Expo Go](https://docs.expo.dev/): [https://github.com/socketio/socket.io/tree/main/examples/expo-example](https://github.com/socketio/socket.io/tree/main/examples/expo-example)
-   React Native CLI: [https://github.com/socketio/socket.io/tree/main/examples/ReactNativeExample](https://github.com/socketio/socket.io/tree/main/examples/ReactNativeExample)
...
-   [Common issues](#common-issues)
    -   [Cleartext traffic blocked on Android](#cleartext-traffic-blocked-on-android)
