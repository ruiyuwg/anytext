...
### In the main namespace[​](#in-the-main-namespace "Direct link to In the main namespace")
...
### Solution 1: `fetchSockets()`[​](#solution-1-fetchsockets "Direct link to solution-1-fetchsockets")
...
### Solution 2: `serverSideEmit()`[​](#solution-2-serversideemit "Direct link to solution-2-serversideemit")
...
### Solution 3: external store[​](#solution-3-external-store "Direct link to Solution 3: external store")
...
-   [Standalone](#standalone)
    -   [Globally](#globally)
    -   [In the main namespace](#in-the-main-namespace)
    -   [In a namespace](#in-a-namespace)
    -   [In a room](#in-a-room)
-   [Cluster](#cluster)
    -   [Solution 1: `fetchSockets()`](#solution-1-fetchsockets)
    -   [Solution 2: `serverSideEmit()`](#solution-2-serversideemit)
    -   [Solution 3: external store](#solution-3-external-store)
