...
## Final server code[​](#final-server-code "Direct link to Final server code")
...
## Final client code[​](#final-client-code "Direct link to Final client code")
...
## Homework[​](#homework "Direct link to Homework")
...
## Getting this example[​](#getting-this-example "Direct link to Getting this example")
...
-   [our Troubleshooting guide](/docs/v4/troubleshooting-connection-issues/)
-   [the Emit cheatsheet](/docs/v4/emit-cheatsheet/)
-   [the complete Server API](/docs/v4/server-api/)
-   [the complete Client API](/docs/v4/client-api/)
-   the different sections of [our guide](/docs/v4/)
