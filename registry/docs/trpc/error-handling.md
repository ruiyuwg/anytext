...
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------- |
| PARSE\_ERROR            | Invalid JSON was received by the server, or an error occurred while parsing the request.                                                                                                                                                                                                         | 400       |
...
| CLIENT\_CLOSED\_REQUEST  | The client closed the connection before the server finished responding.                                                                                                                                                                                                                          | 499       |
