...
### `hydrateRoot(domNode, reactNode, options?)` {/_hydrateroot_/}
...
### Hydrating server-rendered HTML {/_hydrating-server-rendered-html_/}
...
### Hydrating an entire document {/_hydrating-an-entire-document_/}
...
### Suppressing unavoidable hydration mismatch errors {/_suppressing-unavoidable-hydration-mismatch-errors_/}
...
### Handling different client and server content {/_handling-different-client-and-server-content_/}
...
### Updating a hydrated root component {/_updating-a-hydrated-root-component_/}
