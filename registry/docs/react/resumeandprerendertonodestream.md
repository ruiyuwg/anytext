...
### `resumeAndPrerenderToNodeStream(reactNode, postponedState, options?)` {/_resumeandprerendertolnodestream_/}
...
### When should I use `resumeAndPrerenderToNodeStream`? {/_when-to-use-prerender_/}
