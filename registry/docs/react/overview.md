...
## Components and Hooks must be pure {/_components-and-hooks-must-be-pure_/}
...
## React calls Components and Hooks {/_react-calls-components-and-hooks_/}
...
## Rules of Hooks {/_rules-of-hooks_/}
