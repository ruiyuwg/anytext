...
## Consolidate state logic with a reducer {/_consolidate-state-logic-with-a-reducer_/}
...
### Step 1: Move from setting state to dispatching actions {/_step-1-move-from-setting-state-to-dispatching-actions_/}
...
### Step 2: Write a reducer function {/_step-2-write-a-reducer-function_/}
...
#### Why are reducers called this way? {/_why-are-reducers-called-this-way_/}
...
### Step 3: Use the reducer from your component {/_step-3-use-the-reducer-from-your-component_/}
...
## Comparing `useState` and `useReducer` {/_comparing-usestate-and-usereducer_/}
...
## Writing reducers well {/_writing-reducers-well_/}
...
## Writing concise reducers with Immer {/_writing-concise-reducers-with-immer_/}
...
#### Dispatch actions from event handlers {/_dispatch-actions-from-event-handlers_/}
...
#### Clear the input on sending a message {/_clear-the-input-on-sending-a-message_/}
...
#### Restore input values when switching between tabs {/_restore-input-values-when-switching-between-tabs_/}
...
#### Implement `useReducer` from scratch {/_implement-usereducer-from-scratch_/}
