...
### `renderToStaticMarkup(reactNode, options?)` {/_rendertostaticmarkup_/}
...
### Rendering a non-interactive React tree as HTML to a string {/_rendering-a-non-interactive-react-tree-as-html-to-a-string_/}
