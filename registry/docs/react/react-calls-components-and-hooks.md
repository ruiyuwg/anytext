...
## Never call component functions directly {/_never-call-component-functions-directly_/}
...
## Never pass around Hooks as regular values {/_never-pass-around-hooks-as-regular-values_/}
...
### Don't dynamically mutate a Hook {/_dont-dynamically-mutate-a-hook_/}
...
### Don't dynamically use Hooks {/_dont-dynamically-use-hooks_/}
