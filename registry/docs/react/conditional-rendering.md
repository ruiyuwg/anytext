...
## Conditionally returning JSX {/_conditionally-returning-jsx_/}
...
### Conditionally returning nothing with `null` {/_conditionally-returning-nothing-with-null_/}
...
## Conditionally including JSX {/_conditionally-including-jsx_/}
...
### Conditional (ternary) operator (`? :`) {/_conditional-ternary-operator--_/}
...
#### Are these two examples fully equivalent? {/_are-these-two-examples-fully-equivalent_/}
...
### Logical AND operator (`&&`) {/_logical-and-operator-_/}
...
### Conditionally assigning JSX to a variable {/_conditionally-assigning-jsx-to-a-variable_/}
...
#### Show an icon for incomplete items with `? :` {/_show-an-icon-for-incomplete-items-with--_/}
...
#### Show the item importance with `&&` {/_show-the-item-importance-with-_/}
...
#### Refactor a series of `? :` to `if` and variables {/_refactor-a-series-of---to-if-and-variables_/}
