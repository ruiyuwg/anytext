...
## Responding to events {/_responding-to-events_/}
...
## State: a component's memory {/_state-a-components-memory_/}
...
## Render and commit {/_render-and-commit_/}
...
## State as a snapshot {/_state-as-a-snapshot_/}
...
## Queueing a series of state updates {/_queueing-a-series-of-state-updates_/}
...
## Updating objects in state {/_updating-objects-in-state_/}
...
## Updating arrays in state {/_updating-arrays-in-state_/}
