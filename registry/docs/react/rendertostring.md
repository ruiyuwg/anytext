...
### `renderToString(reactNode, options?)` {/_rendertostring_/}
...
### Migrating from `renderToString` to a streaming render on the server {/_migrating-from-rendertostring-to-a-streaming-method-on-the-server_/}
...
### Migrating from `renderToString` to a static prerender on the server {/_migrating-from-rendertostring-to-a-static-prerender-on-the-server_/}
