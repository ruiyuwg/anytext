...
## Adding a ref to your component {/_adding-a-ref-to-your-component_/}
...
## Example: building a stopwatch {/_example-building-a-stopwatch_/}
...
## Differences between refs and state {/_differences-between-refs-and-state_/}
...
#### How does useRef work inside? {/_how-does-use-ref-work-inside_/}
...
#### Fix a broken chat input {/_fix-a-broken-chat-input_/}
...
#### Fix a component failing to re-render {/_fix-a-component-failing-to-re-render_/}
...
#### Fix debouncing {/_fix-debouncing_/}
...
#### Read the latest state {/_read-the-latest-state_/}
