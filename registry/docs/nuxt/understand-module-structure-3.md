...
- "local" modules exist within a Nuxt project, either [inlined in Nuxt config](https://nuxt.com/docs/3.x/api/nuxt-config#modules) or within [the `modules` directory](https://nuxt.com/docs/3.x/directory-structure/modules).
...
You can get type hinting for this function using the higher-level `defineNuxtModule` helper provided by [Nuxt Kit](https://nuxt.com/docs/3.x/guide/going-further/kit).
...
You'll then be able to inject all those assets inside the application from your [module definition](https://nuxt.com/#define-your-module).

::tip
Learn more about asset injection in [the recipes section](https://nuxt.com/docs/3.x/guide/modules/recipes-basics).
::
