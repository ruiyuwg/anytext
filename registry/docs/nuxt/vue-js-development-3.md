...
- Use auto-imported [Reactivity functions](https://vuejs.org/api/reactivity-core){rel=""nofollow""} from Vue and Nuxt [built-in composables](https://nuxt.com/docs/3.x/api/composables/use-async-data).
...
::read-more{to="https://nuxt.com/docs/3.x/guide/concepts/typescript"}
