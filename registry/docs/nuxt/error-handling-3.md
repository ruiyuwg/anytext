...
You cannot currently define a server-side handler for these errors, but can render an error page, see the [Render an Error Page](https://nuxt.com/docs/3.x/getting-started/error-handling#error-page) section.
...
::read-more{to="https://nuxt.com/docs/3.x/api/advanced/hooks"}
...
::read-more{to="https://nuxt.com/docs/3.x/directory-structure/error"}
...
::read-more{to="https://nuxt.com/docs/3.x/api/composables/use-error"}
...
::read-more{to="https://nuxt.com/docs/3.x/api/utils/create-error"}
...
::read-more{to="https://nuxt.com/docs/3.x/api/utils/show-error"}
...
::read-more{to="https://nuxt.com/docs/3.x/api/utils/clear-error"}
...
:link-example{to="https://nuxt.com/docs/3.x/examples/advanced/error-handling"}
