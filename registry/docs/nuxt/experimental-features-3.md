...
:read-more{icon="i-lucide-medal" to="https://nuxt.com/docs/3.x/guide/concepts/rendering#hybrid-rendering"}
...
:read-more{to="https://nuxt.com/docs/3.x/directory-structure/components#server-components"}
...
::important
Enabling this feature changes how Vite plugins are registered and configured. See the [Vite Environment API migration guide](https://nuxt.com/docs/3.x/getting-started/upgrade#migration-to-vite-environment-api) for details on updating your plugins.
::
