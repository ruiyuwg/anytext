...
| Name                                                                     | Config File           | How To Configure                                                                                          |
| ------------------------------------------------------------------------ | --------------------- | --------------------------------------------------------------------------------------------------------- |
| [TypeScript](https://www.typescriptlang.org){rel=""nofollow""} | `tsconfig.json`       | [More Info](https://nuxt.com/docs/3.x/directory-structure/tsconfig)                                       |
...
:read-more{to="https://nuxt.com/docs/3.x/api/configuration/nuxt-config#vue"}
...
:read-more{to="https://nuxt.com/docs/3.x/api/configuration/nuxt-config#loaders"}
...
:read-more{to="https://nuxt.com/docs/3.x/api/configuration/nuxt-config#vue-1"}
