...
This will disable auto-imports completely but it's still possible to use [explicit imports](https://nuxt.com/docs/3.x/guide/concepts/auto-imports#explicit-imports) from `#imports`.
...
:read-more{to="https://nuxt.com/docs/3.x/directory-structure/components"}
