...
:read-more{to="https://nuxt.com/docs/3.x/migration/meta"}
...
:read-more{to="https://nuxt.com/docs/3.x/migration/pages-and-layouts"}
...
:read-more{to="https://nuxt.com/docs/3.x/migration/plugins-and-middleware"}

## `scrollToTop`

This feature is not yet supported in Nuxt 3. If you want to overwrite the default scroll behavior of `vue-router`, you can do so in an `~/app/router.options.ts` (see [docs](https://nuxt.com/docs/3.x/guide/recipes/custom-routing#router-options)) for more info.
...
:read-more{to="https://nuxt.com/docs/3.x/getting-started/transitions"}
