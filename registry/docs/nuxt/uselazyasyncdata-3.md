...
:read-more{to="https://nuxt.com/docs/3.x/api/composables/use-async-data#parameters"}

## Return Values

`useLazyAsyncData` returns the same values as [`useAsyncData`](https://nuxt.com/docs/3.x/api/composables/use-async-data).

:read-more{to="https://nuxt.com/docs/3.x/api/composables/use-async-data#return-values"}
