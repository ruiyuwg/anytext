...
The `test` command runs tests using [`@nuxt/test-utils`](https://nuxt.com/docs/5.x/getting-started/testing). This command sets `process.env.NODE_ENV` to `test` if not already set.
