...
:video{.rounded controls="true" poster="https://res.cloudinary.com/nuxt/video/upload/v1665061349/nuxt3/nuxt3-page-transitions\_umwvmh.jpg"}
...
:video{.rounded controls="true" poster="https://res.cloudinary.com/nuxt/video/upload/v1665065289/nuxt3/nuxt3-layouts-transitions\_c9hwlx.jpg"}
...
[View transition types](https://developer.chrome.com/blog/view-transitions-update-io24#view-transition-types){rel=""nofollow""} allow you to apply different CSS animations depending on the type of navigation. This is useful for creating asymmetric transitions (e.g., a different animation when navigating forward vs. backward).

Types are set on the [`ViewTransition`](https://developer.mozilla.org/en-US/docs/Web/API/ViewTransition){rel=""nofollow""} and can be targeted in CSS using the [`:active-view-transition-type()`](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Selectors/:active-view-transition-type){rel=""nofollow""} pseudo-class selector.
...
The `page:view-transition:start` hook provides access to the [`ViewTransition`](https://developer.mozilla.org/en-US/docs/Web/API/ViewTransition){rel=""nofollow""} object, which includes a [`types`](https://developer.mozilla.org/en-US/docs/Web/API/ViewTransition/types){rel=""nofollow""} property (`ViewTransitionTypeSet`) that can be read or modified at runtime:
