...
When Nitro starts, it initializes and executes the plugins under the [`/server/plugins`](https://nuxt.com/docs/3.x/directory-structure/server#server-plugins) directory. These plugins can:
...
:read-more{to="https://nuxt.com/docs/3.x/directory-structure/server#server-plugins"}
...
:read-more{to="https://nuxt.com/docs/3.x/directory-structure/server#server-middleware"}
...
:read-more{to="https://nuxt.com/docs/3.x/getting-started/routing#route-validation"}
...
:read-more{to="https://nuxt.com/docs/3.x/directory-structure/middleware#when-middleware-runs"}
