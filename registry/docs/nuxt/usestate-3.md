...
If you want to store class instances with `useState` that are not supported by Nuxt, you can use [`definePayloadPlugin`](https://nuxt.com/docs/3.x/api/composables/use-nuxt-app#custom-reducerreviver) to add a custom serializer and deserializer for your classes.

:read-more{to="https://nuxt.com/docs/3.x/api/composables/use-nuxt-app#payload"}
