...
::tip
Defaults can be overwritten, see [overwriting defaults](https://nuxt.com/docs/3.x/api/components/nuxt-link#overwriting-defaults) if you want to change them.
::
...
You can overwrite some `<NuxtLink>` defaults in your [`nuxt.config`](https://nuxt.com/docs/3.x/guide/going-further/experimental-features#defaults)
