...
::read-more{to="https://nuxt.com/docs/3.x/api/commands/generate#nuxt-generate"}
...
:read-more{title="prerenderRoutes" to="https://nuxt.com/docs/3.x/api/utils/prerender-routes"}
