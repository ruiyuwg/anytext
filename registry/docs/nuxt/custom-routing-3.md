...
On top of customizing options for [`vue-router`](https://router.vuejs.org/api/interfaces/routeroptions){rel=""nofollow""}, Nuxt offers [additional options](https://nuxt.com/docs/3.x/api/nuxt-config#router) to customize the router.
