...
| [a11y](https://github.com/nuxt/a11y){rel=""nofollow""}   | Public Alpha | 3.x, 4.x     | [nuxt/a11y](https://github.com/nuxt/a11y){rel=""nofollow""}.      | Real-time accessibility feedback and automated testing in your browser during development (see [nuxt/nuxt#23255](https://github.com/nuxt/nuxt/issues/23255){rel=""nofollow""}).        |
...
| **3.x** (maintenance) | [![Nuxt 3.x version](https://img.shields.io/npm/v/nuxt/3x.svg?logo=nuxt\&label=\&style=flat\&colorA=18181B\&colorB=28CF8D){.not-prose,h-5,w-auto :zoom='false'}](https://www.npmjs.com/package/nuxt?activeTab=versions) | 2022-11-16          | 2026-07-31                 | [nuxt.com](https://nuxt.com/docs/3.x/getting-started/introduction)                            |
