...
## Passing Props to Layouts :badge\[+4.4]{.align-middle color="primary"}
...
You can also pass props when changing the layout dynamically with [`setPageLayout`](https://nuxt.com/docs/4.x/api/utils/set-page-layout):
