...
:read-more{to="https://nuxt.com/docs/3.x/getting-started/layers"}
...
::code-tree{expand-all default-value="nuxt.config.ts"}
...
You can use the [`getLayerDirectories`](https://nuxt.com/docs/3.x/api/kit/layers#getlayerdirectories) utility from Nuxt Kit to support custom multi-layer handling for your modules.
