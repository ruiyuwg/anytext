...
[`useState`](https://nuxt.com/docs/3.x/api/composables/use-state) is an SSR-friendly [`ref`](https://vuejs.org/api/reactivity-core#ref){rel=""nofollow""} replacement. Its value will be preserved after server-side rendering (during client-side hydration) and shared across all components using a unique key.
...
::read-more{to="https://nuxt.com/docs/3.x/api/composables/use-state"}
...
:link-example{to="https://nuxt.com/docs/3.x/examples/features/state-management"}
...
:read-more{to="https://nuxt.com/docs/3.x/api/utils/call-once"}
...
:link-example{to="https://nuxt.com/docs/3.x/examples/advanced/locale"}
