...
:read-more{to="https://nuxt.com/docs/3.x/directory-structure/app"}

:link-example{to="https://nuxt.com/docs/3.x/examples/hello-world"}
...
:read-more{to="https://nuxt.com/docs/3.x/directory-structure/pages#special-metadata"}
