...
icon: i-lucide-box
title: Components
to: https://nuxt.com/docs/3.x/api/components/client-only
--------------------------------------------------------
...
title: Composables
to: https://nuxt.com/docs/3.x/api/composables/use-app-config
------------------------------------------------------------
...
title: Utils
to: https://nuxt.com/docs/3.x/api/utils/dollarfetch
---------------------------------------------------
...
title: Commands
to: https://nuxt.com/docs/3.x/api/commands/add
----------------------------------------------
...
title: Nuxt Kit
to: https://nuxt.com/docs/3.x/api/kit/modules
---------------------------------------------
...
icon: i-lucide-brain
title: Advanced
to: https://nuxt.com/docs/3.x/api/advanced/hooks
------------------------------------------------
...
to: https://nuxt.com/docs/3.x/api/nuxt-config
---------------------------------------------
