...
::warning
Beware that using only `$fetch` will not provide [network calls de-duplication and navigation prevention](https://nuxt.com/docs/3.x/getting-started/data-fetching#the-need-for-usefetch-and-useasyncdata). :br
It is recommended to use `$fetch` for client-side interactions (event-based) or combined with [`useAsyncData`](https://nuxt.com/docs/3.x/getting-started/data-fetching#useasyncdata) when fetching the initial component data.
::

::read-more{to="https://nuxt.com/docs/3.x/api/utils/dollarfetch"}
...
:read-more{to="https://nuxt.com/docs/3.x/api/composables/use-fetch"}

:link-example{to="https://nuxt.com/docs/3.x/examples/features/data-fetching"}
...
::read-more{to="https://nuxt.com/docs/3.x/api/composables/use-async-data"}
...
::read-more{to="https://nuxt.com/docs/3.x/api/composables/use-lazy-fetch"}
Read more about `useLazyFetch`.
::

::read-more{to="https://nuxt.com/docs/3.x/api/composables/use-lazy-async-data"}
Read more about `useLazyAsyncData`.
::

:video-accordion{platform="vimeo" title="Watch a video from Vue School on blocking vs. non-blocking (lazy) requests" video-id="1022000555"}
...
:video-accordion{platform="vimeo" title="Watch a video from Vue School on minimizing payload size" video-id="1026410430"}
...
:video-accordion{platform="vimeo" title="Watch a video from Vue School on caching data with the key option" video-id="1026410044"}
...
If you need to change the URL based on a reactive value, you may want to use a [computed URL](https://nuxt.com/docs/3.x/getting-started/data-fetching#computed-url) instead.
...
Every time a dependency changes, the data will be fetched using the newly constructed URL. Combine this with [not-immediate](https://nuxt.com/docs/3.x/getting-started/data-fetching#not-immediate), and you can wait until the reactive element changes before fetching.
...
:read-more{to="https://nuxt.com/docs/3.x/api/utils/define-nuxt-component"}
...
:video-accordion{platform="vimeo" title="Watch a video from Vue School on parallel data fetching" video-id="1024262536"}
