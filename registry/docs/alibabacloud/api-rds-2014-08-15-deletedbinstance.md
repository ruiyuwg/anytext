...
**Note** Note Before you call this operation, read the following documentation and make sure that you fully understand the prerequisites and impacts of this operation.

-   [Release an ApsaraDB RDS for MySQL instance](/help/en/rds/apsaradb-rds-for-mysql/release-or-unsubscribe-from-an-instance)
-   [Release an ApsaraDB RDS for PostgreSQL instance](/help/en/rds/apsaradb-rds-for-postgresql/release-or-unsubscribe-from-an-apsaradb-rds-for-postgresql-instance)
-   [Release an ApsaraDB RDS for SQL Server instance](/help/en/rds/apsaradb-rds-for-sql-server/release-or-unsubscribe-from-an-apsaradb-rds-for-sql-server-instance)
-   [Release an ApsaraDB RDS for MariaDB instance](/help/en/rds/apsaradb-rds-for-mariadb/release-or-unsubscribe-from-an-apsaradb-rds-for-mariadb-instance)

## Debugging

[You can run this interface directly in OpenAPI Explorer, saving you the trouble of calculating signatures. After running successfully, OpenAPI Explorer can automatically generate SDK code samples.](https://api.alibabacloud.com/api/Rds/2014-08-15/DeleteDBInstance)

[![](https://img.alicdn.com/tfs/TB16JcyXHr1gK0jSZR0XXbP8XXa-24-26.png)Debug](https://api.alibabacloud.com/api/Rds/2014-08-15/DeleteDBInstance)
...
**Note** This parameter is supported only for ApsaraDB RDS for MySQL instance with local disks.
...
The region ID of the instance. You can call the [DescribeDBInstanceAttribute](/help/en/rds/api-query-instance-details) operation to query region ID of the instance.
...
OperationDenied.DeletionProtection

The operation is not permitted when the instance enabled deletion protection.

Instances cannot be deleted if deletion protection is enabled.

400

GuardInstance.ReleaseFail

The guard instance release fail.
...
MasterInstanceNotExist

master instance not exist.

The primary instance data does not exist.
...
[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/DeleteDBInstance?updateTime=2025-04-02#workbench-doc-change-demo)

2024-12-26

The Error code has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/DeleteDBInstance?updateTime=2024-12-26#workbench-doc-change-demo)

2024-08-16

The Error code has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/DeleteDBInstance?updateTime=2024-08-16#workbench-doc-change-demo)

2024-06-18

The Error code has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/DeleteDBInstance?updateTime=2024-06-18#workbench-doc-change-demo)

2022-09-01

The Error code has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/DeleteDBInstance?updateTime=2022-09-01#workbench-doc-change-demo)

2021-12-17

The Error code has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/DeleteDBInstance?updateTime=2021-12-17#workbench-doc-change-demo)
