...
-   [Restore the data of an ApsaraDB RDS for MySQL instance across regions](/help/en/rds/apsaradb-rds-for-mysql/restore-the-data-of-an-apsaradb-rds-for-mysql-instance-across-regions)

## Debugging

[You can run this interface directly in OpenAPI Explorer, saving you the trouble of calculating signatures. After running successfully, OpenAPI Explorer can automatically generate SDK code samples.](https://api.alibabacloud.com/api/Rds/2014-08-15/RestoreDdrTable)

[![](https://img.alicdn.com/tfs/TB16JcyXHr1gK0jSZR0XXbP8XXa-24-26.png)Debug](https://api.alibabacloud.com/api/Rds/2014-08-15/RestoreDdrTable)
...
\[{"type":"db","name":"testdb1","newname":"testdb1","tables":\[{"type":"table","name":"test1","newname":"test1\_backup"},{"type":"table","name":"test2","newname":"test2\_backup"}\]}\]
...
TableMeta missing old dbname or new dbname, please check

The value of the table\_meta parameter does not contain the names of the source and destination tables.
...
[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/RestoreDdrTable?updateTime=2024-09-03#workbench-doc-change-demo)

2022-08-11

API Description Update. The Error code has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/RestoreDdrTable?updateTime=2022-08-11#workbench-doc-change-demo)
