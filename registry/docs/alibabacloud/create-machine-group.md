...
The following table describes the required and specific parameters of the create\_machine\_group command.
...
The path of the configuration file for the machine group.
...
1.  Create a file named machinegroup.json in which the machine group name is group\_name2. The following example shows the content of the machinegroup.json file:
...
2.  Use the default account to create a machine group named group\_name2.
...
If an error message is returned, fix the error based on the error codes of the related API operation. For more information, see [Error codes](/help/en/sls/developer-reference/api-sls-2020-12-30-createmachinegroup#api-detail-45).

## API reference

[CreateMachineGroup](/help/en/sls/developer-reference/api-sls-2020-12-30-createmachinegroup)
