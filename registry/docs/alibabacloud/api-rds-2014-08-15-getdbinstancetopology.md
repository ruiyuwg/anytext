...
[You can run this interface directly in OpenAPI Explorer, saving you the trouble of calculating signatures. After running successfully, OpenAPI Explorer can automatically generate SDK code samples.](https://api.alibabacloud.com/api/Rds/2014-08-15/GetDBInstanceTopology)

[![](https://img.alicdn.com/tfs/TB16JcyXHr1gK0jSZR0XXbP8XXa-24-26.png)Debug](https://api.alibabacloud.com/api/Rds/2014-08-15/GetDBInstanceTopology)
...
The database engine is not supported.
...
[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/GetDBInstanceTopology?updateTime=2024-11-18#workbench-doc-change-demo)

2022-10-28

The Error code has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/GetDBInstanceTopology?updateTime=2022-10-28#workbench-doc-change-demo)

2022-06-13

Add Operation

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/GetDBInstanceTopology?updateTime=2022-06-13#workbench-doc-change-demo)
