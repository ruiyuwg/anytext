...
The signature algorithm must be consistent with the signature algorithm that is returned in the [Sign](/help/en/kms/key-management-service/developer-reference/sign-1#doc-api-Kms-Sign) operation.
