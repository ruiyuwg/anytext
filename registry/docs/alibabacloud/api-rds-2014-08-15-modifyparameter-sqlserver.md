...
-   [Modify the parameters of an ApsaraDB RDS for MySQL instance](/help/en/rds/apsaradb-rds-for-mysql/modify-the-parameters-of-an-apsaradb-rds-for-mysql-instance)
-   [Modify the parameters of an ApsaraDB RDS for PostgreSQL instance](/help/en/rds/apsaradb-rds-for-postgresql/modify-the-parameters-of-an-apsaradb-rds-for-postgresql-instance)
-   [Modify the parameters of an ApsaraDB RDS for SQL Server instance](/help/en/rds/apsaradb-rds-for-sql-server/manage-instance-parameters-in-the-apsaradb-rds-console)
-   [Modify the parameters of an ApsaraDB RDS for MariaDB instance](/help/en/rds/apsaradb-rds-for-mariadb/set-instance-parameters)

## Debugging

[You can run this interface directly in OpenAPI Explorer, saving you the trouble of calculating signatures. After running successfully, OpenAPI Explorer can automatically generate SDK code samples.](https://api.alibabacloud.com/api/Rds/2014-08-15/ModifyParameter)

[![](https://img.alicdn.com/tfs/TB16JcyXHr1gK0jSZR0XXbP8XXa-24-26.png)Debug](https://api.alibabacloud.com/api/Rds/2014-08-15/ModifyParameter)
...
{"delayed\_insert\_timeout":"600","max\_length\_for\_sort\_data":"2048"}
...
**Note**-   If you specify this parameter, you do not need to specify **Parameters**.
...
-   ScheduleTime: modifies the parameter at the point in time that you specify. If you specify this value, you must also specify SwitchTime.
-   Immediate: immediately modifies the parameter.
-   MaintainTime: modifies the parameter during the maintenance window of the instance. You can call the ModifyDBInstanceMaintainTime operation to change the maintenance window.
...
The time at which the modification takes effect. Specify the time in the ISO 8601 standard in the _yyyy-MM-dd_T_HH:mm:ss_Z format. The time must be in UTC.
...
PendingActionOverdue

the action execution time is already overdue
...
The following parameters are prohibited: <br />%s

\-

400

Invalid.ParamGroupDBCategory

ParamGroup category is basic, not standard.

The parameter group is a basic parameter group not a standard parameter group.
...
StorageEngine.NotSupported

Current instance storage engine dose not support this operation.
...
InvalidInstanceParameter

Specified name for the instance parameter is not valid.

The name specified for the instance parameter is invalid.

400

GroupReplicationNotSupport.InvalidParameters

Group Replication limits parameters and does not support modification.

The group Replication has restrictions on parameters and cannot be modified.
...
The current database status does not support the operation.
...
Sepcified wal\_level Parameter is invalid. There are still logical slots in instance, so it can not be set as replica.
...
[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/ModifyParameter?updateTime=2025-03-31#workbench-doc-change-demo)

2024-11-12

API Description Update. The Error code has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/ModifyParameter?updateTime=2024-11-12#workbench-doc-change-demo)

2024-08-22

The Error code has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/ModifyParameter?updateTime=2024-08-22#workbench-doc-change-demo)

2024-07-23

The Error code has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/ModifyParameter?updateTime=2024-07-23#workbench-doc-change-demo)

2024-06-03

The Error code has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/ModifyParameter?updateTime=2024-06-03#workbench-doc-change-demo)

2024-05-27

The Error code has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/ModifyParameter?updateTime=2024-05-27#workbench-doc-change-demo)

2023-12-21

The Error code has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/ModifyParameter?updateTime=2023-12-21#workbench-doc-change-demo)

2023-06-28

The Error code has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/ModifyParameter?updateTime=2023-06-28#workbench-doc-change-demo)

2023-06-20

The Error code has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/ModifyParameter?updateTime=2023-06-20#workbench-doc-change-demo)

2023-05-09

The Error code has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/ModifyParameter?updateTime=2023-05-09#workbench-doc-change-demo)

2023-04-25

The Error code has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/ModifyParameter?updateTime=2023-04-25#workbench-doc-change-demo)

2022-10-28

The Error code has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/ModifyParameter?updateTime=2022-10-28#workbench-doc-change-demo)

2021-10-26

The Error code has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/ModifyParameter?updateTime=2021-10-26#workbench-doc-change-demo)
