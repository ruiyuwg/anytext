...
[Try this API in OpenAPI Explorer, no manual signing needed. Successful calls auto-generate SDK code matching your parameters. Download it with built-in credential security for local usage.](https://api.alibabacloud.com/api/alikafka/2019-09-16/GetConsumerList)

 [![](https://img.alicdn.com/tfs/TB16JcyXHr1gK0jSZR0XXbP8XXa-24-26.png) Test](https://api.alibabacloud.com/api/alikafka/2019-09-16/GetConsumerList)
...
AutomaticallyCreatedGroup

boolean

Indicates whether the consumer group was automatically created.
...
The timestamp of when the group was created. Unit: milliseconds.

**Note**

If the group was automatically created, the value of this parameter is null.
...
See [Release Notes](https://api.alibabacloud.com/document/alikafka/2019-09-16/GetConsumerList#workbench-doc-change-demo) for a complete list.
