To ensure the security of your Alibaba Cloud account and cloud resources, do not use your Alibaba Cloud account to access Edge Node Service (ENS) if unnecessary. We recommend that you access ENS as a Resource Access Management (RAM) user or RAM role.
