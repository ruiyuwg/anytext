...
[You can run this interface directly in OpenAPI Explorer, saving you the trouble of calculating signatures. After running successfully, OpenAPI Explorer can automatically generate SDK code samples.](https://api.alibabacloud.com/api/Rds/2014-08-15/DescribeRegions)

[![](https://img.alicdn.com/tfs/TB16JcyXHr1gK0jSZR0XXbP8XXa-24-26.png)Debug](https://api.alibabacloud.com/api/Rds/2014-08-15/DescribeRegions)
...
The endpoint that is used to connect to Alibaba Cloud services in the region. For more information, see [Endpoints](/help/en/rds/developer-reference/api-rds-2014-08-15-endpoint) .
...
Only Chinese (zh-CN) and English (en-US) are allowed.
...
[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/DescribeRegions?updateTime=2024-11-18#workbench-doc-change-demo)
