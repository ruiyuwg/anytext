...
Make sure that you can access the custom domain name that is bound to a function in Function Compute over the Internet, and that you upload a certificate for the function. For more information, see [Configure a custom domain name](/help/en/functioncompute/fc-2-0/user-guide/configure-a-custom-domain-name#multiTask145).
