...
PutBucketRequestPayment requests contain only common request headers. For more information, see [Common request headers](/help/en/oss/developer-reference/common-http-headers#section-eq1-b2y-wdb).
...
Responses for PutBucketRequestPayment requests contain only common response headers. For more information, see [Common response headers](/help/en/oss/developer-reference/common-http-headers#section-hcd-m2y-wdb).
...
For information about the ossutil command that corresponds to the PutBucketRequestPayment operation, see [put-bucket-request-payment](/help/en/oss/developer-reference/put-bucket-request-payment).
