...
-   [Create a database in an ApsaraDB RDS for MySQL instance](/help/en/rds/apsaradb-rds-for-mysql/create-a-database-for-an-apsaradb-rds-for-mysql-instance)
-   [Create a database in an ApsaraDB RDS for PostgreSQL instance](/help/en/rds/apsaradb-rds-for-postgresql/create-a-database-on-an-apsaradb-rds-for-postgresql-instance)
-   [Create a database in an ApsaraDB RDS for SQL Server instance](/help/en/rds/apsaradb-rds-for-sql-server/create-a-database-on-an-apsaradb-rds-for-sql-server-instance)
-   [Create a database in an ApsaraDB RDS for MariaDB instance](/help/en/rds/apsaradb-rds-for-mariadb/create-a-database-on-an-apsaradb-rds-for-mariadb-instance)

## Debugging

[You can run this interface directly in OpenAPI Explorer, saving you the trouble of calculating signatures. After running successfully, OpenAPI Explorer can automatically generate SDK code samples.](https://api.alibabacloud.com/api/Rds/2014-08-15/CreateDatabase)

[![](https://img.alicdn.com/tfs/TB16JcyXHr1gK0jSZR0XXbP8XXa-24-26.png)Debug](https://api.alibabacloud.com/api/Rds/2014-08-15/CreateDatabase)
...
-   For more information about invalid characters, see [Forbidden keywords table](/help/en/rds/developer-reference/forbidden-keywords).
...
-   Valid values for SQL Server databases: **Chinese\_PRC\_CI\_AS, Chinese\_PRC\_CS\_AS, SQL\_Latin1\_General\_CP1\_CI\_AS, SQL\_Latin1\_General\_CP1\_CS\_AS, and Chinese\_PRC\_BIN**
...
-   Valid values for PostgreSQL databases: a value in the `Character set,<Collate>,<Ctype>` format. Example: `UTF8,C,en_US.utf8`.
    ...
    -   Valid values for the **Ctype** field: You can execute the `SELECT DISTINCT collctype FROM pg_collation;` statement to obtain the field value. The default value is **en\_US.utf8**.
...
The specified operation is disabled when the instance is being migrated across engines.
...
InvalidDBName.Forbid

Specified DB name is a keyword in RDS.

Failed to specify the database name. The database name cannot contain the forbidden keyword DBName. Modify the database name.
...
IncorrectDBInstanceServiceType

Current DB instance top type does not support this operation.
...
Create Db failed, please check input value and instance status.

Failed to create the database. Check the specified parameters and the instance status.

400

Database.QueryError

invalid value, may include special character.

The value is invalid and may contain special characters.

400

SqlExcutionFailed

Due to the limit number you can't create a database.
...
InvalidDBInstanceIdOrDBInstanceName

The specified params DBInstanceId or DBInstanceName should not be empty.

The specified parameter DBInstanceId or DBInstanceName should not be empty.
...
[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/CreateDatabase?updateTime=2025-10-28#workbench-doc-change-demo)

2025-04-02

The Error code has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/CreateDatabase?updateTime=2025-04-02#workbench-doc-change-demo)

2025-03-25

The Error code has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/CreateDatabase?updateTime=2025-03-25#workbench-doc-change-demo)

2024-08-16

The Error code has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/CreateDatabase?updateTime=2024-08-16#workbench-doc-change-demo)

2024-08-13

The Error code has changed. The request parameters of the API has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/CreateDatabase?updateTime=2024-08-13#workbench-doc-change-demo)

2024-06-04

The Error code has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/CreateDatabase?updateTime=2024-06-04#workbench-doc-change-demo)

2024-05-28

The Error code has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/CreateDatabase?updateTime=2024-05-28#workbench-doc-change-demo)

2023-11-21

The Error code has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/CreateDatabase?updateTime=2023-11-21#workbench-doc-change-demo)

2023-09-08

The Error code has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/CreateDatabase?updateTime=2023-09-08#workbench-doc-change-demo)

2023-04-03

The Error code has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/CreateDatabase?updateTime=2023-04-03#workbench-doc-change-demo)

2023-03-24

The Error code has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/CreateDatabase?updateTime=2023-03-24#workbench-doc-change-demo)

2022-10-28

The Error code has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/CreateDatabase?updateTime=2022-10-28#workbench-doc-change-demo)

2022-06-23

API Description Update. The Error code has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/CreateDatabase?updateTime=2022-06-23#workbench-doc-change-demo)
