...
[You can run this interface directly in OpenAPI Explorer, saving you the trouble of calculating signatures. After running successfully, OpenAPI Explorer can automatically generate SDK code samples.](https://api.alibabacloud.com/api/Rds/2014-08-15/DescribeDatabases)

[![](https://img.alicdn.com/tfs/TB16JcyXHr1gK0jSZR0XXbP8XXa-24-26.png)Debug](https://api.alibabacloud.com/api/Rds/2014-08-15/DescribeDatabases)
...
{ "allowedValues": \[ "OFF", "ON" \], "databasePropertyName": "ansi\_nulls", "allowModify": true, "excludeLock": "0", "currentValue": "OFF" }
...
{ "allowedValues": \[ "CHECKSUM" \], "databasePropertyName": "page\_verify", "allowModify": true, "excludeLock": "0", "currentValue": "CHECKSUM" }
...
The details of the runtime information about the database.
...
Query Db failed, please check input value and instance status.

Failed to query the database. Check the specified parameters and the instance state.
...
[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/DescribeDatabases?updateTime=2025-04-02#workbench-doc-change-demo)

2024-10-31

The Error code has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/DescribeDatabases?updateTime=2024-10-31#workbench-doc-change-demo)

2024-10-09

The Error code has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/DescribeDatabases?updateTime=2024-10-09#workbench-doc-change-demo)

2024-08-13

The Error code has changed. The request parameters of the API has changed. The response structure of the API has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/DescribeDatabases?updateTime=2024-08-13#workbench-doc-change-demo)

2024-06-03

The Error code has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/DescribeDatabases?updateTime=2024-06-03#workbench-doc-change-demo)

2024-05-28

The Error code has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/DescribeDatabases?updateTime=2024-05-28#workbench-doc-change-demo)

2023-08-09

The Error code has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/DescribeDatabases?updateTime=2023-08-09#workbench-doc-change-demo)

2023-06-21

The Error code has changed. The response structure of the API has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/DescribeDatabases?updateTime=2023-06-21#workbench-doc-change-demo)

2023-03-24

The Error code has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/DescribeDatabases?updateTime=2023-03-24#workbench-doc-change-demo)

2023-01-06

The Error code has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/DescribeDatabases?updateTime=2023-01-06#workbench-doc-change-demo)

2022-09-15

The Error code has changed. The response structure of the API has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/DescribeDatabases?updateTime=2022-09-15#workbench-doc-change-demo)
