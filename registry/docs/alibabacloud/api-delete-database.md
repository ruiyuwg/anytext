...
-   [Delete a database from an ApsaraDB RDS for MySQL instance](/help/en/rds/delete-a-database-from-an-apsaradb-rds-for-mysql-instance)
-   [Delete a database from an ApsaraDB RDS for PostgreSQL instance](/help/en/rds/apsaradb-rds-for-postgresql/delete-a-database-from-an-apsaradb-rds-for-postgresql-instance)
-   [Delete a database from an ApsaraDB RDS for SQL Server instance](/help/en/rds/apsaradb-rds-for-sql-server/delete-a-database-from-an-apsaradb-rds-for-sql-server-instance)
-   [Delete a database from an ApsaraDB RDS for MariaDB instance](/help/en/rds/delete-a-database-from-an-apsaradb-rds-for-mariadb-instance)

## Debugging

[You can run this interface directly in OpenAPI Explorer, saving you the trouble of calculating signatures. After running successfully, OpenAPI Explorer can automatically generate SDK code samples.](https://api.alibabacloud.com/api/Rds/2014-08-15/DeleteDatabase)

[![](https://img.alicdn.com/tfs/TB16JcyXHr1gK0jSZR0XXbP8XXa-24-26.png)Debug](https://api.alibabacloud.com/api/Rds/2014-08-15/DeleteDatabase)
...
Failed to delete the database. Check the specified parameters and the instance state.

Failed to delete the database. Check the specified parameters and the instance status.

400

ColdDBHasSameNameWithOnlineDB

The instance has cold db and online db with the same name.
...
The current DB state does not support this operation.

The operation failed. The RDS instance is not in a ready state. For example, the RDS instance is being created or is receiving data from a migration task.
...
The operation failed. The instance name cannot be found.
...
[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/DeleteDatabase?updateTime=2025-04-02#workbench-doc-change-demo)

2025-03-25

The Error code has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/DeleteDatabase?updateTime=2025-03-25#workbench-doc-change-demo)

2024-04-02

The Error code has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/DeleteDatabase?updateTime=2024-04-02#workbench-doc-change-demo)

2023-03-24

The Error code has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/DeleteDatabase?updateTime=2023-03-24#workbench-doc-change-demo)

2022-10-28

The Error code has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/DeleteDatabase?updateTime=2022-10-28#workbench-doc-change-demo)

2022-06-23

API Description Update. The Error code has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/DeleteDatabase?updateTime=2022-06-23#workbench-doc-change-demo)
