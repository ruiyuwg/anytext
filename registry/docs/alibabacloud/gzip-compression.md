...
-   Gzip can compress files in the following formats: text/xml, text/plain, text/css, application/javascript, application/x-javascript, application/rss+xml, text/javascript, image/tiff, image/svg+xml, application/json, and application/xml.
    

## **Create a Gzip compression rule**
...
6.  Specify a custom filter expression that you want to use to match user requests, and turn on the **Gzip Compression** switch.
