...
[Try this API in OpenAPI Explorer, no manual signing needed. Successful calls auto-generate SDK code matching your parameters. Download it with built-in credential security for local usage.](https://api.alibabacloud.com/api/dcdn/2018-01-15/DescribeDcdnDomainRealTimeTrafficData)

 [![](https://img.alicdn.com/tfs/TB16JcyXHr1gK0jSZR0XXbP8XXa-24-26.png) Test](https://api.alibabacloud.com/api/dcdn/2018-01-15/DescribeDcdnDomainRealTimeTrafficData)
...
The value of this parameter is determined by the maximum time range per query. Valid values are 60 (1 minute), 300 (5 minutes), and 3600 (1 hour). For more information, see the **Usage notes** section in this topic.
...
See [Release Notes](https://api.alibabacloud.com/document/dcdn/2018-01-15/DescribeDcdnDomainRealTimeTrafficData#workbench-doc-change-demo) for a complete list.
