This topic describes how to connect to a PolarDB for PostgreSQL (Compatible with Oracle) cluster.
...
-   **Obtain the cluster endpoint and port**
    ...
    Log on to the [**PolarDB console**](https://polardb.console.alibabacloud.com/). In the cluster list, click the ID of the cluster to go to its **Basic Information** page. Then, you can view the [endpoint](/help/en/polardb/polardb-for-oracle/view-or-apply-for-an-endpoint#title-l0w-054-wi2) information in the **Database Connections** section.![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/en-US/2213345471/p946899.png)
    
    **Note**
    
    -   We recommend that you use the **Cluster Endpoint** of the cluster for connection. The default port number is 1521.
...
-   **Create a database account**
    ...
    Log on to the [**PolarDB console**](https://polardb.console.alibabacloud.com/). In the cluster list, click the ID of the cluster to go to its **Basic Information** page. In the left-side navigation pane, choose **Settings and Management** > **Accounts** to [create a database account](/help/en/polardb/polardb-for-oracle/create-database-accounts).![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/en-US/6033576371/p900858.png)
    
    **Note**
    
    You can create a **Privileged Account** or a **Standard Account**. These two types of accounts have [different permissions](/help/en/polardb/polardb-for-oracle/account-permissions). Create a database account based on your business requirements.
    
-   **Configure a cluster whitelist**
    
    Log on to the [**PolarDB console**](https://polardb.console.alibabacloud.com/). In the cluster list, click the ID of the cluster that you want to connect to go to its **Basic Information** page. In the left-side navigation pane, choose **Settings and Management** > **Cluster Whitelists**, add an [IP whitelist](/help/en/polardb/polardb-for-oracle/configure-a-whitelist-for-a-cluster) or a [security group](/help/en/polardb/polardb-for-oracle/set-security-group).![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/en-US/2213345471/p946900.png)
...
-   [View or apply for an endpoint](/help/en/polardb/polardb-for-oracle/view-or-apply-for-an-endpoint)
    
-   [Modify or delete an endpoint](/help/en/polardb/polardb-for-oracle/modify-or-delete-an-endpoint-1)
    
-   [Private domain names](/help/en/polardb/polardb-for-oracle/private-domain-names)
    
-   Oracle syntax compatibility 2.0: [Clients](/help/en/polardb/polardb-for-oracle/polardb-compatible-with-oracle-client-2/) and [Drivers](/help/en/polardb/polardb-for-oracle/polardb-compatible-with-oracle-drive-2/)
    
-   Oracle syntax compatibility 1.0: [Clients and drivers](/help/en/polardb/polardb-for-oracle/clients-and-drivers/)
