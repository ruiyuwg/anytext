This Alibaba Cloud International Website Server Load Balancer (SLB) Service Level Agreement (“**SLA**”) applies to your purchase and use of the Alibaba Cloud International Website Server Load Balancer (SLB) (“**Service**”) and your use of the Service is subjected to the terms and conditions of the Alibaba Cloud International Website Product Terms of Service (“**Product Terms**”) between the relevant Alibaba Cloud entity described in the Product Terms (“**Alibaba Cloud**”, “**us**”, or “**we**”) and you.  This SLA only applies to your purchase and use of the Services for a fee, and shall not apply to any free Services or trial Services provided by us.

**1.Scope and Definitions**

1.1“**Downtime**” means the total number of minutes in a billing month when all the running instances in your Service have no external connectivity or cannot be operated.  
...
(j) events that result from the hacking of your applications;

(k) events that result from your failure to configure backend servers or exceptions on backend servers;

(l) events that arise because of your business traffic exceeding the type of your purchased Server Load Balancer instance;

(m) events that arise because of your security policy forbids the availability detection network segment,such as 100.64.0.0/10;

(n) events that caused by data, password, security key loss or disclosure due to improper maintenance or security measures;
...
100%×((total operating minutes in a billing month-Downtime))/(total operating minutes in a billing month)
...
1.6“**Service Credit**” means the percentage of the Monthly Service Fee for the affected Service that is credited to you for a validated claim following our service credit claim process under Section 3.

1.7“**Service Guarantee**” shall have the meaning set forth in Section 2 of this SLA.

**2.Service Level Agreement**

We shall use commercially reasonable endeavors to provide a Monthly Uptime Percentage for each of the different instance types of the Service as indicated in the table below for each billing month in connection with your use of the Service (the “**Service Guarantee**”).

**Instance Type**

**Service Availability**

(suitable for Multi-AZ Instance)

**Service Availability**

(suitable for Single-AZ Instance)
...
(a)  Application Load Balancer,Network Load Balancer and Gateway Load Balancer Instance
...
Less than 99.995%, but equal to or greater than 99.9%

Less than 99.95%, but equal to or greater than 99%

10%

Less than 99.9%, but equal to or greater than 99.5%

Less than 99%, but equal to or greater than 90%
...
Less than 99.9%, but equal to or greater than 90%
...
\[[Link](https://www.alibabacloud.com/help/zh/legal/latest/server-load-balancer-service-level-agreement-v1)\]
