...
![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/en-US/7403371671/CAEQThiBgICPh9i30RkiIDc1NGM2ZDc0MGEyMzRiN2ZiZmFkNWI1ZWQ1OWMwYTBh5617448_20250822165009.413.svg)
...
1.  Create a file named `ossfs2-pv.yaml` with the following content. This PV definition tells Kubernetes how to access your OSS bucket using the RRSA role.
    ...
    -   Parameters in `volumeAttributes`:
        ...
        **Description**
        ...
        > To use specified ARNs or a ServiceAccount with the RRSA authentication method, see [How do I use specified ARNs or a ServiceAccount with the RRSA authentication method?](/help/en/ack/ack-managed-and-ack-dedicated/user-guide/faq-about-oss-volumes-1#65c4c04f5fvuj).
