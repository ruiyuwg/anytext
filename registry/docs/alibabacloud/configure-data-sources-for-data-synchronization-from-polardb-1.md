...
1.  Configure a whitelist for the PolarDB for MySQL cluster.
    ...
    2.  Add the EIP and CIDR blocks recorded in the preceding steps to the whitelist of the PolarDB for MySQL cluster.
        ...
        ![Whitelist of the PolarDB cluster](https://help-static-aliyun-doc.aliyuncs.com/assets/img/en-US/2628330161/p201705.png)For more information, see [Configure an IP whitelist](/help/en/polardb/polardb-for-mysql/user-guide/configure-an-ip-whitelist#task-1580301 "After you create a cluster, you must configure an IP whitelist, and create an account for logging on to the cluster. Only IP addresses in the IP whitelists or Elastic Compute Service (ECS) instances in the security groups of the cluster can access the cluster. This topic describes how to configure an IP whitelist.").
...
2.  Create an account and grant the required permissions to the account.
    ...
    1.  Create an account.
        ...
        For more information, see [Create a database account](/help/en/polardb/polardb-for-mysql/user-guide/create-and-manage-database-accounts#task-1580301 "This topic describes how to create accounts and explains the differences between privileged accounts and standard accounts.").
...
3.  Enable the binary logging feature for the PolarDB for MySQL cluster.
    ...
    For more information, see [Enable binary logging](/help/en/polardb/polardb-for-mysql/user-guide/enable-binary-logging#task-1580301 "This topic describes how to enable the binary logging feature for a cluster.").
...
For more information about how to add a data source, see [Add a data source](/help/en/dataworks/add-a-data-source#task-2010758 "Before you configure and run a data sync node to synchronize data from a source data source to a destination Hologres data source, you must add the source data source and the destination data source in the DataWorks console.").
