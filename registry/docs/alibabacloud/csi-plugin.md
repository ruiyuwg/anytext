...
For more information about how to use csi-plugin, see [Manage the csi-plugin and csi-provisioner components](/help/en/ack/ack-managed-and-ack-dedicated/user-guide/install-and-upgrade-the-csi-plug-in).
...
-   When you upgrade csi-plugin, make sure that csi-provisioner is upgraded to the same version.
...
-   The occasional issue that the token expires when you perfrom the ListS napshot operation is fixed.
...
-   The NAS monitoring feature is supported.
