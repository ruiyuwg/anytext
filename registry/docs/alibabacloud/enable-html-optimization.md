...
5.  In the **HTML Optimization** section, turn on **HTML Optimization**, **CSS Optimization**, or **JavaScript Optimization**.
    ...
    **Note**
    ...
    ![页面优化](https://help-static-aliyun-doc.aliyuncs.com/assets/img/en-US/1103368961/p7303.png)
