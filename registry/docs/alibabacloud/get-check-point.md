...
The following table describes the required and specific parameters of the get\_check\_point command.
...
If an error message is returned, fix the error based on the error codes of the related API operation. For more information, see [Error codes](/help/en/sls/developer-reference/api-sls-2020-12-30-getcheckpoint#api-detail-45).
