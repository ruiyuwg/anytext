...
[Start an ApsaraDB RDS for SQL instance](/help/en/rds/apsaradb-rds-for-sql-server/stop-an-apsaradb-rds-for-sql-server-instance)

## Debugging

[You can run this interface directly in OpenAPI Explorer, saving you the trouble of calculating signatures. After running successfully, OpenAPI Explorer can automatically generate SDK code samples.](https://api.alibabacloud.com/api/Rds/2014-08-15/StartDBInstance)

[![](https://img.alicdn.com/tfs/TB16JcyXHr1gK0jSZR0XXbP8XXa-24-26.png)Debug](https://api.alibabacloud.com/api/Rds/2014-08-15/StartDBInstance)
...
**Note** This parameter must be specified when **DBInstanceTransType** is set to **2**.
...
**Note** This parameter must be specified when **EffectiveTime** is set to **Specified**.
...
[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/StartDBInstance?updateTime=2024-09-05#workbench-doc-change-demo)
