...
For information about the ossutil command that corresponds to the DeleteBucketReplication operation, see [delete-bucket-replication](/help/en/oss/developer-reference/delete-bucket-replication).
