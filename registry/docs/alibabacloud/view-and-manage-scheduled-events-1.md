...
[Minor engine version update](/help/en/polardb/polardb-for-postgresql/version-management-1)
...
Different minor versions have different updates. You must check the differences between the current minor version and the minor version to which your nodes are updated. For more information, see [Release notes](/help/en/polardb/polardb-for-postgresql/release-notes-5#concept-2476410).

[PolarProxy release notes](/help/en/polardb/polardb-for-postgresql/polarproxy-release-notes)
