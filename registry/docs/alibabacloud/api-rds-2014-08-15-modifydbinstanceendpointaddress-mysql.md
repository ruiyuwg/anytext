...
[You can run this interface directly in OpenAPI Explorer, saving you the trouble of calculating signatures. After running successfully, OpenAPI Explorer can automatically generate SDK code samples.](https://api.alibabacloud.com/api/Rds/2014-08-15/ModifyDBInstanceEndpointAddress)

[![](https://img.alicdn.com/tfs/TB16JcyXHr1gK0jSZR0XXbP8XXa-24-26.png)Debug](https://api.alibabacloud.com/api/Rds/2014-08-15/ModifyDBInstanceEndpointAddress)
...
rds:ModifyDBInstanceEndpointAddress
...
VPCId,VSwitchId,PrivateIPAddress can not be modified with ConnectionStringPrefix,Port.

A combination of the VPCId, VSwitchId, and PrivateIPAddress parameters and another combination of the ConnectionStringPrefix and Port parameters must meet the parameter combination requirements.

400

EmptyEndpointNodeConfig

Specified endpoint has no nodes, add node to endpoint first.

No nodes are attached to the endpoint. Attach nodes to the endpoint first.
...
InvalidEngineVersion.NotSupport

The specified parameter "EngineVersion" is not valid.

The database engine version is not supported. If you select MySQL, MySQL 5.5, MySQL 5.6, and MySQL 5.7 are supported. If you select SQLServer, SQL Server 2008 R2 and SQL Server 2012 are supported. If you select PostgreSQL, only PostgreSQL 9.4 is supported. If you select PPAS, only PPAS 9.3 is supported.
...
[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/ModifyDBInstanceEndpointAddress?updateTime=2024-04-17#workbench-doc-change-demo)

2023-05-09

The Error code has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/ModifyDBInstanceEndpointAddress?updateTime=2023-05-09#workbench-doc-change-demo)
