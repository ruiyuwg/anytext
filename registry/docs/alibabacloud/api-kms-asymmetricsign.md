...
You can also set this parameter to an alias that is bound to the key. For more information, see [Alias overview](/help/en/kms/key-management-service/support/overview).
...
-   For more information about how to calculate message digests, see the Preprocess before signing: Compute a message digest section of the [Generate and verify a digital signature by using an asymmetric CMK](/help/en/kms/key-management-service/support/generate-and-verify-a-digital-signature-by-using-an-asymmetric-cmk) topic.
