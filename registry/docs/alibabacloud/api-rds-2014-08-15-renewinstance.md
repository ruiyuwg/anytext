...
**Note** Fees of an instance are changed if the call is successful. Before you call this operation, carefully read the following topics:

-   [Manually renew an ApsaraDB RDS for MySQL instance](/help/en/rds/apsaradb-rds-for-mysql/manually-renew-an-apsaradb-rds-for-mysql-instance)
-   [Manually renew an ApsaraDB RDS for PostgreSQL instance](/help/en/rds/apsaradb-rds-for-postgresql/manually-renew-an-apsaradb-rds-for-postgresql-instance)
-   [Manually renew an ApsaraDB RDS for SQL Server instance](/help/en/rds/apsaradb-rds-for-sql-server/manually-renew-an-apsaradb-rds-for-sql-server-instance)
-   [Manually renew an ApsaraDB RDS for MariaDB instance](/help/en/rds/apsaradb-rds-for-mariadb/manually-renew-an-apsaradb-rds-for-mariadb-instance)

## Debugging

[You can run this interface directly in OpenAPI Explorer, saving you the trouble of calculating signatures. After running successfully, OpenAPI Explorer can automatically generate SDK code samples.](https://api.alibabacloud.com/api/Rds/2014-08-15/RenewInstance)

[![](https://img.alicdn.com/tfs/TB16JcyXHr1gK0jSZR0XXbP8XXa-24-26.png)Debug](https://api.alibabacloud.com/api/Rds/2014-08-15/RenewInstance)
...
**Note** For more information about how to renew the instance in the console, see the following topics:
...
ArrearageOrderExists

Your account has an outstanding balance.

Add funds to your Alibaba Cloud account, complete the overdue payments, and then try again.

400

OperationDenied.MultiRegions

Specified operation dose not support multiple regions.

The current operation does not support multiple regions.
...
InvalidParam.UsedTime

The renewal expiration date cannot exceed:%s.

The current instance is of the classic network type, and the renewal time cannot exceed the limit time.
...
The service has been discontinued and renewal operations for instances on the classic network are no longer allowed.

The classic network is offline. The current instance is of the classic network type and has exceeded the service stop time. You cannot renew the instance.
...
[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/RenewInstance?updateTime=2024-11-19#workbench-doc-change-demo)

2024-10-30

The Error code has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/RenewInstance?updateTime=2024-10-30#workbench-doc-change-demo)

2024-08-13

The Error code has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/RenewInstance?updateTime=2024-08-13#workbench-doc-change-demo)

2024-05-11

The Error code has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/RenewInstance?updateTime=2024-05-11#workbench-doc-change-demo)

2024-02-27

The Error code has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/RenewInstance?updateTime=2024-02-27#workbench-doc-change-demo)

2024-01-31

The Error code has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/RenewInstance?updateTime=2024-01-31#workbench-doc-change-demo)

2022-09-01

The Error code has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/RenewInstance?updateTime=2022-09-01#workbench-doc-change-demo)
