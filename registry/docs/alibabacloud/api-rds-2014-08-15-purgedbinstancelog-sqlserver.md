...
[You can run this interface directly in OpenAPI Explorer, saving you the trouble of calculating signatures. After running successfully, OpenAPI Explorer can automatically generate SDK code samples.](https://api.alibabacloud.com/api/Rds/2014-08-15/PurgeDBInstanceLog)

[![](https://img.alicdn.com/tfs/TB16JcyXHr1gK0jSZR0XXbP8XXa-24-26.png)Debug](https://api.alibabacloud.com/api/Rds/2014-08-15/PurgeDBInstanceLog)
...
The number of concurrent tasks exceeds the maximum number of concurrent tasks that are allowed.
...
[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/PurgeDBInstanceLog?updateTime=2022-09-01#workbench-doc-change-demo)
