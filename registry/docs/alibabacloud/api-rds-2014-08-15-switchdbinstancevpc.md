...
-   [Change the VPC and vSwitch for an ApsaraDB RDS for MySQL instance](/help/en/rds/apsaradb-rds-for-mysql/change-the-vpc-and-vswitch-for-an-apsaradb-rds-for-mysql-instance)
-   [Change the vSwitch for an ApsaraDB RDS for PostgreSQL instance](/help/en/rds/apsaradb-rds-for-postgresql/switch-an-apsaradb-rds-for-postgresql-instance-to-a-different-vswitch)
-   [Change the VPC and vSwitch for an ApsaraDB RDS for SQL Server instance](/help/en/rds/apsaradb-rds-for-sql-server/switch-an-apsaradb-rds-for-sql-server-instance-to-a-different-vswitch)

## Debugging

[You can run this interface directly in OpenAPI Explorer, saving you the trouble of calculating signatures. After running successfully, OpenAPI Explorer can automatically generate SDK code samples.](https://api.alibabacloud.com/api/Rds/2014-08-15/SwitchDBInstanceVpc)

[![](https://img.alicdn.com/tfs/TB16JcyXHr1gK0jSZR0XXbP8XXa-24-26.png)Debug](https://api.alibabacloud.com/api/Rds/2014-08-15/SwitchDBInstanceVpc)
...
Duplicate migration is forbidden.

The same data cannot be migrated twice.
...
[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/SwitchDBInstanceVpc?updateTime=2025-02-28#workbench-doc-change-demo)

2024-08-15

The Error code has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/SwitchDBInstanceVpc?updateTime=2024-08-15#workbench-doc-change-demo)

2022-06-23

API Description Update. The Error code has changed

[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/SwitchDBInstanceVpc?updateTime=2022-06-23#workbench-doc-change-demo)
...
[View Change Details](https://api.alibabacloud.com/document/Rds/2014-08-15/SwitchDBInstanceVpc?updateTime=2021-10-28#workbench-doc-change-demo)
