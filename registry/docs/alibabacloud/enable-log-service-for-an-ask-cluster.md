...
-   ack-virtual-node 2.7.0 or later is installed in the cluster. For more information about ack-virtual-node, see [ack-virtual-node](/help/en/ack/product-overview/ack-virtual-node#task-2441973).
