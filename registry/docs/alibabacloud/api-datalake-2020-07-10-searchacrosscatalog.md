...
[Try this API in OpenAPI Explorer, no manual signing needed. Successful calls auto-generate SDK code matching your parameters. Download it with built-in credential security for local usage.](https://api.alibabacloud.com/api/DataLake/2020-07-10/SearchAcrossCatalog)

 [![](https://img.alicdn.com/tfs/TB16JcyXHr1gK0jSZR0XXbP8XXa-24-26.png) Test](https://api.alibabacloud.com/api/DataLake/2020-07-10/SearchAcrossCatalog)
...
```
POST /api/metastore/catalogs/search/search-across-catalog HTTP/1.1
```
...
The catalog IDs. If this parameter is not specified, all catalogs are searched.
...
The structure of the table result.
...
[Catalog](/help/en/dlf/dlf-1-0/developer-reference/api-datalake-2020-07-10-struct-catalog)
...
The total number of catalogs that match the search criteria.
...
See [Release Notes](https://api.alibabacloud.com/document/DataLake/2020-07-10/SearchAcrossCatalog#workbench-doc-change-demo) for a complete list.
