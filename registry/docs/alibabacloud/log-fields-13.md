...
-   You must manually enable this feature. For more information, see [Enable log collection](/help/en/sls/enable-the-log-collection-feature-46).
...
Simple Log Service (SLS) provides a real-time query and analysis feature for OSS access logs. This service records, collects, stores, and analyzes data for OSS access, batch deletions, and hourly metering. [OSS built-in logging](/help/en/oss/user-guide/logging#concept-t3h-4hd-5db) is an OSS feature that records and stores access logs for OSS buckets.

The logs provided by SLS contain all the information from OSS access logs, but the log fields differ from those of the OSS built-in logs, as shown in the following table. For more information, see [Access logs](#section-odd-2vs-zdb).
...
The API operation. For more information, see [Appendix: API operations](/help/en/sls/log-fields-17#section-z8x-xpl-qbi).
...
The error code returned by OSS. For more information, see [Error codes](/help/en/oss/user-guide/overview-14#concept-dt2-hq3-wdb).
...
The detailed error code. For more information about how to troubleshoot issues based on ECs, see [Troubleshoot issues based on ECs](/help/en/oss/support/self-troubleshooting-by-using-error-codes).
...
The error code returned by OSS. For more information, see [Error codes](/help/en/oss/user-guide/overview-14#undefined).
